...
public class AlertDialogLayout extends LinearLayoutCompat {
    ...
    private boolean tryOnMeasure(int i, int i2) {
        ...
        for (int i10 = 0; i10 < childCount; i10++) {
            ...
            if (childAt.getVisibility() != 8) {
                ...
                if (id == C0021R.C0024id.topPanel) {
                    ...
                    view2 = childAt;
                } else if ((id != C0021R.C0024id.contentPanel && id != C0021R.C0024id.customPanel) || view3 != null) {
                    return false;
                } else {
                    view3 = childAt;
                }
        ...
        if (view2 != null) {
            ...
            view2.measure(i8, View.MeasureSpec.makeMeasureSpec(i5, BasicMeasure.EXACTLY));
