...
public class AppCompatSpinner extends Spinner implements TintableBackgroundView {
    ...
    public final class InspectionCompanion implements android.view.inspector.InspectionCompanion<AppCompatSpinner> {
        ...
        public void mapProperties(PropertyMapper propertyMapper) {
            this.mBackgroundTintId = propertyMapper.mapObject("backgroundTint", C0021R.attr.backgroundTint);
            this.mBackgroundTintModeId = propertyMapper.mapObject("backgroundTintMode", C0021R.attr.backgroundTintMode);
    ...
    public AppCompatSpinner(Context context, int i) {
        this(context, (AttributeSet) null, C0021R.attr.spinnerStyle, i);
    }

    public AppCompatSpinner(Context context, AttributeSet attributeSet) {
        this(context, attributeSet, C0021R.attr.spinnerStyle);
    }
    ...
    public AppCompatSpinner(android.content.Context r7, android.util.AttributeSet r8, int r9, int r10, android.content.res.Resources.Theme r11) {
        /*
            ...
            int[] r0 = androidx.appcompat.C0021R.styleable.Spinner
            r1 = 0
            ...
            goto L_0x003b
        L_0x0029:
            int r11 = androidx.appcompat.C0021R.styleable.Spinner_popupTheme
        ...
        L_0x0073:
            ...
            r10.<init>(r3, r8, r9)
            android.content.Context r3 = r6.mPopupContext
            int[] r4 = androidx.appcompat.C0021R.styleable.Spinner
            ...
            int r3 = androidx.appcompat.C0021R.styleable.Spinner_android_dropDownWidth
            r4 = -2
            int r3 = r1.getLayoutDimension((int) r3, (int) r4)
            r6.mDropDownWidth = r3
            int r3 = androidx.appcompat.C0021R.styleable.Spinner_android_popupBackground
            android.graphics.drawable.Drawable r3 = r1.getDrawable(r3)
            r10.setBackgroundDrawable(r3)
            int r3 = androidx.appcompat.C0021R.styleable.Spinner_android_prompt
        ...
        L_0x00aa:
            ...
            r10.<init>()
            r6.mPopup = r10
            int r1 = androidx.appcompat.C0021R.styleable.Spinner_android_prompt
            java.lang.String r1 = r0.getString(r1)
            r10.setPromptText(r1)
        L_0x00ba:
            int r10 = androidx.appcompat.C0021R.styleable.Spinner_android_entries
            java.lang.CharSequence[] r10 = r0.getTextArray(r10)
            if (r10 == 0) goto L_0x00d2
            android.widget.ArrayAdapter r1 = new android.widget.ArrayAdapter
            r3 = 17367048(0x1090008, float:2.5162948E-38)
            r1.<init>(r7, r3, r10)
            int r7 = androidx.appcompat.C0021R.layout.support_simple_spinner_dropdown_item
    ...
    class DropdownPopup extends ListPopupWindow implements SpinnerPopup {
        ...
        public void show(int i, int i2) {
            ...
            if (!isShowing && (viewTreeObserver = AppCompatSpinner.this.getViewTreeObserver()) != null) {
                final C00852 r6 = new ViewTreeObserver.OnGlobalLayoutListener() {
                    public void onGlobalLayout() {
