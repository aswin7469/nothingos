...
class RoundRectDrawableWithShadow extends Drawable {
    ...
    RoundRectDrawableWithShadow(Resources resources, ColorStateList colorStateList, float f, float f2, float f3) {
        this.mShadowStartColor = resources.getColor(C0125R.C0126color.cardview_shadow_start_color);
        this.mShadowEndColor = resources.getColor(C0125R.C0126color.cardview_shadow_end_color);
        this.mInsetShadow = resources.getDimensionPixelSize(C0125R.dimen.cardview_compat_inset_shadow);
