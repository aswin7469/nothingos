    ...
    public void setup(int i, int i2, float f, long j) {
        ...
        while (true) {
            ...
            while (true) {
                if (i7 >= size) {
                    break;
                } else if (motionPathsArr[i7].attributes.containsKey(str5)) {
                    int[] iArr = this.mAttributeInterpCount;
                    iArr[i6] = iArr[i6] + motionPathsArr[i7].attributes.get(str5).noOfInterpValues();
                    break;
                } else {
                    i7++;
                }
        ...
        while (true) {
            ...
            if (iArr4[i14] < MotionPaths.names.length) {
                String str6 = MotionPaths.names[this.mInterpolateVariables[i14]] + " [";
        ...
        while (true) {
            ...
            double[][] dArr5 = null;
            while (i17 < size) {
                if (motionPathsArr[i17].hasCustomData(str7)) {
                    if (dArr5 == null) {
                        int[] iArr5 = new int[i4];
                        iArr5[1] = motionPathsArr[i17].getCustomDataCount(str7);
                        iArr5[i3] = size;
                        dArr5 = (double[][]) Array.newInstance(cls, iArr5);
                        dArr4 = new double[size];
                    }
                    dArr4[i18] = (double) motionPathsArr[i17].time;
                    motionPathsArr[i17].getCustomData(str7, dArr5[i18], 0);
                    i18++;
                }
                i17++;
                i4 = 2;
        ...
        if (motionPathsArr[0].mPathMotionArc != Key.UNSET) {
            ...
            iArr7[1] = 2;
            iArr7[0] = size;
            double[][] dArr7 = (double[][]) Array.newInstance(cls, iArr7);
            for (int i19 = 0; i19 < size; i19++) {
                iArr6[i19] = motionPathsArr[i19].mPathMotionArc;
                dArr6[i19] = (double) motionPathsArr[i19].time;
                dArr7[i19][0] = (double) motionPathsArr[i19].f29x;
                dArr7[i19][1] = (double) motionPathsArr[i19].f30y;
            }
            this.mArcSpline = CurveFit.getArc(iArr6, dArr6, dArr7);
        }
        float f2 = Float.NaN;
