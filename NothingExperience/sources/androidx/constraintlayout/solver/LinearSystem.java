...
public class LinearSystem {
    ...
    public SolverVariable createObjectVariable(Object obj) {
        ...
        if (obj instanceof ConstraintAnchor) {
            ...
            if (solverVariable.f31id == -1 || solverVariable.f31id > this.mVariablesID || this.mCache.mIndexedVariables[solverVariable.f31id] == null) {
    ...
    private final int optimize(Row row, boolean z) {
        ...
        while (!z2) {
            ...
            if (row.getKey() != null) {
                this.mAlreadyTestedCandidates[row.getKey().f31id] = USE_SYNONYMS;
            }
            SolverVariable pivotCandidate = row.getPivotCandidate(this, this.mAlreadyTestedCandidates);
            if (pivotCandidate != null) {
                if (this.mAlreadyTestedCandidates[pivotCandidate.f31id]) {
                    return i2;
                }
                this.mAlreadyTestedCandidates[pivotCandidate.f31id] = USE_SYNONYMS;
            }
            if (pivotCandidate != null) {
    ...
    private String getDisplaySize(int i) {
        ...
        int i4 = i3 / 1024;
        if (i4 > 0) {
            return HttpUrl.FRAGMENT_ENCODE_SET + i4 + " Mb";
        } else if (i3 > 0) {
            return HttpUrl.FRAGMENT_ENCODE_SET + i3 + " Kb";
        } else {
            return HttpUrl.FRAGMENT_ENCODE_SET + i2 + " bytes";
        }
    }
