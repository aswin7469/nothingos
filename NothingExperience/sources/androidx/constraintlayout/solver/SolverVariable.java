...
public class SolverVariable {
    ...
    private static String getUniqueName(Type type, String str) {
        ...
        int i = C01431.$SwitchMap$androidx$constraintlayout$solver$SolverVariable$Type[type.ordinal()];
        if (i == 1) {
    ...
    static /* synthetic */ class C01431 {
        ...
        static {
            ...
            L_0x003e:
                return
            */
            throw new UnsupportedOperationException("Method not decompiled: androidx.constraintlayout.solver.SolverVariable.C01431.<clinit>():void");
        }
    }
    ...
    public String toString() {
        ...
        return HttpUrl.FRAGMENT_ENCODE_SET + this.f31id;
    }
}
