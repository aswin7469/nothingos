...
public class ConstraintReference implements Reference {
    ...
    static /* synthetic */ class C01441 {
        ...
        static final /* synthetic */ int[] f32x7d4bfe12;
        ...
        static {
            ...
            L_0x0012:
                int[] r0 = f32x7d4bfe12     // Catch:{ NoSuchFieldError -> 0x001d }
            ...
            L_0x001d:
                int[] r0 = f32x7d4bfe12     // Catch:{ NoSuchFieldError -> 0x0028 }
            ...
            L_0x0028:
                int[] r0 = f32x7d4bfe12     // Catch:{ NoSuchFieldError -> 0x0033 }
            ...
            L_0x0033:
                int[] r0 = f32x7d4bfe12     // Catch:{ NoSuchFieldError -> 0x003e }
            ...
            L_0x003e:
                int[] r0 = f32x7d4bfe12     // Catch:{ NoSuchFieldError -> 0x0049 }
            ...
            L_0x0049:
                int[] r0 = f32x7d4bfe12     // Catch:{ NoSuchFieldError -> 0x0054 }
            ...
            L_0x0054:
                int[] r0 = f32x7d4bfe12     // Catch:{ NoSuchFieldError -> 0x0060 }
            ...
            L_0x0060:
                int[] r0 = f32x7d4bfe12     // Catch:{ NoSuchFieldError -> 0x006c }
            ...
            L_0x006c:
                int[] r0 = f32x7d4bfe12     // Catch:{ NoSuchFieldError -> 0x0078 }
            ...
            L_0x0078:
                int[] r0 = f32x7d4bfe12     // Catch:{ NoSuchFieldError -> 0x0084 }
            ...
            L_0x0084:
                int[] r0 = f32x7d4bfe12     // Catch:{ NoSuchFieldError -> 0x0090 }
            ...
            L_0x0090:
                int[] r0 = f32x7d4bfe12     // Catch:{ NoSuchFieldError -> 0x009c }
            ...
            L_0x009c:
                int[] r0 = f32x7d4bfe12     // Catch:{ NoSuchFieldError -> 0x00a8 }
            ...
            L_0x00a8:
                int[] r0 = f32x7d4bfe12     // Catch:{ NoSuchFieldError -> 0x00b4 }
            ...
            L_0x00b4:
                return
            */
            throw new UnsupportedOperationException("Method not decompiled: androidx.constraintlayout.solver.state.ConstraintReference.C01441.<clinit>():void");
        }
    }

    public ConstraintReference margin(int i) {
        if (this.mLast != null) {
            switch (C01441.f32x7d4bfe12[this.mLast.ordinal()]) {
                case 1:
                case 2:
                    this.mMarginLeft = i;
                    break;
    ...
    private void applyConnection(ConstraintWidget constraintWidget, Object obj, State.Constraint constraint) {
        ...
        if (target != null) {
            int i = C01441.f32x7d4bfe12[constraint.ordinal()];
            switch (C01441.f32x7d4bfe12[constraint.ordinal()]) {
                case 1:
