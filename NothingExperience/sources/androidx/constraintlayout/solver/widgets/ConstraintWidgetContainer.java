    ...
    public void layout() {
        ...
        while (z5) {
            ...
            try {
                ...
                for (int i4 = 0; i4 < size; i4++) {
                    ((ConstraintWidget) this.mChildren.get(i4)).createObjectVariables(this.mSystem);
                }
            ...
            if (z5) {
                ...
                for (int i5 = 0; i5 < size; i5++) {
                    ((ConstraintWidget) this.mChildren.get(i5)).updateFromSolver(this.mSystem);
                }
            }
            if (!z3 || i3 >= 8 || !Optimizer.flags[2]) {
                ...
                for (int i8 = 0; i8 < size; i8++) {
                    ...
                    i6 = Math.max(i6, constraintWidget2.f35mX + constraintWidget2.getWidth());
                    i7 = Math.max(i7, constraintWidget2.f36mY + constraintWidget2.getHeight());
                }
