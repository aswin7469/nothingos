...
public class EmojiCompatInitializer implements Initializer<Boolean> {
    ...
    static class BackgroundDefaultLoader implements EmojiCompat.MetadataRepoLoader {
        ...
        public void load(EmojiCompat.MetadataRepoLoaderCallback metadataRepoLoaderCallback) {
            ...
            createBackgroundPriorityExecutor.execute(new C0292xfb0118ab(this, metadataRepoLoaderCallback, createBackgroundPriorityExecutor));
        }

        /* access modifiers changed from: package-private */
        /* renamed from: doLoad */
        public void mo6662x5cc8028a(final EmojiCompat.MetadataRepoLoaderCallback metadataRepoLoaderCallback, final ThreadPoolExecutor threadPoolExecutor) {
            try {
