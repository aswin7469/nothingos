...
public class FlexBuffers {
    ...
    public static class Reference {
        ...
        public int asInt() {
            int i = this.type;
            if (i == 1) {
                return FlexBuffers.readInt(this.f72bb, this.end, this.parentWidth);
            }
            if (i == 2) {
                return (int) FlexBuffers.readUInt(this.f72bb, this.end, this.parentWidth);
            }
            if (i == 3) {
                return (int) FlexBuffers.readDouble(this.f72bb, this.end, this.parentWidth);
            }
            if (i == 5) {
                return Integer.parseInt(asString());
            }
            if (i == 6) {
                ReadBuf readBuf = this.f72bb;
                return FlexBuffers.readInt(readBuf, FlexBuffers.indirect(readBuf, this.end, this.parentWidth), this.byteWidth);
            } else if (i == 7) {
                ReadBuf readBuf2 = this.f72bb;
                return (int) FlexBuffers.readUInt(readBuf2, FlexBuffers.indirect(readBuf2, this.end, this.parentWidth), this.parentWidth);
            } else if (i == 8) {
                ReadBuf readBuf3 = this.f72bb;
        ...
        public long asUInt() {
            int i = this.type;
            if (i == 2) {
                return FlexBuffers.readUInt(this.f72bb, this.end, this.parentWidth);
            }
            if (i == 1) {
                return FlexBuffers.readLong(this.f72bb, this.end, this.parentWidth);
            }
            if (i == 3) {
                return (long) FlexBuffers.readDouble(this.f72bb, this.end, this.parentWidth);
            }
            if (i == 10) {
                return (long) asVector().size();
            }
            if (i == 26) {
                return (long) FlexBuffers.readInt(this.f72bb, this.end, this.parentWidth);
            }
            if (i == 5) {
        ...
        public double asFloat() {
            int i = this.type;
            if (i == 3) {
                return FlexBuffers.readDouble(this.f72bb, this.end, this.parentWidth);
            }
            if (i == 1) {
                return (double) FlexBuffers.readInt(this.f72bb, this.end, this.parentWidth);
            }
            if (i != 2) {
                if (i == 5) {
            ...
            return (double) FlexBuffers.readUInt(this.f72bb, this.end, this.parentWidth);
        }
        ...
        public String asString() {
            if (isString()) {
                int access$200 = FlexBuffers.indirect(this.f72bb, this.end, this.parentWidth);
                ReadBuf readBuf = this.f72bb;
                int i = this.byteWidth;
                return this.f72bb.getString(access$200, (int) FlexBuffers.readUInt(readBuf, access$200 - i, i));
            } else if (!isKey()) {
                return HttpUrl.FRAGMENT_ENCODE_SET;
            } else {
                int access$2002 = FlexBuffers.indirect(this.f72bb, this.end, this.byteWidth);
                int i2 = access$2002;
                while (this.f72bb.get(i2) != 0) {
                    i2++;
                }
                return this.f72bb.getString(access$2002, i2 - access$2002);
            }
        }
    ...
    private static abstract class Sized extends Object {
        ...
        Sized(ReadBuf readBuf, int i, int i2) {
            super(readBuf, i, i2);
            this.size = FlexBuffers.readInt(this.f71bb, i - i2, i2);
        }
    ...
    public static class Blob extends Sized {
        ...
        public ByteBuffer data() {
            ByteBuffer wrap = ByteBuffer.wrap(this.f71bb.data());
        ...
        public byte[] getBytes() {
            ...
            for (int i = 0; i < size; i++) {
                bArr[i] = this.f71bb.get(this.end + i);
            }
            return bArr;
        }

        public byte get(int i) {
            return this.f71bb.get(this.end + i);
        }

        public String toString() {
            return this.f71bb.getString(this.end, size());
        }

        public StringBuilder toString(StringBuilder sb) {
            sb.append(Typography.quote);
            sb.append(this.f71bb.getString(this.end, size()));
            sb.append(Typography.quote);
            return sb;
        }
    }
    ...
    public static class Key extends Object {
        ...
        public String toString() {
            int i = this.end;
            while (this.f71bb.get(i) != 0) {
                i++;
            }
            return this.f71bb.getString(this.end, i - this.end);
        }
    ...
    public static class Map extends Vector {
        ...
        public KeyVector keys() {
            ...
            return new KeyVector(new TypedVector(this.f71bb, FlexBuffers.indirect(this.f71bb, i, this.byteWidth), FlexBuffers.readInt(this.f71bb, i + this.byteWidth, this.byteWidth), 4));
        }

        public Vector values() {
            return new Vector(this.f71bb, this.end, this.byteWidth);
        }
    ...
    public static class Vector extends Sized {
        ...
        public Reference get(int i) {
            ...
            int byteToUnsignedInt = Unsigned.byteToUnsignedInt(this.f71bb.get((int) (((long) this.end) + (size * ((long) this.byteWidth)) + j)));
            return new Reference(this.f71bb, this.end + (i * this.byteWidth), this.byteWidth, byteToUnsignedInt);
        }
    }
    ...
    public static class TypedVector extends Vector {
        ...
        public Reference get(int i) {
            ...
            return new Reference(this.f71bb, this.end + (i * this.byteWidth), this.byteWidth, 1, this.elemType);
        }
    }
    ...
    public static class KeyVector {
        ...
        public Key get(int i) {
            ...
            return new Key(this.vec.f71bb, FlexBuffers.indirect(this.vec.f71bb, this.vec.end + (i * this.vec.byteWidth), this.vec.byteWidth), 1);
        }
