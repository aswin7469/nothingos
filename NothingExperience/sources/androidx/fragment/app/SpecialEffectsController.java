...
abstract class SpecialEffectsController {
    ...
    static SpecialEffectsController getOrCreateController(ViewGroup viewGroup, SpecialEffectsControllerFactory specialEffectsControllerFactory) {
        Object tag = viewGroup.getTag(C0299R.C0302id.special_effects_controller_view_tag);
        if (tag instanceof SpecialEffectsController) {
            return (SpecialEffectsController) tag;
        }
        SpecialEffectsController createController = specialEffectsControllerFactory.createController(viewGroup);
        viewGroup.setTag(C0299R.C0302id.special_effects_controller_view_tag, createController);
    ...
    static class Operation {
        ...
        enum State {
            ...
            public void applyState(View view) {
                int i = C03743.f78xe493b431[ordinal()];
                if (i == 1) {
        ...
        public final void mergeWith(State state, LifecycleImpact lifecycleImpact) {
            int i = C03743.f77xb9e640f0[lifecycleImpact.ordinal()];
            if (i != 1) {
                if (i == 2) {
                    if (FragmentManager.isLoggingEnabled(2)) {
    ...
    static /* synthetic */ class C03743 {
        ...
        static {
            ...
            L_0x0012:
                r0 = 2
                int[] r2 = f77xb9e640f0     // Catch:{ NoSuchFieldError -> 0x001d }
            ...
            L_0x001d:
                r2 = 3
                int[] r3 = f77xb9e640f0     // Catch:{ NoSuchFieldError -> 0x0028 }
            ...
            L_0x0039:
                int[] r1 = f78xe493b431     // Catch:{ NoSuchFieldError -> 0x0043 }
            ...
            L_0x0043:
                int[] r0 = f78xe493b431     // Catch:{ NoSuchFieldError -> 0x004d }
            ...
            L_0x004d:
                int[] r0 = f78xe493b431     // Catch:{ NoSuchFieldError -> 0x0058 }
            ...
            L_0x0058:
                return
            */
            throw new UnsupportedOperationException("Method not decompiled: androidx.fragment.app.SpecialEffectsController.C03743.<clinit>():void");
        }
    }
