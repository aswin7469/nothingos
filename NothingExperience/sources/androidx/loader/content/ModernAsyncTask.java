...
abstract class ModernAsyncTask<Params, Progress, Result> {
    ...
    ModernAsyncTask() {
        C04122 r0 = new WorkerRunnable<Params, Result>() {
    ...
    static /* synthetic */ class C04144 {
        ...
        static {
            ...
            L_0x001d:
                return
            */
            throw new UnsupportedOperationException("Method not decompiled: androidx.loader.content.ModernAsyncTask.C04144.<clinit>():void");
        }
    }

    public final ModernAsyncTask<Params, Progress, Result> executeOnExecutor(Executor executor, Params... paramsArr) {
        if (this.mStatus != Status.PENDING) {
            int i = C04144.$SwitchMap$androidx$loader$content$ModernAsyncTask$Status[this.mStatus.ordinal()];
            if (i == 1) {
