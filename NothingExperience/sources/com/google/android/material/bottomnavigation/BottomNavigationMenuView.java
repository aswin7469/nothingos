...
public class BottomNavigationMenuView extends NavigationBarMenuView {
    ...
    public BottomNavigationMenuView(Context context) {
        ...
        this.inactiveItemMaxWidth = resources.getDimensionPixelSize(C0569R.dimen.design_bottom_navigation_item_max_width);
        this.inactiveItemMinWidth = resources.getDimensionPixelSize(C0569R.dimen.design_bottom_navigation_item_min_width);
        this.activeItemMaxWidth = resources.getDimensionPixelSize(C0569R.dimen.design_bottom_navigation_active_item_max_width);
        this.activeItemMinWidth = resources.getDimensionPixelSize(C0569R.dimen.design_bottom_navigation_active_item_min_width);
    }
    ...
    public void onMeasure(int i, int i2) {
        ...
        if (!isShifting(getLabelVisibilityMode(), size2) || !isItemHorizontalTranslationEnabled()) {
            ...
            while (i9 < childCount) {
                if (getChildAt(i9).getVisibility() != 8) {
                    this.tempChildWidths[i9] = i9 == getSelectedItemPosition() ? min2 : min3;
                    if (i8 > 0) {
        ...
        for (int i11 = 0; i11 < childCount; i11++) {
            ...
            if (childAt2.getVisibility() != 8) {
                childAt2.measure(View.MeasureSpec.makeMeasureSpec(this.tempChildWidths[i11], BasicMeasure.EXACTLY), makeMeasureSpec);
