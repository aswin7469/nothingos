...
public class SnackbarContentLayout extends LinearLayout implements ContentViewCallback {
    ...
    public void onFinishInflate() {
        ...
        this.messageView = (TextView) findViewById(C0569R.C0572id.snackbar_text);
        this.actionView = (Button) findViewById(C0569R.C0572id.snackbar_action);
    }
    ...
    public void updateActionTextColorAlphaIfNeeded(float f) {
        if (f != 1.0f) {
            this.actionView.setTextColor(MaterialColors.layer(MaterialColors.getColor(this, C0569R.attr.colorSurface), this.actionView.getCurrentTextColor(), f));
        }
    }

    /* access modifiers changed from: protected */
    /* JADX WARNING: Code restructure failed: missing block: B:10:0x003e, code lost:
        if (updateViewsWithinLayout(1, r0, r0 - r1) != false) goto L_0x004b;
     */
    /* JADX WARNING: Code restructure failed: missing block: B:14:0x0049, code lost:
        if (updateViewsWithinLayout(0, r0, r0) != false) goto L_0x004b;
     */
    ...
    public void onMeasure(int r8, int r9) {
        /*
            ...
            int r1 = com.google.android.material.C0569R.dimen.design_snackbar_padding_vertical_2lines
            int r0 = r0.getDimensionPixelSize(r1)
            android.content.res.Resources r1 = r7.getResources()
            int r2 = com.google.android.material.C0569R.dimen.design_snackbar_padding_vertical
