...
class PasswordToggleEndIconDelegate extends EndIconDelegate {
    ...
    public void initialize() {
        this.textInputLayout.setEndIconDrawable(this.customEndIcon == 0 ? C0569R.C0571drawable.design_password_eye : this.customEndIcon);
        this.textInputLayout.setEndIconContentDescription(this.textInputLayout.getResources().getText(C0569R.string.password_toggle_content_description));
