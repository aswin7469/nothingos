...
class UArraysKt___UArraysJvmKt {
    ...
    public static /* synthetic */ int m567binarySearchK6DWlUc$default(long[] jArr, long j, int i, int i2, int i3, Object obj) {
        if ((i3 & 2) != 0) {
            i = 0;
        }
        if ((i3 & 4) != 0) {
            i2 = ULongArray.m327getSizeimpl(jArr);
        }
        return UArraysKt.m566binarySearchK6DWlUc(jArr, j, i, i2);
    }

    /* renamed from: binarySearch-K6DWlUc  reason: not valid java name */
    public static final int m566binarySearchK6DWlUc(long[] jArr, long j, int i, int i2) {
        Intrinsics.checkNotNullParameter(jArr, "$this$binarySearch");
        AbstractList.Companion.checkRangeIndexes$kotlin_stdlib(i, i2, ULongArray.m327getSizeimpl(jArr));
        int i3 = i2 - 1;
        while (i <= i3) {
            int i4 = (i + i3) >>> 1;
    ...
    public static /* synthetic */ int m569binarySearchWpHrYlw$default(byte[] bArr, byte b, int i, int i2, int i3, Object obj) {
        if ((i3 & 2) != 0) {
            i = 0;
        }
        if ((i3 & 4) != 0) {
            i2 = UByteArray.m171getSizeimpl(bArr);
        }
        return UArraysKt.m568binarySearchWpHrYlw(bArr, b, i, i2);
    }

    /* renamed from: binarySearch-WpHrYlw  reason: not valid java name */
    public static final int m568binarySearchWpHrYlw(byte[] bArr, byte b, int i, int i2) {
        Intrinsics.checkNotNullParameter(bArr, "$this$binarySearch");
        AbstractList.Companion.checkRangeIndexes$kotlin_stdlib(i, i2, UByteArray.m171getSizeimpl(bArr));
    ...
    public static /* synthetic */ int m565binarySearchEtDCXyQ$default(short[] sArr, short s, int i, int i2, int i3, Object obj) {
        if ((i3 & 2) != 0) {
            i = 0;
        }
        if ((i3 & 4) != 0) {
            i2 = UShortArray.m431getSizeimpl(sArr);
        }
        return UArraysKt.m564binarySearchEtDCXyQ(sArr, s, i, i2);
    }

    /* renamed from: binarySearch-EtDCXyQ  reason: not valid java name */
    public static final int m564binarySearchEtDCXyQ(short[] sArr, short s, int i, int i2) {
        Intrinsics.checkNotNullParameter(sArr, "$this$binarySearch");
        AbstractList.Companion.checkRangeIndexes$kotlin_stdlib(i, i2, UShortArray.m431getSizeimpl(sArr));
    ...
    private static final BigDecimal sumOfBigDecimal(int[] iArr, Function1<? super UInt, ? extends BigDecimal> function1) {
        ...
        while (r2.hasNext()) {
            valueOf = valueOf.add((BigDecimal) function1.invoke(UInt.m183boximpl(r2.next().m240unboximpl())));
    ...
    private static final BigDecimal sumOfBigDecimal(long[] jArr, Function1<? super ULong, ? extends BigDecimal> function1) {
        ...
        BigDecimal valueOf = BigDecimal.valueOf(0);
        Intrinsics.checkNotNullExpressionValue(valueOf, "valueOf(this.toLong())");
        Iterator<ULong> r3 = ULongArray.m330iteratorimpl(jArr);
        while (r3.hasNext()) {
            valueOf = valueOf.add((BigDecimal) function1.invoke(ULong.m261boximpl(r3.next().m318unboximpl())));
            Intrinsics.checkNotNullExpressionValue(valueOf, "this.add(other)");
        }
        return valueOf;
    }
    ...
    private static final BigDecimal sumOfBigDecimal(byte[] bArr, Function1<? super UByte, ? extends BigDecimal> function1) {
        ...
        while (r2.hasNext()) {
            valueOf = valueOf.add((BigDecimal) function1.invoke(UByte.m107boximpl(r2.next().m162unboximpl())));
            Intrinsics.checkNotNullExpressionValue(valueOf, "this.add(other)");
        }
        return valueOf;
    }
    ...
    private static final BigDecimal sumOfBigDecimal(short[] sArr, Function1<? super UShort, ? extends BigDecimal> function1) {
        ...
        while (r2.hasNext()) {
            valueOf = valueOf.add((BigDecimal) function1.invoke(UShort.m367boximpl(r2.next().m422unboximpl())));
            Intrinsics.checkNotNullExpressionValue(valueOf, "this.add(other)");
        }
        return valueOf;
    }
    ...
    private static final BigInteger sumOfBigInteger(int[] iArr, Function1<? super UInt, ? extends BigInteger> function1) {
        ...
        Iterator<UInt> r2 = UIntArray.m252iteratorimpl(iArr);
        while (r2.hasNext()) {
            valueOf = valueOf.add((BigInteger) function1.invoke(UInt.m183boximpl(r2.next().m240unboximpl())));
            Intrinsics.checkNotNullExpressionValue(valueOf, "this.add(other)");
        }
        return valueOf;
    }
    ...
    private static final BigInteger sumOfBigInteger(long[] jArr, Function1<? super ULong, ? extends BigInteger> function1) {
        ...
        Iterator<ULong> r3 = ULongArray.m330iteratorimpl(jArr);
        while (r3.hasNext()) {
            valueOf = valueOf.add((BigInteger) function1.invoke(ULong.m261boximpl(r3.next().m318unboximpl())));
            Intrinsics.checkNotNullExpressionValue(valueOf, "this.add(other)");
        }
        return valueOf;
    }
    ...
    private static final BigInteger sumOfBigInteger(byte[] bArr, Function1<? super UByte, ? extends BigInteger> function1) {
        ...
        Iterator<UByte> r2 = UByteArray.m174iteratorimpl(bArr);
        while (r2.hasNext()) {
            valueOf = valueOf.add((BigInteger) function1.invoke(UByte.m107boximpl(r2.next().m162unboximpl())));
            Intrinsics.checkNotNullExpressionValue(valueOf, "this.add(other)");
        }
        return valueOf;
    }
    ...
    private static final BigInteger sumOfBigInteger(short[] sArr, Function1<? super UShort, ? extends BigInteger> function1) {
        ...
        Iterator<UShort> r2 = UShortArray.m434iteratorimpl(sArr);
        while (r2.hasNext()) {
            valueOf = valueOf.add((BigInteger) function1.invoke(UShort.m367boximpl(r2.next().m422unboximpl())));
            Intrinsics.checkNotNullExpressionValue(valueOf, "this.add(other)");
        }
        return valueOf;
    }
