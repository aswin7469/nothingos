...
final class RunSuspend implements Continuation<Unit> {
    ...
    public final Result<Unit> m1282getResultxLWZpok() {
        return this.result;
    }
    ...
    public void resumeWith(Object obj) {
        synchronized (this) {
            setResult(Result.m94boximpl(obj));
            notifyAll();
    ...
    public final void await() {
        synchronized (this) {
            while (true) {
                Result<Unit> r0 = m1282getResultxLWZpok();
                if (r0 == null) {
                    wait();
                } else {
                    ResultKt.throwOnFailure(r0.m104unboximpl());
                }
            }
        }
    }
