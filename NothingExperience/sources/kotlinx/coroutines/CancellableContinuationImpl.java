...
public class CancellableContinuationImpl<T> extends DispatchedTask<T> implements CancellableContinuation<T>, CoroutineStackFrame {
    ...
    public void invokeOnCancellation(Function1<? super Throwable, Unit> function1) {
        ...
        while (true) {
            ...
            if (obj instanceof Active) {
                if (C0134xc40028dd.m4m(_state$FU, this, obj, makeCancelHandler)) {
                    return;
                }
                ...
                if (z) {
                    ...
                    if (!(makeCancelHandler instanceof BeforeResumeCancelHandler)) {
                        ...
                        if (C0134xc40028dd.m4m(_state$FU, this, obj, CompletedContinuation.copy$default(completedContinuation, (Object) null, makeCancelHandler, (Function1) null, (Object) null, (Throwable) null, 29, (Object) null))) {
                            return;
                        }
                    } else {
                        return;
                    ...
                    if (C0134xc40028dd.m4m(_state$FU, this, obj, new CompletedContinuation(obj, makeCancelHandler, (Function1) null, (Object) null, (Throwable) null, 28, (DefaultConstructorMarker) null))) {
                        return;
                    }
                } else {
                    return;
        ...
        while (true) {
            ...
            if (obj2 instanceof NotCompleted) {
                ...
                if (obj2 instanceof CompletedContinuation) {
                    ...
                    if (!completedContinuation.getCancelled()) {
                        if (C0134xc40028dd.m4m(_state$FU, this, obj2, CompletedContinuation.copy$default(completedContinuation, (Object) null, (CancelHandler) null, (Function1) null, (Object) null, th, 15, (Object) null))) {
                ...
                } else if (C0134xc40028dd.m4m(_state$FU, this, obj2, new CompletedContinuation(obj2, (CancelHandler) null, (Function1) null, (Object) null, th, 14, (DefaultConstructorMarker) null))) {
                    return;
                }
            } else {
                return;
    ...
    public boolean cancel(Throwable th) {
        ...
        } while (!C0134xc40028dd.m4m(_state$FU, this, obj, new CancelledContinuation(this, th, z)));
    ...
    private final void resumeImpl(Object obj, int i, Function1<? super Throwable, Unit> function1) {
        ...
        } while (!C0134xc40028dd.m4m(_state$FU, this, obj2, resumedState((NotCompleted) obj2, obj, i, function1, (Object) null)));
        detachChildIfNonResuable();
        dispatchResume(i);
    }
    ...
    private final Symbol tryResumeImpl(Object obj, Object obj2, Function1<? super Throwable, Unit> function1) {
        ...
        } while (!C0134xc40028dd.m4m(_state$FU, this, obj3, resumedState((NotCompleted) obj3, obj, this.resumeMode, function1, obj2)));
        detachChildIfNonResuable();
        return CancellableContinuationImplKt.RESUME_TOKEN;
    }
}
