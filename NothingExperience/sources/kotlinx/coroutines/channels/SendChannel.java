...
public interface SendChannel<E> {
    ...
    Object m1562trySendJP2dKIU(E e);
    ...
    public static final class DefaultImpls {
        ...
        public static <E> boolean offer(SendChannel<? super E> sendChannel, E e) {
            ...
            if (ChannelResult.m1550isSuccessimpl(r0)) {
                return true;
            }
            Throwable r02 = ChannelResult.m1544exceptionOrNullimpl(r0);
            if (r02 == null) {
                return false;
            }
