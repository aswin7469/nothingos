...
@DebugMetadata(mo14735c = "kotlinx.coroutines.flow.FlowKt__LimitKt$transformWhile$1", mo14736f = "Limit.kt", mo14737i = {0}, mo14738l = {153}, mo14739m = "invokeSuspend", mo14740n = {"collector$iv"}, mo14741s = {"L$0"})
...
final class FlowKt__LimitKt$transformWhile$1 extends SuspendLambda implements Function2<FlowCollector<? super R>, Continuation<? super Unit>, Object> {
    ...
    public final Object invokeSuspend(Object obj) {
        C0997xdf1aa1b6 flowKt__LimitKt$transformWhile$1$invokeSuspend$$inlined$collectWhile$1;
        Object coroutine_suspended = IntrinsicsKt.getCOROUTINE_SUSPENDED();
        int i = this.label;
        if (i == 0) {
            ResultKt.throwOnFailure(obj);
            Flow<T> flow = this.$this_transformWhile;
            C0997xdf1aa1b6 flowKt__LimitKt$transformWhile$1$invokeSuspend$$inlined$collectWhile$12 = new C0997xdf1aa1b6(this.$transform, (FlowCollector) this.L$0);
            try {
            ...
            flowKt__LimitKt$transformWhile$1$invokeSuspend$$inlined$collectWhile$1 = (C0997xdf1aa1b6) this.L$0;
            try {
                ResultKt.throwOnFailure(obj);
