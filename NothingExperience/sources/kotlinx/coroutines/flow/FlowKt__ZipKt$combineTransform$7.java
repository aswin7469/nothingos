...
@DebugMetadata(mo14735c = "kotlinx.coroutines.flow.FlowKt__ZipKt$combineTransform$7", mo14736f = "Zip.kt", mo14737i = {}, mo14738l = {308}, mo14739m = "invokeSuspend", mo14740n = {}, mo14741s = {})
...
public final class FlowKt__ZipKt$combineTransform$7 extends SuspendLambda implements Function2<FlowCollector<? super R>, Continuation<? super Unit>, Object> {
    ...
    @DebugMetadata(mo14735c = "kotlinx.coroutines.flow.FlowKt__ZipKt$combineTransform$7$2", mo14736f = "Zip.kt", mo14737i = {}, mo14738l = {308}, mo14739m = "invokeSuspend", mo14740n = {}, mo14741s = {})
    /* renamed from: kotlinx.coroutines.flow.FlowKt__ZipKt$combineTransform$7$2 */
    /* compiled from: Zip.kt */
    public static final class C10472 extends SuspendLambda implements Function3<FlowCollector<? super R>, T[], Continuation<? super Unit>, Object> {
        private /* synthetic */ Object L$0;
        /* synthetic */ Object L$1;
        int label;

        public final Object invoke(FlowCollector<? super R> flowCollector, T[] tArr, Continuation<? super Unit> continuation) {
            C10472 r0 = new C10472(r3, continuation);
    ...
    public final Object invokeSuspend(Object obj) {
        ...
        if (i == 0) {
            ...
            }, new C10472((Continuation<? super C10472>) null), this) == coroutine_suspended) {
                return coroutine_suspended;
            }
        } else if (i == 1) {
            ResultKt.throwOnFailure(obj);
    ...
    public final Object invokeSuspend$$forInline(Object obj) {
        ...
        }, new C10472((Continuation<? super C10472>) null), this);
        InlineMarker.mark(1);
        return Unit.INSTANCE;
    }
}
