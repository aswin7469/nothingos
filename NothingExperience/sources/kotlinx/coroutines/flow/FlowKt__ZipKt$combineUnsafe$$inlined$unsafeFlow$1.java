...
public final class FlowKt__ZipKt$combineUnsafe$$inlined$unsafeFlow$1 implements Flow<R> {
    ...
    public Object collect$$forInline(FlowCollector flowCollector, Continuation continuation) {
        ...
        Intrinsics.needClassReification();
        InlineMarker.mark(0);
        CombineKt.combineInternal(flowCollector, flowArr, access$nullArrayFactory, new FlowKt__ZipKt$combineUnsafe$1$1(this.$transform$inlined, (Continuation<? super FlowKt__ZipKt$combineUnsafe$1$1>) null), continuation);
        InlineMarker.mark(1);
        return Unit.INSTANCE;
    }
}
