...
@Metadata(mo14006bv = {1, 0, 3}, mo14007d1 = {"\u0000'\n\u0000\n\u0002\u0010)\n\u0002\u0010\u000e\n\u0000\n\u0002\u0010\u000b\n\u0000\n\u0002\u0018\u0002\n\u0002\u0018\u0002\n\u0002\b\u0004\n\u0002\u0010\u0002\n\u0000*\u0001\u0000\b\n\u0018\u00002\b\u0012\u0004\u0012\u00020\u00020\u0001J\t\u0010\t\u001a\u00020\u0004H\u0002J\t\u0010\n\u001a\u00020\u0002H\u0002J\b\u0010\u000b\u001a\u00020\fH\u0016R\u000e\u0010\u0003\u001a\u00020\u0004X\u000e¢\u0006\u0002\n\u0000R\u0018\u0010\u0005\u001a\f\u0012\b\u0012\u00060\u0006R\u00020\u00070\u0001X\u0004¢\u0006\u0002\n\u0000R\u0010\u0010\b\u001a\u0004\u0018\u00010\u0002X\u000e¢\u0006\u0002\n\u0000¨\u0006\r"}, mo14008d2 = {"okhttp3/Cache$urls$1", "", "", "canRemove", "", "delegate", "Lokhttp3/internal/cache/DiskLruCache$Snapshot;", "Lokhttp3/internal/cache/DiskLruCache;", "nextUrl", "hasNext", "next", "remove", "", "okhttp"}, mo14009k = 1, mo14010mv = {1, 4, 0})
...
public final class Cache$urls$1 implements Iterator<String>, KMutableIterator {
    ...
    public boolean hasNext() {
        ...
        L_0x0009:
            ...
            r3 = 0
            r4 = r3
            java.lang.Throwable r4 = (java.lang.Throwable) r4     // Catch:{ IOException -> 0x0009 }
            r4 = r2
            okhttp3.internal.cache.DiskLruCache$Snapshot r4 = (okhttp3.internal.cache.DiskLruCache.Snapshot) r4     // Catch:{ all -> 0x0032 }
            okio.Source r4 = r4.getSource(r0)     // Catch:{ all -> 0x0032 }
            okio.BufferedSource r4 = okio.Okio.buffer((okio.Source) r4)     // Catch:{ all -> 0x0032 }
            java.lang.String r4 = r4.readUtf8LineStrict()     // Catch:{ all -> 0x0032 }
            r5.nextUrl = r4     // Catch:{ all -> 0x0032 }
            kotlin.p004io.CloseableKt.closeFinally(r2, r3)     // Catch:{ IOException -> 0x0009 }
            return r1
        L_0x0032:
            r3 = move-exception
