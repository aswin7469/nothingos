...
public final class Cache implements Closeable, Flushable {
    ...
    public final File m1607deprecated_directory() {
        return this.cache.getDirectory();
    }
    ...
    private static final class Entry {
        ...
        /* JADX WARNING: Code restructure failed: missing block: B:21:0x011d, code lost:
            kotlin.p004io.CloseableKt.closeFinally(r10, r0);
         */
        ...
        public final void writeTo(okhttp3.internal.cache.DiskLruCache.Editor r10) throws java.io.IOException {
            /*
                ...
                r2 = r10
                okio.BufferedSink r2 = (okio.BufferedSink) r2     // Catch:{ all -> 0x011a }
                java.lang.String r3 = r9.url     // Catch:{ all -> 0x011a }
                okio.BufferedSink r3 = r2.writeUtf8(r3)     // Catch:{ all -> 0x011a }
                r4 = 10
                r3.writeByte(r4)     // Catch:{ all -> 0x011a }
                java.lang.String r3 = r9.requestMethod     // Catch:{ all -> 0x011a }
                okio.BufferedSink r3 = r2.writeUtf8(r3)     // Catch:{ all -> 0x011a }
                r3.writeByte(r4)     // Catch:{ all -> 0x011a }
                okhttp3.Headers r3 = r9.varyHeaders     // Catch:{ all -> 0x011a }
                int r3 = r3.size()     // Catch:{ all -> 0x011a }
                long r5 = (long) r3     // Catch:{ all -> 0x011a }
                okio.BufferedSink r3 = r2.writeDecimalLong(r5)     // Catch:{ all -> 0x011a }
                r3.writeByte(r4)     // Catch:{ all -> 0x011a }
                okhttp3.Headers r3 = r9.varyHeaders     // Catch:{ all -> 0x011a }
                int r3 = r3.size()     // Catch:{ all -> 0x011a }
                r5 = r0
            L_0x0040:
                ...
                okhttp3.Headers r7 = r9.varyHeaders     // Catch:{ all -> 0x011a }
                java.lang.String r7 = r7.name(r5)     // Catch:{ all -> 0x011a }
                okio.BufferedSink r7 = r2.writeUtf8(r7)     // Catch:{ all -> 0x011a }
                okio.BufferedSink r6 = r7.writeUtf8(r6)     // Catch:{ all -> 0x011a }
                okhttp3.Headers r7 = r9.varyHeaders     // Catch:{ all -> 0x011a }
                java.lang.String r7 = r7.value(r5)     // Catch:{ all -> 0x011a }
                okio.BufferedSink r6 = r6.writeUtf8(r7)     // Catch:{ all -> 0x011a }
                r6.writeByte(r4)     // Catch:{ all -> 0x011a }
                int r5 = r5 + 1
                goto L_0x0040
            L_0x0062:
                okhttp3.internal.http.StatusLine r3 = new okhttp3.internal.http.StatusLine     // Catch:{ all -> 0x011a }
                okhttp3.Protocol r5 = r9.protocol     // Catch:{ all -> 0x011a }
                int r7 = r9.code     // Catch:{ all -> 0x011a }
                java.lang.String r8 = r9.message     // Catch:{ all -> 0x011a }
                r3.<init>(r5, r7, r8)     // Catch:{ all -> 0x011a }
                java.lang.String r3 = r3.toString()     // Catch:{ all -> 0x011a }
                okio.BufferedSink r3 = r2.writeUtf8(r3)     // Catch:{ all -> 0x011a }
                r3.writeByte(r4)     // Catch:{ all -> 0x011a }
                okhttp3.Headers r3 = r9.responseHeaders     // Catch:{ all -> 0x011a }
                int r3 = r3.size()     // Catch:{ all -> 0x011a }
                int r3 = r3 + 2
                long r7 = (long) r3     // Catch:{ all -> 0x011a }
                okio.BufferedSink r3 = r2.writeDecimalLong(r7)     // Catch:{ all -> 0x011a }
                r3.writeByte(r4)     // Catch:{ all -> 0x011a }
                okhttp3.Headers r3 = r9.responseHeaders     // Catch:{ all -> 0x011a }
                int r3 = r3.size()     // Catch:{ all -> 0x011a }
            L_0x008e:
                if (r0 >= r3) goto L_0x00ae
                okhttp3.Headers r5 = r9.responseHeaders     // Catch:{ all -> 0x011a }
                java.lang.String r5 = r5.name(r0)     // Catch:{ all -> 0x011a }
                okio.BufferedSink r5 = r2.writeUtf8(r5)     // Catch:{ all -> 0x011a }
                okio.BufferedSink r5 = r5.writeUtf8(r6)     // Catch:{ all -> 0x011a }
                okhttp3.Headers r7 = r9.responseHeaders     // Catch:{ all -> 0x011a }
                java.lang.String r7 = r7.value(r0)     // Catch:{ all -> 0x011a }
                okio.BufferedSink r5 = r5.writeUtf8(r7)     // Catch:{ all -> 0x011a }
                r5.writeByte(r4)     // Catch:{ all -> 0x011a }
                int r0 = r0 + 1
                goto L_0x008e
            L_0x00ae:
                java.lang.String r0 = SENT_MILLIS     // Catch:{ all -> 0x011a }
                okio.BufferedSink r0 = r2.writeUtf8(r0)     // Catch:{ all -> 0x011a }
                okio.BufferedSink r0 = r0.writeUtf8(r6)     // Catch:{ all -> 0x011a }
                long r7 = r9.sentRequestMillis     // Catch:{ all -> 0x011a }
                okio.BufferedSink r0 = r0.writeDecimalLong(r7)     // Catch:{ all -> 0x011a }
                r0.writeByte(r4)     // Catch:{ all -> 0x011a }
                java.lang.String r0 = RECEIVED_MILLIS     // Catch:{ all -> 0x011a }
                okio.BufferedSink r0 = r2.writeUtf8(r0)     // Catch:{ all -> 0x011a }
                okio.BufferedSink r0 = r0.writeUtf8(r6)     // Catch:{ all -> 0x011a }
                long r5 = r9.receivedResponseMillis     // Catch:{ all -> 0x011a }
                okio.BufferedSink r0 = r0.writeDecimalLong(r5)     // Catch:{ all -> 0x011a }
                r0.writeByte(r4)     // Catch:{ all -> 0x011a }
                boolean r0 = r9.isHttps()     // Catch:{ all -> 0x011a }
                if (r0 == 0) goto L_0x0114
                r2.writeByte(r4)     // Catch:{ all -> 0x011a }
                okhttp3.Handshake r0 = r9.handshake     // Catch:{ all -> 0x011a }
                kotlin.jvm.internal.Intrinsics.checkNotNull(r0)     // Catch:{ all -> 0x011a }
                okhttp3.CipherSuite r0 = r0.cipherSuite()     // Catch:{ all -> 0x011a }
                java.lang.String r0 = r0.javaName()     // Catch:{ all -> 0x011a }
                okio.BufferedSink r0 = r2.writeUtf8(r0)     // Catch:{ all -> 0x011a }
                r0.writeByte(r4)     // Catch:{ all -> 0x011a }
                okhttp3.Handshake r0 = r9.handshake     // Catch:{ all -> 0x011a }
                java.util.List r0 = r0.peerCertificates()     // Catch:{ all -> 0x011a }
                r9.writeCertList(r2, r0)     // Catch:{ all -> 0x011a }
                okhttp3.Handshake r0 = r9.handshake     // Catch:{ all -> 0x011a }
                java.util.List r0 = r0.localCertificates()     // Catch:{ all -> 0x011a }
                r9.writeCertList(r2, r0)     // Catch:{ all -> 0x011a }
                okhttp3.Handshake r0 = r9.handshake     // Catch:{ all -> 0x011a }
                okhttp3.TlsVersion r0 = r0.tlsVersion()     // Catch:{ all -> 0x011a }
                java.lang.String r0 = r0.javaName()     // Catch:{ all -> 0x011a }
                okio.BufferedSink r0 = r2.writeUtf8(r0)     // Catch:{ all -> 0x011a }
                r0.writeByte(r4)     // Catch:{ all -> 0x011a }
            L_0x0114:
                kotlin.Unit r0 = kotlin.Unit.INSTANCE     // Catch:{ all -> 0x011a }
                kotlin.p004io.CloseableKt.closeFinally(r10, r1)
                return
            L_0x011a:
                r0 = move-exception
        ...
        @Metadata(mo14006bv = {1, 0, 3}, mo14007d1 = {"\u0000\u0014\n\u0002\u0018\u0002\n\u0002\u0010\u0000\n\u0002\b\u0002\n\u0002\u0010\u000e\n\u0002\b\u0002\b\u0003\u0018\u00002\u00020\u0001B\u0007\b\u0002¢\u0006\u0002\u0010\u0002R\u000e\u0010\u0003\u001a\u00020\u0004X\u0004¢\u0006\u0002\n\u0000R\u000e\u0010\u0005\u001a\u00020\u0004X\u0004¢\u0006\u0002\n\u0000¨\u0006\u0006"}, mo14008d2 = {"Lokhttp3/Cache$Entry$Companion;", "", "()V", "RECEIVED_MILLIS", "", "SENT_MILLIS", "okhttp"}, mo14009k = 1, mo14010mv = {1, 4, 0})
        /* compiled from: Cache.kt */
    ...
    @Metadata(mo14006bv = {1, 0, 3}, mo14007d1 = {"\u00000\n\u0002\u0018\u0002\n\u0002\u0018\u0002\n\u0000\n\u0002\u0018\u0002\n\u0002\u0018\u0002\n\u0000\n\u0002\u0010\u000e\n\u0002\b\u0003\n\u0002\u0018\u0002\n\u0002\b\u0002\n\u0002\u0010\t\n\u0002\u0018\u0002\n\u0002\b\u0002\b\u0002\u0018\u00002\u00020\u0001B%\u0012\n\u0010\u0002\u001a\u00060\u0003R\u00020\u0004\u0012\b\u0010\u0005\u001a\u0004\u0018\u00010\u0006\u0012\b\u0010\u0007\u001a\u0004\u0018\u00010\u0006¢\u0006\u0002\u0010\bJ\b\u0010\u0007\u001a\u00020\rH\u0016J\n\u0010\u0005\u001a\u0004\u0018\u00010\u000eH\u0016J\b\u0010\u000f\u001a\u00020\nH\u0016R\u000e\u0010\t\u001a\u00020\nX\u0004¢\u0006\u0002\n\u0000R\u0010\u0010\u0007\u001a\u0004\u0018\u00010\u0006X\u0004¢\u0006\u0002\n\u0000R\u0010\u0010\u0005\u001a\u0004\u0018\u00010\u0006X\u0004¢\u0006\u0002\n\u0000R\u0015\u0010\u0002\u001a\u00060\u0003R\u00020\u0004¢\u0006\b\n\u0000\u001a\u0004\b\u000b\u0010\f¨\u0006\u0010"}, mo14008d2 = {"Lokhttp3/Cache$CacheResponseBody;", "Lokhttp3/ResponseBody;", "snapshot", "Lokhttp3/internal/cache/DiskLruCache$Snapshot;", "Lokhttp3/internal/cache/DiskLruCache;", "contentType", "", "contentLength", "(Lokhttp3/internal/cache/DiskLruCache$Snapshot;Ljava/lang/String;Ljava/lang/String;)V", "bodySource", "Lokio/BufferedSource;", "getSnapshot", "()Lokhttp3/internal/cache/DiskLruCache$Snapshot;", "", "Lokhttp3/MediaType;", "source", "okhttp"}, mo14009k = 1, mo14010mv = {1, 4, 0})
    /* compiled from: Cache.kt */
