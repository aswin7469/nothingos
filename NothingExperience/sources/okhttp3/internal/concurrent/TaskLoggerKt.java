...
public final class TaskLoggerKt {
    ...
    public static final String formatDuration(long j) {
        ...
        if (j <= ((long) -999500000)) {
            ...
            str = ((j - ((long) App.VERSION_HAS_BUILD_INFO)) / ((long) 1000)) + " µs";
        } else if (j < ((long) 999500)) {
            str = ((j + ((long) App.VERSION_HAS_BUILD_INFO)) / ((long) 1000)) + " µs";
