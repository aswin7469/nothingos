...
public final class RealConnectionPool {
    ...
    /* JADX WARNING: Code restructure failed: missing block: B:45:0x0092, code lost:
        if (r10.connections.isEmpty() == false) goto L_0x0099;
     */
    ...
    public final long cleanup(long r11) {
        ...
        L_0x000f:
            ...
            monitor-enter(r6)
            int r7 = r10.pruneAndGetAllocationCount(r6, r11)     // Catch:{ all -> 0x0043 }
            if (r7 <= 0) goto L_0x002e
            int r7 = r3 + 1
            java.lang.Integer.valueOf(r3)     // Catch:{ all -> 0x0043 }
            r3 = r7
            goto L_0x0041
        L_0x002e:
            int r2 = r2 + 1
            long r7 = r6.getIdleAtNs$okhttp()     // Catch:{ all -> 0x0043 }
            long r7 = r11 - r7
        ...
        L_0x005b:
            ...
            monitor-enter(r0)
            java.util.List r1 = r0.getCalls()     // Catch:{ all -> 0x009a }
            java.util.Collection r1 = (java.util.Collection) r1     // Catch:{ all -> 0x009a }
            ...
            return r6
        L_0x0071:
            long r8 = r0.getIdleAtNs$okhttp()     // Catch:{ all -> 0x009a }
            long r8 = r8 + r4
            ...
            return r6
        L_0x007c:
            r0.setNoNewExchanges(r2)     // Catch:{ all -> 0x009a }
            java.util.concurrent.ConcurrentLinkedQueue<okhttp3.internal.connection.RealConnection> r11 = r10.connections     // Catch:{ all -> 0x009a }
            r11.remove(r0)     // Catch:{ all -> 0x009a }
            monitor-exit(r0)
    ...
    @Metadata(mo14006bv = {1, 0, 3}, mo14007d1 = {"\u0000\u0018\n\u0002\u0018\u0002\n\u0002\u0010\u0000\n\u0002\b\u0002\n\u0002\u0018\u0002\n\u0000\n\u0002\u0018\u0002\n\u0000\b\u0003\u0018\u00002\u00020\u0001B\u0007\b\u0002¢\u0006\u0002\u0010\u0002J\u000e\u0010\u0003\u001a\u00020\u00042\u0006\u0010\u0005\u001a\u00020\u0006¨\u0006\u0007"}, mo14008d2 = {"Lokhttp3/internal/connection/RealConnectionPool$Companion;", "", "()V", "get", "Lokhttp3/internal/connection/RealConnectionPool;", "connectionPool", "Lokhttp3/ConnectionPool;", "okhttp"}, mo14009k = 1, mo14010mv = {1, 4, 0})
    /* compiled from: RealConnectionPool.kt */
