...
public final class RetryAndFollowUpInterceptor implements Interceptor {
        ...
        while (true) {
            ...
            try {
                if (!call$okhttp.isCanceled()) {
                    ...
                    if (response2 != null) {
                        proceed = proceed.newBuilder().priorResponse(response2.newBuilder().body((ResponseBody) null).build()).build();
                    }
                    response2 = proceed;
                    Exchange interceptorScopedExchange$okhttp = call$okhttp.getInterceptorScopedExchange$okhttp();
                    Request followUpRequest = followUpRequest(response2, interceptorScopedExchange$okhttp);
    ...
    @Metadata(mo14006bv = {1, 0, 3}, mo14007d1 = {"\u0000\u0012\n\u0002\u0018\u0002\n\u0002\u0010\u0000\n\u0002\b\u0002\n\u0002\u0010\b\n\u0000\b\u0003\u0018\u00002\u00020\u0001B\u0007\b\u0002¢\u0006\u0002\u0010\u0002R\u000e\u0010\u0003\u001a\u00020\u0004XT¢\u0006\u0002\n\u0000¨\u0006\u0005"}, mo14008d2 = {"Lokhttp3/internal/http/RetryAndFollowUpInterceptor$Companion;", "", "()V", "MAX_FOLLOW_UPS", "", "okhttp"}, mo14009k = 1, mo14010mv = {1, 4, 0})
    /* compiled from: RetryAndFollowUpInterceptor.kt */
