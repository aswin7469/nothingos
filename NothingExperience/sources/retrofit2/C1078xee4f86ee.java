...
final class C1078xee4f86ee implements Runnable {
    ...
    public final void run() {
        ...
        intercepted.resumeWith(Result.m95constructorimpl(ResultKt.createFailure(this.$this_suspendAndThrow$inlined)));
    }
}
