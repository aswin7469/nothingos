        ...
        public void enqueue(final Callback<T> callback) {
            ...
            this.delegate.enqueue(new Callback<T>() {
                public void onResponse(Call<T> call, Response<T> response) {
                    ExecutorCallbackCall.this.callbackExecutor.execute(new C1074xee4a199d(this, callback, response));
                }

                /* renamed from: lambda$onResponse$0$retrofit2-DefaultCallAdapterFactory$ExecutorCallbackCall$1 */
                public /* synthetic */ void mo18193xddacc936(Callback callback, Response response) {
                ...
                public /* synthetic */ void mo18192x714e864(Callback callback, Throwable th) {
                    callback.onFailure(ExecutorCallbackCall.this, th);
                }

                public void onFailure(Call<T> call, Throwable th) {
                    ExecutorCallbackCall.this.callbackExecutor.execute(new C1073xee4a199c(this, callback, th));
                }
            });
        }
