...
abstract class ParameterHandler<T> {
    ...
    static final class RelativeUrl extends ParameterHandler<Object> {
        ...
        public void apply(RequestBuilder requestBuilder, @Nullable Object obj) {
            ...
            throw Utils.parameterError(this.method, this.f196p, "@Url parameter is null.", new Object[0]);
        }
    }
            ...
            if (map != null) {
                for (Map.Entry next : map.entrySet()) {
                    ...
                    if (str != null) {
                        ...
                        throw Utils.parameterError(this.method, this.f195p, "Query map contained null key.", new Object[0]);
                    }
                }
                return;
            }
            throw Utils.parameterError(this.method, this.f195p, "Query map was null", new Object[0]);
        }
    }
            ...
            if (map != null) {
                for (Map.Entry next : map.entrySet()) {
                    ...
                    if (str != null) {
                        ...
                        throw Utils.parameterError(this.method, this.f190p, "Header map contained null key.", new Object[0]);
                    }
                }
                return;
            }
            throw Utils.parameterError(this.method, this.f190p, "Header map was null.", new Object[0]);
        }
    }
    ...
    static final class Headers extends ParameterHandler<okhttp3.Headers> {
        ...
        public void apply(RequestBuilder requestBuilder, @Nullable okhttp3.Headers headers) {
            ...
            throw Utils.parameterError(this.method, this.f191p, "Headers parameter must not be null.", new Object[0]);
        }
    }
            ...
            if (map != null) {
                for (Map.Entry next : map.entrySet()) {
                    ...
                    if (str != null) {
                        ...
                        throw Utils.parameterError(this.method, this.f189p, "Field map contained null key.", new Object[0]);
                    }
                }
                return;
            }
            throw Utils.parameterError(this.method, this.f189p, "Field map was null.", new Object[0]);
        }
    }
            ...
            if (map != null) {
                for (Map.Entry next : map.entrySet()) {
                    ...
                    if (str != null) {
                        Object value = next.getValue();
                        if (value != null) {
                            requestBuilder.addPart(okhttp3.Headers.m69of("Content-Disposition", "form-data; name=\"" + str + "\"", "Content-Transfer-Encoding", this.transferEncoding), this.valueConverter.convert(value));
                        } else {
                            Method method2 = this.method;
                            int i = this.f193p;
                        ...
                        throw Utils.parameterError(this.method, this.f193p, "Part map contained null key.", new Object[0]);
                    }
                }
                return;
            }
            throw Utils.parameterError(this.method, this.f193p, "Part map was null.", new Object[0]);
        }
    }
    ...
    static final class Body<T> extends ParameterHandler<T> {
        ...
        public void apply(RequestBuilder requestBuilder, @Nullable T t) {
            if (t != null) {
                ...
                throw Utils.parameterError(this.method, this.f188p, "Body parameter value must not be null.", new Object[0]);
            }
        }
    }
