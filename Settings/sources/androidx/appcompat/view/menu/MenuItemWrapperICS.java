...
public class MenuItemWrapperICS extends BaseMenuWrapper implements MenuItem {
    ...
    public MenuItem setShowAsActionFlags(int i) {
        this.mWrappedObject.mo42setShowAsActionFlags(i);
        return this;
    }
    ...
    public MenuItem setActionView(View view) {
        ...
        this.mWrappedObject.mo40setActionView(view);
        return this;
    }

    @Override // android.view.MenuItem
    public MenuItem setActionView(int i) {
        this.mWrappedObject.mo39setActionView(i);
        View actionView = this.mWrappedObject.getActionView();
        if (actionView instanceof CollapsibleActionView) {
            this.mWrappedObject.mo40setActionView(new CollapsibleActionViewWrapper(actionView));
        }
        return this;
    }
    ...
    public MenuItem setContentDescription(CharSequence charSequence) {
        this.mWrappedObject.mo41setContentDescription(charSequence);
        return this;
    }
    ...
    public MenuItem setTooltipText(CharSequence charSequence) {
        this.mWrappedObject.mo43setTooltipText(charSequence);
        return this;
    }
