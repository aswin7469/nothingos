...
public class ArrayLinkedVariables {
    ...
    public final void put(SolverVariable solverVariable, float f) {
        ...
        this.mArrayIndices[i7] = solverVariable.f16id;
    ...
    public SolverVariable getPivotCandidate(boolean[] zArr, SolverVariable solverVariable) {
        ...
        while (i != -1 && i2 < this.currentSize) {
            ...
            if (f2 < 0.0f) {
                ...
                if ((zArr == null || !zArr[solverVariable3.f16id]) && solverVariable3 != solverVariable && (((type = solverVariable3.mType) == SolverVariable.Type.SLACK || type == SolverVariable.Type.ERROR) && f2 < f)) {
                    f = f2;
