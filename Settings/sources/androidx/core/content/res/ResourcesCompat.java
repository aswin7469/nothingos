...
public final class ResourcesCompat {
    ...
    private static android.graphics.Typeface loadFont(android.content.Context r17, android.content.res.Resources r18, android.util.TypedValue r19, int r20, int r21, androidx.core.content.res.ResourcesCompat.FontCallback r22, android.os.Handler r23, boolean r24, boolean r25) {
        ...
        L_0x0036:
            ...
            return r16
        L_0x0039:
            java.lang.String r2 = r14.toLowerCase()     // Catch:{ XmlPullParserException -> 0x00a1, IOException -> 0x008b }
            java.lang.String r3 = ".xml"
            boolean r2 = r2.endsWith(r3)     // Catch:{ XmlPullParserException -> 0x00a1, IOException -> 0x008b }
            if (r2 == 0) goto L_0x0070
            android.content.res.XmlResourceParser r2 = r0.getXml(r4)     // Catch:{ XmlPullParserException -> 0x00a1, IOException -> 0x008b }
            androidx.core.content.res.FontResourcesParserCompat$FamilyResourceEntry r2 = androidx.core.content.res.FontResourcesParserCompat.parse(r2, r0)     // Catch:{ XmlPullParserException -> 0x00a1, IOException -> 0x008b }
            if (r2 != 0) goto L_0x005a
            java.lang.String r0 = "Failed to find font-family tag"
            android.util.Log.e(r13, r0)     // Catch:{ XmlPullParserException -> 0x00a1, IOException -> 0x008b }
            if (r11 == 0) goto L_0x0059
            r11.callbackFailAsync(r15, r12)     // Catch:{ XmlPullParserException -> 0x00a1, IOException -> 0x008b }
        L_0x0059:
            return r16
        L_0x005a:
            int r6 = r1.assetCookie     // Catch:{ XmlPullParserException -> 0x00a1, IOException -> 0x008b }
            r1 = r17
            r3 = r18
            r4 = r20
            r5 = r14
            ...
            r9 = r23
            r10 = r24
            android.graphics.Typeface r0 = androidx.core.graphics.TypefaceCompat.createFromResourcesFamilyXml(r1, r2, r3, r4, r5, r6, r7, r8, r9, r10)     // Catch:{ XmlPullParserException -> 0x00a1, IOException -> 0x008b }
            return r0
        L_0x0070:
            int r5 = r1.assetCookie     // Catch:{ XmlPullParserException -> 0x00a1, IOException -> 0x008b }
            r1 = r17
            r2 = r18
            r3 = r20
            r4 = r14
            r6 = r21
            android.graphics.Typeface r0 = androidx.core.graphics.TypefaceCompat.createFromResourcesFontFile(r1, r2, r3, r4, r5, r6)     // Catch:{ XmlPullParserException -> 0x00a1, IOException -> 0x008b }
            if (r11 == 0) goto L_0x008a
            if (r0 == 0) goto L_0x0087
            r11.callbackSuccessAsync(r0, r12)     // Catch:{ XmlPullParserException -> 0x00a1, IOException -> 0x008b }
            goto L_0x008a
        L_0x0087:
            r11.callbackFailAsync(r15, r12)     // Catch:{ XmlPullParserException -> 0x00a1, IOException -> 0x008b }
        L_0x008a:
