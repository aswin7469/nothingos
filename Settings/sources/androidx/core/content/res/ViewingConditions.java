...
final class ViewingConditions {
    ...
    /* renamed from: mC */
    private final float f33mC;
    private final float mFl;
    private final float mFlRoot;

    /* renamed from: mN */
    private final float f34mN;
    ...
    static ViewingConditions make(float[] fArr, float f, float f2, float f3, boolean z) {
        ...
        float f18 = fArr7[1];
        return new ViewingConditions(yFromLStar, ((f17 * 2.0f) + ((f18 * 400.0f) / (f18 + 27.13f)) + (((400.0f * pow2) / (pow2 + 27.13f)) * 0.05f)) * pow, pow, pow, lerp, f12, fArr6, cbrt, (float) Math.pow((double) cbrt, 0.25d), sqrt);
    }
}
