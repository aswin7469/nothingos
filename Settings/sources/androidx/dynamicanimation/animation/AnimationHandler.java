...
public class AnimationHandler {
    ...
    static final class FrameCallbackScheduler16 implements FrameCallbackScheduler {
        ...
        public void postFrameCallback(Runnable runnable) {
            this.mChoreographer.postFrameCallback(new C0145xde8d857b(runnable));
        }
    ...
    static class FrameCallbackScheduler14 implements FrameCallbackScheduler {
        ...
        public void postFrameCallback(Runnable runnable) {
            this.mHandler.postDelayed(new C0144x6beb63f9(this, runnable), Math.max(10 - (SystemClock.uptimeMillis() - this.mLastFrameTime), 0));
        }
    ...
    public class DurationScaleChangeListener33 implements DurationScaleChangeListener {
        ...
        public boolean register() {
            ...
            C0143xf577eeeb animationHandler$DurationScaleChangeListener33$$ExternalSyntheticLambda0 = new C0143xf577eeeb(this);
