...
public abstract class LiveData<T> {
    ...
    public void observe(LifecycleOwner lifecycleOwner, Observer<? super T> observer) {
        ...
        if (lifecycleOwner.mo959getLifecycle().getCurrentState() == Lifecycle.State.DESTROYED) {
            return;
        }
        ...
        lifecycleOwner.mo959getLifecycle().addObserver(lifecycleBoundObserver);
    }
    ...
    class LifecycleBoundObserver extends LiveData<T>.ObserverWrapper implements LifecycleEventObserver {
        ...
        boolean shouldBeActive() {
            return this.mOwner.mo959getLifecycle().getCurrentState().isAtLeast(Lifecycle.State.STARTED);
        }

        @Override // androidx.lifecycle.LifecycleEventObserver
        public void onStateChanged(LifecycleOwner lifecycleOwner, Lifecycle.Event event) {
            Lifecycle.State currentState = this.mOwner.mo959getLifecycle().getCurrentState();
            ...
            while (state != currentState) {
                ...
                state = currentState;
                currentState = this.mOwner.mo959getLifecycle().getCurrentState();
            }
        }
        ...
        @Override // androidx.lifecycle.LiveData.ObserverWrapper
        void detachObserver() {
            this.mOwner.mo959getLifecycle().removeObserver(this);
        }
    }
