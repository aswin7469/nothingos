...
public class LinearLayoutManager extends RecyclerView.LayoutManager implements ItemTouchHelper.ViewDropHandler, RecyclerView.SmoothScroller.ScrollVectorProvider {
    ...
    private void updateLayoutState(int layoutDirection, int requiredSpace, boolean canUseExistingSpace, RecyclerView.State state) {
        ...
        LayoutState layoutState = this.mLayoutState;
        int i2 = z ? max2 : max;
        layoutState.mExtraFillSpace = i2;
        if (!z) {
            max = max2;
        }
        layoutState.mNoRecycleSpace = max;
        if (z) {
            layoutState.mExtraFillSpace = i2 + this.mOrientationHelper.getEndPadding();
            View childClosestToEnd = getChildClosestToEnd();
            LayoutState layoutState2 = this.mLayoutState;
            if (this.mShouldReverseLayout) {
                i = -1;
    ...
    public static class SavedState implements Parcelable {
        public static final Parcelable.Creator<SavedState> CREATOR = new Parcelable.Creator<SavedState>() { // from class: androidx.recyclerview.widget.LinearLayoutManager.SavedState.1
            ...
            public SavedState mo128createFromParcel(Parcel in) {
            ...
            public SavedState[] mo129newArray(int size) {
