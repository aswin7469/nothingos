...
public class SwipeRefreshLayout extends ViewGroup implements NestedScrollingParent3, NestedScrollingParent2, NestedScrollingChild {
    ...
    /* renamed from: reset */
    public void lambda$onStopNestedScroll$0() {
    ...
    public SwipeRefreshLayout(Context context, AttributeSet attributeSet) {
        ...
        this.mRefreshListener = new Animation.AnimationListener() {
            ...
            public void onAnimationEnd(Animation animation) {
                ...
                swipeRefreshLayout.lambda$onStopNestedScroll$0();
            }
        };
    ...
    public void onStopNestedScroll(View view) {
        ...
        if (f > 0.0f) {
            ...
            post(new SwipeRefreshLayout$$ExternalSyntheticLambda0(this));
        }
        stopNestedScroll();
    }
