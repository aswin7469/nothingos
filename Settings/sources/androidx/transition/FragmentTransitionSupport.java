...
public class FragmentTransitionSupport extends FragmentTransitionImpl {
    ...
    public Object cloneTransition(Object obj) {
        if (obj != null) {
            return ((Transition) obj).m145clone();
        }
        return null;
    }
    ...
    public void addTargets(Object obj, ArrayList<View> arrayList) {
        ...
        if (transition instanceof TransitionSet) {
            ...
            int size = arrayList.size();
            while (i < size) {
                transition.mo147addTarget(arrayList.get(i));
                i++;
            }
        }
    }
    ...
    public void scheduleHideFragmentView(Object obj, final View view, final ArrayList<View> arrayList) {
        ((Transition) obj).mo146addListener(new Transition.TransitionListener() { // from class: androidx.transition.FragmentTransitionSupport.2
            ...
            public void onTransitionStart(Transition transition) {
                ...
                transition.mo146addListener(this);
            }
    ...
    public void scheduleRemoveTargets(Object obj, final Object obj2, final ArrayList<View> arrayList, final Object obj3, final ArrayList<View> arrayList2, final Object obj4, final ArrayList<View> arrayList3) {
        ((Transition) obj).mo146addListener(new TransitionListenerAdapter() { // from class: androidx.transition.FragmentTransitionSupport.3
    ...
    public void setListenerForTransitionEnd(Fragment fragment, Object obj, CancellationSignal cancellationSignal, final Runnable runnable) {
        ...
        transition.mo146addListener(new Transition.TransitionListener() { // from class: androidx.transition.FragmentTransitionSupport.5
            @Override // androidx.transition.Transition.TransitionListener
    ...
    public void replaceTargets(Object obj, ArrayList<View> arrayList, ArrayList<View> arrayList2) {
        ...
        if (transition instanceof TransitionSet) {
            ...
            while (i < size) {
                transition.mo147addTarget(arrayList2.get(i));
                i++;
            }
            for (int size2 = arrayList.size() - 1; size2 >= 0; size2--) {
                transition.mo150removeTarget(arrayList.get(size2));
            }
        }
    }
    ...
    public void addTarget(Object obj, View view) {
        if (obj != null) {
            ((Transition) obj).mo147addTarget(view);
        }
    }
    ...
    public void removeTarget(Object obj, View view) {
        if (obj != null) {
            ((Transition) obj).mo150removeTarget(view);
        }
    }
