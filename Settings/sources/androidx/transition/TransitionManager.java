...
public class TransitionManager {
    ...
    public static class MultiListener implements ViewTreeObserver.OnPreDrawListener, View.OnAttachStateChangeListener {
        ...
        public boolean onPreDraw() {
            ...
            this.mTransition.mo146addListener(new TransitionListenerAdapter() { // from class: androidx.transition.TransitionManager.MultiListener.1
    ...
    public static void beginDelayedTransition(ViewGroup viewGroup, Transition transition) {
        ...
        Transition m145clone = transition.m145clone();
        sceneChangeSetup(viewGroup, m145clone);
        Scene.setCurrentScene(viewGroup, null);
        sceneChangeRunTransition(viewGroup, m145clone);
    }
}
