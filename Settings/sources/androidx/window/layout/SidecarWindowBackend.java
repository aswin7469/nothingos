...
public final class SidecarWindowBackend implements WindowBackend {
    ...
    public static final class WindowLayoutChangeCallbackWrapper {
        ...
        public final void accept(@NotNull WindowLayoutInfo windowLayoutInfo) {
            ...
            this.lastInfo = windowLayoutInfo;
            this.executor.execute(new C0459x1c94d4b6(this, windowLayoutInfo));
        }

        /* access modifiers changed from: private */
        /* renamed from: accept$lambda-0  reason: not valid java name */
        public static final void m52accept$lambda0(WindowLayoutChangeCallbackWrapper windowLayoutChangeCallbackWrapper, WindowLayoutInfo windowLayoutInfo) {
