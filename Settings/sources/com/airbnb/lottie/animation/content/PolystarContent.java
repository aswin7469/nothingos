...
public class PolystarContent implements PathContent, BaseKeyframeAnimation.AnimationListener, KeyPathElementContent {
    ...
    public PolystarContent(LottieDrawable lottieDrawable, BaseLayer baseLayer, PolystarShape polystarShape) {
        ...
        BaseKeyframeAnimation<Float, Float> mo180createAnimation = polystarShape.getPoints().mo180createAnimation();
        this.pointsAnimation = mo180createAnimation;
        BaseKeyframeAnimation<PointF, PointF> mo180createAnimation2 = polystarShape.getPosition().mo180createAnimation();
        this.positionAnimation = mo180createAnimation2;
        BaseKeyframeAnimation<Float, Float> mo180createAnimation3 = polystarShape.getRotation().mo180createAnimation();
        this.rotationAnimation = mo180createAnimation3;
        BaseKeyframeAnimation<Float, Float> mo180createAnimation4 = polystarShape.getOuterRadius().mo180createAnimation();
        this.outerRadiusAnimation = mo180createAnimation4;
        BaseKeyframeAnimation<Float, Float> mo180createAnimation5 = polystarShape.getOuterRoundedness().mo180createAnimation();
        this.outerRoundednessAnimation = mo180createAnimation5;
        PolystarShape.Type type2 = PolystarShape.Type.STAR;
        if (type == type2) {
            this.innerRadiusAnimation = polystarShape.getInnerRadius().mo180createAnimation();
            this.innerRoundednessAnimation = polystarShape.getInnerRoundedness().mo180createAnimation();
        } else {
        ...
        baseLayer.addAnimation(mo180createAnimation4);
        baseLayer.addAnimation(mo180createAnimation5);
        if (type == type2) {
    ...
    private void createStarPath() {
        ...
        float f8;
        float f9;
        float floatValue = this.pointsAnimation.mo177getValue().floatValue();
        double radians = Math.toRadians((this.rotationAnimation == null ? 0.0d : baseKeyframeAnimation.mo177getValue().floatValue()) - 90.0d);
        ...
        float floatValue2 = this.outerRadiusAnimation.mo177getValue().floatValue();
        float floatValue3 = this.innerRadiusAnimation.mo177getValue().floatValue();
        BaseKeyframeAnimation<?, Float> baseKeyframeAnimation2 = this.innerRoundednessAnimation;
        float floatValue4 = baseKeyframeAnimation2 != null ? baseKeyframeAnimation2.mo177getValue().floatValue() / 100.0f : 0.0f;
        BaseKeyframeAnimation<?, Float> baseKeyframeAnimation3 = this.outerRoundednessAnimation;
        float floatValue5 = baseKeyframeAnimation3 != null ? baseKeyframeAnimation3.mo177getValue().floatValue() / 100.0f : 0.0f;
        if (i2 != 0) {
        ...
        while (true) {
            ...
            if (d7 < ceil) {
                ...
                PointF mo177getValue = this.positionAnimation.mo177getValue();
                this.path.offset(mo177getValue.x, mo177getValue.y);
                this.path.close();
                return;
            }
        }
    ...
    private void createPolygonPath() {
        ...
        double d3;
        int i;
        int floor = (int) Math.floor(this.pointsAnimation.mo177getValue().floatValue());
        double radians = Math.toRadians((this.rotationAnimation == null ? 0.0d : baseKeyframeAnimation.mo177getValue().floatValue()) - 90.0d);
        double d4 = floor;
        float floatValue = this.outerRoundednessAnimation.mo177getValue().floatValue() / 100.0f;
        float floatValue2 = this.outerRadiusAnimation.mo177getValue().floatValue();
