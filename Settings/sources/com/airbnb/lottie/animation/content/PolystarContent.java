...
public class PolystarContent implements PathContent, BaseKeyframeAnimation.AnimationListener, KeyPathElementContent {
    ...
    public Path getPath() {
        ...
        int i = C04961.$SwitchMap$com$airbnb$lottie$model$content$PolystarShape$Type[this.type.ordinal()];
        if (i == 1) {
            createStarPath();
        } else if (i == 2) {
            createPolygonPath();
    ...
    static /* synthetic */ class C04961 {
        ...
        static {
            ...
            L_0x001d:
                return
            */
            throw new UnsupportedOperationException("Method not decompiled: com.airbnb.lottie.animation.content.PolystarContent.C04961.<clinit>():void");
        }
    }
        ...
        while (true) {
            ...
            if (d7 < ceil) {
                ...
                if (floatValue4 == 0.0f && floatValue5 == 0.0f) {
                    ...
                    this.path.cubicTo(f3 - f19, f2 - f20, cos2 + f22, sin2 + f23, cos2, sin2);
                }
                d2 += (double) f5;
                z = !z;
                i3++;
