...
public class RepeaterContent implements DrawingContent, PathContent, GreedyContent, BaseKeyframeAnimation.AnimationListener, KeyPathElementContent {
    ...
    public RepeaterContent(LottieDrawable lottieDrawable, BaseLayer baseLayer, Repeater repeater) {
        ...
        BaseKeyframeAnimation<Float, Float> mo180createAnimation = repeater.getCopies().mo180createAnimation();
        this.copies = mo180createAnimation;
        baseLayer.addAnimation(mo180createAnimation);
        mo180createAnimation.addUpdateListener(this);
        BaseKeyframeAnimation<Float, Float> mo180createAnimation2 = repeater.getOffset().mo180createAnimation();
        this.offset = mo180createAnimation2;
    ...
    public Path getPath() {
        ...
        this.path.reset();
        float floatValue = this.copies.mo177getValue().floatValue();
        float floatValue2 = this.offset.mo177getValue().floatValue();
    ...
    public void draw(Canvas canvas, Matrix matrix, int i) {
        float floatValue = this.copies.mo177getValue().floatValue();
        float floatValue2 = this.offset.mo177getValue().floatValue();
        float floatValue3 = this.transform.getStartOpacity().mo177getValue().floatValue() / 100.0f;
        float floatValue4 = this.transform.getEndOpacity().mo177getValue().floatValue() / 100.0f;
