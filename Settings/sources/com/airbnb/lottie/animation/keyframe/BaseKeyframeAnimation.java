...
public abstract class BaseKeyframeAnimation<K, A> {
    ...
    abstract A mo179getValue(Keyframe<K> keyframe, float f);
    ...
    public A mo177getValue() {
        ...
        A mo179getValue = mo179getValue(getCurrentKeyframe(), interpolatedCurrentKeyframeProgress);
        this.cachedGetValue = mo179getValue;
        return mo179getValue;
    }
