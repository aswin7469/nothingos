...
public class CompositionLayer extends BaseLayer {
    ...
    public CompositionLayer(LottieDrawable lottieDrawable, Layer layer, List<Layer> list, LottieComposition lottieComposition) {
        ...
        if (timeRemapping != null) {
            BaseKeyframeAnimation<Float, Float> mo180createAnimation = timeRemapping.mo180createAnimation();
            this.timeRemapping = mo180createAnimation;
    ...
    public void setProgress(float f) {
        ...
        if (this.timeRemapping != null) {
            f = ((this.timeRemapping.mo177getValue().floatValue() * this.layerModel.getComposition().getFrameRate()) - this.layerModel.getComposition().getStartFrame()) / (this.lottieDrawable.getComposition().getDurationFrames() + 0.01f);
        }
