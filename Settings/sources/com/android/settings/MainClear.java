...
public class MainClear extends InstrumentedFragment implements ViewTreeObserver.OnGlobalLayoutListener {
    ...
    */
    private void loadAccountList(UserManager userManager) {
        ...
        AccountManager accountManager3 = AccountManager.get(activity);
        LayoutInflater layoutInflater = (LayoutInflater) activity.getSystemService("layout_inflater");
        int i3 = 0;
        int i4 = 0;
        while (i4 < size) {
            UserInfo userInfo = (UserInfo) profiles.get(i4);
            int i5 = userInfo.id;
            UserHandle userHandle = new UserHandle(i5);
            Account[] accountsAsUser = accountManager3.getAccountsAsUser(i5);
            ...
            if (length == 0) {
                ...
                int i6 = i3 + length;
                AuthenticatorDescription[] authenticatorTypesAsUser = AccountManager.get(activity).getAuthenticatorTypesAsUser(i5);
                ...
                int i7 = 0;
                while (i7 < length) {
                    Account account = accountsAsUser[i7];
                    int i8 = 0;
                    while (true) {
                        drawable = null;
                        i = length2;
                        ...
                        accountManager2 = accountManager3;
                        if (account.type.equals(authenticatorTypesAsUser[i8].type)) {
                            authenticatorDescription = authenticatorTypesAsUser[i8];
                            break;
                        }
                        i8++;
                        length2 = i;
                    ...
                    if (authenticatorDescription == null) {
                        Log.w("MainClear", "No descriptor for account name=" + account.name + " type=" + account.type);
                            ...
                            if (authenticatorDescription.iconId != 0) {
                                ...
                                try {
                                    ...
                                    try {
                                        ...
                                        Log.w("MainClear", "Bad package name for account type " + authenticatorDescription.type);
                                        if (drawable == null) {
                                        }
                                        ...
                                        e = e;
                                        Log.w("MainClear", "Invalid icon id for account type " + authenticatorDescription.type, e);
                                        if (drawable == null) {
                                        }
                                        View inflate2 = layoutInflater.inflate(R.layout.main_clear_account, (ViewGroup) linearLayout, false);
                                    ...
                                    View inflate22 = layoutInflater.inflate(R.layout.main_clear_account, (ViewGroup) linearLayout, false);
                                    ...
                                    View inflate222 = layoutInflater.inflate(R.layout.main_clear_account, (ViewGroup) linearLayout, false);
                                    ((ImageView) inflate222.findViewById(16908294)).setImageDrawable(drawable);
                                    ((TextView) inflate222.findViewById(16908310)).setText(account.name);
                                    linearLayout.addView(inflate222);
                                    i7++;
                                    length2 = i;
                                    accountManager3 = accountManager2;
                                    accountsAsUser = accountArr;
                        ...
                        View inflate2222 = layoutInflater.inflate(R.layout.main_clear_account, (ViewGroup) linearLayout, false);
                        ((ImageView) inflate2222.findViewById(16908294)).setImageDrawable(drawable);
                        ((TextView) inflate2222.findViewById(16908310)).setText(account.name);
                        linearLayout.addView(inflate2222);
                    }
                    i7++;
                    length2 = i;
                    accountManager3 = accountManager2;
            ...
            if (checkIfRestrictionEnforced != null) {
                new ActionDisabledByAdminDialogHelper(getActivity()).prepareDialogBuilder("no_factory_reset", checkIfRestrictionEnforced).setOnDismissListener(new DialogInterface.OnDismissListener() { // from class: com.android.settings.MainClear$$ExternalSyntheticLambda0
                    ...
                    public final void onDismiss(DialogInterface dialogInterface) {
                        MainClear.this.lambda$onCreateView$0(dialogInterface);
                    }
                }).show();
