...
public class SettingsInitialize extends BroadcastReceiver {
    ...
    public void onReceive(final Context context, Intent intent) {
        ...
        ThreadUtils.postOnBackgroundThread(new Runnable() { // from class: com.android.settings.SettingsInitialize$$ExternalSyntheticLambda0
            @Override // java.lang.Runnable
            public final void run() {
                SettingsInitialize.this.lambda$onReceive$0(context);
            }
        });
    }
    ...
    /* renamed from: refreshExistingShortcuts */
