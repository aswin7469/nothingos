...
public abstract class AccessibilityShortcutPreferenceFragment extends DashboardFragment implements ShortcutPreference.OnClickCallback {
    ...
    public void onCreate(Bundle bundle) {
        ...
        accessibilitySettingsContentObserver.registerKeysToObserverCallback(arrayList, new C0584x835f330e(this));
    }
    ...
    public View onCreateView(LayoutInflater layoutInflater, ViewGroup viewGroup, Bundle bundle) {
        ...
        this.mTouchExplorationStateChangeListener = new C0587x835f3311(this);
    ...
    public void onViewCreated(View view, Bundle bundle) {
        ...
        if (this.mNeedsQSTooltipReshow) {
            getView().post(new C0588x835f3312(this));
        }
    }
    ...
    public Dialog onCreateDialog(int i) {
        if (i == 1) {
            ...
            AlertDialog showEditShortcutDialog = AccessibilityDialogUtils.showEditShortcutDialog(getPrefContext(), isAnySetupWizard ? 1 : 0, getShortcutTitle(), new C0585x835f330f(this));
            setupEditShortcutDialog(showEditShortcutDialog);
            return showEditShortcutDialog;
        } else if (i == 1008) {
            AlertDialog createAccessibilityTutorialDialog = AccessibilityGestureNavigationTutorial.createAccessibilityTutorialDialog(getPrefContext(), getUserShortcutTypes(), new C0586x835f3310(this));
    ...
    private void setDialogTextAreaClickListener(View view, CheckBox checkBox) {
        view.findViewById(R$id.container).setOnClickListener(new C0589x835f3313(checkBox));
    }
