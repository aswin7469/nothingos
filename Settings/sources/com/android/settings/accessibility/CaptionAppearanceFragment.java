...
public class CaptionAppearanceFragment extends DashboardFragment implements Preference.OnPreferenceChangeListener, ListDialogPreference.OnValueChangedListener {
    ...
    private final View.OnLayoutChangeListener mLayoutChangeListener = new View.OnLayoutChangeListener() { // from class: com.android.settings.accessibility.CaptionAppearanceFragment.1
    ...
    public void refreshPreviewText() {
        ...
        this.mPreviewWindow.requestLayout();
    }
    ...
    private void initializeAllPreferences() {
        ...
        this.mPreviewWindow.postDelayed(new Runnable() { // from class: com.android.settings.accessibility.CaptionAppearanceFragment$$ExternalSyntheticLambda0
            @Override // java.lang.Runnable
            public final void run() {
                CaptionAppearanceFragment.this.lambda$initializeAllPreferences$0();
            }
        }, 100L);
    }

    /* JADX INFO: Access modifiers changed from: private */
    public /* synthetic */ void lambda$initializeAllPreferences$0() {
        this.mPreviewWindow.requestLayout();
    }
