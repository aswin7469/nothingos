...
public class RemoveAccountPreferenceController extends AbstractPreferenceController implements PreferenceControllerMixin, View.OnClickListener {
    ...
    public static class ConfirmRemoveAccountDialog extends InstrumentedDialogFragment implements DialogInterface.OnClickListener {
        ...
        public Dialog onCreateDialog(Bundle bundle) {
            return new AlertDialog.Builder(getActivity()).setTitle(R$string.really_remove_account_title).setMessage(R$string.really_remove_account_message).setNegativeButton(17039360, (DialogInterface.OnClickListener) null).setPositiveButton(R$string.remove_account_label, (DialogInterface.OnClickListener) this).create();
        }

        public void onClick(DialogInterface dialogInterface, int i) {
            FragmentActivity activity = getTargetFragment().getActivity();
            AccountManager.get(activity).removeAccountAsUser(this.mAccount, activity, new C0629x609c4744(this), (Handler) null, this.mUserHandle);
        }
    ...
    public static class RemoveAccountFailureDialog extends InstrumentedDialogFragment {
        ...
        public Dialog onCreateDialog(Bundle bundle) {
            return new AlertDialog.Builder(getActivity()).setTitle(R$string.remove_account_label).setMessage((CharSequence) ((DevicePolicyManager) getContext().getSystemService(DevicePolicyManager.class)).getResources().getString("Settings.REMOVE_ACCOUNT_FAILED_ADMIN_RESTRICTION", new C0630xd276c95c(this))).setPositiveButton(17039370, (DialogInterface.OnClickListener) null).create();
        }
