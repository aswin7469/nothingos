...
public class WorkModePreferenceController extends BasePreferenceController implements Preference.OnPreferenceChangeListener, LifecycleObserver, OnStart, OnStop {
    ...
    public CharSequence getSummary() {
        if (isChecked()) {
            return this.mDevicePolicyManager.getResources().getString("Settings.WORK_PROFILE_SETTING_ON_SUMMARY", new WorkModePreferenceController$$ExternalSyntheticLambda0(this));
        }
        return this.mDevicePolicyManager.getResources().getString("Settings.WORK_PROFILE_SETTING_OFF_SUMMARY", new WorkModePreferenceController$$ExternalSyntheticLambda1(this));
    }
    ...
    /* access modifiers changed from: private */
    public /* synthetic */ String lambda$getSummary$1() {
