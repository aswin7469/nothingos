...
public class ActivityEmbeddingRulesController {
    ...
    public static void registerTwoPanePairRuleForSettingsHome(Context context, ComponentName componentName, String str, boolean z, boolean z2, boolean z3) {
        if (ActivityEmbeddingUtils.isEmbeddingActivityEnabled(context)) {
            registerTwoPanePairRule(context, new ComponentName(context, Settings.class), componentName, str, z ? 2 : 0, z2 ? 2 : 0, z3);
            registerTwoPanePairRule(context, new ComponentName(context, SettingsHomepageActivity.class), componentName, str, z ? 2 : 0, z2 ? 2 : 0, z3);
            ...
            registerTwoPanePairRule(context, new ComponentName(context, DeepLinkHomepageActivityInternal.class), componentName, str, z ? 1 : 0, z2 ? 1 : 0, z3);
        }
    }
    ...
    public static void registerSubSettingsPairRule(Context context, boolean z) {
        if (ActivityEmbeddingUtils.isEmbeddingActivityEnabled(context)) {
            registerTwoPanePairRuleForSettingsHome(context, new ComponentName(context, SubSettings.class), (String) null, z);
    ...
    private void registerHomepagePlaceholderRule() {
        HashSet hashSet = new HashSet();
        addActivityFilter((Set<ActivityFilter>) hashSet, (Class<? extends Activity>) SettingsHomepageActivity.class);
        addActivityFilter((Set<ActivityFilter>) hashSet, (Class<? extends Activity>) Settings.class);
    ...
    private void registerAlwaysExpandRule() {
        ...
        if (FeatureFlagUtils.isEnabled(this.mContext, "settings_search_always_expand")) {
            addActivityFilter((Set<ActivityFilter>) hashSet, FeatureFactory.getFactory(this.mContext).getSearchFeatureProvider().buildSearchIntent(this.mContext, 1502));
        }
        addActivityFilter((Set<ActivityFilter>) hashSet, (Class<? extends Activity>) FingerprintEnrollIntroduction.class);
        addActivityFilter((Set<ActivityFilter>) hashSet, (Class<? extends Activity>) FingerprintEnrollIntroductionInternal.class);
        addActivityFilter((Set<ActivityFilter>) hashSet, (Class<? extends Activity>) FingerprintEnrollEnrolling.class);
        addActivityFilter((Set<ActivityFilter>) hashSet, (Class<? extends Activity>) AvatarPickerActivity.class);
    ...
    private void addActivityFilter(Set<ActivityFilter> set, Class<? extends Activity> cls) {
        set.add(new ActivityFilter(new ComponentName(this.mContext, cls), (String) null));
    }
}
