...
public class RunningServiceDetails extends InstrumentedFragment implements RunningState.OnRefreshUiListener {
    ...
    class ActiveDetail implements View.OnClickListener {
        ...
        /* JADX WARNING: Removed duplicated region for block: B:48:0x0134 A[SYNTHETIC, Splitter:B:48:0x0134] */
        /* JADX WARNING: Removed duplicated region for block: B:53:0x013a A[SYNTHETIC, Splitter:B:53:0x013a] */
        ...
        public void onClick(android.view.View r13) {
            ...
            L_0x005d:
                ...
                r6 = 0
                java.io.FileOutputStream r7 = new java.io.FileOutputStream     // Catch:{ IOException -> 0x00a6, all -> 0x00a3 }
                r7.<init>(r5)     // Catch:{ IOException -> 0x00a6, all -> 0x00a3 }
                java.lang.String r8 = "activity"
                java.io.FileDescriptor r9 = r7.getFD()     // Catch:{ IOException -> 0x00a1 }
                r10 = 3
                java.lang.String[] r10 = new java.lang.String[r10]     // Catch:{ IOException -> 0x00a1 }
                java.lang.String r11 = "-a"
                r10[r1] = r11     // Catch:{ IOException -> 0x00a1 }
                java.lang.String r1 = "service"
                r10[r3] = r1     // Catch:{ IOException -> 0x00a1 }
                r1 = 2
                java.lang.String r3 = r4.flattenToString()     // Catch:{ IOException -> 0x00a1 }
                r10[r1] = r3     // Catch:{ IOException -> 0x00a1 }
                android.os.Debug.dumpService(r8, r9, r10)     // Catch:{ IOException -> 0x00a1 }
            L_0x0099:
            ...
            L_0x00a8:
                ...
                r3.append(r8)     // Catch:{ all -> 0x009d }
                r3.append(r4)     // Catch:{ all -> 0x009d }
                java.lang.String r3 = r3.toString()     // Catch:{ all -> 0x009d }
                android.util.Log.w(r2, r3, r1)     // Catch:{ all -> 0x009d }
                if (r7 == 0) goto L_0x00bf
                goto L_0x0099
            L_0x00bf:
                java.io.FileInputStream r1 = new java.io.FileInputStream     // Catch:{ IOException -> 0x00e1 }
                r1.<init>(r5)     // Catch:{ IOException -> 0x00e1 }
                long r6 = r5.length()     // Catch:{ IOException -> 0x00dc, all -> 0x00d9 }
                int r3 = (int) r6     // Catch:{ IOException -> 0x00dc, all -> 0x00d9 }
                byte[] r3 = new byte[r3]     // Catch:{ IOException -> 0x00dc, all -> 0x00d9 }
                r1.read(r3)     // Catch:{ IOException -> 0x00dc, all -> 0x00d9 }
                java.lang.String r6 = new java.lang.String     // Catch:{ IOException -> 0x00dc, all -> 0x00d9 }
                r6.<init>(r3)     // Catch:{ IOException -> 0x00dc, all -> 0x00d9 }
                r0.serviceDetails = r6     // Catch:{ IOException -> 0x00dc, all -> 0x00d9 }
            ...
            L_0x00e2:
                ...
                r1.append(r4)     // Catch:{ all -> 0x00df }
                java.lang.String r1 = r1.toString()     // Catch:{ all -> 0x00df }
                android.util.Log.w(r2, r1, r3)     // Catch:{ all -> 0x00df }
            ...
            L_0x013e:
                ...
                com.android.settings.applications.RunningServiceDetails r13 = com.android.settings.applications.RunningServiceDetails.this     // Catch:{ SendIntentException -> 0x0162, IllegalArgumentException -> 0x015d, ActivityNotFoundException -> 0x0158 }
                androidx.fragment.app.FragmentActivity r3 = r13.getActivity()     // Catch:{ SendIntentException -> 0x0162, IllegalArgumentException -> 0x015d, ActivityNotFoundException -> 0x0158 }
                android.app.PendingIntent r12 = r12.mManageIntent     // Catch:{ SendIntentException -> 0x0162, IllegalArgumentException -> 0x015d, ActivityNotFoundException -> 0x0158 }
                android.content.IntentSender r4 = r12.getIntentSender()     // Catch:{ SendIntentException -> 0x0162, IllegalArgumentException -> 0x015d, ActivityNotFoundException -> 0x0158 }
                r5 = 0
                r6 = 268959744(0x10080000, float:2.682127E-29)
                r7 = 524288(0x80000, float:7.34684E-40)
                r8 = 0
                r3.startIntentSender(r4, r5, r6, r7, r8)     // Catch:{ SendIntentException -> 0x0162, IllegalArgumentException -> 0x015d, ActivityNotFoundException -> 0x0158 }
                goto L_0x0198
            L_0x0158:
                r12 = move-exception
    ...
    public void addServiceDetailsView(com.android.settings.applications.RunningState.ServiceItem r8, com.android.settings.applications.RunningState.MergedItem r9, boolean r10, boolean r11) {
        ...
        L_0x0016:
            ...
            int r3 = com.android.settings.R$layout.running_service_details_service
            ...
            int r11 = com.android.settings.R$id.service
        ...
        L_0x005f:
            int r11 = com.android.settings.R$id.comp_description
            android.view.View r11 = r2.findViewById(r11)
            android.widget.TextView r11 = (android.widget.TextView) r11
            int r3 = com.android.settings.R$id.left_button
            android.view.View r3 = r2.findViewById(r3)
            android.widget.Button r3 = (android.widget.Button) r3
            r1.mStopButton = r3
            int r3 = com.android.settings.R$id.right_button
            android.view.View r3 = r2.findViewById(r3)
            android.widget.Button r3 = (android.widget.Button) r3
            r1.mReportButton = r3
            ...
            r11.setVisibility(r0)
            int r8 = com.android.settings.R$id.control_buttons_panel
        ...
        L_0x00b4:
            ...
            int r9 = com.android.settings.R$string.background_process_stop_description
            r11.setText(r9)
            goto L_0x00fe
        L_0x00be:
            android.app.PendingIntent r9 = r1.mManageIntent
            if (r9 == 0) goto L_0x00ec
            androidx.fragment.app.FragmentActivity r9 = r7.getActivity()     // Catch:{ NameNotFoundException -> 0x00fe }
            android.content.pm.PackageManager r9 = r9.getPackageManager()     // Catch:{ NameNotFoundException -> 0x00fe }
            android.app.ActivityManager$RunningServiceInfo r0 = r8.mRunningService     // Catch:{ NameNotFoundException -> 0x00fe }
            java.lang.String r0 = r0.clientPackage     // Catch:{ NameNotFoundException -> 0x00fe }
            android.content.res.Resources r9 = r9.getResourcesForApplication(r0)     // Catch:{ NameNotFoundException -> 0x00fe }
            android.app.ActivityManager$RunningServiceInfo r0 = r8.mRunningService     // Catch:{ NameNotFoundException -> 0x00fe }
            int r0 = r0.clientLabel     // Catch:{ NameNotFoundException -> 0x00fe }
            java.lang.String r9 = r9.getString(r0)     // Catch:{ NameNotFoundException -> 0x00fe }
            androidx.fragment.app.FragmentActivity r0 = r7.getActivity()     // Catch:{ NameNotFoundException -> 0x00fe }
            int r2 = com.android.settings.R$string.service_manage_description     // Catch:{ NameNotFoundException -> 0x00fe }
            java.lang.Object[] r3 = new java.lang.Object[r10]     // Catch:{ NameNotFoundException -> 0x00fe }
            r3[r5] = r9     // Catch:{ NameNotFoundException -> 0x00fe }
            java.lang.String r9 = r0.getString(r2, r3)     // Catch:{ NameNotFoundException -> 0x00fe }
            r11.setText(r9)     // Catch:{ NameNotFoundException -> 0x00fe }
            goto L_0x00fe
        L_0x00ec:
            androidx.fragment.app.FragmentActivity r9 = r7.getActivity()
            if (r8 == 0) goto L_0x00f5
            int r0 = com.android.settings.R$string.service_stop_description
            goto L_0x00f7
        L_0x00f5:
            int r0 = com.android.settings.R$string.heavy_weight_stop_description
        L_0x00f7:
        ...
        L_0x00fe:
            ...
            int r0 = com.android.settings.R$string.service_manage
            goto L_0x0112
        L_0x0110:
            int r0 = com.android.settings.R$string.service_stop
        L_0x0112:
            ...
            r9.setOnClickListener(r1)
            android.widget.Button r9 = r1.mReportButton
            r11 = 17041386(0x10407ea, float:2.425025E-38)
            r9.setText(r11)
            androidx.fragment.app.FragmentActivity r9 = r7.getActivity()
