    ...
    private void loadBatteryDiffEntries() {
        new AsyncTask<Void, Void, BatteryDiffEntry>() {
            ...
            public BatteryDiffEntry doInBackground(Void... voidArr) {
                ...
                BatteryDiffEntry batteryLast24HrUsageData = BatteryChartPreferenceController.getBatteryLast24HrUsageData(AppBatteryPreferenceController.this.mContext, AppBatteryPreferenceController.this.mPackageName, AppBatteryPreferenceController.this.mUserId);
                Log.d(AppBatteryPreferenceController.TAG, "loadBatteryDiffEntries():\n" + batteryLast24HrUsageData);
                return batteryLast24HrUsageData;
            }
    ...
    public void updateBatteryWithDiffEntry() {
        if (this.mIsChartGraphEnabled) {
            ...
            if (batteryDiffEntry == null || batteryDiffEntry.mConsumePower <= 0.0d) {
                this.mPreference.setSummary((CharSequence) this.mContext.getString(R$string.no_battery_summary_24hr));
            } else {
                ...
                this.mPreference.setSummary((CharSequence) this.mContext.getString(R$string.battery_summary_24hr, new Object[]{formatPercentage}));
            }
        }
