...
public class AppButtonsPreferenceController extends BasePreferenceController implements PreferenceControllerMixin, LifecycleObserver, OnResume, OnDestroy, ApplicationsState.Callbacks {
    ...
    public void handleDialogClick(int i) {
        if (i == 0) {
            if ("com.google.android.webview".equals(this.mAppEntry.info.packageName) && Utils.isMonkeyRunning()) {
    ...
    /* JADX WARN: Code restructure failed: missing block: B:43:0x0101, code lost:
        if (r7.mState.getEntry(r0.targetPackageName, android.os.UserHandle.getUserId(r7.mAppEntry.info.uid)) != null) goto L44;
     */
    /*
    ...
    */
    void updateUninstallButton() {
        ...
        if (this.mAppEntry.info.isResourceOverlay()) {
            if (!z4) {
                ApplicationInfo applicationInfo = this.mAppEntry.info;
                OverlayInfo overlayInfo = this.mOverlayManager.getOverlayInfo(applicationInfo.packageName, UserHandle.getUserHandleForUid(applicationInfo.uid));
                if (overlayInfo != null) {
    ...
    public boolean refreshUi() {
        ...
        if (MonkeyUtils.isNeedIntercept(this.mPackageName)) {
            this.mButtonsPref.setButton2Enabled(false).setButton3Enabled(false);
        }
        return true;
    }
