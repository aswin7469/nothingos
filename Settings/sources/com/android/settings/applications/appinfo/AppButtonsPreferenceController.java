...
public class AppButtonsPreferenceController extends BasePreferenceController implements PreferenceControllerMixin, LifecycleObserver, OnResume, OnDestroy, ApplicationsState.Callbacks {
    ...
    private class UninstallAndDisableButtonListener implements View.OnClickListener {
        ...
        public void onClick(View view) {
            ...
            if (appButtonsPreferenceController.mDpm.packageHasActiveAdmins(AppButtonsPreferenceController.this.mPackageInfo.packageName)) {
                ...
                AppButtonsPreferenceController.this.mMetricsFeatureProvider.action((Context) AppButtonsPreferenceController.this.mActivity, 873, AppButtonsPreferenceController.this.getPackageNameForMetric());
            ...
            if (checkIfUninstallBlocked == null || z) {
                ...
                if ((i & 1) != 0) {
                    if (!applicationInfo.enabled || appButtonsPreferenceController2.isDisabledUntilUsed()) {
                        MetricsFeatureProvider r8 = AppButtonsPreferenceController.this.mMetricsFeatureProvider;
                        SettingsActivity r0 = AppButtonsPreferenceController.this.mActivity;
                        AppButtonsPreferenceController appButtonsPreferenceController3 = AppButtonsPreferenceController.this;
                        r8.action((Context) r0, appButtonsPreferenceController3.mAppEntry.info.enabled ? 874 : 875, appButtonsPreferenceController3.getPackageNameForMetric());
    ...
    private class ForceStopButtonListener implements View.OnClickListener {
        ...
        public void onClick(View view) {
            AppButtonsPreferenceController.this.mMetricsFeatureProvider.action((Context) AppButtonsPreferenceController.this.mActivity, 1775, AppButtonsPreferenceController.this.getPackageNameForMetric());
            PackageManager r4 = AppButtonsPreferenceController.this.mPm;
            AppButtonsPreferenceController appButtonsPreferenceController = AppButtonsPreferenceController.this;
            if (r4.isPackageStateProtected(appButtonsPreferenceController.mAppEntry.info.packageName, appButtonsPreferenceController.mUserId)) {
    ...
    public void handleDialogClick(int i) {
        ...
        } else if (!"com.google.android.webview".equals(this.mAppEntry.info.packageName) || !Utils.isMonkeyRunning()) {
            this.mMetricsFeatureProvider.action((Context) this.mActivity, 874, (Pair<Integer, Object>[]) new Pair[0]);
            AsyncTask.execute(new DisableChangerRunnable(this.mPm, this.mAppEntry.info.packageName, 3));
        } else {
            Log.i(TAG, "Disallow monkey to disable Android System Webview");
        }
    }
    ...
    public void updateUninstallButton() {
        ...
        boolean z2 = true;
        boolean z3 = false;
        boolean z4 = (this.mAppEntry.info.flags & 1) != 0;
        if (z4) {
            z = handleDisableable();
        } else {
    ...
    private void launchApplication() {
        if (this.mAppLaunchIntent != null) {
            ...
            this.mMetricsFeatureProvider.action((Context) this.mActivity, 1773, this.mPackageName);
        }
    }
     ...
     */
    /* Code decompiled incorrectly, please refer to instructions dump. */
    public java.lang.String getPackageNameForMetric() {
        /*
            r0 = this;
            com.android.settingslib.applications.ApplicationsState$AppEntry r0 = r0.mAppEntry
        ...
        L_0x0011:
            return r0
        */
        throw new UnsupportedOperationException("Method not decompiled: com.android.settings.applications.appinfo.AppButtonsPreferenceController.getPackageNameForMetric():java.lang.String");
    }
