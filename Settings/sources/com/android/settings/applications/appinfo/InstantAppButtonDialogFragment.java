...
public class InstantAppButtonDialogFragment extends InstrumentedDialogFragment implements DialogInterface.OnClickListener {
    ...
    private AlertDialog createDialog() {
        ...
        return builder.setPositiveButton(i, (DialogInterface.OnClickListener) this).setNegativeButton(R$string.cancel, (DialogInterface.OnClickListener) null).setTitle(i).setMessage(R$string.clear_instant_app_confirmation).create();
    }
}
