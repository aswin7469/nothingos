...
public class InstantAppButtonsPreferenceController extends BasePreferenceController implements LifecycleObserver, OnCreateOptionsMenu, OnPrepareOptionsMenu, OnOptionsItemSelected {
    ...
    private void initButtons(View view) {
        ...
        if (!TextUtils.isEmpty(this.mLaunchUri)) {
            ...
            button3.setOnClickListener(new View.OnClickListener() { // from class: com.android.settings.applications.appinfo.InstantAppButtonsPreferenceController$$ExternalSyntheticLambda2
        ...
        button2.setOnClickListener(new View.OnClickListener() { // from class: com.android.settings.applications.appinfo.InstantAppButtonsPreferenceController$$ExternalSyntheticLambda0
            @Override // android.view.View.OnClickListener
            public final void onClick(View view2) {
