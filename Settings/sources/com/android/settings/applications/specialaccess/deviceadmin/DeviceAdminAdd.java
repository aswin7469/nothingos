...
public class DeviceAdminAdd extends CollapsingToolbarBaseActivity {
    ...
    public void onCreate(android.os.Bundle r13) {
        ...
        L_0x0108:
            ...
            android.content.pm.ActivityInfo r2 = r13.getReceiverInfo(r4, r2)     // Catch:{ NameNotFoundException -> 0x03fe }
        ...
        L_0x01a0:
            ...
            r13.<init>()
            r13.activityInfo = r2
            android.app.admin.DeviceAdminInfo r0 = new android.app.admin.DeviceAdminInfo     // Catch:{ XmlPullParserException -> 0x03e7, IOException -> 0x03d0 }
            r0.<init>(r12, r13)     // Catch:{ XmlPullParserException -> 0x03e7, IOException -> 0x03d0 }
            r12.mDeviceAdmin = r0     // Catch:{ XmlPullParserException -> 0x03e7, IOException -> 0x03d0 }
        ...
        L_0x0241:
            android.app.admin.DevicePolicyManager r13 = r12.mDPM
            boolean r13 = r13.isSupervisionComponent(r4)
        ...
        L_0x0261:
            ...
            android.app.admin.DevicePolicyResourcesManager r1 = r1.getResources()
            com.android.settings.applications.specialaccess.deviceadmin.DeviceAdminAdd$$ExternalSyntheticLambda0 r2 = new com.android.settings.applications.specialaccess.deviceadmin.DeviceAdminAdd$$ExternalSyntheticLambda0
            r2.<init>(r12)
            ...
            int r1 = com.android.settings.R$layout.profile_owner_add
            androidx.appcompat.app.AlertDialog$Builder r13 = r13.setView((int) r1)
            int r1 = com.android.settings.R$string.allow
            ...
            int r1 = com.android.settings.R$string.cancel
            r2 = 0
            ...
            int r0 = com.android.settings.R$id.add_msg_simplified
            android.view.View r0 = r13.findViewById(r0)
            android.widget.TextView r0 = (android.widget.TextView) r0
            r12.mAddMsg = r0
            java.lang.String r1 = r12.mAddMsgText
            r0.setText(r1)
            int r0 = com.android.settings.R$id.admin_warning_simplified
            ...
            com.android.settings.applications.specialaccess.deviceadmin.DeviceAdminAdd$$ExternalSyntheticLambda1 r1 = new com.android.settings.applications.specialaccess.deviceadmin.DeviceAdminAdd$$ExternalSyntheticLambda1
            r1.<init>(r12)
            ...
            return
        L_0x02e0:
            int r13 = com.android.settings.R$layout.device_admin_add
            r12.setContentView((int) r13)
            int r13 = com.android.settings.R$id.admin_icon
            android.view.View r13 = r12.findViewById(r13)
            android.widget.ImageView r13 = (android.widget.ImageView) r13
            r12.mAdminIcon = r13
            int r13 = com.android.settings.R$id.admin_name
            android.view.View r13 = r12.findViewById(r13)
            android.widget.TextView r13 = (android.widget.TextView) r13
            r12.mAdminName = r13
            int r13 = com.android.settings.R$id.admin_description
            android.view.View r13 = r12.findViewById(r13)
            android.widget.TextView r13 = (android.widget.TextView) r13
            r12.mAdminDescription = r13
            int r13 = com.android.settings.R$id.profile_owner_warning
            android.view.View r13 = r12.findViewById(r13)
            android.widget.TextView r13 = (android.widget.TextView) r13
            r12.mProfileOwnerWarning = r13
            android.app.admin.DevicePolicyManager r0 = r12.mDPM
            android.app.admin.DevicePolicyResourcesManager r0 = r0.getResources()
            com.android.settings.applications.specialaccess.deviceadmin.DeviceAdminAdd$$ExternalSyntheticLambda2 r1 = new com.android.settings.applications.specialaccess.deviceadmin.DeviceAdminAdd$$ExternalSyntheticLambda2
            r1.<init>(r12)
            java.lang.String r2 = "Settings.SET_PROFILE_OWNER_POSTSETUP_WARNING"
            java.lang.String r0 = r0.getString(r2, r1)
            r13.setText(r0)
            int r13 = com.android.settings.R$id.add_msg
            android.view.View r13 = r12.findViewById(r13)
            android.widget.TextView r13 = (android.widget.TextView) r13
            r12.mAddMsg = r13
            int r13 = com.android.settings.R$id.add_msg_expander
            android.view.View r13 = r12.findViewById(r13)
            android.widget.ImageView r13 = (android.widget.ImageView) r13
            ...
            int r13 = com.android.settings.R$id.admin_warning
            android.view.View r13 = r12.findViewById(r13)
            android.widget.TextView r13 = (android.widget.TextView) r13
            r12.mAdminWarning = r13
            int r13 = com.android.settings.R$id.admin_policies
            android.view.View r13 = r12.findViewById(r13)
            android.view.ViewGroup r13 = (android.view.ViewGroup) r13
            r12.mAdminPolicies = r13
            int r13 = com.android.settings.R$id.admin_support_message
            android.view.View r13 = r12.findViewById(r13)
            android.widget.TextView r13 = (android.widget.TextView) r13
            r12.mSupportMessage = r13
            int r13 = com.android.settings.R$id.cancel_button
            android.view.View r13 = r12.findViewById(r13)
            ...
            int r13 = com.android.settings.R$id.uninstall_button
            android.view.View r13 = r12.findViewById(r13)
            android.widget.Button r13 = (android.widget.Button) r13
            ...
            r0.<init>()
            r13.setOnClickListener(r0)
            int r13 = com.android.settings.R$id.action_button
            android.view.View r13 = r12.findViewById(r13)
            android.widget.Button r13 = (android.widget.Button) r13
            r12.mActionButton = r13
            int r13 = com.android.settings.R$id.restricted_action
            android.view.View r13 = r12.findViewById(r13)
            r13.setFilterTouchesWhenObscured(r6)
    ...
    public Dialog onCreateDialog(int i, Bundle bundle) {
        ...
        builder.setPositiveButton(R$string.dlg_ok, (DialogInterface.OnClickListener) new DialogInterface.OnClickListener() {
    ...
    public void updateInterface() {
        ...
        if (this.mRefreshing || this.mAddingProfileOwner || !this.mDPM.isAdminActive(this.mDeviceAdmin.getComponent())) {
            ...
            this.mAdminWarning.setText(this.mDPM.getResources().getString("Settings.NEW_DEVICE_ADMIN_WARNING", new DeviceAdminAdd$$ExternalSyntheticLambda13(this, loadLabel), new Object[]{loadLabel}));
            setTitle((CharSequence) this.mDPM.getResources().getString("Settings.ACTIVATE_DEVICE_ADMIN_APP", new DeviceAdminAdd$$ExternalSyntheticLambda14(this)));
            this.mActionButton.setText(this.mDPM.getResources().getString("Settings.ACTIVATE_THIS_DEVICE_ADMIN_APP", new DeviceAdminAdd$$ExternalSyntheticLambda5(this)));
        ...
        if (equals && isManagedProfile) {
            this.mAdminWarning.setText(this.mDPM.getResources().getString("Settings.WORK_PROFILE_ADMIN_POLICIES_WARNING", new DeviceAdminAdd$$ExternalSyntheticLambda4(this)));
            this.mActionButton.setText(this.mDPM.getResources().getString("Settings.REMOVE_WORK_PROFILE", new DeviceAdminAdd$$ExternalSyntheticLambda6(this)));
            ...
            if (equals) {
                this.mAdminWarning.setText(this.mDPM.getResources().getString("Settings.USER_ADMIN_POLICIES_WARNING", new DeviceAdminAdd$$ExternalSyntheticLambda7(this)));
            } else if (isFinancedDevice()) {
                this.mAdminWarning.setText(R$string.admin_financed_message);
            } else {
                this.mAdminWarning.setText(this.mDPM.getResources().getString("Settings.DEVICE_ADMIN_POLICIES_WARNING", new DeviceAdminAdd$$ExternalSyntheticLambda8(this)));
            }
            this.mActionButton.setText(this.mDPM.getResources().getString("Settings.REMOVE_DEVICE_ADMIN", new DeviceAdminAdd$$ExternalSyntheticLambda9(this)));
            this.mActionButton.setEnabled(false);
        } else {
            ...
            this.mAdminWarning.setText(this.mDPM.getResources().getString("Settings.ACTIVE_DEVICE_ADMIN_WARNING", new DeviceAdminAdd$$ExternalSyntheticLambda10(this, loadLabel2), new Object[]{loadLabel2}));
            setTitle(R$string.active_device_admin_msg);
            if (this.mUninstalling) {
                this.mActionButton.setText(this.mDPM.getResources().getString("Settings.REMOVE_AND_UNINSTALL_DEVICE_ADMIN", new DeviceAdminAdd$$ExternalSyntheticLambda11(this)));
            } else {
                this.mActionButton.setText(this.mDPM.getResources().getString("Settings.REMOVE_DEVICE_ADMIN", new DeviceAdminAdd$$ExternalSyntheticLambda12(this)));
            }
        }
    ...
    /* access modifiers changed from: private */
    public /* synthetic */ String lambda$updateInterface$4() {
        return getString(R$string.admin_profile_owner_message);
    }

    /* access modifiers changed from: private */
    public /* synthetic */ String lambda$updateInterface$5() {
        return getString(R$string.remove_managed_profile_label);
    }

    /* access modifiers changed from: private */
    public /* synthetic */ String lambda$updateInterface$6() {
    ...
    /* access modifiers changed from: private */
    public /* synthetic */ String lambda$updateInterface$9(CharSequence charSequence) {
    ...
    private View getPermissionItemView(CharSequence charSequence, CharSequence charSequence2) {
        Drawable drawable = getDrawable(17302882);
    ...
    public void toggleMessageEllipsis(View view) {
        ...
        this.mAddMsgExpander.setImageResource(this.mAddMsgEllipsized ? 17302241 : 17302240);
    }
