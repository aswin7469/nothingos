...
public class DeviceAdminListPreferenceController extends BasePreferenceController implements LifecycleObserver, OnStart, OnStop {
    ...
    private void bindPreference(DeviceAdminListItem deviceAdminListItem, AppSwitchPreference appSwitchPreference) {
        ...
        appSwitchPreference.setOnPreferenceClickListener(new DeviceAdminListPreferenceController$$ExternalSyntheticLambda0(this, deviceAdminListItem));
        appSwitchPreference.setOnPreferenceChangeListener(new DeviceAdminListPreferenceController$$ExternalSyntheticLambda1());
