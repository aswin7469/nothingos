...
public class InteractAcrossProfilesDetails extends AppInfoBase implements Preference.OnPreferenceClickListener {
    ...
    private void showConsentDialog() {
        ...
        ((TextView) inflate.findViewById(R$id.interact_across_profiles_consent_dialog_title)).setText(this.mDpm.getResources().getString("Settings.CONNECT_APPS_DIALOG_TITLE", new InteractAcrossProfilesDetails$$ExternalSyntheticLambda2(this), new Object[]{this.mAppLabel}));
        ((TextView) inflate.findViewById(R$id.app_data_summary)).setText(this.mDpm.getResources().getString("Settings.APP_CAN_ACCESS_PERSONAL_DATA", new InteractAcrossProfilesDetails$$ExternalSyntheticLambda3(this), new Object[]{this.mAppLabel}));
        ((TextView) inflate.findViewById(R$id.permissions_summary)).setText(this.mDpm.getResources().getString("Settings.APP_CAN_ACCESS_PERSONAL_PERMISSIONS", new InteractAcrossProfilesDetails$$ExternalSyntheticLambda4(this), new Object[]{this.mAppLabel}));
        ((TextView) inflate.findViewById(R$id.interact_across_profiles_consent_dialog_summary)).setText(this.mDpm.getResources().getString("Settings.CONNECT_APPS_DIALOG_SUMMARY", new InteractAcrossProfilesDetails$$ExternalSyntheticLambda5(this)));
        new AlertDialog.Builder(getActivity()).setView(inflate).setPositiveButton(R$string.allow, (DialogInterface.OnClickListener) new DialogInterface.OnClickListener() {
        ...
        }).setNegativeButton(R$string.deny, (DialogInterface.OnClickListener) new DialogInterface.OnClickListener() {
            public void onClick(DialogInterface dialogInterface, int i) {
    ...
    public static CharSequence getPreferenceSummary(Context context, String str) {
        ...
        if (isInteractAcrossProfilesEnabled(context, str)) {
            i = R$string.interact_across_profiles_summary_allowed;
        } else {
            i = R$string.interact_across_profiles_summary_not_allowed;
        }
    ...
    private boolean refreshUiForNonConfigurableApps() {
        ...
        if (!z) {
            this.mInstallBanner.setTitle((CharSequence) this.mDpm.getResources().getString("Settings.INSTALL_IN_PERSONAL_PROFILE_TO_CONNECT_PROMPT", new InteractAcrossProfilesDetails$$ExternalSyntheticLambda0(this), new Object[]{this.mAppLabel}));
            if (this.mInstallAppIntent != null) {
            ...
            this.mInstallBanner.setTitle((CharSequence) this.mDpm.getResources().getString("Settings.INSTALL_IN_WORK_PROFILE_TO_CONNECT_PROMPT", new InteractAcrossProfilesDetails$$ExternalSyntheticLambda1(this), new Object[]{this.mAppLabel}));
            if (this.mInstallAppIntent != null) {
                this.mInstallBanner.setSummary(R$string.interact_across_profiles_install_app_summary);
            }
            this.mInstallBanner.setVisible(true);
    ...
    /* access modifiers changed from: private */
    public /* synthetic */ String lambda$refreshUiForNonConfigurableApps$4() {
        return getString(R$string.interact_across_profiles_install_personal_app_title, this.mAppLabel);
    }

    /* access modifiers changed from: private */
    public /* synthetic */ String lambda$refreshUiForNonConfigurableApps$5() {
