...
public class ApprovalPreferenceController extends BasePreferenceController {
    ...
    public void updateState(Preference preference) {
        ...
        restrictedSwitchPreference.setOnPreferenceChangeListener(new ApprovalPreferenceController$$ExternalSyntheticLambda1(this, loadLabel));
        restrictedSwitchPreference.updateState(this.mCn.getPackageName(), this.mPkgInfo.applicationInfo.uid, isServiceEnabled);
    }
    ...
    public void disable(ComponentName componentName) {
        ...
        AsyncTask.execute(new ApprovalPreferenceController$$ExternalSyntheticLambda0(this, componentName));
    }
