...
public class FriendlyWarningDialogFragment extends InstrumentedDialogFragment {
    ...
    public Dialog onCreateDialog(Bundle bundle) {
        ...
        return new AlertDialog.Builder(getContext()).setMessage((CharSequence) getResources().getString(R$string.zen_access_revoke_warning_dialog_summary)).setTitle((CharSequence) getResources().getString(R$string.zen_access_revoke_warning_dialog_title, new Object[]{string2})).setCancelable(true).setPositiveButton(R$string.okay, (DialogInterface.OnClickListener) new FriendlyWarningDialogFragment$$ExternalSyntheticLambda0(this, string, (ZenAccessDetails) getTargetFragment())).setNegativeButton(R$string.cancel, (DialogInterface.OnClickListener) new FriendlyWarningDialogFragment$$ExternalSyntheticLambda1()).create();
    }
