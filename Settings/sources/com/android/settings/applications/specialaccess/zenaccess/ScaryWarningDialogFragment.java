...
public class ScaryWarningDialogFragment extends InstrumentedDialogFragment {
    ...
    public Dialog onCreateDialog(Bundle bundle) {
        ...
        return new AlertDialog.Builder(getContext()).setMessage((CharSequence) getResources().getString(R$string.zen_access_warning_dialog_summary)).setTitle((CharSequence) getResources().getString(R$string.zen_access_warning_dialog_title, new Object[]{string2})).setCancelable(true).setPositiveButton(R$string.allow, (DialogInterface.OnClickListener) new ScaryWarningDialogFragment$$ExternalSyntheticLambda0(this, string, (ZenAccessDetails) getTargetFragment())).setNegativeButton(R$string.deny, (DialogInterface.OnClickListener) new ScaryWarningDialogFragment$$ExternalSyntheticLambda1()).create();
    }
