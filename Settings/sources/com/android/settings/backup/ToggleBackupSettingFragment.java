...
public class ToggleBackupSettingFragment extends SettingsPreferenceFragment implements DialogInterface.OnClickListener, DialogInterface.OnDismissListener {
    ...
    public void onCreate(Bundle bundle) {
        ...
        C07081 r0 = new Preference(getPrefContext()) {
    ...
    public void showEraseBackupDialog() {
        ...
        this.mConfirmDialog = new AlertDialog.Builder(getActivity()).setMessage(charSequence).setTitle(R$string.backup_erase_dialog_title).setPositiveButton(17039370, (DialogInterface.OnClickListener) this).setNegativeButton(17039360, (DialogInterface.OnClickListener) this).setOnDismissListener(this).show();
    }
