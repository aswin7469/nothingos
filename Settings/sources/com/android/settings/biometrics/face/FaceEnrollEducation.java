...
public class FaceEnrollEducation extends BiometricEnrollBase {
    ...
    public void onCreate(Bundle bundle) {
        ...
        if (WizardManagerHelper.isAnySetupWizard(getIntent())) {
            this.mFooterBarMixin.setSecondaryButton(new FooterButton.Builder(this).setText(R$string.skip_label).setListener(new FaceEnrollEducation$$ExternalSyntheticLambda0(this)).setButtonType(7).setTheme(R$style.SudGlifButton_Secondary).build());
        } else {
            this.mFooterBarMixin.setSecondaryButton(new FooterButton.Builder(this).setText(R$string.security_settings_face_enroll_introduction_cancel).setListener(new FaceEnrollEducation$$ExternalSyntheticLambda0(this)).setButtonType(2).setTheme(R$style.SudGlifButton_Secondary).build());
        }
        FooterButton build = new FooterButton.Builder(this).setText(R$string.security_settings_face_enroll_education_start).setListener(new FaceEnrollEducation$$ExternalSyntheticLambda1(this)).setButtonType(5).setTheme(R$style.SudGlifButton_Primary).build();
        ...
        button.setOnClickListener(new FaceEnrollEducation$$ExternalSyntheticLambda2(this, button));
    ...
    public void onResume() {
        ...
        if (this.mFaceManager.getEnrolledFaces(this.mUserId).size() >= getResources().getInteger(17694831)) {
            finish();
        }
    }
    ...
    public void onNextButtonClick(View view) {
        ...
        newInstance.setPositiveButtonListener(new FaceEnrollEducation$$ExternalSyntheticLambda4(this, intent));
