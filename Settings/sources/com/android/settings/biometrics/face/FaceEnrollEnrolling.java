...
public class FaceEnrollEnrolling extends BiometricsEnrollEnrolling {
    ...
    public void onCreate(Bundle bundle) {
        ...
        footerBarMixin.setSecondaryButton(new FooterButton.Builder(this).setText(R$string.security_settings_face_enroll_enrolling_skip).setListener(new FaceEnrollEnrolling$$ExternalSyntheticLambda0(this)).setButtonType(7).setTheme(R$style.SudGlifButton_Secondary).build());
