...
public class FaceProfileStatusPreferenceController extends FaceStatusPreferenceController {
    ...
    public void updateState(Preference preference) {
        ...
        preference.setTitle((CharSequence) this.mDevicePolicyManager.getResources().getString("Settings.FACE_SETTINGS_FOR_WORK_TITLE", new FaceProfileStatusPreferenceController$$ExternalSyntheticLambda0(this)));
    }
