...
public class FingerprintEnrollFinish extends BiometricEnrollBase {
    ...
    public void onCreate(Bundle bundle) {
        ...
        this.mFooterBarMixin.setPrimaryButton(new FooterButton.Builder(this).setText(R$string.security_settings_fingerprint_enroll_done).setListener(new FingerprintEnrollFinish$$ExternalSyntheticLambda0(this)).setButtonType(5).setTheme(R$style.SudGlifButton_Primary).build());
    }
    ...
    public void onResume() {
        ...
        boolean z = false;
        if (fingerprintManagerOrNull != null && fingerprintManagerOrNull.getEnrolledFingerprints(this.mUserId).size() >= ((FingerprintSensorPropertiesInternal) fingerprintManagerOrNull.getSensorPropertiesInternal().get(0)).maxEnrollmentsPerUser) {
            z = true;
        }
        if (z) {
    ...
    public void onAddAnotherButtonClick(View view) {
        Log.d("Security", "FingerprintEnrollFinish::onAddAnotherButtonClick");
