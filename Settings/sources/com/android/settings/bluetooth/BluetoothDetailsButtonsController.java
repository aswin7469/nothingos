...
public class BluetoothDetailsButtonsController extends BluetoothDetailsController {
    ...
    public void refresh() {
        ...
        if (isConnected) {
            if (!this.mConnectButtonInitialized || !z) {
                this.mActionButtons.setButton2Text(R$string.bluetooth_device_context_disconnect).setButton2Icon(R$drawable.ic_settings_close).setButton2OnClickListener(new BluetoothDetailsButtonsController$$ExternalSyntheticLambda1(this));
                this.mConnectButtonInitialized = true;
            }
        } else if (!this.mConnectButtonInitialized || z) {
            this.mActionButtons.setButton2Text(R$string.bluetooth_device_context_connect).setButton2Icon(R$drawable.ic_add_24dp).setButton2OnClickListener(new BluetoothDetailsButtonsController$$ExternalSyntheticLambda2(this));
            this.mConnectButtonInitialized = true;
        }
    }
    ...
    public /* synthetic */ void lambda$refresh$1(View view) {
        this.mMetricsFeatureProvider.action(this.mContext, 868, (Pair<Integer, Object>[]) new Pair[0]);
        this.mCachedDevice.disconnect();
    }

    /* access modifiers changed from: private */
    public /* synthetic */ void lambda$refresh$2(View view) {
        this.mMetricsFeatureProvider.action(this.mContext, 867, (Pair<Integer, Object>[]) new Pair[0]);
