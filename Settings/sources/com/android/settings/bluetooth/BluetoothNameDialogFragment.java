...
abstract class BluetoothNameDialogFragment extends InstrumentedDialogFragment implements TextWatcher, TextView.OnEditorActionListener {
    ...
    public Dialog onCreateDialog(Bundle bundle) {
        ...
        AlertDialog create = new AlertDialog.Builder(getActivity()).setTitle(getDialogTitle()).setView(createDialogView(deviceName)).setPositiveButton(R$string.bluetooth_rename_button, (DialogInterface.OnClickListener) new BluetoothNameDialogFragment$$ExternalSyntheticLambda0(this)).setNegativeButton(17039360, (DialogInterface.OnClickListener) null).create();
