...
public final class BluetoothPairingService extends Service {
    ...
    private void createPairingNotification(Intent intent) {
        ...
        PendingIntent service = PendingIntent.getService(this, 0, intent2, 1140850688);
        ...
        if (TextUtils.isEmpty(stringExtra)) {
            ...
            if (bluetoothDevice != null) {
                stringExtra = bluetoothDevice.getAlias() != null ? bluetoothDevice.getAlias() : bluetoothDevice.getAddress();
            } else {
