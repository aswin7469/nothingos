    ...
    private void createPairingNotification(Intent intent) {
        ...
        if (TextUtils.isEmpty(stringExtra)) {
            ...
            if (bluetoothDevice != null) {
                ...
                stringExtra = resources.getString(17039374);
            }
        }
        Log.d("BluetoothPairingService", "Show pairing notification for  (" + stringExtra + ")");
        NotificationCompat$Action build = new NotificationCompat$Action.Builder(0, resources.getString(R$string.bluetooth_device_context_pair_connect), service).build();
        localOnly.setContentTitle(resources.getString(R$string.bluetooth_notif_title)).setContentText(resources.getString(R$string.bluetooth_notif_message, new Object[]{stringExtra})).setContentIntent(service).setDefaults(1).setOngoing(true).setColor(getColor(17170460)).addAction(build).addAction(new NotificationCompat$Action.Builder(0, resources.getString(17039360), service2).build());
