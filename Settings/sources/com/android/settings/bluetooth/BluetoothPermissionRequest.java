            ...
            if (!((UserManager) context.getSystemService("user")).isManagedProfile()) {
                ...
                if (!checkUserChoice()) {
                    ...
                    if (!((PowerManager) context.getSystemService("power")).isScreenOn() || !LocalBluetoothPreferences.shouldShowDialogInForeground(context, address, str3)) {
                        ...
                        if (i == 2) {
                            str2 = context.getString(R$string.bluetooth_phonebook_request);
                            str = context.getString(R$string.bluetooth_phonebook_access_notification_content);
                        } else if (i == 3) {
                            str2 = context.getString(R$string.bluetooth_map_request);
                            str = context.getString(R$string.bluetooth_message_access_notification_content);
                        } else if (i != 4) {
                            str2 = context.getString(R$string.bluetooth_connect_access_notification_title);
                            str = context.getString(R$string.bluetooth_connect_access_notification_content);
                        } else {
                            str2 = context.getString(R$string.bluetooth_sim_card_access_notification_title);
                            str = context.getString(R$string.bluetooth_sim_card_access_notification_content);
                        }
