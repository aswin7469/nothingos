...
public class GroupBluetoothDevicesAvailableMediaController extends BasePreferenceController implements PreferenceControllerMixin, LifecycleObserver, OnStart, OnStop, DevicePreferenceCallback {
    ...
    public GroupBluetoothDevicesAvailableMediaController(Context context, DashboardFragment dashboardFragment, Lifecycle lifecycle, int i) {
        super(context, KEY);
        this.mGroupId = i;
        lifecycle.addObserver(this);
        this.mGroupDeviceUpdater = new GroupBluetoothDevicesAvailableMediaDeviceUpdater(dashboardFragment.getContext(), dashboardFragment, this, this.mGroupId);
    }
