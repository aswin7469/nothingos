...
public class GroupBluetoothDevicesConnectedController extends BasePreferenceController implements PreferenceControllerMixin, LifecycleObserver, OnStart, OnStop, DevicePreferenceCallback {
    ...
    public GroupBluetoothDevicesConnectedController(Context context, DashboardFragment dashboardFragment, Lifecycle lifecycle, int i) {
        super(context, KEY);
        this.mGroupId = i;
        lifecycle.addObserver(this);
        this.mGroupDeviceUpdater = new GroupBluetoothDevicesConnectedUpdater(dashboardFragment.getContext(), dashboardFragment, this, this.mGroupId);
    }
