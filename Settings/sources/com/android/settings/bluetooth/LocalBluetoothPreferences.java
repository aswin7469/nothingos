...
final class LocalBluetoothPreferences {
    ...
    static boolean shouldShowDialogInForeground(Context context, String str, String str2) {
        ...
        if (localBtManager == null) {
            ...
            if (str != null && str.equals(sharedPreferences.getString("last_selected_device", (String) null)) && sharedPreferences.getLong("last_selected_device_time", 0) + 60000 > currentTimeMillis) {
                return true;
            }
            if (TextUtils.isEmpty(str2) || !str2.equals(context.getString(17040012))) {
