...
public abstract class BasePreferenceController extends AbstractPreferenceController implements Sliceable {
    ...
    public boolean handlePreferenceTreeClick(Preference preference) {
        ...
        new SubSettingLauncher(preference.getContext()).setDestination(preference.getFragment()).setSourceMetricsCategory(preference.getExtras().getInt("category", 0)).setArguments(preference.getExtras()).setUserHandle(this.mWorkProfileUser).launch();
        return true;
    }
