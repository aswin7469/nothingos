...
public abstract class BasePreferenceController extends AbstractPreferenceController implements Sliceable {
    ...
    private boolean mPrefVisibility = true;
    ...
    public static BasePreferenceController createInstance(Context context, String str, String str2, boolean z) {
        try {
            BasePreferenceController basePreferenceController = (BasePreferenceController) Class.forName(str).getConstructor(new Class[]{Context.class, String.class}).newInstance(new Object[]{context, str2});
