...
public final /* synthetic */ class DashboardFeatureProviderImpl$$ExternalSyntheticLambda7 implements Runnable {
    ...
    public /* synthetic */ DashboardFeatureProviderImpl$$ExternalSyntheticLambda7(DashboardFeatureProviderImpl dashboardFeatureProviderImpl, Uri uri, Preference preference, DynamicDataObserver dynamicDataObserver) {
    ...
    public final void run() {
        this.f$0.lambda$refreshTitle$2(this.f$1, this.f$2, this.f$3);
    }
}
