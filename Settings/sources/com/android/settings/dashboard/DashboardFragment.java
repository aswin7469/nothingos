...
public abstract class DashboardFragment extends SettingsPreferenceFragment implements CategoryMixin.CategoryListener, PreferenceGroup.OnExpandButtonClickListener, BasePreferenceController.UiBlockListener {
    ...
    public void onCreatePreferences(Bundle bundle, String str) {
        ...
        }).filter(DashboardFragment$$ExternalSyntheticLambda11.INSTANCE).forEach(new Consumer() { // from class: com.android.settings.dashboard.DashboardFragment$$ExternalSyntheticLambda3
            @Override // java.util.function.Consumer
            public final void accept(Object obj) {
    ...
    public void onStart() {
        ...
        this.mDashboardTilePrefKeys.values().stream().filter(DashboardFragment$$ExternalSyntheticLambda12.INSTANCE).flatMap(DashboardFragment$$ExternalSyntheticLambda10.INSTANCE).forEach(new Consumer() { // from class: com.android.settings.dashboard.DashboardFragment$$ExternalSyntheticLambda4
            @Override // java.util.function.Consumer
            public final void accept(Object obj) {
    ...
    /* JADX INFO: Access modifiers changed from: protected */
    public void displayResourceTilesToScreen(final PreferenceScreen preferenceScreen) {
