...
public class RegionZonePicker extends BaseTimeZoneInfoPicker {
    ...
    @Override // com.android.settings.datetime.timezone.BaseTimeZonePicker, com.android.settingslib.core.lifecycle.ObservableFragment, androidx.fragment.app.Fragment
    public void onCreate(Bundle bundle) {
        ...
        if (string != null) {
            str = localeDisplayNames.regionDisplayName(string);
        }
