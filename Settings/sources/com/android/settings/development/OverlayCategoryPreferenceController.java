...
public class OverlayCategoryPreferenceController extends DeveloperOptionsPreferenceController implements Preference.OnPreferenceChangeListener, PreferenceControllerMixin {
    private static final Comparator<OverlayInfo> OVERLAY_INFO_COMPARATOR = Comparator.comparingInt(new OverlayCategoryPreferenceController$$ExternalSyntheticLambda0());
    ...
    private boolean setOverlay(final String str) {
        final String str2 = (String) getOverlayInfos().stream().filter(new OverlayCategoryPreferenceController$$ExternalSyntheticLambda1()).map(new OverlayCategoryPreferenceController$$ExternalSyntheticLambda2()).findFirst().orElse((Object) null);
