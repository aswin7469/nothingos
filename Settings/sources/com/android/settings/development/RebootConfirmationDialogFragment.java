...
public class RebootConfirmationDialogFragment extends InstrumentedDialogFragment implements DialogInterface.OnClickListener {
    ...
    public Dialog onCreateDialog(Bundle bundle) {
        return new AlertDialog.Builder(getActivity()).setMessage(this.mMessageId).setPositiveButton(R$string.reboot_dialog_reboot_now, (DialogInterface.OnClickListener) this).setNegativeButton(R$string.reboot_dialog_reboot_later, (DialogInterface.OnClickListener) null).create();
    }
