    ...
    public void updatePairedDevicePreferences(Map<String, PairDevice> map) {
        ...
        if (this.mPairedDevicePreferences.isEmpty()) {
            for (Map.Entry next : map.entrySet()) {
                ...
                adbPairedDevicePreference.setOnPreferenceClickListener(new WirelessDebuggingFragment$$ExternalSyntheticLambda1(this));
                this.mPairedDevicesCategory.addPreference(adbPairedDevicePreference);
            }
            return;
        }
        this.mPairedDevicePreferences.entrySet().removeIf(new WirelessDebuggingFragment$$ExternalSyntheticLambda2(this, map));
        for (Map.Entry next2 : map.entrySet()) {
            if (this.mPairedDevicePreferences.get(next2.getKey()) == null) {
                ...
                adbPairedDevicePreference2.setOnPreferenceClickListener(new WirelessDebuggingFragment$$ExternalSyntheticLambda3(this));
