...
public class BlobInfoListView extends ListActivity {
    ...
    public class BlobListAdapter extends ArrayAdapter<BlobInfo> {
        ...
        public View getView(int i, View view, ViewGroup viewGroup) {
            ...
            createOrRecycle.blobExpiry.setText(BlobInfoListView.this.getString(R.string.blob_expires_text, new Object[]{SharedDataUtils.formatTime(item.getExpiryTimeMs())}));
