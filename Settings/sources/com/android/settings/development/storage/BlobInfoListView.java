...
public class BlobInfoListView extends ListActivity {
    ...
    private class BlobListAdapter extends ArrayAdapter<BlobInfo> {
        ...
        public View getView(int i, View view, ViewGroup viewGroup) {
            ...
            createOrRecycle.blobExpiry.setText(formatExpiryTime(blobInfo.getExpiryTimeMs()));
        ...
        private String formatExpiryTime(long j) {
            if (j == 0) {
                return BlobInfoListView.this.getString(R$string.blob_never_expires_text);
            }
            return BlobInfoListView.this.getString(R$string.blob_expires_text, new Object[]{SharedDataUtils.formatTime(j)});
        }
    }
}
