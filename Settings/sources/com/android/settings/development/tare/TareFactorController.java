...
public class TareFactorController {
    ...
    public String mAlarmManagerConstants;
    ...
    /* access modifiers changed from: private */
    public String mJobSchedulerConstants;
    ...
    private void initAlarmManagerMap() {
        ...
        this.mAlarmManagerMap.put("am_reward_top_activity_ongoing", new TareFactorData(this.mResources.getString(i), 10000000, 0));
    ...
    private void initJobSchedulerMap() {
        ...
        this.mJobSchedulerMap.put("js_reward_top_activity_ongoing", new TareFactorData(this.mResources.getString(i), 500000000, 1));
        ...
        int i17 = R$string.tare_job_timeout_penalty;
        arrayMap16.put("js_action_job_timeout_penalty_ctp", new TareFactorData(resources16.getString(i17), EconomyManager.DEFAULT_JS_ACTION_JOB_TIMEOUT_PENALTY_CTP_CAKES, 1));
        ...
        this.mJobSchedulerMap.put("js_action_job_min_running_base_price", new TareFactorData(this.mResources.getString(i16), EconomyManager.DEFAULT_JS_ACTION_JOB_MIN_RUNNING_BASE_PRICE_CAKES, 1));
        this.mJobSchedulerMap.put("js_action_job_timeout_penalty_base_price", new TareFactorData(this.mResources.getString(i17), EconomyManager.DEFAULT_JS_ACTION_JOB_TIMEOUT_PENALTY_BASE_PRICE_CAKES, 1));
    }
