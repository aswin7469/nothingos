...
public class BuildNumberPreferenceController extends BasePreferenceController implements LifecycleObserver, OnStart {
    ...
    private static final String SPECIAL_SKU = "EEA";
    ...
    public CharSequence getSummary() {
        return BidiFormatter.getInstance().unicodeWrap(getBuildNumber());
    }
        ...
        if (!this.mUm.isAdminUser() && !this.mUm.isDemoUser()) {
            ...
            if (i > 0) {
                ...
                if (i2 == 0 && !this.mProcessingLastDevHit) {
                    ...
                    Toast makeText = Toast.makeText(context, resources.getQuantityString(i3, i4, new Object[]{Integer.valueOf(i4)}), 0);
    ...
    private String getBuildNumber() {
        StringBuilder sb = new StringBuilder(SystemProperties.get(PROPERTIES_KEY_CODE_NAME, PROPERTIES_DEFAULT_STRING_VALUE));
        sb.append(BUILD_NUMBER_SEPARATOR);
        sb.append(Build.DISPLAY);
        String str = SystemProperties.get(PROPERTIES_KEY_SKU, PROPERTIES_DEFAULT_STRING_VALUE);
        if (SPECIAL_SKU.equals(str)) {
            sb.append(BUILD_NUMBER_SEPARATOR);
            sb.append(str);
        }
        return sb.toString();
