...
public class PrivateVolumeForget extends InstrumentedFragment {
    ...
    public View onCreateView(LayoutInflater layoutInflater, ViewGroup viewGroup, Bundle bundle) {
        ...
        ((TextView) inflate.findViewById(R$id.body)).setText(TextUtils.expandTemplate(getText(R$string.storage_internal_forget_details), new CharSequence[]{this.mRecord.getNickname()}));
    ...
    public static class ForgetConfirmFragment extends InstrumentedDialogFragment {
        ...
        public Dialog onCreateDialog(Bundle bundle) {
            ...
            builder.setTitle(TextUtils.expandTemplate(getText(R$string.storage_internal_forget_confirm_title), new CharSequence[]{findRecordByUuid.getNickname()}));
            builder.setMessage(TextUtils.expandTemplate(getText(R$string.storage_internal_forget_confirm), new CharSequence[]{findRecordByUuid.getNickname()}));
            builder.setPositiveButton(R$string.storage_menu_forget, (DialogInterface.OnClickListener) new DialogInterface.OnClickListener() {
