...
public abstract class StorageWizardBase extends FragmentActivity {
    ...
    public void setContentView(int i) {
        ...
        footerBarMixin.setSecondaryButton(new FooterButton.Builder(this).setText(R$string.wizard_back).setListener(new StorageWizardBase$$ExternalSyntheticLambda0(this)).setButtonType(0).setTheme(R$style.SudGlifButton_Secondary).build());
        this.mFooterBarMixin.setPrimaryButton(new FooterButton.Builder(this).setText(R$string.wizard_next).setListener(new StorageWizardBase$$ExternalSyntheticLambda1(this)).setButtonType(5).setTheme(R$style.SudGlifButton_Primary).build());
