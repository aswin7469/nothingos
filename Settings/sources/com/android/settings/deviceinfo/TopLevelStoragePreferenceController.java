...
public class TopLevelStoragePreferenceController extends BasePreferenceController {
    ...
    public Future refreshSummaryThread(Preference preference) {
        return ThreadUtils.postOnBackgroundThread((Runnable) new TopLevelStoragePreferenceController$$ExternalSyntheticLambda1(this, preference));
    }
    ...
    public /* synthetic */ void lambda$refreshSummaryThread$1(Preference preference) {
        ...
        ThreadUtils.postOnMainThread(new TopLevelStoragePreferenceController$$ExternalSyntheticLambda0(this, preference, percentInstance, (double) (privateStorageInfo.totalBytes - privateStorageInfo.freeBytes), privateStorageInfo));
    }
