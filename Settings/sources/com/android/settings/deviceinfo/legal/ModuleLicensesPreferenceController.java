...
public class ModuleLicensesPreferenceController extends BasePreferenceController {
    ...
    public void displayPreference(PreferenceScreen preferenceScreen) {
        ...
        this.mContext.getPackageManager().getInstalledModules(0).stream().sorted(Comparator.comparing(new ModuleLicensesPreferenceController$$ExternalSyntheticLambda0())).filter(new Predicate(this.mContext)).forEach(new ModuleLicensesPreferenceController$$ExternalSyntheticLambda1((PreferenceGroup) preferenceScreen.findPreference(getPreferenceKey())));
    }
