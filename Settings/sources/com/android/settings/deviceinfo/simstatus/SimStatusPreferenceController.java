        ...
        if (activeSubscriptionInfoList != null) {
            for (SubscriptionInfo next : activeSubscriptionInfoList) {
                if (next.getSimSlotIndex() == i) {
                    if (!DomesticRoamUtils.isFeatureEnabled(this.mContext) || "" == (registeredOperatorName = DomesticRoamUtils.getRegisteredOperatorName(this.mContext, next.getSubscriptionId()))) {
