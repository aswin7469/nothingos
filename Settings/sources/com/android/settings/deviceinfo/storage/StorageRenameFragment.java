...
public class StorageRenameFragment extends InstrumentedDialogFragment {
    ...
    public Dialog onCreateDialog(Bundle bundle) {
        ...
        return builder.setTitle(R$string.storage_rename_title).setView(inflate).setPositiveButton(R$string.save, (DialogInterface.OnClickListener) new StorageRenameFragment$$ExternalSyntheticLambda0(storageManager, string, editText)).setNegativeButton(R$string.cancel, (DialogInterface.OnClickListener) null).create();
    }
}
