...
public class StorageUtils {
    ...
    public static class SystemInfoFragment extends InstrumentedDialogFragment {
        ...
        public Dialog onCreateDialog(Bundle bundle) {
            return new AlertDialog.Builder(getActivity()).setMessage(getContext().getString(R.string.storage_detail_dialog_system, Build.VERSION.RELEASE_OR_CODENAME)).setPositiveButton(17039370, (DialogInterface.OnClickListener) null).create();
        }
    }
}
