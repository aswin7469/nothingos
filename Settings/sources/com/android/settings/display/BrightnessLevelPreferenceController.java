    ...
    private double getCurrentBrightness() {
        ...
        if (isInVrMode()) {
            ...
            if (brightnessInfo != null) {
                BrightnessUtils.convertLinearToGammaFloat(brightnessInfo.brightness, brightnessInfo.brightnessMinimum, brightnessInfo.brightnessMaximum);
                return (double) Math.min(brightnessInfo.brightness, brightnessInfo.brightnessMaximum);
            }
            i = 0;
        }
