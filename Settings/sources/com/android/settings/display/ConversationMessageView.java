...
public class ConversationMessageView extends FrameLayout {
    ...
    private void updateViewAppearance() {
        ...
        if (z2) {
            i2 = R.color.message_bubble_incoming;
        } else {
            i2 = R.color.message_bubble_outgoing;
        }
        Context context = getContext();
        this.mMessageTextAndInfoView.setBackground(getTintedDrawable(context, context.getDrawable(i4), context.getColor(i2)));
        if (isLayoutRtl(this)) {
