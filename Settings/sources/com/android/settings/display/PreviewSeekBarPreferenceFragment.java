...
public abstract class PreviewSeekBarPreferenceFragment extends SettingsPreferenceFragment {
    ...
    private class onPreviewSeekBarChangeListener implements SeekBar.OnSeekBarChangeListener {
        ...
        private onPreviewSeekBarChangeListener() {
            this.mCommit = new C0928x84d1f24c(this);
        }
        ...
        public void onStopTrackingTouch(SeekBar seekBar) {
            ...
            if (this.mIsChanged) {
                if (PreviewSeekBarPreferenceFragment.this.mPreviewPagerAdapter.isAnimating()) {
                    PreviewSeekBarPreferenceFragment.this.mPreviewPagerAdapter.setAnimationEndAction(new C0927x84d1f24b(this));
                } else {
                    commitOnNextFrame();
                }
            }
    ...
    public View onCreateView(LayoutInflater layoutInflater, ViewGroup viewGroup, Bundle bundle) {
        ...
        findViewById.setOnClickListener(new PreviewSeekBarPreferenceFragment$$ExternalSyntheticLambda0(this));
        View findViewById2 = inflate.findViewById(R$id.larger);
        this.mLarger = findViewById2;
        findViewById2.setOnClickListener(new PreviewSeekBarPreferenceFragment$$ExternalSyntheticLambda1(this));
