...
public class ScreenTimeoutPreferenceController extends BasePreferenceController {
    ...
    public void updateState(Preference preference) {
        ...
        if (preferenceDisablingAdmin != null) {
            ...
            preference.setSummary((CharSequence) ((DevicePolicyManager) this.mContext.getSystemService(DevicePolicyManager.class)).getResources().getString("Settings.DISABLED_BY_IT_ADMIN_TITLE", new ScreenTimeoutPreferenceController$$ExternalSyntheticLambda0(this)));
