...
public class SmartAutoRotateCameraStateController extends BasePreferenceController {
    ...
    public SmartAutoRotateCameraStateController(Context context, String str) {
        ...
        sensorPrivacyManager.addSensorPrivacyListener(2, new SensorPrivacyManager.OnSensorPrivacyChangedListener() { // from class: com.android.settings.display.SmartAutoRotateCameraStateController$$ExternalSyntheticLambda0
