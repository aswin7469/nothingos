...
public class SmartAutoRotateCameraStateController extends BasePreferenceController {
    ...
    public SmartAutoRotateCameraStateController(Context context, String str) {
        ...
        instance.addSensorPrivacyListener(2, new SmartAutoRotateCameraStateController$$ExternalSyntheticLambda1(this));
    }
    ...
    public void displayPreference(PreferenceScreen preferenceScreen) {
        ...
        ((BannerMessagePreference) findPreference).setPositiveButtonText(R$string.allow).setPositiveButtonOnClickListener(new SmartAutoRotateCameraStateController$$ExternalSyntheticLambda0(this));
    }
