...
public class SmartAutoRotatePermissionController extends BasePreferenceController implements LifecycleObserver, OnResume {
    ...
    public void displayPreference(PreferenceScreen preferenceScreen) {
        ...
        bannerMessagePreference.setPositiveButtonText(R$string.auto_rotate_manage_permission_button).setPositiveButtonOnClickListener(new SmartAutoRotatePermissionController$$ExternalSyntheticLambda0(this));
    }
