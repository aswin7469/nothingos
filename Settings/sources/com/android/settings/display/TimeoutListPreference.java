...
public class TimeoutListPreference extends RestrictedListPreference {
    ...
    private void updateTextOnDialog(AlertDialog.Builder builder) {
        ...
        String string = ((DevicePolicyManager) getContext().getSystemService(DevicePolicyManager.class)).getResources().getString("Settings.OTHER_OPTIONS_DISABLED_BY_ADMIN", new TimeoutListPreference$$ExternalSyntheticLambda0());
        if (string != null) {
