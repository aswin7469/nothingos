...
public final class ActionDisabledByAdminDialogHelper {
    ...
    public ActionDisabledByAdminDialogHelper(Activity activity, String str) {
        ...
        ((TextView) this.mDialogView.findViewById(R$id.admin_support_dialog_title)).setText(((DevicePolicyManager) activity.getSystemService(DevicePolicyManager.class)).getResources().getString("Settings.DISABLED_BY_IT_ADMIN_TITLE", new ActionDisabledByAdminDialogHelper$$ExternalSyntheticLambda0(this)));
    }
    ...
    public AlertDialog.Builder prepareDialogBuilder(String str, RestrictedLockUtils.EnforcedAdmin enforcedAdmin) {
        AlertDialog.Builder view = new AlertDialog.Builder(this.mActivity).setPositiveButton(R$string.okay, this.mActionDisabledByAdminController.getPositiveButtonListener(this.mActivity, enforcedAdmin)).setView((View) this.mDialogView);
