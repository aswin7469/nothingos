...
public abstract class AdminActionPreferenceControllerBase extends AbstractPreferenceController implements PreferenceControllerMixin {
    ...
    private String getEnterprisePrivacyNone() {
        return ((DevicePolicyManager) this.mContext.getSystemService("device_policy")).getResources().getString("Settings.ADMIN_ACTION_NONE", new AdminActionPreferenceControllerBase$$ExternalSyntheticLambda0(this));
    }
