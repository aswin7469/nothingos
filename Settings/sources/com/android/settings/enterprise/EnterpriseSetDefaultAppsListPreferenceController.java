...
public class EnterpriseSetDefaultAppsListPreferenceController extends AbstractPreferenceController implements PreferenceControllerMixin {
    ...
    private void buildAppList() {
        ...
        ThreadUtils.postOnMainThread(new C0958xb9e1e136(this));
    }
            ...
            if (this.mEnterprisePrivacyFeatureProvider.isInCompMode() || this.mUsers.size() != 1) {
                ...
                for (int i = 0; i < this.mUsers.size(); i++) {
                    ...
                    if (this.mUsers.get(i).isManagedProfile()) {
                        preferenceCategory.setTitle((CharSequence) devicePolicyManager.getResources().getString("Settings.WORK_CATEGORY_HEADER", new C0959xb9e1e137(this)));
                    } else {
                        preferenceCategory.setTitle((CharSequence) devicePolicyManager.getResources().getString("Settings.PERSONAL_CATEGORY_HEADER", new C0960xb9e1e138(this)));
                    }
    ...
    /* access modifiers changed from: private */
    public /* synthetic */ String lambda$updateUi$1() {
        return this.mContext.getString(R$string.category_work);
    }

    /* access modifiers changed from: private */
    public /* synthetic */ String lambda$updateUi$2() {
    ...
    private CharSequence buildSummaryString(Context context, List<ApplicationInfo> list) {
        ...
        if (list.size() == 2) {
            return context.getString(R$string.app_names_concatenation_template_2, new Object[]{charSequenceArr[0], charSequenceArr[1]});
        }
        return context.getString(R$string.app_names_concatenation_template_3, new Object[]{charSequenceArr[0], charSequenceArr[1], charSequenceArr[2]});
    }
    ...
    static /* synthetic */ class C09571 {
        ...
        static final /* synthetic */ int[] f181x4783f43a;
        ...
        static {
            ...
            L_0x0012:
                int[] r0 = f181x4783f43a     // Catch:{ NoSuchFieldError -> 0x001d }
            ...
            L_0x001d:
                int[] r0 = f181x4783f43a     // Catch:{ NoSuchFieldError -> 0x0028 }
            ...
            L_0x0028:
                int[] r0 = f181x4783f43a     // Catch:{ NoSuchFieldError -> 0x0033 }
            ...
            L_0x0033:
                int[] r0 = f181x4783f43a     // Catch:{ NoSuchFieldError -> 0x003e }
            ...
            L_0x003e:
                int[] r0 = f181x4783f43a     // Catch:{ NoSuchFieldError -> 0x0049 }
            ...
            L_0x0049:
                int[] r0 = f181x4783f43a     // Catch:{ NoSuchFieldError -> 0x0054 }
            ...
            L_0x0054:
                return
            */
            throw new UnsupportedOperationException("Method not decompiled: com.android.settings.enterprise.EnterpriseSetDefaultAppsListPreferenceController.C09571.<clinit>():void");
        }
    }

    private String getTitle(Context context, EnterpriseDefaultApps enterpriseDefaultApps, int i) {
        switch (C09571.f181x4783f43a[enterpriseDefaultApps.ordinal()]) {
            case 1:
