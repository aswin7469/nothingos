...
public class BatteryChartPreferenceController extends AbstractPreferenceController implements PreferenceControllerMixin, LifecycleObserver, OnCreate, OnDestroy, OnSaveInstanceState, BatteryChartView.OnSelectListener, OnResume, ExpandDividerPreference.OnExpandListener {
    ...
    public void displayPreference(PreferenceScreen preferenceScreen) {
        ...
        this.mAppListPrefGroup.setTitle((CharSequence) this.mPrefContext.getString(R$string.battery_app_usage_for_past_24));
    ...
    public void setBatteryChartView(BatteryChartView batteryChartView) {
        if (this.mBatteryChartView != batteryChartView) {
            this.mHandler.post(new BatteryChartPreferenceController$$ExternalSyntheticLambda0(this, batteryChartView));
        }
    }
    ...
    private void addAllPreferences() {
        ...
        list.forEach(new BatteryChartPreferenceController$$ExternalSyntheticLambda2(this, arrayList));
    ...
    private String getSlotInformation() {
        ...
        String utcToLocalTimeHour = ConvertUtils.utcToLocalTimeHour(this.mPrefContext, this.mBatteryHistoryKeys[i * 2], this.mIs24HourFormat);
        String utcToLocalTimeHour2 = ConvertUtils.utcToLocalTimeHour(this.mPrefContext, this.mBatteryHistoryKeys[(this.mTrapezoidIndex + 1) * 2], this.mIs24HourFormat);
        if (this.mIs24HourFormat) {
            return String.format("%s–%s", new Object[]{utcToLocalTimeHour, utcToLocalTimeHour2});
        }
        return String.format("%s – %s", new Object[]{utcToLocalTimeHour, utcToLocalTimeHour2});
    }
    ...
    private void addFooterPreferenceIfNeeded(boolean z) {
        ...
        if (!this.mIsFooterPrefAdded && (footerPreference = this.mFooterPreference) != null) {
            ...
            this.mHandler.post(new BatteryChartPreferenceController$$ExternalSyntheticLambda3(this));
        }
    }
    ...
    public static BatteryDiffEntry getBatteryLast24HrUsageData(Context context, String str, int i) {
        List<BatteryDiffEntry> batteryLast24HrUsageData;
        if (str == null || (batteryLast24HrUsageData = getBatteryLast24HrUsageData(context)) == null) {
            return null;
        }
        for (BatteryDiffEntry next : batteryLast24HrUsageData) {
            BatteryHistEntry batteryHistEntry = next.mBatteryHistEntry;
            if (batteryHistEntry != null && batteryHistEntry.mConsumerType == 1 && batteryHistEntry.mUserId == ((long) i) && str.equals(next.getPackageName())) {
                return next;
            }
        }
        return null;
    ...
    private final class LoadAllItemsInfoTask extends AsyncTask<Void, Void, Map<Integer, List<BatteryDiffEntry>>> {
        ...
        public Map<Integer, List<BatteryDiffEntry>> doInBackground(Void... voidArr) {
            ...
            for (List<BatteryDiffEntry> forEach : indexedUsageMap.values()) {
                forEach.forEach(new C0965xd2dd8c4());
            }
        ...
        public void onPostExecute(Map<Integer, List<BatteryDiffEntry>> map) {
            ...
            if (map != null) {
                BatteryChartPreferenceController.this.mHandler.post(new C0964xd2dd8c3(this, map));
            }
        }
