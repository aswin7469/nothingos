...
public class TopLevelBatteryPreferenceController extends BasePreferenceController implements LifecycleObserver, OnStart, OnStop, BatteryPreferenceController {
    ...
    public TopLevelBatteryPreferenceController(Context context, String str) {
        ...
        batteryBroadcastReceiver.setBatteryChangedListener(new TopLevelBatteryPreferenceController$$ExternalSyntheticLambda1(this));
    ...
    public /* synthetic */ void lambda$new$1(int i) {
        ...
        BatteryInfo.getBatteryInfo(this.mContext, (BatteryInfo.Callback) new TopLevelBatteryPreferenceController$$ExternalSyntheticLambda2(this), true);
    }
    ...
    private void setSummaryAsync(BatteryInfo batteryInfo) {
        ThreadUtils.postOnBackgroundThread((Runnable) new TopLevelBatteryPreferenceController$$ExternalSyntheticLambda0(this, batteryInfo));
    }
