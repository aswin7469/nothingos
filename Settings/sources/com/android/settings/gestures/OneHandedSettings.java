...
public class OneHandedSettings extends AccessibilityShortcutPreferenceFragment {
    ...
    public void lambda$onStart$1() {
        ...
        ((MainSwitchPreference) getPreferenceScreen().findPreference("gesture_one_handed_mode_enabled_main_switch")).addOnSwitchChangeListener(new OneHandedSettings$$ExternalSyntheticLambda0(this));
    }
    ...
    public void onStart() {
        ...
        oneHandedSettingsUtils.registerToggleAwareObserver(new OneHandedSettings$$ExternalSyntheticLambda1(this));
    }
    ...
    public CharSequence getTileTooltipContent(int i) {
        if (i == 0) {
            return getText(R$string.accessibility_one_handed_mode_qs_tooltip_content);
        }
        return getText(R$string.accessibility_one_handed_mode_auto_added_qs_tooltip_content);
    }
