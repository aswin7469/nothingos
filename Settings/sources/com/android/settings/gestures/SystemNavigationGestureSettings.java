...
public class SystemNavigationGestureSettings extends RadioButtonPickerFragment implements HelpResourceProvider {
    ...
    public void onAttach(Context context) {
        ...
        setIllustrationVideo(illustrationPreference, getDefaultKey(), context);
    ...
    protected boolean setDefaultKey(String str) {
        ...
        setIllustrationVideo(this.mVideoPreference, str, getPrefContext());
        return true;
    }
    ...
    private static void setIllustrationVideo(IllustrationPreference illustrationPreference, String str, Context context) {
