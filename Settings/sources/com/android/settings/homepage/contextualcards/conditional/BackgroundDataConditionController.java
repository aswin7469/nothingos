...
public class BackgroundDataConditionController implements ConditionalCardController {
    ...
    /* renamed from: ID */
    static final int f191ID = Objects.hash(new Object[]{"BackgroundDataConditionController"});
    ...
    public ContextualCard buildContextualCard() {
        ConditionalContextualCard.Builder actionText = new ConditionalContextualCard.Builder().setConditionId((long) f191ID).setMetricsConstant(378).setActionText(this.mAppContext.getText(R$string.condition_turn_off));
