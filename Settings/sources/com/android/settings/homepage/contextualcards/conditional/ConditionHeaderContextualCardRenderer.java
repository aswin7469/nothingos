...
public class ConditionHeaderContextualCardRenderer implements ContextualCardRenderer {
    ...
    public void bindView(RecyclerView.ViewHolder viewHolder, ContextualCard contextualCard) {
        ...
        ((ConditionHeaderContextualCard) contextualCard).getConditionalCards().forEach(new ConditionHeaderContextualCardRenderer$$ExternalSyntheticLambda0(this, conditionHeaderCardHolder));
        conditionHeaderCardHolder.itemView.setOnClickListener(new ConditionHeaderContextualCardRenderer$$ExternalSyntheticLambda1(this, metricsFeatureProvider));
    }
