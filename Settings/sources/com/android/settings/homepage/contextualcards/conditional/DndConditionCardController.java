...
public class DndConditionCardController implements ConditionalCardController {
    ...
    /* renamed from: ID */
    static final int f194ID = Objects.hash(new Object[]{"DndConditionCardController"});
    ...
    public ContextualCard buildContextualCard() {
        ConditionalContextualCard.Builder actionText = new ConditionalContextualCard.Builder().setConditionId((long) f194ID).setMetricsConstant(381).setActionText(this.mAppContext.getText(R$string.condition_turn_off));
