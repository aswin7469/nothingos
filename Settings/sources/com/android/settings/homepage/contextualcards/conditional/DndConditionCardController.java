...
public class DndConditionCardController implements ConditionalCardController {
    ...
    public ContextualCard buildContextualCard() {
        ...
        return actionText.setName(sb.toString()).setTitleText(this.mAppContext.getText(i).toString()).setSummaryText(getSummary()).setIconDrawable(this.mAppContext.getDrawable(R.drawable.ic_do_not_disturb_on_24dp)).setViewType(ConditionContextualCardRenderer.VIEW_TYPE_HALF_WIDTH).mo389build();
    }
