...
public class GrayscaleConditionController implements ConditionalCardController {
    ...
    /* renamed from: ID */
    static final int f195ID = Objects.hash(new Object[]{"GrayscaleConditionController"});
    ...
    public ContextualCard buildContextualCard() {
        ConditionalContextualCard.Builder actionText = new ConditionalContextualCard.Builder().setConditionId((long) f195ID).setMetricsConstant(1683).setActionText(this.mAppContext.getText(R$string.condition_turn_off));
