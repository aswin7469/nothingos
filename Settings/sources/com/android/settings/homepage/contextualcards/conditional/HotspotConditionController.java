...
public class HotspotConditionController implements ConditionalCardController {
    ...
    public ContextualCard buildContextualCard() {
        ...
        return actionText.setName(sb.toString()).setTitleText(this.mAppContext.getText(i).toString()).setSummaryText(getSsid().toString()).setIconDrawable(this.mAppContext.getDrawable(R.drawable.ic_hotspot)).setViewType(ConditionContextualCardRenderer.VIEW_TYPE_HALF_WIDTH).mo389build();
    }
