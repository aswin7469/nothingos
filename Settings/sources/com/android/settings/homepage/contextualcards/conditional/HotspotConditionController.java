...
public class HotspotConditionController implements ConditionalCardController {
    ...
    /* renamed from: ID */
    static final int f196ID = Objects.hash(new Object[]{"HotspotConditionController"});
    ...
    public ContextualCard buildContextualCard() {
        ConditionalContextualCard.Builder actionText = new ConditionalContextualCard.Builder().setConditionId((long) f196ID).setMetricsConstant(382).setActionText(this.mAppContext.getText(R$string.condition_turn_off));
