...
public class NightDisplayConditionController implements ConditionalCardController, NightDisplayListener.Callback {
    ...
    /* renamed from: ID */
    static final int f197ID = Objects.hash(new Object[]{"NightDisplayConditionController"});
    ...
    public ContextualCard buildContextualCard() {
        ConditionalContextualCard.Builder actionText = new ConditionalContextualCard.Builder().setConditionId((long) f197ID).setMetricsConstant(492).setActionText(this.mAppContext.getText(R$string.condition_turn_off));
