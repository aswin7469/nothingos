...
public class RingerVibrateConditionController extends AbnormalRingerConditionController {
    ...
    /* renamed from: ID */
    static final int f199ID = Objects.hash(new Object[]{"RingerVibrateConditionController"});
    ...
    public ContextualCard buildContextualCard() {
        ConditionalContextualCard.Builder actionText = new ConditionalContextualCard.Builder().setConditionId((long) f199ID).setMetricsConstant(1369).setActionText(this.mAppContext.getText(R$string.condition_device_muted_action_turn_on_sound));
