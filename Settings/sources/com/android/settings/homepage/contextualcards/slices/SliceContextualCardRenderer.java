...
public class SliceContextualCardRenderer implements ContextualCardRenderer, LifecycleObserver {
    ...
    public void bindView(RecyclerView.ViewHolder viewHolder, ContextualCard contextualCard) {
        ...
        if (liveData == null) {
            liveData = SliceLiveData.fromUri(this.mContext, sliceUri, new SliceContextualCardRenderer$$ExternalSyntheticLambda1(this, sliceUri));
    ...
    public /* synthetic */ void lambda$bindView$1(Uri uri, int i, Throwable th) {
        ...
        ThreadUtils.postOnMainThread(new SliceContextualCardRenderer$$ExternalSyntheticLambda5(this, uri));
    ...
    private void initDismissalActions(RecyclerView.ViewHolder viewHolder, final ContextualCard contextualCard) {
        ((Button) viewHolder.itemView.findViewById(R$id.keep)).setOnClickListener(new SliceContextualCardRenderer$$ExternalSyntheticLambda3(this, viewHolder));
        ((Button) viewHolder.itemView.findViewById(R$id.remove)).setOnClickListener(new SliceContextualCardRenderer$$ExternalSyntheticLambda4(this, contextualCard, viewHolder));
    ...
    public void onStop() {
        this.mFlippedCardSet.forEach(new SliceContextualCardRenderer$$ExternalSyntheticLambda0(this));
