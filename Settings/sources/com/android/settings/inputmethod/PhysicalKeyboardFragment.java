...
public final class PhysicalKeyboardFragment extends SettingsPreferenceFragment implements InputManager.InputDeviceListener, KeyboardLayoutDialogFragment.OnSetupKeyboardLayoutsListener {
    ...
    private NtCustSwitchPreference mShowVirtualKeyboardSwitch;
    ...
    public void onCreatePreferences(Bundle bundle, String str) {
        ...
        this.mShowVirtualKeyboardSwitch = (NtCustSwitchPreference) Preconditions.checkNotNull((NtCustSwitchPreference) preferenceCategory.findPreference("show_virtual_keyboard_switch"));
    }
    ...
    public void lambda$scheduleUpdateHardKeyboards$0(List<HardKeyboardDeviceInfo> list) {
        if (!Objects.equals(this.mLastHardKeyboards, list)) {
            ...
            for (HardKeyboardDeviceInfo next : list) {
                ...
                preference.setOnPreferenceClickListener(new PhysicalKeyboardFragment$$ExternalSyntheticLambda4(this, next));
    ...
    public void updateShowVirtualKeyboardSwitch() {
        NtCustSwitchPreference ntCustSwitchPreference = this.mShowVirtualKeyboardSwitch;
        boolean z = false;
    ...
    static List<HardKeyboardDeviceInfo> getHardKeyboards(Context context) {
        ...
        arrayList.sort(new PhysicalKeyboardFragment$$ExternalSyntheticLambda1(Collator.getInstance()));
        return arrayList;
    }
