...
public class AppLocationPermissionPreferenceController extends LocationBasePreferenceController implements PreferenceControllerMixin {
    ...
    public CharSequence getSummary() {
        ...
        int i = R$plurals.location_app_permission_summary_location_on;
        ...
        if (this.mLocationManager.isLocationEnabled() && this.loadingInProgress.get() == 0) {
            ...
            for (UserHandle identifier : userProfiles) {
                ...
                if (createPackageContextAsUser == null) {
                    ...
                    permissionControllerManager.countPermissionApps(Arrays.asList(new String[]{"android.permission.ACCESS_FINE_LOCATION", "android.permission.ACCESS_COARSE_LOCATION"}), 0, new C1039xdc12bf8b(this), (Handler) null);
                    permissionControllerManager.countPermissionApps(Arrays.asList(new String[]{"android.permission.ACCESS_FINE_LOCATION", "android.permission.ACCESS_COARSE_LOCATION"}), 1, new C1040xdc12bf8c(this), (Handler) null);
                }
            }
        }
    }
