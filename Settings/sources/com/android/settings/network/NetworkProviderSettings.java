...
public class NetworkProviderSettings extends RestrictedSettingsFragment implements WifiPickerTracker.WifiPickerTrackerCallback, WifiDialog2.WifiDialog2Listener, DialogInterface.OnDismissListener, AirplaneModeEnabler.OnAirplaneModeChangedListener, InternetUpdater.InternetChangeListener {
    ...
    final Runnable mHideProgressBarRunnable = new NetworkProviderSettings$$ExternalSyntheticLambda3(this);
    ...
    final Runnable mRemoveLoadingRunnable = new NetworkProviderSettings$$ExternalSyntheticLambda1(this);
    ...
    final Runnable mUpdateWifiEntryPreferencesRunnable = new NetworkProviderSettings$$ExternalSyntheticLambda2(this);
    ...
    public void addShareMenuIfSuitable(ContextMenu contextMenu) {
        ...
        EventLog.writeEvent(1397638484, new Object[]{"206986392", -1, "User is not an admin"});
    }
    ...
    public boolean onContextItemSelected(MenuItem menuItem) {
        ...
        if (itemId == 2) {
            ...
            WifiDppUtils.showLockScreen(getContext(), new NetworkProviderSettings$$ExternalSyntheticLambda0(this));
            return true;
        }
    }
    ...
    /* access modifiers changed from: package-private */
    public void onSelectedWifiPreferenceClick(LongPressWifiEntryPreference longPressWifiEntryPreference) {
    ...
    public void setWifiScanMessage(boolean z) {
        ...
        if (context != null) {
            ...
            if (TextUtils.isEmpty(this.mWifiStatusMessagePreference.getTitle())) {
                ...
                this.mWifiStatusMessagePreference.setLearnMoreAction(new NetworkProviderSettings$$ExternalSyntheticLambda4(this));
            }
    ...
    public void onWifiEntriesChanged() {
        ...
        if (this.mOpenSsid != null && (wifiPickerTracker = this.mWifiPickerTracker) != null) {
            Optional findFirst = wifiPickerTracker.getWifiEntries().stream().filter(new NetworkProviderSettings$$ExternalSyntheticLambda9(this)).filter(new NetworkProviderSettings$$ExternalSyntheticLambda10()).filter(new NetworkProviderSettings$$ExternalSyntheticLambda11()).findFirst();
        ...
        if (getActivity() != null && getView() != null && !this.mIsRestricted && (wifiPickerTracker = this.mWifiPickerTracker) != null && wifiPickerTracker.getWifiState() == 3) {
            ...
            if (connectedWifiEntry != null) {
                ...
                if (longPressWifiEntryPreference == null || longPressWifiEntryPreference.getWifiEntry() != connectedWifiEntry) {
                    ...
                    createConnectedWifiEntryPreference.setOnPreferenceClickListener(new NetworkProviderSettings$$ExternalSyntheticLambda6(this, connectedWifiEntry, createConnectedWifiEntryPreference));
                    createConnectedWifiEntryPreference.setOnGearClickListener(new NetworkProviderSettings$$ExternalSyntheticLambda7(this, createConnectedWifiEntryPreference));
            ...
            for (WifiEntry next : this.mWifiPickerTracker.getWifiEntries()) {
                ...
                if (next.getHelpUriString() != null) {
                    createLongPressWifiEntryPreference.setOnButtonClickListener(new NetworkProviderSettings$$ExternalSyntheticLambda8(this, next));
                }
    ...
    /* access modifiers changed from: package-private */
    public void launchNetworkDetailsFragment(LongPressWifiEntryPreference longPressWifiEntryPreference) {
    ...
    public void setAdditionalSettingsSummaries() {
        ...
        preference.setSummary((CharSequence) getString(i));
        WifiPickerTracker wifiPickerTracker = this.mWifiPickerTracker;
        if (wifiPickerTracker == null) {
            i2 = 0;
        } else {
            i2 = wifiPickerTracker.getNumSavedNetworks();
        }
        WifiPickerTracker wifiPickerTracker2 = this.mWifiPickerTracker;
        if (wifiPickerTracker2 == null) {
            i3 = 0;
        } else {
            i3 = wifiPickerTracker2.getNumSavedSubscriptions();
        }
        if (i2 + i3 > 0) {
            this.mSavedNetworksPreference.setVisible(true);
            this.mSavedNetworksPreference.setSummary((CharSequence) getSavedNetworkSettingsSummaryText(i2, i3));
            return;
        }
    ...
    public void showResetInternetDialog() {
        ...
        builder.setTitle(R$string.reset_your_internet_title).setMessage(R$string.reset_internet_text).setPositiveButton(R$string.tts_reset, (DialogInterface.OnClickListener) new DialogInterface.OnClickListener() {
    ...
    public void fixConnectivity() {
        if (this.mInternetResetHelper == null) {
            ...
            this.mInternetResetHelper.setWifiTogglePreference(findPreference(PREF_KEY_WIFI_TOGGLE));
