...
public class ProviderModelSlice extends WifiSlice {
    ...
    public Slice getSlice() {
        ...
        for (WifiSliceItem wifiSliceItemRow : (List) results.stream().filter(new ProviderModelSlice$$ExternalSyntheticLambda2()).limit((long) (i2 + -1)).collect(Collectors.toList())) {
    ...
    public AlertDialog getMobileDataDisableDialog(int i, String str) {
        return new AlertDialog.Builder(this.mContext).setTitle(R$string.mobile_data_disable_title).setMessage(this.mContext.getString(R$string.mobile_data_disable_message, new Object[]{str})).setNegativeButton(17039360, new ProviderModelSlice$$ExternalSyntheticLambda0(this)).setPositiveButton(17039659, new ProviderModelSlice$$ExternalSyntheticLambda1(this, i)).create();
    }
    ...
    public Intent getIntent() {
        return SliceBuilderUtils.buildSearchResultPageIntent(this.mContext, NetworkProviderSettings.class.getName(), "", this.mContext.getText(R$string.provider_internet_settings).toString(), 1401, (CustomSliceable) this).setClassName(this.mContext.getPackageName(), SubSettings.class.getName()).setData(getUri());
    }
