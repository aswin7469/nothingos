...
public class QuerySimSlotIndex implements Callable<AtomicIntegerArray> {
    ...
    public IntStream lambda$call$0(UiccSlotInfo uiccSlotInfo) {
        ...
        return uiccSlotInfo.getPorts().stream().filter(new QuerySimSlotIndex$$ExternalSyntheticLambda2(this)).mapToInt(new QuerySimSlotIndex$$ExternalSyntheticLambda3());
    }
