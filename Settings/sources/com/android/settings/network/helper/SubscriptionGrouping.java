...
public class SubscriptionGrouping implements UnaryOperator<List<SubscriptionAnnotation>> {
    public List<SubscriptionAnnotation> apply(List<SubscriptionAnnotation> list) {
        ...
        Map map = (Map) list.stream().filter(new SubscriptionGrouping$$ExternalSyntheticLambda0()).collect(Collectors.groupingBy(new SubscriptionGrouping$$ExternalSyntheticLambda1(this)));
        map.replaceAll(new SubscriptionGrouping$$ExternalSyntheticLambda2(this));
    ...
    public SubscriptionAnnotation selectBestFromList(List<SubscriptionAnnotation> list) {
        return (SubscriptionAnnotation) list.stream().sorted(new SubscriptionGrouping$$ExternalSyntheticLambda3().thenComparingInt(new SubscriptionGrouping$$ExternalSyntheticLambda4()).thenComparingInt(new SubscriptionGrouping$$ExternalSyntheticLambda5(list))).findFirst().orElse((Object) null);
    }
