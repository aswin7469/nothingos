...
abstract class AbstractMobileNetworkSettings extends RestrictedDashboardFragment {
    ...
    public List<AbstractPreferenceController> getPreferenceControllersAsList() {
        ...
        getPreferenceControllers().forEach(new AbstractMobileNetworkSettings$$ExternalSyntheticLambda0(arrayList));
        return arrayList;
    }
    ...
    public void onExpandButtonClick() {
        ...
        this.mHiddenControllerList.stream().filter(new AbstractMobileNetworkSettings$$ExternalSyntheticLambda1()).forEach(new AbstractMobileNetworkSettings$$ExternalSyntheticLambda2(getPreferenceScreen()));
    ...
    public void updatePreferenceStates() {
        ...
        long elapsedRealtime = SystemClock.elapsedRealtime();
        getPreferenceControllersAsList().forEach(new AbstractMobileNetworkSettings$$ExternalSyntheticLambda3(this, getPreferenceScreen()));
    ...
    public void redrawPreferenceControllers() {
        ...
        preferenceControllersAsList.forEach(new AbstractMobileNetworkSettings$$ExternalSyntheticLambda4(this, getPreferenceScreen()));
