...
public class Enable2gPreferenceController extends TelephonyTogglePreferenceController {
    ...
    public void updateState(Preference preference) {
        ...
        if (preference != null && SubscriptionManager.isUsableSubscriptionId(this.mSubId)) {
            ...
            if (z) {
                str = this.mContext.getString(R$string.enable_2g_summary_disabled_carrier, new Object[]{getCarrierName()});
            } else {
    ...
    private String getCarrierName() {
        ...
        CharSequence carrierName = subById.getCarrierName();
        if (DomesticRoamUtils.isFeatureEnabled(this.mContext) && "" != (registeredOperatorName = DomesticRoamUtils.getRegisteredOperatorName(this.mContext, subById.getSubscriptionId()))) {
