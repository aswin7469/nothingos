...
public class MobileDataDialogFragment extends InstrumentedDialogFragment implements DialogInterface.OnClickListener {
    ...
    public Dialog onCreateDialog(Bundle bundle) {
        ...
        int i2 = this.mType;
        if (i2 == 0) {
            return new AlertDialog.Builder(context).setMessage(R$string.data_usage_disable_mobile).setPositiveButton(17039370, (DialogInterface.OnClickListener) this).setNegativeButton(17039360, (DialogInterface.OnClickListener) null).create();
        }
        if (i2 == 1) {
            ...
            return new AlertDialog.Builder(context).setTitle((CharSequence) context.getString(R$string.sim_change_data_title, new Object[]{str2})).setMessage((CharSequence) context.getString(R$string.sim_change_data_message, new Object[]{str2, str})).setPositiveButton((CharSequence) context.getString(R$string.sim_change_data_ok, new Object[]{str2}), (DialogInterface.OnClickListener) this).setNegativeButton(R$string.cancel, (DialogInterface.OnClickListener) null).create();
        } else if (i2 == 2) {
            return new AlertDialog.Builder(context).setMessage(R$string.mobile_data_disable_dialog_ciwlan_call).setPositiveButton(17039370, (DialogInterface.OnClickListener) this).setNegativeButton(17039360, (DialogInterface.OnClickListener) null).create();
        } else {
