...
public class NfcPaymentPreferenceController extends BasePreferenceController implements PaymentBackend.Callback, View.OnClickListener, NfcPaymentPreference.Listener, LifecycleObserver, OnStart, OnStop {
    ...
    public CharSequence getSummary() {
        ...
        return defaultApp.label + " (" + ((UserManager) this.mContext.createContextAsUser(defaultApp.userHandle, 0).getSystemService(UserManager.class)).getUserName() + ")";
    }
    ...
    private class NfcPaymentAdapter extends BaseAdapter implements CompoundButton.OnCheckedChangeListener, View.OnClickListener {
        ...
        public View getView(int i, View view, ViewGroup viewGroup) {
            ...
            UserManager userManager = (UserManager) NfcPaymentPreferenceController.this.mContext.createContextAsUser(paymentAppInfo.userHandle, 0).getSystemService(UserManager.class);
            ...
            radioButton.setContentDescription(paymentAppInfo.label + " (" + userManager.getUserName() + ")");
            ...
            radioButton2.setText(paymentAppInfo.label + " (" + userManager.getUserName() + ")");
            return view;
        }
