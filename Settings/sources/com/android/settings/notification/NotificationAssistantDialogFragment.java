...
public class NotificationAssistantDialogFragment extends InstrumentedDialogFragment implements DialogInterface.OnClickListener {
    ...
    public Dialog onCreateDialog(Bundle bundle) {
        return new AlertDialog.Builder(getContext()).setMessage((CharSequence) getResources().getString(R$string.notification_assistant_security_warning_summary)).setCancelable(true).setPositiveButton(R$string.okay, (DialogInterface.OnClickListener) this).create();
    }
