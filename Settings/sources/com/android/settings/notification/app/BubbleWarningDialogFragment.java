...
public class BubbleWarningDialogFragment extends InstrumentedDialogFragment {
    ...
    public Dialog onCreateDialog(Bundle bundle) {
        ...
        return new AlertDialog.Builder(getContext()).setMessage((CharSequence) getResources().getString(R$string.bubbles_feature_disabled_dialog_text)).setTitle((CharSequence) getResources().getString(R$string.bubbles_feature_disabled_dialog_title)).setCancelable(true).setPositiveButton(R$string.bubbles_feature_disabled_button_approve, (DialogInterface.OnClickListener) new BubbleWarningDialogFragment$$ExternalSyntheticLambda0(this, string, i, i2)).setNegativeButton(R$string.bubbles_feature_disabled_button_cancel, (DialogInterface.OnClickListener) new BubbleWarningDialogFragment$$ExternalSyntheticLambda1(this, string, i)).create();
    }
