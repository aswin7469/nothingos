...
public class NotificationHistoryAdapter extends RecyclerView.Adapter<NotificationHistoryViewHolder> implements NotificationHistoryRecyclerView.OnItemSwipeDeleteListener {
    ...
    public long getItemId(int i) {
        return (long) this.mValues.get(i).hashCode();
    }
    ...
    public void onBindViewHolder(NotificationHistoryViewHolder notificationHistoryViewHolder, int i) {
        ...
        NotificationHistoryAdapter$$ExternalSyntheticLambda1 notificationHistoryAdapter$$ExternalSyntheticLambda1 = new NotificationHistoryAdapter$$ExternalSyntheticLambda1(this, historicalNotification, i, notificationHistoryViewHolder);
        notificationHistoryViewHolder.itemView.setOnClickListener(notificationHistoryAdapter$$ExternalSyntheticLambda1);
        notificationHistoryViewHolder.itemView.setOnLongClickListener(new NotificationHistoryAdapter$$ExternalSyntheticLambda2(notificationHistoryAdapter$$ExternalSyntheticLambda1));
    ...
    public void onRebuildComplete(List<NotificationHistory.HistoricalNotification> list) {
        this.mValues = list;
        list.sort(new NotificationHistoryAdapter$$ExternalSyntheticLambda0());
