...
public class NotificationStation extends SettingsPreferenceFragment {
    ...
    private final Comparator<HistoricalNotificationInfo> mNotificationSorter = new NotificationStation$$ExternalSyntheticLambda0();
    ...
    private CharSequence generateRankingExtraText(HistoricalNotificationInfo historicalNotificationInfo) {
        ...
        if (rankingMap != null && rankingMap.getRanking(historicalNotificationInfo.key, ranking)) {
            ...
            spannableStringBuilder.append("\n").append(bold(getString(R$string.notification_log_channel))).append(string).append(historicalNotificationInfo.channel.toString());
            ...
            if (historicalNotificationInfo.active) {
                spannableStringBuilder.append("\n").append(bold(getString(R$string.notification_log_details_importance))).append(string).append(NotificationListenerService.Ranking.importanceToString(ranking.getImportance()));
                if (ranking.getImportanceExplanation() != null) {
                    spannableStringBuilder.append("\n").append(bold(getString(R$string.notification_log_details_explanation))).append(string).append(ranking.getImportanceExplanation());
                }
                spannableStringBuilder.append("\n").append(bold(getString(R$string.notification_log_details_badge))).append(string).append(Boolean.toString(ranking.canShowBadge()));
            }
    ...
    private CharSequence generateExtraText(StatusBarNotification statusBarNotification, HistoricalNotificationInfo historicalNotificationInfo) {
        ...
        SpannableStringBuilder spannableStringBuilder = new SpannableStringBuilder();
        String string = getString(R$string.notification_log_details_delimiter);
        spannableStringBuilder.append(bold(getString(R$string.notification_log_details_package))).append(string).append(historicalNotificationInfo.pkg).append("\n").append(bold(getString(R$string.notification_log_details_key))).append(string).append(statusBarNotification.getKey());
        spannableStringBuilder.append("\n").append(bold(getString(R$string.notification_log_details_icon))).append(string).append(String.valueOf(notification.getSmallIcon()));
        ...
        if (statusBarNotification.isGroup()) {
            spannableStringBuilder.append("\n").append(bold(getString(R$string.notification_log_details_group))).append(string).append(String.valueOf(statusBarNotification.getGroupKey()));
            if (notification.isGroupSummary()) {
                spannableStringBuilder.append(bold(getString(R$string.notification_log_details_group_summary)));
            }
        }
        if (notification.publicVersion != null) {
            spannableStringBuilder.append("\n").append(bold(getString(R$string.notification_log_details_public_version))).append(string).append(getTitleString(notification.publicVersion));
        }
        if (notification.contentIntent != null) {
            spannableStringBuilder.append("\n").append(bold(getString(R$string.notification_log_details_content_intent))).append(string).append(formatPendingIntent(notification.contentIntent));
        }
        if (notification.deleteIntent != null) {
            spannableStringBuilder.append("\n").append(bold(getString(R$string.notification_log_details_delete_intent))).append(string).append(formatPendingIntent(notification.deleteIntent));
        }
        if (notification.fullScreenIntent != null) {
            spannableStringBuilder.append("\n").append(bold(getString(R$string.notification_log_details_full_screen_intent))).append(string).append(formatPendingIntent(notification.fullScreenIntent));
        }
        ...
        if (actionArr != null && actionArr.length > 0) {
            ...
            while (true) {
                ...
                spannableStringBuilder.append("\n  ").append(String.valueOf(i)).append(' ').append(bold(getString(R$string.notification_log_details_title))).append(string).append(action.title);
                if (action.actionIntent != null) {
                    spannableStringBuilder.append("\n    ").append(bold(getString(R$string.notification_log_details_content_intent))).append(string).append(formatPendingIntent(action.actionIntent));
                }
                if (action.getRemoteInputs() != null) {
                    spannableStringBuilder.append("\n    ").append(bold(getString(R$string.notification_log_details_remoteinput))).append(string).append(String.valueOf(action.getRemoteInputs().length));
                }
                i++;
            }
        }
        if (notification.contentView != null) {
            spannableStringBuilder.append("\n").append(bold(getString(R$string.notification_log_details_content_view))).append(string).append(notification.contentView.toString());
        }
        ...
        spannableStringBuilder.append("\n").append(bold(getString(R$string.notification_log_details_parcel))).append(string).append(String.valueOf(obtain.dataPosition())).append(' ').append(bold(getString(R$string.notification_log_details_ashmem))).append(string).append(String.valueOf(obtain.getOpenAshmemSize())).append("\n");
        return spannableStringBuilder;
    }
    ...
    private static class HistoricalNotificationPreference extends Preference {
        ...
        public void onBindViewHolder(PreferenceViewHolder preferenceViewHolder) {
            ...
            preferenceViewHolder.findViewById(R$id.timestamp).setOnLongClickListener(new C1180xd404025a(this, preferenceViewHolder));
        }
