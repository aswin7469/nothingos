...
public class ZenCustomRuleMessagesSettings extends ZenCustomRuleSettingsBase {
    ...
    public void updatePreferences() {
        ...
        getPreferenceScreen().findPreference("footer_preference").setTitle((CharSequence) this.mContext.getResources().getString(R$string.zen_mode_custom_messages_footer, new Object[]{this.mRule.getName()}));
    }
}
