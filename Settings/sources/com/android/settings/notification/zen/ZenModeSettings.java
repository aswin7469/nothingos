...
public class ZenModeSettings extends ZenModeSettingsBase {
    ...
    public static class SummaryBuilder {
        ...
        public String getOtherSoundCategoriesSummary(NotificationManager.Policy policy) {
            List<String> enabledCategories = getEnabledCategories(policy, new ZenModeSettings$SummaryBuilder$$ExternalSyntheticLambda0(), true);
        ...
        public String getCallsSettingSummary(NotificationManager.Policy policy) {
            List<String> enabledCategories = getEnabledCategories(policy, new ZenModeSettings$SummaryBuilder$$ExternalSyntheticLambda1(), true);
            int size = enabledCategories.size();
            if (size == 0) {
        ...
        public String getMessagesSettingSummary(NotificationManager.Policy policy) {
            List<String> enabledCategories = getEnabledCategories(policy, new ZenModeSettings$SummaryBuilder$$ExternalSyntheticLambda2(), true);
            int size = enabledCategories.size();
            if (size == 0) {
