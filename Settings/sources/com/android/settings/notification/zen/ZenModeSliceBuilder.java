...
public class ZenModeSliceBuilder {
    ...
    public static Slice getSlice(Context context) {
        ...
        ListBuilder.RowBuilder primaryAction = new ListBuilder.RowBuilder().setTitle(text).addEndItem(SliceAction.createToggle(broadcastIntent, null, isZenModeEnabled)).setPrimaryAction(SliceAction.createDeeplink(getPrimaryAction(context), null, 0, text));
    ...
    private static PendingIntent getBroadcastIntent(Context context) {
        return PendingIntent.getBroadcast(context, 0, new Intent("com.android.settings.notification.ZEN_MODE_CHANGED").setClass(context, SliceBroadcastReceiver.class), 301989888);
    }
}
