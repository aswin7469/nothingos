...
public class ZenRuleVisEffectsAllPreferenceController extends AbstractZenCustomRulePreferenceController {
    ...
    public void displayPreference(PreferenceScreen preferenceScreen) {
        ...
        radioButtonPreference.setOnClickListener(new RadioButtonPreference.OnClickListener() { // from class: com.android.settings.notification.zen.ZenRuleVisEffectsAllPreferenceController$$ExternalSyntheticLambda0
            ...
            public final void onRadioButtonClicked(RadioButtonPreference radioButtonPreference2) {
                ZenRuleVisEffectsAllPreferenceController.this.lambda$displayPreference$0(radioButtonPreference2);
            }
        });
    }
