...
public class PanelFragment extends Fragment {
    ...
    private ViewTreeObserver.OnPreDrawListener mOnPreDrawListener = new PanelFragment$$ExternalSyntheticLambda0();
    ...
    private void loadAllSlices() {
        ...
        for (Uri next : slices) {
            LiveData<Slice> fromUri = SliceLiveData.fromUri(getActivity(), next, new PanelFragment$$ExternalSyntheticLambda4(this, next));
            this.mSliceLiveData.put(next, fromUri);
            fromUri.observe(getViewLifecycleOwner(), new PanelFragment$$ExternalSyntheticLambda5(this, next));
        }
    }
    ...
    public View.OnClickListener getCloseListener() {
        return new PanelFragment$$ExternalSyntheticLambda3(this);
    }
