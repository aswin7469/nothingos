...
import com.nothing.settings.face.FaceEnrollImpl;
import com.nothing.settings.face.FaceUtils;
import com.nothing.settings.face.IFaceEnroll;
...
public class ChooseLockGeneric extends SettingsActivity {
    ...
    public static class ChooseLockGenericFragment extends SettingsPreferenceFragment {
        ...
        private IFaceEnroll mFaceEnroll;
            ...
            if (lockPatternUtils != null) {
                if (this.mIsManagedProfile) {
                    if (lockPatternUtils.isSeparateProfileChallengeEnabled(this.mUserId)) {
                        getActivity().setTitle(this.mDpm.getResources().getString("Settings.LOCK_SETTINGS_UPDATE_PROFILE_LOCK_TITLE", new C1256x320961c5(this)));
                    } else {
                        getActivity().setTitle(this.mDpm.getResources().getString("Settings.LOCK_SETTINGS_NEW_PROFILE_LOCK_TITLE", new C1257x320961c6(this)));
                    }
        ...
        public void addHeaderView() {
            ...
            if (this.mForFingerprint) {
                ...
                textView.setText(this.mDpm.getResources().getString("Settings.WORK_PROFILE_SCREEN_LOCK_SETUP_MESSAGE", new C1258x320961c7(this)));
            } else {
                textView.setText("");
            }
        }
        ...
        public void addPreferences() {
            ...
            if (!TextUtils.isEmpty(this.mCallerAppName) && !this.mIsCallingAppAdmin) {
                ...
                footerPreference.setTitle((CharSequence) getFooterString());
                ...
                StringBuilder sb = new StringBuilder(this.mDpm.getResources().getString("Settings.WORK_PROFILE_IT_ADMIN_CANT_RESET_SCREEN_LOCK", new C1259x320961c8(this)));
                footerPreference.setVisible(true);
                footerPreference.setTitle((CharSequence) sb);
                StringBuilder sb2 = new StringBuilder(this.mDpm.getResources().getString("Settings.WORK_PROFILE_IT_ADMIN_CANT_RESET_SCREEN_LOCK_ACTION", new C1260x320961c9(this)));
                C1261x320961ca chooseLockGeneric$ChooseLockGenericFragment$$ExternalSyntheticLambda5 = new C1261x320961ca(this, managedProfileId);
                footerPreference.setLearnMoreText(sb2);
                footerPreference.setLearnMoreAction(chooseLockGeneric$ChooseLockGenericFragment$$ExternalSyntheticLambda5);
            }
        ...
        public void updateUnlockMethodAndFinish(int i, boolean z, boolean z2) {
            if (this.mPasswordConfirmed) {
                ...
                if (intentForUnlockMethod != null) {
                    ...
                    if (iFaceEnroll != null) {
                        iFaceEnroll.deleteFaceMetadatas();
                        FaceUtils.setFaceDataCount(getPrefContext(), 0);
                    }
        ...
        private int getResIdForFactoryResetProtectionWarningMessage() {
            ...
            IFaceEnroll iFaceEnroll = this.mFaceEnroll;
            if (iFaceEnroll != null && iFaceEnroll.getFaceMetadatasCount() > 0) {
                z = true;
            }
        ...
        public boolean setUnlockMethod(String str) {
            ...
            if (fromKey != null) {
                switch (C12551.$SwitchMap$com$android$settings$password$ScreenLockType[fromKey.ordinal()]) {
                    case 1:
                    case 2:
        ...
        public static class FactoryResetProtectionWarningDialog extends InstrumentedDialogFragment {
            ...
            public Dialog onCreateDialog(Bundle bundle) {
                Bundle arguments = getArguments();
                return new AlertDialog.Builder(getActivity()).setTitle(arguments.getInt("titleRes")).setMessage(arguments.getInt("messageRes")).setPositiveButton(R$string.unlock_disable_frp_warning_ok, (DialogInterface.OnClickListener) new C1262x10535b07(this, arguments)).setNegativeButton(R$string.cancel, (DialogInterface.OnClickListener) new C1263x10535b08(this)).create();
            }
    ...
    static /* synthetic */ class C12551 {
        ...
        static {
            ...
            L_0x0049:
                return
            */
            throw new UnsupportedOperationException("Method not decompiled: com.android.settings.password.ChooseLockGeneric.C12551.<clinit>():void");
        }
    }
}
