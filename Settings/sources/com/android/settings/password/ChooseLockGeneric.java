    ...
    public static class ChooseLockGenericFragment extends SettingsPreferenceFragment {
        ...
        protected void addHeaderView() {
            ...
            if (this.mForFingerprint) {
                ...
                if (this.mController.isScreenLockRestrictedByAdmin() && managedProfileId != -10000) {
                    LinkifyUtils.linkify(textView, new StringBuilder(getText(R.string.lock_settings_picker_admin_restricted_personal_message)), new LinkifyUtils.OnClickListener() { // from class: com.android.settings.password.ChooseLockGeneric$ChooseLockGenericFragment$$ExternalSyntheticLambda0
                        @Override // com.android.settings.LinkifyUtils.OnClickListener
                        public final void onClick() {
                            ChooseLockGeneric.ChooseLockGenericFragment.this.lambda$addHeaderView$0(managedProfileId);
                        }
                    });
                } else {
                    textView.setText("");
        ...
        private void updatePreferenceSummaryIfNeeded() {
            if (StorageManager.isBlockEncrypted() && !StorageManager.isNonDefaultBlockEncrypted() && !AccessibilityManager.getInstance(getActivity()).getEnabledAccessibilityServiceList(-1).isEmpty()) {
                ...
                int i = R.string.secure_lock_encryption_warning;
        ...
        void updateUnlockMethodAndFinish(int i, boolean z, boolean z2) {
            ...
            if (intentForUnlockMethod != null) {
                ...
                if (ntIFaceRecognition != null) {
                    ntIFaceRecognition.deleteFaceMetadatas();
                    NtFaceUtil.setFaceDataCount(getPrefContext(), 0);
                }
        ...
        private int getResIdForFactoryResetProtectionWarningMessage() {
            ...
            NtIFaceRecognition ntIFaceRecognition = this.mNtIFaceRecognition;
            if (ntIFaceRecognition != null && ntIFaceRecognition.getFaceMetadatasCount() > 0) {
                z = true;
            }
