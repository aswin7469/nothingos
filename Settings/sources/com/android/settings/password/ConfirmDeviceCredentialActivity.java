    ...
    private String getTitleFromCredentialType(int i, boolean z) {
        if (i != 1) {
            if (i != 3) {
                ...
                if (z) {
                    return this.mDevicePolicyManager.getResources().getString("Settings.CONFIRM_WORK_PROFILE_PASSWORD_HEADER", new ConfirmDeviceCredentialActivity$$ExternalSyntheticLambda3(this));
                }
                return getString(R$string.lockpassword_confirm_your_password_header);
            } else if (z) {
                return this.mDevicePolicyManager.getResources().getString("Settings.CONFIRM_WORK_PROFILE_PIN_HEADER", new ConfirmDeviceCredentialActivity$$ExternalSyntheticLambda1(this));
            } else {
                return getString(R$string.lockpassword_confirm_your_pin_header);
            }
        } else if (z) {
            return this.mDevicePolicyManager.getResources().getString("Settings.CONFIRM_WORK_PROFILE_PATTERN_HEADER", new ConfirmDeviceCredentialActivity$$ExternalSyntheticLambda2(this));
        } else {
    ...
    private String getDetailsFromCredentialType(int i, boolean z) {
        if (i != 1) {
            if (i != 3) {
                ...
                if (z) {
                    return this.mDevicePolicyManager.getResources().getString("Settings.WORK_PROFILE_CONFIRM_PASSWORD", new ConfirmDeviceCredentialActivity$$ExternalSyntheticLambda6(this));
                }
                return getString(R$string.lockpassword_confirm_your_password_generic);
            } else if (z) {
                return this.mDevicePolicyManager.getResources().getString("Settings.WORK_PROFILE_CONFIRM_PIN", new ConfirmDeviceCredentialActivity$$ExternalSyntheticLambda4(this));
            } else {
                return getString(R$string.lockpassword_confirm_your_pin_generic);
            }
        } else if (z) {
            return this.mDevicePolicyManager.getResources().getString("Settings.WORK_PROFILE_CONFIRM_PATTERN", new ConfirmDeviceCredentialActivity$$ExternalSyntheticLambda5(this));
        } else {
