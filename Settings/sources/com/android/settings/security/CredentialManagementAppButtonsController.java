...
public class CredentialManagementAppButtonsController extends BasePreferenceController {
    ...
    public void displayPreference(PreferenceScreen preferenceScreen) {
        ...
        this.mExecutor.execute(new C1332x68006a66(this, preferenceScreen));
    }
    ...
    public /* synthetic */ void lambda$displayPreference$1(PreferenceScreen preferenceScreen) {
        ...
        this.mHandler.post(new C1331x68006a65(this, preferenceScreen));
    }
    ...
    public void lambda$displayPreference$0(PreferenceScreen preferenceScreen) {
        if (this.mHasCredentialManagerPackage) {
            ((ActionButtonsPreference) preferenceScreen.findPreference(getPreferenceKey())).setButton1Text(R$string.uninstall_certs_credential_management_app).setButton1Icon(R$drawable.ic_upload).setButton1OnClickListener(new C1334x68006a68(this)).setButton2Text(R$string.remove_credential_management_app).setButton2Icon(this.mRemoveIcon).setButton2OnClickListener(new C1335x68006a69(this));
        }
    }
    ...
    private void uninstallCertificates() {
        this.mExecutor.execute(new C1333x68006a67(this));
    }
    ...
    public static class RemoveCredentialManagementAppDialog extends InstrumentedDialogFragment {
        ...
        public Dialog onCreateDialog(Bundle bundle) {
            return new AlertDialog.Builder(getContext(), R$style.Theme_AlertDialog).setTitle(R$string.remove_credential_management_app_dialog_title).setMessage(R$string.remove_credential_management_app_dialog_message).setPositiveButton(R$string.remove_credential_management_app, (DialogInterface.OnClickListener) new C1336xe8f0fbac(this)).setNegativeButton(R$string.cancel, (DialogInterface.OnClickListener) new C1337xe8f0fbad(this)).create();
        }
        ...
        private void removeCredentialManagementApp() {
            Executors.newSingleThreadExecutor().execute(new C1338xe8f0fbae(this));
        }
