...
public final class CredentialStorage extends FragmentActivity {
    ...
    private class ResetDialog implements DialogInterface.OnClickListener, DialogInterface.OnDismissListener {
        ...
        private ResetDialog() {
            AlertDialog create = new AlertDialog.Builder(CredentialStorage.this).setTitle(17039380).setMessage(R$string.credentials_reset_hint).setPositiveButton(17039370, (DialogInterface.OnClickListener) this).setNegativeButton(17039360, (DialogInterface.OnClickListener) this).create();
    ...
    private boolean checkCallerIsSelf() {
        try {
            if (Process.myUid() == ActivityManager.getService().getLaunchedFromUid(getActivityToken())) {
                return true;
            }
            return false;
