...
public class SecuritySettings extends DashboardFragment {
    ...
    public static List<AbstractPreferenceController> buildPreferenceControllers(Context context, Lifecycle lifecycle, SecuritySettings securitySettings) {
        ...
        arrayList3.add(new FaceProfileStatusPreferenceController(context, lifecycle));
        arrayList3.add(new FingerprintProfileStatusPreferenceController(context, lifecycle));
        arrayList3.add(new CombinedBiometricProfileStatusPreferenceController(context, lifecycle));
