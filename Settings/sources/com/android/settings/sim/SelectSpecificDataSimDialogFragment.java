...
public class SelectSpecificDataSimDialogFragment extends SimDialogFragment implements DialogInterface.OnClickListener {
    ...
    private void updateDialog(AlertDialog alertDialog) {
        ...
        if (!this.mWasDismissed) {
            ...
            String string = getContext().getString(R$string.select_specific_sim_for_data_button, new Object[]{uniqueSubscriptionDisplayName});
            String string2 = getContext().getString(R$string.select_specific_sim_for_data_msg, new Object[]{uniqueSubscriptionDisplayName, uniqueSubscriptionDisplayName2});
