...
public class MDNHandlerFragment extends Fragment implements Instrumentable {
    ...
    public View onCreateView(LayoutInflater layoutInflater, ViewGroup viewGroup, Bundle bundle) {
        ...
        ((Button) inflate.findViewById(R$id.process)).setOnClickListener(new MDNHandlerFragment$$ExternalSyntheticLambda0(this));
    ...
    private void pressButtonOnClick() {
        ...
        if (TextUtils.isEmpty(str2) || TextUtils.isEmpty(strArr[1])) {
            new AlertDialog.Builder(getActivity()).setTitle(R$string.smart_forwarding_failed_title).setMessage(R$string.smart_forwarding_missing_mdn_text).setPositiveButton(R$string.smart_forwarding_missing_alert_dialog_text, new MDNHandlerFragment$$ExternalSyntheticLambda2()).create().show();
            return;
        }
