...
public class SmartForwardingActivity extends SettingsBaseActivity {
    ...
    public void enableSmartForwarding(String[] strArr) {
        ...
        Futures.addCallback(this.service.submit(new EnableSmartForwardingTask(this, strArr)), new FutureCallback<EnableSmartForwardingTask.FeatureResult>() {
            ...
            public void onFailure(Throwable th) {
                ...
                progressDialog.dismiss();
                new AlertDialog.Builder(SmartForwardingActivity.this).setTitle(R$string.smart_forwarding_failed_title).setMessage(R$string.smart_forwarding_failed_text).setPositiveButton(R$string.smart_forwarding_missing_alert_dialog_text, new SmartForwardingActivity$1$$ExternalSyntheticLambda0()).create().show();
            }
    ...
    public void onError(EnableSmartForwardingTask.FeatureResult featureResult) {
        ...
        new AlertDialog.Builder(this).setTitle(R$string.smart_forwarding_failed_title).setMessage(i).setPositiveButton(R$string.smart_forwarding_missing_alert_dialog_text, new SmartForwardingActivity$$ExternalSyntheticLambda0()).create().show();
    }
}
