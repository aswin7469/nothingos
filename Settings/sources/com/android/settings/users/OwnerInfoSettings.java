...
public class OwnerInfoSettings extends InstrumentedDialogFragment implements DialogInterface.OnClickListener {
    ...
    public Dialog onCreateDialog(Bundle bundle) {
        ...
        initView();
        return new AlertDialog.Builder(getActivity()).setTitle(R$string.owner_info_settings_title).setView(this.mView).setPositiveButton(R$string.save, (DialogInterface.OnClickListener) this).setNegativeButton(R$string.cancel, (DialogInterface.OnClickListener) this).show();
    }
