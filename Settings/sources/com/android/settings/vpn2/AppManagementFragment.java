...
public class AppManagementFragment extends SettingsPreferenceFragment implements Preference.OnPreferenceChangeListener, Preference.OnPreferenceClickListener, ConfirmLockdownFragment.ConfirmLockdownListener {
    ...
    public void onResume() {
        ...
        if (loadInfo()) {
            ...
            if (getPreferenceScreen().findPreference("version") == null) {
                C13932 r0 = new Preference(getPrefContext()) {
                ...
                r0.setOrder(0);
                r0.setKey("version");
                r0.setTitle(R$string.vpn_version);
                r0.setSummary((CharSequence) this.mPackageInfo.versionName);
                r0.setSelectable(false);
    ...
    public static class CannotConnectFragment extends InstrumentedDialogFragment {
        ...
        public Dialog onCreateDialog(Bundle bundle) {
            ...
            return new AlertDialog.Builder(getActivity()).setTitle((CharSequence) getActivity().getString(R$string.vpn_cant_connect_title, new Object[]{string})).setMessage((CharSequence) getActivity().getString(R$string.vpn_cant_connect_message)).setPositiveButton(R$string.okay, (DialogInterface.OnClickListener) null).create();
        }
    }
}
