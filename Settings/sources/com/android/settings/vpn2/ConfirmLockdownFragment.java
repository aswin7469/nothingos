...
public class ConfirmLockdownFragment extends InstrumentedDialogFragment implements DialogInterface.OnClickListener {
    ...
    public Dialog onCreateDialog(Bundle bundle) {
        ...
        return new AlertDialog.Builder(getActivity()).setTitle(i).setMessage(i3).setNegativeButton(R$string.cancel, (DialogInterface.OnClickListener) null).setPositiveButton(i2, (DialogInterface.OnClickListener) this).create();
    }
