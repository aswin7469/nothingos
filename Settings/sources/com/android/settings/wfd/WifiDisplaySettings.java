...
public final class WifiDisplaySettings extends SettingsPreferenceFragment {
    ...
    private final BroadcastReceiver mReceiver = new BroadcastReceiver() {
        public void onReceive(Context context, Intent intent) {
            ...
            } else if (action.equals("android.net.wifi.p2p.STATE_CHANGED") && WifiDisplaySettings.this.mDisplayManager.getWifiDisplayStatus().getActiveDisplayState() == 0) {
                if (intent.getIntExtra("wifi_p2p_state", 1) == 2) {
                    Settings.Global.putInt(WifiDisplaySettings.this.getContentResolver(), "wifi_display_on", 1);
                    WifiDisplaySettings.this.mDisplayManager.startWifiDisplayScan();
                    return;
                }
                Settings.Global.putInt(WifiDisplaySettings.this.getContentResolver(), "wifi_display_on", 0);
            }
        }
    };
    ...
    private final Runnable mUpdateRunnable = new Runnable() {
        public void run() {
            int r0 = WifiDisplaySettings.this.mPendingChanges;
            WifiDisplaySettings.this.mPendingChanges = 0;
            WifiDisplaySettings.this.update(r0);
        }
    };
    ...
    private void buildCertificationMenu(PreferenceScreen preferenceScreen) {
        ...
        C14082 r11 = new NtCustSwitchPreference(getPrefContext()) {
        ...
        r11.setTitle(R$string.wifi_display_listen_mode);
        r11.setChecked(this.mListen);
        this.mCertCategory.addPreference(r11);
        C14093 r112 = new NtCustSwitchPreference(getPrefContext()) {
            /* access modifiers changed from: protected */
            public void onClick() {
                WifiDisplaySettings wifiDisplaySettings = WifiDisplaySettings.this;
        ...
        r112.setTitle(R$string.wifi_display_autonomous_go);
    ...
    public void setListenMode(final boolean z) {
        C14159 r0 = new WifiP2pManager.ActionListener() {
            public void onSuccess() {
            }
    ...
    public void showWifiDisplayOptionsDialog(final WifiDisplay wifiDisplay) {
        ...
        C140211 r2 = new DialogInterface.OnClickListener() {
        ...
        new AlertDialog.Builder(getActivity()).setCancelable(true).setTitle(R$string.wifi_display_options_title).setView(inflate).setPositiveButton(R$string.wifi_display_options_done, (DialogInterface.OnClickListener) r2).setNegativeButton(R$string.wifi_display_options_forget, (DialogInterface.OnClickListener) new DialogInterface.OnClickListener() {
            public void onClick(DialogInterface dialogInterface, int i) {
