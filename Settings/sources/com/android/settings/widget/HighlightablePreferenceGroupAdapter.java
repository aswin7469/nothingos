...
public class HighlightablePreferenceGroupAdapter extends PreferenceGroupAdapter {
    ...
    public void requestHighlight(View view, RecyclerView recyclerView, AppBarLayout appBarLayout) {
        ...
        if (!this.mHighlightRequested && recyclerView != null && !TextUtils.isEmpty(this.mHighlightKey) && (preferenceAdapterPosition = getPreferenceAdapterPosition(this.mHighlightKey)) >= 0) {
            if (appBarLayout != null) {
                view.postDelayed(new HighlightablePreferenceGroupAdapter$$ExternalSyntheticLambda1(appBarLayout), DELAY_COLLAPSE_DURATION_MILLIS);
            }
            view.postDelayed(new HighlightablePreferenceGroupAdapter$$ExternalSyntheticLambda2(this, recyclerView, preferenceAdapterPosition), DELAY_HIGHLIGHT_DURATION_MILLIS);
            view.postDelayed(new HighlightablePreferenceGroupAdapter$$ExternalSyntheticLambda3(this, preferenceAdapterPosition), 900);
        }
    }
    ...
    public void requestRemoveHighlightDelayed(PreferenceViewHolder preferenceViewHolder) {
        preferenceViewHolder.itemView.postDelayed(new HighlightablePreferenceGroupAdapter$$ExternalSyntheticLambda0(this, preferenceViewHolder), 15000);
    }
    ...
    private void addHighlightBackground(PreferenceViewHolder preferenceViewHolder, boolean z) {
        ...
        ofObject.addUpdateListener(new HighlightablePreferenceGroupAdapter$$ExternalSyntheticLambda5(view));
    ...
    private void removeHighlightBackground(final PreferenceViewHolder preferenceViewHolder, boolean z) {
        ...
        ofObject.addUpdateListener(new HighlightablePreferenceGroupAdapter$$ExternalSyntheticLambda4(view));
