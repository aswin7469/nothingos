...
public class NetworkRequestErrorDialogFragment extends InstrumentedDialogFragment {
    ...
    public Dialog onCreateDialog(Bundle bundle) {
        ...
        if (error_dialog_type2 == error_dialog_type) {
            builder.setMessage(R$string.network_connection_timeout_dialog_message).setPositiveButton(R$string.network_connection_timeout_dialog_ok, (DialogInterface.OnClickListener) new NetworkRequestErrorDialogFragment$$ExternalSyntheticLambda0(this)).setNegativeButton(R$string.cancel, (DialogInterface.OnClickListener) new NetworkRequestErrorDialogFragment$$ExternalSyntheticLambda1(this));
        } else {
            builder.setMessage(R$string.network_connection_errorstate_dialog_message).setPositiveButton(R$string.okay, (DialogInterface.OnClickListener) new NetworkRequestErrorDialogFragment$$ExternalSyntheticLambda2(this));
        }
