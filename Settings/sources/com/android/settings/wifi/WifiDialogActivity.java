...
public class WifiDialogActivity extends ObservableActivity implements WifiDialog.WifiDialogListener, WifiDialog2.WifiDialog2Listener, DialogInterface.OnDismissListener {
        ...
        if (hasWifiManager()) {
            ...
            if (accessPoint != null) {
                if (accessPoint.isSaved()) {
                    this.mWifiManager.forget(accessPoint.getConfig().networkId, (WifiManager.ActionListener) null);
        ...
        if (hasWifiManager()) {
            ...
            if (getIntent().getBooleanExtra(KEY_CONNECT_FOR_CALLER, true)) {
                if (config != null || wifiEntry == null || !wifiEntry.canConnect()) {
                    this.mWifiManager.connect(config, (WifiManager.ActionListener) null);
                } else {
    ...
    public void onSubmit(WifiDialog wifiDialog) {
        ...
        if (hasWifiManager()) {
            ...
            if (getIntent().getBooleanExtra(KEY_CONNECT_FOR_CALLER, true)) {
                if (config != null) {
                    this.mWifiManager.save(config, (WifiManager.ActionListener) null);
                    ...
                    this.mWifiManager.connect(accessPoint.getConfig(), (WifiManager.ActionListener) null);
                }
            }
            if (hasPermissionForResult()) {
