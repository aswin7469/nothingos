...
public class WifiSettings extends RestrictedSettingsFragment implements WifiPickerTracker.WifiPickerTrackerCallback, WifiDialog2.WifiDialog2Listener, DialogInterface.OnDismissListener {
    ...
    private final Runnable mHideProgressBarRunnable = new WifiSettings$$ExternalSyntheticLambda2(this);
    ...
    private final Runnable mUpdateWifiEntryPreferencesRunnable = new WifiSettings$$ExternalSyntheticLambda1(this);
    ...
    public void onActivityCreated(Bundle bundle) {
        ...
        this.mWifiPickerTracker = FeatureFactory.getFactory(context).getWifiTrackerLibProvider().createWifiPickerTracker(getSettingsLifecycle(), context, this.mMainHandler, this.mWorkerHandler, r5, 15000, 10000, this);
        if (getActivity() != null) {
    ...
    public boolean onContextItemSelected(MenuItem menuItem) {
        ...
        if (itemId == 2) {
            ...
            WifiDppUtils.showLockScreen(getContext(), new WifiSettings$$ExternalSyntheticLambda0(this));
            return true;
        }
    }
    ...
    public void onWifiStateChanged() {
        if (!this.mIsRestricted && !isFinishingOrDestroyed()) {
    ...
    public void onWifiEntriesChanged() {
        if (isFinishingOrDestroyed()) {
            Log.d("WifiSettings", "onWifiEntriesChanged: isFinishingOrDestroyed true");
            return;
        }
        boolean z = false;
        ...
        if (this.mOpenSsid != null) {
            Optional findFirst = this.mWifiPickerTracker.getWifiEntries().stream().filter(new WifiSettings$$ExternalSyntheticLambda7(this)).filter(new WifiSettings$$ExternalSyntheticLambda8()).filter(new WifiSettings$$ExternalSyntheticLambda9()).findFirst();
        ...
        if (this.mWifiPickerTracker.getWifiState() == 3) {
            ...
            if (connectedWifiEntry != null) {
                ...
                if (longPressWifiEntryPreference == null || longPressWifiEntryPreference.getWifiEntry() != connectedWifiEntry) {
                    ...
                    connectedWifiEntryPreference.setOnPreferenceClickListener(new WifiSettings$$ExternalSyntheticLambda3(this, connectedWifiEntry, connectedWifiEntryPreference));
                    connectedWifiEntryPreference.setOnGearClickListener(new WifiSettings$$ExternalSyntheticLambda4(this, connectedWifiEntryPreference));
                    if (this.mClickedConnect) {
                        this.mClickedConnect = false;
                        scrollToPreference((Preference) this.mConnectedWifiEntryPreferenceCategory);
                    }
                }
            } else {
                this.mConnectedWifiEntryPreferenceCategory.removeAll();
            ...
            for (WifiEntry next : this.mWifiPickerTracker.getWifiEntries()) {
                ...
                if (next.getHelpUriString() != null) {
                    createLongPressWifiEntryPreference.setOnButtonClickListener(new WifiSettings$$ExternalSyntheticLambda5(this, next));
                }
            ...
            if (!z) {
                ...
                View view = getView();
                if (view != null) {
                    view.postDelayed(this.mHideProgressBarRunnable, 1700);
                }
            }
    ...
    private void setOffMessage() {
        ...
        this.mStatusMessagePreference.setText(text, charSequence, new WifiSettings$$ExternalSyntheticLambda6(this));
        removeConnectedWifiEntryPreference();
        removeWifiEntryPreference();
