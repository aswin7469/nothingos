...
public class QrCamera extends Handler {
    ...
    public void stop() {
        ...
        if (camera != null) {
            try {
                ...
                Log.w("QrCamera", "stop camera fail " + e);
            }
        }
    }
    ...
    public class DecodingTask extends AsyncTask<Void, Void, String> {
        ...
        public String doInBackground(Void... voidArr) {
            ...
            while (true) {
                QrCamera.this.mCamera.setOneShotPreviewCallback(new Camera.PreviewCallback() { // from class: com.android.settings.wifi.qrcode.QrCamera$DecodingTask$$ExternalSyntheticLambda0
