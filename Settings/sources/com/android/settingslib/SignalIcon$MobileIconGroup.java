...
public class SignalIcon$MobileIconGroup extends SignalIcon$IconGroup {
    ...
    public SignalIcon$MobileIconGroup(final String str, final int[][] iArr, final int[][] iArr2, final int[] iArr3, final int i, final int i2, final int i3, final int i4, final int i5, int i6, int i7, boolean z) {
