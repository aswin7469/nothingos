...
public class ApplicationsState {
    ...
    public void ensureLabelDescription(AppEntry appEntry) {
        if (appEntry.labelDescription == null) {
            synchronized (appEntry) {
                appEntry.lambda$new$0(this.mContext);
            }
        }
    }
        ...
        final IPackageStatsObserver.Stub mStatsObserver = new IPackageStatsObserver.Stub() {
            ...
            public void onGetStatsCompleted(android.content.pm.PackageStats r13, boolean r14) {
                ...
                L_0x00fe:
                    ...
                    throw r12
                */
                throw new UnsupportedOperationException("Method not decompiled: com.android.settingslib.applications.ApplicationsState.BackgroundHandler.C15451.onGetStatsCompleted(android.content.pm.PackageStats, boolean):void");
            }
        };
