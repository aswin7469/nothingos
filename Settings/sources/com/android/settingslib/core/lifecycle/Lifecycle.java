...
public class Lifecycle extends LifecycleRegistry {
    ...
    private class LifecycleProxy implements LifecycleObserver {
        ...
        public void onLifecycleEvent(LifecycleOwner lifecycleOwner, Lifecycle.Event event) {
            switch (C15601.$SwitchMap$androidx$lifecycle$Lifecycle$Event[event.ordinal()]) {
                case 2:
    ...
    static /* synthetic */ class C15601 {
        ...
        static {
            ...
            L_0x0054:
                return
            */
            throw new UnsupportedOperationException("Method not decompiled: com.android.settingslib.core.lifecycle.Lifecycle.C15601.<clinit>():void");
        }
    }
}
