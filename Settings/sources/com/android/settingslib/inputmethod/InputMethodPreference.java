...
public class InputMethodPreference extends PrimarySwitchPreference implements Preference.OnPreferenceClickListener, Preference.OnPreferenceChangeListener {
    ...
    public void onBindViewHolder(PreferenceViewHolder preferenceViewHolder) {
        ...
        if (ntCustSwitch != null) {
            ntCustSwitch.setOnClickListener(new InputMethodPreference$$ExternalSyntheticLambda0(this, ntCustSwitch));
        }
    ...
    public /* synthetic */ void lambda$onBindViewHolder$0(NtCustSwitch ntCustSwitch, View view) {
