...
public class ZenDurationDialog {
    ...
    public void setupDialog(AlertDialog.Builder builder) {
        ...
        builder.setTitle(R$string.zen_mode_duration_settings_title).setNegativeButton(R$string.cancel, (DialogInterface.OnClickListener) null).setPositiveButton(R$string.okay, (DialogInterface.OnClickListener) new DialogInterface.OnClickListener() {
    ...
    public void setupRadioButtons(int i) {
        ...
        getConditionTagAt(i2).f236rb.setChecked(true);
    }
    ...
    private void bindTag(int i, View view, int i2) {
        ...
        if (conditionTag.f236rb == null) {
            conditionTag.f236rb = (RadioButton) this.mZenRadioGroup.getChildAt(i2);
        }
        if (i <= 0) {
        ...
        conditionTag.f236rb.setOnCheckedChangeListener(new CompoundButton.OnCheckedChangeListener() {
            public void onCheckedChanged(CompoundButton compoundButton, boolean z) {
                if (z) {
                    conditionTag.f236rb.setChecked(true);
                }
            }
        });
