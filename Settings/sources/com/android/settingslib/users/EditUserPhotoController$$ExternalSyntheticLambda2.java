...
public final /* synthetic */ class EditUserPhotoController$$ExternalSyntheticLambda2 implements Runnable {
    ...
    public /* synthetic */ EditUserPhotoController$$ExternalSyntheticLambda2(EditUserPhotoController editUserPhotoController, int i) {
        this.f$0 = editUserPhotoController;
        this.f$1 = i;
    }

    public final void run() {
        this.f$0.lambda$onDefaultIconSelected$2(this.f$1);
    }
}
