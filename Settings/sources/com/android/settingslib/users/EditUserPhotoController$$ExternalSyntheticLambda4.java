...
public final /* synthetic */ class EditUserPhotoController$$ExternalSyntheticLambda4 implements Runnable {
    ...
    public /* synthetic */ EditUserPhotoController$$ExternalSyntheticLambda4(EditUserPhotoController editUserPhotoController, Bitmap bitmap) {
        this.f$0 = editUserPhotoController;
        this.f$1 = bitmap;
    }

    public final void run() {
        this.f$0.lambda$onPhotoCropped$3(this.f$1);
    }
}
