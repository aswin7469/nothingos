...
public class EditUserPhotoController {
    ...
    private void onDefaultIconSelected(int i) {
        try {
            ThreadUtils.postOnBackgroundThread((Runnable) new EditUserPhotoController$$ExternalSyntheticLambda2(this, i)).get();
    ...
    private void onPhotoCropped(Uri uri) {
        ThreadUtils.postOnBackgroundThread((Runnable) new EditUserPhotoController$$ExternalSyntheticLambda1(this, uri));
    }
