...
public class AccessPoint implements Comparable<AccessPoint> {
    ...
    private boolean updateScores(WifiNetworkScoreCache wifiNetworkScoreCache, long j) {
        ...
        it2.forEachRemaining(new AccessPoint$$ExternalSyntheticLambda3(elapsedRealtime - j, it2));
        return updateSpeed();
    }
    ...
    /* JADX WARNING: Code restructure failed: missing block: B:24:0x004f, code lost:
        if (r4.getDetailedState() != r6.getDetailedState()) goto L_0x0051;
     */
    /* Code decompiled incorrectly, please refer to instructions dump. */
    public boolean update(android.net.wifi.WifiConfiguration r4, android.net.wifi.WifiInfo r5, android.net.NetworkInfo r6) {
        ...
        L_0x0012:
            ...
            r3.update(r4)
        L_0x001f:
            int r4 = r3.getWifiStandard()
            int r2 = r5.getWifiStandard()
    ...
    class AccessPointProvisioningCallback extends ProvisioningCallback {
        ...
        public void onProvisioningFailure(int i) {
            ...
            ThreadUtils.postOnMainThread(new C1590xb3759df7(this));
        }
        ...
        public void onProvisioningStatus(int i) {
            ...
            this.this$0.mOsuProvisioningComplete = false;
            if (equals) {
                ThreadUtils.postOnMainThread(new C1588xb3759df5(this));
            }
        }
        ...
        public void onProvisioningComplete() {
            ...
            this.this$0.mOsuFailure = null;
            this.this$0.mOsuStatus = null;
            ThreadUtils.postOnMainThread(new C1589xb3759df6(this));
            WifiManager r0 = this.this$0.getWifiManager();
            PasspointConfiguration passpointConfiguration = (PasspointConfiguration) r0.getMatchingPasspointConfigsForOsuProviders(Collections.singleton(this.this$0.mOsuProvider)).get(this.this$0.mOsuProvider);
            ...
            for (Pair pair : r0.getAllMatchingWifiConfigs(r0.getScanResults())) {
                WifiConfiguration wifiConfiguration = (WifiConfiguration) pair.first;
                if (TextUtils.equals(wifiConfiguration.getKey(), uniqueId)) {
                    r0.connect(new AccessPoint(this.this$0.mContext, wifiConfiguration, (List) ((Map) pair.second).get(0), (List) ((Map) pair.second).get(1)).getConfig(), this.this$0.mConnectListener);
                    return;
                }
            }
            if (this.this$0.mConnectListener != null) {
