...
public class WifiEntryPreference extends Preference implements WifiEntry.WifiEntryCallback, View.OnClickListener {
    ...
    private void updateIcon(boolean z, int i, int i2, boolean z2) {
        ...
        Drawable icon = this.mIconInjector.getIcon(z, i, i2, z2);
        if (icon != null) {
    ...
    public static class IconInjector {
        ...
        public Drawable getIcon(boolean z, int i, int i2, boolean z2) {
            return this.mContext.getDrawable(WifiUtils.getInternetIconResource(i, z, i2, z2));
        }
    }
