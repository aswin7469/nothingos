...
public abstract class NavigationBarView extends FrameLayout {
    ...
    protected abstract NavigationBarMenuView mo708createNavigationBarMenuView(Context context);
    ...
    public NavigationBarView(Context context, AttributeSet attributeSet, int i, int i2) {
        ...
        NavigationBarMenuView mo708createNavigationBarMenuView = mo708createNavigationBarMenuView(context2);
        this.menuView = mo708createNavigationBarMenuView;
        navigationBarPresenter.setMenuView(mo708createNavigationBarMenuView);
        navigationBarPresenter.setId(1);
        mo708createNavigationBarMenuView.setPresenter(navigationBarPresenter);
        navigationBarMenu.addMenuPresenter(navigationBarPresenter);
        navigationBarPresenter.initForMenu(getContext(), navigationBarMenu);
        int i5 = R$styleable.NavigationBarView_itemIconTint;
        if (obtainTintedStyledAttributes.hasValue(i5)) {
            mo708createNavigationBarMenuView.setIconTintList(obtainTintedStyledAttributes.getColorStateList(i5));
        } else {
            mo708createNavigationBarMenuView.setIconTintList(mo708createNavigationBarMenuView.createDefaultColorStateList(16842808));
        }
        ...
        if (resourceId != 0) {
            mo708createNavigationBarMenuView.setItemBackgroundRes(resourceId);
        } else {
        ...
        addView(mo708createNavigationBarMenuView);
    ...
    public static class SavedState extends AbsSavedState {
        public static final Parcelable.Creator<SavedState> CREATOR = new Parcelable.ClassLoaderCreator<SavedState>() { // from class: com.google.android.material.navigation.NavigationBarView.SavedState.1
            ...
            public SavedState mo703createFromParcel(Parcel parcel, ClassLoader classLoader) {
                return new SavedState(parcel, classLoader);
            }

            @Override // android.os.Parcelable.Creator
            /* renamed from: createFromParcel */
            public SavedState mo702createFromParcel(Parcel parcel) {
                return new SavedState(parcel, null);
            }

            @Override // android.os.Parcelable.Creator
            /* renamed from: newArray */
            public SavedState[] mo704newArray(int i) {
