...
public abstract class ImmutableList<E> extends ImmutableCollection<E> implements List<E>, RandomAccess {
    ...
    public static <E> ImmutableList<E> copyOf(Iterator<? extends E> it) {
        ...
        return new Builder().mo798add((Builder) next).addAll((Iterator) it).build();
    }
    ...
    public UnmodifiableIterator<E> mo831iterator() {
        return mo761listIterator();
    }

    @Override // java.util.List
    /* renamed from: listIterator */
    public UnmodifiableListIterator<E> mo761listIterator() {
        return mo762listIterator(0);
    }

    @Override // java.util.List
    /* renamed from: listIterator */
    public UnmodifiableListIterator<E> mo762listIterator(int i) {
    ...
    public ImmutableList<E> mo763subList(int i, int i2) {
    ...
    public class SubList extends ImmutableList<E> {
        ...
        /* renamed from: subList */
        public ImmutableList<E> mo766subList(int i, int i2) {
            Preconditions.checkPositionIndexes(i, i2, this.length);
            ImmutableList immutableList = ImmutableList.this;
            int i3 = this.offset;
            return immutableList.mo763subList(i + i3, i2 + i3);
        }
    }
    ...
    public static class ReverseImmutableList<E> extends ImmutableList<E> {
        ...
        public ImmutableList<E> mo766subList(int i, int i2) {
            Preconditions.checkPositionIndexes(i, i2, size());
            return this.forwardList.mo763subList(reversePosition(i2), reversePosition(i)).reverse();
        }
