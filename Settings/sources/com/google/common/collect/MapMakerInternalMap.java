...
public class MapMakerInternalMap<K, V, E extends InternalEntry<K, V, E>, S extends Segment<K, V, E, S>> extends AbstractMap<K, V> implements ConcurrentMap<K, V>, Serializable {
    static final WeakValueReference<Object, Object, DummyInternalEntry> UNSET_WEAK_VALUE_REFERENCE = new WeakValueReference<Object, Object, DummyInternalEntry>() { // from class: com.google.common.collect.MapMakerInternalMap.1
        ...
        public DummyInternalEntry mo802getEntry() {
            return null;
        }
    };
    ...
    public interface InternalEntryHelper<K, V, E extends InternalEntry<K, V, E>, S extends Segment<K, V, E, S>> {
        ...
        S mo815newSegment(MapMakerInternalMap<K, V, E, S> mapMakerInternalMap, int i, int i2);
    ...
    public static final class StrongKeyStrongValueEntry<K, V> extends AbstractStrongKeyEntry<K, V, StrongKeyStrongValueEntry<K, V>> {
        ...
        static final class Helper<K, V> implements InternalEntryHelper<K, V, StrongKeyStrongValueEntry<K, V>, StrongKeyStrongValueSegment<K, V>> {
            ...
            public StrongKeyStrongValueSegment<K, V> mo815newSegment(MapMakerInternalMap<K, V, StrongKeyStrongValueEntry<K, V>, StrongKeyStrongValueSegment<K, V>> mapMakerInternalMap, int i, int i2) {
    ...
    public static final class StrongKeyWeakValueEntry<K, V> extends AbstractStrongKeyEntry<K, V, StrongKeyWeakValueEntry<K, V>> implements WeakValueEntry<K, V, StrongKeyWeakValueEntry<K, V>> {
        ...
        static final class Helper<K, V> implements InternalEntryHelper<K, V, StrongKeyWeakValueEntry<K, V>, StrongKeyWeakValueSegment<K, V>> {
            ...
            @Override // com.google.common.collect.MapMakerInternalMap.InternalEntryHelper
            /* renamed from: newSegment  reason: collision with other method in class */
            public StrongKeyWeakValueSegment<K, V> mo815newSegment(MapMakerInternalMap<K, V, StrongKeyWeakValueEntry<K, V>, StrongKeyWeakValueSegment<K, V>> mapMakerInternalMap, int i, int i2) {
    ...
    public static final class WeakKeyStrongValueEntry<K, V> extends AbstractWeakKeyEntry<K, V, WeakKeyStrongValueEntry<K, V>> {
        ...
        static final class Helper<K, V> implements InternalEntryHelper<K, V, WeakKeyStrongValueEntry<K, V>, WeakKeyStrongValueSegment<K, V>> {
            ...
            @Override // com.google.common.collect.MapMakerInternalMap.InternalEntryHelper
            /* renamed from: newSegment  reason: collision with other method in class */
            public WeakKeyStrongValueSegment<K, V> mo815newSegment(MapMakerInternalMap<K, V, WeakKeyStrongValueEntry<K, V>, WeakKeyStrongValueSegment<K, V>> mapMakerInternalMap, int i, int i2) {
    ...
    public static final class WeakKeyWeakValueEntry<K, V> extends AbstractWeakKeyEntry<K, V, WeakKeyWeakValueEntry<K, V>> implements WeakValueEntry<K, V, WeakKeyWeakValueEntry<K, V>> {
        ...
        static final class Helper<K, V> implements InternalEntryHelper<K, V, WeakKeyWeakValueEntry<K, V>, WeakKeyWeakValueSegment<K, V>> {
            ...
            @Override // com.google.common.collect.MapMakerInternalMap.InternalEntryHelper
            /* renamed from: newSegment  reason: collision with other method in class */
            public WeakKeyWeakValueSegment<K, V> mo815newSegment(MapMakerInternalMap<K, V, WeakKeyWeakValueEntry<K, V>, WeakKeyWeakValueSegment<K, V>> mapMakerInternalMap, int i, int i2) {
    ...
    public static final class DummyInternalEntry implements InternalEntry<Object, Object, DummyInternalEntry> {
        ...
        @Override // com.google.common.collect.MapMakerInternalMap.InternalEntry
        /* renamed from: getNext */
        public DummyInternalEntry mo804getNext() {
            throw new AssertionError();
        }
    ...
    void reclaimValue(WeakValueReference<K, V, E> weakValueReference) {
        E mo802getEntry = weakValueReference.mo802getEntry();
        int hash = mo802getEntry.getHash();
        segmentFor(hash).reclaimValue((K) mo802getEntry.getKey(), hash, weakValueReference);
    }
    ...
    Segment<K, V, E, S> createSegment(int i, int i2) {
        return (S) this.entryHelper.mo815newSegment(this, i, i2);
    }
    ...
    public static abstract class Segment<K, V, E extends InternalEntry<K, V, E>, S extends Segment<K, V, E, S>> extends ReentrantLock {
        ...
        abstract E mo816castForTesting(InternalEntry<K, V, ?> internalEntry);
        ...
        void setValue(E e, V v) {
            this.map.entryHelper.setValue(mo817self(), e, v);
        }

        E copyEntry(E e, E e2) {
            return this.map.entryHelper.copy(mo817self(), e, e2);
        }
        ...
        V getLiveValueForTesting(InternalEntry<K, V, ?> internalEntry) {
            return getLiveValue(mo816castForTesting(internalEntry));
        }
        ...
        E getEntry(Object obj, int i) {
            if (this.count != 0) {
                for (E first = getFirst(i); first != null; first = (E) first.mo804getNext()) {
                    if (first.getHash() == i) {
            ...
            try {
                if (this.count != 0) {
                    ...
                    for (int i = 0; i < length; i++) {
                        for (E e = atomicReferenceArray.get(i); e != null; e = e.mo804getNext()) {
        ...
        V put(K k, int i, V v, boolean z) {
            ...
            try {
                ...
                for (InternalEntry internalEntry = e; internalEntry != null; internalEntry = internalEntry.mo804getNext()) {
                ...
                this.modCount++;
                E newEntry = this.map.entryHelper.newEntry(mo817self(), k, i, e);
                setValue(newEntry, v);
        ...
        void expand() {
            ...
            for (int i2 = 0; i2 < length; i2++) {
                ...
                if (e != null) {
                    InternalEntry mo804getNext = e.mo804getNext();
                    int hash = e.getHash() & length2;
                    if (mo804getNext == null) {
                        atomicReferenceArray2.set(hash, e);
                    } else {
                        InternalEntry internalEntry = e;
                        while (mo804getNext != null) {
                            int hash2 = mo804getNext.getHash() & length2;
                            if (hash2 != hash) {
                                internalEntry = mo804getNext;
                                hash = hash2;
                            }
                            mo804getNext = mo804getNext.mo804getNext();
                        }
        ...
        */
        boolean remove(Object obj, int i, Object obj2) {
            ...
            try {
                ...
                while (true) {
                    ...
                    internalEntry = internalEntry.mo804getNext();
                }
            } finally {
                unlock();
            }
        ...
        boolean reclaimKey(E e, int i) {
            ...
            try {
                ...
                for (InternalEntry internalEntry = e2; internalEntry != null; internalEntry = internalEntry.mo804getNext()) {
                    if (internalEntry == e) {
                        this.modCount++;
    ...
    public static final class StrongKeyStrongValueSegment<K, V> extends Segment<K, V, StrongKeyStrongValueEntry<K, V>, StrongKeyStrongValueSegment<K, V>> {
        ...
        public StrongKeyStrongValueSegment<K, V> mo817self() {
            return this;
        }
        ...
        public StrongKeyStrongValueEntry<K, V> mo816castForTesting(InternalEntry<K, V, ?> internalEntry) {
    ...
    public static final class StrongKeyWeakValueSegment<K, V> extends Segment<K, V, StrongKeyWeakValueEntry<K, V>, StrongKeyWeakValueSegment<K, V>> {
        ...
        @Override // com.google.common.collect.MapMakerInternalMap.Segment
        /* renamed from: self  reason: collision with other method in class */
        public StrongKeyWeakValueSegment<K, V> mo817self() {
            return this;
        }
        ...
        @Override // com.google.common.collect.MapMakerInternalMap.Segment
        /* renamed from: castForTesting  reason: collision with other method in class */
        public StrongKeyWeakValueEntry<K, V> mo816castForTesting(InternalEntry<K, V, ?> internalEntry) {
    ...
    public static final class WeakKeyStrongValueSegment<K, V> extends Segment<K, V, WeakKeyStrongValueEntry<K, V>, WeakKeyStrongValueSegment<K, V>> {
        ...
        @Override // com.google.common.collect.MapMakerInternalMap.Segment
        /* renamed from: self  reason: collision with other method in class */
        public WeakKeyStrongValueSegment<K, V> mo817self() {
            return this;
        }
        ...
        @Override // com.google.common.collect.MapMakerInternalMap.Segment
        /* renamed from: castForTesting  reason: collision with other method in class */
        public WeakKeyStrongValueEntry<K, V> mo816castForTesting(InternalEntry<K, V, ?> internalEntry) {
    ...
    public static final class WeakKeyWeakValueSegment<K, V> extends Segment<K, V, WeakKeyWeakValueEntry<K, V>, WeakKeyWeakValueSegment<K, V>> {
        ...
        @Override // com.google.common.collect.MapMakerInternalMap.Segment
        /* renamed from: self  reason: collision with other method in class */
        public WeakKeyWeakValueSegment<K, V> mo817self() {
            return this;
        }
        ...
        @Override // com.google.common.collect.MapMakerInternalMap.Segment
        /* renamed from: castForTesting  reason: collision with other method in class */
        public WeakKeyWeakValueEntry<K, V> mo816castForTesting(InternalEntry<K, V, ?> internalEntry) {
        ...
        while (i < 3) {
            ...
            for (int i2 = z; i2 < length; i2++) {
                ...
                for (int i4 = z; i4 < atomicReferenceArray.length(); i4++) {
                    for (E e = atomicReferenceArray.get(i4); e != null; e = e.mo804getNext()) {
    ...
    public abstract class HashIterator<T> implements Iterator<T> {
        ...
        boolean nextInChain() {
            ...
            if (e != null) {
                while (true) {
                    this.nextEntry = (E) e.mo804getNext();
                    E e2 = this.nextEntry;
                    if (e2 == null) {
                        return false;
                    }
    ...
    static abstract class AbstractSerializationProxy<K, V> extends ForwardingConcurrentMap<K, V> implements Serializable {
        ...
        public ConcurrentMap<K, V> mo848delegate() {
