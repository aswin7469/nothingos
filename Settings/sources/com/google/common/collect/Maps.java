...
public final class Maps {
    ...
    public static class KeySet<K, V> extends Sets.ImprovedAbstractSet<K> {
        ...
        /* JADX INFO: Access modifiers changed from: package-private */
        /* renamed from: map */
        public Map<K, V> mo819map() {
            return this.map;
        }

        @Override // java.util.AbstractCollection, java.util.Collection, java.lang.Iterable, java.util.Set
        public Iterator<K> iterator() {
            return Maps.keyIterator(mo819map().entrySet().iterator());
        }

        @Override // java.util.AbstractCollection, java.util.Collection, java.util.Set
        public int size() {
            return mo819map().size();
        }

        @Override // java.util.AbstractCollection, java.util.Collection, java.util.Set
        public boolean isEmpty() {
            return mo819map().isEmpty();
        }

        @Override // java.util.AbstractCollection, java.util.Collection, java.util.Set
        public boolean contains(Object obj) {
            return mo819map().containsKey(obj);
        }
    ...
    static class SortedKeySet<K, V> extends KeySet<K, V> implements SortedSet<K> {
        ...
        public Comparator<? super K> comparator() {
            return mo819map().comparator();
        }

        @Override // java.util.SortedSet
        public K first() {
            return mo819map().firstKey();
        }

        @Override // java.util.SortedSet
        public K last() {
            return mo819map().lastKey();
        }
    }
    ...
    public static class NavigableKeySet<K, V> extends SortedKeySet<K, V> implements NavigableSet<K> {
        ...
        public NavigableMap<K, V> mo819map() {
            return (NavigableMap) this.map;
        }

        @Override // java.util.NavigableSet
        public K lower(K k) {
            return mo819map().lowerKey(k);
        }

        @Override // java.util.NavigableSet
        public K floor(K k) {
            return mo819map().floorKey(k);
        }

        @Override // java.util.NavigableSet
        public K ceiling(K k) {
            return mo819map().ceilingKey(k);
        }

        @Override // java.util.NavigableSet
        public K higher(K k) {
            return mo819map().higherKey(k);
        }

        @Override // java.util.NavigableSet
        public K pollFirst() {
            return (K) Maps.keyOrNull(mo819map().pollFirstEntry());
        }

        @Override // java.util.NavigableSet
        public K pollLast() {
            return (K) Maps.keyOrNull(mo819map().pollLastEntry());
        }

        @Override // java.util.NavigableSet
        public NavigableSet<K> descendingSet() {
            return mo819map().descendingKeySet();
        }
        ...
        public NavigableSet<K> subSet(K k, boolean z, K k2, boolean z2) {
            return mo819map().subMap(k, z, k2, z2).navigableKeySet();
        }
        ...
        public NavigableSet<K> headSet(K k, boolean z) {
            return mo819map().headMap(k, z).navigableKeySet();
        }
        ...
        public NavigableSet<K> tailSet(K k, boolean z) {
            return mo819map().tailMap(k, z).navigableKeySet();
        }
    ...
    static abstract class DescendingMap<K, V> extends ForwardingMap<K, V> implements NavigableMap<K, V> {
        ...
        public final Map<K, V> mo848delegate() {
            return forward();
        }
