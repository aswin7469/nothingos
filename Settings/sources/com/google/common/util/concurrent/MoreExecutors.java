...
public final class MoreExecutors {
    ...
    public static final class ScheduledListeningDecorator extends ListeningDecorator implements ScheduledExecutorService {
        ...
        public ListenableScheduledFuture<?> mo849schedule(Runnable runnable, long j, TimeUnit timeUnit) {
        ...
        @Override // java.util.concurrent.ScheduledExecutorService
        /* renamed from: schedule */
        public <V> ListenableScheduledFuture<V> mo850schedule(Callable<V> callable, long j, TimeUnit timeUnit) {
        ...
        public ListenableScheduledFuture<?> mo851scheduleAtFixedRate(Runnable runnable, long j, long j2, TimeUnit timeUnit) {
        ...
        public ListenableScheduledFuture<?> mo852scheduleWithFixedDelay(Runnable runnable, long j, long j2, TimeUnit timeUnit) {
            NeverSuccessfulListenableFutureTask neverSuccessfulListenableFutureTask = new NeverSuccessfulListenableFutureTask(runnable);
