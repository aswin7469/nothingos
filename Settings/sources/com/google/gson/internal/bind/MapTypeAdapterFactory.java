...
public final class MapTypeAdapterFactory implements TypeAdapterFactory {
    ...
    private final class Adapter<K, V> extends TypeAdapter<Map<K, V>> {
        ...
        public Map<K, V> mo894read(JsonReader jsonReader) throws IOException {
            ...
            if (peek == JsonToken.BEGIN_ARRAY) {
                ...
                while (jsonReader.hasNext()) {
                    jsonReader.beginArray();
                    K mo894read = this.keyTypeAdapter.mo894read(jsonReader);
                    if (construct.put(mo894read, this.valueTypeAdapter.mo894read(jsonReader)) != null) {
                        throw new JsonSyntaxException("duplicate key: " + mo894read);
                    }
                    jsonReader.endArray();
                }
                jsonReader.endArray();
                ...
                while (jsonReader.hasNext()) {
                    ...
                    K mo894read2 = this.keyTypeAdapter.mo894read(jsonReader);
                    if (construct.put(mo894read2, this.valueTypeAdapter.mo894read(jsonReader)) != null) {
                        throw new JsonSyntaxException("duplicate key: " + mo894read2);
                    }
                }
