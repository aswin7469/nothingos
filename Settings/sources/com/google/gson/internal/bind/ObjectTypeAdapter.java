    ...
    public Object mo894read(JsonReader jsonReader) throws IOException {
        switch (AnonymousClass2.$SwitchMap$com$google$gson$stream$JsonToken[jsonReader.peek().ordinal()]) {
            ...
            case 2:
                ...
                while (jsonReader.hasNext()) {
                    linkedTreeMap.put(jsonReader.nextName(), mo894read(jsonReader));
                }
