...
public final class FieldSet<FieldDescriptorType extends FieldDescriptorLite<FieldDescriptorType>> {
    ...
    /* renamed from: clone */
    public FieldSet<FieldDescriptorType> m902clone() {
    ...
    /* JADX WARN: Code restructure failed: missing block: B:6:0x001b, code lost:
        if ((r3 instanceof com.google.protobuf.LazyField) == false) goto L7;
     */
    ...
    */
    ...
    private void mergeFromField(Map.Entry<FieldDescriptorType, Object> entry) {
        ...
        if (key.isRepeated()) {
            ...
            this.fields.put((SmallSortedMap<FieldDescriptorType, Object>) key, (FieldDescriptorType) key.internalMergeFrom(((MessageLite) field2).mo907toBuilder(), (MessageLite) value).mo908build());
        } else {
            this.fields.put((SmallSortedMap<FieldDescriptorType, Object>) key, (FieldDescriptorType) cloneIfMutable(value));
        }
    }
