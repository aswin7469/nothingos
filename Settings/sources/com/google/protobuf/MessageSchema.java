...
final class MessageSchema<T> implements Schema<T> {
    ...
    private <K, V> void writeMapHelper(Writer writer, int i, Object obj, int i2) throws IOException {
        if (obj != null) {
            ...
            writer.writeMap(i, (MapEntryLite.Metadata) null, this.mapFieldSchema.forMapData(obj));
        }
    }
    ...
    private final <K, V> void mergeMap(Object obj, int i, Object obj2, ExtensionRegistryLite extensionRegistryLite, Reader reader) throws IOException {
        ...
        reader.readMap(forMutableMapData, (MapEntryLite.Metadata) null, extensionRegistryLite);
    }
    ...
    private final <K, V, UT, UB> UB filterUnknownEnumMap(int i, int i2, Map<K, V> map, Internal.EnumVerifier enumVerifier, UB ub, UnknownFieldSchema<UT, UB> unknownFieldSchema2) {
        ...
        while (it.hasNext()) {
            ...
            if (!enumVerifier.isInRange(((Integer) next.getValue()).intValue())) {
                ...
                ByteString.CodedBuilder newCodedBuilder = ByteString.newCodedBuilder(MapEntryLite.computeSerializedSize((MapEntryLite.Metadata) null, next.getKey(), next.getValue()));
                try {
                    MapEntryLite.writeTo(newCodedBuilder.getCodedOutput(), (MapEntryLite.Metadata) null, next.getKey(), next.getValue());
