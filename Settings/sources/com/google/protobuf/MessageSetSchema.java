...
final class MessageSetSchema<T> implements Schema<T> {
    ...
    public T newInstance() {
        return (T) this.defaultInstance.mo906newBuilderForType().mo909buildPartial();
    }
    ...
    public int hashCode(T t) {
        int hashCode = this.unknownFieldSchema.mo927getFromMessage(t).hashCode();
    ...
    private <UT, UB> void writeUnknownFieldsHelper(UnknownFieldSchema<UT, UB> unknownFieldSchema, T t, Writer writer) throws IOException {
        unknownFieldSchema.writeAsMessageSetTo(unknownFieldSchema.mo927getFromMessage(t), writer);
    }
    ...
    private <UT, UB, ET extends FieldSet.FieldDescriptorLite<ET>> void mergeFromHelper(UnknownFieldSchema<UT, UB> unknownFieldSchema, ExtensionSchema<ET> extensionSchema, T t, Reader reader, ExtensionRegistryLite extensionRegistryLite) throws IOException {
        UB mo926getBuilderFromMessage = unknownFieldSchema.mo926getBuilderFromMessage(t);
        ...
        do {
            try {
                ...
                unknownFieldSchema.setBuilderToMessage(t, mo926getBuilderFromMessage);
            }
        } while (parseMessageSetItemOrUnknownField(reader, extensionRegistryLite, extensionSchema, mutableExtensions, unknownFieldSchema, mo926getBuilderFromMessage));
    }
    ...
    private <UT, UB> int getUnknownFieldsSerializedSize(UnknownFieldSchema<UT, UB> unknownFieldSchema, T t) {
        return unknownFieldSchema.getSerializedSizeAsMessageSet(unknownFieldSchema.mo927getFromMessage(t));
    }
}
