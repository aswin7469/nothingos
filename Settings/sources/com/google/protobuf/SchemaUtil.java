...
public final class SchemaUtil {
    ...
    public static <T, UT, UB> void mergeUnknownFields(UnknownFieldSchema<UT, UB> unknownFieldSchema, T t, T t2) {
        unknownFieldSchema.setToMessage(t, unknownFieldSchema.merge(unknownFieldSchema.mo927getFromMessage(t), unknownFieldSchema.mo927getFromMessage(t2)));
    }
    ...
    public static <UT, UB> UB filterUnknownEnumList(int i, List<Integer> list, Internal.EnumLiteMap<?> enumLiteMap, UB ub, UnknownFieldSchema<UT, UB> unknownFieldSchema) {
        ...
        if (list instanceof RandomAccess) {
            ...
            for (int i3 = 0; i3 < size; i3++) {
                ...
                if (enumLiteMap.mo402findValueByNumber(intValue) != null) {
                    if (i3 != i2) {
            ...
            while (it.hasNext()) {
                ...
                if (enumLiteMap.mo402findValueByNumber(intValue2) == null) {
