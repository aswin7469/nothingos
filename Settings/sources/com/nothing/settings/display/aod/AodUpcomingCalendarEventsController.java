...
public class AodUpcomingCalendarEventsController extends TogglePreferenceController {
    ...
    public AodUpcomingCalendarEventsController(Context context, String str) {
        super(context, str);
    }
