...
public class IllustrationPreference extends Preference {
    ...
    LottieAnimationView mIllustrationView;
    ...
    private void handleImageFrameMaxHeight(ImageView imageView, ImageView imageView2) {
        if (this.mMaxHeight != -1) {
            ...
            int dimensionPixelSize = resources.getDimensionPixelSize(R$dimen.nt_settingslib_illustration_width);
            int dimensionPixelSize2 = resources.getDimensionPixelSize(R$dimen.nt_settingslib_illustration_height);
    ...
    private void init(Context context, AttributeSet attributeSet) {
        setLayoutResource(R$layout.nt_illustration_preference);
