...
public class NotificationSettingPreferenceController extends BasePreferenceController implements Preference.OnPreferenceClickListener {
    ...
    public NotificationSettingPreferenceController(Context context, String str) {
        super(context, str);
    }
    ...
    public void updateState(Preference preference) {
        ThreadUtils.postOnBackgroundThread((Runnable) new C2025xfd87330c(this, preference));
    ...
    public void lambda$updateState$0(Preference preference) {
        try {
            ...
            if (title != null) {
                ThreadUtils.postOnMainThread(new C2024xfd87330b(preference, title));
            }
