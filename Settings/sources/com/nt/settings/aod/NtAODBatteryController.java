...
public class NtAODBatteryController extends TogglePreferenceController {
    private static final String SETTING_KEY = "aod_show_battery";
    ...
    public NtAODBatteryController(Context context, String str) {
        super(context, str);
    }
