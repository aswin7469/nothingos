...
public class NtAODNewNotificationReminderController extends TogglePreferenceController {
    private static final String SETTING_KEY = "aod_new_notification_reminder";
    ...
    public NtAODNewNotificationReminderController(Context context, String str) {
        super(context, str);
    }
