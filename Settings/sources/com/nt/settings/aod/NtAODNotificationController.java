...
public class NtAODNotificationController extends TogglePreferenceController {
    private static final String SETTING_KEY = "aod_show_notification";
    ...
    public NtAODNotificationController(Context context, String str) {
        super(context, str);
    }
