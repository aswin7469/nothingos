...
public class NtAODUpcomingCalendarEventsController extends TogglePreferenceController {
    private static final String SETTING_KEY = "aod_show_upcoming_calendar_events";
    ...
    public NtAODUpcomingCalendarEventsController(Context context, String str) {
        super(context, str);
    }
