...
public class NtAODWeatherController extends TogglePreferenceController {
    private static final String SETTING_KEY = "aod_show_weather";
    ...
    public NtAODWeatherController(Context context, String str) {
        super(context, str);
    }
