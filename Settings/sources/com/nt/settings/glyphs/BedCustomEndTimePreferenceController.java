...
public class BedCustomEndTimePreferenceController extends BasePreferenceController {
    ...
    public BedCustomEndTimePreferenceController(Context context, String str) {
        super(context, str);
    ...
    public final void updateState(Preference preference) {
        preference.setSummary(this.mTimeFormatter.getFormattedTimeString(getEndTime()));
    }
