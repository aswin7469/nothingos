...
public class GlyphsChargingSwitchPreferenceController extends TogglePreferenceController implements LifecycleObserver, OnResume, OnPause {
    ...
    public GlyphsChargingSwitchPreferenceController(Context context, String str) {
        super(context, str);
    }
    ...
    public boolean isChecked() {
        return Settings.Global.getInt(this.mContentResolver, "led_effect_charging_enable", 0) == 1;
    }
