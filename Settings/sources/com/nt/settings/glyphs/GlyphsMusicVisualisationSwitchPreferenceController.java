...
public class GlyphsMusicVisualisationSwitchPreferenceController extends TogglePreferenceController implements LifecycleObserver, OnResume, OnPause {
    ...
    public GlyphsMusicVisualisationSwitchPreferenceController(Context context, String str) {
        super(context, str);
    }
