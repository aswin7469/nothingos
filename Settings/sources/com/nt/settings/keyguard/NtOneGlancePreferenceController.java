package com.nt.settings.keyguard;
...
public class NtOneGlancePreferenceController extends TogglePreferenceController {
    ...
    public NtOneGlancePreferenceController(Context context, String str) {
        super(context, str);
    }
