...
public class NtUtils {
    ...
    public static void setListViewHoldPress(ListView listView) {
    }
    ...
    public static void trackRingtoneChanged(Context context, int i, String str, int i2) {
        ...
        Log.d("Settings.NtUtils", "trackRingtoneChanged: [APP_TRACKING] " + bundle.toString() + ", " + bundle2.toString());
    ...
    public static void setViewAdjustToActionbarAndMenuBar(Context context, View view) {
        int dimensionPixelSize = context.getResources().getDimensionPixelSize(R.dimen.nt_preference_category_margin_top);
        if (view.getLayoutParams() instanceof ViewGroup.MarginLayoutParams) {
            ((ViewGroup.MarginLayoutParams) view.getLayoutParams()).setMargins(view.getLeft(), -dimensionPixelSize, view.getRight(), view.getBottom());
        }
        if (view instanceof ListView) {
            setListViewHoldPress((ListView) view);
        }
    }
    ...
    public static void setViewPaddingBottom(Context context, View view) {
        if (view != null) {
            view.setPadding(view.getPaddingStart(), view.getPaddingTop(), view.getPaddingEnd(), context.getResources().getDimensionPixelSize(R.dimen.listview_padding_bottom));
        }
    }

    public static void startShakeAnim(View view) {
        ObjectAnimator.ofFloat(view, "translationX", 0.0f, 5.6f, 17.9f, 30.2f, 35.8f, 26.4f, 5.7f, -14.9f, -24.3f, -19.6f, -8.4f, 4.9f, 16.1f, 20.8f, 17.0f, 8.1f, -2.6f, -11.5f, -15.3f, -13.4f, -8.7f, -2.6f, 3.4f, 8.1f, 10.0f, 9.6f, 8.4f, 6.8f, 5.0f, 3.2f, 1.6f, 0.4f, 0.0f).setDuration(550L).start();
    }
