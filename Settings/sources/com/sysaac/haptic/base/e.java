...
public class e extends d {
    ...
    */
                        ...
                        if (i == 4096) {
                            ...
                            if (4096 == i) {
                                ...
                                if (!c(i5, 0, 5000)) {
                                    ...
                                    int[] b = b(jSONArray3);
                                    if (b != null) {
                                        System.arraycopy(b, 0, iArr2, i8 + 7, 48);
                                    }
                                }
                            }
                            i3++;
    ...
    /* JADX WARN: Removed duplicated region for block: B:51:0x01b7 A[Catch: Exception -> 0x0308, TryCatch #1 {Exception -> 0x0308, blocks: (B:35:0x00e1, B:119:0x00f0, B:38:0x0109, B:41:0x0111, B:117:0x0134, B:89:0x02eb, B:86:0x02f2, B:43:0x0153, B:45:0x016d, B:47:0x0174, B:49:0x01a1, B:51:0x01b7, B:99:0x01bd, B:53:0x01d6, B:97:0x01e3, B:55:0x01f3, B:56:0x0217, B:58:0x021d, B:62:0x0245, B:67:0x0250, B:70:0x0257, B:94:0x0273, B:76:0x028e, B:78:0x02a8, B:82:0x02b4, B:92:0x0297, B:104:0x017c, B:109:0x018d, B:111:0x0194, B:127:0x02c8), top: B:34:0x00e1 }] */
    /* JADX WARN: Removed duplicated region for block: B:80:0x02ad  */
    /* JADX WARN: Removed duplicated region for block: B:82:0x02b4 A[Catch: Exception -> 0x0308, LOOP:1: B:21:0x0085->B:82:0x02b4, LOOP_END, TryCatch #1 {Exception -> 0x0308, blocks: (B:35:0x00e1, B:119:0x00f0, B:38:0x0109, B:41:0x0111, B:117:0x0134, B:89:0x02eb, B:86:0x02f2, B:43:0x0153, B:45:0x016d, B:47:0x0174, B:49:0x01a1, B:51:0x01b7, B:99:0x01bd, B:53:0x01d6, B:97:0x01e3, B:55:0x01f3, B:56:0x0217, B:58:0x021d, B:62:0x0245, B:67:0x0250, B:70:0x0257, B:94:0x0273, B:76:0x028e, B:78:0x02a8, B:82:0x02b4, B:92:0x0297, B:104:0x017c, B:109:0x018d, B:111:0x0194, B:127:0x02c8), top: B:34:0x00e1 }] */
        ...
        try {
            ...
            while (true) {
                ...
                if (!TextUtils.equals("continuous", string)) {
                    ...
                    JSONObject jSONObject2 = jSONObject.getJSONObject("Parameters");
                    a2 = d.a(jSONObject2.getInt("Intensity"), jSONObject2.getInt("Frequency"));
                    jArr[i6 + 1] = a2;
                } else {
                    int i7 = i3 * 2;
        ...
        if (this.c == null) {
            ...
            try {
                ...
                if (!c) {
                    ...
                    if (!b(r.a(), r.b(), i5)) {
                        Log.e("PatternHeImpl", "richtap version check failed, richTapMajorVersion:" + String.format("%x02", Integer.valueOf(a2)) + " heVersion:" + i5);
                        return;
                    }
                } else {
                    i5 = 0;
                }
                int[] b = r.a() < 24 ? b(str) : c(str);
                if (b == null) {
            ...
            if (i >= 1) {
                try {
                    ...
                    if (!r.c()) {
                        ...
                        if (!b(r.a(), r.b(), i6)) {
                            Log.e("PatternHeImpl", "richtap version check failed, richTapMajorVersion:" + String.format("%x02", Integer.valueOf(a2)) + " heVersion:" + i6);
                            return;
                        }
                        i5 = i6;
                    } else {
                        ...
                        while (i7 < ((int) Math.ceil(d.length / 4.0d))) {
                            ...
                            try {
                                if (Build.VERSION.SDK_INT >= 26) {
                                    Class<?> cls = this.e;
                                    Class<?> cls2 = Integer.TYPE;
                                    this.c.vibrate((VibrationEffect) cls.getMethod("createPatternHeWithParam", int[].class, cls2, cls2, cls2, cls2).invoke(null, a3, Integer.valueOf(i), Integer.valueOf(i2), Integer.valueOf(i3), Integer.valueOf(i4)));
                                } else {
                                    Log.e("PatternHeImpl", "The system is low than 26,does not support richTap!!");
                                }
                            } catch (Exception e) {
