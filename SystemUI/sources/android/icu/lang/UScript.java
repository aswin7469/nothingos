...
public final class UScript {
    ...
    /* renamed from: YI */
    public static final int f21YI = 41;
    ...
    public static int[] getCode(ULocale uLocale) {
        throw new RuntimeException("Stub!");
    }
    ...
    public static int getScript(int i) {
        throw new RuntimeException("Stub!");
    }

    public static boolean hasScript(int i, int i2) {
        throw new RuntimeException("Stub!");
    }

    public static int getScriptExtensions(int i, BitSet bitSet) {
        throw new RuntimeException("Stub!");
    }
    ...
    public static ScriptUsage getUsage(int i) {
        throw new RuntimeException("Stub!");
    }
    ...
    public static boolean breaksBetweenLetters(int i) {
        throw new RuntimeException("Stub!");
    }

    public static boolean isCased(int i) {
        throw new RuntimeException("Stub!");
    }
}
