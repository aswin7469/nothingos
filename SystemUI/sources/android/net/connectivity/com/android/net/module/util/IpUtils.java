...
public class IpUtils {
    ...
    private static int checksum(ByteBuffer byteBuffer, int i, int i2, int i3) {
        ...
        int i6 = i2 + (i4 * 2);
        if (i3 != i6) {
            short s = (short) byteBuffer.get(i6);
            if (s < 0) {
                s = (short) (s + 256);
            }
            i += s * 256;
    ...
    private static short transportChecksum(ByteBuffer byteBuffer, int i, int i2, int i3, int i4) {
        ...
        if (i4 >= 0) {
            ...
            if (ipversion == 4) {
                i5 = pseudoChecksumIPv4(byteBuffer, i2, i, i4);
            } else if (ipversion == 6) {
                i5 = pseudoChecksumIPv6(byteBuffer, i2, i, i4);
            } else {
                throw new UnsupportedOperationException("Checksum must be IPv4 or IPv6");
            }
            int checksum = checksum(byteBuffer, i5, i3, i4 + i3);
