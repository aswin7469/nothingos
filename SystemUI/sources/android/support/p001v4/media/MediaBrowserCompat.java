...
public final class MediaBrowserCompat {
    ...
    public static class MediaItem implements Parcelable {
        ...
        public String toString() {
            ...
            sb.append(", mDescription=").append((Object) this.mDescription);
            sb.append('}');
            return sb.toString();
        }
    ...
    static class MediaBrowserImplBase implements MediaBrowserImpl, MediaBrowserServiceCallbackImpl {
        ...
        public void connect() {
            ...
            throw new IllegalStateException("connect() called while neigther disconnecting nor disconnected (state=" + getStateLabel(this.mState) + NavigationBarInflaterView.KEY_CODE_END);
        }
        ...
        public void search(final String str, final Bundle bundle, final SearchCallback searchCallback) {
            if (isConnected()) {
                ...
                throw new IllegalStateException("search() called while not connected (state=" + getStateLabel(this.mState) + NavigationBarInflaterView.KEY_CODE_END);
            }
        }
        ...
        public void onReceiveResult(int i, Bundle bundle) {
            if (this.mCallback != null) {
                ...
                if (i == -1) {
                    ...
                    Log.w(MediaBrowserCompat.TAG, "Unknown result code: " + i + " (extras=" + this.mExtras + ", resultData=" + bundle + NavigationBarInflaterView.KEY_CODE_END);
                } else {
    ...
    /* renamed from: android.support.v4.media.MediaBrowserCompat$Api21Impl */
