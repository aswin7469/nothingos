...
public final class MediaMetadataCompat implements Parcelable {
    ...
    private static final String[] PREFERRED_DESCRIPTION_ORDER = {"android.media.metadata.TITLE", "android.media.metadata.ARTIST", METADATA_KEY_ALBUM, "android.media.metadata.ALBUM_ARTIST", METADATA_KEY_WRITER, "android.media.metadata.AUTHOR", "android.media.metadata.COMPOSER"};
