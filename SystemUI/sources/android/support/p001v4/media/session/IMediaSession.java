...
public interface IMediaSession extends IInterface {
    ...
    /* renamed from: android.support.v4.media.session.IMediaSession$Default */
    ...
    public static abstract class Stub extends Binder implements IMediaSession {
        ...
        public boolean onTransact(int r5, android.os.Parcel r6, android.os.Parcel r7, int r8) throws android.os.RemoteException {
            ...
            L_0x003b:
                r6.enforceInterface(r2)
                android.os.Bundle r4 = r4.getSessionInfo()
                r7.writeNoException()
            ...
            L_0x008d:
                r6.enforceInterface(r2)
                boolean r4 = r4.isCaptioningEnabled()
                r7.writeNoException()
                r7.writeInt(r4)
                return r1
            L_0x009b:
            ...
            L_0x0117:
                r6.enforceInterface(r2)
                boolean r4 = r4.isShuffleModeEnabledRemoved()
                r7.writeNoException()
                r7.writeInt(r4)
                return r1
            L_0x0125:
            ...
            L_0x01c5:
                r6.enforceInterface(r2)
                java.lang.CharSequence r4 = r4.getQueueTitle()
                r7.writeNoException()
                if (r4 == 0) goto L_0x01d8
                r7.writeInt(r1)
                android.text.TextUtils.writeToParcel(r4, r7, r1)
                goto L_0x01db
            L_0x01d8:
                r7.writeInt(r0)
            L_0x01db:
            ...
            L_0x01dc:
                r6.enforceInterface(r2)
                java.util.List r4 = r4.getQueue()
                r7.writeNoException()
                r7.writeTypedList(r4)
                return r1
            L_0x01ea:
                r6.enforceInterface(r2)
            ...
            L_0x0201:
                r6.enforceInterface(r2)
                android.support.v4.media.MediaMetadataCompat r4 = r4.getMetadata()
                r7.writeNoException()
            ...
            L_0x033f:
                r6.enforceInterface(r2)
                android.support.v4.media.session.ParcelableVolumeInfo r4 = r4.getVolumeAttributes()
                r7.writeNoException()
            ...
            L_0x0364:
                r6.enforceInterface(r2)
                android.app.PendingIntent r4 = r4.getLaunchPendingIntent()
                r7.writeNoException()
            ...
            L_0x0397:
                r6.enforceInterface(r2)
                boolean r4 = r4.isTransportControlEnabled()
                r7.writeNoException()
                r7.writeInt(r4)
                return r1
            L_0x03a5:
                ...
                android.support.v4.media.session.IMediaControllerCallback r5 = android.support.p001v4.media.session.IMediaControllerCallback.Stub.asInterface(r5)
            ...
            L_0x03db:
                boolean r4 = r4.sendMediaButton(r3)
                r7.writeNoException()
                r7.writeInt(r4)
                return r1
            L_0x03e6:
            ...
            L_0x0413:
                ...
                return r1
            */
            throw new UnsupportedOperationException("Method not decompiled: android.support.p001v4.media.session.IMediaSession.Stub.onTransact(int, android.os.Parcel, android.os.Parcel, int):boolean");
        }
