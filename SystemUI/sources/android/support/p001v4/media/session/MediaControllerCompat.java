...
public final class MediaControllerCompat {
    ...
    public static void setMediaController(Activity activity, MediaControllerCompat mediaControllerCompat) {
        activity.getWindow().getDecorView().setTag(C1154R.C1156id.media_controller_compat_view_tag, mediaControllerCompat);
        MediaControllerImplApi21.setMediaController(activity, mediaControllerCompat);
    }

    public static MediaControllerCompat getMediaController(Activity activity) {
        Object tag = activity.getWindow().getDecorView().getTag(C1154R.C1156id.media_controller_compat_view_tag);
    ...
    static void validateCustomAction(String str, Bundle bundle) {
        if (str != null) {
            ...
            if (bundle == null || !bundle.containsKey(MediaSessionCompat.ARGUMENT_MEDIA_ATTRIBUTE)) {
                throw new IllegalArgumentException("An extra field android.support.v4.media.session.ARGUMENT_MEDIA_ATTRIBUTE is required for this action " + str + BaseIconCache.EMPTY_CLASS_NAME);
            }
        }
    }
        ...
        public final void unregisterCallback(Callback callback) {
            ...
            synchronized (this.mLock) {
                if (this.mSessionToken.getExtraBinder() != null) {
                    ...
                    this.mPendingCallbacks.remove((Object) callback);
                }
            }
        }
    ...
    /* renamed from: android.support.v4.media.session.MediaControllerCompat$MediaControllerImplApi29 */
