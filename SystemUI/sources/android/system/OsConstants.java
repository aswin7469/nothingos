...
public final class OsConstants {
    ...
    @SystemApi(client = SystemApi.Client.MODULE_LIBRARIES)
    public static int CAP_TO_INDEX(int i) {
        return i >>> 5;
    }

    @SystemApi(client = SystemApi.Client.MODULE_LIBRARIES)
    public static int CAP_TO_MASK(int i) {
        return 1 << (i & 31);
    }
    ...
    public static boolean S_ISBLK(int i) {
        return (i & S_IFMT) == S_IFBLK;
    }

    public static boolean S_ISCHR(int i) {
        return (i & S_IFMT) == S_IFCHR;
    }
    ...
    public static boolean S_ISLNK(int i) {
        return (i & S_IFMT) == S_IFLNK;
    }

    public static boolean S_ISSOCK(int i) {
        return (i & S_IFMT) == S_IFSOCK;
    }
