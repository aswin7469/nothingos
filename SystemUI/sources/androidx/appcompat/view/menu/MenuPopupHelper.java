...
public class MenuPopupHelper implements MenuHelper {
    ...
    public MenuPopupHelper(Context context, MenuBuilder menuBuilder) {
        this(context, menuBuilder, (View) null, false, C0329R.attr.popupMenuStyle, 0);
    }

    public MenuPopupHelper(Context context, MenuBuilder menuBuilder, View view) {
        this(context, menuBuilder, view, false, C0329R.attr.popupMenuStyle, 0);
    }
    ...
    private androidx.appcompat.view.menu.MenuPopup createPopup() {
        /*
            ...
            int r2 = androidx.appcompat.C0329R.dimen.abc_cascading_menus_min_smallest_width
