...
class AppCompatCheckedTextViewHelper {
    ...
    public void loadFromAttributes(android.util.AttributeSet r11, int r12) {
        /*
            ...
            int[] r1 = androidx.appcompat.C0329R.styleable.CheckedTextView
            r2 = 0
            ...
            int[] r5 = androidx.appcompat.C0329R.styleable.CheckedTextView
            ...
            int r11 = androidx.appcompat.C0329R.styleable.CheckedTextView_checkMarkCompat     // Catch:{ all -> 0x008e }
        ...
        L_0x003f:
            ...
            int r11 = androidx.appcompat.C0329R.styleable.CheckedTextView_android_checkMark     // Catch:{ all -> 0x008e }
            boolean r11 = r0.hasValue(r11)     // Catch:{ all -> 0x008e }
            if (r11 == 0) goto L_0x005e
            int r11 = androidx.appcompat.C0329R.styleable.CheckedTextView_android_checkMark     // Catch:{ all -> 0x008e }
            int r11 = r0.getResourceId(r11, r2)     // Catch:{ all -> 0x008e }
        ...
        L_0x005e:
            int r11 = androidx.appcompat.C0329R.styleable.CheckedTextView_checkMarkTint     // Catch:{ all -> 0x008e }
            boolean r11 = r0.hasValue(r11)     // Catch:{ all -> 0x008e }
            if (r11 == 0) goto L_0x0071
            android.widget.CheckedTextView r11 = r10.mView     // Catch:{ all -> 0x008e }
            int r12 = androidx.appcompat.C0329R.styleable.CheckedTextView_checkMarkTint     // Catch:{ all -> 0x008e }
        ...
        L_0x0071:
            int r11 = androidx.appcompat.C0329R.styleable.CheckedTextView_checkMarkTintMode     // Catch:{ all -> 0x008e }
            boolean r11 = r0.hasValue(r11)     // Catch:{ all -> 0x008e }
            if (r11 == 0) goto L_0x008a
            android.widget.CheckedTextView r10 = r10.mView     // Catch:{ all -> 0x008e }
            int r11 = androidx.appcompat.C0329R.styleable.CheckedTextView_checkMarkTintMode     // Catch:{ all -> 0x008e }
            r12 = -1
            int r11 = r0.getInt(r11, r12)     // Catch:{ all -> 0x008e }
            r12 = 0
            android.graphics.PorterDuff$Mode r11 = androidx.appcompat.widget.DrawableUtils.parseTintMode(r11, r12)     // Catch:{ all -> 0x008e }
            androidx.core.widget.CheckedTextViewCompat.setCheckMarkTintMode(r10, r11)     // Catch:{ all -> 0x008e }
        L_0x008a:
            r0.recycle()
            return
        L_0x008e:
