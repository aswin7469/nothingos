...
class AppCompatEmojiEditTextHelper {
    ...
    public void loadFromAttributes(AttributeSet attributeSet, int i) {
        TypedArray obtainStyledAttributes = this.mView.getContext().obtainStyledAttributes(attributeSet, C0329R.styleable.AppCompatTextView, i, 0);
        try {
            boolean z = true;
            if (obtainStyledAttributes.hasValue(C0329R.styleable.AppCompatTextView_emojiCompatEnabled)) {
                z = obtainStyledAttributes.getBoolean(C0329R.styleable.AppCompatTextView_emojiCompatEnabled, true);
            }
    ...
    public void initKeyListener() {
        ...
        this.mView.setInputType(inputType);
