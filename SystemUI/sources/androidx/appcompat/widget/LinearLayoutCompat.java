...
public class LinearLayoutCompat extends ViewGroup {
    ...
    public final class InspectionCompanion implements android.view.inspector.InspectionCompanion<LinearLayoutCompat> {
        ...
        public void mapProperties(PropertyMapper propertyMapper) {
            ...
            this.mDividerId = propertyMapper.mapObject("divider", C0329R.attr.divider);
            this.mDividerPaddingId = propertyMapper.mapInt("dividerPadding", C0329R.attr.dividerPadding);
            this.mMeasureWithLargestChildId = propertyMapper.mapBoolean("measureWithLargestChild", C0329R.attr.measureWithLargestChild);
            this.mShowDividersId = propertyMapper.mapIntFlag("showDividers", C0329R.attr.showDividers, new IntFunction<Set<String>>() {
    ...
    public LinearLayoutCompat(Context context, AttributeSet attributeSet, int i) {
        ...
        TintTypedArray obtainStyledAttributes = TintTypedArray.obtainStyledAttributes(context, attributeSet, C0329R.styleable.LinearLayoutCompat, i, 0);
        ViewCompat.saveAttributeDataForStyleable(this, context, C0329R.styleable.LinearLayoutCompat, attributeSet, obtainStyledAttributes.getWrappedTypeArray(), i, 0);
        int i2 = obtainStyledAttributes.getInt(C0329R.styleable.LinearLayoutCompat_android_orientation, -1);
        if (i2 >= 0) {
            setOrientation(i2);
        }
        int i3 = obtainStyledAttributes.getInt(C0329R.styleable.LinearLayoutCompat_android_gravity, -1);
        if (i3 >= 0) {
            setGravity(i3);
        }
        boolean z = obtainStyledAttributes.getBoolean(C0329R.styleable.LinearLayoutCompat_android_baselineAligned, true);
        if (!z) {
            setBaselineAligned(z);
        }
        this.mWeightSum = obtainStyledAttributes.getFloat(C0329R.styleable.LinearLayoutCompat_android_weightSum, -1.0f);
        this.mBaselineAlignedChildIndex = obtainStyledAttributes.getInt(C0329R.styleable.LinearLayoutCompat_android_baselineAlignedChildIndex, -1);
        this.mUseLargestChild = obtainStyledAttributes.getBoolean(C0329R.styleable.LinearLayoutCompat_measureWithLargestChild, false);
        setDividerDrawable(obtainStyledAttributes.getDrawable(C0329R.styleable.LinearLayoutCompat_divider));
        this.mShowDividers = obtainStyledAttributes.getInt(C0329R.styleable.LinearLayoutCompat_showDividers, 0);
        this.mDividerPadding = obtainStyledAttributes.getDimensionPixelSize(C0329R.styleable.LinearLayoutCompat_dividerPadding, 0);
    ...
    public void measureVertical(int r34, int r35) {
        ...
        L_0x00f7:
            ...
            int r2 = r2 + r4
            int r1 = java.lang.Math.max((int) r1, (int) r2)
            r7.mTotalLength = r1
            if (r15 == 0) goto L_0x0119
            int r0 = java.lang.Math.max((int) r0, (int) r9)
            goto L_0x011a
        L_0x0119:
            r0 = r9
        L_0x011a:
        ...
        L_0x0144:
            ...
            int r4 = r4 + r2
            r5 = r29
            int r5 = java.lang.Math.max((int) r5, (int) r4)
        ...
        L_0x0171:
            r2 = r4
        L_0x0172:
            int r4 = java.lang.Math.max((int) r13, (int) r2)
            r1 = r31
            goto L_0x0184
        L_0x0179:
        ...
        L_0x01eb:
            ...
            int r6 = r21 + r6
            int r6 = java.lang.Math.max((int) r14, (int) r6)
            r7.mTotalLength = r6
        L_0x0209:
            int r4 = r4 + 1
            r10 = 8
        ...
        L_0x020e:
            ...
            int r4 = java.lang.Math.max((int) r4, (int) r6)
            r6 = r35
            r10 = r9
            r9 = 0
            ...
            goto L_0x027d
        L_0x023c:
            int r0 = java.lang.Math.max((int) r1, (int) r13)
        ...
        L_0x0306:
            ...
            int r15 = r15 + r10
            int r5 = java.lang.Math.max((int) r5, (int) r15)
            r18 = r0
        ...
        L_0x032b:
            r10 = r15
        L_0x032c:
            int r0 = java.lang.Math.max((int) r9, (int) r10)
        ...
        L_0x033a:
            ...
            int r15 = r15 + r1
            int r1 = java.lang.Math.max((int) r10, (int) r15)
            r7.mTotalLength = r1
            r19 = r9
            r1 = r23
            r9 = r0
        ...
        L_0x0379:
            ...
            int r0 = java.lang.Math.max((int) r0, (int) r3)
    ...
    public void measureHorizontal(int r39, int r40) {
        ...
        L_0x00bf:
            ...
            int r2 = r2 + r5
            int r0 = java.lang.Math.max((int) r0, (int) r2)
            r7.mTotalLength = r0
        L_0x00cd:
        ...
        L_0x0167:
            ...
            int r14 = java.lang.Math.max((int) r0, (int) r14)
        L_0x016d:
            r1 = 1073741824(0x40000000, float:2.0)
        L_0x016f:
        ...
        L_0x01a2:
            ...
            int r6 = r6 >> 1
            r9 = r15[r6]
            int r9 = java.lang.Math.max((int) r9, (int) r5)
            r15[r6] = r9
            r9 = r28[r6]
            int r5 = r4 - r5
            int r5 = java.lang.Math.max((int) r9, (int) r5)
            r28[r6] = r5
        L_0x01bc:
            r5 = r21
            int r21 = java.lang.Math.max((int) r5, (int) r4)
        ...
        L_0x01d8:
            r10 = r23
            int r23 = java.lang.Math.max((int) r10, (int) r2)
            goto L_0x01ed
        L_0x01df:
            r10 = r23
        ...
        L_0x01e5:
            r4 = r22
            int r22 = java.lang.Math.max((int) r4, (int) r2)
            r23 = r10
        L_0x01ed:
            r10 = r34
        ...
        L_0x0244:
            ...
            r9 = r15[r5]
            r5 = r15[r17]
            int r1 = java.lang.Math.max((int) r1, (int) r5)
            int r1 = java.lang.Math.max((int) r9, (int) r1)
            int r1 = java.lang.Math.max((int) r3, (int) r1)
            r3 = r28[r16]
            r5 = 0
            r9 = r28[r5]
            r5 = r28[r18]
            r23 = r6
            r6 = r28[r17]
            int r5 = java.lang.Math.max((int) r5, (int) r6)
            int r5 = java.lang.Math.max((int) r9, (int) r5)
            int r3 = java.lang.Math.max((int) r3, (int) r5)
            int r1 = r1 + r3
        ...
        L_0x02ba:
            ...
            int r9 = r9 + r1
            int r1 = java.lang.Math.max((int) r6, (int) r9)
            r7.mTotalLength = r1
        L_0x02d1:
            int r2 = r2 + 1
            r1 = r21
        ...
        L_0x02d6:
            ...
            goto L_0x0347
        L_0x0303:
            int r0 = java.lang.Math.max((int) r4, (int) r10)
        ...
        L_0x0404:
            ...
            int r11 = r11 + r0
            int r0 = java.lang.Math.max((int) r8, (int) r11)
            r7.mTotalLength = r0
        L_0x041e:
            r0 = 1073741824(0x40000000, float:2.0)
        ...
        L_0x042b:
            ...
            int r11 = r11 + r8
            int r4 = java.lang.Math.max((int) r4, (int) r11)
            if (r0 == 0) goto L_0x043c
            goto L_0x043d
        L_0x043c:
            r8 = r11
        L_0x043d:
            int r0 = java.lang.Math.max((int) r6, (int) r8)
        ...
        L_0x045e:
            ...
            int r5 = r5 >> 1
            r8 = r15[r5]
            int r8 = java.lang.Math.max((int) r8, (int) r14)
            r15[r5] = r8
            r8 = r28[r5]
            int r11 = r11 - r14
            int r8 = java.lang.Math.max((int) r8, (int) r11)
            r28[r5] = r8
        L_0x0477:
            r26 = r6
            r6 = r0
        ...
        L_0x04b3:
            ...
            r8 = r15[r5]
            r10 = r15[r17]
            int r0 = java.lang.Math.max((int) r0, (int) r10)
            int r0 = java.lang.Math.max((int) r8, (int) r0)
            int r0 = java.lang.Math.max((int) r3, (int) r0)
            r3 = r28[r16]
            r5 = r28[r5]
            r8 = r28[r18]
            r10 = r28[r17]
            int r8 = java.lang.Math.max((int) r8, (int) r10)
            int r5 = java.lang.Math.max((int) r5, (int) r8)
            int r3 = java.lang.Math.max((int) r3, (int) r5)
            int r0 = r0 + r3
            int r0 = java.lang.Math.max((int) r4, (int) r0)
        L_0x04df:
            r3 = r0
            r0 = r6
            r23 = r9
    ...
    public void setVerticalGravity(int i) {
        ...
        int i3 = this.mGravity;
        if ((i3 & 112) != i2) {
            this.mGravity = i2 | (i3 & TrafficStats.TAG_NETWORK_STACK_IMPERSONATION_RANGE_END);
            requestLayout();
        }
    }
