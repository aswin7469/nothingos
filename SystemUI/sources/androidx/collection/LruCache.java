...
public class LruCache<K, V> {
    ...
    public void trimToSize(int r5) {
        ...
        L_0x0000:
            monitor-enter(r4)
            int r0 = r4.size     // Catch:{ all -> 0x0073 }
            if (r0 < 0) goto L_0x0052
            java.util.LinkedHashMap<K, V> r0 = r4.map     // Catch:{ all -> 0x0073 }
        ...
        L_0x001e:
            ...
            java.util.LinkedHashMap<K, V> r2 = r4.map     // Catch:{ all -> 0x0073 }
            r2.remove(r1)     // Catch:{ all -> 0x0073 }
            int r2 = r4.size     // Catch:{ all -> 0x0073 }
            int r3 = r4.safeSizeOf(r1, r0)     // Catch:{ all -> 0x0073 }
            int r2 = r2 - r3
            r4.size = r2     // Catch:{ all -> 0x0073 }
            int r2 = r4.evictionCount     // Catch:{ all -> 0x0073 }
            r3 = 1
            int r2 = r2 + r3
            r4.evictionCount = r2     // Catch:{ all -> 0x0073 }
        ...
        L_0x0050:
            ...
            return
        L_0x0052:
            java.lang.IllegalStateException r5 = new java.lang.IllegalStateException     // Catch:{ all -> 0x0073 }
            java.lang.StringBuilder r0 = new java.lang.StringBuilder     // Catch:{ all -> 0x0073 }
            r0.<init>()     // Catch:{ all -> 0x0073 }
            java.lang.Class r1 = r4.getClass()     // Catch:{ all -> 0x0073 }
            java.lang.String r1 = r1.getName()     // Catch:{ all -> 0x0073 }
            java.lang.StringBuilder r0 = r0.append((java.lang.String) r1)     // Catch:{ all -> 0x0073 }
            java.lang.String r1 = ".sizeOf() is reporting inconsistent results!"
            java.lang.StringBuilder r0 = r0.append((java.lang.String) r1)     // Catch:{ all -> 0x0073 }
            java.lang.String r0 = r0.toString()     // Catch:{ all -> 0x0073 }
            r5.<init>((java.lang.String) r0)     // Catch:{ all -> 0x0073 }
    ...
    public final synchronized String toString() {
        ...
        i = this.hitCount;
        i2 = this.missCount + i;
        return String.format(Locale.f698US, "LruCache[maxSize=%d,hits=%d,misses=%d,hitRate=%d%%]", Integer.valueOf(this.maxSize), Integer.valueOf(this.hitCount), Integer.valueOf(this.missCount), Integer.valueOf(i2 != 0 ? (i * 100) / i2 : 0));
    }
}
