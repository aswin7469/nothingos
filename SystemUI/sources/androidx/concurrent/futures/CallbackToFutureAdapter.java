...
public final class CallbackToFutureAdapter {
    ...
    public static final class SafeFuture<T> implements ListenableFuture<T> {
        ...
        private final AbstractResolvableFuture<T> delegate = (AbstractResolvableFuture<T>) new AbstractResolvableFuture<?>() { // from class: androidx.concurrent.futures.CallbackToFutureAdapter.SafeFuture.1
