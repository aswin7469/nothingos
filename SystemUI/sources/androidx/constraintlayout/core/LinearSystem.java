...
public class LinearSystem {
    ...
    private String getDisplayStrength(int i) {
        return i == 1 ? "LOW" : i == 2 ? "MEDIUM" : i == 3 ? DumpHandler.PRIORITY_ARG_HIGH : i == 4 ? "HIGHEST" : i == 5 ? "EQUALITY" : i == 8 ? "FIXED" : i == 6 ? "BARRIER" : "NONE";
    }
    ...
    private void increaseTableSize() {
        ...
        this.TABLE_SIZE = i;
        this.mRows = (ArrayRow[]) Arrays.copyOf((T[]) this.mRows, i);
        Cache cache = this.mCache;
        cache.mIndexedVariables = (SolverVariable[]) Arrays.copyOf((T[]) cache.mIndexedVariables, this.TABLE_SIZE);
    ...
    public SolverVariable createObjectVariable(Object obj) {
        ...
        if (obj instanceof ConstraintAnchor) {
            ...
            if (solverVariable.f73id == -1 || solverVariable.f73id > this.mVariablesID || this.mCache.mIndexedVariables[solverVariable.f73id] == null) {
                if (solverVariable.f73id != -1) {
                    solverVariable.reset();
                }
                int i = this.mVariablesID + 1;
                this.mVariablesID = i;
                this.mNumColumns++;
                solverVariable.f73id = i;
    ...
    public SolverVariable createErrorVariable(int i, String str) {
        ...
        this.mNumColumns++;
        acquireSolverVariable.f73id = i2;
    ...
    private SolverVariable acquireSolverVariable(SolverVariable.Type type, String str) {
        ...
        if (i >= i2) {
            int i3 = i2 * 2;
            POOL_SIZE = i3;
            this.mPoolVariables = (SolverVariable[]) Arrays.copyOf((T[]) this.mPoolVariables, i3);
        }
    ...
    private final int optimize(Row row, boolean z) {
        ...
        while (!z2) {
            ...
            if (row.getKey() != null) {
                this.mAlreadyTestedCandidates[row.getKey().f73id] = true;
            }
            SolverVariable pivotCandidate = row.getPivotCandidate(this, this.mAlreadyTestedCandidates);
            if (pivotCandidate != null) {
                if (this.mAlreadyTestedCandidates[pivotCandidate.f73id]) {
                    return i2;
                }
                this.mAlreadyTestedCandidates[pivotCandidate.f73id] = true;
            }
            if (pivotCandidate != null) {
    ...
    private void displaySolverVariables() {
        System.out.println("Display Rows (" + this.mNumRows + LanguageTag.PRIVATEUSE + this.mNumColumns + ")\n");
    }
    ...
    public void addEquality(SolverVariable solverVariable, int i) {
        if (!USE_BASIC_SYNONYMS || solverVariable.definitionId != -1) {
            ...
            for (int i3 = 0; i3 < this.mVariablesID + 1; i3++) {
                ...
                if (solverVariable2 != null && solverVariable2.isSynonym && solverVariable2.synonym == solverVariable.f73id) {
