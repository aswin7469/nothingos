...
public class PriorityGoalRow extends ArrayRow {
    ...
    class GoalVariableAccessor implements Comparable {
        ...
        public int compareTo(Object obj) {
            return this.variable.f73id - ((SolverVariable) obj).f73id;
        }
        ...
        public String toString() {
            ...
            if (this.variable != null) {
                for (int i = 0; i < 9; i++) {
                    str = str + this.variable.goalStrengthVector[i] + WifiEnterpriseConfig.CA_CERT_ALIAS_DELIMITER;
                }
            }
    ...
    private final void addToGoal(SolverVariable solverVariable) {
        ...
        if (i2 > solverVariableArr.length) {
            SolverVariable[] solverVariableArr2 = (SolverVariable[]) Arrays.copyOf((T[]) solverVariableArr, solverVariableArr.length * 2);
            this.arrayGoals = solverVariableArr2;
            this.sortArray = (SolverVariable[]) Arrays.copyOf((T[]) solverVariableArr2, solverVariableArr2.length * 2);
        }
        ...
        int i4 = i3 + 1;
        this.numGoals = i4;
        if (i4 > 1 && solverVariableArr3[i4 - 1].f73id > solverVariable.f73id) {
            int i5 = 0;
            while (true) {
                i = this.numGoals;
                if (i5 >= i) {
            ...
            Arrays.sort(this.sortArray, 0, i, new Comparator<SolverVariable>() {
                public int compare(SolverVariable solverVariable, SolverVariable solverVariable2) {
                    return solverVariable.f73id - solverVariable2.f73id;
                }
            });
    ...
    public String toString() {
        ...
        for (int i = 0; i < this.numGoals; i++) {
            ...
            str = str + this.accessor + WifiEnterpriseConfig.CA_CERT_ALIAS_DELIMITER;
        }
        return str;
    }
}
