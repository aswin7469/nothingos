...
public class SolverVariable {
    ...
    private static String getUniqueName(Type type, String str) {
        ...
        int i = C04491.$SwitchMap$androidx$constraintlayout$core$SolverVariable$Type[type.ordinal()];
        if (i == 1) {
    ...
    static /* synthetic */ class C04491 {
        ...
        static {
            ...
            L_0x003e:
                return
            */
            throw new UnsupportedOperationException("Method not decompiled: androidx.constraintlayout.core.SolverVariable.C04491.<clinit>():void");
        }
    }
    ...
    public String strengthsToString() {
        String str = this + NavigationBarInflaterView.SIZE_MOD_START;
        boolean z = false;
        boolean z2 = true;
        ...
        while (true) {
            ...
            if (i >= i2) {
                ...
                if (i2 >= arrayRowArr.length) {
                    this.mClientEquations = (ArrayRow[]) Arrays.copyOf((T[]) arrayRowArr, arrayRowArr.length * 2);
                }
    ...
    public void setSynonym(LinearSystem linearSystem, SolverVariable solverVariable, float f) {
        this.isSynonym = true;
        this.synonym = solverVariable.f73id;
        this.synonymDelta = f;
        int i = this.mClientEquationsCount;
        this.definitionId = -1;
        for (int i2 = 0; i2 < i; i2++) {
