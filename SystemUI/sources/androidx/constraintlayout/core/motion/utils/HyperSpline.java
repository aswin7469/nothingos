...
public class HyperSpline {
    ...
    public void setup(double[][] dArr) {
        ...
        iArr[1] = length2;
        iArr[0] = length;
        this.mCtl = (double[][]) Array.newInstance((Class<?>) Double.TYPE, iArr);
    ...
    public static class Cubic {
        ...
        public double eval(double d) {
            return (((((this.f81mD * d) + this.f80mC) * d) + this.f79mB) * d) + this.f78mA;
        }

        public double vel(double d) {
            return (((this.f81mD * 0.3333333333333333d * d) + (this.f80mC * 0.5d)) * d) + this.f79mB;
        }
    }
}
