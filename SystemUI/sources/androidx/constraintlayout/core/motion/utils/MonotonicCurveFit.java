...
public class MonotonicCurveFit extends CurveFit {
    ...
    /* renamed from: mT */
    private double[] f84mT;
    private double[][] mTangent;

    /* renamed from: mY */
    private double[][] f85mY;
    ...
    public MonotonicCurveFit(double[] dArr, double[][] dArr2) {
        ...
        iArr2[1] = length2;
        iArr2[0] = length;
        double[][] dArr6 = (double[][]) Array.newInstance((Class<?>) Double.TYPE, iArr2);
    ...
    public void getPos(double d, double[] dArr) {
        double[] dArr2 = this.f84mT;
        int length = dArr2.length;
        int i = 0;
        int length2 = this.f85mY[0].length;
        if (this.mExtrapolate) {
            double d2 = dArr2[0];
            if (d <= d2) {
                getSlope(d2, this.mSlopeTemp);
                for (int i2 = 0; i2 < length2; i2++) {
                    dArr[i2] = this.f85mY[0][i2] + ((d - this.f84mT[0]) * this.mSlopeTemp[i2]);
                }
                return;
            }
            int i3 = length - 1;
            ...
            if (d >= d3) {
                ...
                while (i < length2) {
                    dArr[i] = this.f85mY[i3][i] + ((d - this.f84mT[i3]) * this.mSlopeTemp[i]);
                    i++;
                }
                return;
            }
        ...
        while (i6 < length - 1) {
            if (d == this.f84mT[i6]) {
                for (int i7 = 0; i7 < length2; i7++) {
                    dArr[i7] = this.f85mY[i6][i7];
                }
            }
            double[] dArr3 = this.f84mT;
            int i8 = i6 + 1;
            double d4 = dArr3[i8];
            if (d < d4) {
                double d5 = dArr3[i6];
    ...
    public void getPos(double d, float[] fArr) {
        ...
        if (this.mExtrapolate) {
            ...
            if (d <= d2) {
                getSlope(d2, this.mSlopeTemp);
                for (int i2 = 0; i2 < length2; i2++) {
                    fArr[i2] = (float) (this.f85mY[0][i2] + ((d - this.f84mT[0]) * this.mSlopeTemp[i2]));
                }
                return;
            }
            int i3 = length - 1;
            ...
            if (d >= d3) {
                getSlope(d3, this.mSlopeTemp);
                while (i < length2) {
                    fArr[i] = (float) (this.f85mY[i3][i] + ((d - this.f84mT[i3]) * this.mSlopeTemp[i]));
                    i++;
                }
                return;
            }
        ...
        while (i6 < length - 1) {
            if (d == this.f84mT[i6]) {
                for (int i7 = 0; i7 < length2; i7++) {
                    fArr[i7] = (float) this.f85mY[i6][i7];
                }
            }
            double[] dArr2 = this.f84mT;
            int i8 = i6 + 1;
    ...
    public double getPos(double d, int i) {
        ...
        if (this.mExtrapolate) {
            ...
            return this.f85mY[0][i2];
        } else {
            int i5 = length - 1;
            if (d >= dArr[i5]) {
                return this.f85mY[i5][i2];
            }
        }
        while (i3 < length - 1) {
            double[] dArr2 = this.f84mT;
