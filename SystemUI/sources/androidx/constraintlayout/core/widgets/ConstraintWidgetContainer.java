...
public class ConstraintWidgetContainer extends WidgetContainer {
        ...
        while (z7) {
            ...
            if (z7) {
                ...
                for (int i9 = 0; i9 < size; i9++) {
                    ((ConstraintWidget) this.mChildren.get(i9)).updateFromSolver(this.mSystem, optimizeFor);
                }
                z2 = false;
            }
            if (!z5 || i7 >= 8 || !Optimizer.flags[2]) {
                ...
                int i12 = 0;
                while (i10 < size) {
                    ConstraintWidget constraintWidget3 = (ConstraintWidget) this.mChildren.get(i10);
                    i11 = Math.max(i11, constraintWidget3.f90mX + constraintWidget3.getWidth());
                    i12 = Math.max(i12, constraintWidget3.f91mY + constraintWidget3.getHeight());
                    i10++;
                    z2 = z2;
                }
                z3 = z2;
    ...
    private void addHorizontalChain(ConstraintWidget constraintWidget) {
        ...
        if (i >= chainHeadArr.length) {
            this.mHorizontalChainsArray = (ChainHead[]) Arrays.copyOf((T[]) chainHeadArr, chainHeadArr.length * 2);
        }
    ...
    private void addVerticalChain(ConstraintWidget constraintWidget) {
        ...
        if (i >= chainHeadArr.length) {
            this.mVerticalChainsArray = (ChainHead[]) Arrays.copyOf((T[]) chainHeadArr, chainHeadArr.length * 2);
        }
