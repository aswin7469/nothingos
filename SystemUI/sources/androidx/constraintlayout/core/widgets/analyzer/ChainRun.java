...
public class ChainRun extends WidgetRun {
    ...
    public void update(androidx.constraintlayout.core.widgets.analyzer.Dependency r23) {
        ...
        L_0x018a:
            ...
            int r7 = r7.wrapValue
            int r7 = java.lang.Math.min((int) r9, (int) r7)
            goto L_0x019d
        L_0x019c:
            r7 = r9
        L_0x019d:
            int r7 = java.lang.Math.max((int) r10, (int) r7)
            if (r11 <= 0) goto L_0x01a7
            int r7 = java.lang.Math.min((int) r11, (int) r7)
        L_0x01a7:
        ...
        L_0x031d:
            ...
            int r10 = java.lang.Math.min((int) r10, (int) r11)
        L_0x0334:
