...
public class DependencyNode implements Dependency {
    ...
    public String toString() {
        return this.run.widget.getDebugName() + ":" + this.type + NavigationBarInflaterView.KEY_CODE_START + (this.resolved ? Integer.valueOf(this.value) : "unresolved") + ") <t=" + this.targets.size() + ":d=" + this.dependencies.size() + ">";
    }
