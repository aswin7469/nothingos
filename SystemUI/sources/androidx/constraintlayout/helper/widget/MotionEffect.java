...
public class MotionEffect extends MotionHelper {
    ...
    private void init(Context context, AttributeSet attributeSet) {
        if (attributeSet != null) {
            TypedArray obtainStyledAttributes = context.obtainStyledAttributes(attributeSet, C0483R.styleable.MotionEffect);
            int indexCount = obtainStyledAttributes.getIndexCount();
            for (int i = 0; i < indexCount; i++) {
                int index = obtainStyledAttributes.getIndex(i);
                if (index == C0483R.styleable.MotionEffect_motionEffect_start) {
                ...
                } else if (index == C0483R.styleable.MotionEffect_motionEffect_end) {
    ...
    public void onPreSetup(androidx.constraintlayout.motion.widget.MotionLayout r22, java.util.HashMap<android.view.View, androidx.constraintlayout.motion.widget.MotionController> r23) {
        /*
            ...
            r0.<init>()
            java.lang.String r1 = androidx.constraintlayout.motion.widget.Debug.getLoc()
        ...
        L_0x002d:
            ...
            java.lang.Float r5 = java.lang.Float.valueOf((float) r5)
            ...
            r7.setType(r6)
            r10 = 1
            java.lang.Integer r11 = java.lang.Integer.valueOf((int) r10)
            r7.setValue(r8, r11)
            java.lang.Integer r8 = java.lang.Integer.valueOf((int) r10)
            r7.setValue(r9, r8)
            ...
            java.lang.Integer r12 = java.lang.Integer.valueOf((int) r6)
        ...
        L_0x00c1:
            ...
            java.lang.Integer r13 = java.lang.Integer.valueOf((int) r6)
