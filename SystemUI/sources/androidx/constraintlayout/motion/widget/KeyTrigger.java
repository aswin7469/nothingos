...
public class KeyTrigger extends Key {
    ...
    public void load(Context context, AttributeSet attributeSet) {
        Loader.read(this, context.obtainStyledAttributes(attributeSet, C0483R.styleable.KeyTrigger), context);
    }
    ...
    public void conditionallyFire(float r10, android.view.View r11) {
        ...
        L_0x014c:
            ...
            int r9 = r9.mViewTransitionOnCross
            android.view.View[] r0 = new android.view.View[r2]
            r0[r3] = r10
            r11.viewTransition(r9, r0)
        L_0x0161:
            return
        */
        ...
        if (str != null) {
            ...
            if (method == null) {
                try {
                    ...
                    Log.e("KeyTrigger", "Could not find method \"" + str + "\"on class " + view.getClass().getSimpleName() + WifiEnterpriseConfig.CA_CERT_ALIAS_DELIMITER + Debug.getName(view));
                    return;
                }
            }
            try {
                ...
                Log.e("KeyTrigger", "Exception in call \"" + this.mCross + "\"on class " + view.getClass().getSimpleName() + WifiEnterpriseConfig.CA_CERT_ALIAS_DELIMITER + Debug.getName(view));
            }
        }
    }
    ...
    private static class Loader {
        ...
        static {
            ...
            sparseIntArray.append(C0483R.styleable.KeyTrigger_framePosition, 8);
            mAttrMap.append(C0483R.styleable.KeyTrigger_onCross, 4);
            mAttrMap.append(C0483R.styleable.KeyTrigger_onNegativeCross, 1);
            mAttrMap.append(C0483R.styleable.KeyTrigger_onPositiveCross, 2);
            mAttrMap.append(C0483R.styleable.KeyTrigger_motionTarget, 7);
            mAttrMap.append(C0483R.styleable.KeyTrigger_triggerId, 6);
            mAttrMap.append(C0483R.styleable.KeyTrigger_triggerSlack, 5);
            mAttrMap.append(C0483R.styleable.KeyTrigger_motion_triggerOnCollision, 9);
            mAttrMap.append(C0483R.styleable.KeyTrigger_motion_postLayoutCollision, 10);
            mAttrMap.append(C0483R.styleable.KeyTrigger_triggerReceiver, 11);
            mAttrMap.append(C0483R.styleable.KeyTrigger_viewTransitionOnCross, 12);
            mAttrMap.append(C0483R.styleable.KeyTrigger_viewTransitionOnNegativeCross, 13);
            mAttrMap.append(C0483R.styleable.KeyTrigger_viewTransitionOnPositiveCross, 14);
        }
