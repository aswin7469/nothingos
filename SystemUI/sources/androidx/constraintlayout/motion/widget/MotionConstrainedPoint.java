...
class MotionConstrainedPoint implements Comparable<MotionConstrainedPoint> {
    ...
    public void different(MotionConstrainedPoint motionConstrainedPoint, boolean[] zArr, String[] strArr) {
        ...
        zArr[1] = zArr[1] | diff(this.f101x, motionConstrainedPoint.f101x);
        zArr[2] = zArr[2] | diff(this.f102y, motionConstrainedPoint.f102y);
    ...
    public void fillStandard(double[] dArr, int[] iArr) {
        float[] fArr = {this.position, this.f101x, this.f102y, this.width, this.height, this.alpha, this.elevation, this.rotation, this.rotationX, this.rotationY, this.scaleX, this.scaleY, this.mPivotX, this.mPivotY, this.translationX, this.translationY, this.translationZ, this.mPathRotate};
        int i = 0;
        for (int i2 : iArr) {
            if (i2 < 18) {
            ...
            switch (c) {
                ...
                default:
                    if (!next.startsWith(Key.CUSTOM)) {
                        ...
                        String str = next.split(NavigationBarInflaterView.BUTTON_SEPARATOR)[1];
