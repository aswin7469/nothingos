...
public class MotionController {
    ...
    public float getStartX() {
        return this.mStartMotionPath.f105x;
    }

    public float getStartY() {
        return this.mStartMotionPath.f106y;
    }

    public float getFinalX() {
        return this.mEndMotionPath.f105x;
    }

    public float getFinalY() {
        return this.mEndMotionPath.f106y;
    }
    ...
    public void buildPath(float[] fArr, int i) {
        ...
        ViewOscillator viewOscillator2 = hashMap3 == null ? null : hashMap3.get(Key.TRANSLATION_X);
        HashMap<String, ViewOscillator> hashMap4 = this.mCycleMap;
        if (hashMap4 != null) {
            viewOscillator = hashMap4.get(Key.TRANSLATION_Y);
        }
    ...
    public void buildBounds(float[] fArr, int i) {
        ...
        HashMap<String, ViewOscillator> hashMap3 = this.mCycleMap;
        if (hashMap3 != null) {
            ViewOscillator viewOscillator = hashMap3.get(Key.TRANSLATION_X);
        }
        HashMap<String, ViewOscillator> hashMap4 = this.mCycleMap;
        if (hashMap4 != null) {
            ViewOscillator viewOscillator2 = hashMap4.get(Key.TRANSLATION_Y);
        }
    ...
    public KeyPositionBase getPositionKeyframe(int i, int i2, float f, float f2) {
        ...
        rectF.left = this.mStartMotionPath.f105x;
        rectF.top = this.mStartMotionPath.f106y;
        rectF.right = rectF.left + this.mStartMotionPath.width;
        rectF.bottom = rectF.top + this.mStartMotionPath.height;
        RectF rectF2 = new RectF();
        rectF2.left = this.mEndMotionPath.f105x;
        rectF2.top = this.mEndMotionPath.f106y;
    ...
    public float getKeyFrameParameter(int i, float f, float f2) {
        float f3 = this.mEndMotionPath.f105x - this.mStartMotionPath.f105x;
        float f4 = this.mEndMotionPath.f106y - this.mStartMotionPath.f106y;
        float f5 = this.mStartMotionPath.f105x + (this.mStartMotionPath.width / 2.0f);
        float f6 = this.mStartMotionPath.f106y + (this.mStartMotionPath.height / 2.0f);
    ...
    public void setup(int r17, int r18, float r19, long r20) {
        ...
        L_0x028d:
            ...
            r12.<init>((java.lang.String) r9)
            java.lang.StringBuilder r12 = r12.append((java.lang.String) r11)
        ...
        L_0x0331:
            ...
            int r2 = java.lang.Math.max((int) r4, (int) r9)
        ...
        L_0x0353:
            ...
            r7[r10] = r2
            r7[r5] = r1
            java.lang.Class<java.lang.Double> r2 = java.lang.Double.TYPE
            java.lang.Object r2 = java.lang.reflect.Array.newInstance((java.lang.Class<?>) r2, (int[]) r7)
            double[][] r2 = (double[][]) r2
            double[] r7 = new double[r1]
            r8 = r5
        L_0x0367:
            if (r8 >= r1) goto L_0x037c
            r9 = r6[r8]
            r11 = r2[r8]
        ...
        L_0x037d:
            ...
            r12 = r12[r8]
            r11 = r11[r12]
            java.lang.StringBuilder r9 = r9.append((java.lang.String) r11)
            java.lang.String r11 = " ["
            java.lang.StringBuilder r9 = r9.append((java.lang.String) r11)
            java.lang.String r9 = r9.toString()
            r11 = r5
        L_0x03a5:
            if (r11 >= r1) goto L_0x03bf
            java.lang.StringBuilder r12 = new java.lang.StringBuilder
            r12.<init>()
            java.lang.StringBuilder r9 = r12.append((java.lang.String) r9)
            r12 = r2[r11]
            r12 = r12[r8]
            java.lang.StringBuilder r9 = r9.append((double) r12)
            java.lang.String r9 = r9.toString()
            int r11 = r11 + 1
            goto L_0x03a5
        L_0x03bf:
        ...
        L_0x03d6:
            ...
            r15[r10] = r14
            r15[r5] = r1
            java.lang.Class<java.lang.Double> r14 = java.lang.Double.TYPE
            java.lang.Object r14 = java.lang.reflect.Array.newInstance((java.lang.Class<?>) r14, (int[]) r15)
        ...
        L_0x0409:
            ...
            goto L_0x03d6
        L_0x040e:
            double[] r4 = java.util.Arrays.copyOf((double[]) r12, (int) r13)
            java.lang.Object[] r5 = java.util.Arrays.copyOf((T[]) r14, (int) r13)
            double[][] r5 = (double[][]) r5
        ...
        L_0x0427:
            ...
            r8[r10] = r7
            r8[r5] = r1
            java.lang.Class<java.lang.Double> r5 = java.lang.Double.TYPE
            java.lang.Object r5 = java.lang.reflect.Array.newInstance((java.lang.Class<?>) r5, (int[]) r8)
            double[][] r5 = (double[][]) r5
            r15 = 0
        L_0x044e:
            if (r15 >= r1) goto L_0x0473
            r7 = r6[r15]
    ...
    public String toString() {
        return " start: x: " + this.mStartMotionPath.f105x + " y: " + this.mStartMotionPath.f106y + " end: x: " + this.mEndMotionPath.f105x + " y: " + this.mEndMotionPath.f106y;
    }
    ...
    public void getDpDt(float f, float f2, float f3, float[] fArr) {
        ...
        float f5 = this.mEndMotionPath.f105x - this.mStartMotionPath.f105x;
        float f6 = this.mEndMotionPath.f106y - this.mStartMotionPath.f106y;
    ...
    public void getPostLayoutDvDp(float f, int i, int i2, float f2, float f3, float[] fArr) {
        ...
        ViewOscillator viewOscillator2 = hashMap6 == null ? null : hashMap6.get(Key.TRANSLATION_X);
        HashMap<String, ViewOscillator> hashMap7 = this.mCycleMap;
        ViewOscillator viewOscillator3 = hashMap7 == null ? null : hashMap7.get(Key.TRANSLATION_Y);
        ...
        ViewOscillator viewOscillator5 = hashMap9 == null ? null : hashMap9.get(Key.SCALE_X);
        HashMap<String, ViewOscillator> hashMap10 = this.mCycleMap;
        if (hashMap10 != null) {
            viewOscillator = hashMap10.get(Key.SCALE_Y);
        }
        ...
        if (this.mSpline != null) {
            ...
            float f7 = this.mEndMotionPath.f105x - this.mStartMotionPath.f105x;
            float f8 = this.mEndMotionPath.f106y - this.mStartMotionPath.f106y;
