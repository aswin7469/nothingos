...
public class ViewTransition {
    ...
    public String toString() {
        return "ViewTransition(" + Debug.getName(this.mContext, this.mId) + NavigationBarInflaterView.KEY_CODE_END;
    }
    ...
    ViewTransition(android.content.Context r10, org.xmlpull.p032v1.XmlPullParser r11) {
        /*
            r9 = this;
            r9.<init>()
            r0 = -1
            ...
            r9.mContext = r10
            int r2 = r11.getEventType()     // Catch:{ XmlPullParserException -> 0x00ec, IOException -> 0x00e7 }
        L_0x002a:
            r3 = 1
            ...
            goto L_0x00e1
        L_0x0037:
            java.lang.String r2 = r11.getName()     // Catch:{ XmlPullParserException -> 0x00ec, IOException -> 0x00e7 }
            boolean r2 = r4.equals(r2)     // Catch:{ XmlPullParserException -> 0x00ec, IOException -> 0x00e7 }
            if (r2 == 0) goto L_0x00e1
            return
        L_0x0042:
            java.lang.String r2 = r11.getName()     // Catch:{ XmlPullParserException -> 0x00ec, IOException -> 0x00e7 }
            int r7 = r2.hashCode()     // Catch:{ XmlPullParserException -> 0x00ec, IOException -> 0x00e7 }
            r8 = 4
            switch(r7) {
            ...
            }     // Catch:{ XmlPullParserException -> 0x00ec, IOException -> 0x00e7 }
        L_0x004e:
            goto L_0x007f
        L_0x004f:
            java.lang.String r4 = "CustomAttribute"
            boolean r4 = r2.equals(r4)     // Catch:{ XmlPullParserException -> 0x00ec, IOException -> 0x00e7 }
        ...
        L_0x0080:
            ...
            java.lang.String r3 = TAG     // Catch:{ XmlPullParserException -> 0x00ec, IOException -> 0x00e7 }
            java.lang.StringBuilder r4 = new java.lang.StringBuilder     // Catch:{ XmlPullParserException -> 0x00ec, IOException -> 0x00e7 }
            r4.<init>()     // Catch:{ XmlPullParserException -> 0x00ec, IOException -> 0x00e7 }
            java.lang.String r5 = androidx.constraintlayout.motion.widget.Debug.getLoc()     // Catch:{ XmlPullParserException -> 0x00ec, IOException -> 0x00e7 }
            java.lang.StringBuilder r4 = r4.append((java.lang.String) r5)     // Catch:{ XmlPullParserException -> 0x00ec, IOException -> 0x00e7 }
            java.lang.String r5 = " unknown tag "
            java.lang.StringBuilder r4 = r4.append((java.lang.String) r5)     // Catch:{ XmlPullParserException -> 0x00ec, IOException -> 0x00e7 }
            java.lang.StringBuilder r2 = r4.append((java.lang.String) r2)     // Catch:{ XmlPullParserException -> 0x00ec, IOException -> 0x00e7 }
            java.lang.String r2 = r2.toString()     // Catch:{ XmlPullParserException -> 0x00ec, IOException -> 0x00e7 }
            android.util.Log.e(r3, r2)     // Catch:{ XmlPullParserException -> 0x00ec, IOException -> 0x00e7 }
            java.lang.String r2 = TAG     // Catch:{ XmlPullParserException -> 0x00ec, IOException -> 0x00e7 }
            java.lang.StringBuilder r3 = new java.lang.StringBuilder     // Catch:{ XmlPullParserException -> 0x00ec, IOException -> 0x00e7 }
            r3.<init>()     // Catch:{ XmlPullParserException -> 0x00ec, IOException -> 0x00e7 }
            java.lang.String r4 = ".xml:"
            java.lang.StringBuilder r3 = r3.append((java.lang.String) r4)     // Catch:{ XmlPullParserException -> 0x00ec, IOException -> 0x00e7 }
            int r4 = r11.getLineNumber()     // Catch:{ XmlPullParserException -> 0x00ec, IOException -> 0x00e7 }
            java.lang.StringBuilder r3 = r3.append((int) r4)     // Catch:{ XmlPullParserException -> 0x00ec, IOException -> 0x00e7 }
            java.lang.String r3 = r3.toString()     // Catch:{ XmlPullParserException -> 0x00ec, IOException -> 0x00e7 }
            android.util.Log.e(r2, r3)     // Catch:{ XmlPullParserException -> 0x00ec, IOException -> 0x00e7 }
            goto L_0x00e1
        L_0x00c7:
            androidx.constraintlayout.widget.ConstraintSet$Constraint r2 = r9.mConstraintDelta     // Catch:{ XmlPullParserException -> 0x00ec, IOException -> 0x00e7 }
            java.util.HashMap<java.lang.String, androidx.constraintlayout.widget.ConstraintAttribute> r2 = r2.mCustomConstraints     // Catch:{ XmlPullParserException -> 0x00ec, IOException -> 0x00e7 }
            androidx.constraintlayout.widget.ConstraintAttribute.parse(r10, r11, r2)     // Catch:{ XmlPullParserException -> 0x00ec, IOException -> 0x00e7 }
            goto L_0x00e1
        L_0x00cf:
            androidx.constraintlayout.widget.ConstraintSet$Constraint r2 = androidx.constraintlayout.widget.ConstraintSet.buildDelta(r10, r11)     // Catch:{ XmlPullParserException -> 0x00ec, IOException -> 0x00e7 }
            r9.mConstraintDelta = r2     // Catch:{ XmlPullParserException -> 0x00ec, IOException -> 0x00e7 }
            goto L_0x00e1
        L_0x00d6:
            androidx.constraintlayout.motion.widget.KeyFrames r2 = new androidx.constraintlayout.motion.widget.KeyFrames     // Catch:{ XmlPullParserException -> 0x00ec, IOException -> 0x00e7 }
            r2.<init>(r10, r11)     // Catch:{ XmlPullParserException -> 0x00ec, IOException -> 0x00e7 }
            r9.mKeyFrames = r2     // Catch:{ XmlPullParserException -> 0x00ec, IOException -> 0x00e7 }
            goto L_0x00e1
        L_0x00de:
            r9.parseViewTransitionTags(r10, r11)     // Catch:{ XmlPullParserException -> 0x00ec, IOException -> 0x00e7 }
        L_0x00e1:
            int r2 = r11.next()     // Catch:{ XmlPullParserException -> 0x00ec, IOException -> 0x00e7 }
            goto L_0x002a
        L_0x00e7:
            r9 = move-exception
            r9.printStackTrace()
    ...
    private void parseViewTransitionTags(Context context, XmlPullParser xmlPullParser) {
        TypedArray obtainStyledAttributes = context.obtainStyledAttributes(Xml.asAttributeSet(xmlPullParser), C0483R.styleable.ViewTransition);
        int indexCount = obtainStyledAttributes.getIndexCount();
        for (int i = 0; i < indexCount; i++) {
            int index = obtainStyledAttributes.getIndex(i);
            if (index == C0483R.styleable.ViewTransition_android_id) {
                this.mId = obtainStyledAttributes.getResourceId(index, this.mId);
            } else if (index == C0483R.styleable.ViewTransition_motionTarget) {
            ...
            } else if (index == C0483R.styleable.ViewTransition_onStateTransition) {
                this.mOnStateTransition = obtainStyledAttributes.getInt(index, this.mOnStateTransition);
            } else if (index == C0483R.styleable.ViewTransition_transitionDisable) {
                this.mDisabled = obtainStyledAttributes.getBoolean(index, this.mDisabled);
            } else if (index == C0483R.styleable.ViewTransition_pathMotionArc) {
                this.mPathMotionArc = obtainStyledAttributes.getInt(index, this.mPathMotionArc);
            } else if (index == C0483R.styleable.ViewTransition_duration) {
                this.mDuration = obtainStyledAttributes.getInt(index, this.mDuration);
            } else if (index == C0483R.styleable.ViewTransition_upDuration) {
                this.mUpDuration = obtainStyledAttributes.getInt(index, this.mUpDuration);
            } else if (index == C0483R.styleable.ViewTransition_viewTransitionMode) {
                this.mViewTransitionMode = obtainStyledAttributes.getInt(index, this.mViewTransitionMode);
            } else if (index == C0483R.styleable.ViewTransition_motionInterpolator) {
    ...
    public void applyTransition(ViewTransitionController viewTransitionController, MotionLayout motionLayout, int i, ConstraintSet constraintSet, View... viewArr) {
        if (!this.mDisabled) {
            ...
            motionLayout.updateState(C0483R.C0486id.view_transition, constraintSet);
            motionLayout.setState(C0483R.C0486id.view_transition, -1, -1);
            MotionScene.Transition transition = new MotionScene.Transition(-1, motionLayout.mScene, C0483R.C0486id.view_transition, i);
    ...
    public /* synthetic */ void mo11399x14d7500(View[] viewArr) {
        if (this.mSetsTag != -1) {
