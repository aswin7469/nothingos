...
public class Flow extends VirtualLayout {
    ...
    public void measure(int i, int i2, int i3, int i4) {
        ...
        char c5 = z ? 1 : 0;
        char c6 = z ? 1 : 0;
        int i16 = iArr[c] + paddingTop + paddingBottom;
        if (i == 1073741824) {
            i15 = i2;
    ...
    private void measureChainWrap(ConstraintWidget[] constraintWidgetArr, int i, int i2, int i3, int[] iArr) {
        ...
        if (i2 == 0) {
            ...
            while (i9 < i) {
                ...
                int i10 = i4;
                boolean z = (this.mHorizontalGap + i8) + widgetWidth > i3 && widgetsList.biggest != null;
            ...
            while (i12 < i) {
                ...
                int i13 = i4;
                boolean z2 = (this.mVerticalGap + i11) + widgetHeight > i3 && widgetsList.biggest != null;
    ...
    /* JADX WARN: Unsupported multi-entry loop pattern (BACK_EDGE: B:77:0x011b -> B:22:0x0063). Please submit an issue!!! */
    /* JADX WARN: Unsupported multi-entry loop pattern (BACK_EDGE: B:78:0x011d -> B:22:0x0063). Please submit an issue!!! */
    /* JADX WARN: Unsupported multi-entry loop pattern (BACK_EDGE: B:80:0x0123 -> B:22:0x0063). Please submit an issue!!! */
    /* JADX WARN: Unsupported multi-entry loop pattern (BACK_EDGE: B:81:0x0125 -> B:22:0x0063). Please submit an issue!!! */
    /*
