...
public class MotionLabel extends View implements FloatLayout {
    ...
    private void setUpTheme(Context context, AttributeSet attributeSet) {
        ...
        context.getTheme().resolveAttribute(C0483R.attr.colorPrimary, typedValue, true);
        TextPaint textPaint = this.mPaint;
    ...
    public void layout(int i, int i2, int i3, int i4) {
        ...
        if (this.mAutoSize) {
            ...
            float height = (float) ((int) (((float) this.mTempRect.height()) * 1.3f));
            if (f3 * f2 > height * f) {
    ...
    public void setRoundPercent(float f) {
        ...
        if (f != 0.0f) {
            ...
            if (this.mViewOutlineProvider == null) {
                C04791 r6 = new ViewOutlineProvider() {
    ...
    public void setRound(float f) {
        ...
        if (f != 0.0f) {
            ...
            if (this.mViewOutlineProvider == null) {
                C04802 r5 = new ViewOutlineProvider() {
                    public void getOutline(View view, Outline outline) {
