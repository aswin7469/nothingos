...
import androidx.constraintlayout.widget.C0483R;
...
public class ConstraintSet {
    ...
    private String sideToString(int i) {
        switch (i) {
            case 1:
                return NavigationBarInflaterView.LEFT;
            case 2:
                return NavigationBarInflaterView.RIGHT;
            case 3:
                return "top";
            case 4:
                return "bottom";
    ...
    static {
        mapToConstant.append(C0483R.styleable.Constraint_layout_constraintLeft_toLeftOf, 25);
        mapToConstant.append(C0483R.styleable.Constraint_layout_constraintLeft_toRightOf, 26);
        mapToConstant.append(C0483R.styleable.Constraint_layout_constraintRight_toLeftOf, 29);
        mapToConstant.append(C0483R.styleable.Constraint_layout_constraintRight_toRightOf, 30);
        mapToConstant.append(C0483R.styleable.Constraint_layout_constraintTop_toTopOf, 36);
        mapToConstant.append(C0483R.styleable.Constraint_layout_constraintTop_toBottomOf, 35);
        mapToConstant.append(C0483R.styleable.Constraint_layout_constraintBottom_toTopOf, 4);
        mapToConstant.append(C0483R.styleable.Constraint_layout_constraintBottom_toBottomOf, 3);
        mapToConstant.append(C0483R.styleable.Constraint_layout_constraintBaseline_toBaselineOf, 1);
        mapToConstant.append(C0483R.styleable.Constraint_layout_constraintBaseline_toTopOf, 91);
        mapToConstant.append(C0483R.styleable.Constraint_layout_constraintBaseline_toBottomOf, 92);
        mapToConstant.append(C0483R.styleable.Constraint_layout_editor_absoluteX, 6);
        mapToConstant.append(C0483R.styleable.Constraint_layout_editor_absoluteY, 7);
        mapToConstant.append(C0483R.styleable.Constraint_layout_constraintGuide_begin, 17);
        mapToConstant.append(C0483R.styleable.Constraint_layout_constraintGuide_end, 18);
        mapToConstant.append(C0483R.styleable.Constraint_layout_constraintGuide_percent, 19);
        mapToConstant.append(C0483R.styleable.Constraint_android_orientation, 27);
        mapToConstant.append(C0483R.styleable.Constraint_layout_constraintStart_toEndOf, 32);
        mapToConstant.append(C0483R.styleable.Constraint_layout_constraintStart_toStartOf, 33);
        mapToConstant.append(C0483R.styleable.Constraint_layout_constraintEnd_toStartOf, 10);
        mapToConstant.append(C0483R.styleable.Constraint_layout_constraintEnd_toEndOf, 9);
        mapToConstant.append(C0483R.styleable.Constraint_layout_goneMarginLeft, 13);
        mapToConstant.append(C0483R.styleable.Constraint_layout_goneMarginTop, 16);
        mapToConstant.append(C0483R.styleable.Constraint_layout_goneMarginRight, 14);
        mapToConstant.append(C0483R.styleable.Constraint_layout_goneMarginBottom, 11);
        mapToConstant.append(C0483R.styleable.Constraint_layout_goneMarginStart, 15);
        mapToConstant.append(C0483R.styleable.Constraint_layout_goneMarginEnd, 12);
        mapToConstant.append(C0483R.styleable.Constraint_layout_constraintVertical_weight, 40);
        mapToConstant.append(C0483R.styleable.Constraint_layout_constraintHorizontal_weight, 39);
        mapToConstant.append(C0483R.styleable.Constraint_layout_constraintHorizontal_chainStyle, 41);
        mapToConstant.append(C0483R.styleable.Constraint_layout_constraintVertical_chainStyle, 42);
        mapToConstant.append(C0483R.styleable.Constraint_layout_constraintHorizontal_bias, 20);
        mapToConstant.append(C0483R.styleable.Constraint_layout_constraintVertical_bias, 37);
        mapToConstant.append(C0483R.styleable.Constraint_layout_constraintDimensionRatio, 5);
        mapToConstant.append(C0483R.styleable.Constraint_layout_constraintLeft_creator, 87);
        mapToConstant.append(C0483R.styleable.Constraint_layout_constraintTop_creator, 87);
        mapToConstant.append(C0483R.styleable.Constraint_layout_constraintRight_creator, 87);
        mapToConstant.append(C0483R.styleable.Constraint_layout_constraintBottom_creator, 87);
        mapToConstant.append(C0483R.styleable.Constraint_layout_constraintBaseline_creator, 87);
        mapToConstant.append(C0483R.styleable.Constraint_android_layout_marginLeft, 24);
        mapToConstant.append(C0483R.styleable.Constraint_android_layout_marginRight, 28);
        mapToConstant.append(C0483R.styleable.Constraint_android_layout_marginStart, 31);
        mapToConstant.append(C0483R.styleable.Constraint_android_layout_marginEnd, 8);
        mapToConstant.append(C0483R.styleable.Constraint_android_layout_marginTop, 34);
        mapToConstant.append(C0483R.styleable.Constraint_android_layout_marginBottom, 2);
        mapToConstant.append(C0483R.styleable.Constraint_android_layout_width, 23);
        mapToConstant.append(C0483R.styleable.Constraint_android_layout_height, 21);
        mapToConstant.append(C0483R.styleable.Constraint_layout_constraintWidth, 95);
        mapToConstant.append(C0483R.styleable.Constraint_layout_constraintHeight, 96);
        mapToConstant.append(C0483R.styleable.Constraint_android_visibility, 22);
        mapToConstant.append(C0483R.styleable.Constraint_android_alpha, 43);
        mapToConstant.append(C0483R.styleable.Constraint_android_elevation, 44);
        mapToConstant.append(C0483R.styleable.Constraint_android_rotationX, 45);
        mapToConstant.append(C0483R.styleable.Constraint_android_rotationY, 46);
        mapToConstant.append(C0483R.styleable.Constraint_android_rotation, 60);
        mapToConstant.append(C0483R.styleable.Constraint_android_scaleX, 47);
        mapToConstant.append(C0483R.styleable.Constraint_android_scaleY, 48);
        mapToConstant.append(C0483R.styleable.Constraint_android_transformPivotX, 49);
        mapToConstant.append(C0483R.styleable.Constraint_android_transformPivotY, 50);
        mapToConstant.append(C0483R.styleable.Constraint_android_translationX, 51);
        mapToConstant.append(C0483R.styleable.Constraint_android_translationY, 52);
        mapToConstant.append(C0483R.styleable.Constraint_android_translationZ, 53);
        mapToConstant.append(C0483R.styleable.Constraint_layout_constraintWidth_default, 54);
        mapToConstant.append(C0483R.styleable.Constraint_layout_constraintHeight_default, 55);
        mapToConstant.append(C0483R.styleable.Constraint_layout_constraintWidth_max, 56);
        mapToConstant.append(C0483R.styleable.Constraint_layout_constraintHeight_max, 57);
        mapToConstant.append(C0483R.styleable.Constraint_layout_constraintWidth_min, 58);
        mapToConstant.append(C0483R.styleable.Constraint_layout_constraintHeight_min, 59);
        mapToConstant.append(C0483R.styleable.Constraint_layout_constraintCircle, 61);
        mapToConstant.append(C0483R.styleable.Constraint_layout_constraintCircleRadius, 62);
        mapToConstant.append(C0483R.styleable.Constraint_layout_constraintCircleAngle, 63);
        mapToConstant.append(C0483R.styleable.Constraint_animateRelativeTo, 64);
        mapToConstant.append(C0483R.styleable.Constraint_transitionEasing, 65);
        mapToConstant.append(C0483R.styleable.Constraint_drawPath, 66);
        mapToConstant.append(C0483R.styleable.Constraint_transitionPathRotate, 67);
        mapToConstant.append(C0483R.styleable.Constraint_motionStagger, 79);
        mapToConstant.append(C0483R.styleable.Constraint_android_id, 38);
        mapToConstant.append(C0483R.styleable.Constraint_motionProgress, 68);
        mapToConstant.append(C0483R.styleable.Constraint_layout_constraintWidth_percent, 69);
        mapToConstant.append(C0483R.styleable.Constraint_layout_constraintHeight_percent, 70);
        mapToConstant.append(C0483R.styleable.Constraint_layout_wrapBehaviorInParent, 97);
        mapToConstant.append(C0483R.styleable.Constraint_chainUseRtl, 71);
        mapToConstant.append(C0483R.styleable.Constraint_barrierDirection, 72);
        mapToConstant.append(C0483R.styleable.Constraint_barrierMargin, 73);
        mapToConstant.append(C0483R.styleable.Constraint_constraint_referenced_ids, 74);
        mapToConstant.append(C0483R.styleable.Constraint_barrierAllowsGoneWidgets, 75);
        mapToConstant.append(C0483R.styleable.Constraint_pathMotionArc, 76);
        mapToConstant.append(C0483R.styleable.Constraint_layout_constraintTag, 77);
        mapToConstant.append(C0483R.styleable.Constraint_visibilityMode, 78);
        mapToConstant.append(C0483R.styleable.Constraint_layout_constrainedWidth, 80);
        mapToConstant.append(C0483R.styleable.Constraint_layout_constrainedHeight, 81);
        mapToConstant.append(C0483R.styleable.Constraint_polarRelativeTo, 82);
        mapToConstant.append(C0483R.styleable.Constraint_transformPivotTarget, 83);
        mapToConstant.append(C0483R.styleable.Constraint_quantizeMotionSteps, 84);
        mapToConstant.append(C0483R.styleable.Constraint_quantizeMotionPhase, 85);
        mapToConstant.append(C0483R.styleable.Constraint_quantizeMotionInterpolator, 86);
        overrideMapToConstant.append(C0483R.styleable.ConstraintOverride_layout_constraintGuide_begin, 17);
        overrideMapToConstant.append(C0483R.styleable.ConstraintOverride_layout_constraintGuide_end, 18);
        overrideMapToConstant.append(C0483R.styleable.ConstraintOverride_layout_constraintGuide_percent, 19);
        overrideMapToConstant.append(C0483R.styleable.ConstraintOverride_layout_editor_absoluteY, 6);
        overrideMapToConstant.append(C0483R.styleable.ConstraintOverride_layout_editor_absoluteY, 7);
        overrideMapToConstant.append(C0483R.styleable.ConstraintOverride_android_orientation, 27);
        overrideMapToConstant.append(C0483R.styleable.ConstraintOverride_layout_goneMarginLeft, 13);
        overrideMapToConstant.append(C0483R.styleable.ConstraintOverride_layout_goneMarginTop, 16);
        overrideMapToConstant.append(C0483R.styleable.ConstraintOverride_layout_goneMarginRight, 14);
        overrideMapToConstant.append(C0483R.styleable.ConstraintOverride_layout_goneMarginBottom, 11);
        overrideMapToConstant.append(C0483R.styleable.ConstraintOverride_layout_goneMarginStart, 15);
        overrideMapToConstant.append(C0483R.styleable.ConstraintOverride_layout_goneMarginEnd, 12);
        overrideMapToConstant.append(C0483R.styleable.ConstraintOverride_layout_constraintVertical_weight, 40);
        overrideMapToConstant.append(C0483R.styleable.ConstraintOverride_layout_constraintHorizontal_weight, 39);
        overrideMapToConstant.append(C0483R.styleable.ConstraintOverride_layout_constraintHorizontal_chainStyle, 41);
        overrideMapToConstant.append(C0483R.styleable.ConstraintOverride_layout_constraintVertical_chainStyle, 42);
        overrideMapToConstant.append(C0483R.styleable.ConstraintOverride_layout_constraintHorizontal_bias, 20);
        overrideMapToConstant.append(C0483R.styleable.ConstraintOverride_layout_constraintVertical_bias, 37);
        overrideMapToConstant.append(C0483R.styleable.ConstraintOverride_layout_constraintDimensionRatio, 5);
        overrideMapToConstant.append(C0483R.styleable.ConstraintOverride_layout_constraintLeft_creator, 87);
        overrideMapToConstant.append(C0483R.styleable.ConstraintOverride_layout_constraintTop_creator, 87);
        overrideMapToConstant.append(C0483R.styleable.ConstraintOverride_layout_constraintRight_creator, 87);
        overrideMapToConstant.append(C0483R.styleable.ConstraintOverride_layout_constraintBottom_creator, 87);
        overrideMapToConstant.append(C0483R.styleable.ConstraintOverride_layout_constraintBaseline_creator, 87);
        overrideMapToConstant.append(C0483R.styleable.ConstraintOverride_android_layout_marginLeft, 24);
        overrideMapToConstant.append(C0483R.styleable.ConstraintOverride_android_layout_marginRight, 28);
        overrideMapToConstant.append(C0483R.styleable.ConstraintOverride_android_layout_marginStart, 31);
        overrideMapToConstant.append(C0483R.styleable.ConstraintOverride_android_layout_marginEnd, 8);
        overrideMapToConstant.append(C0483R.styleable.ConstraintOverride_android_layout_marginTop, 34);
        overrideMapToConstant.append(C0483R.styleable.ConstraintOverride_android_layout_marginBottom, 2);
        overrideMapToConstant.append(C0483R.styleable.ConstraintOverride_android_layout_width, 23);
        overrideMapToConstant.append(C0483R.styleable.ConstraintOverride_android_layout_height, 21);
        overrideMapToConstant.append(C0483R.styleable.ConstraintOverride_layout_constraintWidth, 95);
        overrideMapToConstant.append(C0483R.styleable.ConstraintOverride_layout_constraintHeight, 96);
        overrideMapToConstant.append(C0483R.styleable.ConstraintOverride_android_visibility, 22);
        overrideMapToConstant.append(C0483R.styleable.ConstraintOverride_android_alpha, 43);
        overrideMapToConstant.append(C0483R.styleable.ConstraintOverride_android_elevation, 44);
        overrideMapToConstant.append(C0483R.styleable.ConstraintOverride_android_rotationX, 45);
        overrideMapToConstant.append(C0483R.styleable.ConstraintOverride_android_rotationY, 46);
        overrideMapToConstant.append(C0483R.styleable.ConstraintOverride_android_rotation, 60);
        overrideMapToConstant.append(C0483R.styleable.ConstraintOverride_android_scaleX, 47);
        overrideMapToConstant.append(C0483R.styleable.ConstraintOverride_android_scaleY, 48);
        overrideMapToConstant.append(C0483R.styleable.ConstraintOverride_android_transformPivotX, 49);
        overrideMapToConstant.append(C0483R.styleable.ConstraintOverride_android_transformPivotY, 50);
        overrideMapToConstant.append(C0483R.styleable.ConstraintOverride_android_translationX, 51);
        overrideMapToConstant.append(C0483R.styleable.ConstraintOverride_android_translationY, 52);
        overrideMapToConstant.append(C0483R.styleable.ConstraintOverride_android_translationZ, 53);
        overrideMapToConstant.append(C0483R.styleable.ConstraintOverride_layout_constraintWidth_default, 54);
        overrideMapToConstant.append(C0483R.styleable.ConstraintOverride_layout_constraintHeight_default, 55);
        overrideMapToConstant.append(C0483R.styleable.ConstraintOverride_layout_constraintWidth_max, 56);
        overrideMapToConstant.append(C0483R.styleable.ConstraintOverride_layout_constraintHeight_max, 57);
        overrideMapToConstant.append(C0483R.styleable.ConstraintOverride_layout_constraintWidth_min, 58);
        overrideMapToConstant.append(C0483R.styleable.ConstraintOverride_layout_constraintHeight_min, 59);
        overrideMapToConstant.append(C0483R.styleable.ConstraintOverride_layout_constraintCircleRadius, 62);
        overrideMapToConstant.append(C0483R.styleable.ConstraintOverride_layout_constraintCircleAngle, 63);
        overrideMapToConstant.append(C0483R.styleable.ConstraintOverride_animateRelativeTo, 64);
        overrideMapToConstant.append(C0483R.styleable.ConstraintOverride_transitionEasing, 65);
        overrideMapToConstant.append(C0483R.styleable.ConstraintOverride_drawPath, 66);
        overrideMapToConstant.append(C0483R.styleable.ConstraintOverride_transitionPathRotate, 67);
        overrideMapToConstant.append(C0483R.styleable.ConstraintOverride_motionStagger, 79);
        overrideMapToConstant.append(C0483R.styleable.ConstraintOverride_android_id, 38);
        overrideMapToConstant.append(C0483R.styleable.ConstraintOverride_motionProgress, 68);
        overrideMapToConstant.append(C0483R.styleable.ConstraintOverride_layout_constraintWidth_percent, 69);
        overrideMapToConstant.append(C0483R.styleable.ConstraintOverride_layout_constraintHeight_percent, 70);
        overrideMapToConstant.append(C0483R.styleable.ConstraintOverride_chainUseRtl, 71);
        overrideMapToConstant.append(C0483R.styleable.ConstraintOverride_barrierDirection, 72);
        overrideMapToConstant.append(C0483R.styleable.ConstraintOverride_barrierMargin, 73);
        overrideMapToConstant.append(C0483R.styleable.ConstraintOverride_constraint_referenced_ids, 74);
        overrideMapToConstant.append(C0483R.styleable.ConstraintOverride_barrierAllowsGoneWidgets, 75);
        overrideMapToConstant.append(C0483R.styleable.ConstraintOverride_pathMotionArc, 76);
        overrideMapToConstant.append(C0483R.styleable.ConstraintOverride_layout_constraintTag, 77);
        overrideMapToConstant.append(C0483R.styleable.ConstraintOverride_visibilityMode, 78);
        overrideMapToConstant.append(C0483R.styleable.ConstraintOverride_layout_constrainedWidth, 80);
        overrideMapToConstant.append(C0483R.styleable.ConstraintOverride_layout_constrainedHeight, 81);
        overrideMapToConstant.append(C0483R.styleable.ConstraintOverride_polarRelativeTo, 82);
        overrideMapToConstant.append(C0483R.styleable.ConstraintOverride_transformPivotTarget, 83);
        overrideMapToConstant.append(C0483R.styleable.ConstraintOverride_quantizeMotionSteps, 84);
        overrideMapToConstant.append(C0483R.styleable.ConstraintOverride_quantizeMotionPhase, 85);
        overrideMapToConstant.append(C0483R.styleable.ConstraintOverride_quantizeMotionInterpolator, 86);
        overrideMapToConstant.append(C0483R.styleable.ConstraintOverride_layout_wrapBehaviorInParent, 97);
    }
    ...
    public static class Layout {
        ...
        static {
            ...
            sparseIntArray.append(C0483R.styleable.Layout_layout_constraintLeft_toLeftOf, 24);
            mapToConstant.append(C0483R.styleable.Layout_layout_constraintLeft_toRightOf, 25);
            mapToConstant.append(C0483R.styleable.Layout_layout_constraintRight_toLeftOf, 28);
            mapToConstant.append(C0483R.styleable.Layout_layout_constraintRight_toRightOf, 29);
            mapToConstant.append(C0483R.styleable.Layout_layout_constraintTop_toTopOf, 35);
            mapToConstant.append(C0483R.styleable.Layout_layout_constraintTop_toBottomOf, 34);
            mapToConstant.append(C0483R.styleable.Layout_layout_constraintBottom_toTopOf, 4);
            mapToConstant.append(C0483R.styleable.Layout_layout_constraintBottom_toBottomOf, 3);
            mapToConstant.append(C0483R.styleable.Layout_layout_constraintBaseline_toBaselineOf, 1);
            mapToConstant.append(C0483R.styleable.Layout_layout_editor_absoluteX, 6);
            mapToConstant.append(C0483R.styleable.Layout_layout_editor_absoluteY, 7);
            mapToConstant.append(C0483R.styleable.Layout_layout_constraintGuide_begin, 17);
            mapToConstant.append(C0483R.styleable.Layout_layout_constraintGuide_end, 18);
            mapToConstant.append(C0483R.styleable.Layout_layout_constraintGuide_percent, 19);
            mapToConstant.append(C0483R.styleable.Layout_android_orientation, 26);
            mapToConstant.append(C0483R.styleable.Layout_layout_constraintStart_toEndOf, 31);
            mapToConstant.append(C0483R.styleable.Layout_layout_constraintStart_toStartOf, 32);
            mapToConstant.append(C0483R.styleable.Layout_layout_constraintEnd_toStartOf, 10);
            mapToConstant.append(C0483R.styleable.Layout_layout_constraintEnd_toEndOf, 9);
            mapToConstant.append(C0483R.styleable.Layout_layout_goneMarginLeft, 13);
            mapToConstant.append(C0483R.styleable.Layout_layout_goneMarginTop, 16);
            mapToConstant.append(C0483R.styleable.Layout_layout_goneMarginRight, 14);
            mapToConstant.append(C0483R.styleable.Layout_layout_goneMarginBottom, 11);
            mapToConstant.append(C0483R.styleable.Layout_layout_goneMarginStart, 15);
            mapToConstant.append(C0483R.styleable.Layout_layout_goneMarginEnd, 12);
            mapToConstant.append(C0483R.styleable.Layout_layout_constraintVertical_weight, 38);
            mapToConstant.append(C0483R.styleable.Layout_layout_constraintHorizontal_weight, 37);
            mapToConstant.append(C0483R.styleable.Layout_layout_constraintHorizontal_chainStyle, 39);
            mapToConstant.append(C0483R.styleable.Layout_layout_constraintVertical_chainStyle, 40);
            mapToConstant.append(C0483R.styleable.Layout_layout_constraintHorizontal_bias, 20);
            mapToConstant.append(C0483R.styleable.Layout_layout_constraintVertical_bias, 36);
            mapToConstant.append(C0483R.styleable.Layout_layout_constraintDimensionRatio, 5);
            mapToConstant.append(C0483R.styleable.Layout_layout_constraintLeft_creator, 76);
            mapToConstant.append(C0483R.styleable.Layout_layout_constraintTop_creator, 76);
            mapToConstant.append(C0483R.styleable.Layout_layout_constraintRight_creator, 76);
            mapToConstant.append(C0483R.styleable.Layout_layout_constraintBottom_creator, 76);
            mapToConstant.append(C0483R.styleable.Layout_layout_constraintBaseline_creator, 76);
            mapToConstant.append(C0483R.styleable.Layout_android_layout_marginLeft, 23);
            mapToConstant.append(C0483R.styleable.Layout_android_layout_marginRight, 27);
            mapToConstant.append(C0483R.styleable.Layout_android_layout_marginStart, 30);
            mapToConstant.append(C0483R.styleable.Layout_android_layout_marginEnd, 8);
            mapToConstant.append(C0483R.styleable.Layout_android_layout_marginTop, 33);
            mapToConstant.append(C0483R.styleable.Layout_android_layout_marginBottom, 2);
            mapToConstant.append(C0483R.styleable.Layout_android_layout_width, 22);
            mapToConstant.append(C0483R.styleable.Layout_android_layout_height, 21);
            mapToConstant.append(C0483R.styleable.Layout_layout_constraintWidth, 41);
            mapToConstant.append(C0483R.styleable.Layout_layout_constraintHeight, 42);
            mapToConstant.append(C0483R.styleable.Layout_layout_constrainedWidth, 41);
            mapToConstant.append(C0483R.styleable.Layout_layout_constrainedHeight, 42);
            mapToConstant.append(C0483R.styleable.Layout_layout_wrapBehaviorInParent, 97);
            mapToConstant.append(C0483R.styleable.Layout_layout_constraintCircle, 61);
            mapToConstant.append(C0483R.styleable.Layout_layout_constraintCircleRadius, 62);
            mapToConstant.append(C0483R.styleable.Layout_layout_constraintCircleAngle, 63);
            mapToConstant.append(C0483R.styleable.Layout_layout_constraintWidth_percent, 69);
            mapToConstant.append(C0483R.styleable.Layout_layout_constraintHeight_percent, 70);
            mapToConstant.append(C0483R.styleable.Layout_chainUseRtl, 71);
            mapToConstant.append(C0483R.styleable.Layout_barrierDirection, 72);
            mapToConstant.append(C0483R.styleable.Layout_barrierMargin, 73);
            mapToConstant.append(C0483R.styleable.Layout_constraint_referenced_ids, 74);
            mapToConstant.append(C0483R.styleable.Layout_barrierAllowsGoneWidgets, 75);
        }

        /* access modifiers changed from: package-private */
        public void fillFromAttributeList(Context context, AttributeSet attributeSet) {
            TypedArray obtainStyledAttributes = context.obtainStyledAttributes(attributeSet, C0483R.styleable.Layout);
            this.mApply = true;
        ...
        public void dump(androidx.constraintlayout.motion.widget.MotionScene r10, java.lang.StringBuilder r11) {
            /*
                ...
                java.lang.String r1 = "\n"
                r11.append((java.lang.String) r1)
                r1 = 0
            L_0x000e:
                int r2 = r0.length
            ...
            L_0x0022:
                ...
                java.lang.Class<java.lang.Integer> r5 = java.lang.Integer.TYPE     // Catch:{ IllegalAccessException -> 0x0079 }
                java.lang.String r6 = "\"\n"
                java.lang.String r7 = " = \""
                java.lang.String r8 = "    "
                ...
                r11.append((java.lang.String) r8)     // Catch:{ IllegalAccessException -> 0x0079 }
                r11.append((java.lang.String) r3)     // Catch:{ IllegalAccessException -> 0x0079 }
                r11.append((java.lang.String) r7)     // Catch:{ IllegalAccessException -> 0x0079 }
                if (r2 != 0) goto L_0x0051
                goto L_0x0052
            L_0x0051:
                r4 = r2
            L_0x0052:
                r11.append((java.lang.Object) r4)     // Catch:{ IllegalAccessException -> 0x0079 }
                r11.append((java.lang.String) r6)     // Catch:{ IllegalAccessException -> 0x0079 }
                goto L_0x007d
            L_0x0059:
                java.lang.Class<java.lang.Float> r5 = java.lang.Float.TYPE     // Catch:{ IllegalAccessException -> 0x0079 }
                if (r2 != r5) goto L_0x007d
    ...
    public static class Transform {
        ...
        static {
            SparseIntArray sparseIntArray = new SparseIntArray();
            mapToConstant = sparseIntArray;
            sparseIntArray.append(C0483R.styleable.Transform_android_rotation, 1);
            mapToConstant.append(C0483R.styleable.Transform_android_rotationX, 2);
            mapToConstant.append(C0483R.styleable.Transform_android_rotationY, 3);
            mapToConstant.append(C0483R.styleable.Transform_android_scaleX, 4);
            mapToConstant.append(C0483R.styleable.Transform_android_scaleY, 5);
            mapToConstant.append(C0483R.styleable.Transform_android_transformPivotX, 6);
            mapToConstant.append(C0483R.styleable.Transform_android_transformPivotY, 7);
            mapToConstant.append(C0483R.styleable.Transform_android_translationX, 8);
            mapToConstant.append(C0483R.styleable.Transform_android_translationY, 9);
            mapToConstant.append(C0483R.styleable.Transform_android_translationZ, 10);
            mapToConstant.append(C0483R.styleable.Transform_android_elevation, 11);
            mapToConstant.append(C0483R.styleable.Transform_transformPivotTarget, 12);
        }

        /* access modifiers changed from: package-private */
        public void fillFromAttributeList(Context context, AttributeSet attributeSet) {
            TypedArray obtainStyledAttributes = context.obtainStyledAttributes(attributeSet, C0483R.styleable.Transform);
            this.mApply = true;
            int indexCount = obtainStyledAttributes.getIndexCount();
            for (int i = 0; i < indexCount; i++) {
                int index = obtainStyledAttributes.getIndex(i);
    ...
    public static class PropertySet {
        ...
        /* access modifiers changed from: package-private */
        public void fillFromAttributeList(Context context, AttributeSet attributeSet) {
            TypedArray obtainStyledAttributes = context.obtainStyledAttributes(attributeSet, C0483R.styleable.PropertySet);
            this.mApply = true;
            int indexCount = obtainStyledAttributes.getIndexCount();
            for (int i = 0; i < indexCount; i++) {
                int index = obtainStyledAttributes.getIndex(i);
                if (index == C0483R.styleable.PropertySet_android_alpha) {
                    this.alpha = obtainStyledAttributes.getFloat(index, this.alpha);
                } else if (index == C0483R.styleable.PropertySet_android_visibility) {
                    this.visibility = obtainStyledAttributes.getInt(index, this.visibility);
                    this.visibility = ConstraintSet.VISIBILITY_FLAGS[this.visibility];
                } else if (index == C0483R.styleable.PropertySet_visibilityMode) {
                    this.mVisibilityMode = obtainStyledAttributes.getInt(index, this.mVisibilityMode);
                } else if (index == C0483R.styleable.PropertySet_motionProgress) {
    ...
    public static class Motion {
        ...
        static {
            SparseIntArray sparseIntArray = new SparseIntArray();
            mapToConstant = sparseIntArray;
            sparseIntArray.append(C0483R.styleable.Motion_motionPathRotate, 1);
            mapToConstant.append(C0483R.styleable.Motion_pathMotionArc, 2);
            mapToConstant.append(C0483R.styleable.Motion_transitionEasing, 3);
            mapToConstant.append(C0483R.styleable.Motion_drawPath, 4);
            mapToConstant.append(C0483R.styleable.Motion_animateRelativeTo, 5);
            mapToConstant.append(C0483R.styleable.Motion_animateCircleAngleTo, 6);
            mapToConstant.append(C0483R.styleable.Motion_motionStagger, 7);
            mapToConstant.append(C0483R.styleable.Motion_quantizeMotionSteps, 8);
            mapToConstant.append(C0483R.styleable.Motion_quantizeMotionPhase, 9);
            mapToConstant.append(C0483R.styleable.Motion_quantizeMotionInterpolator, 10);
        }

        /* access modifiers changed from: package-private */
        public void fillFromAttributeList(Context context, AttributeSet attributeSet) {
            TypedArray obtainStyledAttributes = context.obtainStyledAttributes(attributeSet, C0483R.styleable.Motion);
            this.mApply = true;
            int indexCount = obtainStyledAttributes.getIndexCount();
            for (int i = 0; i < indexCount; i++) {
                int index = obtainStyledAttributes.getIndex(i);
        ...
        static class Delta {
            ...
            public void add(int i, String str) {
                ...
                if (i2 >= iArr.length) {
                    ...
                    this.mValueString = (String[]) Arrays.copyOf((T[]) strArr, strArr.length * 2);
                }
     ...
     */
    /* Code decompiled incorrectly, please refer to instructions dump. */
    public void load(android.content.Context r10, org.xmlpull.p032v1.XmlPullParser r11) {
        /*
            r9 = this;
            int r0 = r11.getEventType()     // Catch:{ XmlPullParserException -> 0x01e2, IOException -> 0x01dd }
            r1 = 0
            r2 = r1
        L_0x0006:
            r3 = 1
            ...
            goto L_0x01d7
        L_0x0015:
            java.lang.String r0 = r11.getName()     // Catch:{ XmlPullParserException -> 0x01e2, IOException -> 0x01dd }
            java.util.Locale r8 = java.util.Locale.ROOT     // Catch:{ XmlPullParserException -> 0x01e2, IOException -> 0x01dd }
            java.lang.String r0 = r0.toLowerCase(r8)     // Catch:{ XmlPullParserException -> 0x01e2, IOException -> 0x01dd }
            int r8 = r0.hashCode()     // Catch:{ XmlPullParserException -> 0x01e2, IOException -> 0x01dd }
            switch(r8) {
            ...
            }     // Catch:{ XmlPullParserException -> 0x01e2, IOException -> 0x01dd }
        L_0x0026:
            goto L_0x004e
        L_0x0027:
            java.lang.String r8 = "constraintset"
            boolean r0 = r0.equals(r8)     // Catch:{ XmlPullParserException -> 0x01e2, IOException -> 0x01dd }
            if (r0 == 0) goto L_0x004e
            r4 = r7
            goto L_0x004e
        L_0x0031:
            java.lang.String r7 = "constraintoverride"
            boolean r0 = r0.equals(r7)     // Catch:{ XmlPullParserException -> 0x01e2, IOException -> 0x01dd }
            if (r0 == 0) goto L_0x004e
            r4 = r6
            goto L_0x004e
        L_0x003b:
        ...
        L_0x004e:
            ...
            goto L_0x01d7
        L_0x0058:
            java.util.HashMap<java.lang.Integer, androidx.constraintlayout.widget.ConstraintSet$Constraint> r0 = r9.mConstraints     // Catch:{ XmlPullParserException -> 0x01e2, IOException -> 0x01dd }
            int r3 = r2.mViewId     // Catch:{ XmlPullParserException -> 0x01e2, IOException -> 0x01dd }
            java.lang.Integer r3 = java.lang.Integer.valueOf((int) r3)     // Catch:{ XmlPullParserException -> 0x01e2, IOException -> 0x01dd }
            r0.put(r3, r2)     // Catch:{ XmlPullParserException -> 0x01e2, IOException -> 0x01dd }
            r2 = r1
            goto L_0x01d7
        L_0x0066:
            return
        ...
        L_0x0074:
            ...
            boolean r0 = r0.equals(r5)     // Catch:{ XmlPullParserException -> 0x01e2, IOException -> 0x01dd }
        ...
        L_0x0089:
            ...
            boolean r0 = r0.equals(r6)     // Catch:{ XmlPullParserException -> 0x01e2, IOException -> 0x01dd }
            if (r0 == 0) goto L_0x00d9
            r4 = r5
            goto L_0x00d9
        L_0x0093:
        ...
        L_0x00e0:
            ...
            java.util.HashMap<java.lang.String, androidx.constraintlayout.widget.ConstraintAttribute> r0 = r2.mCustomConstraints     // Catch:{ XmlPullParserException -> 0x01e2, IOException -> 0x01dd }
            androidx.constraintlayout.widget.ConstraintAttribute.parse(r10, r11, r0)     // Catch:{ XmlPullParserException -> 0x01e2, IOException -> 0x01dd }
            goto L_0x01d7
        L_0x00e9:
            java.lang.RuntimeException r9 = new java.lang.RuntimeException     // Catch:{ XmlPullParserException -> 0x01e2, IOException -> 0x01dd }
            java.lang.StringBuilder r10 = new java.lang.StringBuilder     // Catch:{ XmlPullParserException -> 0x01e2, IOException -> 0x01dd }
            r10.<init>()     // Catch:{ XmlPullParserException -> 0x01e2, IOException -> 0x01dd }
            java.lang.StringBuilder r10 = r10.append((java.lang.String) r0)     // Catch:{ XmlPullParserException -> 0x01e2, IOException -> 0x01dd }
            int r11 = r11.getLineNumber()     // Catch:{ XmlPullParserException -> 0x01e2, IOException -> 0x01dd }
            java.lang.StringBuilder r10 = r10.append((int) r11)     // Catch:{ XmlPullParserException -> 0x01e2, IOException -> 0x01dd }
            java.lang.String r10 = r10.toString()     // Catch:{ XmlPullParserException -> 0x01e2, IOException -> 0x01dd }
            r9.<init>((java.lang.String) r10)     // Catch:{ XmlPullParserException -> 0x01e2, IOException -> 0x01dd }
            throw r9     // Catch:{ XmlPullParserException -> 0x01e2, IOException -> 0x01dd }
        L_0x0104:
            if (r2 == 0) goto L_0x0111
            androidx.constraintlayout.widget.ConstraintSet$Motion r0 = r2.motion     // Catch:{ XmlPullParserException -> 0x01e2, IOException -> 0x01dd }
            android.util.AttributeSet r3 = android.util.Xml.asAttributeSet(r11)     // Catch:{ XmlPullParserException -> 0x01e2, IOException -> 0x01dd }
            r0.fillFromAttributeList(r10, r3)     // Catch:{ XmlPullParserException -> 0x01e2, IOException -> 0x01dd }
            goto L_0x01d7
        L_0x0111:
            java.lang.RuntimeException r9 = new java.lang.RuntimeException     // Catch:{ XmlPullParserException -> 0x01e2, IOException -> 0x01dd }
            java.lang.StringBuilder r10 = new java.lang.StringBuilder     // Catch:{ XmlPullParserException -> 0x01e2, IOException -> 0x01dd }
        ...
        L_0x012c:
            ...
            androidx.constraintlayout.widget.ConstraintSet$Layout r0 = r2.layout     // Catch:{ XmlPullParserException -> 0x01e2, IOException -> 0x01dd }
            android.util.AttributeSet r3 = android.util.Xml.asAttributeSet(r11)     // Catch:{ XmlPullParserException -> 0x01e2, IOException -> 0x01dd }
            r0.fillFromAttributeList(r10, r3)     // Catch:{ XmlPullParserException -> 0x01e2, IOException -> 0x01dd }
            goto L_0x01d7
        L_0x0139:
        ...
        L_0x0154:
            ...
            androidx.constraintlayout.widget.ConstraintSet$Transform r0 = r2.transform     // Catch:{ XmlPullParserException -> 0x01e2, IOException -> 0x01dd }
            android.util.AttributeSet r3 = android.util.Xml.asAttributeSet(r11)     // Catch:{ XmlPullParserException -> 0x01e2, IOException -> 0x01dd }
            r0.fillFromAttributeList(r10, r3)     // Catch:{ XmlPullParserException -> 0x01e2, IOException -> 0x01dd }
            goto L_0x01d7
        L_0x0161:
        ...
        L_0x017c:
            ...
            androidx.constraintlayout.widget.ConstraintSet$PropertySet r0 = r2.propertySet     // Catch:{ XmlPullParserException -> 0x01e2, IOException -> 0x01dd }
            android.util.AttributeSet r3 = android.util.Xml.asAttributeSet(r11)     // Catch:{ XmlPullParserException -> 0x01e2, IOException -> 0x01dd }
            r0.fillFromAttributeList(r10, r3)     // Catch:{ XmlPullParserException -> 0x01e2, IOException -> 0x01dd }
            goto L_0x01d7
        L_0x0188:
            ...
            throw r9     // Catch:{ XmlPullParserException -> 0x01e2, IOException -> 0x01dd }
        L_0x01a3:
            android.util.AttributeSet r0 = android.util.Xml.asAttributeSet(r11)     // Catch:{ XmlPullParserException -> 0x01e2, IOException -> 0x01dd }
            androidx.constraintlayout.widget.ConstraintSet$Constraint r0 = r9.fillFromAttributeList(r10, r0, r7)     // Catch:{ XmlPullParserException -> 0x01e2, IOException -> 0x01dd }
            androidx.constraintlayout.widget.ConstraintSet$Layout r2 = r0.layout     // Catch:{ XmlPullParserException -> 0x01e2, IOException -> 0x01dd }
            r2.mHelperType = r3     // Catch:{ XmlPullParserException -> 0x01e2, IOException -> 0x01dd }
            goto L_0x01d2
        L_0x01b0:
            android.util.AttributeSet r0 = android.util.Xml.asAttributeSet(r11)     // Catch:{ XmlPullParserException -> 0x01e2, IOException -> 0x01dd }
            androidx.constraintlayout.widget.ConstraintSet$Constraint r0 = r9.fillFromAttributeList(r10, r0, r7)     // Catch:{ XmlPullParserException -> 0x01e2, IOException -> 0x01dd }
            androidx.constraintlayout.widget.ConstraintSet$Layout r2 = r0.layout     // Catch:{ XmlPullParserException -> 0x01e2, IOException -> 0x01dd }
            r2.mIsGuideline = r3     // Catch:{ XmlPullParserException -> 0x01e2, IOException -> 0x01dd }
            androidx.constraintlayout.widget.ConstraintSet$Layout r2 = r0.layout     // Catch:{ XmlPullParserException -> 0x01e2, IOException -> 0x01dd }
            r2.mApply = r3     // Catch:{ XmlPullParserException -> 0x01e2, IOException -> 0x01dd }
            goto L_0x01d2
        L_0x01c1:
            android.util.AttributeSet r0 = android.util.Xml.asAttributeSet(r11)     // Catch:{ XmlPullParserException -> 0x01e2, IOException -> 0x01dd }
            androidx.constraintlayout.widget.ConstraintSet$Constraint r0 = r9.fillFromAttributeList(r10, r0, r3)     // Catch:{ XmlPullParserException -> 0x01e2, IOException -> 0x01dd }
            goto L_0x01d2
        L_0x01ca:
            android.util.AttributeSet r0 = android.util.Xml.asAttributeSet(r11)     // Catch:{ XmlPullParserException -> 0x01e2, IOException -> 0x01dd }
            androidx.constraintlayout.widget.ConstraintSet$Constraint r0 = r9.fillFromAttributeList(r10, r0, r7)     // Catch:{ XmlPullParserException -> 0x01e2, IOException -> 0x01dd }
        L_0x01d2:
            ...
            goto L_0x01d7
        L_0x01d4:
            r11.getName()     // Catch:{ XmlPullParserException -> 0x01e2, IOException -> 0x01dd }
        L_0x01d7:
            int r0 = r11.next()     // Catch:{ XmlPullParserException -> 0x01e2, IOException -> 0x01dd }
            goto L_0x0006
        L_0x01dd:
            r9 = move-exception
            r9.printStackTrace()
    ...
    private Constraint fillFromAttributeList(Context context, AttributeSet attributeSet, boolean z) {
        Constraint constraint = new Constraint();
        TypedArray obtainStyledAttributes = context.obtainStyledAttributes(attributeSet, z ? C0483R.styleable.ConstraintOverride : C0483R.styleable.Constraint);
    ...
    public static Constraint buildDelta(Context context, XmlPullParser xmlPullParser) {
        ...
        Constraint constraint = new Constraint();
        TypedArray obtainStyledAttributes = context.obtainStyledAttributes(asAttributeSet, C0483R.styleable.ConstraintOverride);
    ...
    public static void setDeltaValue(Constraint constraint, int i, float f) {
        if (i == 19) {
            ...
            constraint.layout.guideBegin = -1;
            constraint.layout.guideEnd = -1;
        } else if (i == 20) {
            constraint.layout.horizontalBias = f;
        } else if (i == 37) {
            constraint.layout.verticalBias = f;
        ...
        if (i == 6) {
            ...
            switch (i) {
                ...
                case 17:
                    ...
                    constraint.layout.guidePercent = -1.0f;
                    constraint.layout.guideEnd = -1;
                    return;
                case 18:
    ...
    private void populateConstraint(Context context, Constraint constraint, TypedArray typedArray, boolean z) {
        ...
        for (int i = 0; i < indexCount; i++) {
            int index = typedArray.getIndex(i);
            if (!(index == C0483R.styleable.Constraint_android_id || C0483R.styleable.Constraint_android_layout_marginStart == index || C0483R.styleable.Constraint_android_layout_marginEnd == index)) {
    ...
    private int[] convertReferenceString(View view, String str) {
        ...
        while (i2 < split.length) {
            ...
            try {
                i = C0483R.C0486id.class.getField(trim).getInt((Object) null);
    ...
    static String getDebugName(int i) {
        for (Field field : ConstraintSet.class.getDeclaredFields()) {
            if (field.getName().contains(BaseLocale.SEP) && field.getType() == Integer.TYPE && Modifier.isStatic(field.getModifiers()) && Modifier.isFinal(field.getModifiers())) {
                try {
