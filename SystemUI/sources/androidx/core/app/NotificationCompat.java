...
public class NotificationCompat {
    ...
    public static abstract class Style {
        ...
        public android.widget.RemoteViews applyStandardTemplate(boolean r12, int r13, boolean r14) {
            /*
                ...
                int r13 = androidx.core.C0494R.C0497id.icon
                ...
                int r12 = r12.icon
                if (r12 == 0) goto L_0x009b
                int r12 = androidx.core.C0494R.dimen.notification_right_icon_size
                int r12 = r0.getDimensionPixelSize(r12)
                int r13 = androidx.core.C0494R.dimen.notification_small_icon_background_padding
                ...
                int r13 = androidx.core.C0494R.C0497id.right_icon
                r7.setImageViewBitmap(r13, r12)
                int r12 = androidx.core.C0494R.C0497id.right_icon
            ...
            L_0x0064:
                ...
                int r12 = r12.icon
                if (r12 == 0) goto L_0x009b
                int r12 = androidx.core.C0494R.C0497id.icon
                r7.setViewVisibility(r12, r8)
                int r12 = androidx.core.C0494R.dimen.notification_large_icon_width
                int r12 = r0.getDimensionPixelSize(r12)
                int r13 = androidx.core.C0494R.dimen.notification_big_circle_margin
                int r13 = r0.getDimensionPixelSize(r13)
                int r12 = r12 - r13
                int r13 = androidx.core.C0494R.dimen.notification_small_icon_size_as_large
                int r13 = r0.getDimensionPixelSize(r13)
                androidx.core.app.NotificationCompat$Builder r1 = r11.mBuilder
                android.app.Notification r1 = r1.mNotification
                int r1 = r1.icon
            ...
            L_0x009b:
                ...
                int r12 = androidx.core.C0494R.C0497id.title
                androidx.core.app.NotificationCompat$Builder r13 = r11.mBuilder
            ...
            L_0x00aa:
                ...
                int r12 = androidx.core.C0494R.C0497id.text
                androidx.core.app.NotificationCompat$Builder r1 = r11.mBuilder
            ...
            L_0x00bd:
                ...
                int r12 = androidx.core.C0494R.C0497id.info
                androidx.core.app.NotificationCompat$Builder r1 = r11.mBuilder
                java.lang.CharSequence r1 = r1.mContentInfo
                r7.setTextViewText(r12, r1)
                int r12 = androidx.core.C0494R.C0497id.info
            ...
            L_0x00d6:
                ...
                int r12 = androidx.core.C0494R.integer.status_bar_notification_info_maxnum
                int r12 = r0.getInteger(r12)
                androidx.core.app.NotificationCompat$Builder r1 = r11.mBuilder
                int r1 = r1.mNumber
                if (r1 <= r12) goto L_0x00f4
                int r12 = androidx.core.C0494R.C0497id.info
                int r1 = androidx.core.C0494R.string.status_bar_notification_info_overflow
                java.lang.String r1 = r0.getString(r1)
                r7.setTextViewText(r12, r1)
                goto L_0x0106
            L_0x00f4:
                java.text.NumberFormat r12 = java.text.NumberFormat.getIntegerInstance()
                int r1 = androidx.core.C0494R.C0497id.info
                androidx.core.app.NotificationCompat$Builder r2 = r11.mBuilder
                int r2 = r2.mNumber
                long r2 = (long) r2
                java.lang.String r12 = r12.format((long) r2)
            ...
            L_0x0112:
                ...
                int r1 = androidx.core.C0494R.C0497id.text
                androidx.core.app.NotificationCompat$Builder r2 = r11.mBuilder
                ...
                int r1 = androidx.core.C0494R.C0497id.text2
                androidx.core.app.NotificationCompat$Builder r2 = r11.mBuilder
            ...
            L_0x013d:
                ...
                int r14 = androidx.core.C0494R.dimen.notification_subtext_size
                int r14 = r0.getDimensionPixelSize(r14)
                float r14 = (float) r14
                int r0 = androidx.core.C0494R.C0497id.text
                r7.setTextViewTextSize(r0, r8, r14)
            L_0x014d:
                int r2 = androidx.core.C0494R.C0497id.line1
                r3 = 0
                r4 = 0
                r5 = 0
                r6 = 0
            ...
            L_0x0157:
                ...
                int r14 = androidx.core.C0494R.C0497id.chronometer
                ...
                boolean r11 = r11.mChronometerCountDown
                r7.setChronometerCountDown(r14, r11)
                goto L_0x01b0
            L_0x019c:
                int r14 = androidx.core.C0494R.C0497id.time
                r7.setViewVisibility(r14, r8)
                int r14 = androidx.core.C0494R.C0497id.time
                androidx.core.app.NotificationCompat$Builder r11 = r11.mBuilder
            ...
            L_0x01af:
                r13 = r10
            L_0x01b0:
                int r11 = androidx.core.C0494R.C0497id.right_side
            ...
            L_0x01b7:
                ...
                int r11 = androidx.core.C0494R.C0497id.line3
        ...
        private Bitmap createIconWithBackground(int i, int i2, int i3, int i4) {
            int i5 = C0494R.C0496drawable.notification_icon_background;
            if (i4 == 0) {
                i4 = 0;
            }
        ...
        public void buildIntoRemoteViews(RemoteViews remoteViews, RemoteViews remoteViews2) {
            ...
            remoteViews.removeAllViews(C0494R.C0497id.notification_main_column);
            remoteViews.addView(C0494R.C0497id.notification_main_column, remoteViews2.clone());
            remoteViews.setViewVisibility(C0494R.C0497id.notification_main_column, 0);
            remoteViews.setViewPadding(C0494R.C0497id.notification_main_column_container, 0, calculateTopPadding(), 0, 0);
        }

        private void hideNormalContent(RemoteViews remoteViews) {
            remoteViews.setViewVisibility(C0494R.C0497id.title, 8);
            remoteViews.setViewVisibility(C0494R.C0497id.text2, 8);
            remoteViews.setViewVisibility(C0494R.C0497id.text, 8);
        }

        private int calculateTopPadding() {
            Resources resources = this.mBuilder.mContext.getResources();
            int dimensionPixelSize = resources.getDimensionPixelSize(C0494R.dimen.notification_top_pad);
            int dimensionPixelSize2 = resources.getDimensionPixelSize(C0494R.dimen.notification_top_pad_large_text);
    ...
    public static class MessagingStyle extends Style {
        ...
        public static final class Message {
            ...
            public Notification.MessagingStyle.Message toAndroidMessage() {
                ...
                Notification.MessagingStyle.Message message = new Notification.MessagingStyle.Message(text, timestamp, person);
    ...
    public static class DecoratedCustomViewStyle extends Style {
        ...
        private RemoteViews createRemoteViews(RemoteViews remoteViews, boolean z) {
            ...
            boolean z2 = true;
            int i = 0;
            RemoteViews applyStandardTemplate = applyStandardTemplate(true, C0494R.layout.notification_template_custom_big, false);
            applyStandardTemplate.removeAllViews(C0494R.C0497id.actions);
            ...
            if (!z || nonContextualActions == null || (min = Math.min(nonContextualActions.size(), 3)) <= 0) {
                ...
                for (int i2 = 0; i2 < min; i2++) {
                    applyStandardTemplate.addView(C0494R.C0497id.actions, generateActionButton(nonContextualActions.get(i2)));
                }
            }
            if (!z2) {
                i = 8;
            }
            applyStandardTemplate.setViewVisibility(C0494R.C0497id.actions, i);
            applyStandardTemplate.setViewVisibility(C0494R.C0497id.action_divider, i);
        ...
        private RemoteViews generateActionButton(Action action) {
            ...
            if (z) {
                i = C0494R.layout.notification_action_tombstone;
            } else {
                i = C0494R.layout.notification_action;
            }
            RemoteViews remoteViews = new RemoteViews(packageName, i);
            IconCompat iconCompat = action.getIconCompat();
            if (iconCompat != null) {
                remoteViews.setImageViewBitmap(C0494R.C0497id.action_image, createColoredBitmap(iconCompat, this.mBuilder.mContext.getResources().getColor(C0494R.C0495color.notification_action_color_filter)));
            }
            remoteViews.setTextViewText(C0494R.C0497id.action_text, action.title);
            if (!z) {
                remoteViews.setOnClickPendingIntent(C0494R.C0497id.action_container, action.actionIntent);
            }
            remoteViews.setContentDescription(C0494R.C0497id.action_container, action.title);
            return remoteViews;
        }
    }
    ...
    public static final class CarExtender implements Extender {
        ...
        private static UnreadConversation getUnreadConversationFromBundle(Bundle bundle) {
            ...
            if (remoteInput2 != null) {
                remoteInput = new RemoteInput(remoteInput2.getResultKey(), remoteInput2.getLabel(), remoteInput2.getChoices(), remoteInput2.getAllowFreeFormInput(), remoteInput2.getEditChoicesBeforeSending(), remoteInput2.getExtras(), (Set<String>) null);
            }
    ...
    static Action getActionCompatFromAction(Notification.Action action) {
        ...
        if (remoteInputs == null) {
            ...
            for (int i = 0; i < remoteInputs.length; i++) {
                ...
                remoteInputArr2[i] = new RemoteInput(remoteInput.getResultKey(), remoteInput.getLabel(), remoteInput.getChoices(), remoteInput.getAllowFreeFormInput(), remoteInput.getEditChoicesBeforeSending(), remoteInput.getExtras(), (Set<String>) null);
            }
