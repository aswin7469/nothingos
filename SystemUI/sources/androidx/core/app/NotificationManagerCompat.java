...
public final class NotificationManagerCompat {
    ...
    public void deleteUnlistedNotificationChannels(Collection<String> collection) {
        for (NotificationChannel next : this.mNotificationManager.getNotificationChannels()) {
            if (!collection.contains(next.getId()) && !collection.contains(next.getParentChannelId())) {
    ...
    private static class NotifyTask implements Task {
        ...
        public void send(INotificationSideChannel iNotificationSideChannel) throws RemoteException {
            iNotificationSideChannel.notify(this.packageName, this.f115id, this.tag, this.notif);
        }

        public String toString() {
            StringBuilder sb = new StringBuilder("NotifyTask[packageName:");
            sb.append(this.packageName);
            sb.append(", id:").append(this.f115id);
    ...
    private static class CancelTask implements Task {
        ...
        public void send(INotificationSideChannel iNotificationSideChannel) throws RemoteException {
            if (this.all) {
                ...
                iNotificationSideChannel.cancel(this.packageName, this.f114id, this.tag);
            }
        }
        ...
        public String toString() {
            ...
            sb.append(this.packageName);
            sb.append(", id:").append(this.f114id);
            sb.append(", tag:").append(this.tag);
