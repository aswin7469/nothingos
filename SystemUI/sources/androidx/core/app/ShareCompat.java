    ...
    public static class IntentBuilder {
        ...
        public android.content.Intent getIntent() {
            ...
            L_0x0065:
                ...
                androidx.core.app.ShareCompat.Api16Impl.migrateExtraStreamToClipData(r0, r1)
            L_0x007a:
                android.content.Intent r4 = r4.mIntent
                return r4
            */
        ...
        private void combineArrayExtra(String str, ArrayList<String> arrayList) {
            ...
            if (stringArrayExtra != null) {
                System.arraycopy((Object) stringArrayExtra, 0, (Object) strArr, arrayList.size(), length);
            }
        ...
        private void combineArrayExtra(String str, String[] strArr) {
            ...
            if (stringArrayExtra != null) {
                System.arraycopy((Object) stringArrayExtra, 0, (Object) strArr2, 0, length);
            }
            System.arraycopy((Object) strArr, 0, (Object) strArr2, length, strArr.length);
        ...
        private static void withinStyle(StringBuilder sb, CharSequence charSequence, int i, int i2) {
            while (i < i2) {
                ...
                if (charAt == '<') {
                    ...
                    sb.append("&#").append((int) charAt).append(NavigationBarInflaterView.GRAVITY_SEPARATOR);
                } else if (charAt == ' ') {
                    while (true) {
                        int i3 = i + 1;
