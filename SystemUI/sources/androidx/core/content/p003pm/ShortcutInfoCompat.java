...
public class ShortcutInfoCompat {
    ...
    public Intent[] getIntents() {
        Intent[] intentArr = this.mIntents;
        return (Intent[]) Arrays.copyOf((T[]) intentArr, intentArr.length);
    }
    ...
    public static class Builder {
        ...
        public Builder(ShortcutInfoCompat shortcutInfoCompat) {
            ...
            shortcutInfoCompat2.mIntents = (Intent[]) Arrays.copyOf((T[]) shortcutInfoCompat.mIntents, shortcutInfoCompat.mIntents.length);
            ...
            if (shortcutInfoCompat.mPersons != null) {
                shortcutInfoCompat2.mPersons = (Person[]) Arrays.copyOf((T[]) shortcutInfoCompat.mPersons, shortcutInfoCompat.mPersons.length);
            }
        ...
        public Builder(Context context, ShortcutInfo shortcutInfo) {
            ...
            shortcutInfoCompat.mIntents = (Intent[]) Arrays.copyOf((T[]) intents, intents.length);
