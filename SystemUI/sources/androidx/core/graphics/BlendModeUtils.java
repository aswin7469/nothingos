...
class BlendModeUtils {
    ...
    static class Api29Impl {
        ...
        static Object obtainBlendModeFromCompat(BlendModeCompat blendModeCompat) {
            switch (C05081.$SwitchMap$androidx$core$graphics$BlendModeCompat[blendModeCompat.ordinal()]) {
                case 1:
    ...
    static /* synthetic */ class C05081 {
        ...
        static {
            ...
            L_0x015c:
                return
            */
            throw new UnsupportedOperationException("Method not decompiled: androidx.core.graphics.BlendModeUtils.C05081.<clinit>():void");
        }
    }
