...
public final class ColorUtils {
    ...
    static class Api26Impl {
        ...
        static Color compositeColors(Color color, Color color2) {
            ...
            throw new IllegalArgumentException("Color models must match (" + color.getModel() + " vs. " + color2.getModel() + NavigationBarInflaterView.KEY_CODE_END);
        }
    }
    ...
    public static void RGBToXYZ(int i, int i2, int i3, double[] dArr) {
        ...
        if (dArr2.length == 3) {
            ...
            dArr2[0] = ((0.4124d * d) + (0.3576d * d2) + (0.1805d * d3)) * XYZ_WHITE_REFERENCE_Y;
            dArr2[1] = ((0.2126d * d) + (0.7152d * d2) + (0.0722d * d3)) * XYZ_WHITE_REFERENCE_Y;
            dArr2[2] = ((d * 0.0193d) + (d2 * 0.1192d) + (d3 * 0.9505d)) * XYZ_WHITE_REFERENCE_Y;
            return;
        }
