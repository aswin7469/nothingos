...
class TypefaceCompatApi21Impl extends TypefaceCompatBaseImpl {
    ...
    private File getFile(ParcelFileDescriptor parcelFileDescriptor) {
        try {
            String readlink = C0308Os.readlink("/proc/self/fd/" + parcelFileDescriptor.getFd());
            if (OsConstants.S_ISREG(C0308Os.stat(readlink).st_mode)) {
    ...
    private static Typeface createFromFamiliesWithDefault(Object obj) {
        ...
        try {
            ...
            return (Typeface) sCreateFromFamiliesWithDefault.invoke((Object) null, newInstance);
