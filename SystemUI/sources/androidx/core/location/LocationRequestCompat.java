    ...
    private static class Api19Impl {
        ...
        public static Object toLocationRequest(LocationRequestCompat locationRequestCompat, String str) {
            try {
                ...
                Object invoke = sCreateFromDeprecatedProviderMethod.invoke((Object) null, str, Long.valueOf(locationRequestCompat.getIntervalMillis()), Float.valueOf(locationRequestCompat.getMinUpdateDistanceMeters()), false);
                if (invoke == null) {
                    return null;
                }
