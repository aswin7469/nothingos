...
public class SelfDestructiveThread {
    ...
    public <T> T postAndWait(java.util.concurrent.Callable<T> r13, int r14) throws java.lang.InterruptedException {
        /*
            ...
            r12.post(r11)
            r7.lock()
            boolean r12 = r10.get()     // Catch:{ all -> 0x005d }
            if (r12 != 0) goto L_0x0034
            java.lang.Object r12 = r9.get()     // Catch:{ all -> 0x005d }
            r7.unlock()
            return r12
        L_0x0034:
            java.util.concurrent.TimeUnit r12 = java.util.concurrent.TimeUnit.MILLISECONDS     // Catch:{ all -> 0x005d }
            long r13 = (long) r14     // Catch:{ all -> 0x005d }
            long r12 = r12.toNanos(r13)     // Catch:{ all -> 0x005d }
        L_0x003b:
            long r12 = r8.awaitNanos(r12)     // Catch:{ InterruptedException -> 0x003f }
        L_0x003f:
            boolean r14 = r10.get()     // Catch:{ all -> 0x005d }
        ...
        L_0x004d:
            ...
            goto L_0x003b
        L_0x0054:
            java.lang.InterruptedException r12 = new java.lang.InterruptedException     // Catch:{ all -> 0x005d }
