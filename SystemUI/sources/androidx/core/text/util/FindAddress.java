...
class FindAddress {
    ...
    /* renamed from: NL */
    private static final String f125NL = "\n\u000b\f\r  ";

    /* renamed from: SP */
    private static final String f126SP = "\t                　";
    private static final String WORD_DELIM = ",*•\t                　\n\u000b\f\r  ";
    private static final String WORD_END = "(?=[,*•\t                　\n\u000b\f\r  ]|$)";

    /* renamed from: WS */
    private static final String f127WS = "\t                　\n\u000b\f\r  ";
    ...
    public static MatchResult matchHouseNumber(String str, int i) {
        if (i > 0 && HOUSE_PRE_DELIM.indexOf((int) str.charAt(i - 1)) == -1) {
            return null;
        }
    ...
    public static MatchResult matchState(String str, int i) {
        if (i > 0 && WORD_DELIM.indexOf((int) str.charAt(i - 1)) == -1) {
            return null;
        }
    ...
    private static int attemptMatch(java.lang.String r13, java.util.regex.MatchResult r14) {
        ...
        L_0x0069:
            ...
            goto L_0x00cb
        L_0x006d:
            java.lang.String r7 = r0.group((int) r3)
        ...
        L_0x00a7:
            ...
            java.lang.String r7 = r4.group((int) r3)
        ...
        L_0x00c6:
            ...
            goto L_0x0078
        L_0x00cb:
            java.lang.String r4 = r0.group((int) r3)
            int r14 = r0.end()
            goto L_0x0015
        L_0x00d5:
