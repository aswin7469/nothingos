...
public final class ViewPropertyAnimatorCompat {
    ...
    static class ViewPropertyAnimatorListenerApi14 implements ViewPropertyAnimatorListener {
        ...
        public void onAnimationStart(android.view.View r4) {
            ...
            L_0x000f:
                ...
                androidx.core.view.ViewPropertyAnimatorCompat r0 = r3.mVpa
                java.lang.Runnable r0 = r0.mStartAction
                androidx.core.view.ViewPropertyAnimatorCompat r3 = r3.mVpa
                r3.mStartAction = r2
                r0.run()
            L_0x0020:
                r3 = 2113929216(0x7e000000, float:4.2535296E37)
                java.lang.Object r3 = r4.getTag(r3)
                boolean r0 = r3 instanceof androidx.core.view.ViewPropertyAnimatorListener
    ...
    /* renamed from: x */
    public ViewPropertyAnimatorCompat mo13181x(float f) {
        View view = this.mView.get();
        if (view != null) {
            view.animate().x(f);
        }
    ...
    /* renamed from: y */
    public ViewPropertyAnimatorCompat mo13183y(float f) {
        View view = this.mView.get();
        if (view != null) {
            view.animate().y(f);
        }
    ...
    /* renamed from: z */
    public ViewPropertyAnimatorCompat mo13185z(float f) {
        View view = this.mView.get();
        if (view != null) {
            Api21Impl.m110z(view.animate(), f);
        }
        return this;
    }
    ...
    static class Api21Impl {
        ...
        /* renamed from: z */
        static ViewPropertyAnimator m110z(ViewPropertyAnimator viewPropertyAnimator, float f) {
