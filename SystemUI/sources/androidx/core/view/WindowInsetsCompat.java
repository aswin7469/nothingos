...
public class WindowInsetsCompat {
    ...
    public WindowInsetsCompat replaceSystemWindowInsets(int i, int i2, int i3, int i4) {
        return new Builder(this).setSystemWindowInsets(Insets.m88of(i, i2, i3, i4)).build();
    }

    @Deprecated
    public WindowInsetsCompat replaceSystemWindowInsets(Rect rect) {
        return new Builder(this).setSystemWindowInsets(Insets.m89of(rect)).build();
    }
    ...
    private static class Impl20 extends Impl {
                ...
                if (i != 2) {
                    if (i == 8) {
                        ...
                        if (systemWindowInsets.bottom > rootStableInsets.bottom) {
                            return Insets.m88of(0, 0, 0, systemWindowInsets.bottom);
                        }
                        ...
                        return Insets.m88of(0, 0, 0, this.mRootViewVisibleInsets.bottom);
                    } else if (i == 16) {
                        ...
                        if (displayCutoutCompat != null) {
                            return Insets.m88of(displayCutoutCompat.getSafeInsetLeft(), displayCutoutCompat.getSafeInsetTop(), displayCutoutCompat.getSafeInsetRight(), displayCutoutCompat.getSafeInsetBottom());
                        }
                        return Insets.NONE;
                    }
                } else if (z) {
                    ...
                    return Insets.m88of(Math.max(rootStableInsets2.left, stableInsets.left), 0, Math.max(rootStableInsets2.right, stableInsets.right), Math.max(rootStableInsets2.bottom, stableInsets.bottom));
                } else {
                    ...
                    return Insets.m88of(systemWindowInsets2.left, 0, systemWindowInsets2.right, i2);
                }
            } else if (z) {
                return Insets.m88of(0, Math.max(getRootStableInsets().top, getSystemWindowInsets().top), 0, 0);
            } else {
                return Insets.m88of(0, getSystemWindowInsets().top, 0, 0);
            }
        }
        ...
        public final Insets getSystemWindowInsets() {
            if (this.mSystemWindowInsets == null) {
                this.mSystemWindowInsets = Insets.m88of(this.mPlatformInsets.getSystemWindowInsetLeft(), this.mPlatformInsets.getSystemWindowInsetTop(), this.mPlatformInsets.getSystemWindowInsetRight(), this.mPlatformInsets.getSystemWindowInsetBottom());
            }
    ...
    private static class Impl21 extends Impl20 {
        ...
        public final Insets getStableInsets() {
            if (this.mStableInsets == null) {
                this.mStableInsets = Insets.m88of(this.mPlatformInsets.getStableInsetLeft(), this.mPlatformInsets.getStableInsetTop(), this.mPlatformInsets.getStableInsetRight(), this.mPlatformInsets.getStableInsetBottom());
            }
    ...
    static Insets insetInsets(Insets insets, int i, int i2, int i3, int i4) {
        ...
        return Insets.m88of(max, max2, max3, max4);
    }
                ...
                try {
                    ...
                    if (obj != null) {
                        ...
                        if (!(rect == null || rect2 == null)) {
                            WindowInsetsCompat build = new Builder().setStableInsets(Insets.m89of(rect)).setSystemWindowInsets(Insets.m89of(rect2)).build();
