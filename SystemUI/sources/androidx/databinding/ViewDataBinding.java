...
import androidx.databinding.library.C0609R;
...
public abstract class ViewDataBinding extends BaseObservable implements ViewBinding {
    ...
    public static final View.OnAttachStateChangeListener ROOT_REATTACHED_LISTENER = new View.OnAttachStateChangeListener() {
    ...
    public void setRootTag(View view) {
        view.setTag(C0609R.C0612id.dataBinding, this);
    }

    /* access modifiers changed from: protected */
    public void setRootTag(View[] viewArr) {
        for (View tag : viewArr) {
            tag.setTag(C0609R.C0612id.dataBinding, this);
        }
    }
    ...
    static ViewDataBinding getBinding(View view) {
        if (view != null) {
            return (ViewDataBinding) view.getTag(C0609R.C0612id.dataBinding);
        }
        return null;
    }
