...
public abstract class DynamicAnimation<T extends DynamicAnimation<T>> implements AnimationHandler.AnimationFrameCallback {
    ...
    /* renamed from: X */
    public static final ViewProperty f132X = new ViewProperty(LanguageTag.PRIVATEUSE) {
        public void setValue(View view, float f) {
            view.setX(f);
        }
    ...
    /* renamed from: Y */
    public static final ViewProperty f133Y = new ViewProperty(DateFormat.YEAR) {
        public void setValue(View view, float f) {
            view.setY(f);
        }
    ...
    /* renamed from: Z */
    public static final ViewProperty f134Z = new ViewProperty(DateFormat.ABBR_SPECIFIC_TZ) {
        public void setValue(View view, float f) {
