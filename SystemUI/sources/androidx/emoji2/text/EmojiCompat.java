...
public class EmojiCompat {
    ...
    public static EmojiCompat get() {
        ...
        synchronized (INSTANCE_LOCK) {
            emojiCompat = sInstance;
            Preconditions.checkState(emojiCompat != null, "EmojiCompat is not initialized. Please call EmojiCompat.init() first");
        }
        return emojiCompat;
    }
    ...
    public static abstract class Config {
        ...
        int mEmojiSpanIndicatorColor = ScrimController.DEBUG_FRONT_TINT;
    ...
    private static class ListenerDispatcher implements Runnable {
        ...
        ListenerDispatcher(InitCallback initCallback, int i) {
            this(Arrays.asList((InitCallback) Preconditions.checkNotNull(initCallback, "initCallback cannot be null")), i, (Throwable) null);
        }
