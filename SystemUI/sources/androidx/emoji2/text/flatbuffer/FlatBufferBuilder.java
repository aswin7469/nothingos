...
public class FlatBufferBuilder {
    ...
    public FlatBufferBuilder(int i, ByteBufferFactory byteBufferFactory, ByteBuffer byteBuffer, Utf8 utf82) {
        ...
        if (byteBuffer != null) {
            this.f136bb = byteBuffer;
            byteBuffer.clear();
            this.f136bb.order(ByteOrder.LITTLE_ENDIAN);
        } else {
            this.f136bb = byteBufferFactory.newByteBuffer(i);
        }
        this.utf8 = utf82;
        this.space = this.f136bb.capacity();
    }
    ...
    public int offset() {
        return this.f136bb.capacity() - this.space;
    }

    public void pad(int i) {
        for (int i2 = 0; i2 < i; i2++) {
            ByteBuffer byteBuffer = this.f136bb;
            int i3 = this.space - 1;
            this.space = i3;
    ...
    public ByteBuffer createUnintializedVector(int i, int i2, int i3) {
        ...
        ByteBuffer order = this.f136bb.slice().order(ByteOrder.LITTLE_ENDIAN);
        order.limit(i4);
        return order;
    }
    ...
    public int createString(CharSequence charSequence) {
        ...
        this.utf8.encodeUtf8(charSequence, this.f136bb);
        return endVector();
    }
    ...
    public int createString(ByteBuffer byteBuffer) {
        ...
        ByteBuffer byteBuffer2 = this.f136bb;
        int i = this.space - remaining;
        this.space = i;
        byteBuffer2.position(i);
        this.f136bb.put(byteBuffer);
        return endVector();
    }
    ...
    public int endTable() {
        ...
        while (true) {
            ...
            int capacity = this.f136bb.capacity() - this.vtables[i5];
            int i6 = this.space;
            short s = this.f136bb.getShort(capacity);
            if (s == this.f136bb.getShort(i6)) {
                int i7 = 2;
                while (i7 < s) {
                    if (this.f136bb.getShort(capacity + i7) == this.f136bb.getShort(i6 + i7)) {
                        i7 += 2;
                    }
                }
                i = this.vtables[i5];
        ...
        if (i != 0) {
            int capacity2 = this.f136bb.capacity() - offset;
            this.space = capacity2;
            this.f136bb.putInt(capacity2, i - offset);
        } else {
    ...
    public void required(int i, int i2) {
        int capacity = this.f136bb.capacity() - i;
        if (!(this.f136bb.getShort((capacity - this.f136bb.getInt(capacity)) + i2) != 0)) {
            throw new AssertionError((Object) "FlatBuffers: field " + i2 + " must be set");
        }
    }
    ...
    public void finish(int i, boolean z) {
        ...
        addOffset(i);
        if (z) {
            addInt(this.f136bb.capacity() - this.space);
        }
        this.f136bb.position(this.space);
        this.finished = true;
    }
    ...
    public byte[] sizedByteArray(int i, int i2) {
        ...
        this.f136bb.position(i);
        this.f136bb.get(bArr);
        return bArr;
    }

    public byte[] sizedByteArray() {
        return sizedByteArray(this.space, this.f136bb.capacity() - this.space);
    }

    public InputStream sizedInputStream() {
        finished();
        ByteBuffer duplicate = this.f136bb.duplicate();
        duplicate.position(this.space);
        duplicate.limit(this.f136bb.capacity());
