...
public final class MetadataItem extends Table {
    ...
    /* renamed from: id */
    public int mo14606id() {
        int __offset = __offset(4);
        if (__offset != 0) {
            return this.f141bb.getInt(__offset + this.bb_pos);
        }
        return 0;
    }
    ...
    public boolean emojiStyle() {
        ...
        return (__offset == 0 || this.f141bb.get(__offset + this.bb_pos) == 0) ? false : true;
    }

    public short sdkAdded() {
        int __offset = __offset(8);
        if (__offset != 0) {
            return this.f141bb.getShort(__offset + this.bb_pos);
        }
        return 0;
    }
    ...
    public int codepoints(int i) {
        ...
        if (__offset != 0) {
            return this.f141bb.getInt(__vector(__offset) + (i * 4));
        }
        return 0;
    }
    ...
    public IntVector codepointsVector(IntVector intVector) {
        int __offset = __offset(16);
        if (__offset != 0) {
            return intVector.__assign(__vector(__offset), this.f141bb);
        }
        return null;
    }
    ...
    public static final class Vector extends BaseVector {
        ...
        public MetadataItem get(MetadataItem metadataItem, int i) {
            return metadataItem.__assign(MetadataItem.__indirect(__element(i), this.f135bb), this.f135bb);
        }
    }
}
