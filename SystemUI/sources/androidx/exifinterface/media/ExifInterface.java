...
public class ExifInterface {
    ...
    private static final ExifTag JPEG_INTERCHANGE_FORMAT_LENGTH_TAG = new ExifTag(TAG_JPEG_INTERCHANGE_FORMAT_LENGTH, MediaRouter.GlobalMediaRouter.CallbackHandler.MSG_PROVIDER_REMOVED, 4);
    ...
    private static final ExifTag TAG_RAF_IMAGE_SIZE = new ExifTag(TAG_STRIP_OFFSETS, UCharacter.UnicodeBlock.TANGUT_COMPONENTS_ID, 3);
    ...
    static {
        ExifTag[] exifTagArr = {new ExifTag(TAG_NEW_SUBFILE_TYPE, 254, 4), new ExifTag(TAG_SUBFILE_TYPE, 255, 4), new ExifTag(TAG_IMAGE_WIDTH, 256, 3, 4), new ExifTag(TAG_IMAGE_LENGTH, 257, 3, 4), new ExifTag(TAG_BITS_PER_SAMPLE, 258, 3), new ExifTag(TAG_COMPRESSION, 259, 3), new ExifTag(TAG_PHOTOMETRIC_INTERPRETATION, 262, 3), new ExifTag(TAG_IMAGE_DESCRIPTION, 270, 2), new ExifTag(TAG_MAKE, 271, 2), new ExifTag(TAG_MODEL, 272, 2), new ExifTag(TAG_STRIP_OFFSETS, UCharacter.UnicodeBlock.TANGUT_COMPONENTS_ID, 3, 4), new ExifTag(TAG_ORIENTATION, UCharacter.UnicodeBlock.CJK_UNIFIED_IDEOGRAPHS_EXTENSION_F_ID, 3), new ExifTag(TAG_SAMPLES_PER_PIXEL, 277, 3), new ExifTag(TAG_ROWS_PER_STRIP, UCharacter.UnicodeBlock.SOYOMBO_ID, 3, 4), new ExifTag(TAG_STRIP_BYTE_COUNTS, UCharacter.UnicodeBlock.SYRIAC_SUPPLEMENT_ID, 3, 4), new ExifTag(TAG_X_RESOLUTION, 282, 5), new ExifTag(TAG_Y_RESOLUTION, UCharacter.UnicodeBlock.GEORGIAN_EXTENDED_ID, 5), new ExifTag(TAG_PLANAR_CONFIGURATION, UCharacter.UnicodeBlock.GUNJALA_GONDI_ID, 3), new ExifTag(TAG_RESOLUTION_UNIT, UCharacter.UnicodeBlock.OTTOMAN_SIYAQ_NUMBERS_ID, 3), new ExifTag(TAG_TRANSFER_FUNCTION, 301, 3), new ExifTag(TAG_SOFTWARE, 305, 2), new ExifTag(TAG_DATETIME, UCharacter.UnicodeBlock.SYMBOLS_FOR_LEGACY_COMPUTING_ID, 2), new ExifTag(TAG_ARTIST, UCharacter.UnicodeBlock.OLD_UYGHUR_ID, 2), new ExifTag(TAG_WHITE_POINT, UCharacter.UnicodeBlock.UNIFIED_CANADIAN_ABORIGINAL_SYLLABICS_EXTENDED_A_ID, 5), new ExifTag(TAG_PRIMARY_CHROMATICITIES, UCharacter.UnicodeBlock.VITHKUQI_ID, 5), new ExifTag(TAG_SUB_IFD_POINTER, 330, 4), new ExifTag(TAG_JPEG_INTERCHANGE_FORMAT, 513, 4), new ExifTag(TAG_JPEG_INTERCHANGE_FORMAT_LENGTH, MediaRouter.GlobalMediaRouter.CallbackHandler.MSG_PROVIDER_REMOVED, 4), new ExifTag(TAG_Y_CB_CR_COEFFICIENTS, 529, 5), new ExifTag(TAG_Y_CB_CR_SUB_SAMPLING, 530, 3), new ExifTag(TAG_Y_CB_CR_POSITIONING, 531, 3), new ExifTag(TAG_REFERENCE_BLACK_WHITE, 532, 5), new ExifTag(TAG_COPYRIGHT, 33432, 2), new ExifTag(TAG_EXIF_IFD_POINTER, 34665, 4), new ExifTag(TAG_GPS_INFO_IFD_POINTER, 34853, 4), new ExifTag(TAG_RW2_SENSOR_TOP_BORDER, 4, 4), new ExifTag(TAG_RW2_SENSOR_LEFT_BORDER, 5, 4), new ExifTag(TAG_RW2_SENSOR_BOTTOM_BORDER, 6, 4), new ExifTag(TAG_RW2_SENSOR_RIGHT_BORDER, 7, 4), new ExifTag(TAG_RW2_ISO, 23, 3), new ExifTag(TAG_RW2_JPG_FROM_RAW, 46, 7), new ExifTag(TAG_XMP, 700, 1)};
        ...
        SimpleDateFormat simpleDateFormat = new SimpleDateFormat("yyyy:MM:dd HH:mm:ss", Locale.f700US);
        sFormatterPrimary = simpleDateFormat;
        simpleDateFormat.setTimeZone(TimeZone.getTimeZone("UTC"));
        SimpleDateFormat simpleDateFormat2 = new SimpleDateFormat("yyyy-MM-dd HH:mm:ss", Locale.f700US);
    ...
    private static class ExifAttribute {
        ...
        public java.lang.Object getValue(java.nio.ByteOrder r11) {
            ...
            L_0x012e:
                ...
                r11.append((char) r4)     // Catch:{ IOException -> 0x018b }
                goto L_0x013c
            L_0x0137:
                r4 = 63
                r11.append((char) r4)     // Catch:{ IOException -> 0x018b }
            L_0x013c:
                ...
                goto L_0x0123
            L_0x013f:
                java.lang.String r10 = r11.toString()     // Catch:{ IOException -> 0x018b }
            ...
            L_0x014c:
                ...
                byte[] r10 = r10.bytes     // Catch:{ IOException -> 0x018b }
                byte r10 = r10[r5]     // Catch:{ IOException -> 0x018b }
                int r10 = r10 + 48
                char r10 = (char) r10     // Catch:{ IOException -> 0x018b }
                r4[r5] = r10     // Catch:{ IOException -> 0x018b }
                r11.<init>((char[]) r4)     // Catch:{ IOException -> 0x018b }
            ...
            L_0x0170:
                java.lang.String r11 = new java.lang.String     // Catch:{ IOException -> 0x018b }
                byte[] r10 = r10.bytes     // Catch:{ IOException -> 0x018b }
                java.nio.charset.Charset r4 = androidx.exifinterface.media.ExifInterface.ASCII     // Catch:{ IOException -> 0x018b }
                r11.<init>((byte[]) r10, (java.nio.charset.Charset) r4)     // Catch:{ IOException -> 0x018b }
            ...
            L_0x0191:
                ...
                android.util.Log.w(r1, r11, r10)     // Catch:{ all -> 0x01a1 }
    ...
    /* Code decompiled incorrectly, please refer to instructions dump. */
    public ExifInterface(java.p026io.FileDescriptor r4) throws java.p026io.IOException {
        /*
            r3 = this;
            r3.<init>()
            ...
            java.io.FileDescriptor r4 = android.system.C0308Os.dup(r4)     // Catch:{ Exception -> 0x002b }
            r1 = 1
            goto L_0x0037
        L_0x002b:
            r3 = move-exception
        ...
        L_0x0037:
            ...
            r2.<init>((java.p026io.FileDescriptor) r4)     // Catch:{ all -> 0x004b }
            ...
            if (exifAttribute != null) {
                ...
                if (!str.equals(TAG_GPS_TIMESTAMP)) {
                    ...
                    if (rationalArr == null || rationalArr.length != 3) {
                        Log.w(TAG, "Invalid GPS Timestamp array. array=" + Arrays.toString((Object[]) rationalArr));
                        return null;
                    }
    ...
    public void setAttribute(java.lang.String r18, java.lang.String r19) {
        ...
        L_0x00b9:
            ...
            r2.<init>()
            java.lang.String r4 = r8.group((int) r7)
            int r4 = java.lang.Integer.parseInt(r4)
            java.lang.StringBuilder r2 = r2.append((int) r4)
            java.lang.String r4 = "/1,"
            java.lang.StringBuilder r2 = r2.append((java.lang.String) r4)
            java.lang.String r5 = r8.group((int) r3)
            int r5 = java.lang.Integer.parseInt(r5)
            java.lang.StringBuilder r2 = r2.append((int) r5)
            java.lang.StringBuilder r2 = r2.append((java.lang.String) r4)
            r4 = 3
            java.lang.String r4 = r8.group((int) r4)
            int r4 = java.lang.Integer.parseInt(r4)
            java.lang.StringBuilder r2 = r2.append((int) r4)
            java.lang.String r4 = "/1"
            java.lang.StringBuilder r2 = r2.append((java.lang.String) r4)
        ...
        L_0x0194:
            ...
            java.lang.StringBuilder r10 = r10.append((java.lang.String) r1)
        ...
        L_0x01bd:
            ...
            r13.<init>((java.lang.String) r15)
            int r8 = r8.secondaryFormat
            r8 = r11[r8]
            java.lang.StringBuilder r8 = r13.append((java.lang.String) r8)
            java.lang.String r8 = r8.toString()
        L_0x01ce:
            java.lang.StringBuilder r8 = r10.append((java.lang.String) r8)
            java.lang.String r10 = " (guess: "
            java.lang.StringBuilder r8 = r8.append((java.lang.String) r10)
        ...
        L_0x01f1:
            java.lang.StringBuilder r10 = new java.lang.StringBuilder
            r10.<init>((java.lang.String) r15)
            java.lang.Object r9 = r9.second
            java.lang.Integer r9 = (java.lang.Integer) r9
            int r9 = r9.intValue()
            r9 = r11[r9]
            java.lang.StringBuilder r9 = r10.append((java.lang.String) r9)
            java.lang.String r14 = r9.toString()
        L_0x0208:
            java.lang.StringBuilder r8 = r8.append((java.lang.String) r14)
            java.lang.String r9 = ")"
        ...
        L_0x0227:
            ...
            java.lang.StringBuilder r3 = r3.append((int) r8)
    ...
    private static boolean isSeekableFD(FileDescriptor fileDescriptor) {
        try {
            C0308Os.lseek(fileDescriptor, 0, OsConstants.SEEK_CUR);
            return true;
    ...
    /* JADX DEBUG: Multi-variable search result rejected for TypeSearchVarInfo{r2v18, resolved type: java.io.FileInputStream} */
    ...
    /* JADX WARNING: Code restructure failed: missing block: B:63:0x00d4, code lost:
        android.system.C0308Os.lseek(r14.mSeekableFileDescriptor, 0, android.system.OsConstants.SEEK_SET);
        r2 = new java.p026io.FileOutputStream(r14.mSeekableFileDescriptor);
     */
    /* JADX WARNING: Code restructure failed: missing block: B:64:0x00e3, code lost:
        r2 = new java.p026io.FileOutputStream(r14.mFilename);
     */
    ...
    /* JADX WARNING: Removed duplicated region for block: B:53:0x00c2 A[ExcHandler: all (th java.lang.Throwable), Splitter:B:19:0x0058] */
    /* JADX WARNING: Removed duplicated region for block: B:63:0x00d4 A[Catch:{ Exception -> 0x0100, all -> 0x00fc }] */
    /* JADX WARNING: Removed duplicated region for block: B:64:0x00e3 A[Catch:{ Exception -> 0x0100, all -> 0x00fc }] */
    /* JADX WARNING: Removed duplicated region for block: B:88:0x0131  */
    /* Code decompiled incorrectly, please refer to instructions dump. */
    public void saveAttributes() throws java.p026io.IOException {
        /*
            r14 = this;
            java.lang.String r0 = "Failed to save new file. Original file is stored in "
            boolean r1 = r14.isSupportedFormatForSavingAttributes()
        ...
        L_0x0019:
            ...
            java.io.File r3 = java.p026io.File.createTempFile(r3, r4)     // Catch:{ Exception -> 0x0144, all -> 0x0141 }
            java.lang.String r4 = r14.mFilename     // Catch:{ Exception -> 0x0144, all -> 0x0141 }
            r5 = 0
            if (r4 == 0) goto L_0x003b
            java.io.FileInputStream r4 = new java.io.FileInputStream     // Catch:{ Exception -> 0x0144, all -> 0x0141 }
            java.lang.String r7 = r14.mFilename     // Catch:{ Exception -> 0x0144, all -> 0x0141 }
            r4.<init>((java.lang.String) r7)     // Catch:{ Exception -> 0x0144, all -> 0x0141 }
            goto L_0x0049
        L_0x003b:
            java.io.FileDescriptor r4 = r14.mSeekableFileDescriptor     // Catch:{ Exception -> 0x0144, all -> 0x0141 }
            int r7 = android.system.OsConstants.SEEK_SET     // Catch:{ Exception -> 0x0144, all -> 0x0141 }
            android.system.C0308Os.lseek(r4, r5, r7)     // Catch:{ Exception -> 0x0144, all -> 0x0141 }
            java.io.FileInputStream r4 = new java.io.FileInputStream     // Catch:{ Exception -> 0x0144, all -> 0x0141 }
            java.io.FileDescriptor r7 = r14.mSeekableFileDescriptor     // Catch:{ Exception -> 0x0144, all -> 0x0141 }
            r4.<init>((java.p026io.FileDescriptor) r7)     // Catch:{ Exception -> 0x0144, all -> 0x0141 }
        L_0x0049:
            java.io.FileOutputStream r7 = new java.io.FileOutputStream     // Catch:{ Exception -> 0x013d, all -> 0x0139 }
            r7.<init>((java.p026io.File) r3)     // Catch:{ Exception -> 0x013d, all -> 0x0139 }
            copy(r4, r7)     // Catch:{ Exception -> 0x0137, all -> 0x0135 }
            closeQuietly(r4)
            closeQuietly(r7)
            r4 = 0
            java.io.FileInputStream r7 = new java.io.FileInputStream     // Catch:{ Exception -> 0x00c6, all -> 0x00c2 }
            r7.<init>((java.p026io.File) r3)     // Catch:{ Exception -> 0x00c6, all -> 0x00c2 }
            java.lang.String r8 = r14.mFilename     // Catch:{ Exception -> 0x00bd, all -> 0x00c2 }
            if (r8 == 0) goto L_0x0069
            java.io.FileOutputStream r8 = new java.io.FileOutputStream     // Catch:{ Exception -> 0x00bd, all -> 0x00c2 }
            java.lang.String r9 = r14.mFilename     // Catch:{ Exception -> 0x00bd, all -> 0x00c2 }
            r8.<init>((java.lang.String) r9)     // Catch:{ Exception -> 0x00bd, all -> 0x00c2 }
            goto L_0x0077
        L_0x0069:
            java.io.FileDescriptor r8 = r14.mSeekableFileDescriptor     // Catch:{ Exception -> 0x00bd, all -> 0x00c2 }
            int r9 = android.system.OsConstants.SEEK_SET     // Catch:{ Exception -> 0x00bd, all -> 0x00c2 }
            android.system.C0308Os.lseek(r8, r5, r9)     // Catch:{ Exception -> 0x00bd, all -> 0x00c2 }
            java.io.FileOutputStream r8 = new java.io.FileOutputStream     // Catch:{ Exception -> 0x00bd, all -> 0x00c2 }
            java.io.FileDescriptor r9 = r14.mSeekableFileDescriptor     // Catch:{ Exception -> 0x00bd, all -> 0x00c2 }
            r8.<init>((java.p026io.FileDescriptor) r9)     // Catch:{ Exception -> 0x00bd, all -> 0x00c2 }
        L_0x0077:
            java.io.BufferedInputStream r9 = new java.io.BufferedInputStream     // Catch:{ Exception -> 0x00b7, all -> 0x00c2 }
            r9.<init>(r7)     // Catch:{ Exception -> 0x00b7, all -> 0x00c2 }
            java.io.BufferedOutputStream r10 = new java.io.BufferedOutputStream     // Catch:{ Exception -> 0x00b1, all -> 0x00ad }
            r10.<init>(r8)     // Catch:{ Exception -> 0x00b1, all -> 0x00ad }
            int r11 = r14.mMimeType     // Catch:{ Exception -> 0x00a8 }
            r12 = 4
            if (r11 != r12) goto L_0x008a
            r14.saveJpegAttributes(r9, r10)     // Catch:{ Exception -> 0x00a8 }
            goto L_0x0099
        L_0x008a:
            r12 = 13
            if (r11 != r12) goto L_0x0092
            r14.savePngAttributes(r9, r10)     // Catch:{ Exception -> 0x00a8 }
            goto L_0x0099
        L_0x0092:
            r12 = 14
            if (r11 != r12) goto L_0x0099
            r14.saveWebpAttributes(r9, r10)     // Catch:{ Exception -> 0x00a8 }
        L_0x0099:
            closeQuietly(r9)
            closeQuietly(r10)
            r3.delete()
        ...
        L_0x00c9:
            ...
            r8 = r10
        L_0x00cb:
            java.io.FileInputStream r11 = new java.io.FileInputStream     // Catch:{ Exception -> 0x0106, all -> 0x0103 }
            r11.<init>((java.p026io.File) r3)     // Catch:{ Exception -> 0x0106, all -> 0x0103 }
            java.lang.String r2 = r14.mFilename     // Catch:{ Exception -> 0x0100, all -> 0x00fc }
            if (r2 != 0) goto L_0x00e3
            java.io.FileDescriptor r2 = r14.mSeekableFileDescriptor     // Catch:{ Exception -> 0x0100, all -> 0x00fc }
            int r12 = android.system.OsConstants.SEEK_SET     // Catch:{ Exception -> 0x0100, all -> 0x00fc }
            android.system.C0308Os.lseek(r2, r5, r12)     // Catch:{ Exception -> 0x0100, all -> 0x00fc }
            java.io.FileOutputStream r2 = new java.io.FileOutputStream     // Catch:{ Exception -> 0x0100, all -> 0x00fc }
            java.io.FileDescriptor r14 = r14.mSeekableFileDescriptor     // Catch:{ Exception -> 0x0100, all -> 0x00fc }
            r2.<init>((java.p026io.FileDescriptor) r14)     // Catch:{ Exception -> 0x0100, all -> 0x00fc }
            goto L_0x00ea
        L_0x00e3:
            java.io.FileOutputStream r2 = new java.io.FileOutputStream     // Catch:{ Exception -> 0x0100, all -> 0x00fc }
            java.lang.String r14 = r14.mFilename     // Catch:{ Exception -> 0x0100, all -> 0x00fc }
            r2.<init>((java.lang.String) r14)     // Catch:{ Exception -> 0x0100, all -> 0x00fc }
        L_0x00ea:
            r8 = r2
            copy(r11, r8)     // Catch:{ Exception -> 0x0100, all -> 0x00fc }
            closeQuietly(r11)     // Catch:{ all -> 0x00a5 }
            closeQuietly(r8)     // Catch:{ all -> 0x00a5 }
            java.io.IOException r14 = new java.io.IOException     // Catch:{ all -> 0x00a5 }
            java.lang.String r0 = "Failed to save new file"
            r14.<init>(r0, r7)     // Catch:{ all -> 0x00a5 }
        ...
        L_0x0106:
            r14 = move-exception
        L_0x0107:
            java.io.IOException r4 = new java.io.IOException     // Catch:{ all -> 0x011e }
            java.lang.StringBuilder r5 = new java.lang.StringBuilder     // Catch:{ all -> 0x011e }
            r5.<init>((java.lang.String) r0)     // Catch:{ all -> 0x011e }
            java.lang.String r0 = r3.getAbsolutePath()     // Catch:{ all -> 0x011e }
            java.lang.StringBuilder r0 = r5.append((java.lang.String) r0)     // Catch:{ all -> 0x011e }
            java.lang.String r0 = r0.toString()     // Catch:{ all -> 0x011e }
            r4.<init>(r0, r14)     // Catch:{ all -> 0x011e }
            throw r4     // Catch:{ all -> 0x011e }
        L_0x011e:
            r14 = move-exception
        L_0x011f:
            closeQuietly(r2)     // Catch:{ all -> 0x0126 }
            closeQuietly(r8)     // Catch:{ all -> 0x0126 }
            throw r14     // Catch:{ all -> 0x0126 }
        L_0x0126:
            r14 = move-exception
            r4 = r1
        L_0x0128:
        ...
        L_0x0146:
            ...
            r0.<init>(r1, r14)     // Catch:{ all -> 0x014e }
    ...
    /* JADX WARNING: Removed duplicated region for block: B:49:0x008b A[Catch:{ Exception -> 0x0089 }] */
    /* JADX WARNING: Removed duplicated region for block: B:64:0x00a8  */
    /* JADX WARNING: Removed duplicated region for block: B:70:0x00b3  */
    /* Code decompiled incorrectly, please refer to instructions dump. */
    public byte[] getThumbnailBytes() {
        ...
        L_0x0008:
            ...
            return r1
        L_0x000d:
            android.content.res.AssetManager$AssetInputStream r1 = r9.mAssetInputStream     // Catch:{ Exception -> 0x009b, all -> 0x0098 }
        ...
        L_0x0029:
            ...
            goto L_0x009e
        L_0x002d:
            java.lang.String r1 = r9.mFilename     // Catch:{ Exception -> 0x009b, all -> 0x0098 }
            if (r1 == 0) goto L_0x0039
            java.io.FileInputStream r1 = new java.io.FileInputStream     // Catch:{ Exception -> 0x009b, all -> 0x0098 }
            java.lang.String r3 = r9.mFilename     // Catch:{ Exception -> 0x009b, all -> 0x0098 }
            r1.<init>((java.lang.String) r3)     // Catch:{ Exception -> 0x009b, all -> 0x0098 }
            goto L_0x001a
        L_0x0039:
            java.io.FileDescriptor r1 = r9.mSeekableFileDescriptor     // Catch:{ Exception -> 0x009b, all -> 0x0098 }
            java.io.FileDescriptor r1 = android.system.C0308Os.dup(r1)     // Catch:{ Exception -> 0x009b, all -> 0x0098 }
            int r3 = android.system.OsConstants.SEEK_SET     // Catch:{ Exception -> 0x0094, all -> 0x0091 }
            r4 = 0
            android.system.C0308Os.lseek(r1, r4, r3)     // Catch:{ Exception -> 0x0094, all -> 0x0091 }
            java.io.FileInputStream r3 = new java.io.FileInputStream     // Catch:{ Exception -> 0x0094, all -> 0x0091 }
            r3.<init>((java.p026io.FileDescriptor) r1)     // Catch:{ Exception -> 0x0094, all -> 0x0091 }
            r8 = r3
            r3 = r1
            r1 = r8
        L_0x004e:
            if (r1 == 0) goto L_0x008b
            int r4 = r9.mThumbnailOffset     // Catch:{ Exception -> 0x0089 }
            int r5 = r9.mOffsetToExifData     // Catch:{ Exception -> 0x0089 }
            int r4 = r4 + r5
            long r4 = (long) r4     // Catch:{ Exception -> 0x0089 }
            long r4 = r1.skip(r4)     // Catch:{ Exception -> 0x0089 }
            int r6 = r9.mThumbnailOffset     // Catch:{ Exception -> 0x0089 }
            int r7 = r9.mOffsetToExifData     // Catch:{ Exception -> 0x0089 }
            int r6 = r6 + r7
            long r6 = (long) r6
            int r4 = (r4 > r6 ? 1 : (r4 == r6 ? 0 : -1))
            java.lang.String r5 = "Corrupted image"
            if (r4 != 0) goto L_0x0083
            int r4 = r9.mThumbnailLength     // Catch:{ Exception -> 0x0089 }
            byte[] r4 = new byte[r4]     // Catch:{ Exception -> 0x0089 }
            int r6 = r1.read(r4)     // Catch:{ Exception -> 0x0089 }
            int r7 = r9.mThumbnailLength     // Catch:{ Exception -> 0x0089 }
            if (r6 != r7) goto L_0x007d
            r9.mThumbnailBytes = r4     // Catch:{ Exception -> 0x0089 }
            closeQuietly(r1)
        ...
        L_0x007c:
            return r4
        L_0x007d:
            java.io.IOException r9 = new java.io.IOException     // Catch:{ Exception -> 0x0089 }
            r9.<init>((java.lang.String) r5)     // Catch:{ Exception -> 0x0089 }
        ...
        L_0x0089:
            ...
            goto L_0x009e
        L_0x008b:
            java.io.FileNotFoundException r9 = new java.io.FileNotFoundException     // Catch:{ Exception -> 0x0089 }
        ...
        L_0x009e:
            ...
            android.util.Log.d(r0, r4, r9)     // Catch:{ all -> 0x00ac }
            closeQuietly(r1)
    ...
    public void setLatLong(double d, double d2) {
        if (d < -90.0d || d > 90.0d || Double.isNaN(d)) {
            ...
            setAttribute(TAG_GPS_LONGITUDE_REF, d2 >= 0.0d ? "E" : LONGITUDE_WEST);
    ...
    /* JADX WARNING: Code restructure failed: missing block: B:18:0x0054, code lost:
        if (sun.util.locale.LanguageTag.SEP.equals(r1) != false) goto L_0x0056;
     */
    ...
    private static java.lang.Long parseDateTime(java.lang.String r10, java.lang.String r11, java.lang.String r12) {
        ...
        L_0x0088:
            long r3 = r3 + r10
        L_0x0089:
            java.lang.Long r10 = java.lang.Long.valueOf((long) r3)     // Catch:{ IllegalArgumentException -> 0x008e }
            return r10
        L_0x008e:
            return r0
        */
    ...
    /* Code decompiled incorrectly, please refer to instructions dump. */
    private boolean isHeifFormat(byte[] r14) throws java.p026io.IOException {
        /*
            r13 = this;
            r13 = 0
            r0 = 0
            ...
            boolean r4 = java.util.Arrays.equals((byte[]) r4, (byte[]) r5)     // Catch:{ Exception -> 0x0088, all -> 0x0085 }
        ...
        L_0x0063:
            ...
            boolean r10 = java.util.Arrays.equals((byte[]) r14, (byte[]) r10)     // Catch:{ Exception -> 0x0088, all -> 0x0085 }
            r11 = 1
    ...
    /* Code decompiled incorrectly, please refer to instructions dump. */
    private boolean isOrfFormat(byte[] r4) throws java.p026io.IOException {
        /*
            r3 = this;
            r0 = 0
            r1 = 0
    ...
    /* Code decompiled incorrectly, please refer to instructions dump. */
    private boolean isRw2Format(byte[] r4) throws java.p026io.IOException {
        /*
            r3 = this;
            r0 = 0
            r1 = 0
    ...
    /* Code decompiled incorrectly, please refer to instructions dump. */
    private void getJpegAttributes(androidx.exifinterface.media.ExifInterface.ByteOrderedDataInputStream r22, int r23, int r24) throws java.p026io.IOException {
        /*
            r21 = this;
            r0 = r21
            r1 = r22
            ...
            java.lang.StringBuilder r3 = r3.append((java.lang.Object) r1)
            java.lang.String r3 = r3.toString()
        ...
        L_0x006d:
            ...
            r12 = r9 & 255(0xff, float:3.57E-43)
            java.lang.String r12 = java.lang.Integer.toHexString(r12)
            java.lang.StringBuilder r10 = r10.append((java.lang.String) r12)
            java.lang.String r12 = " (length: "
            java.lang.StringBuilder r10 = r10.append((java.lang.String) r12)
            int r12 = r11 + 2
            java.lang.StringBuilder r10 = r10.append((int) r12)
        ...
        L_0x00f3:
            ...
            r12.<init>((byte[]) r9, (java.nio.charset.Charset) r13)
        ...
        L_0x011f:
            ...
            int r8 = r13.length
            byte[] r8 = java.util.Arrays.copyOfRange((byte[]) r9, (int) r8, (int) r11)
            int r6 = r23 + r6
            int r9 = r13.length
            int r6 = r6 + r9
        ...
        L_0x0145:
            ...
            int r6 = r6 + r14
            int r13 = r13.length
            byte[] r9 = java.util.Arrays.copyOfRange((byte[]) r9, (int) r13, (int) r11)
    ...
    private void getHeifAttributes(final ByteOrderedDataInputStream byteOrderedDataInputStream) throws IOException {
        ...
        try {
            ...
            if (DEBUG) {
                Log.d(TAG, "Heif meta: " + str3 + LanguageTag.PRIVATEUSE + str2 + ", rotation " + str);
            }
        } finally {
    ...
    private void saveWebpAttributes(InputStream inputStream, OutputStream outputStream) throws IOException {
        ...
        if (DEBUG) {
            Log.d(TAG, "saveWebpAttributes starting with (inputStream: " + inputStream2 + ", outputStream: " + outputStream2 + NavigationBarInflaterView.KEY_CODE_END);
        }
    ...
    /* Code decompiled incorrectly, please refer to instructions dump. */
    private void readImageFileDirectory(androidx.exifinterface.media.ExifInterface.ByteOrderedDataInputStream r30, int r31) throws java.p026io.IOException {
        /*
            r29 = this;
            r0 = r29
            r1 = r30
            ...
            int r4 = r1.mPosition
            java.lang.Integer r4 = java.lang.Integer.valueOf((int) r4)
            r3.add(r4)
            int r3 = r1.mPosition
            r4 = 2
            int r3 = r3 + r4
        ...
        L_0x001a:
            ...
            java.lang.StringBuilder r5 = r5.append((int) r3)
        ...
        L_0x0045:
            ...
            r12 = r20[r2]
            java.lang.Integer r4 = java.lang.Integer.valueOf((int) r13)
            ...
            java.lang.Integer r23 = java.lang.Integer.valueOf((int) r31)
            r8[r5] = r23
            java.lang.Integer r23 = java.lang.Integer.valueOf((int) r13)
            r20 = 1
            r8[r20] = r23
        ...
        L_0x0086:
            ...
            r8[r11] = r5
            java.lang.Integer r5 = java.lang.Integer.valueOf((int) r15)
            r21 = 4
            r8[r21] = r5
        ...
        L_0x00a1:
            ...
            java.lang.StringBuilder r8 = r8.append((int) r13)
            java.lang.String r8 = r8.toString()
            android.util.Log.d(r6, r8)
        L_0x00b8:
            r11 = r6
        ...
        L_0x00c5:
            ...
            java.lang.String[] r11 = IFD_FORMAT_NAMES
            r11 = r11[r14]
            java.lang.StringBuilder r8 = r8.append((java.lang.String) r11)
        ...
        L_0x010c:
            ...
            java.lang.StringBuilder r7 = r7.append((int) r15)
        ...
        L_0x0144:
            ...
            r3.<init>((java.lang.String) r14)
            java.lang.StringBuilder r3 = r3.append((int) r7)
            java.lang.String r3 = r3.toString()
        ...
        L_0x01d8:
            ...
            java.lang.StringBuilder r2 = r2.append((int) r7)
            java.lang.String r2 = r2.toString()
        ...
        L_0x01fb:
            ...
            r3.<init>((java.lang.String) r4)
            java.lang.StringBuilder r3 = r3.append((java.lang.Object) r2)
            java.lang.String r4 = " byteCount: "
            java.lang.StringBuilder r3 = r3.append((java.lang.String) r4)
            r5 = r27
            java.lang.StringBuilder r3 = r3.append((long) r5)
            java.lang.String r3 = r3.toString()
            android.util.Log.d(r11, r3)
            goto L_0x022a
        L_0x0228:
        ...
        L_0x0257:
            ...
            java.lang.Long r6 = java.lang.Long.valueOf((long) r3)
            r8 = 0
            r5[r8] = r6
            r13 = r24
        ...
        L_0x0273:
            ...
            int r6 = (int) r3
            java.lang.Integer r6 = java.lang.Integer.valueOf((int) r6)
        ...
        L_0x0298:
            ...
            r5.<init>((java.lang.String) r6)
            java.lang.StringBuilder r2 = r5.append((java.lang.Object) r2)
            java.lang.String r5 = " (at "
            java.lang.StringBuilder r2 = r2.append((java.lang.String) r5)
            java.lang.StringBuilder r2 = r2.append((long) r3)
            java.lang.String r3 = ")"
            java.lang.StringBuilder r2 = r2.append((java.lang.String) r3)
            java.lang.String r2 = r2.toString()
            android.util.Log.d(r11, r2)
            goto L_0x02d1
        L_0x02bd:
        ...
        L_0x035f:
            ...
            java.lang.Integer r5 = java.lang.Integer.valueOf((int) r2)
            r6 = 0
            r4[r6] = r5
        ...
        L_0x0385:
            ...
            java.lang.Integer r7 = java.lang.Integer.valueOf((int) r2)
        ...
        if (exifAttribute != null && exifAttribute2 != null) {
            ...
            if (convertToLongArray == null || convertToLongArray.length == 0) {
                ...
                for (int i4 = 0; i4 < convertToLongArray.length; i4++) {
                    ...
                    i2 = i8 + i6;
                    System.arraycopy((Object) bArr2, 0, (Object) bArr, i3, i6);
                    i3 += i6;
                }
                this.mThumbnailBytes = bArr;
        ...
        if (exifAttribute3 != null) {
            if (exifAttribute3.format == 5) {
                ...
                if (rationalArr == null || rationalArr.length != 2) {
                    Log.w(TAG, "Invalid crop size values. cropSize=" + Arrays.toString((Object[]) rationalArr));
                    return;
                } else {
    ...
    private static android.util.Pair<java.lang.Integer, java.lang.Integer> guessDataFormat(java.lang.String r12) {
        /*
            ...
            r3 = 1
            r4 = 2
            java.lang.Integer r5 = java.lang.Integer.valueOf((int) r4)
            r6 = -1
        ...
        L_0x0097:
            ...
            android.util.Pair r0 = new android.util.Pair
            java.lang.Integer r1 = java.lang.Integer.valueOf((int) r2)
            r0.<init>(r1, r7)
        L_0x00a2:
            int r3 = r3 + 1
            goto L_0x0029
        ...
        L_0x00dd:
            ...
            java.lang.Integer r1 = java.lang.Integer.valueOf((int) r4)     // Catch:{ NumberFormatException -> 0x00ff }
            java.lang.Integer r0 = java.lang.Integer.valueOf((int) r0)     // Catch:{ NumberFormatException -> 0x00ff }
        ...
        L_0x00f5:
            android.util.Pair r12 = new android.util.Pair     // Catch:{ NumberFormatException -> 0x00ff }
            java.lang.Integer r0 = java.lang.Integer.valueOf((int) r4)     // Catch:{ NumberFormatException -> 0x00ff }
            r12.<init>(r0, r7)     // Catch:{ NumberFormatException -> 0x00ff }
            return r12
        L_0x00ff:
            android.util.Pair r12 = new android.util.Pair
        ...
        L_0x0105:
            ...
            java.lang.Long r0 = java.lang.Long.valueOf((long) r0)     // Catch:{ NumberFormatException -> 0x014e }
            ...
            r1 = 3
            java.lang.Integer r1 = java.lang.Integer.valueOf((int) r1)     // Catch:{ NumberFormatException -> 0x014e }
            java.lang.Integer r2 = java.lang.Integer.valueOf((int) r2)     // Catch:{ NumberFormatException -> 0x014e }
        ...
        L_0x0144:
            android.util.Pair r0 = new android.util.Pair     // Catch:{ NumberFormatException -> 0x014e }
            java.lang.Integer r1 = java.lang.Integer.valueOf((int) r2)     // Catch:{ NumberFormatException -> 0x014e }
            r0.<init>(r1, r7)     // Catch:{ NumberFormatException -> 0x014e }
            return r0
        L_0x014e:
            ...
            r0 = 12
            java.lang.Integer r0 = java.lang.Integer.valueOf((int) r0)     // Catch:{ NumberFormatException -> 0x015d }
