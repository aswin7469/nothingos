...
class DefaultSpecialEffectsController extends SpecialEffectsController {
    ...
    public void executeOperations(List<SpecialEffectsController.Operation> list, boolean z) {
        ...
        for (SpecialEffectsController.Operation next : list) {
            ...
            int i = C067010.f142xe493b431[next.getFinalState().ordinal()];
            if (i == 1 || i == 2 || i == 3) {
                    ...
                    next2.addCompletionListener(new Runnable() {
                        public void run() {
                            if (arrayList3.contains(next2)) {
                                arrayList3.remove((Object) next2);
    ...
    static /* synthetic */ class C067010 {
        ...
        static {
            ...
            L_0x0012:
                int[] r0 = f142xe493b431     // Catch:{ NoSuchFieldError -> 0x001d }
            ...
            L_0x001d:
                int[] r0 = f142xe493b431     // Catch:{ NoSuchFieldError -> 0x0028 }
            ...
            L_0x0028:
                int[] r0 = f142xe493b431     // Catch:{ NoSuchFieldError -> 0x0033 }
            ...
            L_0x0033:
                return
            */
            throw new UnsupportedOperationException("Method not decompiled: androidx.fragment.app.DefaultSpecialEffectsController.C067010.<clinit>():void");
        }
    }
                ...
                if (animation == null) {
                    ...
                    if (animator == null) {
                        ...
                        if (Boolean.TRUE.equals(map.get(operation))) {
                            ...
                            C06712 r0 = new AnimatorListenerAdapter() {
    ...
    private Map<SpecialEffectsController.Operation, Boolean> startTransitions(List<TransitionInfo> list, List<SpecialEffectsController.Operation> list2, boolean z, SpecialEffectsController.Operation operation, SpecialEffectsController.Operation operation2) {
        ...
        for (TransitionInfo next3 : list) {
            if (!next3.hasSharedElementTransition() || operation6 == null || operation7 == null) {
                ...
                if (arrayMap2.isEmpty()) {
                    ...
                    C06766 r0 = new Runnable() {
                        public void run() {
                            FragmentTransition.callSharedElementStartEnd(operation9.getFragment(), operation10.getFragment(), z7, arrayMap5, false);
                        }
                    };
        ...
        while (it.hasNext()) {
            ...
            if (next4.isVisibilityUnchanged()) {
                hashMap5.put(next4.getOperation(), Boolean.valueOf(z8));
                ...
                boolean z9 = (obj3 == null || !(operation13 == operation12 || operation13 == operation11)) ? z8 : true;
                if (cloneTransition == null) {
                    if (!z9) {
                        hashMap5.put(operation13, Boolean.valueOf(z8));
                        next4.completeSpecialEffect();
                    }
                    List<SpecialEffectsController.Operation> list3 = list2;
                    view = view14;
                    ...
                    if (arrayList14.isEmpty()) {
                        ...
                        if (operation14.getFinalState() == SpecialEffectsController.Operation.State.GONE) {
                            ...
                            list2.remove((Object) operation3);
        ...
        for (final TransitionInfo next5 : list) {
            if (!next5.isVisibilityUnchanged()) {
                ...
                boolean z10 = obj3 != null && (operation15 == operation12 || operation15 == operation11);
                if (transition != null || z10) {
                    if (!ViewCompat.isLaidOut(getContainer())) {
                        if (FragmentManager.isLoggingEnabled(2)) {
                            Log.v("FragmentManager", "SpecialEffectsController: Container " + getContainer() + " has not been laid out. Completing operation " + operation15);
                        }
