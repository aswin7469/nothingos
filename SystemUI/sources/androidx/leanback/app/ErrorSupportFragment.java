...
public class ErrorSupportFragment extends BrandedSupportFragment {
    ...
    public View onCreateView(LayoutInflater layoutInflater, ViewGroup viewGroup, Bundle bundle) {
        View inflate = layoutInflater.inflate(C0742R.layout.lb_error_fragment, viewGroup, false);
        this.mErrorFrame = (ViewGroup) inflate.findViewById(C0742R.C0745id.error_frame);
        updateBackground();
        installTitleView(layoutInflater, this.mErrorFrame, bundle);
        this.mImageView = (ImageView) inflate.findViewById(C0742R.C0745id.image);
        updateImageDrawable();
        this.mTextView = (TextView) inflate.findViewById(C0742R.C0745id.message);
        updateMessage();
        this.mButton = (Button) inflate.findViewById(C0742R.C0745id.button);
        updateButton();
        Paint.FontMetricsInt fontMetricsInt = getFontMetricsInt(this.mTextView);
        setTopMargin(this.mTextView, viewGroup.getResources().getDimensionPixelSize(C0742R.dimen.lb_error_under_image_baseline_margin) + fontMetricsInt.ascent);
        setTopMargin(this.mButton, viewGroup.getResources().getDimensionPixelSize(C0742R.dimen.lb_error_under_message_baseline_margin) - fontMetricsInt.descent);
        return inflate;
    }
    ...
    private void updateBackground() {
        ...
        if (viewGroup != null) {
            ...
            if (this.mIsBackgroundTranslucent) {
                i = C0742R.C0743color.lb_error_background_color_translucent;
            } else {
                i = C0742R.C0743color.lb_error_background_color_opaque;
            }
