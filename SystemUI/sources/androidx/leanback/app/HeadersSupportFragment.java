...
public class HeadersSupportFragment extends BaseRowSupportFragment {
    private static final PresenterSelector sHeaderPresenter = new ClassPresenterSelector().addClassPresenter(DividerRow.class, new DividerPresenter()).addClassPresenter(SectionRow.class, new RowHeaderPresenter(C0742R.layout.lb_section_header, false)).addClassPresenter(Row.class, new RowHeaderPresenter(C0742R.layout.lb_header));
    ...
    public VerticalGridView findGridViewFromRoot(View view) {
        return (VerticalGridView) view.findViewById(C0742R.C0745id.browse_headers);
    }
    ...
    public int getLayoutResourceId() {
        return C0742R.layout.lb_headers_fragment;
    }
    ...
    private void updateFadingEdgeToBrandColor(int i) {
        Drawable background = getView().findViewById(C0742R.C0745id.fade_out_edge).getBackground();
