...
public abstract class OnboardingFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater layoutInflater, ViewGroup viewGroup, Bundle bundle) {
        resolveTheme();
        boolean z = false;
        ViewGroup viewGroup2 = (ViewGroup) getThemeInflater(layoutInflater).inflate(C0742R.layout.lb_onboarding_fragment, viewGroup, false);
        if (getResources().getConfiguration().getLayoutDirection() == 0) {
            z = true;
        }
        this.mIsLtr = z;
        PagingIndicator pagingIndicator = (PagingIndicator) viewGroup2.findViewById(C0742R.C0745id.page_indicator);
        ...
        View findViewById = viewGroup2.findViewById(C0742R.C0745id.button_start);
        this.mStartButton = findViewById;
        findViewById.setOnClickListener(this.mOnClickListener);
        this.mStartButton.setOnKeyListener(this.mOnKeyListener);
        this.mMainIconView = (ImageView) viewGroup2.findViewById(C0742R.C0745id.main_icon);
        this.mLogoView = (ImageView) viewGroup2.findViewById(C0742R.C0745id.logo);
        this.mTitleView = (TextView) viewGroup2.findViewById(C0742R.C0745id.title);
        this.mDescriptionView = (TextView) viewGroup2.findViewById(C0742R.C0745id.description);
    ...
    private void resolveTheme() {
        ...
        if (onProvideTheme == -1) {
            int i = C0742R.attr.onboardingTheme;
    ...
    public boolean startLogoAnimation() {
        ...
        if (this.mLogoResourceId != 0) {
            ...
            Animator loadAnimator = AnimatorInflater.loadAnimator(context, C0742R.animator.lb_onboarding_logo_enter);
            Animator loadAnimator2 = AnimatorInflater.loadAnimator(context, C0742R.animator.lb_onboarding_logo_exit);
    ...
    public void hideLogoView() {
        ...
        ViewGroup viewGroup = (ViewGroup) view.findViewById(C0742R.C0745id.background_container);
        ...
        ViewGroup viewGroup2 = (ViewGroup) view.findViewById(C0742R.C0745id.content_container);
        View onCreateContentView = onCreateContentView(themeInflater, viewGroup2);
        if (onCreateContentView != null) {
            viewGroup2.setVisibility(0);
            viewGroup2.addView(onCreateContentView);
        }
        ViewGroup viewGroup3 = (ViewGroup) view.findViewById(C0742R.C0745id.foreground_container);
        ...
        view.findViewById(C0742R.C0745id.page_container).setVisibility(0);
        view.findViewById(C0742R.C0745id.content_container).setVisibility(0);
        if (getPageCount() > 1) {
    ...
    public final void startEnterAnimation(boolean z) {
        ...
        if (context != null) {
            ...
            if (!this.mEnterAnimationFinished || z) {
                ...
                Animator loadAnimator = AnimatorInflater.loadAnimator(context, C0742R.animator.lb_onboarding_page_indicator_enter);
    ...
    public Animator onCreateDescriptionAnimator() {
        return AnimatorInflater.loadAnimator(FragmentUtil.getContext(this), C0742R.animator.lb_onboarding_description_enter);
    }

    /* access modifiers changed from: protected */
    public Animator onCreateTitleAnimator() {
        return AnimatorInflater.loadAnimator(FragmentUtil.getContext(this), C0742R.animator.lb_onboarding_title_enter);
    }
    ...
    private void onPageChangedInternal(int i) {
        ...
        if (i < getCurrentPageIndex()) {
            ...
            animator = createAnimator(this.mDescriptionView, false, 8388611, DESCRIPTION_START_DELAY_MS);
            arrayList.add(animator);
            arrayList.add(createAnimator(this.mTitleView, true, GravityCompat.END, 500));
            ...
            animator = createAnimator(this.mDescriptionView, false, GravityCompat.END, DESCRIPTION_START_DELAY_MS);
            arrayList.add(animator);
        ...
        if (getCurrentPageIndex() == getPageCount() - 1) {
            this.mStartButton.setVisibility(0);
            Animator loadAnimator = AnimatorInflater.loadAnimator(context, C0742R.animator.lb_onboarding_page_indicator_fade_out);
            ...
            arrayList.add(loadAnimator);
            Animator loadAnimator2 = AnimatorInflater.loadAnimator(context, C0742R.animator.lb_onboarding_start_button_fade_in);
            loadAnimator2.setTarget(this.mStartButton);
            arrayList.add(loadAnimator2);
        } else if (i == getPageCount() - 1) {
            this.mPageIndicator.setVisibility(0);
            Animator loadAnimator3 = AnimatorInflater.loadAnimator(context, C0742R.animator.lb_onboarding_page_indicator_fade_in);
            loadAnimator3.setTarget(this.mPageIndicator);
            arrayList.add(loadAnimator3);
            Animator loadAnimator4 = AnimatorInflater.loadAnimator(context, C0742R.animator.lb_onboarding_start_button_fade_out);
