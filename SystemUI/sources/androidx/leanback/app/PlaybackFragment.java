...
public class PlaybackFragment extends Fragment {
    ...
    private void loadBgAnimator() {
        C08607 r0 = new ValueAnimator.AnimatorUpdateListener() {
    ...
    private void loadControlRowAnimator() {
        C08618 r0 = new ValueAnimator.AnimatorUpdateListener() {
            public void onAnimationUpdate(ValueAnimator valueAnimator) {
    ...
    private void loadOtherRowAnimator() {
        C08629 r0 = new ValueAnimator.AnimatorUpdateListener() {
            public void onAnimationUpdate(ValueAnimator valueAnimator) {
    ...
    public void onCreate(Bundle bundle) {
        ...
        FragmentUtil.getContext(this).getTheme().resolveAttribute(C0742R.attr.playbackControlsAutoHideTimeout, typedValue, true);
        this.mAutohideTimerAfterPlayingInMs = typedValue.data;
        FragmentUtil.getContext(this).getTheme().resolveAttribute(C0742R.attr.playbackControlsAutoHideTickleTimeout, typedValue, true);
    ...
    public View onCreateView(LayoutInflater layoutInflater, ViewGroup viewGroup, Bundle bundle) {
        ...
        RowsFragment rowsFragment = (RowsFragment) getChildFragmentManager().findFragmentById(C0742R.C0745id.playback_controls_dock);
        this.mRowsFragment = rowsFragment;
        if (rowsFragment == null) {
            this.mRowsFragment = new RowsFragment();
            getChildFragmentManager().beginTransaction().replace(C0742R.C0745id.playback_controls_dock, this.mRowsFragment).commit();
        }
