...
public class MediaPlayerAdapter extends PlayerAdapter {
    ...
    final MediaPlayer.OnErrorListener mOnErrorListener = new MediaPlayer.OnErrorListener() {
        public boolean onError(MediaPlayer mediaPlayer, int i, int i2) {
            ...
            MediaPlayerAdapter mediaPlayerAdapter = MediaPlayerAdapter.this;
            callback.onError(mediaPlayerAdapter, i, mediaPlayerAdapter.mContext.getString(C0742R.string.lb_media_player_error, new Object[]{Integer.valueOf(i), Integer.valueOf(i2)}));
