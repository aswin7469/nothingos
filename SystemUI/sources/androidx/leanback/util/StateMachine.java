...
public final class StateMachine {
    ...
    static class Transition {
        ...
        public String toString() {
            ...
            if (event != null) {
                ...
                str = condition != null ? condition.mName : DebugKt.DEBUG_PROPERTY_VALUE_AUTO;
            }
            return NavigationBarInflaterView.SIZE_MOD_START + this.mFromState.mName + " -> " + this.mToState.mName + " <" + str + ">]";
        }
    }
    ...
    public static class State {
        ...
        public String toString() {
            return NavigationBarInflaterView.SIZE_MOD_START + this.mName + WifiEnterpriseConfig.CA_CERT_ALIAS_DELIMITER + this.mStatus + NavigationBarInflaterView.SIZE_MOD_END;
        }
