...
public class GuidanceStylist implements FragmentAnimationProvider {
    ...
    public View onCreateView(LayoutInflater layoutInflater, ViewGroup viewGroup, Guidance guidance) {
        ...
        this.mTitleView = (TextView) inflate.findViewById(C0742R.C0745id.guidance_title);
        this.mBreadcrumbView = (TextView) inflate.findViewById(C0742R.C0745id.guidance_breadcrumb);
        this.mDescriptionView = (TextView) inflate.findViewById(C0742R.C0745id.guidance_description);
        this.mIconView = (ImageView) inflate.findViewById(C0742R.C0745id.guidance_icon);
        this.mGuidanceContainer = inflate.findViewById(C0742R.C0745id.guidance_container);
        ...
        if (view != null && TextUtils.isEmpty(view.getContentDescription())) {
            ...
            if (!TextUtils.isEmpty(guidance.getBreadcrumb())) {
                sb.append(guidance.getBreadcrumb()).append(10);
            }
            if (!TextUtils.isEmpty(guidance.getTitle())) {
                sb.append(guidance.getTitle()).append(10);
            }
            if (!TextUtils.isEmpty(guidance.getDescription())) {
                sb.append(guidance.getDescription()).append(10);
            }
    ...
    public int onProvideLayoutId() {
        return C0742R.layout.lb_guidance;
    }
