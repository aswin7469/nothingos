...
public class RowHeaderPresenter extends Presenter {
    ...
    public RowHeaderPresenter() {
        this(C0742R.layout.lb_row_header);
    }
    ...
    public static class ViewHolder extends Presenter.ViewHolder {
        ...
        public ViewHolder(View view) {
            super(view);
            this.mTitleView = (RowHeaderView) view.findViewById(C0742R.C0745id.row_header);
            this.mDescriptionView = (TextView) view.findViewById(C0742R.C0745id.row_header_description);
            initColors();
        }
        ...
        public void initColors() {
            ...
            this.mUnselectAlpha = this.view.getResources().getFraction(C0742R.fraction.lb_browse_header_unselect_alpha, 1, 1);
        }
