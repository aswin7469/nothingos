...
public class ShadowOverlayContainer extends FrameLayout {
    ...
    public void useDynamicShadow() {
        useDynamicShadow(getResources().getDimension(C0742R.dimen.lb_material_shadow_normal_z), getResources().getDimension(C0742R.dimen.lb_material_shadow_focused_z));
    }
    ...
    public void initialize(boolean z, boolean z2, boolean z3) {
        initialize(!z ? 1 : this.mShadowType, z2, z3 ? getContext().getResources().getDimensionPixelSize(C0742R.dimen.lb_rounded_rect_corner_radius) : 0);
    }
