...
public class ThumbsBar extends LinearLayout {
    ...
    public ThumbsBar(Context context, AttributeSet attributeSet, int i) {
        ...
        this.mThumbWidthInPixel = context.getResources().getDimensionPixelSize(C0742R.dimen.lb_playback_transport_thumbs_width);
        this.mThumbHeightInPixel = context.getResources().getDimensionPixelSize(C0742R.dimen.lb_playback_transport_thumbs_height);
        this.mHeroThumbHeightInPixel = context.getResources().getDimensionPixelSize(C0742R.dimen.lb_playback_transport_hero_thumbs_width);
        this.mHeroThumbWidthInPixel = context.getResources().getDimensionPixelSize(C0742R.dimen.lb_playback_transport_hero_thumbs_height);
        this.mMeasuredMarginInPixel = context.getResources().getDimensionPixelSize(C0742R.dimen.lb_playback_transport_thumbs_margin);
    }
