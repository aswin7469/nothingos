...
public class DatePicker extends Picker {
    ...
    public DatePicker(Context context, AttributeSet attributeSet) {
        this(context, attributeSet, C0742R.attr.datePickerStyle);
    }
    ...
    public DatePicker(Context context, AttributeSet attributeSet, int i) {
        ...
        updateCurrentLocale();
        TypedArray obtainStyledAttributes = context.obtainStyledAttributes(attributeSet, C0742R.styleable.lbDatePicker);
        ViewCompat.saveAttributeDataForStyleable(this, context, C0742R.styleable.lbDatePicker, attributeSet, obtainStyledAttributes, 0, 0);
        try {
            String string = obtainStyledAttributes.getString(C0742R.styleable.lbDatePicker_android_minDate);
            String string2 = obtainStyledAttributes.getString(C0742R.styleable.lbDatePicker_android_maxDate);
            String string3 = obtainStyledAttributes.getString(C0742R.styleable.lbDatePicker_datePickerFormat);
            ...
            if (TextUtils.isEmpty(string2)) {
                this.mTempDate.set(SafetyCenterIssue.ISSUE_SEVERITY_LEVEL_OK, 0, 1);
