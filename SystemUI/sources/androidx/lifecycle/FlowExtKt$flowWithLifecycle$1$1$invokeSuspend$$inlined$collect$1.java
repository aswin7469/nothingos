...
public final class FlowExtKt$flowWithLifecycle$1$1$invokeSuspend$$inlined$collect$1 implements FlowCollector<T> {
    final /* synthetic */ ProducerScope $$this$callbackFlow$inlined;

    public FlowExtKt$flowWithLifecycle$1$1$invokeSuspend$$inlined$collect$1(ProducerScope producerScope) {
        this.$$this$callbackFlow$inlined = producerScope;
    }

    public Object emit(T t, Continuation<? super Unit> continuation) {
        Object send = this.$$this$callbackFlow$inlined.send(t, continuation);
