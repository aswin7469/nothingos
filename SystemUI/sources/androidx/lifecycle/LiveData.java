...
public abstract class LiveData<T> {
    ...
    public void observe(LifecycleOwner lifecycleOwner, Observer<? super T> observer) {
        ...
        if (lifecycleOwner.mo1437getLifecycle().getCurrentState() == Lifecycle.State.DESTROYED) {
            return;
        }
        ...
        lifecycleOwner.mo1437getLifecycle().addObserver(lifecycleBoundObserver);
    }
    ...
    class LifecycleBoundObserver extends LiveData<T>.ObserverWrapper implements LifecycleEventObserver {
        ...
        boolean shouldBeActive() {
            return this.mOwner.mo1437getLifecycle().getCurrentState().isAtLeast(Lifecycle.State.STARTED);
        }

        @Override // androidx.lifecycle.LifecycleEventObserver
        public void onStateChanged(LifecycleOwner lifecycleOwner, Lifecycle.Event event) {
            Lifecycle.State currentState = this.mOwner.mo1437getLifecycle().getCurrentState();
            ...
            while (state != currentState) {
                ...
                state = currentState;
                currentState = this.mOwner.mo1437getLifecycle().getCurrentState();
            }
        }
        ...
        @Override // androidx.lifecycle.LiveData.ObserverWrapper
        void detachObserver() {
            this.mOwner.mo1437getLifecycle().removeObserver(this);
        }
    }
