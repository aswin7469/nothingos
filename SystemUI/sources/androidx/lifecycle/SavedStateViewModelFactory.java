...
public final class SavedStateViewModelFactory extends ViewModelProvider.KeyedFactory {
    ...
    public <T extends ViewModel> T create(String str, Class<T> cls) {
        ...
        if (isAssignableFrom) {
            try {
                ...
                if (application != null) {
                    t = (ViewModel) constructor.newInstance(application, create.getHandle());
        ...
        t = (ViewModel) constructor.newInstance(create.getHandle());
        t.setTagIfAbsent("androidx.lifecycle.savedstate.vm.tag", create);
        return t;
    }
    ...
    private static <T> Constructor<T> findMatchingConstructor(Class<T> cls, Class<?>[] clsArr) {
        for (Constructor<T> constructor : cls.getConstructors()) {
            if (Arrays.equals((Object[]) clsArr, (Object[]) constructor.getParameterTypes())) {
                return constructor;
            }
        }
        return null;
