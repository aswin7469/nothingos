...
public final class WithLifecycleStateKt {
    ...
    /* JADX WARNING: type inference failed for: r0v8, types: [java.lang.Throwable, kotlin.coroutines.Continuation] */
    ...
    /* JADX WARNING: type inference failed for: r0v5, types: [java.lang.Throwable, kotlin.coroutines.Continuation] */
    ...
    public static final <R> Object suspendWithStateAtLeastUnchecked(Lifecycle lifecycle, Lifecycle.State state, boolean z, CoroutineDispatcher coroutineDispatcher, Function0<? extends R> function0, Continuation<? super R> continuation) {
        ...
        C1104xfdb59cc4 withLifecycleStateKt$suspendWithStateAtLeastUnchecked$2$observer$1 = new C1104xfdb59cc4(state, lifecycle, cancellableContinuation, function0);
        if (z) {
