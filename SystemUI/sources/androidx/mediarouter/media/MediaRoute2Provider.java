...
class MediaRoute2Provider extends MediaRouteProvider {
    ...
    public void refreshRoutes() {
        List<MediaRoute2Info> list = (List) this.mMediaRouter2.getRoutes().stream().distinct().filter(new MediaRoute2Provider$$ExternalSyntheticLambda1()).collect(Collectors.toList());
        if (!list.equals(this.mRoutes)) {
            ...
            setDescriptor(new MediaRouteProviderDescriptor.Builder().setSupportsDynamicGroupRoute(true).addRoutes((List) this.mRoutes.stream().map(new MediaRoute2Provider$$ExternalSyntheticLambda2()).filter(new MediaRoute2Provider$$ExternalSyntheticLambda3()).collect(Collectors.toList())).build());
        }
    }
    ...
    public void setDynamicRouteDescriptors(MediaRouter2.RoutingController routingController) {
        ...
        String string = getContext().getString(C1159R.string.mr_dialog_default_group_name);
    ...
    private MediaRouteDiscoveryRequest updateDiscoveryRequest(MediaRouteDiscoveryRequest mediaRouteDiscoveryRequest, boolean z) {
        ...
        if (!z) {
            controlCategories.remove((Object) MediaControlIntent.CATEGORY_LIVE_AUDIO);
    ...
    private class GroupRouteController extends MediaRouteProvider.DynamicGroupRouteController {
        ...
        private final Runnable mClearOptimisticVolumeRunnable = new C1191xd009781b(this);
        ...
        /* access modifiers changed from: package-private */
        /* renamed from: lambda$new$0$androidx-mediarouter-media-MediaRoute2Provider$GroupRouteController */
        public /* synthetic */ void mo19378x37b4ed04() {
