...
public final class MediaRouter {
    ...
    private static final class GlobalMediaRouter implements SystemMediaRouteProvider.SyncCallback, RegisteredMediaRouteProviderWatcher.Callback {
        ...
        GlobalMediaRouter(Context context) {
            ...
            this.mLowRam = ActivityManagerCompat.isLowRamDevice((ActivityManager) context.getSystemService(SliceHints.HINT_ACTIVITY));
            boolean isDeclared = MediaTransferReceiver.isDeclared(context);
            this.mMediaTransferEnabled = isDeclared;
            if (isDeclared) {
        ...
        public void removeProvider(MediaRouteProvider mediaRouteProvider) {
            ...
            if (findProviderInfo != null) {
                ...
                this.mProviders.remove((Object) findProviderInfo);
            }
        }
        ...
        private void updateProviderContents(ProviderInfo providerInfo, MediaRouteProviderDescriptor mediaRouteProviderDescriptor) {
            ...
            if (providerInfo.updateDescriptor(mediaRouteProviderDescriptor)) {
                    ...
                    for (MediaRouteDescriptor next : routes) {
                        if (next == null || !next.isValid()) {
                            ...
                            if (findRouteIndexByDescriptorId < 0) {
                                ...
                                int i3 = i + 1;
                                Collections.swap((List<?>) providerInfo.mRoutes, findRouteIndexByDescriptorId, i);
                                if (next.getGroupMemberIds().size() > 0) {
                ...
                for (int size = providerInfo.mRoutes.size() - 1; size >= i; size--) {
                    ...
                    this.mRoutes.remove((Object) routeInfo5);
                }
        ...
        public void selectRouteInternal(RouteInfo routeInfo, int i) {
            if (MediaRouter.sGlobal == null || (this.mBluetoothRoute != null && routeInfo.isDefault())) {
                ...
                for (int i2 = 3; i2 < stackTrace.length; i2++) {
                    ...
                    sb.append(stackTraceElement.getClassName()).append(BaseIconCache.EMPTY_CLASS_NAME).append(stackTraceElement.getMethodName()).append(":").append(stackTraceElement.getLineNumber()).append("  ");
                }
        ...
        public void notifyTransfer(GlobalMediaRouter globalMediaRouter, RouteInfo routeInfo, MediaRouteProvider.RouteController routeController, int i, RouteInfo routeInfo2, Collection<MediaRouteProvider.DynamicGroupRouteController.DynamicRouteDescriptor> collection) {
            ...
            if (prepareTransferNotifier2.mReason != 3 || (onPrepareTransferListener = this.mOnPrepareTransferListener) == null) {
                this.mTransferNotifier.mo19680x4ea60c89();
                return;
            }
        ...
        public void updatePlaybackInfoFromSelectedRoute() {
            ...
            if (routeInfo != null) {
                ...
                this.mMediaSession.configureVolume(i, this.mPlaybackInfo.volumeMax, this.mPlaybackInfo.volume, this.mPlaybackInfo.volumeControlId);
                return;
            }
            MediaSessionRecord mediaSessionRecord = this.mMediaSession;
            if (mediaSessionRecord != null) {
        ...
        private final class MediaSessionRecord {
            ...
            public void configureVolume(int i, int i2, int i3, String str) {
                if (this.mMsCompat != null) {
                    ...
                    C12031 r2 = new VolumeProviderCompat(i, i2, i3, str) {
    ...
    static final class PrepareTransferNotifier {
        ...
        PrepareTransferNotifier(GlobalMediaRouter globalMediaRouter, RouteInfo routeInfo, MediaRouteProvider.RouteController routeController, int i, RouteInfo routeInfo2, Collection<MediaRouteProvider.DynamicGroupRouteController.DynamicRouteDescriptor> collection) {
            ...
            globalMediaRouter.mCallbackHandler.postDelayed(new MediaRouter$PrepareTransferNotifier$$ExternalSyntheticLambda2(this), TRANSFER_TIMEOUT_MS);
        }
        ...
        public void setFuture(ListenableFuture<Void> listenableFuture) {
            ...
            if (globalMediaRouter == null || globalMediaRouter.mTransferNotifier != this) {
                ...
                listenableFuture.addListener(mediaRouter$PrepareTransferNotifier$$ExternalSyntheticLambda0, new MediaRouter$PrepareTransferNotifier$$ExternalSyntheticLambda1(callbackHandler));
            } else {
