...
final class RegisteredMediaRouteProviderWatcher {
        ...
        if (this.mRunning) {
            ...
            for (ResolveInfo resolveInfo : this.mPackageManager.queryIntentServices(new Intent("android.media.MediaRouteProviderService"), 0)) {
                ...
                if (serviceInfo != null && (!MediaRouter.isMediaTransferEnabled() || !listContainsServiceInfo(mediaRoute2ProviderServices, serviceInfo))) {
                    ...
                    if (findProvider < 0) {
                        ...
                        i = i2 + 1;
                        Collections.swap((List<?>) this.mProviders, findProvider, i2);
                    }
                    i2 = i;
                }
            }
            if (i2 < this.mProviders.size()) {
                for (int size = this.mProviders.size() - 1; size >= i2; size--) {
                    ...
                    this.mProviders.remove((Object) registeredMediaRouteProvider3);
    ...
    /* access modifiers changed from: package-private */
    /* renamed from: lambda$scanPackages$0$androidx-mediarouter-media-RegisteredMediaRouteProviderWatcher */
    public /* synthetic */ void mo19832xbed17048(RegisteredMediaRouteProvider registeredMediaRouteProvider, MediaRouteProvider.RouteController routeController) {
    ...
    public List<ServiceInfo> getMediaRoute2ProviderServices() {
        return (List) this.mPackageManager.queryIntentServices(new Intent(MediaRoute2ProviderServiceAdapter.SERVICE_INTERFACE), 0).stream().map(new RegisteredMediaRouteProviderWatcher$$ExternalSyntheticLambda1()).collect(Collectors.toList());
    }
