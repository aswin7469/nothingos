...
class PreferenceInflater {
    ...
    private void init(PreferenceManager preferenceManager) {
        ...
        setDefaultPackages(new String[]{Preference.class.getPackage().getName() + BaseIconCache.EMPTY_CLASS_NAME, SwitchPreference.class.getPackage().getName() + BaseIconCache.EMPTY_CLASS_NAME});
    }
    ...
    public androidx.preference.Preference inflate(org.xmlpull.p032v1.XmlPullParser r6, androidx.preference.PreferenceGroup r7) {
        /*
            r5 = this;
        ...
        L_0x0018:
            ...
            return r7
        L_0x002d:
            android.view.InflateException r5 = new android.view.InflateException     // Catch:{ InflateException -> 0x0081, XmlPullParserException -> 0x0073, IOException -> 0x004a }
            java.lang.StringBuilder r7 = new java.lang.StringBuilder     // Catch:{ InflateException -> 0x0081, XmlPullParserException -> 0x0073, IOException -> 0x004a }
            r7.<init>()     // Catch:{ InflateException -> 0x0081, XmlPullParserException -> 0x0073, IOException -> 0x004a }
            java.lang.String r1 = r6.getPositionDescription()     // Catch:{ InflateException -> 0x0081, XmlPullParserException -> 0x0073, IOException -> 0x004a }
            java.lang.StringBuilder r7 = r7.append((java.lang.String) r1)     // Catch:{ InflateException -> 0x0081, XmlPullParserException -> 0x0073, IOException -> 0x004a }
            java.lang.String r1 = ": No start tag found!"
            java.lang.StringBuilder r7 = r7.append((java.lang.String) r1)     // Catch:{ InflateException -> 0x0081, XmlPullParserException -> 0x0073, IOException -> 0x004a }
            java.lang.String r7 = r7.toString()     // Catch:{ InflateException -> 0x0081, XmlPullParserException -> 0x0073, IOException -> 0x004a }
            r5.<init>(r7)     // Catch:{ InflateException -> 0x0081, XmlPullParserException -> 0x0073, IOException -> 0x004a }
            throw r5     // Catch:{ InflateException -> 0x0081, XmlPullParserException -> 0x0073, IOException -> 0x004a }
        L_0x004a:
            r5 = move-exception
            ...
            java.lang.StringBuilder r6 = r1.append((java.lang.String) r6)     // Catch:{ all -> 0x0083 }
            java.lang.String r1 = ": "
            java.lang.StringBuilder r6 = r6.append((java.lang.String) r1)     // Catch:{ all -> 0x0083 }
            java.lang.String r1 = r5.getMessage()     // Catch:{ all -> 0x0083 }
            java.lang.StringBuilder r6 = r6.append((java.lang.String) r1)     // Catch:{ all -> 0x0083 }
    ...
    /* JADX WARNING: Removed duplicated region for block: B:25:0x007d A[ExcHandler: Exception (r10v5 'e' java.lang.Exception A[CUSTOM_DECLARE]), Splitter:B:2:0x000d] */
    /* Code decompiled incorrectly, please refer to instructions dump. */
    private androidx.preference.Preference createItem(java.lang.String r11, java.lang.String[] r12, android.util.AttributeSet r13) throws java.lang.ClassNotFoundException, android.view.InflateException {
        ...
        L_0x001e:
            ...
            java.lang.StringBuilder r8 = r9.append((java.lang.String) r8)     // Catch:{ ClassNotFoundException -> 0x0038, Exception -> 0x007d }
            java.lang.StringBuilder r8 = r8.append((java.lang.String) r11)     // Catch:{ ClassNotFoundException -> 0x0038, Exception -> 0x007d }
        ...
        L_0x003c:
            ...
            android.view.InflateException r10 = new android.view.InflateException     // Catch:{ ClassNotFoundException -> 0x00a0, Exception -> 0x007d }
            java.lang.StringBuilder r12 = new java.lang.StringBuilder     // Catch:{ ClassNotFoundException -> 0x00a0, Exception -> 0x007d }
            r12.<init>()     // Catch:{ ClassNotFoundException -> 0x00a0, Exception -> 0x007d }
            java.lang.String r0 = r13.getPositionDescription()     // Catch:{ ClassNotFoundException -> 0x00a0, Exception -> 0x007d }
            java.lang.StringBuilder r12 = r12.append((java.lang.String) r0)     // Catch:{ ClassNotFoundException -> 0x00a0, Exception -> 0x007d }
            java.lang.StringBuilder r12 = r12.append((java.lang.String) r1)     // Catch:{ ClassNotFoundException -> 0x00a0, Exception -> 0x007d }
            java.lang.StringBuilder r12 = r12.append((java.lang.String) r11)     // Catch:{ ClassNotFoundException -> 0x00a0, Exception -> 0x007d }
            java.lang.String r12 = r12.toString()     // Catch:{ ClassNotFoundException -> 0x00a0, Exception -> 0x007d }
            r10.<init>(r12)     // Catch:{ ClassNotFoundException -> 0x00a0, Exception -> 0x007d }
            throw r10     // Catch:{ ClassNotFoundException -> 0x00a0, Exception -> 0x007d }
        L_0x005f:
        ...
        L_0x0072:
            java.lang.Object[] r10 = r10.mConstructorArgs     // Catch:{ ClassNotFoundException -> 0x00a0, Exception -> 0x007d }
            r10[r2] = r13     // Catch:{ ClassNotFoundException -> 0x00a0, Exception -> 0x007d }
            java.lang.Object r10 = r0.newInstance(r10)     // Catch:{ ClassNotFoundException -> 0x00a0, Exception -> 0x007d }
            androidx.preference.Preference r10 = (androidx.preference.Preference) r10     // Catch:{ ClassNotFoundException -> 0x00a0, Exception -> 0x007d }
            return r10
        L_0x007d:
            r10 = move-exception
            ...
            java.lang.StringBuilder r13 = r0.append((java.lang.String) r13)
            java.lang.StringBuilder r13 = r13.append((java.lang.String) r1)
            java.lang.StringBuilder r11 = r13.append((java.lang.String) r11)
