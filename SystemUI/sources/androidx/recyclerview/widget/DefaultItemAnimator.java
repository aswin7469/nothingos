...
public class DefaultItemAnimator extends SimpleItemAnimator {
            ...
            if (z2) {
                ...
                C12681 r6 = new Runnable() {
                    public void run() {
                        ...
                        arrayList.clear();
                        DefaultItemAnimator.this.mMovesList.remove((Object) arrayList);
                    }
                };
                if (z) {
            ...
            if (z3) {
                ...
                C12692 r62 = new Runnable() {
                    public void run() {
                        ...
                        arrayList2.clear();
                        DefaultItemAnimator.this.mChangesList.remove((Object) arrayList2);
                    }
                };
                if (z) {
            ...
            if (z4) {
                ...
                C12703 r5 = new Runnable() {
                    public void run() {
                        ...
                        arrayList3.clear();
                        DefaultItemAnimator.this.mAdditionsList.remove((Object) arrayList3);
                    }
                };
                if (z || z2 || z3) {
                    long j = 0;
    ...
    private void animateRemoveImpl(final RecyclerView.ViewHolder viewHolder) {
        ...
        animate.setDuration(getRemoveDuration()).alpha(0.0f).setListener(new AnimatorListenerAdapter() {
            ...
            public void onAnimationEnd(Animator animator) {
                ...
                DefaultItemAnimator.this.mRemoveAnimations.remove((Object) viewHolder);
    ...
    public void animateAddImpl(final RecyclerView.ViewHolder viewHolder) {
        ...
        animate.alpha(1.0f).setDuration(getAddDuration()).setListener(new AnimatorListenerAdapter() {
            ...
            public void onAnimationEnd(Animator animator) {
                ...
                DefaultItemAnimator.this.mAddAnimations.remove((Object) viewHolder);
                DefaultItemAnimator.this.dispatchFinishedWhenDone();
            }
        }).start();
    }
    ...
    public void animateMoveImpl(RecyclerView.ViewHolder viewHolder, int i, int i2, int i3, int i4) {
        ...
        animate.setDuration(getMoveDuration()).setListener(new AnimatorListenerAdapter() {
            ...
            public void onAnimationEnd(Animator animator) {
                ...
                DefaultItemAnimator.this.mMoveAnimations.remove((Object) viewHolder2);
                DefaultItemAnimator.this.dispatchFinishedWhenDone();
            }
        }).start();
    }
        ...
        if (view != null) {
            ...
            duration.alpha(0.0f).setListener(new AnimatorListenerAdapter() {
                ...
                public void onAnimationEnd(Animator animator) {
                    ...
                    DefaultItemAnimator.this.mChangeAnimations.remove((Object) changeInfo.oldHolder);
                    DefaultItemAnimator.this.dispatchFinishedWhenDone();
                }
            }).start();
        }
        if (view2 != null) {
            ...
            animate.translationX(0.0f).translationY(0.0f).setDuration(getChangeDuration()).alpha(1.0f).setListener(new AnimatorListenerAdapter() {
                ...
                public void onAnimationEnd(Animator animator) {
                    ...
                    DefaultItemAnimator.this.mChangeAnimations.remove((Object) changeInfo.newHolder);
                    DefaultItemAnimator.this.dispatchFinishedWhenDone();
                }
            }).start();
        }
    ...
    public void endAnimation(RecyclerView.ViewHolder viewHolder) {
        ...
        if (this.mPendingRemovals.remove((Object) viewHolder)) {
            view.setAlpha(1.0f);
            dispatchRemoveFinished(viewHolder);
        }
        if (this.mPendingAdditions.remove((Object) viewHolder)) {
            view.setAlpha(1.0f);
        ...
        for (int size5 = this.mAdditionsList.size() - 1; size5 >= 0; size5--) {
            ...
            if (arrayList3.remove((Object) viewHolder)) {
                view.setAlpha(1.0f);
                dispatchAddFinished(viewHolder);
        ...
        this.mRemoveAnimations.remove((Object) viewHolder);
        this.mAddAnimations.remove((Object) viewHolder);
        this.mChangeAnimations.remove((Object) viewHolder);
        this.mMoveAnimations.remove((Object) viewHolder);
        ...
        if (isRunning()) {
            for (int size5 = this.mMovesList.size() - 1; size5 >= 0; size5--) {
                ...
                for (int size6 = arrayList.size() - 1; size6 >= 0; size6--) {
                    ...
                    if (arrayList.isEmpty()) {
                        this.mMovesList.remove((Object) arrayList);
                    }
                }
            }
            for (int size7 = this.mAdditionsList.size() - 1; size7 >= 0; size7--) {
                ...
                for (int size8 = arrayList2.size() - 1; size8 >= 0; size8--) {
                    ...
                    if (arrayList2.isEmpty()) {
                        this.mAdditionsList.remove((Object) arrayList2);
                    }
                }
            }
            for (int size9 = this.mChangesList.size() - 1; size9 >= 0; size9--) {
                ...
                for (int size10 = arrayList3.size() - 1; size10 >= 0; size10--) {
                    ...
                    if (arrayList3.isEmpty()) {
                        this.mChangesList.remove((Object) arrayList3);
                    }
                }
            }
