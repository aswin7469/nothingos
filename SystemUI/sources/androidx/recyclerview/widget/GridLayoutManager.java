...
public class GridLayoutManager extends LinearLayoutManager {
    ...
    public void layoutChunk(RecyclerView.Recycler recycler, RecyclerView.State state, LinearLayoutManager.LayoutState layoutState, LinearLayoutManager.LayoutChunkResult layoutChunkResult) {
        ...
        for (int i21 = 0; i21 < i16; i21++) {
            ...
            if (this.mOrientationHelper.getDecoratedMeasurement(view3) != i18) {
                ...
                if (this.mOrientation == 1) {
                    i13 = getChildMeasureSpec(spaceForSpanRange, 1073741824, i23, layoutParams.width, false);
                    ...
                    i12 = getChildMeasureSpec(spaceForSpanRange, 1073741824, i22, layoutParams.height, false);
                    i13 = makeMeasureSpec;
                }
    ...
    public android.view.View onFocusSearchFailed(android.view.View r23, int r24, androidx.recyclerview.widget.RecyclerView.Recycler r25, androidx.recyclerview.widget.RecyclerView.State r26) {
        ...
        L_0x00bc:
            ...
            goto L_0x0107
        L_0x00be:
            int r11 = java.lang.Math.max((int) r2, (int) r6)
            int r20 = java.lang.Math.min((int) r3, (int) r7)
            int r11 = r20 - r11
        ...
        L_0x0107:
            ...
            int r3 = java.lang.Math.min((int) r3, (int) r7)
            int r2 = java.lang.Math.max((int) r2, (int) r6)
            int r8 = r3 - r2
            r15 = r4
            r17 = r5
            r16 = r11
