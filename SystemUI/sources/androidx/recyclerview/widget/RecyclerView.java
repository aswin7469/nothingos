...
import androidx.recyclerview.C1259R;
...
public class RecyclerView extends ViewGroup implements ScrollingView, NestedScrollingChild2, NestedScrollingChild3 {
    ...
    public RecyclerView(Context context, AttributeSet attributeSet) {
        this(context, attributeSet, C1259R.attr.recyclerViewStyle);
    }
    ...
    public RecyclerView(Context context, AttributeSet attributeSet, int i) {
        ...
        TypedArray obtainStyledAttributes = context2.obtainStyledAttributes(attributeSet2, C1259R.styleable.RecyclerView, i2, 0);
        ViewCompat.saveAttributeDataForStyleable(this, context, C1259R.styleable.RecyclerView, attributeSet, obtainStyledAttributes, i, 0);
        String string = obtainStyledAttributes.getString(C1259R.styleable.RecyclerView_layoutManager);
        if (obtainStyledAttributes.getInt(C1259R.styleable.RecyclerView_android_descendantFocusability, -1) == -1) {
            setDescendantFocusability(262144);
        }
        this.mClipToPadding = obtainStyledAttributes.getBoolean(C1259R.styleable.RecyclerView_android_clipToPadding, true);
        boolean z = obtainStyledAttributes.getBoolean(C1259R.styleable.RecyclerView_fastScrollEnabled, false);
        this.mEnableFastScroller = z;
        if (z) {
            initFastScroller((StateListDrawable) obtainStyledAttributes.getDrawable(C1259R.styleable.RecyclerView_fastScrollVerticalThumbDrawable), obtainStyledAttributes.getDrawable(C1259R.styleable.RecyclerView_fastScrollVerticalTrackDrawable), (StateListDrawable) obtainStyledAttributes.getDrawable(C1259R.styleable.RecyclerView_fastScrollHorizontalThumbDrawable), obtainStyledAttributes.getDrawable(C1259R.styleable.RecyclerView_fastScrollHorizontalTrackDrawable));
        }
    ...
    public String exceptionLabel() {
        return WifiEnterpriseConfig.CA_CERT_ALIAS_DELIMITER + super.toString() + ", adapter:" + this.mAdapter + ", layout:" + this.mLayout + ", context:" + getContext();
    }
    ...
    public void removeRecyclerListener(RecyclerListener recyclerListener) {
        this.mRecyclerListeners.remove((Object) recyclerListener);
    }
    ...
    public void removeItemDecoration(ItemDecoration itemDecoration) {
        ...
        this.mItemDecorations.remove((Object) itemDecoration);
        if (this.mItemDecorations.isEmpty()) {
            setWillNotDraw(getOverScrollMode() == 2);
        }
        markItemDecorInsetsDirty();
    ...
    public void removeOnItemTouchListener(OnItemTouchListener onItemTouchListener) {
        this.mOnItemTouchListeners.remove((Object) onItemTouchListener);
    ...
    public boolean onTouchEvent(android.view.MotionEvent r18) {
        ...
        L_0x00df:
            ...
            int r1 = r1 - r3
            int r1 = java.lang.Math.max((int) r8, (int) r1)
            goto L_0x00f2
        L_0x00eb:
            int r3 = r6.mTouchSlop
            int r1 = r1 + r3
            int r1 = java.lang.Math.min((int) r8, (int) r1)
        L_0x00f2:
    ...
    public final class Recycler {
        ...
        public androidx.recyclerview.widget.RecyclerView.ViewHolder tryGetViewHolderForPositionByDeadline(int r17, boolean r18, long r19) {
            ...
            L_0x0147:
                ...
                r1.<init>((java.lang.String) r2)
                java.lang.StringBuilder r1 = r1.append((int) r3)
                java.lang.String r2 = "(offset:"
                java.lang.StringBuilder r1 = r1.append((java.lang.String) r2)
                java.lang.StringBuilder r1 = r1.append((int) r5)
        ...
        public void unscrapView(ViewHolder viewHolder) {
            if (viewHolder.mInChangeScrap) {
                this.mChangedScrap.remove((Object) viewHolder);
            } else {
                this.mAttachedScrap.remove((Object) viewHolder);
            }
    ...
    public static abstract class Adapter<VH extends ViewHolder> {
        ...
        public boolean canRestoreState() {
            int i = C13047.f161x3d106619[this.mStateRestorationPolicy.ordinal()];
            if (i == 1) {
                return false;
            }
            if (i != 2) {
    ...
    static /* synthetic */ class C13047 {
        ...
        static {
            ...
            L_0x0012:
                int[] r0 = f161x3d106619     // Catch:{ NoSuchFieldError -> 0x001d }
            ...
            L_0x001d:
                return
            */
            throw new UnsupportedOperationException("Method not decompiled: androidx.recyclerview.widget.RecyclerView.C13047.<clinit>():void");
        }
    }
    ...
    public static abstract class LayoutManager {
        ...
        public LayoutManager() {
            C13051 r0 = new ViewBoundsCheck.Callback() {
                public View getChildAt(int i) {
            ...
            C13062 r1 = new ViewBoundsCheck.Callback() {
                public View getChildAt(int i) {
                    return LayoutManager.this.getChildAt(i);
                }
        ...
        public static Properties getProperties(Context context, AttributeSet attributeSet, int i, int i2) {
            ...
            TypedArray obtainStyledAttributes = context.obtainStyledAttributes(attributeSet, C1259R.styleable.RecyclerView, i, i2);
            properties.orientation = obtainStyledAttributes.getInt(C1259R.styleable.RecyclerView_android_orientation, 1);
            properties.spanCount = obtainStyledAttributes.getInt(C1259R.styleable.RecyclerView_spanCount, 1);
            properties.reverseLayout = obtainStyledAttributes.getBoolean(C1259R.styleable.RecyclerView_reverseLayout, false);
            properties.stackFromEnd = obtainStyledAttributes.getBoolean(C1259R.styleable.RecyclerView_stackFromEnd, false);
            obtainStyledAttributes.recycle();
            return properties;
        }
    ...
    public static abstract class ViewHolder {
        ...
        public String toString() {
            ...
            if (!isRecyclable()) {
                sb.append(" not recyclable(" + this.mIsRecyclableCount + NavigationBarInflaterView.KEY_CODE_END);
            }
    ...
    public void initFastScroller(StateListDrawable stateListDrawable, Drawable drawable, StateListDrawable stateListDrawable2, Drawable drawable2) {
        ...
        new FastScroller(this, stateListDrawable, drawable, stateListDrawable2, drawable2, resources.getDimensionPixelSize(C1259R.dimen.fastscroll_default_thickness), resources.getDimensionPixelSize(C1259R.dimen.fastscroll_minimum_range), resources.getDimensionPixelOffset(C1259R.dimen.fastscroll_margin));
    }
