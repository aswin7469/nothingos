...
public class SortedList<T> {
    ...
    public void addAll(Collection<T> collection) {
        addAll(collection.toArray((T[]) (Object[]) Array.newInstance((Class<?>) this.mTClass, collection.size())), true);
    }
    ...
    public void replaceAll(Collection<T> collection) {
        replaceAll(collection.toArray((T[]) (Object[]) Array.newInstance((Class<?>) this.mTClass, collection.size())), true);
    }
    ...
    private void replaceAllInternal(T[] tArr) {
        ...
        while (true) {
            ...
            if (i2 >= i3) {
                ...
                System.arraycopy((Object) tArr, i, (Object) this.mData, i, i4);
    ...
    private void merge(T[] tArr, int i) {
        ...
        while (true) {
            ...
            if (i4 >= i5 && i2 >= i) {
                ...
                int i6 = i - i2;
                System.arraycopy((Object) tArr, i2, (Object) this.mData, this.mNewDataStart, i6);
                ...
                int i8 = i5 - i4;
                System.arraycopy((Object) this.mOldData, i4, (Object) this.mData, this.mNewDataStart, i8);
    ...
    private void removeItemAtIndex(int i, boolean z) {
        T[] tArr = this.mData;
        System.arraycopy((Object) tArr, i + 1, (Object) tArr, i, (this.mSize - i) - 1);
        int i2 = this.mSize - 1;
        this.mSize = i2;
        this.mData[i2] = null;
        if (z) {
    ...
    private void addToData(int i, T t) {
        ...
        if (i <= i2) {
            ...
            if (i2 == tArr.length) {
                ...
                System.arraycopy((Object) this.mData, 0, (Object) tArr2, 0, i);
                tArr2[i] = t;
                System.arraycopy((Object) this.mData, i, (Object) tArr2, i + 1, this.mSize - i);
                this.mData = tArr2;
            } else {
                System.arraycopy((Object) tArr, i, (Object) tArr, i + 1, i2 - i);
                this.mData[i] = t;
            }
            this.mSize++;
            return;
    ...
    private T[] copyArray(T[] tArr) {
        T[] tArr2 = (Object[]) Array.newInstance((Class<?>) this.mTClass, tArr.length);
        System.arraycopy((Object) tArr, 0, (Object) tArr2, 0, tArr.length);
        return tArr2;
    }
