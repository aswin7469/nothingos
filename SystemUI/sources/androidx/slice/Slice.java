...
public final class Slice extends CustomVersionedParcelable implements VersionedParcelable {
    ...
    public Slice(Bundle bundle) {
        ...
        this.mSpec = bundle.containsKey(SPEC_TYPE) ? new SliceSpec(bundle.getString(SPEC_TYPE), bundle.getInt(SPEC_REVISION)) : sliceSpec;
    }
    ...
    public static class Builder {
        ...
        public Builder addSubSlice(Slice slice, String str) {
            Preconditions.checkNotNull(slice);
            this.mItems.add(new SliceItem((Object) slice, SliceProviderCompat.EXTRA_SLICE, str, slice.getHintArray()));
            return this;
        }
