...
public class RemoteInputView extends LinearLayout implements View.OnClickListener, TextWatcher {
    ...
    public void onFinishInflate() {
        ...
        this.mProgressBar = (ProgressBar) findViewById(C1349R.C1352id.remote_input_progress);
        ImageButton imageButton = (ImageButton) findViewById(C1349R.C1352id.remote_input_send);
    ...
    public static RemoteInputView inflate(Context context, ViewGroup viewGroup) {
        RemoteInputView remoteInputView = (RemoteInputView) LayoutInflater.from(context).inflate(C1349R.layout.abc_slice_remote_input, viewGroup, false);
