...
public class ShortcutView extends SliceChildView {
    ...
    public ShortcutView(Context context) {
        ...
        this.mSmallIconSize = resources.getDimensionPixelSize(C1349R.dimen.abc_slice_icon_size);
        this.mLargeIconSize = resources.getDimensionPixelSize(C1349R.dimen.abc_slice_shortcut_size);
    }
