...
public class SliceActionView extends FrameLayout implements View.OnClickListener, CompoundButton.OnCheckedChangeListener {
    ...
    public SliceActionView(Context context, SliceStyle sliceStyle, RowStyle rowStyle) {
        ...
        this.mImageSize = resources.getDimensionPixelSize(C1349R.dimen.abc_slice_small_image_size);
        if (rowStyle != null) {
    ...
    public void setAction(SliceActionImpl sliceActionImpl, EventInfo eventInfo, SliceView.OnSliceActionListener onSliceActionListener, int i, SliceActionLoadingListener sliceActionLoadingListener) {
        ...
        if (sliceActionImpl.isDefaultToggle()) {
            Switch switchR = (Switch) LayoutInflater.from(getContext()).inflate(C1349R.layout.abc_slice_switch, this, false);
            ...
            if (i != -1) {
                ...
                ColorStateList colorStateList = new ColorStateList(new int[][]{iArr, EMPTY_STATE_SET}, new int[]{i, colorAttr});
                Drawable wrap = DrawableCompat.wrap(switchR.getTrackDrawable());
                DrawableCompat.setTintList(wrap, colorStateList);
                switchR.setTrackDrawable(wrap);
                int colorAttr2 = SliceViewUtil.getColorAttr(getContext(), C0329R.attr.colorSwitchThumbNormal);
                if (colorAttr2 == 0) {
                    colorAttr2 = ContextCompat.getColor(getContext(), C0329R.C0330color.switch_thumb_normal_material_light);
                }
                ColorStateList colorStateList2 = new ColorStateList(new int[][]{iArr, EMPTY_STATE_SET}, new int[]{i, colorAttr2});
            ...
            if (sliceActionImpl.getImageMode() == 0) {
                ...
                i2 = (i4 == -1 ? this.mIconSize : i4 - this.mIconSize) / 2;
            }
    ...
    public void setLoading(boolean z) {
        ...
        if (z) {
            if (this.mProgressView == null) {
                ProgressBar progressBar = (ProgressBar) LayoutInflater.from(getContext()).inflate(C1349R.layout.abc_slice_progress_view, this, false);
            ...
            try {
                ...
                if (this.mSliceAction.getActionItem().fireActionInternal(getContext(), intent)) {
                    ...
                    if (this.mLoadingListener != null) {
                        ...
                        this.mLoadingListener.onSliceActionLoading(this.mSliceAction.getSliceItem(), eventInfo3 != null ? eventInfo3.rowIndex : -1);
                    }
                }
    ...
    private static class ImageToggle extends ImageView implements Checkable, View.OnClickListener {
        ...
        public int[] onCreateDrawableState(int i) {
            ...
            if (this.mIsChecked) {
                mergeDrawableStates(onCreateDrawableState, SliceActionView.CHECKED_STATE_SET);
            }
