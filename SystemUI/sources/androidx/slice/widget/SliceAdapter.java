...
public class SliceAdapter extends RecyclerView.Adapter<SliceViewHolder> implements SliceActionView.SliceActionLoadingListener {
    ...
    private View inflateForType(int i) {
        if (i == 3) {
            return LayoutInflater.from(this.mContext).inflate(C1349R.layout.abc_slice_grid, (ViewGroup) null);
        }
        if (i == 4) {
            return LayoutInflater.from(this.mContext).inflate(C1349R.layout.abc_slice_message, (ViewGroup) null);
        }
        if (i != 5) {
            return new RowView(this.mContext);
        }
        return LayoutInflater.from(this.mContext).inflate(C1349R.layout.abc_slice_message_local, (ViewGroup) null);
    }
    ...
    public class SliceViewHolder extends RecyclerView.ViewHolder implements View.OnTouchListener, View.OnClickListener {
        ...
        public void bind(SliceContent sliceContent, int i) {
            if (this.mSliceChildView != null && sliceContent != null) {
                ...
                this.mSliceChildView.setInsets(SliceAdapter.this.mInsetStart, i == 0 ? SliceAdapter.this.mInsetTop : 0, SliceAdapter.this.mInsetEnd, i == SliceAdapter.this.getItemCount() - 1 ? SliceAdapter.this.mInsetBottom : 0);
        ...
        public void onClick(View view) {
            if (SliceAdapter.this.mParent != null) {
                SliceAdapter.this.mParent.setClickInfo((int[]) view.getTag());
                SliceAdapter.this.mParent.performClick();
            }
        }

        public boolean onTouch(View view, MotionEvent motionEvent) {
            if (SliceAdapter.this.mTemplateView == null) {
                return false;
            }
            SliceAdapter.this.mTemplateView.onForegroundActivated(motionEvent);
            return false;
        }
    }
