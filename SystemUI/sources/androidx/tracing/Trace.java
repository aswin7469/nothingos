...
public final class Trace {
    ...
    private static boolean isEnabledFallback() {
        try {
            ...
            return ((Boolean) sIsTagEnabledMethod.invoke((Object) null, Long.valueOf(sTraceTagApp))).booleanValue();
        } catch (Exception e) {
    ...
    private static void beginAsyncSectionFallback(String str, int i) {
        try {
            ...
            sAsyncTraceBeginMethod.invoke((Object) null, Long.valueOf(sTraceTagApp), str, Integer.valueOf(i));
        } catch (Exception e) {
    ...
    private static void endAsyncSectionFallback(String str, int i) {
        try {
            ...
            sAsyncTraceEndMethod.invoke((Object) null, Long.valueOf(sTraceTagApp), str, Integer.valueOf(i));
        } catch (Exception e) {
    ...
    private static void setCounterFallback(String str, int i) {
        try {
            ...
            sTraceCounterMethod.invoke((Object) null, Long.valueOf(sTraceTagApp), str, Integer.valueOf(i));
        } catch (Exception e) {
