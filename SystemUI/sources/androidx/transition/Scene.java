...
public class Scene {
    ...
    public static Scene getSceneForLayout(ViewGroup viewGroup, int i, Context context) {
        SparseArray sparseArray = (SparseArray) viewGroup.getTag(C1419R.C1422id.transition_scene_layoutid_cache);
        if (sparseArray == null) {
            sparseArray = new SparseArray();
            viewGroup.setTag(C1419R.C1422id.transition_scene_layoutid_cache, sparseArray);
        }
    ...
    static void setCurrentScene(ViewGroup viewGroup, Scene scene) {
        viewGroup.setTag(C1419R.C1422id.transition_current_scene, scene);
    }

    public static Scene getCurrentScene(ViewGroup viewGroup) {
        return (Scene) viewGroup.getTag(C1419R.C1422id.transition_current_scene);
    }
