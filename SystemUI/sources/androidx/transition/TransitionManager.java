...
public class TransitionManager {
    ...
    public static class MultiListener implements ViewTreeObserver.OnPreDrawListener, View.OnAttachStateChangeListener {
        ...
        public boolean onPreDraw() {
            ...
            this.mTransition.mo158addListener(new TransitionListenerAdapter() { // from class: androidx.transition.TransitionManager.MultiListener.1
    ...
    public static void beginDelayedTransition(ViewGroup viewGroup, Transition transition) {
        ...
        Transition m157clone = transition.m157clone();
        sceneChangeSetup(viewGroup, m157clone);
        Scene.setCurrentScene(viewGroup, null);
        sceneChangeRunTransition(viewGroup, m157clone);
    }
}
