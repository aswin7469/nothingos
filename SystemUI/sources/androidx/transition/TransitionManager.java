...
public class TransitionManager {
        ...
        public boolean onPreDraw() {
            ...
            this.mTransition.addListener(new TransitionListenerAdapter() {
                public void onTransitionEnd(Transition transition) {
                    ((ArrayList) runningTransitions.get(MultiListener.this.mSceneRoot)).remove((Object) transition);
    ...
    /* renamed from: go */
    public static void m134go(Scene scene) {
        changeScene(scene, sDefaultTransition);
    }

    /* renamed from: go */
    public static void m135go(Scene scene, Transition transition) {
