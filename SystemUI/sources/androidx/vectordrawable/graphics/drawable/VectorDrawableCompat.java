...
public class VectorDrawableCompat extends VectorDrawableCommon {
    ...
    public boolean isStateful() {
        /*
            ...
            android.graphics.drawable.Drawable r1 = r1.mDelegateDrawable
        ...
        L_0x000b:
            ...
            if (r0 == 0) goto L_0x002c
            androidx.vectordrawable.graphics.drawable.VectorDrawableCompat$VectorDrawableCompatState r1 = r1.mVectorState
        ...
        public String nodesToString(PathParser.PathDataNode[] pathDataNodeArr) {
            ...
            for (int i = 0; i < pathDataNodeArr.length; i++) {
                ...
                for (int i2 = 0; i2 < fArr.length; i2++) {
                    str = str + fArr[i2] + NavigationBarInflaterView.BUTTON_SEPARATOR;
                }
            }
            return str;
        }
