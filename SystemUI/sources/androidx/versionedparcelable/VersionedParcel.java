...
public abstract class VersionedParcel {
    ...
    private void writeSerializable(Serializable serializable) {
        ...
        try {
            ...
            throw new RuntimeException("VersionedParcelable encountered IOException writing serializable object (name = " + name + NavigationBarInflaterView.KEY_CODE_END, e);
        }
    }
    ...
    public java.lang.Exception readException(java.lang.Exception r1, int r2) {
        ...
        L_0x0007:
            ...
            java.lang.Exception r0 = r0.readException((int) r2, (java.lang.String) r1)
            return r0
        L_0x0016:
            return r1
        */
    ...
    public Serializable readSerializable() {
        ...
        try {
            ...
            throw new RuntimeException("VersionedParcelable encountered IOException reading a Serializable object (name = " + readString + NavigationBarInflaterView.KEY_CODE_END, e);
        } catch (ClassNotFoundException e2) {
            throw new RuntimeException("VersionedParcelable encountered ClassNotFoundException reading a Serializable object (name = " + readString + NavigationBarInflaterView.KEY_CODE_END, e2);
        }
    }
    ...
    public <T extends VersionedParcelable> T readFromParcel(String str, VersionedParcel versionedParcel) {
        try {
            return (VersionedParcelable) getReadMethod(str).invoke((Object) null, versionedParcel);
    ...
    public <T extends VersionedParcelable> void writeToParcel(T t, VersionedParcel versionedParcel) {
        try {
            getWriteMethod(t.getClass()).invoke((Object) null, t, versionedParcel);
        } catch (IllegalAccessException e) {
            throw new RuntimeException("VersionedParcel encountered IllegalAccessException", e);
        } catch (InvocationTargetException e2) {
            if (e2.getCause() instanceof RuntimeException) {
