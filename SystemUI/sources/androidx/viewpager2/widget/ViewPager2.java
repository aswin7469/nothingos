...
import androidx.viewpager2.C1466R;
...
public final class ViewPager2 extends ViewGroup {
    ...
    private void initialize(Context context, AttributeSet attributeSet) {
        ...
        C14812 r3 = new OnPageChangeCallback() {
            public void onPageSelected(int i) {
        ...
        C14823 r4 = new OnPageChangeCallback() {
            public void onPageSelected(int i) {
    ...
    private void setOrientation(Context context, AttributeSet attributeSet) {
        TypedArray obtainStyledAttributes = context.obtainStyledAttributes(attributeSet, C1466R.styleable.ViewPager2);
        ViewCompat.saveAttributeDataForStyleable(this, context, C1466R.styleable.ViewPager2, attributeSet, obtainStyledAttributes, 0, 0);
        try {
            setOrientation(obtainStyledAttributes.getInt(C1466R.styleable.ViewPager2_android_orientation, 0));
        } finally {
