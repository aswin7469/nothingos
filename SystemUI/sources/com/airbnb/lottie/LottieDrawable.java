...
public class LottieDrawable extends Drawable implements Drawable.Callback, Animatable {
    ...
    public LottieDrawable() {
        ...
        C15131 r3 = new ValueAnimator.AnimatorUpdateListener() {
    ...
    public void draw(Canvas canvas) {
        this.isDirty = false;
        C1488L.beginSection("Drawable#draw");
        if (this.safeMode) {
            try {
                drawInternal(canvas);
            } catch (Throwable th) {
        ...
        C1488L.endSection("Drawable#draw");
    }
