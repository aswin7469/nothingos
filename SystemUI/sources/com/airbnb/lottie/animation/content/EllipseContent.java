...
public class EllipseContent implements PathContent, BaseKeyframeAnimation.AnimationListener, KeyPathElementContent {
    ...
    public EllipseContent(LottieDrawable lottieDrawable, BaseLayer baseLayer, CircleShape circleShape) {
        ...
        BaseKeyframeAnimation<PointF, PointF> mo192createAnimation = circleShape.getSize().mo192createAnimation();
        this.sizeAnimation = mo192createAnimation;
        BaseKeyframeAnimation<PointF, PointF> mo192createAnimation2 = circleShape.getPosition().mo192createAnimation();
    ...
    public Path getPath() {
        ...
        this.path.offset(mo189getValue2.x, mo189getValue2.y);
        this.path.close();
