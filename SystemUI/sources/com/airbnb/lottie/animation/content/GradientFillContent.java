...
public class GradientFillContent implements DrawingContent, BaseKeyframeAnimation.AnimationListener, KeyPathElementContent {
    ...
    public GradientFillContent(LottieDrawable lottieDrawable, BaseLayer baseLayer, GradientFill gradientFill) {
        ...
        BaseKeyframeAnimation<GradientColor, GradientColor> mo192createAnimation = gradientFill.getGradientColor().mo192createAnimation();
        ...
        BaseKeyframeAnimation<Integer, Integer> mo192createAnimation2 = gradientFill.getOpacity().mo192createAnimation();
        this.opacityAnimation = mo192createAnimation2;
        mo192createAnimation2.addUpdateListener(this);
        baseLayer.addAnimation(mo192createAnimation2);
        BaseKeyframeAnimation<PointF, PointF> mo192createAnimation3 = gradientFill.getStartPoint().mo192createAnimation();
        this.startPointAnimation = mo192createAnimation3;
        mo192createAnimation3.addUpdateListener(this);
        baseLayer.addAnimation(mo192createAnimation3);
        BaseKeyframeAnimation<PointF, PointF> mo192createAnimation4 = gradientFill.getEndPoint().mo192createAnimation();
        this.endPointAnimation = mo192createAnimation4;
    ...
    public void draw(Canvas canvas, Matrix matrix, int i) {
        ...
        this.paint.setAlpha(MiscUtils.clamp((int) ((((i / 255.0f) * this.opacityAnimation.mo189getValue().intValue()) / 100.0f) * 255.0f), 0, 255));
    ...
    private RadialGradient getRadialGradient() {
        ...
        float f2 = mo189getValue.y;
        float hypot = (float) Math.hypot(mo189getValue2.x - f, mo189getValue2.y - f2);
        if (hypot <= 0.0f) {
            hypot = 0.001f;
        }
