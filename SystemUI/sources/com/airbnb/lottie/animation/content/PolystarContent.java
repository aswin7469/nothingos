...
public class PolystarContent implements PathContent, BaseKeyframeAnimation.AnimationListener, KeyPathElementContent {
    ...
    public PolystarContent(LottieDrawable lottieDrawable, BaseLayer baseLayer, PolystarShape polystarShape) {
        ...
        BaseKeyframeAnimation<Float, Float> mo192createAnimation = polystarShape.getPoints().mo192createAnimation();
        this.pointsAnimation = mo192createAnimation;
        BaseKeyframeAnimation<PointF, PointF> mo192createAnimation2 = polystarShape.getPosition().mo192createAnimation();
        this.positionAnimation = mo192createAnimation2;
        BaseKeyframeAnimation<Float, Float> mo192createAnimation3 = polystarShape.getRotation().mo192createAnimation();
        this.rotationAnimation = mo192createAnimation3;
        BaseKeyframeAnimation<Float, Float> mo192createAnimation4 = polystarShape.getOuterRadius().mo192createAnimation();
        this.outerRadiusAnimation = mo192createAnimation4;
        BaseKeyframeAnimation<Float, Float> mo192createAnimation5 = polystarShape.getOuterRoundedness().mo192createAnimation();
        this.outerRoundednessAnimation = mo192createAnimation5;
        PolystarShape.Type type2 = PolystarShape.Type.STAR;
        if (type == type2) {
            this.innerRadiusAnimation = polystarShape.getInnerRadius().mo192createAnimation();
            this.innerRoundednessAnimation = polystarShape.getInnerRoundedness().mo192createAnimation();
        } else {
        ...
        baseLayer.addAnimation(mo192createAnimation4);
        baseLayer.addAnimation(mo192createAnimation5);
        if (type == type2) {
        ...
        mo192createAnimation4.addUpdateListener(this);
        mo192createAnimation5.addUpdateListener(this);
        if (type == type2) {
    ...
    private void createStarPath() {
        ...
        float f8;
        float f9;
        float floatValue = this.pointsAnimation.mo189getValue().floatValue();
        double radians = Math.toRadians((this.rotationAnimation == null ? 0.0d : baseKeyframeAnimation.mo189getValue().floatValue()) - 90.0d);
        ...
        float floatValue2 = this.outerRadiusAnimation.mo189getValue().floatValue();
        float floatValue3 = this.innerRadiusAnimation.mo189getValue().floatValue();
        BaseKeyframeAnimation<?, Float> baseKeyframeAnimation2 = this.innerRoundednessAnimation;
        float floatValue4 = baseKeyframeAnimation2 != null ? baseKeyframeAnimation2.mo189getValue().floatValue() / 100.0f : 0.0f;
        BaseKeyframeAnimation<?, Float> baseKeyframeAnimation3 = this.outerRoundednessAnimation;
        float floatValue5 = baseKeyframeAnimation3 != null ? baseKeyframeAnimation3.mo189getValue().floatValue() / 100.0f : 0.0f;
        if (i2 != 0) {
        ...
        while (true) {
            ...
            if (d7 < ceil) {
                ...
                if (floatValue4 == 0.0f && floatValue5 == 0.0f) {
                    ...
                    this.path.cubicTo(f - f17, f2 - f18, cos2 + f20, sin2 + f21, cos2, sin2);
                }
                d2 += f5;
                z = !z;
                i3++;
                ...
                PointF mo189getValue = this.positionAnimation.mo189getValue();
                this.path.offset(mo189getValue.x, mo189getValue.y);
                this.path.close();
                return;
            }
        }
    ...
    private void createPolygonPath() {
        ...
        double d3;
        int i;
        int floor = (int) Math.floor(this.pointsAnimation.mo189getValue().floatValue());
        double radians = Math.toRadians((this.rotationAnimation == null ? 0.0d : baseKeyframeAnimation.mo189getValue().floatValue()) - 90.0d);
        double d4 = floor;
        float floatValue = this.outerRoundednessAnimation.mo189getValue().floatValue() / 100.0f;
        float floatValue2 = this.outerRadiusAnimation.mo189getValue().floatValue();
