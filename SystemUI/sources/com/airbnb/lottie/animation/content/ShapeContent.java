...
public class ShapeContent implements PathContent, BaseKeyframeAnimation.AnimationListener {
    ...
    public ShapeContent(LottieDrawable lottieDrawable, BaseLayer baseLayer, ShapePath shapePath) {
        ...
        BaseKeyframeAnimation<ShapeData, Path> mo192createAnimation = shapePath.getShapePath().mo192createAnimation();
        this.shapeAnimation = mo192createAnimation;
    ...
    public Path getPath() {
        ...
        this.path.set(this.shapeAnimation.mo189getValue());
