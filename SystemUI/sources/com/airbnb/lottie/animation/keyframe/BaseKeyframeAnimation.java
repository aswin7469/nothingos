...
public abstract class BaseKeyframeAnimation<K, A> {
    ...
    abstract A mo191getValue(Keyframe<K> keyframe, float f);
    ...
    public A mo189getValue() {
        ...
        A mo191getValue = mo191getValue(getCurrentKeyframe(), interpolatedCurrentKeyframeProgress);
        this.cachedGetValue = mo191getValue;
        return mo191getValue;
    }
