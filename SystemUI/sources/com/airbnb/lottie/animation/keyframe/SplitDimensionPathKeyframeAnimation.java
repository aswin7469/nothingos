...
public class SplitDimensionPathKeyframeAnimation extends BaseKeyframeAnimation<PointF, PointF> {
    ...
    public void setProgress(float f) {
        ...
        this.point.set(this.xAnimation.mo189getValue().floatValue(), this.yAnimation.mo189getValue().floatValue());
    ...
    public PointF mo189getValue() {
        return mo191getValue((Keyframe<PointF>) null, 0.0f);
    }
