...
public class TransformKeyframeAnimation {
    ...
    public TransformKeyframeAnimation(AnimatableTransform animatableTransform) {
        this.anchorPoint = animatableTransform.getAnchorPoint() == null ? null : animatableTransform.getAnchorPoint().mo192createAnimation();
        this.position = animatableTransform.getPosition() == null ? null : animatableTransform.getPosition().mo192createAnimation();
        this.scale = animatableTransform.getScale() == null ? null : animatableTransform.getScale().mo192createAnimation();
        this.rotation = animatableTransform.getRotation() == null ? null : animatableTransform.getRotation().mo192createAnimation();
        FloatKeyframeAnimation floatKeyframeAnimation = animatableTransform.getSkew() == null ? null : (FloatKeyframeAnimation) animatableTransform.getSkew().mo192createAnimation();
        ...
        this.skewAngle = animatableTransform.getSkewAngle() == null ? null : (FloatKeyframeAnimation) animatableTransform.getSkewAngle().mo192createAnimation();
        if (animatableTransform.getOpacity() != null) {
            this.opacity = animatableTransform.getOpacity().mo192createAnimation();
        }
        if (animatableTransform.getStartOpacity() != null) {
            this.startOpacity = animatableTransform.getStartOpacity().mo192createAnimation();
        } else {
            this.startOpacity = null;
        }
        if (animatableTransform.getEndOpacity() != null) {
            this.endOpacity = animatableTransform.getEndOpacity().mo192createAnimation();
        } else {
    ...
    public Matrix getMatrix() {
        ...
        if (baseKeyframeAnimation != null) {
            PointF mo189getValue = baseKeyframeAnimation.mo189getValue();
            float f = mo189getValue.x;
            if (f != 0.0f || mo189getValue.y != 0.0f) {
                this.matrix.preTranslate(f, mo189getValue.y);
            }
        }
        ...
        if (baseKeyframeAnimation2 != null) {
            if (baseKeyframeAnimation2 instanceof ValueCallbackKeyframeAnimation) {
                floatValue = baseKeyframeAnimation2.mo189getValue().floatValue();
            } else {
        ...
        if (baseKeyframeAnimation3 != null) {
            ScaleXY mo189getValue2 = baseKeyframeAnimation3.mo189getValue();
            if (mo189getValue2.getScaleX() != 1.0f || mo189getValue2.getScaleY() != 1.0f) {
                this.matrix.preScale(mo189getValue2.getScaleX(), mo189getValue2.getScaleY());
            }
        }
        BaseKeyframeAnimation<PointF, PointF> baseKeyframeAnimation4 = this.anchorPoint;
        if (baseKeyframeAnimation4 != null) {
            PointF mo189getValue3 = baseKeyframeAnimation4.mo189getValue();
            float f3 = mo189getValue3.x;
            if (f3 != 0.0f || mo189getValue3.y != 0.0f) {
                this.matrix.preTranslate(-f3, -mo189getValue3.y);
            }
        }
        return this.matrix;
    }
    ...
    public Matrix getMatrixForRepeater(float f) {
        BaseKeyframeAnimation<?, PointF> baseKeyframeAnimation = this.position;
        PointF pointF = null;
        PointF mo189getValue = baseKeyframeAnimation == null ? null : baseKeyframeAnimation.mo189getValue();
        BaseKeyframeAnimation<ScaleXY, ScaleXY> baseKeyframeAnimation2 = this.scale;
        ScaleXY mo189getValue2 = baseKeyframeAnimation2 == null ? null : baseKeyframeAnimation2.mo189getValue();
        this.matrix.reset();
        if (mo189getValue != null) {
            this.matrix.preTranslate(mo189getValue.x * f, mo189getValue.y * f);
        }
        if (mo189getValue2 != null) {
            double d = f;
            this.matrix.preScale((float) Math.pow(mo189getValue2.getScaleX(), d), (float) Math.pow(mo189getValue2.getScaleY(), d));
        }
        BaseKeyframeAnimation<Float, Float> baseKeyframeAnimation3 = this.rotation;
        if (baseKeyframeAnimation3 != null) {
            float floatValue = baseKeyframeAnimation3.mo189getValue().floatValue();
            BaseKeyframeAnimation<PointF, PointF> baseKeyframeAnimation4 = this.anchorPoint;
            if (baseKeyframeAnimation4 != null) {
                pointF = baseKeyframeAnimation4.mo189getValue();
            }
