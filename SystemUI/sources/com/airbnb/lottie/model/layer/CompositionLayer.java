...
public class CompositionLayer extends BaseLayer {
        ...
        while (true) {
            ...
            if (forModel != null) {
                ...
                if (baseLayer2 != null) {
                    ...
                    int i2 = C15431.$SwitchMap$com$airbnb$lottie$model$layer$Layer$MatteType[layer2.getMatteType().ordinal()];
                    if (i2 == 1 || i2 == 2) {
                        baseLayer2 = forModel;
                    }
                }
    ...
    static /* synthetic */ class C15431 {
        ...
        static {
            ...
            L_0x001d:
                return
            */
            throw new UnsupportedOperationException("Method not decompiled: com.airbnb.lottie.model.layer.CompositionLayer.C15431.<clinit>():void");
        }
    }
    ...
    public void drawLayer(Canvas canvas, Matrix matrix, int i) {
        C1488L.beginSection("CompositionLayer#draw");
        ...
        canvas.restore();
        C1488L.endSection("CompositionLayer#draw");
    }
