...
public class TextLayer extends BaseLayer {
    ...
    public TextLayer(LottieDrawable lottieDrawable, Layer layer) {
        ...
        TextKeyframeAnimation mo192createAnimation = layer.getText().mo192createAnimation();
        this.textAnimation = mo192createAnimation;
        ...
        if (textProperties != null && (animatableColorValue2 = textProperties.color) != null) {
            BaseKeyframeAnimation<Integer, Integer> mo192createAnimation2 = animatableColorValue2.mo192createAnimation();
            this.colorAnimation = mo192createAnimation2;
            mo192createAnimation2.addUpdateListener(this);
            addAnimation(this.colorAnimation);
        }
        if (textProperties != null && (animatableColorValue = textProperties.stroke) != null) {
            BaseKeyframeAnimation<Integer, Integer> mo192createAnimation3 = animatableColorValue.mo192createAnimation();
            this.strokeColorAnimation = mo192createAnimation3;
        ...
        if (textProperties != null && (animatableFloatValue2 = textProperties.strokeWidth) != null) {
            BaseKeyframeAnimation<Float, Float> mo192createAnimation4 = animatableFloatValue2.mo192createAnimation();
            this.strokeWidthAnimation = mo192createAnimation4;
        ...
        BaseKeyframeAnimation<Float, Float> mo192createAnimation5 = animatableFloatValue.mo192createAnimation();
        this.trackingAnimation = mo192createAnimation5;
    ...
    void drawLayer(Canvas canvas, Matrix matrix, int i) {
        ...
        DocumentData mo189getValue = this.textAnimation.mo189getValue();
        Font font = this.composition.getFonts().get(mo189getValue.fontName);
        if (font == null) {
            canvas.restore();
            return;
        }
        ...
        if (baseKeyframeAnimation != null) {
            this.fillPaint.setColor(baseKeyframeAnimation.mo189getValue().intValue());
        } else {
            this.fillPaint.setColor(mo189getValue.color);
        }
        BaseKeyframeAnimation<Integer, Integer> baseKeyframeAnimation2 = this.strokeColorAnimation;
        if (baseKeyframeAnimation2 != null) {
            this.strokePaint.setColor(baseKeyframeAnimation2.mo189getValue().intValue());
        } else {
            this.strokePaint.setColor(mo189getValue.strokeColor);
        }
        int intValue = ((this.transform.getOpacity() == null ? 100 : this.transform.getOpacity().mo189getValue().intValue()) * 255) / 100;
        this.fillPaint.setAlpha(intValue);
        this.strokePaint.setAlpha(intValue);
        BaseKeyframeAnimation<Float, Float> baseKeyframeAnimation3 = this.strokeWidthAnimation;
        if (baseKeyframeAnimation3 != null) {
            this.strokePaint.setStrokeWidth(baseKeyframeAnimation3.mo189getValue().floatValue());
        } else {
            this.strokePaint.setStrokeWidth(mo189getValue.strokeWidth * Utils.dpScale() * Utils.getScale(matrix));
        }
        if (this.lottieDrawable.useTextGlyphs()) {
            drawTextGlyphs(mo189getValue, matrix, font, canvas);
        } else {
            drawTextWithFont(mo189getValue, font, matrix, canvas);
        }
        canvas.restore();
    }
    ...
    private void drawTextGlyphs(DocumentData documentData, Matrix matrix, Font font, Canvas canvas) {
        ...
        float floatValue = (baseKeyframeAnimation == null ? documentData.size : baseKeyframeAnimation.mo189getValue().floatValue()) / 100.0f;
    ...
    private void drawGlyphTextLine(String str, DocumentData documentData, Matrix matrix, Font font, Canvas canvas, float f, float f2) {
        for (int i = 0; i < str.length(); i++) {
            ...
            if (fontCharacter != null) {
                ...
                if (baseKeyframeAnimation != null) {
                    f3 += baseKeyframeAnimation.mo189getValue().floatValue();
                }
    ...
    private void drawTextWithFont(DocumentData documentData, Font font, Matrix matrix, Canvas canvas) {
        ...
        BaseKeyframeAnimation<Float, Float> baseKeyframeAnimation = this.textSizeAnimation;
        this.fillPaint.setTextSize((baseKeyframeAnimation == null ? documentData.size : baseKeyframeAnimation.mo189getValue().floatValue()) * Utils.dpScale());
    ...
    private void drawFontTextLine(String str, DocumentData documentData, Canvas canvas, float f) {
        ...
        while (i < str.length()) {
            ...
            BaseKeyframeAnimation<Float, Float> baseKeyframeAnimation = this.trackingAnimation;
            if (baseKeyframeAnimation != null) {
                f2 += baseKeyframeAnimation.mo189getValue().floatValue();
            }
