...
class FontCharacterParser {
    private static final JsonReader.Options DATA_NAMES = JsonReader.Options.m137of("shapes");
    private static final JsonReader.Options NAMES = JsonReader.Options.m137of("ch", AuthDialog.KEY_BIOMETRIC_DIALOG_SIZE, "w", "style", "fFamily", "data");
