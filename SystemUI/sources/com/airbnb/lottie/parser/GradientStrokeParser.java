...
class GradientStrokeParser {
    ...
    private static JsonReader.Options NAMES = JsonReader.Options.m137of("nm", "g", "o", "t", DateFormat.SECOND, "e", "w", "lc", "lj", "ml", "hd", DateFormat.DAY);
                ...
                case 11:
                    ...
                    while (jsonReader.hasNext()) {
                        ...
                        if (str7.equals("o")) {
                            ...
                            if (str7.equals(DateFormat.DAY) || str7.equals("g")) {
