...
class KeyframeParser {
    static JsonReader.Options INTERPOLATOR_NAMES = JsonReader.Options.m137of(LanguageTag.PRIVATEUSE, DateFormat.YEAR);
    private static final Interpolator LINEAR_INTERPOLATOR = new LinearInterpolator();
    private static final float MAX_CP_VALUE = 100.0f;
    static JsonReader.Options NAMES = JsonReader.Options.m137of("t", DateFormat.SECOND, "e", "o", "i", "h", "to", "ti");
    ...
    private static <T> com.airbnb.lottie.value.Keyframe<T> parseMultiDimensionalKeyframe(com.airbnb.lottie.LottieComposition r20, com.airbnb.lottie.parser.moshi.JsonReader r21, float r22, com.airbnb.lottie.parser.ValueParser<T> r23) throws java.p026io.IOException {
        /*
            r0 = r21
            r1 = r22
            r2 = r23
