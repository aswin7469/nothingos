...
public class LottieCompositionMoshiParser {
    static JsonReader.Options ASSETS_NAMES = JsonReader.Options.m137of("id", "layers", "w", "h", "p", "u");
    private static final JsonReader.Options FONT_NAMES = JsonReader.Options.m137of("list");
    private static final JsonReader.Options MARKER_NAMES = JsonReader.Options.m137of("cm", "tm", "dr");
    private static final JsonReader.Options NAMES = JsonReader.Options.m137of("w", "h", "ip", "op", "fr", DateFormat.ABBR_GENERIC_TZ, "layers", "assets", "fonts", "chars", "markers");
