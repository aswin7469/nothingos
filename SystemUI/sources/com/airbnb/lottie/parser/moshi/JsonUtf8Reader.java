...
final class JsonUtf8Reader extends JsonReader {
                ...
                if (b == 45) {
                    ...
                    if (b >= 48 && b <= 57) {
                        if (c2 == z || c2 == 0) {
                            ...
                            int i3 = (j > MIN_INCOMPLETE_INTEGER ? 1 : (j == MIN_INCOMPLETE_INTEGER ? 0 : -1));
                            z3 &= i3 > 0 || (i3 == 0 && j2 < j);
                            j = j2;
                        } else if (c2 == 3) {
                            c2 = 4;
    ...
    private int nextNonWhitespace(boolean r7) throws java.p026io.IOException {
        /*
            r6 = this;
            r0 = 0
        L_0x0001:
    ...
    public String toString() {
        return "JsonReader(" + this.source + NavigationBarInflaterView.KEY_CODE_END;
    }
