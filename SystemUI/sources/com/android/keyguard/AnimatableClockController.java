...
public class AnimatableClockController extends ViewController<AnimatableClockView> {
    ...
    private final BatteryController.BatteryStateChangeCallback mBatteryCallback = new BatteryController.BatteryStateChangeCallback() { // from class: com.android.keyguard.AnimatableClockController.1
        ...
        public void onBatteryLevelChanged(int i, boolean z, boolean z2) {
            ...
            if (animatableClockController.mKeyguardShowing && !animatableClockController.mIsCharging && z2) {
                final StatusBarStateController statusBarStateController = AnimatableClockController.this.mStatusBarStateController;
                Objects.requireNonNull(statusBarStateController);
                ((AnimatableClockView) ((ViewController) AnimatableClockController.this).mView).animateCharge(new AnimatableClockView.DozeStateGetter() { // from class: com.android.keyguard.AnimatableClockController$1$$ExternalSyntheticLambda0
    ...
    private final StatusBarStateController.StateListener mStatusBarStateListener = new StatusBarStateController.StateListener() { // from class: com.android.keyguard.AnimatableClockController.3
