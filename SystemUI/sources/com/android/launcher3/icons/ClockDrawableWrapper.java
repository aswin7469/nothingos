...
public class ClockDrawableWrapper extends AdaptiveIconDrawable implements BitmapInfo.Extender {
    ...
    public static ClockDrawableWrapper forPackage(Context context, String str, final int i) {
        try {
            ...
            return forExtras(applicationInfo, applicationInfo.metaData, new IntFunction() { // from class: com.android.launcher3.icons.ClockDrawableWrapper$$ExternalSyntheticLambda0
    ...
    /* renamed from: getExtendedInfo  reason: collision with other method in class */
    public ClockBitmapInfo mo253getExtendedInfo(Bitmap bitmap, int i, BaseIconFactory baseIconFactory, float f, UserHandle userHandle) {
