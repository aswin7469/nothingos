...
public class IconProvider {
    ...
    public Drawable getIcon(final ActivityInfo activityInfo, final int i) {
        ...
        return getIconWithOverrides(applicationInfo.packageName, UserHandle.getUserHandleForUid(applicationInfo.uid), i, new Supplier() { // from class: com.android.launcher3.icons.IconProvider$$ExternalSyntheticLambda0
            @Override // java.util.function.Supplier
            public final Object get() {
                Drawable lambda$getIcon$1;
                lambda$getIcon$1 = IconProvider.this.lambda$getIcon$1(activityInfo, i);
    ...
    */
    public Drawable lambda$getIcon$1(ActivityInfo activityInfo, int i) {
        Drawable drawable;
