...
public final class HttpUrl {
    ...
    static HttpUrl getChecked(String str) throws MalformedURLException, UnknownHostException {
        ...
        int i = C17051.$SwitchMap$com$android$okhttp$HttpUrl$Builder$ParseResult[parse.ordinal()];
        if (i == 1) {
            return builder.build();
        }
        if (i != 2) {
    ...
    /* renamed from: com.android.okhttp.HttpUrl$1 */
    static /* synthetic */ class C17051 {
        ...
        static {
            /*
                ...
                int r0 = r0.length
                int[] r0 = new int[r0]
                $SwitchMap$com$android$okhttp$HttpUrl$Builder$ParseResult = r0
                com.android.okhttp.HttpUrl$Builder$ParseResult r1 = com.android.okhttp.HttpUrl.Builder.ParseResult.SUCCESS     // Catch:{ NoSuchFieldError -> 0x0012 }
                int r1 = r1.ordinal()     // Catch:{ NoSuchFieldError -> 0x0012 }
                r2 = 1
                r0[r1] = r2     // Catch:{ NoSuchFieldError -> 0x0012 }
            L_0x0012:
                int[] r0 = $SwitchMap$com$android$okhttp$HttpUrl$Builder$ParseResult     // Catch:{ NoSuchFieldError -> 0x001d }
                com.android.okhttp.HttpUrl$Builder$ParseResult r1 = com.android.okhttp.HttpUrl.Builder.ParseResult.INVALID_HOST     // Catch:{ NoSuchFieldError -> 0x001d }
                int r1 = r1.ordinal()     // Catch:{ NoSuchFieldError -> 0x001d }
                r2 = 2
                r0[r1] = r2     // Catch:{ NoSuchFieldError -> 0x001d }
            L_0x001d:
                int[] r0 = $SwitchMap$com$android$okhttp$HttpUrl$Builder$ParseResult     // Catch:{ NoSuchFieldError -> 0x0028 }
                com.android.okhttp.HttpUrl$Builder$ParseResult r1 = com.android.okhttp.HttpUrl.Builder.ParseResult.UNSUPPORTED_SCHEME     // Catch:{ NoSuchFieldError -> 0x0028 }
                int r1 = r1.ordinal()     // Catch:{ NoSuchFieldError -> 0x0028 }
                r2 = 3
                r0[r1] = r2     // Catch:{ NoSuchFieldError -> 0x0028 }
            L_0x0028:
                int[] r0 = $SwitchMap$com$android$okhttp$HttpUrl$Builder$ParseResult     // Catch:{ NoSuchFieldError -> 0x0033 }
                com.android.okhttp.HttpUrl$Builder$ParseResult r1 = com.android.okhttp.HttpUrl.Builder.ParseResult.MISSING_SCHEME     // Catch:{ NoSuchFieldError -> 0x0033 }
                int r1 = r1.ordinal()     // Catch:{ NoSuchFieldError -> 0x0033 }
                r2 = 4
                r0[r1] = r2     // Catch:{ NoSuchFieldError -> 0x0033 }
            L_0x0033:
                int[] r0 = $SwitchMap$com$android$okhttp$HttpUrl$Builder$ParseResult     // Catch:{ NoSuchFieldError -> 0x003e }
                com.android.okhttp.HttpUrl$Builder$ParseResult r1 = com.android.okhttp.HttpUrl.Builder.ParseResult.INVALID_PORT     // Catch:{ NoSuchFieldError -> 0x003e }
            ...
            L_0x003e:
                return
            */
            throw new UnsupportedOperationException("Method not decompiled: com.android.okhttp.HttpUrl.C17051.<clinit>():void");
        }
    }
    ...
    public static final class Builder {
        ...
        public ParseResult parse(HttpUrl httpUrl, String str) {
            ...
            if (slashCount >= 2 || httpUrl == null || !httpUrl.scheme.equals(this.scheme)) {
                ...
                while (true) {
                    r8 = HttpUrl.delimiterOffset(str2, i2, skipTrailingAsciiWhitespace, "@/\\?#");
                    char charAt = r8 != skipTrailingAsciiWhitespace ? str2.charAt(r8) : 65535;
                    if (charAt == 65535 || charAt == c2 || charAt == '/' || charAt == '\\' || charAt == c) {
                        ...
                        if (charAt == '@') {
                            if (!z) {
                                int r6 = HttpUrl.delimiterOffset(str2, i2, r8, ":");
                                int i5 = r6;
                                String str3 = "%40";
                                i = r8;
                                String canonicalize = HttpUrl.canonicalize(str, i2, r6, " \"':;<=>@[]^`{}|/\\?#", true, false, false, true);
                                if (z2) {
            ...
            int r1 = HttpUrl.delimiterOffset(str2, skipLeadingAsciiWhitespace, skipTrailingAsciiWhitespace, "?#");
            resolvePath(str2, skipLeadingAsciiWhitespace, r1);
            if (r1 < skipTrailingAsciiWhitespace && str2.charAt(r1) == '?') {
                int r11 = HttpUrl.delimiterOffset(str2, r1, skipTrailingAsciiWhitespace, "#");
                this.encodedQueryNamesAndValues = HttpUrl.queryStringToNamesAndValues(HttpUrl.canonicalize(str, r1 + 1, r11, HttpUrl.QUERY_ENCODE_SET, true, false, true, true));
                r1 = r11;
            }
            if (r1 < skipTrailingAsciiWhitespace && str2.charAt(r1) == '#') {
                this.encodedFragment = HttpUrl.canonicalize(str, 1 + r1, skipTrailingAsciiWhitespace, "", true, false, false, false);
            }
        ...
        private void resolvePath(java.lang.String r11, int r12, int r13) {
            ...
            L_0x0029:
                ...
                int r12 = com.android.okhttp.HttpUrl.delimiterOffset(r11, r6, r13, r12)
        ...
        private boolean isDot(String str) {
            return str.equals(BaseIconCache.EMPTY_CLASS_NAME) || str.equalsIgnoreCase("%2e");
        }
        ...
        private static String canonicalizeHost(String str, int i, int i2) {
            ...
            if (!percentDecode.startsWith(NavigationBarInflaterView.SIZE_MOD_START) || !percentDecode.endsWith(NavigationBarInflaterView.SIZE_MOD_END)) {
        ...
        private static InetAddress decodeIpv6(String str, int i, int i2) {
                    ...
                    if (i6 > i2 || !str.regionMatches(i, "::", 0, 2)) {
                        if (i3 != 0) {
                            if (str.regionMatches(i, ":", 0, 1)) {
                                i++;
                            } else if (!str.regionMatches(i, BaseIconCache.EMPTY_CLASS_NAME, 0, 1) || !decodeIpv4Suffix(str, i5, i2, bArr, i3 - 2)) {
                                return null;
                            } else {
                                i3 += 2;
                            }
            ...
            if (i3 != 16) {
                ...
                int i10 = i3 - i4;
                System.arraycopy((Object) bArr, i4, (Object) bArr, 16 - i10, i10);
        ...
        private static boolean containsInvalidHostnameAsciiCodes(String str) {
            for (int i = 0; i < str.length(); i++) {
                char charAt = str.charAt(i);
                if (charAt <= 31 || charAt >= 127 || " #%/:?@[\\]".indexOf((int) charAt) != -1) {
                    return true;
                }
            }
            return false;
    ...
    public static int delimiterOffset(String str, int i, int i2, String str2) {
        while (i < i2) {
            if (str2.indexOf((int) str.charAt(i)) != -1) {
                return i;
            }
            i++;
        }
