...
final class Hpack {
    ...
    /* access modifiers changed from: private */
    public static final Header[] STATIC_HEADER_TABLE = {new Header(Header.TARGET_AUTHORITY, ""), new Header(Header.TARGET_METHOD, "GET"), new Header(Header.TARGET_METHOD, "POST"), new Header(Header.TARGET_PATH, "/"), new Header(Header.TARGET_PATH, "/index.html"), new Header(Header.TARGET_SCHEME, "http"), new Header(Header.TARGET_SCHEME, "https"), new Header(Header.RESPONSE_STATUS, "200"), new Header(Header.RESPONSE_STATUS, "204"), new Header(Header.RESPONSE_STATUS, "206"), new Header(Header.RESPONSE_STATUS, "304"), new Header(Header.RESPONSE_STATUS, "400"), new Header(Header.RESPONSE_STATUS, "404"), new Header(Header.RESPONSE_STATUS, "500"), new Header("accept-charset", ""), new Header("accept-encoding", "gzip, deflate"), new Header("accept-language", ""), new Header("accept-ranges", ""), new Header((String) SecurityConstants.SOCKET_ACCEPT_ACTION, ""), new Header("access-control-allow-origin", ""), new Header("age", ""), new Header("allow", ""), new Header("authorization", ""), new Header("cache-control", ""), new Header("content-disposition", ""), new Header("content-encoding", ""), new Header("content-language", ""), new Header("content-length", ""), new Header("content-location", ""), new Header("content-range", ""), new Header("content-type", ""), new Header("cookie", ""), new Header((String) InvalidityDateExtension.DATE, ""), new Header("etag", ""), new Header("expect", ""), new Header("expires", ""), new Header("from", ""), new Header("host", ""), new Header("if-match", ""), new Header("if-modified-since", ""), new Header("if-none-match", ""), new Header("if-range", ""), new Header("if-unmodified-since", ""), new Header("last-modified", ""), new Header((String) AnnotationLinkSpan.LinkInfo.DEFAULT_ANNOTATION, ""), new Header("location", ""), new Header("max-forwards", ""), new Header("proxy-authenticate", ""), new Header("proxy-authorization", ""), new Header("range", ""), new Header("referer", ""), new Header("refresh", ""), new Header("retry-after", ""), new Header("server", ""), new Header("set-cookie", ""), new Header("strict-transport-security", ""), new Header("transfer-encoding", ""), new Header("user-agent", ""), new Header("vary", ""), new Header("via", ""), new Header("www-authenticate", "")};
    ...
    static final class Reader {
            ...
            if (i > 0) {
                ...
                while (true) {
                    ...
                    if (length < i2 || i <= 0) {
                        ...
                        System.arraycopy((Object) headerArr, i2 + 1, (Object) headerArr, i2 + 1 + i3, this.headerCount);
                ...
                System.arraycopy((Object) headerArr2, i2 + 1, (Object) headerArr2, i2 + 1 + i3, this.headerCount);
                this.nextHeaderIndex += i3;
            }
            return i3;
        }
        ...
        public void readHeaders() throws IOException {
            while (!this.source.exhausted()) {
                ...
                } else if ((readByte & NetworkStackConstants.TCPHDR_URG) == 32) {
        ...
        private void insertIntoDynamicTable(int i, Header header) {
            ...
            if (i == -1) {
                ...
                if (i4 > headerArr.length) {
                    ...
                    System.arraycopy((Object) headerArr, 0, (Object) headerArr2, headerArr.length, headerArr.length);
                    this.nextHeaderIndex = this.dynamicTable.length - 1;
        ...
        public ByteString readByteString() throws IOException {
            ...
            if (z) {
                return ByteString.m192of(Huffman.get().decode(this.source.readByteArray((long) readInt)));
            }
