    ...
    public static Set<String> varyFields(Headers headers) {
        ...
        for (int i = 0; i < size; i++) {
            if ("Vary".equalsIgnoreCase(headers.name(i))) {
                ...
                for (String trim : value.split(NavigationBarInflaterView.BUTTON_SEPARATOR)) {
        ...
        for (int i = 0; i < size; i++) {
            if (str.equalsIgnoreCase(headers.name(i))) {
                ...
                while (i2 < value.length()) {
                    int skipUntil = HeaderParser.skipUntil(value, i2, WifiEnterpriseConfig.CA_CERT_ALIAS_DELIMITER);
                    ...
                    i2 = HeaderParser.skipWhitespace(value, HeaderParser.skipUntil(value, skipUntil2 + 1, NavigationBarInflaterView.BUTTON_SEPARATOR) + 1);
