...
public final class StreamAllocation {
    ...
    private com.android.okhttp.internal.p006io.RealConnection findHealthyConnection(int r4, int r5, int r6, boolean r7, boolean r8) throws java.p026io.IOException, com.android.okhttp.internal.http.RouteException {
        /*
            r3 = this;
        L_0x0000:
    ...
    /* JADX WARNING: Code restructure failed: missing block: B:24:0x003b, code lost:
        r7 = new com.android.okhttp.internal.p006io.RealConnection(r8.routeSelector.next());
        acquire(r7);
    ...
    /* JADX WARNING: Code restructure failed: missing block: B:34:0x007b, code lost:
        throw new java.p026io.IOException("Canceled");
     */
    /* Code decompiled incorrectly, please refer to instructions dump. */
    private com.android.okhttp.internal.p006io.RealConnection findConnection(int r9, int r10, int r11, boolean r12) throws java.p026io.IOException, com.android.okhttp.internal.http.RouteException {
        /*
            r8 = this;
            com.android.okhttp.ConnectionPool r0 = r8.connectionPool
            monitor-enter(r0)
            boolean r1 = r8.released     // Catch:{ all -> 0x0099 }
            if (r1 != 0) goto L_0x0090
            com.android.okhttp.internal.http.HttpStream r1 = r8.stream     // Catch:{ all -> 0x0099 }
            if (r1 != 0) goto L_0x0087
            boolean r1 = r8.canceled     // Catch:{ all -> 0x0099 }
            if (r1 != 0) goto L_0x007f
            com.android.okhttp.internal.io.RealConnection r1 = r8.connection     // Catch:{ all -> 0x0099 }
            if (r1 == 0) goto L_0x0019
            boolean r2 = r1.noNewStreams     // Catch:{ all -> 0x0099 }
            if (r2 != 0) goto L_0x0019
            monitor-exit(r0)     // Catch:{ all -> 0x0099 }
            return r1
        L_0x0019:
            com.android.okhttp.internal.Internal r1 = com.android.okhttp.internal.Internal.instance     // Catch:{ all -> 0x0099 }
            com.android.okhttp.ConnectionPool r2 = r8.connectionPool     // Catch:{ all -> 0x0099 }
            com.android.okhttp.Address r3 = r8.address     // Catch:{ all -> 0x0099 }
            com.android.okhttp.internal.io.RealConnection r1 = r1.get(r2, r3, r8)     // Catch:{ all -> 0x0099 }
            if (r1 == 0) goto L_0x0029
            r8.connection = r1     // Catch:{ all -> 0x0099 }
            monitor-exit(r0)     // Catch:{ all -> 0x0099 }
            return r1
        L_0x0029:
            com.android.okhttp.internal.http.RouteSelector r1 = r8.routeSelector     // Catch:{ all -> 0x0099 }
            if (r1 != 0) goto L_0x003a
            com.android.okhttp.internal.http.RouteSelector r1 = new com.android.okhttp.internal.http.RouteSelector     // Catch:{ all -> 0x0099 }
            com.android.okhttp.Address r2 = r8.address     // Catch:{ all -> 0x0099 }
            com.android.okhttp.internal.RouteDatabase r3 = r8.routeDatabase()     // Catch:{ all -> 0x0099 }
            r1.<init>(r2, r3)     // Catch:{ all -> 0x0099 }
            r8.routeSelector = r1     // Catch:{ all -> 0x0099 }
        L_0x003a:
            monitor-exit(r0)     // Catch:{ all -> 0x0099 }
            com.android.okhttp.internal.http.RouteSelector r0 = r8.routeSelector
            com.android.okhttp.Route r0 = r0.next()
            com.android.okhttp.internal.io.RealConnection r7 = new com.android.okhttp.internal.io.RealConnection
            r7.<init>(r0)
            r8.acquire(r7)
            com.android.okhttp.ConnectionPool r1 = r8.connectionPool
            monitor-enter(r1)
            com.android.okhttp.internal.Internal r0 = com.android.okhttp.internal.Internal.instance     // Catch:{ all -> 0x007c }
            com.android.okhttp.ConnectionPool r2 = r8.connectionPool     // Catch:{ all -> 0x007c }
            ...
            com.android.okhttp.Address r0 = r8.address
            ...
            com.android.okhttp.internal.RouteDatabase r8 = r8.routeDatabase()
            com.android.okhttp.Route r9 = r7.getRoute()
            r8.connected(r9)
            return r7
        L_0x0074:
            java.io.IOException r8 = new java.io.IOException     // Catch:{ all -> 0x007c }
            java.lang.String r9 = "Canceled"
            r8.<init>((java.lang.String) r9)     // Catch:{ all -> 0x007c }
