        ...
        if (outputStream == null) {
            ...
            return new Sink() {
                ...
                public String toString() {
                    return "sink(" + outputStream + NavigationBarInflaterView.KEY_CODE_END;
                }
            };
        } else {
    ...
    private static Source source(final InputStream inputStream, final Timeout timeout) {
        if (inputStream == null) {
            ...
            return new Source() {
                ...
                public String toString() {
                    return "source(" + inputStream + NavigationBarInflaterView.KEY_CODE_END;
                }
            };
        } else {
            throw new IllegalArgumentException("timeout == null");
        ...
        return new AsyncTimeout() {
            ...
            public void timedOut() {
                try {
                    ...
                    Logger r2 = Okio.logger;
                    Level level = Level.WARNING;
                    r2.log(level, "Failed to close timed out socket " + Socket.this, (Throwable) e);
                } catch (AssertionError e2) {
                    if (Okio.isAndroidGetsocknameError(e2)) {
                        Logger r22 = Okio.logger;
                        Level level2 = Level.WARNING;
                        r22.log(level2, "Failed to close timed out socket " + Socket.this, (Throwable) e2);
                        return;
                    }
                    throw e2;
                }
