...
public class FlingAnimationUtils {
    ...
    public FlingAnimationUtils(DisplayMetrics displayMetrics, float f, float f2, float f3, float f4) {
        ...
        if (f3 < 0.0f) {
            this.mLinearOutSlowInX2 = interpolate(LINEAR_OUT_SLOW_IN_X2, LINEAR_OUT_SLOW_IN_X2_MAX, f2);
        } else {
            this.mLinearOutSlowInX2 = f3;
        }
        this.mY2 = f4;
        this.mMinVelocityPxPerSecond = displayMetrics.density * MIN_VELOCITY_DP_PER_SECOND;
        this.mHighVelocityPxPerSecond = displayMetrics.density * HIGH_VELOCITY_DP_PER_SECOND;
    }
    ...
    private AnimatorProperties getProperties(float f, float f2, float f3, float f4) {
        ...
        if (this.mSpeedUpFactor != 0.0f) {
            f6 = Math.min(abs2 / HIGH_VELOCITY_DP_PER_SECOND, 1.0f);
        }
        ...
        this.mAnimatorProperties.mDuration = (long) (sqrt * 1000.0f);
    ...
    private AnimatorProperties getDismissingProperties(float f, float f2, float f3, float f4) {
        ...
        this.mAnimatorProperties.mDuration = (long) (pow * 1000.0f);
        return this.mAnimatorProperties;
    }
    ...
    private float calculateLinearOutFasterInY2(float f) {
        ...
        return ((1.0f - max) * LINEAR_OUT_FASTER_IN_Y2_MIN) + (max * 0.5f);
    }
