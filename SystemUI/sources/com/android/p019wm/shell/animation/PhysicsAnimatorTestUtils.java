...
public final class PhysicsAnimatorTestUtils {
    ...
    public static final void m3396tearDown$lambda1(CountDownLatch countDownLatch) {
    ...
    public static final <T> void blockUntilFirstAnimationFrameWhereTrue(PhysicsAnimator<T> physicsAnimator, Function1<? super T, Boolean> function1) throws InterruptedException {
        ...
        if (physicsAnimator.isRunning()) {
            CountDownLatch countDownLatch = new CountDownLatch(1);
            INSTANCE.getAnimationTestHelper(physicsAnimator).addTestUpdateListener$WMShell_release(new C3357x4cc8474d(function1, countDownLatch));
            countDownLatch.await(timeoutMs, TimeUnit.MILLISECONDS);
        }
    }
    ...
    public static final class AnimatorTestHelper<T> {
        ...
        public final void startForTest() {
            ...
            PhysicsAnimatorTestUtils.animationThreadHandler.post(new C3355x10869(this, countDownLatch));
        ...
        public static final void m3399startForTest$lambda0(AnimatorTestHelper animatorTestHelper, CountDownLatch countDownLatch) {
        ...
        public final void cancelForTest(Set<? extends FloatPropertyCompat<? super T>> set) {
            ...
            CountDownLatch countDownLatch = new CountDownLatch(1);
            PhysicsAnimatorTestUtils.animationThreadHandler.post(new C3356x1086a(this, set, countDownLatch));
            countDownLatch.await(PhysicsAnimatorTestUtils.INSTANCE.getTimeoutMs(), TimeUnit.MILLISECONDS);
        }

        /* access modifiers changed from: private */
        /* renamed from: cancelForTest$lambda-1  reason: not valid java name */
        public static final void m3398cancelForTest$lambda1(AnimatorTestHelper animatorTestHelper, Set set, CountDownLatch countDownLatch) {
            Intrinsics.checkNotNullParameter(animatorTestHelper, "this$0");
