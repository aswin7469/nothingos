...
public final /* synthetic */ class BubbleController$BubblesImpl$$ExternalSyntheticLambda0 implements Runnable {
    ...
    public /* synthetic */ BubbleController$BubblesImpl$$ExternalSyntheticLambda0(BubbleController.BubblesImpl bubblesImpl, boolean z) {
        this.f$0 = bubblesImpl;
        this.f$1 = z;
    }

    public final void run() {
        this.f$0.mo48414xa2f96552(this.f$1);
    }
}
