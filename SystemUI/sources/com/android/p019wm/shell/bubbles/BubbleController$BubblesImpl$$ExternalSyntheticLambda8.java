...
public final /* synthetic */ class BubbleController$BubblesImpl$$ExternalSyntheticLambda8 implements Runnable {
    ...
    public /* synthetic */ BubbleController$BubblesImpl$$ExternalSyntheticLambda8(BubbleController.BubblesImpl bubblesImpl, BubbleEntry bubbleEntry) {
        this.f$0 = bubblesImpl;
        this.f$1 = bubbleEntry;
    }

    public final void run() {
        this.f$0.mo48410x5a95736(this.f$1);
    }
}
