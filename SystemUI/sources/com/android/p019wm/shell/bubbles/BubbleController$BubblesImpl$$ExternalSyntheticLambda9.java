...
public final /* synthetic */ class BubbleController$BubblesImpl$$ExternalSyntheticLambda9 implements Runnable {
    ...
    public /* synthetic */ BubbleController$BubblesImpl$$ExternalSyntheticLambda9(BubbleController.BubblesImpl bubblesImpl, int i) {
        this.f$0 = bubblesImpl;
        this.f$1 = i;
    }

    public final void run() {
        this.f$0.mo48426xa9e04d0e(this.f$1);
    }
}
