...
public class BubbleViewInfoTask extends AsyncTask<Void, Void, BubbleViewInfo> {
    ...
    BubbleViewInfoTask(Bubble bubble, Context context, BubbleController bubbleController, BubbleStackView bubbleStackView, BubbleIconFactory bubbleIconFactory, BubbleBadgeIconFactory bubbleBadgeIconFactory, boolean z, Callback callback, Executor executor) {
        this.mBubble = bubble;
        ...
        public static BubbleViewInfo populate(Context context, BubbleController bubbleController, BubbleStackView bubbleStackView, BubbleIconFactory bubbleIconFactory, BubbleBadgeIconFactory bubbleBadgeIconFactory, Bubble bubble, boolean z) {
            ...
            try {
                ...
                if (applicationInfo != null) {
                    bubbleViewInfo.appName = String.valueOf((Object) packageManagerForUser.getApplicationLabel(applicationInfo));
                }
                ...
                Path createPathFromPathData = PathParser.createPathFromPathData(context.getResources().getString(17039987));
