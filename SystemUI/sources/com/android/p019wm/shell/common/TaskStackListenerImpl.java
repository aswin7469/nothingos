...
public class TaskStackListenerImpl extends TaskStackListener implements Handler.Callback {
    ...
    private static final String TAG = "TaskStackListenerImpl";
    ...
    public void removeListener(TaskStackListenerCallback taskStackListenerCallback) {
        ...
        synchronized (this.mTaskStackListeners) {
            isEmpty = this.mTaskStackListeners.isEmpty();
            this.mTaskStackListeners.remove((Object) taskStackListenerCallback);
    ...
    public void onTaskProfileLocked(ActivityManager.RunningTaskInfo runningTaskInfo) {
        this.mMainHandler.obtainMessage(7, runningTaskInfo).sendToTarget();
    }
            ...
            switch (message.what) {
                ...
                case 2:
                    ...
                    for (int size2 = this.mTaskStackListeners.size() - 1; size2 >= 0; size2--) {
                        z |= this.mTaskStackListeners.get(size2).onTaskSnapshotChanged(message.arg1, taskSnapshot);
                    }
                    if (!z && taskSnapshot.getHardwareBuffer() != null) {
