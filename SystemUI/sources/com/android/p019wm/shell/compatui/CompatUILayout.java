...
class CompatUILayout extends LinearLayout {
    ...
    public void updateCameraTreatmentButton(int i) {
        ...
        int i3;
        if (i == 1) {
            i2 = C3343R.C3345drawable.camera_compat_treatment_suggested_ripple;
        } else {
            i2 = C3343R.C3345drawable.camera_compat_treatment_applied_ripple;
        }
        if (i == 1) {
            i3 = C3343R.string.camera_compat_treatment_suggested_button_description;
        } else {
            i3 = C3343R.string.camera_compat_treatment_applied_button_description;
        }
        ImageButton imageButton = (ImageButton) findViewById(C3343R.C3346id.camera_compat_treatment_button);
        imageButton.setImageResource(i2);
        imageButton.setContentDescription(getResources().getString(i3));
        ((TextView) ((LinearLayout) findViewById(C3343R.C3346id.camera_compat_hint)).findViewById(C3343R.C3346id.compat_mode_hint_text)).setText(i3);
    }

    /* access modifiers changed from: package-private */
    public void setSizeCompatHintVisibility(boolean z) {
        setViewVisibility(C3343R.C3346id.size_compat_hint, z);
    }

    /* access modifiers changed from: package-private */
    public void setCameraCompatHintVisibility(boolean z) {
        setViewVisibility(C3343R.C3346id.camera_compat_hint, z);
    }

    /* access modifiers changed from: package-private */
    public void setRestartButtonVisibility(boolean z) {
        setViewVisibility(C3343R.C3346id.size_compat_restart_button, z);
        if (!z) {
    ...
    public void setCameraControlVisibility(boolean z) {
        setViewVisibility(C3343R.C3346id.camera_compat_control, z);
        if (!z) {
    ...
    public void onFinishInflate() {
        ...
        ImageButton imageButton = (ImageButton) findViewById(C3343R.C3346id.size_compat_restart_button);
        ...
        LinearLayout linearLayout = (LinearLayout) findViewById(C3343R.C3346id.size_compat_hint);
        ((TextView) linearLayout.findViewById(C3343R.C3346id.compat_mode_hint_text)).setText(C3343R.string.restart_button_description);
        linearLayout.setOnClickListener(new CompatUILayout$$ExternalSyntheticLambda2(this));
        ImageButton imageButton2 = (ImageButton) findViewById(C3343R.C3346id.camera_compat_treatment_button);
        ...
        ImageButton imageButton3 = (ImageButton) findViewById(C3343R.C3346id.camera_compat_dismiss_button);
        ...
        ((LinearLayout) findViewById(C3343R.C3346id.camera_compat_hint)).setOnClickListener(new CompatUILayout$$ExternalSyntheticLambda7(this));
    }

    /* access modifiers changed from: package-private */
    /* renamed from: lambda$onFinishInflate$0$com-android-wm-shell-compatui-CompatUILayout */
    public /* synthetic */ void mo49374x59037d4d(View view) {
    ...
    public /* synthetic */ boolean mo49375x127b0aec(View view) {
    ...
    public /* synthetic */ void mo49376xcbf2988b(View view) {
        setSizeCompatHintVisibility(false);
    }

    /* access modifiers changed from: package-private */
    /* renamed from: lambda$onFinishInflate$3$com-android-wm-shell-compatui-CompatUILayout */
    public /* synthetic */ void mo49377x856a262a(View view) {
    ...
    public /* synthetic */ boolean mo49378x3ee1b3c9(View view) {
    ...
    public /* synthetic */ void mo49379xf8594168(View view) {
    ...
    public /* synthetic */ boolean mo49380xb1d0cf07(View view) {
        this.mWindowManager.onCameraButtonLongClicked();
        return true;
    }
    ...
    public /* synthetic */ void mo49381x6b485ca6(View view) {
        setCameraCompatHintVisibility(false);
    }
}
