...
public final class C3463x374a97b implements Factory<AnimationHandler> {
    private final Provider<ShellExecutor> mainExecutorProvider;

    public C3463x374a97b(Provider<ShellExecutor> provider) {
    ...
    public static C3463x374a97b create(Provider<ShellExecutor> provider) {
        return new C3463x374a97b(provider);
    }
