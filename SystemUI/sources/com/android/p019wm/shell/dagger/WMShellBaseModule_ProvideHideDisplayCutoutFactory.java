...
public final class WMShellBaseModule_ProvideHideDisplayCutoutFactory implements Factory<Optional<HideDisplayCutout>> {
    ...
    public static java.util.Optional<com.android.p019wm.shell.hidedisplaycutout.HideDisplayCutout> provideHideDisplayCutout(java.util.Optional<com.android.p019wm.shell.hidedisplaycutout.HideDisplayCutoutController> r0) {
        /*
            java.util.Optional r0 = com.android.p019wm.shell.dagger.WMShellBaseModule.provideHideDisplayCutout(r0)
            java.lang.Object r0 = dagger.internal.Preconditions.checkNotNullFromProvides(r0)
            java.util.Optional r0 = (java.util.Optional) r0
            return r0
        */
        throw new UnsupportedOperationException("Method not decompiled: com.android.p019wm.shell.dagger.WMShellBaseModule_ProvideHideDisplayCutoutFactory.provideHideDisplayCutout(java.util.Optional):java.util.Optional");
    }
}
