...
public class DragLayout extends LinearLayout {
    ...
    public DragLayout(Context context, SplitScreenController splitScreenController, IconProvider iconProvider) {
        ...
        this.mDisplayMargin = context.getResources().getDimensionPixelSize(C3343R.dimen.drop_layout_display_margin);
        this.mDividerSize = context.getResources().getDimensionPixelSize(C3343R.dimen.split_divider_bar_width);
