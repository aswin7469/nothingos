...
public class DividerView extends FrameLayout implements View.OnTouchListener, ViewTreeObserver.OnComputeInternalInsetsListener {
    ...
    public boolean onTouch(android.view.View r6, android.view.MotionEvent r7) {
        ...
        L_0x0017:
            ...
            int r2 = r5.mStartY
            int r2 = r7 - r2
            int r2 = java.lang.Math.abs((int) r2)
        ...
        L_0x00d3:
            ...
            return r6
        */
        throw new UnsupportedOperationException("Method not decompiled: com.android.p019wm.shell.legacysplitscreen.DividerView.onTouch(android.view.View, android.view.MotionEvent):boolean");
    }
    ...
    private boolean commitSnapFlags(com.android.internal.policy.DividerSnapAlgorithm.SnapTarget r6) {
        ...
        L_0x0020:
            ...
            return r0
        */
        throw new UnsupportedOperationException("Method not decompiled: com.android.p019wm.shell.legacysplitscreen.DividerView.commitSnapFlags(com.android.internal.policy.DividerSnapAlgorithm$SnapTarget):boolean");
    }
    ...
    private void initializeSurfaceState() {
        ...
        if (this.mDockedStackMinimized) {
            ...
            resizeSplitSurfaces(transaction, this.mSplitLayout.mPrimary, (Rect) null, this.mSplitLayout.mSecondary, (Rect) null);
        }
    ...
    private void applyDismissingParallax(Rect rect, int i, DividerSnapAlgorithm.SnapTarget snapTarget, int i2, int i3) {
        ...
        if (i2 <= this.mSplitLayout.getSnapAlgorithm().getLastSplitTarget().position && dockSideTopLeft(i)) {
            ...
            snapTarget2 = this.mSplitLayout.getSnapAlgorithm().getLastSplitTarget();
            i3 = snapTarget2.position;
        }
