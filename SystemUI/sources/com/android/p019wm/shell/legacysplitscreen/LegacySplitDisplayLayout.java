...
public class LegacySplitDisplayLayout {
    ...
    /* access modifiers changed from: package-private */
    public boolean resizeSplits(int i) {
        ...
        DockedDividerUtils.calculateBoundsForPosition(i, primarySplitSide, this.mPrimary, this.mDisplayLayout.width(), this.mDisplayLayout.height(), this.mDividerSize);
        this.mTmpBounds.set(this.mSecondary);
        DockedDividerUtils.calculateBoundsForPosition(i, DockedDividerUtils.invertDockSide(primarySplitSide), this.mSecondary, this.mDisplayLayout.width(), this.mDisplayLayout.height(), this.mDividerSize);
    ...
    private void adjustForIME(DisplayLayout displayLayout, int i, int i2, int i3, int i4, int i5, Rect rect, Rect rect2) {
        ...
        int i6 = rect3.top + ((int) (((float) (this.mPrimary.bottom - rect3.top)) * 0.3f));
        int height = displayLayout.height();
        int max = Math.max(0, height - (i + Math.max(0, (i2 - i3) - (this.mPrimary.bottom - i6))));
        this.mAdjustedPrimary.set(rect);
        int i7 = -max;
        this.mAdjustedPrimary.offset(0, (i4 - ((int) ((((float) i5) * f) + (((float) i4) * (1.0f - f))))) + i7);
        this.mAdjustedSecondary.set(rect2);
        this.mAdjustedSecondary.offset(0, i7);
    }
    ...
    static int getSmallestWidthDpForBounds(Context context, DisplayLayout displayLayout, Rect rect) {
        ...
        for (int i2 = 0; i2 < 4; i2++) {
            ...
            rect2.set(rect);
            RotationUtils.rotateBounds(rect2, rect4, displayLayout.rotation(), i2);
