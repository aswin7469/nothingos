...
public class LegacySplitScreenController implements DisplayController.OnDisplaysChangedListener {
    ...
    public /* synthetic */ void mo49703x4b648d14(int i, int i2, int i3, WindowContainerTransaction windowContainerTransaction) {
        int i4;
    ...
    public void addDivider(Configuration configuration) {
        ...
        DividerView dividerView = (DividerView) LayoutInflater.from(displayContext).inflate(C3343R.layout.docked_stack_divider, (ViewGroup) null);
    ...
    public /* synthetic */ void mo49705x4fee9dde(SurfaceControl.Transaction transaction) {
    ...
    public /* synthetic */ void mo49706xec5c9a3d(SurfaceControl.Transaction transaction) {
    ...
    public /* synthetic */ void mo49704xdcd70392(boolean z) {
        if (this.mVisible) {
            setHomeMinimized(z);
        }
    }
    ...
    public boolean splitPrimaryTask() {
        ...
        L_0x003c:
            ...
            int r1 = com.android.p019wm.shell.C3343R.string.dock_non_resizeble_failed_to_dock_text
    ...
    private class SplitScreenImpl implements LegacySplitScreen {
        ...
        public boolean isDividerVisible() {
            ...
            try {
                LegacySplitScreenController.this.mMainExecutor.executeBlocking(new C3478x586845ac(this, zArr));
        ...
        public /* synthetic */ void mo49732x7f0588f9(boolean[] zArr) {
            zArr[0] = LegacySplitScreenController.this.isDividerVisible();
        }

        public void onKeyguardVisibilityChanged(boolean z) {
            LegacySplitScreenController.this.mMainExecutor.execute(new C3477xb4a06fe6(this, z));
        }
        ...
        public /* synthetic */ void mo49734xc47161b8(boolean z) {
            LegacySplitScreenController.this.onKeyguardVisibilityChanged(z);
        }

        public void setMinimized(boolean z) {
            LegacySplitScreenController.this.mMainExecutor.execute(new C3476xb4a06fe5(this, z));
        }

        /* access modifiers changed from: package-private */
        /* renamed from: lambda$setMinimized$2$com-android-wm-shell-legacysplitscreen-LegacySplitScreenController$SplitScreenImpl */
        public /* synthetic */ void mo49738x5b2ad76(boolean z) {
            LegacySplitScreenController.this.setMinimized(z);
        }

        public void onUndockingTask() {
            LegacySplitScreenController.this.mMainExecutor.execute(new C3483x586845b1(this));
        }

        /* access modifiers changed from: package-private */
        /* renamed from: lambda$onUndockingTask$3$com-android-wm-shell-legacysplitscreen-LegacySplitScreenController$SplitScreenImpl */
        public /* synthetic */ void mo49735x668eb57() {
            LegacySplitScreenController.this.onUndockingTask();
        }

        public void onAppTransitionFinished() {
            LegacySplitScreenController.this.mMainExecutor.execute(new C3482x586845b0(this));
        }
        ...
        public /* synthetic */ void mo49733x5fea5da9() {
            LegacySplitScreenController.this.onAppTransitionFinished();
        }

        public void registerInSplitScreenListener(Consumer<Boolean> consumer) {
            LegacySplitScreenController.this.mMainExecutor.execute(new C3480x586845ae(this, consumer));
        }
        ...
        public /* synthetic */ void mo49737x1213837f(Consumer consumer) {
            LegacySplitScreenController.this.registerInSplitScreenListener(consumer);
        }

        public void unregisterInSplitScreenListener(Consumer<Boolean> consumer) {
            LegacySplitScreenController.this.mMainExecutor.execute(new C3485x586845b3(this, consumer));
        }
        ...
        public /* synthetic */ void mo49740x31a3e4f7(Consumer consumer) {
            LegacySplitScreenController.this.unregisterInSplitScreenListener(consumer);
        }

        public void registerBoundsChangeListener(BiConsumer<Rect, Rect> biConsumer) {
            LegacySplitScreenController.this.mMainExecutor.execute(new C3484x586845b2(this, biConsumer));
        }
        ...
        public /* synthetic */ void mo49736x31964bb9(BiConsumer biConsumer) {
        ...
        public WindowContainerToken getSecondaryRoot() {
            ...
            try {
                LegacySplitScreenController.this.mMainExecutor.executeBlocking(new C3481x586845af(this, windowContainerTokenArr));
            } catch (InterruptedException unused) {
        ...
        public /* synthetic */ void mo49731x52055634(WindowContainerToken[] windowContainerTokenArr) {
        ...
        public boolean splitPrimaryTask() {
            boolean[] zArr = new boolean[1];
            try {
                LegacySplitScreenController.this.mMainExecutor.executeBlocking(new C3479x586845ad(this, zArr));
            } catch (InterruptedException unused) {
        ...
        public /* synthetic */ void mo49739x348ebc46(boolean[] zArr) {
            zArr[0] = LegacySplitScreenController.this.splitPrimaryTask();
        }

        public void dismissSplitToPrimaryTask() {
            LegacySplitScreenController.this.mMainExecutor.execute(new C3475x586845ab(this));
        }
        ...
        public /* synthetic */ void mo49729x97619981() {
            LegacySplitScreenController.this.dismissSplitToPrimaryTask();
        }

        public void dump(PrintWriter printWriter) {
            try {
                LegacySplitScreenController.this.mMainExecutor.executeBlocking(new C3474x586845aa(this, printWriter));
            } catch (InterruptedException unused) {
        ...
        public /* synthetic */ void mo49730x8270b152(PrintWriter printWriter) {
