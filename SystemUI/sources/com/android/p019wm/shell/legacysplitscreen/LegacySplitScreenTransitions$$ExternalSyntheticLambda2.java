...
public final /* synthetic */ class LegacySplitScreenTransitions$$ExternalSyntheticLambda2 implements Runnable {
    ...
    public /* synthetic */ LegacySplitScreenTransitions$$ExternalSyntheticLambda2(LegacySplitScreenTransitions legacySplitScreenTransitions, SurfaceControl.Transaction transaction, SurfaceControl surfaceControl, Rect rect, ValueAnimator valueAnimator) {
    ...
    public final void run() {
        this.f$0.mo49761xcd682193(this.f$1, this.f$2, this.f$3, this.f$4);
    }
}
