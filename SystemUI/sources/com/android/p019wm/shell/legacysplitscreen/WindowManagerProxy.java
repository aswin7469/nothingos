...
class WindowManagerProxy {
    ...
    WindowManagerProxy(SyncTransactionQueue syncTransactionQueue, TaskOrganizer taskOrganizer) {
    ...
    static void buildDismissSplit(WindowContainerTransaction windowContainerTransaction, LegacySplitScreenTaskListener legacySplitScreenTaskListener, LegacySplitDisplayLayout legacySplitDisplayLayout, boolean z) {
        int i;
        int i2;
        ...
        rootTasks.removeIf(new WindowManagerProxy$$ExternalSyntheticLambda0(legacySplitScreenTaskListener));
    ...
    static /* synthetic */ boolean lambda$buildDismissSplit$0(LegacySplitScreenTaskListener legacySplitScreenTaskListener, ActivityManager.RunningTaskInfo runningTaskInfo) {
