...
public class PipBoundsAlgorithm {
    ...
    public Rect getDefaultBounds() {
        return getDefaultBounds(-1.0f, (Size) null);
    }
    ...
    public float getAspectRatioOrDefault(PictureInPictureParams pictureInPictureParams) {
        ...
        return pictureInPictureParams.getAspectRatioFloat();
    }
    ...
    public void getInsetBounds(Rect rect) {
        ...
        rect.set(stableInsets.left + this.mScreenEdgeInsets.x, stableInsets.top + this.mScreenEdgeInsets.y, (displayLayout.width() - stableInsets.right) - this.mScreenEdgeInsets.x, (displayLayout.height() - stableInsets.bottom) - this.mScreenEdgeInsets.y);
    }
