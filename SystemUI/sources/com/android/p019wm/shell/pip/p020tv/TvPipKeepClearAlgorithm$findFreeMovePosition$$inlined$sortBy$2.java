...
/* renamed from: com.android.wm.shell.pip.tv.TvPipKeepClearAlgorithm$findFreeMovePosition$$inlined$sortBy$2 */
/* compiled from: Comparisons.kt */
public final class TvPipKeepClearAlgorithm$findFreeMovePosition$$inlined$sortBy$2<T> implements Comparator {
    final /* synthetic */ Rect $pipAnchorBounds$inlined;
    ...
    public final int compare(T t, T t2) {
        return ComparisonsKt.compareValues(Integer.valueOf(this.this$0.candidateCost((Rect) t, this.$pipAnchorBounds$inlined)), Integer.valueOf(this.this$0.candidateCost((Rect) t2, this.$pipAnchorBounds$inlined)));
    }
}
