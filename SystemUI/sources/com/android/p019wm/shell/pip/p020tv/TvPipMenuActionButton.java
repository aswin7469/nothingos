...
public class TvPipMenuActionButton extends RelativeLayout implements View.OnClickListener {
    ...
    public TvPipMenuActionButton(Context context, AttributeSet attributeSet, int i, int i2) {
        ...
        ((LayoutInflater) getContext().getSystemService("layout_inflater")).inflate(C3343R.layout.tv_pip_menu_action_button, this);
        this.mIconImageView = (ImageView) findViewById(C3343R.C3346id.icon);
        this.mButtonView = findViewById(C3343R.C3346id.button);
        this.mButtonBackgroundView = findViewById(C3343R.C3346id.background);
    ...
    public void setIsCustomCloseAction(boolean z) {
        ...
        if (z) {
            i = C3343R.C3344color.tv_pip_menu_close_icon;
        } else {
            i = C3343R.C3344color.tv_pip_menu_icon;
        }
        imageView.setImageTintList(resources.getColorStateList(i));
        View view = this.mButtonBackgroundView;
        Resources resources2 = getResources();
        if (z) {
            i2 = C3343R.C3344color.tv_pip_menu_close_icon_bg;
        } else {
            i2 = C3343R.C3344color.tv_pip_menu_icon_bg;
        }
