...
public final /* synthetic */ class C3519xdda2519e implements Runnable {
    ...
    public /* synthetic */ C3519xdda2519e(PipAccessibilityInteractionConnection.PipAccessibilityInteractionConnectionImpl pipAccessibilityInteractionConnectionImpl, long j, int i, Bundle bundle, int i2, IAccessibilityInteractionConnectionCallback iAccessibilityInteractionConnectionCallback, int i3, int i4, long j2) {
    ...
    public final void run() {
        this.f$0.mo50311x2a817942(this.f$1, this.f$2, this.f$3, this.f$4, this.f$5, this.f$6, this.f$7, this.f$8);
    }
}
