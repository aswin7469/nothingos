...
/* renamed from: com.android.wm.shell.pip.phone.PipPinchResizingAlgorithm */
public class PipPinchResizingAlgorithm {
    ...
    public float calculateBoundsAndAngle(PointF pointF, PointF pointF2, PointF pointF3, PointF pointF4, Point point, Point point2, Rect rect, Rect rect2) {
        ...
        rect2.offset((int) (this.mTmpLastCentroid.x - this.mTmpDownCentroid.x), (int) (this.mTmpLastCentroid.y - this.mTmpDownCentroid.y));
    ...
    private float constrainRotationAngle(float f) {
        return Math.signum(f) * Math.max(0.0f, Math.abs(dampedRotate(f)) - ANGLE_THRESHOLD);
    }
    ...
    private float dampedRotate(float f) {
        ...
        return abs * OVERROTATE_DAMP_FACTOR * 45.0f;
    }
