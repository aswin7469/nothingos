            ...
            if (actionMasked != 1) {
                if (actionMasked != 2) {
                    ...
                    if (findPointerIndex == -1) {
                        ProtoLog.e(ShellProtoLogGroup.WM_SHELL_PICTURE_IN_PICTURE, "%s: Invalid active pointer id on MOVE: %d", new Object[]{TAG, Integer.valueOf(this.mActivePointerId)});
                        return;
                    }
                ...
                if (findPointerIndex2 == -1) {
                    ProtoLog.e(ShellProtoLogGroup.WM_SHELL_PICTURE_IN_PICTURE, "%s: Invalid active pointer id on UP: %d", new Object[]{TAG, Integer.valueOf(this.mActivePointerId)});
                    return;
                }
