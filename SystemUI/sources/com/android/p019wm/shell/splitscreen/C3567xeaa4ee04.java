...
public final /* synthetic */ class C3567xeaa4ee04 implements Consumer {
    ...
    public /* synthetic */ C3567xeaa4ee04(String str, String str2, int i, Bundle bundle, UserHandle userHandle) {
        this.f$0 = str;
        this.f$1 = str2;
        this.f$2 = i;
        this.f$3 = bundle;
