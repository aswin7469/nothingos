...
public final /* synthetic */ class RemoteTransitionHandler$2$$ExternalSyntheticLambda0 implements Runnable {
    public final /* synthetic */ RemoteTransitionHandler.C36242 f$0;
    ...
    public /* synthetic */ RemoteTransitionHandler$2$$ExternalSyntheticLambda0(RemoteTransitionHandler.C36242 r1, IBinder iBinder, Transitions.TransitionFinishCallback transitionFinishCallback, WindowContainerTransaction windowContainerTransaction) {
        this.f$0 = r1;
        this.f$1 = iBinder;
    ...
    public final void run() {
        this.f$0.mo51273x67d3e2ba(this.f$1, this.f$2, this.f$3);
    }
}
