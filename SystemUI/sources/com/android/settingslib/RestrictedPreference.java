...
public class RestrictedPreference extends TwoTargetPreference {
    ...
    public RestrictedPreference(Context context, AttributeSet attributeSet) {
        this(context, attributeSet, TypedArrayUtils.getAttr(context, C1757R.attr.preferenceStyle, 16842894));
    }
    ...
    public RestrictedPreference(Context context, String str, int i) {
        this(context, (AttributeSet) null, TypedArrayUtils.getAttr(context, C1757R.attr.preferenceStyle, 16842894), 0, str, i);
    }
