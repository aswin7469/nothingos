...
public class AccessibilityUtils {
    ...
    public static Set<ComponentName> getEnabledServicesFromSettings(Context context, int i) {
        ...
        TextUtils.SimpleStringSplitter<String> simpleStringSplitter = new TextUtils.SimpleStringSplitter<>(ENABLED_ACCESSIBILITY_SERVICES_SEPARATOR);
    ...
    public static String getShortcutTargetServiceComponentNameString(Context context, int i) {
        ...
        return context.getString(17039916);
    }
    ...
    private static Set<ComponentName> getInstalledServices(Context context) {
        ...
        for (AccessibilityServiceInfo resolveInfo : installedAccessibilityServiceList) {
            ...
            hashSet.add(new ComponentName(resolveInfo2.serviceInfo.packageName, resolveInfo2.serviceInfo.name));
        }
        return hashSet;
    }
}
