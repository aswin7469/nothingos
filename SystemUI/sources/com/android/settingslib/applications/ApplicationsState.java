...
public class ApplicationsState {
    ...
    public static final AppFilter FILTER_GAMES = new AppFilter() {
        ...
        public boolean filterApp(AppEntry appEntry) {
            ...
            synchronized (appEntry.info) {
                if (!ApplicationsState.hasFlag(appEntry.info.flags, QuickStepContract.SYSUI_STATE_VOICE_INTERACTION_WINDOW_SHOWING)) {
    ...
    public static final AppFilter FILTER_NOT_HIDE = new AppFilter() {
        ...
        public void init(Context context) {
            this.mHidePackageNames = context.getResources().getStringArray(17236072);
        }
    ...
    private ApplicationsState(android.app.Application r8, android.content.pm.IPackageManager r9) {
        ...
        L_0x00b5:
            ...
            java.lang.Boolean r9 = java.lang.Boolean.valueOf((boolean) r9)
            r2.put(r3, r9)
            goto L_0x00b5
        L_0x00d3:
        ...
        if (!this.mResumed) {
            ...
            for (UserInfo userInfo : this.mUm.getProfiles(UserHandle.myUserId())) {
                try {
                    ...
                    this.mApplications.addAll(this.mIpm.getInstalledApplications((long) (userInfo.isAdmin() ? this.mAdminRetrieveFlags : this.mRetrieveFlags), userInfo.id).getList());
                } catch (Exception e) {
     ...
     */
    /* Code decompiled incorrectly, please refer to instructions dump. */
    public void addPackage(java.lang.String r5, int r6) {
        /*
            r4 = this;
            android.util.SparseArray<java.util.HashMap<java.lang.String, com.android.settingslib.applications.ApplicationsState$AppEntry>> r0 = r4.mEntriesMap     // Catch:{ RemoteException -> 0x0065 }
            monitor-enter(r0)     // Catch:{ RemoteException -> 0x0065 }
            boolean r1 = r4.mResumed     // Catch:{ all -> 0x0062 }
            if (r1 != 0) goto L_0x0009
            monitor-exit(r0)     // Catch:{ all -> 0x0062 }
            return
        L_0x0009:
            int r1 = r4.indexOfApplicationInfoLocked(r5, r6)     // Catch:{ all -> 0x0062 }
            if (r1 < 0) goto L_0x0011
            monitor-exit(r0)     // Catch:{ all -> 0x0062 }
            return
        L_0x0011:
            android.content.pm.IPackageManager r1 = r4.mIpm     // Catch:{ all -> 0x0062 }
            android.os.UserManager r2 = r4.mUm     // Catch:{ all -> 0x0062 }
            boolean r2 = r2.isUserAdmin(r6)     // Catch:{ all -> 0x0062 }
            if (r2 == 0) goto L_0x001f
            int r2 = r4.mAdminRetrieveFlags     // Catch:{ all -> 0x0062 }
        L_0x001d:
            long r2 = (long) r2     // Catch:{ all -> 0x0062 }
            goto L_0x0022
        L_0x001f:
            int r2 = r4.mRetrieveFlags     // Catch:{ all -> 0x0062 }
            goto L_0x001d
        L_0x0022:
            android.content.pm.ApplicationInfo r5 = r1.getApplicationInfo(r5, r2, r6)     // Catch:{ all -> 0x0062 }
            if (r5 != 0) goto L_0x002a
            monitor-exit(r0)     // Catch:{ all -> 0x0062 }
            return
        L_0x002a:
            boolean r6 = r5.enabled     // Catch:{ all -> 0x0062 }
            r1 = 1
            if (r6 != 0) goto L_0x0038
            int r6 = r5.enabledSetting     // Catch:{ all -> 0x0062 }
            r2 = 3
            if (r6 == r2) goto L_0x0036
            monitor-exit(r0)     // Catch:{ all -> 0x0062 }
            return
        L_0x0036:
            r4.mHaveDisabledApps = r1     // Catch:{ all -> 0x0062 }
        L_0x0038:
            boolean r6 = com.android.settingslib.applications.AppUtils.isInstant(r5)     // Catch:{ all -> 0x0062 }
            if (r6 == 0) goto L_0x0040
            r4.mHaveInstantApps = r1     // Catch:{ all -> 0x0062 }
        L_0x0040:
            java.util.List<android.content.pm.ApplicationInfo> r6 = r4.mApplications     // Catch:{ all -> 0x0062 }
            r6.add(r5)     // Catch:{ all -> 0x0062 }
            com.android.settingslib.applications.ApplicationsState$BackgroundHandler r5 = r4.mBackgroundHandler     // Catch:{ all -> 0x0062 }
            r6 = 2
            boolean r5 = r5.hasMessages(r6)     // Catch:{ all -> 0x0062 }
            if (r5 != 0) goto L_0x0053
            com.android.settingslib.applications.ApplicationsState$BackgroundHandler r5 = r4.mBackgroundHandler     // Catch:{ all -> 0x0062 }
            r5.sendEmptyMessage(r6)     // Catch:{ all -> 0x0062 }
        L_0x0053:
            com.android.settingslib.applications.ApplicationsState$MainHandler r5 = r4.mMainHandler     // Catch:{ all -> 0x0062 }
            boolean r5 = r5.hasMessages(r6)     // Catch:{ all -> 0x0062 }
            if (r5 != 0) goto L_0x0060
            com.android.settingslib.applications.ApplicationsState$MainHandler r4 = r4.mMainHandler     // Catch:{ all -> 0x0062 }
            r4.sendEmptyMessage(r6)     // Catch:{ all -> 0x0062 }
        L_0x0060:
            monitor-exit(r0)     // Catch:{ all -> 0x0062 }
            goto L_0x0065
        L_0x0062:
            r4 = move-exception
            monitor-exit(r0)     // Catch:{ all -> 0x0062 }
            throw r4     // Catch:{ RemoteException -> 0x0065 }
        L_0x0065:
            return
        */
        ...
        synchronized (this.mEntriesMap) {
            ...
            if (indexOfApplicationInfoLocked >= 0) {
                ...
                if (appEntry != null) {
                    ...
                    this.mAppEntries.remove((Object) appEntry);
                }
        ...
        synchronized (this.mEntriesMap) {
            ...
            if (hashMap != null) {
                for (AppEntry appEntry : hashMap.values()) {
                    this.mAppEntries.remove((Object) appEntry);
                    this.mApplications.remove((Object) appEntry.info);
                }
    ...
    public class Session implements LifecycleObserver {
        ...
        public void onDestroy() {
            ...
            synchronized (ApplicationsState.this.mEntriesMap) {
                ApplicationsState.this.mSessions.remove((Object) this);
            }
        }
    }
    ...
    private class BackgroundHandler extends Handler {
        ...
        final IPackageStatsObserver.Stub mStatsObserver = new IPackageStatsObserver.Stub() {
            ...
            public void onGetStatsCompleted(android.content.pm.PackageStats r13, boolean r14) {
                ...
                L_0x00c4:
                    ...
                    java.lang.String r1 = r13.packageName     // Catch:{ all -> 0x0110 }
                    r2 = 4
                    android.os.Message r0 = r0.obtainMessage(r2, r1)     // Catch:{ all -> 0x0110 }
                ...
                L_0x0110:
                    ...
                    throw r12
                */
                throw new UnsupportedOperationException("Method not decompiled: com.android.settingslib.applications.ApplicationsState.BackgroundHandler.C17911.onGetStatsCompleted(android.content.pm.PackageStats, boolean):void");
            }
        };
        ...
        public void handleMessage(android.os.Message r19) {
            /*
                ...
                monitor-enter(r2)
                com.android.settingslib.applications.ApplicationsState r3 = com.android.settingslib.applications.ApplicationsState.this     // Catch:{ all -> 0x038f }
                java.util.ArrayList<com.android.settingslib.applications.ApplicationsState$Session> r3 = r3.mRebuildingSessions     // Catch:{ all -> 0x038f }
                int r3 = r3.size()     // Catch:{ all -> 0x038f }
                r4 = 0
                if (r3 <= 0) goto L_0x0025
                java.util.ArrayList r3 = new java.util.ArrayList     // Catch:{ all -> 0x038f }
                com.android.settingslib.applications.ApplicationsState r5 = com.android.settingslib.applications.ApplicationsState.this     // Catch:{ all -> 0x038f }
                java.util.ArrayList<com.android.settingslib.applications.ApplicationsState$Session> r5 = r5.mRebuildingSessions     // Catch:{ all -> 0x038f }
                r3.<init>(r5)     // Catch:{ all -> 0x038f }
                com.android.settingslib.applications.ApplicationsState r5 = com.android.settingslib.applications.ApplicationsState.this     // Catch:{ all -> 0x038f }
                java.util.ArrayList<com.android.settingslib.applications.ApplicationsState$Session> r5 = r5.mRebuildingSessions     // Catch:{ all -> 0x038f }
                r5.clear()     // Catch:{ all -> 0x038f }
                goto L_0x0026
            L_0x0025:
                r3 = r4
            L_0x0026:
            ...
            L_0x00ac:
                ...
                java.lang.Integer r5 = java.lang.Integer.valueOf((int) r14)     // Catch:{ all -> 0x011e }
            ...
            L_0x00c5:
                ...
                com.android.settingslib.applications.ApplicationsState$BackgroundHandler$$ExternalSyntheticLambda0 r3 = new com.android.settingslib.applications.ApplicationsState$BackgroundHandler$$ExternalSyntheticLambda0     // Catch:{ all -> 0x011e }
                r3.<init>(r0)     // Catch:{ all -> 0x011e }
            ...
            L_0x00f5:
                ...
                com.android.settingslib.applications.ApplicationsState r2 = com.android.settingslib.applications.ApplicationsState.this     // Catch:{ all -> 0x011e }
                com.android.settingslib.applications.ApplicationsState$MainHandler r2 = r2.mMainHandler     // Catch:{ all -> 0x011e }
                java.lang.Integer r3 = java.lang.Integer.valueOf((int) r13)     // Catch:{ all -> 0x011e }
            ...
            L_0x014b:
                ...
                java.lang.Integer r5 = java.lang.Integer.valueOf((int) r14)     // Catch:{ all -> 0x0175 }
            ...
            L_0x01c5:
                ...
                monitor-enter(r6)
                com.android.settingslib.applications.ApplicationsState r8 = com.android.settingslib.applications.ApplicationsState.this     // Catch:{ all -> 0x024c }
                android.util.SparseArray<java.util.HashMap<java.lang.String, com.android.settingslib.applications.ApplicationsState$AppEntry>> r8 = r8.mEntriesMap     // Catch:{ all -> 0x024c }
                java.lang.Object r8 = r8.valueAt(r3)     // Catch:{ all -> 0x024c }
                java.util.HashMap r8 = (java.util.HashMap) r8     // Catch:{ all -> 0x024c }
                int r10 = r5.size()     // Catch:{ all -> 0x024c }
                r15 = r13
            L_0x01f6:
                if (r15 >= r10) goto L_0x0243
                java.lang.Object r16 = r5.get(r15)     // Catch:{ all -> 0x024c }
                r13 = r16
                android.content.pm.ResolveInfo r13 = (android.content.pm.ResolveInfo) r13     // Catch:{ all -> 0x024c }
                android.content.pm.ActivityInfo r12 = r13.activityInfo     // Catch:{ all -> 0x024c }
                java.lang.String r12 = r12.packageName     // Catch:{ all -> 0x024c }
                java.lang.Object r17 = r8.get(r12)     // Catch:{ all -> 0x024c }
                r9 = r17
                com.android.settingslib.applications.ApplicationsState$AppEntry r9 = (com.android.settingslib.applications.ApplicationsState.AppEntry) r9     // Catch:{ all -> 0x024c }
                if (r9 == 0) goto L_0x021a
                r9.hasLauncherEntry = r14     // Catch:{ all -> 0x024c }
                boolean r12 = r9.launcherEntryEnabled     // Catch:{ all -> 0x024c }
                android.content.pm.ActivityInfo r13 = r13.activityInfo     // Catch:{ all -> 0x024c }
                boolean r13 = r13.enabled     // Catch:{ all -> 0x024c }
                r12 = r12 | r13
                r9.launcherEntryEnabled = r12     // Catch:{ all -> 0x024c }
                goto L_0x023c
            L_0x021a:
                java.lang.String r9 = "ApplicationsState"
                java.lang.StringBuilder r13 = new java.lang.StringBuilder     // Catch:{ all -> 0x024c }
                r13.<init>()     // Catch:{ all -> 0x024c }
                java.lang.String r14 = "Cannot find pkg: "
                java.lang.StringBuilder r13 = r13.append((java.lang.String) r14)     // Catch:{ all -> 0x024c }
                java.lang.StringBuilder r12 = r13.append((java.lang.String) r12)     // Catch:{ all -> 0x024c }
                java.lang.String r13 = " on user "
                java.lang.StringBuilder r12 = r12.append((java.lang.String) r13)     // Catch:{ all -> 0x024c }
                java.lang.StringBuilder r12 = r12.append((int) r4)     // Catch:{ all -> 0x024c }
                java.lang.String r12 = r12.toString()     // Catch:{ all -> 0x024c }
                android.util.Log.w(r9, r12)     // Catch:{ all -> 0x024c }
            L_0x023c:
                int r15 = r15 + 1
                r9 = 5
                r12 = 6
                ...
                goto L_0x01f6
            L_0x0243:
                monitor-exit(r6)     // Catch:{ all -> 0x024c }
                int r3 = r3 + 1
                r9 = 5
                r12 = 6
                r13 = 0
            ...
            L_0x0270:
                ...
                monitor-enter(r2)
                com.android.settingslib.applications.ApplicationsState r3 = com.android.settingslib.applications.ApplicationsState.this     // Catch:{ all -> 0x02c2 }
                android.util.SparseArray<java.util.HashMap<java.lang.String, com.android.settingslib.applications.ApplicationsState$AppEntry>> r3 = r3.mEntriesMap     // Catch:{ all -> 0x02c2 }
                int r3 = r3.size()     // Catch:{ all -> 0x02c2 }
                r13 = 0
            L_0x0291:
                if (r13 >= r3) goto L_0x02c0
                com.android.settingslib.applications.ApplicationsState r4 = com.android.settingslib.applications.ApplicationsState.this     // Catch:{ all -> 0x02c2 }
                android.util.SparseArray<java.util.HashMap<java.lang.String, com.android.settingslib.applications.ApplicationsState$AppEntry>> r4 = r4.mEntriesMap     // Catch:{ all -> 0x02c2 }
                java.lang.Object r4 = r4.valueAt(r13)     // Catch:{ all -> 0x02c2 }
                java.util.HashMap r4 = (java.util.HashMap) r4     // Catch:{ all -> 0x02c2 }
                java.util.Iterator r5 = r1.iterator()     // Catch:{ all -> 0x02c2 }
            L_0x02a1:
                boolean r6 = r5.hasNext()     // Catch:{ all -> 0x02c2 }
                if (r6 == 0) goto L_0x02bd
                java.lang.Object r6 = r5.next()     // Catch:{ all -> 0x02c2 }
                android.content.pm.ResolveInfo r6 = (android.content.pm.ResolveInfo) r6     // Catch:{ all -> 0x02c2 }
                android.content.pm.ActivityInfo r6 = r6.activityInfo     // Catch:{ all -> 0x02c2 }
                java.lang.String r6 = r6.packageName     // Catch:{ all -> 0x02c2 }
                java.lang.Object r6 = r4.get(r6)     // Catch:{ all -> 0x02c2 }
                com.android.settingslib.applications.ApplicationsState$AppEntry r6 = (com.android.settingslib.applications.ApplicationsState.AppEntry) r6     // Catch:{ all -> 0x02c2 }
                if (r6 == 0) goto L_0x02a1
                r7 = 1
                r6.isHomeApp = r7     // Catch:{ all -> 0x02c2 }
                goto L_0x02a1
            L_0x02bd:
                int r13 = r13 + 1
                goto L_0x0291
            ...
            L_0x02ca:
                ...
                r3 = 0
            L_0x02d1:
                com.android.settingslib.applications.ApplicationsState r4 = com.android.settingslib.applications.ApplicationsState.this     // Catch:{ all -> 0x038b }
                java.util.List<android.content.pm.ApplicationInfo> r4 = r4.mApplications     // Catch:{ all -> 0x038b }
                int r4 = r4.size()     // Catch:{ all -> 0x038b }
                if (r3 >= r4) goto L_0x036e
                r4 = 6
                if (r2 >= r4) goto L_0x036e
                boolean r4 = r0.mRunning     // Catch:{ all -> 0x038b }
                if (r4 != 0) goto L_0x02fa
                r4 = 1
                r0.mRunning = r4     // Catch:{ all -> 0x038b }
                com.android.settingslib.applications.ApplicationsState r7 = com.android.settingslib.applications.ApplicationsState.this     // Catch:{ all -> 0x038b }
                com.android.settingslib.applications.ApplicationsState$MainHandler r7 = r7.mMainHandler     // Catch:{ all -> 0x038b }
                java.lang.Integer r9 = java.lang.Integer.valueOf((int) r4)     // Catch:{ all -> 0x038b }
                r11 = 6
                android.os.Message r7 = r7.obtainMessage(r11, r9)     // Catch:{ all -> 0x038b }
                com.android.settingslib.applications.ApplicationsState r9 = com.android.settingslib.applications.ApplicationsState.this     // Catch:{ all -> 0x038b }
                com.android.settingslib.applications.ApplicationsState$MainHandler r9 = r9.mMainHandler     // Catch:{ all -> 0x038b }
                r9.sendMessage(r7)     // Catch:{ all -> 0x038b }
                goto L_0x02fb
            L_0x02fa:
                r4 = 1
            L_0x02fb:
                com.android.settingslib.applications.ApplicationsState r7 = com.android.settingslib.applications.ApplicationsState.this     // Catch:{ all -> 0x038b }
                java.util.List<android.content.pm.ApplicationInfo> r7 = r7.mApplications     // Catch:{ all -> 0x038b }
                java.lang.Object r7 = r7.get(r3)     // Catch:{ all -> 0x038b }
                android.content.pm.ApplicationInfo r7 = (android.content.pm.ApplicationInfo) r7     // Catch:{ all -> 0x038b }
                int r9 = r7.uid     // Catch:{ all -> 0x038b }
                int r9 = android.os.UserHandle.getUserId(r9)     // Catch:{ all -> 0x038b }
                com.android.settingslib.applications.ApplicationsState r11 = com.android.settingslib.applications.ApplicationsState.this     // Catch:{ all -> 0x038b }
                android.util.SparseArray<java.util.HashMap<java.lang.String, com.android.settingslib.applications.ApplicationsState$AppEntry>> r11 = r11.mEntriesMap     // Catch:{ all -> 0x038b }
                java.lang.Object r11 = r11.get(r9)     // Catch:{ all -> 0x038b }
                java.util.HashMap r11 = (java.util.HashMap) r11     // Catch:{ all -> 0x038b }
                java.lang.String r12 = r7.packageName     // Catch:{ all -> 0x038b }
                java.lang.Object r11 = r11.get(r12)     // Catch:{ all -> 0x038b }
                if (r11 != 0) goto L_0x0324
                int r2 = r2 + 1
                com.android.settingslib.applications.ApplicationsState r11 = com.android.settingslib.applications.ApplicationsState.this     // Catch:{ all -> 0x038b }
                com.android.settingslib.applications.ApplicationsState.AppEntry unused = r11.getEntryLocked(r7)     // Catch:{ all -> 0x038b }
            L_0x0324:
                if (r9 == 0) goto L_0x0369
                com.android.settingslib.applications.ApplicationsState r9 = com.android.settingslib.applications.ApplicationsState.this     // Catch:{ all -> 0x038b }
                android.util.SparseArray<java.util.HashMap<java.lang.String, com.android.settingslib.applications.ApplicationsState$AppEntry>> r9 = r9.mEntriesMap     // Catch:{ all -> 0x038b }
                r11 = 0
                int r9 = r9.indexOfKey(r11)     // Catch:{ all -> 0x038b }
                if (r9 < 0) goto L_0x0367
                com.android.settingslib.applications.ApplicationsState r9 = com.android.settingslib.applications.ApplicationsState.this     // Catch:{ all -> 0x038b }
                android.util.SparseArray<java.util.HashMap<java.lang.String, com.android.settingslib.applications.ApplicationsState$AppEntry>> r9 = r9.mEntriesMap     // Catch:{ all -> 0x038b }
                java.lang.Object r9 = r9.get(r11)     // Catch:{ all -> 0x038b }
                java.util.HashMap r9 = (java.util.HashMap) r9     // Catch:{ all -> 0x038b }
                java.lang.String r11 = r7.packageName     // Catch:{ all -> 0x038b }
                java.lang.Object r9 = r9.get(r11)     // Catch:{ all -> 0x038b }
                com.android.settingslib.applications.ApplicationsState$AppEntry r9 = (com.android.settingslib.applications.ApplicationsState.AppEntry) r9     // Catch:{ all -> 0x038b }
                if (r9 == 0) goto L_0x0369
                android.content.pm.ApplicationInfo r11 = r9.info     // Catch:{ all -> 0x038b }
                int r11 = r11.flags     // Catch:{ all -> 0x038b }
                boolean r11 = com.android.settingslib.applications.ApplicationsState.hasFlag(r11, r5)     // Catch:{ all -> 0x038b }
                ...
                java.lang.Object r11 = r11.get(r12)     // Catch:{ all -> 0x038b }
                java.util.HashMap r11 = (java.util.HashMap) r11     // Catch:{ all -> 0x038b }
                java.lang.String r7 = r7.packageName     // Catch:{ all -> 0x038b }
                r11.remove(r7)     // Catch:{ all -> 0x038b }
                com.android.settingslib.applications.ApplicationsState r7 = com.android.settingslib.applications.ApplicationsState.this     // Catch:{ all -> 0x038b }
                java.util.ArrayList<com.android.settingslib.applications.ApplicationsState$AppEntry> r7 = r7.mAppEntries     // Catch:{ all -> 0x038b }
                r7.remove((java.lang.Object) r9)     // Catch:{ all -> 0x038b }
                goto L_0x036a
            L_0x0367:
                r12 = r11
                goto L_0x036a
            ...
            L_0x036a:
                ...
                goto L_0x02d1
            L_0x036e:
                monitor-exit(r1)     // Catch:{ all -> 0x038b }
                r1 = 6
        ...
        public /* synthetic */ void mo27992x363bbbe7() {
            try {
                ...
                Log.w(ApplicationsState.TAG, "Failed to query stats: " + e);
                try {
    ...
    public static class AppEntry extends SizeInfo {
        ...
        public String getNormalizedLabel() {
            ...
            String normalize = ApplicationsState.normalize(this.label);
            this.normalizedLabel = normalize;
            return normalize;
        }
        ...
        public boolean ensureIconLocked(Context context) {
            ...
            if (this.icon == null) {
                ...
                this.mounted = false;
                this.icon = context.getDrawable(17303704);
