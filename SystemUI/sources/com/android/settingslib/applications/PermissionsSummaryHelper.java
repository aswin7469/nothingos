...
public class PermissionsSummaryHelper {
    ...
    public static void getPermissionSummary(Context context, String str, PermissionsResultCallback permissionsResultCallback) {
        ((PermissionControllerManager) context.getSystemService(PermissionControllerManager.class)).getAppPermissions(str, new PermissionsSummaryHelper$$ExternalSyntheticLambda0(permissionsResultCallback), (Handler) null);
    }
