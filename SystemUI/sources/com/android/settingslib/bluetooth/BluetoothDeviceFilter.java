...
public final class BluetoothDeviceFilter {
    ...
    private static final class AudioFilter extends ClassUuidFilter {
        ...
        public boolean matches(android.os.ParcelUuid[] r2, android.bluetooth.BluetoothClass r3) {
            ...
            L_0x0016:
                ...
                boolean r2 = com.android.settingslib.bluetooth.BluetoothDeviceFilter.doesClassMatch(r3, r0)
                if (r2 != 0) goto L_0x0024
                boolean r2 = com.android.settingslib.bluetooth.BluetoothDeviceFilter.doesClassMatch(r3, r1)
                if (r2 == 0) goto L_0x0025
            L_0x0024:
                return r0
            L_0x0025:
    ...
    private static final class TransferFilter extends ClassUuidFilter {
        ...
        public boolean matches(ParcelUuid[] parcelUuidArr, BluetoothClass bluetoothClass) {
            ...
            if (bluetoothClass == null || !BluetoothDeviceFilter.doesClassMatch(bluetoothClass, 2)) {
                return false;
            }
            return true;
        }
    ...
    private static final class PanuFilter extends ClassUuidFilter {
        ...
        public boolean matches(ParcelUuid[] parcelUuidArr, BluetoothClass bluetoothClass) {
            ...
            if (bluetoothClass == null || !BluetoothDeviceFilter.doesClassMatch(bluetoothClass, 4)) {
                return false;
            }
            return true;
        }
    ...
    private static final class NapFilter extends ClassUuidFilter {
        ...
        public boolean matches(ParcelUuid[] parcelUuidArr, BluetoothClass bluetoothClass) {
            ...
            if (bluetoothClass == null || !BluetoothDeviceFilter.doesClassMatch(bluetoothClass, 5)) {
                return false;
            }
            return true;
        }
