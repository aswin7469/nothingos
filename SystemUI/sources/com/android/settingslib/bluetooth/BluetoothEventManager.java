...
public class BluetoothEventManager {
    ...
    BluetoothEventManager(LocalBluetoothAdapter localBluetoothAdapter, CachedBluetoothDeviceManager cachedBluetoothDeviceManager, Context context, android.os.Handler handler, UserHandle userHandle) {
        ...
        try {
            obj = Class.forName("com.android.settingslib.bluetooth.BroadcastSourceInfoHandler").getDeclaredConstructor(CachedBluetoothDeviceManager.class).newInstance(cachedBluetoothDeviceManager);
    ...
    private class DeviceFoundHandler implements Handler {
        ...
        public void onReceive(Context context, Intent intent, BluetoothDevice bluetoothDevice) {
            ...
            if (findDevice == null) {
                ...
                Log.d(BluetoothEventManager.TAG, "DeviceFoundHandler created new CachedBluetoothDevice " + findDevice.getDevice().getAnonymizedAddress());
    ...
    private class BondStateChangedHandler implements Handler {
        ...
        public void onReceive(Context context, Intent intent, BluetoothDevice bluetoothDevice) {
            ...
            if (BluetoothEventManager.this.mDeviceManager.onBondStateChangedIfProcess(bluetoothDevice, intExtra)) {
                Log.d(BluetoothEventManager.TAG, "Should not update UI for the set member");
                return;
            }
            CachedBluetoothDevice findDevice = BluetoothEventManager.this.mDeviceManager.findDevice(bluetoothDevice);
            if (findDevice == null) {
            ...
            if (intExtra == 12) {
                ...
                if (intExtra2 != Integer.MIN_VALUE && intExtra2 >= 0) {
                    ...
                    Log.d(BluetoothEventManager.TAG, "Hide showing private address in UI  " + findDevice);
        ...
        private void showUnbondMessage(Context context, String str, int i) {
            ...
            if (BluetoothEventManager.DEBUG) {
                Log.d(BluetoothEventManager.TAG, "showUnbondMessage() name : " + str + ", reason : " + i);
            }
            switch (i) {
                case 1:
                    i2 = C1757R.string.bluetooth_pairing_pin_error_message;
                    break;
                case 2:
                    i2 = C1757R.string.bluetooth_pairing_rejected_error_message;
                    break;
                case 4:
                    i2 = C1757R.string.bluetooth_pairing_device_down_error_message;
                    break;
                case 5:
                case 6:
                case 7:
                case 8:
                    i2 = C1757R.string.bluetooth_pairing_error_message;
                    break;
                default:
    ...
    private class TwspBatteryLevelChangedHandler implements Handler {
        ...
        public void onReceive(Context context, Intent intent, BluetoothDevice bluetoothDevice) {
            ...
            if (findDevice != null) {
                ...
                Log.i(BluetoothEventManager.TAG, findDevice + ": mTwspBatteryState: " + findDevice.mTwspBatteryState + "mTwspBatteryLevel: " + findDevice.mTwspBatteryLevel);
                findDevice.refresh();
            }
        }
    }
    ...
    private class ActiveDeviceChangedHandler implements Handler {
        ...
        public void onReceive(Context context, Intent intent, BluetoothDevice bluetoothDevice) {
            ...
            if (Objects.equals(action, "android.bluetooth.a2dp.profile.action.ACTIVE_DEVICE_CHANGED")) {
                ...
                i = 21;
            } else if (Objects.equals(action, "android.bluetooth.action.LE_AUDIO_ACTIVE_DEVICE_CHANGED")) {
                i = 22;
            } else {
    ...
    private class A2dpCodecConfigChangedHandler implements Handler {
        ...
        public void onReceive(Context context, Intent intent, BluetoothDevice bluetoothDevice) {
            if (intent.getAction() == null) {
                Log.w(BluetoothEventManager.TAG, "A2dpCodecConfigChangedHandler: action is null");
                return;
            }
            CachedBluetoothDevice findDevice = BluetoothEventManager.this.mDeviceManager.findDevice(bluetoothDevice);
            if (findDevice == null) {
                Log.w(BluetoothEventManager.TAG, "A2dpCodecConfigChangedHandler: device is null");
                return;
            }
            BluetoothCodecStatus parcelableExtra = intent.getParcelableExtra("android.bluetooth.extra.CODEC_STATUS");
            Log.d(BluetoothEventManager.TAG, "A2dpCodecConfigChangedHandler: device=" + bluetoothDevice + ", codecStatus=" + parcelableExtra);
    ...
    private class VcpModeChangedHandler implements Handler {
        ...
        public void onReceive(Context context, Intent intent, BluetoothDevice bluetoothDevice) {
            ...
            if (findDevice != null) {
                Log.i(BluetoothEventManager.TAG, findDevice + " Vcp connection mode change to " + intExtra);
                findDevice.refresh();
            }
        }
    }
    ...
    private class VcpVolumeChangedHandler implements Handler {
        ...
        public void onReceive(Context context, Intent intent, BluetoothDevice bluetoothDevice) {
            CachedBluetoothDevice findDevice = BluetoothEventManager.this.mDeviceManager.findDevice(bluetoothDevice);
            if (findDevice != null) {
                Log.i(BluetoothEventManager.TAG, findDevice + " Vcp volume change");
                findDevice.refresh();
            }
        }
    }
    ...
    public void updateCacheDeviceInfo(int i, CachedBluetoothDevice cachedBluetoothDevice) {
        ...
        Log.d(TAG, "updateCacheDeviceInfo groupId " + i + ", cachedDevice :" + cachedBluetoothDevice + ", name :" + cachedBluetoothDevice.getName() + " isGroup :" + isGroupDevice + " qgroupId " + cachedBluetoothDevice.getQGroupId());
        if (!isGroupDevice) {
            cachedBluetoothDevice.setDeviceType(i);
        } else if (i != cachedBluetoothDevice.getQGroupId()) {
            Log.d(TAG, "groupId mismatch ignore " + cachedBluetoothDevice.getQGroupId());
        } else {
    ...
    public void updateIgnoreDeviceFlag(CachedBluetoothDevice cachedBluetoothDevice) {
        cachedBluetoothDevice.setDeviceType(101);
    }
    ...
    private class CsipGroupFoundHandler implements Handler {
        ...
        public void onReceive(Context context, Intent intent, BluetoothDevice bluetoothDevice) {
            ...
            Log.d(BluetoothEventManager.TAG, "CsipGroupFoundHandler  " + findDevice + "  " + intExtra);
            if (findDevice != null) {
