...
public class CsipDeviceManager {
    ...
    public void initCsipDeviceIfNeeded(CachedBluetoothDevice cachedBluetoothDevice) {
        ...
        if (isValidGroupId(baseGroupId)) {
            log("initCsipDeviceIfNeeded: " + cachedBluetoothDevice + " (group: " + baseGroupId + NavigationBarInflaterView.KEY_CODE_END);
    ...
    public void onGroupIdChanged(int i) {
        ...
        if (cachedBluetoothDevice != null) {
            ...
            for (CachedBluetoothDevice cachedBluetoothDevice2 : list) {
                ...
                this.mCachedDevices.remove((Object) cachedBluetoothDevice2);
    ...
    static /* synthetic */ boolean lambda$onGroupIdChanged$0(CachedBluetoothDevice cachedBluetoothDevice, int i, CachedBluetoothDevice cachedBluetoothDevice2) {
