...
public class CsipSetCoordinatorProfile implements LocalBluetoothProfile {
    ...
    private final class CoordinatedSetServiceListener implements BluetoothProfile.ServiceListener {
        ...
        public void onServiceConnected(int i, BluetoothProfile bluetoothProfile) {
            Log.d(CsipSetCoordinatorProfile.TAG, "Bluetooth service connected");
            BluetoothCsipSetCoordinator unused = CsipSetCoordinatorProfile.this.mService = (BluetoothCsipSetCoordinator) bluetoothProfile;
            ...
            while (!connectedDevices.isEmpty()) {
                ...
                if (findDevice == null) {
                    Log.d(CsipSetCoordinatorProfile.TAG, "CsipSetCoordinatorProfile found new device: " + bluetoothDevice);
            ...
            boolean unused2 = CsipSetCoordinatorProfile.this.mIsProfileReady = true;
        }

        public void onServiceDisconnected(int i) {
            Log.d(CsipSetCoordinatorProfile.TAG, "Bluetooth service disconnected");
            CsipSetCoordinatorProfile.this.mProfileManager.callServiceDisconnectedListeners();
            boolean unused = CsipSetCoordinatorProfile.this.mIsProfileReady = false;
        }
    }
    ...
    public List<BluetoothDevice> getConnectedDevices() {
        ...
        return bluetoothCsipSetCoordinator.getDevicesMatchingConnectionStates(new int[]{2, 1, 3});
    }
    ...
    public void finalize() {
        ...
        if (this.mService != null) {
            try {
                ...
                Log.w(TAG, "Error cleaning up CSIP Set Coordinator proxy", th);
            }
        }
    }
}
