...
public class SharedPreferencesLogger implements SharedPreferences {
        ...
        if (z || this.mPreferenceKeySet.contains(buildPrefKey)) {
            ...
            if (obj instanceof Long) {
                ...
                if (obj instanceof Integer) {
                    ...
                    parseInt = ((Boolean) obj).booleanValue();
    ...
    public void logPackageName(String str, String str2) {
        this.mMetricsFeature.action(0, 853, 0, (this.mTag + "/" + str) + ":" + str2, 0);
    }

    /* access modifiers changed from: private */
    public void safeLogValue(String str, String str2) {
        new AsyncPackageCheck().executeOnExecutor(AsyncTask.THREAD_POOL_EXECUTOR, new String[]{str, str2});
    }
    ...
    public class EditorLogger implements SharedPreferences.Editor {
        ...
        public SharedPreferences.Editor putStringSet(String str, Set<String> set) {
            SharedPreferencesLogger.this.safeLogValue(str, TextUtils.join(NavigationBarInflaterView.BUTTON_SEPARATOR, set));
            return this;
        }
