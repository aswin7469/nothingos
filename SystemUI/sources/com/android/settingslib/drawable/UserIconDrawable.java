...
public class UserIconDrawable extends Drawable implements Drawable.Callback {
    ...
    public UserIconDrawable setBadgeIfManagedDevice(Context context) {
        return setBadge(((DevicePolicyManager) context.getSystemService(DevicePolicyManager.class)).getDeviceOwnerComponentOnAnyUser() != null ? getManagementBadge(context) : null);
    }
    ...
    private static Drawable getUpdatableManagementBadge(Context context) {
        return ((DevicePolicyManager) context.getSystemService(DevicePolicyManager.class)).getResources().getDrawableForDensity("WORK_PROFILE_ICON", "SOLID_COLORED", context.getResources().getDisplayMetrics().densityDpi, new UserIconDrawable$$ExternalSyntheticLambda1(context));
    }
