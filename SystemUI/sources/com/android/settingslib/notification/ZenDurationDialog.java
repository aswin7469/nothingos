...
public class ZenDurationDialog {
    ...
    public void setupDialog(AlertDialog.Builder builder) {
        ...
        builder.setTitle(C1757R.string.zen_mode_duration_settings_title).setNegativeButton(C1757R.string.cancel, (DialogInterface.OnClickListener) null).setPositiveButton(C1757R.string.okay, (DialogInterface.OnClickListener) new DialogInterface.OnClickListener() {
    ...
    public View getContentView() {
        ...
        View inflate = this.mLayoutInflater.inflate(C1757R.layout.zen_mode_duration_dialog, (ViewGroup) null);
        ScrollView scrollView = (ScrollView) inflate.findViewById(C1757R.C1760id.zen_duration_container);
    ...
    public void setupRadioButtons(int i) {
        ...
        getConditionTagAt(i2).f253rb.setChecked(true);
    }
    ...
    private void bindTag(int i, View view, int i2) {
        ...
        if (conditionTag.f253rb == null) {
            conditionTag.f253rb = (RadioButton) this.mZenRadioGroup.getChildAt(i2);
        }
        if (i <= 0) {
        ...
        conditionTag.f253rb.setOnCheckedChangeListener(new CompoundButton.OnCheckedChangeListener() {
            public void onCheckedChanged(CompoundButton compoundButton, boolean z) {
                if (z) {
                    conditionTag.f253rb.setChecked(true);
                }
            }
        });
    ...
    public void updateUi(ConditionTag conditionTag, View view, int i) {
        ...
        if (i == 0) {
            str = this.mContext.getString(C1757R.string.zen_mode_forever);
        } else if (i == 1) {
            ...
            str = this.mContext.getString(C1757R.string.zen_mode_duration_always_prompt_title);
        }
