...
public class QrDecorateView extends View {
    private static final float CORNER_LINE_LENGTH = 264.0f;
    ...
    public QrDecorateView(Context context, AttributeSet attributeSet, int i, int i2) {
        ...
        this.mFocused = false;
        this.mRadius = TypedValue.applyDimension(1, CORNER_RADIUS, getResources().getDisplayMetrics());
        this.mInnerRidus = TypedValue.applyDimension(1, 12.0f, getResources().getDisplayMetrics());
        this.mCornerColor = context.getResources().getColor(C1757R.C1758color.qr_corner_line_color);
        this.mFocusedCornerColor = context.getResources().getColor(C1757R.C1758color.qr_focused_corner_line_color);
        int color = context.getResources().getColor(C1757R.C1758color.qr_background_color);
    ...
    private void calculateFramePos() {
        float applyDimension = TypedValue.applyDimension(1, CORNER_LINE_LENGTH, getResources().getDisplayMetrics()) / 2.0f;
        float applyDimension2 = TypedValue.applyDimension(1, CORNER_STROKE_WIDTH, getResources().getDisplayMetrics());
        ...
        this.mInnerFrame = new RectF(this.mOuterFrame.left + applyDimension2, this.mOuterFrame.top + applyDimension2, this.mOuterFrame.right - applyDimension2, this.mOuterFrame.bottom - applyDimension2);
    }
