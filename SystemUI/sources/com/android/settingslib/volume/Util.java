...
public class Util {
    ...
    public static String playbackStateStateToString(int i) {
        ...
        if (i != 2) {
            return i != 3 ? "UNKNOWN_" + i : "STATE_PLAYING";
        }
        return "STATE_PAUSED";
    }
    ...
    public static String volumeProviderControlToString(int i) {
        ...
        if (i != 1) {
            return i != 2 ? "VOLUME_CONTROL_UNKNOWN_" + i : "VOLUME_CONTROL_ABSOLUTE";
        }
    ...
    public static String playbackStateToString(PlaybackState playbackState) {
        ...
        return playbackStateStateToString(playbackState.getState()) + WifiEnterpriseConfig.CA_CERT_ALIAS_DELIMITER + playbackState;
    }
