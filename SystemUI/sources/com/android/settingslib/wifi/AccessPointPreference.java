...
public class AccessPointPreference extends Preference {
    ...
    private static final int[] STATE_METERED = {C1757R.attr.state_metered};
    ...
    AccessPointPreference(AccessPoint accessPoint, Context context, UserBadgeCache userBadgeCache, int i, boolean z, StateListDrawable stateListDrawable, int i2, IconInjector iconInjector) {
        ...
        this.mBadgePadding = context.getResources().getDimensionPixelSize(C1757R.dimen.wifi_preference_badge_padding);
    }

    /* access modifiers changed from: protected */
    public int getWidgetLayoutResourceId() {
        return C1757R.layout.access_point_friction_widget;
    }
    ...
    public void onBindViewHolder(PreferenceViewHolder preferenceViewHolder) {
        ...
        if (this.mAccessPoint != null) {
            ...
            bindFrictionImage((ImageView) preferenceViewHolder.findViewById(C1757R.C1760id.friction_icon));
            preferenceViewHolder.findViewById(C1757R.C1760id.two_target_divider).setVisibility(shouldShowDivider() ? 0 : 4);
        }
    }
    ...
    /* access modifiers changed from: protected */
    public void updateIcon(int i, int i2, Context context) {
        if (i == -1) {
            safeSetDefaultIcon();
            return;
        }
        TronUtils.logWifiSettingsSpeed(context, this.mWifiSpeed);
        Drawable icon = this.mIconInjector.getIcon(i, i2);
    ...
    public void refresh() {
        ...
        if (!(level == this.mLevel && speed == this.mWifiSpeed && wifiStandard == this.mWifiStandard)) {
            this.mLevel = level;
            this.mWifiSpeed = speed;
            this.mWifiStandard = wifiStandard;
            updateIcon(level, wifiStandard, context);
            notifyChanged();
        }
        updateBadge(context);
    ...
    static class IconInjector {
        ...
        public Drawable getIcon(int i, int i2) {
            return this.mContext.getDrawable(Utils.getWifiIconResource(i, i2));
        }
    }
}
