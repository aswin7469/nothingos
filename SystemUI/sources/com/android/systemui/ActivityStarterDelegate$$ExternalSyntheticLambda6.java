...
public final /* synthetic */ class ActivityStarterDelegate$$ExternalSyntheticLambda6 implements Consumer {
    ...
    public /* synthetic */ ActivityStarterDelegate$$ExternalSyntheticLambda6(Intent intent, boolean z, ActivityLaunchAnimator.Controller controller, boolean z2, UserHandle userHandle) {
        this.f$0 = intent;
        this.f$1 = z;
        this.f$2 = controller;
        this.f$3 = z2;
