...
public final class Dependency_Factory implements Factory<Dependency> {
    ...
    private final Provider<BatteryShareController> mBatteryShareControllerProvider;
    ...
    private final Provider<GlyphsController> mGlyphsControllerProvider;
    ...
    private final Provider<NothingOSHeadsupManager> mNothingOSHeadsupManagerProvider;
    ...
    private final Provider<QSStatusBarController> mQSStatusBarControllerProvider;
    ...
    public Dependency_Factory(Provider<DumpManager> provider, Provider<ActivityStarter> provider2, Provider<BroadcastDispatcher> provider3, Provider<AsyncSensorManager> provider4, Provider<BluetoothController> provider5, Provider<LocationController> provider6, Provider<RotationLockController> provider7, Provider<NetworkController> provider8, Provider<ZenModeController> provider9, Provider<HotspotController> provider10, Provider<CastController> provider11, Provider<FlashlightController> provider12, Provider<UserSwitcherController> provider13, Provider<UserInfoController> provider14, Provider<KeyguardStateController> provider15, Provider<KeyguardUpdateMonitor> provider16, Provider<BatteryController> provider17, Provider<NightDisplayListener> provider18, Provider<ReduceBrightColorsController> provider19, Provider<ManagedProfileController> provider20, Provider<NextAlarmController> provider21, Provider<DataSaverController> provider22, Provider<AccessibilityController> provider23, Provider<DeviceProvisionedController> provider24, Provider<PluginManager> provider25, Provider<AssistManager> provider26, Provider<SecurityController> provider27, Provider<LeakDetector> provider28, Provider<LeakReporter> provider29, Provider<GarbageMonitor> provider30, Provider<TunerService> provider31, Provider<NotificationShadeWindowController> provider32, Provider<StatusBarWindowController> provider33, Provider<DarkIconDispatcher> provider34, Provider<ConfigurationController> provider35, Provider<StatusBarIconController> provider36, Provider<ScreenLifecycle> provider37, Provider<WakefulnessLifecycle> provider38, Provider<FragmentService> provider39, Provider<ExtensionController> provider40, Provider<PluginDependencyProvider> provider41, Provider<LocalBluetoothManager> provider42, Provider<VolumeDialogController> provider43, Provider<MetricsLogger> provider44, Provider<AccessibilityManagerWrapper> provider45, Provider<SysuiColorExtractor> provider46, Provider<TunablePadding.TunablePaddingService> provider47, Provider<ForegroundServiceController> provider48, Provider<UiOffloadThread> provider49, Provider<PowerUI.WarningsUI> provider50, Provider<LightBarController> provider51, Provider<IWindowManager> provider52, Provider<OverviewProxyService> provider53, Provider<NavigationModeController> provider54, Provider<AccessibilityButtonModeObserver> provider55, Provider<AccessibilityButtonTargetsObserver> provider56, Provider<EnhancedEstimates> provider57, Provider<VibratorHelper> provider58, Provider<IStatusBarService> provider59, Provider<DisplayMetrics> provider60, Provider<LockscreenGestureLogger> provider61, Provider<NotificationEntryManager.KeyguardEnvironment> provider62, Provider<ShadeController> provider63, Provider<NotificationRemoteInputManager.Callback> provider64, Provider<AppOpsController> provider65, Provider<NavigationBarController> provider66, Provider<AccessibilityFloatingMenuController> provider67, Provider<StatusBarStateController> provider68, Provider<NotificationLockscreenUserManager> provider69, Provider<NotificationGroupAlertTransferHelper> provider70, Provider<NotificationGroupManagerLegacy> provider71, Provider<VisualStabilityManager> provider72, Provider<NotificationGutsManager> provider73, Provider<NotificationMediaManager> provider74, Provider<NotificationRemoteInputManager> provider75, Provider<SmartReplyConstants> provider76, Provider<NotificationListener> provider77, Provider<NotificationLogger> provider78, Provider<NotificationViewHierarchyManager> provider79, Provider<NotificationFilter> provider80, Provider<KeyguardDismissUtil> provider81, Provider<SmartReplyController> provider82, Provider<RemoteInputQuickSettingsDisabler> provider83, Provider<NotificationEntryManager> provider84, Provider<SensorPrivacyManager> provider85, Provider<AutoHideController> provider86, Provider<ForegroundServiceNotificationListener> provider87, Provider<PrivacyItemController> provider88, Provider<Looper> provider89, Provider<Handler> provider90, Provider<Looper> provider91, Provider<Handler> provider92, Provider<Handler> provider93, Provider<String> provider94, Provider<Executor> provider95, Provider<Executor> provider96, Provider<ClockManager> provider97, Provider<ActivityManagerWrapper> provider98, Provider<DevicePolicyManagerWrapper> provider99, Provider<PackageManagerWrapper> provider100, Provider<SensorPrivacyController> provider101, Provider<DockManager> provider102, Provider<INotificationManager> provider103, Provider<SysUiState> provider104, Provider<AlarmManager> provider105, Provider<KeyguardSecurityModel> provider106, Provider<DozeParameters> provider107, Provider<IWallpaperManager> provider108, Provider<CommandQueue> provider109, Provider<Recents> provider110, Provider<StatusBar> provider111, Provider<RecordingController> provider112, Provider<ProtoTracer> provider113, Provider<MediaOutputDialogFactory> provider114, Provider<DeviceConfigProxy> provider115, Provider<NavigationBarOverlayController> provider116, Provider<TelephonyListenerManager> provider117, Provider<SystemStatusAnimationScheduler> provider118, Provider<PrivacyDotViewController> provider119, Provider<EdgeBackGestureHandler.Factory> provider120, Provider<UiEventLogger> provider121, Provider<FeatureFlags> provider122, Provider<StatusBarContentInsetsProvider> provider123, Provider<InternetDialogFactory> provider124, Provider<FalsingManager> provider125, Provider<NothingOSHeadsupManager> provider126, Provider<AODController> provider127, Provider<LiftWakeGestureController> provider128, Provider<FaceRecognitionController> provider129, Provider<QSStatusBarController> provider130, Provider<KeyguardWeatherController> provider131, Provider<GlyphsController> provider132, Provider<BatteryShareController> provider133, Provider<NfcController> provider134, Provider<NTColorController> provider135, Provider<TeslaInfoController> provider136) {
        ...
        this.mInternetDialogFactoryProvider = provider124;
        this.mFalsingManagerProvider = provider125;
        this.mNothingOSHeadsupManagerProvider = provider126;
        this.mAODControllerProvider = provider127;
        this.mLiftWakeGestureControllerProvider = provider128;
        this.mFaceRecognitionControllerProvider = provider129;
        this.mQSStatusBarControllerProvider = provider130;
        this.mKeyguardWeatherControllerProvider = provider131;
        this.mGlyphsControllerProvider = provider132;
        this.mBatteryShareControllerProvider = provider133;
        this.mNfcControllerProvider = provider134;
        this.mNTColorControllerProvider = provider135;
        this.mTeslaInfoControllerProvider = provider136;
    }

    @Override // javax.inject.Provider
    /* renamed from: get */
    public Dependency mo1933get() {
        Dependency newInstance = newInstance();
        Dependency_MembersInjector.injectMDumpManager(newInstance, this.mDumpManagerProvider.mo1933get());
        ...
        Dependency_MembersInjector.injectMFalsingManager(newInstance, DoubleCheck.lazy(this.mFalsingManagerProvider));
        Dependency_MembersInjector.injectMNothingOSHeadsupManager(newInstance, DoubleCheck.lazy(this.mNothingOSHeadsupManagerProvider));
        Dependency_MembersInjector.injectMAODController(newInstance, DoubleCheck.lazy(this.mAODControllerProvider));
        Dependency_MembersInjector.injectMLiftWakeGestureController(newInstance, DoubleCheck.lazy(this.mLiftWakeGestureControllerProvider));
        Dependency_MembersInjector.injectMFaceRecognitionController(newInstance, DoubleCheck.lazy(this.mFaceRecognitionControllerProvider));
        Dependency_MembersInjector.injectMQSStatusBarController(newInstance, DoubleCheck.lazy(this.mQSStatusBarControllerProvider));
        Dependency_MembersInjector.injectMKeyguardWeatherController(newInstance, DoubleCheck.lazy(this.mKeyguardWeatherControllerProvider));
        Dependency_MembersInjector.injectMGlyphsController(newInstance, DoubleCheck.lazy(this.mGlyphsControllerProvider));
        Dependency_MembersInjector.injectMBatteryShareController(newInstance, DoubleCheck.lazy(this.mBatteryShareControllerProvider));
        Dependency_MembersInjector.injectMNfcController(newInstance, DoubleCheck.lazy(this.mNfcControllerProvider));
        Dependency_MembersInjector.injectMNTColorController(newInstance, DoubleCheck.lazy(this.mNTColorControllerProvider));
        Dependency_MembersInjector.injectMTeslaInfoController(newInstance, DoubleCheck.lazy(this.mTeslaInfoControllerProvider));
        return newInstance;
    }
