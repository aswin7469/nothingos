...
public class ExpandHelper implements Gefingerpoken {
    ...
    private static final FloatProperty<ViewScaler> VIEW_SCALER_HEIGHT_PROPERTY = new FloatProperty<ViewScaler>("ViewScalerHeight") {
    ...
    public ExpandHelper(Context context, Callback callback, int i, int i2) {
        this.mSmallSize = i;
        this.mMaximumStretch = ((float) i) * STRETCH_INTERVAL;
        this.mLargeSize = i2;
        ...
        this.mPullGestureMinXSpan = this.mContext.getResources().getDimension(C1894R.dimen.pull_span_min);
    ...
    public boolean onInterceptTouchEvent(android.view.MotionEvent r8) {
        ...
        L_0x0079:
            ...
            float r2 = java.lang.Math.abs((float) r2)
            int r0 = (r0 > r2 ? 1 : (r0 == r2 ? 0 : -1))
            if (r0 <= 0) goto L_0x010d
            r7.mWatchingForPull = r1
            com.android.systemui.statusbar.notification.row.ExpandableView r0 = r7.mResizedView
    ...
    private void finishExpanding(boolean z, float f, boolean z2) {
        ...
        if (this.mExpanding) {
            ...
            if (i2 == 0 || !this.mEnabled || !z2) {
                ...
                this.mScaleAnimation.setFloatValues(new float[]{f3});
                ...
                this.mFlingAnimationUtils.apply((Animator) this.mScaleAnimation, height, f3, f);
