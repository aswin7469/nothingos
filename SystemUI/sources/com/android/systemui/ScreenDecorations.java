...
public class ScreenDecorations extends SystemUI implements TunerService.Tunable {
    ...
    private CameraAvailabilityListener.CameraTransitionCallback mCameraTransitionCallback = new CameraAvailabilityListener.CameraTransitionCallback() { // from class: com.android.systemui.ScreenDecorations.1
        ...
        public void onApplyCameraProtection(Path path, Rect rect) {
            DisplayCutoutView[] displayCutoutViewArr;
    ...
    private void setupDecorations() {
        ...
        if (hasOverlays()) {
            ...
            this.mExecutor.execute(new Runnable() { // from class: com.android.systemui.ScreenDecorations$$ExternalSyntheticLambda3
                @Override // java.lang.Runnable
                public final void run() {
                    ScreenDecorations.this.lambda$setupDecorations$0();
                }
            });
        ...
        this.mMainExecutor.execute(new Runnable() { // from class: com.android.systemui.ScreenDecorations$$ExternalSyntheticLambda0
            @Override // java.lang.Runnable
            public final void run() {
                ScreenDecorations.this.lambda$setupDecorations$1();
            }
        });
    ...
    public void onConfigurationChanged(Configuration configuration) {
        if (DEBUG_DISABLE_SCREEN_DECORATIONS) {
            ...
            this.mExecutor.execute(new Runnable() { // from class: com.android.systemui.ScreenDecorations$$ExternalSyntheticLambda1
                @Override // java.lang.Runnable
                public final void run() {
                    ScreenDecorations.this.lambda$onConfigurationChanged$2();
                }
            });
        }
    }
    ...
    private void updateStatusBarHeight() {
        this.mStatusBarHeightLandscape = this.mContext.getResources().getDimensionPixelSize(17105527);
        int dimensionPixelSize = this.mContext.getResources().getDimensionPixelSize(17105528);
    ...
    private void updateRoundedCornerRadii() {
        int dimensionPixelSize = this.mContext.getResources().getDimensionPixelSize(17105497);
        boolean z = false;
        if (mDisableRoundedCorner == 1) {
            dimensionPixelSize = 0;
        }
        int dimensionPixelSize2 = this.mContext.getResources().getDimensionPixelSize(17105501);
        int dimensionPixelSize3 = this.mContext.getResources().getDimensionPixelSize(17105499);
        Point point = this.mRoundedDefault;
        if (point.x != dimensionPixelSize || this.mRoundedDefaultTop.x != dimensionPixelSize2 || this.mRoundedDefaultBottom.x != dimensionPixelSize3) {
            z = true;
        }
        if (z) {
    ...
    private int getRoundedCornerGravity(int i, boolean z) {
        ...
        if (boundPositionFromRotation == 0) {
            return z ? 51 : 83;
        } else if (boundPositionFromRotation == 1) {
            return z ? 51 : 53;
    ...
    private boolean shouldShowRoundedCorner(int i) {
        ...
        DisplayCutout cutout = getCutout();
        return ((cutout == null || cutout.isBoundsEmpty()) || !cutout.getBoundingRectsAll()[getBoundPositionFromRotation(1, this.mRotation)].isEmpty() || !cutout.getBoundingRectsAll()[getBoundPositionFromRotation(3, this.mRotation)].isEmpty()) ? i == 1 || i == 3 : i == 0 || i == 2;
    }
    ...
    public void onTuningChanged(final String str, final String str2) {
        if (DEBUG_DISABLE_SCREEN_DECORATIONS) {
            ...
            this.mExecutor.execute(new Runnable() { // from class: com.android.systemui.ScreenDecorations$$ExternalSyntheticLambda4
                @Override // java.lang.Runnable
                public final void run() {
                    ScreenDecorations.this.lambda$onTuningChanged$3(str, str2);
                }
            });
        }
    }
        ...
        void setShowProtection(boolean z) {
            ...
            this.mCameraProtectionAnimator.addUpdateListener(new ValueAnimator.AnimatorUpdateListener() { // from class: com.android.systemui.ScreenDecorations$DisplayCutoutView$$ExternalSyntheticLambda0
                ...
                public final void onAnimationUpdate(ValueAnimator valueAnimator2) {
                    ScreenDecorations.DisplayCutoutView.this.lambda$setShowProtection$1(valueAnimator2);
                }
            });
