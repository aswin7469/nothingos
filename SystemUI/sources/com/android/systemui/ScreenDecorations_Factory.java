...
public final class ScreenDecorations_Factory implements Factory<ScreenDecorations> {
    ...
    /* renamed from: get */
    public ScreenDecorations mo1933get() {
        return newInstance(this.contextProvider.mo1933get(), this.mainExecutorProvider.mo1933get(), this.secureSettingsProvider.mo1933get(), this.broadcastDispatcherProvider.mo1933get(), this.tunerServiceProvider.mo1933get(), this.userTrackerProvider.mo1933get(), this.dotViewControllerProvider.mo1933get(), this.threadFactoryProvider.mo1933get());
    }
