...
public class SlicePermissionActivity extends Activity implements DialogInterface.OnClickListener, DialogInterface.OnDismissListener {
    ...
    public void onCreate(Bundle bundle) {
        ...
        try {
            ...
            AlertDialog create = new AlertDialog.Builder(this).setTitle(getString(C1894R.string.slice_permission_title, new Object[]{unicodeWrap, unicodeWrap2})).setView(C1894R.layout.slice_permission_request).setNegativeButton(C1894R.string.slice_permission_deny, this).setPositiveButton(C1894R.string.slice_permission_allow, this).setOnDismissListener(this).create();
            create.getWindow().addSystemFlags(524288);
            create.show();
            ((TextView) create.getWindow().getDecorView().findViewById(C1894R.C1898id.text1)).setText(getString(C1894R.string.slice_permission_text_1, new Object[]{unicodeWrap2}));
            ((TextView) create.getWindow().getDecorView().findViewById(C1894R.C1898id.text2)).setText(getString(C1894R.string.slice_permission_text_2, new Object[]{unicodeWrap2}));
            CheckBox checkBox = (CheckBox) create.getWindow().getDecorView().findViewById(C1894R.C1898id.slice_permission_checkbox);
            this.mAllCheckbox = checkBox;
            checkBox.setText(getString(C1894R.string.slice_permission_checkbox, new Object[]{unicodeWrap}));
