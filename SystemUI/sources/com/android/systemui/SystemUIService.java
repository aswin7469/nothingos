...
public class SystemUIService extends Service {
    ...
    @Inject
    public SystemUIService(@Main Handler handler, DumpHandler dumpHandler, BroadcastDispatcher broadcastDispatcher, LogBufferFreezer logBufferFreezer, BatteryStateNotifier batteryStateNotifier) {
            ...
            if (Build.IS_DEBUGGABLE) {
                ...
                BinderInternal.setBinderProxyCountCallback(new BinderInternal.BinderProxyLimitListener() {
                    public void onLimitReached(int i) {
                        Slog.w(SystemUIApplication.TAG, "uid " + i + " sent too many Binder proxies to uid " + Process.myUid());
                    }
                }, this.mMainHandler);
            }
    ...
    public void dump(FileDescriptor fileDescriptor, PrintWriter printWriter, String[] strArr) {
        if (strArr.length == 0) {
            strArr = new String[]{DumpHandler.PRIORITY_ARG, DumpHandler.PRIORITY_ARG_CRITICAL};
        }
