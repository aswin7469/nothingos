...
public final class SystemActions_Factory implements Factory<SystemActions> {
    ...
    /* renamed from: get */
    public SystemActions mo1933get() {
        return newInstance(this.contextProvider.mo1933get(), this.notificationShadeControllerProvider.mo1933get(), DoubleCheck.lazy(this.statusBarProvider), this.recentsProvider.mo1933get());
    }
