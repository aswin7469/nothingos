...
class BaseTooltipView extends FrameLayout {
    ...
    BaseTooltipView(Context context, AccessibilityFloatingMenuView accessibilityFloatingMenuView) {
        super(context);
    ...
    private void updateArrowWith(Rect rect) {
        ...
        layoutParams.setMargins(i, 0, isAnchorViewOnLeft ? this.mArrowMargin : 0, 0);
