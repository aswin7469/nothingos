...
public class AssistManager {
    ...
    public void startAssist(Bundle bundle) {
        ...
        if (!equals || (!isVoiceSessionRunning() && shouldShowOrb())) {
            ...
            this.mOrbController.postHideDelayed(equals ? 2500L : 1000L);
        }
        if (bundle == null) {
            bundle = new Bundle();
        }
    ...
    public boolean canVoiceAssistBeLaunchedFromKeyguard() {
        return ((Boolean) DejankUtils.whitelistIpcs(new Supplier() { // from class: com.android.systemui.assist.AssistManager$$ExternalSyntheticLambda0
            ...
            public final Object get() {
                Boolean lambda$canVoiceAssistBeLaunchedFromKeyguard$0;
                lambda$canVoiceAssistBeLaunchedFromKeyguard$0 = AssistManager.this.lambda$canVoiceAssistBeLaunchedFromKeyguard$0();
                return lambda$canVoiceAssistBeLaunchedFromKeyguard$0;
            }
        })).booleanValue();
    }
