...
public final class AssistManager_Factory implements Factory<AssistManager> {
    ...
    /* renamed from: get */
    public AssistManager mo1933get() {
        return newInstance(this.controllerProvider.mo1933get(), this.contextProvider.mo1933get(), this.assistUtilsProvider.mo1933get(), this.commandQueueProvider.mo1933get(), this.phoneStateMonitorProvider.mo1933get(), this.overviewProxyServiceProvider.mo1933get(), this.configurationControllerProvider.mo1933get(), DoubleCheck.lazy(this.sysUiStateProvider), this.defaultUiControllerProvider.mo1933get(), this.assistLoggerProvider.mo1933get());
    }
