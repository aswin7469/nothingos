...
public enum AssistantInvocationEvent implements UiEventLogger.UiEventEnum {
    ...
    public static AssistantInvocationEvent[] valuesCustom() {
        AssistantInvocationEvent[] valuesCustom = values();
        AssistantInvocationEvent[] assistantInvocationEventArr = new AssistantInvocationEvent[valuesCustom.length];
        System.arraycopy(valuesCustom, 0, assistantInvocationEventArr, 0, valuesCustom.length);
        return assistantInvocationEventArr;
    }
