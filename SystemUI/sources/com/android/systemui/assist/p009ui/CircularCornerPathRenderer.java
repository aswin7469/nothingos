...
public final class CircularCornerPathRenderer extends CornerPathRenderer {
    ...
    static /* synthetic */ class C19531 {
        ...
        static final /* synthetic */ int[] f293x853e7b3e;
        ...
        static {
            ...
            L_0x0012:
                int[] r0 = f293x853e7b3e     // Catch:{ NoSuchFieldError -> 0x001d }
            ...
            L_0x001d:
                int[] r0 = f293x853e7b3e     // Catch:{ NoSuchFieldError -> 0x0028 }
            ...
            L_0x0028:
                int[] r0 = f293x853e7b3e     // Catch:{ NoSuchFieldError -> 0x0033 }
            ...
            L_0x0033:
                return
            */
            throw new UnsupportedOperationException("Method not decompiled: com.android.systemui.assist.p009ui.CircularCornerPathRenderer.C19531.<clinit>():void");
        }
    }

    public Path getCornerPath(CornerPathRenderer.Corner corner) {
        this.mPath.reset();
        int i = C19531.f293x853e7b3e[corner.ordinal()];
        if (i == 1) {
