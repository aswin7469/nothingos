...
public class PerimeterPathGuide {
    ...
    public float getBottomCornerRadiusPx() {
        return (float) this.mBottomCornerRadiusPx;
    }
    ...
    private void computeRegions() {
        ...
        while (true) {
            ...
            if (i4 < regionAttributesArr2.length) {
                RegionAttributes regionAttributes = regionAttributesArr2[i4];
                regionAttributes.normalizedLength = regionAttributes.absoluteLength / f2;
                f += this.mRegions[i4].absoluteLength;
                this.mRegions[i4].endCoordinate = f / f2;
                i4++;
            } else {
