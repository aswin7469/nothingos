...
public final class AuthBiometricFingerprintAndFaceIconController extends AuthBiometricFingerprintIconController {
    ...
    public Drawable getAnimationForTransition(int i, int i2) {
        if (i2 != 5) {
            ...
            return getContext().getDrawable(C1893R.C1895drawable.fingerprint_dialog_error_to_unlock);
        } else {
            return getContext().getDrawable(C1893R.C1895drawable.fingerprint_dialog_fp_to_unlock);
        }
    }
}
