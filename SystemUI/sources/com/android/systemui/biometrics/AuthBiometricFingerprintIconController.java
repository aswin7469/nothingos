...
@Metadata(mo64986d1 = {"\u0000:\n\u0002\u0018\u0002\n\u0002\u0018\u0002\n\u0000\n\u0002\u0018\u0002\n\u0000\n\u0002\u0018\u0002\n\u0002\b\u0002\n\u0002\u0018\u0002\n\u0000\n\u0002\u0010\b\n\u0002\b\u0002\n\u0002\u0010\r\n\u0000\n\u0002\u0010\u000b\n\u0000\n\u0002\u0010\u0002\n\u0002\b\u0002\b\u0016\u0018\u00002\u00020\u0001B\u0015\u0012\u0006\u0010\u0002\u001a\u00020\u0003\u0012\u0006\u0010\u0004\u001a\u00020\u0005¢\u0006\u0002\u0010\u0006J\u001a\u0010\u0007\u001a\u0004\u0018\u00010\b2\u0006\u0010\t\u001a\u00020\n2\u0006\u0010\u000b\u001a\u00020\nH\u0014J\u0012\u0010\f\u001a\u0004\u0018\u00010\r2\u0006\u0010\u000b\u001a\u00020\nH\u0002J\u0018\u0010\u000e\u001a\u00020\u000f2\u0006\u0010\t\u001a\u00020\n2\u0006\u0010\u000b\u001a\u00020\nH\u0014J\u0018\u0010\u0010\u001a\u00020\u00112\u0006\u0010\u0012\u001a\u00020\n2\u0006\u0010\u000b\u001a\u00020\nH\u0016¨\u0006\u0013"}, mo64987d2 = {"Lcom/android/systemui/biometrics/AuthBiometricFingerprintIconController;", "Lcom/android/systemui/biometrics/AuthIconController;", "context", "Landroid/content/Context;", "iconView", "Landroid/widget/ImageView;", "(Landroid/content/Context;Landroid/widget/ImageView;)V", "getAnimationForTransition", "Landroid/graphics/drawable/Drawable;", "oldState", "", "newState", "getIconContentDescription", "", "shouldAnimateForTransition", "", "updateIcon", "", "lastState", "SystemUI_nothingRelease"}, mo64988k = 1, mo64989mv = {1, 6, 0}, mo64991xi = 48)
...
public class AuthBiometricFingerprintIconController extends AuthIconController {
    ...
    public AuthBiometricFingerprintIconController(Context context, ImageView imageView) {
        ...
        int dimensionPixelSize = context.getResources().getDimensionPixelSize(C1893R.dimen.biometric_dialog_fingerprint_icon_size);
    ...
    private final CharSequence getIconContentDescription(int i) {
        ...
        switch (i) {
            ...
            case 5:
            case 6:
                num = Integer.valueOf((int) C1893R.string.accessibility_fingerprint_dialog_fingerprint_icon);
                break;
            case 3:
            case 4:
                num = Integer.valueOf((int) C1893R.string.biometric_dialog_try_again);
                break;
            default:
                num = null;
                break;
    ...
    public Drawable getAnimationForTransition(int i, int i2) {
        return getContext().getDrawable(C1893R.C1895drawable.nt_third_part_fp_icon);
    }
}
