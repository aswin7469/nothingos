...
public final class AuthController_Factory implements Factory<AuthController> {
    ...
    /* renamed from: get */
    public AuthController mo1933get() {
        return newInstance(this.contextProvider.mo1933get(), this.commandQueueProvider.mo1933get(), this.activityTaskManagerProvider.mo1933get(), this.windowManagerProvider.mo1933get(), this.fingerprintManagerProvider.mo1933get(), this.faceManagerProvider.mo1933get(), this.udfpsControllerFactoryProvider, this.sidefpsControllerFactoryProvider, this.displayManagerProvider.mo1933get(), this.handlerProvider.mo1933get());
    }
