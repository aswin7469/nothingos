...
public final class SidefpsController {
        ...
        if (!(fingerprintManager == null || (sensorPropertiesInternal = fingerprintManager.getSensorPropertiesInternal()) == null)) {
            ...
            if (fingerprintSensorPropertiesInternal != null) {
                ...
                fingerprintManager.setSidefpsController(new ISidefpsController.Stub(this) {
                    ...
                    public static final void m2580doShow$lambda0(SidefpsController sidefpsController) {
                    ...
                    public static final void m2581hide$lambda1(SidefpsController sidefpsController) {
                        Intrinsics.checkNotNullParameter(sidefpsController, "this$0");
    ...
    public final void createOverlayForDisplay() {
        View inflate = this.layoutInflater.inflate(C1894R.layout.sidefps_view, (ViewGroup) null, false);
        ...
        View findViewById = inflate.findViewById(C1894R.C1898id.sidefps_animation);
    ...
    public static final void m2578createOverlayForDisplay$lambda5(SidefpsController sidefpsController, View view, Display display, LottieComposition lottieComposition) {
        Intrinsics.checkNotNullParameter(sidefpsController, "this$0");
