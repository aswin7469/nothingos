...
public class SidefpsController {
    ...
    public class AnonymousClass1 extends ISidefpsController.Stub {
        ...
        public void show() {
            SidefpsController.this.mFgExecutor.execute(new Runnable() { // from class: com.android.systemui.biometrics.SidefpsController$1$$ExternalSyntheticLambda1
                ...
                public final void run() {
                    SidefpsController.AnonymousClass1.this.lambda$show$0();
                }
            });
        }
        ...
        public void hide() {
            SidefpsController.this.mFgExecutor.execute(new Runnable() { // from class: com.android.systemui.biometrics.SidefpsController$1$$ExternalSyntheticLambda0
                @Override // java.lang.Runnable
                public final void run() {
                    SidefpsController.AnonymousClass1.this.lambda$hide$1();
                }
            });
        }
    ...
    public SidefpsController(Context context, LayoutInflater layoutInflater, FingerprintManager fingerprintManager, WindowManager windowManager, DelayableExecutor delayableExecutor, DisplayManager displayManager, Handler handler) {
        ...
        this.mOrientationListener = new BiometricOrientationEventListener(context, new Function0() { // from class: com.android.systemui.biometrics.SidefpsController$$ExternalSyntheticLambda0
            ...
            public final Object mo1951invoke() {
                Unit lambda$new$0;
                lambda$new$0 = SidefpsController.this.lambda$new$0();
                return lambda$new$0;
            }
    ...
    private WindowManager.LayoutParams computeLayoutParams() {
        ...
        if (rotation == 1) {
            ...
            layoutParams2.x = (this.mDisplayHeight - i3) - i4;
            layoutParams2.y = this.mDisplayWidth - 50;
            layoutParams2.height = 50;
            layoutParams2.width = i4;
        } else {
            WindowManager.LayoutParams layoutParams3 = this.mCoreLayoutParams;
            layoutParams3.x = this.mDisplayWidth - 50;
            layoutParams3.y = i3;
