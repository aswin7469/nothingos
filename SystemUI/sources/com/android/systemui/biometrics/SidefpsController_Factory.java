...
public final class SidefpsController_Factory implements Factory<SidefpsController> {
    ...
    /* renamed from: get */
    public SidefpsController mo1933get() {
        return newInstance(this.contextProvider.mo1933get(), this.inflaterProvider.mo1933get(), this.fingerprintManagerProvider.mo1933get(), this.windowManagerProvider.mo1933get(), this.fgExecutorProvider.mo1933get(), this.displayManagerProvider.mo1933get(), this.handlerProvider.mo1933get());
    }
