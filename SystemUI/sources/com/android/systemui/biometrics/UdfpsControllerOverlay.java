...
public final class UdfpsControllerOverlay {
    ...
    public final boolean show(UdfpsController udfpsController, UdfpsOverlayParams udfpsOverlayParams) {
        ...
        if (this.overlayView == null) {
            ...
            try {
                View inflate = this.inflater.inflate(C1893R.layout.udfps_view, (ViewGroup) null, false);
                if (inflate != null) {
    ...
    public static final void m2586show$lambda4$lambda3(UdfpsControllerOverlay udfpsControllerOverlay, UdfpsView udfpsView, boolean z) {
    ...
    public static final boolean m2587show$lambda4$lambda3$lambda1(UdfpsControllerOverlay udfpsControllerOverlay, View view, MotionEvent motionEvent) {
        Intrinsics.checkNotNullParameter(udfpsControllerOverlay, "this$0");
    ...
    public static final boolean m2588show$lambda4$lambda3$lambda2(UdfpsControllerOverlay udfpsControllerOverlay, View view, MotionEvent motionEvent) {
        Intrinsics.checkNotNullParameter(udfpsControllerOverlay, "this$0");
        Function3<View, MotionEvent, Boolean, Boolean> function3 = udfpsControllerOverlay.onTouch;
        Intrinsics.checkNotNullExpressionValue(view, DateFormat.ABBR_GENERIC_TZ);
        Intrinsics.checkNotNullExpressionValue(motionEvent, NotificationCompat.CATEGORY_EVENT);
    ...
    public final UdfpsAnimationViewController<?> inflateUdfpsAnimation(UdfpsView udfpsView, UdfpsController udfpsController) {
        ...
        switch (this.requestReason) {
            case 1:
            case 2:
                View inflate = this.inflater.inflate(C1893R.layout.udfps_enroll_view, (ViewGroup) null);
                if (inflate != null) {
            ...
            case 3:
                View inflate2 = this.inflater.inflate(C1893R.layout.udfps_bp_view, (ViewGroup) null);
                if (inflate2 != null) {
            ...
            case 4:
                View inflate3 = this.inflater.inflate(C1893R.layout.udfps_keyguard_view, (ViewGroup) null);
                if (inflate3 != null) {
            ...
            case 5:
            case 6:
                View inflate4 = this.inflater.inflate(C1893R.layout.udfps_fpm_other_view, (ViewGroup) null);
                if (inflate4 != null) {
    ...
    public final void onTouchOutsideOfSensorArea(float f, float f2, float f3, float f4, int i) {
        if (this.touchExplorationEnabled) {
            String[] stringArray = this.context.getResources().getStringArray(C1893R.array.udfps_accessibility_touch_hints);
    ...
    private final WindowManager.LayoutParams updateDimensions(WindowManager.LayoutParams layoutParams, UdfpsAnimationViewController<?> udfpsAnimationViewController) {
        ...
        NTLogUtil.m1682i("UdfpsControllerOverlay", "computeLayoutParams sensorBounds=" + this.overlayParams.getSensorBounds() + ", padding=" + paddingX);
    ...
    public final void onDozingChanged(boolean z) {
        if (z) {
            NTLogUtil.m1682i("UdfpsControllerOverlay", "onDozingChanged update icon Alpha");
            UdfpsAnimationViewController<?> animationViewController = getAnimationViewController();
            if (animationViewController != null) {
