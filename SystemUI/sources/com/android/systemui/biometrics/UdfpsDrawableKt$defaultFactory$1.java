...
@Metadata(mo65042d1 = {"\u0000\u000e\n\u0000\n\u0002\u0018\u0002\n\u0000\n\u0002\u0018\u0002\n\u0000\u0010\u0000\u001a\u00020\u00012\u0006\u0010\u0002\u001a\u00020\u0003H\n¢\u0006\u0002\b\u0004"}, mo65043d2 = {"<anonymous>", "Landroid/graphics/drawable/ShapeDrawable;", "context", "Landroid/content/Context;", "invoke"}, mo65044k = 3, mo65045mv = {1, 6, 0}, mo65047xi = 48)
...
final class UdfpsDrawableKt$defaultFactory$1 extends Lambda implements Function1<Context, ShapeDrawable> {
    ...
    public final ShapeDrawable invoke(Context context) {
        ...
        ShapeDrawable shapeDrawable = new ShapeDrawable(new PathShape(PathParser.createPathFromPathData(context.getResources().getString(C1894R.string.config_udfpsIcon)), 72.0f, 72.0f));
