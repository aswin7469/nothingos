...
public class UdfpsKeyguardView extends UdfpsAnimationView {
    ...
    private LottieAnimationView mNTLockScreenFp;
    ...
    protected void onFinishInflate() {
        ...
        this.mLockScreenFp.setVisibility(8);
        this.mBgProtection.setVisibility(8);
        this.mAodFp.setVisibility(8);
        this.mNTLockScreenFp = (LottieAnimationView) findViewById(R$id.nt_udfps_lockscreen_fp);
        updateColor();
        this.mLockScreenFp.addValueCallback(new KeyPath("**"), (KeyPath) LottieProperty.COLOR_FILTER, (SimpleLottieValueCallback<KeyPath>) new SimpleLottieValueCallback() { // from class: com.android.systemui.biometrics.UdfpsKeyguardView$$ExternalSyntheticLambda0
            ...
            public final Object getValue(LottieFrameInfo lottieFrameInfo) {
                ColorFilter lambda$onFinishInflate$0;
                lambda$onFinishInflate$0 = UdfpsKeyguardView.this.lambda$onFinishInflate$0(lottieFrameInfo);
    ...
    public int updateAlpha() {
        ...
        Log.d("UdfpsKeyguardView", "updateAlpha: alpha = " + updateAlpha);
    ...
    @Override // com.android.systemui.biometrics.UdfpsAnimationView
    int calculateAlpha() {
        Log.d("UdfpsKeyguardView", "calculateAlpha: mpauseAuth = " + this.mPauseAuth);
        if (this.mPauseAuth) {
            return 0;
        }
        return this.mAlpha;
    ...
    public void startFpsBreatheAnim() {
        ...
        Log.i("UdfpsKeyguardView", "startFpsBreatheAnim");
    ...
    public void stopFpsBreatheAnim() {
        ...
        Log.i("UdfpsKeyguardView", "stopFpsBreatheAnim");
