...
final class BroadcastDispatcherLogger$logClearedAfterRemoval$2 extends Lambda implements Function1<LogMessage, String> {
    ...
    BroadcastDispatcherLogger$logClearedAfterRemoval$2() {
        super(1);
    }
