...
public final /* synthetic */ class ClipboardOverlayController$$ExternalSyntheticLambda5 implements View.OnClickListener {
    ...
    public /* synthetic */ ClipboardOverlayController$$ExternalSyntheticLambda5(ClipboardOverlayController clipboardOverlayController, ClipData clipData) {
        this.f$0 = clipboardOverlayController;
        this.f$1 = clipData;
    }

    public final void onClick(View view) {
        this.f$0.mo31308x4377dcc8(this.f$1, view);
    }
}
