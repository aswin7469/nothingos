...
public class ControlsBindingControllerImpl implements ControlsBindingController {
    ...
    public static final void m2607onComponentRemoved$lambda2(ControlsBindingControllerImpl controlsBindingControllerImpl, ComponentName componentName) {
    ...
    @Metadata(mo65042d1 = {"\u0000(\n\u0002\u0018\u0002\n\u0002\u0018\u0002\n\u0002\u0018\u0002\n\u0000\n\u0002\u0018\u0002\n\u0000\n\u0002\u0010\u000e\n\u0000\n\u0002\u0018\u0002\n\u0002\b\u0006\n\u0002\u0010\u0002\n\u0000\b\u0004\u0018\u00002\u00060\u0001R\u00020\u0002B\u001d\u0012\u0006\u0010\u0003\u001a\u00020\u0004\u0012\u0006\u0010\u0005\u001a\u00020\u0006\u0012\u0006\u0010\u0007\u001a\u00020\b¢\u0006\u0002\u0010\tJ\b\u0010\u000e\u001a\u00020\u000fH\u0016R\u0011\u0010\u0007\u001a\u00020\b¢\u0006\b\n\u0000\u001a\u0004\b\n\u0010\u000bR\u0011\u0010\u0005\u001a\u00020\u0006¢\u0006\b\n\u0000\u001a\u0004\b\f\u0010\r¨\u0006\u0010"}, mo65043d2 = {"Lcom/android/systemui/controls/controller/ControlsBindingControllerImpl$OnLoadErrorRunnable;", "Lcom/android/systemui/controls/controller/ControlsBindingControllerImpl$CallbackRunnable;", "Lcom/android/systemui/controls/controller/ControlsBindingControllerImpl;", "token", "Landroid/os/IBinder;", "error", "", "callback", "Lcom/android/systemui/controls/controller/ControlsBindingController$LoadCallback;", "(Lcom/android/systemui/controls/controller/ControlsBindingControllerImpl;Landroid/os/IBinder;Ljava/lang/String;Lcom/android/systemui/controls/controller/ControlsBindingController$LoadCallback;)V", "getCallback", "()Lcom/android/systemui/controls/controller/ControlsBindingController$LoadCallback;", "getError", "()Ljava/lang/String;", "doRun", "", "SystemUI_nothingRelease"}, mo65044k = 1, mo65045mv = {1, 6, 0}, mo65047xi = 48)
    /* compiled from: ControlsBindingControllerImpl.kt */
    ...
    private final class LoadSubscriber extends IControlsSubscriber.Stub {
        ...
        public final Runnable loadCancel() {
            return new C2024x1b4f6956(this);
        }

        /* access modifiers changed from: private */
        /* renamed from: loadCancel$lambda-1  reason: not valid java name */
        public static final void m2610loadCancel$lambda1(LoadSubscriber loadSubscriber) {
        ...
        public void onNext(IBinder iBinder, Control control) {
            ...
            this.this$0.backgroundExecutor.execute(new C2026x1b4f6958(this, control, this.this$0, iBinder));
        }

        /* access modifiers changed from: private */
        /* renamed from: onNext$lambda-2  reason: not valid java name */
        public static final void m2612onNext$lambda2(LoadSubscriber loadSubscriber, Control control, ControlsBindingControllerImpl controlsBindingControllerImpl, IBinder iBinder) {
            Intrinsics.checkNotNullParameter(loadSubscriber, "this$0");
            Intrinsics.checkNotNullParameter(control, "$c");
        ...
        private final void maybeTerminateAndRun(Runnable runnable) {
            if (!this.isTerminated.get()) {
                this._loadCancelInternal = C2027x5cb900b7.INSTANCE;
                ...
                this.this$0.backgroundExecutor.execute(new C2025x1b4f6957(this, runnable));
            }
        }

        /* access modifiers changed from: private */
        /* renamed from: maybeTerminateAndRun$lambda-3  reason: not valid java name */
        public static final void m2611maybeTerminateAndRun$lambda3(LoadSubscriber loadSubscriber, Runnable runnable) {
            Intrinsics.checkNotNullParameter(loadSubscriber, "this$0");
