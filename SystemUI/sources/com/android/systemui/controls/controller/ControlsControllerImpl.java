...
public final class ControlsControllerImpl implements Dumpable, ControlsController {
    ...
    @Metadata(mo65042d1 = {"\u0000 \n\u0002\u0018\u0002\n\u0002\u0010\u0000\n\u0002\b\u0002\n\u0002\u0010\b\n\u0000\n\u0002\u0010\u000e\n\u0002\b\u0003\n\u0002\u0010\t\n\u0000\b\u0003\u0018\u00002\u00020\u0001B\u0007\b\u0002¢\u0006\u0002\u0010\u0002R\u000e\u0010\u0003\u001a\u00020\u0004XT¢\u0006\u0002\n\u0000R\u000e\u0010\u0005\u001a\u00020\u0006XT¢\u0006\u0002\n\u0000R\u000e\u0010\u0007\u001a\u00020\u0004XT¢\u0006\u0002\n\u0000R\u000e\u0010\b\u001a\u00020\u0006XT¢\u0006\u0002\n\u0000R\u000e\u0010\t\u001a\u00020\nXT¢\u0006\u0002\n\u0000¨\u0006\u000b"}, mo65043d2 = {"Lcom/android/systemui/controls/controller/ControlsControllerImpl$Companion;", "", "()V", "DEFAULT_ENABLED", "", "PERMISSION_SELF", "", "SUGGESTED_CONTROLS_PER_STRUCTURE", "TAG", "USER_CHANGE_RETRY_DELAY", "", "SystemUI_nothingRelease"}, mo65044k = 1, mo65045mv = {1, 6, 0}, mo65047xi = 48)
    /* compiled from: ControlsControllerImpl.kt */
    ...
    public static final ControlsFavoritePersistenceWrapper m2616_init_$lambda0(ControlsControllerImpl controlsControllerImpl) {
    ...
    public static final void m2619loadForComponent$lambda1(ControlsControllerImpl controlsControllerImpl, ComponentName componentName, Consumer consumer, Consumer consumer2) {
        Intrinsics.checkNotNullParameter(controlsControllerImpl, "this$0");
    ...
    public static final void m2618addSeedingFavoritesCallback$lambda2(ControlsControllerImpl controlsControllerImpl, Consumer consumer) {
        Intrinsics.checkNotNullParameter(controlsControllerImpl, "this$0");
        Intrinsics.checkNotNullParameter(consumer, "$callback");
    ...
    public static final void m2622seedFavoritesForComponents$lambda3(ControlsControllerImpl controlsControllerImpl, List list, Consumer consumer) {
        Intrinsics.checkNotNullParameter(controlsControllerImpl, "this$0");
        Intrinsics.checkNotNullParameter(list, "$componentNames");
        Intrinsics.checkNotNullParameter(consumer, "$callback");
    ...
    public static final void m2617addFavorite$lambda8(ComponentName componentName, CharSequence charSequence, ControlInfo controlInfo, ControlsControllerImpl controlsControllerImpl) {
        Intrinsics.checkNotNullParameter(componentName, "$componentName");
        Intrinsics.checkNotNullParameter(charSequence, "$structureName");
        Intrinsics.checkNotNullParameter(controlInfo, "$controlInfo");
        Intrinsics.checkNotNullParameter(controlsControllerImpl, "this$0");
    ...
    public static final void m2621replaceFavoritesForStructure$lambda9(StructureInfo structureInfo, ControlsControllerImpl controlsControllerImpl) {
        Intrinsics.checkNotNullParameter(structureInfo, "$structureInfo");
        Intrinsics.checkNotNullParameter(controlsControllerImpl, "this$0");
    ...
    public static final void m2620refreshStatus$lambda10(ComponentName componentName, Control control, ControlsControllerImpl controlsControllerImpl) {
        Intrinsics.checkNotNullParameter(componentName, "$componentName");
        Intrinsics.checkNotNullParameter(control, "$control");
        Intrinsics.checkNotNullParameter(controlsControllerImpl, "this$0");
