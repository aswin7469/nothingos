...
public final class ControlsComponent {
    ...
    @Metadata(mo64986d1 = {"\u0000\f\n\u0002\u0018\u0002\n\u0002\u0010\u0010\n\u0002\b\u0005\b\u0001\u0018\u00002\b\u0012\u0004\u0012\u00020\u00000\u0001B\u0007\b\u0002¢\u0006\u0002\u0010\u0002j\u0002\b\u0003j\u0002\b\u0004j\u0002\b\u0005¨\u0006\u0006"}, mo64987d2 = {"Lcom/android/systemui/controls/dagger/ControlsComponent$Visibility;", "", "(Ljava/lang/String;I)V", "AVAILABLE", "AVAILABLE_AFTER_UNLOCK", "UNAVAILABLE", "SystemUI_nothingRelease"}, mo64988k = 1, mo64989mv = {1, 6, 0}, mo64991xi = 48)
    /* compiled from: ControlsComponent.kt */
    ...
    public final Optional<ControlsController> getControlsController() {
        ...
        if (this.featureEnabled) {
            optional = Optional.m1745of(this.lazyControlsController.get());
    ...
    public final Optional<ControlsUiController> getControlsUiController() {
        ...
        String str;
        if (this.featureEnabled) {
            optional = Optional.m1745of(this.lazyControlsUiController.get());
    ...
    public final Optional<ControlsListingController> getControlsListingController() {
        if (this.featureEnabled) {
            Optional<ControlsListingController> of = Optional.m1745of(this.lazyControlsListingController.get());
