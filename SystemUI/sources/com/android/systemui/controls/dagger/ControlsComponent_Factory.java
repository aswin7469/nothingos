...
public final class ControlsComponent_Factory implements Factory<ControlsComponent> {
    ...
    /* renamed from: get */
    public ControlsComponent mo1933get() {
        return newInstance(this.featureEnabledProvider.mo1933get().booleanValue(), this.contextProvider.mo1933get(), DoubleCheck.lazy(this.controlsControllerProvider), DoubleCheck.lazy(this.controlsUiControllerProvider), DoubleCheck.lazy(this.controlsListingControllerProvider), this.lockPatternUtilsProvider.mo1933get(), this.keyguardStateControllerProvider.mo1933get(), this.userTrackerProvider.mo1933get(), this.secureSettingsProvider.mo1933get());
    }
