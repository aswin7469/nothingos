...
public final class ControlsComponent_Factory implements Factory<ControlsComponent> {
    ...
    public static ControlsComponent newInstance(boolean z, Context context, Lazy<ControlsController> lazy, Lazy<ControlsUiController> lazy2, Lazy<ControlsListingController> lazy3, LockPatternUtils lockPatternUtils, KeyguardStateController keyguardStateController, UserTracker userTracker, SecureSettings secureSettings, Optional<ControlsTileResourceConfiguration> optional) {
        return new ControlsComponent(z, context, lazy, lazy2, lazy3, lockPatternUtils, keyguardStateController, userTracker, secureSettings, optional);
    }
}
