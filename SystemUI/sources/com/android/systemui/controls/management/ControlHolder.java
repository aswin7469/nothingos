...
@Metadata(mo65042d1 = {"\u0000v\n\u0002\u0018\u0002\n\u0002\u0018\u0002\n\u0000\n\u0002\u0018\u0002\n\u0000\n\u0002\u0018\u0002\n\u0000\n\u0002\u0018\u0002\n\u0002\u0010\u000e\n\u0002\u0010\u000b\n\u0002\u0010\u0002\n\u0002\u0018\u0002\n\u0002\b\u0002\n\u0002\u0018\u0002\n\u0000\n\u0002\u0018\u0002\n\u0002\b\u0005\n\u0002\u0018\u0002\n\u0002\b\u0004\n\u0002\u0018\u0002\n\u0002\b\u0004\n\u0002\u0018\u0002\n\u0000\n\u0002\u0018\u0002\n\u0002\b\u0002\n\u0002\u0018\u0002\n\u0002\b\u0002\n\u0002\u0018\u0002\n\u0000\n\u0002\u0010\b\n\u0000\n\u0002\u0010\r\n\u0002\b\u0002\b\u0000\u0018\u00002\u00020\u0001B5\u0012\u0006\u0010\u0002\u001a\u00020\u0003\u0012\b\u0010\u0004\u001a\u0004\u0018\u00010\u0005\u0012\u001c\u0010\u0006\u001a\u0018\u0012\u0004\u0012\u00020\b\u0012\u0004\u0012\u00020\t\u0012\u0004\u0012\u00020\n0\u0007j\u0002`\u000b¢\u0006\u0002\u0010\fJ\u0018\u0010\u001e\u001a\u00020\n2\u0006\u0010\u001f\u001a\u00020 2\u0006\u0010!\u001a\u00020\"H\u0002J\u0010\u0010#\u001a\u00020\n2\u0006\u0010$\u001a\u00020%H\u0016J\u0018\u0010&\u001a\u00020 2\u0006\u0010'\u001a\u00020(2\u0006\u0010)\u001a\u00020*H\u0002J\u0012\u0010+\u001a\u0004\u0018\u00010,2\u0006\u0010\u000f\u001a\u00020\tH\u0002J\u0010\u0010-\u001a\u00020\n2\u0006\u0010\u000f\u001a\u00020\tH\u0016R\u000e\u0010\r\u001a\u00020\u000eX\u0004¢\u0006\u0002\n\u0000R\u000e\u0010\u000f\u001a\u00020\u0010X\u0004¢\u0006\u0002\n\u0000R'\u0010\u0006\u001a\u0018\u0012\u0004\u0012\u00020\b\u0012\u0004\u0012\u00020\t\u0012\u0004\u0012\u00020\n0\u0007j\u0002`\u000b¢\u0006\b\n\u0000\u001a\u0004\b\u0011\u0010\u0012R\u0016\u0010\u0013\u001a\n \u0014*\u0004\u0018\u00010\b0\bX\u0004¢\u0006\u0002\n\u0000R\u000e\u0010\u0015\u001a\u00020\u0016X\u0004¢\u0006\u0002\n\u0000R\u0013\u0010\u0004\u001a\u0004\u0018\u00010\u0005¢\u0006\b\n\u0000\u001a\u0004\b\u0017\u0010\u0018R\u0016\u0010\u0019\u001a\n \u0014*\u0004\u0018\u00010\b0\bX\u0004¢\u0006\u0002\n\u0000R\u000e\u0010\u001a\u001a\u00020\u001bX\u0004¢\u0006\u0002\n\u0000R\u000e\u0010\u001c\u001a\u00020\u001bX\u0004¢\u0006\u0002\n\u0000R\u000e\u0010\u001d\u001a\u00020\u001bX\u0004¢\u0006\u0002\n\u0000¨\u0006."}, mo65043d2 = {"Lcom/android/systemui/controls/management/ControlHolder;", "Lcom/android/systemui/controls/management/Holder;", "view", "Landroid/view/View;", "moveHelper", "Lcom/android/systemui/controls/management/ControlsModel$MoveHelper;", "favoriteCallback", "Lkotlin/Function2;", "", "", "", "Lcom/android/systemui/controls/management/ModelFavoriteChanger;", "(Landroid/view/View;Lcom/android/systemui/controls/management/ControlsModel$MoveHelper;Lkotlin/jvm/functions/Function2;)V", "accessibilityDelegate", "Lcom/android/systemui/controls/management/ControlHolderAccessibilityDelegate;", "favorite", "Landroid/widget/CheckBox;", "getFavoriteCallback", "()Lkotlin/jvm/functions/Function2;", "favoriteStateDescription", "kotlin.jvm.PlatformType", "icon", "Landroid/widget/ImageView;", "getMoveHelper", "()Lcom/android/systemui/controls/management/ControlsModel$MoveHelper;", "notFavoriteStateDescription", "removed", "Landroid/widget/TextView;", "subtitle", "title", "applyRenderInfo", "ri", "Lcom/android/systemui/controls/ui/RenderInfo;", "ci", "Lcom/android/systemui/controls/ControlInterface;", "bindData", "wrapper", "Lcom/android/systemui/controls/management/ElementWrapper;", "getRenderInfo", "component", "Landroid/content/ComponentName;", "deviceType", "", "stateDescription", "", "updateFavorite", "SystemUI_nothingRelease"}, mo65044k = 1, mo65045mv = {1, 6, 0}, mo65047xi = 48)
...
public final class ControlHolder extends Holder {
    ...
    private final String favoriteStateDescription = this.itemView.getContext().getString(C1894R.string.accessibility_control_favorite);
    private final ImageView icon;
    private final ControlsModel.MoveHelper moveHelper;
    private final String notFavoriteStateDescription = this.itemView.getContext().getString(C1894R.string.accessibility_control_not_favorite);
    ...
    public ControlHolder(View view, ControlsModel.MoveHelper moveHelper2, Function2<? super String, ? super Boolean, Unit> function2) {
        ...
        View requireViewById = this.itemView.requireViewById(C1894R.C1898id.icon);
        ...
        View requireViewById2 = this.itemView.requireViewById(C1894R.C1898id.title);
        ...
        View requireViewById3 = this.itemView.requireViewById(C1894R.C1898id.subtitle);
        ...
        View requireViewById4 = this.itemView.requireViewById(C1894R.C1898id.status);
        ...
        View requireViewById5 = this.itemView.requireViewById(C1894R.C1898id.favorite);
    ...
    public final CharSequence stateDescription(boolean z) {
        ...
        return this.itemView.getContext().getString(C1894R.string.accessibility_control_favorite_position, new Object[]{Integer.valueOf(getLayoutPosition() + 1)});
    }
    ...
    public void bindData(ElementWrapper elementWrapper) {
        ...
        this.removed.setText(controlInterface.getRemoved() ? this.itemView.getContext().getText(C1894R.string.controls_removed) : "");
    ...
    public static final void m2641bindData$lambda1(ControlHolder controlHolder, ElementWrapper elementWrapper, View view) {
