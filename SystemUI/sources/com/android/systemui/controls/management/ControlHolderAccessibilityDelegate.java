...
final class ControlHolderAccessibilityDelegate extends AccessibilityDelegateCompat {
    ...
    @Metadata(mo64986d1 = {"\u0000\u0014\n\u0002\u0018\u0002\n\u0002\u0010\u0000\n\u0002\b\u0002\n\u0002\u0010\b\n\u0002\b\u0002\b\u0003\u0018\u00002\u00020\u0001B\u0007\b\u0002¢\u0006\u0002\u0010\u0002R\u000e\u0010\u0003\u001a\u00020\u0004XD¢\u0006\u0002\n\u0000R\u000e\u0010\u0005\u001a\u00020\u0004XD¢\u0006\u0002\n\u0000¨\u0006\u0006"}, mo64987d2 = {"Lcom/android/systemui/controls/management/ControlHolderAccessibilityDelegate$Companion;", "", "()V", "MOVE_AFTER_ID", "", "MOVE_BEFORE_ID", "SystemUI_nothingRelease"}, mo64988k = 1, mo64989mv = {1, 6, 0}, mo64991xi = 48)
    /* compiled from: ControlAdapter.kt */
    ...
    private final void addClickAction(View view, AccessibilityNodeInfoCompat accessibilityNodeInfoCompat) {
        String str;
        if (this.isFavorite) {
            str = view.getContext().getString(C1893R.string.accessibility_control_change_unfavorite);
        } else {
            str = view.getContext().getString(C1893R.string.accessibility_control_change_favorite);
        }
    ...
    private final void maybeAddMoveBeforeAction(View view, AccessibilityNodeInfoCompat accessibilityNodeInfoCompat) {
        ...
        if (moveHelper2 != null ? moveHelper2.canMoveBefore(this.positionRetriever.invoke().intValue()) : false) {
            accessibilityNodeInfoCompat.addAction(new AccessibilityNodeInfoCompat.AccessibilityActionCompat(MOVE_BEFORE_ID, view.getContext().getString(C1893R.string.accessibility_control_move, new Object[]{Integer.valueOf((this.positionRetriever.invoke().intValue() + 1) - 1)})));
    ...
    private final void maybeAddMoveAfterAction(View view, AccessibilityNodeInfoCompat accessibilityNodeInfoCompat) {
        ...
        if (moveHelper2 != null ? moveHelper2.canMoveAfter(this.positionRetriever.invoke().intValue()) : false) {
            accessibilityNodeInfoCompat.addAction(new AccessibilityNodeInfoCompat.AccessibilityActionCompat(MOVE_AFTER_ID, view.getContext().getString(C1893R.string.accessibility_control_move, new Object[]{Integer.valueOf(this.positionRetriever.invoke().intValue() + 1 + 1)})));
            accessibilityNodeInfoCompat.setContextClickable(true);
        }
    }
}
