...
public final class ControlsListingControllerImpl implements ControlsListingController {
    ...
    public ControlsListingControllerImpl(Context context2, Executor executor, UserTracker userTracker) {
        this(context2, executor, C20331.INSTANCE, userTracker);
        Intrinsics.checkNotNullParameter(context2, "context");
        Intrinsics.checkNotNullParameter(executor, "executor");
        Intrinsics.checkNotNullParameter(userTracker, "userTracker");
    }

    @Metadata(mo64986d1 = {"\u0000\u0012\n\u0002\u0018\u0002\n\u0002\u0010\u0000\n\u0002\b\u0002\n\u0002\u0010\u000e\n\u0000\b\u0003\u0018\u00002\u00020\u0001B\u0007\b\u0002¢\u0006\u0002\u0010\u0002R\u000e\u0010\u0003\u001a\u00020\u0004XT¢\u0006\u0002\n\u0000¨\u0006\u0005"}, mo64987d2 = {"Lcom/android/systemui/controls/management/ControlsListingControllerImpl$Companion;", "", "()V", "TAG", "", "SystemUI_nothingRelease"}, mo64988k = 1, mo64989mv = {1, 6, 0}, mo64991xi = 48)
    /* compiled from: ControlsListingControllerImpl.kt */
    ...
    public static final void m2654serviceListingCallback$lambda3(ControlsListingControllerImpl controlsListingControllerImpl, List list) {
    ...
    public static final void m2655serviceListingCallback$lambda3$lambda2(ControlsListingControllerImpl controlsListingControllerImpl, Set set, List list) {
        Intrinsics.checkNotNullParameter(controlsListingControllerImpl, "this$0");
    ...
    public static final void m2652changeUser$lambda4(ControlsListingControllerImpl controlsListingControllerImpl, UserHandle userHandle) {
        Intrinsics.checkNotNullParameter(controlsListingControllerImpl, "this$0");
        Intrinsics.checkNotNullParameter(userHandle, "$newUser");
    ...
    public static final void m2651addCallback$lambda5(ControlsListingControllerImpl controlsListingControllerImpl, ControlsListingController.ControlsListingCallback controlsListingCallback) {
        Intrinsics.checkNotNullParameter(controlsListingControllerImpl, "this$0");
        Intrinsics.checkNotNullParameter(controlsListingCallback, "$listener");
    ...
    public static final void m2653removeCallback$lambda6(ControlsListingControllerImpl controlsListingControllerImpl, ControlsListingController.ControlsListingCallback controlsListingCallback) {
        Intrinsics.checkNotNullParameter(controlsListingControllerImpl, "this$0");
        Intrinsics.checkNotNullParameter(controlsListingCallback, "$listener");
