...
public final class FavoritesModel implements ControlsModel {
    ...
    @NotNull
    private final ControlsModel.MoveHelper moveHelper = new ControlsModel.MoveHelper() { // from class: com.android.systemui.controls.management.FavoritesModel$moveHelper$1
    ...
    public FavoritesModel(@NotNull CustomIconCache customIconCache, @NotNull ComponentName componentName, @NotNull List<ControlInfo> favorites, @NotNull FavoritesModelCallback favoritesModelCallback) {
        ...
        for (ControlInfo controlInfo : favorites) {
        ...
        plus = CollectionsKt___CollectionsKt.plus(arrayList, new DividerWrapper(false, false, 3, null));
        this.elements = plus;
    ...
    public ControlsModel.MoveHelper mo411getMoveHelper() {
    ...
    public List<ControlInfo> getFavorites() {
        List<ElementWrapper> take;
        int collectionSizeOrDefault;
        take = CollectionsKt___CollectionsKt.take(getElements(), this.dividerPosition);
    ...
    public void changeFavoriteStatus(@NotNull String controlId, boolean z) {
        ...
        while (true) {
            ...
            if ((next instanceof ControlInterface) && Intrinsics.areEqual(((ControlInterface) next).getControlId(), controlId)) {
                break;
            }
            i++;
        }
