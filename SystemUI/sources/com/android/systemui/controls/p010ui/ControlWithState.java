...
public final class ControlWithState {
    ...
    /* renamed from: ci */
    private final ControlInfo f300ci;
    ...
    public static /* synthetic */ ControlWithState copy$default(ControlWithState controlWithState, ComponentName componentName2, ControlInfo controlInfo, Control control2, int i, Object obj) {
        ...
        if ((i & 2) != 0) {
            controlInfo = controlWithState.f300ci;
        }
        if ((i & 4) != 0) {
    ...
    public boolean equals(Object obj) {
        ...
        return Intrinsics.areEqual((Object) this.componentName, (Object) controlWithState.componentName) && Intrinsics.areEqual((Object) this.f300ci, (Object) controlWithState.f300ci) && Intrinsics.areEqual((Object) this.control, (Object) controlWithState.control);
    }

    public int hashCode() {
        int hashCode = ((this.componentName.hashCode() * 31) + this.f300ci.hashCode()) * 31;
        Control control2 = this.control;
        return hashCode + (control2 == null ? 0 : control2.hashCode());
    }

    public String toString() {
        return "ControlWithState(componentName=" + this.componentName + ", ci=" + this.f300ci + ", control=" + this.control + ')';
    }
