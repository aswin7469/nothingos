...
@Metadata(mo64986d1 = {"\u0000\u000e\n\u0000\n\u0002\u0018\u0002\n\u0002\u0010\b\n\u0002\b\u0002\u0010\u0000\u001a\u000e\u0012\u0004\u0012\u00020\u0002\u0012\u0004\u0012\u00020\u00020\u00012\u0006\u0010\u0003\u001a\u00020\u0002H\n¢\u0006\u0002\b\u0004"}, mo64987d2 = {"<anonymous>", "Lkotlin/Pair;", "", "it", "invoke"}, mo64988k = 3, mo64989mv = {1, 6, 0}, mo64991xi = 48)
...
final class RenderInfoKt$deviceColorMap$1 extends Lambda implements Function1<Integer, Pair<? extends Integer, ? extends Integer>> {
    ...
    public final Pair<Integer, Integer> invoke(int i) {
        return new Pair<>(Integer.valueOf((int) C1893R.C1894color.control_foreground), Integer.valueOf((int) C1893R.C1894color.control_enabled_default_background));
    }
}
