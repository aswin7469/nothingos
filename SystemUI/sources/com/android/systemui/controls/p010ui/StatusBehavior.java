...
public final class StatusBehavior implements Behavior {
    ...
    public void bind(ControlWithState controlWithState, int i) {
        ...
        if (status == 2) {
            ...
            i2 = C1893R.string.controls_error_removed;
        } else if (status == 3) {
            i2 = C1893R.string.controls_error_generic;
        } else if (status != 4) {
            getCvh().setLoading(true);
            i2 = 17040589;
        } else {
            i2 = C1893R.string.controls_error_timeout;
        }
    ...
    public static final void m2718bind$lambda0(StatusBehavior statusBehavior, ControlWithState controlWithState, View view) {
    ...
    public static final boolean m2719bind$lambda1(StatusBehavior statusBehavior, ControlWithState controlWithState, View view) {
        Intrinsics.checkNotNullParameter(statusBehavior, "this$0");
        Intrinsics.checkNotNullParameter(controlWithState, "$cws");
        statusBehavior.showNotFoundDialog(statusBehavior.getCvh(), controlWithState);
        return true;
    ...
    private final void showNotFoundDialog(ControlViewHolder controlViewHolder, ControlWithState controlWithState) {
        ...
        builder.setTitle(resources.getString(C1893R.string.controls_error_removed_title));
        builder.setMessage(resources.getString(C1893R.string.controls_error_removed_message, new Object[]{controlViewHolder.getTitle().getText(), applicationLabel}));
        builder.setPositiveButton(C1893R.string.controls_open_app, new StatusBehavior$$ExternalSyntheticLambda0(controlWithState, builder, controlViewHolder));
    ...
    public static final void m2720showNotFoundDialog$lambda4$lambda2(ControlWithState controlWithState, AlertDialog.Builder builder, ControlViewHolder controlViewHolder, DialogInterface dialogInterface, int i) {
    ...
    public static final void m2721showNotFoundDialog$lambda4$lambda3(DialogInterface dialogInterface, int i) {
