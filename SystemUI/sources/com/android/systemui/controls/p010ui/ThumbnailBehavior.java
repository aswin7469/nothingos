...
public final class ThumbnailBehavior implements Behavior {
    ...
    public void initialize(ControlViewHolder controlViewHolder) {
        ...
        controlViewHolder.getContext().getResources().getValue(C1893R.dimen.controls_thumbnail_shadow_x, typedValue, true);
        this.shadowOffsetX = typedValue.getFloat();
        controlViewHolder.getContext().getResources().getValue(C1893R.dimen.controls_thumbnail_shadow_y, typedValue, true);
        this.shadowOffsetY = typedValue.getFloat();
        controlViewHolder.getContext().getResources().getValue(C1893R.dimen.controls_thumbnail_shadow_radius, typedValue, true);
        this.shadowRadius = typedValue.getFloat();
        this.shadowColor = controlViewHolder.getContext().getResources().getColor(C1893R.C1894color.control_thumbnail_shadow_color);
    ...
    public static final void m2729initialize$lambda0(ControlViewHolder controlViewHolder, ThumbnailBehavior thumbnailBehavior, View view) {
        Intrinsics.checkNotNullParameter(controlViewHolder, "$cvh");
    ...
    public static final void m2727bind$lambda2(ThumbnailBehavior thumbnailBehavior, ClipDrawable clipDrawable, int i) {
        Intrinsics.checkNotNullParameter(thumbnailBehavior, "this$0");
    ...
    public static final void m2728bind$lambda2$lambda1(ThumbnailBehavior thumbnailBehavior, ClipDrawable clipDrawable, Drawable drawable, int i) {
        Intrinsics.checkNotNullParameter(thumbnailBehavior, "this$0");
        Intrinsics.checkNotNullParameter(clipDrawable, "$clipLayer");
        Intrinsics.checkNotNullExpressionValue(drawable, "drawable");
        clipDrawable.setDrawable(new CornerDrawable(drawable, (float) thumbnailBehavior.getCvh().getContext().getResources().getDimensionPixelSize(C1893R.dimen.control_corner_radius)));
        clipDrawable.setColorFilter(new BlendModeColorFilter(thumbnailBehavior.getCvh().getContext().getResources().getColor(C1893R.C1894color.control_thumbnail_tint), BlendMode.LUMINOSITY));
