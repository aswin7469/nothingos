...
public final class ControlActionCoordinatorImpl_Factory implements Factory<ControlActionCoordinatorImpl> {
    ...
    /* renamed from: get */
    public ControlActionCoordinatorImpl mo1933get() {
        return newInstance(this.contextProvider.mo1933get(), this.bgExecutorProvider.mo1933get(), this.uiExecutorProvider.mo1933get(), this.activityStarterProvider.mo1933get(), this.keyguardStateControllerProvider.mo1933get(), this.globalActionsComponentProvider.mo1933get(), this.taskViewFactoryProvider.mo1933get(), this.broadcastDispatcherProvider.mo1933get(), DoubleCheck.lazy(this.uiControllerProvider), this.controlsMetricsLoggerProvider.mo1933get());
    }
