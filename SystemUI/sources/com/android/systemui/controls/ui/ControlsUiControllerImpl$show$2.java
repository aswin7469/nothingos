...
public /* synthetic */ class ControlsUiControllerImpl$show$2 extends FunctionReferenceImpl implements Function1<List<? extends SelectionItem>, Unit> {
    /* JADX INFO: Access modifiers changed from: package-private */
    public ControlsUiControllerImpl$show$2(ControlsUiControllerImpl controlsUiControllerImpl) {
        super(1, controlsUiControllerImpl, ControlsUiControllerImpl.class, "showInitialSetupView", "showInitialSetupView(Ljava/util/List;)V", 0);
    }
    ...
    public final void invoke2(@NotNull List<SelectionItem> p0) {
        ...
        ((ControlsUiControllerImpl) this.receiver).showInitialSetupView(p0);
    }
}
