...
public final class ControlsUiControllerImpl_Factory implements Factory<ControlsUiControllerImpl> {
    ...
    /* renamed from: get */
    public ControlsUiControllerImpl mo1933get() {
        return newInstance(DoubleCheck.lazy(this.controlsControllerProvider), this.contextProvider.mo1933get(), this.uiExecutorProvider.mo1933get(), this.bgExecutorProvider.mo1933get(), DoubleCheck.lazy(this.controlsListingControllerProvider), this.sharedPreferencesProvider.mo1933get(), this.controlActionCoordinatorProvider.mo1933get(), this.activityStarterProvider.mo1933get(), this.shadeControllerProvider.mo1933get(), this.iconCacheProvider.mo1933get(), this.controlsMetricsLoggerProvider.mo1933get(), this.keyguardStateControllerProvider.mo1933get());
    }
