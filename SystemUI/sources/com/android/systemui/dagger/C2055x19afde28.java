...
public final class C2055x19afde28 implements Factory<AmbientDisplayConfiguration> {
    private final Provider<Context> contextProvider;
    private final FrameworkServicesModule module;

    public C2055x19afde28(FrameworkServicesModule frameworkServicesModule, Provider<Context> provider) {
    ...
    public static C2055x19afde28 create(FrameworkServicesModule frameworkServicesModule, Provider<Context> provider) {
        return new C2055x19afde28(frameworkServicesModule, provider);
    }
