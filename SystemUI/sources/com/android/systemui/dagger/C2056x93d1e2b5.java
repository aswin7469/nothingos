...
public final class C2056x93d1e2b5 implements Factory<IndividualSensorPrivacyController> {
    private final Provider<SensorPrivacyManager> sensorPrivacyManagerProvider;

    public C2056x93d1e2b5(Provider<SensorPrivacyManager> provider) {
    ...
    public static C2056x93d1e2b5 create(Provider<SensorPrivacyManager> provider) {
        return new C2056x93d1e2b5(provider);
    }
