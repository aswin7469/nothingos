...
public class ContextComponentResolver implements ContextComponentHelper {
    ...
    public ContextComponentResolver(Map<Class<?>, Provider<Activity>> map, Map<Class<?>, Provider<Service>> map2, Map<Class<?>, Provider<SystemUI>> map3, Map<Class<?>, Provider<RecentsImplementation>> map4, Map<Class<?>, Provider<BroadcastReceiver>> map5) {
