...
public final class ContextComponentResolver_Factory implements Factory<ContextComponentResolver> {
    ...
    /* renamed from: get */
    public ContextComponentResolver mo1933get() {
        return newInstance(this.activityCreatorsProvider.mo1933get(), this.serviceCreatorsProvider.mo1933get(), this.systemUICreatorsProvider.mo1933get(), this.recentsCreatorsProvider.mo1933get(), this.broadcastReceiverCreatorsProvider.mo1933get());
    }
