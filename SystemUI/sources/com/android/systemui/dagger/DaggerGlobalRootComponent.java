...
public final class DaggerGlobalRootComponent implements GlobalRootComponent {
    ...
    public WMComponent.Builder mo1379getWMComponentBuilder() {
        return new WMComponentBuilder();
    }

    @Override // com.android.systemui.dagger.GlobalRootComponent
    /* renamed from: getSysUIComponent */
    public SysUIComponent.Builder mo1378getSysUIComponent() {
    ...
    public static final class Builder implements GlobalRootComponent.Builder {
        ...
        @Override // com.android.systemui.dagger.GlobalRootComponent.Builder
        /* renamed from: build */
        public GlobalRootComponent mo1380build() {
    ...
    private final class WMComponentBuilder implements WMComponent.Builder {
        ...
        /* renamed from: build */
        public WMComponent mo1418build() {
    ...
    private final class WMComponentImpl implements WMComponent {
        ...
        public Optional<LegacySplitScreen> getLegacySplitScreen() {
            return this.provideLegacySplitScreenProvider2.mo1933get();
        }

        @Override // com.android.systemui.dagger.WMComponent
        public Optional<SplitScreen> getSplitScreen() {
            return this.provideSplitScreenProvider.mo1933get();
        }

        @Override // com.android.systemui.dagger.WMComponent
        public Optional<AppPairs> getAppPairs() {
            return this.provideAppPairsProvider2.mo1933get();
        }
    ...
    private final class SysUIComponentBuilder implements SysUIComponent.Builder {
        ...
        @Override // com.android.systemui.dagger.SysUIComponent.Builder
        /* renamed from: setPip */
        public SysUIComponentBuilder mo1390setPip(Optional<Pip> optional) {
        ...
        public SysUIComponentBuilder mo1388setLegacySplitScreen(Optional<LegacySplitScreen> optional) {
        ...
        public SysUIComponentBuilder mo1392setSplitScreen(Optional<SplitScreen> optional) {
        ...
        public SysUIComponentBuilder mo1385setAppPairs(Optional<AppPairs> optional) {
        ...
        public SysUIComponentBuilder mo1389setOneHanded(Optional<OneHanded> optional) {
        ...
        public SysUIComponentBuilder mo1386setBubbles(Optional<Bubbles> optional) {
        ...
        public SysUIComponentBuilder mo1395setTaskViewFactory(Optional<TaskViewFactory> optional) {
        ...
        public SysUIComponentBuilder mo1387setHideDisplayCutout(Optional<HideDisplayCutout> optional) {
        ...
        public SysUIComponentBuilder mo1391setShellCommandHandler(Optional<ShellCommandHandler> optional) {
        ...
        public SysUIComponentBuilder mo1396setTransitions(ShellTransitions shellTransitions) {
        ...
        public SysUIComponentBuilder mo1393setStartingSurface(Optional<StartingSurface> optional) {
        ...
        public SysUIComponentBuilder mo1394setTaskSurfaceHelper(Optional<TaskSurfaceHelper> optional) {
        ...
        @Override // com.android.systemui.dagger.SysUIComponent.Builder
        /* renamed from: build */
        public SysUIComponent mo1384build() {
    ...
    public final class SysUIComponentImpl implements SysUIComponent {
        ...
        private NotificationSectionsFeatureManager notificationSectionsFeatureManager() {
            return new NotificationSectionsFeatureManager(this.deviceConfigProxyProvider.mo1933get(), DaggerGlobalRootComponent.this.context);
        }
        ...
        private void initialize3(DependencyProvider dependencyProvider, NightDisplayListenerModule nightDisplayListenerModule, UserModule userModule, Optional<Pip> optional, Optional<LegacySplitScreen> optional2, Optional<SplitScreen> optional3, Optional<AppPairs> optional4, Optional<OneHanded> optional5, Optional<Bubbles> optional6, Optional<TaskViewFactory> optional7, Optional<HideDisplayCutout> optional8, Optional<ShellCommandHandler> optional9, ShellTransitions shellTransitions, Optional<StartingSurface> optional10, Optional<TaskSurfaceHelper> optional11) {
            ...
            this.mediaDataFilterProvider = MediaDataFilter_Factory.create(DaggerGlobalRootComponent.this.contextProvider, this.providesBroadcastDispatcherProvider, this.mediaResumeListenerProvider, this.notificationLockscreenUserManagerImplProvider, DaggerGlobalRootComponent.this.provideMainExecutorProvider, this.bindSystemClockProvider);
            ...
            Provider<SectionHeaderControllerSubcomponent.Builder> provider4 = new Provider<SectionHeaderControllerSubcomponent.Builder>() { // from class: com.android.systemui.dagger.DaggerGlobalRootComponent.SysUIComponentImpl.4
                /* JADX WARN: Can't rename method to resolve collision */
                @Override // javax.inject.Provider
                /* renamed from: get */
            ...
            this.preparationCoordinatorProvider = DoubleCheck.provider(PreparationCoordinator_Factory.create(this.preparationCoordinatorLoggerProvider, this.notifInflaterImplProvider, this.notifInflationErrorManagerProvider, provider10, DaggerGlobalRootComponent.this.provideIStatusBarServiceProvider));
            ...
            Provider<InjectionInflationController.ViewInstanceCreator.Factory> provider14 = new Provider<InjectionInflationController.ViewInstanceCreator.Factory>() { // from class: com.android.systemui.dagger.DaggerGlobalRootComponent.SysUIComponentImpl.5
                /* JADX WARN: Can't rename method to resolve collision */
                @Override // javax.inject.Provider
                /* renamed from: get */
            ...
            this.carrierConfigTrackerProvider = DoubleCheck.provider(CarrierConfigTracker_Factory.create(DaggerGlobalRootComponent.this.contextProvider, this.providesBroadcastDispatcherProvider));
        ...
        private void initialize4(DependencyProvider dependencyProvider, NightDisplayListenerModule nightDisplayListenerModule, UserModule userModule, Optional<Pip> optional, Optional<LegacySplitScreen> optional2, Optional<SplitScreen> optional3, Optional<AppPairs> optional4, Optional<OneHanded> optional5, Optional<Bubbles> optional6, Optional<TaskViewFactory> optional7, Optional<HideDisplayCutout> optional8, Optional<ShellCommandHandler> optional9, ShellTransitions shellTransitions, Optional<StartingSurface> optional10, Optional<TaskSurfaceHelper> optional11) {
            ...
            this.rotationLockControllerImplProvider = DoubleCheck.provider(RotationLockControllerImpl_Factory.create(DaggerGlobalRootComponent.this.contextProvider, this.secureSettingsImplProvider));
            ...
            SystemEventChipAnimationController_Factory create3 = SystemEventChipAnimationController_Factory.create(DaggerGlobalRootComponent.this.contextProvider, this.superStatusBarViewFactoryProvider, this.statusBarWindowControllerProvider, this.statusBarLocationPublisherProvider);
            ...
            this.udfpsControllerProvider = DoubleCheck.provider(UdfpsController_Factory.create(DaggerGlobalRootComponent.this.contextProvider, DaggerGlobalRootComponent.this.provideExecutionProvider, this.providerLayoutInflaterProvider, DaggerGlobalRootComponent.this.providesFingerprintManagerProvider, DaggerGlobalRootComponent.this.provideWindowManagerProvider, this.statusBarStateControllerImplProvider, this.provideMainDelayableExecutorProvider, this.provideStatusBarProvider, this.statusBarKeyguardViewManagerProvider, this.dumpManagerProvider, this.keyguardUpdateMonitorProvider, this.falsingManagerProxyProvider, DaggerGlobalRootComponent.this.providePowerManagerProvider, DaggerGlobalRootComponent.this.provideAccessibilityManagerProvider, this.lockscreenShadeTransitionControllerProvider, this.screenLifecycleProvider, DaggerGlobalRootComponent.this.provideVibratorProvider, this.udfpsHapticsSimulatorProvider, this.optionalOfUdfpsHbmProvider, this.keyguardStateControllerImplProvider, this.keyguardBypassControllerProvider, DaggerGlobalRootComponent.this.provideDisplayManagerProvider, DaggerGlobalRootComponent.this.provideMainHandlerProvider, this.provideConfigurationControllerProvider, this.bindSystemClockProvider, this.unlockedScreenOffAnimationControllerProvider));
            ...
            this.createUserActivityProvider = CreateUserActivity_Factory.create(this.userCreatorProvider, create4, DaggerGlobalRootComponent.this.provideIActivityManagerProvider);
            TvNotificationHandler_Factory create5 = TvNotificationHandler_Factory.create(DaggerGlobalRootComponent.this.contextProvider, this.provideNotificationListenerProvider);
            this.tvNotificationHandlerProvider = create5;
            this.tvNotificationPanelActivityProvider = TvNotificationPanelActivity_Factory.create(create5);
        ...
        private void initialize5(DependencyProvider dependencyProvider, NightDisplayListenerModule nightDisplayListenerModule, UserModule userModule, Optional<Pip> optional, Optional<LegacySplitScreen> optional2, Optional<SplitScreen> optional3, Optional<AppPairs> optional4, Optional<OneHanded> optional5, Optional<Bubbles> optional6, Optional<TaskViewFactory> optional7, Optional<HideDisplayCutout> optional8, Optional<ShellCommandHandler> optional9, ShellTransitions shellTransitions, Optional<StartingSurface> optional10, Optional<TaskSurfaceHelper> optional11) {
            ...
            Provider<DozeComponent.Builder> provider = new Provider<DozeComponent.Builder>() { // from class: com.android.systemui.dagger.DaggerGlobalRootComponent.SysUIComponentImpl.8
                /* JADX WARN: Can't rename method to resolve collision */
                @Override // javax.inject.Provider
                /* renamed from: get */
            ...
            this.recordingServiceProvider = RecordingService_Factory.create(this.recordingControllerProvider, provider4, DaggerGlobalRootComponent.this.provideUiEventLoggerProvider, DaggerGlobalRootComponent.this.provideNotificationManagerProvider, this.provideUserTrackerProvider, this.keyguardDismissUtilProvider);
            ...
            this.scrollCaptureControllerProvider = ScrollCaptureController_Factory.create(DaggerGlobalRootComponent.this.contextProvider, this.provideBackgroundExecutorProvider, this.scrollCaptureClientProvider, this.imageTileSetProvider, DaggerGlobalRootComponent.this.provideUiEventLoggerProvider);
            ...
            this.provideThemeOverlayManagerProvider = DoubleCheck.provider(DependencyProvider_ProvideThemeOverlayManagerFactory.create(DaggerGlobalRootComponent.this.contextProvider, this.provideBackgroundExecutorProvider, DaggerGlobalRootComponent.this.provideMainExecutorProvider, DaggerGlobalRootComponent.this.provideOverlayManagerProvider, this.dumpManagerProvider));
            ...
            Provider<FragmentService.FragmentCreator.Factory> provider6 = new Provider<FragmentService.FragmentCreator.Factory>() { // from class: com.android.systemui.dagger.DaggerGlobalRootComponent.SysUIComponentImpl.9
                /* JADX WARN: Can't rename method to resolve collision */
                @Override // javax.inject.Provider
                /* renamed from: get */
            ...
            this.liftWakeGestureControllerProvider = DoubleCheck.provider(LiftWakeGestureController_Factory.create(DaggerGlobalRootComponent.this.contextProvider, DaggerGlobalRootComponent.this.provideMainHandlerProvider, this.proximitySensorProvider));
            this.faceRecognitionControllerProvider = DoubleCheck.provider(FaceRecognitionController_Factory.create(DaggerGlobalRootComponent.this.contextProvider));
            this.privacyDialogControllerProvider = DoubleCheck.provider(PrivacyDialogController_Factory.create(DaggerGlobalRootComponent.this.providePermissionManagerProvider, DaggerGlobalRootComponent.this.providePackageManagerProvider, this.privacyItemControllerProvider, this.provideUserTrackerProvider, this.activityStarterDelegateProvider, this.provideBackgroundExecutorProvider, DaggerGlobalRootComponent.this.provideMainExecutorProvider, this.privacyLoggerProvider, this.keyguardStateControllerImplProvider, this.appOpsControllerImplProvider, DaggerGlobalRootComponent.this.provideUiEventLoggerProvider));
            this.qSStatusBarControllerProvider = DoubleCheck.provider(QSStatusBarController_Factory.create(DaggerGlobalRootComponent.this.contextProvider, this.privacyDialogControllerProvider, this.privacyItemControllerProvider, DaggerGlobalRootComponent.this.provideUiEventLoggerProvider, this.privacyLoggerProvider));
            this.keyguardWeatherControllerImplProvider = DoubleCheck.provider(KeyguardWeatherControllerImpl_Factory.create(DaggerGlobalRootComponent.this.contextProvider, DaggerGlobalRootComponent.this.provideMainHandlerProvider, this.keyguardUpdateMonitorProvider));
            this.glyphsControllerImplProvider = DoubleCheck.provider(GlyphsControllerImpl_Factory.create(DaggerGlobalRootComponent.this.contextProvider));
            this.batteryShareControllerImplProvider = DoubleCheck.provider(BatteryShareControllerImpl_Factory.create(DaggerGlobalRootComponent.this.contextProvider, this.provideBatteryControllerProvider));
            this.nfcControllerImplProvider = DoubleCheck.provider(NfcControllerImpl_Factory.create(DaggerGlobalRootComponent.this.contextProvider, this.provideBatteryControllerProvider));
            this.nTColorControllerProvider = DoubleCheck.provider(NTColorController_Factory.create(DaggerGlobalRootComponent.this.contextProvider));
            this.teslaInfoControllerImplProvider = DoubleCheck.provider(TeslaInfoControllerImpl_Factory.create(DaggerGlobalRootComponent.this.contextProvider, this.providesBroadcastDispatcherProvider, GlobalConcurrencyModule_ProvideMainLooperFactory.create(), this.dumpManagerProvider));
        }
        ...
        private void initialize6(DependencyProvider dependencyProvider, NightDisplayListenerModule nightDisplayListenerModule, UserModule userModule, Optional<Pip> optional, Optional<LegacySplitScreen> optional2, Optional<SplitScreen> optional3, Optional<AppPairs> optional4, Optional<OneHanded> optional5, Optional<Bubbles> optional6, Optional<TaskViewFactory> optional7, Optional<HideDisplayCutout> optional8, Optional<ShellCommandHandler> optional9, ShellTransitions shellTransitions, Optional<StartingSurface> optional10, Optional<TaskSurfaceHelper> optional11) {
            ...
            this.rotationLockTileProvider = RotationLockTile_Factory.create(this.qSTileHostProvider, this.provideBgLooperProvider, DaggerGlobalRootComponent.this.provideMainHandlerProvider, this.falsingManagerProxyProvider, this.provideMetricsLoggerProvider, this.statusBarStateControllerImplProvider, this.activityStarterDelegateProvider, this.qSLoggerProvider, this.rotationLockControllerImplProvider, DaggerGlobalRootComponent.this.provideSensorPrivacyManagerProvider, this.provideBatteryControllerProvider, this.secureSettingsImplProvider);
            ...
            Provider<Boolean> provider3 = DoubleCheck.provider(QSFlagsModule_IsReduceBrightColorsAvailableFactory.create(DaggerGlobalRootComponent.this.contextProvider));
            ...
            this.quickAccessWalletTileProvider = QuickAccessWalletTile_Factory.create(this.qSTileHostProvider, this.provideBgLooperProvider, DaggerGlobalRootComponent.this.provideMainHandlerProvider, this.falsingManagerProxyProvider, this.provideMetricsLoggerProvider, this.statusBarStateControllerImplProvider, this.activityStarterDelegateProvider, this.qSLoggerProvider, this.keyguardStateControllerImplProvider, DaggerGlobalRootComponent.this.providePackageManagerProvider, this.secureSettingsImplProvider, this.quickAccessWalletControllerProvider);
            this.glyphsTileProvider = GlyphsTile_Factory.create(this.qSTileHostProvider, this.provideBgLooperProvider, DaggerGlobalRootComponent.this.provideMainHandlerProvider, this.falsingManagerProxyProvider, this.provideMetricsLoggerProvider, this.statusBarStateControllerImplProvider, this.activityStarterDelegateProvider, this.qSLoggerProvider, this.glyphsControllerImplProvider);
            BatteryShareTile_Factory create = BatteryShareTile_Factory.create(this.qSTileHostProvider, this.provideBgLooperProvider, DaggerGlobalRootComponent.this.provideMainHandlerProvider, this.falsingManagerProxyProvider, this.provideMetricsLoggerProvider, this.statusBarStateControllerImplProvider, this.activityStarterDelegateProvider, this.qSLoggerProvider, this.batteryShareControllerImplProvider);
            ...
            this.builderProvider8 = DoubleCheck.provider(AutoAddTracker_Builder_Factory.create(this.secureSettingsImplProvider, this.providesBroadcastDispatcherProvider, this.qSTileHostProvider, this.dumpManagerProvider, DaggerGlobalRootComponent.this.provideMainHandlerProvider, this.provideBackgroundExecutorProvider));
        ...
        private KeyguardSliceProvider injectKeyguardSliceProvider(KeyguardSliceProvider keyguardSliceProvider) {
            ...
            KeyguardSliceProvider_MembersInjector.injectMAlarmManager(keyguardSliceProvider, (AlarmManager) DaggerGlobalRootComponent.this.provideAlarmManagerProvider.mo1933get());
            KeyguardSliceProvider_MembersInjector.injectMContentResolver(keyguardSliceProvider, (ContentResolver) DaggerGlobalRootComponent.this.provideContentResolverProvider.mo1933get());
        ...
        private final class KeyguardStatusViewComponentImpl implements KeyguardStatusViewComponent {
            ...
            public KeyguardClockSwitchController getKeyguardClockSwitchController() {
                return new KeyguardClockSwitchController(keyguardClockSwitch(), (StatusBarStateController) SysUIComponentImpl.this.statusBarStateControllerImplProvider.mo1933get(), (SysuiColorExtractor) SysUIComponentImpl.this.sysuiColorExtractorProvider.mo1933get(), (ClockManager) SysUIComponentImpl.this.clockManagerProvider.mo1933get(), this.keyguardSliceViewControllerProvider.mo1933get(), (NotificationIconAreaController) SysUIComponentImpl.this.notificationIconAreaControllerProvider.mo1933get(), (BroadcastDispatcher) SysUIComponentImpl.this.providesBroadcastDispatcherProvider.mo1933get(), (BatteryController) SysUIComponentImpl.this.provideBatteryControllerProvider.mo1933get(), (KeyguardUpdateMonitor) SysUIComponentImpl.this.keyguardUpdateMonitorProvider.mo1933get(), (KeyguardBypassController) SysUIComponentImpl.this.keyguardBypassControllerProvider.mo1933get(), (LockscreenSmartspaceController) SysUIComponentImpl.this.lockscreenSmartspaceControllerProvider.mo1933get(), (KeyguardUnlockAnimationController) SysUIComponentImpl.this.keyguardUnlockAnimationControllerProvider.mo1933get(), (SmartspaceTransitionController) SysUIComponentImpl.this.provideSmartspaceTransitionControllerProvider.mo1933get(), DaggerGlobalRootComponent.this.mainResources());
            }

            @Override // com.android.keyguard.dagger.KeyguardStatusViewComponent
            public KeyguardStatusViewController getKeyguardStatusViewController() {
                return new KeyguardStatusViewController(this.presentation, this.keyguardSliceViewControllerProvider.mo1933get(), getKeyguardClockSwitchController(), (KeyguardStateController) SysUIComponentImpl.this.keyguardStateControllerImplProvider.mo1933get(), (KeyguardUpdateMonitor) SysUIComponentImpl.this.keyguardUpdateMonitorProvider.mo1933get(), (ConfigurationController) SysUIComponentImpl.this.provideConfigurationControllerProvider.mo1933get(), (DozeParameters) SysUIComponentImpl.this.dozeParametersProvider.mo1933get(), (KeyguardUnlockAnimationController) SysUIComponentImpl.this.keyguardUnlockAnimationControllerProvider.mo1933get(), (SmartspaceTransitionController) SysUIComponentImpl.this.provideSmartspaceTransitionControllerProvider.mo1933get(), (UnlockedScreenOffAnimationController) SysUIComponentImpl.this.unlockedScreenOffAnimationControllerProvider.mo1933get());
            }
        }
        ...
        private final class ViewInstanceCreatorImpl implements InjectionInflationController.ViewInstanceCreator {
            ...
            public NotificationStackScrollLayout createNotificationStackScrollLayout() {
                return new NotificationStackScrollLayout(this.context, this.attributeSet, SysUIComponentImpl.this.notificationSectionsManager(), (GroupMembershipManager) SysUIComponentImpl.this.provideGroupMembershipManagerProvider.mo1933get(), (GroupExpansionManager) SysUIComponentImpl.this.provideGroupExpansionManagerProvider.mo1933get(), (AmbientState) SysUIComponentImpl.this.ambientStateProvider.mo1933get(), (FeatureFlags) SysUIComponentImpl.this.featureFlagsProvider.mo1933get(), (UnlockedScreenOffAnimationController) SysUIComponentImpl.this.unlockedScreenOffAnimationControllerProvider.mo1933get());
            }
        }
        ...
        private final class StatusBarComponentImpl implements StatusBarComponent {
            ...
            private void initialize(NotificationShadeWindowView notificationShadeWindowView) {
                ...
                this.udfpsScanningViewControllerProvider = DoubleCheck.provider(UdfpsScanningViewController_Factory.create(SysUIComponentImpl.this.provideStatusBarProvider, DaggerGlobalRootComponent.this.contextProvider, SysUIComponentImpl.this.authControllerProvider, SysUIComponentImpl.this.provideConfigurationControllerProvider, SysUIComponentImpl.this.keyguardUpdateMonitorProvider, SysUIComponentImpl.this.keyguardStateControllerImplProvider, SysUIComponentImpl.this.wakefulnessLifecycleProvider, SysUIComponentImpl.this.commandRegistryProvider, SysUIComponentImpl.this.notificationShadeWindowControllerImplProvider, SysUIComponentImpl.this.keyguardBypassControllerProvider, SysUIComponentImpl.this.biometricUnlockControllerProvider, SysUIComponentImpl.this.udfpsControllerProvider, SysUIComponentImpl.this.statusBarStateControllerImplProvider, this.getLottieAnimationViewProvider));
            }

            @Override // com.android.systemui.statusbar.phone.dagger.StatusBarComponent
            public NotificationShadeWindowViewController getNotificationShadeWindowViewController() {
                return new NotificationShadeWindowViewController((InjectionInflationController) SysUIComponentImpl.this.injectionInflationControllerProvider.mo1933get(), (NotificationWakeUpCoordinator) SysUIComponentImpl.this.notificationWakeUpCoordinatorProvider.mo1933get(), (PulseExpansionHandler) SysUIComponentImpl.this.pulseExpansionHandlerProvider.mo1933get(), (DynamicPrivacyController) SysUIComponentImpl.this.dynamicPrivacyControllerProvider.mo1933get(), (KeyguardBypassController) SysUIComponentImpl.this.keyguardBypassControllerProvider.mo1933get(), (LockscreenShadeTransitionController) SysUIComponentImpl.this.lockscreenShadeTransitionControllerProvider.mo1933get(), (FalsingCollector) SysUIComponentImpl.this.falsingCollectorImplProvider.mo1933get(), (PluginManager) SysUIComponentImpl.this.providePluginManagerProvider.mo1933get(), (TunerService) SysUIComponentImpl.this.tunerServiceImplProvider.mo1933get(), (NotificationLockscreenUserManager) SysUIComponentImpl.this.notificationLockscreenUserManagerImplProvider.mo1933get(), (NotificationEntryManager) SysUIComponentImpl.this.provideNotificationEntryManagerProvider.mo1933get(), (KeyguardStateController) SysUIComponentImpl.this.keyguardStateControllerImplProvider.mo1933get(), (SysuiStatusBarStateController) SysUIComponentImpl.this.statusBarStateControllerImplProvider.mo1933get(), (DozeLog) SysUIComponentImpl.this.dozeLogProvider.mo1933get(), (DozeParameters) SysUIComponentImpl.this.dozeParametersProvider.mo1933get(), (CommandQueue) SysUIComponentImpl.this.provideCommandQueueProvider.mo1933get(), (ShadeController) SysUIComponentImpl.this.shadeControllerImplProvider.mo1933get(), (DockManager) SysUIComponentImpl.this.dockManagerImplProvider.mo1933get(), (NotificationShadeDepthController) SysUIComponentImpl.this.notificationShadeDepthControllerProvider.mo1933get(), this.statusBarWindowView, this.notificationPanelViewControllerProvider.mo1933get(), (SuperStatusBarViewFactory) SysUIComponentImpl.this.superStatusBarViewFactoryProvider.mo1933get(), this.notificationStackScrollLayoutControllerProvider.mo1933get(), (StatusBarKeyguardViewManager) SysUIComponentImpl.this.statusBarKeyguardViewManagerProvider.mo1933get(), this.lockIconViewControllerProvider.mo1933get());
            }

            @Override // com.android.systemui.statusbar.phone.dagger.StatusBarComponent
            public StatusBarWindowController getStatusBarWindowController() {
                return (StatusBarWindowController) SysUIComponentImpl.this.statusBarWindowControllerProvider.mo1933get();
            }
        ...
        private final class FragmentCreatorImpl implements FragmentService.FragmentCreator {
            ...
            public QSFragment createQSFragment() {
                return new QSFragment((RemoteInputQuickSettingsDisabler) SysUIComponentImpl.this.remoteInputQuickSettingsDisablerProvider.mo1933get(), (InjectionInflationController) SysUIComponentImpl.this.injectionInflationControllerProvider.mo1933get(), (QSTileHost) SysUIComponentImpl.this.qSTileHostProvider.mo1933get(), (StatusBarStateController) SysUIComponentImpl.this.statusBarStateControllerImplProvider.mo1933get(), (CommandQueue) SysUIComponentImpl.this.provideCommandQueueProvider.mo1933get(), (QSDetailDisplayer) SysUIComponentImpl.this.qSDetailDisplayerProvider.mo1933get(), (MediaHost) SysUIComponentImpl.this.providesQSMediaHostProvider.mo1933get(), (MediaHost) SysUIComponentImpl.this.providesQuickQSMediaHostProvider.mo1933get(), (KeyguardBypassController) SysUIComponentImpl.this.keyguardBypassControllerProvider.mo1933get(), new QSFragmentComponentFactory(), (FeatureFlags) SysUIComponentImpl.this.featureFlagsProvider.mo1933get(), (FalsingManager) SysUIComponentImpl.this.falsingManagerProxyProvider.mo1933get(), (DumpManager) SysUIComponentImpl.this.dumpManagerProvider.mo1933get());
            }

            @Override // com.android.systemui.fragments.FragmentService.FragmentCreator
            public CollapsedStatusBarFragment createCollapsedStatusBarFragment() {
                return new CollapsedStatusBarFragment((OngoingCallController) SysUIComponentImpl.this.provideOngoingCallControllerProvider.mo1933get(), (SystemStatusAnimationScheduler) SysUIComponentImpl.this.systemStatusAnimationSchedulerProvider.mo1933get(), (StatusBarLocationPublisher) SysUIComponentImpl.this.statusBarLocationPublisherProvider.mo1933get(), (NotificationIconAreaController) SysUIComponentImpl.this.notificationIconAreaControllerProvider.mo1933get(), (FeatureFlags) SysUIComponentImpl.this.featureFlagsProvider.mo1933get(), (StatusBarIconController) SysUIComponentImpl.this.statusBarIconControllerImplProvider.mo1933get(), (KeyguardStateController) SysUIComponentImpl.this.keyguardStateControllerImplProvider.mo1933get(), (NetworkController) SysUIComponentImpl.this.networkControllerImplProvider.mo1933get(), (StatusBarStateController) SysUIComponentImpl.this.statusBarStateControllerImplProvider.mo1933get(), (StatusBar) SysUIComponentImpl.this.provideStatusBarProvider.mo1933get(), (CommandQueue) SysUIComponentImpl.this.provideCommandQueueProvider.mo1933get());
            }
        }
        ...
        private final class KeyguardStatusBarViewComponentImpl implements KeyguardStatusBarViewComponent {
            ...
            private CarrierTextManager.Builder carrierTextManagerBuilder() {
                return new CarrierTextManager.Builder(DaggerGlobalRootComponent.this.context, DaggerGlobalRootComponent.this.mainResources(), (WifiManager) DaggerGlobalRootComponent.this.provideWifiManagerProvider.mo1933get(), (TelephonyManager) DaggerGlobalRootComponent.this.provideTelephonyManagerProvider.mo1933get(), (TelephonyListenerManager) SysUIComponentImpl.this.telephonyListenerManagerProvider.mo1933get(), (WakefulnessLifecycle) SysUIComponentImpl.this.wakefulnessLifecycleProvider.mo1933get(), DaggerGlobalRootComponent.this.mainExecutor(), (Executor) SysUIComponentImpl.this.provideBackgroundExecutorProvider.mo1933get(), (KeyguardUpdateMonitor) SysUIComponentImpl.this.keyguardUpdateMonitorProvider.mo1933get());
            }

            private CarrierTextController carrierTextController() {
                return new CarrierTextController(this.getCarrierTextProvider.mo1933get(), carrierTextManagerBuilder(), (KeyguardUpdateMonitor) SysUIComponentImpl.this.keyguardUpdateMonitorProvider.mo1933get());
            }
        ...
        private final class QSFragmentComponentImpl implements QSFragmentComponent {
            ...
            private void initialize(QSFragment qSFragment) {
                ...
                this.tileQueryHelperProvider = DoubleCheck.provider(TileQueryHelper_Factory.create(DaggerGlobalRootComponent.this.contextProvider, SysUIComponentImpl.this.provideUserTrackerProvider, DaggerGlobalRootComponent.this.provideMainExecutorProvider, SysUIComponentImpl.this.provideBackgroundExecutorProvider, SysUIComponentImpl.this.featureFlagsProvider));
