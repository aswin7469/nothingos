...
public class DependencyProvider {
    ...
    public static ThemeOverlayApplier provideThemeOverlayManager(Context context, Executor executor, Executor executor2, OverlayManager overlayManager, DumpManager dumpManager) {
        return new ThemeOverlayApplier(overlayManager, executor, executor2, context.getString(R$string.launcher_overlayable_package), context.getString(R$string.themepicker_overlayable_package), dumpManager);
    }
