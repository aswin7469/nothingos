...
public final class DependencyProvider_ProvideAccessibilityFloatingMenuControllerFactory implements Factory<AccessibilityFloatingMenuController> {
    ...
    /* renamed from: get */
    public AccessibilityFloatingMenuController mo1933get() {
        return provideAccessibilityFloatingMenuController(this.module, this.contextProvider.mo1933get(), this.accessibilityButtonTargetsObserverProvider.mo1933get(), this.accessibilityButtonModeObserverProvider.mo1933get(), this.keyguardUpdateMonitorProvider.mo1933get());
    }
