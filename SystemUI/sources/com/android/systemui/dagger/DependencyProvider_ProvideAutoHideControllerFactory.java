...
public final class DependencyProvider_ProvideAutoHideControllerFactory implements Factory<AutoHideController> {
    ...
    /* renamed from: get */
    public AutoHideController mo1933get() {
        return provideAutoHideController(this.module, this.contextProvider.mo1933get(), this.mainHandlerProvider.mo1933get(), this.iWindowManagerProvider.mo1933get());
    }
