...
public final class DependencyProvider_ProvideNavigationBarControllerFactory implements Factory<NavigationBarController> {
    ...
    /* renamed from: get */
    public NavigationBarController mo1933get() {
        return provideNavigationBarController(this.module, this.contextProvider.mo1933get(), this.windowManagerProvider.mo1933get(), DoubleCheck.lazy(this.assistManagerLazyProvider), this.accessibilityManagerProvider.mo1933get(), this.accessibilityManagerWrapperProvider.mo1933get(), this.deviceProvisionedControllerProvider.mo1933get(), this.metricsLoggerProvider.mo1933get(), this.overviewProxyServiceProvider.mo1933get(), this.navigationModeControllerProvider.mo1933get(), this.accessibilityButtonModeObserverProvider.mo1933get(), this.statusBarStateControllerProvider.mo1933get(), this.sysUiFlagsContainerProvider.mo1933get(), this.broadcastDispatcherProvider.mo1933get(), this.commandQueueProvider.mo1933get(), this.pipOptionalProvider.mo1933get(), this.splitScreenOptionalProvider.mo1933get(), this.recentsOptionalProvider.mo1933get(), DoubleCheck.lazy(this.statusBarLazyProvider), this.shadeControllerProvider.mo1933get(), this.notificationRemoteInputManagerProvider.mo1933get(), this.notificationShadeDepthControllerProvider.mo1933get(), this.systemActionsProvider.mo1933get(), this.mainHandlerProvider.mo1933get(), this.uiEventLoggerProvider.mo1933get(), this.navBarOverlayControllerProvider.mo1933get(), this.configurationControllerProvider.mo1933get(), this.userTrackerProvider.mo1933get());
    }
