...
public final class DependencyProvider_ProvidesBroadcastDispatcherFactory implements Factory<BroadcastDispatcher> {
    ...
    /* renamed from: get */
    public BroadcastDispatcher mo1933get() {
        return providesBroadcastDispatcher(this.module, this.contextProvider.mo1933get(), this.backgroundLooperProvider.mo1933get(), this.backgroundExecutorProvider.mo1933get(), this.dumpManagerProvider.mo1933get(), this.loggerProvider.mo1933get(), this.userTrackerProvider.mo1933get());
    }
