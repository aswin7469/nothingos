...
public final class SystemUIDefaultModule_ProvideBatteryControllerFactory implements Factory<BatteryController> {
    ...
    /* renamed from: get */
    public BatteryController mo1933get() {
        return provideBatteryController(this.contextProvider.mo1933get(), this.enhancedEstimatesProvider.mo1933get(), this.powerManagerProvider.mo1933get(), this.broadcastDispatcherProvider.mo1933get(), this.demoModeControllerProvider.mo1933get(), this.mainHandlerProvider.mo1933get(), this.bgHandlerProvider.mo1933get());
    }
