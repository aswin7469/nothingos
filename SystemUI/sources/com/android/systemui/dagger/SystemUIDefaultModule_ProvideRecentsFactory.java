...
public final class SystemUIDefaultModule_ProvideRecentsFactory implements Factory<Recents> {
    ...
    /* renamed from: get */
    public Recents mo1933get() {
        return provideRecents(this.contextProvider.mo1933get(), this.recentsImplementationProvider.mo1933get(), this.commandQueueProvider.mo1933get());
    }
