...
public final class SystemUIModule_ProvideBubblesManagerFactory implements Factory<Optional<BubblesManager>> {
    ...
    public Optional<BubblesManager> mo1933get() {
        return provideBubblesManager(this.contextProvider.mo1933get(), this.bubblesOptionalProvider.mo1933get(), this.notificationShadeWindowControllerProvider.mo1933get(), this.statusBarStateControllerProvider.mo1933get(), this.shadeControllerProvider.mo1933get(), this.configurationControllerProvider.mo1933get(), this.statusBarServiceProvider.mo1933get(), this.notificationManagerProvider.mo1933get(), this.interruptionStateProvider.mo1933get(), this.zenModeControllerProvider.mo1933get(), this.notifUserManagerProvider.mo1933get(), this.groupManagerProvider.mo1933get(), this.entryManagerProvider.mo1933get(), this.notifPipelineProvider.mo1933get(), this.sysUiStateProvider.mo1933get(), this.featureFlagsProvider.mo1933get(), this.dumpManagerProvider.mo1933get(), this.sysuiMainExecutorProvider.mo1933get());
    }
