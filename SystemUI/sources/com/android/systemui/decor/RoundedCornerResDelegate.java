...
public final class RoundedCornerResDelegate implements Dumpable {
    ...
    private final void reloadRes() {
        ...
        this.hasBottom = z;
        this.topRoundedDrawable = getDrawable(displayUniqueIdConfigIndex, C1894R.array.config_roundedCornerTopDrawableArray, C1894R.C1896drawable.rounded_corner_top);
        this.bottomRoundedDrawable = getDrawable(displayUniqueIdConfigIndex, C1894R.array.config_roundedCornerBottomDrawableArray, C1894R.C1896drawable.rounded_corner_bottom);
    }
