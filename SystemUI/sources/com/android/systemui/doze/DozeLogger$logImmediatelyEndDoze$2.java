...
final class DozeLogger$logImmediatelyEndDoze$2 extends Lambda implements Function1<LogMessage, String> {
    public static final DozeLogger$logImmediatelyEndDoze$2 INSTANCE = new DozeLogger$logImmediatelyEndDoze$2();

    DozeLogger$logImmediatelyEndDoze$2() {
        super(1);
    }

    public final String invoke(LogMessage logMessage) {
        Intrinsics.checkNotNullParameter(logMessage, "$this$log");
        return "Doze immediately ended due to " + logMessage.getStr1();
    }
}
