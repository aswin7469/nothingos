...
public final class DozeUi_Factory implements Factory<DozeUi> {
    ...
    /* renamed from: get */
    public DozeUi mo1933get() {
        return newInstance(this.contextProvider.mo1933get(), this.alarmManagerProvider.mo1933get(), this.wakeLockProvider.mo1933get(), this.hostProvider.mo1933get(), this.handlerProvider.mo1933get(), this.paramsProvider.mo1933get(), this.keyguardUpdateMonitorProvider.mo1933get(), this.dozeLogProvider.mo1933get(), this.tunerServiceProvider.mo1933get(), DoubleCheck.lazy(this.statusBarStateControllerProvider), this.configurationControllerProvider.mo1933get());
    }
