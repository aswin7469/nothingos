...
public final class DozeModule_ProvidesDozeMachinePartsFactory implements Factory<DozeMachine.Part[]> {
    ...
    private final Provider<DozeSuppressor> dozeSuppressorProvider;
    ...
    public DozeMachine.Part[] get() {
        return providesDozeMachineParts(this.dozePauserProvider.get(), this.dozeFalsingManagerAdapterProvider.get(), this.dozeTriggersProvider.get(), this.dozeUiProvider.get(), this.dozeScreenStateProvider.get(), this.dozeScreenBrightnessProvider.get(), this.dozeWallpaperStateProvider.get(), this.dozeDockHandlerProvider.get(), this.dozeAuthRemoverProvider.get(), this.dozeSuppressorProvider.get());
    }
    ...
    public static DozeModule_ProvidesDozeMachinePartsFactory create(Provider<DozePauser> provider, Provider<DozeFalsingManagerAdapter> provider2, Provider<DozeTriggers> provider3, Provider<DozeUi> provider4, Provider<DozeScreenState> provider5, Provider<DozeScreenBrightness> provider6, Provider<DozeWallpaperState> provider7, Provider<DozeDockHandler> provider8, Provider<DozeAuthRemover> provider9, Provider<DozeSuppressor> provider10) {
        return new DozeModule_ProvidesDozeMachinePartsFactory(provider, provider2, provider3, provider4, provider5, provider6, provider7, provider8, provider9, provider10);
    }
    ...
    public static DozeMachine.Part[] providesDozeMachineParts(DozePauser dozePauser, DozeFalsingManagerAdapter dozeFalsingManagerAdapter, DozeTriggers dozeTriggers, DozeUi dozeUi, DozeScreenState dozeScreenState, DozeScreenBrightness dozeScreenBrightness, DozeWallpaperState dozeWallpaperState, DozeDockHandler dozeDockHandler, DozeAuthRemover dozeAuthRemover, DozeSuppressor dozeSuppressor) {
        return (DozeMachine.Part[]) Preconditions.checkNotNullFromProvides(DozeModule.providesDozeMachineParts(dozePauser, dozeFalsingManagerAdapter, dozeTriggers, dozeUi, dozeScreenState, dozeScreenBrightness, dozeWallpaperState, dozeDockHandler, dozeAuthRemover, dozeSuppressor));
    }
}
