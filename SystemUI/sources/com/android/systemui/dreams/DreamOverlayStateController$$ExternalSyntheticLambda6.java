...
public final /* synthetic */ class DreamOverlayStateController$$ExternalSyntheticLambda6 implements Runnable {
    ...
    public /* synthetic */ DreamOverlayStateController$$ExternalSyntheticLambda6(DreamOverlayStateController dreamOverlayStateController, int i) {
        this.f$0 = dreamOverlayStateController;
        this.f$1 = i;
    }

    public final void run() {
        this.f$0.mo32528x8393206b(this.f$1);
    }
}
