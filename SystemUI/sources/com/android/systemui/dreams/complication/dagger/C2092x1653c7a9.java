...
public final class C2092x1653c7a9 implements Factory<ComplicationCollectionViewModel> {
    ...
    public C2092x1653c7a9(Provider<ViewModelStore> provider, Provider<ComplicationCollectionViewModel> provider2) {
    ...
    public static C2092x1653c7a9 create(Provider<ViewModelStore> provider, Provider<ComplicationCollectionViewModel> provider2) {
        return new C2092x1653c7a9(provider, provider2);
    }
