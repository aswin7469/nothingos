...
public final class C2096x56e4d2ac implements Factory<ComplicationLayoutParams> {
    public ComplicationLayoutParams get() {
        return provideLayoutParams();
    }

    public static C2096x56e4d2ac create() {
    ...
    private static final class InstanceHolder {
        ...
        public static final C2096x56e4d2ac INSTANCE = new C2096x56e4d2ac();
