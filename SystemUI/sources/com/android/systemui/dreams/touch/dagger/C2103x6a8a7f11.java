...
public final class C2103x6a8a7f11 implements Factory<FlingAnimationUtils> {
    private final Provider<FlingAnimationUtils.Builder> flingAnimationUtilsBuilderProvider;

    public C2103x6a8a7f11(Provider<FlingAnimationUtils.Builder> provider) {
    ...
    public static C2103x6a8a7f11 create(Provider<FlingAnimationUtils.Builder> provider) {
        return new C2103x6a8a7f11(provider);
    }
