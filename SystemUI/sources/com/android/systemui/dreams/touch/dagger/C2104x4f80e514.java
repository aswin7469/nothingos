...
public final class C2104x4f80e514 implements Factory<FlingAnimationUtils> {
    private final Provider<FlingAnimationUtils.Builder> flingAnimationUtilsBuilderProvider;

    public C2104x4f80e514(Provider<FlingAnimationUtils.Builder> provider) {
    ...
    public static C2104x4f80e514 create(Provider<FlingAnimationUtils.Builder> provider) {
        return new C2104x4f80e514(provider);
    }
