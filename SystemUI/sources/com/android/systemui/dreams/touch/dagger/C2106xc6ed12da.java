...
public final class C2106xc6ed12da implements Factory<DreamTouchHandler> {
    private final Provider<HideComplicationTouchHandler> touchHandlerProvider;

    public C2106xc6ed12da(Provider<HideComplicationTouchHandler> provider) {
    ...
    public static C2106xc6ed12da create(Provider<HideComplicationTouchHandler> provider) {
        return new C2106xc6ed12da(provider);
    }
