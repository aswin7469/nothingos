...
public final class SysPropBooleanFlag implements SysPropFlag<Boolean> {
    ...
    public Boolean getDefault() {
        return Boolean.valueOf(this.f945default);
    }
