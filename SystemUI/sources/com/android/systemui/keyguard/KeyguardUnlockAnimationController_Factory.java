...
public final class KeyguardUnlockAnimationController_Factory implements Factory<KeyguardUnlockAnimationController> {
    ...
    /* renamed from: get */
    public KeyguardUnlockAnimationController mo1933get() {
        return newInstance(this.contextProvider.mo1933get(), this.keyguardStateControllerProvider.mo1933get(), DoubleCheck.lazy(this.keyguardViewMediatorProvider), this.keyguardViewControllerProvider.mo1933get(), this.smartspaceTransitionControllerProvider.mo1933get(), this.featureFlagsProvider.mo1933get());
    }
