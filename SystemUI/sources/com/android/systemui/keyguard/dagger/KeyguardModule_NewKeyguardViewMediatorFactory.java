...
public final class KeyguardModule_NewKeyguardViewMediatorFactory implements Factory<KeyguardViewMediator> {
    ...
    /* renamed from: get */
    public KeyguardViewMediator mo1933get() {
        return newKeyguardViewMediator(this.contextProvider.mo1933get(), this.falsingCollectorProvider.mo1933get(), this.lockPatternUtilsProvider.mo1933get(), this.broadcastDispatcherProvider.mo1933get(), DoubleCheck.lazy(this.statusBarKeyguardViewManagerLazyProvider), this.dismissCallbackRegistryProvider.mo1933get(), this.updateMonitorProvider.mo1933get(), this.dumpManagerProvider.mo1933get(), this.powerManagerProvider.mo1933get(), this.trustManagerProvider.mo1933get(), this.userSwitcherControllerProvider.mo1933get(), this.uiBgExecutorProvider.mo1933get(), this.deviceConfigProvider.mo1933get(), this.navigationModeControllerProvider.mo1933get(), this.keyguardDisplayManagerProvider.mo1933get(), this.dozeParametersProvider.mo1933get(), this.statusBarStateControllerProvider.mo1933get(), this.keyguardStateControllerProvider.mo1933get(), DoubleCheck.lazy(this.keyguardUnlockAnimationControllerProvider), this.unlockedScreenOffAnimationControllerProvider.mo1933get(), DoubleCheck.lazy(this.notificationShadeDepthControllerProvider));
    }
