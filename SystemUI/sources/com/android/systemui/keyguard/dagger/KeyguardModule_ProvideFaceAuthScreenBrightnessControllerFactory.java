...
public final class KeyguardModule_ProvideFaceAuthScreenBrightnessControllerFactory implements Factory<Optional<FaceAuthScreenBrightnessController>> {
    ...
    public Optional<FaceAuthScreenBrightnessController> mo1933get() {
        return provideFaceAuthScreenBrightnessController(this.contextProvider.mo1933get(), this.notificationShadeWindowControllerProvider.mo1933get(), this.resourcesProvider.mo1933get(), this.handlerProvider.mo1933get(), this.faceManagerProvider.mo1933get(), this.packageManagerProvider.mo1933get(), this.keyguardUpdateMonitorProvider.mo1933get(), this.globalSettingProvider.mo1933get(), this.systemSettingsProvider.mo1933get(), this.dumpManagerProvider.mo1933get());
    }
