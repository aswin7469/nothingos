...
public final class KeyguardModule_ProvideKeyguardLiftControllerFactory implements Factory<KeyguardLiftController> {
    ...
    /* renamed from: get */
    public KeyguardLiftController mo1933get() {
        return provideKeyguardLiftController(this.contextProvider.mo1933get(), this.statusBarStateControllerProvider.mo1933get(), this.asyncSensorManagerProvider.mo1933get(), this.keyguardUpdateMonitorProvider.mo1933get(), this.dumpManagerProvider.mo1933get());
    }
