...
public final class GutsViewHolder {
    ...
    public GutsViewHolder(View view) {
        ...
        View requireViewById = view.requireViewById(C1894R.C1898id.remove_text);
        ...
        View requireViewById2 = view.requireViewById(C1894R.C1898id.cancel);
        Intrinsics.checkNotNullExpressionValue(requireViewById2, "itemView.requireViewById(R.id.cancel)");
        this.cancel = requireViewById2;
        View requireViewById3 = view.requireViewById(C1894R.C1898id.cancel_text);
        ...
        View requireViewById4 = view.requireViewById(C1894R.C1898id.dismiss);
        ...
        View requireViewById5 = view.requireViewById(C1894R.C1898id.dismiss_text);
        ...
        View requireViewById6 = view.requireViewById(C1894R.C1898id.settings);
    ...
    public static final void m2766marquee$lambda0(GutsViewHolder gutsViewHolder, boolean z) {
    ...
    @Metadata(mo65042d1 = {"\u0000\u0018\n\u0002\u0018\u0002\n\u0002\u0010\u0000\n\u0002\b\u0002\n\u0002\u0010\"\n\u0002\u0010\b\n\u0002\b\u0003\b\u0003\u0018\u00002\u00020\u0001B\u0007\b\u0002¢\u0006\u0002\u0010\u0002R\u0017\u0010\u0003\u001a\b\u0012\u0004\u0012\u00020\u00050\u0004¢\u0006\b\n\u0000\u001a\u0004\b\u0006\u0010\u0007¨\u0006\b"}, mo65043d2 = {"Lcom/android/systemui/media/GutsViewHolder$Companion;", "", "()V", "ids", "", "", "getIds", "()Ljava/util/Set;", "SystemUI_nothingRelease"}, mo65044k = 1, mo65045mv = {1, 6, 0}, mo65047xi = 48)
    /* compiled from: GutsViewHolder.kt */
