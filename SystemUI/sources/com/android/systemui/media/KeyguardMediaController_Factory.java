...
public final class KeyguardMediaController_Factory implements Factory<KeyguardMediaController> {
    ...
    /* renamed from: get */
    public KeyguardMediaController mo1933get() {
        return newInstance(this.mediaHostProvider.mo1933get(), this.bypassControllerProvider.mo1933get(), this.statusBarStateControllerProvider.mo1933get(), this.notifLockscreenUserManagerProvider.mo1933get(), this.featureFlagsProvider.mo1933get(), this.contextProvider.mo1933get(), this.configurationControllerProvider.mo1933get());
    }
