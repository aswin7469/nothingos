...
public final class MediaCarouselController implements Dumpable {
    ...
    public MediaCarouselController(Context context2, Provider<MediaControlPanel> provider, VisualStabilityProvider visualStabilityProvider2, MediaHostStatesManager mediaHostStatesManager2, ActivityStarter activityStarter2, SystemClock systemClock2, @Main DelayableExecutor delayableExecutor, MediaDataManager mediaDataManager, ConfigurationController configurationController, FalsingCollector falsingCollector, FalsingManager falsingManager, DumpManager dumpManager, MediaUiEventLogger mediaUiEventLogger, MediaCarouselControllerLogger mediaCarouselControllerLogger) {
        ...
        View requireViewById = inflateMediaCarousel.requireViewById(C1894R.C1898id.media_carousel_scroller);
        ...
        View requireViewById2 = inflateMediaCarousel.requireViewById(C1894R.C1898id.media_page_indicator);
        ...
        View requireViewById3 = mediaScrollView2.requireViewById(C1894R.C1898id.media_carousel);
    ...
    public static final void m2774_init_$lambda1(MediaCarouselController mediaCarouselController) {
    ...
    public static final void m2775_init_$lambda2(MediaCarouselController mediaCarouselController, View view, int i, int i2, int i3, int i4, int i5, int i6, int i7, int i8) {
        Intrinsics.checkNotNullParameter(mediaCarouselController, "this$0");
    ...
    public final void inflateSettingsButton() {
        View inflate = LayoutInflater.from(this.context).inflate(C1894R.layout.media_carousel_settings_button, this.mediaFrame, false);
        if (inflate != null) {
    ...
    public static final void m2776inflateSettingsButton$lambda3(MediaCarouselController mediaCarouselController, View view) {
        Intrinsics.checkNotNullParameter(mediaCarouselController, "this$0");
    ...
    private final ViewGroup inflateMediaCarousel() {
        View inflate = LayoutInflater.from(this.context).inflate(C1894R.layout.media_carousel, new UniqueObjectHostView(this.context), false);
        if (inflate != null) {
    ...
    public final void updatePlayers(boolean z) {
        this.pageIndicator.setTintList(ColorStateList.valueOf(this.context.getColor(C1894R.C1895color.media_paging_indicator)));
    ...
    private final void updateCarouselSize() {
        ...
        L_0x002d:
            ...
            r3 = 2131166901(0x7f0706b5, float:1.794806E38)
