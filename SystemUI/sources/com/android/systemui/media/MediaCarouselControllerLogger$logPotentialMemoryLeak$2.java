...
final class MediaCarouselControllerLogger$logPotentialMemoryLeak$2 extends Lambda implements Function1<LogMessage, String> {
    ...
    MediaCarouselControllerLogger$logPotentialMemoryLeak$2() {
        super(1);
    }
