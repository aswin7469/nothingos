...
public final /* synthetic */ class MediaControlPanel$$ExternalSyntheticLambda6 implements Runnable {
    ...
    public /* synthetic */ MediaControlPanel$$ExternalSyntheticLambda6(MediaControlPanel mediaControlPanel, ColorScheme colorScheme) {
        this.f$0 = mediaControlPanel;
        this.f$1 = colorScheme;
    }

    public final void run() {
        this.f$0.mo33668x371ef810(this.f$1);
    }
}
