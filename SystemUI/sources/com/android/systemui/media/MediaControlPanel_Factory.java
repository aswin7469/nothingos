...
public final class MediaControlPanel_Factory implements Factory<MediaControlPanel> {
    ...
    /* renamed from: get */
    public MediaControlPanel mo1933get() {
        return newInstance(this.contextProvider.mo1933get(), this.backgroundExecutorProvider.mo1933get(), this.activityStarterProvider.mo1933get(), this.mediaViewControllerProvider.mo1933get(), this.seekBarViewModelProvider.mo1933get(), DoubleCheck.lazy(this.mediaDataManagerProvider), this.keyguardDismissUtilProvider.mo1933get(), this.mediaOutputDialogFactoryProvider.mo1933get(), this.mediaCarouselControllerProvider.mo1933get());
    }
