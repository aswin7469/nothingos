...
public final class MediaHierarchyManager {
        ...
        sysuiStatusBarStateController.addCallback(new StatusBarStateController.StateListener(this) {
            ...
            public void onDozeAmountChanged(float r3, float r4) {
                ...
                L_0x001b:
                    ...
                    return
                */
                throw new UnsupportedOperationException("Method not decompiled: com.android.systemui.media.MediaHierarchyManager.C21992.onDozeAmountChanged(float, float):void");
            }
    ...
    public static final void m2814animator$lambda1$lambda0(MediaHierarchyManager mediaHierarchyManager, ValueAnimator valueAnimator, ValueAnimator valueAnimator2) {
        float f;
    ...
    public static final void m2815startAnimation$lambda2(MediaHierarchyManager mediaHierarchyManager) {
        Intrinsics.checkNotNullParameter(mediaHierarchyManager, "this$0");
    ...
    public final void updateConfiguration() {
        this.distanceForFullShadeTransition = this.context.getResources().getDimensionPixelSize(C1894R.dimen.lockscreen_shade_media_transition_distance);
    ...
    private final Pair<Long, Long> getAnimationParams(int i, int i2) {
        ...
        return TuplesKt.m1802to(Long.valueOf(j), Long.valueOf(j2));
    }
    ...
    @Metadata(mo65042d1 = {"\u0000\u0014\n\u0002\u0018\u0002\n\u0002\u0010\u0000\n\u0002\b\u0002\n\u0002\u0010\b\n\u0002\b\u0007\b\u0003\u0018\u00002\u00020\u0001B\u0007\b\u0002¢\u0006\u0002\u0010\u0002R\u000e\u0010\u0003\u001a\u00020\u0004XT¢\u0006\u0002\n\u0000R\u000e\u0010\u0005\u001a\u00020\u0004XT¢\u0006\u0002\n\u0000R\u000e\u0010\u0006\u001a\u00020\u0004XT¢\u0006\u0002\n\u0000R\u000e\u0010\u0007\u001a\u00020\u0004XT¢\u0006\u0002\n\u0000R\u000e\u0010\b\u001a\u00020\u0004XT¢\u0006\u0002\n\u0000R\u000e\u0010\t\u001a\u00020\u0004XT¢\u0006\u0002\n\u0000R\u000e\u0010\n\u001a\u00020\u0004XT¢\u0006\u0002\n\u0000¨\u0006\u000b"}, mo65043d2 = {"Lcom/android/systemui/media/MediaHierarchyManager$Companion;", "", "()V", "IN_OVERLAY", "", "LOCATION_DREAM_OVERLAY", "LOCATION_LOCKSCREEN", "LOCATION_QQS", "LOCATION_QS", "TRANSFORMATION_TYPE_FADE", "TRANSFORMATION_TYPE_TRANSITION", "SystemUI_nothingRelease"}, mo65044k = 1, mo65045mv = {1, 6, 0}, mo65047xi = 48)
    /* compiled from: MediaHierarchyManager.kt */
