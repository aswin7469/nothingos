...
public final class MediaPlayerData$special$$inlined$thenByDescending$1<T> implements Comparator {
    ...
    public final int compare(T t, T t2) {
        ...
        boolean z = true;
        Comparable valueOf = Boolean.valueOf(Intrinsics.areEqual((Object) mediaSortKey.getData().isPlaying(), (Object) true) && mediaSortKey.getData().getPlaybackLocation() == 1);
        MediaPlayerData.MediaSortKey mediaSortKey2 = (MediaPlayerData.MediaSortKey) t;
        if (!Intrinsics.areEqual((Object) mediaSortKey2.getData().isPlaying(), (Object) true) || mediaSortKey2.getData().getPlaybackLocation() != 1) {
            z = false;
        }
