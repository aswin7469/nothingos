...
public final class MediaPlayerData$special$$inlined$thenByDescending$3<T> implements Comparator {
    ...
    public final int compare(T t, T t2) {
        ...
        boolean z = true;
        Comparable valueOf = Boolean.valueOf(MediaPlayerData.INSTANCE.getShouldPrioritizeSs$SystemUI_nothingRelease() == ((MediaPlayerData.MediaSortKey) t2).isSsMediaRec());
        if (MediaPlayerData.INSTANCE.getShouldPrioritizeSs$SystemUI_nothingRelease() != ((MediaPlayerData.MediaSortKey) t).isSsMediaRec()) {
            z = false;
        }
