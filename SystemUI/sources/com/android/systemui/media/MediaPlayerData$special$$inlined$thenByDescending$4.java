...
public final class MediaPlayerData$special$$inlined$thenByDescending$4<T> implements Comparator {
    ...
    public final int compare(T t, T t2) {
        ...
        return compare != 0 ? compare : ComparisonsKt.compareValues(Boolean.valueOf(!((MediaPlayerData.MediaSortKey) t2).getData().getResumption()), Boolean.valueOf(!((MediaPlayerData.MediaSortKey) t).getData().getResumption()));
    }
}
