...
final class MediaTimeoutLogger$logCancelIgnored$2 extends Lambda implements Function1<LogMessage, String> {
    public static final MediaTimeoutLogger$logCancelIgnored$2 INSTANCE = new MediaTimeoutLogger$logCancelIgnored$2();

    MediaTimeoutLogger$logCancelIgnored$2() {
        super(1);
    }

    public final String invoke(LogMessage logMessage) {
        Intrinsics.checkNotNullParameter(logMessage, "$this$log");
        return "cancellation already exists for " + logMessage.getStr1();
    }
}
