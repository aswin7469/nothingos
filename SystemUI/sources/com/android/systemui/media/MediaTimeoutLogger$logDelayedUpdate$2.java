...
final class MediaTimeoutLogger$logDelayedUpdate$2 extends Lambda implements Function1<LogMessage, String> {
    public static final MediaTimeoutLogger$logDelayedUpdate$2 INSTANCE = new MediaTimeoutLogger$logDelayedUpdate$2();

    MediaTimeoutLogger$logDelayedUpdate$2() {
        super(1);
    }

    public final String invoke(LogMessage logMessage) {
        Intrinsics.checkNotNullParameter(logMessage, "$this$log");
        return "deliver delayed playback state for " + logMessage.getStr1();
    }
}
