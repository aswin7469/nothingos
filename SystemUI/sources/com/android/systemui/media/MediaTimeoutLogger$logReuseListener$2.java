...
final class MediaTimeoutLogger$logReuseListener$2 extends Lambda implements Function1<LogMessage, String> {
    public static final MediaTimeoutLogger$logReuseListener$2 INSTANCE = new MediaTimeoutLogger$logReuseListener$2();

    MediaTimeoutLogger$logReuseListener$2() {
        super(1);
    }

    public final String invoke(LogMessage logMessage) {
        Intrinsics.checkNotNullParameter(logMessage, "$this$log");
        return "reuse listener: " + logMessage.getStr1();
    }
}
