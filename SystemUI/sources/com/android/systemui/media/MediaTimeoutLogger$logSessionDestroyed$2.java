...
final class MediaTimeoutLogger$logSessionDestroyed$2 extends Lambda implements Function1<LogMessage, String> {
    public static final MediaTimeoutLogger$logSessionDestroyed$2 INSTANCE = new MediaTimeoutLogger$logSessionDestroyed$2();

    MediaTimeoutLogger$logSessionDestroyed$2() {
        super(1);
    }

    public final String invoke(LogMessage logMessage) {
        Intrinsics.checkNotNullParameter(logMessage, "$this$log");
        return "session destroyed " + logMessage.getStr1();
    }
}
