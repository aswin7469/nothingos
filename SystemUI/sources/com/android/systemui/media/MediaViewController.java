...
public final class MediaViewController {
    ...
    @Metadata(mo64986d1 = {"\u0000\f\n\u0002\u0018\u0002\n\u0002\u0010\u0010\n\u0002\b\u0004\b\u0001\u0018\u00002\b\u0012\u0004\u0012\u00020\u00000\u0001B\u0007\b\u0002¢\u0006\u0002\u0010\u0002j\u0002\b\u0003j\u0002\b\u0004¨\u0006\u0005"}, mo64987d2 = {"Lcom/android/systemui/media/MediaViewController$TYPE;", "", "(Ljava/lang/String;I)V", "PLAYER", "RECOMMENDATION", "SystemUI_nothingRelease"}, mo64988k = 1, mo64989mv = {1, 6, 0}, mo64991xi = 48)
    /* compiled from: MediaViewController.kt */
    public enum TYPE {
        PLAYER,
        RECOMMENDATION
    ...
    @Metadata(mo64986d1 = {"\u0000\u0012\n\u0002\u0018\u0002\n\u0002\u0010\u0000\n\u0002\b\u0002\n\u0002\u0010\t\n\u0000\b\u0003\u0018\u00002\u00020\u0001B\u0007\b\u0002¢\u0006\u0002\u0010\u0002R\u0010\u0010\u0003\u001a\u00020\u00048\u0006XD¢\u0006\u0002\n\u0000¨\u0006\u0005"}, mo64987d2 = {"Lcom/android/systemui/media/MediaViewController$Companion;", "", "()V", "GUTS_ANIMATION_DURATION", "", "SystemUI_nothingRelease"}, mo64988k = 1, mo64989mv = {1, 6, 0}, mo64991xi = 48)
    /* compiled from: MediaViewController.kt */
    ...
    private final void updateMediaViewControllerType(TYPE type2) {
        ...
        if (i == 1) {
            this.collapsedLayout.load(this.context, (int) C1893R.C1901xml.media_session_collapsed);
            this.expandedLayout.load(this.context, (int) C1893R.C1901xml.media_session_expanded);
        } else if (i == 2) {
            this.collapsedLayout.load(this.context, (int) C1893R.C1901xml.media_recommendation_collapsed);
            this.expandedLayout.load(this.context, (int) C1893R.C1901xml.media_recommendation_expanded);
        }
        refreshState();
    }
