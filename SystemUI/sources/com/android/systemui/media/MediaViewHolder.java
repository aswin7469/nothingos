...
public final class MediaViewHolder {
    ...
    public MediaViewHolder(View view) {
        ...
        this.albumView = (ImageView) view.requireViewById(C1894R.C1898id.album_art);
        this.appIcon = (ImageView) view.requireViewById(C1894R.C1898id.icon);
        this.titleText = (TextView) view.requireViewById(C1894R.C1898id.header_title);
        this.artistText = (TextView) view.requireViewById(C1894R.C1898id.header_artist);
        this.seamless = (ViewGroup) view.requireViewById(C1894R.C1898id.media_seamless);
        this.seamlessIcon = (ImageView) view.requireViewById(C1894R.C1898id.media_seamless_image);
        this.seamlessText = (TextView) view.requireViewById(C1894R.C1898id.media_seamless_text);
        this.seamlessButton = view.requireViewById(C1894R.C1898id.media_seamless_button);
        this.seekBar = (SeekBar) view.requireViewById(C1894R.C1898id.media_progress_bar);
        View requireViewById = view.requireViewById(C1894R.C1898id.media_scrubbing_elapsed_time);
        ...
        View requireViewById2 = view.requireViewById(C1894R.C1898id.media_scrubbing_total_time);
        ...
        this.actionPlayPause = (ImageButton) view.requireViewById(C1894R.C1898id.actionPlayPause);
        this.actionNext = (ImageButton) view.requireViewById(C1894R.C1898id.actionNext);
        this.actionPrev = (ImageButton) view.requireViewById(C1894R.C1898id.actionPrev);
        this.action0 = (ImageButton) view.requireViewById(C1894R.C1898id.action0);
        this.action1 = (ImageButton) view.requireViewById(C1894R.C1898id.action1);
        this.action2 = (ImageButton) view.requireViewById(C1894R.C1898id.action2);
        this.action3 = (ImageButton) view.requireViewById(C1894R.C1898id.action3);
        this.action4 = (ImageButton) view.requireViewById(C1894R.C1898id.action4);
        this.actionsTopBarrier = (Barrier) view.requireViewById(C1894R.C1898id.media_action_barrier_top);
    }
    ...
    @Metadata(mo65042d1 = {"\u0000*\n\u0002\u0018\u0002\n\u0002\u0010\u0000\n\u0002\b\u0002\n\u0002\u0010\"\n\u0002\u0010\b\n\u0002\b\u0007\n\u0002\u0018\u0002\n\u0000\n\u0002\u0018\u0002\n\u0000\n\u0002\u0018\u0002\n\u0000\b\u0003\u0018\u00002\u00020\u0001B\u0007\b\u0002¢\u0006\u0002\u0010\u0002J\u0018\u0010\f\u001a\u00020\r2\u0006\u0010\u000e\u001a\u00020\u000f2\u0006\u0010\u0010\u001a\u00020\u0011H\u0007R\u0017\u0010\u0003\u001a\b\u0012\u0004\u0012\u00020\u00050\u0004¢\u0006\b\n\u0000\u001a\u0004\b\u0006\u0010\u0007R\u0017\u0010\b\u001a\b\u0012\u0004\u0012\u00020\u00050\u0004¢\u0006\b\n\u0000\u001a\u0004\b\t\u0010\u0007R\u0017\u0010\n\u001a\b\u0012\u0004\u0012\u00020\u00050\u0004¢\u0006\b\n\u0000\u001a\u0004\b\u000b\u0010\u0007¨\u0006\u0012"}, mo65043d2 = {"Lcom/android/systemui/media/MediaViewHolder$Companion;", "", "()V", "controlsIds", "", "", "getControlsIds", "()Ljava/util/Set;", "expandedBottomActionIds", "getExpandedBottomActionIds", "genericButtonIds", "getGenericButtonIds", "create", "Lcom/android/systemui/media/MediaViewHolder;", "inflater", "Landroid/view/LayoutInflater;", "parent", "Landroid/view/ViewGroup;", "SystemUI_nothingRelease"}, mo65044k = 1, mo65045mv = {1, 6, 0}, mo65047xi = 48)
    /* compiled from: MediaViewHolder.kt */
    public static final class Companion {
        ...
        public final MediaViewHolder create(LayoutInflater layoutInflater, ViewGroup viewGroup) {
            ...
            View inflate = layoutInflater.inflate(C1894R.layout.media_session_view, viewGroup, false);
    ...
    static {
        Integer valueOf = Integer.valueOf((int) C1894R.C1898id.icon);
        Integer valueOf2 = Integer.valueOf((int) C1894R.C1898id.actionNext);
        Integer valueOf3 = Integer.valueOf((int) C1894R.C1898id.actionPrev);
        Integer valueOf4 = Integer.valueOf((int) C1894R.C1898id.action0);
        Integer valueOf5 = Integer.valueOf((int) C1894R.C1898id.action1);
        Integer valueOf6 = Integer.valueOf((int) C1894R.C1898id.action2);
        Integer valueOf7 = Integer.valueOf((int) C1894R.C1898id.action3);
        Integer valueOf8 = Integer.valueOf((int) C1894R.C1898id.action4);
        Integer valueOf9 = Integer.valueOf((int) C1894R.C1898id.media_scrubbing_elapsed_time);
        Integer valueOf10 = Integer.valueOf((int) C1894R.C1898id.media_scrubbing_total_time);
        controlsIds = SetsKt.setOf(valueOf, Integer.valueOf((int) C1894R.C1898id.app_name), Integer.valueOf((int) C1894R.C1898id.header_title), Integer.valueOf((int) C1894R.C1898id.header_artist), Integer.valueOf((int) C1894R.C1898id.media_seamless), Integer.valueOf((int) C1894R.C1898id.media_progress_bar), Integer.valueOf((int) C1894R.C1898id.actionPlayPause), valueOf2, valueOf3, valueOf4, valueOf5, valueOf6, valueOf7, valueOf8, valueOf, valueOf9, valueOf10);
