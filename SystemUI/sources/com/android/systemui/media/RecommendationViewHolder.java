...
public final class RecommendationViewHolder {
    ...
    private RecommendationViewHolder(View view) {
        ...
        listOf = CollectionsKt__CollectionsKt.listOf((Object[]) new ImageView[]{(ImageView) requireViewById, (ImageView) requireViewById2, (ImageView) requireViewById3, (ImageView) requireViewById4, (ImageView) requireViewById5, (ImageView) requireViewById6});
        this.mediaCoverItems = listOf;
        ...
        listOf2 = CollectionsKt__CollectionsKt.listOf((Object[]) new ViewGroup[]{(ViewGroup) requireViewById7, (ViewGroup) requireViewById8, (ViewGroup) requireViewById9, (ViewGroup) requireViewById10, (ViewGroup) requireViewById11, (ViewGroup) requireViewById12});
        this.mediaCoverContainers = listOf2;
        listOf3 = CollectionsKt__CollectionsKt.listOf((Object[]) new Integer[]{Integer.valueOf(i), Integer.valueOf(i2), Integer.valueOf(i3), Integer.valueOf(i4), Integer.valueOf(i5), Integer.valueOf(i6)});
        this.mediaCoverItemsResIds = listOf3;
        listOf4 = CollectionsKt__CollectionsKt.listOf((Object[]) new Integer[]{Integer.valueOf(i7), Integer.valueOf(i8), Integer.valueOf(i9), Integer.valueOf(i10), Integer.valueOf(i11), Integer.valueOf(i12)});
        this.mediaCoverContainersResIds = listOf4;
    ...
    public final void marquee(final boolean z, long j) {
        this.longPressText.getHandler().postDelayed(new Runnable() { // from class: com.android.systemui.media.RecommendationViewHolder$marquee$1
            @Override // java.lang.Runnable
            public final void run() {
                RecommendationViewHolder.this.getLongPressText().setSelected(z);
            }
        }, j);
    }
    ...
    public static final class Companion {
        ...
        @NotNull
        public final RecommendationViewHolder create(@NotNull LayoutInflater inflater, @NotNull ViewGroup parent) {
            Intrinsics.checkNotNullParameter(inflater, "inflater");
            Intrinsics.checkNotNullParameter(parent, "parent");
            View itemView = inflater.inflate(R$layout.media_smartspace_recommendations, parent, false);
            itemView.setLayoutDirection(3);
            Intrinsics.checkNotNullExpressionValue(itemView, "itemView");
            return new RecommendationViewHolder(itemView, null);
        }
