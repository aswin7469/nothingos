...
public class SeekBarObserver implements Observer<SeekBarViewModel.Progress> {
    ...
    public SeekBarObserver(MediaViewHolder mediaViewHolder) {
        ...
        this.seekBarEnabledMaxHeight = mediaViewHolder.getSeekBar().getContext().getResources().getDimensionPixelSize(C1893R.dimen.qs_media_enabled_seekbar_height);
        this.seekBarDisabledHeight = mediaViewHolder.getSeekBar().getContext().getResources().getDimensionPixelSize(C1893R.dimen.qs_media_disabled_seekbar_height);
        this.seekBarEnabledVerticalPadding = mediaViewHolder.getSeekBar().getContext().getResources().getDimensionPixelSize(C1893R.dimen.qs_media_session_enabled_seekbar_vertical_padding);
        this.seekBarDisabledVerticalPadding = mediaViewHolder.getSeekBar().getContext().getResources().getDimensionPixelSize(C1893R.dimen.qs_media_session_disabled_seekbar_vertical_padding);
        float dimensionPixelSize = (float) mediaViewHolder.getSeekBar().getContext().getResources().getDimensionPixelSize(C1893R.dimen.qs_media_seekbar_progress_wavelength);
        float dimensionPixelSize2 = (float) mediaViewHolder.getSeekBar().getContext().getResources().getDimensionPixelSize(C1893R.dimen.qs_media_seekbar_progress_amplitude);
        float dimensionPixelSize3 = (float) mediaViewHolder.getSeekBar().getContext().getResources().getDimensionPixelSize(C1893R.dimen.qs_media_seekbar_progress_phase);
        float dimensionPixelSize4 = (float) mediaViewHolder.getSeekBar().getContext().getResources().getDimensionPixelSize(C1893R.dimen.qs_media_seekbar_progress_stroke_width);
    ...
    @Metadata(mo64986d1 = {"\u0000\u0014\n\u0002\u0018\u0002\n\u0002\u0010\u0000\n\u0002\b\u0002\n\u0002\u0010\b\n\u0002\b\u0007\b\u0003\u0018\u00002\u00020\u0001B\u0007\b\u0002¢\u0006\u0002\u0010\u0002R\u001c\u0010\u0003\u001a\u00020\u00048\u0006XD¢\u0006\u000e\n\u0000\u0012\u0004\b\u0005\u0010\u0002\u001a\u0004\b\u0006\u0010\u0007R\u001c\u0010\b\u001a\u00020\u00048\u0006XD¢\u0006\u000e\n\u0000\u0012\u0004\b\t\u0010\u0002\u001a\u0004\b\n\u0010\u0007¨\u0006\u000b"}, mo64987d2 = {"Lcom/android/systemui/media/SeekBarObserver$Companion;", "", "()V", "RESET_ANIMATION_DURATION_MS", "", "getRESET_ANIMATION_DURATION_MS$annotations", "getRESET_ANIMATION_DURATION_MS", "()I", "RESET_ANIMATION_THRESHOLD_MS", "getRESET_ANIMATION_THRESHOLD_MS$annotations", "getRESET_ANIMATION_THRESHOLD_MS", "SystemUI_nothingRelease"}, mo64988k = 1, mo64989mv = {1, 6, 0}, mo64991xi = 48)
    /* compiled from: SeekBarObserver.kt */
    ...
    public void onChanged(SeekBarViewModel.Progress progress) {
        ...
        if (elapsedTime != null) {
            ...
            this.holder.getSeekBar().setContentDescription(this.holder.getSeekBar().getContext().getString(C1893R.string.controls_media_seekbar_description, new Object[]{formatElapsedTime2, formatElapsedTime}));
        }
    }
