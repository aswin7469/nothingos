...
public final class MediaModule_ProvidesKeyguardMediaHostFactory implements Factory<MediaHost> {
    ...
    public MediaHost mo1933get() {
        return providesKeyguardMediaHost(this.stateHolderProvider.mo1933get(), this.hierarchyManagerProvider.mo1933get(), this.dataManagerProvider.mo1933get(), this.statesManagerProvider.mo1933get());
    }
