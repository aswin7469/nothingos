...
public final /* synthetic */ class C2232x1869e5b0 implements CompoundButton.OnCheckedChangeListener {
    public final /* synthetic */ MediaOutputGroupAdapter.GroupViewHolder f$0;
    public final /* synthetic */ MediaDevice f$1;

    public /* synthetic */ C2232x1869e5b0(MediaOutputGroupAdapter.GroupViewHolder groupViewHolder, MediaDevice mediaDevice) {
        this.f$0 = groupViewHolder;
        this.f$1 = mediaDevice;
    }

    public final void onCheckedChanged(CompoundButton compoundButton, boolean z) {
        this.f$0.mo34467x27986ca6(this.f$1, compoundButton, z);
    }
}
