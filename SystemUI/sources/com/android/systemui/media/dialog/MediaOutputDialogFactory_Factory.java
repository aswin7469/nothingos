...
public final class MediaOutputDialogFactory_Factory implements Factory<MediaOutputDialogFactory> {
    ...
    /* renamed from: get */
    public MediaOutputDialogFactory mo1933get() {
        return newInstance(this.contextProvider.mo1933get(), this.mediaSessionManagerProvider.mo1933get(), this.lbmProvider.mo1933get(), this.shadeControllerProvider.mo1933get(), this.starterProvider.mo1933get(), this.notificationEntryManagerProvider.mo1933get(), this.uiEventLoggerProvider.mo1933get());
    }
