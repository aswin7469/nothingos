...
public class MediaOutputGroupDialog extends MediaOutputBaseDialog {
    ...
    CharSequence getHeaderSubtitle() {
        ...
        return size == 1 ? ((MediaOutputBaseDialog) this).mContext.getText(R$string.media_output_dialog_single_device) : ((MediaOutputBaseDialog) this).mContext.getString(R$string.media_output_dialog_multiple_devices, Integer.valueOf(size));
    }
