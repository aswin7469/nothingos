...
final class NearbyMediaDevicesLogger$logProviderBinderDied$2 extends Lambda implements Function1<LogMessage, String> {
    ...
    NearbyMediaDevicesLogger$logProviderBinderDied$2() {
        super(1);
    }

    public final String invoke(LogMessage logMessage) {
        Intrinsics.checkNotNullParameter(logMessage, "$this$log");
        return "Provider binder died; total providers = " + logMessage.getInt1();
    }
}
