...
final class NearbyMediaDevicesLogger$logProviderRegistered$2 extends Lambda implements Function1<LogMessage, String> {
    ...
    NearbyMediaDevicesLogger$logProviderRegistered$2() {
        super(1);
    }

    public final String invoke(LogMessage logMessage) {
        Intrinsics.checkNotNullParameter(logMessage, "$this$log");
        return "Provider registered; total providers = " + logMessage.getInt1();
    }
}
