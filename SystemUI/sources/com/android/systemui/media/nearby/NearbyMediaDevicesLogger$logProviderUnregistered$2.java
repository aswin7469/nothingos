...
final class NearbyMediaDevicesLogger$logProviderUnregistered$2 extends Lambda implements Function1<LogMessage, String> {
    ...
    NearbyMediaDevicesLogger$logProviderUnregistered$2() {
        super(1);
    }

    public final String invoke(LogMessage logMessage) {
        Intrinsics.checkNotNullParameter(logMessage, "$this$log");
        return "Provider unregistered; total providers = " + logMessage.getInt1();
    }
}
