...
public abstract class MediaTttChipControllerCommon<T extends ChipInfoCommon> {
    ...
    public static final void m2848displayChip$lambda1(MediaTttChipControllerCommon mediaTttChipControllerCommon) {
    ...
    public final void setIcon$SystemUI_nothingRelease(ViewGroup viewGroup, String str, Drawable drawable, CharSequence charSequence) {
        ...
        CachingIconView requireViewById = viewGroup.requireViewById(C1894R.C1898id.app_icon);
    ...
    private final IconInfo getIconInfo(String str) {
        ...
        String string = this.context.getString(C1894R.string.media_output_dialog_unknown_launch_app_name);
        Intrinsics.checkNotNullExpressionValue(string, "context.getString(R.stri…_unknown_launch_app_name)");
        Drawable drawable = this.context.getResources().getDrawable(C1894R.C1896drawable.ic_cast);
