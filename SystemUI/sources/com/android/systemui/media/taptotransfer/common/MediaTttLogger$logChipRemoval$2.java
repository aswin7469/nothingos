...
final class MediaTttLogger$logChipRemoval$2 extends Lambda implements Function1<LogMessage, String> {
    public static final MediaTttLogger$logChipRemoval$2 INSTANCE = new MediaTttLogger$logChipRemoval$2();

    MediaTttLogger$logChipRemoval$2() {
        super(1);
    }

    public final String invoke(LogMessage logMessage) {
        Intrinsics.checkNotNullParameter(logMessage, "$this$log");
        return "Chip removed due to " + logMessage.getStr1();
    }
}
