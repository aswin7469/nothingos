...
public final class MediaTttChipControllerReceiver extends MediaTttChipControllerCommon<ChipReceiverInfo> {
    ...
    public static final void m2844updateMediaTapToTransferReceiverDisplay$lambda0(MediaTttChipControllerReceiver mediaTttChipControllerReceiver, MediaRoute2Info mediaRoute2Info, CharSequence charSequence, Drawable drawable) {
    ...
    public Integer getIconSize(boolean z) {
        return Integer.valueOf(getContext$SystemUI_nothingRelease().getResources().getDimensionPixelSize(z ? C1893R.dimen.media_ttt_icon_size_receiver : C1893R.dimen.media_ttt_generic_icon_size_receiver));
    }
}
