...
public final class MediaTttChipControllerSender extends MediaTttChipControllerCommon<ChipSenderInfo> {
    ...
    public void updateChipView(ChipSenderInfo chipSenderInfo, ViewGroup viewGroup) {
        ...
        viewGroup.requireViewById(C1894R.C1898id.loading).setVisibility(visibleIfTrue(state.isMidTransfer()));
        View requireViewById = viewGroup.requireViewById(C1894R.C1898id.undo);
        ...
        viewGroup.requireViewById(C1894R.C1898id.failure_icon).setVisibility(visibleIfTrue(state.isTransferFailure()));
    }
