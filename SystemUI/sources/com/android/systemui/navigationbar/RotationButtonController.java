...
public class RotationButtonController {
    ...
    private TaskStackListenerImpl mTaskStackListener = new TaskStackListenerImpl(this, null);
    ...
    /* JADX INFO: Access modifiers changed from: package-private */
    /* renamed from: com.android.systemui.navigationbar.RotationButtonController$1  reason: invalid class name */
    /* loaded from: classes.dex */
    public class AnonymousClass1 extends IRotationWatcher.Stub {
        ...
        public void onRotationChanged(final int i) throws RemoteException {
            RotationButtonController.this.mMainThreadHandler.postAtFrontOfQueue(new Runnable() { // from class: com.android.systemui.navigationbar.RotationButtonController$1$$ExternalSyntheticLambda0
                @Override // java.lang.Runnable
                public final void run() {
    ...
    public class TaskStackListenerImpl extends TaskStackChangeListener {
        ...
        public void onActivityRequestedOrientationChanged(final int i, int i2) {
            Optional.ofNullable(ActivityManagerWrapper.getInstance()).map(RotationButtonController$TaskStackListenerImpl$$ExternalSyntheticLambda1.INSTANCE).ifPresent(new Consumer() { // from class: com.android.systemui.navigationbar.RotationButtonController$TaskStackListenerImpl$$ExternalSyntheticLambda0
