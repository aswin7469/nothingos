...
public class EdgeBackGestureHandler extends CurrentUserTracker implements PluginListener<NavigationEdgeBackPlugin>, ProtoTraceable<SystemUiTraceProto> {
    ...
    private final NavigationEdgeBackPlugin.BackCallback mBackCallback = new NavigationEdgeBackPlugin.BackCallback() { // from class: com.android.systemui.navigationbar.gestural.EdgeBackGestureHandler.5
        ...
        public void triggerBack() {
            if (EdgeBackGestureHandler.this.mNeedInterceptBack) {
                EdgeBackGestureHandler.this.mNeedInterceptBack = false;
                EdgeBackGestureHandler.this.mBackInterceptTime = SystemClock.uptimeMillis();
                EdgeBackGestureHandler.this.showToast();
                return;
            }
            EdgeBackGestureHandler.this.hideToast();
            ...
            if (i == EdgeBackGestureHandler.this.mDisplayId) {
                EdgeBackGestureHandler.this.mMainExecutor.execute(new Runnable() { // from class: com.android.systemui.navigationbar.gestural.EdgeBackGestureHandler$1$$ExternalSyntheticLambda0
                    ...
                    public final void run() {
                        EdgeBackGestureHandler.AnonymousClass1.this.lambda$onSystemGestureExclusionChanged$0(region, region2);
                    }
                });
            }
        }
    ...
    EdgeBackGestureHandler(Context context, OverviewProxyService overviewProxyService, SysUiState sysUiState, PluginManager pluginManager, Executor executor, BroadcastDispatcher broadcastDispatcher, ProtoTracer protoTracer, NavigationModeController navigationModeController, ViewConfiguration viewConfiguration, WindowManager windowManager, IWindowManager iWindowManager, FalsingManager falsingManager) {
        ...
        this.mGameModeHelper = GameModeHelper.getInstance(context);
    }
    ...
    private void updateIsEnabled() {
        ...
        if (!this.mIsEnabled) {
            ...
            DeviceConfig.addOnPropertiesChangedListener("systemui", new Executor() { // from class: com.android.systemui.navigationbar.gestural.EdgeBackGestureHandler$$ExternalSyntheticLambda4
    ...
    private int getBackGesturePredictionsCategory(int i, int i2, int i3) {
        ...
        float predict = this.mBackGestureTfClassifierProvider.predict(new Object[]{new long[]{i5}, new long[]{i}, new long[]{i4}, new long[]{i3}, new long[]{i2}});
    ...
    private boolean isWithinInsets(int i, int i2) {
        ...
        if (i2 >= point.y - this.mBottomGestureHeight) {
            return false;
        }
    ...
    private void onMotionEvent(MotionEvent motionEvent) {
        ...
        if (actionMasked == 0) {
            ...
            boolean z = this.mGameModeHelper.isMistouchPreventionOn() && SystemClock.uptimeMillis() - this.mBackInterceptTime >= 2000;
            this.mNeedInterceptBack = z;
            this.mEdgeBackPlugin.setTriggerBackSilently(z);
            ...
            if (!this.mThresholdCrossed) {
                ...
                if (actionMasked == 5) {
                    ...
                    if (abs2 > abs && abs2 > this.mTouchSlop) {
                        ...
                        if (this.mAllowGesture && !this.mNeedInterceptBack) {
    ...
    public void showToast() {
        this.mMainExecutor.execute(new Runnable() { // from class: com.android.systemui.navigationbar.gestural.EdgeBackGestureHandler$$ExternalSyntheticLambda1
            @Override // java.lang.Runnable
            public final void run() {
                EdgeBackGestureHandler.this.lambda$showToast$0();
            }
        });
    }
    ...
    public void hideToast() {
        this.mMainExecutor.execute(new Runnable() { // from class: com.android.systemui.navigationbar.gestural.EdgeBackGestureHandler$$ExternalSyntheticLambda2
            @Override // java.lang.Runnable
            public final void run() {
                EdgeBackGestureHandler.this.lambda$hideToast$1();
            }
        });
    }

    /* JADX INFO: Access modifiers changed from: private */
    public /* synthetic */ void lambda$hideToast$1() {
