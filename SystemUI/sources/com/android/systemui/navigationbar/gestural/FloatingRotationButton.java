...
public class FloatingRotationButton implements RotationButton {
    ...
    public void updateIcon(int i, int i2) {
        KeyButtonDrawable create = KeyButtonDrawable.create(this.mRotationButtonController.getContext(), i, i2, this.mRotationButtonController.getIconResId(), false, Color.valueOf(Color.red(i2), Color.green(i2), Color.blue(i2), 0.92f));
