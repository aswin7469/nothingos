...
public final class FooterActionsController extends ViewController<FooterActionsView> {
    ...
    public static final void m2901onClickListener$lambda3$lambda2() {
    }
    ...
    public static final void m2902onUserInfoChangedListener$lambda1(FooterActionsController footerActionsController, String str, Drawable drawable, String str2) {
    ...
    public static final void m2900onClickListener$lambda3(FooterActionsController footerActionsController, View view) {
        Intrinsics.checkNotNullParameter(footerActionsController, "this$0");
    ...
    public void onViewAttached() {
        ...
        int dimensionPixelSize = getResources().getDimensionPixelSize(C1894R.dimen.qs_footer_action_inset);
    ...
    public static final void m2903onViewAttached$lambda5(View view, View view2, FooterActionsController footerActionsController, int i) {
        Intrinsics.checkNotNullParameter(footerActionsController, "this$0");
        boolean z = false;
