...
public class ReduceBrightColorsController implements CallbackController<Listener> {
    ...
    @Inject
    public ReduceBrightColorsController(UserTracker userTracker, @Background Handler handler, ColorDisplayManager colorDisplayManager, SecureSettings secureSettings) {
    ...
    public void removeCallback(Listener listener) {
        synchronized (this.mListeners) {
            if (this.mListeners.remove((Object) listener) && this.mListeners.size() == 0) {
