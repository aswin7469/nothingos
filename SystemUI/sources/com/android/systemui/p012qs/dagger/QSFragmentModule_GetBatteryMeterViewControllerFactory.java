...
/* renamed from: com.android.systemui.qs.dagger.QSFragmentModule_GetBatteryMeterViewControllerFactory */
public final class QSFragmentModule_GetBatteryMeterViewControllerFactory implements Factory<BatteryMeterViewController> {
    ...
    public static QSFragmentModule_GetBatteryMeterViewControllerFactory create(Provider<BatteryMeterView> provider, Provider<ConfigurationController> provider2, Provider<TunerService> provider3, Provider<BroadcastDispatcher> provider4, Provider<Handler> provider5, Provider<ContentResolver> provider6, Provider<BatteryController> provider7) {
        return new QSFragmentModule_GetBatteryMeterViewControllerFactory(provider, provider2, provider3, provider4, provider5, provider6, provider7);
    }
    ...
    public static BatteryMeterViewController getBatteryMeterViewController(BatteryMeterView batteryMeterView, ConfigurationController configurationController, TunerService tunerService, BroadcastDispatcher broadcastDispatcher, Handler handler, ContentResolver contentResolver, BatteryController batteryController) {
        return (BatteryMeterViewController) Preconditions.checkNotNullFromProvides(QSFragmentModule.getBatteryMeterViewController(batteryMeterView, configurationController, tunerService, broadcastDispatcher, handler, contentResolver, batteryController));
    }
}
