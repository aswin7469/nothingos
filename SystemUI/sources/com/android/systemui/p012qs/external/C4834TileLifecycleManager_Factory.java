...
public final class C4834TileLifecycleManager_Factory {
    ...
    public C4834TileLifecycleManager_Factory(Provider<Handler> provider, Provider<Context> provider2, Provider<IQSService> provider3, Provider<PackageManagerAdapter> provider4, Provider<BroadcastDispatcher> provider5) {
    ...
    public static C4834TileLifecycleManager_Factory create(Provider<Handler> provider, Provider<Context> provider2, Provider<IQSService> provider3, Provider<PackageManagerAdapter> provider4, Provider<BroadcastDispatcher> provider5) {
        return new C4834TileLifecycleManager_Factory(provider, provider2, provider3, provider4, provider5);
    }
