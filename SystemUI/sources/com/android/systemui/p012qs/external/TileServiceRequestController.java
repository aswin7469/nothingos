...
public final class TileServiceRequestController {
    ...
    @Metadata(mo64986d1 = {"\u0000\u0014\n\u0002\u0018\u0002\n\u0002\u0010\u0000\n\u0002\b\u0002\n\u0002\u0010\b\n\u0002\b\u0004\b\u0003\u0018\u00002\u00020\u0001B\u0007\b\u0002¢\u0006\u0002\u0010\u0002R\u000e\u0010\u0003\u001a\u00020\u0004XT¢\u0006\u0002\n\u0000R\u000e\u0010\u0005\u001a\u00020\u0004XT¢\u0006\u0002\n\u0000R\u000e\u0010\u0006\u001a\u00020\u0004XT¢\u0006\u0002\n\u0000R\u000e\u0010\u0007\u001a\u00020\u0004XT¢\u0006\u0002\n\u0000¨\u0006\b"}, mo64987d2 = {"Lcom/android/systemui/qs/external/TileServiceRequestController$Companion;", "", "()V", "ADD_TILE", "", "DISMISSED", "DONT_ADD_TILE", "TILE_ALREADY_ADDED", "SystemUI_nothingRelease"}, mo64988k = 1, mo64989mv = {1, 6, 0}, mo64991xi = 48)
    ...
    public static final void m2953requestTileAdd$lambda0(TileServiceRequestController tileServiceRequestController, ComponentName componentName, String str, InstanceId instanceId, Consumer consumer, Integer num) {
    ...
    private final SystemUIDialog createDialog(TileRequestDialog.TileData tileData, SingleShotConsumer<Integer> singleShotConsumer) {
        ...
        tileRequestDialog.setPositiveButton(C1893R.string.qs_tile_request_dialog_add, tileServiceRequestController$$ExternalSyntheticLambda0);
        tileRequestDialog.setNegativeButton(C1893R.string.qs_tile_request_dialog_not_add, tileServiceRequestController$$ExternalSyntheticLambda0);
        return invoke;
    }

    /* access modifiers changed from: private */
    /* renamed from: createDialog$lambda-2  reason: not valid java name */
    public static final void m2950createDialog$lambda2(SingleShotConsumer singleShotConsumer, DialogInterface dialogInterface, int i) {
    ...
    public static final void m2951createDialog$lambda5$lambda3(SingleShotConsumer singleShotConsumer, DialogInterface dialogInterface) {
        Intrinsics.checkNotNullParameter(singleShotConsumer, "$responseHandler");
    ...
    public static final void m2952createDialog$lambda5$lambda4(SingleShotConsumer singleShotConsumer, DialogInterface dialogInterface) {
        Intrinsics.checkNotNullParameter(singleShotConsumer, "$responseHandler");
        singleShotConsumer.accept(3);
    }
    ...
    public final class TileServiceRequestCommand implements Command {
        ...
        public void execute(PrintWriter printWriter, List<String> list) {
            ...
            TileServiceRequestController.this.requestTileAdd$SystemUI_nothingRelease(unflattenFromString, list.get(1), list.get(2), (Icon) null, new C2376x7cac3252());
        }

        /* access modifiers changed from: private */
        /* renamed from: execute$lambda-1  reason: not valid java name */
        public static final void m2954execute$lambda1(Integer num) {
    ...
    @Metadata(mo64986d1 = {"\u0000\u001c\n\u0002\u0018\u0002\n\u0000\n\u0002\u0018\u0002\n\u0002\b\u0003\n\u0002\u0018\u0002\n\u0000\n\u0002\u0010\u0002\n\u0002\b\u0003\b\u0002\u0018\u0000*\u0004\b\u0000\u0010\u00012\b\u0012\u0004\u0012\u0002H\u00010\u0002B\u0013\u0012\f\u0010\u0003\u001a\b\u0012\u0004\u0012\u00028\u00000\u0002¢\u0006\u0002\u0010\u0004J\u0015\u0010\u0007\u001a\u00020\b2\u0006\u0010\t\u001a\u00028\u0000H\u0016¢\u0006\u0002\u0010\nR\u0014\u0010\u0003\u001a\b\u0012\u0004\u0012\u00028\u00000\u0002X\u0004¢\u0006\u0002\n\u0000R\u000e\u0010\u0005\u001a\u00020\u0006X\u0004¢\u0006\u0002\n\u0000¨\u0006\u000b"}, mo64987d2 = {"Lcom/android/systemui/qs/external/TileServiceRequestController$SingleShotConsumer;", "T", "Ljava/util/function/Consumer;", "consumer", "(Ljava/util/function/Consumer;)V", "dispatched", "Ljava/util/concurrent/atomic/AtomicBoolean;", "accept", "", "t", "(Ljava/lang/Object;)V", "SystemUI_nothingRelease"}, mo64988k = 1, mo64989mv = {1, 6, 0}, mo64991xi = 48)
