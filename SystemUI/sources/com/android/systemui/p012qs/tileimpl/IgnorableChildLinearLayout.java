...
public final class IgnorableChildLinearLayout extends LinearLayout {
    ...
    @Metadata(mo64986d1 = {"\u0000\u0012\n\u0002\u0018\u0002\n\u0002\u0010\u0000\n\u0002\b\u0002\n\u0002\u0010\u000e\n\u0000\b\u0003\u0018\u00002\u00020\u0001B\u0007\b\u0002¢\u0006\u0002\u0010\u0002R\u000e\u0010\u0003\u001a\u00020\u0004XT¢\u0006\u0002\n\u0000¨\u0006\u0005"}, mo64987d2 = {"Lcom/android/systemui/qs/tileimpl/IgnorableChildLinearLayout$Companion;", "", "()V", "TAG", "", "SystemUI_nothingRelease"}, mo64988k = 1, mo64989mv = {1, 6, 0}, mo64991xi = 48)
    ...
    public void onFinishInflate() {
        ...
        this.label = (TextView) findViewById(C1893R.C1897id.tile_label);
        this.secondLabel = (TextView) findViewById(C1893R.C1897id.app_label);
    }

    public final void setLabelSingleMode(boolean z) {
        NTLogUtil.m1680d(TAG, "setLabelSingleMode: singleMode " + z);
        this.isSingleMode = z;
        View findViewById = findViewById(C1893R.C1897id.tile_label);
        Intrinsics.checkNotNullExpressionValue(findViewById, "findViewById(R.id.tile_label)");
        TextView textView = (TextView) findViewById;
        View findViewById2 = findViewById(C1893R.C1897id.app_label);
        ...
        if (z) {
            ...
            if (layoutParams != null) {
                ...
                layoutParams2.topMargin = getResources().getDimensionPixelSize(C1893R.dimen.circle_qs_tile_label_top_margin);
        ...
        if (layoutParams7 != null) {
            ...
            layoutParams8.leftMargin = getResources().getDimensionPixelSize(C1893R.dimen.qs_label_container_margin);
    ...
    public final void setLabelSingleModeNonFirst(boolean z) {
        NTLogUtil.m1680d(TAG, "setCircleLabelSingleMode: singleMode " + z);
        this.isSingleMode = z;
        View findViewById = findViewById(C1893R.C1897id.tile_label);
        Intrinsics.checkNotNullExpressionValue(findViewById, "findViewById(R.id.tile_label)");
        TextView textView = (TextView) findViewById;
        ...
        if (layoutParams3 != null) {
            LinearLayout.LayoutParams layoutParams4 = (LinearLayout.LayoutParams) layoutParams3;
            layoutParams4.width = getResources().getDimensionPixelSize(C1893R.dimen.circle_qs_tile_label_max_width);
    ...
    public final void setPosition(float f, boolean z) {
        ...
        double d = (double) f;
        if (d <= 0.01d) {
            NTLogUtil.m1680d(TAG, "setPosition: position under 0.01 , onFirst = " + z + " position = " + f);
            ...
            if (f > 0.5f && !this.isSingleMode) {
                NTLogUtil.m1680d(TAG, "setPosition: make single line enable, onFirst = " + z);
                this.isSingleMode = true;
                if (z) {
            ...
            NTLogUtil.m1680d(TAG, "setPosition: make single line disable, onFirst = " + z);
            this.isSingleMode = false;
            if (z) {
                setLabelSingleMode(false);
                setTranslationX(0.0f);
