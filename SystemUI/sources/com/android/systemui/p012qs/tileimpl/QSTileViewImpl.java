...
public class QSTileViewImpl extends QSTileView implements HeightOverrideable, LaunchableView {
    ...
    private int colorInactiveCircleDark;
    private int colorInactiveDark;
    ...
    private int colorUnavailableCircleDark;
    private int colorUnavailableDark;
    private ImageView customDrawableView;

    /* renamed from: ex */
    private QSTileViewImplEx f333ex;
    ...
    public QSTileViewImpl(Context context, QSIconView qSIconView, boolean z) {
        ...
        this.colorInactive = context.getColor(C1893R.C1894color.off_state_color);
        this.colorUnavailable = Utils.applyAlpha(0.3f, getColorInactive());
        this.colorInactiveDark = context.getColor(C1893R.C1894color.off_state_color_dark);
        this.colorUnavailableDark = Utils.applyAlpha(0.3f, getColorInactiveDark());
        this.colorInactiveCircle = context.getColor(C1893R.C1894color.circle_off_state_color);
        this.colorUnavailableCircle = Utils.applyAlpha(0.3f, getColorInactiveCircle());
        this.colorInactiveCircleDark = context.getColor(C1893R.C1894color.circle_off_state_color_dark);
        this.colorUnavailableCircleDark = Utils.applyAlpha(0.3f, getColorInactiveCircleDark());
        ...
        this.f333ex = (QSTileViewImplEx) NTDependencyEx.get(QSTileViewImplEx.class);
        ...
        int dimensionPixelSize = getResources().getDimensionPixelSize(C1893R.dimen.qs_tile_padding);
        setPaddingRelative(getResources().getDimensionPixelSize(C1893R.dimen.qs_tile_start_padding), dimensionPixelSize, dimensionPixelSize, dimensionPixelSize);
        dealAndAddIcon();
        createAndAddLabels();
    ...
    @Metadata(mo64986d1 = {"\u0000\"\n\u0002\u0018\u0002\n\u0002\u0010\u0000\n\u0002\b\u0002\n\u0002\u0010\u000e\n\u0002\b\u0002\n\u0002\u0010\b\n\u0002\b\u0005\n\u0002\u0010\u0007\n\u0000\b\u0003\u0018\u00002\u00020\u0001B\u0007\b\u0002¢\u0006\u0002\u0010\u0002R\u000e\u0010\u0003\u001a\u00020\u0004XT¢\u0006\u0002\n\u0000R\u000e\u0010\u0005\u001a\u00020\u0004XT¢\u0006\u0002\n\u0000R\u000e\u0010\u0006\u001a\u00020\u0007XT¢\u0006\u0002\n\u0000R\u000e\u0010\b\u001a\u00020\u0004XT¢\u0006\u0002\n\u0000R\u000e\u0010\t\u001a\u00020\u0004XT¢\u0006\u0002\n\u0000R\u0016\u0010\n\u001a\u00020\u00048\u0000XT¢\u0006\b\n\u0000\u0012\u0004\b\u000b\u0010\u0002R\u000e\u0010\f\u001a\u00020\rXT¢\u0006\u0002\n\u0000¨\u0006\u000e"}, mo64987d2 = {"Lcom/android/systemui/qs/tileimpl/QSTileViewImpl$Companion;", "", "()V", "BACKGROUND_NAME", "", "CHEVRON_NAME", "INVALID", "", "LABEL_NAME", "SECONDARY_LABEL_NAME", "TILE_STATE_RES_PREFIX", "getTILE_STATE_RES_PREFIX$SystemUI_nothingRelease$annotations", "UNAVAILABLE_ALPHA", "", "SystemUI_nothingRelease"}, mo64988k = 1, mo64989mv = {1, 6, 0}, mo64991xi = 48)
    ...
    public int getColorInactiveDark() {
        return this.colorInactiveDark;
    }

    public void setColorInactiveDark(int i) {
        this.colorInactiveDark = i;
    }

    public int getColorUnavailableDark() {
        return this.colorUnavailableDark;
    }

    public void setColorUnavailableDark(int i) {
        this.colorUnavailableDark = i;
    }
    ...
    public int getColorInactiveCircleDark() {
        return this.colorInactiveCircleDark;
    }

    public void setColorInactiveCircleDark(int i) {
        this.colorInactiveCircleDark = i;
    }

    public int getColorUnavailableCircleDark() {
        return this.colorUnavailableCircleDark;
    }

    public void setColorUnavailableCircleDark(int i) {
        this.colorUnavailableCircleDark = i;
    }
    ...
    public final TextView m2964getLabel() {
    ...
    public final TextView m2966getSecondaryLabel() {
    ...
    public final IgnorableChildLinearLayout m2965getLabelContainer() {
    ...
    public static final void m2963singleAnimator$lambda1$lambda0(QSTileViewImpl qSTileViewImpl, ValueAnimator valueAnimator) {
    ...
    public void updateResources() {
        FontSizeUtils.updateFontSize(getLabel(), C1893R.dimen.qs_tile_text_size);
        FontSizeUtils.updateFontSize(getSecondaryLabel(), C1893R.dimen.qs_tile_text_size);
        int dimensionPixelSize = getContext().getResources().getDimensionPixelSize(C1893R.dimen.qs_icon_size);
        ViewGroup.LayoutParams layoutParams = this._icon.getLayoutParams();
        layoutParams.height = dimensionPixelSize;
        layoutParams.width = dimensionPixelSize;
        int dimensionPixelSize2 = getResources().getDimensionPixelSize(C1893R.dimen.qs_tile_padding);
        setPaddingRelative(getResources().getDimensionPixelSize(C1893R.dimen.qs_tile_start_padding), dimensionPixelSize2, dimensionPixelSize2, dimensionPixelSize2);
        int dimensionPixelSize3 = getResources().getDimensionPixelSize(C1893R.dimen.qs_label_container_margin);
        this.f333ex.applyLabelContainerMarginStart(getTileOrientation() == 0, getLabelContainer(), dimensionPixelSize3);
        ...
        if (layoutParams2 != null) {
            ...
            if (layoutParams3 != null) {
                ...
                int dimensionPixelSize4 = getResources().getDimensionPixelSize(C1893R.dimen.qs_drawable_end_margin);
    ...
    public void createAndAddLabels() {
        QSTileViewImplEx qSTileViewImplEx = this.f333ex;
        boolean z = getTileOrientation() == 0;
        Context context = getContext();
        Intrinsics.checkNotNullExpressionValue(context, "context");
        setLabelContainer(qSTileViewImplEx.inflateLabelContainer(z, context, this));
        View requireViewById = getLabelContainer().requireViewById(C1893R.C1897id.tile_label);
        ...
        View requireViewById2 = getLabelContainer().requireViewById(C1893R.C1897id.app_label);
    ...
    private final void createAndAddSideView() {
        View inflate = LayoutInflater.from(getContext()).inflate(C1893R.layout.qs_tile_side_icon, this, false);
        if (inflate != null) {
            setSideView((ViewGroup) inflate);
            View requireViewById = getSideView().requireViewById(C1893R.C1897id.customDrawable);
            ...
            View requireViewById2 = getSideView().requireViewById(C1893R.C1897id.chevron);
    ...
    public Drawable createTileBackground() {
        Drawable drawable = this.mContext.getDrawable(C1893R.C1895drawable.qs_tile_background);
        if (drawable != null) {
    ...
    public void init(QSTile qSTile) {
        ...
        this.f333ex.setCircleTileLabelIfNeeded(isSignalOrBtTile, getLabel(), getSecondaryLabel());
    }

    /* access modifiers changed from: private */
    /* renamed from: init$lambda-6  reason: not valid java name */
    public static final void m2960init$lambda6(QSTileViewImpl qSTileViewImpl, QSTile qSTile, View view) {
        Intrinsics.checkNotNullParameter(qSTileViewImpl, "this$0");
        Intrinsics.checkNotNullParameter(qSTile, "$tile");
    ...
    public static final boolean m2961init$lambda7(QSTileViewImpl qSTileViewImpl, QSTile qSTile, View view) {
        Intrinsics.checkNotNullParameter(qSTileViewImpl, "this$0");
        Intrinsics.checkNotNullParameter(qSTile, "$tile");
        if (qSTileViewImpl.isTesla) {
            qSTileViewImpl.setTag(C1893R.C1897id.qs_tesla_tag, "tesla");
        }
        if (qSTileViewImpl.f333ex.isIntercepted()) {
            qSTileViewImpl.f333ex.resetIntercepted();
            NTLogUtil.m1680d("QSTileViewImpl", "Mistouch longClick");
            return false;
        }
    ...
    public boolean onTouchEvent(MotionEvent motionEvent) {
        ...
        if (this.f333ex.onTouchEvent(motionEvent)) {
            return true;
        }
    ...
    public static final void m2962onStateChanged$lambda8(QSTileViewImpl qSTileViewImpl, QSTile.State state) {
        Intrinsics.checkNotNullParameter(qSTileViewImpl, "this$0");
    ...
    public void onInitializeAccessibilityNodeInfo(AccessibilityNodeInfo accessibilityNodeInfo) {
        ...
        if (!TextUtils.isEmpty(this.accessibilityClass)) {
            ...
            if (Intrinsics.areEqual((Object) Switch.class.getName(), (Object) this.accessibilityClass)) {
                accessibilityNodeInfo.setText(getResources().getString(this.tileState ? C1893R.string.switch_bar_on : C1893R.string.switch_bar_off));
                accessibilityNodeInfo.setChecked(this.tileState);
                accessibilityNodeInfo.setCheckable(true);
                if (isLongClickable()) {
                    accessibilityNodeInfo.addAction(new AccessibilityNodeInfo.AccessibilityAction(AccessibilityNodeInfo.AccessibilityAction.ACTION_LONG_CLICK.getId(), getResources().getString(C1893R.string.accessibility_long_click_tile)));
                }
            }
        }
        if (this._position != -1) {
    ...
    public void handleStateChanged(QSTile.State state) {
        ...
        Context context = getContext();
        Intrinsics.checkNotNullExpressionValue(context, "context");
        icon.setCircleIconBgColor(qSTileViewImplEx.getCircleIconBackgroundColorForState(context, state.state, getColorActive(), getColorInactiveCircleDark(), getColorInactiveCircle(), getColorUnavailableCircleDark(), getColorUnavailableCircle()));
        if (state.icon != null) {
    ...
    private final String getStateText(QSTile.State state) {
        if (state.disabledByPolicy) {
            String string = getContext().getString(C1893R.string.tile_disabled);
    ...
    public int getBackgroundColorForState(int i) {
        if (this.isSignalOrBt) {
            ...
            Context context = getContext();
            Intrinsics.checkNotNullExpressionValue(context, "context");
            return qSTileViewImplEx.getCircularTileBackgroundColor(context, getColorInactiveDark(), getColorInactive());
        } else if (i == 0) {
    ...
    public int getLabelColorForState(int i) {
        ...
        if (i == 2) {
            return this.f333ex.getLabelColorForState(this.isSignalOrBt, getColorLabelInactive(), getColorLabelActive());
        }
        Log.e("QSTileViewImpl", "Invalid state " + i);
        return 0;
    }
    ...
    public void dealAndAddIcon() {
        int dimensionPixelSize = getResources().getDimensionPixelSize(C1893R.dimen.qs_icon_size);
