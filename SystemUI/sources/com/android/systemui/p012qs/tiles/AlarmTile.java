...
public final class AlarmTile extends QSTileImpl<QSTile.State> {
    ...
    private final QSTile.Icon icon = QSTileImpl.ResourceIcon.get(C1893R.C1895drawable.ic_alarm);
    ...
    public static final void m2967callback$lambda0(AlarmTile alarmTile, AlarmManager.AlarmClockInfo alarmClockInfo) {
    ...
    public void handleUpdateState(QSTile.State state, Object obj) {
        ...
        if (unit == null) {
            ...
            state.secondaryLabel = this.mContext.getString(C1893R.string.qs_alarm_tile_no_alarm);
            state.state = 1;
        }
    ...
    public CharSequence getTileLabel() {
        String string = this.mContext.getString(C1893R.string.status_bar_alarm);
