...
public final class DeviceControlsTile extends QSTileImpl<QSTile.State> {
    ...
    public static final void m2975_init_$lambda0(DeviceControlsTile deviceControlsTile, ControlsListingController controlsListingController) {
    ...
    public void handleClick(View view) {
        if (getState().state != 0) {
            ...
            if (view != null) {
                ActivityLaunchAnimator.Controller.Companion.fromView(view, 32);
            }
            this.mUiHandler.post(new DeviceControlsTile$$ExternalSyntheticLambda0(this, intent));
        }
    }

    /* access modifiers changed from: private */
    /* renamed from: handleClick$lambda-4  reason: not valid java name */
    public static final void m2976handleClick$lambda4(DeviceControlsTile deviceControlsTile, Intent intent) {
        Intrinsics.checkNotNullParameter(deviceControlsTile, "this$0");
        Intrinsics.checkNotNullParameter(intent, "$intent");
        int i = deviceControlsTile.getState().state;
    ...
    public void handleUpdateState(QSTile.State state, Object obj) {
        ...
        if (this.controlsComponent.getVisibility() == ControlsComponent.Visibility.AVAILABLE) {
            ...
            state.state = 1;
            state.secondaryLabel = this.mContext.getText(C1893R.string.controls_tile_locked);
        }
