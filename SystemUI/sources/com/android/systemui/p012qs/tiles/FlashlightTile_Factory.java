...
public final class FlashlightTile_Factory implements Factory<FlashlightTile> {
    ...
    public FlashlightTile get() {
        return newInstance(this.hostProvider.get(), this.backgroundLooperProvider.get(), this.mainHandlerProvider.get(), this.falsingManagerProvider.get(), this.metricsLoggerProvider.get(), this.statusBarStateControllerProvider.get(), this.activityStarterProvider.get(), this.qsLoggerProvider.get(), this.flashlightControllerProvider.get());
    }
