...
public final class NfcTile_Factory implements Factory<NfcTile> {
    ...
    public NfcTile get() {
        return newInstance(this.hostProvider.get(), this.backgroundLooperProvider.get(), this.mainHandlerProvider.get(), this.falsingManagerProvider.get(), this.metricsLoggerProvider.get(), this.statusBarStateControllerProvider.get(), this.activityStarterProvider.get(), this.qsLoggerProvider.get(), this.broadcastDispatcherProvider.get(), this.nfcControllerProvider.get());
    }
