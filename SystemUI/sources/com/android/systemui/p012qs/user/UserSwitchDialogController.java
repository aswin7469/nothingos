...
public final class UserSwitchDialogController {
    ...
    @Metadata(mo64986d1 = {"\u0000\u0016\n\u0002\u0018\u0002\n\u0002\u0018\u0002\n\u0000\n\u0002\u0010\u0002\n\u0000\n\u0002\u0018\u0002\n\u0000\bf\u0018\u00002\u00020\u0001J\u0010\u0010\u0002\u001a\u00020\u00032\u0006\u0010\u0004\u001a\u00020\u0005H&ø\u0001\u0000\u0002\u0006\n\u0004\b!0\u0001¨\u0006\u0006À\u0006\u0001"}, mo64987d2 = {"Lcom/android/systemui/qs/user/UserSwitchDialogController$DialogShower;", "Landroid/content/DialogInterface;", "showDialog", "", "dialog", "Landroid/app/Dialog;", "SystemUI_nothingRelease"}, mo64988k = 1, mo64989mv = {1, 6, 0}, mo64991xi = 48)
    ...
    public UserSwitchDialogController(Provider<UserDetailView.Adapter> provider, ActivityStarter activityStarter2, FalsingManager falsingManager2, DialogLaunchAnimator dialogLaunchAnimator2, UiEventLogger uiEventLogger2) {
        this(provider, activityStarter2, falsingManager2, dialogLaunchAnimator2, uiEventLogger2, C24151.INSTANCE);
        Intrinsics.checkNotNullParameter(provider, "userDetailViewAdapterProvider");
        Intrinsics.checkNotNullParameter(activityStarter2, "activityStarter");
        Intrinsics.checkNotNullParameter(falsingManager2, "falsingManager");
        Intrinsics.checkNotNullParameter(dialogLaunchAnimator2, "dialogLaunchAnimator");
    ...
    @Metadata(mo64986d1 = {"\u0000\u0012\n\u0002\u0018\u0002\n\u0002\u0010\u0000\n\u0002\b\u0002\n\u0002\u0018\u0002\n\u0000\b\u0003\u0018\u00002\u00020\u0001B\u0007\b\u0002¢\u0006\u0002\u0010\u0002R\u000e\u0010\u0003\u001a\u00020\u0004X\u0004¢\u0006\u0002\n\u0000¨\u0006\u0005"}, mo64987d2 = {"Lcom/android/systemui/qs/user/UserSwitchDialogController$Companion;", "", "()V", "USER_SETTINGS_INTENT", "Landroid/content/Intent;", "SystemUI_nothingRelease"}, mo64988k = 1, mo64989mv = {1, 6, 0}, mo64991xi = 48)
    ...
    public final void showDialog(View view) {
        ...
        invoke.setTitle(C1893R.string.qs_user_switch_dialog_title);
        invoke.setPositiveButton(C1893R.string.quick_settings_done, new UserSwitchDialogController$$ExternalSyntheticLambda0(this));
        invoke.setNeutralButton(C1893R.string.quick_settings_more_user_settings, new UserSwitchDialogController$$ExternalSyntheticLambda1(this, invoke), false);
        View inflate = LayoutInflater.from(invoke.getContext()).inflate(C1893R.layout.qs_user_dialog_content, (ViewGroup) null);
        invoke.setView(inflate);
        UserDetailView.Adapter adapter = this.userDetailViewAdapterProvider.get();
        adapter.linkToViewGroup((ViewGroup) inflate.findViewById(C1893R.C1897id.grid));
    ...
    public static final void m2991showDialog$lambda2$lambda0(UserSwitchDialogController userSwitchDialogController, DialogInterface dialogInterface, int i) {
    ...
    public static final void m2992showDialog$lambda2$lambda1(UserSwitchDialogController userSwitchDialogController, SystemUIDialog systemUIDialog, DialogInterface dialogInterface, int i) {
        Intrinsics.checkNotNullParameter(userSwitchDialogController, "this$0");
    ...
    @Metadata(mo64986d1 = {"\u0000$\n\u0002\u0018\u0002\n\u0002\u0018\u0002\n\u0002\u0018\u0002\n\u0000\n\u0002\u0018\u0002\n\u0000\n\u0002\u0018\u0002\n\u0002\b\u0002\n\u0002\u0010\u0002\n\u0002\b\u0004\b\u0002\u0018\u00002\u00020\u00012\u00020\u0002B\u0015\u0012\u0006\u0010\u0003\u001a\u00020\u0004\u0012\u0006\u0010\u0005\u001a\u00020\u0006¢\u0006\u0002\u0010\u0007J\t\u0010\b\u001a\u00020\tH\u0001J\t\u0010\n\u001a\u00020\tH\u0001J\u0010\u0010\u000b\u001a\u00020\t2\u0006\u0010\f\u001a\u00020\u0004H\u0016R\u000e\u0010\u0003\u001a\u00020\u0004X\u0004¢\u0006\u0002\n\u0000R\u000e\u0010\u0005\u001a\u00020\u0006X\u0004¢\u0006\u0002\n\u0000¨\u0006\r"}, mo64987d2 = {"Lcom/android/systemui/qs/user/UserSwitchDialogController$DialogShowerImpl;", "Landroid/content/DialogInterface;", "Lcom/android/systemui/qs/user/UserSwitchDialogController$DialogShower;", "animateFrom", "Landroid/app/Dialog;", "dialogLaunchAnimator", "Lcom/android/systemui/animation/DialogLaunchAnimator;", "(Landroid/app/Dialog;Lcom/android/systemui/animation/DialogLaunchAnimator;)V", "cancel", "", "dismiss", "showDialog", "dialog", "SystemUI_nothingRelease"}, mo64988k = 1, mo64989mv = {1, 6, 0}, mo64991xi = 48)
