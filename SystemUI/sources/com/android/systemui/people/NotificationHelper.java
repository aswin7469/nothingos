...
public class NotificationHelper {
    ...
    private static boolean hasContent(NotificationEntry notificationEntry) {
        ...
        return (notificationEntry == null || (messagingStyleMessages = getMessagingStyleMessages(notificationEntry.getSbn().getNotification())) == null || messagingStyleMessages.isEmpty()) ? false : true;
    }
    ...
    public static boolean shouldFilterOut(Optional<Bubbles> optional, NotificationEntry notificationEntry) {
        try {
            ...
            return optional.get().isBubbleNotificationSuppressedFromShade(notificationEntry.getKey(), notificationEntry.getSbn().getGroupKey());
        } catch (Exception e) {
