...
public final class BatteryStateSnapshot {
    ...
    public static /* synthetic */ BatteryStateSnapshot copy$default(BatteryStateSnapshot batteryStateSnapshot, int i, boolean z, boolean z2, int i2, int i3, int i4, int i5, long j, long j2, long j3, long j4, boolean z3, boolean z4, int i6, Object obj) {
        BatteryStateSnapshot batteryStateSnapshot2 = batteryStateSnapshot;
        int i7 = i6;
        return batteryStateSnapshot.copy((i7 & 1) != 0 ? batteryStateSnapshot2.batteryLevel : i, (i7 & 2) != 0 ? batteryStateSnapshot2.isPowerSaver : z, (i7 & 4) != 0 ? batteryStateSnapshot2.plugged : z2, (i7 & 8) != 0 ? batteryStateSnapshot2.bucket : i2, (i7 & 16) != 0 ? batteryStateSnapshot2.batteryStatus : i3, (i7 & 32) != 0 ? batteryStateSnapshot2.severeLevelThreshold : i4, (i7 & 64) != 0 ? batteryStateSnapshot2.lowLevelThreshold : i5, (i7 & 128) != 0 ? batteryStateSnapshot2.timeRemainingMillis : j, (i7 & 256) != 0 ? batteryStateSnapshot2.averageTimeToDischargeMillis : j2, (i7 & 512) != 0 ? batteryStateSnapshot2.severeThresholdMillis : j3, (i7 & 1024) != 0 ? batteryStateSnapshot2.lowThresholdMillis : j4, (i7 & 2048) != 0 ? batteryStateSnapshot2.isBasedOnUsage : z3, (i7 & 4096) != 0 ? batteryStateSnapshot2.isLowWarningEnabled : z4);
    }
    ...
    public String toString() {
        ...
        sb.append(this.batteryLevel).append(", isPowerSaver=").append(this.isPowerSaver).append(", plugged=").append(this.plugged).append(", bucket=").append(this.bucket).append(", batteryStatus=").append(this.batteryStatus).append(", severeLevelThreshold=").append(this.severeLevelThreshold).append(", lowLevelThreshold=").append(this.lowLevelThreshold).append(", timeRemainingMillis=").append(this.timeRemainingMillis).append(", averageTimeToDischargeMillis=").append(this.averageTimeToDischargeMillis).append(", severeThresholdMillis=").append(this.severeThresholdMillis).append(", lowThresholdMillis=").append(this.lowThresholdMillis).append(", isBasedOnUsage=");
        sb.append(this.isBasedOnUsage).append(", isLowWarningEnabled=").append(this.isLowWarningEnabled).append(')');
        return sb.toString();
    }
