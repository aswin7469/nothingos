...
public class AutoSizingList extends LinearLayout {
    ...
    private final Runnable mBindChildren = new Runnable() { // from class: com.android.systemui.qs.AutoSizingList.1
        @Override // java.lang.Runnable
        public void run() {
            AutoSizingList.this.rebindChildren();
        }
    };
    private final DataSetObserver mDataObserver = new DataSetObserver() { // from class: com.android.systemui.qs.AutoSizingList.2
