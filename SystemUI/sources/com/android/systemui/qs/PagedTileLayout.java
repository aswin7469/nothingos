...
public class PagedTileLayout extends ViewPager implements QSPanel.QSTileLayout {
    ...
    private int mRadius = getResources().getDimensionPixelSize(R$dimen.page_tile_layout_corner_radius);
        ...
        try {
            ...
            post(new Runnable() { // from class: com.android.systemui.qs.PagedTileLayout$$ExternalSyntheticLambda1
                ...
                public final void run() {
                    PagedTileLayout.this.lambda$fakeDragBy$1(size);
                }
            });
        }
    }
    ...
    protected void dispatchDraw(Canvas canvas) {
        if (this.mRoundnessNeeded && !SystemUIDebugConfig.DEBUG_QS_DISABLE_CLIP) {
            this.mPath.reset();
            Rect clipBounds = canvas.getClipBounds();
            RectF rectF = this.mRectF;
            int i = clipBounds.left;
            int i2 = this.mPageMargin;
            rectF.set(i + i2, clipBounds.top, clipBounds.right - i2, clipBounds.bottom);
