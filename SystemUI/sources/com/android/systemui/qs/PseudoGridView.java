...
public class PseudoGridView extends ViewGroup {
    ...
    protected void onMeasure(int i, int i2) {
        ...
        int makeMeasureSpec = View.MeasureSpec.makeMeasureSpec((size - ((i4 - 1) * this.mHorizontalSpacing)) / i4, 1073741824);
        int childCount = getChildCount();
        int i5 = ((childCount + i3) - 1) / this.mNumColumns;
        int i6 = 0;
    ...
    protected void onLayout(boolean z, int i, int i2, int i3, int i4) {
        ...
        int childCount = getChildCount();
        int i6 = ((childCount + i5) - 1) / this.mNumColumns;
        int i7 = 0;
