...
public final class QSAnimator_Factory implements Factory<QSAnimator> {
    ...
    /* renamed from: get */
    public QSAnimator mo1933get() {
        return newInstance(this.qsProvider.mo1933get(), this.quickPanelProvider.mo1933get(), this.quickStatusBarHeaderProvider.mo1933get(), this.qsPanelControllerProvider.mo1933get(), this.quickQSPanelControllerProvider.mo1933get(), this.qsTileHostProvider.mo1933get(), this.securityFooterProvider.mo1933get(), this.executorProvider.mo1933get(), this.tunerServiceProvider.mo1933get(), this.qsExpansionPathInterpolatorProvider.mo1933get());
    }
