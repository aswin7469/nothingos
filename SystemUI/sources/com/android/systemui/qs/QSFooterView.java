...
public class QSFooterView extends FrameLayout {
    ...
    public void setBuildText() {
        ...
        if (DevelopmentSettingsEnabler.isDevelopmentSettingsEnabled(((FrameLayout) this).mContext)) {
            this.mBuildText.setText(((FrameLayout) this).mContext.getString(17039802, Build.VERSION.RELEASE_OR_CODENAME, Build.ID));
    ...
    public void updateEverything(final boolean z, final boolean z2) {
        post(new Runnable() { // from class: com.android.systemui.qs.QSFooterView$$ExternalSyntheticLambda0
            ...
            public final void run() {
                QSFooterView.this.lambda$updateEverything$0(z, z2);
            }
        });
    }
