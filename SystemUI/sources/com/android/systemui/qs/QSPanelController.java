...
public class QSPanelController extends QSPanelControllerBase<QSPanel> {
    ...
    protected void onViewAttached() {
        ...
        ((PagedTileLayout) ((QSPanel) this.mView).mo773getOrCreateTileLayout()).setOnTouchListener(this.mTileLayoutTouchListener);
    }

    @Override // com.android.systemui.qs.QSPanelControllerBase
    protected QSTileRevealController createTileRevealController() {
        return this.mQsTileRevealControllerFactory.create(this, (PagedTileLayout) ((QSPanel) this.mView).mo773getOrCreateTileLayout());
    }
    ...
    public void showEdit(final View view) {
        view.post(new Runnable() { // from class: com.android.systemui.qs.QSPanelController$$ExternalSyntheticLambda1
            @Override // java.lang.Runnable
            public final void run() {
                QSPanelController.this.lambda$showEdit$1(view);
            }
        });
    }
