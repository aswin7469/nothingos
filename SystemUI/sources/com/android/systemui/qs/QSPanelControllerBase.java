...
public abstract class QSPanelControllerBase<T extends QSPanel> extends ViewController<T> implements Dumpable {
    ...
    @VisibleForTesting
    protected final QSPanel.OnConfigurationChangedListener mOnConfigurationChangedListener = new QSPanel.OnConfigurationChangedListener() { // from class: com.android.systemui.qs.QSPanelControllerBase.1
    ...
    private final Function1<Boolean, Unit> mMediaHostVisibilityListener = new Function1() { // from class: com.android.systemui.qs.QSPanelControllerBase$$ExternalSyntheticLambda2
        ...
        public final Object mo1949invoke(Object obj) {
            Unit lambda$new$0;
            lambda$new$0 = QSPanelControllerBase.this.lambda$new$0((Boolean) obj);
            return lambda$new$0;
        }
    };
    ...
    private void addTile(QSTile qSTile, boolean z) {
        ...
        tileRecord.isSignalTile = QSTileHost.isSignalTile(qSTile.getTileSpec());
        boolean z2 = true;
        tileRecord.isCollapsedSignalTile = z && QSTileHost.isCellularTile(qSTile.getTileSpec());
        tileRecord.isCircleSignalTile = !z && tileRecord.isSignalTile;
        boolean isBluetoothTile = QSTileHost.isBluetoothTile(qSTile.getTileSpec());
        tileRecord.isBtTile = isBluetoothTile;
        tileRecord.isCollapsedBtTile = z && isBluetoothTile;
        if (z || !isBluetoothTile) {
            z2 = false;
        }
    ...
    public boolean shouldUseHorizontalLayout() {
        return !this.mShouldUseSplitNotificationShade && this.mUsingMediaPlayer && this.mMediaHost.getVisible() && this.mLastOrientation == 2;
    }
    ...
    public void setQSAnimator(QSAnimator qSAnimator) {
        ((QSPanel) this.mView).setQSAnimator(qSAnimator);
    }
}
