...
public class QSSecurityFooter implements View.OnClickListener, DialogInterface.OnClickListener {
    ...
    public void handleRefreshState() {
        ...
        if (isParentalControlsEnabled) {
            if (this.mPrimaryFooterIconDrawable == null) {
    ...
    protected CharSequence getFooterText(boolean z, boolean z2, boolean z3, boolean z4, boolean z5, String str, String str2, CharSequence charSequence, CharSequence charSequence2, boolean z6, boolean z7, boolean z8) {
        ...
        if (!z) {
            ...
            return isFinancedDevice() ? this.mContext.getString(R$string.quick_settings_financed_disclosure_named_management, charSequence) : this.mContext.getString(R$string.quick_settings_disclosure_named_management, charSequence);
    ...
    protected CharSequence getManagementMessage(boolean z, CharSequence charSequence) {
        ...
        return isFinancedDevice() ? this.mContext.getString(R$string.monitoring_financed_description_named_management, charSequence, charSequence) : this.mContext.getString(R$string.monitoring_description_named_management, charSequence);
    }
    ...
    CharSequence getManagementTitle(CharSequence charSequence) {
        return (charSequence == null || !isFinancedDevice()) ? this.mContext.getString(R$string.monitoring_title_device_owned) : this.mContext.getString(R$string.monitoring_title_financed_device, charSequence);
    }
