...
public final class QSSecurityFooter_Factory implements Factory<QSSecurityFooter> {
    ...
    /* renamed from: get */
    public QSSecurityFooter mo1933get() {
        return newInstance(this.rootViewProvider.mo1933get(), this.userTrackerProvider.mo1933get(), this.mainHandlerProvider.mo1933get(), this.activityStarterProvider.mo1933get(), this.securityControllerProvider.mo1933get(), this.bgLooperProvider.mo1933get());
    }
