...
public final class QSTileHost_Factory implements Factory<QSTileHost> {
    ...
    /* renamed from: get */
    public QSTileHost mo1933get() {
        return newInstance(this.contextProvider.mo1933get(), this.iconControllerProvider.mo1933get(), this.defaultFactoryProvider.mo1933get(), this.mainHandlerProvider.mo1933get(), this.bgLooperProvider.mo1933get(), this.pluginManagerProvider.mo1933get(), this.tunerServiceProvider.mo1933get(), this.autoTilesProvider, this.dumpManagerProvider.mo1933get(), this.broadcastDispatcherProvider.mo1933get(), this.statusBarOptionalProvider.mo1933get(), this.qsLoggerProvider.mo1933get(), this.uiEventLoggerProvider.mo1933get(), this.userTrackerProvider.mo1933get(), this.secureSettingsProvider.mo1933get(), this.customTileStatePersisterProvider.mo1933get(), this.featureFlagsProvider.mo1933get());
    }
    ...
    public static QSTileHost newInstance(Context context, StatusBarIconController statusBarIconController, QSFactory qSFactory, Handler handler, Looper looper, PluginManager pluginManager, TunerService tunerService, Provider<AutoTileManager> provider, DumpManager dumpManager, BroadcastDispatcher broadcastDispatcher, Optional<StatusBar> optional, QSLogger qSLogger, UiEventLogger uiEventLogger, UserTracker userTracker, SecureSettings secureSettings, CustomTileStatePersister customTileStatePersister, FeatureFlags featureFlags) {
        return new QSTileHost(context, statusBarIconController, qSFactory, handler, looper, pluginManager, tunerService, provider, dumpManager, broadcastDispatcher, optional, qSLogger, uiEventLogger, userTracker, secureSettings, customTileStatePersister, featureFlags);
    }
}
