...
public final class QuickQSPanelController_Factory implements Factory<QuickQSPanelController> {
    ...
    /* renamed from: get */
    public QuickQSPanelController mo1933get() {
        return newInstance(this.viewProvider.mo1933get(), this.qsTileHostProvider.mo1933get(), this.qsCustomizerControllerProvider.mo1933get(), this.usingMediaPlayerProvider.mo1933get().booleanValue(), this.mediaHostProvider.mo1933get(), this.metricsLoggerProvider.mo1933get(), this.uiEventLoggerProvider.mo1933get(), this.qsLoggerProvider.mo1933get(), this.dumpManagerProvider.mo1933get(), this.featureFlagsProvider.mo1933get());
    }
