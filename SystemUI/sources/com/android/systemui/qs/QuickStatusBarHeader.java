...
public class QuickStatusBarHeader extends FrameLayout {
    ...
    protected void onFinishInflate() {
        ...
        this.mQsStatusBarLayout = (RelativeLayout) findViewById(R$id.qs_status_bar_layout);
        this.mPullDownArrow = findViewById(R$id.arrow_down);
        updateResources();
        ...
        setSecurityHeaderContainerVisibility(z);
        ...
        if (this.mDatePrivacyView.getMeasuredHeight() != this.mTopViewMeasureHeight) {
            ...
            post(new Runnable() { // from class: com.android.systemui.qs.QuickStatusBarHeader$$ExternalSyntheticLambda0
                ...
                public final void run() {
                    QuickStatusBarHeader.this.updateAnimators();
                }
            });
        }
    }
    ...
    public void updateResources() {
        ...
        int dimensionPixelSize = resources.getDimensionPixelSize(17105476);
        ...
        updateAnimators();
        updatePortQSStatusBarVisibility();
        updatePullDownArrowVisibility();
        int dimensionPixelSize2 = ((FrameLayout) this).mContext.getResources().getDimensionPixelSize(R$dimen.qs_status_bar_height);
        View view3 = this.mContainer;
        view3.setPadding(view3.getPaddingLeft(), dimensionPixelSize2, this.mContainer.getPaddingRight(), this.mContainer.getPaddingBottom());
    ...
    private void updateAlphaAnimator() {
        this.mAlphaAnimator = new TouchAnimator.Builder().addFloat(this.mSecurityHeaderView, "alpha", 0.0f, 1.0f).addFloat(this.mDateView, "alpha", 0.0f, 0.0f, 1.0f).addFloat(this.mClockDateView, "alpha", 1.0f, 0.0f, 0.0f).addFloat(this.mQSCarriers, "alpha", 0.0f, 1.0f).setListener(new TouchAnimator.ListenerAdapter() { // from class: com.android.systemui.qs.QuickStatusBarHeader.1
    ...
    public void updateEverything() {
        post(new Runnable() { // from class: com.android.systemui.qs.QuickStatusBarHeader$$ExternalSyntheticLambda1
            @Override // java.lang.Runnable
            public final void run() {
                QuickStatusBarHeader.this.lambda$updateEverything$0();
            }
        });
    }
    ...
    public void updateMediaVisibility(boolean z) {
        this.mMediaVisible = z;
        updatePullDownArrowVisibility();
    }

    public void updatePullDownArrowVisibility() {
        View view = this.mPullDownArrow;
        if (view != null) {
            view.setVisibility((this.mMediaVisible || !SystemUIUtils.getInstance().shouldUseSplitNotificationShade() || this.mExpanded) ? 8 : 0);
        }
    }

    public void updatePortQSStatusBarVisibility() {
        this.mQsStatusBarLayout.setVisibility(SystemUIUtils.getInstance().shouldUseSplitNotificationShade() ? 8 : 0);
    }
}
