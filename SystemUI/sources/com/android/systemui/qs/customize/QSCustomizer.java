...
public class QSCustomizer extends LinearLayout {
    ...
    public QSCustomizer(Context context, AttributeSet attributeSet) {
        ...
        toolbar.getMenu().add(0, 1, 0, ((LinearLayout) this).mContext.getString(17041272));
    ...
    public void updateResources() {
        ...
        layoutParams.height = ((LinearLayout) this).mContext.getResources().getDimensionPixelSize(17105476);
