...
public class TileAdapter extends RecyclerView.Adapter<Holder> implements TileQueryHelper.TileStateListener {
    ...
    public TileAdapter(Context context, QSTileHost qSTileHost, UiEventLogger uiEventLogger) {
        GridLayoutManager.SpanSizeLookup spanSizeLookup = new GridLayoutManager.SpanSizeLookup() { // from class: com.android.systemui.qs.customize.TileAdapter.4
    ...
    public void setTileSpecs(List<String> list) {
        QSTileHost.removeCircleForSpecs(list);
    ...
    public void onTilesChanged(List<TileQueryHelper.TileInfo> list) {
        QSTileHost.removeCircleForTileInfo(list);
        this.mAllTiles = list;
        recalcSpecs();
    }
    ...
    public void onBindViewHolder(final Holder holder, int i) {
        ...
        if (holder.getItemViewType() == 4) {
            ...
            if (this.mCurrentDrag == null) {
                ...
                string = resources.getString(R$string.drag_to_remove_disabled, Integer.valueOf(this.mMinNumTiles));
            } else {
                string = resources.getString(R$string.drag_to_remove_tiles);
            }
            ((TextView) holder.itemView.findViewById(16908310)).setText(string);
            setSelectableForHeaders(holder.itemView);
