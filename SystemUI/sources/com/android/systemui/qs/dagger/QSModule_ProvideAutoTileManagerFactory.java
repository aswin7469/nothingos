...
public final class QSModule_ProvideAutoTileManagerFactory implements Factory<AutoTileManager> {
    ...
    /* renamed from: get */
    public AutoTileManager mo1933get() {
        return provideAutoTileManager(this.contextProvider.mo1933get(), this.autoAddTrackerBuilderProvider.mo1933get(), this.hostProvider.mo1933get(), this.handlerProvider.mo1933get(), this.secureSettingsProvider.mo1933get(), this.hotspotControllerProvider.mo1933get(), this.dataSaverControllerProvider.mo1933get(), this.managedProfileControllerProvider.mo1933get(), this.nightDisplayListenerProvider.mo1933get(), this.castControllerProvider.mo1933get(), this.reduceBrightColorsControllerProvider.mo1933get(), this.deviceControlsControllerProvider.mo1933get(), this.walletControllerProvider.mo1933get(), this.isReduceBrightColorsAvailableProvider.mo1933get().booleanValue());
    }
