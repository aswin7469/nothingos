...
public final class CustomTile_Builder_Factory implements Factory<CustomTile.Builder> {
    ...
    /* renamed from: get */
    public CustomTile.Builder mo1933get() {
        return newInstance(DoubleCheck.lazy(this.hostLazyProvider), this.backgroundLooperProvider.mo1933get(), this.mainHandlerProvider.mo1933get(), this.falsingManagerProvider.mo1933get(), this.metricsLoggerProvider.mo1933get(), this.statusBarStateControllerProvider.mo1933get(), this.activityStarterProvider.mo1933get(), this.qsLoggerProvider.mo1933get(), this.customTileStatePersisterProvider.mo1933get());
    }
