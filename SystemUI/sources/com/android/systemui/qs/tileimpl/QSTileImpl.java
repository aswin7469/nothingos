...
public abstract class QSTileImpl<TState extends QSTile.State> implements QSTile, LifecycleOwner, Dumpable {
    ...
    public abstract TState mo1926newTileState();
    ...
    public final void resetStates() {
        this.mState = mo1926newTileState();
        TState mo1926newTileState = mo1926newTileState();
        this.mTmpState = mo1926newTileState;
        TState tstate = this.mState;
        String str = this.mTileSpec;
        tstate.spec = str;
        mo1926newTileState.spec = str;
    }
    ...
    protected void handleLongClick(View view) {
        ...
        if ("tesla".equals(view.getTag(R$id.qs_tesla_tag))) {
            ...
            this.mActivityStarter.postStartActivityDismissingKeyguard(intent, 0, fromView);
            return;
        }
    ...
    public static class ResourceIcon extends QSTile.Icon {
        ...
        public boolean equals(Object obj) {
            if (obj instanceof ResourceIcon) {
                ...
                if (resourceIcon.mResId == this.mResId && resourceIcon.isTesla == this.isTesla && resourceIcon.skipTintBt == this.skipTintBt) {
                    return true;
                }
            }
            return false;
