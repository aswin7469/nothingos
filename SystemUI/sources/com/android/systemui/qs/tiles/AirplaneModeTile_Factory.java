...
public final class AirplaneModeTile_Factory implements Factory<AirplaneModeTile> {
    ...
    /* renamed from: get */
    public AirplaneModeTile mo1933get() {
        return newInstance(this.hostProvider.mo1933get(), this.backgroundLooperProvider.mo1933get(), this.mainHandlerProvider.mo1933get(), this.falsingManagerProvider.mo1933get(), this.metricsLoggerProvider.mo1933get(), this.statusBarStateControllerProvider.mo1933get(), this.activityStarterProvider.mo1933get(), this.qsLoggerProvider.mo1933get(), this.broadcastDispatcherProvider.mo1933get(), DoubleCheck.lazy(this.connectivityManagerProvider));
    }
