...
public class InternetTile extends QSTileImpl<QSTile.SignalState> {
    ...
    private final NetworkController.AccessPointController mAccessPointController;
    ...
    public InternetTile(QSHost qSHost, Looper looper, Handler handler, FalsingManager falsingManager, MetricsLogger metricsLogger, StatusBarStateController statusBarStateController, ActivityStarter activityStarter, QSLogger qSLogger, NetworkController networkController, NetworkController.AccessPointController accessPointController, InternetDialogFactory internetDialogFactory) {
        ...
        networkController.observe(mo1437getLifecycle(), (Lifecycle) internetSignalCallback);
    }
    ...
    public /* synthetic */ void lambda$handleClick$0() {
        this.mInternetDialogFactory.create(true, this.mAccessPointController.canConfigMobileData(), this.mAccessPointController.canConfigWifi());
    }
    ...
    protected void handleClick(View view) {
        this.mHandler.post(new Runnable() { // from class: com.android.systemui.qs.tiles.InternetTile$$ExternalSyntheticLambda0
            ...
            public final void run() {
                InternetTile.this.lambda$handleClick$0();
            }
        });
    }
    ...
    private void handleUpdateCellularState(QSTile.SignalState signalState, Object obj) {
        ...
        if (cellularCallbackInfo.mAirplaneModeEnabled && cellularCallbackInfo.mQsTypeIcon != TelephonyIcons.ICON_CWF) {
            ...
            if (cellularCallbackInfo.mNoNetworksAvailable || !this.mSignalCallback.mWifiInfo.mEnabled) {
                signalState.icon = QSTileImpl.ResourceIcon.get(R$drawable.ic_qs_no_internet_unavailable);
                signalState.secondaryLabel = resources.getString(R$string.quick_settings_networks_unavailable);
            } else {
                signalState.icon = QSTileImpl.ResourceIcon.get(R$drawable.ic_qs_no_internet_available);
