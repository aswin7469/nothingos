...
public class MicrophoneToggleTile extends SensorPrivacyToggleTile {
    ...
    public boolean isAvailable() {
        return this.mSensorPrivacyController.supportsSensorToggle(1) && ((Boolean) DejankUtils.whitelistIpcs(MicrophoneToggleTile$$ExternalSyntheticLambda0.INSTANCE)).booleanValue();
    }
