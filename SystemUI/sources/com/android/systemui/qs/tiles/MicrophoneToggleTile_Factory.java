...
public final class MicrophoneToggleTile_Factory implements Factory<MicrophoneToggleTile> {
    ...
    /* renamed from: get */
    public MicrophoneToggleTile mo1933get() {
        return newInstance(this.hostProvider.mo1933get(), this.backgroundLooperProvider.mo1933get(), this.mainHandlerProvider.mo1933get(), this.metricsLoggerProvider.mo1933get(), this.falsingManagerProvider.mo1933get(), this.statusBarStateControllerProvider.mo1933get(), this.activityStarterProvider.mo1933get(), this.qsLoggerProvider.mo1933get(), this.sensorPrivacyControllerProvider.mo1933get(), this.keyguardStateControllerProvider.mo1933get());
    }
