...
public final class UserDetailView_Adapter_Factory implements Factory<UserDetailView.Adapter> {
    ...
    /* renamed from: get */
    public UserDetailView.Adapter mo1933get() {
        return newInstance(this.contextProvider.mo1933get(), this.controllerProvider.mo1933get(), this.uiEventLoggerProvider.mo1933get(), this.falsingManagerProvider.mo1933get());
    }
