...
public final /* synthetic */ class OverviewProxyService$1$$ExternalSyntheticLambda2 implements Runnable {
    ...
    public /* synthetic */ OverviewProxyService$1$$ExternalSyntheticLambda2(OverviewProxyService.C24211 r1, MotionEvent motionEvent) {
        this.f$0 = r1;
        this.f$1 = motionEvent;
    }

    public final void run() {
        this.f$0.mo37164x68b640ae(this.f$1);
    }
}
