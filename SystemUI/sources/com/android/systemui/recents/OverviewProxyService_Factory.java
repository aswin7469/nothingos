...
public final class OverviewProxyService_Factory implements Factory<OverviewProxyService> {
    ...
    /* renamed from: get */
    public OverviewProxyService mo1933get() {
        return newInstance(this.contextProvider.mo1933get(), this.commandQueueProvider.mo1933get(), DoubleCheck.lazy(this.navBarControllerLazyProvider), this.navModeControllerProvider.mo1933get(), this.statusBarWinControllerProvider.mo1933get(), this.sysUiStateProvider.mo1933get(), this.pipOptionalProvider.mo1933get(), this.legacySplitScreenOptionalProvider.mo1933get(), this.splitScreenOptionalProvider.mo1933get(), this.statusBarOptionalLazyProvider.mo1933get(), this.oneHandedOptionalProvider.mo1933get(), this.broadcastDispatcherProvider.mo1933get(), this.shellTransitionsProvider.mo1933get(), this.startingSurfaceProvider.mo1933get(), this.smartspaceTransitionControllerProvider.mo1933get());
    }
