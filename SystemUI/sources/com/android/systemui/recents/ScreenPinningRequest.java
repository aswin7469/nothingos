...
public class ScreenPinningRequest implements View.OnClickListener, NavigationModeController.ModeChangedListener {
    ...
    public class RequestWindowView extends FrameLayout {
        ...
        private final Runnable mUpdateLayoutRunnable = new Runnable() { // from class: com.android.systemui.recents.ScreenPinningRequest.RequestWindowView.2
        ...
        private final BroadcastReceiver mReceiver = new BroadcastReceiver() { // from class: com.android.systemui.recents.ScreenPinningRequest.RequestWindowView.3
        ...
        private void inflateView(int i) {
            ...
            if (!QuickStepContract.isGesturalMode(ScreenPinningRequest.this.mNavBarMode) && windowManagerWrapper.hasSoftNavigationBar(((FrameLayout) this).mContext.getDisplayId())) {
            ...
            NavigationBarView navigationBarView = (NavigationBarView) ScreenPinningRequest.this.mStatusBarOptionalLazy.map(ScreenPinningRequest$RequestWindowView$$ExternalSyntheticLambda0.INSTANCE).orElse(null);
