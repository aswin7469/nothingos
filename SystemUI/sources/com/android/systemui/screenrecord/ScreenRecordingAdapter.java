...
public class ScreenRecordingAdapter extends ArrayAdapter<ScreenRecordingAudioSource> {
    ...
    private void initViews() {
        this.mSelectedInternal = getSelected(C1893R.string.screenrecord_device_audio_label);
        this.mSelectedMic = getSelected(C1893R.string.screenrecord_mic_label);
        this.mSelectedMicAndInternal = getSelected(C1893R.string.screenrecord_device_audio_and_mic_label);
        LinearLayout option = getOption(C1893R.string.screenrecord_mic_label, 0);
        this.mMicOption = option;
        option.removeViewAt(1);
        LinearLayout option2 = getOption(C1893R.string.screenrecord_device_audio_and_mic_label, 0);
        this.mMicAndInternalOption = option2;
        option2.removeViewAt(1);
        this.mInternalOption = getOption(C1893R.string.screenrecord_device_audio_label, C1893R.string.screenrecord_device_audio_description);
    }

    private LinearLayout getOption(int i, int i2) {
        LinearLayout linearLayout = (LinearLayout) ((LayoutInflater) getContext().getSystemService("layout_inflater")).inflate(C1893R.layout.screen_record_dialog_audio_source, (ViewGroup) null, false);
        ((TextView) linearLayout.findViewById(C1893R.C1897id.screen_recording_dialog_source_text)).setText(i);
        if (i2 != 0) {
            ((TextView) linearLayout.findViewById(C1893R.C1897id.screen_recording_dialog_source_description)).setText(i2);
        }
        return linearLayout;
    }

    private LinearLayout getSelected(int i) {
        LinearLayout linearLayout = (LinearLayout) LayoutInflater.from(getContext()).inflate(C1893R.layout.screen_record_dialog_audio_source_selected, (ViewGroup) null, false);
        ((TextView) linearLayout.findViewById(C1893R.C1897id.screen_recording_dialog_source_text)).setText(i);
        return linearLayout;
    }
    ...
    static /* synthetic */ class C24291 {
        ...
        static final /* synthetic */ int[] f337x73e7906a;
        ...
        static {
            ...
            L_0x0012:
                int[] r0 = f337x73e7906a     // Catch:{ NoSuchFieldError -> 0x001d }
            ...
            L_0x001d:
                int[] r0 = f337x73e7906a     // Catch:{ NoSuchFieldError -> 0x0028 }
            ...
            L_0x0028:
                return
            */
            throw new UnsupportedOperationException("Method not decompiled: com.android.systemui.screenrecord.ScreenRecordingAdapter.C24291.<clinit>():void");
        }
    }

    public View getDropDownView(int i, View view, ViewGroup viewGroup) {
        int i2 = C24291.f337x73e7906a[((ScreenRecordingAudioSource) getItem(i)).ordinal()];
        if (i2 == 1) {
