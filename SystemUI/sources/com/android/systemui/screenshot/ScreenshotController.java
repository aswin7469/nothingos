...
public class ScreenshotController {
    ...
    public void takeScreenshotPartial(final Consumer<Uri> consumer, TakeScreenshotService.RequestCallback requestCallback) {
        ...
        this.mScreenshotView.takePartialScreenshot(new Consumer() { // from class: com.android.systemui.screenshot.ScreenshotController$$ExternalSyntheticLambda18
            @Override // java.util.function.Consumer
            public final void accept(Object obj) {
                ScreenshotController.this.lambda$takeScreenshotPartial$0(consumer, (Rect) obj);
            }
        });
    }
    ...
    private void reloadAssets() {
        ...
        this.mScreenshotView.setOnKeyListener(new View.OnKeyListener() { // from class: com.android.systemui.screenshot.ScreenshotController$$ExternalSyntheticLambda1
            ...
            public final boolean onKey(View view, int i, KeyEvent keyEvent) {
                boolean lambda$reloadAssets$1;
                lambda$reloadAssets$1 = ScreenshotController.this.lambda$reloadAssets$1(view, i, keyEvent);
                return lambda$reloadAssets$1;
            }
        });
    ...
    public /* synthetic */ void lambda$saveScreenshot$2(Configuration configuration, int i) {
        if (this.mConfigChanges.applyNewConfig(this.mContext.getResources())) {
            ...
            this.mScreenshotView.updateInsets(this.mWindowManager.getCurrentWindowMetrics().getWindowInsets());
    ...
    private void onScrollCaptureResponseReady(Future<ScrollCaptureResponse> future) {
        try {
            try {
                ...
                this.mScreenshotView.showScrollChip(scrollCaptureResponse3.getPackageName(), new Runnable() { // from class: com.android.systemui.screenshot.ScreenshotController$$ExternalSyntheticLambda14
                    @Override // java.lang.Runnable
                    public final void run() {
                        ScreenshotController.this.lambda$onScrollCaptureResponseReady$9(scrollCaptureResponse3);
                    }
                });
    ...
    /* JADX INFO: Access modifiers changed from: private */
    public /* synthetic */ void lambda$onScrollCaptureResponseReady$9(final ScrollCaptureResponse scrollCaptureResponse) {
        DisplayMetrics displayMetrics = new DisplayMetrics();
        getDefaultDisplay().getRealMetrics(displayMetrics);
        ...
        this.mScreenshotView.post(new Runnable() { // from class: com.android.systemui.screenshot.ScreenshotController$$ExternalSyntheticLambda13
            @Override // java.lang.Runnable
            public final void run() {
                ScreenshotController.this.lambda$onScrollCaptureResponseReady$8(scrollCaptureResponse);
            }
        });
    }
    ...
    public /* synthetic */ void lambda$onScrollCaptureResponseReady$8(ScrollCaptureResponse scrollCaptureResponse) {
        ...
        run.addListener(new Runnable() { // from class: com.android.systemui.screenshot.ScreenshotController$$ExternalSyntheticLambda17
            @Override // java.lang.Runnable
            public final void run() {
                ScreenshotController.this.lambda$onScrollCaptureResponseReady$7(run);
            }
        }, this.mMainExecutor);
    }
    ...
    public /* synthetic */ void lambda$onScrollCaptureResponseReady$7(ListenableFuture listenableFuture) {
        try {
            ...
            this.mLongScreenshotHolder.setTransitionDestinationCallback(new TransitionDestination() { // from class: com.android.systemui.screenshot.ScreenshotController$$ExternalSyntheticLambda7
                ...
                public final void setTransitionDestination(Rect rect, Runnable runnable) {
                    ScreenshotController.this.lambda$onScrollCaptureResponseReady$6(longScreenshot, rect, runnable);
                }
            });
    ...
    private void saveScreenshotAndToast(final Consumer<Uri> consumer) {
        ...
        saveScreenshotInWorkerThread(consumer, new ActionsReadyListener() { // from class: com.android.systemui.screenshot.ScreenshotController$$ExternalSyntheticLambda5
            @Override // com.android.systemui.screenshot.ScreenshotController.ActionsReadyListener
            public final void onActionsReady(ScreenshotController.SavedImageData savedImageData) {
                ScreenshotController.this.lambda$saveScreenshotAndToast$11(consumer, savedImageData);
            }
        }, null);
    }
    ...
    public void resetTimeout() {
        ...
        handler.sendMessageDelayed(handler.obtainMessage(2), ((AccessibilityManager) this.mContext.getSystemService("accessibility")).getRecommendedTimeoutMillis(6000, 4));
    }
    ...
    public void showUiOnActionsReady(final SavedImageData savedImageData) {
        ...
        resetTimeout();
        if (savedImageData.uri != null) {
            this.mScreenshotHandler.post(new Runnable() { // from class: com.android.systemui.screenshot.ScreenshotController$$ExternalSyntheticLambda16
                @Override // java.lang.Runnable
                public final void run() {
                    ScreenshotController.this.lambda$showUiOnActionsReady$12(savedImageData);
                }
            });
        }
    }
    ...
    public void showUiOnQuickShareActionReady(final QuickShareData quickShareData) {
        if (quickShareData.quickShareAction != null) {
            this.mScreenshotHandler.post(new Runnable() { // from class: com.android.systemui.screenshot.ScreenshotController$$ExternalSyntheticLambda15
                @Override // java.lang.Runnable
                public final void run() {
                    ScreenshotController.this.lambda$showUiOnQuickShareActionReady$13(quickShareData);
                }
            });
        }
    }
    ...
    private Supplier<SavedImageData.ActionTransition> getActionTransitionSupplier() {
        return new Supplier() { // from class: com.android.systemui.screenshot.ScreenshotController$$ExternalSyntheticLambda19
            ...
            public final Object get() {
                ScreenshotController.SavedImageData.ActionTransition lambda$getActionTransitionSupplier$15;
                lambda$getActionTransitionSupplier$15 = ScreenshotController.this.lambda$getActionTransitionSupplier$15();
                return lambda$getActionTransitionSupplier$15;
            }
        };
    }
    ...
    public /* synthetic */ SavedImageData.ActionTransition lambda$getActionTransitionSupplier$15() {
        ...
        Pair startSharedElementAnimation = ActivityOptions.startSharedElementAnimation(this.mWindow, new ScreenshotExitTransitionCallbacksSupplier(true).mo941get(), null, new Pair[]{Pair.create(this.mScreenshotView.getTransitionView(), "screenshot_preview_image")});
    ...
    public class ScreenshotExitTransitionCallbacksSupplier implements Supplier<ExitTransitionCoordinator.ExitTransitionCallbacks> {
        ...
        @Override // java.util.function.Supplier
        /* renamed from: get */
        public ExitTransitionCoordinator.ExitTransitionCallbacks mo941get() {
