...
public final class UserTrackerImpl extends BroadcastReceiver implements UserTracker, Dumpable {
    ...
    @Metadata(mo64986d1 = {"\u0000\u0012\n\u0002\u0018\u0002\n\u0002\u0010\u0000\n\u0002\b\u0002\n\u0002\u0010\u000e\n\u0000\b\u0003\u0018\u00002\u00020\u0001B\u0007\b\u0002¢\u0006\u0002\u0010\u0002R\u000e\u0010\u0003\u001a\u00020\u0004XT¢\u0006\u0002\n\u0000¨\u0006\u0005"}, mo64987d2 = {"Lcom/android/systemui/settings/UserTrackerImpl$Companion;", "", "()V", "TAG", "", "SystemUI_nothingRelease"}, mo64988k = 1, mo64989mv = {1, 6, 0}, mo64991xi = 48)
    /* compiled from: UserTrackerImpl.kt */
    ...
    private final Pair<Context, List<UserInfo>> setUserIdInternal(int i) {
        ...
        return TuplesKt.m1796to(createContextAsUser, profiles);
    }
    ...
    private final void handleProfilesChanged() {
        ...
        for (DataItem dataItem : list) {
            if (dataItem.getCallback().get() != null) {
                dataItem.getExecutor().execute(new C2466xc58954eb(dataItem, profiles));
            }
        }
    }
    ...
    public static final boolean m3021removeCallback$lambda11$lambda10(UserTracker.Callback callback, DataItem dataItem) {
        Intrinsics.checkNotNullParameter(callback, "$callback");
