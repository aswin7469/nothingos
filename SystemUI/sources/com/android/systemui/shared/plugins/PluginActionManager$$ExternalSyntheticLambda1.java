...
public final /* synthetic */ class PluginActionManager$$ExternalSyntheticLambda1 implements Runnable {
    ...
    public /* synthetic */ PluginActionManager$$ExternalSyntheticLambda1(PluginActionManager pluginActionManager, PluginInstance pluginInstance) {
        this.f$0 = pluginActionManager;
        this.f$1 = pluginInstance;
    }

    public final void run() {
        this.f$0.mo37858x2d46fcb0(this.f$1);
    }
}
