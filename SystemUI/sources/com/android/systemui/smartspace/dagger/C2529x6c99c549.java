...
public final class C2529x6c99c549 implements Factory<BcSmartspaceDataPlugin.SmartspaceView> {
    ...
    public C2529x6c99c549(Provider<ActivityStarter> provider, Provider<FalsingManager> provider2, Provider<ViewGroup> provider3, Provider<BcSmartspaceDataPlugin> provider4, Provider<View.OnAttachStateChangeListener> provider5) {
    ...
    public static C2529x6c99c549 create(Provider<ActivityStarter> provider, Provider<FalsingManager> provider2, Provider<ViewGroup> provider3, Provider<BcSmartspaceDataPlugin> provider4, Provider<View.OnAttachStateChangeListener> provider5) {
        return new C2529x6c99c549(provider, provider2, provider3, provider4, provider5);
    }
