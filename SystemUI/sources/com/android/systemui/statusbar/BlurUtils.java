...
public class BlurUtils implements Dumpable {
    ...
    public BlurUtils(@Main Resources resources2, CrossWindowBlurListeners crossWindowBlurListeners2, DumpManager dumpManager) {
        ...
        this.minBlurRadius = resources2.getDimensionPixelSize(C1894R.dimen.min_window_blur_radius);
        this.maxBlurRadius = resources2.getDimensionPixelSize(C1894R.dimen.max_window_blur_radius);
