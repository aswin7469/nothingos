...
public final class C4835LockscreenShadeKeyguardTransitionController_Factory {
    private final Provider<ConfigurationController> configurationControllerProvider;
    private final Provider<Context> contextProvider;
    private final Provider<DumpManager> dumpManagerProvider;
    private final Provider<MediaHierarchyManager> mediaHierarchyManagerProvider;

    public C4835LockscreenShadeKeyguardTransitionController_Factory(Provider<MediaHierarchyManager> provider, Provider<Context> provider2, Provider<ConfigurationController> provider3, Provider<DumpManager> provider4) {
    ...
    public static C4835LockscreenShadeKeyguardTransitionController_Factory create(Provider<MediaHierarchyManager> provider, Provider<Context> provider2, Provider<ConfigurationController> provider3, Provider<DumpManager> provider4) {
        return new C4835LockscreenShadeKeyguardTransitionController_Factory(provider, provider2, provider3, provider4);
    }
