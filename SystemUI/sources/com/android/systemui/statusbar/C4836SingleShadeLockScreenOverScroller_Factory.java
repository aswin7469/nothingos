...
public final class C4836SingleShadeLockScreenOverScroller_Factory {
    private final Provider<ConfigurationController> configurationControllerProvider;
    private final Provider<Context> contextProvider;
    private final Provider<SysuiStatusBarStateController> statusBarStateControllerProvider;

    public C4836SingleShadeLockScreenOverScroller_Factory(Provider<ConfigurationController> provider, Provider<Context> provider2, Provider<SysuiStatusBarStateController> provider3) {
    ...
    public static C4836SingleShadeLockScreenOverScroller_Factory create(Provider<ConfigurationController> provider, Provider<Context> provider2, Provider<SysuiStatusBarStateController> provider3) {
        return new C4836SingleShadeLockScreenOverScroller_Factory(provider, provider2, provider3);
    }
