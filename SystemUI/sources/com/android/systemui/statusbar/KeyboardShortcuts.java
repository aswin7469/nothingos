...
public final class KeyboardShortcuts {
    ...
    private void loadResources(Context context) {
        ...
        SparseArray<String> sparseArray = this.mSpecialCharacterNames;
        ...
        SparseArray<String> sparseArray2 = this.mSpecialCharacterNames;
        ...
        this.mSpecialCharacterNames.put(R$styleable.Constraint_layout_goneMarginRight, context.getString(i2, "Z"));
        this.mSpecialCharacterNames.put(R$styleable.Constraint_layout_goneMarginStart, context.getString(i2, "L1"));
        this.mSpecialCharacterNames.put(R$styleable.Constraint_layout_goneMarginTop, context.getString(i2, "R1"));
        this.mSpecialCharacterNames.put(R$styleable.Constraint_motionStagger, context.getString(i2, "L2"));
        this.mSpecialCharacterNames.put(R$styleable.Constraint_pathMotionArc, context.getString(i2, "R2"));
        this.mSpecialCharacterNames.put(R$styleable.Constraint_transitionEasing, context.getString(i2, "Start"));
        this.mSpecialCharacterNames.put(R$styleable.Constraint_transitionPathRotate, context.getString(i2, "Select"));
        this.mSpecialCharacterNames.put(R$styleable.Constraint_visibilityMode, context.getString(i2, "Mode"));
        ...
        this.mSpecialCharacterNames.put(androidx.appcompat.R$styleable.AppCompatTheme_windowFixedWidthMajor, context.getString(R$string.keyboard_key_move_home));
        this.mSpecialCharacterNames.put(androidx.appcompat.R$styleable.AppCompatTheme_windowFixedWidthMinor, context.getString(R$string.keyboard_key_move_end));
        this.mSpecialCharacterNames.put(androidx.appcompat.R$styleable.AppCompatTheme_windowMinWidthMajor, context.getString(R$string.keyboard_key_insert));
        ...
        SparseArray<String> sparseArray3 = this.mSpecialCharacterNames;
    ...
    private PackageInfo getPackageInfoForIntent(Intent intent, int i) {
        ...
        try {
            ...
            if (resolveIntent != null && (activityInfo = resolveIntent.activityInfo) != null) {
                return this.mPackageManager.getPackageInfo(activityInfo.packageName, 0, i);
            }
            return null;
    ...
    private void populateKeyboardShortcuts(LinearLayout linearLayout, List<KeyboardShortcutGroup> list) {
        ...
        while (i9 < size) {
            ...
            textView2.setTextColor(keyboardShortcutGroup2.isSystemGroup() ? Utils.getColorAccent(this.mContext) : ColorStateList.valueOf(this.mContext.getColor(R$color.ksh_application_group_color)));
