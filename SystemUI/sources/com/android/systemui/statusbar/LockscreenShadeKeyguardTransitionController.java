...
public final class LockscreenShadeKeyguardTransitionController extends AbstractLockscreenShadeTransitionController {
    ...
    public void updateResources() {
        this.alphaTransitionDistance = getContext().getResources().getDimensionPixelSize(C1894R.dimen.lockscreen_shade_npvc_keyguard_content_alpha_transition_distance);
        this.keyguardTransitionDistance = getContext().getResources().getDimensionPixelSize(C1894R.dimen.lockscreen_shade_keyguard_transition_distance);
        this.keyguardTransitionOffset = getContext().getResources().getDimensionPixelSize(C1894R.dimen.lockscreen_shade_keyguard_transition_vertical_offset);
    }
