...
public final class LockscreenShadeScrimTransitionController extends AbstractLockscreenShadeTransitionController {
    ...
    public void updateResources() {
        this.scrimTransitionDistance = getContext().getResources().getDimensionPixelSize(C1893R.dimen.lockscreen_shade_scrim_transition_distance);
        this.notificationsScrimTransitionDelay = getContext().getResources().getDimensionPixelSize(C1893R.dimen.lockscreen_shade_notifications_scrim_transition_delay);
        this.notificationsScrimTransitionDistance = getContext().getResources().getDimensionPixelSize(C1893R.dimen.lockscreen_shade_notifications_scrim_transition_distance);
    }
