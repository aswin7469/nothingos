...
public final class LockscreenShadeTransitionController implements Dumpable {
    ...
    public LockscreenShadeTransitionController(SysuiStatusBarStateController sysuiStatusBarStateController, LSShadeTransitionLogger lSShadeTransitionLogger, KeyguardBypassController keyguardBypassController2, NotificationLockscreenUserManager notificationLockscreenUserManager, FalsingCollector falsingCollector2, AmbientState ambientState2, MediaHierarchyManager mediaHierarchyManager2, LockscreenShadeScrimTransitionController lockscreenShadeScrimTransitionController, LockscreenShadeKeyguardTransitionController.Factory factory, NotificationShadeDepthController notificationShadeDepthController, Context context2, SplitShadeLockScreenOverScroller.Factory factory2, SingleShadeLockScreenOverScroller.Factory factory3, WakefulnessLifecycle wakefulnessLifecycle, ConfigurationController configurationController, FalsingManager falsingManager, DumpManager dumpManager) {
        ...
        this.keyguardTransitionController$delegate = LazyKt.lazy(new C2563x794b57c2(this));
        updateResources();
    ...
    public final void updateResources() {
        this.fullTransitionDistance = this.context.getResources().getDimensionPixelSize(C1894R.dimen.lockscreen_shade_full_transition_distance);
        this.fullTransitionDistanceByTap = this.context.getResources().getDimensionPixelSize(C1894R.dimen.lockscreen_shade_transition_by_tap_distance);
        this.notificationShelfTransitionDistance = this.context.getResources().getDimensionPixelSize(C1894R.dimen.lockscreen_shade_notif_shelf_transition_distance);
        this.qsTransitionDistance = this.context.getResources().getDimensionPixelSize(C1894R.dimen.lockscreen_shade_qs_transition_distance);
        this.depthControllerTransitionDistance = this.context.getResources().getDimensionPixelSize(C1894R.dimen.lockscreen_shade_depth_controller_transition_distance);
        this.udfpsTransitionDistance = this.context.getResources().getDimensionPixelSize(C1894R.dimen.lockscreen_shade_udfps_keyguard_transition_distance);
        this.statusBarTransitionDistance = this.context.getResources().getDimensionPixelSize(C1894R.dimen.lockscreen_shade_status_bar_transition_distance);
    ...
    public static final void m3031bindController$lambda0(LockscreenShadeTransitionController lockscreenShadeTransitionController, View view) {
    ...
    public final void onDraggedDown$SystemUI_nothingRelease(View view, int i) {
        if (canDragDown$SystemUI_nothingRelease()) {
            ...
            if (!this.ambientState.isDozing() || view != null) {
                Function1 lockscreenShadeTransitionController$onDraggedDown$animationHandler$1 = new C2564x21fef5f(view, this);
    ...
    public static final void m3034onDraggedDown$lambda1(LockscreenShadeTransitionController lockscreenShadeTransitionController) {
        Intrinsics.checkNotNullParameter(lockscreenShadeTransitionController, "this$0");
    ...
    public static final boolean m3035onDraggedDown$lambda2(LockscreenShadeTransitionController lockscreenShadeTransitionController) {
        Intrinsics.checkNotNullParameter(lockscreenShadeTransitionController, "this$0");
    ...
    private final void transitionToShadeAmountCommon(float f) {
        ...
        NTLogUtil.m1686d(this.TAG, "udfpsProgress " + saturate + " dragDownAmount " + f + " udfpsTransitionDistance " + this.udfpsTransitionDistance + " - " + Debug.getCallers(5));
    ...
    public static final void m3036setDragDownAmountAnimated$lambda4(LockscreenShadeTransitionController lockscreenShadeTransitionController, ValueAnimator valueAnimator) {
        Intrinsics.checkNotNullParameter(lockscreenShadeTransitionController, "this$0");
    ...
    public static final boolean m3032goToLockedShadeInternal$lambda5(LockscreenShadeTransitionController lockscreenShadeTransitionController, Function1 function1) {
        Intrinsics.checkNotNullParameter(lockscreenShadeTransitionController, "this$0");
    ...
    public static final void m3033goToLockedShadeInternal$lambda7(LockscreenShadeTransitionController lockscreenShadeTransitionController, Runnable runnable) {
        Intrinsics.checkNotNullParameter(lockscreenShadeTransitionController, "this$0");
    ...
    private final void performDefaultGoToFullShadeAnimation(long j) {
        ...
        if (!getCentralSurfaces().getNotificationPanelViewController().isQsCustomizing() || !((CentralSurfacesImplEx) NTDependencyEx.get(CentralSurfacesImplEx.class)).isPanelCollapsedByDream()) {
            animateAppear(j);
        }
    }
    ...
    public static final void m3037setPulseHeight$lambda9(LockscreenShadeTransitionController lockscreenShadeTransitionController, ValueAnimator valueAnimator) {
        Intrinsics.checkNotNullParameter(lockscreenShadeTransitionController, "this$0");
        Intrinsics.checkNotNullParameter(valueAnimator, "animation");
        Object animatedValue = valueAnimator.getAnimatedValue();
        if (animatedValue != null) {
