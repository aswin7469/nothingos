...
public final class LockscreenShadeTransitionController_Factory implements Factory<LockscreenShadeTransitionController> {
    ...
    /* renamed from: get */
    public LockscreenShadeTransitionController mo1933get() {
        return newInstance(this.statusBarStateControllerProvider.mo1933get(), this.lockscreenGestureLoggerProvider.mo1933get(), this.keyguardBypassControllerProvider.mo1933get(), this.lockScreenUserManagerProvider.mo1933get(), this.falsingCollectorProvider.mo1933get(), this.ambientStateProvider.mo1933get(), this.displayMetricsProvider.mo1933get(), this.mediaHierarchyManagerProvider.mo1933get(), this.scrimControllerProvider.mo1933get(), this.depthControllerProvider.mo1933get(), this.featureFlagsProvider.mo1933get(), this.contextProvider.mo1933get(), this.configurationControllerProvider.mo1933get(), this.falsingManagerProvider.mo1933get());
    }
