...
public final class NotificationClickNotifier {
    ...
    public static final void m3034onNotificationActionClick$lambda0(NotificationClickNotifier notificationClickNotifier, String str) {
    ...
    public static final void m3035onNotificationClick$lambda1(NotificationClickNotifier notificationClickNotifier, String str) {
        Intrinsics.checkNotNullParameter(notificationClickNotifier, "this$0");
        Intrinsics.checkNotNullParameter(str, "$key");
        notificationClickNotifier.notifyListenersAboutInteraction(str);
    }
