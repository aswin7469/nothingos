...
public class NotificationLockscreenUserManagerImpl implements Dumpable, NotificationLockscreenUserManager, StatusBarStateController.StateListener {
    ...
    public boolean shouldHideNotifications(String str) {
        ...
        return isLockscreenPublicMode(this.mCurrentUserId) && activeNotificationUnfiltered != null && activeNotificationUnfiltered.getRanking().getLockscreenVisibilityOverride() == -1;
    }
    ...
    private boolean hideSilentNotificationsOnLockscreen() {
        return ((Boolean) DejankUtils.whitelistIpcs(new Supplier() { // from class: com.android.systemui.statusbar.NotificationLockscreenUserManagerImpl$$ExternalSyntheticLambda1
            ...
            public final Object get() {
                Boolean lambda$hideSilentNotificationsOnLockscreen$0;
                lambda$hideSilentNotificationsOnLockscreen$0 = NotificationLockscreenUserManagerImpl.this.lambda$hideSilentNotificationsOnLockscreen$0();
                return lambda$hideSilentNotificationsOnLockscreen$0;
            }
        })).booleanValue();
    }
    ...
    private boolean packageHasVisibilityOverride(String str) {
        ...
        NotificationEntry activeNotificationUnfiltered = getEntryManager().getActiveNotificationUnfiltered(str);
        return activeNotificationUnfiltered != null && activeNotificationUnfiltered.getRanking().getLockscreenVisibilityOverride() == 0;
    }
    ...
    public void updateCurrentProfilesCache() {
        ...
        this.mMainHandler.post(new Runnable() { // from class: com.android.systemui.statusbar.NotificationLockscreenUserManagerImpl$$ExternalSyntheticLambda0
            ...
            public final void run() {
                NotificationLockscreenUserManagerImpl.this.lambda$updateCurrentProfilesCache$1();
            }
        });
    }
    ...
    public void updatePublicMode() {
        ...
        for (int size = currentProfiles.size() - 1; size >= 0; size--) {
            ...
            boolean booleanValue = ((Boolean) DejankUtils.whitelistIpcs(new Supplier() { // from class: com.android.systemui.statusbar.NotificationLockscreenUserManagerImpl$$ExternalSyntheticLambda2
                @Override // java.util.function.Supplier
                public final Object get() {
                    Boolean lambda$updatePublicMode$2;
                    lambda$updatePublicMode$2 = NotificationLockscreenUserManagerImpl.this.lambda$updatePublicMode$2(i);
                    return lambda$updatePublicMode$2;
                }
            })).booleanValue();
