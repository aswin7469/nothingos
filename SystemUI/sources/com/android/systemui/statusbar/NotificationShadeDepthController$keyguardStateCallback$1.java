...
@Metadata(mo65042d1 = {"\u0000\u0013\n\u0000\n\u0002\u0018\u0002\n\u0000\n\u0002\u0010\u0002\n\u0002\b\u0002*\u0001\u0000\b\n\u0018\u00002\u00020\u0001J\b\u0010\u0002\u001a\u00020\u0003H\u0016J\b\u0010\u0004\u001a\u00020\u0003H\u0016¨\u0006\u0005"}, mo65043d2 = {"com/android/systemui/statusbar/NotificationShadeDepthController$keyguardStateCallback$1", "Lcom/android/systemui/statusbar/policy/KeyguardStateController$Callback;", "onKeyguardFadingAwayChanged", "", "onKeyguardShowingChanged", "SystemUI_nothingRelease"}, mo65044k = 1, mo65045mv = {1, 6, 0}, mo65047xi = 48)
...
public final class NotificationShadeDepthController$keyguardStateCallback$1 implements KeyguardStateController.Callback {
    ...
    public void onKeyguardFadingAwayChanged() {
        if (this.this$0.keyguardStateController.isKeyguardFadingAway() && this.this$0.biometricUnlockController.getMode() == 1) {
            ...
            ofFloat.addUpdateListener(new C2587x82488ea5(notificationShadeDepthController2));
            ofFloat.addListener(new C2589xd4eb1c55(notificationShadeDepthController2));
            ofFloat.start();
    ...
    public static final void m3044onKeyguardFadingAwayChanged$lambda1$lambda0(NotificationShadeDepthController notificationShadeDepthController, ValueAnimator valueAnimator) {
