...
public final class SingleShadeLockScreenOverScroller_Factory_Impl implements SingleShadeLockScreenOverScroller.Factory {
    private final C4836SingleShadeLockScreenOverScroller_Factory delegateFactory;

    SingleShadeLockScreenOverScroller_Factory_Impl(C4836SingleShadeLockScreenOverScroller_Factory singleShadeLockScreenOverScroller_Factory) {
    ...
    public static Provider<SingleShadeLockScreenOverScroller.Factory> create(C4836SingleShadeLockScreenOverScroller_Factory singleShadeLockScreenOverScroller_Factory) {
