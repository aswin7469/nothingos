...
public final class RippleShader extends RuntimeShader {
    ...
    public final void setOrigin(@NotNull PointF value) {
        ...
        this.origin = value;
        setUniform("in_origin", new float[]{value.x, value.y});
    }
    ...
    public final void setProgress(float f) {
        ...
        float f3 = 1;
        float f4 = f3 - f;
        setUniform("in_radius", (f3 - ((f4 * f4) * f4)) * this.radius);
        ...
        setUniform("in_fadeSparkle", Math.min(subProgress, f3 - subProgress2));
        setUniform("in_fadeCircle", f3 - f5);
        setUniform("in_fadeRing", Math.min(subProgress, f3 - f2));
    }
