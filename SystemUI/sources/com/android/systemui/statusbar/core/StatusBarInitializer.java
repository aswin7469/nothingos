...
public final class StatusBarInitializer {
    ...
    public final void initializeStatusBar(CentralSurfacesComponent centralSurfacesComponent) {
        ...
        this.windowController.getFragmentHostManager().addTagListener(CollapsedStatusBarFragment.TAG, new StatusBarInitializer$initializeStatusBar$1(this)).getFragmentManager().beginTransaction().replace(C1894R.C1898id.status_bar_container, centralSurfacesComponent.createCollapsedStatusBarFragment(), CollapsedStatusBarFragment.TAG).commit();
    }
}
