...
public final class C2627xbcfb28e4 implements Factory<NotificationMediaManager> {
    ...
    public static C2627xbcfb28e4 create(Provider<Context> provider, Provider<Optional<CentralSurfaces>> provider2, Provider<NotificationShadeWindowController> provider3, Provider<NotificationVisibilityProvider> provider4, Provider<NotificationEntryManager> provider5, Provider<MediaArtworkProcessor> provider6, Provider<KeyguardBypassController> provider7, Provider<NotifPipeline> provider8, Provider<NotifCollection> provider9, Provider<NotifPipelineFlags> provider10, Provider<DelayableExecutor> provider11, Provider<MediaDataManager> provider12, Provider<DumpManager> provider13) {
        return new C2627xbcfb28e4(provider, provider2, provider3, provider4, provider5, provider6, provider7, provider8, provider9, provider10, provider11, provider12, provider13);
    }
