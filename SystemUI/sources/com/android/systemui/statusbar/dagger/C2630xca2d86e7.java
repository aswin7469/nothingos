...
public final class C2630xca2d86e7 implements Factory<OngoingCallController> {
    ...
    public static C2630xca2d86e7 create(Provider<Context> provider, Provider<CommonNotifCollection> provider2, Provider<SystemClock> provider3, Provider<ActivityStarter> provider4, Provider<Executor> provider5, Provider<IActivityManager> provider6, Provider<OngoingCallLogger> provider7, Provider<DumpManager> provider8, Provider<StatusBarWindowController> provider9, Provider<SwipeStatusBarAwayGestureHandler> provider10, Provider<StatusBarStateController> provider11, Provider<OngoingCallFlags> provider12) {
        return new C2630xca2d86e7(provider, provider2, provider3, provider4, provider5, provider6, provider7, provider8, provider9, provider10, provider11, provider12);
    }
