...
public final class C2631x512569cf implements Factory<ActivityLaunchAnimator> {
    public ActivityLaunchAnimator get() {
        return provideActivityLaunchAnimator();
    }

    public static C2631x512569cf create() {
    ...
    private static final class InstanceHolder {
        ...
        public static final C2631x512569cf INSTANCE = new C2631x512569cf();
