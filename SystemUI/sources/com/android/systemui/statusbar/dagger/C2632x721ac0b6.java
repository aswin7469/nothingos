...
public final class C2632x721ac0b6 implements Factory<DialogLaunchAnimator> {
    private final Provider<IDreamManager> dreamManagerProvider;

    public C2632x721ac0b6(Provider<IDreamManager> provider) {
    ...
    public static C2632x721ac0b6 create(Provider<IDreamManager> provider) {
        return new C2632x721ac0b6(provider);
    }
