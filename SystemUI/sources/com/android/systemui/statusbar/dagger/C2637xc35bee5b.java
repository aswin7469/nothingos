...
public final class C2637xc35bee5b implements Factory<SmartReplyController> {
    ...
    public C2637xc35bee5b(Provider<DumpManager> provider, Provider<NotificationVisibilityProvider> provider2, Provider<IStatusBarService> provider3, Provider<NotificationClickNotifier> provider4) {
    ...
    public static C2637xc35bee5b create(Provider<DumpManager> provider, Provider<NotificationVisibilityProvider> provider2, Provider<IStatusBarService> provider3, Provider<NotificationClickNotifier> provider4) {
        return new C2637xc35bee5b(provider, provider2, provider3, provider4);
    }
