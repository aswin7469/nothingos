...
public final class StatusBarDependenciesModule_ProvideNotificationListenerFactory implements Factory<NotificationListener> {
    ...
    /* renamed from: get */
    public NotificationListener mo1933get() {
        return provideNotificationListener(this.contextProvider.mo1933get(), this.notificationManagerProvider.mo1933get(), this.mainHandlerProvider.mo1933get());
    }
