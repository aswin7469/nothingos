...
public final class StatusBarDependenciesModule_ProvideNotificationMediaManagerFactory implements Factory<NotificationMediaManager> {
    ...
    /* renamed from: get */
    public NotificationMediaManager mo1933get() {
        return provideNotificationMediaManager(this.contextProvider.mo1933get(), DoubleCheck.lazy(this.statusBarLazyProvider), DoubleCheck.lazy(this.notificationShadeWindowControllerProvider), this.notificationEntryManagerProvider.mo1933get(), this.mediaArtworkProcessorProvider.mo1933get(), this.keyguardBypassControllerProvider.mo1933get(), this.notifPipelineProvider.mo1933get(), this.notifCollectionProvider.mo1933get(), this.featureFlagsProvider.mo1933get(), this.mainExecutorProvider.mo1933get(), this.deviceConfigProxyProvider.mo1933get(), this.mediaDataManagerProvider.mo1933get());
    }
