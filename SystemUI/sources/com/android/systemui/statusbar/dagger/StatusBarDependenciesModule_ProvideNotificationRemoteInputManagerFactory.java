...
public final class StatusBarDependenciesModule_ProvideNotificationRemoteInputManagerFactory implements Factory<NotificationRemoteInputManager> {
    ...
    /* renamed from: get */
    public NotificationRemoteInputManager mo1933get() {
        return provideNotificationRemoteInputManager(this.contextProvider.mo1933get(), this.lockscreenUserManagerProvider.mo1933get(), this.smartReplyControllerProvider.mo1933get(), this.notificationEntryManagerProvider.mo1933get(), DoubleCheck.lazy(this.statusBarLazyProvider), this.statusBarStateControllerProvider.mo1933get(), this.mainHandlerProvider.mo1933get(), this.remoteInputUriControllerProvider.mo1933get(), this.clickNotifierProvider.mo1933get(), this.actionClickLoggerProvider.mo1933get());
    }
