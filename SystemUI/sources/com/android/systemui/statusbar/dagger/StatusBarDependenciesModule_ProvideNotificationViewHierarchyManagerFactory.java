...
public final class StatusBarDependenciesModule_ProvideNotificationViewHierarchyManagerFactory implements Factory<NotificationViewHierarchyManager> {
    ...
    /* renamed from: get */
    public NotificationViewHierarchyManager mo1933get() {
        return provideNotificationViewHierarchyManager(this.contextProvider.mo1933get(), this.mainHandlerProvider.mo1933get(), this.notificationLockscreenUserManagerProvider.mo1933get(), this.groupManagerProvider.mo1933get(), this.visualStabilityManagerProvider.mo1933get(), this.statusBarStateControllerProvider.mo1933get(), this.notificationEntryManagerProvider.mo1933get(), this.bypassControllerProvider.mo1933get(), this.bubblesOptionalProvider.mo1933get(), this.privacyControllerProvider.mo1933get(), this.fgsSectionControllerProvider.mo1933get(), this.dynamicChildBindControllerProvider.mo1933get(), this.lowPriorityInflationHelperProvider.mo1933get(), this.assistantFeedbackControllerProvider.mo1933get());
    }
