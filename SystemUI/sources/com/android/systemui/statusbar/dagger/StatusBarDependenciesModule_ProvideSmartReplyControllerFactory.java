...
public final class StatusBarDependenciesModule_ProvideSmartReplyControllerFactory implements Factory<SmartReplyController> {
    ...
    /* renamed from: get */
    public SmartReplyController mo1933get() {
        return provideSmartReplyController(this.entryManagerProvider.mo1933get(), this.statusBarServiceProvider.mo1933get(), this.clickNotifierProvider.mo1933get());
    }
