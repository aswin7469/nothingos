...
public final class SystemEventCoordinator_Factory implements Factory<SystemEventCoordinator> {
    ...
    /* renamed from: get */
    public SystemEventCoordinator mo1933get() {
        return newInstance(this.systemClockProvider.mo1933get(), this.batteryControllerProvider.mo1933get(), this.privacyControllerProvider.mo1933get(), this.contextProvider.mo1933get());
    }
