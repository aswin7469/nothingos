...
public final class ViewState {
    ...
    public int hashCode() {
        ...
        int i14 = 0;
        int hashCode = (i13 + (rect == null ? 0 : rect.hashCode())) * 31;
    ...
    public final boolean needsLayout(@NotNull ViewState other) {
        Intrinsics.checkNotNullParameter(other, "other");
        return this.rotation != other.rotation || this.layoutRtl != other.layoutRtl || !Intrinsics.areEqual(this.portraitRect, other.portraitRect) || !Intrinsics.areEqual(this.landscapeRect, other.landscapeRect) || !Intrinsics.areEqual(this.upsideDownRect, other.upsideDownRect) || !Intrinsics.areEqual(this.seascapeRect, other.seascapeRect);
    }
