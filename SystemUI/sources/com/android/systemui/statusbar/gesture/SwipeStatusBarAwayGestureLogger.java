...
public final class SwipeStatusBarAwayGestureLogger {
    ...
    public final void logGestureDetectionEndedWithoutTriggering(int i) {
        LogBuffer logBuffer = this.buffer;
        LogMessage obtain = logBuffer.obtain("SwipeStatusBarAwayGestureHandler", LogLevel.DEBUG, C2637x6caa9506.INSTANCE);
        obtain.setInt1(i);
        logBuffer.commit(obtain);
    }
