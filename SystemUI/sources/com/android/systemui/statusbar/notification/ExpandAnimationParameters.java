...
public final class ExpandAnimationParameters extends ActivityLaunchAnimator.State {
    ...
    public int getTopChange() {
        ...
        return Math.min(super.getTopChange() - (!((((float) i) > 0.0f ? 1 : (((float) i) == 0.0f ? 0 : -1)) == 0) ? (int) MathUtils.lerp(0.0f, i, Interpolators.FAST_OUT_SLOW_IN.getInterpolation(this.linearProgress)) : 0), 0);
    }
