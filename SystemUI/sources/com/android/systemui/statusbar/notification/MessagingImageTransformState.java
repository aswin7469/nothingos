...
public class MessagingImageTransformState extends ImageTransformState {
    ...
    public void transformViewFrom(TransformState transformState, int i, ViewTransformationHelper.CustomTransformation customTransformation, float f) {
        ...
        messagingImageMessage2.setActualWidth((int) NotificationUtils.interpolate(getStartActualWidth(), messagingImageMessage2.getWidth(), interpolation));
        MessagingImageMessage messagingImageMessage3 = this.mImageMessage;
        messagingImageMessage3.setActualHeight((int) NotificationUtils.interpolate(getStartActualHeight(), messagingImageMessage3.getHeight(), interpolation));
    }
