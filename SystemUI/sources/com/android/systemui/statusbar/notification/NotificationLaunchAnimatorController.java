...
public final class NotificationLaunchAnimatorController implements ActivityLaunchAnimator.Controller {
    ...
    public void setLaunchContainer(@NotNull ViewGroup ignored) {
        Intrinsics.checkNotNullParameter(ignored, "ignored");
    }

    public NotificationLaunchAnimatorController(@NotNull NotificationShadeWindowViewController notificationShadeWindowViewController, @NotNull NotificationListContainer notificationListContainer, @NotNull HeadsUpManagerPhone headsUpManager, @NotNull ExpandableNotificationRow notification) {
