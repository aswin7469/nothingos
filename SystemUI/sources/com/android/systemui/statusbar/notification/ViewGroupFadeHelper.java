...
@Metadata(mo65042d1 = {"\u0000\f\n\u0002\u0018\u0002\n\u0002\u0010\u0000\n\u0002\b\u0003\u0018\u0000 \u00032\u00020\u0001:\u0001\u0003B\u0005¢\u0006\u0002\u0010\u0002¨\u0006\u0004"}, mo65043d2 = {"Lcom/android/systemui/statusbar/notification/ViewGroupFadeHelper;", "", "()V", "Companion", "SystemUI_nothingRelease"}, mo65044k = 1, mo65045mv = {1, 6, 0}, mo65047xi = 48)
...
public final class ViewGroupFadeHelper {
    ...
    @Metadata(mo65042d1 = {"\u0000<\n\u0002\u0018\u0002\n\u0002\u0010\u0000\n\u0002\b\u0002\n\u0002\u0018\u0002\n\u0002\u0018\u0002\n\u0002\u0010\u000b\n\u0000\n\u0002\u0010\u0002\n\u0000\n\u0002\u0018\u0002\n\u0002\b\u0002\n\u0002\u0010\t\n\u0000\n\u0002\u0018\u0002\n\u0000\n\u0002\u0010#\n\u0002\b\u0003\b\u0003\u0018\u00002\u00020\u0001B\u0007\b\u0002¢\u0006\u0002\u0010\u0002J*\u0010\u0007\u001a\u00020\b2\u0006\u0010\t\u001a\u00020\n2\u0006\u0010\u000b\u001a\u00020\u00052\u0006\u0010\f\u001a\u00020\r2\b\u0010\u000e\u001a\u0004\u0018\u00010\u000fH\u0007J2\u0010\u0010\u001a\b\u0012\u0004\u0012\u00020\u00050\u00112\u0006\u0010\t\u001a\u00020\n2\u0006\u0010\u000b\u001a\u00020\u00052\u0012\u0010\u0012\u001a\u000e\u0012\u0004\u0012\u00020\u0005\u0012\u0004\u0012\u00020\u00060\u0004H\u0002J\u0010\u0010\u0013\u001a\u00020\b2\u0006\u0010\t\u001a\u00020\nH\u0007R\u001a\u0010\u0003\u001a\u000e\u0012\u0004\u0012\u00020\u0005\u0012\u0004\u0012\u00020\u00060\u0004X\u0004¢\u0006\u0002\n\u0000¨\u0006\u0014"}, mo65043d2 = {"Lcom/android/systemui/statusbar/notification/ViewGroupFadeHelper$Companion;", "", "()V", "visibilityIncluder", "Lkotlin/Function1;", "Landroid/view/View;", "", "fadeOutAllChildrenExcept", "", "root", "Landroid/view/ViewGroup;", "excludedView", "duration", "", "endRunnable", "Ljava/lang/Runnable;", "gatherViews", "", "shouldInclude", "reset", "SystemUI_nothingRelease"}, mo65044k = 1, mo65045mv = {1, 6, 0}, mo65047xi = 48)
    /* compiled from: ViewGroupFadeHelper.kt */
    public static final class Companion {
        ...
        public final void fadeOutAllChildrenExcept(ViewGroup viewGroup, View view, long j, Runnable runnable) {
            ...
            for (View next : gatherViews) {
                if (next.getHasOverlappingRendering() && next.getLayerType() == 0) {
                    ...
                    next.setTag(C1894R.C1898id.view_group_fade_helper_hardware_layer, true);
                }
            }
            ...
            ofFloat.addListener(new C2670xbb47cb27(runnable));
            ofFloat.start();
            viewGroup.setTag(C1894R.C1898id.view_group_fade_helper_modified_views, gatherViews);
            viewGroup.setTag(C1894R.C1898id.view_group_fade_helper_animator, ofFloat);
        }

        /* access modifiers changed from: private */
        /* renamed from: fadeOutAllChildrenExcept$lambda-1$lambda-0  reason: not valid java name */
        public static final void m3098fadeOutAllChildrenExcept$lambda1$lambda0(ViewGroup viewGroup, Set set, ValueAnimator valueAnimator) {
            Intrinsics.checkNotNullParameter(viewGroup, "$root");
            Intrinsics.checkNotNullParameter(set, "$viewsToFadeOut");
            Float f = (Float) viewGroup.getTag(C1894R.C1898id.view_group_fade_helper_previous_value_tag);
            ...
            if (animatedValue != null) {
                ...
                while (it.hasNext()) {
                    ...
                    if (!Intrinsics.areEqual(view.getAlpha(), f)) {
                        view.setTag(C1894R.C1898id.view_group_fade_helper_restore_tag, Float.valueOf(view.getAlpha()));
                    }
                    view.setAlpha(floatValue);
                }
                viewGroup.setTag(C1894R.C1898id.view_group_fade_helper_previous_value_tag, Float.valueOf(floatValue));
                return;
            }
        ...
        public final void reset(ViewGroup viewGroup) {
            Intrinsics.checkNotNullParameter(viewGroup, "root");
            Set<View> asMutableSet = TypeIntrinsics.asMutableSet(viewGroup.getTag(C1894R.C1898id.view_group_fade_helper_modified_views));
            Animator animator = (Animator) viewGroup.getTag(C1894R.C1898id.view_group_fade_helper_animator);
            if (asMutableSet != null && animator != null) {
                animator.cancel();
                Float f = (Float) viewGroup.getTag(C1894R.C1898id.view_group_fade_helper_previous_value_tag);
                for (View view : asMutableSet) {
                    Float f2 = (Float) view.getTag(C1894R.C1898id.view_group_fade_helper_restore_tag);
                    if (f2 != null) {
                        if (Intrinsics.areEqual(f, view.getAlpha())) {
                            view.setAlpha(f2.floatValue());
                        }
                        if (Intrinsics.areEqual((Object) (Boolean) view.getTag(C1894R.C1898id.view_group_fade_helper_hardware_layer), (Object) true)) {
                            view.setLayerType(0, (Paint) null);
                            view.setTag(C1894R.C1898id.view_group_fade_helper_hardware_layer, (Object) null);
                        }
                        view.setTag(C1894R.C1898id.view_group_fade_helper_restore_tag, (Object) null);
                    }
                }
                viewGroup.setTag(C1894R.C1898id.view_group_fade_helper_modified_views, (Object) null);
                viewGroup.setTag(C1894R.C1898id.view_group_fade_helper_previous_value_tag, (Object) null);
                viewGroup.setTag(C1894R.C1898id.view_group_fade_helper_animator, (Object) null);
            }
        }
    }
}
