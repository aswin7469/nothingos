...
public final class NotifCollection_Factory implements Factory<NotifCollection> {
    ...
    /* renamed from: get */
    public NotifCollection mo1933get() {
        return newInstance(this.statusBarServiceProvider.mo1933get(), this.clockProvider.mo1933get(), this.featureFlagsProvider.mo1933get(), this.loggerProvider.mo1933get(), this.logBufferEulogizerProvider.mo1933get(), this.dumpManagerProvider.mo1933get());
    }
