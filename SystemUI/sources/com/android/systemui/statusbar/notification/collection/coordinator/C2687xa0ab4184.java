...
final class C2687xa0ab4184 extends Lambda implements Function1<NotificationEntry, Boolean> {
    final /* synthetic */ Map<String, List<HeadsUpCoordinator.PostedEntry>> $postedEntriesByGroup;

    /* JADX INFO: super call moved to the top of the method (can break code semantics) */
    C2687xa0ab4184(Map<String, ? extends List<HeadsUpCoordinator.PostedEntry>> map) {
        super(1);
