...
public final class HeadsUpCoordinator$mNotifCollectionListener$1 implements NotifCollectionListener {
    ...
    public void onEntryUpdated(NotificationEntry notificationEntry) {
        Intrinsics.checkNotNullParameter(notificationEntry, "entry");
        HeadsUpCoordinator.PostedEntry postedEntry = (HeadsUpCoordinator.PostedEntry) this.this$0.mPostedEntries.compute(notificationEntry.getKey(), new C2685xf16970b3(notificationEntry, this.this$0.mNotificationInterruptStateProvider.shouldHeadsUp(notificationEntry), this.this$0.shouldHunAgain(notificationEntry), this.this$0.mHeadsUpManager.isAlerting(notificationEntry.getKey()), this.this$0.isEntryBinding(notificationEntry)));
    ...
    public static final HeadsUpCoordinator.PostedEntry m3110onEntryUpdated$lambda1(NotificationEntry notificationEntry, boolean z, boolean z2, boolean z3, boolean z4, String str, HeadsUpCoordinator.PostedEntry postedEntry) {
        Intrinsics.checkNotNullParameter(notificationEntry, "$entry");
