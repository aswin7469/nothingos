...
public class KeyguardCoordinator implements Coordinator {
    ...
    private final NotifFilter mNotifFilter = new NotifFilter("KeyguardCoordinator") { // from class: com.android.systemui.statusbar.notification.collection.coordinator.KeyguardCoordinator.1
    ...
    public boolean priorityExceedsLockscreenShowingThreshold(ListEntry listEntry) {
        ...
        return listEntry.getRepresentativeEntry() != null && !listEntry.getRepresentativeEntry().getRanking().isAmbient();
    }
