...
public final class PreparationCoordinator_Factory implements Factory<PreparationCoordinator> {
    ...
    /* renamed from: get */
    public PreparationCoordinator mo1933get() {
        return newInstance(this.loggerProvider.mo1933get(), this.notifInflaterProvider.mo1933get(), this.errorManagerProvider.mo1933get(), this.viewBarnProvider.mo1933get(), this.serviceProvider.mo1933get());
    }
