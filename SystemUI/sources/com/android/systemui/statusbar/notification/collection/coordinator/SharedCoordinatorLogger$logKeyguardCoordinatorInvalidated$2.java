...
final class SharedCoordinatorLogger$logKeyguardCoordinatorInvalidated$2 extends Lambda implements Function1<LogMessage, String> {
    ...
    SharedCoordinatorLogger$logKeyguardCoordinatorInvalidated$2() {
        super(1);
    }

    public final String invoke(LogMessage logMessage) {
        Intrinsics.checkNotNullParameter(logMessage, "$this$log");
        return "KeyguardCoordinator invalidated: " + logMessage.getStr1();
    }
}
