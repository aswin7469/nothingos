...
public final class ShadeListBuilderLogger {
    ...
    public final void logPreGroupFilterInvalidated(@NotNull String filterName, int i) {
        ...
        if (!logBuffer.getFrozen()) {
            ...
            obtain.setStr1(filterName);
            obtain.setInt1(i);
            logBuffer.push(obtain);
        }
    }

    public final void logReorderingAllowedInvalidated(@NotNull String name, int i) {
    ...
    public final void logDuplicateSummary(int i, @NotNull String groupKey, @NotNull String existingKey, @NotNull String newKey) {
        ...
        if (!logBuffer.getFrozen()) {
            ...
            obtain.setStr2(existingKey);
            obtain.setStr3(newKey);
            logBuffer.push(obtain);
        }
    }
    ...
    public final void logEntryAttachStateChanged(int i, @NotNull String key, @Nullable GroupEntry groupEntry, @Nullable GroupEntry groupEntry2) {
        ...
        if (!logBuffer.getFrozen()) {
            ...
            obtain.setStr1(key);
            String str = null;
            obtain.setStr2(groupEntry == null ? null : groupEntry.getKey());
            if (groupEntry2 != null) {
    ...
    public final void logParentChanged(int i, @Nullable GroupEntry groupEntry, @Nullable GroupEntry groupEntry2) {
        ...
        if (!logBuffer.getFrozen()) {
            ...
            obtain.setInt1(i);
            String str = null;
            obtain.setStr1(groupEntry == null ? null : groupEntry.getKey());
            if (groupEntry2 != null) {
                str = groupEntry2.getKey();
            }
            obtain.setStr2(str);
    ...
    public final void logFilterChanged(int i, @Nullable NotifFilter notifFilter, @Nullable NotifFilter notifFilter2) {
        ...
        if (!logBuffer.getFrozen()) {
            ...
            obtain.setInt1(i);
            String str = null;
            obtain.setStr1(notifFilter == null ? null : notifFilter.getName());
    ...
    public final void logPromoterChanged(int i, @Nullable NotifPromoter notifPromoter, @Nullable NotifPromoter notifPromoter2) {
        ...
        if (!logBuffer.getFrozen()) {
            ...
            obtain.setInt1(i);
            String str = null;
            obtain.setStr1(notifPromoter == null ? null : notifPromoter.getName());
    ...
    public final void logSectionChanged(int i, @Nullable NotifSection notifSection, @Nullable NotifSection notifSection2) {
        ...
        if (!logBuffer.getFrozen()) {
            ...
            obtain.setLong1(i);
            String str = null;
            obtain.setStr1(notifSection == null ? null : notifSection.getLabel());
