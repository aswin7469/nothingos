...
final class NotifCollectionLogger$logNonExistentNotifDismissed$2 extends Lambda implements Function1<LogMessage, String> {
    ...
    NotifCollectionLogger$logNonExistentNotifDismissed$2() {
        super(1);
    }

    public final String invoke(LogMessage logMessage) {
        Intrinsics.checkNotNullParameter(logMessage, "$this$log");
        return "DISMISSED Non Existent " + logMessage.getStr1();
    }
}
