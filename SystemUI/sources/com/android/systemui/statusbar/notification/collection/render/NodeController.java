...
public interface NodeController {
    ...
    public static final class DefaultImpls {
        ...
        public static void addChildAt(@NotNull NodeController nodeController, @NotNull NodeController child, int i) {
            Intrinsics.checkNotNullParameter(nodeController, "this");
            Intrinsics.checkNotNullParameter(child, "child");
            throw new RuntimeException("Not supported");
        }

        public static void moveChildTo(@NotNull NodeController nodeController, @NotNull NodeController child, int i) {
            Intrinsics.checkNotNullParameter(nodeController, "this");
            Intrinsics.checkNotNullParameter(child, "child");
            throw new RuntimeException("Not supported");
        }

        public static void removeChild(@NotNull NodeController nodeController, @NotNull NodeController child, boolean z) {
            Intrinsics.checkNotNullParameter(nodeController, "this");
            Intrinsics.checkNotNullParameter(child, "child");
            throw new RuntimeException("Not supported");
        }
