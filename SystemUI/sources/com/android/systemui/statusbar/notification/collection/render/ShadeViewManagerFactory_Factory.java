...
public final class ShadeViewManagerFactory_Factory implements Factory<ShadeViewManagerFactory> {
    ...
    /* renamed from: get */
    public ShadeViewManagerFactory mo1933get() {
        return newInstance(this.contextProvider.mo1933get(), this.loggerProvider.mo1933get(), this.viewBarnProvider.mo1933get(), this.notificationIconAreaControllerProvider.mo1933get());
    }
