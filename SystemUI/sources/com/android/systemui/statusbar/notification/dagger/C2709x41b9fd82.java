...
public final class C2709x41b9fd82 implements Factory<SectionHeaderController> {
    private final Provider<SectionHeaderControllerSubcomponent> subcomponentProvider;

    public C2709x41b9fd82(Provider<SectionHeaderControllerSubcomponent> provider) {
    ...
    public static C2709x41b9fd82 create(Provider<SectionHeaderControllerSubcomponent> provider) {
        return new C2709x41b9fd82(provider);
    }
