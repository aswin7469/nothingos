...
public final class C2711x3fd4641 implements Factory<SectionHeaderControllerSubcomponent> {
    private final Provider<SectionHeaderControllerSubcomponent.Builder> builderProvider;

    public C2711x3fd4641(Provider<SectionHeaderControllerSubcomponent.Builder> provider) {
    ...
    public static C2711x3fd4641 create(Provider<SectionHeaderControllerSubcomponent.Builder> provider) {
        return new C2711x3fd4641(provider);
    }
