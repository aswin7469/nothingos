...
public final class C2714xb614d321 implements Factory<SectionHeaderControllerSubcomponent> {
    private final Provider<SectionHeaderControllerSubcomponent.Builder> builderProvider;

    public C2714xb614d321(Provider<SectionHeaderControllerSubcomponent.Builder> provider) {
    ...
    public static C2714xb614d321 create(Provider<SectionHeaderControllerSubcomponent.Builder> provider) {
        return new C2714xb614d321(provider);
    }
