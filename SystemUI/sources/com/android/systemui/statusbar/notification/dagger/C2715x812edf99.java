...
public final class C2715x812edf99 implements Factory<SectionHeaderController> {
    private final Provider<SectionHeaderControllerSubcomponent> subcomponentProvider;

    public C2715x812edf99(Provider<SectionHeaderControllerSubcomponent> provider) {
    ...
    public static C2715x812edf99 create(Provider<SectionHeaderControllerSubcomponent> provider) {
        return new C2715x812edf99(provider);
    }
