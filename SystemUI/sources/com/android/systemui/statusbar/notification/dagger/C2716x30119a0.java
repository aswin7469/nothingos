...
public final class C2716x30119a0 implements Factory<NodeController> {
    private final Provider<SectionHeaderControllerSubcomponent> subcomponentProvider;

    public C2716x30119a0(Provider<SectionHeaderControllerSubcomponent> provider) {
    ...
    public static C2716x30119a0 create(Provider<SectionHeaderControllerSubcomponent> provider) {
        return new C2716x30119a0(provider);
    }
