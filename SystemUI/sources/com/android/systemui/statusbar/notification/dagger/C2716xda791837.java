...
public final class C2716xda791837 implements Factory<NodeController> {
    private final Provider<SectionHeaderControllerSubcomponent> subcomponentProvider;

    public C2716xda791837(Provider<SectionHeaderControllerSubcomponent> provider) {
    ...
    public static C2716xda791837 create(Provider<SectionHeaderControllerSubcomponent> provider) {
        return new C2716xda791837(provider);
    }
