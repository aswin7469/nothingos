...
public final class C2719x8d68ee80 implements Factory<NodeController> {
    private final Provider<SectionHeaderControllerSubcomponent> subcomponentProvider;

    public C2719x8d68ee80(Provider<SectionHeaderControllerSubcomponent> provider) {
    ...
    public static C2719x8d68ee80 create(Provider<SectionHeaderControllerSubcomponent> provider) {
        return new C2719x8d68ee80(provider);
    }
