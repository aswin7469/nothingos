...
public final class C2722xda791837 implements Factory<NodeController> {
    private final Provider<SectionHeaderControllerSubcomponent> subcomponentProvider;

    public C2722xda791837(Provider<SectionHeaderControllerSubcomponent> provider) {
    ...
    public static C2722xda791837 create(Provider<SectionHeaderControllerSubcomponent> provider) {
        return new C2722xda791837(provider);
    }
