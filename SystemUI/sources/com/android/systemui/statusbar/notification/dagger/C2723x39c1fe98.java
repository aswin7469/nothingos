...
public final class C2723x39c1fe98 implements Factory<SectionHeaderControllerSubcomponent> {
    private final Provider<SectionHeaderControllerSubcomponent.Builder> builderProvider;

    public C2723x39c1fe98(Provider<SectionHeaderControllerSubcomponent.Builder> provider) {
    ...
    public static C2723x39c1fe98 create(Provider<SectionHeaderControllerSubcomponent.Builder> provider) {
        return new C2723x39c1fe98(provider);
    }
