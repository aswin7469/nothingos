...
public final class C2725x9d7acab1 implements Factory<NodeController> {
    private final Provider<SectionHeaderControllerSubcomponent> subcomponentProvider;

    public C2725x9d7acab1(Provider<SectionHeaderControllerSubcomponent> provider) {
    ...
    public static C2725x9d7acab1 create(Provider<SectionHeaderControllerSubcomponent> provider) {
        return new C2725x9d7acab1(provider);
    }
