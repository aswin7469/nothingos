...
public final class C2726x34a20792 implements Factory<SectionHeaderControllerSubcomponent> {
    private final Provider<SectionHeaderControllerSubcomponent.Builder> builderProvider;

    public C2726x34a20792(Provider<SectionHeaderControllerSubcomponent.Builder> provider) {
    ...
    public static C2726x34a20792 create(Provider<SectionHeaderControllerSubcomponent.Builder> provider) {
        return new C2726x34a20792(provider);
    }
