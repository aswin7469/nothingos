...
public final class NotificationsModule_ProvideCommonNotifCollectionFactory implements Factory<CommonNotifCollection> {
    ...
    /* renamed from: get */
    public CommonNotifCollection mo1933get() {
        return provideCommonNotifCollection(this.featureFlagsProvider.mo1933get(), DoubleCheck.lazy(this.pipelineProvider), this.entryManagerProvider.mo1933get());
    }
