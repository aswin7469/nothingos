...
public final class NotificationsModule_ProvideGroupExpansionManagerFactory implements Factory<GroupExpansionManager> {
    ...
    /* renamed from: get */
    public GroupExpansionManager mo1933get() {
        return provideGroupExpansionManager(this.featureFlagsProvider.mo1933get(), DoubleCheck.lazy(this.groupMembershipManagerProvider), DoubleCheck.lazy(this.groupManagerLegacyProvider));
    }
