...
public final class NotificationsModule_ProvideNotificationEntryManagerFactory implements Factory<NotificationEntryManager> {
    ...
    /* renamed from: get */
    public NotificationEntryManager mo1933get() {
        return provideNotificationEntryManager(this.loggerProvider.mo1933get(), this.groupManagerProvider.mo1933get(), this.featureFlagsProvider.mo1933get(), DoubleCheck.lazy(this.notificationRowBinderLazyProvider), DoubleCheck.lazy(this.notificationRemoteInputManagerLazyProvider), this.leakDetectorProvider.mo1933get(), this.fgsFeatureControllerProvider.mo1933get(), this.statusBarServiceProvider.mo1933get());
    }
