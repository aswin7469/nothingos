...
public final class NotificationsModule_ProvideNotificationGutsManagerFactory implements Factory<NotificationGutsManager> {
    ...
    /* renamed from: get */
    public NotificationGutsManager mo1933get() {
        return provideNotificationGutsManager(this.contextProvider.mo1933get(), DoubleCheck.lazy(this.statusBarLazyProvider), this.mainHandlerProvider.mo1933get(), this.bgHandlerProvider.mo1933get(), this.accessibilityManagerProvider.mo1933get(), this.highPriorityProvider.mo1933get(), this.notificationManagerProvider.mo1933get(), this.notificationEntryManagerProvider.mo1933get(), this.peopleSpaceWidgetManagerProvider.mo1933get(), this.launcherAppsProvider.mo1933get(), this.shortcutManagerProvider.mo1933get(), this.channelEditorDialogControllerProvider.mo1933get(), this.contextTrackerProvider.mo1933get(), this.assistantFeedbackControllerProvider.mo1933get(), this.bubblesManagerOptionalProvider.mo1933get(), this.uiEventLoggerProvider.mo1933get(), this.onUserInteractionCallbackProvider.mo1933get(), this.shadeControllerProvider.mo1933get());
    }
