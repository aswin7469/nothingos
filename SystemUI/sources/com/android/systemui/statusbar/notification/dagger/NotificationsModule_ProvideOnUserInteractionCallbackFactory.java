...
public final class NotificationsModule_ProvideOnUserInteractionCallbackFactory implements Factory<OnUserInteractionCallback> {
    ...
    /* renamed from: get */
    public OnUserInteractionCallback mo1933get() {
        return provideOnUserInteractionCallback(this.featureFlagsProvider.mo1933get(), this.headsUpManagerProvider.mo1933get(), this.statusBarStateControllerProvider.mo1933get(), DoubleCheck.lazy(this.pipelineProvider), DoubleCheck.lazy(this.notifCollectionProvider), DoubleCheck.lazy(this.visualStabilityCoordinatorProvider), this.entryManagerProvider.mo1933get(), this.visualStabilityManagerProvider.mo1933get(), DoubleCheck.lazy(this.groupMembershipManagerLazyProvider));
    }
