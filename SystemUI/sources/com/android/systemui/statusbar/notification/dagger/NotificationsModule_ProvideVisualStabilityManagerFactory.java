...
public final class NotificationsModule_ProvideVisualStabilityManagerFactory implements Factory<VisualStabilityManager> {
    ...
    /* renamed from: get */
    public VisualStabilityManager mo1933get() {
        return provideVisualStabilityManager(this.featureFlagsProvider.mo1933get(), this.notificationEntryManagerProvider.mo1933get(), this.handlerProvider.mo1933get(), this.statusBarStateControllerProvider.mo1933get(), this.wakefulnessLifecycleProvider.mo1933get());
    }
