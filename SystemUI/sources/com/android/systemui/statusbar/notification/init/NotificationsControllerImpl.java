...
public final class NotificationsControllerImpl implements NotificationsController {
    ...
    public void initialize(NotificationPresenter notificationPresenter, NotificationListContainer notificationListContainer, NotifStackController notifStackController, NotificationActivityStarter notificationActivityStarter, NotificationRowBinderImpl.BindRowCallback bindRowCallback) {
        ...
        this.notificationRowBinder.setNotificationClicker(this.clickerBuilder.build(Optional.m1751of(this.centralSurfaces.get()), this.bubblesOptional, notificationActivityStarter));
    ...
    public static final void m3124initialize$lambda0(NotificationsControllerImpl notificationsControllerImpl) {
    ...
    @Metadata(mo65042d1 = {"\u0000\u0012\n\u0002\u0018\u0002\n\u0002\u0010\u0000\n\u0002\b\u0002\n\u0002\u0010\u000b\n\u0000\b\u0003\u0018\u00002\u00020\u0001B\u0007\b\u0002¢\u0006\u0002\u0010\u0002R\u000e\u0010\u0003\u001a\u00020\u0004XT¢\u0006\u0002\n\u0000¨\u0006\u0005"}, mo65043d2 = {"Lcom/android/systemui/statusbar/notification/init/NotificationsControllerImpl$Companion;", "", "()V", "INITIALIZE_NEW_PIPELINE", "", "SystemUI_nothingRelease"}, mo65044k = 1, mo65045mv = {1, 6, 0}, mo65047xi = 48)
    /* compiled from: NotificationsControllerImpl.kt */
