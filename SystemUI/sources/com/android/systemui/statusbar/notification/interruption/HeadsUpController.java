...
public class HeadsUpController {
    ...
    public void updateHunState(NotificationEntry notificationEntry) {
        ...
        if (this.mHeadsUpManager.isAlerting(notificationEntry.getKey())) {
            ...
            ((HeadsUpControllerEx) NTDependencyEx.get(HeadsUpControllerEx.class)).bindHeadsUpView(notificationEntry, new HeadsUpController$$ExternalSyntheticLambda0(headsUpManager));
        }
    }
