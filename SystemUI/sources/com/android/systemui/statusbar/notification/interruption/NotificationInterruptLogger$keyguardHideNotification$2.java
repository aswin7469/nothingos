...
final class NotificationInterruptLogger$keyguardHideNotification$2 extends Lambda implements Function1<LogMessage, String> {
    ...
    NotificationInterruptLogger$keyguardHideNotification$2() {
        super(1);
    }

    public final String invoke(LogMessage logMessage) {
        Intrinsics.checkNotNullParameter(logMessage, "$this$log");
        return "Keyguard Hide Notification: " + logMessage.getStr1();
    }
}
