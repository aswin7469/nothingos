...
final class NotificationInterruptLogger$logNoHeadsUpAlreadyBubbled$2 extends Lambda implements Function1<LogMessage, String> {
    ...
    NotificationInterruptLogger$logNoHeadsUpAlreadyBubbled$2() {
        super(1);
    }

    public final String invoke(LogMessage logMessage) {
        Intrinsics.checkNotNullParameter(logMessage, "$this$log");
        return "No heads up: in unlocked shade where notification is shown as a bubble: " + logMessage.getStr1();
    }
}
