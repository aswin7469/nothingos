...
public final class NotificationPersonExtractorPluginBoundary implements NotificationPersonExtractor {
    ...
    public NotificationPersonExtractorPluginBoundary(ExtensionController extensionController) {
        ...
        this.plugin = extensionController.newExtension(NotificationPersonExtractorPlugin.class).withPlugin(NotificationPersonExtractorPlugin.class).withCallback(new C2730x57544f0(this)).build().get();
    }

    /* access modifiers changed from: private */
    /* renamed from: _init_$lambda-0  reason: not valid java name */
    public static final void m3121_init_$lambda0(NotificationPersonExtractorPluginBoundary notificationPersonExtractorPluginBoundary, NotificationPersonExtractorPlugin notificationPersonExtractorPlugin) {
