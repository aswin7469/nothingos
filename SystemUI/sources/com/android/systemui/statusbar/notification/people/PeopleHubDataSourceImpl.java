...
public final class PeopleHubDataSourceImpl implements DataSource<PeopleHubModel> {
    ...
    public PeopleHubDataSourceImpl(CommonNotifCollection commonNotifCollection, NotificationPersonExtractor notificationPersonExtractor, UserManager userManager2, LauncherApps launcherApps, PackageManager packageManager, Context context, NotificationListener notificationListener2, @Background Executor executor, @Main Executor executor2, NotificationLockscreenUserManager notificationLockscreenUserManager, PeopleNotificationIdentifier peopleNotificationIdentifier2) {
        ...
        this.iconFactory = new ConversationIconFactory(applicationContext, launcherApps, packageManager, IconDrawableFactory.newInstance(applicationContext), applicationContext.getResources().getDimensionPixelSize(C1893R.dimen.notification_guts_conversation_icon_size));
    ...
    public static final void m3128removeVisibleEntry$lambda3$lambda2(PeopleHubDataSourceImpl peopleHubDataSourceImpl, int i, int i2, String str) {
    ...
    public static final void m3129removeVisibleEntry$lambda3$lambda2$lambda1(int i, PeopleHubDataSourceImpl peopleHubDataSourceImpl, int i2, String str) {
        Intrinsics.checkNotNullParameter(peopleHubDataSourceImpl, "this$0");
        Intrinsics.checkNotNullParameter(str, "$key");
        if (i == 18) {
    ...
    public static final void m3125addVisibleEntry$lambda7$lambda6(PeopleHubDataSourceImpl peopleHubDataSourceImpl, int i, PersonModel personModel) {
        Intrinsics.checkNotNullParameter(peopleHubDataSourceImpl, "this$0");
    ...
    public static final void m3126addVisibleEntry$lambda7$lambda6$lambda5(PeopleHubDataSourceImpl peopleHubDataSourceImpl, int i, PersonModel personModel) {
        Intrinsics.checkNotNullParameter(peopleHubDataSourceImpl, "this$0");
        Intrinsics.checkNotNullParameter(personModel, "$personModel");
    ...
    public static final void m3127extractPerson$lambda9(PeopleHubDataSourceImpl peopleHubDataSourceImpl, NotificationEntry notificationEntry) {
        Intrinsics.checkNotNullParameter(peopleHubDataSourceImpl, "this$0");
