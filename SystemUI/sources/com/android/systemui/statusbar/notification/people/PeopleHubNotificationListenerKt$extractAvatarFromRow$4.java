...
@Metadata(mo64986d1 = {"\u0000\u000e\n\u0000\n\u0002\u0018\u0002\n\u0000\n\u0002\u0018\u0002\n\u0000\u0010\u0000\u001a\u0004\u0018\u00010\u00012\u0006\u0010\u0002\u001a\u00020\u0003H\n¢\u0006\u0002\b\u0004"}, mo64987d2 = {"<anonymous>", "Landroid/graphics/drawable/Drawable;", "messagesView", "Landroid/view/ViewGroup;", "invoke"}, mo64988k = 3, mo64989mv = {1, 6, 0}, mo64991xi = 48)
...
final class PeopleHubNotificationListenerKt$extractAvatarFromRow$4 extends Lambda implements Function1<ViewGroup, Drawable> {
    ...
    public final Drawable invoke(ViewGroup viewGroup) {
        ...
        MessagingGroup messagingGroup = (MessagingGroup) SequencesKt.lastOrNull(SequencesKt.mapNotNull(PeopleHubNotificationListenerKt.getChildren(viewGroup), C27311.INSTANCE));
