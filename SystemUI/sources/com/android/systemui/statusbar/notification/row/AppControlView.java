...
public final class AppControlView extends LinearLayout {
    ...
    public final Switch getSwitch() {
        Switch switchR = this.f946switch;
        if (switchR != null) {
            return switchR;
        }
    ...
    public final void setSwitch(Switch switchR) {
        ...
        this.f946switch = switchR;
    }

    /* access modifiers changed from: protected */
    public void onFinishInflate() {
        View findViewById = findViewById(C1894R.C1898id.icon);
        Intrinsics.checkNotNullExpressionValue(findViewById, "findViewById(R.id.icon)");
        setIconView((ImageView) findViewById);
        View findViewById2 = findViewById(C1894R.C1898id.app_name);
    ...
    public static final void m3137onFinishInflate$lambda0(AppControlView appControlView, View view) {
