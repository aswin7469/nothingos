...
public class HybridGroupManager {
    ...
    public void initDimens() {
        ...
        this.mOverflowNumberSize = (float) resources.getDimensionPixelSize(C1893R.dimen.group_overflow_number_size);
        this.mOverflowNumberPadding = resources.getDimensionPixelSize(C1893R.dimen.group_overflow_number_padding);
    }

    private HybridNotificationView inflateHybridViewWithStyle(int i, View view, ViewGroup viewGroup) {
        HybridNotificationView hybridNotificationView = (HybridNotificationView) ((LayoutInflater) new ContextThemeWrapper(this.mContext, i).getSystemService(LayoutInflater.class)).inflate(view instanceof ConversationLayout ? C1893R.layout.hybrid_conversation_notification : C1893R.layout.hybrid_notification, viewGroup, false);
    ...
    private TextView inflateOverflowNumber(ViewGroup viewGroup) {
        TextView textView = (TextView) ((LayoutInflater) this.mContext.getSystemService(LayoutInflater.class)).inflate(C1893R.layout.hybrid_overflow_number, viewGroup, false);
    ...
    public HybridNotificationView bindFromNotification(HybridNotificationView hybridNotificationView, View view, StatusBarNotification statusBarNotification, ViewGroup viewGroup) {
        return bindFromNotificationWithStyle(hybridNotificationView, view, statusBarNotification, C1893R.style.HybridNotification, viewGroup);
    }
    ...
    public TextView bindOverflowNumber(TextView textView, int i, ViewGroup viewGroup) {
        ...
        String string = this.mContext.getResources().getString(C1893R.string.notification_group_overflow_indicator, new Object[]{Integer.valueOf(i)});
        if (!string.equals(textView.getText())) {
            textView.setText(string);
        }
        textView.setContentDescription(String.format(this.mContext.getResources().getQuantityString(C1893R.plurals.notification_group_overflow_description, i), Integer.valueOf(i)));
