...
public final class NotifBindPipeline {
    ...
    public void setStage(BindStage bindStage) {
        ...
        bindStage.setBindRequestListener(new NotifBindPipeline$$ExternalSyntheticLambda2(this));
    }
    ...
    public void startPipeline(NotificationEntry notificationEntry) {
        ...
        if (this.mStage != null) {
            this.mStage.executeStage(notificationEntry, this.mBindEntries.get(notificationEntry).row, new NotifBindPipeline$$ExternalSyntheticLambda1(this));
            return;
        }
