...
public class NotificationInfo extends LinearLayout implements NotificationGuts.GutsContent {
    ...
    private void bindHeader() {
        ...
        if (appSettingsIntent != null && !TextUtils.isEmpty(this.mSbn.getNotification().getSettingsText())) {
            ...
            findViewById.setOnClickListener(new View.OnClickListener() { // from class: com.android.systemui.statusbar.notification.row.NotificationInfo$$ExternalSyntheticLambda6
                @Override // android.view.View.OnClickListener
                public final void onClick(View view) {
                    NotificationInfo.this.lambda$bindHeader$4(appSettingsIntent, view);
                }
            });
        } else {
    ...
    private View.OnClickListener getSettingsOnClickListener() {
        ...
        return new View.OnClickListener() { // from class: com.android.systemui.statusbar.notification.row.NotificationInfo$$ExternalSyntheticLambda5
            @Override // android.view.View.OnClickListener
            public final void onClick(View view) {
                NotificationInfo.this.lambda$getSettingsOnClickListener$5(i, view);
            }
        };
    }
        ...
        if (i == 0) {
            ...
            post(new Runnable() { // from class: com.android.systemui.statusbar.notification.row.NotificationInfo$$ExternalSyntheticLambda8
                ...
                public final void run() {
                    NotificationInfo.lambda$applyAlertingBehavior$8(findViewById, findViewById2, findViewById3);
                }
            });
        } else if (i == 1) {
            ...
            this.mAutomaticDescriptionView.setVisibility(8);
            post(new Runnable() { // from class: com.android.systemui.statusbar.notification.row.NotificationInfo$$ExternalSyntheticLambda9
                @Override // java.lang.Runnable
                public final void run() {
                    NotificationInfo.lambda$applyAlertingBehavior$9(findViewById, findViewById2, findViewById3);
                }
            });
        } else if (i == 2) {
            ...
            this.mPriorityDescriptionView.setVisibility(8);
            this.mSilentDescriptionView.setVisibility(8);
            post(new Runnable() { // from class: com.android.systemui.statusbar.notification.row.NotificationInfo$$ExternalSyntheticLambda10
                @Override // java.lang.Runnable
                public final void run() {
                    NotificationInfo.lambda$applyAlertingBehavior$10(findViewById3, findViewById, findViewById2);
                }
            });
        } else {
