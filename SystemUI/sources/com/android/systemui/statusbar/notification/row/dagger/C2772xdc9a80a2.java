...
public final class C2772xdc9a80a2 implements Factory<String> {
    private final Provider<StatusBarNotification> statusBarNotificationProvider;

    public C2772xdc9a80a2(Provider<StatusBarNotification> provider) {
    ...
    public static C2772xdc9a80a2 create(Provider<StatusBarNotification> provider) {
        return new C2772xdc9a80a2(provider);
    }
