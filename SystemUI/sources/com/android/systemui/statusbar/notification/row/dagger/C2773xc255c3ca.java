...
public final class C2773xc255c3ca implements Factory<StatusBarNotification> {
    private final Provider<NotificationEntry> notificationEntryProvider;

    public C2773xc255c3ca(Provider<NotificationEntry> provider) {
    ...
    public static C2773xc255c3ca create(Provider<NotificationEntry> provider) {
        return new C2773xc255c3ca(provider);
    }
