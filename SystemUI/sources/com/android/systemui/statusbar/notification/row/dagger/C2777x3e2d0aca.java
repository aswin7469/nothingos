...
public final class C2777x3e2d0aca implements Factory<String> {
    private final Provider<Context> contextProvider;
    private final Provider<StatusBarNotification> statusBarNotificationProvider;

    public C2777x3e2d0aca(Provider<Context> provider, Provider<StatusBarNotification> provider2) {
    ...
    public static C2777x3e2d0aca create(Provider<Context> provider, Provider<StatusBarNotification> provider2) {
        return new C2777x3e2d0aca(provider, provider2);
    }
