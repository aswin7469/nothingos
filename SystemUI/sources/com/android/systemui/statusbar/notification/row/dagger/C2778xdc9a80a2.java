...
public final class C2778xdc9a80a2 implements Factory<String> {
    private final Provider<StatusBarNotification> statusBarNotificationProvider;

    public C2778xdc9a80a2(Provider<StatusBarNotification> provider) {
    ...
    public static C2778xdc9a80a2 create(Provider<StatusBarNotification> provider) {
        return new C2778xdc9a80a2(provider);
    }
