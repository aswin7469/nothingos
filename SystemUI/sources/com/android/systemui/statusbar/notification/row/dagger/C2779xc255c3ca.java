...
public final class C2779xc255c3ca implements Factory<StatusBarNotification> {
    private final Provider<NotificationEntry> notificationEntryProvider;

    public C2779xc255c3ca(Provider<NotificationEntry> provider) {
    ...
    public static C2779xc255c3ca create(Provider<NotificationEntry> provider) {
        return new C2779xc255c3ca(provider);
    }
