...
public class NotificationBigPictureTemplateViewWrapper extends NotificationTemplateViewWrapper {
    ...
    private void updateImageTag(StatusBarNotification statusBarNotification) {
        ...
        if (icon != null) {
            this.mRightIcon.setTag(C1893R.C1897id.image_icon_tag, icon);
            this.mLeftIcon.setTag(C1893R.C1897id.image_icon_tag, icon);
            return;
        }
        this.mRightIcon.setTag(C1893R.C1897id.image_icon_tag, getLargeIcon(statusBarNotification.getNotification()));
    }
}
