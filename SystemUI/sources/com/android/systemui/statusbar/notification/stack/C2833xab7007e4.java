...
public final class C2833xab7007e4 implements Factory<NotificationListContainer> {
    private final Provider<NotificationStackScrollLayoutController> nsslControllerProvider;

    public C2833xab7007e4(Provider<NotificationStackScrollLayoutController> provider) {
    ...
    public static C2833xab7007e4 create(Provider<NotificationStackScrollLayoutController> provider) {
        return new C2833xab7007e4(provider);
    }
