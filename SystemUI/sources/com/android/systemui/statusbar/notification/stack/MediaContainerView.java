...
public final class MediaContainerView extends ExpandableView {
    ...
    private final void updateResources() {
        this.cornerRadius = (float) getContext().getResources().getDimensionPixelSize(C1894R.dimen.notification_corner_radius);
    }
