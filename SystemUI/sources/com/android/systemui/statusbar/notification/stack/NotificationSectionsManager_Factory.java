...
public final class NotificationSectionsManager_Factory implements Factory<NotificationSectionsManager> {
    ...
    /* renamed from: get */
    public NotificationSectionsManager mo1933get() {
        return newInstance(this.statusBarStateControllerProvider.mo1933get(), this.configurationControllerProvider.mo1933get(), this.keyguardMediaControllerProvider.mo1933get(), this.sectionsFeatureManagerProvider.mo1933get(), this.loggerProvider.mo1933get(), this.incomingHeaderControllerProvider.mo1933get(), this.peopleHeaderControllerProvider.mo1933get(), this.alertingHeaderControllerProvider.mo1933get(), this.silentHeaderControllerProvider.mo1933get());
    }
