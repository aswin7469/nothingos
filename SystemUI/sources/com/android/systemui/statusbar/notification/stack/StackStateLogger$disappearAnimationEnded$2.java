...
final class StackStateLogger$disappearAnimationEnded$2 extends Lambda implements Function1<LogMessage, String> {
    public static final StackStateLogger$disappearAnimationEnded$2 INSTANCE = new StackStateLogger$disappearAnimationEnded$2();

    StackStateLogger$disappearAnimationEnded$2() {
        super(1);
    }
