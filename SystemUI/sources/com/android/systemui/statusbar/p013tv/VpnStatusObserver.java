...
public final class VpnStatusObserver extends CoreStartable implements SecurityController.SecurityControllerCallback {
    ...
    private final int getVpnIconId() {
        return this.securityController.isVpnBranded() ? C1894R.C1896drawable.stat_sys_branded_vpn : C1894R.C1896drawable.stat_sys_vpn_ic;
    }
    ...
    private final Notification createVpnConnectedNotification() {
        ...
        if (vpnName != null) {
            builder.setContentText(this.mContext.getString(C1894R.string.notification_disclosure_vpn_text, new Object[]{vpnName}));
        }
        return builder.build();
    }

    private final Notification.Builder createVpnConnectedNotificationBuilder() {
        return new Notification.Builder(this.mContext, NOTIFICATION_CHANNEL_TV_VPN).setSmallIcon(getVpnIconId()).setVisibility(1).setCategory(NotificationCompat.CATEGORY_SYSTEM).extend(new Notification.TvExtender()).setOngoing(true).setContentTitle(this.mContext.getString(C1894R.string.notification_vpn_connected)).setContentIntent(VpnConfig.getIntentForStatusPanel(this.mContext));
    }

    private final Notification createVpnDisconnectedNotification() {
        return new Notification.Builder(this.mContext, NOTIFICATION_CHANNEL_TV_VPN).setSmallIcon(getVpnIconId()).setVisibility(1).setCategory(NotificationCompat.CATEGORY_SYSTEM).extend(new Notification.TvExtender()).setTimeoutAfter(5000).setContentTitle(this.mContext.getString(C1894R.string.notification_vpn_disconnected)).build();
    }

    @Metadata(mo65042d1 = {"\u0000\u001a\n\u0002\u0018\u0002\n\u0002\u0010\u0000\n\u0002\b\u0002\n\u0002\u0010\u000e\n\u0002\b\u0005\n\u0002\u0010\t\n\u0000\b\u0003\u0018\u00002\u00020\u0001B\u0007\b\u0002¢\u0006\u0002\u0010\u0002R\u000e\u0010\u0003\u001a\u00020\u0004XT¢\u0006\u0002\n\u0000R\u0011\u0010\u0005\u001a\u00020\u0004¢\u0006\b\n\u0000\u001a\u0004\b\u0006\u0010\u0007R\u000e\u0010\b\u001a\u00020\u0004XT¢\u0006\u0002\n\u0000R\u000e\u0010\t\u001a\u00020\nXT¢\u0006\u0002\n\u0000¨\u0006\u000b"}, mo65043d2 = {"Lcom/android/systemui/statusbar/tv/VpnStatusObserver$Companion;", "", "()V", "NOTIFICATION_CHANNEL_TV_VPN", "", "NOTIFICATION_TAG", "getNOTIFICATION_TAG", "()Ljava/lang/String;", "TAG", "VPN_DISCONNECTED_NOTIFICATION_TIMEOUT_MS", "", "SystemUI_nothingRelease"}, mo65044k = 1, mo65045mv = {1, 6, 0}, mo65047xi = 48)
