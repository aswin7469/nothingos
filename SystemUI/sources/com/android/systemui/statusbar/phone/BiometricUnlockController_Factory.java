...
public final class BiometricUnlockController_Factory implements Factory<BiometricUnlockController> {
    ...
    /* renamed from: get */
    public BiometricUnlockController mo1933get() {
        return newInstance(this.contextProvider.mo1933get(), this.dozeScrimControllerProvider.mo1933get(), this.keyguardViewMediatorProvider.mo1933get(), this.scrimControllerProvider.mo1933get(), this.shadeControllerProvider.mo1933get(), this.notificationShadeWindowControllerProvider.mo1933get(), this.keyguardStateControllerProvider.mo1933get(), this.handlerProvider.mo1933get(), this.keyguardUpdateMonitorProvider.mo1933get(), this.resourcesProvider.mo1933get(), this.keyguardBypassControllerProvider.mo1933get(), this.dozeParametersProvider.mo1933get(), this.metricsLoggerProvider.mo1933get(), this.dumpManagerProvider.mo1933get(), this.powerManagerProvider.mo1933get(), this.notificationMediaManagerProvider.mo1933get(), this.wakefulnessLifecycleProvider.mo1933get(), this.screenLifecycleProvider.mo1933get(), this.authControllerProvider.mo1933get());
    }
