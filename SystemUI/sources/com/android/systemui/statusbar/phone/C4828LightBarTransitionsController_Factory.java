...
public final class C4828LightBarTransitionsController_Factory {
    private final Provider<CommandQueue> commandQueueProvider;
    private final Provider<Context> contextProvider;
    private final Provider<KeyguardStateController> keyguardStateControllerProvider;
    private final Provider<StatusBarStateController> statusBarStateControllerProvider;

    public C4828LightBarTransitionsController_Factory(Provider<Context> provider, Provider<CommandQueue> provider2, Provider<KeyguardStateController> provider3, Provider<StatusBarStateController> provider4) {
    ...
    public static C4828LightBarTransitionsController_Factory create(Provider<Context> provider, Provider<CommandQueue> provider2, Provider<KeyguardStateController> provider3, Provider<StatusBarStateController> provider4) {
        return new C4828LightBarTransitionsController_Factory(provider, provider2, provider3, provider4);
    }
