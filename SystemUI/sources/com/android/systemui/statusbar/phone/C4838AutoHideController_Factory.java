...
public final class C4838AutoHideController_Factory implements Factory<AutoHideController> {
    private final Provider<Context> contextProvider;
    private final Provider<Handler> handlerProvider;
    private final Provider<IWindowManager> iWindowManagerProvider;

    public C4838AutoHideController_Factory(Provider<Context> provider, Provider<Handler> provider2, Provider<IWindowManager> provider3) {
    ...
    public static C4838AutoHideController_Factory create(Provider<Context> provider, Provider<Handler> provider2, Provider<IWindowManager> provider3) {
        return new C4838AutoHideController_Factory(provider, provider2, provider3);
    }
