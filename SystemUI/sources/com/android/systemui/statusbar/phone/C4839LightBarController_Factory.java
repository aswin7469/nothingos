...
public final class C4839LightBarController_Factory implements Factory<LightBarController> {
    ...
    public C4839LightBarController_Factory(Provider<Context> provider, Provider<DarkIconDispatcher> provider2, Provider<BatteryController> provider3, Provider<NavigationModeController> provider4, Provider<DumpManager> provider5) {
    ...
    public static C4839LightBarController_Factory create(Provider<Context> provider, Provider<DarkIconDispatcher> provider2, Provider<BatteryController> provider3, Provider<NavigationModeController> provider4, Provider<DumpManager> provider5) {
        return new C4839LightBarController_Factory(provider, provider2, provider3, provider4, provider5);
    }
