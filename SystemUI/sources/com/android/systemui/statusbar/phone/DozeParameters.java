...
public class DozeParameters implements TunerService.Tunable, com.android.systemui.plugins.statusbar.DozeParameters, Dumpable {
    ...
    public float getScreenBrightnessDoze() {
        return this.mResources.getInteger(17694908) / 255.0f;
    }
    ...
    public boolean canControlUnlockedScreenOff() {
        return getAlwaysOn() && !((AODController) Dependency.get(AODController.class)).checkNightMode() && this.mFeatureFlags.useNewLockscreenAnimations() && !getDisplayNeedsBlanking();
    }
