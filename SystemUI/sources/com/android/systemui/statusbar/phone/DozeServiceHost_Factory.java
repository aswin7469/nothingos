...
public final class DozeServiceHost_Factory implements Factory<DozeServiceHost> {
    ...
    /* renamed from: get */
    public DozeServiceHost mo1933get() {
        return newInstance(this.dozeLogProvider.mo1933get(), this.powerManagerProvider.mo1933get(), this.wakefulnessLifecycleProvider.mo1933get(), this.statusBarStateControllerProvider.mo1933get(), this.deviceProvisionedControllerProvider.mo1933get(), this.headsUpManagerPhoneProvider.mo1933get(), this.batteryControllerProvider.mo1933get(), this.scrimControllerProvider.mo1933get(), DoubleCheck.lazy(this.biometricUnlockControllerLazyProvider), this.keyguardViewMediatorProvider.mo1933get(), DoubleCheck.lazy(this.assistManagerLazyProvider), this.dozeScrimControllerProvider.mo1933get(), this.keyguardUpdateMonitorProvider.mo1933get(), this.pulseExpansionHandlerProvider.mo1933get(), this.notificationShadeWindowControllerProvider.mo1933get(), this.notificationWakeUpCoordinatorProvider.mo1933get(), this.authControllerProvider.mo1933get(), this.notificationIconAreaControllerProvider.mo1933get());
    }
