...
public class HeadsUpManagerPhone extends HeadsUpManager implements Dumpable, VisualStabilityManager.Callback, OnHeadsUpChangedListener {
    ...
    private final Pools.Pool<HeadsUpEntryPhone> mEntryPool = new Pools.Pool<HeadsUpEntryPhone>() { // from class: com.android.systemui.statusbar.phone.HeadsUpManagerPhone.1
        private Stack<HeadsUpEntryPhone> mPoolObjects = new Stack<>();

        /* renamed from: acquire */
        public HeadsUpEntryPhone m1193acquire() {
    ...
    public HeadsUpManagerPhone(Context context, StatusBarStateController statusBarStateController, KeyguardBypassController keyguardBypassController, GroupMembershipManager groupMembershipManager, ConfigurationController configurationController) {
        super(context);
    ...
    public void updateResources() {
        Resources resources = this.mContext.getResources();
        this.mHeadsUpInset = resources.getDimensionPixelSize(17105526) + resources.getDimensionPixelSize(R$dimen.heads_up_status_bar_padding);
    }
    ...
    /* renamed from: createAlertEntry  reason: collision with other method in class */
    public HeadsUpManager.HeadsUpEntry mo1301createAlertEntry() {
        ...
        public void setEntry(final NotificationEntry notificationEntry) {
            setEntry(notificationEntry, new Runnable() { // from class: com.android.systemui.statusbar.phone.HeadsUpManagerPhone$HeadsUpEntryPhone$$ExternalSyntheticLambda0
                ...
                public final void run() {
                    HeadsUpManagerPhone.HeadsUpEntryPhone.this.lambda$setEntry$0(notificationEntry);
                }
            });
        }
