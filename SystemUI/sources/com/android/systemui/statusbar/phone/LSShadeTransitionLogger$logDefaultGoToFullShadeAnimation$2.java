...
final class LSShadeTransitionLogger$logDefaultGoToFullShadeAnimation$2 extends Lambda implements Function1<LogMessage, String> {
    ...
    LSShadeTransitionLogger$logDefaultGoToFullShadeAnimation$2() {
        super(1);
    }

    public final String invoke(LogMessage logMessage) {
        Intrinsics.checkNotNullParameter(logMessage, "$this$log");
        return "Default animation started to full shade with delay " + logMessage.getLong1();
    }
}
