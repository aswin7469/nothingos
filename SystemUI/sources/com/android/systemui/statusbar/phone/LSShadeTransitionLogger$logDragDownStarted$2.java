...
final class LSShadeTransitionLogger$logDragDownStarted$2 extends Lambda implements Function1<LogMessage, String> {
    ...
    LSShadeTransitionLogger$logDragDownStarted$2() {
        super(1);
    }

    public final String invoke(LogMessage logMessage) {
        Intrinsics.checkNotNullParameter(logMessage, "$this$log");
        return "The drag down has started on " + logMessage.getStr1();
    }
}
