...
public final class LightBarController_Factory implements Factory<LightBarController> {
    ...
    /* renamed from: get */
    public LightBarController mo1933get() {
        return newInstance(this.ctxProvider.mo1933get(), this.darkIconDispatcherProvider.mo1933get(), this.batteryControllerProvider.mo1933get(), this.navModeControllerProvider.mo1933get());
    }
