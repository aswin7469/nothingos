...
public class LightsOutNotifController {
    ...
    void updateLightsOutView() {
        ...
        animate.alpha(f).setDuration(shouldShowDot ? 750L : 250L).setInterpolator(new AccelerateInterpolator(2.0f)).setListener(new AnimatorListenerAdapter() { // from class: com.android.systemui.statusbar.phone.LightsOutNotifController.1
