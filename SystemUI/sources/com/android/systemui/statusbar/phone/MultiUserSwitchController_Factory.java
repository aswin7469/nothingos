...
public final class MultiUserSwitchController_Factory implements Factory<MultiUserSwitchController> {
    ...
    /* renamed from: get */
    public MultiUserSwitchController mo1933get() {
        return newInstance(this.viewProvider.mo1933get(), this.userManagerProvider.mo1933get(), this.userSwitcherControllerProvider.mo1933get(), this.qsDetailDisplayerProvider.mo1933get(), this.falsingManagerProvider.mo1933get());
    }
