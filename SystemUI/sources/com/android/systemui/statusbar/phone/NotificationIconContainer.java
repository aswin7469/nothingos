...
public class NotificationIconContainer extends AlphaOptimizedFrameLayout {
    ...
    private int MAX_STATIC_ICONS = 4;
    ...
    public void setMoreIcons(boolean z) {
        if (z) {
            this.MAX_STATIC_ICONS = 50;
        } else {
            this.MAX_STATIC_ICONS = 4;
        }
    }
        ...
        if (view instanceof StatusBarIconView) {
            ...
            statusBarIconView.setVisibleState(2, true, new Runnable() { // from class: com.android.systemui.statusbar.phone.NotificationIconContainer$$ExternalSyntheticLambda0
                ...
                public final void run() {
                    NotificationIconContainer.this.lambda$onViewRemoved$0(statusBarIconView);
                }
            }, z ? 110L : 0L);
        }
    }
    ...
    public void calculateIconTranslations() {
        ...
        while (true) {
            ...
            float iconScaleIncreased = (!this.mOnLockScreen || !(childAt2 instanceof StatusBarIconView)) ? 1.0f : ((StatusBarIconView) childAt2).getIconScaleIncreased();
            ...
            actualPaddingStart += iconState2.iconAppearAmount * childAt2.getWidth() * iconScaleIncreased;
            i3++;
            f2 = 0.0f;
        }
        this.mNumDots = 0;
        if (i2 != -1) {
            ...
            while (i2 < childCount) {
                ...
                if (i6 < 1 && f5 >= 0.0f) {
                    ...
                    f5 += i5 * iconState3.iconAppearAmount;
        ...
        if (isLayoutRtl()) {
            for (int i7 = 0; i7 < childCount; i7++) {
                IconState iconState4 = this.mIconStates.get(getChildAt(i7));
    ...
    private float getActualPaddingEnd() {
        ...
        return f == -2.14748365E9f ? getPaddingEnd() : f;
    }

    public float getActualPaddingStart() {
        float f = this.mActualPaddingStart;
        return f == -2.14748365E9f ? getPaddingStart() : f;
    }
    ...
    public class IconState extends ViewState {
        ...
        private final Consumer<Property> mCannedAnimationEndListener = new Consumer() { // from class: com.android.systemui.statusbar.phone.NotificationIconContainer$IconState$$ExternalSyntheticLambda0
            ...
            public final void accept(Object obj) {
                NotificationIconContainer.IconState.this.lambda$new$0((Property) obj);
            }
        };
        ...
        public void applyToView(View view) {
            ...
            if (view instanceof StatusBarIconView) {
                ...
                statusBarIconView.setIconColor(NotificationIconContainer.this.mInNotificationIconShelf ? NotificationIconContainer.this.mThemedTextColorPrimary : this.iconColor, this.needsCannedAnimation && z3);
                if (z) {
