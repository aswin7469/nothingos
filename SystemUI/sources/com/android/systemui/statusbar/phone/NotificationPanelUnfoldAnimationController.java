...
public final class NotificationPanelUnfoldAnimationController {
    ...
    public final void setup(ViewGroup viewGroup) {
        ...
        getTranslateAnimator().init(viewGroup, (float) this.context.getResources().getDimensionPixelSize(C1893R.dimen.notification_side_paddings));
    }
}
