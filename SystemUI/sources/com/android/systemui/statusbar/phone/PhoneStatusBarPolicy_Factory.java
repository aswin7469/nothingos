...
public final class PhoneStatusBarPolicy_Factory implements Factory<PhoneStatusBarPolicy> {
    ...
    /* renamed from: get */
    public PhoneStatusBarPolicy mo1933get() {
        return newInstance(this.iconControllerProvider.mo1933get(), this.commandQueueProvider.mo1933get(), this.broadcastDispatcherProvider.mo1933get(), this.uiBgExecutorProvider.mo1933get(), this.resourcesProvider.mo1933get(), this.castControllerProvider.mo1933get(), this.hotspotControllerProvider.mo1933get(), this.bluetoothControllerProvider.mo1933get(), this.nextAlarmControllerProvider.mo1933get(), this.userInfoControllerProvider.mo1933get(), this.rotationLockControllerProvider.mo1933get(), this.dataSaverControllerProvider.mo1933get(), this.zenModeControllerProvider.mo1933get(), this.deviceProvisionedControllerProvider.mo1933get(), this.keyguardStateControllerProvider.mo1933get(), this.locationControllerProvider.mo1933get(), this.sensorPrivacyControllerProvider.mo1933get(), this.iActivityManagerProvider.mo1933get(), this.alarmManagerProvider.mo1933get(), this.userManagerProvider.mo1933get(), this.recordingControllerProvider.mo1933get(), this.telecomManagerProvider.mo1933get(), this.displayIdProvider.mo1933get().intValue(), this.sharedPreferencesProvider.mo1933get(), this.dateFormatUtilProvider.mo1933get(), this.ringerModeTrackerProvider.mo1933get(), this.privacyItemControllerProvider.mo1933get(), this.privacyLoggerProvider.mo1933get());
    }
