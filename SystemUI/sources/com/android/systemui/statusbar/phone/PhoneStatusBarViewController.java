...
public final class PhoneStatusBarViewController extends ViewController<PhoneStatusBarView> {
    ...
    public void onViewAttached() {
        if (this.moveFromCenterAnimationController != null) {
            View findViewById = ((PhoneStatusBarView) this.mView).findViewById(C1894R.C1898id.status_bar_left_side);
            Intrinsics.checkNotNullExpressionValue(findViewById, "mView.findViewById(R.id.status_bar_left_side)");
            View findViewById2 = ((PhoneStatusBarView) this.mView).findViewById(C1894R.C1898id.system_icon_area);
    ...
    public static final void m3193onViewAttached$lambda0(PhoneStatusBarViewController phoneStatusBarViewController, View view, int i, int i2, int i3, int i4, int i5, int i6, int i7, int i8) {
    ...
    @Metadata(mo65042d1 = {"\u0000&\n\u0002\u0018\u0002\n\u0002\u0018\u0002\n\u0002\b\u0002\n\u0002\u0010\u0002\n\u0000\n\u0002\u0018\u0002\n\u0000\n\u0002\u0018\u0002\n\u0002\b\u0002\n\u0002\u0010\u000b\n\u0000\u0018\u00002\u00020\u0001B\u0005¢\u0006\u0002\u0010\u0002J\u0018\u0010\u0003\u001a\u00020\u00042\u0006\u0010\u0005\u001a\u00020\u00062\u0006\u0010\u0007\u001a\u00020\bH\u0016J \u0010\t\u001a\u00020\u00042\u0006\u0010\u0005\u001a\u00020\u00062\u0006\u0010\u0007\u001a\u00020\b2\u0006\u0010\n\u001a\u00020\u000bH\u0002¨\u0006\f"}, mo65043d2 = {"Lcom/android/systemui/statusbar/phone/PhoneStatusBarViewController$StatusBarViewsCenterProvider;", "Lcom/android/systemui/shared/animation/UnfoldMoveFromCenterAnimator$ViewCenterProvider;", "()V", "getViewCenter", "", "view", "Landroid/view/View;", "outPoint", "Landroid/graphics/Point;", "getViewEdgeCenter", "isStart", "", "SystemUI_nothingRelease"}, mo65044k = 1, mo65045mv = {1, 6, 0}, mo65047xi = 48)
    /* compiled from: PhoneStatusBarViewController.kt */
    public static final class StatusBarViewsCenterProvider implements UnfoldMoveFromCenterAnimator.ViewCenterProvider {
        public void getViewCenter(View view, Point point) {
            ...
            int id = view.getId();
            if (id == C1894R.C1898id.status_bar_left_side) {
                getViewEdgeCenter(view, point, true);
            } else if (id != C1894R.C1898id.system_icon_area) {
