...
public final class ShadeControllerImpl_Factory implements Factory<ShadeControllerImpl> {
    ...
    /* renamed from: get */
    public ShadeControllerImpl mo1933get() {
        return newInstance(this.commandQueueProvider.mo1933get(), this.statusBarStateControllerProvider.mo1933get(), this.notificationShadeWindowControllerProvider.mo1933get(), this.statusBarKeyguardViewManagerProvider.mo1933get(), this.windowManagerProvider.mo1933get(), DoubleCheck.lazy(this.statusBarLazyProvider), DoubleCheck.lazy(this.assistManagerLazyProvider), this.bubblesOptionalProvider.mo1933get());
    }
