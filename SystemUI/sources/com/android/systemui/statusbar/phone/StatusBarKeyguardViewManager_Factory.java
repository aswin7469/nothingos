...
public final class StatusBarKeyguardViewManager_Factory implements Factory<StatusBarKeyguardViewManager> {
    ...
    /* renamed from: get */
    public StatusBarKeyguardViewManager mo1933get() {
        return newInstance(this.contextProvider.mo1933get(), this.callbackProvider.mo1933get(), this.lockPatternUtilsProvider.mo1933get(), this.sysuiStatusBarStateControllerProvider.mo1933get(), this.configurationControllerProvider.mo1933get(), this.keyguardUpdateMonitorProvider.mo1933get(), this.navigationModeControllerProvider.mo1933get(), this.dockManagerProvider.mo1933get(), this.notificationShadeWindowControllerProvider.mo1933get(), this.keyguardStateControllerProvider.mo1933get(), this.faceAuthScreenBrightnessControllerProvider.mo1933get(), this.notificationMediaManagerProvider.mo1933get(), this.keyguardBouncerFactoryProvider.mo1933get(), this.wakefulnessLifecycleProvider.mo1933get(), this.unlockedScreenOffAnimationControllerProvider.mo1933get(), this.keyguardMessageAreaFactoryProvider.mo1933get());
    }
