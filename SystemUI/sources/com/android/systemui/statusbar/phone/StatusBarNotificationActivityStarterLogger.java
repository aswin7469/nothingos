...
@Metadata(mo64986d1 = {"\u0000:\n\u0002\u0018\u0002\n\u0002\u0010\u0000\n\u0000\n\u0002\u0018\u0002\n\u0002\b\u0002\n\u0002\u0010\u0002\n\u0000\n\u0002\u0018\u0002\n\u0002\b\u0007\n\u0002\u0018\u0002\n\u0000\n\u0002\u0010\b\n\u0002\b\u0003\n\u0002\u0018\u0002\n\u0002\u0018\u0002\n\u0002\b\u0003\u0018\u00002\u00020\u0001B\u0011\b\u0007\u0012\b\b\u0001\u0010\u0002\u001a\u00020\u0003¢\u0006\u0002\u0010\u0004J\u000e\u0010\u0005\u001a\u00020\u00062\u0006\u0010\u0007\u001a\u00020\bJ\u000e\u0010\t\u001a\u00020\u00062\u0006\u0010\u0007\u001a\u00020\bJ\u000e\u0010\n\u001a\u00020\u00062\u0006\u0010\u0007\u001a\u00020\bJ\u000e\u0010\u000b\u001a\u00020\u00062\u0006\u0010\u0007\u001a\u00020\bJ\u000e\u0010\f\u001a\u00020\u00062\u0006\u0010\u0007\u001a\u00020\bJ\u000e\u0010\r\u001a\u00020\u00062\u0006\u0010\u0007\u001a\u00020\bJ\u001e\u0010\u000e\u001a\u00020\u00062\u0006\u0010\u0007\u001a\u00020\b2\u0006\u0010\u000f\u001a\u00020\u00102\u0006\u0010\u0011\u001a\u00020\u0012J\u0016\u0010\u0013\u001a\u00020\u00062\u0006\u0010\u0007\u001a\u00020\b2\u0006\u0010\u000f\u001a\u00020\u0010J\u0012\u0010\u0014\u001a\u00020\u00062\n\u0010\u0015\u001a\u00060\u0016j\u0002`\u0017J\u000e\u0010\u0018\u001a\u00020\u00062\u0006\u0010\u0007\u001a\u00020\bJ\u000e\u0010\u0019\u001a\u00020\u00062\u0006\u0010\u0007\u001a\u00020\bR\u000e\u0010\u0002\u001a\u00020\u0003X\u0004¢\u0006\u0002\n\u0000¨\u0006\u001a"}, mo64987d2 = {"Lcom/android/systemui/statusbar/phone/StatusBarNotificationActivityStarterLogger;", "", "buffer", "Lcom/android/systemui/log/LogBuffer;", "(Lcom/android/systemui/log/LogBuffer;)V", "logExpandingBubble", "", "entry", "Lcom/android/systemui/statusbar/notification/collection/NotificationEntry;", "logFullScreenIntentNotImportantEnough", "logFullScreenIntentSuppressedByDnD", "logHandleClickAfterKeyguardDismissed", "logHandleClickAfterPanelCollapsed", "logNonClickableNotification", "logSendPendingIntent", "pendingIntent", "Landroid/app/PendingIntent;", "result", "", "logSendingFullScreenIntent", "logSendingIntentFailed", "e", "Ljava/lang/Exception;", "Lkotlin/Exception;", "logStartNotificationIntent", "logStartingActivityFromClick", "SystemUI_nothingRelease"}, mo64988k = 1, mo64989mv = {1, 6, 0}, mo64991xi = 48)
...
public final class StatusBarNotificationActivityStarterLogger {
    ...
    public final void logStartingActivityFromClick(NotificationEntry notificationEntry) {
        ...
        LogMessage obtain = logBuffer.obtain("NotifActivityStarter", LogLevel.DEBUG, C3102xbe0e6f79.INSTANCE);
    ...
    public final void logHandleClickAfterKeyguardDismissed(NotificationEntry notificationEntry) {
        Intrinsics.checkNotNullParameter(notificationEntry, "entry");
        LogBuffer logBuffer = this.buffer;
        LogMessage obtain = logBuffer.obtain("NotifActivityStarter", LogLevel.DEBUG, C3095x5700bdb1.INSTANCE);
        obtain.setStr1(NotificationUtilsKt.getLogKey((ListEntry) notificationEntry));
        logBuffer.commit(obtain);
    }
    ...
    public final void logHandleClickAfterPanelCollapsed(NotificationEntry notificationEntry) {
        Intrinsics.checkNotNullParameter(notificationEntry, "entry");
        LogBuffer logBuffer = this.buffer;
        LogMessage obtain = logBuffer.obtain("NotifActivityStarter", LogLevel.DEBUG, C3096xe49d9e41.INSTANCE);
        obtain.setStr1(NotificationUtilsKt.getLogKey((ListEntry) notificationEntry));
        logBuffer.commit(obtain);
    }
    ...
    public final void logStartNotificationIntent(NotificationEntry notificationEntry) {
        Intrinsics.checkNotNullParameter(notificationEntry, "entry");
        LogBuffer logBuffer = this.buffer;
        LogMessage obtain = logBuffer.obtain("NotifActivityStarter", LogLevel.INFO, C3101x1850e613.INSTANCE);
        obtain.setStr1(NotificationUtilsKt.getLogKey((ListEntry) notificationEntry));
        logBuffer.commit(obtain);
    }
    ...
    public final void logSendPendingIntent(NotificationEntry notificationEntry, PendingIntent pendingIntent, int i) {
        ...
        LogBuffer logBuffer = this.buffer;
        LogMessage obtain = logBuffer.obtain("NotifActivityStarter", LogLevel.INFO, C3098xf7e3e395.INSTANCE);
        obtain.setStr1(NotificationUtilsKt.getLogKey((ListEntry) notificationEntry));
    ...
    public final void logSendingIntentFailed(Exception exc) {
        ...
        LogBuffer logBuffer = this.buffer;
        LogMessage obtain = logBuffer.obtain("NotifActivityStarter", LogLevel.WARNING, C3100x40a889d.INSTANCE);
    ...
    public final void logNonClickableNotification(NotificationEntry notificationEntry) {
        Intrinsics.checkNotNullParameter(notificationEntry, "entry");
        LogBuffer logBuffer = this.buffer;
        LogMessage obtain = logBuffer.obtain("NotifActivityStarter", LogLevel.ERROR, C3097x823c33d2.INSTANCE);
        obtain.setStr1(NotificationUtilsKt.getLogKey((ListEntry) notificationEntry));
        logBuffer.commit(obtain);
    }
    ...
    public final void logFullScreenIntentSuppressedByDnD(NotificationEntry notificationEntry) {
        Intrinsics.checkNotNullParameter(notificationEntry, "entry");
        LogBuffer logBuffer = this.buffer;
        LogMessage obtain = logBuffer.obtain("NotifActivityStarter", LogLevel.DEBUG, C3094x7a36b302.INSTANCE);
        obtain.setStr1(NotificationUtilsKt.getLogKey((ListEntry) notificationEntry));
        logBuffer.commit(obtain);
    }
    ...
    public final void logFullScreenIntentNotImportantEnough(NotificationEntry notificationEntry) {
        Intrinsics.checkNotNullParameter(notificationEntry, "entry");
        LogBuffer logBuffer = this.buffer;
        LogMessage obtain = logBuffer.obtain("NotifActivityStarter", LogLevel.DEBUG, C3093x141720c8.INSTANCE);
        obtain.setStr1(NotificationUtilsKt.getLogKey((ListEntry) notificationEntry));
        logBuffer.commit(obtain);
    }
    ...
    public final void logSendingFullScreenIntent(NotificationEntry notificationEntry, PendingIntent pendingIntent) {
        ...
        Intrinsics.checkNotNullParameter(pendingIntent, "pendingIntent");
        LogBuffer logBuffer = this.buffer;
        LogMessage obtain = logBuffer.obtain("NotifActivityStarter", LogLevel.INFO, C3099x57d5767b.INSTANCE);
        obtain.setStr1(NotificationUtilsKt.getLogKey((ListEntry) notificationEntry));
        obtain.setStr2(pendingIntent.getIntent().toString());
        logBuffer.commit(obtain);
    }
