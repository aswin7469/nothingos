...
public final class StatusBarNotificationActivityStarter_Builder_Factory implements Factory<StatusBarNotificationActivityStarter.Builder> {
    ...
    /* renamed from: get */
    public StatusBarNotificationActivityStarter.Builder mo1933get() {
        return newInstance(this.contextProvider.mo1933get(), this.commandQueueProvider.mo1933get(), this.mainThreadHandlerProvider.mo1933get(), this.uiBgExecutorProvider.mo1933get(), this.entryManagerProvider.mo1933get(), this.notifPipelineProvider.mo1933get(), this.headsUpManagerProvider.mo1933get(), this.activityStarterProvider.mo1933get(), this.clickNotifierProvider.mo1933get(), this.statusBarStateControllerProvider.mo1933get(), this.statusBarKeyguardViewManagerProvider.mo1933get(), this.keyguardManagerProvider.mo1933get(), this.dreamManagerProvider.mo1933get(), this.bubblesManagerProvider.mo1933get(), DoubleCheck.lazy(this.assistManagerLazyProvider), this.remoteInputManagerProvider.mo1933get(), this.groupMembershipManagerProvider.mo1933get(), this.lockscreenUserManagerProvider.mo1933get(), this.shadeControllerProvider.mo1933get(), this.keyguardStateControllerProvider.mo1933get(), this.notificationInterruptStateProvider.mo1933get(), this.lockPatternUtilsProvider.mo1933get(), this.remoteInputCallbackProvider.mo1933get(), this.activityIntentHelperProvider.mo1933get(), this.featureFlagsProvider.mo1933get(), this.metricsLoggerProvider.mo1933get(), this.loggerProvider.mo1933get(), this.onUserInteractionCallbackProvider.mo1933get());
    }
