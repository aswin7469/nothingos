...
public class StatusBarRemoteInputCallback implements NotificationRemoteInputManager.Callback, CommandQueue.Callbacks, StatusBarStateController.StateListener {
    ...
    public void onStateChanged(int i) {
        ...
        if ((this.mStatusBarStateController.leaveOpenOnKeyguardHide() || z) && !this.mStatusBarStateController.isKeyguardRequested() && this.mKeyguardStateController.isUnlocked()) {
            if (z) {
                ...
                executor.execute(new StatusBarRemoteInputCallback$$ExternalSyntheticLambda4(view));
            }
    ...
    public /* synthetic */ void mo45338xbc60c05b() {
        ...
        if (view != null) {
            ...
            if (parent2 instanceof NotificationStackScrollLayout) {
                ...
                expandableNotificationRow.post(new StatusBarRemoteInputCallback$$ExternalSyntheticLambda1(this, (NotificationStackScrollLayout) parent2, expandableNotificationRow));
            }
        }
    }
    ...
    public /* synthetic */ void mo45337xe09f449a(NotificationStackScrollLayout notificationStackScrollLayout, ExpandableNotificationRow expandableNotificationRow) {
        ...
        if (notificationStackScrollLayout.scrollTo(expandableNotificationRow)) {
            ...
            statusBarRemoteInputCallback$$ExternalSyntheticLambda0.run();
        }
    }
    ...
    public boolean startWorkChallengeIfNecessary(int i, IntentSender intentSender, String str) {
        ...
        Intent intent = new Intent(NotificationLockscreenUserManager.NOTIFICATION_UNLOCKED_BY_WORK_CHALLENGE_ACTION);
    ...
    public boolean handleRemoteViewClick(View view, PendingIntent pendingIntent, boolean z, NotificationRemoteInputManager.ClickHandler clickHandler) {
        ...
        this.mActivityStarter.dismissKeyguardThenExecute(new StatusBarRemoteInputCallback$$ExternalSyntheticLambda3(this, pendingIntent, clickHandler), (Runnable) null, this.mActivityIntentHelper.wouldLaunchResolverActivity(pendingIntent.getIntent(), this.mLockscreenUserManager.getCurrentUserId()));
        return true;
    }
