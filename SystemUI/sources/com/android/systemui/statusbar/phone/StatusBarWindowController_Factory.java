...
public final class StatusBarWindowController_Factory implements Factory<StatusBarWindowController> {
    ...
    /* renamed from: get */
    public StatusBarWindowController mo1933get() {
        return newInstance(this.contextProvider.mo1933get(), this.windowManagerProvider.mo1933get(), this.iWindowManagerProvider.mo1933get(), this.superStatusBarViewFactoryProvider.mo1933get(), this.contentInsetsProvider.mo1933get(), this.resourcesProvider.mo1933get());
    }
