...
public final class C3121x8fd6ebda implements Factory<NotificationsQuickSettingsContainer> {
    private final Provider<NotificationShadeWindowView> notificationShadeWindowViewProvider;

    public C3121x8fd6ebda(Provider<NotificationShadeWindowView> provider) {
    ...
    public static C3121x8fd6ebda create(Provider<NotificationShadeWindowView> provider) {
        return new C3121x8fd6ebda(provider);
    }
