...
public final class C3127xfe780fd7 implements Factory<PhoneStatusBarViewController> {
    ...
    public C3127xfe780fd7(Provider<PhoneStatusBarViewController.Factory> provider, Provider<PhoneStatusBarView> provider2, Provider<NotificationPanelViewController> provider3) {
    ...
    public static C3127xfe780fd7 create(Provider<PhoneStatusBarViewController.Factory> provider, Provider<PhoneStatusBarView> provider2, Provider<NotificationPanelViewController> provider3) {
        return new C3127xfe780fd7(provider, provider2, provider3);
    }
