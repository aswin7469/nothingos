...
public final class C3128x6673e9b7 implements Factory<StatusBarUserSwitcherContainer> {
    private final Provider<PhoneStatusBarView> viewProvider;

    public C3128x6673e9b7(Provider<PhoneStatusBarView> provider) {
    ...
    public static C3128x6673e9b7 create(Provider<PhoneStatusBarView> provider) {
        return new C3128x6673e9b7(provider);
    }
