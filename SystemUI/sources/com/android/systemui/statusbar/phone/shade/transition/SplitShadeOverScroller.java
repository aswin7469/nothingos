...
public final class SplitShadeOverScroller implements ShadeOverScroller {
    ...
    @AssistedFactory
    @Metadata(mo64986d1 = {"\u0000\u001c\n\u0002\u0018\u0002\n\u0002\u0010\u0000\n\u0000\n\u0002\u0018\u0002\n\u0000\n\u0002\u0018\u0002\n\u0000\n\u0002\u0018\u0002\n\u0000\bç\u0001\u0018\u00002\u00020\u0001J\u0018\u0010\u0002\u001a\u00020\u00032\u0006\u0010\u0004\u001a\u00020\u00052\u0006\u0010\u0006\u001a\u00020\u0007H&ø\u0001\u0000\u0002\u0006\n\u0004\b!0\u0001¨\u0006\bÀ\u0006\u0001"}, mo64987d2 = {"Lcom/android/systemui/statusbar/phone/shade/transition/SplitShadeOverScroller$Factory;", "", "create", "Lcom/android/systemui/statusbar/phone/shade/transition/SplitShadeOverScroller;", "qS", "Lcom/android/systemui/plugins/qs/QS;", "nsslController", "Lcom/android/systemui/statusbar/notification/stack/NotificationStackScrollLayoutController;", "SystemUI_nothingRelease"}, mo64988k = 1, mo64989mv = {1, 6, 0}, mo64991xi = 48)
    /* compiled from: SplitShadeOverScroller.kt */
    public interface Factory {
        SplitShadeOverScroller create(C2301QS qs, NotificationStackScrollLayoutController notificationStackScrollLayoutController);
    }
    ...
    @AssistedInject
    public SplitShadeOverScroller(ConfigurationController configurationController, DumpManager dumpManager, Context context2, ScrimController scrimController2, @Assisted C2301QS qs, @Assisted NotificationStackScrollLayoutController notificationStackScrollLayoutController) {
    ...
    public final void updateResources() {
        ...
        this.maxOverScrollAmount = resources.getDimensionPixelSize(C1893R.dimen.shade_max_over_scroll_amount);
    ...
    private final void applyOverscroll(int i) {
        this.f393qS.setOverScrollAmount(i);
    ...
    public static final void m3216releaseOverScroll$lambda0(SplitShadeOverScroller splitShadeOverScroller, ValueAnimator valueAnimator) {
        Intrinsics.checkNotNullParameter(splitShadeOverScroller, "this$0");
        Object animatedValue = valueAnimator.getAnimatedValue();
        if (animatedValue != null) {
            int intValue = ((Integer) animatedValue).intValue();
            splitShadeOverScroller.f393qS.setOverScrollAmount(intValue);
