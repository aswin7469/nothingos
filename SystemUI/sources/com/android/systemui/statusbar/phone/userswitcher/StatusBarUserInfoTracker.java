...
public final class StatusBarUserInfoTracker implements CallbackController<CurrentUserChipInfoUpdatedListener>, Dumpable {
    ...
    public static final void m3220userInfoChangedListener$lambda0(StatusBarUserInfoTracker statusBarUserInfoTracker, String str, Drawable drawable, String str2) {
    ...
    public static final void m3218checkEnabled$lambda4(StatusBarUserInfoTracker statusBarUserInfoTracker) {
        Intrinsics.checkNotNullParameter(statusBarUserInfoTracker, "this$0");
    ...
    public static final void m3219checkEnabled$lambda4$lambda3(StatusBarUserInfoTracker statusBarUserInfoTracker) {
        Intrinsics.checkNotNullParameter(statusBarUserInfoTracker, "this$0");
