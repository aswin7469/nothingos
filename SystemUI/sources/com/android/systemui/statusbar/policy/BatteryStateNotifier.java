...
public final class BatteryStateNotifier implements BatteryController.BatteryStateChangeCallback {
    ...
    public void onBatteryUnknownStateChanged(boolean z) {
        ...
        if (z) {
            ...
            this.noMan.notify("BatteryStateNotifier", 666, new Notification.Builder(this.context, notificationChannel.getId()).setAutoCancel(false).setContentTitle(this.context.getString(C1893R.string.battery_state_unknown_notification_title)).setContentText(this.context.getString(C1893R.string.battery_state_unknown_notification_text)).setSmallIcon(17303599).setContentIntent(PendingIntent.getActivity(this.context, 0, new Intent("android.intent.action.VIEW", Uri.parse(this.context.getString(C1893R.string.config_batteryStateUnknownUrl))), 67108864)).setAutoCancel(true).setOngoing(true).build());
            return;
        }
    ...
    public static final void m3224scheduleNotificationCancel$lambda0(Function0 function0) {
