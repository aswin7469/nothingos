...
final class HeadsUpManagerLogger$logShowNotification$2 extends Lambda implements Function1<LogMessage, String> {
    public static final HeadsUpManagerLogger$logShowNotification$2 INSTANCE = new HeadsUpManagerLogger$logShowNotification$2();

    HeadsUpManagerLogger$logShowNotification$2() {
        super(1);
    }

    public final String invoke(LogMessage logMessage) {
        Intrinsics.checkNotNullParameter(logMessage, "$this$log");
        return "show notification " + logMessage.getStr1();
    }
}
