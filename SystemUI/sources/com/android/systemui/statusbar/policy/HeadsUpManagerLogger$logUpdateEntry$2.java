...
final class HeadsUpManagerLogger$logUpdateEntry$2 extends Lambda implements Function1<LogMessage, String> {
    final /* synthetic */ String $key;

    /* JADX INFO: super call moved to the top of the method (can break code semantics) */
    HeadsUpManagerLogger$logUpdateEntry$2(String str) {
        super(1);
        this.$key = str;
    }
