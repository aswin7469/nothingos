...
public final class HotspotControllerImpl_Factory implements Factory<HotspotControllerImpl> {
    ...
    /* renamed from: get */
    public HotspotControllerImpl mo1933get() {
        return newInstance(this.contextProvider.mo1933get(), this.mainHandlerProvider.mo1933get(), this.backgroundHandlerProvider.mo1933get());
    }
