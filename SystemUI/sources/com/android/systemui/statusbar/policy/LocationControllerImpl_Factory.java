...
public final class LocationControllerImpl_Factory implements Factory<LocationControllerImpl> {
    ...
    /* renamed from: get */
    public LocationControllerImpl mo1933get() {
        return newInstance(this.contextProvider.mo1933get(), this.appOpsControllerProvider.mo1933get(), this.mainLooperProvider.mo1933get(), this.backgroundHandlerProvider.mo1933get(), this.broadcastDispatcherProvider.mo1933get(), this.bootCompleteCacheProvider.mo1933get(), this.userTrackerProvider.mo1933get());
    }
