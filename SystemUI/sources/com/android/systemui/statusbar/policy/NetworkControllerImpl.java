...
public class NetworkControllerImpl extends BroadcastReceiver implements NetworkController, DemoMode, DataUsageController.NetworkNameProvider, Dumpable {
        ...
        public void onConfigChanged(Configuration configuration) {
            ...
            NetworkControllerImpl.this.mReceiverHandler.post(new Runnable() { // from class: com.android.systemui.statusbar.policy.NetworkControllerImpl$1$$ExternalSyntheticLambda0
                ...
                public final void run() {
                    NetworkControllerImpl.AnonymousClass1.this.lambda$onConfigChanged$0();
                }
            });
        }
    ...
    NetworkControllerImpl(Context context, ConnectivityManager connectivityManager, TelephonyManager telephonyManager, TelephonyListenerManager telephonyListenerManager, WifiManager wifiManager, NetworkScoreManager networkScoreManager, SubscriptionManager subscriptionManager, MobileMappings.Config config, Looper looper, Executor executor, CallbackHandler callbackHandler, AccessPointControllerImpl accessPointControllerImpl, DataUsageController dataUsageController, MobileStatusTracker.SubscriptionDefaults subscriptionDefaults, final DeviceProvisionedController deviceProvisionedController, BroadcastDispatcher broadcastDispatcher, DemoModeController demoModeController, CarrierConfigTracker carrierConfigTracker, FeatureFlags featureFlags, DumpManager dumpManager) {
        ...
        this.mClearForceValidated = new Runnable() { // from class: com.android.systemui.statusbar.policy.NetworkControllerImpl$$ExternalSyntheticLambda7
            @Override // java.lang.Runnable
            public final void run() {
        ...
        this.mRegisterListeners = new Runnable() { // from class: com.android.systemui.statusbar.policy.NetworkControllerImpl$$ExternalSyntheticLambda5
            @Override // java.lang.Runnable
            public final void run() {
                NetworkControllerImpl.this.lambda$new$6();
            }
        };
        ...
        if (wifiManager != null) {
            ...
            handler = handler2;
            wifiManager.registerScanResultsCallback(new MediaRoute2Provider$$ExternalSyntheticLambda0(handler), scanResultsCallback);
        } else {
            handler = handler2;
        }
    ...
    public /* synthetic */ void lambda$new$1(final int i) {
        this.mBgExecutor.execute(new Runnable() { // from class: com.android.systemui.statusbar.policy.NetworkControllerImpl$$ExternalSyntheticLambda8
            @Override // java.lang.Runnable
            public final void run() {
                NetworkControllerImpl.this.lambda$new$0(i);
            }
        });
    }
    ...
    public void lambda$new$6() {
        ...
        if (InternetDialogUtil.isProviderModelEnabled(this.mContext)) {
        ...
        handler.post(new Runnable() { // from class: com.android.systemui.statusbar.policy.NetworkControllerImpl$$ExternalSyntheticLambda10
            @Override // java.lang.Runnable
            public final void run() {
                WifiSignalController.this.fetchInitialState();
            }
        });
        this.mReceiverHandler.post(new Runnable() { // from class: com.android.systemui.statusbar.policy.NetworkControllerImpl$$ExternalSyntheticLambda6
            @Override // java.lang.Runnable
            public final void run() {
    ...
    public void onReceive(Context context, Intent intent) {
        ...
        switch (c) {
            ...
            case 6:
                break;
            case 7:
                this.mMainHandler.post(new Runnable() { // from class: com.android.systemui.statusbar.policy.NetworkControllerImpl$$ExternalSyntheticLambda3
                    @Override // java.lang.Runnable
                    public final void run() {
                        NetworkControllerImpl.this.lambda$onReceive$4();
                    }
                });
                return;
            default:
    ...
    public /* synthetic */ void lambda$onReceive$4() {
        this.mInternetDialogFactory.create(true, this.mAccessPoints.canConfigMobileData(), this.mAccessPoints.canConfigWifi());
    }
    ...
    public void setUserSetupComplete(final boolean z) {
        this.mReceiverHandler.post(new Runnable() { // from class: com.android.systemui.statusbar.policy.NetworkControllerImpl$$ExternalSyntheticLambda9
            @Override // java.lang.Runnable
            public final void run() {
                NetworkControllerImpl.this.lambda$setUserSetupComplete$5(z);
            }
        });
    }
    ...
    public void lambda$setUserSetupComplete$5(boolean z) {
        this.mUserSetup = z;
        for (int i = 0; i < this.mMobileSignalControllers.size(); i++) {
        ...
        if (string9 != null) {
            ...
            if (string10 != null) {
                ...
                if (string10.equals("1x")) {
                    ...
                    signalIcon$MobileIconGroup = string10.equals("not") ? TelephonyIcons.NOT_DEFAULT_DATA : TelephonyIcons.UNKNOWN;
                }
            ...
            if (bundle.containsKey("inflate")) {
                for (int i4 = 0; i4 < this.mMobileSignalControllers.size(); i4++) {
                    this.mMobileSignalControllers.valueAt(i4).mInflateSignalStrengths = "true".equals(bundle.getString("inflate"));
                }
            }
