...
public final class RemoteInputViewControllerImpl implements RemoteInputViewController {
    ...
    public static final void m3244onFocusChangeListener$lambda4(RemoteInputViewControllerImpl remoteInputViewControllerImpl, View view2, boolean z) {
    ...
    public static final void m3245onSendRemoteInputListener$lambda7(RemoteInputViewControllerImpl remoteInputViewControllerImpl) {
        Intrinsics.checkNotNullParameter(remoteInputViewControllerImpl, "this$0");
    ...
    private final Intent prepareRemoteInputFromData(RemoteInput remoteInput2, String str, Uri uri) {
        ...
        if (TextUtils.isEmpty(label)) {
            label = getResources().getString(C1894R.string.remote_input_image_insertion_text);
        }
