...
public final class VariableDateView extends TextView {
    ...
    @Metadata(mo64986d1 = {"\u0000\u0016\n\u0002\u0018\u0002\n\u0002\u0010\u0000\n\u0000\n\u0002\u0010\u0002\n\u0000\n\u0002\u0010\b\n\u0000\bf\u0018\u00002\u00020\u0001J\u0010\u0010\u0002\u001a\u00020\u00032\u0006\u0010\u0004\u001a\u00020\u0005H&ø\u0001\u0000\u0002\u0006\n\u0004\b!0\u0001¨\u0006\u0006À\u0006\u0001"}, mo64987d2 = {"Lcom/android/systemui/statusbar/policy/VariableDateView$OnMeasureListener;", "", "onMeasureAction", "", "availableWidth", "", "SystemUI_nothingRelease"}, mo64988k = 1, mo64989mv = {1, 6, 0}, mo64991xi = 48)
    /* compiled from: VariableDateView.kt */
    ...
    public VariableDateView(Context context, AttributeSet attributeSet) {
        ...
        TypedArray obtainStyledAttributes = context.getTheme().obtainStyledAttributes(attributeSet, C1893R.styleable.VariableDateView, 0, 0);
        String string = obtainStyledAttributes.getString(0);
        if (string == null) {
            string = context.getString(C1893R.string.system_ui_date_pattern);
        ...
        if (string2 == null) {
            string2 = context.getString(C1893R.string.abbrev_month_day_no_year);
