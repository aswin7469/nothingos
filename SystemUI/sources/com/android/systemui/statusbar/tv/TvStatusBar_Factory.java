...
public final class TvStatusBar_Factory implements Factory<TvStatusBar> {
    ...
    /* renamed from: get */
    public TvStatusBar mo1933get() {
        return newInstance(this.contextProvider.mo1933get(), this.commandQueueProvider.mo1933get(), DoubleCheck.lazy(this.assistManagerLazyProvider));
    }
