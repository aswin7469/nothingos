...
public final class VpnStatusObserver extends SystemUI implements SecurityController.SecurityControllerCallback {
    ...
    private final Notification createVpnDisconnectedNotification() {
        return new Notification.Builder(this.mContext, "VPN Status").setSmallIcon(getVpnIconId()).setVisibility(1).setCategory("sys").extend(new Notification.TvExtender()).setTimeoutAfter(5000L).setContentTitle(this.mContext.getString(R$string.notification_vpn_disconnected)).build();
    }
