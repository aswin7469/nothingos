...
public final class C3207x1f42e6fb implements Factory<StatusBarWindowView> {
    private final Provider<LayoutInflater> layoutInflaterProvider;

    public C3207x1f42e6fb(Provider<LayoutInflater> provider) {
    ...
    public static C3207x1f42e6fb create(Provider<LayoutInflater> provider) {
        return new C3207x1f42e6fb(provider);
    }
