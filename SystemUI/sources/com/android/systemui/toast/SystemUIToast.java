...
public class SystemUIToast implements ToastPlugin.Toast {
    ...
    public void onOrientationChange(int i) {
        ...
        this.mDefaultY = this.mContext.getResources().getDimensionPixelSize(17105610);
        this.mDefaultGravity = this.mContext.getResources().getInteger(17694952);
    }
    ...
    public static Drawable getBadgedIcon(Context context, String str, int i) {
        ...
        try {
            ...
            ApplicationInfo applicationInfoAsUser = packageManager.getApplicationInfoAsUser(str, PackageManager.ApplicationInfoFlags.of(128), i);
