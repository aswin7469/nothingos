...
public final /* synthetic */ class TouchInsetManager$TouchInsetSession$$ExternalSyntheticLambda1 implements Runnable {
    ...
    public /* synthetic */ TouchInsetManager$TouchInsetSession$$ExternalSyntheticLambda1(TouchInsetManager.TouchInsetSession touchInsetSession, View view) {
        this.f$0 = touchInsetSession;
        this.f$1 = view;
    }

    public final void run() {
        this.f$0.mo46357x54fb6084(this.f$1);
    }
}
