...
public final class SystemUiTraceEntryProto extends MessageNano {
    ...
    public static SystemUiTraceEntryProto parseFrom(byte[] bArr) throws InvalidProtocolBufferNanoException {
        return (SystemUiTraceEntryProto) MessageNano.mergeFrom(new SystemUiTraceEntryProto(), bArr);
    }

    public static SystemUiTraceEntryProto parseFrom(CodedInputByteBufferNano codedInputByteBufferNano) throws IOException {
        return new SystemUiTraceEntryProto().mergeFrom(codedInputByteBufferNano);
    }
}
