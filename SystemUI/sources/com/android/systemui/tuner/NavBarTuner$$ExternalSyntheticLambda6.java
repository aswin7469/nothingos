...
public final /* synthetic */ class NavBarTuner$$ExternalSyntheticLambda6 implements Runnable {
    ...
    public /* synthetic */ NavBarTuner$$ExternalSyntheticLambda6(NavBarTuner navBarTuner, String str, String str2, ListPreference listPreference, ListPreference listPreference2, Preference preference) {
    ...
    public final void run() {
        this.f$0.m3253lambda$bindButton$4$comandroidsystemuitunerNavBarTuner(this.f$1, this.f$2, this.f$3, this.f$4, this.f$5);
    }
}
