...
public final class C3239xd9485442 implements Factory<Optional<NaturalRotationUnfoldProgressProvider>> {
    ...
    public C3239xd9485442(UnfoldTransitionModule unfoldTransitionModule, Provider<Context> provider, Provider<IWindowManager> provider2, Provider<Optional<UnfoldTransitionProgressProvider>> provider3) {
    ...
    public static C3239xd9485442 create(UnfoldTransitionModule unfoldTransitionModule, Provider<Context> provider, Provider<IWindowManager> provider2, Provider<Optional<UnfoldTransitionProgressProvider>> provider3) {
        return new C3239xd9485442(unfoldTransitionModule, provider, provider2, provider3);
    }
    ...
    public static java.util.Optional<com.android.systemui.unfold.util.NaturalRotationUnfoldProgressProvider> provideNaturalRotationProgressProvider(com.android.systemui.unfold.UnfoldTransitionModule r0, android.content.Context r1, android.view.IWindowManager r2, java.util.Optional<com.android.systemui.unfold.UnfoldTransitionProgressProvider> r3) {
        /*
            ...
            return r0
        */
        throw new UnsupportedOperationException("Method not decompiled: com.android.systemui.unfold.C3239xd9485442.provideNaturalRotationProgressProvider(com.android.systemui.unfold.UnfoldTransitionModule, android.content.Context, android.view.IWindowManager, java.util.Optional):java.util.Optional");
    }
}
