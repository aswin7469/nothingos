...
public final class C3240x6e72e9f0 implements Factory<Optional<ScopedUnfoldTransitionProgressProvider>> {
    ...
    public C3240x6e72e9f0(UnfoldTransitionModule unfoldTransitionModule, Provider<Optional<NaturalRotationUnfoldProgressProvider>> provider) {
    ...
    public static C3240x6e72e9f0 create(UnfoldTransitionModule unfoldTransitionModule, Provider<Optional<NaturalRotationUnfoldProgressProvider>> provider) {
        return new C3240x6e72e9f0(unfoldTransitionModule, provider);
    }
    ...
    public static java.util.Optional<com.android.systemui.unfold.util.ScopedUnfoldTransitionProgressProvider> provideStatusBarScopedTransitionProvider(com.android.systemui.unfold.UnfoldTransitionModule r0, java.util.Optional<com.android.systemui.unfold.util.NaturalRotationUnfoldProgressProvider> r1) {
        /*
            ...
            return r0
        */
        throw new UnsupportedOperationException("Method not decompiled: com.android.systemui.unfold.C3240x6e72e9f0.provideStatusBarScopedTransitionProvider(com.android.systemui.unfold.UnfoldTransitionModule, java.util.Optional):java.util.Optional");
    }
}
