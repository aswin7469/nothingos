...
public final class UnfoldTransitionModule {
    ...
    public final Optional<FoldStateLoggingProvider> providesFoldStateLoggingProvider(UnfoldTransitionConfig unfoldTransitionConfig, Lazy<FoldStateProvider> lazy) {
        ...
        if (unfoldTransitionConfig.isHingeAngleEnabled()) {
            ...
            Optional<FoldStateLoggingProvider> of = Optional.m1745of(new FoldStateLoggingProviderImpl(foldStateProvider, new SystemClockImpl()));
    ...
    public static final FoldStateLogger m3285providesFoldStateLogger$lambda0(FoldStateLoggingProvider foldStateLoggingProvider) {
    ...
    public static final NaturalRotationUnfoldProgressProvider m3283provideNaturalRotationProgressProvider$lambda1(Context context, IWindowManager iWindowManager, UnfoldTransitionProgressProvider unfoldTransitionProgressProvider) {
        Intrinsics.checkNotNullParameter(context, "$context");
        Intrinsics.checkNotNullParameter(iWindowManager, "$windowManager");
    ...
    public static final ScopedUnfoldTransitionProgressProvider m3284provideStatusBarScopedTransitionProvider$lambda2(NaturalRotationUnfoldProgressProvider naturalRotationUnfoldProgressProvider) {
