...
public class UsbConfirmActivity extends AlertActivity implements DialogInterface.OnClickListener, CompoundButton.OnCheckedChangeListener {
    ...
    public void onCreate(Bundle bundle) {
        ...
        if (!z) {
            ...
            if (usbDevice == null) {
                checkBox.setText(getString(R$string.always_use_accessory, new Object[]{charSequence, this.mAccessory.getDescription()}));
            } else {
                checkBox.setText(getString(R$string.always_use_device, new Object[]{charSequence, usbDevice.getProductName()}));
            }
            this.mAlwaysUse.setOnCheckedChangeListener(this);
            TextView textView = (TextView) alertParams.mView.findViewById(16908850);
