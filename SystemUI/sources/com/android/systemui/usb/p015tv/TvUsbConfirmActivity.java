...
public class TvUsbConfirmActivity extends TvUsbDialogActivity {
    ...
    public void onResume() {
        ...
        if (this.mDialogHelper.isUsbDevice()) {
            i = this.mDialogHelper.deviceHasAudioCapture() && !this.mDialogHelper.packageHasAudioRecordingPermission() ? C1894R.string.usb_device_confirm_prompt_warn : C1894R.string.usb_device_confirm_prompt;
        } else {
            i = C1894R.string.usb_accessory_confirm_prompt;
        }
