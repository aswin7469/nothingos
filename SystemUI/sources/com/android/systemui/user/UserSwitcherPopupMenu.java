...
public final class UserSwitcherPopupMenu extends ListPopupWindow {
    ...
    public UserSwitcherPopupMenu(Context context2, FalsingManager falsingManager2) {
        ...
        this.res = resources;
        setBackgroundDrawable(resources.getDrawable(C1894R.C1896drawable.bouncer_user_switcher_popup_bg, context2.getTheme()));
        setModal(false);
    ...
    public void show() {
        ...
        listView.setDividerHeight(this.res.getDimensionPixelSize(C1894R.dimen.bouncer_user_switcher_popup_divider_height));
        int dimensionPixelSize = this.res.getDimensionPixelSize(C1894R.dimen.bouncer_user_switcher_popup_header_height);
