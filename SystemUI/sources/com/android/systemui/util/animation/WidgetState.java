...
public final class WidgetState {
    ...
    public static /* synthetic */ WidgetState copy$default(WidgetState widgetState, float f, float f2, int i, int i2, int i3, int i4, float f3, float f4, boolean z, int i5, Object obj) {
        ...
        int i6 = i5;
        return widgetState.copy((i6 & 1) != 0 ? widgetState2.f397x : f, (i6 & 2) != 0 ? widgetState2.f398y : f2, (i6 & 4) != 0 ? widgetState2.width : i, (i6 & 8) != 0 ? widgetState2.height : i2, (i6 & 16) != 0 ? widgetState2.measureWidth : i3, (i6 & 32) != 0 ? widgetState2.measureHeight : i4, (i6 & 64) != 0 ? widgetState2.alpha : f3, (i6 & 128) != 0 ? widgetState2.scale : f4, (i6 & 256) != 0 ? widgetState2.gone : z);
    }
    ...
    public boolean equals(Object obj) {
        ...
        return Intrinsics.areEqual((Object) Float.valueOf(this.f397x), (Object) Float.valueOf(widgetState.f397x)) && Intrinsics.areEqual((Object) Float.valueOf(this.f398y), (Object) Float.valueOf(widgetState.f398y)) && this.width == widgetState.width && this.height == widgetState.height && this.measureWidth == widgetState.measureWidth && this.measureHeight == widgetState.measureHeight && Intrinsics.areEqual((Object) Float.valueOf(this.alpha), (Object) Float.valueOf(widgetState.alpha)) && Intrinsics.areEqual((Object) Float.valueOf(this.scale), (Object) Float.valueOf(widgetState.scale)) && this.gone == widgetState.gone;
    }

    public int hashCode() {
        int hashCode = ((((((((((((((Float.hashCode(this.f397x) * 31) + Float.hashCode(this.f398y)) * 31) + Integer.hashCode(this.width)) * 31) + Integer.hashCode(this.height)) * 31) + Integer.hashCode(this.measureWidth)) * 31) + Integer.hashCode(this.measureHeight)) * 31) + Float.hashCode(this.alpha)) * 31) + Float.hashCode(this.scale)) * 31;
        boolean z = this.gone;
        if (z) {
            z = true;
        }
    ...
    public String toString() {
        return "WidgetState(x=" + this.f397x + ", y=" + this.f398y + ", width=" + this.width + ", height=" + this.height + ", measureWidth=" + this.measureWidth + ", measureHeight=" + this.measureHeight + ", alpha=" + this.alpha + ", scale=" + this.scale + ", gone=" + this.gone + ')';
    }
    ...
    public final void initFromLayout(View view) {
        ...
        if (z2) {
            ...
            if (layoutParams != null) {
                ...
                this.f397x = (float) layoutParams2.getConstraintWidget().getLeft();
                this.f398y = (float) layoutParams2.getConstraintWidget().getTop();
        ...
        this.f397x = (float) view.getLeft();
        this.f398y = (float) view.getTop();
