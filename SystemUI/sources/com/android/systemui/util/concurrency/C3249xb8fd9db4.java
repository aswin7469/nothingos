...
public final class C3249xb8fd9db4 implements Factory<RepeatableExecutor> {
    private final Provider<DelayableExecutor> execProvider;

    public C3249xb8fd9db4(Provider<DelayableExecutor> provider) {
    ...
    public static C3249xb8fd9db4 create(Provider<DelayableExecutor> provider) {
        return new C3249xb8fd9db4(provider);
    }
