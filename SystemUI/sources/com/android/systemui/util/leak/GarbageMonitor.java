    ...
    private static class MemoryIconDrawable extends Drawable {
        ...
        public void draw(Canvas canvas) {
            ...
            if (j > 0) {
                ...
                float f = this.dp;
                canvas.translate(bounds.left + (f * 8.0f), bounds.top + (f * 5.0f));
                float f2 = this.dp;
    ...
    public static class MemoryTile extends QSTileImpl<QSTile.State> {
        ...
        public class AnonymousClass1 extends Thread {
            ...
            public void run() {
                ...
                final Intent dumpHprofAndGetShareIntent = MemoryTile.this.gm.dumpHprofAndGetShareIntent();
                ((QSTileImpl) MemoryTile.this).mHandler.post(new Runnable() { // from class: com.android.systemui.util.leak.GarbageMonitor$MemoryTile$1$$ExternalSyntheticLambda0
                    ...
                    public final void run() {
                        GarbageMonitor.MemoryTile.AnonymousClass1.this.lambda$run$0(dumpHprofAndGetShareIntent);
                    }
                });
            }
