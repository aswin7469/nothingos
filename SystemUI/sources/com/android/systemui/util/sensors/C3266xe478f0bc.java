...
public final class C3266xe478f0bc implements Factory<ThresholdSensor[]> {
    private final Provider<Resources> resourcesProvider;
    private final Provider<ThresholdSensorImpl.BuilderFactory> thresholdSensorImplBuilderFactoryProvider;

    public C3266xe478f0bc(Provider<ThresholdSensorImpl.BuilderFactory> provider, Provider<Resources> provider2) {
    ...
    public static C3266xe478f0bc create(Provider<ThresholdSensorImpl.BuilderFactory> provider, Provider<Resources> provider2) {
        return new C3266xe478f0bc(provider, provider2);
    }
