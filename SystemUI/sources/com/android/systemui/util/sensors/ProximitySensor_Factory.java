...
public final class ProximitySensor_Factory implements Factory<ProximitySensor> {
    ...
    /* renamed from: get */
    public ProximitySensor mo1933get() {
        return newInstance(this.primaryProvider.mo1933get(), this.secondaryProvider.mo1933get(), this.delayableExecutorProvider.mo1933get(), this.executionProvider.mo1933get());
    }
