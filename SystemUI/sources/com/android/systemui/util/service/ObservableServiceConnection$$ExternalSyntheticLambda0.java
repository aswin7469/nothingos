...
public final /* synthetic */ class ObservableServiceConnection$$ExternalSyntheticLambda0 implements Runnable {
    ...
    public /* synthetic */ ObservableServiceConnection$$ExternalSyntheticLambda0(ObservableServiceConnection observableServiceConnection, ObservableServiceConnection.Callback callback) {
        this.f$0 = observableServiceConnection;
        this.f$1 = callback;
    }

    public final void run() {
        this.f$0.mo47115xbbde41de(this.f$1);
    }
}
