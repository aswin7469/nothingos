...
public final class VolumeDialogControllerImpl_Factory implements Factory<VolumeDialogControllerImpl> {
    ...
    /* renamed from: get */
    public VolumeDialogControllerImpl mo1933get() {
        return newInstance(this.contextProvider.mo1933get(), this.broadcastDispatcherProvider.mo1933get(), this.ringerModeTrackerProvider.mo1933get(), this.theadFactoryProvider.mo1933get(), this.audioManagerProvider.mo1933get(), this.notificationManagerProvider.mo1933get(), this.optionalVibratorProvider.mo1933get(), this.iAudioServiceProvider.mo1933get(), this.accessibilityManagerProvider.mo1933get(), this.packageManagerProvider.mo1933get(), this.wakefulnessLifecycleProvider.mo1933get());
    }
