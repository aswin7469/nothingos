...
public class VolumePrefs {
    ...
    public static void unregisterCallbacks(Context context, SharedPreferences.OnSharedPreferenceChangeListener onSharedPreferenceChangeListener) {
        prefs(context).unregisterOnSharedPreferenceChangeListener(onSharedPreferenceChangeListener);
    }

    public static void registerCallbacks(Context context, SharedPreferences.OnSharedPreferenceChangeListener onSharedPreferenceChangeListener) {
        prefs(context).registerOnSharedPreferenceChangeListener(onSharedPreferenceChangeListener);
    }
