...
public class ZenModePanel extends FrameLayout {
    ...
    private final ZenModeController.Callback mZenCallback = new ZenModeController.Callback() { // from class: com.android.systemui.volume.ZenModePanel.6
    ...
    protected final SegmentedButtons.Callback mZenButtonsCallback = new SegmentedButtons.Callback() { // from class: com.android.systemui.volume.ZenModePanel.7
    ...
    private final Interaction.Callback mInteractionCallback = new Interaction.Callback() { // from class: com.android.systemui.volume.ZenModePanel.8
        @Override // com.android.systemui.volume.Interaction.Callback
        public void onInteraction() {
            ZenModePanel.this.fireInteraction();
        }
    };
    private final ZenPrefs mPrefs = new ZenPrefs();
    protected int mZenModeConditionLayoutId = R$layout.zen_mode_condition;
    protected int mZenModeButtonLayoutId = R$layout.zen_mode_button;
    ...
    protected void onFinishInflate() {
        ...
        findViewById.setOnClickListener(new View.OnClickListener() { // from class: com.android.systemui.volume.ZenModePanel$$ExternalSyntheticLambda1
            @Override // android.view.View.OnClickListener
            public final void onClick(View view) {
                ZenModePanel.this.lambda$onFinishInflate$0(view);
            }
        });
        ...
        textView.setOnClickListener(new View.OnClickListener() { // from class: com.android.systemui.volume.ZenModePanel$$ExternalSyntheticLambda0
            @Override // android.view.View.OnClickListener
            public final void onClick(View view) {
                ZenModePanel.this.lambda$onFinishInflate$1(view);
            }
        });
        ...
        View findViewById3 = findViewById(R$id.auto_rule);
    ...
    public void setEmptyState(final int i, final int i2) {
        this.mEmptyIcon.post(new Runnable() { // from class: com.android.systemui.volume.ZenModePanel$$ExternalSyntheticLambda4
            ...
            public final void run() {
                ZenModePanel.this.lambda$setEmptyState$2(i, i2);
            }
        });
    }
    ...
    public void setAutoText(final CharSequence charSequence) {
        this.mAutoTitle.post(new Runnable() { // from class: com.android.systemui.volume.ZenModePanel$$ExternalSyntheticLambda5
            @Override // java.lang.Runnable
            public final void run() {
                ZenModePanel.this.lambda$setAutoText$3(charSequence);
            }
        });
    }
    ...
    void handleUpdateManualRule(ZenModeConfig.ZenRule zenRule) {
        ...
        if (zenRule == null) {
            ...
            createCondition = condition != null ? condition : createCondition(zenRule.conditionId);
        }
    ...
    public void onClickTimeButton(View view, ConditionTag conditionTag, boolean z, int i) {
        ...
        if (i2 == -1) {
            ...
            for (int i4 = 0; i4 < length; i4++) {
                ...
                int i6 = MINUTE_BUCKETS[i5];
                long j = currentTimeMillis + (60000 * i6);
                if ((z && j > tryParseCountdownConditionId) || (!z && j < tryParseCountdownConditionId)) {
                    this.mBucketIndex = i5;
                    condition = ZenModeConfig.toTimeCondition(this.mContext, j, i6, ActivityManager.getCurrentUser(), false);
                    break;
                }
            }
            if (condition == null) {
            ...
            int max = Math.max(0, Math.min(i8, i2 + i3));
