...
public final class QuickAccessWalletController_Factory implements Factory<QuickAccessWalletController> {
    ...
    /* renamed from: get */
    public QuickAccessWalletController mo1933get() {
        return newInstance(this.contextProvider.mo1933get(), this.executorProvider.mo1933get(), this.secureSettingsProvider.mo1933get(), this.quickAccessWalletClientProvider.mo1933get(), this.clockProvider.mo1933get());
    }
