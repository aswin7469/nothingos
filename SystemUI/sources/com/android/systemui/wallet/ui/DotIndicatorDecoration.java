...
public final class DotIndicatorDecoration extends RecyclerView.ItemDecoration {
    ...
    public void onDrawOver(Canvas canvas, RecyclerView recyclerView, RecyclerView.State state) {
        ...
        canvas.translate((recyclerView.getWidth() - (((this.mDotMargin * (itemCount - 1)) + ((this.mUnselectedRadius * 2) * (itemCount - 2))) + (this.mSelectedRadius * 2))) / 2.0f, recyclerView.getHeight() - this.mDotMargin);
    ...
    private void drawUnselectedDot(Canvas canvas) {
        ...
        canvas.drawCircle(i, 0.0f, i, this.mPaint);
    ...
    private boolean isLayoutLtr() {
        WalletCardCarousel walletCardCarousel = this.mCardCarousel;
        return walletCardCarousel == null || walletCardCarousel.getLayoutDirection() == 0;
    }
}
