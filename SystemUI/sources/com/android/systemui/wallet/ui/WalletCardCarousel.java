...
public class WalletCardCarousel extends RecyclerView {
    ...
    public void setExpectedViewWidth(int i) {
        ...
        int round = Math.round(Math.min(i, Math.min(displayMetrics.widthPixels, displayMetrics.heightPixels)) * 0.69f);
        this.mCardWidthPx = round;
        this.mCardHeightPx = Math.round(round / 1.5909091f);
        int i2 = this.mCardWidthPx;
        this.mCornerRadiusPx = i2 * 0.035714287f;
        this.mCardMarginPx = Math.round(i2 * (-0.03f));
    ...
    public void onViewAdded(final View view) {
        ...
        view.addOnLayoutChangeListener(new View.OnLayoutChangeListener() { // from class: com.android.systemui.wallet.ui.WalletCardCarousel$$ExternalSyntheticLambda0
            ...
            public final void onLayoutChange(View view2, int i2, int i3, int i4, int i5, int i6, int i7, int i8, int i9) {
                WalletCardCarousel.this.lambda$onViewAdded$0(view, view2, i2, i3, i4, i5, i6, i7, i8, i9);
            }
        });
    }
    ...
    private class CarouselSnapHelper extends PagerSnapHelper {
        ...
        public LinearSmoothScroller mo1503createScroller(final RecyclerView.LayoutManager layoutManager) {
    ...
    public class WalletCardCarouselAdapter extends RecyclerView.Adapter<WalletCardViewHolder> {
        ...
        public WalletCardViewHolder mo1838onCreateViewHolder(ViewGroup viewGroup, int i) {
        ...
        public void onBindViewHolder(WalletCardViewHolder walletCardViewHolder, final int i) {
            ...
            walletCardViewHolder.mCardView.setOnClickListener(new View.OnClickListener() { // from class: com.android.systemui.wallet.ui.WalletCardCarousel$WalletCardCarouselAdapter$$ExternalSyntheticLambda0
                @Override // android.view.View.OnClickListener
                public final void onClick(View view) {
                    WalletCardCarousel.WalletCardCarouselAdapter.this.lambda$onBindViewHolder$0(i, walletCardViewInfo, view);
                }
            });
        }
