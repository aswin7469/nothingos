...
public final class TvPipModule_ProvidePipFactory implements Factory<Optional<Pip>> {
    ...
    public Optional<Pip> mo1933get() {
        return providePip(this.contextProvider.mo1933get(), this.pipBoundsStateProvider.mo1933get(), this.pipBoundsAlgorithmProvider.mo1933get(), this.pipTaskOrganizerProvider.mo1933get(), this.tvPipMenuControllerProvider.mo1933get(), this.pipMediaControllerProvider.mo1933get(), this.pipTransitionControllerProvider.mo1933get(), this.tvPipNotificationControllerProvider.mo1933get(), this.taskStackListenerProvider.mo1933get(), this.windowManagerShellWrapperProvider.mo1933get(), this.mainExecutorProvider.mo1933get());
    }
