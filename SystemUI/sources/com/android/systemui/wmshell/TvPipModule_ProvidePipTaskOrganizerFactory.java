...
public final class TvPipModule_ProvidePipTaskOrganizerFactory implements Factory<PipTaskOrganizer> {
    ...
    /* renamed from: get */
    public PipTaskOrganizer mo1933get() {
        return providePipTaskOrganizer(this.contextProvider.mo1933get(), this.tvPipMenuControllerProvider.mo1933get(), this.syncTransactionQueueProvider.mo1933get(), this.pipBoundsStateProvider.mo1933get(), this.pipBoundsAlgorithmProvider.mo1933get(), this.pipAnimationControllerProvider.mo1933get(), this.pipTransitionControllerProvider.mo1933get(), this.pipSurfaceTransactionHelperProvider.mo1933get(), this.splitScreenOptionalProvider.mo1933get(), this.displayControllerProvider.mo1933get(), this.pipUiEventLoggerProvider.mo1933get(), this.shellTaskOrganizerProvider.mo1933get(), this.mainExecutorProvider.mo1933get());
    }
