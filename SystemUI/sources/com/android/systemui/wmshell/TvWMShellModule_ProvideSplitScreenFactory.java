...
public final class TvWMShellModule_ProvideSplitScreenFactory implements Factory<LegacySplitScreenController> {
    ...
    /* renamed from: get */
    public LegacySplitScreenController mo1933get() {
        return provideSplitScreen(this.contextProvider.mo1933get(), this.displayControllerProvider.mo1933get(), this.systemWindowsProvider.mo1933get(), this.displayImeControllerProvider.mo1933get(), this.transactionPoolProvider.mo1933get(), this.shellTaskOrganizerProvider.mo1933get(), this.syncQueueProvider.mo1933get(), this.taskStackListenerProvider.mo1933get(), this.transitionsProvider.mo1933get(), this.mainExecutorProvider.mo1933get(), this.sfVsyncAnimationHandlerProvider.mo1933get());
    }

    public static TvWMShellModule_ProvideSplitScreenFactory create(Provider<Context> provider, Provider<DisplayController> provider2, Provider<SystemWindows> provider3, Provider<DisplayImeController> provider4, Provider<TransactionPool> provider5, Provider<ShellTaskOrganizer> provider6, Provider<SyncTransactionQueue> provider7, Provider<TaskStackListenerImpl> provider8, Provider<Transitions> provider9, Provider<ShellExecutor> provider10, Provider<AnimationHandler> provider11) {
        return new TvWMShellModule_ProvideSplitScreenFactory(provider, provider2, provider3, provider4, provider5, provider6, provider7, provider8, provider9, provider10, provider11);
    }
    ...
    public static LegacySplitScreenController provideSplitScreen(Context context, DisplayController displayController, SystemWindows systemWindows, DisplayImeController displayImeController, TransactionPool transactionPool, ShellTaskOrganizer shellTaskOrganizer, SyncTransactionQueue syncTransactionQueue, TaskStackListenerImpl taskStackListenerImpl, Transitions transitions, ShellExecutor shellExecutor, AnimationHandler animationHandler) {
        return (LegacySplitScreenController) Preconditions.checkNotNullFromProvides(TvWMShellModule.provideSplitScreen(context, displayController, systemWindows, displayImeController, transactionPool, shellTaskOrganizer, syncTransactionQueue, taskStackListenerImpl, transitions, shellExecutor, animationHandler));
    }
}
