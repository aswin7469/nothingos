...
public final class WMShellBaseModule_ProvideBubbleControllerFactory implements Factory<Optional<BubbleController>> {
    ...
    public Optional<BubbleController> mo1933get() {
        return provideBubbleController(this.contextProvider.mo1933get(), this.floatingContentCoordinatorProvider.mo1933get(), this.statusBarServiceProvider.mo1933get(), this.windowManagerProvider.mo1933get(), this.windowManagerShellWrapperProvider.mo1933get(), this.launcherAppsProvider.mo1933get(), this.taskStackListenerProvider.mo1933get(), this.uiEventLoggerProvider.mo1933get(), this.organizerProvider.mo1933get(), this.displayControllerProvider.mo1933get(), this.mainExecutorProvider.mo1933get(), this.mainHandlerProvider.mo1933get());
    }
