...
public final class WMShellBaseModule_ProvideOneHandedControllerFactory implements Factory<Optional<OneHandedController>> {
    ...
    public Optional<OneHandedController> mo1933get() {
        return provideOneHandedController(this.contextProvider.mo1933get(), this.windowManagerProvider.mo1933get(), this.displayControllerProvider.mo1933get(), this.displayLayoutProvider.mo1933get(), this.taskStackListenerProvider.mo1933get(), this.uiEventLoggerProvider.mo1933get(), this.mainExecutorProvider.mo1933get(), this.mainHandlerProvider.mo1933get());
    }
