...
public final class WMShellBaseModule_ProvideShellCommandHandlerImplFactory implements Factory<ShellCommandHandlerImpl> {
    ...
    /* renamed from: get */
    public ShellCommandHandlerImpl mo1933get() {
        return provideShellCommandHandlerImpl(this.shellTaskOrganizerProvider.mo1933get(), this.legacySplitScreenOptionalProvider.mo1933get(), this.splitScreenOptionalProvider.mo1933get(), this.pipOptionalProvider.mo1933get(), this.oneHandedOptionalProvider.mo1933get(), this.hideDisplayCutoutProvider.mo1933get(), this.appPairsOptionalProvider.mo1933get(), this.mainExecutorProvider.mo1933get());
    }
