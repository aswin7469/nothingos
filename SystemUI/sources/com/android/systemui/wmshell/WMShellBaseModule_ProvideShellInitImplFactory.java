...
public final class WMShellBaseModule_ProvideShellInitImplFactory implements Factory<ShellInitImpl> {
    ...
    /* renamed from: get */
    public ShellInitImpl mo1933get() {
        return provideShellInitImpl(this.displayImeControllerProvider.mo1933get(), this.dragAndDropControllerProvider.mo1933get(), this.shellTaskOrganizerProvider.mo1933get(), this.bubblesOptionalProvider.mo1933get(), this.legacySplitScreenOptionalProvider.mo1933get(), this.splitScreenOptionalProvider.mo1933get(), this.appPairsOptionalProvider.mo1933get(), this.pipTouchHandlerOptionalProvider.mo1933get(), this.fullscreenTaskListenerProvider.mo1933get(), this.transitionsProvider.mo1933get(), this.startingWindowProvider.mo1933get(), this.mainExecutorProvider.mo1933get());
    }
