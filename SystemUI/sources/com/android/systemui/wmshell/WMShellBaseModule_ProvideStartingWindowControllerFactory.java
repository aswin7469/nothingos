...
public final class WMShellBaseModule_ProvideStartingWindowControllerFactory implements Factory<StartingWindowController> {
    ...
    /* renamed from: get */
    public StartingWindowController mo1933get() {
        return provideStartingWindowController(this.contextProvider.mo1933get(), this.splashScreenExecutorProvider.mo1933get(), this.startingWindowTypeAlgorithmProvider.mo1933get(), this.poolProvider.mo1933get());
    }
