...
public final class WMShellBaseModule_ProvideTaskSurfaceHelperControllerFactory implements Factory<Optional<TaskSurfaceHelperController>> {
    ...
    public Optional<TaskSurfaceHelperController> mo1933get() {
        return provideTaskSurfaceHelperController(this.taskOrganizerProvider.mo1933get(), this.mainExecutorProvider.mo1933get());
    }
