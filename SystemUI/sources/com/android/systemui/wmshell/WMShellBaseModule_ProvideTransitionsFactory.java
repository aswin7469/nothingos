...
public final class WMShellBaseModule_ProvideTransitionsFactory implements Factory<Transitions> {
    ...
    /* renamed from: get */
    public Transitions mo1933get() {
        return provideTransitions(this.organizerProvider.mo1933get(), this.poolProvider.mo1933get(), this.contextProvider.mo1933get(), this.mainExecutorProvider.mo1933get(), this.animExecutorProvider.mo1933get());
    }
