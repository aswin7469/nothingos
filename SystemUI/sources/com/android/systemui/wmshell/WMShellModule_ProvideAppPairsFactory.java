...
public final class WMShellModule_ProvideAppPairsFactory implements Factory<AppPairsController> {
    ...
    /* renamed from: get */
    public AppPairsController mo1933get() {
        return provideAppPairs(this.shellTaskOrganizerProvider.mo1933get(), this.syncQueueProvider.mo1933get(), this.displayControllerProvider.mo1933get(), this.mainExecutorProvider.mo1933get(), this.displayImeControllerProvider.mo1933get());
    }
