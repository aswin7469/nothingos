...
public final class WMShellModule_ProvideDisplayImeControllerFactory implements Factory<DisplayImeController> {
    ...
    /* renamed from: get */
    public DisplayImeController mo1933get() {
        return provideDisplayImeController(this.wmServiceProvider.mo1933get(), this.displayControllerProvider.mo1933get(), this.mainExecutorProvider.mo1933get(), this.transactionPoolProvider.mo1933get());
    }
