...
public final class WMShellModule_ProvidePipMotionHelperFactory implements Factory<PipMotionHelper> {
    ...
    /* renamed from: get */
    public PipMotionHelper mo1933get() {
        return providePipMotionHelper(this.contextProvider.mo1933get(), this.pipBoundsStateProvider.mo1933get(), this.pipTaskOrganizerProvider.mo1933get(), this.menuControllerProvider.mo1933get(), this.pipSnapAlgorithmProvider.mo1933get(), this.pipTransitionControllerProvider.mo1933get(), this.floatingContentCoordinatorProvider.mo1933get());
    }
