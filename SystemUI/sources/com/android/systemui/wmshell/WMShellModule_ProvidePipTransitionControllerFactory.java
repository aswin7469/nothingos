...
public final class WMShellModule_ProvidePipTransitionControllerFactory implements Factory<PipTransitionController> {
    ...
    public PipTransitionController mo1933get() {
        return providePipTransitionController(this.contextProvider.mo1933get(), this.transitionsProvider.mo1933get(), this.shellTaskOrganizerProvider.mo1933get(), this.pipAnimationControllerProvider.mo1933get(), this.pipBoundsAlgorithmProvider.mo1933get(), this.pipBoundsStateProvider.mo1933get(), this.pipMenuControllerProvider.mo1933get());
    }
