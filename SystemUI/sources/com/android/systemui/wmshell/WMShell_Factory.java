...
public final class WMShell_Factory implements Factory<WMShell> {
    ...
    /* renamed from: get */
    public WMShell mo1933get() {
        return newInstance(this.contextProvider.mo1933get(), this.pipOptionalProvider.mo1933get(), this.splitScreenOptionalProvider.mo1933get(), this.oneHandedOptionalProvider.mo1933get(), this.hideDisplayCutoutOptionalProvider.mo1933get(), this.shellCommandHandlerProvider.mo1933get(), this.commandQueueProvider.mo1933get(), this.configurationControllerProvider.mo1933get(), this.keyguardUpdateMonitorProvider.mo1933get(), this.navigationModeControllerProvider.mo1933get(), this.screenLifecycleProvider.mo1933get(), this.sysUiStateProvider.mo1933get(), this.protoTracerProvider.mo1933get(), this.wakefulnessLifecycleProvider.mo1933get(), this.sysUiMainExecutorProvider.mo1933get());
    }
