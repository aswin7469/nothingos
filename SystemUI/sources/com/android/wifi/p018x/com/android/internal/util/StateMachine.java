...
/* renamed from: com.android.wifi.x.com.android.internal.util.StateMachine */
public class StateMachine {
    ...
    /* renamed from: com.android.wifi.x.com.android.internal.util.StateMachine$LogRec */
    ...
    /* renamed from: com.android.wifi.x.com.android.internal.util.StateMachine$LogRecords */
    ...
    /* renamed from: com.android.wifi.x.com.android.internal.util.StateMachine$SmHandler */
    private static class SmHandler extends Handler {
        ...
        /* renamed from: com.android.wifi.x.com.android.internal.util.StateMachine$SmHandler$StateInfo */
        ...
        /* renamed from: com.android.wifi.x.com.android.internal.util.StateMachine$SmHandler$HaltingState */
        ...
        /* renamed from: com.android.wifi.x.com.android.internal.util.StateMachine$SmHandler$QuittingState */
        ...
        public void removeState(State state) {
            StateInfo stateInfo = this.mStateInfo.get(state);
            if (stateInfo != null && !stateInfo.active && !this.mStateInfo.values().stream().filter(new StateMachine$SmHandler$$ExternalSyntheticLambda0(stateInfo)).findAny().isPresent()) {
        ...
        public final void transitionTo(IState iState) {
            if (this.mTransitionInProgress) {
                String r0 = this.mSm.mName;
                Log.wtf(r0, "transitionTo called while transition already in progress to " + this.mDestState + ", new target state=" + iState);
            }
    ...
    public void dump(FileDescriptor fileDescriptor, PrintWriter printWriter, String[] strArr) {
        ...
        sb2.append(currentState == null ? "<QUIT>" : currentState.getName());
