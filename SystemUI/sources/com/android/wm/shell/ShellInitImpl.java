...
public class ShellInitImpl {
    ...
    public class InitImpl implements ShellInit {
        ...
        public void init() {
            try {
                ShellInitImpl.this.mMainExecutor.executeBlocking(new Runnable() { // from class: com.android.wm.shell.ShellInitImpl$InitImpl$$ExternalSyntheticLambda0
                    @Override // java.lang.Runnable
                    public final void run() {
                        ShellInitImpl.InitImpl.this.lambda$init$0();
                    }
                });
