...
public class TaskView extends SurfaceView implements SurfaceHolder.Callback, ShellTaskOrganizer.TaskListener, ViewTreeObserver.OnComputeInternalInsetsListener {
    ...
    private void prepareActivityOptions(ActivityOptions activityOptions, Rect rect) {
        ...
        this.mShellExecutor.execute(new Runnable() { // from class: com.android.wm.shell.TaskView$$ExternalSyntheticLambda9
    ...
    private void updateTaskVisibility() {
        ...
        if (this.mListener != null) {
            ...
            this.mListenerExecutor.execute(new Runnable() { // from class: com.android.wm.shell.TaskView$$ExternalSyntheticLambda6
                @Override // java.lang.Runnable
                public final void run() {
    ...
    public void onTaskAppeared(ActivityManager.RunningTaskInfo runningTaskInfo, SurfaceControl surfaceControl) {
        ...
        if (this.mListener != null) {
            ...
            this.mListenerExecutor.execute(new Runnable() { // from class: com.android.wm.shell.TaskView$$ExternalSyntheticLambda8
                @Override // java.lang.Runnable
                public final void run() {
                    TaskView.this.lambda$onTaskAppeared$4(i, componentName);
                }
            });
        }
    }
    ...
    public void onTaskVanished(ActivityManager.RunningTaskInfo runningTaskInfo) {
        ...
        if (this.mListener != null) {
            final int i = runningTaskInfo.taskId;
            this.mListenerExecutor.execute(new Runnable() { // from class: com.android.wm.shell.TaskView$$ExternalSyntheticLambda7
                @Override // java.lang.Runnable
                public final void run() {
                    TaskView.this.lambda$onTaskVanished$5(i);
                }
            });
        }
    ...
    public void onBackPressedOnTaskRoot(ActivityManager.RunningTaskInfo runningTaskInfo) {
        ...
        final int i = runningTaskInfo.taskId;
        this.mListenerExecutor.execute(new Runnable() { // from class: com.android.wm.shell.TaskView$$ExternalSyntheticLambda5
            @Override // java.lang.Runnable
            public final void run() {
                TaskView.this.lambda$onBackPressedOnTaskRoot$6(i);
            }
        });
    }
