...
public class AppPairsController {
    ...
    public void unpair(int i, boolean z) {
        ...
        if (appPair == null) {
            ...
            ShellProtoLogImpl.v(ShellProtoLogGroup.WM_SHELL_TASK_ORG, 950299522, 1, null, Long.valueOf(i));
            return;
        }
        if (ShellProtoLogCache.WM_SHELL_TASK_ORG_enabled) {
            ShellProtoLogImpl.v(ShellProtoLogGroup.WM_SHELL_TASK_ORG, -234284913, 1, null, Long.valueOf(i), String.valueOf(appPair));
        }
