...
public class BubblePositioner {
    ...
    public int[] getExpandedViewPadding(boolean z, boolean z2) {
        ...
        if (showBubblesVertically()) {
            if (!z) {
                i4 = (int) (i4 + (this.mBubbleSize - this.mPointerHeight));
                i3 += z3 ? (this.mPositionRect.width() - i4) - this.mExpandedViewLargeScreenWidth : 0;
            } else {
                i3 = (int) (i3 + (this.mBubbleSize - this.mPointerHeight));
    ...
    public PointF getDefaultStartPosition() {
        ...
        return new BubbleStackView.RelativeStackPosition(z, this.mContext.getResources().getDimensionPixelOffset(R.dimen.bubble_stack_starting_offset_y) / this.mPositionRect.height()).getAbsolutePositionInRegion(new RectF(this.mPositionRect));
    }
