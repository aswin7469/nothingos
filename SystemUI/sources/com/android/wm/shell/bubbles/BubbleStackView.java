...
public class BubbleStackView extends FrameLayout implements ViewTreeObserver.OnComputeInternalInsetsListener {
    ...
    private final MagnetizedObject.MagnetListener mIndividualBubbleMagnetListener = new AnonymousClass4();
    private final MagnetizedObject.MagnetListener mStackMagnetListener = new AnonymousClass5();
    ...
    private RelativeTouchListener mBubbleTouchListener = new RelativeTouchListener() { // from class: com.android.wm.shell.bubbles.BubbleStackView.7
        ...
        public void onMove(View view, MotionEvent motionEvent, float f, float f2, float f3, float f4) {
            if (!BubbleStackView.this.mIsExpansionAnimating) {
                ...
                if (BubbleStackView.this.mIsExpanded && BubbleStackView.this.mExpandedBubble != null && view.equals(BubbleStackView.this.mExpandedBubble.mo1645getIconView())) {
    ...
    class AnonymousClass4 implements MagnetizedObject.MagnetListener {
        ...
        public void onReleasedInTarget(MagnetizedObject.MagneticTarget magneticTarget) {
            ...
            BubbleStackView.this.mExpandedAnimationController.dismissDraggedOutBubble(BubbleStackView.this.mExpandedAnimationController.getDraggedOutBubble(), BubbleStackView.this.mDismissView.getHeight(), new Runnable() { // from class: com.android.wm.shell.bubbles.BubbleStackView$4$$ExternalSyntheticLambda0
                @Override // java.lang.Runnable
                public final void run() {
                    BubbleStackView.access$700(BubbleStackView.this);
                }
            });
            BubbleStackView.this.mDismissView.hide();
        }
    ...
    public class AnonymousClass5 implements MagnetizedObject.MagnetListener {
        ...
        @Override // com.android.wm.shell.common.magnetictarget.MagnetizedObject.MagnetListener
        public void onReleasedInTarget(MagnetizedObject.MagneticTarget magneticTarget) {
            BubbleStackView.this.mStackAnimationController.animateStackDismissal(BubbleStackView.this.mDismissView.getHeight(), new Runnable() { // from class: com.android.wm.shell.bubbles.BubbleStackView$5$$ExternalSyntheticLambda0
                @Override // java.lang.Runnable
                public final void run() {
                    BubbleStackView.AnonymousClass5.this.lambda$onReleasedInTarget$0();
                }
            });
            BubbleStackView.this.mDismissView.hide();
        }
    ...
    public BubbleStackView(Context context, BubbleController bubbleController, BubbleData bubbleData, SurfaceSynchronizer surfaceSynchronizer, FloatingContentCoordinator floatingContentCoordinator, ShellExecutor shellExecutor) {
        ...
        FloatPropertyCompat floatPropertyCompat = new FloatPropertyCompat("FlyoutCollapseSpring") { // from class: com.android.wm.shell.bubbles.BubbleStackView.3
        ...
        DynamicAnimation.OnAnimationEndListener onAnimationEndListener = new DynamicAnimation.OnAnimationEndListener() { // from class: com.android.wm.shell.bubbles.BubbleStackView$$ExternalSyntheticLambda11
        ...
        Runnable runnable = new Runnable() { // from class: com.android.wm.shell.bubbles.BubbleStackView$$ExternalSyntheticLambda31
            @Override // java.lang.Runnable
            public final void run() {
        ...
        }, runnable, new Runnable() { // from class: com.android.wm.shell.bubbles.BubbleStackView$$ExternalSyntheticLambda28
            @Override // java.lang.Runnable
            public final void run() {
                BubbleStackView.this.animateShadows();
            }
        }, this.mPositioner);
        this.mExpandedAnimationController = new ExpandedAnimationController(this.mPositioner, this.mExpandedViewPadding, runnable);
        ...
        this.mBubbleContainer.addView(overflow.mo1645getIconView(), this.mBubbleContainer.getChildCount(), new FrameLayout.LayoutParams(this.mPositioner.getBubbleSize(), this.mPositioner.getBubbleSize()));
        updateOverflow();
        this.mBubbleOverflow.mo1645getIconView().setOnClickListener(new View.OnClickListener() { // from class: com.android.wm.shell.bubbles.BubbleStackView$$ExternalSyntheticLambda8
            @Override // android.view.View.OnClickListener
        ...
        ofFloat3.addUpdateListener(new ValueAnimator.AnimatorUpdateListener() { // from class: com.android.wm.shell.bubbles.BubbleStackView$$ExternalSyntheticLambda2
            @Override // android.animation.ValueAnimator.AnimatorUpdateListener
            public final void onAnimationUpdate(ValueAnimator valueAnimator) {
                BubbleStackView.this.lambda$new$6(dimensionPixelSize2, valueAnimator);
            }
        });
    ...
    public /* synthetic */ void lambda$new$6(float f, ValueAnimator valueAnimator) {
        ...
        if (dismissView != null) {
            ...
            dismissView2.setPivotY((dismissView2.getBottom() - this.mDismissView.getTop()) / 2.0f);
    ...
    private void updateOverflow() {
        ...
        this.mBubbleContainer.reorderView(this.mBubbleOverflow.mo1645getIconView(), this.mBubbleContainer.getChildCount() - 1);
        updateOverflowVisibility();
    }
    ...
    public void onDisplaySizeChanged() {
        ...
        for (Bubble bubble : this.mBubbleData.getBubbles()) {
            if (bubble.mo1645getIconView() == null) {
                Log.d("Bubbles", "Display size changed. Icon null: " + bubble);
            } else {
                BadgedImageView mo1645getIconView = bubble.mo1645getIconView();
                int i = this.mBubbleSize;
                mo1645getIconView.setLayoutParams(new FrameLayout.LayoutParams(i, i));
                if (bubble.getExpandedView() != null) {
                    bubble.getExpandedView().updateDimensions();
                }
            }
        }
        BadgedImageView mo1645getIconView2 = this.mBubbleOverflow.mo1645getIconView();
        int i2 = this.mBubbleSize;
        mo1645getIconView2.setLayoutParams(new FrameLayout.LayoutParams(i2, i2));
        this.mExpandedAnimationController.updateResources();
        this.mStackAnimationController.updateResources();
    ...
    void updateExpandedViewDirection(final int i) {
        ...
        bubbles.forEach(new Consumer() { // from class: com.android.wm.shell.bubbles.BubbleStackView$$ExternalSyntheticLambda42
            @Override // java.util.function.Consumer
            public final void accept(Object obj) {
                BubbleStackView.lambda$updateExpandedViewDirection$15(i, (Bubble) obj);
            }
        });
    }
        ...
        for (int i = 0; i < this.mBubbleData.getBubbles().size(); i++) {
            ...
            if (bubble.mo1645getIconView() != null) {
                if (this.mIsExpanded || i > 0) {
                    bubble.mo1645getIconView().setContentDescription(getResources().getString(R.string.bubble_content_description_single, title, appName));
                } else {
                    bubble.mo1645getIconView().setContentDescription(getResources().getString(R.string.bubble_content_description_stack, title, appName, Integer.valueOf(this.mBubbleContainer.getChildCount() - 1)));
                }
            }
        }
    }
    ...
    public void addBubble(Bubble bubble) {
        ...
        this.mBubbleContainer.addView(bubble.mo1645getIconView(), 0, new FrameLayout.LayoutParams(this.mPositioner.getBubbleSize(), this.mPositioner.getBubbleSize()));
        if (getBubbleCount() == 0) {
            this.mStackOnLeftOrWillBe = this.mStackAnimationController.isStackOnLeftSide();
        }
        bubble.mo1645getIconView().setDotBadgeOnLeft(!this.mStackOnLeftOrWillBe);
        bubble.mo1645getIconView().setOnClickListener(this.mBubbleClickListener);
        bubble.mo1645getIconView().setOnTouchListener(this.mBubbleTouchListener);
    ...
    public void updateBubbleOrder(final List<Bubble> list) {
        Runnable runnable = new Runnable() { // from class: com.android.wm.shell.bubbles.BubbleStackView$$ExternalSyntheticLambda37
            @Override // java.lang.Runnable
            public final void run() {
                BubbleStackView.this.lambda$updateBubbleOrder$16(list);
            }
        };
        if (this.mIsExpanded || isExpansionAnimating()) {
            ...
            this.mStackAnimationController.animateReorder((List) list.stream().map(BubbleStackView$$ExternalSyntheticLambda45.INSTANCE).collect(Collectors.toList()), runnable);
        }
        updatePointerPosition();
    }
    ...
    public /* synthetic */ void lambda$updateBubbleOrder$16(List list) {
        for (int i = 0; i < list.size(); i++) {
            this.mBubbleContainer.reorderView(((Bubble) list.get(i)).mo1645getIconView(), i);
        }
    }
    ...
    public void setSelectedBubble(final BubbleViewProvider bubbleViewProvider) {
        ...
        if (bubbleViewProvider == null) {
            ...
            if (this.mIsExpanded && (bubbleViewProvider2 = this.mExpandedBubble) != null && bubbleViewProvider2.getExpandedView() != null && !this.mExpandedViewTemporarilyHidden) {
                ...
                try {
                    screenshotAnimatingOutBubbleIntoSurface(new Consumer() { // from class: com.android.wm.shell.bubbles.BubbleStackView$$ExternalSyntheticLambda43
                        @Override // java.util.function.Consumer
                        public final void accept(Object obj) {
                            BubbleStackView.this.lambda$setSelectedBubble$18(bubbleViewProvider, (Boolean) obj);
                        }
                    });
                    return;
                } catch (Exception e) {
    ...
    private void showNewlySelectedBubble(final BubbleViewProvider bubbleViewProvider) {
        ...
        if (this.mIsExpanded) {
            ...
            this.mSurfaceSynchronizer.syncSurfaceAndRun(new Runnable() { // from class: com.android.wm.shell.bubbles.BubbleStackView$$ExternalSyntheticLambda36
                @Override // java.lang.Runnable
                public final void run() {
                    BubbleStackView.this.lambda$showNewlySelectedBubble$19(bubbleViewProvider2, bubbleViewProvider);
                }
            });
        }
    }
    ...
    public void setBubbleVisibility(Bubble bubble, boolean z) {
        if (bubble.mo1645getIconView() != null) {
            bubble.mo1645getIconView().setVisibility(z ? 0 : 8);
        }
    }
    ...
    private void animateExpansion() {
        ...
        if (this.mPositioner.showingInTaskbar() && this.mPositioner.getTaskbarPosition() != 2) {
            ...
            this.mTaskbarScrim.setTranslationX(this.mStackOnLeftOrWillBe ? 0.0f : this.mPositioner.getAvailableRect().right - this.mPositioner.getTaskbarSize());
        ...
        if (bubbleViewProvider != null && "Overflow".equals(bubbleViewProvider.getKey())) {
            bubbleIndex = this.mBubbleData.getBubbles().size();
        } else {
            bubbleIndex = getBubbleIndex(this.mExpandedBubble);
        }
        final float bubbleXOrYForOrientation = this.mExpandedAnimationController.getBubbleXOrYForOrientation(bubbleIndex);
        ...
        long j = 0;
        if (getWidth() > 0) {
            j = ((abs / getWidth()) * 30.0f) + 210.00002f;
        }
        if (showBubblesVertically) {
            float f2 = (this.mBubbleSize / 2.0f) + bubbleXOrYForOrientation;
            if (this.mStackOnLeftOrWillBe) {
                i = this.mPositioner.getAvailableRect().left + this.mBubbleSize + this.mExpandedViewPadding;
            } else {
                i = (this.mPositioner.getAvailableRect().right - this.mBubbleSize) - this.mExpandedViewPadding;
            }
            this.mExpandedViewContainerMatrix.setScale(0.9f, 0.9f, i, f2);
        } else {
            this.mExpandedViewContainerMatrix.setScale(0.9f, 0.9f, (this.mBubbleSize / 2.0f) + bubbleXOrYForOrientation, this.mPositioner.getExpandedViewY());
        }
        this.mExpandedViewContainer.setAnimationMatrix(this.mExpandedViewContainerMatrix);
        ...
        Runnable runnable = new Runnable() { // from class: com.android.wm.shell.bubbles.BubbleStackView$$ExternalSyntheticLambda40
            @Override // java.lang.Runnable
            public final void run() {
                BubbleStackView.this.lambda$animateExpansion$25(showBubblesVertically, bubbleXOrYForOrientation);
            }
        };
        this.mDelayedAnimation = runnable;
        this.mDelayedAnimationExecutor.executeDelayed(runnable, j);
    }
    ...
    /* JADX INFO: Access modifiers changed from: private */
    public /* synthetic */ void lambda$animateExpansion$25(final boolean z, final float f) {
        this.mExpandedViewAlphaAnimator.start();
        ...
        PhysicsAnimator.getInstance(this.mExpandedViewContainerMatrix).spring(AnimatableScaleMatrix.SCALE_X, AnimatableScaleMatrix.getAnimatableValueForScaleFactor(1.0f), this.mScaleInSpringConfig).spring(AnimatableScaleMatrix.SCALE_Y, AnimatableScaleMatrix.getAnimatableValueForScaleFactor(1.0f), this.mScaleInSpringConfig).addUpdateListener(new PhysicsAnimator.UpdateListener() { // from class: com.android.wm.shell.bubbles.BubbleStackView$$ExternalSyntheticLambda16
            @Override // com.android.wm.shell.animation.PhysicsAnimator.UpdateListener
            public final void onAnimationUpdateForProperty(Object obj, ArrayMap arrayMap) {
                BubbleStackView.this.lambda$animateExpansion$23(z, f, (AnimatableScaleMatrix) obj, arrayMap);
            }
    ...
    public /* synthetic */ void lambda$animateExpansion$23(boolean z, float f, AnimatableScaleMatrix animatableScaleMatrix, ArrayMap arrayMap) {
        float translationX;
        BubbleViewProvider bubbleViewProvider = this.mExpandedBubble;
        if (bubbleViewProvider == null || bubbleViewProvider.mo1645getIconView() == null) {
            return;
        }
        if (z) {
            translationX = this.mExpandedBubble.mo1645getIconView().getTranslationY();
        } else {
            translationX = this.mExpandedBubble.mo1645getIconView().getTranslationX();
        }
        this.mExpandedViewContainerMatrix.postTranslate(translationX - f, 0.0f);
        this.mExpandedViewContainer.setAnimationMatrix(this.mExpandedViewContainerMatrix);
    }
    ...
    private void animateCollapse() {
        ...
        BubbleViewProvider bubbleViewProvider = this.mExpandedBubble;
        if (bubbleViewProvider != null && "Overflow".equals(bubbleViewProvider.getKey())) {
            indexOf = this.mBubbleData.getBubbles().size();
        } else {
            indexOf = this.mBubbleData.getBubbles().indexOf(this.mExpandedBubble);
        }
        float bubbleXOrYForOrientation = this.mExpandedAnimationController.getBubbleXOrYForOrientation(indexOf);
        this.mPositioner.showBubblesVertically();
        if (this.mPositioner.showBubblesVertically()) {
            float f = bubbleXOrYForOrientation + (this.mBubbleSize / 2.0f);
            if (this.mStackOnLeftOrWillBe) {
                i = this.mPositioner.getAvailableRect().left + this.mBubbleSize + this.mExpandedViewPadding;
            } else {
                i = (this.mPositioner.getAvailableRect().right - this.mBubbleSize) - this.mExpandedViewPadding;
            }
            this.mExpandedViewContainerMatrix.setScale(1.0f, 1.0f, i, f);
        } else {
            this.mExpandedViewContainerMatrix.setScale(1.0f, 1.0f, bubbleXOrYForOrientation + (this.mBubbleSize / 2.0f), this.mPositioner.getExpandedViewY());
        }
        this.mExpandedViewAlphaAnimator.reverse();
        if (this.mExpandedBubble.getExpandedView() != null) {
    ...
    public void animateSwitchBubbles() {
        ...
        if (this.mPositioner.showBubblesVertically()) {
            if (this.mStackAnimationController.isStackOnLeftSide()) {
                translationX = this.mAnimatingOutSurfaceContainer.getTranslationX() + (this.mBubbleSize * 2);
            } else {
                translationX = this.mAnimatingOutSurfaceContainer.getTranslationX();
            }
            PhysicsAnimator.getInstance(this.mAnimatingOutSurfaceContainer).spring(DynamicAnimation.TRANSLATION_X, translationX, this.mTranslateSpringConfig).start();
        } else {
        ...
        if (z) {
            indexOf = getBubbleCount();
        } else {
            indexOf = this.mBubbleData.getBubbles().indexOf(this.mExpandedBubble);
        }
        float bubbleXOrYForOrientation = expandedAnimationController.getBubbleXOrYForOrientation(indexOf);
        this.mExpandedViewContainer.setAlpha(1.0f);
        ...
        if (this.mPositioner.showBubblesVertically()) {
            ...
            this.mExpandedViewContainerMatrix.setScale(0.0f, 0.0f, i, f);
        } else {
            this.mExpandedViewContainerMatrix.setScale(0.9f, 0.9f, bubbleXOrYForOrientation + (this.mBubbleSize / 2.0f), this.mPositioner.getExpandedViewY());
        }
        this.mExpandedViewContainer.setAnimationMatrix(this.mExpandedViewContainerMatrix);
    ...
    void setFlyoutStateForDragLength(float f) {
        ...
        if (i < 0 || width > 1.0f) {
            ...
            float f3 = (z2 ? width - 1.0f : width * (-1.0f)) * (z ? -1 : 1);
            float width2 = this.mFlyout.getWidth();
            if (z2) {
                i3 = 2;
            }
            f2 = f3 * (width2 / (8.0f / i3));
        }
        BubbleFlyoutView bubbleFlyoutView = this.mFlyout;
    ...
    private boolean shouldShowFlyout(Bubble bubble) {
        ...
        BadgedImageView mo1645getIconView = bubble.mo1645getIconView();
        if (flyoutMessage == null || flyoutMessage.message == null || !bubble.showFlyout() || (((stackEducationView = this.mStackEduView) != null && stackEducationView.getVisibility() == 0) || isExpanded() || this.mIsExpansionAnimating || this.mIsGestureInProgress || this.mBubbleToExpandAfterFlyoutCollapse != null || mo1645getIconView == null)) {
            if (mo1645getIconView == null || this.mFlyout.getVisibility() == 0) {
                return false;
            }
            mo1645getIconView.removeDotSuppressionFlag(BadgedImageView.SuppressionFlag.FLYOUT_VISIBLE);
            return false;
        }
        return true;
    }
    ...
    void animateInFlyoutForBubble(final Bubble bubble) {
        ...
        clearFlyoutOnHide();
        this.mAfterFlyoutHidden = new Runnable() { // from class: com.android.wm.shell.bubbles.BubbleStackView$$ExternalSyntheticLambda35
            @Override // java.lang.Runnable
            public final void run() {
                BubbleStackView.this.lambda$animateInFlyoutForBubble$32(bubble);
            }
        };
        bubble.mo1645getIconView().addDotSuppressionFlag(BadgedImageView.SuppressionFlag.FLYOUT_VISIBLE);
        post(new Runnable() { // from class: com.android.wm.shell.bubbles.BubbleStackView$$ExternalSyntheticLambda34
            @Override // java.lang.Runnable
            public final void run() {
                BubbleStackView.this.lambda$animateInFlyoutForBubble$35(bubble);
            }
        });
    ...
    public /* synthetic */ void lambda$animateInFlyoutForBubble$32(Bubble bubble) {
        ...
        if (bubble.mo1645getIconView() != null) {
            bubble.mo1645getIconView().removeDotSuppressionFlag(BadgedImageView.SuppressionFlag.FLYOUT_VISIBLE);
        }
    ...
    public /* synthetic */ void lambda$animateInFlyoutForBubble$35(Bubble bubble) {
        if (isExpanded() || bubble.mo1645getIconView() == null) {
            return;
        }
        Runnable runnable = new Runnable() { // from class: com.android.wm.shell.bubbles.BubbleStackView$$ExternalSyntheticLambda25
            @Override // java.lang.Runnable
            public final void run() {
        ...
        if (this.mFlyout.getVisibility() == 0) {
            this.mFlyout.animateUpdate(bubble.getFlyoutMessage(), getWidth(), this.mStackAnimationController.getStackPosition(), !bubble.showDot(), this.mAfterFlyoutHidden);
        } else {
            this.mFlyout.setVisibility(4);
            this.mFlyout.setupFlyoutStartingAsDot(bubble.getFlyoutMessage(), this.mStackAnimationController.getStackPosition(), getWidth(), this.mStackAnimationController.isStackOnLeftSide(), bubble.mo1645getIconView().getDotColor(), runnable, this.mAfterFlyoutHidden, bubble.mo1645getIconView().getDotCenter(), !bubble.showDot(), this.mPositioner);
        }
    ...
    public /* synthetic */ void lambda$animateInFlyoutForBubble$34() {
        Runnable runnable = new Runnable() { // from class: com.android.wm.shell.bubbles.BubbleStackView$$ExternalSyntheticLambda17
            @Override // java.lang.Runnable
            public final void run() {
    ...
    private void screenshotAnimatingOutBubbleIntoSurface(final Consumer<Boolean> consumer) {
        ...
        post(new Runnable() { // from class: com.android.wm.shell.bubbles.BubbleStackView$$ExternalSyntheticLambda38
            @Override // java.lang.Runnable
            public final void run() {
                BubbleStackView.this.lambda$screenshotAnimatingOutBubbleIntoSurface$42(consumer);
            }
        });
    }

    /* JADX INFO: Access modifiers changed from: private */
    public /* synthetic */ void lambda$screenshotAnimatingOutBubbleIntoSurface$42(final Consumer consumer) {
        SurfaceControl.ScreenshotHardwareBuffer screenshotHardwareBuffer = this.mAnimatingOutBubbleBuffer;
        if (screenshotHardwareBuffer == null || screenshotHardwareBuffer.getHardwareBuffer() == null || this.mAnimatingOutBubbleBuffer.getHardwareBuffer().isClosed()) {
            ...
            this.mSurfaceSynchronizer.syncSurfaceAndRun(new Runnable() { // from class: com.android.wm.shell.bubbles.BubbleStackView$$ExternalSyntheticLambda39
                @Override // java.lang.Runnable
                public final void run() {
                    BubbleStackView.this.lambda$screenshotAnimatingOutBubbleIntoSurface$41(consumer);
                }
            });
        }
    }
    ...
    /* JADX INFO: Access modifiers changed from: private */
    public /* synthetic */ void lambda$screenshotAnimatingOutBubbleIntoSurface$41(final Consumer consumer) {
        post(new Runnable() { // from class: com.android.wm.shell.bubbles.BubbleStackView$$ExternalSyntheticLambda41
            @Override // java.lang.Runnable
            public final void run() {
                BubbleStackView.lambda$screenshotAnimatingOutBubbleIntoSurface$40(consumer);
            }
        });
    }
    ...
    public void updateBubbleShadows(boolean z) {
        ...
        for (int i = 0; i < bubbleCount; i++) {
            float maxBubbles = (this.mPositioner.getMaxBubbles() * this.mBubbleElevation) - i;
    ...
    private void updateZOrder() {
        ...
        int i = 0;
        while (i < bubbleCount) {
            ((BadgedImageView) this.mBubbleContainer.getChildAt(i)).setZ(i < 2 ? (this.mPositioner.getMaxBubbles() * this.mBubbleElevation) - i : 0.0f);
            i++;
        }
    }
    ...
    int getBubbleIndex(BubbleViewProvider bubbleViewProvider) {
        ...
        return this.mBubbleContainer.indexOfChild(bubbleViewProvider.mo1645getIconView());
    }
