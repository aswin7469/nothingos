...
public final class BubbleXmlHelperKt {
    public static final void writeXml(@NotNull OutputStream stream, @NotNull SparseArray<List<BubbleEntity>> bubbles) throws IOException {
        ...
        if (size > 0) {
            ...
            while (true) {
                int i2 = i + 1;
                int keyAt = bubbles.keyAt(i);
                List<BubbleEntity> v = bubbles.valueAt(i);
                fastXmlSerializer.startTag(null, "bs");
                fastXmlSerializer.attribute(null, "uid", String.valueOf(keyAt));
                Intrinsics.checkNotNullExpressionValue(v, "v");
                for (BubbleEntity bubbleEntity : v) {
    ...
    @NotNull
    public static final SparseArray<List<BubbleEntity>> readXml(@NotNull InputStream stream) {
        List<BubbleEntity> list;
        List<BubbleEntity> list2;
        Intrinsics.checkNotNullParameter(stream, "stream");
            ...
            while (XmlUtils.nextElementWithin(newPullParser, depth)) {
                ...
                if (attributeWithName2 != null) {
                    ...
                    if (!arrayList2.isEmpty()) {
                        int parseInt = Integer.parseInt(attributeWithName2);
