...
public class DisplayLayout {
    ...
    static int getStatusBarHeight(boolean z, Resources resources) {
        if (z) {
            return resources.getDimensionPixelSize(17105527);
        }
        return resources.getDimensionPixelSize(17105528);
    }
    ...
    public static int navigationBarPosition(Resources resources, int i, int i2, int i3) {
        if (!(i != i2 && resources.getBoolean(17891595)) || i <= i2) {
            return 4;
        }
        return i3 == 1 ? 2 : 1;
    }
    ...
    public static int getNavigationBarSize(Resources resources, int i, boolean z, int i2) {
        if ((i2 & 15) == 3) {
            if (i == 4) {
                return resources.getDimensionPixelSize(z ? 17105357 : 17105355);
            }
            return resources.getDimensionPixelSize(17105360);
        } else if (i == 4) {
            return resources.getDimensionPixelSize(z ? 17105356 : 17105354);
        } else {
            return resources.getDimensionPixelSize(17105359);
        }
    }

    public static int getNavigationBarFrameHeight(Resources resources, boolean z) {
        return resources.getDimensionPixelSize(z ? 17105351 : 17105350);
    }
}
