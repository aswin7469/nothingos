...
public final class FloatingContentCoordinator$Companion$findAreaForContentVertically$newContentBoundsBelow$2 extends Lambda implements Function0<Rect> {
    ...
    public final Rect mo1951invoke() {
        ...
        plus = CollectionsKt___CollectionsKt.plus(this.$rectsToAvoidBelow.element, this.$newlyOverlappingRect);
        return companion.findAreaForContentAboveOrBelow(rect, plus, false);
    }
}
