...
public final class FloatingContentCoordinator$Companion$findAreaForContentVertically$positionAboveInBounds$2 extends Lambda implements Function0<Boolean> {
    ...
    public final Boolean mo1951invoke() {
        Rect m1695findAreaForContentVertically$lambda2;
        Rect rect = this.$allowedBounds;
        m1695findAreaForContentVertically$lambda2 = FloatingContentCoordinator.Companion.m1695findAreaForContentVertically$lambda2(this.$newContentBoundsAbove$delegate);
        return rect.contains(m1695findAreaForContentVertically$lambda2);
    }
}
