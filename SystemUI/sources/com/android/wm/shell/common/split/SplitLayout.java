...
public final class SplitLayout {
    ...
    public void applySurfaceChanges(SurfaceControl.Transaction transaction, SurfaceControl surfaceControl, SurfaceControl surfaceControl2, SurfaceControl surfaceControl3, SurfaceControl surfaceControl4) {
        ...
        if (dividerLeash != null) {
            transaction.setPosition(dividerLeash, adjustForIme.left, adjustForIme.top).setLayer(dividerLeash, Integer.MAX_VALUE);
        }
        transaction.setPosition(surfaceControl, adjustForIme2.left, adjustForIme2.top).setWindowCrop(surfaceControl, adjustForIme2.width(), adjustForIme2.height());
        transaction.setPosition(surfaceControl2, adjustForIme3.left, adjustForIme3.top).setWindowCrop(surfaceControl2, adjustForIme3.width(), adjustForIme3.height());
    ...
    public class ImePositionProcessor implements DisplayImeController.ImePositionProcessor {
        ...
        private float getProgress(int i) {
            ...
            return (i - i2) / (this.mEndImeTop - i2);
        }
