...
public class LegacySplitDisplayLayout {
    ...
    public void rotateTo(int i) {
        ...
        configuration.screenWidthDp = (int) (rect.width() / this.mDisplayLayout.density());
        configuration.screenHeightDp = (int) (rect.height() / this.mDisplayLayout.density());
    ...
    void calcSplitBounds(int i, Rect rect, Rect rect2) {
    ...
    private void adjustForIME(DisplayLayout displayLayout, int i, int i2, int i3, int i4, int i5, Rect rect, Rect rect2) {
        ...
        int max = Math.max(0, height - (i + Math.max(0, (i2 - i3) - (i7 - (i6 + ((int) ((i7 - i6) * 0.3f)))))));
        this.mAdjustedPrimary.set(rect);
        int i8 = -max;
        this.mAdjustedPrimary.offset(0, (i4 - ((int) ((i5 * f) + (i4 * (1.0f - f))))) + i8);
    ...
    static int getSmallestWidthDpForBounds(Context context, DisplayLayout displayLayout, Rect rect) {
        ...
        return (int) (i / displayLayout.density());
    }
    ...
    static DividerSnapAlgorithm initSnapAlgorithmForRotation(Context context, DisplayLayout displayLayout, int i) {
        ...
        configuration.screenWidthDp = (int) (rect.width() / displayLayout.density());
        configuration.screenHeightDp = (int) (rect.height() / displayLayout.density());
    ...
    static int getPrimarySplitSide(Rect rect, Rect rect2, int i) {
        if (i == 1) {
            ...
            return (rect2.right - rect.right) - (rect.left - rect2.left) < 0 ? 3 : 1;
        }
    }
}
