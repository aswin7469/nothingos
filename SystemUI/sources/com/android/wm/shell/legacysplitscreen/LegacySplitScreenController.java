...
public class LegacySplitScreenController implements DisplayController.OnDisplaysChangedListener {
    ...
    public void addDivider(Configuration configuration) {
        ...
        int width = z ? dimensionPixelSize : displayLayout.width();
        if (z) {
    ...
    public void updateVisibility(final boolean z) {
        if (this.mVisible != z) {
            ...
            synchronized (this.mDockedStackExistsListeners) {
                this.mDockedStackExistsListeners.removeIf(new Predicate() { // from class: com.android.wm.shell.legacysplitscreen.LegacySplitScreenController$$ExternalSyntheticLambda5
                    @Override // java.util.function.Predicate
                    public final boolean test(Object obj) {
                        boolean lambda$updateVisibility$3;
                        lambda$updateVisibility$3 = LegacySplitScreenController.lambda$updateVisibility$3(z, (WeakReference) obj);
    ...
    public void setMinimized(final boolean z) {
        this.mMainExecutor.execute(new Runnable() { // from class: com.android.wm.shell.legacysplitscreen.LegacySplitScreenController$$ExternalSyntheticLambda3
            @Override // java.lang.Runnable
            public final void run() {
                LegacySplitScreenController.this.lambda$setMinimized$4(z);
            }
        });
    }
    ...
    public long getAnimDuration() {
        return Settings.Global.getFloat(this.mContext.getContentResolver(), "transition_animation_scale", this.mContext.getResources().getFloat(17105060)) * 336.0f;
    }
    ...
    public void notifyBoundsChanged(final Rect rect, final Rect rect2) {
        synchronized (this.mBoundsChangedListeners) {
            this.mBoundsChangedListeners.removeIf(new Predicate() { // from class: com.android.wm.shell.legacysplitscreen.LegacySplitScreenController$$ExternalSyntheticLambda4
                @Override // java.util.function.Predicate
                public final boolean test(Object obj) {
    ...
    public class SplitScreenImpl implements LegacySplitScreen {
        ...
        public boolean isDividerVisible() {
            ...
            try {
                LegacySplitScreenController.this.mMainExecutor.executeBlocking(new Runnable() { // from class: com.android.wm.shell.legacysplitscreen.LegacySplitScreenController$SplitScreenImpl$$ExternalSyntheticLambda7
                    @Override // java.lang.Runnable
                    public final void run() {
        ...
        public void onKeyguardVisibilityChanged(final boolean z) {
            LegacySplitScreenController.this.mMainExecutor.execute(new Runnable() { // from class: com.android.wm.shell.legacysplitscreen.LegacySplitScreenController$SplitScreenImpl$$ExternalSyntheticLambda4
                @Override // java.lang.Runnable
                public final void run() {
                    LegacySplitScreenController.SplitScreenImpl.this.lambda$onKeyguardVisibilityChanged$1(z);
                }
            });
        }
        ...
        @Override // com.android.wm.shell.legacysplitscreen.LegacySplitScreen
        public void setMinimized(final boolean z) {
            LegacySplitScreenController.this.mMainExecutor.execute(new Runnable() { // from class: com.android.wm.shell.legacysplitscreen.LegacySplitScreenController$SplitScreenImpl$$ExternalSyntheticLambda5
                @Override // java.lang.Runnable
                public final void run() {
                    LegacySplitScreenController.SplitScreenImpl.this.lambda$setMinimized$2(z);
                }
            });
        }
        ...
        public void registerInSplitScreenListener(final Consumer<Boolean> consumer) {
            LegacySplitScreenController.this.mMainExecutor.execute(new Runnable() { // from class: com.android.wm.shell.legacysplitscreen.LegacySplitScreenController$SplitScreenImpl$$ExternalSyntheticLambda3
                @Override // java.lang.Runnable
                public final void run() {
        ...
        public void registerBoundsChangeListener(final BiConsumer<Rect, Rect> biConsumer) {
            LegacySplitScreenController.this.mMainExecutor.execute(new Runnable() { // from class: com.android.wm.shell.legacysplitscreen.LegacySplitScreenController$SplitScreenImpl$$ExternalSyntheticLambda2
                @Override // java.lang.Runnable
                public final void run() {
        ...
        public boolean splitPrimaryTask() {
            final boolean[] zArr = new boolean[1];
            try {
                LegacySplitScreenController.this.mMainExecutor.executeBlocking(new Runnable() { // from class: com.android.wm.shell.legacysplitscreen.LegacySplitScreenController$SplitScreenImpl$$ExternalSyntheticLambda6
                    @Override // java.lang.Runnable
                    public final void run() {
