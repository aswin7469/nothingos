...
public class WindowManagerProxy {
    ...
    public boolean getHomeAndRecentsTasks(List<ActivityManager.RunningTaskInfo> list, WindowContainerToken windowContainerToken) {
        ...
        if (windowContainerToken == null) {
            childTasks = this.mTaskOrganizer.getRootTasks(0, HOME_AND_RECENTS);
        } else {
            childTasks = this.mTaskOrganizer.getChildTasks(windowContainerToken, HOME_AND_RECENTS);
        }
    ...
    /* JADX INFO: Access modifiers changed from: package-private */
    public static void buildDismissSplit(WindowContainerTransaction windowContainerTransaction, final LegacySplitScreenTaskListener legacySplitScreenTaskListener, LegacySplitDisplayLayout legacySplitDisplayLayout, boolean z) {
        int i;
        int i2;
        ...
        rootTasks.removeIf(new Predicate() { // from class: com.android.wm.shell.legacysplitscreen.WindowManagerProxy$$ExternalSyntheticLambda0
            ...
            public final boolean test(Object obj) {
                boolean lambda$buildDismissSplit$0;
                lambda$buildDismissSplit$0 = WindowManagerProxy.lambda$buildDismissSplit$0(LegacySplitScreenTaskListener.this, (ActivityManager.RunningTaskInfo) obj);
                return lambda$buildDismissSplit$0;
            }
        });
