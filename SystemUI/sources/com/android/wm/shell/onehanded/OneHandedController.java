...
public class OneHandedController implements RemoteCallable<OneHandedController> {
    ...
    OneHandedController(Context context, DisplayController displayController, OneHandedBackgroundPanelOrganizer oneHandedBackgroundPanelOrganizer, OneHandedDisplayAreaOrganizer oneHandedDisplayAreaOrganizer, OneHandedTouchHandler oneHandedTouchHandler, OneHandedTutorialHandler oneHandedTutorialHandler, OneHandedSettingsUtil oneHandedSettingsUtil, OneHandedAccessibilityUtil oneHandedAccessibilityUtil, OneHandedTimeoutHandler oneHandedTimeoutHandler, OneHandedState oneHandedState, OneHandedUiEventLogger oneHandedUiEventLogger, IOverlayManager iOverlayManager, TaskStackListenerImpl taskStackListenerImpl, ShellExecutor shellExecutor, Handler handler) {
        DisplayChangeController.OnDisplayChangingListener onDisplayChangingListener = new DisplayChangeController.OnDisplayChangingListener() { // from class: com.android.wm.shell.onehanded.OneHandedController$$ExternalSyntheticLambda0
    ...
    private void setEnabledGesturalOverlay(final boolean z, boolean z2) {
        if (this.mState.isTransitioning() || z2) {
            this.mMainExecutor.executeDelayed(new Runnable() { // from class: com.android.wm.shell.onehanded.OneHandedController$$ExternalSyntheticLambda10
                @Override // java.lang.Runnable
                public final void run() {
                    OneHandedController.this.lambda$setEnabledGesturalOverlay$5(z);
                }
            }, 250L);
            return;
        }
    ...
    public class OneHandedImpl implements OneHanded {
        ...
        public void setLockedDisabled(final boolean z, final boolean z2) {
            OneHandedController.this.mMainExecutor.execute(new Runnable() { // from class: com.android.wm.shell.onehanded.OneHandedController$OneHandedImpl$$ExternalSyntheticLambda7
                @Override // java.lang.Runnable
                public final void run() {
        ...
        public void registerEventCallback(final OneHandedEventCallback oneHandedEventCallback) {
            OneHandedController.this.mMainExecutor.execute(new Runnable() { // from class: com.android.wm.shell.onehanded.OneHandedController$OneHandedImpl$$ExternalSyntheticLambda4
                @Override // java.lang.Runnable
                public final void run() {
        ...
        public void registerTransitionCallback(final OneHandedTransitionCallback oneHandedTransitionCallback) {
            OneHandedController.this.mMainExecutor.execute(new Runnable() { // from class: com.android.wm.shell.onehanded.OneHandedController$OneHandedImpl$$ExternalSyntheticLambda5
                @Override // java.lang.Runnable
                public final void run() {
        ...
        public void onConfigChanged(final Configuration configuration) {
            OneHandedController.this.mMainExecutor.execute(new Runnable() { // from class: com.android.wm.shell.onehanded.OneHandedController$OneHandedImpl$$ExternalSyntheticLambda3
                @Override // java.lang.Runnable
                public final void run() {
        ...
        public void onUserSwitch(final int i) {
            OneHandedController.this.mMainExecutor.execute(new Runnable() { // from class: com.android.wm.shell.onehanded.OneHandedController$OneHandedImpl$$ExternalSyntheticLambda2
                @Override // java.lang.Runnable
                public final void run() {
                    OneHandedController.OneHandedImpl.this.lambda$onUserSwitch$7(i);
                }
            });
        }
        ...
        public void onKeyguardVisibilityChanged(final boolean z) {
            OneHandedController.this.mMainExecutor.execute(new Runnable() { // from class: com.android.wm.shell.onehanded.OneHandedController$OneHandedImpl$$ExternalSyntheticLambda6
                @Override // java.lang.Runnable
                public final void run() {
                    OneHandedController.OneHandedImpl.this.lambda$onKeyguardVisibilityChanged$8(z);
                }
            });
        }
