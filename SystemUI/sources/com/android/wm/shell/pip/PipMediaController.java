...
public class PipMediaController {
    ...
    public PipMediaController(Context context, Handler handler) {
        ...
        context.registerReceiverForAllUsers(broadcastReceiver, intentFilter, "com.android.systemui.permission.SELF", handler);
    ...
    public void notifyActionsChanged() {
        if (!this.mActionListeners.isEmpty()) {
            ...
            this.mActionListeners.forEach(new Consumer() { // from class: com.android.wm.shell.pip.PipMediaController$$ExternalSyntheticLambda2
    ...
    public void notifyMetadataChanged(final MediaMetadata mediaMetadata) {
        if (!this.mMetadataListeners.isEmpty()) {
            this.mMetadataListeners.forEach(new Consumer() { // from class: com.android.wm.shell.pip.PipMediaController$$ExternalSyntheticLambda1
                @Override // java.util.function.Consumer
                public final void accept(Object obj) {
