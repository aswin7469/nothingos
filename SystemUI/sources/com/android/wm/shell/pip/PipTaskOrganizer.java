...
public class PipTaskOrganizer implements ShellTaskOrganizer.TaskListener, DisplayController.OnDisplaysChangedListener {
    ...
    public void exitPip(final int i) {
        if (this.mState.isInPip()) {
            ...
            State state2 = State.EXITING_PIP;
            if (state != state2 && this.mToken != null) {
                ...
                int i2 = 4;
                final int i3 = syncWithSplitScreenBounds(displayBounds) ? 4 : 3;
                ...
                this.mSyncTransactionQueue.runInSync(new SyncTransactionQueue.TransactionRunnable() { // from class: com.android.wm.shell.pip.PipTaskOrganizer$$ExternalSyntheticLambda1
                    @Override // com.android.wm.shell.common.SyncTransactionQueue.TransactionRunnable
                    public final void runWithTransaction(SurfaceControl.Transaction transaction2) {
                        PipTaskOrganizer.this.lambda$exitPip$1(displayBounds, i3, i, transaction2);
                    }
                });
                return;
            }
    ...
    private void applyWindowingModeChangeOnExit(final WindowContainerTransaction windowContainerTransaction, final int i) {
        ...
        this.mSplitScreenOptional.ifPresent(new Consumer() { // from class: com.android.wm.shell.pip.PipTaskOrganizer$$ExternalSyntheticLambda9
            @Override // java.util.function.Consumer
            public final void accept(Object obj) {
                PipTaskOrganizer.this.lambda$applyWindowingModeChangeOnExit$2(i, windowContainerTransaction, (LegacySplitScreenController) obj);
            }
        });
    }
    ...
    public void onTaskAppeared(ActivityManager.RunningTaskInfo runningTaskInfo, SurfaceControl surfaceControl) {
        ...
        if (Transitions.ENABLE_SHELL_TRANSITIONS) {
            if (this.mOneShotAnimationType != 0) {
                return;
            }
    ...
    void enterPipWithAlphaAnimation(final Rect rect, final long j) {
        ...
        applyEnterPipSyncTransaction(rect, new Runnable() { // from class: com.android.wm.shell.pip.PipTaskOrganizer$$ExternalSyntheticLambda7
            @Override // java.lang.Runnable
            public final void run() {
                PipTaskOrganizer.this.lambda$enterPipWithAlphaAnimation$3(rect, j);
            }
        }, null);
    }
    ...
    private void onEndOfSwipePipToHomeTransition() {
        ...
        applyEnterPipSyncTransaction(bounds, new Runnable() { // from class: com.android.wm.shell.pip.PipTaskOrganizer$$ExternalSyntheticLambda8
            @Override // java.lang.Runnable
            public final void run() {
    ...
    private void applyEnterPipSyncTransaction(Rect rect, final Runnable runnable, SurfaceControl.Transaction transaction) {
        ...
        this.mSyncTransactionQueue.queue(windowContainerTransaction);
        if (runnable != null) {
            this.mSyncTransactionQueue.runInSync(new SyncTransactionQueue.TransactionRunnable() { // from class: com.android.wm.shell.pip.PipTaskOrganizer$$ExternalSyntheticLambda3
                @Override // com.android.wm.shell.common.SyncTransactionQueue.TransactionRunnable
                public final void runWithTransaction(SurfaceControl.Transaction transaction2) {
                    runnable.run();
                }
    ...
    public void onTaskInfoChanged(ActivityManager.RunningTaskInfo runningTaskInfo) {
        ...
        if (state != State.ENTERED_PIP && state != State.EXITING_PIP) {
            String str = TAG;
            Log.d(str, "Defer onTaskInfoChange in current state: " + this.mState);
        ...
        if (pictureInPictureParams == null || !applyPictureInPictureParams(pictureInPictureParams)) {
            String str2 = TAG;
            Log.d(str2, "Ignored onTaskInfoChanged with PiP param: " + pictureInPictureParams);
            return;
        }
    ...
    public void onFixedRotationFinished(int i) {
        ...
        if (state == State.TASK_APPEARED) {
            ...
            applyEnterPipSyncTransaction(destinationBounds, new Runnable() { // from class: com.android.wm.shell.pip.PipTaskOrganizer$$ExternalSyntheticLambda6
                @Override // java.lang.Runnable
                public final void run() {
    ...
    public void onMovementBoundsChanged(Rect rect, boolean z, boolean z2, boolean z3, WindowContainerTransaction windowContainerTransaction) {
        ...
        if (currentAnimator == null || !currentAnimator.isRunning() || currentAnimator.getTransitionDirection() != 2) {
            ...
            if (z4 && this.mWaitForFixedRotation && this.mHasFadeOut) {
                ...
                return;
            } else if (this.mPipBoundsState.getBounds().isEmpty()) {
                return;
            } else {
    ...
    private PipAnimationController.PipTransitionAnimator<?> animateResizePip(Rect rect, Rect rect2, Rect rect3, int i, int i2, float f) {
        ...
        Rect rect5 = rect4;
        PipAnimationController.PipTransitionAnimator<?> animator = this.mPipAnimationController.getAnimator(this.mTaskInfo, this.mLeash, i == 6 ? this.mPipBoundsState.getBounds() : rect, rect, rect2, rect5, i, f, deltaRotation);
        animator.setTransitionDirection(i).setPipAnimationCallback(this.mPipAnimationCallback).setPipTransactionHandler(this.mPipTransactionHandler).setDuration(i2);
        if (PipAnimationController.isInPipDirection(i)) {
            if (rect5 == null) {
    ...
    public void fadeOutAndRemoveOverlay(final SurfaceControl surfaceControl, final Runnable runnable, boolean z) {
        ...
        ofFloat.addUpdateListener(new ValueAnimator.AnimatorUpdateListener() { // from class: com.android.wm.shell.pip.PipTaskOrganizer$$ExternalSyntheticLambda0
            ...
            public final void onAnimationUpdate(ValueAnimator valueAnimator) {
                PipTaskOrganizer.this.lambda$fadeOutAndRemoveOverlay$8(surfaceControl, valueAnimator);
            }
        });
