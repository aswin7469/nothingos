...
public class PipTransition extends PipTransitionController {
    ...
    private boolean startEnterAnimation(TaskInfo taskInfo, SurfaceControl surfaceControl, SurfaceControl.Transaction transaction) {
        ...
        if (i == 0) {
            animator = this.mPipAnimationController.getAnimator(taskInfo, surfaceControl, bounds, bounds, entryDestinationBounds, PipBoundsAlgorithm.getValidSourceHintRect(taskInfo.pictureInPictureParams, bounds), 2, 0.0f, 0);
        } else if (i == 1) {
