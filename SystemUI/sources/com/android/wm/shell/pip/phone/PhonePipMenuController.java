...
public class PhonePipMenuController implements PipMenuController {
    ...
    public void onMenuStateChangeStart(final int i, final boolean z, final Runnable runnable) {
        if (i != this.mMenuState) {
            this.mListeners.forEach(new Consumer() { // from class: com.android.wm.shell.pip.phone.PhonePipMenuController$$ExternalSyntheticLambda2
    ...
    public void onMenuStateChangeFinish(final int i) {
        if (i != this.mMenuState) {
            this.mListeners.forEach(new Consumer() { // from class: com.android.wm.shell.pip.phone.PhonePipMenuController$$ExternalSyntheticLambda1
                @Override // java.util.function.Consumer
                public final void accept(Object obj) {
