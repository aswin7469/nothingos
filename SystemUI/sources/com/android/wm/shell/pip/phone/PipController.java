...
public class PipController implements PipTransitionController.PipTransitionCallback, RemoteCallable<PipController> {
    ...
    public static /* synthetic */ void access$1400(PipController pipController, boolean z, int i) {
        pipController.setShelfHeight(z, i);
    }

    /* JADX INFO: Access modifiers changed from: package-private */
    public static /* synthetic */ void access$2300(PipController pipController, ComponentName componentName, Rect rect, SurfaceControl surfaceControl) {
        pipController.stopSwipePipToHome(componentName, rect, surfaceControl);
    }
    ...
    protected PipController(Context context, DisplayController displayController, PipAppOpsListener pipAppOpsListener, PipBoundsAlgorithm pipBoundsAlgorithm, PipBoundsState pipBoundsState, PipMediaController pipMediaController, PhonePipMenuController phonePipMenuController, PipTaskOrganizer pipTaskOrganizer, PipTouchHandler pipTouchHandler, PipTransitionController pipTransitionController, WindowManagerShellWrapper windowManagerShellWrapper, TaskStackListenerImpl taskStackListenerImpl, Optional<OneHandedController> optional, ShellExecutor shellExecutor) {
        ...
        shellExecutor.execute(new Runnable() { // from class: com.android.wm.shell.pip.phone.PipController$$ExternalSyntheticLambda4
    ...
    /* JADX INFO: Access modifiers changed from: private */
    public void onDisplayChanged(final DisplayLayout displayLayout, boolean z) {
        if (Objects.equals(displayLayout, this.mPipBoundsState.getDisplayLayout())) {
            return;
        }
        Runnable runnable = new Runnable() { // from class: com.android.wm.shell.pip.phone.PipController$$ExternalSyntheticLambda6
            @Override // java.lang.Runnable
            public final void run() {
                PipController.this.lambda$onDisplayChanged$5(displayLayout);
            }
        };
    ...
    public class PipImpl implements Pip {
        ...
        @Override // com.android.wm.shell.pip.Pip
        public void hidePipMenu(final Runnable runnable, final Runnable runnable2) {
            PipController.this.mMainExecutor.execute(new Runnable() { // from class: com.android.wm.shell.pip.phone.PipController$PipImpl$$ExternalSyntheticLambda7
                @Override // java.lang.Runnable
                public final void run() {
                    PipController.PipImpl.this.lambda$hidePipMenu$0(runnable, runnable2);
                }
            });
        }
        ...
        public void onConfigurationChanged(final Configuration configuration) {
            PipController.this.mMainExecutor.execute(new Runnable() { // from class: com.android.wm.shell.pip.phone.PipController$PipImpl$$ExternalSyntheticLambda5
                @Override // java.lang.Runnable
                public final void run() {
                    PipController.PipImpl.this.lambda$onConfigurationChanged$2(configuration);
                }
            });
        }
        ...
        @Override // com.android.wm.shell.pip.Pip
        public void onDensityOrFontScaleChanged() {
            PipController.this.mMainExecutor.execute(new Runnable() { // from class: com.android.wm.shell.pip.phone.PipController$PipImpl$$ExternalSyntheticLambda0
                @Override // java.lang.Runnable
                public final void run() {
                    PipController.PipImpl.this.lambda$onDensityOrFontScaleChanged$3();
                }
            });
        }
        ...
        @Override // com.android.wm.shell.pip.Pip
        public void onOverlayChanged() {
            PipController.this.mMainExecutor.execute(new Runnable() { // from class: com.android.wm.shell.pip.phone.PipController$PipImpl$$ExternalSyntheticLambda3
                @Override // java.lang.Runnable
                public final void run() {
                    PipController.PipImpl.this.lambda$onOverlayChanged$4();
                }
            });
        }
        ...
        public void onSystemUiStateChanged(final boolean z, final int i) {
            PipController.this.mMainExecutor.execute(new Runnable() { // from class: com.android.wm.shell.pip.phone.PipController$PipImpl$$ExternalSyntheticLambda9
                @Override // java.lang.Runnable
                public final void run() {
                    PipController.PipImpl.this.lambda$onSystemUiStateChanged$5(z, i);
                }
            });
        }
        ...
        public void registerSessionListenerForCurrentUser() {
            PipController.this.mMainExecutor.execute(new Runnable() { // from class: com.android.wm.shell.pip.phone.PipController$PipImpl$$ExternalSyntheticLambda2
                @Override // java.lang.Runnable
                public final void run() {
                    PipController.PipImpl.this.lambda$registerSessionListenerForCurrentUser$6();
                }
            });
        }
        ...
        public void setPinnedStackAnimationType(final int i) {
            PipController.this.mMainExecutor.execute(new Runnable() { // from class: com.android.wm.shell.pip.phone.PipController$PipImpl$$ExternalSyntheticLambda4
                @Override // java.lang.Runnable
                public final void run() {
                    PipController.PipImpl.this.lambda$setPinnedStackAnimationType$8(i);
                }
            });
        }
        ...
        @Override // com.android.wm.shell.pip.Pip
        public void setPipExclusionBoundsChangeListener(final Consumer<Rect> consumer) {
            PipController.this.mMainExecutor.execute(new Runnable() { // from class: com.android.wm.shell.pip.phone.PipController$PipImpl$$ExternalSyntheticLambda8
                @Override // java.lang.Runnable
                public final void run() {
                    PipController.PipImpl.this.lambda$setPipExclusionBoundsChangeListener$9(consumer);
                }
            });
        }
        ...
        @Override // com.android.wm.shell.pip.Pip
        public void showPictureInPictureMenu() {
            PipController.this.mMainExecutor.execute(new Runnable() { // from class: com.android.wm.shell.pip.phone.PipController$PipImpl$$ExternalSyntheticLambda1
                @Override // java.lang.Runnable
                public final void run() {
                    PipController.PipImpl.this.lambda$showPictureInPictureMenu$10();
                }
            });
        }
        ...
        public void dump(final PrintWriter printWriter) {
            try {
                PipController.this.mMainExecutor.executeBlocking(new Runnable() { // from class: com.android.wm.shell.pip.phone.PipController$PipImpl$$ExternalSyntheticLambda6
                    @Override // java.lang.Runnable
                    public final void run() {
                        PipController.PipImpl.this.lambda$dump$11(printWriter);
                    }
                });
    ...
    public static class IPipImpl extends IPip.Stub {
        ...
        public class AnonymousClass1 implements IBinder.DeathRecipient {
            ...
            public void binderDied() {
                final PipController pipController = IPipImpl.this.mController;
                pipController.getRemoteCallExecutor().execute(new Runnable() { // from class: com.android.wm.shell.pip.phone.PipController$IPipImpl$1$$ExternalSyntheticLambda0
                    @Override // java.lang.Runnable
                    public final void run() {
                        PipController.IPipImpl.AnonymousClass1.this.lambda$binderDied$0(pipController);
                    }
                });
            }
        ...
        public Rect startSwipePipToHome(final ComponentName componentName, final ActivityInfo activityInfo, final PictureInPictureParams pictureInPictureParams, final int i, final int i2) {
            final Rect[] rectArr = new Rect[1];
            ExecutorUtils.executeRemoteCallWithTaskPermission(this.mController, "startSwipePipToHome", new Consumer() { // from class: com.android.wm.shell.pip.phone.PipController$IPipImpl$$ExternalSyntheticLambda3
                @Override // java.util.function.Consumer
                public final void accept(Object obj) {
                    PipController.IPipImpl.lambda$startSwipePipToHome$0(rectArr, componentName, activityInfo, pictureInPictureParams, i, i2, (PipController) obj);
                }
            }, true);
            return rectArr[0];
        }
        ...
        @Override // com.android.wm.shell.pip.IPip
        public void stopSwipePipToHome(final ComponentName componentName, final Rect rect, final SurfaceControl surfaceControl) {
            ExecutorUtils.executeRemoteCallWithTaskPermission(this.mController, "stopSwipePipToHome", new Consumer() { // from class: com.android.wm.shell.pip.phone.PipController$IPipImpl$$ExternalSyntheticLambda0
                @Override // java.util.function.Consumer
                public final void accept(Object obj) {
                    PipController.access$2300((PipController) obj, componentName, rect, surfaceControl);
                }
            });
        }
        ...
        public void setShelfHeight(final boolean z, final int i) {
            ExecutorUtils.executeRemoteCallWithTaskPermission(this.mController, "setShelfHeight", new Consumer() { // from class: com.android.wm.shell.pip.phone.PipController$IPipImpl$$ExternalSyntheticLambda2
                @Override // java.util.function.Consumer
                public final void accept(Object obj) {
                    PipController.access$1400((PipController) obj, z, i);
                }
            });
        }

        @Override // com.android.wm.shell.pip.IPip
        public void setPinnedStackAnimationListener(final IPipAnimationListener iPipAnimationListener) {
            ExecutorUtils.executeRemoteCallWithTaskPermission(this.mController, "setPinnedStackAnimationListener", new Consumer() { // from class: com.android.wm.shell.pip.phone.PipController$IPipImpl$$ExternalSyntheticLambda1
                @Override // java.util.function.Consumer
                public final void accept(Object obj) {
                    PipController.IPipImpl.this.lambda$setPinnedStackAnimationListener$3(iPipAnimationListener, (PipController) obj);
                }
            });
        }
