...
public class PipDismissTargetHandler implements ViewTreeObserver.OnPreDrawListener {
    ...
    public void init() {
        ...
        this.mMagnetizedPip.setAnimateStuckToTarget(new Function5() { // from class: com.android.wm.shell.pip.phone.PipDismissTargetHandler$$ExternalSyntheticLambda1
            ...
            public final Object invoke(Object obj, Object obj2, Object obj3, Object obj4, Object obj5) {
                Unit lambda$init$0;
                lambda$init$0 = PipDismissTargetHandler.this.lambda$init$0((MagnetizedObject.MagneticTarget) obj, (Float) obj2, (Float) obj3, (Boolean) obj4, (Function0) obj5);
    ...
    public class AnonymousClass1 implements MagnetizedObject.MagnetListener {
        ...
        public void onReleasedInTarget(MagnetizedObject.MagneticTarget magneticTarget) {
            PipDismissTargetHandler.this.mMainExecutor.executeDelayed(new Runnable() { // from class: com.android.wm.shell.pip.phone.PipDismissTargetHandler$1$$ExternalSyntheticLambda0
    ...
    public void setMagneticFieldRadiusPercent(float f) {
        ...
        this.mMagneticTarget.setMagneticFieldRadiusPx((int) (f * this.mTargetSize * 1.25f));
    }
    ...
    public void hideDismissTargetMaybe() {
        ...
        this.mMagneticTargetAnimator.spring(DynamicAnimation.TRANSLATION_Y, this.mTargetViewContainer.getHeight(), this.mTargetSpringConfig).withEndActions(new Runnable() { // from class: com.android.wm.shell.pip.phone.PipDismissTargetHandler$$ExternalSyntheticLambda0
            @Override // java.lang.Runnable
            public final void run() {
