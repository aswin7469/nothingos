...
public class PipMotionHelper implements PipAppOpsListener.Callback, FloatingContentCoordinator.FloatingContent {
    ...
    private ThreadLocal<AnimationHandler> mSfAnimationHandlerThreadLocal = ThreadLocal.withInitial(new Supplier() { // from class: com.android.wm.shell.pip.phone.PipMotionHelper$$ExternalSyntheticLambda5
        ...
        public final Object get() {
            ...
            lambda$new$0 = PipMotionHelper.this.lambda$new$0();
            return lambda$new$0;
        }
    });
    ...
    /* renamed from: com.android.wm.shell.pip.phone.PipMotionHelper$1  reason: invalid class name */
    /* loaded from: classes2.dex */
    public class AnonymousClass1 implements AnimationHandler.FrameCallbackScheduler {
        final /* synthetic */ Looper val$initialLooper;

        AnonymousClass1(Looper looper) {
            this.val$initialLooper = looper;
        }
        ...
        public void postFrameCallback(final Runnable runnable) {
            Choreographer.getSfInstance().postFrameCallback(new Choreographer.FrameCallback() { // from class: com.android.wm.shell.pip.phone.PipMotionHelper$1$$ExternalSyntheticLambda0
        ...
        public boolean isCurrentThread() {
            return Looper.myLooper() == this.val$initialLooper;
        }
    }

    /* JADX INFO: Access modifiers changed from: private */
    public /* synthetic */ AnimationHandler lambda$new$0() {
        return new AnimationHandler(new AnonymousClass1(Looper.myLooper()));
    }
    ...
    public PipMotionHelper(Context context, PipBoundsState pipBoundsState, PipTaskOrganizer pipTaskOrganizer, PhonePipMenuController phonePipMenuController, PipSnapAlgorithm pipSnapAlgorithm, PipTransitionController pipTransitionController, FloatingContentCoordinator floatingContentCoordinator) {
        PipTransitionController.PipTransitionCallback pipTransitionCallback = new PipTransitionController.PipTransitionCallback() { // from class: com.android.wm.shell.pip.phone.PipMotionHelper.2
    ...
    public void init() {
        PhysicsAnimator<Rect> physicsAnimator = PhysicsAnimator.getInstance(this.mPipBoundsState.getMotionBoundsState().getBoundsInMotion());
        this.mTemporaryBoundsPhysicsAnimator = physicsAnimator;
        physicsAnimator.setCustomAnimationHandler(this.mSfAnimationHandlerThreadLocal.get());
    }
    ...
    private void movetoTarget(float f, float f2, Runnable runnable, boolean z) {
        ...
        startBoundsAnimator(f3, PhysicsAnimator.estimateFlingEndValue(this.mPipBoundsState.getMotionBoundsState().getBoundsInMotion().top, f2, this.mFlingConfigY), runnable);
    }
    ...
    public void animateDismiss() {
        this.mTemporaryBoundsPhysicsAnimator.spring(FloatProperties.RECT_Y, this.mPipBoundsState.getMovementBounds().bottom + (getBounds().height() * 2), 0.0f, this.mSpringConfig).withEndActions(new Runnable() { // from class: com.android.wm.shell.pip.phone.PipMotionHelper$$ExternalSyntheticLambda1
    ...
    public void animateToStashedClosestEdge() {
        ...
        if (i == 1) {
            stashOffset = (this.mPipBoundsState.getStashOffset() - this.mPipBoundsState.getBounds().width()) + stableInsets.left;
        } else {
            stashOffset = (this.mPipBoundsState.getDisplayBounds().right - this.mPipBoundsState.getStashOffset()) - stableInsets.right;
        }
        float f = stashOffset;
        rect.set((int) f, this.mPipBoundsState.getBounds().top, (int) (f + this.mPipBoundsState.getBounds().width()), this.mPipBoundsState.getBounds().bottom);
        resizeAndAnimatePipUnchecked(rect, 250);
    ...
    private void rebuildFlingConfigs() {
        this.mFlingConfigX = new PhysicsAnimator.FlingConfig(1.9f, this.mPipBoundsState.getMovementBounds().left, this.mPipBoundsState.getMovementBounds().right);
        this.mFlingConfigY = new PhysicsAnimator.FlingConfig(1.9f, this.mPipBoundsState.getMovementBounds().top, this.mPipBoundsState.getMovementBounds().bottom);
        Rect stableInsets = this.mPipBoundsState.getDisplayLayout().stableInsets();
        this.mStashConfigX = new PhysicsAnimator.FlingConfig(1.9f, (this.mPipBoundsState.getStashOffset() - this.mPipBoundsState.getBounds().width()) + stableInsets.left, (this.mPipBoundsState.getDisplayBounds().right - this.mPipBoundsState.getStashOffset()) - stableInsets.right);
    }
