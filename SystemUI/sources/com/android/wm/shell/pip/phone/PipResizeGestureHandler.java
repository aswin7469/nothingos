...
public class PipResizeGestureHandler {
        ...
        try {
            this.mMainExecutor.executeBlocking(new Runnable() { // from class: com.android.wm.shell.pip.phone.PipResizeGestureHandler$$ExternalSyntheticLambda0
                ...
                public final void run() {
                    PipResizeGestureHandler.this.lambda$updateIsEnabled$0();
                }
            });
    ...
    public boolean willStartResizeGesture(MotionEvent motionEvent) {
        if (isInValidSysUiState()) {
            ...
            } else if (actionMasked != 5 || !this.mEnablePinchResize || motionEvent.getPointerCount() != 2) {
                return false;
            } else {
                onPinchResize(motionEvent);
    ...
    private void finishResize() {
        if (!this.mLastResizeBounds.isEmpty()) {
            Consumer<Rect> consumer = new Consumer() { // from class: com.android.wm.shell.pip.phone.PipResizeGestureHandler$$ExternalSyntheticLambda1
                @Override // java.util.function.Consumer
                public final void accept(Object obj) {
                    PipResizeGestureHandler.this.lambda$finishResize$1((Rect) obj);
                }
            };
            if (this.mOngoingPinchToResize) {
                ...
                this.mPipTaskOrganizer.scheduleAnimateResizePip(rect, this.mLastResizeBounds, 250, this.mAngle, consumer);
            } else {
                this.mPipTaskOrganizer.scheduleFinishResizePip(this.mLastResizeBounds, 7, consumer);
            }
            this.mPipDismissTargetHandler.setMagneticFieldRadiusPercent((this.mLastResizeBounds.width() / this.mMinSize.x) / 2.0f);
