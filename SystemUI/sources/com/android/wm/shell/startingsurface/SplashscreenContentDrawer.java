...
public class SplashscreenContentDrawer {
    ...
    /* JADX INFO: Access modifiers changed from: package-private */
    public void createContentView(final Context context, @StartingWindowInfo.StartingWindowType final int i, final ActivityInfo activityInfo, final int i2, final Consumer<SplashScreenView> consumer) {
        this.mSplashscreenWorkerHandler.post(new Runnable() { // from class: com.android.wm.shell.startingsurface.SplashscreenContentDrawer$$ExternalSyntheticLambda0
            @Override // java.lang.Runnable
            public final void run() {
                SplashscreenContentDrawer.this.lambda$createContentView$0(context, activityInfo, i, i2, consumer);
            }
        });
    }
    ...
    private void updateDensity() {
        this.mIconSize = this.mContext.getResources().getDimensionPixelSize(17105523);
        this.mDefaultIconSize = this.mContext.getResources().getDimensionPixelSize(17105522);
    ...
    private static int peekWindowBGColor(Context context, SplashScreenWindowAttrs splashScreenWindowAttrs) {
        ...
        if (splashScreenWindowAttrs.mWindowBgColor != 0) {
            ...
            String str = TAG;
            Slog.w(str, "Window background does not exist, using " + createDefaultBackgroundDrawable);
        } else {
    ...
    private static Drawable peekLegacySplashscreenContent(Context context, SplashScreenWindowAttrs splashScreenWindowAttrs) {
        ...
        int intValue = ((Integer) safeReturnAttrDefault(new UnaryOperator() { // from class: com.android.wm.shell.startingsurface.SplashscreenContentDrawer$$ExternalSyntheticLambda8
    ...
    private SplashScreenView makeSplashScreenContentView(final Context context, ActivityInfo activityInfo, @StartingWindowInfo.StartingWindowType int i) {
        ...
        if (peekLegacySplashscreenContent != null) {
            bGColorFromCache = getBGColorFromCache(activityInfo, new IntSupplier() { // from class: com.android.wm.shell.startingsurface.SplashscreenContentDrawer$$ExternalSyntheticLambda1
            ...
            bGColorFromCache = getBGColorFromCache(activityInfo, new IntSupplier() { // from class: com.android.wm.shell.startingsurface.SplashscreenContentDrawer$$ExternalSyntheticLambda2
                @Override // java.util.function.IntSupplier
                public final int getAsInt() {
        ...
        return new StartingWindowViewBuilder(context, activityInfo).setWindowBGColor(bGColorFromCache).overlayDrawable(peekLegacySplashscreenContent).chooseStyle(i).build();
    }
    ...
    private static void getWindowAttrs(Context context, SplashScreenWindowAttrs splashScreenWindowAttrs) {
        ...
        splashScreenWindowAttrs.mWindowBgColor = ((Integer) safeReturnAttrDefault(new UnaryOperator() { // from class: com.android.wm.shell.startingsurface.SplashscreenContentDrawer$$ExternalSyntheticLambda6
            @Override // java.util.function.Function
            public final Object apply(Object obj) {
        ...
        splashScreenWindowAttrs.mSplashScreenIcon = (Drawable) safeReturnAttrDefault(new UnaryOperator() { // from class: com.android.wm.shell.startingsurface.SplashscreenContentDrawer$$ExternalSyntheticLambda3
            @Override // java.util.function.Function
            public final Object apply(Object obj) {
                Drawable drawable;
        ...
        splashScreenWindowAttrs.mAnimationDuration = ((Integer) safeReturnAttrDefault(new UnaryOperator() { // from class: com.android.wm.shell.startingsurface.SplashscreenContentDrawer$$ExternalSyntheticLambda7
            @Override // java.util.function.Function
            public final Object apply(Object obj) {
                Integer lambda$getWindowAttrs$6;
                lambda$getWindowAttrs$6 = SplashscreenContentDrawer.lambda$getWindowAttrs$6(obtainStyledAttributes, (Integer) obj);
                return lambda$getWindowAttrs$6;
            }
        }, 0)).intValue();
        splashScreenWindowAttrs.mBrandingImage = (Drawable) safeReturnAttrDefault(new UnaryOperator() { // from class: com.android.wm.shell.startingsurface.SplashscreenContentDrawer$$ExternalSyntheticLambda4
            @Override // java.util.function.Function
            public final Object apply(Object obj) {
                Drawable drawable;
                Drawable drawable2 = (Drawable) obj;
        ...
        splashScreenWindowAttrs.mIconBgColor = ((Integer) safeReturnAttrDefault(new UnaryOperator() { // from class: com.android.wm.shell.startingsurface.SplashscreenContentDrawer$$ExternalSyntheticLambda5
            @Override // java.util.function.Function
            public final Object apply(Object obj) {
                Integer lambda$getWindowAttrs$8;
                lambda$getWindowAttrs$8 = SplashscreenContentDrawer.lambda$getWindowAttrs$8(obtainStyledAttributes, (Integer) obj);
                return lambda$getWindowAttrs$8;
            }
        }, 0)).intValue();
        obtainStyledAttributes.recycle();
        if (DEBUG) {
    ...
    public class StartingWindowViewBuilder {
        ...
        SplashScreenView build() {
            ...
            int i2 = 0;
            if (i != 3 && i != 4) {
                if (SplashscreenContentDrawer.this.mTmpAttrs.mSplashScreenIcon != null) {
                    ...
                    int i4 = (int) (((SplashscreenContentDrawer.this.mIconSize / SplashscreenContentDrawer.this.mDefaultIconSize) * this.mContext.getResources().getDisplayMetrics().densityDpi * 1.2f) + 0.5f);
        ...
        private boolean processAdaptiveIcon(Drawable drawable) {
            ...
            final AdaptiveIconDrawable adaptiveIconDrawable = (AdaptiveIconDrawable) drawable;
            ...
            ColorCache.IconColor iconColor = colorCache.getIconColor(activityInfo.packageName, activityInfo.getIconResource(), SplashscreenContentDrawer.this.mLastPackageContextConfigHash, new Supplier() { // from class: com.android.wm.shell.startingsurface.SplashscreenContentDrawer$StartingWindowViewBuilder$$ExternalSyntheticLambda1
            ...
            }, new Supplier() { // from class: com.android.wm.shell.startingsurface.SplashscreenContentDrawer$StartingWindowViewBuilder$$ExternalSyntheticLambda0
                @Override // java.util.function.Supplier
                public final Object get() {
                    SplashscreenContentDrawer.DrawableColorTester lambda$processAdaptiveIcon$1;
                    lambda$processAdaptiveIcon$1 = SplashscreenContentDrawer.StartingWindowViewBuilder.lambda$processAdaptiveIcon$1(adaptiveIconDrawable);
            ...
            if (iconColor.mIsBgComplex || SplashscreenContentDrawer.this.mTmpAttrs.mIconBgColor != 0 || (!SplashscreenContentDrawer.isRgbSimilarInHsv(this.mThemeColor, iconColor.mBgColor) && (!iconColor.mIsBgGrayscale || SplashscreenContentDrawer.isRgbSimilarInHsv(this.mThemeColor, iconColor.mFgColor)))) {
                ...
                this.mFinalIconSize = (int) ((SplashscreenContentDrawer.this.mIconSize * (iconColor.mFgNonTranslucentRatio < 0.44444445f ? 1.2f : 1.0f)) + 0.5f);
        ...
        private SplashScreenView fillViewWithIcon(int i, Drawable[] drawableArr, int i2) {
            ...
            SplashScreenView.Builder animationDurationMillis = new SplashScreenView.Builder(SplashscreenContentDrawer.this.createViewContextWrapper(this.mContext)).setBackgroundColor(this.mThemeColor).setOverlayDrawable(this.mOverlayDrawable).setIconSize(i).setIconBackground(drawable2).setCenterViewDrawable(drawable).setAnimationDurationMillis(i2);
