...
public class SplashscreenIconDrawableFactory {
    ...
    public static Drawable[] makeIconDrawable(int i, int i2, Drawable drawable, int i3, int i4, Handler handler) {
        ...
        if (drawable instanceof Animatable) {
            ...
            immobileIconDrawable = new ImmobileIconDrawable(drawable, i3, i4, handler);
            z = false;
        } else {
            immobileIconDrawable = new ImmobileIconDrawable(new AdaptiveForegroundDrawable(drawable), i3, i4, handler);
        }
        return new Drawable[]{immobileIconDrawable, z ? new MaskBackgroundDrawable(i) : null};
    }
    ...
    public static class ImmobileIconDrawable extends Drawable {
        ...
        ImmobileIconDrawable(final Drawable drawable, final int i, int i2, Handler handler) {
            ...
            handler.post(new Runnable() { // from class: com.android.wm.shell.startingsurface.SplashscreenIconDrawableFactory$ImmobileIconDrawable$$ExternalSyntheticLambda0
                ...
                public final void run() {
                    SplashscreenIconDrawableFactory.ImmobileIconDrawable.this.lambda$new$0(drawable, i);
                }
            });
        }
    ...
    public static class MaskBackgroundDrawable extends Drawable {
        ...
        public MaskBackgroundDrawable(int i) {
            sMask = PathParser.createPathFromPathData(Resources.getSystem().getString(17039952));
            if (i != 0) {
    ...
    public static class AnimatableIconAnimateListener extends AdaptiveForegroundDrawable implements SplashScreenView.IconAnimateListener {
        ...
        AnimatableIconAnimateListener(Drawable drawable) {
            super(drawable);
            Drawable.Callback callback = new Drawable.Callback() { // from class: com.android.wm.shell.startingsurface.SplashscreenIconDrawableFactory.AnimatableIconAnimateListener.2
            ...
            this.mForegroundDrawable.setCallback(callback);
        }
