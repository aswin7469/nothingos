...
public class TaskSnapshotWindow {
    ...
    public static TaskSnapshotWindow create(StartingWindowInfo startingWindowInfo, IBinder iBinder, TaskSnapshot taskSnapshot, ShellExecutor shellExecutor, Runnable runnable) {
        ...
        TaskSnapshotWindow taskSnapshotWindow = new TaskSnapshotWindow(surfaceControl, taskSnapshot, layoutParams3.getTitle(), taskDescription, i2, i3, i4, rect, orientation, i5, taskSnapshot.hasImeSurface() ? 600L : 100L, insetsState, runnable, shellExecutor);
    ...
    /* JADX INFO: Access modifiers changed from: package-private */
    public void scheduleRemove(final Runnable runnable) {
        if (this.mActivityType == 2) {
            removeImmediately();
            runnable.run();
            return;
        }
        Runnable runnable2 = this.mScheduledRunnable;
        if (runnable2 != null) {
            this.mSplashScreenExecutor.removeCallbacks(runnable2);
            this.mScheduledRunnable = null;
        }
        Runnable runnable3 = new Runnable() { // from class: com.android.wm.shell.startingsurface.TaskSnapshotWindow$$ExternalSyntheticLambda0
            @Override // java.lang.Runnable
            public final void run() {
                TaskSnapshotWindow.this.lambda$scheduleRemove$0(runnable);
            }
        };
        this.mScheduledRunnable = runnable3;
        this.mSplashScreenExecutor.executeDelayed(runnable3, this.mDelayRemovalTime);
    }

    /* JADX INFO: Access modifiers changed from: private */
    public /* synthetic */ void lambda$scheduleRemove$0(Runnable runnable) {
        removeImmediately();
        runnable.run();
    }
    ...
    public Rect calculateSnapshotCrop() {
        ...
        int i2 = (int) (contentInsets.left * width);
        if (!z) {
            i = (int) (contentInsets.top * height);
        }
        rect.inset(i2, i, (int) (contentInsets.right * width), (int) (contentInsets.bottom * height));
        return rect;
    }
    ...
    public void drawBackgroundAndBars(Canvas canvas, Rect rect) {
        ...
        if (z2) {
            float f = rect.right;
            float f2 = Color.alpha(this.mStatusBarColor) == 255 ? statusBarColorViewHeight : 0.0f;
            ...
            canvas.drawRect(f, f2, width, height, this.mBackgroundPaint);
        }
        if (z) {
        ...
        public void resized(ClientWindowFrames clientWindowFrames, final boolean z, final MergedConfiguration mergedConfiguration, boolean z2, boolean z3, int i) {
            ...
            if (taskSnapshotWindow != null) {
                taskSnapshotWindow.mSplashScreenExecutor.execute(new Runnable() { // from class: com.android.wm.shell.startingsurface.TaskSnapshotWindow$Window$$ExternalSyntheticLambda0
                    @Override // java.lang.Runnable
                    public final void run() {
                        TaskSnapshotWindow.Window.this.lambda$resized$0(mergedConfiguration, z);
                    }
                });
            }
        }
    ...
    public static class SystemBarBackgroundPainter {
        ...
        SystemBarBackgroundPainter(int i, int i2, int i3, ActivityManager.TaskDescription taskDescription, float f, InsetsState insetsState) {
            ...
            int color = systemUiContext.getColor(17171090);
