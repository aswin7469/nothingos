...
public class Transitions implements RemoteCallable<Transitions> {
    ...
    void attemptMergeTransition(ActiveTransition activeTransition, final ActiveTransition activeTransition2) {
        if (ShellProtoLogCache.WM_SHELL_TRANSITIONS_enabled) {
    ...
    boolean startAnimation(final ActiveTransition activeTransition, TransitionHandler transitionHandler) {
        return transitionHandler.startAnimation(activeTransition.mToken, activeTransition.mInfo, activeTransition.mStartT, new TransitionFinishCallback() { // from class: com.android.wm.shell.transition.Transitions$$ExternalSyntheticLambda1
            @Override // com.android.wm.shell.transition.Transitions.TransitionFinishCallback
            public final void onTransitionFinished(WindowContainerTransaction windowContainerTransaction, WindowContainerTransactionCallback windowContainerTransactionCallback) {
                Transitions.this.lambda$startAnimation$2(activeTransition, windowContainerTransaction, windowContainerTransactionCallback);
            }
        });
    }
    ...
    private void onFinish(IBinder iBinder, WindowContainerTransaction windowContainerTransaction, WindowContainerTransactionCallback windowContainerTransactionCallback) {
        ...
        if (findActiveTransition < 0) {
            ...
            for (int i = findActiveTransition + 1; i < this.mActiveTransitions.size() && this.mActiveTransitions.get(i).mMerged; i++) {
    ...
    private static class IShellTransitionsImpl extends IShellTransitions.Stub {
        ...
        public void registerRemote(final TransitionFilter transitionFilter, final IRemoteTransition iRemoteTransition) {
            ExecutorUtils.executeRemoteCallWithTaskPermission(this.mTransitions, "registerRemote", new Consumer() { // from class: com.android.wm.shell.transition.Transitions$IShellTransitionsImpl$$ExternalSyntheticLambda1
                @Override // java.util.function.Consumer
                public final void accept(Object obj) {
                    Transitions.IShellTransitionsImpl.lambda$registerRemote$0(transitionFilter, iRemoteTransition, (Transitions) obj);
                }
            });
        }
        ...
        @Override // com.android.wm.shell.transition.IShellTransitions
        public void unregisterRemote(final IRemoteTransition iRemoteTransition) {
            ExecutorUtils.executeRemoteCallWithTaskPermission(this.mTransitions, "unregisterRemote", new Consumer() { // from class: com.android.wm.shell.transition.Transitions$IShellTransitionsImpl$$ExternalSyntheticLambda0
                @Override // java.util.function.Consumer
                public final void accept(Object obj) {
                    Transitions.IShellTransitionsImpl.lambda$unregisterRemote$1(iRemoteTransition, (Transitions) obj);
                }
            });
        }
