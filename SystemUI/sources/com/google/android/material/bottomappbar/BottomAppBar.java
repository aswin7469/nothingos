...
public class BottomAppBar extends Toolbar implements CoordinatorLayout.AttachedBehavior {
    ...
    public void removeAnimationListener(AnimationListener animationListener) {
        ...
        if (arrayList != null) {
            arrayList.remove((Object) animationListener);
        }
    }
    ...
    private void createFabTranslationXAnimation(int i, List<Animator> list) {
        ObjectAnimator ofFloat = ObjectAnimator.ofFloat(findDependentFab(), Key.TRANSLATION_X, new float[]{getFabTranslationX(i)});
