...
final class ColorResourcesTableCreator {
    ...
    private static class PackageChunk {
        ...
        public void writeTo(ByteArrayOutputStream byteArrayOutputStream) throws IOException {
            ...
            byteArrayOutputStream.write(ColorResourcesTableCreator.intToByteArray(UCharacter.UnicodeBlock.MAYAN_NUMERALS_ID));
            byteArrayOutputStream.write(ColorResourcesTableCreator.intToByteArray(0));
            byteArrayOutputStream.write(ColorResourcesTableCreator.intToByteArray(this.typeStrings.getChunkSize() + UCharacter.UnicodeBlock.MAYAN_NUMERALS_ID));
            byteArrayOutputStream.write(ColorResourcesTableCreator.intToByteArray(0));
            byteArrayOutputStream.write(ColorResourcesTableCreator.intToByteArray(0));
        ...
        /* access modifiers changed from: package-private */
        public int getChunkSize() {
            return this.typeStrings.getChunkSize() + UCharacter.UnicodeBlock.MAYAN_NUMERALS_ID + this.keyStrings.getChunkSize() + this.typeSpecChunk.getChunkSizeWithTypeChunk();
        }
    }
    ...
    public static byte[] stringToByteArrayUtf8(String str) {
        ...
        System.arraycopy((Object) bytes, 0, (Object) bArr, 2, (int) length);
        bArr[1] = length;
        bArr[0] = length;
        bArr[length2 - 1] = 0;
        return bArr;
