...
final class CalendarItemStyle {
    ...
    public void styleItem(TextView textView) {
        ...
        ViewCompat.setBackground(textView, new InsetDrawable(new RippleDrawable(this.textColor.withAlpha(30), materialShapeDrawable, materialShapeDrawable2), this.insets.left, this.insets.top, this.insets.right, this.insets.bottom));
    }
