...
public final class MaterialSharedAxis extends MaterialVisibility<VisibilityAnimatorProvider> {
    ...
    /* renamed from: X */
    public static final int f449X = 0;

    /* renamed from: Y */
    public static final int f450Y = 1;

    /* renamed from: Z */
    public static final int f451Z = 2;
    ...
    private static VisibilityAnimatorProvider createPrimaryAnimatorProvider(int i, boolean z) {
        if (i == 0) {
            return new SlideDistanceProvider(z ? GravityCompat.END : 8388611);
        } else if (i == 1) {
