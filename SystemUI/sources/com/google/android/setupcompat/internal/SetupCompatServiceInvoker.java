...
public class SetupCompatServiceInvoker {
    ...
    public void logMetricEvent(int i, Bundle bundle) {
        try {
            ...
            LOG.mo55160e(String.format("Metric of type %d dropped since queue is full.", Integer.valueOf(i)), e);
        }
    }
    ...
    public void bindBack(String str, Bundle bundle) {
        try {
            ...
            LOG.mo55160e(String.format("Screen %s bind back fail.", str), e);
        }
    }
    ...
    public void onFocusStatusChanged(String str, Bundle bundle) {
        try {
            ...
            LOG.mo55160e(String.format("Screen %s report focus changed failed.", str), e);
        }
    }

    /* access modifiers changed from: private */
    /* renamed from: invokeLogMetric */
    public void mo54927xaaa27393(int i, Bundle bundle) {
        try {
            ...
            if (iSetupCompatService != null) {
                ...
                LOG.mo55164w("logMetric failed since service reference is null. Are the permissions valid?");
            }
        } catch (RemoteException | IllegalStateException | InterruptedException | TimeoutException e) {
            LOG.mo55160e(String.format("Exception occurred while trying to log metric = [%s]", bundle), e);
        }
    }

    /* access modifiers changed from: private */
    /* renamed from: invokeOnWindowFocusChanged */
    public void mo54928xcb05bb98(String str, Bundle bundle) {
        try {
            ISetupCompatService iSetupCompatService = SetupCompatServiceProvider.get(this.context, this.waitTimeInMillisForServiceConnection, TimeUnit.MILLISECONDS);
            if (iSetupCompatService != null) {
                iSetupCompatService.onFocusStatusChanged(bundle);
            } else {
                LOG.mo55164w("Report focusChange failed since service reference is null. Are the permission valid?");
            }
        } catch (RemoteException | InterruptedException | UnsupportedOperationException | TimeoutException e) {
            LOG.mo55160e(String.format("Exception occurred while %s trying report windowFocusChange to SetupWizard.", str), e);
        }
    }

    /* access modifiers changed from: private */
    /* renamed from: invokeBindBack */
    public void mo54926x485a6bf2(String str, Bundle bundle) {
        try {
            ISetupCompatService iSetupCompatService = SetupCompatServiceProvider.get(this.context, this.waitTimeInMillisForServiceConnection, TimeUnit.MILLISECONDS);
            if (iSetupCompatService != null) {
                iSetupCompatService.validateActivity(str, bundle);
            } else {
                LOG.mo55164w("BindBack failed since service reference is null. Are the permissions valid?");
            }
        } catch (RemoteException | InterruptedException | TimeoutException e) {
            LOG.mo55160e(String.format("Exception occurred while %s trying bind back to SetupWizard.", str), e);
        }
    }
