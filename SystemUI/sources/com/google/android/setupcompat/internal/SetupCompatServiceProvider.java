...
public class SetupCompatServiceProvider {
    ...
    private synchronized void requestServiceBind() {
        /*
            ...
            monitor-enter(r5)
            com.google.android.setupcompat.internal.SetupCompatServiceProvider$ServiceContext r1 = r5.getCurrentServiceState()     // Catch:{ all -> 0x0079 }
            com.google.android.setupcompat.internal.SetupCompatServiceProvider$State r2 = r1.state     // Catch:{ all -> 0x0079 }
            com.google.android.setupcompat.internal.SetupCompatServiceProvider$State r3 = com.google.android.setupcompat.internal.SetupCompatServiceProvider.State.CONNECTED     // Catch:{ all -> 0x0079 }
            ...
            return
        L_0x0016:
            com.google.android.setupcompat.internal.SetupCompatServiceProvider$State r1 = r1.state     // Catch:{ all -> 0x0079 }
            com.google.android.setupcompat.internal.SetupCompatServiceProvider$State r2 = com.google.android.setupcompat.internal.SetupCompatServiceProvider.State.NOT_STARTED     // Catch:{ all -> 0x0079 }
            ...
            r1.atInfo(r2)     // Catch:{ all -> 0x0079 }
            android.content.Context r1 = r5.context     // Catch:{ all -> 0x0079 }
            android.content.ServiceConnection r2 = r5.serviceConnection     // Catch:{ all -> 0x0079 }
            r1.unbindService(r2)     // Catch:{ all -> 0x0079 }
        L_0x002a:
            android.content.Context r1 = r5.context     // Catch:{ SecurityException -> 0x0036 }
            android.content.Intent r2 = COMPAT_SERVICE_INTENT     // Catch:{ SecurityException -> 0x0036 }
            android.content.ServiceConnection r3 = r5.serviceConnection     // Catch:{ SecurityException -> 0x0036 }
            r4 = 1
            boolean r0 = r1.bindService(r2, r3, r4)     // Catch:{ SecurityException -> 0x0036 }
            goto L_0x004a
        L_0x0036:
            r1 = move-exception
            com.google.android.setupcompat.util.Logger r2 = LOG     // Catch:{ all -> 0x0079 }
        ...
        L_0x004a:
            ...
            com.google.android.setupcompat.internal.SetupCompatServiceProvider$State r0 = r5.getCurrentState()     // Catch:{ all -> 0x0079 }
    ...
    public void swapServiceContextAndNotify(ServiceContext serviceContext2) {
        LOG.atInfo(String.format("State changed: %s -> %s", this.serviceContext.state, serviceContext2.state));
