    ...
    static void updateButtonBackgroundTintList(Context context, Button button, int i, float f, int i2) {
        ...
        if (i != 0) {
            if (f <= 0.0f) {
                ...
                f = obtainStyledAttributes.getFloat(0, DEFAULT_DISABLED_ALPHA);
