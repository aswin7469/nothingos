...
public class GlifPreferenceLayout extends GlifRecyclerLayout {
    ...
    public View onInflateTemplate(LayoutInflater layoutInflater, int i) {
        if (i == 0) {
            i = C3963R.layout.sud_glif_preference_template;
        }
    ...
    public void onTemplateInflated() {
        this.recyclerMixin = new RecyclerMixin(this, (RecyclerView) LayoutInflater.from(getContext()).inflate(C3963R.layout.sud_glif_preference_recycler_view, this, false));
    }
}
