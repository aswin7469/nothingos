...
public final class GsonBuilder {
    ...
    private void addTypeAdaptersForDate(String str, int i, int i2, List<TypeAdapterFactory> list) {
        ...
        if (str != null && !"".equals(str.trim())) {
            defaultDateTypeAdapter3 = new DefaultDateTypeAdapter((Class<? extends Date>) Date.class, str);
            defaultDateTypeAdapter2 = new DefaultDateTypeAdapter((Class<? extends Date>) Timestamp.class, str);
            defaultDateTypeAdapter = new DefaultDateTypeAdapter((Class<? extends Date>) java.sql.Date.class, str);
        } else if (i != 2 && i2 != 2) {
        ...
        list.add(TypeAdapters.newFactory(Date.class, defaultDateTypeAdapter3));
        list.add(TypeAdapters.newFactory(Timestamp.class, defaultDateTypeAdapter2));
        list.add(TypeAdapters.newFactory(java.sql.Date.class, defaultDateTypeAdapter));
    }
}
