...
public final class C$Gson$Types {
    ...
    public static boolean equals(Type type, Type type2) {
        ...
        if (type instanceof ParameterizedType) {
            ...
            if (!equal(parameterizedType.getOwnerType(), parameterizedType2.getOwnerType()) || !parameterizedType.getRawType().equals(parameterizedType2.getRawType()) || !Arrays.equals((Object[]) parameterizedType.getActualTypeArguments(), (Object[]) parameterizedType2.getActualTypeArguments())) {
                return false;
            }
            return true;
        } else if (type instanceof GenericArrayType) {
            ...
            if (!Arrays.equals((Object[]) wildcardType.getUpperBounds(), (Object[]) wildcardType2.getUpperBounds()) || !Arrays.equals((Object[]) wildcardType.getLowerBounds(), (Object[]) wildcardType2.getLowerBounds())) {
                return false;
            }
            return true;
    ...
    private static final class ParameterizedTypeImpl implements ParameterizedType, Serializable {
        ...
        public int hashCode() {
            return C$Gson$Types.hashCodeOrZero(this.ownerType) ^ (Arrays.hashCode((Object[]) this.typeArguments) ^ this.rawType.hashCode());
        }
