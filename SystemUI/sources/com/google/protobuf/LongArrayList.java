...
final class LongArrayList extends AbstractProtobufList<Long> implements Internal.LongList, RandomAccess {
    ...
    private void addLong(int i, long j) {
        ...
        long[] jArr = this.array;
        if (i2 < jArr.length) {
            System.arraycopy((Object) jArr, i, (Object) jArr, i + 1, i2 - i);
        } else {
            long[] jArr2 = new long[(((i2 * 3) / 2) + 1)];
            System.arraycopy((Object) jArr, 0, (Object) jArr2, 0, i);
            System.arraycopy((Object) this.array, i, (Object) jArr2, i + 1, this.size - i);
            this.array = jArr2;
        }
        this.array[i] = j;
        this.size++;
    ...
    public boolean remove(Object obj) {
        ...
        for (int i = 0; i < this.size; i++) {
            if (obj.equals(Long.valueOf(this.array[i]))) {
                long[] jArr = this.array;
                System.arraycopy((Object) jArr, i + 1, (Object) jArr, i, this.size - i);
                this.size--;
                this.modCount++;
                return true;
            }
