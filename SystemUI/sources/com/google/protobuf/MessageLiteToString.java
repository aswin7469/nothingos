...
final class MessageLiteToString {
    ...
    private static void reflectivePrintWithIndent(MessageLite messageLite, StringBuilder sb, int i) {
        ...
        for (String replaceFirst : treeSet) {
            ...
            if (((Method) hashMap2.get("set" + replaceFirst2)) != null && (!replaceFirst2.endsWith(BYTES_SUFFIX) || !hashMap.containsKey("get" + replaceFirst2.substring(0, replaceFirst2.length() - 5)))) {
        ...
        if (messageLite instanceof GeneratedMessageLite.ExtendableMessage) {
            ...
            while (it.hasNext()) {
                ...
                printField(sb, i, NavigationBarInflaterView.SIZE_MOD_START + ((GeneratedMessageLite.ExtensionDescriptor) next.getKey()).getNumber() + NavigationBarInflaterView.SIZE_MOD_END, next.getValue());
            }
        }
    ...
    static final void printField(StringBuilder sb, int i, String str, Object obj) {
        ...
        if (obj instanceof String) {
            sb.append(": \"").append(TextFormatEscaper.escapeText((String) obj)).append((char) Typography.quote);
        } else if (obj instanceof ByteString) {
            sb.append(": \"").append(TextFormatEscaper.escapeBytes((ByteString) obj)).append((char) Typography.quote);
