...
public final class CodedInputByteBufferNano {
    ...
    public byte[] readBytes() throws IOException {
        ...
        if (readRawVarint32 <= i - i2 && readRawVarint32 > 0) {
            ...
            System.arraycopy((Object) this.buffer, i2, (Object) bArr, 0, readRawVarint32);
            this.bufferPos += readRawVarint32;
            return bArr;
    ...
    public byte[] getData(int i, int i2) {
        ...
        System.arraycopy((Object) this.buffer, this.bufferStart + i, (Object) bArr, 0, i2);
        return bArr;
    }
    ...
    public byte[] readRawBytes(int i) throws IOException {
        if (i >= 0) {
            ...
            if (i3 > i4) {
                ...
                System.arraycopy((Object) this.buffer, i2, (Object) bArr, 0, i);
                this.bufferPos += i;
                return bArr;
            } else {
                throw InvalidProtocolBufferNanoException.truncatedMessage();
