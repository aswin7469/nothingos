...
public final class PlanarYUVLuminanceSource extends LuminanceSource {
    ...
    public byte[] getRow(int i, byte[] bArr) {
        ...
        System.arraycopy((Object) this.yuvData, ((i + this.top) * this.dataWidth) + this.left, (Object) bArr, 0, width);
        return bArr;
    }
    ...
    public byte[] getMatrix() {
        ...
        if (width == i) {
            System.arraycopy((Object) this.yuvData, i3, (Object) bArr, 0, i2);
            return bArr;
        }
        for (int i4 = 0; i4 < height; i4++) {
            System.arraycopy((Object) this.yuvData, i3, (Object) bArr, i4 * width, width);
            i3 += this.dataWidth;
        }
        return bArr;
    }
