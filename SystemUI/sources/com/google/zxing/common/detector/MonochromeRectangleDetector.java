...
public final class MonochromeRectangleDetector {
    ...
    public ResultPoint[] detect() throws NotFoundException {
        ...
        int i10 = -max2;
        int y = ((int) findCornerFromCenter(i5, 0, 0, i6, i7, i3, 0, i8, i4).getY()) - 1;
        int i11 = max2;
        int i12 = i / 2;
        ResultPoint findCornerFromCenter = findCornerFromCenter(i5, i10, 0, i6, i7, 0, y, i8, i12);
        int x = ((int) findCornerFromCenter.getX()) - 1;
        ResultPoint findCornerFromCenter2 = findCornerFromCenter(i5, i11, x, i6, i7, 0, y, i8, i12);
        int x2 = ((int) findCornerFromCenter2.getX()) + 1;
        ResultPoint findCornerFromCenter3 = findCornerFromCenter(i5, 0, x, x2, i7, i9, y, i8, i4);
        return new ResultPoint[]{findCornerFromCenter(i5, 0, x, x2, i7, i3, y, ((int) findCornerFromCenter3.getY()) + 1, i2 / 4), findCornerFromCenter, findCornerFromCenter2, findCornerFromCenter3};
    }
    ...
    private ResultPoint findCornerFromCenter(int i, int i2, int i3, int i4, int i5, int i6, int i7, int i8, int i9) throws NotFoundException {
        ...
        while (i14 < i12 && i14 >= i7 && i13 < i4 && i13 >= i3) {
            if (i2 == 0) {
                iArr = blackWhiteRange(i14, i9, i3, i4, true);
            } else {
                iArr = blackWhiteRange(i13, i9, i7, i8, false);
            }
            if (iArr != null) {
                i14 += i6;
                i13 += i2;
