...
public final class Code39Reader extends OneDReader {
    ...
    static final int[] CHARACTER_ENCODINGS = {52, UCharacter.UnicodeBlock.MEDEFAIDRIN_ID, 97, SysUiStatsLog.SMARTSPACE_CARD_REPORTED, 49, 304, 112, 37, UCharacter.UnicodeBlock.EGYPTIAN_HIEROGLYPH_FORMAT_CONTROLS_ID, 100, 265, 73, 328, 25, 280, 88, 13, 268, 76, 28, 259, 67, 322, 19, UCharacter.UnicodeBlock.CJK_UNIFIED_IDEOGRAPHS_EXTENSION_F_ID, 82, 7, 262, 70, 22, 385, 193, StackStateAnimator.ANIMATION_DURATION_GO_TO_FULL_SHADE, 145, 400, 208, 133, 388, 196, 168, 162, 138, 42};
                    ...
                    if (nextSet2 == size || i6 * 2 >= i4) {
                        if (this.usingCheckDigit) {
                            ...
                            for (int i8 = 0; i8 < length; i8++) {
                                i7 += ALPHABET_STRING.indexOf((int) this.decodeRowResult.charAt(i8));
                            }
                        ...
                        if (sb.length() != 0) {
                            ...
                            float f = (float) i;
                            Result result = new Result(str, (byte[]) null, new ResultPoint[]{new ResultPoint(((float) (findAsteriskPattern[1] + findAsteriskPattern[0])) / 2.0f, f), new ResultPoint(((float) nextSet) + (((float) i4) / 2.0f), f)}, BarcodeFormat.CODE_39);
