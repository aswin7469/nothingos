    ...
    public boolean[] encode(String str) {
        ...
        if (length <= 80) {
            ...
            while (true) {
                if (i >= length) {
                    break;
                } else if ("0123456789ABCDEFGHIJKLMNOPQRSTUVWXYZ-. $/+%".indexOf((int) str.charAt(i)) < 0) {
            ...
            for (int i2 = 0; i2 < length; i2++) {
                toIntArray(Code39Reader.CHARACTER_ENCODINGS["0123456789ABCDEFGHIJKLMNOPQRSTUVWXYZ-. $/+%".indexOf((int) str.charAt(i2))], iArr);
