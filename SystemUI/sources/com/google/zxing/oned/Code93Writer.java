...
public class Code93Writer extends OneDimensionalCodeWriter {
    ...
    public boolean[] encode(String str) {
        ...
        if (length <= 80) {
            ...
            for (int i = 0; i < length; i++) {
                appendPattern += appendPattern(zArr, appendPattern, Code93Reader.CHARACTER_ENCODINGS["0123456789ABCDEFGHIJKLMNOPQRSTUVWXYZ-. $/+%abcd*".indexOf((int) convertToExtended.charAt(i))]);
            }
    ...
    private static int computeChecksumIndex(String str, int i) {
        ...
        for (int length = str.length() - 1; length >= 0; length--) {
            i2 += "0123456789ABCDEFGHIJKLMNOPQRSTUVWXYZ-. $/+%abcd*".indexOf((int) str.charAt(length)) * i3;
            i3++;
            if (i3 > i) {
                i3 = 1;
            }
