...
public final class ITFReader extends OneDReader {
    ...
    public Result decodeRow(int i, BitArray bitArray, Map<DecodeHintType, ?> map) throws FormatException, NotFoundException {
        ...
        if (z) {
            float f = (float) i;
            Result result = new Result(sb2, (byte[]) null, new ResultPoint[]{new ResultPoint((float) decodeStart[1], f), new ResultPoint((float) decodeEnd[0], f)}, BarcodeFormat.ITF);
    ...
    private void validateQuietZone(BitArray bitArray, int i) throws NotFoundException {
        ...
        int i2 = i - 1;
        while (min > 0 && i2 >= 0 && !bitArray.get(i2)) {
            min--;
            i2--;
        }
        if (min != 0) {
    ...
    private int[] decodeEnd(com.google.zxing.common.BitArray r6) throws com.google.zxing.NotFoundException {
        /*
            r5 = this;
            r6.reverse()
            int r0 = skipWhiteSpace(r6)     // Catch:{ all -> 0x0035 }
            r1 = 1
            r2 = 0
            int[][] r3 = END_PATTERN_REVERSED     // Catch:{ NotFoundException -> 0x0012 }
            r3 = r3[r2]     // Catch:{ NotFoundException -> 0x0012 }
            int[] r0 = findGuardPattern(r6, r0, r3)     // Catch:{ NotFoundException -> 0x0012 }
            goto L_0x001a
        L_0x0012:
            int[][] r3 = END_PATTERN_REVERSED     // Catch:{ all -> 0x0035 }
            r3 = r3[r1]     // Catch:{ all -> 0x0035 }
            int[] r0 = findGuardPattern(r6, r0, r3)     // Catch:{ all -> 0x0035 }
        L_0x001a:
            r3 = r0[r2]     // Catch:{ all -> 0x0035 }
            r5.validateQuietZone(r6, r3)     // Catch:{ all -> 0x0035 }
            r5 = r0[r2]     // Catch:{ all -> 0x0035 }
            int r3 = r6.getSize()     // Catch:{ all -> 0x0035 }
            r4 = r0[r1]     // Catch:{ all -> 0x0035 }
            int r3 = r3 - r4
            r0[r2] = r3     // Catch:{ all -> 0x0035 }
            int r2 = r6.getSize()     // Catch:{ all -> 0x0035 }
            int r2 = r2 - r5
        ...
        while (i < size) {
            if (bitArray.get(i) != z) {
                ...
                if (i3 != length - 1) {
                    ...
                    i2 += iArr2[0] + iArr2[1];
                    int i4 = i3 - 1;
                    System.arraycopy((Object) iArr2, 2, (Object) iArr2, 0, i4);
                    iArr2[i4] = 0;
                    iArr2[i3] = 0;
                    i3--;
                }
