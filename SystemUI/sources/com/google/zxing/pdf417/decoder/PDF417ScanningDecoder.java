...
import com.google.zxing.pdf417.decoder.p022ec.ErrorCorrection;
...
public final class PDF417ScanningDecoder {
    ...
    public static DecoderResult decode(BitMatrix bitMatrix, ResultPoint resultPoint, ResultPoint resultPoint2, ResultPoint resultPoint3, ResultPoint resultPoint4, int i, int i2) throws NotFoundException, FormatException, ChecksumException {
        ...
        int i8 = i2;
        int i9 = 1;
        while (i9 <= barcodeColumnCount2) {
            int i10 = z3 ? i9 : barcodeColumnCount2 - i9;
            if (merge.getDetectionResultColumn(i10) == null) {
                if (i10 == 0 || i10 == barcodeColumnCount2) {
                    detectionResultRowIndicatorColumn = new DetectionResultRowIndicatorColumn(boundingBox, i10 == 0 ? z : false);
                } else {
                ...
                while (minY <= boundingBox.getMaxY()) {
                    ...
                    i3 = i11;
                    detectionResultColumn = detectionResultColumn2;
                    Codeword detectCodeword = detectCodeword(bitMatrix, boundingBox.getMinX(), boundingBox.getMaxX(), z3, i6, i13, i7, i8);
                    i4 = i13;
    ...
    private static BarcodeValue[][] createBarcodeMatrix(DetectionResult detectionResult) {
        ...
        BarcodeValue[][] barcodeValueArr = (BarcodeValue[][]) Array.newInstance((Class<?>) BarcodeValue.class, iArr);
    ...
    public static java.lang.String toString(com.google.zxing.pdf417.decoder.BarcodeValue[][] r9) {
        ...
        L_0x0007:
            ...
            r4 = 1
            java.lang.Object[] r5 = new java.lang.Object[r4]     // Catch:{ all -> 0x0066 }
            java.lang.Integer r6 = java.lang.Integer.valueOf((int) r2)     // Catch:{ all -> 0x0066 }
            r5[r1] = r6     // Catch:{ all -> 0x0066 }
            r0.format(r3, r5)     // Catch:{ all -> 0x0066 }
            r3 = r1
        L_0x0019:
            r5 = r9[r2]     // Catch:{ all -> 0x0066 }
            int r6 = r5.length     // Catch:{ all -> 0x0066 }
            if (r3 >= r6) goto L_0x0054
            r5 = r5[r3]     // Catch:{ all -> 0x0066 }
            int[] r6 = r5.getValue()     // Catch:{ all -> 0x0066 }
            int r6 = r6.length     // Catch:{ all -> 0x0066 }
            if (r6 != 0) goto L_0x0031
            java.lang.String r5 = "        "
            r6 = 0
            r7 = r6
            java.lang.Object[] r7 = (java.lang.Object[]) r7     // Catch:{ all -> 0x0066 }
            r0.format(r5, r6)     // Catch:{ all -> 0x0066 }
            goto L_0x0051
        L_0x0031:
            java.lang.String r6 = "%4d(%2d)"
            r7 = 2
            java.lang.Object[] r7 = new java.lang.Object[r7]     // Catch:{ all -> 0x0066 }
            int[] r8 = r5.getValue()     // Catch:{ all -> 0x0066 }
            r8 = r8[r1]     // Catch:{ all -> 0x0066 }
            java.lang.Integer r8 = java.lang.Integer.valueOf((int) r8)     // Catch:{ all -> 0x0066 }
            r7[r1] = r8     // Catch:{ all -> 0x0066 }
            int[] r8 = r5.getValue()     // Catch:{ all -> 0x0066 }
            r8 = r8[r1]     // Catch:{ all -> 0x0066 }
            java.lang.Integer r5 = r5.getConfidence(r8)     // Catch:{ all -> 0x0066 }
            r7[r4] = r5     // Catch:{ all -> 0x0066 }
            r0.format(r6, r7)     // Catch:{ all -> 0x0066 }
        L_0x0051:
            int r3 = r3 + 1
            goto L_0x0019
        L_0x0054:
            ...
            r0.format(r3, r4)     // Catch:{ all -> 0x0066 }
            int r2 = r2 + 1
            goto L_0x0007
        L_0x005e:
            java.lang.String r9 = r0.toString()     // Catch:{ all -> 0x0066 }
            r0.close()
            return r9
        L_0x0066:
            r9 = move-exception
