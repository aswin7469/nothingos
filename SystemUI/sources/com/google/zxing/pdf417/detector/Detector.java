...
public final class Detector {
    ...
    private static java.util.List<com.google.zxing.ResultPoint[]> detect(boolean r8, com.google.zxing.common.BitMatrix r9) {
        ...
        L_0x0024:
            ...
            float r2 = (float) r2
            float r7 = r7.getY()
            float r2 = java.lang.Math.max((float) r2, (float) r7)
            int r2 = (int) r2
        L_0x003e:
            r4 = r4[r5]
            ...
            float r4 = r4.getY()
            int r4 = (int) r4
            int r2 = java.lang.Math.max((int) r2, (int) r4)
            goto L_0x0024
        L_0x004c:
            int r2 = r2 + 5
            r3 = r1
    ...
    private static ResultPoint[] findRowsWithPattern(BitMatrix bitMatrix, int i, int i2, int i3, int i4, int[] iArr) {
        ...
        if (i12 - i8 < 10) {
            Arrays.fill((Object[]) resultPointArr, (Object) null);
        }
        return resultPointArr;
    }
        ...
        while (i < i3) {
            if (bitMatrix.get(i, i2) != z) {
                ...
                if (i7 != length - 1) {
                    ...
                    i6 += iArr2[0] + iArr2[1];
                    int i8 = i7 - 1;
                    System.arraycopy((Object) iArr2, 2, (Object) iArr2, 0, i8);
                    iArr2[i8] = 0;
                    iArr2[i7] = 0;
                    i7--;
                }
