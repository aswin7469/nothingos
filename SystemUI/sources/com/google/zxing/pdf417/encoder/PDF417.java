...
public final class PDF417 {
    ...
    public void generateBarcodeLogic(String str, int i) throws WriterException {
        generateBarcodeLogic(str, i, false);
    }

    public void generateBarcodeLogic(String str, int i, boolean z) throws WriterException {
        int errorCorrectionCodewordCount = PDF417ErrorCorrection.getErrorCorrectionCodewordCount(i);
        String encodeHighLevel = PDF417HighLevelEncoder.encodeHighLevel(str, this.compaction, this.encoding, z);
