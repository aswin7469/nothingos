...
public class QSPanelEx {
    ...
    private final C4191H handler = new C4191H();
    ...
    @Metadata(mo64986d1 = {"\u0000\u001a\n\u0002\u0018\u0002\n\u0002\u0010\u0000\n\u0002\b\u0002\n\u0002\u0010\b\n\u0002\b\u0002\n\u0002\u0010\u000e\n\u0000\b\u0003\u0018\u00002\u00020\u0001B\u0007\b\u0002¢\u0006\u0002\u0010\u0002R\u000e\u0010\u0003\u001a\u00020\u0004XT¢\u0006\u0002\n\u0000R\u000e\u0010\u0005\u001a\u00020\u0004XT¢\u0006\u0002\n\u0000R\u000e\u0010\u0006\u001a\u00020\u0007XT¢\u0006\u0002\n\u0000¨\u0006\b"}, mo64987d2 = {"Lcom/nothing/systemui/qs/QSPanelEx$Companion;", "", "()V", "ADD_TILE", "", "REMOVE_TILE", "TAG", "", "SystemUI_nothingRelease"}, mo64988k = 1, mo64989mv = {1, 6, 0}, mo64991xi = 48)
            ...
            if (state.addressList != null && !state.addressList.isEmpty()) {
                for (Map.Entry entry : this.cacheBtDevices.entrySet()) {
                    ...
                    if (!state.addressList.contains(charSequence)) {
                        NTLogUtil.m1680d(TAG, "onStateChanged: remove pre device " + charSequence);
                ...
                for (int i = 0; i < size; i++) {
                    ...
                    if (tileRecord3 == null) {
                        ...
                        NTLogUtil.m1680d(TAG, "onStateChanged: create bt device " + charSequence3);
                    }
                ...
                for (Map.Entry entry2 : this.cacheBtDevices.entrySet()) {
                    ...
                    NTLogUtil.m1680d(TAG, "onStateChanged: remove device " + ((CharSequence) entry2.getKey()));
                }
    ...
    public void createCirclePagedTileLayouts(Context context, QSPanel qSPanel) {
        ...
        NTLogUtil.m1680d(TAG, "createCirclePagedTileLayouts");
        ...
        View inflate = from.inflate(C1893R.layout.circle_qs_tile_layout, qSPanel2, false);
        ...
        CirclePagedTileLayout circlePagedTileLayout2 = (CirclePagedTileLayout) inflate.findViewById(C1893R.C1897id.signal_tile_page);
        ...
        CirclePagedTileLayout circlePagedTileLayout3 = (CirclePagedTileLayout) view.findViewById(C1893R.C1897id.bt_tile_page);
        ...
        PageIndicator pageIndicator = (PageIndicator) view2.findViewById(C1893R.C1897id.signal_tile_indicator);
        ...
        PageIndicator pageIndicator2 = (PageIndicator) view3.findViewById(C1893R.C1897id.bt_tile_indicator);
        ...
        NTLogUtil.m1680d(TAG, "checkNull: false");
    }
    ...
    public void removeAndRecreateCirclePagedTileLayouts(Context context) {
        ...
        NTLogUtil.m1680d(TAG, "removeAndRecreateCirclePagedTileLayouts");
        QSPanel qSPanel3 = this.qsPanel;
        if (qSPanel3 == null) {
            Intrinsics.throwUninitializedPropertyAccessException("qsPanel");
        } else {
    ...
    @Metadata(mo64986d1 = {"\u0000\u0018\n\u0002\u0018\u0002\n\u0002\u0018\u0002\n\u0002\b\u0002\n\u0002\u0010\u0002\n\u0000\n\u0002\u0018\u0002\n\u0000\b\u0004\u0018\u00002\u00020\u0001B\u0005¢\u0006\u0002\u0010\u0002J\u0010\u0010\u0003\u001a\u00020\u00042\u0006\u0010\u0005\u001a\u00020\u0006H\u0016¨\u0006\u0007"}, mo64987d2 = {"Lcom/nothing/systemui/qs/QSPanelEx$H;", "Landroid/os/Handler;", "(Lcom/nothing/systemui/qs/QSPanelEx;)V", "handleMessage", "", "msg", "Landroid/os/Message;", "SystemUI_nothingRelease"}, mo64988k = 1, mo64989mv = {1, 6, 0}, mo64991xi = 48)
    /* renamed from: com.nothing.systemui.qs.QSPanelEx$H */
    /* compiled from: QSPanelEx.kt */
    private final class C4191H extends Handler {
        public C4191H() {
        }
