...
@Metadata(mo64986d1 = {"\u0000\u0017\n\u0000\n\u0002\u0018\u0002\n\u0000\n\u0002\u0010\u0002\n\u0000\n\u0002\u0018\u0002\n\u0000*\u0001\u0000\b\n\u0018\u00002\u00020\u0001J\u0010\u0010\u0002\u001a\u00020\u00032\u0006\u0010\u0004\u001a\u00020\u0005H\u0016¨\u0006\u0006"}, mo64987d2 = {"com/nothing/systemui/qs/tiles/BluetoothTileEx$setClickListener$1", "Landroid/view/View$OnClickListener;", "onClick", "", "v", "Landroid/view/View;", "SystemUI_nothingRelease"}, mo64988k = 1, mo64989mv = {1, 6, 0}, mo64991xi = 48)
    ...
    public void onClick(View view) {
        ...
        if (!access$getBluetoothController$p.isBluetoothConnected()) {
            ...
            if (!access$getTeslaInfoController$p.shouldShowTeslaInfo() || this.this$0.qSFragmentEx.getBtPageIndex() != 0) {
                ...
                NTLogUtil.m1680d("BluetoothTileEx", "setBluetoothEnabled: " + (!isBluetoothEnabled));
                BluetoothTile access$getTile$p = this.this$0.tile;
                Intrinsics.checkNotNull(access$getTile$p);
                access$getTile$p.refreshStateInternal(isBluetoothEnabled ? null : QSTileImpl.ARG_SHOW_TRANSIENT_ENABLING);
                view.post(new BluetoothTileEx$setClickListener$1$$ExternalSyntheticLambda0(this.this$0, isBluetoothEnabled));
                return;
            }
        }
        BluetoothTile access$getTile$p2 = this.this$0.tile;
        Intrinsics.checkNotNull(access$getTile$p2);
        access$getTile$p2.handleIconClick(view, false);
    }

    /* access modifiers changed from: private */
    /* renamed from: onClick$lambda-0  reason: not valid java name */
    public static final void m3518onClick$lambda0(BluetoothTileEx bluetoothTileEx, boolean z) {
