...
public class ScreenshotViewEx {
    ...
    public static void updateScreenshotPreviewBorder(boolean z, Context context, ImageView imageView, View view, float f) {
        ...
        if (drawable == null) {
            NTLogUtil.m1681e(TAG, " updateScreenshotPreviewBorder drawable is null");
            return;
        }
        int intrinsicWidth = drawable.getIntrinsicWidth();
        int intrinsicHeight = drawable.getIntrinsicHeight();
        ViewGroup.LayoutParams layoutParams = view.getLayoutParams();
        int dimension = (int) (context.getResources().getDimension(C1893R.dimen.overlay_border_width) * 2.0f);
        if (z) {
        ...
        NTLogUtil.m1681e(TAG, " updateScreenshotPreviewBorder drawable h:" + intrinsicHeight + " w:" + intrinsicWidth + " Params.width:" + layoutParams.width + " bordeParams.height:" + layoutParams.height + " orientationPortrait:" + z);
