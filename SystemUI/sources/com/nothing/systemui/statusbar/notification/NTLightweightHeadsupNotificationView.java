...
public class NTLightweightHeadsupNotificationView extends NTLightweightHeadsupView implements View.OnClickListener, SwipeHelper.Callback {
    ...
    public int getInflateLayoutId() {
        return C1893R.layout.lightweight_headsup_notification_layout;
    }
    ...
    public int getLayoutWidth() {
        int dimensionPixelSize = getResources().getDimensionPixelSize(C1893R.dimen.nt_pop_view_margin_start) + getResources().getDimensionPixelSize(C1893R.dimen.nt_pop_icon_diameter) + getResources().getDimensionPixelSize(C1893R.dimen.nt_pop_view_margin_mid) + getResources().getDimensionPixelSize(C1893R.dimen.nt_pop_view_margin_end) + getLargerTextViewWidth();
        int dimensionPixelSize2 = getResources().getDimensionPixelSize(C1893R.dimen.nt_pop_view_min_width);
        int dimensionPixelSize3 = getResources().getDimensionPixelSize(C1893R.dimen.nt_pop_view_max_width);
    ...
    public int calculateTextLayoutWidth() {
        int dimensionPixelSize = getResources().getDimensionPixelSize(C1893R.dimen.nt_pop_view_margin_start) + getResources().getDimensionPixelSize(C1893R.dimen.nt_pop_icon_diameter) + getResources().getDimensionPixelSize(C1893R.dimen.nt_pop_view_margin_mid) + getResources().getDimensionPixelSize(C1893R.dimen.nt_pop_view_margin_end);
        int largerTextViewWidth = getLargerTextViewWidth();
        int dimensionPixelSize2 = getResources().getDimensionPixelSize(C1893R.dimen.nt_pop_view_max_width);
    ...
    public void init() {
        /*
            ...
            if (r0 == 0) goto L_0x001b
            r1 = 2131166677(0x7f0705d5, float:1.7947606E38)
    ...
    @Metadata(mo64986d1 = {"\u0000\u001a\n\u0002\u0018\u0002\n\u0002\u0010\u0000\n\u0002\b\u0002\n\u0002\u0010\u000b\n\u0002\b\u0002\n\u0002\u0010\u000e\n\u0000\b\u0003\u0018\u00002\u00020\u0001B\u0007\b\u0002¢\u0006\u0002\u0010\u0002R\u000e\u0010\u0003\u001a\u00020\u0004XT¢\u0006\u0002\n\u0000R\u000e\u0010\u0005\u001a\u00020\u0004XT¢\u0006\u0002\n\u0000R\u000e\u0010\u0006\u001a\u00020\u0007X\u0004¢\u0006\u0002\n\u0000¨\u0006\b"}, mo64987d2 = {"Lcom/nothing/systemui/statusbar/notification/NTLightweightHeadsupNotificationView$Companion;", "", "()V", "DEBUG_EDGE_SWIPE", "", "DISABLE_TOUCH_AND_SWIPE", "TAG", "", "SystemUI_nothingRelease"}, mo64988k = 1, mo64989mv = {1, 6, 0}, mo64991xi = 48)
    /* compiled from: NTLightweightHeadsupNotificationView.kt */
