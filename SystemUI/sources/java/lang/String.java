...
public final class String implements Serializable, Comparable<String>, CharSequence {
    ...
    public int codePointAt(int i) {
        checkIndex(i, length());
        return Character.codePointAt((CharSequence) this, i);
    }

    public int codePointBefore(int i) {
        int i2 = i - 1;
        if (i2 >= 0 && i2 < length()) {
            return Character.codePointBefore((CharSequence) this, i);
        }
    ...
    public int codePointCount(int i, int i2) {
        if (i >= 0 && i <= i2 && i2 <= length()) {
            return Character.codePointCount((CharSequence) this, i, i2);
        }
    ...
    public String replace(CharSequence charSequence, CharSequence charSequence2) {
        ...
        if (length3 >= 0) {
            ...
            int i = 0;
            do {
                sb.append((CharSequence) this, i, indexOf);
                sb.append(charSequence4);
                i = indexOf + length;
                if (indexOf >= length2 || (indexOf = indexOf(charSequence3, indexOf + max)) <= 0) {
                    sb.append((CharSequence) this, i, length2);
                }
                sb.append((CharSequence) this, i, indexOf);
                sb.append(charSequence4);
                i = indexOf + length;
                break;
            } while ((indexOf = indexOf(charSequence3, indexOf + max)) <= 0);
            sb.append((CharSequence) this, i, length2);
            return sb.toString();
        }
    ...
    public static String join(CharSequence charSequence, CharSequence... charSequenceArr) {
        ...
        for (CharSequence add : charSequenceArr) {
