...
public abstract class Buffer {
        ...
        if (i4 >= 0) {
            ...
            if (i >= 0) {
                if (i <= i2) {
                    ...
                    throw new IllegalArgumentException("mark > position: (" + i + " > " + i2 + NavigationBarInflaterView.KEY_CODE_END);
                }
            }
    ...
    public final int checkIndex(int i) {
        ...
        throw new IndexOutOfBoundsException("index=" + i + " out of bounds (limit=" + this.limit + NavigationBarInflaterView.KEY_CODE_END);
    }
    ...
    public final int checkIndex(int i, int i2) {
        ...
        throw new IndexOutOfBoundsException("index=" + i + " out of bounds (limit=" + this.limit + ", nb=" + i2 + NavigationBarInflaterView.KEY_CODE_END);
    }
    ...
    static void checkBounds(int i, int i2, int i3) {
        int i4 = i + i2;
        if ((i | i2 | i4 | (i3 - i4)) < 0) {
            throw new IndexOutOfBoundsException("off=" + i + ", len=" + i2 + " out of bounds (size=" + i3 + NavigationBarInflaterView.KEY_CODE_END);
        }
    }
