...
public class CertificateFactory {
    ...
    public static final CertificateFactory getInstance(String str) throws CertificateException {
        try {
            GetInstance.Instance instance = GetInstance.getInstance("CertificateFactory", (Class<?>) CertificateFactorySpi.class, str);
    ...
    public static final CertificateFactory getInstance(String str, String str2) throws CertificateException, NoSuchProviderException {
        try {
            ...
            GetInstance.Instance instance = GetInstance.getInstance("CertificateFactory", (Class<?>) CertificateFactorySpi.class, str, str2);
            return new CertificateFactory((CertificateFactorySpi) instance.impl, instance.provider, str);
        } catch (NoSuchAlgorithmException e) {
            throw new CertificateException(str + " not found", e);
        }
    ...
    public static final CertificateFactory getInstance(String str, Provider provider2) throws CertificateException {
        try {
            Providers.checkBouncyCastleDeprecation(provider2, "CertificateFactory", str);
            GetInstance.Instance instance = GetInstance.getInstance("CertificateFactory", (Class<?>) CertificateFactorySpi.class, str, provider2);
            return new CertificateFactory((CertificateFactorySpi) instance.impl, instance.provider, str);
        } catch (NoSuchAlgorithmException e) {
            throw new CertificateException(str + " not found", e);
        }
