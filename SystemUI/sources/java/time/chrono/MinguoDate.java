...
public final class MinguoDate extends ChronoLocalDateImpl<MinguoDate> implements ChronoLocalDate, Serializable {
    ...
    /* renamed from: of */
    public static MinguoDate m949of(int i, int i2, int i3) {
        return new MinguoDate(LocalDate.m908of(i + 1911, i2, i3));
    }
    ...
    public ValueRange range(TemporalField temporalField) {
        ...
        if (isSupported(temporalField)) {
            ...
            int i = C28721.$SwitchMap$java$time$temporal$ChronoField[chronoField.ordinal()];
            if (i == 1 || i == 2 || i == 3) {
            ...
            return ValueRange.m955of(1, getProlepticYear() <= 0 ? (-range.getMinimum()) + 1 + 1911 : range.getMaximum() - 1911);
        }
    ...
    static /* synthetic */ class C28721 {
        ...
        static {
            ...
            L_0x0054:
                return
            */
            throw new UnsupportedOperationException("Method not decompiled: java.time.chrono.MinguoDate.C28721.<clinit>():void");
        }
    }
    ...
    public long getLong(TemporalField temporalField) {
        ...
        int i = C28721.$SwitchMap$java$time$temporal$ChronoField[((ChronoField) temporalField).ordinal()];
        int i2 = 1;
        if (i == 4) {
    ...
    public java.time.chrono.MinguoDate with(java.time.temporal.TemporalField r7, long r8) {
        /*
            ...
            return r6
        L_0x0010:
            int[] r1 = java.time.chrono.MinguoDate.C28721.$SwitchMap$java$time$temporal$ChronoField
            int r2 = r0.ordinal()
            r1 = r1[r2]
            r2 = 7
            r3 = 6
        ...
        L_0x003a:
            ...
            int[] r5 = java.time.chrono.MinguoDate.C28721.$SwitchMap$java$time$temporal$ChronoField
            int r0 = r0.ordinal()
            r0 = r5[r0]
            r5 = 1
