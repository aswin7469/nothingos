...
public final class ClassReference implements KClass<Object>, ClassBasedDeclarationContainer {
    ...
    static {
        ...
        for (Object next : listOf) {
            ...
            arrayList.add(TuplesKt.m1796to((Class) next, Integer.valueOf(i)));
            i = i2;
        }
        ...
        for (String str : values) {
            ...
            Pair pair = TuplesKt.m1796to(sb.append(StringsKt.substringAfterLast$default(str, '.', (String) null, 2, (Object) null)).append("CompanionObject").toString(), str + ".Companion");
