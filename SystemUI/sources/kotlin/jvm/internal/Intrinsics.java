...
public class Intrinsics {
    ...
    public static void throwAssert(String str) {
        throw ((AssertionError) sanitizeStackTrace(new AssertionError((Object) str)));
    }
    ...
    public static void checkReturnedValueIsNotNull(Object obj, String str, String str2) {
        if (obj == null) {
            throw ((IllegalStateException) sanitizeStackTrace(new IllegalStateException("Method specified as non-null returned null: " + str + BaseIconCache.EMPTY_CLASS_NAME + str2)));
        }
    }
    ...
    public static void checkFieldIsNotNull(Object obj, String str, String str2) {
        if (obj == null) {
            throw ((IllegalStateException) sanitizeStackTrace(new IllegalStateException("Field specified as non-null is null: " + str + BaseIconCache.EMPTY_CLASS_NAME + str2)));
        }
    }
    ...
    private static String createParameterIsNullExceptionMessage(String str) {
        ...
        return "Parameter specified as non-null is null: method " + className + BaseIconCache.EMPTY_CLASS_NAME + stackTraceElement.getMethodName() + ", parameter " + str;
    }
    ...
    static <T extends Throwable> T sanitizeStackTrace(T t, String str) {
        ...
        t.setStackTrace((StackTraceElement[]) Arrays.copyOfRange((T[]) stackTrace, i + 1, length));
        return t;
    }
