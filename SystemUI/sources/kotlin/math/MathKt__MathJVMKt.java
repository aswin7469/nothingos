...
class MathKt__MathJVMKt extends MathKt__MathHKt {
    ...
    /* renamed from: ln */
    private static final double m1814ln(double d) {
        return Math.log(d);
    }
    ...
    /* renamed from: ln */
    private static final float m1815ln(float f) {
