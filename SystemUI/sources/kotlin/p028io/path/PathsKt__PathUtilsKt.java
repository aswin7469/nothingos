...
class PathsKt__PathUtilsKt extends PathsKt__PathReadWriteKt {
    ...
    /* JADX WARNING: Code restructure failed: missing block: B:4:0x0011, code lost:
        r3 = kotlin.text.StringsKt.substringBeforeLast$default((r3 = r3.toString()), com.android.launcher3.icons.cache.BaseIconCache.EMPTY_CLASS_NAME, (java.lang.String) null, 2, (java.lang.Object) null);
     */
    ...
    public static final java.lang.String getNameWithoutExtension(java.nio.file.Path r3) {
        ...
        L_0x001d:
            return r3
        */
        throw new UnsupportedOperationException("Method not decompiled: kotlin.p028io.path.PathsKt__PathUtilsKt.getNameWithoutExtension(java.nio.file.Path):java.lang.String");
    }
    ...
    public static final java.lang.String getExtension(java.nio.file.Path r2) {
        ...
        L_0x001d:
            return r0
        */
        throw new UnsupportedOperationException("Method not decompiled: kotlin.p028io.path.PathsKt__PathUtilsKt.getExtension(java.nio.file.Path):java.lang.String");
    }
    ...
    static /* synthetic */ Path copyTo$default(Path path, Path path2, boolean z, int i, Object obj) throws IOException {
        ...
        Path copy = Files.copy(path, path2, (CopyOption[]) Arrays.copyOf((T[]) copyOptionArr, copyOptionArr.length));
    ...
    private static final boolean exists(Path path, LinkOption... linkOptionArr) {
        ...
        return Files.exists(path, (LinkOption[]) Arrays.copyOf((T[]) linkOptionArr, linkOptionArr.length));
    }

    private static final boolean notExists(Path path, LinkOption... linkOptionArr) {
        Intrinsics.checkNotNullParameter(path, "<this>");
        Intrinsics.checkNotNullParameter(linkOptionArr, "options");
        return Files.notExists(path, (LinkOption[]) Arrays.copyOf((T[]) linkOptionArr, linkOptionArr.length));
    }

    private static final boolean isRegularFile(Path path, LinkOption... linkOptionArr) {
        Intrinsics.checkNotNullParameter(path, "<this>");
        Intrinsics.checkNotNullParameter(linkOptionArr, "options");
        return Files.isRegularFile(path, (LinkOption[]) Arrays.copyOf((T[]) linkOptionArr, linkOptionArr.length));
    }

    private static final boolean isDirectory(Path path, LinkOption... linkOptionArr) {
        Intrinsics.checkNotNullParameter(path, "<this>");
        Intrinsics.checkNotNullParameter(linkOptionArr, "options");
        return Files.isDirectory(path, (LinkOption[]) Arrays.copyOf((T[]) linkOptionArr, linkOptionArr.length));
    }
    ...
    private static final boolean isSameFileAs(Path path, Path path2) throws IOException {
        Intrinsics.checkNotNullParameter(path, "<this>");
        Intrinsics.checkNotNullParameter(path2, PluralRules.KEYWORD_OTHER);
    ...
    /* JADX WARNING: Code restructure failed: missing block: B:9:0x0026, code lost:
        kotlin.p028io.CloseableKt.closeFinally(r1, r2);
     */
    /* Code decompiled incorrectly, please refer to instructions dump. */
    public static final java.util.List<java.nio.file.Path> listDirectoryEntries(java.nio.file.Path r1, java.lang.String r2) throws java.p026io.IOException {
        /*
            java.lang.String r0 = "<this>"
            kotlin.jvm.internal.Intrinsics.checkNotNullParameter(r1, r0)
            java.lang.String r0 = "glob"
            kotlin.jvm.internal.Intrinsics.checkNotNullParameter(r2, r0)
            java.nio.file.DirectoryStream r1 = java.nio.file.Files.newDirectoryStream((java.nio.file.Path) r1, (java.lang.String) r2)
            java.io.Closeable r1 = (java.p026io.Closeable) r1
            r2 = r1
            ...
            r0 = 0
            kotlin.p028io.CloseableKt.closeFinally(r1, r0)
            return r2
        L_0x0023:
            r2 = move-exception
        ...
        L_0x0025:
            ...
            throw r0
        */
        throw new UnsupportedOperationException("Method not decompiled: kotlin.p028io.path.PathsKt__PathUtilsKt.listDirectoryEntries(java.nio.file.Path, java.lang.String):java.util.List");
    }
     ...
     */
    /* Code decompiled incorrectly, please refer to instructions dump. */
    static /* synthetic */ java.lang.Object useDirectoryEntries$default(java.nio.file.Path r0, java.lang.String r1, kotlin.jvm.functions.Function1 r2, int r3, java.lang.Object r4) throws java.p026io.IOException {
        /*
            r4 = 1
            r3 = r3 & r4
        ...
        L_0x0006:
            ...
            java.nio.file.DirectoryStream r0 = java.nio.file.Files.newDirectoryStream((java.nio.file.Path) r0, (java.lang.String) r1)
        ...
        L_0x003a:
            ...
            throw r2
        */
        throw new UnsupportedOperationException("Method not decompiled: kotlin.p028io.path.PathsKt__PathUtilsKt.useDirectoryEntries$default(java.nio.file.Path, java.lang.String, kotlin.jvm.functions.Function1, int, java.lang.Object):java.lang.Object");
    }
    ...
    /* JADX WARNING: Code restructure failed: missing block: B:9:0x0036, code lost:
        kotlin.jvm.internal.InlineMarker.finallyStart(1);
        kotlin.p028io.CloseableKt.closeFinally(r2, r4);
        kotlin.jvm.internal.InlineMarker.finallyEnd(1);
     */
    /* Code decompiled incorrectly, please refer to instructions dump. */
    private static final <T> T useDirectoryEntries(java.nio.file.Path r2, java.lang.String r3, kotlin.jvm.functions.Function1<? super kotlin.sequences.Sequence<? extends java.nio.file.Path>, ? extends T> r4) throws java.p026io.IOException {
        /*
            java.lang.String r0 = "<this>"
            kotlin.jvm.internal.Intrinsics.checkNotNullParameter(r2, r0)
            java.lang.String r0 = "glob"
            ...
            java.nio.file.DirectoryStream r2 = java.nio.file.Files.newDirectoryStream((java.nio.file.Path) r2, (java.lang.String) r3)
            java.io.Closeable r2 = (java.p026io.Closeable) r2
            r3 = 1
            r0 = r2
            ...
            r0 = 0
            kotlin.p028io.CloseableKt.closeFinally(r2, r0)
        ...
        L_0x0035:
            ...
            throw r0
        */
        throw new UnsupportedOperationException("Method not decompiled: kotlin.p028io.path.PathsKt__PathUtilsKt.useDirectoryEntries(java.nio.file.Path, java.lang.String, kotlin.jvm.functions.Function1):java.lang.Object");
    }
     ...
     */
    /* Code decompiled incorrectly, please refer to instructions dump. */
    static /* synthetic */ void forEachDirectoryEntry$default(java.nio.file.Path r0, java.lang.String r1, kotlin.jvm.functions.Function1 r2, int r3, java.lang.Object r4) throws java.p026io.IOException {
        /*
            r4 = 1
            r3 = r3 & r4
            if (r3 == 0) goto L_0x0006
        ...
        L_0x0046:
            ...
            throw r2
        */
        throw new UnsupportedOperationException("Method not decompiled: kotlin.p028io.path.PathsKt__PathUtilsKt.forEachDirectoryEntry$default(java.nio.file.Path, java.lang.String, kotlin.jvm.functions.Function1, int, java.lang.Object):void");
    }
     ...
     */
    /* Code decompiled incorrectly, please refer to instructions dump. */
    private static final void forEachDirectoryEntry(java.nio.file.Path r2, java.lang.String r3, kotlin.jvm.functions.Function1<? super java.nio.file.Path, kotlin.Unit> r4) throws java.p026io.IOException {
        /*
            java.lang.String r0 = "<this>"
            kotlin.jvm.internal.Intrinsics.checkNotNullParameter(r2, r0)
            java.lang.String r0 = "glob"
        ...
        L_0x0041:
            ...
            throw r0
        */
        throw new UnsupportedOperationException("Method not decompiled: kotlin.p028io.path.PathsKt__PathUtilsKt.forEachDirectoryEntry(java.nio.file.Path, java.lang.String, kotlin.jvm.functions.Function1):void");
    }
    ...
    private static final Path createDirectory(Path path, FileAttribute<?>... fileAttributeArr) throws IOException {
        ...
        Path createDirectory = Files.createDirectory(path, (FileAttribute[]) Arrays.copyOf((T[]) fileAttributeArr, fileAttributeArr.length));
    ...
    private static final Path createDirectories(Path path, FileAttribute<?>... fileAttributeArr) throws IOException {
        Intrinsics.checkNotNullParameter(path, "<this>");
        Intrinsics.checkNotNullParameter(fileAttributeArr, "attributes");
        Path createDirectories = Files.createDirectories(path, (FileAttribute[]) Arrays.copyOf((T[]) fileAttributeArr, fileAttributeArr.length));
    ...
    private static final Path moveTo(Path path, Path path2, CopyOption... copyOptionArr) throws IOException {
        ...
        Intrinsics.checkNotNullParameter(path2, "target");
        Intrinsics.checkNotNullParameter(copyOptionArr, "options");
        Path move = Files.move(path, path2, (CopyOption[]) Arrays.copyOf((T[]) copyOptionArr, copyOptionArr.length));
    ...
    private static final Object getAttribute(Path path, String str, LinkOption... linkOptionArr) throws IOException {
        ...
        Intrinsics.checkNotNullParameter(linkOptionArr, "options");
        return Files.getAttribute(path, str, (LinkOption[]) Arrays.copyOf((T[]) linkOptionArr, linkOptionArr.length));
    }
    ...
    private static final Path setAttribute(Path path, String str, Object obj, LinkOption... linkOptionArr) throws IOException {
        ...
        Intrinsics.checkNotNullParameter(str, "attribute");
        Intrinsics.checkNotNullParameter(linkOptionArr, "options");
        Path attribute = Files.setAttribute(path, str, obj, (LinkOption[]) Arrays.copyOf((T[]) linkOptionArr, linkOptionArr.length));
    ...
    private static final /* synthetic */ <V extends FileAttributeView> V fileAttributesViewOrNull(Path path, LinkOption... linkOptionArr) {
        ...
        Class cls2 = cls;
        return Files.getFileAttributeView(path, cls, (LinkOption[]) Arrays.copyOf((T[]) linkOptionArr, linkOptionArr.length));
    }
    ...
    private static final /* synthetic */ <V extends FileAttributeView> V fileAttributesView(Path path, LinkOption... linkOptionArr) {
        ...
        Class<FileAttributeView> cls = FileAttributeView.class;
        Class cls2 = cls;
        V fileAttributeView = Files.getFileAttributeView(path, cls, (LinkOption[]) Arrays.copyOf((T[]) linkOptionArr, linkOptionArr.length));
    ...
    private static final /* synthetic */ <A extends BasicFileAttributes> A readAttributes(Path path, LinkOption... linkOptionArr) throws IOException {
        ...
        Class cls2 = cls;
        A readAttributes = Files.readAttributes(path, cls, (LinkOption[]) Arrays.copyOf((T[]) linkOptionArr, linkOptionArr.length));
    ...
    private static final Map<String, Object> readAttributes(Path path, String str, LinkOption... linkOptionArr) throws IOException {
        ...
        Intrinsics.checkNotNullParameter(linkOptionArr, "options");
        Map<String, Object> readAttributes = Files.readAttributes(path, str, (LinkOption[]) Arrays.copyOf((T[]) linkOptionArr, linkOptionArr.length));
    ...
    private static final FileTime getLastModifiedTime(Path path, LinkOption... linkOptionArr) throws IOException {
        Intrinsics.checkNotNullParameter(path, "<this>");
        Intrinsics.checkNotNullParameter(linkOptionArr, "options");
        FileTime lastModifiedTime = Files.getLastModifiedTime(path, (LinkOption[]) Arrays.copyOf((T[]) linkOptionArr, linkOptionArr.length));
    ...
    private static final UserPrincipal getOwner(Path path, LinkOption... linkOptionArr) throws IOException {
        Intrinsics.checkNotNullParameter(path, "<this>");
        Intrinsics.checkNotNullParameter(linkOptionArr, "options");
        return Files.getOwner(path, (LinkOption[]) Arrays.copyOf((T[]) linkOptionArr, linkOptionArr.length));
    }
    ...
    private static final Set<PosixFilePermission> getPosixFilePermissions(Path path, LinkOption... linkOptionArr) throws IOException {
        Intrinsics.checkNotNullParameter(path, "<this>");
        Intrinsics.checkNotNullParameter(linkOptionArr, "options");
        Set<PosixFilePermission> posixFilePermissions = Files.getPosixFilePermissions(path, (LinkOption[]) Arrays.copyOf((T[]) linkOptionArr, linkOptionArr.length));
    ...
    private static final Path createSymbolicLinkPointingTo(Path path, Path path2, FileAttribute<?>... fileAttributeArr) throws IOException {
        ...
        Intrinsics.checkNotNullParameter(path2, "target");
        Intrinsics.checkNotNullParameter(fileAttributeArr, "attributes");
        Path createSymbolicLink = Files.createSymbolicLink(path, path2, (FileAttribute[]) Arrays.copyOf((T[]) fileAttributeArr, fileAttributeArr.length));
    ...
    private static final Path createFile(Path path, FileAttribute<?>... fileAttributeArr) throws IOException {
        Intrinsics.checkNotNullParameter(path, "<this>");
        Intrinsics.checkNotNullParameter(fileAttributeArr, "attributes");
        Path createFile = Files.createFile(path, (FileAttribute[]) Arrays.copyOf((T[]) fileAttributeArr, fileAttributeArr.length));
    ...
    static /* synthetic */ Path createTempFile$default(String str, String str2, FileAttribute[] fileAttributeArr, int i, Object obj) throws IOException {
        ...
        Intrinsics.checkNotNullParameter(fileAttributeArr, "attributes");
        Path createTempFile = Files.createTempFile(str, str2, (FileAttribute[]) Arrays.copyOf((T[]) fileAttributeArr, fileAttributeArr.length));
    ...
    public static final Path createTempFile(Path path, String str, String str2, FileAttribute<?>... fileAttributeArr) throws IOException {
        Intrinsics.checkNotNullParameter(fileAttributeArr, "attributes");
        if (path != null) {
            Path createTempFile = Files.createTempFile(path, str, str2, (FileAttribute[]) Arrays.copyOf((T[]) fileAttributeArr, fileAttributeArr.length));
            Intrinsics.checkNotNullExpressionValue(createTempFile, "createTempFile(directory…fix, suffix, *attributes)");
            return createTempFile;
        }
        Path createTempFile2 = Files.createTempFile(str, str2, (FileAttribute[]) Arrays.copyOf((T[]) fileAttributeArr, fileAttributeArr.length));
    ...
    static /* synthetic */ Path createTempDirectory$default(String str, FileAttribute[] fileAttributeArr, int i, Object obj) throws IOException {
        ...
        Intrinsics.checkNotNullParameter(fileAttributeArr, "attributes");
        Path createTempDirectory = Files.createTempDirectory(str, (FileAttribute[]) Arrays.copyOf((T[]) fileAttributeArr, fileAttributeArr.length));
    ...
    public static final Path createTempDirectory(Path path, String str, FileAttribute<?>... fileAttributeArr) throws IOException {
        Intrinsics.checkNotNullParameter(fileAttributeArr, "attributes");
        if (path != null) {
            Path createTempDirectory = Files.createTempDirectory(path, str, (FileAttribute[]) Arrays.copyOf((T[]) fileAttributeArr, fileAttributeArr.length));
            Intrinsics.checkNotNullExpressionValue(createTempDirectory, "createTempDirectory(dire…ory, prefix, *attributes)");
            return createTempDirectory;
        }
        Path createTempDirectory2 = Files.createTempDirectory(str, (FileAttribute[]) Arrays.copyOf((T[]) fileAttributeArr, fileAttributeArr.length));
    ...
    private static final Path div(Path path, String str) {
        Intrinsics.checkNotNullParameter(path, "<this>");
        Intrinsics.checkNotNullParameter(str, PluralRules.KEYWORD_OTHER);
    ...
    private static final Path Path(String str, String... strArr) {
        ...
        Path path = Paths.get(str, (String[]) Arrays.copyOf((T[]) strArr, strArr.length));
