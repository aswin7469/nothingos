...
class RangesKt___RangesKt extends RangesKt__RangesKt {
    ...
    public static final boolean intRangeContains(ClosedRange<Integer> closedRange, byte b) {
        ...
        return closedRange.contains(Integer.valueOf((int) b));
    }
    ...
    public static final boolean intRangeContains(ClosedRange<Integer> closedRange, short s) {
        Intrinsics.checkNotNullParameter(closedRange, "<this>");
        return closedRange.contains(Integer.valueOf((int) s));
    }
    ...
    public static final Byte toByteExactOrNull(int i) {
        if (new IntRange(TrafficStats.TAG_NETWORK_STACK_IMPERSONATION_RANGE_START, 127).contains(i)) {
    ...
    public static final Byte toByteExactOrNull(short s) {
        if (RangesKt.intRangeContains((ClosedRange<Integer>) new IntRange(TrafficStats.TAG_NETWORK_STACK_IMPERSONATION_RANGE_START, 127), s)) {
    ...
    public static final Short toShortExactOrNull(int i) {
        if (new IntRange(SignalStrength.INVALID, FP16.EXPONENT_SIGNIFICAND_MASK).contains(i)) {
