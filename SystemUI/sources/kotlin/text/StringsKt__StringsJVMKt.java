...
class StringsKt__StringsJVMKt extends StringsKt__StringNumberConversionsKt {
    ...
    private static final int nativeLastIndexOf(String str, char c, int i) {
        Intrinsics.checkNotNullParameter(str, "<this>");
        return str.lastIndexOf((int) c, i);
    }
    ...
    public static final String replace(String str, String str2, String str3, boolean z) {
        ...
        if (length2 >= 0) {
            ...
            do {
                sb.append(charSequence, i, indexOf).append(str3);
                i = indexOf + length;
                if (indexOf >= str.length() || (indexOf = StringsKt.indexOf(charSequence, str2, indexOf + coerceAtLeast, z)) <= 0) {
                    String sb2 = sb.append(charSequence, i, str.length()).toString();
            ...
            String sb22 = sb.append(charSequence, i, str.length()).toString();
    ...
    private static final String format(String str, Object... objArr) {
        ...
        String format = String.format(str, Arrays.copyOf((T[]) objArr, objArr.length));
    ...
    private static final /* synthetic */ String format(String str, Locale locale, Object... objArr) {
        ...
        Intrinsics.checkNotNullParameter(objArr, "args");
        String format = String.format(locale, str, Arrays.copyOf((T[]) objArr, objArr.length));
    ...
    public static final int compareTo(String str, String str2, boolean z) {
        Intrinsics.checkNotNullParameter(str, "<this>");
        Intrinsics.checkNotNullParameter(str2, PluralRules.KEYWORD_OTHER);
        if (z) {
    ...
    public static final boolean regionMatches(CharSequence charSequence, int i, CharSequence charSequence2, int i2, int i3, boolean z) {
        Intrinsics.checkNotNullParameter(charSequence, "<this>");
        Intrinsics.checkNotNullParameter(charSequence2, PluralRules.KEYWORD_OTHER);
