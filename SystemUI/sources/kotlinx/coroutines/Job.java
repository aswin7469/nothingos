...
public interface Job extends CoroutineContext.Element {
    ...
    public static final class DefaultImpls {
        public static <R> R fold(Job job, R r, @NotNull Function2<? super R, ? super CoroutineContext.Element, ? extends R> operation) {
        ...
        @NotNull
        public static CoroutineContext plus(Job job, @NotNull CoroutineContext context) {
