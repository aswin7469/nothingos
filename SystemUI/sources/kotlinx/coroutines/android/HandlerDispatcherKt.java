...
public final class HandlerDispatcherKt {
    ...
    static {
        ...
        try {
            ...
            obj = Result.m3936constructorimpl(new HandlerContext(asHandler(Looper.getMainLooper(), true), (String) null, 2, (DefaultConstructorMarker) null));
        } catch (Throwable th) {
    ...
    public static final void m5422postFrameCallback$lambda6(CancellableContinuation cancellableContinuation, long j) {
        Dispatchers dispatchers = Dispatchers.INSTANCE;
