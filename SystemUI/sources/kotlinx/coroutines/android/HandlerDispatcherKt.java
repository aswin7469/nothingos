...
public final class HandlerDispatcherKt {
    ...
    public static final Handler asHandler(Looper looper, boolean z) {
        ...
        Object invoke = Handler.class.getDeclaredMethod("createAsync", Looper.class).invoke((Object) null, looper);
        if (invoke != null) {
    ...
    static {
        ...
        try {
            ...
            obj = Result.m3954constructorimpl(new HandlerContext(asHandler(Looper.getMainLooper(), true), (String) null, 2, (DefaultConstructorMarker) null));
        } catch (Throwable th) {
    ...
    public static final void m5440postFrameCallback$lambda6(CancellableContinuation cancellableContinuation, long j) {
        Dispatchers dispatchers = Dispatchers.INSTANCE;
