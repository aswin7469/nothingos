...
public abstract class AbstractChannel<E> extends AbstractSendChannel<E> implements Channel<E> {
    ...
    public boolean enqueueReceiveInternal(Receive<? super E> receive) {
        ...
        if (isBufferAlwaysEmpty()) {
            ...
            LockFreeLinkedListNode.CondAddOp abstractChannel$enqueueReceiveInternal$$inlined$addLastIfPrevAndIf$1 = new C4598x75f916ce(lockFreeLinkedListNode, this);
            do {
    ...
    public final java.lang.Object m5424receiveCatchingJP2dKIU(kotlin.coroutines.Continuation<? super kotlinx.coroutines.channels.ChannelResult<? extends E>> r5) {
        /*
            r4 = this;
        ...
        L_0x0032:
            ...
            java.lang.Object r4 = r4.m5448closedJP2dKIU(r5)
            goto L_0x0052
        L_0x004c:
            kotlinx.coroutines.channels.ChannelResult$Companion r4 = kotlinx.coroutines.channels.ChannelResult.Companion
            java.lang.Object r4 = r4.m5450successJP2dKIU(r5)
        L_0x0052:
            return r4
        L_0x0053:
            r0.label = r3
        ...
        L_0x005c:
            ...
            java.lang.Object r4 = r5.m5447unboximpl()
            return r4
        */
        throw new UnsupportedOperationException("Method not decompiled: kotlinx.coroutines.channels.AbstractChannel.m5424receiveCatchingJP2dKIU(kotlin.coroutines.Continuation):java.lang.Object");
    }

    /* renamed from: tryReceive-PtdJZtk  reason: not valid java name */
    public final Object m5425tryReceivePtdJZtk() {
        Object pollInternal = pollInternal();
        if (pollInternal == AbstractChannelKt.POLL_FAILED) {
            return ChannelResult.Companion.m5449failurePtdJZtk();
        }
        if (pollInternal instanceof Closed) {
            return ChannelResult.Companion.m5448closedJP2dKIU(((Closed) pollInternal).closeCause);
        }
        return ChannelResult.Companion.m5450successJP2dKIU(pollInternal);
    }
    ...
    public void onCancelIdempotent(boolean z) {
        ...
        if (closedForSend != null) {
            Object r0 = InlineList.m5472constructorimpl$default((Object) null, 1, (DefaultConstructorMarker) null);
            while (true) {
                LockFreeLinkedListNode prevNode = closedForSend.getPrevNode();
                if (prevNode instanceof LockFreeLinkedListHead) {
                    m5423onCancelIdempotentListww6eGU(r0, closedForSend);
                    return;
                    ...
                    r0 = InlineList.m5477plusFjFbRPM(r0, (Send) prevNode);
                }
            }
        } else {
    ...
    private final <R> void tryStartBlockUnintercepted(Function2<Object, ? super Continuation<? super R>, ? extends Object> function2, SelectInstance<? super R> selectInstance, int i, Object obj) {
        ...
        if (z) {
            if (i == 0) {
                ...
                UndispatchedKt.startCoroutineUnintercepted(function2, ChannelResult.m5435boximpl(ChannelResult.Companion.m5448closedJP2dKIU(((Closed) obj).closeCause)), selectInstance.getCompletion());
            }
        } else if (i == 1) {
            UndispatchedKt.startCoroutineUnintercepted(function2, ChannelResult.m5435boximpl(z ? ChannelResult.Companion.m5448closedJP2dKIU(((Closed) obj).closeCause) : ChannelResult.Companion.m5450successJP2dKIU(obj)), selectInstance.getCompletion());
        } else {
            ...
            while (true) {
                ...
                if (pollInternal instanceof Closed) {
                    ...
                    if (closed.closeCause == null) {
                        ...
                        cancellableContinuation.resumeWith(Result.m3936constructorimpl(boxBoolean));
                    } else {
                        Throwable receiveException = closed.getReceiveException();
                        Result.Companion companion2 = Result.Companion;
                        cancellableContinuation.resumeWith(Result.m3936constructorimpl(ResultKt.createFailure(receiveException)));
                    }
    ...
    private static class ReceiveElement<E> extends Receive<E> {
        ...
        public final Object resumeValue(E e) {
            return this.receiveMode == 1 ? ChannelResult.m5435boximpl(ChannelResult.Companion.m5450successJP2dKIU(e)) : e;
        }
        ...
        public void resumeReceiveClosed(Closed<?> closed) {
            if (this.receiveMode == 1) {
                ChannelResult r3 = ChannelResult.m5435boximpl(ChannelResult.Companion.m5448closedJP2dKIU(closed.closeCause));
                Result.Companion companion = Result.Companion;
                this.cont.resumeWith(Result.m3936constructorimpl(r3));
                return;
            }
            Throwable receiveException = closed.getReceiveException();
            Result.Companion companion2 = Result.Companion;
            this.cont.resumeWith(Result.m3936constructorimpl(ResultKt.createFailure(receiveException)));
        }
    ...
    private static final class ReceiveSelect<R, E> extends Receive<E> implements DisposableHandle {
        ...
        public void completeResumeReceive(E e) {
            CancellableKt.startCoroutineCancellable(this.block, this.receiveMode == 1 ? ChannelResult.m5435boximpl(ChannelResult.Companion.m5450successJP2dKIU(e)) : e, this.select.getCompletion(), resumeOnCancellationFun(e));
        }
        ...
        public void resumeReceiveClosed(Closed<?> closed) {
            if (this.select.trySelect()) {
                ...
                if (i == 0) {
                    ...
                    CancellableKt.startCoroutineCancellable$default(this.block, ChannelResult.m5435boximpl(ChannelResult.Companion.m5448closedJP2dKIU(closed.closeCause)), this.select.getCompletion(), (Function1) null, 4, (Object) null);
                }
            }
        }
    ...
    public void m5423onCancelIdempotentListww6eGU(Object obj, Closed<?> closed) {
        if (obj != null) {
