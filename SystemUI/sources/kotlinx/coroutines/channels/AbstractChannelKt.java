...
public final class AbstractChannelKt {
    ...
    private static final <E> Object toResult(Object obj) {
        return obj instanceof Closed ? ChannelResult.Companion.m5466closedJP2dKIU(((Closed) obj).closeCause) : ChannelResult.Companion.m5468successJP2dKIU(obj);
    }

    private static final <E> Object toResult(Closed<?> closed) {
        return ChannelResult.Companion.m5466closedJP2dKIU(closed.closeCause);
    }
}
