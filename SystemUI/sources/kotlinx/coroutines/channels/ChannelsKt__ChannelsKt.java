...
final /* synthetic */ class ChannelsKt__ChannelsKt {
    ...
    public static final <E> void sendBlocking(SendChannel<? super E> sendChannel, E e) {
        if (!ChannelResult.m5445isSuccessimpl(sendChannel.m5457trySendJP2dKIU(e))) {
    ...
    public static final <E> Object trySendBlocking(SendChannel<? super E> sendChannel, E e) throws InterruptedException {
        Object r0 = sendChannel.m5457trySendJP2dKIU(e);
        if (r0 instanceof ChannelResult.Failed) {
            return ((ChannelResult) BuildersKt__BuildersKt.runBlocking$default((CoroutineContext) null, new ChannelsKt__ChannelsKt$trySendBlocking$2(sendChannel, e, (Continuation<? super ChannelsKt__ChannelsKt$trySendBlocking$2>) null), 1, (Object) null)).m5447unboximpl();
        }
        Unit unit = (Unit) r0;
