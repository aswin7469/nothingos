...
@DebugMetadata(mo65296c = "kotlinx.coroutines.channels.ChannelsKt__DeprecatedKt$map$1", mo65297f = "Deprecated.kt", mo65298i = {0, 0, 1, 1, 2, 2}, mo65299l = {415, 288, 288}, mo65300m = "invokeSuspend", mo65301n = {"$this$produce", "$this$consume$iv$iv", "$this$produce", "$this$consume$iv$iv", "$this$produce", "$this$consume$iv$iv"}, mo65302s = {"L$0", "L$2", "L$0", "L$2", "L$0", "L$2"})
