...
public interface SendChannel<E> {
    ...
    Object m5457trySendJP2dKIU(E e);
    ...
    public static final class DefaultImpls {
        ...
        public static <E> boolean offer(SendChannel<? super E> sendChannel, E e) {
            ...
            if (ChannelResult.m5445isSuccessimpl(r0)) {
                return true;
            }
            Throwable r02 = ChannelResult.m5439exceptionOrNullimpl(r0);
            if (r02 == null) {
                return false;
            }
