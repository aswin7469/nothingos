...
public final class CancellableFlowImpl$collect$$inlined$collect$1 implements FlowCollector<T> {
    final /* synthetic */ FlowCollector $collector$inlined;

    public CancellableFlowImpl$collect$$inlined$collect$1(FlowCollector flowCollector) {
        this.$collector$inlined = flowCollector;
    }

    public Object emit(T t, Continuation<? super Unit> continuation) {
        JobKt.ensureActive(continuation.getContext());
        Object emit = this.$collector$inlined.emit(t, continuation);
