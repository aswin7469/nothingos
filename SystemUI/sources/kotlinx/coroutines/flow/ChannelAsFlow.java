...
final class ChannelAsFlow<T> extends ChannelFlow<T> {
    ...
    public Object collectTo(ProducerScope<? super T> producerScope, Continuation<? super Unit> continuation) {
        Object access$emitAllImpl = FlowKt__ChannelsKt.emitAllImpl$FlowKt__ChannelsKt(new SendingCollector(producerScope), this.channel, this.consume, continuation);
        return access$emitAllImpl == IntrinsicsKt.getCOROUTINE_SUSPENDED() ? access$emitAllImpl : Unit.INSTANCE;
    }
    ...
    public Object collect(FlowCollector<? super T> flowCollector, Continuation<? super Unit> continuation) {
        if (this.capacity == -3) {
            markConsumed();
            Object access$emitAllImpl = FlowKt__ChannelsKt.emitAllImpl$FlowKt__ChannelsKt(flowCollector, this.channel, this.consume, continuation);
            return access$emitAllImpl == IntrinsicsKt.getCOROUTINE_SUSPENDED() ? access$emitAllImpl : Unit.INSTANCE;
        }
