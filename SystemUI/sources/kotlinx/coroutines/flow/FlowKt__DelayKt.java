...
final /* synthetic */ class FlowKt__DelayKt {
    ...
    public static final <T> Flow<T> m5480debounceHG0u8IE(Flow<? extends T> flow, long j) {
        return FlowKt.debounce(flow, DelayKt.m5436toDelayMillisLRDsOJo(j));
    }
    ...
    public static final <T> Flow<T> m5481sampleHG0u8IE(Flow<? extends T> flow, long j) {
        return FlowKt.sample(flow, DelayKt.m5436toDelayMillisLRDsOJo(j));
    }
}
