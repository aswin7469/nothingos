...
public final class FlowKt__EmittersKt$onEmpty$$inlined$unsafeFlow$1 implements Flow<T> {
    ...
    public java.lang.Object collect(kotlinx.coroutines.flow.FlowCollector<? super T> r7, kotlin.coroutines.Continuation<? super kotlin.Unit> r8) {
        /*
            r6 = this;
            boolean r0 = r8 instanceof kotlinx.coroutines.flow.FlowKt__EmittersKt$onEmpty$$inlined$unsafeFlow$1.C46291
            if (r0 == 0) goto L_0x0014
            r0 = r8
            kotlinx.coroutines.flow.FlowKt__EmittersKt$onEmpty$$inlined$unsafeFlow$1$1 r0 = (kotlinx.coroutines.flow.FlowKt__EmittersKt$onEmpty$$inlined$unsafeFlow$1.C46291) r0
            int r1 = r0.label
        ...
        L_0x0072:
            ...
            r8.<init>(r7, r6)
            kotlin.jvm.functions.Function2 r6 = r2.$action$inlined     // Catch:{ all -> 0x009e }
            ...
            r7 = 6
            kotlin.jvm.internal.InlineMarker.mark((int) r7)     // Catch:{ all -> 0x009e }
            java.lang.Object r6 = r6.invoke(r8, r0)     // Catch:{ all -> 0x009e }
            r7 = 7
            kotlin.jvm.internal.InlineMarker.mark((int) r7)     // Catch:{ all -> 0x009e }
