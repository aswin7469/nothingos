...
public final class FlowKt__EmittersKt$unsafeTransform$$inlined$unsafeFlow$1 implements Flow<R> {
    ...
    public Object collect(FlowCollector<? super R> flowCollector, Continuation<? super Unit> continuation) {
        Object collect = this.$this_unsafeTransform$inlined.collect(new FlowKt__EmittersKt$unsafeTransform$lambda1$$inlined$collect$1(this.$transform$inlined, flowCollector), continuation);
    ...
    public Object collect$$forInline(FlowCollector flowCollector, Continuation continuation) {
        ...
        InlineMarker.mark(5);
        InlineMarker.mark(0);
        this.$this_unsafeTransform$inlined.collect(new FlowKt__EmittersKt$unsafeTransform$lambda1$$inlined$collect$1(this.$transform$inlined, flowCollector), continuation);
        InlineMarker.mark(1);
        return Unit.INSTANCE;
    }
}
