...
public final class FlowKt__LimitKt$drop$$inlined$unsafeFlow$1 implements Flow<T> {
    ...
    public Object collect(FlowCollector<? super T> flowCollector, Continuation<? super Unit> continuation) {
        Object collect = this.$this_drop$inlined.collect(new FlowKt__LimitKt$drop$lambda2$$inlined$collect$1(new Ref.IntRef(), this.$count$inlined, flowCollector), continuation);
