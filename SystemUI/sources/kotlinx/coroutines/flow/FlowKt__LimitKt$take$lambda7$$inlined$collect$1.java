...
public final class FlowKt__LimitKt$take$lambda7$$inlined$collect$1 implements FlowCollector<T> {
    ...
    public Object emit(T t, Continuation<? super Unit> continuation) {
        ...
        if (this.$consumed$inlined.element < this.$count$inlined) {
            ...
            Object access$emitAbort = FlowKt__LimitKt.emitAbort$FlowKt__LimitKt(this.$this_unsafeFlow$inlined, t, continuation);
            if (access$emitAbort == IntrinsicsKt.getCOROUTINE_SUSPENDED()) {
