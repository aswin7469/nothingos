...
public final class FlowKt__TransformKt$runningReduce$$inlined$unsafeFlow$1 implements Flow<T> {
    ...
    public Object collect(FlowCollector<? super T> flowCollector, Continuation<? super Unit> continuation) {
        ...
        Object collect = this.$this_runningReduce$inlined.collect(new FlowKt__TransformKt$runningReduce$lambda12$$inlined$collect$1(objectRef, this.$operation$inlined, flowCollector), continuation);
