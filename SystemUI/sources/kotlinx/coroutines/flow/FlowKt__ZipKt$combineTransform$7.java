...
@DebugMetadata(mo65240c = "kotlinx.coroutines.flow.FlowKt__ZipKt$combineTransform$7", mo65241f = "Zip.kt", mo65242i = {}, mo65243l = {308}, mo65244m = "invokeSuspend", mo65245n = {}, mo65246s = {})
...
public final class FlowKt__ZipKt$combineTransform$7 extends SuspendLambda implements Function2<FlowCollector<? super R>, Continuation<? super Unit>, Object> {
    ...
    @DebugMetadata(mo65240c = "kotlinx.coroutines.flow.FlowKt__ZipKt$combineTransform$7$2", mo65241f = "Zip.kt", mo65242i = {}, mo65243l = {308}, mo65244m = "invokeSuspend", mo65245n = {}, mo65246s = {})
    /* renamed from: kotlinx.coroutines.flow.FlowKt__ZipKt$combineTransform$7$2 */
    /* compiled from: Zip.kt */
    public static final class C46832 extends SuspendLambda implements Function3<FlowCollector<? super R>, T[], Continuation<? super Unit>, Object> {
        private /* synthetic */ Object L$0;
        /* synthetic */ Object L$1;
        int label;

        public final Object invoke(FlowCollector<? super R> flowCollector, T[] tArr, Continuation<? super Unit> continuation) {
            C46832 r0 = new C46832(r3, continuation);
    ...
    public final Object invokeSuspend(Object obj) {
        ...
        if (i == 0) {
            ...
            }, new C46832((Continuation<? super C46832>) null), this) == coroutine_suspended) {
                return coroutine_suspended;
            }
        } else if (i == 1) {
            ResultKt.throwOnFailure(obj);
    ...
    public final Object invokeSuspend$$forInline(Object obj) {
        ...
        }, new C46832((Continuation<? super C46832>) null), this);
        InlineMarker.mark(1);
        return Unit.INSTANCE;
    }
}
