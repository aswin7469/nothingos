...
public final class FlowKt__ZipKt$combineUnsafe$$inlined$unsafeFlow$1 implements Flow<R> {
    ...
    public Object collect(FlowCollector<? super R> flowCollector, Continuation<? super Unit> continuation) {
        Object combineInternal = CombineKt.combineInternal(flowCollector, this.$flows$inlined, FlowKt__ZipKt.nullArrayFactory$FlowKt__ZipKt(), new FlowKt__ZipKt$combineUnsafe$1$1(this.$transform$inlined, (Continuation<? super FlowKt__ZipKt$combineUnsafe$1$1>) null), continuation);
    ...
    public Object collect$$forInline(FlowCollector flowCollector, Continuation continuation) {
        ...
        InlineMarker.mark(5);
        InlineMarker.mark(0);
        CombineKt.combineInternal(flowCollector, this.$flows$inlined, FlowKt__ZipKt.nullArrayFactory$FlowKt__ZipKt(), new FlowKt__ZipKt$combineUnsafe$1$1(this.$transform$inlined, (Continuation<? super FlowKt__ZipKt$combineUnsafe$1$1>) null), continuation);
        InlineMarker.mark(1);
        return Unit.INSTANCE;
    }
}
