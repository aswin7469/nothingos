...
final class SharedFlowImpl<T> extends AbstractSharedFlow<SharedFlowSlot> implements MutableSharedFlow<T>, CancellableFlow<T>, FusibleFlow<T> {
    ...
    public boolean tryEmit(T t) {
        ...
        while (i < length) {
            ...
            if (continuation != null) {
                ...
                continuation.resumeWith(Result.m3954constructorimpl(unit));
            }
        }
        return z;
    }
    ...
    public final kotlin.coroutines.Continuation<kotlin.Unit>[] updateCollectorIndexLocked$kotlinx_coroutines_core(long r23) {
        ...
        L_0x007c:
            ...
            return r0
        L_0x0085:
            long r7 = r22.getBufferEndIndex()
            int r4 = r22.getNCollectors()
            ...
            int r13 = r13 - r4
            int r4 = java.lang.Math.min((int) r12, (int) r13)
            goto L_0x009e
        L_0x009c:
            int r4 = r9.queueSize
        L_0x009e:
        ...
        L_0x0105:
            ...
            int r5 = r9.replay
            int r0 = java.lang.Math.min((int) r5, (int) r0)
            long r5 = (long) r0
            long r5 = r7 - r5
            long r0 = java.lang.Math.max((long) r1, (long) r5)
    ...
    public final kotlin.coroutines.Continuation<kotlin.Unit>[] findSlotsToResumeLocked(kotlin.coroutines.Continuation[] r11) {
        ...
        L_0x002c:
            ...
            r7 = 2
            int r11 = r11 * r7
            int r11 = java.lang.Math.max((int) r7, (int) r11)
            java.lang.Object[] r11 = java.util.Arrays.copyOf((T[]) r6, (int) r11)
    ...
    @Metadata(mo65042d1 = {"\u0000(\n\u0002\u0018\u0002\n\u0002\u0018\u0002\n\u0000\n\u0002\u0018\u0002\n\u0000\n\u0002\u0010\t\n\u0000\n\u0002\u0010\u0000\n\u0000\n\u0002\u0018\u0002\n\u0002\u0010\u0002\n\u0002\b\u0003\b\u0002\u0018\u00002\u00020\u0001B1\u0012\n\u0010\u0002\u001a\u0006\u0012\u0002\b\u00030\u0003\u0012\u0006\u0010\u0004\u001a\u00020\u0005\u0012\b\u0010\u0006\u001a\u0004\u0018\u00010\u0007\u0012\f\u0010\b\u001a\b\u0012\u0004\u0012\u00020\n0\t¢\u0006\u0002\u0010\u000bJ\b\u0010\f\u001a\u00020\nH\u0016R\u0016\u0010\b\u001a\b\u0012\u0004\u0012\u00020\n0\t8\u0006X\u0004¢\u0006\u0002\n\u0000R\u0014\u0010\u0002\u001a\u0006\u0012\u0002\b\u00030\u00038\u0006X\u0004¢\u0006\u0002\n\u0000R\u0012\u0010\u0004\u001a\u00020\u00058\u0006@\u0006X\u000e¢\u0006\u0002\n\u0000R\u0012\u0010\u0006\u001a\u0004\u0018\u00010\u00078\u0006X\u0004¢\u0006\u0002\n\u0000¨\u0006\r"}, mo65043d2 = {"Lkotlinx/coroutines/flow/SharedFlowImpl$Emitter;", "Lkotlinx/coroutines/DisposableHandle;", "flow", "Lkotlinx/coroutines/flow/SharedFlowImpl;", "index", "", "value", "", "cont", "Lkotlin/coroutines/Continuation;", "", "(Lkotlinx/coroutines/flow/SharedFlowImpl;JLjava/lang/Object;Lkotlin/coroutines/Continuation;)V", "dispose", "kotlinx-coroutines-core"}, mo65044k = 1, mo65045mv = {1, 5, 1}, mo65047xi = 48)
    /* compiled from: SharedFlow.kt */
    ...
    public java.util.List<T> getReplayCache() {
        ...
        L_0x000d:
            ...
            r1.<init>((int) r0)     // Catch:{ all -> 0x0033 }
    ...
    public final Object emitSuspend(T t, Continuation<? super Unit> continuation) {
        ...
        while (i < length) {
            ...
            if (continuation2 != null) {
                ...
                continuation2.resumeWith(Result.m3954constructorimpl(unit2));
            }
        }
