...
public abstract class ChannelFlowOperator<S, T> extends ChannelFlow<T> {
    ...
    public ChannelFlowOperator(Flow<? extends S> flow2, CoroutineContext coroutineContext, int i, BufferOverflow bufferOverflow) {
