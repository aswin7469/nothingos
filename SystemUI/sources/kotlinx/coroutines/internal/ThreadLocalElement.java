...
public final class ThreadLocalElement<T> implements ThreadContextElement<T> {
    ...
    public CoroutineContext minusKey(CoroutineContext.Key<?> key2) {
        boolean areEqual = Intrinsics.areEqual((Object) getKey(), (Object) key2);
        this = this;
        if (areEqual) {
