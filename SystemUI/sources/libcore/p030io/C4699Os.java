...
/* renamed from: libcore.io.Os */
public interface C4699Os {
    ...
    long android_fdsan_get_owner_tag(FileDescriptor fileDescriptor);

    String android_fdsan_get_tag_type(long j);

    long android_fdsan_get_tag_value(long j);
    ...
    StructRlimit getrlimit(int i) throws ErrnoException;
    ...
    int ioctlInt(FileDescriptor fileDescriptor, int i) throws ErrnoException;
    ...
    FileDescriptor memfd_create(String str, int i) throws ErrnoException;
    ...
    int recvmsg(FileDescriptor fileDescriptor, StructMsghdr structMsghdr, int i) throws ErrnoException, SocketException;
    ...
    long sendfile(FileDescriptor fileDescriptor, FileDescriptor fileDescriptor2, Int64Ref int64Ref, long j) throws ErrnoException;

    int sendmsg(FileDescriptor fileDescriptor, StructMsghdr structMsghdr, int i) throws ErrnoException, SocketException;
    ...
    long splice(FileDescriptor fileDescriptor, Int64Ref int64Ref, FileDescriptor fileDescriptor2, Int64Ref int64Ref2, long j, int i) throws ErrnoException;
    ...
    int waitpid(int i, Int32Ref int32Ref, int i2) throws ErrnoException;
    ...
    @SystemApi(client = SystemApi.Client.MODULE_LIBRARIES)
    static boolean compareAndSetDefault(C4699Os os, C4699Os os2) {
        return Libcore.compareAndSetOs(os, os2);
    }

    @SystemApi(client = SystemApi.Client.MODULE_LIBRARIES)
    static C4699Os getDefault() {
