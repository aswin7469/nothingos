        ...
        return new AsyncTimeout() {
            ...
            public void timedOut() {
                try {
                    ...
                    Okio.logger.log(Level.WARNING, "Failed to close timed out socket " + Socket.this, (Throwable) e);
                } catch (AssertionError e2) {
                    if (Okio.isAndroidGetsocknameError(e2)) {
                        Okio.logger.log(Level.WARNING, "Failed to close timed out socket " + Socket.this, (Throwable) e2);
                        return;
                    }
                    throw e2;
                }
