...
public class SocketAdaptor extends Socket {
    ...
    /* renamed from: sc */
    public final SocketChannelImpl f891sc;
    ...
    public void connect(java.net.SocketAddress r7, int r8) throws java.p026io.IOException {
        /*
            ...
            sun.nio.ch.SocketChannelImpl r0 = r6.f891sc
            java.lang.Object r0 = r0.blockingLock()
            monitor-enter(r0)
            sun.nio.ch.SocketChannelImpl r1 = r6.f891sc     // Catch:{ all -> 0x00a5 }
            boolean r1 = r1.isBlocking()     // Catch:{ all -> 0x00a5 }
            if (r1 == 0) goto L_0x009f
            r1 = 1
            if (r8 != 0) goto L_0x0022
            sun.nio.ch.SocketChannelImpl r6 = r6.f891sc     // Catch:{ Exception -> 0x001c }
        ...
        L_0x0020:
            ...
            return
        L_0x0022:
            sun.nio.ch.SocketChannelImpl r2 = r6.f891sc     // Catch:{ Exception -> 0x0099 }
            r3 = 0
            r2.configureBlocking(r3)     // Catch:{ Exception -> 0x0099 }
            sun.nio.ch.SocketChannelImpl r2 = r6.f891sc     // Catch:{ all -> 0x008a }
            boolean r7 = r2.connect(r7)     // Catch:{ all -> 0x008a }
            if (r7 == 0) goto L_0x003f
            sun.nio.ch.SocketChannelImpl r7 = r6.f891sc     // Catch:{ Exception -> 0x0099 }
            boolean r7 = r7.isOpen()     // Catch:{ Exception -> 0x0099 }
            if (r7 == 0) goto L_0x003d
            sun.nio.ch.SocketChannelImpl r6 = r6.f891sc     // Catch:{ Exception -> 0x0099 }
        ...
        L_0x0040:
            ...
            sun.nio.ch.SocketChannelImpl r4 = r6.f891sc     // Catch:{ all -> 0x008a }
        ...
        L_0x006c:
            ...
            goto L_0x0040
        L_0x0079:
            sun.nio.ch.SocketChannelImpl r7 = r6.f891sc     // Catch:{ IOException -> 0x007e }
        ...
        L_0x008a:
            r7 = move-exception
            sun.nio.ch.SocketChannelImpl r8 = r6.f891sc     // Catch:{ Exception -> 0x0099 }
    ...
    public void bind(SocketAddress socketAddress) throws IOException {
        try {
            this.f891sc.bind(socketAddress);
        } catch (Exception e) {
    ...
    public InetAddress getInetAddress() {
        ...
        if (isConnected() && (remoteAddress = this.f891sc.remoteAddress()) != null) {
    ...
    public InetAddress getLocalAddress() {
        ...
        if (!this.f891sc.isOpen() || (localAddress = this.f891sc.localAddress()) == null) {
    ...
    public int getLocalPort() {
        InetSocketAddress localAddress = this.f891sc.localAddress();
    ...
    private class SocketInputStream extends ChannelInputStream {
        private SocketInputStream() {
            super(SocketAdaptor.this.f891sc);
        }
        ...
        public int read(java.nio.ByteBuffer r9) throws java.p026io.IOException {
            /*
                ...
                sun.nio.ch.SocketChannelImpl r0 = r0.f891sc
                java.lang.Object r0 = r0.blockingLock()
                monitor-enter(r0)
                sun.nio.ch.SocketAdaptor r1 = sun.nio.p033ch.SocketAdaptor.this     // Catch:{ all -> 0x00d7 }
                sun.nio.ch.SocketChannelImpl r1 = r1.f891sc     // Catch:{ all -> 0x00d7 }
                ...
                sun.nio.ch.SocketChannelImpl r8 = r8.f891sc     // Catch:{ all -> 0x00d7 }
            ...
            L_0x002b:
                ...
                sun.nio.ch.SocketChannelImpl r2 = r2.f891sc     // Catch:{ all -> 0x00ba }
                int r2 = r2.read(r9)     // Catch:{ all -> 0x00ba }
                if (r2 == 0) goto L_0x0059
                sun.nio.ch.SocketAdaptor r9 = sun.nio.p033ch.SocketAdaptor.this     // Catch:{ all -> 0x00d7 }
                sun.nio.ch.SocketChannelImpl r9 = r9.f891sc     // Catch:{ all -> 0x00d7 }
            ...
            L_0x0060:
                ...
                sun.nio.ch.SocketChannelImpl r4 = r4.f891sc     // Catch:{ all -> 0x00ba }
                ...
                sun.nio.ch.SocketChannelImpl r6 = r6.f891sc     // Catch:{ all -> 0x00ba }
            ...
            L_0x00ba:
                ...
                sun.nio.ch.SocketChannelImpl r2 = r2.f891sc     // Catch:{ all -> 0x00d7 }
    ...
    public InputStream getInputStream() throws IOException {
        if (!this.f891sc.isOpen()) {
            throw new SocketException("Socket is closed");
        } else if (!this.f891sc.isConnected()) {
            throw new SocketException("Socket is not connected");
        } else if (this.f891sc.isInputOpen()) {
    ...
    public OutputStream getOutputStream() throws IOException {
        if (!this.f891sc.isOpen()) {
            ...
            throw new SocketException("Socket is not connected");
        } else if (this.f891sc.isOutputOpen()) {
            try {
                return (OutputStream) AccessController.doPrivileged(new PrivilegedExceptionAction<OutputStream>() {
                    public OutputStream run() throws IOException {
                        return Channels.newOutputStream((WritableByteChannel) SocketAdaptor.this.f891sc);
                    }
                });
            } catch (PrivilegedActionException e) {
                throw ((IOException) e.getException());
    ...
    private void setBooleanOption(SocketOption<Boolean> socketOption, boolean z) throws SocketException {
        try {
            this.f891sc.setOption((SocketOption) socketOption, (Object) Boolean.valueOf(z));
        } catch (IOException e) {
    ...
    private void setIntOption(SocketOption<Integer> socketOption, int i) throws SocketException {
        try {
            this.f891sc.setOption((SocketOption) socketOption, (Object) Integer.valueOf(i));
        } catch (IOException e) {
            Net.translateToSocketException(e);
        }
    }
    ...
    private boolean getBooleanOption(java.net.SocketOption<java.lang.Boolean> r1) throws java.net.SocketException {
        /*
            r0 = this;
            sun.nio.ch.SocketChannelImpl r0 = r0.f891sc     // Catch:{ IOException -> 0x000d }
    ...
    public void sendUrgentData(int i) throws IOException {
        if (this.f891sc.sendOutOfBandData((byte) i) == 0) {
    ...
    public boolean isConnected() {
        return this.f891sc.isConnected();
    }

    public boolean isBound() {
        return this.f891sc.localAddress() != null;
    }

    public boolean isClosed() {
        return !this.f891sc.isOpen();
    }

    public boolean isInputShutdown() {
        return !this.f891sc.isInputOpen();
    }

    public boolean isOutputShutdown() {
        return !this.f891sc.isOutputOpen();
    }

    public FileDescriptor getFileDescriptor$() {
        return this.f891sc.getFD();
    }
}
