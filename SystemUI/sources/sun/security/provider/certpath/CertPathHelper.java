...
public abstract class CertPathHelper {
    ...
    public abstract void implSetDateAndTime(X509CRLSelector x509CRLSelector, Date date, long j);

    /* access modifiers changed from: protected */
    public abstract void implSetPathToNames(X509CertSelector x509CertSelector, Set<GeneralNameInterface> set);
