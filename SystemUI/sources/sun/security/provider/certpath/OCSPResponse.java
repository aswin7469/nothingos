...
public final class OCSPResponse {
    ...
    static /* synthetic */ class C48091 {
        ...
        static {
            ...
            L_0x0012:
                int[] r0 = f916x3ad85ed1     // Catch:{ NoSuchFieldError -> 0x001d }
            ...
            L_0x001d:
                int[] r0 = f916x3ad85ed1     // Catch:{ NoSuchFieldError -> 0x0028 }
            ...
            L_0x0028:
                int[] r0 = f916x3ad85ed1     // Catch:{ NoSuchFieldError -> 0x0033 }
            ...
            L_0x0033:
                return
            */
            throw new UnsupportedOperationException("Method not decompiled: sun.security.provider.certpath.OCSPResponse.C48091.<clinit>():void");
        }
    }
    ...
    public void verify(List<CertId> list, X509Certificate x509Certificate, X509Certificate x509Certificate2, Date date, byte[] bArr) throws CertPathValidatorException {
        ...
        byte[] bArr2;
        Debug debug2;
        int i = C48091.f916x3ad85ed1[this.responseStatus.ordinal()];
        if (i == 1) {
