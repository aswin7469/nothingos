...
public class OIDMap {
    ...
    static {
        ...
        addInternal("x509.info.extensions.NetscapeCertType", ObjectIdentifier.newInternal(new int[]{2, 16, DatatypeConstants.MIN_TIMEZONE_OFFSET, 1, 113730, 1, 1}), NetscapeCertTypeExtension.class);
    ...
    public static void addAttribute(String str, String str2, Class<?> cls) throws CertificateException {
        try {
            ...
            } else if (nameMap.put(str, oIDInfo) != null) {
