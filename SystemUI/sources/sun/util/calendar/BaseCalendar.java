...
public abstract class BaseCalendar extends AbstractCalendar {
    ...
    static final int[] ACCUMULATED_DAYS_IN_MONTH = {-30, 0, 31, 59, 90, 120, 151, 181, 212, 243, UCharacter.UnicodeBlock.TANGUT_COMPONENTS_ID, 304, 334};
    static final int[] ACCUMULATED_DAYS_IN_MONTH_LEAP = {-30, 0, 31, 60, 91, 121, 152, 182, 213, 244, UCharacter.UnicodeBlock.CJK_UNIFIED_IDEOGRAPHS_EXTENSION_F_ID, 305, 335};
    ...
    public static abstract class Date extends CalendarDate {
        ...
        long cachedFixedDateNextJan1 = (731581 + 366);
    ...
    public boolean normalize(CalendarDate calendarDate) {
        ...
        if (i <= 0 || dayOfMonth > ((long) monthLength)) {
            ...
            if (i > 0 || dayOfMonth <= -28) {
                ...
                int i4 = month - 1;
                date.setDayOfMonth((int) (dayOfMonth + ((long) getMonthLength(normalizedYear, i4))));
                if (i4 == 0) {
                    date.setNormalizedYear(normalizedYear - 1);
                } else {
                    i2 = i4;
    ...
    public long getFixedDate(int i, int i2, int i3, Date date) {
        ...
        if (date2 == null || !date2.hit(i5)) {
            int i8 = i5 - 1970;
            if (i8 >= 0) {
                int[] iArr = FIXED_DATES;
                if (i8 < iArr.length) {
                    long j2 = (long) iArr[i8];
                    if (date2 != null) {
                        date2.setCache(i5, j2, isLeapYear(i) ? 366 : 365);
                    }
            ...
            if (j3 >= 0) {
                ...
                i4 = CalendarUtils.floorDivide((i6 * 367) - 362, 12);
            }
            ...
            if (date2 != null && z) {
                date2.setCache(i5, j5, isLeapYear(i) ? 366 : 365);
            }
            return j5;
        } else if (z) {
    ...
    public void getCalendarDateFromFixedDate(CalendarDate calendarDate, long j) {
        ...
        if (date.hit(j)) {
            ...
            j2 = getFixedDate(i, 1, 1, (Date) null);
            z = isLeapYear(i);
