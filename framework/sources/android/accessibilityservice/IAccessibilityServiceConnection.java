                ...
                default:
                    ...
                    switch (code) {
                        case 1:
                            ...
                            if (data.readInt() != 0) {
                                _arg0 = AccessibilityServiceInfo.CREATOR.mo3559createFromParcel(data);
                            } else {
                                _arg0 = null;
                            }
                        ...
                        case 32:
                            ...
                            if (data.readInt() != 0) {
                                _arg13 = RemoteCallback.CREATOR.mo3559createFromParcel(data);
                            } else {
                                _arg13 = null;
                            }
                        ...
                        case 33:
                            ...
                            if (data.readInt() != 0) {
                                _arg14 = Region.CREATOR.mo3559createFromParcel(data);
                            } else {
                                _arg14 = null;
                            }
                        ...
                        case 34:
                            ...
                            if (data.readInt() != 0) {
                                _arg15 = Region.CREATOR.mo3559createFromParcel(data);
                            } else {
                                _arg15 = null;
                            }
        ...
        public static class Proxy implements IAccessibilityServiceConnection {
            ...
            public AccessibilityWindowInfo getWindow(int windowId) throws RemoteException {
                ...
                try {
                    ...
                    _reply.readException();
                    if (_reply.readInt() != 0) {
                        _result = AccessibilityWindowInfo.CREATOR.mo3559createFromParcel(_reply);
                    } else {
                        _result = null;
                    }
                    return _result;
            ...
            public AccessibilityWindowInfo.WindowListSparseArray getWindows() throws RemoteException {
                ...
                try {
                    ...
                    _reply.readException();
                    if (_reply.readInt() != 0) {
                        _result = AccessibilityWindowInfo.WindowListSparseArray.CREATOR.mo3559createFromParcel(_reply);
                    } else {
                        _result = null;
                    }
                    return _result;
            ...
            public AccessibilityServiceInfo getServiceInfo() throws RemoteException {
                ...
                try {
                    ...
                    _reply.readException();
                    if (_reply.readInt() != 0) {
                        _result = AccessibilityServiceInfo.CREATOR.mo3559createFromParcel(_reply);
                    } else {
                        _result = null;
                    }
                    return _result;
