...
public class AccountManager {
    ...
    PropertyInvalidatedCache<UserIdPackage, Account[]> mAccountsForUserCache = new PropertyInvalidatedCache<UserIdPackage, Account[]>(4, CACHE_KEY_ACCOUNTS_DATA_PROPERTY) { // from class: android.accounts.AccountManager.1
        ...
        /* JADX INFO: Access modifiers changed from: protected */
        @Override // android.app.PropertyInvalidatedCache
        public boolean debugCompareQueryResults(Account[] l, Account[] r) {
            if (l == r) {
                return true;
            }
            if (l == null || r == null) {
    ...
    /* loaded from: classes.dex */
    public static final class UserIdPackage {
        ...
        public boolean equals(Object o) {
            ...
            if (e.userId != this.userId || !e.packageName.equals(this.packageName)) {
                return false;
            }
            return true;
        }
    ...
    public Account[] getAccountsAsUser(int userId) {
        UserIdPackage userAndPackage = new UserIdPackage(userId, this.mContext.getOpPackageName());
    ...
    public AccountManagerFuture<String> getAuthTokenLabel(final String accountType, final String authTokenType, AccountManagerCallback<String> callback, Handler handler) {
        ...
        return new Future2Task<String>(handler, callback) { // from class: android.accounts.AccountManager.3
            ...
            @Override // android.accounts.AccountManager.BaseFutureTask
            /* renamed from: bundleToResult  reason: collision with other method in class */
            public String mo18bundleToResult(Bundle bundle) throws AuthenticatorException {
    ...
    public AccountManagerFuture<Boolean> hasFeatures(final Account account, final String[] features, AccountManagerCallback<Boolean> callback, Handler handler) {
        ...
        return new Future2Task<Boolean>(handler, callback) { // from class: android.accounts.AccountManager.4
            ...
            @Override // android.accounts.AccountManager.BaseFutureTask
            /* renamed from: bundleToResult */
            public Boolean mo18bundleToResult(Bundle bundle) throws AuthenticatorException {
    ...
    public AccountManagerFuture<Account[]> getAccountsByTypeAndFeatures(final String type, final String[] features, AccountManagerCallback<Account[]> callback, Handler handler) {
        ...
        return new Future2Task<Account[]>(handler, callback) { // from class: android.accounts.AccountManager.5
            ...
            @Override // android.accounts.AccountManager.BaseFutureTask
            /* renamed from: bundleToResult  reason: collision with other method in class */
            public Account[] mo18bundleToResult(Bundle bundle) throws AuthenticatorException {
    ...
    public String blockingGetAuthToken(Account account, String authTokenType, boolean notifyAuthFailure) throws OperationCanceledException, IOException, AuthenticatorException {
        ...
        Bundle bundle = getAuthToken(account, authTokenType, notifyAuthFailure, null, null).mo19getResult();
        if (bundle == null) {
    ...
    public abstract class AmsTask extends FutureTask<Bundle> implements AccountManagerFuture<Bundle> {
        ...
        public AmsTask(Activity activity, Handler handler, AccountManagerCallback<Bundle> callback) {
            super(new Callable<Bundle>() { // from class: android.accounts.AccountManager.AmsTask.1
                ...
                /* renamed from: call */
                public Bundle mo21call() throws Exception {
        ...
        public Bundle mo19getResult() throws OperationCanceledException, IOException, AuthenticatorException {
        ...
        @Override // android.accounts.AccountManagerFuture
        /* renamed from: getResult */
        public Bundle mo20getResult(long timeout, TimeUnit unit) throws OperationCanceledException, IOException, AuthenticatorException {
    ...
    public abstract class BaseFutureTask<T> extends FutureTask<T> {
        ...
        /* renamed from: bundleToResult */
        public abstract T mo18bundleToResult(Bundle bundle) throws AuthenticatorException;
        ...
        protected class Response extends IAccountManagerResponse.Stub {
            ...
            public void onResult(Bundle bundle) {
                try {
                    Object mo18bundleToResult = BaseFutureTask.this.mo18bundleToResult(bundle);
                    if (mo18bundleToResult != null) {
                        BaseFutureTask.this.set(mo18bundleToResult);
                    }
    ...
    public abstract class Future2Task<T> extends BaseFutureTask<T> implements AccountManagerFuture<T> {
        ...
        @Override // android.accounts.AccountManagerFuture
        /* renamed from: getResult */
        public T mo19getResult() throws OperationCanceledException, IOException, AuthenticatorException {
            return internalGetResult(null, null);
        }

        @Override // android.accounts.AccountManagerFuture
        /* renamed from: getResult */
        public T mo20getResult(long timeout, TimeUnit unit) throws OperationCanceledException, IOException, AuthenticatorException {
            return internalGetResult(Long.valueOf(timeout), unit);
        }
    }
        ...
        public void doWork() throws RemoteException {
            ...
            AccountManager.this.getAccountByTypeAndFeatures(this.mAccountType, this.mFeatures, new AccountManagerCallback<Bundle>() { // from class: android.accounts.AccountManager.GetAuthTokenByTypeAndFeaturesTask.1
                ...
                public void run(AccountManagerFuture<Bundle> future) {
                    try {
                        Bundle result = future.mo19getResult();
