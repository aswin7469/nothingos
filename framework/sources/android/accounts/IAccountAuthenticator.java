                ...
                default:
                    switch (code) {
                        ...
                        case 4:
                            ...
                            getAuthTokenLabel(_arg04, _arg111);
                            return true;
                        case 5:
                            data.enforceInterface(DESCRIPTOR);
                        ...
                        case 7:
                            ...
                            hasFeatures(_arg07, _arg14, _arg27);
                            return true;
                        case 8:
                            data.enforceInterface(DESCRIPTOR);
                            ...
                            getAccountRemovalAllowed(_arg08, _arg15);
                            return true;
                        case 9:
                            data.enforceInterface(DESCRIPTOR);
                            ...
                            getAccountCredentialsForCloning(_arg09, _arg16);
                            return true;
                        case 10:
                            data.enforceInterface(DESCRIPTOR);
                            ...
                            addAccountFromCredentials(_arg010, _arg17, _arg22);
                            return true;
                        case 11:
                            data.enforceInterface(DESCRIPTOR);
                            ...
                            startAddAccountSession(_arg011, _arg113, _arg28, _arg35, _arg42);
                            return true;
                        case 12:
                            data.enforceInterface(DESCRIPTOR);
                            ...
                            startUpdateCredentialsSession(_arg012, _arg18, _arg29, _arg33);
                            return true;
                        case 13:
                            data.enforceInterface(DESCRIPTOR);
                            ...
                            finishSession(_arg013, _arg114, _arg23);
                            return true;
                        case 14:
                            data.enforceInterface(DESCRIPTOR);
                            IAccountAuthenticatorResponse _arg014 = IAccountAuthenticatorResponse.Stub.asInterface(data.readStrongBinder());
                            if (data.readInt() != 0) {
                                _arg19 = Account.CREATOR.mo3559createFromParcel(data);
                            } else {
                                _arg19 = null;
                            }
                            String _arg210 = data.readString();
                            isCredentialsUpdateSuggested(_arg014, _arg19, _arg210);
                            return true;
                        default:
