        ...
        if (valueType2 == 2) {
            ...
            if (nodesFrom == null && nodesTo == null) {
                ...
                if (nodesTo != null) {
                    ...
                    returnValue = PropertyValuesHolder.ofObject(propertyName, evaluator, nodesTo);
                }
            } else {
                ...
                if (nodesTo != null) {
                    ...
                    returnValue = PropertyValuesHolder.ofObject(propertyName, evaluator2, nodesFrom, nodesTo);
                    toType = toType2;
                } else {
                    toType = toType2;
                    returnValue = PropertyValuesHolder.ofObject(propertyName, evaluator2, nodesFrom);
                }
            }
