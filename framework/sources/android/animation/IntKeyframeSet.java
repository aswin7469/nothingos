...
class IntKeyframeSet extends KeyframeSet implements Keyframes.IntKeyframes {
    ...
    @Override // android.animation.KeyframeSet, android.animation.Keyframes
    /* renamed from: clone */
    public IntKeyframeSet mo45clone() {
        ...
        for (int i = 0; i < numKeyframes; i++) {
            newKeyframes[i] = (Keyframe.IntKeyframe) keyframes.get(i).m35clone();
        }
    ...
    public int getIntValue(float fraction) {
        if (fraction <= 0.0f) {
            ...
            if (this.mEvaluator == null) {
                return ((int) ((nextValue - prevValue) * intervalFraction)) + prevValue;
            }
            ...
            if (this.mEvaluator == null) {
                return ((int) ((nextValue2 - prevValue2) * intervalFraction2)) + prevValue2;
            }
            ...
            for (int i = 1; i < this.mNumKeyframes; i++) {
                ...
                if (fraction < nextKeyframe3.getFraction()) {
                    ...
                    if (this.mEvaluator == null) {
                        return ((int) ((nextValue3 - prevValue3) * intervalFraction3)) + prevValue3;
                    }
