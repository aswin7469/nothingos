...
public class LayoutTransition {
    ...
    public LayoutTransition() {
        ...
        if (defaultChangeIn == null) {
            ...
            ofPropertyValuesHolder.mo1103setDuration(DEFAULT_DURATION);
            ...
            ObjectAnimator mo1102clone = defaultChangeIn.mo1102clone();
            defaultChangeOut = mo1102clone;
            mo1102clone.setStartDelay(this.mChangingDisappearingDelay);
            defaultChangeOut.setInterpolator(this.mChangingDisappearingInterpolator);
            ObjectAnimator mo1102clone2 = defaultChangeIn.mo1102clone();
            defaultChange = mo1102clone2;
            mo1102clone2.setStartDelay(this.mChangingDelay);
            defaultChange.setInterpolator(this.mChangingInterpolator);
            ObjectAnimator ofFloat = ObjectAnimator.ofFloat((Object) null, "alpha", 0.0f, 1.0f);
            defaultFadeIn = ofFloat;
            ofFloat.mo1103setDuration(DEFAULT_DURATION);
            ...
            ofFloat2.mo1103setDuration(DEFAULT_DURATION);
    ...
    private void setupChangeAnimation(final ViewGroup parent, final int changeReason, Animator baseAnimator, final long duration, final View child) {
        ...
        final Animator anim = baseAnimator.m26clone();
        ...
        ValueAnimator pendingAnimRemover = ValueAnimator.ofFloat(0.0f, 1.0f).mo1103setDuration(duration + 100);
        ...
        final View.OnLayoutChangeListener listener = new View.OnLayoutChangeListener() { // from class: android.animation.LayoutTransition.2
            ...
            public void onLayoutChange(View v, int left, int top, int right, int bottom, int oldLeft, int oldTop, int oldRight, int oldBottom) {
                ...
                anim.mo1103setDuration(duration);
    ...
    private void runAppearingTransition(final ViewGroup parent, final View child) {
        ...
        Animator anim = animator.m26clone();
        anim.setTarget(child);
        anim.setStartDelay(this.mAppearingDelay);
        anim.mo1103setDuration(this.mAppearingDuration);
    ...
    private void runDisappearingTransition(final ViewGroup parent, final View child) {
        ...
        anim.mo1103setDuration(this.mDisappearingDuration);
