...
public final class ObjectAnimator extends ValueAnimator {
    ...
    public String getPropertyName() {
        ...
        if (this.mPropertyName != null) {
            String propertyName2 = this.mPropertyName;
            return propertyName2;
        }
        Property property = this.mProperty;
        if (property != null) {
            String propertyName3 = property.getName();
    ...
    public ObjectAnimator mo1103setDuration(long duration) {
        super.mo1103setDuration(duration);
        return this;
    }
    ...
    public ObjectAnimator mo1102clone() {
        ObjectAnimator anim = (ObjectAnimator) super.mo1102clone();
        return anim;
    }
