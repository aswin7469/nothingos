...
public class StateListAnimator implements Cloneable {
    ...
    /* renamed from: clone */
    public StateListAnimator m50clone() {
        try {
            ...
            for (int i = 0; i < tupleSize; i++) {
                ...
                Animator animatorClone = tuple.mAnimator.m26clone();
    ...
    private static class StateListAnimatorConstantState extends ConstantState<StateListAnimator> {
        ...
        public StateListAnimator mo1064newInstance() {
            StateListAnimator clone = this.mAnimator.m50clone();
