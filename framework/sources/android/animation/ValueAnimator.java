...
public class ValueAnimator extends Animator implements AnimationHandler.AnimationFrameCallback {
    ...
    public ValueAnimator mo1103setDuration(long duration) {
        if (duration < 0) {
    ...
    public ValueAnimator mo1102clone() {
        ValueAnimator anim = (ValueAnimator) super.m26clone();
        if (this.mUpdateListeners != null) {
        ...
        if (oldValues != null) {
            ...
            for (int i = 0; i < numValues; i++) {
                PropertyValuesHolder newValuesHolder = oldValues[i].m47clone();
