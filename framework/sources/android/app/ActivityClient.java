...
public class ActivityClient {
    private static final Singleton<ActivityClient> sInstance = new Singleton<ActivityClient>() { // from class: android.app.ActivityClient.1
        ...
        /* renamed from: create */
        public ActivityClient mo3561create() {
    ...
    public boolean navigateUpTo(IBinder token, Intent destIntent, int resultCode, Intent resultData) {
        try {
            return getActivityClientController().navigateUpTo(token, destIntent, resultCode, resultData);
        } catch (RemoteException e) {
            throw e.rethrowFromSystemServer();
        }
    }
    ...
    public void overridePendingTransition(IBinder token, String packageName, int enterAnim, int exitAnim) {
        try {
            getActivityClientController().overridePendingTransition(token, packageName, enterAnim, exitAnim);
        } catch (RemoteException e) {
            e.rethrowFromSystemServer();
        }
    }
    ...
    public static class ActivityClientControllerSingleton extends Singleton<IActivityClientController> {
        ...
        @Override // android.util.Singleton
        /* renamed from: create */
        public IActivityClientController mo3561create() {
            try {
