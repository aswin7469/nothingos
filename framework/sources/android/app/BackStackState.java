...
public final class BackStackState implements Parcelable {
    public static final Parcelable.Creator<BackStackState> CREATOR = new Parcelable.Creator<BackStackState>() { // from class: android.app.BackStackState.1
        ...
        public BackStackState mo3559createFromParcel(Parcel in) {
        ...
        public BackStackState[] mo3560newArray(int size) {
    ...
    public BackStackState(Parcel in) {
        ...
        this.mBreadCrumbTitleText = TextUtils.CHAR_SEQUENCE_CREATOR.mo3559createFromParcel(in);
        this.mBreadCrumbShortTitleRes = in.readInt();
        this.mBreadCrumbShortTitleText = TextUtils.CHAR_SEQUENCE_CREATOR.mo3559createFromParcel(in);
