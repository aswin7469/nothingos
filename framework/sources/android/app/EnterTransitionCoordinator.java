...
public class EnterTransitionCoordinator extends ActivityTransitionCoordinator {
    ...
    private void triggerViewsReady(final ArrayMap<String, View> sharedElements) {
        ...
        this.mViewsReadyListener = OneShotPreDrawListener.add(decor, new Runnable() { // from class: android.app.EnterTransitionCoordinator$$ExternalSyntheticLambda1
            ...
            public final void run() {
                EnterTransitionCoordinator.this.lambda$triggerViewsReady$0$EnterTransitionCoordinator(sharedElements);
            }
        });
        decor.invalidate();
    }
    ...
    protected void prepareEnter() {
        ...
        if (!this.mIsReturning) {
            ...
            if (background2 == null) {
                ...
                background = background2.mo3113mutate();
    ...
    public class AnonymousClass3 implements SharedElementCallback.OnSharedElementsReadyListener {
        ...
        public void onSharedElementsReady() {
            ...
            if (decorView != null) {
                ...
                OneShotPreDrawListener.add(decorView, false, new Runnable() { // from class: android.app.EnterTransitionCoordinator$3$$ExternalSyntheticLambda1
                    @Override // java.lang.Runnable
                    public final void run() {
                        EnterTransitionCoordinator.AnonymousClass3.this.lambda$onSharedElementsReady$1$EnterTransitionCoordinator$3(bundle);
                    }
                });
        ...
        public /* synthetic */ void lambda$onSharedElementsReady$1$EnterTransitionCoordinator$3(final Bundle sharedElementState) {
            EnterTransitionCoordinator.this.startTransition(new Runnable() { // from class: android.app.EnterTransitionCoordinator$3$$ExternalSyntheticLambda0
                @Override // java.lang.Runnable
                public final void run() {
                    EnterTransitionCoordinator.AnonymousClass3.this.lambda$onSharedElementsReady$0$EnterTransitionCoordinator$3(sharedElementState);
                }
            });
        }
    ...
    public Transition beginTransition(ViewGroup decorView, boolean startEnterTransition, boolean startSharedElementTransition) {
        ...
        if (startSharedElementTransition) {
            ...
            if (sharedElementTransition == null) {
                ...
                sharedElementTransition.mo2749addListener(new TransitionListenerAdapter() { // from class: android.app.EnterTransitionCoordinator.4
        ...
        if (startEnterTransition) {
            ...
            if (viewsTransition == null) {
                ...
                viewsTransition.mo2749addListener(new ActivityTransitionCoordinator.ContinueTransitionListener() { // from class: android.app.EnterTransitionCoordinator.5
        ...
        if (transition != null) {
            transition.mo2749addListener(new ActivityTransitionCoordinator.ContinueTransitionListener());
            if (startEnterTransition) {
    ...
    public void startEnterTransition(Transition transition) {
        ...
        if (!this.mIsReturning && decorView != null) {
            ...
            if (background != null) {
                Drawable background2 = background.mo3113mutate();
                ...
                ofInt.mo1103setDuration(getFadeDuration());
                ...
                transition.mo2749addListener(new TransitionListenerAdapter() { // from class: android.app.EnterTransitionCoordinator.7
                    @Override // android.transition.TransitionListenerAdapter, android.transition.Transition.TransitionListener
                    public void onTransitionEnd(Transition transition2) {
                        transition2.mo2755removeListener(this);
                        EnterTransitionCoordinator.this.makeOpaque();
                    }
                });
    ...
    private void startRejectedAnimations(final ArrayList<View> rejectedSnapshots) {
        ...
        if (rejectedSnapshots != null && !rejectedSnapshots.isEmpty() && (decorView = getDecor()) != null) {
            ViewGroupOverlay overlay = decorView.mo2895getOverlay();
            ...
            animator.addListener(new AnimatorListenerAdapter() { // from class: android.app.EnterTransitionCoordinator.8
                @Override // android.animation.AnimatorListenerAdapter, android.animation.Animator.AnimatorListener
                public void onAnimationEnd(Animator animation) {
                    ViewGroupOverlay overlay2 = decorView.mo2895getOverlay();
