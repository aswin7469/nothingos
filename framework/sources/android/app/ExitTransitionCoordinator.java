...
public class ExitTransitionCoordinator extends ActivityTransitionCoordinator {
    ...
    public void startSharedElementExit(ViewGroup decorView) {
        ...
        transition.mo2749addListener(new TransitionListenerAdapter() { // from class: android.app.ExitTransitionCoordinator.2
        ...
        OneShotPreDrawListener.add(decorView, new Runnable() { // from class: android.app.ExitTransitionCoordinator$$ExternalSyntheticLambda2
            @Override // java.lang.Runnable
    ...
    public void fadeOutBackground() {
        ...
        if (this.mBackgroundAnimator == null) {
            ...
            if (decor != null && (background = decor.getBackground()) != null) {
                ...
                this.mBackgroundAnimator.mo1103setDuration(getFadeDuration());
    ...
    private Transition getExitTransition() {
        ...
        if (viewsTransition == null) {
            ...
            viewsTransition.mo2749addListener(new ActivityTransitionCoordinator.ContinueTransitionListener() { // from class: android.app.ExitTransitionCoordinator.6
    ...
    private Transition getSharedElementExitTransition() {
        ...
        if (sharedElementTransition == null) {
            ...
            sharedElementTransition.mo2749addListener(new ActivityTransitionCoordinator.ContinueTransitionListener() { // from class: android.app.ExitTransitionCoordinator.7
                @Override // android.app.ActivityTransitionCoordinator.ContinueTransitionListener, android.transition.TransitionListenerAdapter, android.transition.Transition.TransitionListener
                public void onTransitionEnd(Transition transition) {
