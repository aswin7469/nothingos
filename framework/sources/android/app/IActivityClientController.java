                ...
                default:
                    ...
                    switch (code) {
                        case 1:
                            ...
                            if (data.readInt() != 0) {
                                _arg1 = Configuration.CREATOR.mo3559createFromParcel(data);
                            } else {
                                _arg1 = null;
                            }
                            if (data.readInt() != 0) {
                        ...
                        case 5:
                            ...
                            if (data.readInt() != 0) {
                                _arg3 = TextUtils.CHAR_SEQUENCE_CREATOR.mo3559createFromParcel(data);
                            } else {
                                _arg3 = null;
                            }
                        ...
                        case 8:
                            ...
                            if (data.readInt() != 0) {
                                _arg13 = SizeConfigurationBuckets.CREATOR.mo3559createFromParcel(data);
                            } else {
                                _arg13 = null;
                            }
                        ...
                        case 30:
                            ...
                            if (data.readInt() != 0) {
                                _arg16 = PictureInPictureParams.CREATOR.mo3559createFromParcel(data);
                            } else {
                                _arg16 = null;
                            }
                        ...
                        case 31:
                            ...
                            if (data.readInt() != 0) {
                                _arg17 = PictureInPictureParams.CREATOR.mo3559createFromParcel(data);
                            } else {
                                _arg17 = null;
                            }
                        ...
                        case 36:
                            ...
                            if (data.readInt() != 0) {
                                _arg18 = ActivityManager.TaskDescription.CREATOR.mo3559createFromParcel(data);
                            } else {
                                _arg18 = null;
                            }
                        ...
                        case 49:
                            ...
                            if (data.readInt() != 0) {
                                _arg24 = TextUtils.CHAR_SEQUENCE_CREATOR.mo3559createFromParcel(data);
                            } else {
                                _arg24 = null;
                            }
                        ...
                        case 50:
                            ...
                            if (data.readInt() != 0) {
                                _arg111 = RemoteAnimationDefinition.CREATOR.mo3559createFromParcel(data);
                            } else {
                                _arg111 = null;
                            }
