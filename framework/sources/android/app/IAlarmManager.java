                ...
                default:
                    switch (code) {
                        case 1:
                            ...
                            if (data.readInt() != 0) {
                                _arg9 = WorkSource.CREATOR.mo3559createFromParcel(data);
                            } else {
                                _arg9 = null;
                            }
                            if (data.readInt() != 0) {
                                _arg10 = AlarmManager.AlarmClockInfo.CREATOR.mo3559createFromParcel(data);
                            } else {
                                _arg10 = null;
                            }
                        ...
                        case 8:
                            ...
                            boolean canScheduleExactAlarms = canScheduleExactAlarms(_arg06);
                            reply.writeNoException();
                        ...
                        case 9:
                            ...
                            boolean hasScheduleExactAlarm = hasScheduleExactAlarm(_arg07, _arg13);
                            reply.writeNoException();
        ...
        public static class Proxy implements IAlarmManager {
            ...
            public AlarmManager.AlarmClockInfo getNextAlarmClock(int userId) throws RemoteException {
                ...
                try {
                    ...
                    _reply.readException();
                    if (_reply.readInt() != 0) {
                        _result = AlarmManager.AlarmClockInfo.CREATOR.mo3559createFromParcel(_reply);
                    } else {
                        _result = null;
                    }
                    return _result;
