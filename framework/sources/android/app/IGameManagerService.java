...
public interface IGameManagerService extends IInterface {
    ...
    boolean getAngleEnabled(String str, int i) throws RemoteException;
    ...
    public static class Default implements IGameManagerService {
        ...
        @Override // android.app.IGameManagerService
        public boolean getAngleEnabled(String packageName, int userId) throws RemoteException {
            return false;
        }
    ...
    public static abstract class Stub extends Binder implements IGameManagerService {
        static final int TRANSACTION_getAngleEnabled = 4;
                ...
                default:
                    switch (code) {
                        ...
                        case 4:
                            ...
                            boolean angleEnabled = getAngleEnabled(_arg04, _arg13);
                            reply.writeNoException();
                            reply.writeInt(angleEnabled ? 1 : 0);
                            return true;
                        default:
        ...
        public static class Proxy implements IGameManagerService {
            ...
            public boolean getAngleEnabled(String packageName, int userId) throws RemoteException {
                ...
                try {
                    ...
                    if (!_status && Stub.getDefaultImpl() != null) {
                        return Stub.getDefaultImpl().getAngleEnabled(packageName, userId);
                    }
                    _reply.readException();
                    if (_reply.readInt() != 0) {
                        z = true;
