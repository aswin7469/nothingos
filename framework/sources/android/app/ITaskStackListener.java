                ...
                default:
                    ...
                    switch (code) {
                        ...
                        case 4:
                            data.enforceInterface(DESCRIPTOR);
                            if (data.readInt() != 0) {
                                _arg0 = ActivityManager.RunningTaskInfo.CREATOR.mo3559createFromParcel(data);
                            } else {
                                _arg0 = null;
                            }
                            if (data.readInt() != 0) {
                        ...
                        case 7:
                            data.enforceInterface(DESCRIPTOR);
                            if (data.readInt() != 0) {
                                _arg02 = ActivityManager.RunningTaskInfo.CREATOR.mo3559createFromParcel(data);
                            } else {
                                _arg02 = null;
                            }
                        ...
                        case 8:
                            data.enforceInterface(DESCRIPTOR);
                            if (data.readInt() != 0) {
                                _arg03 = ActivityManager.RunningTaskInfo.CREATOR.mo3559createFromParcel(data);
                            } else {
                                _arg03 = null;
                            }
                        ...
                        case 11:
                            data.enforceInterface(DESCRIPTOR);
                            if (data.readInt() != 0) {
                                _arg04 = ActivityManager.RunningTaskInfo.CREATOR.mo3559createFromParcel(data);
                            } else {
                                _arg04 = null;
                            }
                        ...
                        case 12:
                            data.enforceInterface(DESCRIPTOR);
                            if (data.readInt() != 0) {
                                _arg05 = ActivityManager.RunningTaskInfo.CREATOR.mo3559createFromParcel(data);
                            } else {
                                _arg05 = null;
                            }
                        ...
                        case 14:
                            data.enforceInterface(DESCRIPTOR);
                            if (data.readInt() != 0) {
                                _arg06 = ActivityManager.RunningTaskInfo.CREATOR.mo3559createFromParcel(data);
                            } else {
                                _arg06 = null;
                            }
                        ...
                        case 16:
                            ...
                            if (data.readInt() != 0) {
                                _arg13 = TaskSnapshot.CREATOR.mo3559createFromParcel(data);
                            } else {
                                _arg13 = null;
                            }
                        ...
                        case 17:
                            data.enforceInterface(DESCRIPTOR);
                            if (data.readInt() != 0) {
                                _arg07 = ActivityManager.RunningTaskInfo.CREATOR.mo3559createFromParcel(data);
                            } else {
                                _arg07 = null;
                            }
                        ...
                        case 24:
                            data.enforceInterface(DESCRIPTOR);
                            if (data.readInt() != 0) {
                                _arg08 = ActivityManager.RunningTaskInfo.CREATOR.mo3559createFromParcel(data);
                            } else {
                                _arg08 = null;
                            }
