                ...
                default:
                    ...
                    switch (code) {
                        ...
                        case 7:
                            data.enforceInterface(DESCRIPTOR);
                            if (data.readInt() != 0) {
                                _arg03 = SurfaceControl.CREATOR.mo3559createFromParcel(data);
                            } else {
                                _arg03 = null;
                            }
                        ...
                        case 12:
                            ...
                            if (data.readInt() != 0) {
                                _arg2 = ParcelFileDescriptor.CREATOR.mo3559createFromParcel(data);
                            } else {
                                _arg2 = null;
                            }
                        ...
                        case 18:
                            ...
                            if (data.readInt() != 0) {
                                _arg22 = ParcelFileDescriptor.CREATOR.mo3559createFromParcel(data);
                            } else {
                                _arg22 = null;
                            }
                            if (data.readInt() != 0) {
        ...
        public static class Proxy implements IUiAutomationConnection {
            ...
            public WindowAnimationFrameStats getWindowAnimationFrameStats() throws RemoteException {
                ...
                try {
                    ...
                    _reply.readException();
                    if (_reply.readInt() != 0) {
                        _result = WindowAnimationFrameStats.CREATOR.mo3559createFromParcel(_reply);
                    } else {
                        _result = null;
                    }
                    return _result;
