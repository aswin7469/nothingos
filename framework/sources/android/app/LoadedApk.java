...
public final class LoadedApk {
    ...
    */
    public void createOrUpdateClassLoaderLocked(List<String> addedPaths) {
        ...
        String libraryPermittedPath = canAccessDataDir() ? this.mDataDir : "";
        String libraryPermittedPath2 = !isBundledApp ? libraryPermittedPath : (libraryPermittedPath + File.pathSeparator + Paths.get(getAppDir(), new String[0]).getParent().toString()) + File.pathSeparator + defaultSearchPaths;
        ...
        if (activityThread != null) {
            ...
            if (!gpuDebugApp.isEmpty() && this.mPackageName.equals(gpuDebugApp)) {
                try {
                    ApplicationInfo ai = ActivityThread.getPackageManager().getApplicationInfo(this.mPackageName, 128, UserHandle.myUserId());
                    ...
                    if (debugLayerPath2 != null) {
                        libraryPermittedPath2 = libraryPermittedPath2 + File.pathSeparator + debugLayerPath2;
                    }
                    debugLayerPath = libraryPermittedPath2;
                ...
                if (this.mDefaultClassLoader != null) {
                    ...
                    List<ClassLoader> sharedLibraries = createSharedLibrariesLoaders(this.mApplicationInfo.sharedLibraryInfos, treatVendorApkAsUnbundled2, librarySearchPath, debugLayerPath);
        ...
        synchronized (this.mReceivers) {
            ...
            if (map != null && (rd2 = map.get(r)) != null) {
                ...
                if (holder2 != null && (rd = holder2.get(r)) != null) {
                    RuntimeException ex2 = rd.getUnregisterLocation();
        ...
        synchronized (this.mServices) {
            ...
            if (map != null && (sd2 = map.get(c)) != null) {
                ...
                if (holder2 != null && (sd = holder2.get(c)) != null) {
                    RuntimeException ex2 = sd.getUnbindLocation();
