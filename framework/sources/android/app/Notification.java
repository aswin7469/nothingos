...
public class Notification implements Parcelable {
    ...
    private static final List<Class<? extends Style>> PLATFORM_STYLE_CLASSES = Arrays.asList(BigTextStyle.class, BigPictureStyle.class, InboxStyle.class, MediaStyle.class, DecoratedCustomViewStyle.class, DecoratedMediaCustomViewStyle.class, MessagingStyle.class, CallStyle.class);
    public static final Parcelable.Creator<Notification> CREATOR = new Parcelable.Creator<Notification>() { // from class: android.app.Notification.1
        ...
        public Notification mo3559createFromParcel(Parcel parcel) {
        ...
        public Notification[] mo3560newArray(int size) {
    ...
    static {
        ...
        arraySet.add(Integer.valueOf((int) R.layout.notification_template_material_base));
        arraySet.add(Integer.valueOf((int) R.layout.notification_template_material_heads_up_base));
        arraySet.add(Integer.valueOf((int) R.layout.notification_template_material_big_base));
        arraySet.add(Integer.valueOf((int) R.layout.notification_template_material_big_picture));
        arraySet.add(Integer.valueOf((int) R.layout.notification_template_material_big_text));
        arraySet.add(Integer.valueOf((int) R.layout.notification_template_material_inbox));
        arraySet.add(Integer.valueOf((int) R.layout.notification_template_material_messaging));
        arraySet.add(Integer.valueOf((int) R.layout.notification_template_material_big_messaging));
        arraySet.add(Integer.valueOf((int) R.layout.notification_template_material_conversation));
        arraySet.add(Integer.valueOf((int) R.layout.notification_template_material_media));
        arraySet.add(Integer.valueOf((int) R.layout.notification_template_material_big_media));
        arraySet.add(Integer.valueOf((int) R.layout.notification_template_material_call));
        arraySet.add(Integer.valueOf((int) R.layout.notification_template_material_big_call));
        arraySet.add(Integer.valueOf((int) R.layout.notification_template_header));
    }
    ...
    public static class Action implements Parcelable {
        public static final Parcelable.Creator<Action> CREATOR = new Parcelable.Creator<Action>() { // from class: android.app.Notification.Action.1
            ...
            @Override // android.os.Parcelable.Creator
            /* renamed from: createFromParcel */
            public Action mo3559createFromParcel(Parcel in) {
            ...
            @Override // android.os.Parcelable.Creator
            /* renamed from: newArray */
            public Action[] mo3560newArray(int size) {
        ...
        private Action(Parcel in) {
            ...
            if (in.readInt() != 0) {
                Icon mo3559createFromParcel = Icon.CREATOR.mo3559createFromParcel(in);
                this.mIcon = mo3559createFromParcel;
                if (mo3559createFromParcel.getType() == 2) {
                    this.icon = this.mIcon.getResId();
                }
            }
            this.title = TextUtils.CHAR_SEQUENCE_CREATOR.mo3559createFromParcel(in);
            if (in.readInt() == 1) {
                this.actionIntent = PendingIntent.CREATOR.mo3559createFromParcel(in);
            }
            ...
            this.mAuthenticationRequired = in.readInt() != 1 ? false : z;
        }
        ...
        public static final class WearableExtender implements Extender {
            ...
            /* renamed from: clone */
            public WearableExtender m157clone() {
    ...
    private void readFromParcelImpl(Parcel parcel) {
        ...
        if (parcel.readInt() != 0) {
            Icon mo3559createFromParcel = Icon.CREATOR.mo3559createFromParcel(parcel);
            this.mSmallIcon = mo3559createFromParcel;
            if (mo3559createFromParcel.getType() == 2) {
        ...
        if (parcel.readInt() != 0) {
            this.contentIntent = PendingIntent.CREATOR.mo3559createFromParcel(parcel);
        }
        if (parcel.readInt() != 0) {
            this.deleteIntent = PendingIntent.CREATOR.mo3559createFromParcel(parcel);
        }
        if (parcel.readInt() != 0) {
            this.tickerText = TextUtils.CHAR_SEQUENCE_CREATOR.mo3559createFromParcel(parcel);
        }
        if (parcel.readInt() != 0) {
            this.tickerView = RemoteViews.CREATOR.mo3559createFromParcel(parcel);
        }
        if (parcel.readInt() != 0) {
            this.contentView = RemoteViews.CREATOR.mo3559createFromParcel(parcel);
        }
        if (parcel.readInt() != 0) {
            this.mLargeIcon = Icon.CREATOR.mo3559createFromParcel(parcel);
        }
        this.defaults = parcel.readInt();
        this.flags = parcel.readInt();
        if (parcel.readInt() != 0) {
            this.sound = Uri.CREATOR.mo3559createFromParcel(parcel);
        }
        this.audioStreamType = parcel.readInt();
        if (parcel.readInt() != 0) {
            this.audioAttributes = AudioAttributes.CREATOR.mo3559createFromParcel(parcel);
        }
        ...
        if (parcel.readInt() != 0) {
            this.fullScreenIntent = PendingIntent.CREATOR.mo3559createFromParcel(parcel);
        }
        ...
        if (parcel.readInt() != 0) {
            this.bigContentView = RemoteViews.CREATOR.mo3559createFromParcel(parcel);
        }
        if (parcel.readInt() != 0) {
            this.headsUpContentView = RemoteViews.CREATOR.mo3559createFromParcel(parcel);
        }
        this.visibility = parcel.readInt();
        if (parcel.readInt() != 0) {
            this.publicVersion = CREATOR.mo3559createFromParcel(parcel);
        }
        ...
        if (parcel.readInt() != 0) {
            this.mLocusId = LocusId.CREATOR.mo3559createFromParcel(parcel);
        }
        this.mBadgeIcon = parcel.readInt();
        if (parcel.readInt() != 0) {
            this.mSettingsText = TextUtils.CHAR_SEQUENCE_CREATOR.mo3559createFromParcel(parcel);
        }
        this.mGroupAlertBehavior = parcel.readInt();
        if (parcel.readInt() != 0) {
            this.mBubbleMetadata = BubbleMetadata.CREATOR.mo3559createFromParcel(parcel);
        }
        ...
        if (actionArr != null) {
            ...
            while (true) {
                ...
                if (actionArr2[i] != null) {
                    that.actions[i] = actionArr2[i].m154clone();
                }
                i++;
            }
        }
    ...
    public void visitUris(Consumer<Uri> visitor) {
        ...
        if (bundle2 != null) {
            visitIconUri(visitor, (Icon) bundle2.getParcelable(EXTRA_LARGE_ICON_BIG));
            visitIconUri(visitor, (Icon) this.extras.getParcelable(EXTRA_PICTURE_ICON));
            ...
            ArrayList<Person> people = this.extras.getParcelableArrayList(EXTRA_PEOPLE_LIST);
            ...
            Person person = (Person) this.extras.getParcelable(EXTRA_MESSAGING_PERSON);
            if (person != null) {
        ...
        if (charSequence instanceof Spanned) {
            ...
            for (Object span : spans) {
                ...
                if (resultSpan2 instanceof CharacterStyle) {
                    resultSpan2 = ((CharacterStyle) span).mo2745getUnderlying();
                }
        ...
        if (collectPendingIntents) {
            PendingIntent.setOnMarshaledListener(new PendingIntent.OnMarshaledListener() { // from class: android.app.Notification$$ExternalSyntheticLambda0
                ...
                public final void onMarshaled(PendingIntent pendingIntent, Parcel parcel2, int i) {
                    Notification.this.lambda$writeToParcel$0$Notification(parcel, pendingIntent, parcel2, i);
                }
            });
        }
        try {
    ...
    public static class Builder {
        ...
        public RemoteViews applyStandardTemplate(int resId, StandardTemplateParams p, TemplateBindResult result) {
            p.headerless(resId == getBaseLayoutResource() || resId == getHeadsUpBaseLayoutResource() || resId == getMessagingLayoutResource() || resId == 17367221);
            ...
            if (p.text != null && p.text.length() != 0 && (!showProgress || p.mAllowTextWithProgress)) {
                ...
                hasSecondLine = true;
            } else if (p.mTextViewId != 16909534) {
        ...
        private void bindLargeIcon(RemoteViews contentView, StandardTemplateParams p, TemplateBindResult result) {
            ...
            if (rightIcon != null) {
                ...
                if (!isPromotedPicture) {
                    i = 0;
                }
                contentView.setIntTag(R.id.right_icon, R.id.tag_keep_when_showing_left_icon, i);
        ...
        private boolean bindHeaderTextSecondary(RemoteViews contentView, StandardTemplateParams p, boolean hasTextToLeft) {
            if (!p.mHideSubText && !TextUtils.isEmpty(p.headerTextSecondary)) {
        ...
        private boolean isBackgroundColorized(StandardTemplateParams p) {
            return p.allowColorization && this.mN.color != 0 && this.mN.isColorized();
        }

        /* JADX INFO: Access modifiers changed from: private */
        public boolean isCallActionColorCustomizable() {
            return this.mN.color != 0 && this.mN.isColorized() && this.mContext.getResources().getBoolean(R.bool.config_callNotificationActionColorsRequireColorized);
        }
        ...
        private void resetStandardTemplateWithActions(RemoteViews big) {
            ...
            big.setViewLayoutMarginDimen(R.id.notification_action_list_margin_target, 3, R.dimen.notification_content_margin);
        }

        private void bindSnoozeAction(RemoteViews big, StandardTemplateParams p) {
            boolean snoozeEnabled = true;
            boolean hideSnoozeButton = this.mN.isForegroundService() || this.mN.fullScreenIntent != null || isBackgroundColorized(p) || p.mViewType != StandardTemplateParams.VIEW_TYPE_BIG;
        ...
        public RemoteViews applyStandardTemplateWithActions(int layoutId, StandardTemplateParams p, TemplateBindResult result) {
            ...
            boolean emphazisedMode2 = this.mN.fullScreenIntent != null || p.mCallStyleActions;
            if (!p.mCallStyleActions) {
                i = 16908722;
                emphazisedMode = emphazisedMode2;
            } else {
                i = 16908722;
                emphazisedMode = emphazisedMode2;
            ...
            big.setBoolean(i, "setEmphasizedMode", emphazisedMode);
            ...
            if (validRemoteInput && replyText != null && replyText.length > 0 && !TextUtils.isEmpty(replyText[0].getText()) && p.maxRemoteInputHistory > 0) {
                ...
                big.setTextViewText(R.id.notification_material_reply_text_1, processTextSpans(replyText[0].getText()));
                ...
                if (replyText.length > 1 && !TextUtils.isEmpty(replyText[1].getText()) && p.maxRemoteInputHistory > 1) {
                    ...
                    big.setTextViewText(R.id.notification_material_reply_text_2, processTextSpans(replyText[1].getText()));
                    ...
                    if (replyText.length > 2 && !TextUtils.isEmpty(replyText[2].getText()) && p.maxRemoteInputHistory > 2) {
                        ...
                        big.setTextViewText(R.id.notification_material_reply_text_3, processTextSpans(replyText[2].getText()));
        ...
        private CharSequence createSummaryText() {
            ...
            if (titleText != null) {
                summary.mo2731append(bidi.unicodeWrap(titleText));
            }
            CharSequence contentText = this.mN.extras.getCharSequence(Notification.EXTRA_TEXT);
            if (titleText != null && contentText != null) {
                summary.mo2731append(bidi.unicodeWrap(this.mContext.getText(R.string.notification_header_divider_symbol_with_spaces)));
            }
            if (contentText != null) {
                summary.mo2731append(bidi.unicodeWrap(contentText));
            }
            return summary;
        }
        ...
        private RemoteViews generateActionButton(Action action, boolean emphasizedMode, StandardTemplateParams p) {
            ...
            if (!emphasizedMode) {
                ...
                if (p.mCallStyleActions) {
                    ...
                    if (priority) {
                        minWidthDimen = R.dimen.call_notification_system_action_min_width;
                    }
            ...
            if (charSequence instanceof Spanned) {
                ...
                while (i2 < length) {
                    ...
                    if (resultSpan instanceof CharacterStyle) {
                        resultSpan = ((CharacterStyle) span).mo2745getUnderlying();
                    }
        ...
        private void processSmallIconColor(Icon smallIcon, RemoteViews contentView, StandardTemplateParams p) {
            ...
            contentView.setInt(16908294, "setOriginalIconColor", i);
        }
        ...
        public static Notification maybeCloneStrippedForDelivery(Notification n) {
            ...
            Notification clone = n.m151clone();
            if (stripContentView) {
    ...
    public void reduceImageSizes(Context context) {
        ...
        if (this.mLargeIcon != null || this.largeIcon != null) {
            ...
            int maxSize = resources.getDimensionPixelSize(i);
            ...
            if (bitmap != null) {
                this.largeIcon = Icon.scaleDownIfNecessary(bitmap, maxSize, maxSize);
            }
        }
    ...
    public boolean shouldShowForegroundImmediately() {
        ...
        return isMediaNotification() || hasMediaSession() || "call".equals(this.category) || CATEGORY_NAVIGATION.equals(this.category) || ((actionArr = this.actions) != null && actionArr.length > 0);
    }
    ...
    public static class BigPictureStyle extends Style {
        ...
        public RemoteViews makeBigContentView() {
            ...
            if (charSequence != null) {
                contentView.setContentDescription(R.id.big_picture, charSequence);
            }
            return contentView;
        }
        ...
        public static Icon getPictureIcon(Bundle extras) {
            ...
            Bitmap bitmapPicture = (Bitmap) extras.getParcelable(Notification.EXTRA_PICTURE);
            if (bitmapPicture != null) {
                return Icon.createWithBitmap(bitmapPicture);
            }
            return (Icon) extras.getParcelable(Notification.EXTRA_PICTURE_ICON);
        }
    ...
    public static class MessagingStyle extends Style {
        ...
        protected void restoreFromExtras(Bundle extras) {
            super.restoreFromExtras(extras);
            Person person = (Person) extras.getParcelable(Notification.EXTRA_MESSAGING_PERSON);
            this.mUser = person;
            if (person == null) {
            ...
            this.mShortcutIcon = (Icon) extras.getParcelable(Notification.EXTRA_CONVERSATION_ICON);
        }
        ...
        private RemoteViews makeMessagingView(int viewType) {
            ...
            StandardTemplateParams hideRightIcon = this.mBuilder.mParams.reset().viewType(viewType).highlightExpander(isConversationLayout).hideProgress(true).title(isHeaderless ? conversationTitle : null).text(null).hideLeftIcon(isOneToOne).hideRightIcon(hideRightIcons || isOneToOne);
            if (!isHeaderless) {
                charSequence = conversationTitle;
            }
            StandardTemplateParams p = hideRightIcon.headerTextSecondary(charSequence);
            Builder builder = this.mBuilder;
            if (isConversationLayout) {
                messagingLayoutResource = this.mBuilder.getConversationLayoutResource();
            } else {
                messagingLayoutResource = isCollapsed ? this.mBuilder.getMessagingLayoutResource() : this.mBuilder.getBigMessagingLayoutResource();
            }
            RemoteViews contentView = builder.applyStandardTemplateWithActions(messagingLayoutResource, p, bindResult);
            if (isConversationLayout) {
    ...
    public static class InboxStyle extends Style {
        ...
        */
        public RemoteViews makeBigContentView() {
            ...
            RemoteInputHistoryItem[] remoteInputHistory = (RemoteInputHistoryItem[]) Notification.getParcelableArrayFromBundle(this.mBuilder.mN.extras, Notification.EXTRA_REMOTE_INPUT_HISTORY_ITEMS, RemoteInputHistoryItem.class);
    ...
    public static class MediaStyle extends Style {
        ...
        protected RemoteViews makeMediaContentView(RemoteViews customContent) {
            ...
            for (int i2 = 0; i2 < 3; i2++) {
                if (i2 < numActionsToShow) {
                    Action action = (Action) this.mBuilder.mActions.get(this.mActionsToShowInCompact[i2]);
                    bindMediaActionButton(template, MEDIA_BUTTON_IDS[i2], action, p);
                } else {
                    template.setViewVisibility(MEDIA_BUTTON_IDS[i2], 8);
                }
            }
            if (numActionsToShow == 0) {
                z = false;
            }
            boolean hasActions = z;
            if (!hasActions) {
                i = 8;
            }
            template.setViewVisibility(R.id.media_actions, i);
    ...
    public static class CallStyle extends Style {
        ...
        public static CallStyle forIncomingCall(Person person, PendingIntent declineIntent, PendingIntent answerIntent) {
            Objects.requireNonNull(declineIntent, "declineIntent is required");
            Objects.requireNonNull(answerIntent, "answerIntent is required");
            return new CallStyle(1, person, null, declineIntent, answerIntent);
        }
        ...
        public static CallStyle forOngoingCall(Person person, PendingIntent hangUpIntent) {
            ...
            return new CallStyle(2, person, hangUpIntent, null, null);
        }

        public static CallStyle forScreeningCall(Person person, PendingIntent hangUpIntent, PendingIntent answerIntent) {
            Objects.requireNonNull(hangUpIntent, "hangUpIntent is required");
            Objects.requireNonNull(answerIntent, "answerIntent is required");
            return new CallStyle(3, person, hangUpIntent, null, answerIntent);
        }
        ...
        private Action makeAnswerAction() {
            ...
            return makeAction(z ? R.drawable.ic_call_answer_video : R.drawable.ic_call_answer, z ? 17039806 : 17039805, this.mAnswerButtonColor, R.color.call_notification_answer_color, pendingIntent);
        }
        ...
        public ArrayList<Action> getActionsListWithSystemActions() {
            ...
            Action answerAction = makeAnswerAction();
        ...
        private RemoteViews makeCallLayout(int viewType) {
            ...
            this.mBuilder.mActions = getActionsListWithSystemActions();
            RemoteViews contentView = isCollapsed ? this.mBuilder.applyStandardTemplate(R.layout.notification_template_material_call, p, null) : this.mBuilder.applyStandardTemplateWithActions(R.layout.notification_template_material_big_call, p, null);
            if (!p.mHideAppName) {
                this.mBuilder.setTextViewColorSecondary(contentView, R.id.app_name_divider, p);
                contentView.setViewVisibility(R.id.app_name_divider, 0);
            }
        ...
        private void bindCallerVerification(RemoteViews contentView, StandardTemplateParams p) {
            ...
            Icon icon = this.mVerificationIcon;
            if (icon != null) {
                contentView.setImageViewIcon(R.id.verification_icon, icon);
            ...
            if (showDivider) {
                contentView.setViewVisibility(R.id.verification_divider, 0);
        ...
        protected void restoreFromExtras(Bundle extras) {
            ...
            this.mPerson = (Person) extras.getParcelable(Notification.EXTRA_CALL_PERSON);
            ...
            this.mAnswerIntent = (PendingIntent) extras.getParcelable(Notification.EXTRA_ANSWER_INTENT);
            this.mDeclineIntent = (PendingIntent) extras.getParcelable(Notification.EXTRA_DECLINE_INTENT);
            this.mHangUpIntent = (PendingIntent) extras.getParcelable(Notification.EXTRA_HANG_UP_INTENT);
            Integer num = null;
            ...
            if (extras.containsKey(Notification.EXTRA_DECLINE_COLOR)) {
                num = Integer.valueOf(extras.getInt(Notification.EXTRA_DECLINE_COLOR));
            }
        ...
        public boolean areNotificationsVisiblyDifferent(Style other) {
            ...
            return !Objects.equals(Integer.valueOf(this.mCallType), Integer.valueOf(otherS.mCallType)) || !Objects.equals(this.mPerson, otherS.mPerson) || !Objects.equals(this.mVerificationText, otherS.mVerificationText);
        }
    }
    ...
    public static final class BubbleMetadata implements Parcelable {
        public static final Parcelable.Creator<BubbleMetadata> CREATOR = new Parcelable.Creator<BubbleMetadata>() { // from class: android.app.Notification.BubbleMetadata.1
            ...
            @Override // android.os.Parcelable.Creator
            /* renamed from: createFromParcel */
            public BubbleMetadata mo3559createFromParcel(Parcel source) {
            ...
            @Override // android.os.Parcelable.Creator
            /* renamed from: newArray */
            public BubbleMetadata[] mo3560newArray(int size) {
        ...
        private BubbleMetadata(Parcel in) {
            if (in.readInt() != 0) {
                this.mPendingIntent = PendingIntent.CREATOR.mo3559createFromParcel(in);
            }
            if (in.readInt() != 0) {
                this.mIcon = Icon.CREATOR.mo3559createFromParcel(in);
            }
            this.mDesiredHeight = in.readInt();
            this.mFlags = in.readInt();
            if (in.readInt() != 0) {
                this.mDeleteIntent = PendingIntent.CREATOR.mo3559createFromParcel(in);
            }
    ...
    public static final class WearableExtender implements Extender {
        ...
        /* renamed from: clone */
        public WearableExtender m161clone() {
            WearableExtender that = new WearableExtender();
    ...
    public static class BuilderRemoteViews extends RemoteViews {
        ...
        /* renamed from: clone */
        public BuilderRemoteViews mo160clone() {
    ...
    public static class TemplateBindResult {
        ...
        public class MarginSet {
            ...
            public void applyToView(RemoteViews views, int viewId, float extraMarginDp) {
                ...
                } else if (viewId == 16909534 || viewId == 16908795) {
    ...
    public static class Colors {
        ...
        public void resolvePalette(Context ctx, int rawColor, boolean isColorized, boolean nightMode) {
            ...
            if (isColorized) {
                ...
                this.mPrimaryAccentColor = i2;
                this.mSecondaryAccentColor = findAlphaToMeetContrast;
                this.mTertiaryAccentColor = flattenAlpha(i2, this.mBackgroundColor);
                this.mOnAccentTextColor = this.mBackgroundColor;
                this.mErrorColor = this.mPrimaryTextColor;
                this.mRippleAlpha = 51;
            } else {
                ta = obtainDayNightAttributes(ctx, new int[]{R.attr.colorSurface, 16844002, 16842806, 16842808, 16843829, R.attr.colorAccentSecondary, R.attr.colorAccentTertiary, R.attr.textColorOnAccent, 16844099, 16843820});
                if (nightMode) {
                    i = -16777216;
                }
                try {
                    this.mBackgroundColor = getColor(ta, 0, i);
