...
public final class NotificationChannel implements Parcelable {
    ...
    public static final Parcelable.Creator<NotificationChannel> CREATOR = new Parcelable.Creator<NotificationChannel>() { // from class: android.app.NotificationChannel.1
        ...
        public NotificationChannel mo3559createFromParcel(Parcel in) {
        ...
        public NotificationChannel[] mo3560newArray(int size) {
    ...
    protected NotificationChannel(Parcel in) {
        ...
        if (in.readByte() != 0) {
            this.mSound = Uri.CREATOR.mo3559createFromParcel(in);
        } else {
            this.mSound = null;
        }
        if (in.readByte() == 0) {
        ...
        this.mAudioAttributes = in.readInt() > 0 ? AudioAttributes.CREATOR.mo3559createFromParcel(in) : audioAttributes;
