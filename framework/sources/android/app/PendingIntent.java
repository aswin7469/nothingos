...
public final class PendingIntent implements Parcelable {
    ...
    public static final Parcelable.Creator<PendingIntent> CREATOR = new Parcelable.Creator<PendingIntent>() { // from class: android.app.PendingIntent.2
        ...
        public PendingIntent mo3559createFromParcel(Parcel in) {
        ...
        public PendingIntent[] mo3560newArray(int size) {
    ...
    private static void checkFlags(int flags, String packageName) {
        ...
        if (Compatibility.isChangeEnabled((long) PENDING_INTENT_EXPLICIT_MUTABILITY_REQUIRED) && !flagImmutableSet && !flagMutableSet) {
