...
public class ProfilerInfo implements Parcelable {
    public static final Parcelable.Creator<ProfilerInfo> CREATOR = new Parcelable.Creator<ProfilerInfo>() { // from class: android.app.ProfilerInfo.1
        ...
        public ProfilerInfo mo3559createFromParcel(Parcel in) {
        ...
        public ProfilerInfo[] mo3560newArray(int size) {
    ...
    private ProfilerInfo(Parcel in) {
        ...
        this.profileFd = in.readInt() != 0 ? ParcelFileDescriptor.CREATOR.mo3559createFromParcel(in) : null;
