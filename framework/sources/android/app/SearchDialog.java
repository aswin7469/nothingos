...
public class SearchDialog extends Dialog {
    ...
    private BroadcastReceiver mConfChangeListener = new BroadcastReceiver() { // from class: android.app.SearchDialog.1
    ...
    private final SearchView.OnCloseListener mOnCloseListener = new SearchView.OnCloseListener() { // from class: android.app.SearchDialog.3
        @Override // android.widget.SearchView.OnCloseListener
        public boolean onClose() {
            return SearchDialog.this.onClosePressed();
        }
    };
    private final SearchView.OnQueryTextListener mOnQueryChangeListener = new SearchView.OnQueryTextListener() { // from class: android.app.SearchDialog.4
    ...
    private final SearchView.OnSuggestionListener mOnSuggestionSelectionListener = new SearchView.OnSuggestionListener() { // from class: android.app.SearchDialog.5
