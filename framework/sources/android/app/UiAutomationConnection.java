...
public final class UiAutomationConnection extends IUiAutomationConnection.Stub {
    ...
    public boolean injectInputEvent(InputEvent event, boolean sync, boolean waitForAnimations) {
        ...
        try {
            return this.mWindowManager.injectInputAfterTransactionsApplied(event, mode, waitForAnimations);
    ...
    public Bitmap takeScreenshot(Rect crop) {
        ...
        try {
            ...
            SurfaceControl.DisplayCaptureArgs captureArgs = ((SurfaceControl.DisplayCaptureArgs.Builder) new SurfaceControl.DisplayCaptureArgs.Builder(displayToken).setSourceCrop(crop)).setSize(width, height).build();
    ...
    public Bitmap takeSurfaceControlScreenshot(SurfaceControl surfaceControl) {
        ...
        long identity = Binder.clearCallingIdentity();
        try {
            SurfaceControl.ScreenshotHardwareBuffer captureBuffer = SurfaceControl.captureLayers(new SurfaceControl.LayerCaptureArgs.Builder(surfaceControl).setChildrenOnly(false).build());
