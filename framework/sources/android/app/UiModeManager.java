    ...
    public static class InnerListener extends IOnProjectionStateChangedListener.Stub {
        ...
        public void onProjectionStateChanged(int activeProjectionTypes, List<String> projectingPackages) {
            ...
            if (outerListener == null || executor == null) {
                ...
                executor.execute(PooledLambda.obtainRunnable(UiModeManager$InnerListener$$ExternalSyntheticLambda0.INSTANCE, outerListener, Integer.valueOf(activeProjectionTypes), new ArraySet(projectingPackages)).mo3494recycleOnUse());
            }
        }
    }
