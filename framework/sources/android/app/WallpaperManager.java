...
public class WallpaperManager {
    ...
    public static class Globals extends IWallpaperManagerCallback.Stub {
        ...
        public Rect peekWallpaperDimensions(Context context, boolean returnDefault, int userId) {
            ...
            if ((dimensions == null || dimensions.width() == 0 || dimensions.height() == 0) && returnDefault && (is = WallpaperManager.openDefaultWallpaper(context, 1)) != null) {
                try {
    ...
    public Rect peekBitmapDimensions() {
        ...
        return globals.peekWallpaperDimensions(context, true, context.getUserId());
    }
    ...
    public static InputStream openDefaultWallpaper(Context context, int which) {
        ...
        String colorType = SystemProperties.get("ro.phone.shell.color", "");
        String str = TAG;
        Log.d(str, "openDefaultWallpaper colorType :" + colorType);
        if ("black".equalsIgnoreCase(colorType)) {
            defaultResId = R.drawable.feature_wallpaper_black;
        } else if ("white".equalsIgnoreCase(colorType)) {
            defaultResId = R.drawable.feature_wallpaper_white;
        } else {
