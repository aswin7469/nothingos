...
public class DevicePolicyManager {
    ...
    public void resetNewUserDisclaimer() {
        ...
        if (iDevicePolicyManager != null) {
            try {
                iDevicePolicyManager.resetNewUserDisclaimer();
            } catch (RemoteException e) {
                throw e.rethrowFromSystemServer();
            }
        }
    ...
    public void setRequiredPasswordComplexity(int passwordComplexity) {
        ...
        try {
            iDevicePolicyManager.setRequiredPasswordComplexity(passwordComplexity, this.mParentInstance);
        } catch (RemoteException e) {
            throw e.rethrowFromSystemServer();
        }
    }
    ...
    public int getRequiredPasswordComplexity() {
        ...
        try {
            return iDevicePolicyManager.getRequiredPasswordComplexity(this.mParentInstance);
        } catch (RemoteException e) {
            throw e.rethrowFromSystemServer();
        }
    }
    ...
    private void wipeDataInternal(int flags, String wipeReasonForUser) {
        ...
        if (iDevicePolicyManager != null) {
            try {
                iDevicePolicyManager.wipeDataWithReason(flags, wipeReasonForUser, this.mParentInstance);
            } catch (RemoteException e) {
                throw e.rethrowFromSystemServer();
            }
        }
    ...
    public void setFactoryResetProtectionPolicy(ComponentName admin, FactoryResetProtectionPolicy policy) {
        ...
        if (iDevicePolicyManager != null) {
            try {
                iDevicePolicyManager.setFactoryResetProtectionPolicy(admin, policy);
            } catch (RemoteException e) {
                throw e.rethrowFromSystemServer();
            }
        }
    ...
    public Pair<String, String> getProxyParameters(Proxy proxySpec, List<String> exclusionList) {
        ...
        return new Pair<>(hostName + SettingsStringUtil.DELIMITER + port, TextUtils.join(",", trimmedExclList));
    }
    ...
    public void setCameraDisabled(ComponentName admin, boolean disabled) {
        ...
        if (iDevicePolicyManager != null) {
            try {
                iDevicePolicyManager.setCameraDisabled(admin, disabled, this.mParentInstance);
            } catch (RemoteException e) {
                throw e.rethrowFromSystemServer();
            }
        }
    ...
    public boolean getCameraDisabled(ComponentName admin, int userHandle) {
        ...
        if (iDevicePolicyManager != null) {
            try {
                return iDevicePolicyManager.getCameraDisabled(admin, userHandle, this.mParentInstance);
            } catch (RemoteException e) {
                throw e.rethrowFromSystemServer();
            }
        }
    ...
    public void setScreenCaptureDisabled(ComponentName admin, boolean disabled) {
        ...
        if (iDevicePolicyManager != null) {
            try {
                iDevicePolicyManager.setScreenCaptureDisabled(admin, disabled, this.mParentInstance);
            } catch (RemoteException e) {
                throw e.rethrowFromSystemServer();
            }
        }
    ...
    public void setAutoTimeEnabled(ComponentName admin, boolean enabled) {
        ...
        if (iDevicePolicyManager != null) {
            try {
                iDevicePolicyManager.setAutoTimeEnabled(admin, enabled);
            } catch (RemoteException e) {
                throw e.rethrowFromSystemServer();
            }
        }
    ...
    public boolean getAutoTimeEnabled(ComponentName admin) {
        ...
        if (iDevicePolicyManager != null) {
            try {
                return iDevicePolicyManager.getAutoTimeEnabled(admin);
            } catch (RemoteException e) {
                throw e.rethrowFromSystemServer();
            }
        }
    ...
    public void setAutoTimeZoneEnabled(ComponentName admin, boolean enabled) {
        ...
        if (iDevicePolicyManager != null) {
            try {
                iDevicePolicyManager.setAutoTimeZoneEnabled(admin, enabled);
            } catch (RemoteException e) {
                throw e.rethrowFromSystemServer();
            }
        }
    ...
    public boolean getAutoTimeZoneEnabled(ComponentName admin) {
        ...
        if (iDevicePolicyManager != null) {
            try {
                return iDevicePolicyManager.getAutoTimeZoneEnabled(admin);
            } catch (RemoteException e) {
                throw e.rethrowFromSystemServer();
            }
        }
    ...
    public boolean setProfileOwner(ComponentName admin, @Deprecated String ownerName, int userHandle) throws IllegalArgumentException {
        ...
        if (iDevicePolicyManager != null) {
            ...
            try {
                return iDevicePolicyManager.setProfileOwner(admin, ownerName, userHandle);
            } catch (RemoteException re) {
                throw re.rethrowFromSystemServer();
            }
        }
    ...
    public ComponentName getProfileOwnerOrDeviceOwnerSupervisionComponent(UserHandle user) {
        ...
        if (iDevicePolicyManager != null) {
            try {
                return iDevicePolicyManager.getProfileOwnerOrDeviceOwnerSupervisionComponent(user);
            } catch (RemoteException re) {
                throw re.rethrowFromSystemServer();
            }
        }
    ...
    public void setDefaultSmsApplication(ComponentName admin, String packageName) {
        ...
        if (iDevicePolicyManager != null) {
            try {
                iDevicePolicyManager.setDefaultSmsApplication(admin, packageName, this.mParentInstance);
            } catch (RemoteException e) {
                throw e.rethrowFromSystemServer();
            }
        }
    ...
    public boolean setPermittedInputMethods(ComponentName admin, List<String> packageNames) {
        ...
        if (iDevicePolicyManager != null) {
            try {
                return iDevicePolicyManager.setPermittedInputMethods(admin, packageNames, this.mParentInstance);
            } catch (RemoteException e) {
                throw e.rethrowFromSystemServer();
            }
        }
    ...
    public List<String> getPermittedInputMethods(ComponentName admin) {
        ...
        if (iDevicePolicyManager != null) {
            try {
                return iDevicePolicyManager.getPermittedInputMethods(admin, this.mParentInstance);
            } catch (RemoteException e) {
                throw e.rethrowFromSystemServer();
            }
        }
    ...
    public void addUserRestriction(ComponentName admin, String key) {
        ...
        if (iDevicePolicyManager != null) {
            try {
                iDevicePolicyManager.setUserRestriction(admin, key, true, this.mParentInstance);
            } catch (RemoteException e) {
                throw e.rethrowFromSystemServer();
            }
        }
    ...
    public void clearUserRestriction(ComponentName admin, String key) {
        ...
        if (iDevicePolicyManager != null) {
            try {
                iDevicePolicyManager.setUserRestriction(admin, key, false, this.mParentInstance);
            } catch (RemoteException e) {
                throw e.rethrowFromSystemServer();
            }
        }
    ...
    public Bundle getUserRestrictions(ComponentName admin) {
        ...
        if (iDevicePolicyManager != null) {
            try {
                ret = iDevicePolicyManager.getUserRestrictions(admin, this.mParentInstance);
            } catch (RemoteException e) {
                throw e.rethrowFromSystemServer();
            }
        }
    ...
    public void setAccountManagementDisabled(ComponentName admin, String accountType, boolean disabled) {
        ...
        if (iDevicePolicyManager != null) {
            try {
                iDevicePolicyManager.setAccountManagementDisabled(admin, accountType, disabled, this.mParentInstance);
            } catch (RemoteException e) {
                throw e.rethrowFromSystemServer();
            }
        }
    ...
    public String[] getAccountTypesWithManagementDisabledAsUser(int userId, boolean parentInstance) {
        ...
        if (iDevicePolicyManager != null) {
            try {
                return iDevicePolicyManager.getAccountTypesWithManagementDisabledAsUser(userId, parentInstance);
            } catch (RemoteException e) {
                throw e.rethrowFromSystemServer();
            }
        }
    ...
    public void setPreferentialNetworkServiceEnabled(boolean enabled) {
        ...
        try {
            iDevicePolicyManager.setPreferentialNetworkServiceEnabled(enabled);
        } catch (RemoteException e) {
            throw e.rethrowFromSystemServer();
        }
    }
    ...
    public boolean isPreferentialNetworkServiceEnabled() {
        ...
        try {
            return iDevicePolicyManager.isPreferentialNetworkServiceEnabled(myUserId());
        } catch (RemoteException e) {
            throw e.rethrowFromSystemServer();
        }
    }
    ...
    public void setConfiguredNetworksLockdownState(ComponentName admin, boolean lockdown) {
        ...
        if (iDevicePolicyManager != null) {
            try {
                iDevicePolicyManager.setConfiguredNetworksLockdownState(admin, lockdown);
            } catch (RemoteException e) {
                throw e.rethrowFromSystemServer();
            }
        }
    ...
    public boolean setPermissionGrantState(ComponentName admin, String packageName, String permission, int grantState) {
        ...
        try {
            ...
            this.mService.setPermissionGrantState(admin, this.mContext.getPackageName(), packageName, permission, grantState, new RemoteCallback(new RemoteCallback.OnResultListener() { // from class: android.app.admin.DevicePolicyManager$$ExternalSyntheticLambda0
                @Override // android.os.RemoteCallback.OnResultListener
                public final void onResult(Bundle bundle) {
                    result.complete(Boolean.valueOf(b != null));
                }
            }));
            BackgroundThread.getHandler().sendMessageDelayed(PooledLambda.obtainMessage(DevicePolicyManager$$ExternalSyntheticLambda2.INSTANCE, result, false), 20000L);
    ...
    public boolean bindDeviceAdminServiceAsUser(ComponentName admin, Intent serviceIntent, ServiceConnection conn, int flags, UserHandle targetUser) {
        ...
        try {
            ...
            IServiceConnection sd = context.getServiceDispatcher(conn, context.getMainThreadHandler(), flags);
    ...
    public void installSystemUpdate(ComponentName admin, Uri updateFilePath, final Executor executor, final InstallSystemUpdateCallback callback) {
        ...
        try {
            ...
            try {
                this.mService.installUpdateFromFile(admin, fileDescriptor, new StartInstallingUpdateCallback.Stub() { // from class: android.app.admin.DevicePolicyManager.2
    ...
    public void executeCallback(final int errorCode, final String errorMessage, Executor executor, final InstallSystemUpdateCallback callback) {
        executor.execute(new Runnable() { // from class: android.app.admin.DevicePolicyManager$$ExternalSyntheticLambda1
            @Override // java.lang.Runnable
            public final void run() {
    ...
    public void markProfileOwnerOnOrganizationOwnedDevice(ComponentName who) {
        ...
        try {
            iDevicePolicyManager.markProfileOwnerOnOrganizationOwnedDevice(who, myUserId());
        } catch (RemoteException re) {
            throw re.rethrowFromSystemServer();
        }
    }
    ...
    public void setUserControlDisabledPackages(ComponentName admin, List<String> packages) {
        ...
        if (iDevicePolicyManager != null) {
            try {
                iDevicePolicyManager.setUserControlDisabledPackages(admin, packages);
            } catch (RemoteException re) {
                throw re.rethrowFromSystemServer();
            }
        }
    ...
    public List<String> getUserControlDisabledPackages(ComponentName admin) {
        ...
        if (iDevicePolicyManager != null) {
            try {
                return iDevicePolicyManager.getUserControlDisabledPackages(admin);
            } catch (RemoteException re) {
                throw re.rethrowFromSystemServer();
            }
        }
    ...
    public void setCommonCriteriaModeEnabled(ComponentName admin, boolean enabled) {
        ...
        if (iDevicePolicyManager != null) {
            try {
                iDevicePolicyManager.setCommonCriteriaModeEnabled(admin, enabled);
            } catch (RemoteException e) {
                throw e.rethrowFromSystemServer();
            }
        }
    ...
    public boolean canAdminGrantSensorsPermissions() {
        ...
        try {
            return iDevicePolicyManager.canAdminGrantSensorsPermissionsForUser(myUserId());
        } catch (RemoteException re) {
            throw re.rethrowFromSystemServer();
        }
    }
