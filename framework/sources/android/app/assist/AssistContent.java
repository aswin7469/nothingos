...
public class AssistContent implements Parcelable {
    public static final Parcelable.Creator<AssistContent> CREATOR = new Parcelable.Creator<AssistContent>() { // from class: android.app.assist.AssistContent.1
        ...
        public AssistContent mo3559createFromParcel(Parcel in) {
        ...
        public AssistContent[] mo3560newArray(int size) {
    ...
    AssistContent(Parcel in) {
        ...
        this.mIsAppProvidedWebUri = false;
        if (in.readInt() != 0) {
            this.mIntent = Intent.CREATOR.mo3559createFromParcel(in);
        }
        if (in.readInt() != 0) {
            this.mClipData = ClipData.CREATOR.mo3559createFromParcel(in);
        }
        if (in.readInt() != 0) {
