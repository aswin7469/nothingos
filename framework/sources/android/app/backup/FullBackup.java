...
public class FullBackup {
    ...
    private static class BackupSchemeId {
        ...
        public int hashCode() {
            return Objects.hash(this.mPackageName, Integer.valueOf(this.mOperationType));
        }
        ...
        public boolean equals(Object object) {
            ...
            if (Objects.equals(this.mPackageName, that.mPackageName) && Objects.equals(Integer.valueOf(this.mOperationType), Integer.valueOf(that.mOperationType))) {
                return true;
            }
            return false;
        }
    ...
    public static synchronized BackupScheme getBackupScheme(Context context, int operationType) {
    ...
    public static class BackupScheme {
        ...
        private void maybeParseBackupSchemeLocked() throws IOException, XmlPullParserException {
            ...
            try {
                parseSchemeForOperationType(this.mOperationType);
        ...
        private void parseSchemeForOperationType(int operationType) throws PackageManager.NameNotFoundException, IOException, XmlPullParserException {
            ...
            if (operationType == 1 && CompatChanges.isChangeEnabled(FullBackup.IGNORE_FULL_BACKUP_CONTENT_IN_D2D)) {
                this.mIsUsingNewScheme = true;
                return;
            }
