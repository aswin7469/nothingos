                ...
                default:
                    switch (code) {
                        case 1:
                            ...
                            if (data.readInt() != 0) {
                                _arg0 = BlobHandle.CREATOR.mo3559createFromParcel(data);
                            } else {
                                _arg0 = null;
                            }
                        ...
                        case 3:
                            data.enforceInterface(IBlobStoreManager.DESCRIPTOR);
                            if (data.readInt() != 0) {
                                _arg02 = BlobHandle.CREATOR.mo3559createFromParcel(data);
                            } else {
                                _arg02 = null;
                            }
                        ...
                        case 5:
                            data.enforceInterface(IBlobStoreManager.DESCRIPTOR);
                            if (data.readInt() != 0) {
                                _arg03 = BlobHandle.CREATOR.mo3559createFromParcel(data);
                            } else {
                                _arg03 = null;
                            }
                        ...
                        case 6:
                            data.enforceInterface(IBlobStoreManager.DESCRIPTOR);
                            if (data.readInt() != 0) {
                                _arg04 = BlobHandle.CREATOR.mo3559createFromParcel(data);
                            } else {
                                _arg04 = null;
                            }
                        ...
                        case 8:
                            data.enforceInterface(IBlobStoreManager.DESCRIPTOR);
                            if (data.readInt() != 0) {
                                _arg05 = RemoteCallback.CREATOR.mo3559createFromParcel(data);
                            } else {
                                _arg05 = null;
                            }
                            waitForIdle(_arg05);
                        ...
                        case 12:
                            data.enforceInterface(IBlobStoreManager.DESCRIPTOR);
                            if (data.readInt() != 0) {
                                _arg06 = BlobHandle.CREATOR.mo3559createFromParcel(data);
                            } else {
                                _arg06 = null;
                            }
        ...
        public static class Proxy implements IBlobStoreManager {
            ...
            public LeaseInfo getLeaseInfo(BlobHandle blobHandle, String packageName) throws RemoteException {
                ...
                try {
                    ...
                    _reply.readException();
                    if (_reply.readInt() != 0) {
                        _result = LeaseInfo.CREATOR.mo3559createFromParcel(_reply);
                    } else {
                        _result = null;
                    }
                    return _result;
