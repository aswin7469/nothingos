...
public class JobInfo implements Parcelable {
    ...
    public static final Parcelable.Creator<JobInfo> CREATOR = new Parcelable.Creator<JobInfo>() { // from class: android.app.job.JobInfo.1
        ...
        public JobInfo mo3559createFromParcel(Parcel in) {
        ...
        public JobInfo[] mo3560newArray(int size) {
    ...
    private JobInfo(Parcel in) {
        ...
        if (in.readInt() != 0) {
            this.networkRequest = (NetworkRequest) NetworkRequest.CREATOR.mo3559createFromParcel(in);
        } else {
        ...
        this.hasLateConstraint = in.readInt() == 1 ? true : z;
    ...
    public static final class TriggerContentUri implements Parcelable {
        public static final Parcelable.Creator<TriggerContentUri> CREATOR = new Parcelable.Creator<TriggerContentUri>() { // from class: android.app.job.JobInfo.TriggerContentUri.1
            ...
            @Override // android.os.Parcelable.Creator
            /* renamed from: createFromParcel */
            public TriggerContentUri mo3559createFromParcel(Parcel in) {
            ...
            @Override // android.os.Parcelable.Creator
            /* renamed from: newArray */
            public TriggerContentUri[] mo3560newArray(int size) {
        ...
        private TriggerContentUri(Parcel in) {
            this.mUri = Uri.CREATOR.mo3559createFromParcel(in);
    ...
    public void enforceValidity() {
        ...
        int i = this.flags;
        if ((i & 2) != 0 && this.hasEarlyConstraint) {
