...
public final class ConversationChannel implements Parcelable {
    public static final Parcelable.Creator<ConversationChannel> CREATOR = new Parcelable.Creator<ConversationChannel>() { // from class: android.app.people.ConversationChannel.1
        ...
        public ConversationChannel mo3559createFromParcel(Parcel in) {
        ...
        public ConversationChannel[] mo3560newArray(int size) {
    ...
    public ConversationChannel(Parcel in) {
        ...
        this.mNotificationChannel = (NotificationChannel) in.readParcelable(NotificationChannel.class.getClassLoader());
        this.mNotificationChannelGroup = (NotificationChannelGroup) in.readParcelable(NotificationChannelGroup.class.getClassLoader());
        ...
        in.readParcelableList(arrayList, ConversationStatus.class.getClassLoader());
    }
