            ...
            if (this.mListener == null || (executor = this.mExecutor) == null) {
                ...
                executor.execute(new Runnable() { // from class: android.app.people.PeopleManager$ConversationListenerProxy$$ExternalSyntheticLambda0
                    ...
                    public final void run() {
                        PeopleManager.ConversationListenerProxy.this.lambda$onConversationUpdate$0$PeopleManager$ConversationListenerProxy(conversation);
                    }
                });
            }
        }

        public /* synthetic */ void lambda$onConversationUpdate$0$PeopleManager$ConversationListenerProxy(ConversationChannel conversation) {
