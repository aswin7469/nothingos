...
public class PeopleSpaceTile implements Parcelable {
    ...
    public static final Parcelable.Creator<PeopleSpaceTile> CREATOR = new Parcelable.Creator<PeopleSpaceTile>() { // from class: android.app.people.PeopleSpaceTile.1
        ...
        public PeopleSpaceTile mo3559createFromParcel(Parcel source) {
        ...
        public PeopleSpaceTile[] mo3560newArray(int size) {
    ...
    public PeopleSpaceTile(Parcel in) {
        ...
        this.mUserIcon = (Icon) in.readParcelable(Icon.class.getClassLoader());
        this.mContactUri = (Uri) in.readParcelable(Uri.class.getClassLoader());
        this.mUserHandle = (UserHandle) in.readParcelable(UserHandle.class.getClassLoader());
        ...
        this.mNotificationDataUri = (Uri) in.readParcelable(Uri.class.getClassLoader());
