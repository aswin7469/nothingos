                ...
                default:
                    switch (code) {
                        case 1:
                            ...
                            if (data.readInt() != 0) {
                                _arg0 = SearchContext.CREATOR.mo3559createFromParcel(data);
                            } else {
                                _arg0 = null;
                            }
                            if (data.readInt() != 0) {
                                _arg1 = SearchSessionId.CREATOR.mo3559createFromParcel(data);
                            } else {
                                _arg1 = null;
                            }
                        ...
                        case 2:
                            data.enforceInterface(ISearchUiManager.DESCRIPTOR);
                            if (data.readInt() != 0) {
                                _arg02 = SearchSessionId.CREATOR.mo3559createFromParcel(data);
                            } else {
                                _arg02 = null;
                            }
                            if (data.readInt() != 0) {
                                _arg12 = Query.CREATOR.mo3559createFromParcel(data);
                            } else {
                                _arg12 = null;
                            }
                        ...
                        case 3:
                            data.enforceInterface(ISearchUiManager.DESCRIPTOR);
                            if (data.readInt() != 0) {
                                _arg03 = SearchSessionId.CREATOR.mo3559createFromParcel(data);
                            } else {
                                _arg03 = null;
                            }
                            if (data.readInt() != 0) {
                                _arg13 = Query.CREATOR.mo3559createFromParcel(data);
                            } else {
                                _arg13 = null;
                            }
                            if (data.readInt() != 0) {
                                _arg2 = SearchTargetEvent.CREATOR.mo3559createFromParcel(data);
                            } else {
                                _arg2 = null;
                            }
                        ...
                        case 4:
                            data.enforceInterface(ISearchUiManager.DESCRIPTOR);
                            if (data.readInt() != 0) {
                                _arg04 = SearchSessionId.CREATOR.mo3559createFromParcel(data);
                            } else {
                                _arg04 = null;
                            }
