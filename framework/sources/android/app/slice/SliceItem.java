...
public final class SliceItem implements Parcelable {
    public static final Parcelable.Creator<SliceItem> CREATOR = new Parcelable.Creator<SliceItem>() { // from class: android.app.slice.SliceItem.1
        ...
        public SliceItem mo3559createFromParcel(Parcel in) {
        ...
        public SliceItem[] mo3560newArray(int size) {
    ...
    private static Object readObj(String type, Parcel in) {
        ...
        switch (c) {
            case 0:
                return Slice.CREATOR.mo3559createFromParcel(in);
            case 1:
                return TextUtils.CHAR_SEQUENCE_CREATOR.mo3559createFromParcel(in);
            case 2:
                return Icon.CREATOR.mo3559createFromParcel(in);
            case 3:
                return new Pair(PendingIntent.CREATOR.mo3559createFromParcel(in), Slice.CREATOR.mo3559createFromParcel(in));
            case 4:
                return Integer.valueOf(in.readInt());
            case 5:
                return Long.valueOf(in.readLong());
            case 6:
                return RemoteInput.CREATOR.mo3559createFromParcel(in);
            case 7:
                return Bundle.CREATOR.mo3559createFromParcel(in);
            default:
