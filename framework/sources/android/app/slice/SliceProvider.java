...
public abstract class SliceProvider extends ContentProvider {
    ...
    public Bundle call(String method, String arg, Bundle extras) {
        if (method.equals(METHOD_SLICE)) {
            Uri uri = getUriWithoutUserId(validateIncomingUriOrNull((Uri) extras.getParcelable("slice_uri")));
            ...
            if (method.equals(METHOD_PIN)) {
                ...
                Uri uri6 = getUriWithoutUserId(validateIncomingUriOrNull((Uri) extras.getParcelable("slice_uri")));
    ...
    public static PendingIntent createPermissionIntent(Context context, Uri sliceUri, String callingPackage) {
        ...
        intent.setComponent(ComponentName.unflattenFromString(context.getResources().getString(R.string.config_slicePermissionComponent)));
