...
public final class SmartspaceSession implements AutoCloseable {
    ...
    public SmartspaceSession(Context context, SmartspaceConfig smartspaceConfig) {
        ...
        SmartspaceSessionId smartspaceSessionId = new SmartspaceSessionId(context.getPackageName() + SettingsStringUtil.DELIMITER + UUID.randomUUID().toString(), context.getUser());
    ...
    public static class CallbackWrapper extends ISmartspaceCallback.Stub {
            ...
            try {
                this.mExecutor.execute(new Runnable() { // from class: android.app.smartspace.SmartspaceSession$CallbackWrapper$$ExternalSyntheticLambda0
                    ...
                    public final void run() {
                        SmartspaceSession.CallbackWrapper.this.lambda$onResult$0$SmartspaceSession$CallbackWrapper(result);
                    }
                });
            } finally {
        ...
        public /* synthetic */ void lambda$onResult$0$SmartspaceSession$CallbackWrapper(ParceledListSlice result) {
