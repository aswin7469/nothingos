                ...
                default:
                    switch (code) {
                        ...
                        case 2:
                            data.enforceInterface(ITimeDetectorService.DESCRIPTOR);
                            if (data.readInt() != 0) {
                                _arg0 = TimeConfiguration.CREATOR.mo3559createFromParcel(data);
                            } else {
                                _arg0 = null;
                            }
                        ...
                        case 3:
                            data.enforceInterface(ITimeDetectorService.DESCRIPTOR);
                            if (data.readInt() != 0) {
                                _arg02 = ExternalTimeSuggestion.CREATOR.mo3559createFromParcel(data);
                            } else {
                                _arg02 = null;
                            }
                        ...
                        case 4:
                            data.enforceInterface(ITimeDetectorService.DESCRIPTOR);
                            if (data.readInt() != 0) {
                                _arg03 = GnssTimeSuggestion.CREATOR.mo3559createFromParcel(data);
                            } else {
                                _arg03 = null;
                            }
                        ...
                        case 5:
                            data.enforceInterface(ITimeDetectorService.DESCRIPTOR);
                            if (data.readInt() != 0) {
                                _arg04 = ManualTimeSuggestion.CREATOR.mo3559createFromParcel(data);
                            } else {
                                _arg04 = null;
                            }
                        ...
                        case 6:
                            data.enforceInterface(ITimeDetectorService.DESCRIPTOR);
                            if (data.readInt() != 0) {
                                _arg05 = NetworkTimeSuggestion.CREATOR.mo3559createFromParcel(data);
                            } else {
                                _arg05 = null;
                            }
                        ...
                        case 7:
                            data.enforceInterface(ITimeDetectorService.DESCRIPTOR);
                            if (data.readInt() != 0) {
                                _arg06 = TelephonyTimeSuggestion.CREATOR.mo3559createFromParcel(data);
                            } else {
                                _arg06 = null;
                            }
        ...
        public static class Proxy implements ITimeDetectorService {
            ...
            public TimeCapabilitiesAndConfig getCapabilitiesAndConfig() throws RemoteException {
                ...
                try {
                    ...
                    if (_reply.readInt() != 0) {
                        _result = TimeCapabilitiesAndConfig.CREATOR.mo3559createFromParcel(_reply);
                    } else {
                        _result = null;
                    }
                    return _result;
