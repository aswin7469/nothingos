                ...
                default:
                    switch (code) {
                        ...
                        case 4:
                            data.enforceInterface(ITimeZoneDetectorService.DESCRIPTOR);
                            if (data.readInt() != 0) {
                                _arg0 = TimeZoneConfiguration.CREATOR.mo3559createFromParcel(data);
                            } else {
                                _arg0 = null;
                            }
                        ...
                        case 5:
                            data.enforceInterface(ITimeZoneDetectorService.DESCRIPTOR);
                            if (data.readInt() != 0) {
                                _arg02 = ManualTimeZoneSuggestion.CREATOR.mo3559createFromParcel(data);
                            } else {
                                _arg02 = null;
                            }
                        ...
                        case 6:
                            data.enforceInterface(ITimeZoneDetectorService.DESCRIPTOR);
                            if (data.readInt() != 0) {
                                _arg03 = TelephonyTimeZoneSuggestion.CREATOR.mo3559createFromParcel(data);
                            } else {
                                _arg03 = null;
                            }
        ...
        public static class Proxy implements ITimeZoneDetectorService {
            ...
            public TimeZoneCapabilitiesAndConfig getCapabilitiesAndConfig() throws RemoteException {
                ...
                try {
                    ...
                    if (_reply.readInt() != 0) {
                        _result = TimeZoneCapabilitiesAndConfig.CREATOR.mo3559createFromParcel(_reply);
                    } else {
                        _result = null;
                    }
                    return _result;
