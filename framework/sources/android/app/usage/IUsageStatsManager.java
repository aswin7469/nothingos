                ...
                default:
                    ...
                    switch (code) {
                        case 1:
                            ...
                            ParceledListSlice _result = queryUsageStats(_arg02, _arg1, _arg2, _arg32, _arg43);
                        ...
                        case 7:
                            ...
                            UsageEvents _result7 = queryEventsForPackageForUser(_arg08, _arg17, _arg27, _arg36, _arg44);
                            reply.writeNoException();
                            if (_result7 != null) {
                                reply.writeInt(1);
                        ...
                        case 18:
                            ...
                            if (data.readInt() != 0) {
                                _arg4 = PendingIntent.CREATOR.mo3559createFromParcel(data);
                            } else {
                                _arg4 = null;
                            }
                            if (data.readInt() != 0) {
        ...
        public static class Proxy implements IUsageStatsManager {
            ...
            public UsageEvents queryEvents(long beginTime, long endTime, String callingPackage) throws RemoteException {
                ...
                try {
                    ...
                    _reply.readException();
                    if (_reply.readInt() != 0) {
                        _result = UsageEvents.CREATOR.mo3559createFromParcel(_reply);
                    } else {
                        _result = null;
                    }
                    return _result;
