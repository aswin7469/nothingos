...
public class AppWidgetHostView extends FrameLayout {
    ...
    private static final LayoutInflater.Filter INFLATER_FILTER = AppWidgetHostView$$ExternalSyntheticLambda0.INSTANCE;
    ...
    private SparseIntArray mColorMapping;
    ...
    public FrameLayout.LayoutParams mo3517generateLayoutParams(AttributeSet attrs) {
    ...
    private void inflateAsync(RemoteViews remoteViews) {
        ...
        if (layoutId == this.mLayoutId && (view = this.mView) != null) {
            try {
                this.mLastExecutionSignal = remoteViews.reapplyAsync(this.mContext, view, this.mAsyncExecutor, new ViewApplyListener(remoteViews, layoutId, true), this.mInteractionHandler, this.mCurrentSize, this.mColorResources);
            } catch (Exception e) {
            }
        }
    ...
    private RemoteViews.InteractionHandler getHandler(final RemoteViews.InteractionHandler handler) {
        return new RemoteViews.InteractionHandler() { // from class: android.appwidget.AppWidgetHostView$$ExternalSyntheticLambda2
            ...
            public final boolean onInteraction(View view, PendingIntent pendingIntent, RemoteViews.RemoteResponse remoteResponse) {
                return AppWidgetHostView.this.lambda$getHandler$1$AppWidgetHostView(handler, view, pendingIntent, remoteResponse);
            }
        };
    }

    public /* synthetic */ boolean lambda$getHandler$1$AppWidgetHostView(RemoteViews.InteractionHandler handler, View view, PendingIntent pendingIntent, RemoteViews.RemoteResponse response) {
    ...
    public void setColorResources(SparseIntArray colorMapping) {
        SparseIntArray sparseIntArray = this.mColorMapping;
        if (sparseIntArray != null && isSameColorMapping(sparseIntArray, colorMapping)) {
            return;
        }
        SparseIntArray m2785clone = colorMapping.m2785clone();
        this.mColorMapping = m2785clone;
        this.mColorResources = RemoteViews.ColorResources.create(this.mContext, m2785clone);
        this.mLayoutId = -1;
        this.mViewMode = 0;
