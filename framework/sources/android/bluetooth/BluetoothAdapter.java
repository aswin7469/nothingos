...
public final class BluetoothAdapter {
    ...
    public boolean factoryReset() {
        try {
            ...
            return this.mManagerService.factoryReset();
        } finally {
            this.mServiceLock.readLock().unlock();
        }
    }
    ...
    public boolean setScanMode(int mode) {
        ...
        try {
            try {
                ...
                IBluetooth iBluetooth = this.mService;
                if (iBluetooth != null) {
                    return iBluetooth.setScanMode(mode, getDiscoverableTimeout(), this.mAttributionSource);
                }
            } catch (RemoteException e) {
                Log.e(TAG, "", e);
            }
    ...
    public Set<BluetoothDevice> getBondedDevices() {
        ...
        try {
            ...
            try {
                this.mServiceLock.readLock().lock();
                IBluetooth iBluetooth = this.mService;
                return iBluetooth != null ? toDeviceSet(Attributable.setAttributionSource(Arrays.asList(iBluetooth.getBondedDevices(this.mAttributionSource)), this.mAttributionSource)) : toDeviceSet(Arrays.asList(new BluetoothDevice[0]));
            } catch (RemoteException e) {
                Log.e(TAG, "", e);
                this.mServiceLock.readLock().unlock();
                return null;
    ...
    private boolean getBroadcastProfile(Context context, BluetoothProfile.ServiceListener listener) {
    ...
    /* loaded from: classes.dex */
    public class AnonymousClass7 extends IBluetoothManagerCallback.Stub {
        AnonymousClass7() {
        }
