...
public final class BluetoothClass implements Parcelable {
    public static final Parcelable.Creator<BluetoothClass> CREATOR = new Parcelable.Creator<BluetoothClass>() { // from class: android.bluetooth.BluetoothClass.1
        ...
        public BluetoothClass mo3559createFromParcel(Parcel in) {
        ...
        public BluetoothClass[] mo3560newArray(int size) {
    ...
    public static final class Service {
        ...
        public static final int GROUP = 16384;
    ...
    public boolean doesClassMatch(int profile) {
        if (profile == 1) {
            ...
            return getMajorDeviceClass() == 1280;
        } else if (profile != 4 && profile != 5) {
            return false;
        } else {
            return hasService(131072) || getMajorDeviceClass() == 768;
        }
    }
}
