...
public final class BluetoothCodecConfig implements Parcelable {
    ...
    public static final Parcelable.Creator<BluetoothCodecConfig> CREATOR = new Parcelable.Creator<BluetoothCodecConfig>() { // from class: android.bluetooth.BluetoothCodecConfig.1
        ...
        public BluetoothCodecConfig mo3559createFromParcel(Parcel in) {
        ...
        public BluetoothCodecConfig[] mo3560newArray(int size) {
    ...
    public static final int SOURCE_CODEC_TYPE_APTX_ADAPTIVE = 9;
    public static final int SOURCE_CODEC_TYPE_APTX_HD = 3;
    public static final int SOURCE_CODEC_TYPE_APTX_TWSP = 10;
    public static final int SOURCE_CODEC_TYPE_CELT = 13;
    public static final int SOURCE_CODEC_TYPE_INVALID = 1000000;
    public static final int SOURCE_CODEC_TYPE_LC3 = 12;
    ...
    public boolean sameAudioFeedingParameters(BluetoothCodecConfig other) {
        return other != null && other.mSampleRate == this.mSampleRate && other.mBitsPerSample == this.mBitsPerSample && other.mChannelMode == this.mChannelMode && other.mCodecSpecific1 == this.mCodecSpecific1 && other.mCodecSpecific2 == this.mCodecSpecific2 && other.mCodecSpecific3 == this.mCodecSpecific3;
    }
    ...
    public boolean sameCodecSpecificParameters(BluetoothCodecConfig other) {
        ...
        switch (this.mCodecType) {
            ...
            case 4:
                ...
                return other.mCodecSpecific4 > 0;
            case 2:
            case 3:
            default:
                return true;
            ...
            case 7:
            case 8:
                if (this.mCodecSpecific1 != other.mCodecSpecific1 || this.mCodecSpecific2 != other.mCodecSpecific2 || this.mCodecSpecific3 != other.mCodecSpecific3) {
                    return false;
                }
                break;
            case 9:
