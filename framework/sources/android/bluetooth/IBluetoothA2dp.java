                ...
                default:
                    switch (code) {
                        ...
                        case 19:
                            ...
                            if (data.readInt() != 0) {
                                _arg110 = BluetoothCodecConfig.CREATOR.mo3559createFromParcel(data);
                            } else {
                                _arg110 = null;
                            }
                            if (data.readInt() != 0) {
                        ...
                        case 26:
                            data.enforceInterface(DESCRIPTOR);
                            if (data.readInt() != 0) {
                                _arg021 = AttributionSource.CREATOR.mo3559createFromParcel(data);
                            } else {
                                _arg021 = null;
                            }
        ...
        public static class Proxy implements IBluetoothA2dp {
            ...
            public BluetoothCodecStatus getCodecStatus(BluetoothDevice device, AttributionSource attributionSource) throws RemoteException {
                ...
                try {
                    ...
                    _reply.readException();
                    if (_reply.readInt() != 0) {
                        _result = BluetoothCodecStatus.CREATOR.mo3559createFromParcel(_reply);
                    } else {
                        _result = null;
                    }
                    return _result;
            ...
            public BufferConstraints getBufferConstraints(AttributionSource attributionSource) throws RemoteException {
                ...
                try {
                    ...
                    _reply.readException();
                    if (_reply.readInt() != 0) {
                        _result = BufferConstraints.CREATOR.mo3559createFromParcel(_reply);
                    } else {
                        _result = null;
                    }
                    return _result;
