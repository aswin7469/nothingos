...
public interface IBluetoothHeadset extends IInterface {
    ...
    boolean getEqMode(BluetoothDevice bluetoothDevice, AttributionSource attributionSource) throws RemoteException;

    boolean getLowLatencyMode(BluetoothDevice bluetoothDevice, AttributionSource attributionSource) throws RemoteException;
    ...
    boolean isEqSupported(BluetoothDevice bluetoothDevice, AttributionSource attributionSource) throws RemoteException;

    boolean isInbandRingingEnabled(AttributionSource attributionSource) throws RemoteException;

    boolean isLowLatencySupported(BluetoothDevice bluetoothDevice, AttributionSource attributionSource) throws RemoteException;
    ...
    boolean setEqMode(BluetoothDevice bluetoothDevice, boolean z, AttributionSource attributionSource) throws RemoteException;

    void setForceScoAudio(boolean z, AttributionSource attributionSource) throws RemoteException;

    boolean setLowLatencyMode(BluetoothDevice bluetoothDevice, boolean z, AttributionSource attributionSource) throws RemoteException;
    ...
    public static class Default implements IBluetoothHeadset {
        ...
        @Override // android.bluetooth.IBluetoothHeadset
        public boolean isLowLatencySupported(BluetoothDevice device, AttributionSource source) throws RemoteException {
            return false;
        }

        @Override // android.bluetooth.IBluetoothHeadset
        public boolean isEqSupported(BluetoothDevice device, AttributionSource source) throws RemoteException {
            return false;
        }

        @Override // android.bluetooth.IBluetoothHeadset
        public boolean getLowLatencyMode(BluetoothDevice device, AttributionSource source) throws RemoteException {
            return false;
        }

        @Override // android.bluetooth.IBluetoothHeadset
        public boolean getEqMode(BluetoothDevice device, AttributionSource source) throws RemoteException {
            return false;
        }

        @Override // android.bluetooth.IBluetoothHeadset
        public boolean setLowLatencyMode(BluetoothDevice device, boolean enable, AttributionSource source) throws RemoteException {
            return false;
        }

        @Override // android.bluetooth.IBluetoothHeadset
        public boolean setEqMode(BluetoothDevice device, boolean enable, AttributionSource source) throws RemoteException {
            return false;
        }
    ...
    public static abstract class Stub extends Binder implements IBluetoothHeadset {
        ...
        static final int TRANSACTION_getEqMode = 37;
        static final int TRANSACTION_getLowLatencyMode = 36;
        ...
        static final int TRANSACTION_isEqSupported = 35;
        static final int TRANSACTION_isInbandRingingEnabled = 29;
        static final int TRANSACTION_isLowLatencySupported = 34;
        ...
        static final int TRANSACTION_setEqMode = 39;
        static final int TRANSACTION_setForceScoAudio = 22;
        static final int TRANSACTION_setLowLatencyMode = 38;
        ...
        public static String getDefaultTransactionName(int transactionCode) {
            switch (transactionCode) {
                ...
                case 34:
                    return "isLowLatencySupported";
                case 35:
                    return "isEqSupported";
                case 36:
                    return "getLowLatencyMode";
                case 37:
                    return "getEqMode";
                case 38:
                    return "setLowLatencyMode";
                case 39:
                    return "setEqMode";
                default:
                    return null;
                ...
                default:
                    ...
                    switch (code) {
                        ...
                        case 3:
                            ...
                            List<BluetoothDevice> _result3 = getDevicesMatchingConnectionStates(_arg034, _arg1);
                            reply.writeNoException();
                        ...
                        case 9:
                            ...
                            boolean sendVendorSpecificResultCode = sendVendorSpecificResultCode(_arg07, _arg121, _arg25, _arg3);
                            reply.writeNoException();
                        ...
                        case 14:
                            ...
                            boolean connectionPolicy = setConnectionPolicy(_arg012, _arg122, _arg2);
                            reply.writeNoException();
                        ...
                        case 19:
                            data.enforceInterface(DESCRIPTOR);
                            if (data.readInt() != 0) {
                                _arg017 = AttributionSource.CREATOR.mo3559createFromParcel(data);
                            } else {
                                _arg017 = null;
                            }
                        ...
                        case 20:
                            ...
                            setAudioRouteAllowed(_arg120, _arg110);
                            reply.writeNoException();
                            return true;
                        case 21:
                            data.enforceInterface(DESCRIPTOR);
                            if (data.readInt() != 0) {
                                _arg018 = AttributionSource.CREATOR.mo3559createFromParcel(data);
                            } else {
                                _arg018 = null;
                            }
                        ...
                        case 22:
                            ...
                            setForceScoAudio(_arg120, _arg111);
                            reply.writeNoException();
                            return true;
                        case 23:
                            data.enforceInterface(DESCRIPTOR);
                            if (data.readInt() != 0) {
                                _arg019 = AttributionSource.CREATOR.mo3559createFromParcel(data);
                            } else {
                                _arg019 = null;
                            }
                        ...
                        case 24:
                            data.enforceInterface(DESCRIPTOR);
                            if (data.readInt() != 0) {
                                _arg020 = AttributionSource.CREATOR.mo3559createFromParcel(data);
                            } else {
                                _arg020 = null;
                            }
                        ...
                        case 25:
                            ...
                            phoneStateChanged(_arg035, _arg123, _arg26, _arg32, _arg42, _arg5, _arg6);
                            return true;
                        case 26:
                            data.enforceInterface(DESCRIPTOR);
                            ...
                            if (data.readInt() != 0) {
                                _arg7 = AttributionSource.CREATOR.mo3559createFromParcel(data);
                            } else {
                                _arg7 = null;
                            }
                            clccResponse(_arg036, _arg124, _arg27, _arg33, _arg4, _arg52, _arg62, _arg7);
                            reply.writeNoException();
                            return true;
                        case 27:
                            data.enforceInterface(DESCRIPTOR);
                        ...
                        case 28:
                            data.enforceInterface(DESCRIPTOR);
                            if (data.readInt() != 0) {
                                _arg022 = AttributionSource.CREATOR.mo3559createFromParcel(data);
                            } else {
                                _arg022 = null;
                            }
                        ...
                        case 29:
                            data.enforceInterface(DESCRIPTOR);
                            if (data.readInt() != 0) {
                                _arg023 = AttributionSource.CREATOR.mo3559createFromParcel(data);
                            } else {
                                _arg023 = null;
                            }
                        ...
                        case 30:
                            ...
                            boolean priority = setPriority(_arg024, _arg125, _arg22);
                            reply.writeNoException();
                        ...
                        case 34:
                            ...
                            boolean isLowLatencySupported = isLowLatencySupported(_arg028, _arg116);
                            reply.writeNoException();
                            reply.writeInt(isLowLatencySupported ? 1 : 0);
                            return true;
                        case 35:
                            data.enforceInterface(DESCRIPTOR);
                            if (data.readInt() != 0) {
                            ...
                            boolean isEqSupported = isEqSupported(_arg029, _arg117);
                            reply.writeNoException();
                            reply.writeInt(isEqSupported ? 1 : 0);
                            return true;
                        case 36:
                            data.enforceInterface(DESCRIPTOR);
                            if (data.readInt() != 0) {
                            ...
                            boolean lowLatencyMode = getLowLatencyMode(_arg030, _arg118);
                            reply.writeNoException();
                            reply.writeInt(lowLatencyMode ? 1 : 0);
                            return true;
                        case 37:
                            data.enforceInterface(DESCRIPTOR);
                            if (data.readInt() != 0) {
                            ...
                            boolean eqMode = getEqMode(_arg031, _arg119);
                            reply.writeNoException();
                            reply.writeInt(eqMode ? 1 : 0);
                            return true;
                        case 38:
                            data.enforceInterface(DESCRIPTOR);
                            if (data.readInt() != 0) {
                            ...
                            boolean lowLatencyMode2 = setLowLatencyMode(_arg032, _arg120, _arg23);
                            reply.writeNoException();
                            reply.writeInt(lowLatencyMode2 ? 1 : 0);
                            return true;
                        case 39:
                            data.enforceInterface(DESCRIPTOR);
                            if (data.readInt() != 0) {
                            ...
                            boolean eqMode2 = setEqMode(_arg033, _arg120, _arg24);
                            reply.writeNoException();
                            reply.writeInt(eqMode2 ? 1 : 0);
                            return true;
                        default:
        ...
        public static class Proxy implements IBluetoothHeadset {
            ...
            public BluetoothDevice getActiveDevice(AttributionSource attributionSource) throws RemoteException {
                ...
                try {
                    ...
                    _reply.readException();
                    if (_reply.readInt() != 0) {
                        _result = BluetoothDevice.CREATOR.mo3559createFromParcel(_reply);
                    } else {
                        _result = null;
                    }
                    return _result;
            ...
            public boolean isLowLatencySupported(BluetoothDevice device, AttributionSource source) throws RemoteException {
                ...
                try {
                    ...
                    if (!_status && Stub.getDefaultImpl() != null) {
                        return Stub.getDefaultImpl().isLowLatencySupported(device, source);
                    }
                    _reply.readException();
                    if (_reply.readInt() == 0) {
                        _result = false;
            ...
            public boolean isEqSupported(BluetoothDevice device, AttributionSource source) throws RemoteException {
                ...
                try {
                    ...
                    if (!_status && Stub.getDefaultImpl() != null) {
                        return Stub.getDefaultImpl().isEqSupported(device, source);
                    }
                    _reply.readException();
                    if (_reply.readInt() == 0) {
                        _result = false;
            ...
            public boolean getLowLatencyMode(BluetoothDevice device, AttributionSource source) throws RemoteException {
                ...
                try {
                    ...
                    if (!_status && Stub.getDefaultImpl() != null) {
                        return Stub.getDefaultImpl().getLowLatencyMode(device, source);
                    }
                    _reply.readException();
                    if (_reply.readInt() == 0) {
                        _result = false;
            ...
            public boolean getEqMode(BluetoothDevice device, AttributionSource source) throws RemoteException {
                ...
                try {
                    ...
                    if (!_status && Stub.getDefaultImpl() != null) {
                        return Stub.getDefaultImpl().getEqMode(device, source);
                    }
                    _reply.readException();
                    if (_reply.readInt() == 0) {
                        _result = false;
            ...
            public boolean setLowLatencyMode(BluetoothDevice device, boolean enable, AttributionSource source) throws RemoteException {
                ...
                try {
                    ...
                    if (!_status && Stub.getDefaultImpl() != null) {
                        return Stub.getDefaultImpl().setLowLatencyMode(device, enable, source);
                    }
                    _reply.readException();
                    if (_reply.readInt() == 0) {
                        _result = false;
            ...
            public boolean setEqMode(BluetoothDevice device, boolean enable, AttributionSource source) throws RemoteException {
                ...
                try {
                    ...
                    if (!_status && Stub.getDefaultImpl() != null) {
                        return Stub.getDefaultImpl().setEqMode(device, enable, source);
                    }
                    _reply.readException();
                    if (_reply.readInt() == 0) {
                        _result = false;
