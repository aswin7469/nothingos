                ...
                default:
                    switch (code) {
                        case 1:
                            ...
                            if (data.readInt() != 0) {
                                _arg0 = BluetoothHidDeviceAppSdpSettings.CREATOR.mo3559createFromParcel(data);
                            } else {
                                _arg0 = null;
                            }
                            if (data.readInt() != 0) {
                                _arg1 = BluetoothHidDeviceAppQosSettings.CREATOR.mo3559createFromParcel(data);
                            } else {
                                _arg1 = null;
                            }
                            if (data.readInt() != 0) {
                                _arg2 = BluetoothHidDeviceAppQosSettings.CREATOR.mo3559createFromParcel(data);
                            } else {
                                _arg2 = null;
                            }
