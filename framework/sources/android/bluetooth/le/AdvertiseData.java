...
public final class AdvertiseData implements Parcelable {
    public static final Parcelable.Creator<AdvertiseData> CREATOR = new Parcelable.Creator<AdvertiseData>() { // from class: android.bluetooth.le.AdvertiseData.1
        ...
        public AdvertiseData[] mo3560newArray(int size) {
        ...
        public AdvertiseData mo3559createFromParcel(Parcel in) {
    ...
    private AdvertiseData(List<ParcelUuid> serviceUuids, List<ParcelUuid> serviceSolicitationUuids, SparseArray<byte[]> manufacturerData, Map<ParcelUuid, byte[]> serviceData, boolean includeTxPowerLevel, boolean includeDeviceName, byte[] transportDiscoveryData) {
    ...
    public int hashCode() {
        return Objects.hash(this.mServiceUuids, this.mServiceSolicitationUuids, this.mManufacturerSpecificData, this.mServiceData, Boolean.valueOf(this.mIncludeDeviceName), Boolean.valueOf(this.mIncludeTxPowerLevel), this.mTransportDiscoveryData);
    }
    ...
    public void writeToParcel(Parcel dest, int flags) {
        ...
        byte[] bArr2 = this.mTransportDiscoveryData;
        if (bArr2 != null) {
    ...
    public static final class Builder {
        ...
        public AdvertiseData build() {
            return new AdvertiseData(this.mServiceUuids, this.mServiceSolicitationUuids, this.mManufacturerSpecificData, this.mServiceData, this.mIncludeTxPowerLevel, this.mIncludeDeviceName, this.mTransportDiscoveryData);
        }
    }
}
