...
public class BluetoothLeUtils {
    ...
    /* JADX INFO: Access modifiers changed from: package-private */
    public static <T> String toString(byte[] data) {
        if (data == null) {
            return "null";
        }
        if (data.length == 0) {
    ...
    /* JADX INFO: Access modifiers changed from: package-private */
    public static <T> boolean equals(byte[] data, byte[] otherData) {
        if (data == otherData) {
            return true;
        }
        if (data != null && otherData != null && data.length == otherData.length && Objects.deepEquals(data, otherData)) {
            return true;
        }
        return false;
    }
