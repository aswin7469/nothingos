...
public interface IPeriodicAdvertisingCallback extends IInterface {
    ...
    void onSyncTransfered(BluetoothDevice bluetoothDevice, int i) throws RemoteException;
    ...
    public static class Default implements IPeriodicAdvertisingCallback {
        ...
        @Override // android.bluetooth.le.IPeriodicAdvertisingCallback
        public void onSyncTransfered(BluetoothDevice device, int status) throws RemoteException {
        }
    ...
    public static abstract class Stub extends Binder implements IPeriodicAdvertisingCallback {
        ...
        static final int TRANSACTION_onSyncTransfered = 4;
                ...
                default:
                    switch (code) {
                        case 1:
                            ...
                            onSyncEstablished(_arg03, _arg1, _arg2, _arg3, _arg4, _arg5);
                            return true;
                        case 2:
                            data.enforceInterface(DESCRIPTOR);
                            if (data.readInt() != 0) {
                                _arg0 = PeriodicAdvertisingReport.CREATOR.mo3559createFromParcel(data);
                            } else {
                                _arg0 = null;
                            }
                        ...
                        case 4:
                            ...
                            onSyncTransfered(_arg02, _arg12);
                            return true;
                        default:
        ...
        public static class Proxy implements IPeriodicAdvertisingCallback {
            ...
            public void onSyncTransfered(BluetoothDevice device, int status) throws RemoteException {
                ...
                try {
                    ...
                    if (!_status && Stub.getDefaultImpl() != null) {
                        Stub.getDefaultImpl().onSyncTransfered(device, status);
                    }
                } finally {
                    _data.recycle();
                }
