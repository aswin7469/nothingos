...
public final class PeriodicAdvertisingManager {
    ...
    private IPeriodicAdvertisingCallback wrap(final PeriodicAdvertisingCallback callback, final Handler handler) {
        return new IPeriodicAdvertisingCallback.Stub() { // from class: android.bluetooth.le.PeriodicAdvertisingManager.1
            ...
            @Override // android.bluetooth.le.IPeriodicAdvertisingCallback
            public void onSyncTransfered(final BluetoothDevice device, final int status) {
    ...
    public void transferSync(BluetoothDevice bda, int service_data, int sync_handle) {
        try {
            ...
            if (callback != null) {
                callback.onSyncTransfered(bda, 2);
            }
        }
    }

    public void transferSetInfo(BluetoothDevice bda, int service_data, int adv_handle, PeriodicAdvertisingCallback callback) {
        transferSetInfo(bda, service_data, adv_handle, callback, null);
    }

    public void transferSetInfo(BluetoothDevice bda, int service_data, int adv_handle, PeriodicAdvertisingCallback callback, Handler handler) {
        if (callback == null) {
            throw new IllegalArgumentException("callback can't be null");
        }
        try {
