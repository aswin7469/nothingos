...
public final class ScanResult implements Parcelable, Attributable {
    public static final Parcelable.Creator<ScanResult> CREATOR = new Parcelable.Creator<ScanResult>() { // from class: android.bluetooth.le.ScanResult.1
        ...
        public ScanResult mo3559createFromParcel(Parcel source) {
        ...
        public ScanResult[] mo3560newArray(int size) {
    ...
    public ScanResult(BluetoothDevice device, int addressType, int eventType, int primaryPhy, int secondaryPhy, int advertisingSid, int txPower, int rssi, int periodicAdvertisingInterval, ScanRecord scanRecord, long timestampNanos) {
        this.mDevice = device;
        this.mEventType = eventType;
        this.mPrimaryPhy = primaryPhy;
        this.mSecondaryPhy = secondaryPhy;
    ...
    private void readFromParcel(Parcel in) {
        if (in.readInt() == 1) {
            this.mDevice = BluetoothDevice.CREATOR.mo3559createFromParcel(in);
        }
        if (in.readInt() == 1) {
