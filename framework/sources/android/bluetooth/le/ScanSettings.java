...
public final class ScanSettings implements Parcelable {
    ...
    public static final Parcelable.Creator<ScanSettings> CREATOR = new Parcelable.Creator<ScanSettings>() { // from class: android.bluetooth.le.ScanSettings.1
        ...
        public ScanSettings[] mo3560newArray(int size) {
        ...
        public ScanSettings mo3559createFromParcel(Parcel in) {
    ...
    public static final class Builder {
        ...
        private boolean isValidCallbackType(int callbackType) {
            return callbackType == 1 || callbackType == 2 || callbackType == 4 || callbackType == 8 || callbackType == 6;
        }
