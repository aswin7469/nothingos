...
public final class WifiDeviceFilter implements DeviceFilter<ScanResult> {
    ...
    static {
        ...
        CREATOR = new Parcelable.Creator<WifiDeviceFilter>() { // from class: android.companion.WifiDeviceFilter.1
            ...
            public WifiDeviceFilter[] mo3560newArray(int size) {
            ...
            public WifiDeviceFilter mo3559createFromParcel(Parcel in) {
    ...
    WifiDeviceFilter(Parcel in) {
        ...
        Pattern namePattern = sParcellingForNamePattern.mo3468unparcel(in);
    ...
    public static final class Builder {
        ...
        public WifiDeviceFilter build() {
            ...
            WifiDeviceFilter o = new WifiDeviceFilter(this.mNamePattern, this.mBssid, this.mBssidMask);
            return o;
        }
