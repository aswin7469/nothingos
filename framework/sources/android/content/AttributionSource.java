...
public final class AttributionSource implements Parcelable {
    ...
    public static final Parcelable.Creator<AttributionSource> CREATOR = new Parcelable.Creator<AttributionSource>() { // from class: android.content.AttributionSource.1
        ...
        public AttributionSource[] mo3560newArray(int size) {
        ...
        public AttributionSource mo3559createFromParcel(Parcel in) {
    ...
    AttributionSource(Parcel in) {
        this(AttributionSourceState.CREATOR.mo3559createFromParcel(in));
    ...
    public boolean checkCallingUid() {
        ...
        if (callingUid != 0 && callingUid != 1000 && callingUid != this.mAttributionSourceState.uid) {
            return false;
        }
        return true;
    }
    ...
    public int hashCode() {
        int _hash = (1 * 31) + this.mAttributionSourceState.uid;
        return (((((((((_hash * 31) + Objects.hashCode(this.mAttributionSourceState.packageName)) * 31) + Objects.hashCode(this.mAttributionSourceState.attributionTag)) * 31) + Objects.hashCode(this.mAttributionSourceState.token)) * 31) + Objects.hashCode(this.mAttributionSourceState.renouncedPermissions)) * 31) + Objects.hashCode(getNext());
    }
