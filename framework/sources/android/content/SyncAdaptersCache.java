...
public class SyncAdaptersCache extends RegisteredServicesCache<SyncAdapterType> {
    ...
    public SyncAdapterType mo703parseServiceAttributes(Resources res, String packageName, AttributeSet attrs) {
    ...
    static class MySerializer implements XmlSerializerAndParser<SyncAdapterType> {
        ...
        public SyncAdapterType mo704createFromXml(TypedXmlPullParser parser) throws IOException, XmlPullParserException {
