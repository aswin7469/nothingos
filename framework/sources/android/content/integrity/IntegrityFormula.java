...
public abstract class IntegrityFormula {
    ...
    public static IntegrityFormula readFromParcel(Parcel in) {
        ...
        switch (tag) {
            case 0:
                return CompoundFormula.CREATOR.mo3559createFromParcel(in);
            case 1:
                return AtomicFormula.StringAtomicFormula.CREATOR.mo3559createFromParcel(in);
            case 2:
                return AtomicFormula.LongAtomicFormula.CREATOR.mo3559createFromParcel(in);
            case 3:
                return AtomicFormula.BooleanAtomicFormula.CREATOR.mo3559createFromParcel(in);
            case 4:
                return InstallerAllowedByManifestFormula.CREATOR.mo3559createFromParcel(in);
            default:
