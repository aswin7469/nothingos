                ...
                default:
                    ...
                    switch (code) {
                        ...
                        case 4:
                            data.enforceInterface(DESCRIPTOR);
                            if (data.readInt() != 0) {
                                _arg0 = OverlayIdentifier.CREATOR.mo3559createFromParcel(data);
                            } else {
                                _arg0 = null;
                            }
                        ...
                        case 13:
                            data.enforceInterface(DESCRIPTOR);
                            if (data.readInt() != 0) {
                                _arg02 = OverlayManagerTransaction.CREATOR.mo3559createFromParcel(data);
                            } else {
                                _arg02 = null;
                            }
                            commit(_arg02);
        ...
        public static class Proxy implements IOverlayManager {
            ...
            public OverlayInfo getOverlayInfo(String packageName, int userId) throws RemoteException {
                ...
                try {
                    ...
                    _reply.readException();
                    if (_reply.readInt() != 0) {
                        _result = OverlayInfo.CREATOR.mo3559createFromParcel(_reply);
                    } else {
                        _result = null;
                    }
                    return _result;
