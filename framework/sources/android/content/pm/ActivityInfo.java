...
public class ActivityInfo extends ComponentInfo implements Parcelable {
    ...
    public static final Parcelable.Creator<ActivityInfo> CREATOR = new Parcelable.Creator<ActivityInfo>() { // from class: android.content.pm.ActivityInfo.1
        ...
        public ActivityInfo mo3559createFromParcel(Parcel source) {
        ...
        public ActivityInfo[] mo3560newArray(int size) {
    ...
    public int supportsSizeChanges() {
        if (CompatChanges.isChangeEnabled(FORCE_NON_RESIZE_APP, this.applicationInfo.packageName, UserHandle.getUserHandleForUid(this.applicationInfo.uid))) {
            return 1;
        }
        if (this.supportsSizeChanges) {
            return 2;
        }
        if (CompatChanges.isChangeEnabled(FORCE_RESIZE_APP, this.applicationInfo.packageName, UserHandle.getUserHandleForUid(this.applicationInfo.uid))) {
            return 3;
        }
        return 0;
    }
    ...
    public boolean neverSandboxDisplayApis() {
        return CompatChanges.isChangeEnabled(NEVER_SANDBOX_DISPLAY_APIS, this.applicationInfo.packageName, UserHandle.getUserHandleForUid(this.applicationInfo.uid)) || ConstrainDisplayApisConfig.neverConstrainDisplayApis(this.applicationInfo);
    }

    public boolean alwaysSandboxDisplayApis() {
        return CompatChanges.isChangeEnabled(ALWAYS_SANDBOX_DISPLAY_APIS, this.applicationInfo.packageName, UserHandle.getUserHandleForUid(this.applicationInfo.uid)) || ConstrainDisplayApisConfig.alwaysConstrainDisplayApis(this.applicationInfo);
    }
    ...
    public float getMinAspectRatio() {
        if (this.applicationInfo == null || !CompatChanges.isChangeEnabled(OVERRIDE_MIN_ASPECT_RATIO, this.applicationInfo.packageName, UserHandle.getUserHandleForUid(this.applicationInfo.uid))) {
            return this.mMinAspectRatio;
        }
        if (CompatChanges.isChangeEnabled(OVERRIDE_MIN_ASPECT_RATIO_LARGE, this.applicationInfo.packageName, UserHandle.getUserHandleForUid(this.applicationInfo.uid))) {
            return Math.max(1.7777778f, this.mMinAspectRatio);
        }
        if (CompatChanges.isChangeEnabled(OVERRIDE_MIN_ASPECT_RATIO_MEDIUM, this.applicationInfo.packageName, UserHandle.getUserHandleForUid(this.applicationInfo.uid))) {
