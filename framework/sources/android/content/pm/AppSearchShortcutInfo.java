...
public class AppSearchShortcutInfo extends GenericDocument {
    ...
    public ShortcutInfo toShortcutInfo(int userId) {
        ...
        if (intentsStrings == null) {
            ...
            intentArr = (Intent[]) Arrays.stream(intentsStrings).map(AppSearchShortcutInfo$$ExternalSyntheticLambda1.INSTANCE).toArray(AppSearchShortcutInfo$$ExternalSyntheticLambda2.INSTANCE);
        }
        ...
        if (intentExtrasesBytes == null) {
            ...
            bundleArr = (Bundle[]) Arrays.stream(intentExtrasesBytes).map(new Function() { // from class: android.content.pm.AppSearchShortcutInfo$$ExternalSyntheticLambda0
    ...
    public static class Builder extends GenericDocument.Builder<Builder> {
        ...
        public Builder setShortLabelResId(int shortLabelResId) {
            setPropertyLong(AppSearchShortcutInfo.KEY_SHORT_LABEL_RES_ID, shortLabelResId);
        ...
        public Builder setShortLabelResName(String shortLabelResName) {
            if (!TextUtils.isEmpty(shortLabelResName)) {
                setPropertyString(AppSearchShortcutInfo.KEY_SHORT_LABEL_RES_NAME, shortLabelResName);
            }
            return this;
        }
        ...
        public Builder setLongLabelResId(int longLabelResId) {
            setPropertyLong(AppSearchShortcutInfo.KEY_LONG_LABEL_RES_ID, longLabelResId);
            if (longLabelResId != 0) {
                this.mHasStringResource = true;
            }
            return this;
        ...
        public Builder setLongLabelResName(String longLabelResName) {
            if (!TextUtils.isEmpty(longLabelResName)) {
                setPropertyString(AppSearchShortcutInfo.KEY_LONG_LABEL_RES_NAME, longLabelResName);
            }
            return this;
        }
        ...
        public Builder setDisabledMessageResId(int disabledMessageResId) {
            setPropertyLong(AppSearchShortcutInfo.KEY_DISABLED_MESSAGE_RES_ID, disabledMessageResId);
        ...
        public Builder setDisabledMessageResName(String disabledMessageResName) {
            if (!TextUtils.isEmpty(disabledMessageResName)) {
                setPropertyString(AppSearchShortcutInfo.KEY_DISABLED_MESSAGE_RES_NAME, disabledMessageResName);
            }
            return this;
        }
        ...
        public Builder setIntents(Intent[] intents) {
            ...
            for (int i = 0; i < intents.length; i++) {
                ...
                if (extras != null) {
                    transformToByteArray = AppSearchShortcutInfo.transformToByteArray(new PersistableBundle(extras));
                } else {
                    transformToByteArray = new byte[0];
                }
                intentExtrases[i] = transformToByteArray;
            }
        ...
        public Builder setRank(int rank) {
            ...
            setPropertyString("rank", String.valueOf(rank));
            if (rank != 0) {
        ...
        public Builder setImplicitRank(int rank) {
            setPropertyLong(AppSearchShortcutInfo.KEY_IMPLICIT_RANK, rank);
            return this;
        }
        ...
        public Builder setBitmapPath(String bitmapPath) {
            if (!TextUtils.isEmpty(bitmapPath)) {
                setPropertyString(AppSearchShortcutInfo.KEY_BITMAP_PATH, bitmapPath);
