...
public class ApplicationInfo extends PackageItemInfo implements Parcelable {
    ...
    public void dump(Printer pw, String prefix, int dumpFlags) {
        ...
        if ((dumpFlags & 1) != 0) {
            ...
            String str = "true";
            sb.append(hasRtlSupport() ? str : "false");
            ...
            if (this.fullBackupContent > 0) {
                ...
                sb2.append(this.fullBackupContent < 0 ? "false" : str);
            ...
            sb3.append(this.crossProfile ? str : "false");
    ...
    public void writeToParcel(Parcel dest, int parcelableFlags) {
        ...
        dest.writeInt(this.forceFull ? 1 : 0);
    }
    ...
    class AnonymousClass1 implements Parcelable.Creator<ApplicationInfo> {
        ...
        public static /* synthetic */ ApplicationInfo lambda$createFromParcel$0(Parcel x$0) {
            return new ApplicationInfo(x$0, null);
        }

        /* JADX WARN: Can't rename method to resolve collision */
        @Override // android.os.Parcelable.Creator
        /* renamed from: createFromParcel */
        public ApplicationInfo mo3559createFromParcel(Parcel source) {
            return (ApplicationInfo) source.readSquashed(ApplicationInfo$1$$ExternalSyntheticLambda0.INSTANCE);
        }

        /* JADX WARN: Can't rename method to resolve collision */
        @Override // android.os.Parcelable.Creator
        /* renamed from: newArray */
        public ApplicationInfo[] mo3560newArray(int size) {
    ...
    private ApplicationInfo(Parcel source) {
        ...
        this.requestRawExternalStorageAccess = sForBoolean.mo3468unparcel(source);
        this.forceFull = source.readInt() != 0 ? true : z4;
    }
