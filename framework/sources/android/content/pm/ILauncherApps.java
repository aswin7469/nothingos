                ...
                default:
                    switch (code) {
                        ...
                        case 3:
                            ...
                            if (data.readInt() != 0) {
                                _arg2 = UserHandle.CREATOR.mo3559createFromParcel(data);
                            } else {
                                _arg2 = null;
                            }
                        ...
                        case 4:
                            ...
                            if (data.readInt() != 0) {
                                _arg22 = UserHandle.CREATOR.mo3559createFromParcel(data);
                            } else {
                                _arg22 = null;
                            }
                        ...
                        case 5:
                            ...
                            if (data.readInt() != 0) {
                                _arg3 = PackageInstaller.SessionInfo.CREATOR.mo3559createFromParcel(data);
                            } else {
                                _arg3 = null;
                            }
                            if (data.readInt() != 0) {
                                _arg4 = Rect.CREATOR.mo3559createFromParcel(data);
                            } else {
                                _arg4 = null;
                            }
                            if (data.readInt() != 0) {
                        ...
                        case 6:
                            ...
                            if (data.readInt() != 0) {
                                _arg32 = ComponentName.CREATOR.mo3559createFromParcel(data);
                            } else {
                                _arg32 = null;
                            }
                            if (data.readInt() != 0) {
                                _arg42 = Rect.CREATOR.mo3559createFromParcel(data);
                            } else {
                                _arg42 = null;
                            }
                            if (data.readInt() != 0) {
                        ...
                        case 8:
                            ...
                            if (data.readInt() != 0) {
                                _arg43 = Rect.CREATOR.mo3559createFromParcel(data);
                            } else {
                                _arg43 = null;
                            }
                            if (data.readInt() != 0) {
                        ...
                        case 9:
                            ...
                            if (data.readInt() != 0) {
                                _arg24 = UserHandle.CREATOR.mo3559createFromParcel(data);
                            } else {
                                _arg24 = null;
                            }
                        ...
                        case 10:
                            ...
                            if (data.readInt() != 0) {
                                _arg13 = UserHandle.CREATOR.mo3559createFromParcel(data);
                            } else {
                                _arg13 = null;
                            }
                        ...
                        case 11:
                            ...
                            if (data.readInt() != 0) {
                                _arg14 = ComponentName.CREATOR.mo3559createFromParcel(data);
                            } else {
                                _arg14 = null;
                            }
                            if (data.readInt() != 0) {
                        ...
                        case 12:
                            ...
                            if (data.readInt() != 0) {
                                _arg34 = UserHandle.CREATOR.mo3559createFromParcel(data);
                            } else {
                                _arg34 = null;
                            }
                        ...
                        case 14:
                            ...
                            if (data.readInt() != 0) {
                                _arg15 = ShortcutQueryWrapper.CREATOR.mo3559createFromParcel(data);
                            } else {
                                _arg15 = null;
                            }
                            if (data.readInt() != 0) {
                                _arg27 = UserHandle.CREATOR.mo3559createFromParcel(data);
                            } else {
                                _arg27 = null;
                            }
                        ...
                        case 15:
                            ...
                            if (data.readInt() != 0) {
                                _arg35 = UserHandle.CREATOR.mo3559createFromParcel(data);
                            } else {
                                _arg35 = null;
                            }
                        ...
                        case 16:
                            ...
                            if (data.readInt() != 0) {
                                _arg44 = Rect.CREATOR.mo3559createFromParcel(data);
                            } else {
                                _arg44 = null;
                            }
                            if (data.readInt() != 0) {
                        ...
                        case 20:
                            ...
                            if (data.readInt() != 0) {
                                _arg16 = UserHandle.CREATOR.mo3559createFromParcel(data);
                            } else {
                                _arg16 = null;
                            }
                        ...
                        case 22:
                            ...
                            if (data.readInt() != 0) {
                                _arg17 = ComponentName.CREATOR.mo3559createFromParcel(data);
                            } else {
                                _arg17 = null;
                            }
                            if (data.readInt() != 0) {
                        ...
                        case 23:
                            ...
                            if (data.readInt() != 0) {
                                _arg36 = Bundle.CREATOR.mo3559createFromParcel(data);
                            } else {
                                _arg36 = null;
                            }
                            if (data.readInt() != 0) {
                                _arg45 = UserHandle.CREATOR.mo3559createFromParcel(data);
                            } else {
                                _arg45 = null;
                            }
                        ...
                        case 26:
                            ...
                            if (data.readInt() != 0) {
                                _arg18 = ShortcutQueryWrapper.CREATOR.mo3559createFromParcel(data);
                            } else {
                                _arg18 = null;
                            }
                        ...
                        case 28:
                            ...
                            if (data.readInt() != 0) {
                                _arg37 = UserHandle.CREATOR.mo3559createFromParcel(data);
                            } else {
                                _arg37 = null;
                            }
                        ...
                        case 29:
                            ...
                            if (data.readInt() != 0) {
                                _arg38 = UserHandle.CREATOR.mo3559createFromParcel(data);
                            } else {
                                _arg38 = null;
                            }
        ...
        public static class Proxy implements ILauncherApps {
            ...
            public LauncherActivityInfoInternal resolveLauncherActivityInternal(String callingPackage, ComponentName component, UserHandle user) throws RemoteException {
                ...
                try {
                    ...
                    _reply.readException();
                    if (_reply.readInt() != 0) {
                        _result = LauncherActivityInfoInternal.CREATOR.mo3559createFromParcel(_reply);
                    } else {
                        _result = null;
                    }
                    return _result;
            ...
            public LauncherApps.AppUsageLimit getAppUsageLimit(String callingPackage, String packageName, UserHandle user) throws RemoteException {
                ...
                try {
                    ...
                    _reply.readException();
                    if (_reply.readInt() != 0) {
                        _result = LauncherApps.AppUsageLimit.CREATOR.mo3559createFromParcel(_reply);
                    } else {
                        _result = null;
                    }
                    return _result;
