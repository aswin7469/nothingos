                ...
                default:
                    ...
                    switch (code) {
                        ...
                        case 4:
                            data.enforceInterface(DESCRIPTOR);
                            if (data.readInt() != 0) {
                                _arg04 = UserHandle.CREATOR.mo3559createFromParcel(data);
                            } else {
                                _arg04 = null;
                            }
                        ...
                        case 5:
                            data.enforceInterface(DESCRIPTOR);
                            if (data.readInt() != 0) {
                                _arg05 = UserHandle.CREATOR.mo3559createFromParcel(data);
                            } else {
                                _arg05 = null;
                            }
                        ...
                        case 6:
                            data.enforceInterface(DESCRIPTOR);
                            if (data.readInt() != 0) {
                                _arg06 = UserHandle.CREATOR.mo3559createFromParcel(data);
                            } else {
                                _arg06 = null;
                            }
                        ...
                        case 7:
                            data.enforceInterface(DESCRIPTOR);
                            if (data.readInt() != 0) {
                                _arg07 = UserHandle.CREATOR.mo3559createFromParcel(data);
                            } else {
                                _arg07 = null;
                            }
                        ...
                        case 8:
                            data.enforceInterface(DESCRIPTOR);
                            if (data.readInt() != 0) {
                                _arg08 = UserHandle.CREATOR.mo3559createFromParcel(data);
                            } else {
                                _arg08 = null;
                            }
                        ...
                        case 9:
                            data.enforceInterface(DESCRIPTOR);
                            if (data.readInt() != 0) {
                                _arg09 = UserHandle.CREATOR.mo3559createFromParcel(data);
                            } else {
                                _arg09 = null;
                            }
