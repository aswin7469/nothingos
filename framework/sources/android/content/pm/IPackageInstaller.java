                ...
                default:
                    ...
                    switch (code) {
                        case 1:
                            ...
                            if (data.readInt() != 0) {
                                _arg0 = PackageInstaller.SessionParams.CREATOR.mo3559createFromParcel(data);
                            } else {
                                _arg0 = null;
                            }
                        ...
                        case 12:
                            data.enforceInterface(DESCRIPTOR);
                            if (data.readInt() != 0) {
                                _arg02 = VersionedPackage.CREATOR.mo3559createFromParcel(data);
                            } else {
                                _arg02 = null;
                            }
                            ...
                            if (data.readInt() != 0) {
                                _arg3 = IntentSender.CREATOR.mo3559createFromParcel(data);
                            } else {
                                _arg3 = null;
                            }
                        ...
                        case 13:
                            data.enforceInterface(DESCRIPTOR);
                            if (data.readInt() != 0) {
                                _arg03 = VersionedPackage.CREATOR.mo3559createFromParcel(data);
                            } else {
                                _arg03 = null;
                            }
                            String _arg17 = data.readString();
                            if (data.readInt() != 0) {
                                _arg2 = IntentSender.CREATOR.mo3559createFromParcel(data);
                            } else {
                                _arg2 = null;
                            }
        ...
        public static class Proxy implements IPackageInstaller {
            ...
            public PackageInstaller.SessionInfo getSessionInfo(int sessionId) throws RemoteException {
                ...
                try {
                    ...
                    _reply.readException();
                    if (_reply.readInt() != 0) {
                        _result = PackageInstaller.SessionInfo.CREATOR.mo3559createFromParcel(_reply);
                    } else {
                        _result = null;
                    }
                    return _result;
