...
public interface IPackageInstallerSession extends IInterface {
    ...
    public static abstract class Stub extends Binder implements IPackageInstallerSession {
        ...
        static final int TRANSACTION_getInstallFlags = 23;
                ...
                default:
                    ...
                    switch (code) {
                        ...
                        case 8:
                            ...
                            setChecksums(_arg08, _arg13, _arg23);
                            reply.writeNoException();
                            return true;
                        case 9:
                            data.enforceInterface(DESCRIPTOR);
        ...
        public static class Proxy implements IPackageInstallerSession {
            ...
            public DataLoaderParamsParcel getDataLoaderParams() throws RemoteException {
                ...
                try {
                    ...
                    _reply.readException();
                    if (_reply.readInt() != 0) {
                        _result = DataLoaderParamsParcel.CREATOR.mo3559createFromParcel(_reply);
                    } else {
                        _result = null;
                    }
                    return _result;
            ...
            public int getInstallFlags() throws RemoteException {
                ...
                try {
                    ...
                    if (!_status && Stub.getDefaultImpl() != null) {
                        return Stub.getDefaultImpl().getInstallFlags();
                    }
                    _reply.readException();
                    int _result = _reply.readInt();
                    return _result;
