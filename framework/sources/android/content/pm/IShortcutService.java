                ...
                default:
                    switch (code) {
                        ...
                        case 6:
                            ...
                            if (data.readInt() != 0) {
                                _arg14 = ShortcutInfo.CREATOR.mo3559createFromParcel(data);
                            } else {
                                _arg14 = null;
                            }
                            if (data.readInt() != 0) {
                        ...
                        case 7:
                            ...
                            if (data.readInt() != 0) {
                                _arg15 = ShortcutInfo.CREATOR.mo3559createFromParcel(data);
                            } else {
                                _arg15 = null;
                            }
                        ...
                        case 20:
                            ...
                            if (data.readInt() != 0) {
                                _arg16 = IntentFilter.CREATOR.mo3559createFromParcel(data);
                            } else {
                                _arg16 = null;
                            }
                        ...
                        case 24:
                            ...
                            if (data.readInt() != 0) {
                                _arg17 = ShortcutInfo.CREATOR.mo3559createFromParcel(data);
                            } else {
                                _arg17 = null;
                            }
        ...
        public static class Proxy implements IShortcutService {
            ...
            public AndroidFuture setDynamicShortcuts(String packageName, ParceledListSlice shortcutInfoList, int userId) throws RemoteException {
                ...
                try {
                    ...
                    if (_reply.readInt() != 0) {
                        _result = AndroidFuture.CREATOR.mo3559createFromParcel(_reply);
                    } else {
                        _result = null;
                    }
                    return _result;
