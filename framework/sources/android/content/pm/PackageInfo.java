...
public class PackageInfo implements Parcelable {
    public static final Parcelable.Creator<PackageInfo> CREATOR = new Parcelable.Creator<PackageInfo>() { // from class: android.content.pm.PackageInfo.1
        ...
        public PackageInfo mo3559createFromParcel(Parcel source) {
        ...
        public PackageInfo[] mo3560newArray(int size) {
    ...
    private PackageInfo(Parcel source) {
        ...
        if (hasApp != 0) {
            this.applicationInfo = ApplicationInfo.CREATOR.mo3559createFromParcel(source);
        }
        ...
        if (hasSigningInfo != 0) {
            this.signingInfo = SigningInfo.CREATOR.mo3559createFromParcel(source);
        }
