...
public abstract class PackageManager {
    ...
    private static final PropertyInvalidatedCache<ApplicationInfoQuery, ApplicationInfo> sApplicationInfoCache = new PropertyInvalidatedCache<ApplicationInfoQuery, ApplicationInfo>(16, PermissionManager.CACHE_KEY_PACKAGE_INFO, "getApplicationInfo") { // from class: android.content.pm.PackageManager.1
        ...
        /* JADX INFO: Access modifiers changed from: protected */
        @Override // android.app.PropertyInvalidatedCache
        public ApplicationInfo maybeCheckConsistency(ApplicationInfoQuery query, ApplicationInfo proposedResult) {
    ...
    private static final PropertyInvalidatedCache<PackageInfoQuery, PackageInfo> sPackageInfoCache = new PropertyInvalidatedCache<PackageInfoQuery, PackageInfo>(32, PermissionManager.CACHE_KEY_PACKAGE_INFO, "getPackageInfo") { // from class: android.content.pm.PackageManager.2
        ...
        /* JADX INFO: Access modifiers changed from: protected */
        @Override // android.app.PropertyInvalidatedCache
        public PackageInfo maybeCheckConsistency(PackageInfoQuery query, PackageInfo proposedResult) {
            return proposedResult;
        }
    };
    ...
    public static final class Property implements Parcelable {
        ...
        public static final Parcelable.Creator<Property> CREATOR = new Parcelable.Creator<Property>() { // from class: android.content.pm.PackageManager.Property.1
            ...
            public Property mo3559createFromParcel(Parcel source) {
            ...
            public Property[] mo3560newArray(int size) {
        ...
        public Bundle toBundle(Bundle outBundle) {
            Bundle b = outBundle == null ? new Bundle() : outBundle;
            int i = this.mType;
            if (i == 1) {
    ...
    public boolean isDefaultApplicationIcon(Drawable drawable) {
        ...
        return resId == 17301651 || resId == 17303690;
    }
    ...
    public static final class ApplicationInfoQuery {
        ...
        ApplicationInfoQuery(String packageName, int flags, int userId) {
        ...
        public String toString() {
            return String.format("ApplicationInfoQuery(packageName=\"%s\", flags=%s, userId=%s)", this.packageName, Integer.valueOf(this.flags), Integer.valueOf(this.userId));
        }

        public int hashCode() {
            int hash = Objects.hashCode(this.packageName);
            return (((hash * 13) + Objects.hashCode(Integer.valueOf(this.flags))) * 13) + Objects.hashCode(Integer.valueOf(this.userId));
        }
    ...
    /* JADX INFO: Access modifiers changed from: private */
    public static ApplicationInfo getApplicationInfoAsUserUncached(String packageName, int flags, int userId) {
        try {
    ...
    public static ApplicationInfo getApplicationInfoAsUserCached(String packageName, int flags, int userId) {
    ...
    public static final class PackageInfoQuery {
        ...
        PackageInfoQuery(String packageName, int flags, int userId) {
            this.packageName = packageName;
            this.flags = flags;
            this.userId = userId;
        }
        ...
        public String toString() {
            return String.format("PackageInfoQuery(packageName=\"%s\", flags=%s, userId=%s)", this.packageName, Integer.valueOf(this.flags), Integer.valueOf(this.userId));
        }
    ...
    /* JADX INFO: Access modifiers changed from: private */
    public static PackageInfo getPackageInfoAsUserUncached(String packageName, int flags, int userId) {
        try {
    ...
    public static PackageInfo getPackageInfoAsUserCached(String packageName, int flags, int userId) {
