...
public class PermissionInfo extends PackageItemInfo implements Parcelable {
    ...
    public static final Parcelable.Creator<PermissionInfo> CREATOR = new Parcelable.Creator<PermissionInfo>() { // from class: android.content.pm.PermissionInfo.1
        ...
        public PermissionInfo mo3559createFromParcel(Parcel source) {
        ...
        public PermissionInfo[] mo3560newArray(int size) {
    ...
    private PermissionInfo(Parcel source) {
        ...
        this.nonLocalizedDescription = TextUtils.CHAR_SEQUENCE_CREATOR.mo3559createFromParcel(source);
        this.knownCerts = sForStringSet.mo3468unparcel(source);
    }
}
