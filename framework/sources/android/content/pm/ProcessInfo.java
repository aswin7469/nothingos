...
public class ProcessInfo implements Parcelable {
    ...
    static {
        ...
        CREATOR = new Parcelable.Creator<ProcessInfo>() { // from class: android.content.pm.ProcessInfo.1
            ...
            public ProcessInfo[] mo3560newArray(int size) {
            ...
            public ProcessInfo mo3559createFromParcel(Parcel in) {
    ...
    protected ProcessInfo(Parcel in) {
        ...
        ArraySet<String> _deniedPermissions = sParcellingForDeniedPermissions.mo3468unparcel(in);
