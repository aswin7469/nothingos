...
public class ResolveInfo implements Parcelable {
    public static final Parcelable.Creator<ResolveInfo> CREATOR = new Parcelable.Creator<ResolveInfo>() { // from class: android.content.pm.ResolveInfo.1
        ...
        public ResolveInfo mo3559createFromParcel(Parcel source) {
        ...
        public ResolveInfo[] mo3560newArray(int size) {
    ...
    private ResolveInfo(Parcel source) {
        ...
        switch (source.readInt()) {
            case 1:
                this.activityInfo = ActivityInfo.CREATOR.mo3559createFromParcel(source);
                break;
            case 2:
                this.serviceInfo = ServiceInfo.CREATOR.mo3559createFromParcel(source);
                break;
            case 3:
                this.providerInfo = ProviderInfo.CREATOR.mo3559createFromParcel(source);
                break;
            default:
        ...
        if (source.readInt() != 0) {
            this.filter = IntentFilter.CREATOR.mo3559createFromParcel(source);
        }
        ...
        this.nonLocalizedLabel = TextUtils.CHAR_SEQUENCE_CREATOR.mo3559createFromParcel(source);
        ...
        this.isInstantAppAvailable = source.readInt() == 0 ? false : z;
    }
