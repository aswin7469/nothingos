...
public final class ShortcutInfo implements Parcelable {
    ...
    public static final Parcelable.Creator<ShortcutInfo> CREATOR = new Parcelable.Creator<ShortcutInfo>() { // from class: android.content.pm.ShortcutInfo.1
        ...
        public ShortcutInfo mo3559createFromParcel(Parcel source) {
        ...
        public ShortcutInfo[] mo3560newArray(int size) {
    ...
    public static class Builder {
        ...
        public Builder setLocusId(LocusId locusId) {
            Objects.requireNonNull(locusId, "locusId cannot be null");
            this.mLocusId = locusId;
            return this;
        }
        ...
        public Builder setIntents(Intent[] intents) {
            ...
            Objects.requireNonNull(Integer.valueOf(intents.length), "intents cannot be empty");
        ...
        public Builder setPersons(Person[] persons) {
            ...
            Objects.requireNonNull(Integer.valueOf(persons.length), "persons cannot be empty");
