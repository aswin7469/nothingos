...
public class ShortcutManager {
    ...
    public boolean setDynamicShortcuts(List<ShortcutInfo> shortcutInfoList) {
        try {
            return ((Boolean) getFutureOrThrow(this.mService.setDynamicShortcuts(this.mContext.getPackageName(), new ParceledListSlice(shortcutInfoList), injectMyUserId()))).booleanValue();
    ...
    public List<ShortcutInfo> getDynamicShortcuts() {
        try {
            return ((ParceledListSlice) getFutureOrThrow(this.mService.getShortcuts(this.mContext.getPackageName(), 2, injectMyUserId()))).getList();
        } catch (RemoteException e) {
            throw e.rethrowFromSystemServer();
        }
    }
    ...
    public List<ShortcutInfo> getManifestShortcuts() {
        try {
            return ((ParceledListSlice) getFutureOrThrow(this.mService.getShortcuts(this.mContext.getPackageName(), 1, injectMyUserId()))).getList();
        } catch (RemoteException e) {
            throw e.rethrowFromSystemServer();
        }
    }
    ...
    public List<ShortcutInfo> getShortcuts(int matchFlags) {
        try {
            return ((ParceledListSlice) getFutureOrThrow(this.mService.getShortcuts(this.mContext.getPackageName(), matchFlags, injectMyUserId()))).getList();
        } catch (RemoteException e) {
            throw e.rethrowFromSystemServer();
        }
    }
    ...
    public boolean addDynamicShortcuts(List<ShortcutInfo> shortcutInfoList) {
        try {
            return ((Boolean) getFutureOrThrow(this.mService.addDynamicShortcuts(this.mContext.getPackageName(), new ParceledListSlice(shortcutInfoList), injectMyUserId()))).booleanValue();
        } catch (RemoteException e) {
            throw e.rethrowFromSystemServer();
        }
    }
    ...
    public void removeDynamicShortcuts(List<String> shortcutIds) {
        try {
            getFutureOrThrow(this.mService.removeDynamicShortcuts(this.mContext.getPackageName(), shortcutIds, injectMyUserId()));
        } catch (RemoteException e) {
            throw e.rethrowFromSystemServer();
        }
    }
    ...
    public void removeAllDynamicShortcuts() {
        try {
            getFutureOrThrow(this.mService.removeAllDynamicShortcuts(this.mContext.getPackageName(), injectMyUserId()));
        } catch (RemoteException e) {
            throw e.rethrowFromSystemServer();
        }
    }
    ...
    public void removeLongLivedShortcuts(List<String> shortcutIds) {
        try {
            getFutureOrThrow(this.mService.removeLongLivedShortcuts(this.mContext.getPackageName(), shortcutIds, injectMyUserId()));
        } catch (RemoteException e) {
            throw e.rethrowFromSystemServer();
        }
    }
    ...
    public List<ShortcutInfo> getPinnedShortcuts() {
        try {
            return ((ParceledListSlice) getFutureOrThrow(this.mService.getShortcuts(this.mContext.getPackageName(), 4, injectMyUserId()))).getList();
        } catch (RemoteException e) {
            throw e.rethrowFromSystemServer();
        }
    }
    ...
    public boolean updateShortcuts(List<ShortcutInfo> shortcutInfoList) {
        try {
            return ((Boolean) getFutureOrThrow(this.mService.updateShortcuts(this.mContext.getPackageName(), new ParceledListSlice(shortcutInfoList), injectMyUserId()))).booleanValue();
        } catch (RemoteException e) {
            throw e.rethrowFromSystemServer();
        }
    }
    ...
    public void disableShortcuts(List<String> shortcutIds) {
        try {
            getFutureOrThrow(this.mService.disableShortcuts(this.mContext.getPackageName(), shortcutIds, null, 0, injectMyUserId()));
        } catch (RemoteException e) {
            throw e.rethrowFromSystemServer();
        }
    }
    ...
    public void disableShortcuts(List<String> shortcutIds, int disabledMessageResId) {
        try {
            getFutureOrThrow(this.mService.disableShortcuts(this.mContext.getPackageName(), shortcutIds, null, disabledMessageResId, injectMyUserId()));
        } catch (RemoteException e) {
            throw e.rethrowFromSystemServer();
        }
    }
    ...
    public void disableShortcuts(List<String> shortcutIds, CharSequence disabledMessage) {
        try {
            getFutureOrThrow(this.mService.disableShortcuts(this.mContext.getPackageName(), shortcutIds, disabledMessage, 0, injectMyUserId()));
        } catch (RemoteException e) {
            throw e.rethrowFromSystemServer();
        }
    }
    ...
    public void enableShortcuts(List<String> shortcutIds) {
        try {
            getFutureOrThrow(this.mService.enableShortcuts(this.mContext.getPackageName(), shortcutIds, injectMyUserId()));
        } catch (RemoteException e) {
            throw e.rethrowFromSystemServer();
        }
    }
    ...
    public void reportShortcutUsed(String shortcutId) {
        try {
            getFutureOrThrow(this.mService.reportShortcutUsed(this.mContext.getPackageName(), shortcutId, injectMyUserId()));
        } catch (RemoteException e) {
            throw e.rethrowFromSystemServer();
        }
    }
    ...
    public boolean requestPinShortcut(ShortcutInfo shortcut, IntentSender resultIntent) {
        try {
            return ((Boolean) getFutureOrThrow(this.mService.requestPinShortcut(this.mContext.getPackageName(), shortcut, resultIntent, injectMyUserId()))).booleanValue();
        } catch (RemoteException e) {
            throw e.rethrowFromSystemServer();
        }
    }
    ...
    public Intent createShortcutResultIntent(ShortcutInfo shortcut) {
        try {
            return (Intent) getFutureOrThrow(this.mService.createShortcutResultIntent(this.mContext.getPackageName(), shortcut, injectMyUserId()));
        } catch (RemoteException e) {
            throw e.rethrowFromSystemServer();
        }
    }
    ...
    public void onApplicationActive(String packageName, int userId) {
        try {
            getFutureOrThrow(this.mService.onApplicationActive(packageName, userId));
        } catch (RemoteException e) {
            throw e.rethrowFromSystemServer();
        }
    }
    ...
    public List<ShareShortcutInfo> getShareTargets(IntentFilter filter) {
        try {
            return ((ParceledListSlice) getFutureOrThrow(this.mService.getShareTargets(this.mContext.getPackageName(), filter, injectMyUserId()))).getList();
        } catch (RemoteException e) {
            throw e.rethrowFromSystemServer();
        }
    }
    ...
    public static final class ShareShortcutInfo implements Parcelable {
        public static final Parcelable.Creator<ShareShortcutInfo> CREATOR = new Parcelable.Creator<ShareShortcutInfo>() { // from class: android.content.pm.ShortcutManager.ShareShortcutInfo.1
            ...
            public ShareShortcutInfo mo3559createFromParcel(Parcel in) {
            ...
            public ShareShortcutInfo[] mo3560newArray(int size) {
    ...
    public void pushDynamicShortcut(ShortcutInfo shortcut) {
        try {
            getFutureOrThrow(this.mService.pushDynamicShortcut(this.mContext.getPackageName(), shortcut, injectMyUserId()));
        } catch (RemoteException e) {
            throw e.rethrowFromSystemServer();
        }
    }
