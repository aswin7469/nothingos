...
public final class SigningInfo implements Parcelable {
    public static final Parcelable.Creator<SigningInfo> CREATOR = new Parcelable.Creator<SigningInfo>() { // from class: android.content.pm.SigningInfo.1
        ...
        public SigningInfo mo3559createFromParcel(Parcel source) {
        ...
        public SigningInfo[] mo3560newArray(int size) {
    ...
    private SigningInfo(Parcel source) {
        this.mSigningDetails = PackageParser.SigningDetails.CREATOR.mo3559createFromParcel(source);
    }
