...
public interface XmlSerializerAndParser<T> {
    ...
    T mo704createFromXml(TypedXmlPullParser typedXmlPullParser) throws IOException, XmlPullParserException;
    ...
    default T createFromXml(XmlPullParser parser) throws IOException, XmlPullParserException {
        return mo704createFromXml(XmlUtils.makeTyped(parser));
    }
}
