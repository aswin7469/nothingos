    ...
    */
    ...
    public static ParseResult<String> buildCompoundName(String pkg, CharSequence procSeq, String type, ParseInput input) {
        ...
        if (pkg != null && c == ':') {
            ...
            ParseResult<?> nameResult = ParsingPackageUtils.validateName(input, subName, false, false);
        ...
        if (!"system".equals(proc)) {
            ParseResult<?> nameResult2 = ParsingPackageUtils.validateName(input, proc, true, false);
