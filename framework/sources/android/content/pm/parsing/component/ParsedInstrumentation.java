...
public class ParsedInstrumentation extends ParsedComponent {
    public static final Parcelable.Creator<ParsedInstrumentation> CREATOR = new Parcelable.Creator<ParsedInstrumentation>() { // from class: android.content.pm.parsing.component.ParsedInstrumentation.1
        ...
        public ParsedInstrumentation mo3559createFromParcel(Parcel source) {
        ...
        public ParsedInstrumentation[] mo3560newArray(int size) {
    ...
    protected ParsedInstrumentation(Parcel in) {
        super(in);
        this.targetPackage = ParsingPackageImpl.sForInternedString.mo3468unparcel(in);
        this.targetProcesses = ParsingPackageImpl.sForInternedString.mo3468unparcel(in);
        boolean z = true;
