...
public final class ParsedIntentInfo extends IntentFilter {
    ...
    public static class Parceler implements Parcelling<ParsedIntentInfo> {
        ...
        public ParsedIntentInfo mo3468unparcel(Parcel source) {
    ...
    public static class ListParceler implements Parcelling<List<ParsedIntentInfo>> {
        ...
        public List<ParsedIntentInfo> mo3468unparcel(Parcel source) {
            ...
            for (int i = 0; i < size; i++) {
                intentsList.add(ParsedIntentInfo.PARCELER.mo3468unparcel(source));
            }
            return intentsList;
        }
    }
    ...
    public static class StringPairListParceler implements Parcelling<List<Pair<String, ParsedIntentInfo>>> {
        ...
        @Override // com.android.internal.util.Parcelling
        /* renamed from: unparcel  reason: collision with other method in class */
        public List<Pair<String, ParsedIntentInfo>> mo3468unparcel(Parcel source) {
            int size = source.readInt();
            if (size == -1) {
                return null;
            }
            ...
            for (int i = 0; i < size; i++) {
                list.add(Pair.create(source.readString(), ParsedIntentInfo.PARCELER.mo3468unparcel(source)));
            }
            return list;
        }
    }
