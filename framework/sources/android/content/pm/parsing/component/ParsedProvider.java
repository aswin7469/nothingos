...
public class ParsedProvider extends ParsedMainComponent {
    public static final Parcelable.Creator<ParsedProvider> CREATOR = new Parcelable.Creator<ParsedProvider>() { // from class: android.content.pm.parsing.component.ParsedProvider.1
        ...
        public ParsedProvider mo3559createFromParcel(Parcel source) {
        ...
        public ParsedProvider[] mo3560newArray(int size) {
    ...
    protected ParsedProvider(Parcel in) {
        ...
        this.readPermission = ParsingPackageImpl.sForInternedString.mo3468unparcel(in);
        this.writePermission = ParsingPackageImpl.sForInternedString.mo3468unparcel(in);
