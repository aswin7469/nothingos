                ...
                default:
                    ...
                    switch (code) {
                        ...
                        case 5:
                            ...
                            if (data.readInt() != 0) {
                                _arg1 = DomainSet.CREATOR.mo3559createFromParcel(data);
                            } else {
                                _arg1 = null;
                            }
                        ...
                        case 7:
                            ...
                            if (data.readInt() != 0) {
                                _arg12 = DomainSet.CREATOR.mo3559createFromParcel(data);
                            } else {
                                _arg12 = null;
                            }
                            if (data.readInt() != 0) {
        ...
        public static class Proxy implements IDomainVerificationManager {
            ...
            public DomainVerificationInfo getDomainVerificationInfo(String packageName) throws RemoteException {
                ...
                try {
                    ...
                    _reply.readException();
                    if (_reply.readInt() != 0) {
                        _result = DomainVerificationInfo.CREATOR.mo3559createFromParcel(_reply);
                    } else {
                        _result = null;
                    }
                    return _result;
            ...
            public DomainVerificationUserState getDomainVerificationUserState(String packageName, int userId) throws RemoteException {
                ...
                try {
                    ...
                    _reply.readException();
                    if (_reply.readInt() != 0) {
                        _result = DomainVerificationUserState.CREATOR.mo3559createFromParcel(_reply);
                    } else {
                        _result = null;
                    }
                    return _result;
