...
public final class AssetManager implements AutoCloseable {
    ...
    public static class Builder {
        ...
        public AssetManager build() {
            ...
            ResourcesLoader[] resourcesLoaderArr = null;
            ...
            if (!this.mLoaders.isEmpty()) {
                resourcesLoaderArr = (ResourcesLoader[]) this.mLoaders.toArray(new ResourcesLoader[0]);
            }
            assetManager.mLoaders = resourcesLoaderArr;
            return assetManager;
        }
    }
