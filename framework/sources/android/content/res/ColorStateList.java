...
public class ColorStateList extends ComplexColor implements Parcelable {
    ...
    public static final Parcelable.Creator<ColorStateList> CREATOR = new Parcelable.Creator<ColorStateList>() { // from class: android.content.res.ColorStateList.1
        ...
        public ColorStateList[] mo3560newArray(int size) {
        ...
        public ColorStateList mo3559createFromParcel(Parcel source) {
    ...
    public static ColorStateList valueOf(int color) {
        ...
        synchronized (sparseArray) {
            ...
            for (int i = N - 1; i >= 0; i--) {
                ...
                if (sparseArray2.valueAt(i).get() == null) {
    ...
    public ColorStateList mo1063obtainForTheme(Resources.Theme t) {
    ...
    private static class ColorStateListFactory extends ConstantState<ComplexColor> {
        ...
        public ComplexColor mo1064newInstance() {
            return this.mSrc;
        }
        ...
        public ComplexColor newInstance2(Resources res, Resources.Theme theme) {
            return this.mSrc.mo1063obtainForTheme(theme);
        }
    }
