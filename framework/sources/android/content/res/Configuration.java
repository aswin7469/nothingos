...
public final class Configuration implements Parcelable, Comparable<Configuration> {
    ...
    public static final Parcelable.Creator<Configuration> CREATOR = new Parcelable.Creator<Configuration>() { // from class: android.content.res.Configuration.1
        ...
        public Configuration mo3559createFromParcel(Parcel source) {
        ...
        public Configuration[] mo3560newArray(int size) {
    ...
    /* JADX WARN: Removed duplicated region for block: B:101:0x034e A[Catch: IllformedLocaleException -> 0x0375, all -> 0x03a0, TRY_ENTER, TryCatch #0 {all -> 0x03a0, blocks: (B:95:0x0325, B:97:0x0328, B:101:0x034e, B:103:0x039f, B:109:0x0371, B:111:0x037a, B:145:0x024c, B:147:0x025f, B:150:0x0269, B:153:0x0280, B:158:0x02d0, B:163:0x0286), top: B:144:0x024c }] */
    /* JADX WARN: Removed duplicated region for block: B:109:0x0371 A[Catch: IllformedLocaleException -> 0x0375, all -> 0x03a0, TRY_LEAVE, TryCatch #0 {all -> 0x03a0, blocks: (B:95:0x0325, B:97:0x0328, B:101:0x034e, B:103:0x039f, B:109:0x0371, B:111:0x037a, B:145:0x024c, B:147:0x025f, B:150:0x0269, B:153:0x0280, B:158:0x02d0, B:163:0x0286), top: B:144:0x024c }] */
    ...
    */
                                                        ...
                                                        try {
                                                            ...
                                                            try {
                                                                ...
                                                                try {
                                                                    ...
                                                                    Slog.e(str3, "readFromProto error building locale with: language-" + language + ";country-" + country + ";variant-" + variant + ";script-" + script);
                                                ...
                                                try {
                                                    try {
                                                        ...
                                                        if (inListIndex2 != -1) {
                                                            ...
                                                            str4 = str7;
                                                            try {
                                                                sb.append(list.get(inListIndex2));
                                                                sb.append(") found when trying to add: ");
                                                                sb.append(locale3.toString());
                                                                str5 = str10;
                                                            } catch (IllformedLocaleException e6) {
                                                                str5 = str10;
                                                                Slog.e(str5, "readFromProto error building locale with: language-" + language2 + ";country-" + country2 + ";variant-" + variant2 + ";script-" + script2);
                                                                configuration = this;
                                                                protoInputStream2 = protoInputStream;
                                                                str7 = str4;
                                                                str8 = str;
                        ...
                        case 20:
                            ...
                            try {
                                try {
                                    ...
                                    Slog.e(str9, "error parsing locale list in configuration.", e13);
                                    str = str8;
                                    token2 = token7;
                                    break;
                                }
    ...
    public int updateFrom(Configuration delta) {
        ...
        if (i41 != Integer.MAX_VALUE && i41 != this.fontWeightAdjustment) {
            int changed2 = changed | 268435456;
    ...
    public int diff(Configuration delta, boolean compareUndefined, boolean publicOnly) {
        ...
        if (publicOnly && this.windowConfiguration.getWindowingMode() != delta.windowConfiguration.getWindowingMode() && ActivityThread.isSystem() && (isNtWindowMode(this.windowConfiguration.getWindowingMode()) || isNtWindowMode(delta.windowConfiguration.getWindowingMode()))) {
            changed |= 536870912;
        }
        if ((compareUndefined || delta.fontWeightAdjustment != Integer.MAX_VALUE) && this.fontWeightAdjustment != delta.fontWeightAdjustment) {
            return changed | 268435456;
        }
        return changed;
    }
    ...
    public int compareTo(Configuration that) {
        ...
        return n23 != 0 ? n23 : this.fontWeightAdjustment - that.fontWeightAdjustment;
    }
    ...
    public static boolean isNtWindowMode(int windowMode) {
        return windowMode == 11 || windowMode == 12;
    }

    public boolean isNtWindowMode() {
        int windowMode = this.windowConfiguration.getWindowingMode();
        return windowMode == 11 || windowMode == 12;
    }

    public boolean isNtMiniWindow() {
        return this.windowConfiguration.getWindowingMode() == 11;
    }

    public boolean isNtPinWindow() {
        return this.windowConfiguration.getWindowingMode() == 12;
    }
}
