...
public class Resources {
    ...
    public final Theme newTheme() {
        ...
        synchronized (this.mThemeRefs) {
            ...
            if (this.mThemeRefs.size() > this.mThemeRefsNextFlushSize) {
                this.mThemeRefs.removeIf(Resources$$ExternalSyntheticLambda0.INSTANCE);
    ...
    public DisplayAdjustments getDisplayAdjustments() {
        DisplayAdjustments overrideDisplayAdjustments = this.mOverrideDisplayAdjustments;
    ...
    public void overrideDisplayAdjustments(Consumer<DisplayAdjustments> override) {
        if (override != null) {
            ...
            override.accept(displayAdjustments);
            return;
        }
    ...
    public boolean hasOverrideDisplayAdjustments() {
        return this.mOverrideDisplayAdjustments != null;
    }
