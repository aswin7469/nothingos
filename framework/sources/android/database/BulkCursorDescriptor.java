...
public final class BulkCursorDescriptor implements Parcelable {
    public static final Parcelable.Creator<BulkCursorDescriptor> CREATOR = new Parcelable.Creator<BulkCursorDescriptor>() { // from class: android.database.BulkCursorDescriptor.1
        ...
        public BulkCursorDescriptor mo3559createFromParcel(Parcel in) {
        ...
        public BulkCursorDescriptor[] mo3560newArray(int size) {
    ...
    public void readFromParcel(Parcel in) {
        ...
        if (in.readInt() != 0) {
            this.window = CursorWindow.CREATOR.mo3559createFromParcel(in);
        }
    }
}
