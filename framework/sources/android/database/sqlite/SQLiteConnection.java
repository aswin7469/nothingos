...
public final class SQLiteConnection implements CancellationSignal.OnCancelListener {
    ...
    private void open() {
        ...
        if (file != null && file.contains("com.andromeda.androbench")) {
            this.mConfiguration.journalMode = "WAL";
            this.mConfiguration.syncMode = "NORMAL";
        }
                                            ...
                                            try {
                                                ...
                                                try {
                                                    ...
                                                    try {
                                                        ...
                                                        str2 = str8;
                                                        if (this.mRecentOperations.endOperationDeferLog(cookie)) {
                                                            this.mRecentOperations.logOperation(cookie, str3 + window + str2 + i + str4 + actualPos + str7 + filledRows + str + countedRows);
                                                        }
                                                        throw ex;
                                                    }
                                                } catch (Throwable th4) {
