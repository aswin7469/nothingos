...
public final class SQLiteDatabase extends SQLiteClosable {
    ...
    private final ThreadLocal<SQLiteSession> mThreadSession = ThreadLocal.withInitial(new Supplier() { // from class: android.database.sqlite.SQLiteDatabase$$ExternalSyntheticLambda1
    ...
    private static void dumpDatabaseDirectory(Printer pw, File dir, boolean isSystem) {
        ...
        Arrays.sort(files, SQLiteDatabase$$ExternalSyntheticLambda0.INSTANCE);
        for (File f : files) {
            if (isSystem) {
    ...
    public static final class OpenParams {
        ...
        public static final class Builder {
            ...
            public Builder setLookasideConfig(int slotSize, int slotCount) {
                ...
                Preconditions.checkArgument((slotSize > 0 && slotCount > 0) || (slotCount == 0 && slotSize == 0), "Invalid configuration: %d, %d", Integer.valueOf(slotSize), Integer.valueOf(slotCount));
