...
public class BackDropperFilter extends Filter {
    ...
    private void allocateFrames(FrameFormat inputFormat, FilterContext context) {
        ...
        shaderProgram.setHostValue("subsample_level", Float.valueOf((float) this.mSubsampleLevel));
        ...
        shaderProgram3.setHostValue("subsample_level", Float.valueOf((float) this.mSubsampleLevel));
        ...
        shaderProgram4.setHostValue("subsample_level", Float.valueOf((float) this.mSubsampleLevel));
        ...
        shaderProgram5.setHostValue("pyramid_depth", Float.valueOf((float) this.mPyramidDepth));
    ...
    public void process(FilterContext context) {
        ...
        if (this.mFrameCount <= this.mLearningDuration) {
            ...
            if (i == i2 - i3) {
                ...
                Frame[] maskVerifyInputs = {gLFrameArr[inputIndex], this.mMask};
                this.mMaskVerifyProgram.process(maskVerifyInputs, gLFrameArr[r4]);
        ...
        if (this.mFrameCount < this.mLearningDuration - this.mLearningVerifyDuration || this.mAdaptRateBg > 0.0d || this.mAdaptRateFg > 0.0d) {
            ...
            Frame[] meanUpdateInputs = {this.mVideoInput, gLFrameArr2[inputIndex], this.mMask};
            ShaderProgram shaderProgram = this.mBgUpdateMeanProgram;
            int outputIndex = r4 == true ? 1 : 0;
            shaderProgram.process(meanUpdateInputs, gLFrameArr2[outputIndex]);
            this.mBgMean[r4].generateMipMap();
            this.mBgMean[r4].setTextureParameter(10241, 9985);
            GLFrame[] gLFrameArr3 = this.mBgVariance;
            Frame[] varianceUpdateInputs = {this.mVideoInput, this.mBgMean[inputIndex], gLFrameArr3[inputIndex], this.mMask};
            this.mBgUpdateVarianceProgram.process(varianceUpdateInputs, gLFrameArr3[r4]);
