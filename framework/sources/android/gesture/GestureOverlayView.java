...
public class GestureOverlayView extends FrameLayout {
    ...
    public GestureOverlayView(Context context, AttributeSet attrs, int defStyleAttr, int defStyleRes) {
        ...
        float f = a.getFloat(1, this.mGestureStrokeWidth);
    ...
    public void setPaintAlpha(int alpha) {
        ...
        this.mGesturePaint.setColor(((i << 8) >>> 8) | (useAlpha << 24));
    }
    ...
    public boolean dispatchTouchEvent(MotionEvent event) {
        ...
        boolean cancelDispatch2 = super.dispatchTouchEvent(event);
    ...
    private Rect touchMove(MotionEvent event) {
        ...
        if (dx >= 3.0f || dy >= 3.0f) {
            ...
            if (!this.mHandleGestureActions || this.mIsGesturing) {
                ...
                float hypot = this.mTotalLength + ((float) Math.hypot(dx, dy));
    ...
    private void touchUp(MotionEvent event, boolean cancel) {
        ...
        if (gesture != null) {
            ...
            if (!cancel) {
                ...
                boolean z = this.mHandleGestureActions;
                boolean z2 = true;
                boolean z3 = z && this.mFadeEnabled;
                if (!z || !this.mIsGesturing) {
                    z2 = false;
                }
                clear(z3, z2, false);
            } else {
