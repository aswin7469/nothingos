...
public class HardwareRenderer {
    ...
    public final class FrameRenderRequest {
        ...
        public FrameRenderRequest setFrameCommitCallback(final Executor executor, final Runnable frameCommitCallback) {
            HardwareRenderer.this.setFrameCompleteCallback(new FrameCompleteCallback() { // from class: android.graphics.HardwareRenderer$FrameRenderRequest$$ExternalSyntheticLambda0
    ...
    public void setASurfaceTransactionCallback(ASurfaceTransactionCallback callback) {
        this.mASurfaceTransactionCallback = callback;
    ...
    public void setPrepareSurfaceControlForWebviewCallback(PrepareSurfaceControlForWebviewCallback callback) {
        this.mAPrepareSurfaceControlForWebviewCallback = callback;
    ...
    public static class ProcessInitializer {
        ...
        public enum Dataspace {
            DISPLAY_P3(ColorSpace.Named.DISPLAY_P3, ProcessInitializer.INTERNAL_DATASPACE_DISPLAY_P3),
            SCRGB(ColorSpace.Named.EXTENDED_SRGB, ProcessInitializer.INTERNAL_DATASPACE_SCRGB),
            SRGB(ColorSpace.Named.SRGB, ProcessInitializer.INTERNAL_DATASPACE_SRGB);
        ...
        private void initDisplayInfo() {
            ...
            Dataspace wideColorDataspace = (Dataspace) Optional.ofNullable(display.getPreferredWideGamutColorSpace()).flatMap(HardwareRenderer$ProcessInitializer$$ExternalSyntheticLambda0.INSTANCE).orElse(Dataspace.SRGB);
