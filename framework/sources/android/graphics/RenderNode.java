...
public final class RenderNode {
    ...
    public void getMatrix(Matrix outMatrix) {
        nGetTransformMatrix(this.mNativeRenderNode, outMatrix.ni());
    }

    public void getInverseMatrix(Matrix outMatrix) {
        nGetInverseTransformMatrix(this.mNativeRenderNode, outMatrix.ni());
    }
    ...
    public Matrix getAnimationMatrix() {
        ...
        if (nGetAnimationMatrix(this.mNativeRenderNode, output.ni())) {
            return output;
        }
        return null;
    }
