...
public class Typeface {
    ...
    @CriticalNative
    private static native long nativeGetFamily(long j, int i);

    @CriticalNative
    private static native int nativeGetFamilySize(long j);
    ...
    private static native long[] nativeReadTypefaces(ByteBuffer byteBuffer);
    ...
    private static native int nativeWriteTypefaces(ByteBuffer byteBuffer, long[] jArr);
    ...
    public static final class Builder {
        ...
        public Builder setItalic(boolean italic) {
            ...
            this.mFontBuilder.setSlant(italic);
            return this;
        }
    ...
    private static Typeface createFromFamilies(FontFamily[] families) {
        ...
        return new Typeface(nativeCreateFromArray(ptrArray, 0L, -1, -1));
    }
    ...
    private static Typeface createFromFamiliesWithDefault(FontFamily[] families, String fallbackName, int weight, int italic) {
        ...
        return new Typeface(nativeCreateFromArray(ptrArray, fallbackTypeface.native_instance, weight, italic));
    }
    ...
    private static void preloadFontFile(String filePath) {
        ...
        if (file.exists()) {
            String str = TAG;
            Log.i(str, "Preloading " + file.getAbsolutePath());
    ...
    public List<android.graphics.fonts.FontFamily> getFallback() {
        ArrayList<android.graphics.fonts.FontFamily> families = new ArrayList<>();
        int familySize = nativeGetFamilySize(this.native_instance);
        for (int i = 0; i < familySize; i++) {
            families.add(new android.graphics.fonts.FontFamily(nativeGetFamily(this.native_instance, i)));
        }
        return families;
    }
}
