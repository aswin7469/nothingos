...
public class AdaptiveIconDrawable extends Drawable implements Drawable.Callback {
    ...
    AdaptiveIconDrawable(LayerState state, Resources res) {
        ...
        sMask = PathParser.createPathFromPathData("M50 0A50 50,0,1,1,50 100A50 50,0,1,1,50 0");
        ...
        LayerState(LayerState orig, AdaptiveIconDrawable owner, Resources res) {
            ...
            if (orig != null) {
                ...
                for (int i2 = 0; i2 < 2; i2++) {
                    ChildDrawable or = origChildDrawable[i2];
                    this.mChildren[i2] = new ChildDrawable(or, owner, res);
                }
