    ...
    private void updateStateFromTypedArray(TypedArray a, int srcDensityOverride) throws XmlPullParserException {
        ...
        if (srcResId != 0) {
            ...
            try {
                ...
                Drawable drawable = ImageDecoder.decodeDrawable(source, AnimatedImageDrawable$$ExternalSyntheticLambda0.INSTANCE);
    ...
    public void draw(Canvas canvas) {
        ...
        if (nextUpdate > 0) {
            if (this.mRunnable == null) {
                this.mRunnable = new Runnable() { // from class: android.graphics.drawable.AnimatedImageDrawable$$ExternalSyntheticLambda3
