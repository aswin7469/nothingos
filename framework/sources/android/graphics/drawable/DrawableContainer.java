...
public class DrawableContainer extends Drawable implements Drawable.Callback {
    ...
    public Drawable mo3113mutate() {
        if (!this.mMutated && super.mo3113mutate() == this) {
            DrawableContainerState clone = mo1111cloneConstantState();
            clone.mutate();
    ...
    DrawableContainerState mo1111cloneConstantState() {
        return this.mDrawableContainerState;
    }
    ...
    public static abstract class DrawableContainerState extends Drawable.ConstantState {
        ...
        public DrawableContainerState(DrawableContainerState orig, DrawableContainer owner, Resources res) {
            ...
            if (orig != null) {
                ...
                if (origDf != null) {
                    this.mDrawableFutures = origDf.m2782clone();
                } else {
        ...
        private Drawable prepareDrawable(Drawable child) {
            ...
            Drawable child2 = child.mo3113mutate();
