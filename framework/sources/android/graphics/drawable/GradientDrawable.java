...
public class GradientDrawable extends Drawable {
    ...
    /* synthetic */ GradientDrawable(GradientState x0, Resources x1, AnonymousClass1 x2) {
        this(x0, x1);
    }
                ...
                if (st.mGradient == 0) {
                    ...
                    if (st.mUseLevel) {
                        ...
                        for (int i = 0; i < length; i++) {
                            tempPositions2[i] = i * fraction * level2;
                        }
    ...
    public void applyTheme(Resources.Theme t) {
        ...
        if (state.mSolidColors != null && state.mSolidColors.canApplyTheme()) {
            state.mSolidColors = state.mSolidColors.mo1063obtainForTheme(t);
        }
        if (state.mStrokeColors != null && state.mStrokeColors.canApplyTheme()) {
            state.mStrokeColors = state.mStrokeColors.mo1063obtainForTheme(t);
        }
