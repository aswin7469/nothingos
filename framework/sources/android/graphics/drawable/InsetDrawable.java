...
public class InsetDrawable extends DrawableWrapper {
    ...
    public static final class InsetState extends DrawableWrapper.DrawableWrapperState {
        ...
        InsetState(InsetState orig, Resources res) {
            super(orig, res);
            if (orig != null) {
                this.mInsetLeft = orig.mInsetLeft.m1108clone();
                this.mInsetTop = orig.mInsetTop.m1108clone();
                this.mInsetRight = orig.mInsetRight.m1108clone();
                this.mInsetBottom = orig.mInsetBottom.m1108clone();
