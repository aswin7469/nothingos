...
public final class RippleAnimationSession {
    ...
    private void exitSoftware() {
        ...
        expand.mo1103setDuration(375L);
        expand.setStartDelay(computeDelay());
        expand.addUpdateListener(new ValueAnimator.AnimatorUpdateListener() { // from class: android.graphics.drawable.RippleAnimationSession$$ExternalSyntheticLambda2
            @Override // android.animation.ValueAnimator.AnimatorUpdateListener
            public final void onAnimationUpdate(ValueAnimator valueAnimator) {
                RippleAnimationSession.this.lambda$exitSoftware$0$RippleAnimationSession(expand, valueAnimator);
            }
        });
    ...
    public /* synthetic */ void lambda$exitSoftware$0$RippleAnimationSession(ValueAnimator expand, ValueAnimator updatedAnimation) {
        notifyUpdate();
    ...
    private void startAnimation(Animator expand, Animator loop) {
        expand.mo1103setDuration(450L);
        expand.addListener(new AnimatorListener(this));
        expand.setInterpolator(FAST_OUT_SLOW_IN);
        expand.start();
        loop.mo1103setDuration(NOISE_ANIMATION_DURATION);
    ...
    private void enterSoftware() {
        ...
        expand.addUpdateListener(new ValueAnimator.AnimatorUpdateListener() { // from class: android.graphics.drawable.RippleAnimationSession$$ExternalSyntheticLambda0
            @Override // android.animation.ValueAnimator.AnimatorUpdateListener
            public final void onAnimationUpdate(ValueAnimator valueAnimator) {
                RippleAnimationSession.this.lambda$enterSoftware$1$RippleAnimationSession(expand, valueAnimator);
            }
        });
        long j = this.mStartTime;
        final ValueAnimator loop = ValueAnimator.ofFloat((float) j, (float) (j + 32));
        loop.addUpdateListener(new ValueAnimator.AnimatorUpdateListener() { // from class: android.graphics.drawable.RippleAnimationSession$$ExternalSyntheticLambda1
            @Override // android.animation.ValueAnimator.AnimatorUpdateListener
            public final void onAnimationUpdate(ValueAnimator valueAnimator) {
                RippleAnimationSession.this.lambda$enterSoftware$2$RippleAnimationSession(loop, valueAnimator);
            }
        });
        startAnimation(expand, loop);
        this.mCurrentAnimation = expand;
    ...
    public /* synthetic */ void lambda$enterSoftware$1$RippleAnimationSession(ValueAnimator expand, ValueAnimator updatedAnimation) {
        notifyUpdate();
        this.mProperties.getShader().setProgress(((Float) expand.getAnimatedValue()).floatValue());
    }

    public /* synthetic */ void lambda$enterSoftware$2$RippleAnimationSession(ValueAnimator loop, ValueAnimator updatedAnimation) {
        notifyUpdate();
