...
public class RippleDrawable extends LayerDrawable {
    ...
    public void applyTheme(Resources.Theme t) {
        ...
        if (state.mColor != null && state.mColor.canApplyTheme()) {
            state.mColor = state.mColor.mo1063obtainForTheme(t);
        }
        updateLocalState();
    }
    ...
    private void startBackgroundAnimation() {
        ...
        this.mBackgroundAnimation.mo1103setDuration(80L);
    ...
    /* JADX INFO: Access modifiers changed from: package-private */
    @Override // android.graphics.drawable.LayerDrawable
    /* renamed from: createConstantState  reason: collision with other method in class */
    public RippleState mo1110createConstantState(LayerDrawable.LayerState state, Resources res) {
