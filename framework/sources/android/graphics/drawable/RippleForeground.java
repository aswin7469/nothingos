...
public class RippleForeground extends RippleComponent {
    ...
    private final AnimatorListenerAdapter mAnimationListener = new AnimatorListenerAdapter() { // from class: android.graphics.drawable.RippleForeground.1
    ...
    private void startSoftwareEnter() {
        ...
        tweenRadius.mo1103setDuration(225L);
        ...
        tweenOrigin.mo1103setDuration(225L);
    ...
    private void startSoftwareExit() {
        ...
        opacity.mo1103setDuration(150L);
        opacity.setInterpolator(LINEAR_INTERPOLATOR);
