...
public class CameraSessionStats implements Parcelable {
    ...
    public static final Parcelable.Creator<CameraSessionStats> CREATOR = new Parcelable.Creator<CameraSessionStats>() { // from class: android.hardware.CameraSessionStats.1
        ...
        public CameraSessionStats mo3559createFromParcel(Parcel in) {
        ...
        public CameraSessionStats[] mo3560newArray(int size) {
    ...
    public CameraSessionStats(String cameraId, int facing, int newCameraState, String clientName, int apiLevel, boolean isNdk, int creationDuration, int sessionType, int internalReconfigure) {
