...
import nothing.utils.VibrateUtils;
...
public class BiometricPrompt implements BiometricAuthenticator, BiometricConstants {
    ...
    /* synthetic */ BiometricPrompt(Context x0, PromptInfo x1, ButtonInfo x2, AnonymousClass1 x3) {
        this(x0, x1, x2);
    }
    ...
    public static class Builder {
        ...
        public BiometricPrompt build() {
            ...
            return new BiometricPrompt(this.mContext, this.mPromptInfo, this.mNegativeButtonInfo, null);
        }
    }
    ...
    public class AnonymousClass1 extends IBiometricServiceReceiver.Stub {
        ...
        public void onAuthenticationSucceeded(final int authenticationType) {
            VibrateUtils.getInstance(BiometricPrompt.this.mContext).playVerityVibrate(VibrateUtils.VibrateType.FINGERPRINT_VERIFICATION_SUCCEEDED);
            BiometricPrompt.this.mExecutor.execute(new Runnable() { // from class: android.hardware.biometrics.BiometricPrompt$1$$ExternalSyntheticLambda2
                ...
                public final void run() {
                    BiometricPrompt.AnonymousClass1.this.lambda$onAuthenticationSucceeded$0$BiometricPrompt$1(authenticationType);
                }
            });
        }

        public /* synthetic */ void lambda$onAuthenticationSucceeded$0$BiometricPrompt$1(int authenticationType) {
        ...
        public void onAuthenticationFailed() {
            VibrateUtils.getInstance(BiometricPrompt.this.mContext).playVerityVibrate(VibrateUtils.VibrateType.FINGERPRINT_VERIFICATION_ERROR);
        ...
        public void onError(int modality, final int error, int vendorCode) {
            ...
            BiometricPrompt.this.mExecutor.execute(new Runnable() { // from class: android.hardware.biometrics.BiometricPrompt$1$$ExternalSyntheticLambda5
                @Override // java.lang.Runnable
                public final void run() {
                    BiometricPrompt.AnonymousClass1.this.lambda$onError$2$BiometricPrompt$1(error, stringToSend);
                }
            });
        }

        public /* synthetic */ void lambda$onError$2$BiometricPrompt$1(int error, String stringToSend) {
        ...
        public void onDialogDismissed(int reason) {
            if (reason == 2) {
                BiometricPrompt.this.mNegativeButtonInfo.executor.execute(new Runnable() { // from class: android.hardware.biometrics.BiometricPrompt$1$$ExternalSyntheticLambda1
                    @Override // java.lang.Runnable
                    public final void run() {
        ...
        public void onSystemEvent(final int event) {
            BiometricPrompt.this.mExecutor.execute(new Runnable() { // from class: android.hardware.biometrics.BiometricPrompt$1$$ExternalSyntheticLambda3
                @Override // java.lang.Runnable
                public final void run() {
                    BiometricPrompt.AnonymousClass1.this.lambda$onSystemEvent$5$BiometricPrompt$1(event);
                }
            });
        }

        public /* synthetic */ void lambda$onSystemEvent$5$BiometricPrompt$1(int event) {
    ...
    public static class AuthenticationResult extends BiometricAuthenticator.AuthenticationResult {
        ...
        public CryptoObject mo1142getCryptoObject() {
            return (CryptoObject) super.mo1142getCryptoObject();
        }
    ...
    public void authenticateUser(CancellationSignal cancel, Executor executor, AuthenticationCallback callback, int userId) {
        authenticateUserForOperation(cancel, executor, callback, userId, 0L);
    }

    public long authenticateUserForOperation(CancellationSignal cancel, Executor executor, AuthenticationCallback callback, int userId, long operationId) {
        if (cancel == null) {
    ...
    public void cancelAuthentication(long requestId) {
        ...
        if (iAuthService != null) {
            try {
                iAuthService.cancelAuthentication(this.mToken, this.mContext.getOpPackageName(), requestId);
        ...
        try {
            if (!cancel.isCanceled()) {
                try {
                    ...
                    long authId = this.mService.authenticate(this.mToken, operationId, userId, this.mBiometricServiceReceiver, this.mContext.getOpPackageName(), promptInfo);
                    try {
