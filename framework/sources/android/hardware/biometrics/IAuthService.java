                ...
                default:
                    switch (code) {
                        ...
                        case 4:
                            ...
                            if (data.readInt() != 0) {
                                _arg5 = PromptInfo.CREATOR.mo3559createFromParcel(data);
                            } else {
                                _arg5 = null;
                            }
                        ...
                        case 10:
                            ...
                            long[] _result6 = getAuthenticatorIds(_arg09);
                            reply.writeNoException();
                        ...
                        case 12:
                            ...
                            CharSequence _result7 = getButtonLabel(_arg011, _arg18, _arg27);
                            reply.writeNoException();
                            if (_result7 != null) {
                                reply.writeInt(1);
                        ...
                        case 13:
                            ...
                            CharSequence _result8 = getPromptMessage(_arg012, _arg19, _arg28);
                            reply.writeNoException();
                            if (_result8 != null) {
                                reply.writeInt(1);
                        ...
                        case 14:
                            ...
                            CharSequence _result9 = getSettingName(_arg013, _arg110, _arg29);
                            reply.writeNoException();
                            if (_result9 != null) {
                                reply.writeInt(1);
                    ...
                    try {
                        ...
                        try {
                            ...
                            try {
                                ...
                                if (!_status && Stub.getDefaultImpl() != null) {
                                    long authenticate = Stub.getDefaultImpl().authenticate(token, sessionId, userId, receiver, opPackageName, promptInfo);
                                    _reply.recycle();
                                    _data.recycle();
                                    return authenticate;
                                }
