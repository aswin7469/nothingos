...
public interface ITestSessionCallback extends IInterface {
    ...
    public static abstract class Stub extends Binder implements ITestSessionCallback {
        ...
        public static class Proxy implements ITestSessionCallback {
            public static ITestSessionCallback sDefaultImpl;
            ...
            public void onCleanupStarted(int userId) throws RemoteException {
                ...
                try {
                    ...
                    if (!_status && Stub.getDefaultImpl() != null) {
                        Stub.getDefaultImpl().onCleanupStarted(userId);
                    } else {
            ...
            public void onCleanupFinished(int userId) throws RemoteException {
                ...
                try {
                    ...
                    if (!_status && Stub.getDefaultImpl() != null) {
                        Stub.getDefaultImpl().onCleanupFinished(userId);
                    } else {
                        _reply.readException();
                    }
                } finally {
        ...
        public static boolean setDefaultImpl(ITestSessionCallback impl) {
        ...
        public static ITestSessionCallback getDefaultImpl() {
