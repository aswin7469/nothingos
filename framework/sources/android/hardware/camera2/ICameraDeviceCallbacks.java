                ...
                default:
                    switch (code) {
                        case 1:
                            ...
                            if (data.readInt() != 0) {
                                _arg1 = CaptureResultExtras.CREATOR.mo3559createFromParcel(data);
                            } else {
                                _arg1 = null;
                            }
                        ...
                        case 3:
                            data.enforceInterface(DESCRIPTOR);
                            if (data.readInt() != 0) {
                                _arg0 = CaptureResultExtras.CREATOR.mo3559createFromParcel(data);
                            } else {
                                _arg0 = null;
                            }
                            long _arg13 = data.readLong();
                            onCaptureStarted(_arg0, _arg13);
                            return true;
                        case 4:
                            data.enforceInterface(DESCRIPTOR);
                            if (data.readInt() != 0) {
                                _arg02 = CameraMetadataNative.CREATOR.mo3559createFromParcel(data);
                            } else {
                                _arg02 = null;
                            }
                            if (data.readInt() != 0) {
                                _arg12 = CaptureResultExtras.CREATOR.mo3559createFromParcel(data);
                            } else {
                                _arg12 = null;
                            }
                            PhysicalCaptureResultInfo[] _arg2 = (PhysicalCaptureResultInfo[]) data.createTypedArray(PhysicalCaptureResultInfo.CREATOR);
                            onResultReceived(_arg02, _arg12, _arg2);
                            return true;
                        case 5:
                            data.enforceInterface(DESCRIPTOR);
