...
public class CaptureBundle implements Parcelable {
    public static final Parcelable.Creator<CaptureBundle> CREATOR = new Parcelable.Creator<CaptureBundle>() { // from class: android.hardware.camera2.extension.CaptureBundle.1
        ...
        public CaptureBundle mo3559createFromParcel(Parcel _aidl_source) {
        ...
        public CaptureBundle[] mo3560newArray(int _aidl_size) {
    ...
    public final void readFromParcel(Parcel _aidl_parcel) {
        ...
        try {
            ...
            if (_aidl_parcel.readInt() != 0) {
                this.captureResult = CameraMetadataNative.CREATOR.mo3559createFromParcel(_aidl_parcel);
            } else {
            ...
            if (_aidl_parcel.readInt() != 0) {
                this.captureImage = ParcelImage.CREATOR.mo3559createFromParcel(_aidl_parcel);
            } else {
