                ...
                default:
                    switch (code) {
                        case 1:
                            ...
                            if (data.readInt() != 0) {
                                _arg1 = CameraMetadataNative.CREATOR.mo3559createFromParcel(data);
                            } else {
                                _arg1 = null;
                            }
                            onInit(_arg02, _arg1);
                        ...
                        case 6:
                            ...
                            if (data.readInt() != 0) {
                                _arg12 = CameraMetadataNative.CREATOR.mo3559createFromParcel(data);
                            } else {
                                _arg12 = null;
                            }
                        ...
                        case 12:
                            data.enforceInterface(IImageCaptureExtenderImpl.DESCRIPTOR);
                            if (data.readInt() != 0) {
                                _arg0 = Size.CREATOR.mo3559createFromParcel(data);
                            } else {
                                _arg0 = null;
                            }
        ...
        public static class Proxy implements IImageCaptureExtenderImpl {
            ...
            public CaptureStageImpl onPresetSession() throws RemoteException {
                ...
                try {
                    ...
                    _reply.readException();
                    if (_reply.readInt() != 0) {
                        _result = CaptureStageImpl.CREATOR.mo3559createFromParcel(_reply);
                    } else {
                        _result = null;
                    }
                    return _result;
            ...
            public LatencyRange getEstimatedCaptureLatencyRange(Size outputSize) throws RemoteException {
                ...
                try {
                    ...
                    _reply.readException();
                    if (_reply.readInt() != 0) {
                        _result = LatencyRange.CREATOR.mo3559createFromParcel(_reply);
                    } else {
                        _result = null;
                    }
                    return _result;
