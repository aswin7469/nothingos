                ...
                default:
                    switch (code) {
                        ...
                        case 2:
                            ...
                            if (data.readInt() != 0) {
                                _arg1 = ParcelCaptureResult.CREATOR.mo3559createFromParcel(data);
                            } else {
                                _arg1 = null;
                            }
                        ...
                        case 3:
                            ...
                            if (data.readInt() != 0) {
                                _arg12 = ParcelTotalCaptureResult.CREATOR.mo3559createFromParcel(data);
                            } else {
                                _arg12 = null;
                            }
                        ...
                        case 4:
                            ...
                            if (data.readInt() != 0) {
                                _arg13 = CaptureFailure.CREATOR.mo3559createFromParcel(data);
                            } else {
                                _arg13 = null;
                            }
