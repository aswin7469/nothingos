                ...
                default:
                    switch (code) {
                        case 1:
                            ...
                            if (data.readInt() != 0) {
                                _arg0 = OutputConfigId.CREATOR.mo3559createFromParcel(data);
                            } else {
                                _arg0 = null;
                            }
                        ...
                        case 2:
                            data.enforceInterface(IRequestProcessorImpl.DESCRIPTOR);
                            if (data.readInt() != 0) {
                                _arg02 = Request.CREATOR.mo3559createFromParcel(data);
                            } else {
                                _arg02 = null;
                            }
                        ...
                        case 4:
                            data.enforceInterface(IRequestProcessorImpl.DESCRIPTOR);
                            if (data.readInt() != 0) {
                                _arg03 = Request.CREATOR.mo3559createFromParcel(data);
                            } else {
                                _arg03 = null;
                            }
