                ...
                default:
                    switch (code) {
                        case 1:
                            ...
                            if (data.readInt() != 0) {
                                _arg1 = OutputSurface.CREATOR.mo3559createFromParcel(data);
                            } else {
                                _arg1 = null;
                            }
                            if (data.readInt() != 0) {
                                _arg2 = OutputSurface.CREATOR.mo3559createFromParcel(data);
                            } else {
                                _arg2 = null;
                            }
        ...
        public static class Proxy implements ISessionProcessorImpl {
            ...
            public CameraSessionConfig initSession(String cameraId, OutputSurface previewSurface, OutputSurface imageCaptureSurface) throws RemoteException {
                ...
                try {
                    ...
                    if (_reply.readInt() != 0) {
                        _result = CameraSessionConfig.CREATOR.mo3559createFromParcel(_reply);
                    } else {
                        _result = null;
                    }
                    return _result;
