...
public class ParcelCaptureResult implements Parcelable {
    public static final Parcelable.Creator<ParcelCaptureResult> CREATOR = new Parcelable.Creator<ParcelCaptureResult>() { // from class: android.hardware.camera2.extension.ParcelCaptureResult.1
        ...
        public ParcelCaptureResult mo3559createFromParcel(Parcel _aidl_source) {
        ...
        public ParcelCaptureResult[] mo3560newArray(int _aidl_size) {
    ...
    public final void readFromParcel(Parcel _aidl_parcel) {
        ...
        try {
            ...
            if (_aidl_parcel.readInt() != 0) {
                this.results = CameraMetadataNative.CREATOR.mo3559createFromParcel(_aidl_parcel);
            } else {
                this.results = null;
            }
            if (_aidl_parcel.dataPosition() - _aidl_start_pos >= _aidl_parcelable_size) {
            ...
            if (_aidl_parcel.readInt() != 0) {
                this.parent = CaptureRequest.CREATOR.mo3559createFromParcel(_aidl_parcel);
            } else {
                this.parent = null;
            }
            if (_aidl_parcel.dataPosition() - _aidl_start_pos >= _aidl_parcelable_size) {
