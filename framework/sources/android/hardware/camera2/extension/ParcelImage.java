...
public class ParcelImage implements Parcelable {
    public static final Parcelable.Creator<ParcelImage> CREATOR = new Parcelable.Creator<ParcelImage>() { // from class: android.hardware.camera2.extension.ParcelImage.1
        ...
        public ParcelImage mo3559createFromParcel(Parcel _aidl_source) {
        ...
        public ParcelImage[] mo3560newArray(int _aidl_size) {
    ...
    public final void readFromParcel(Parcel _aidl_parcel) {
        ...
        try {
            ...
            if (_aidl_parcel.readInt() != 0) {
                this.crop = Rect.CREATOR.mo3559createFromParcel(_aidl_parcel);
            } else {
                this.crop = null;
            }
            if (_aidl_parcel.dataPosition() - _aidl_start_pos >= _aidl_parcelable_size) {
            ...
            if (_aidl_parcel.readInt() != 0) {
                this.buffer = HardwareBuffer.CREATOR.mo3559createFromParcel(_aidl_parcel);
            } else {
                this.buffer = null;
            }
            if (_aidl_parcel.dataPosition() - _aidl_start_pos >= _aidl_parcelable_size) {
            ...
            if (_aidl_parcel.readInt() != 0) {
                this.fence = ParcelFileDescriptor.CREATOR.mo3559createFromParcel(_aidl_parcel);
            } else {
                this.fence = null;
            }
            if (_aidl_start_pos > Integer.MAX_VALUE - _aidl_parcelable_size) {
