...
public class SizeList implements Parcelable {
    public static final Parcelable.Creator<SizeList> CREATOR = new Parcelable.Creator<SizeList>() { // from class: android.hardware.camera2.extension.SizeList.1
        ...
        public SizeList mo3559createFromParcel(Parcel _aidl_source) {
        ...
        public SizeList[] mo3560newArray(int _aidl_size) {
    ...
    public final void writeToParcel(Parcel _aidl_parcel, int _aidl_flag) {
        ...
        _aidl_parcel.writeTypedList(this.sizes);
    ...
    public final void readFromParcel(Parcel _aidl_parcel) {
        ...
        try {
            ...
            this.sizes = _aidl_parcel.createTypedArrayList(Size.CREATOR);
            if (_aidl_start_pos > Integer.MAX_VALUE - _aidl_parcelable_size) {
                throw new BadParcelableException("Overflow in the size of parcelable");
            }
            _aidl_parcel.setDataPosition(_aidl_start_pos + _aidl_parcelable_size);
    ...
    public int describeContents() {
        int _mask = 0 | describeContents(this.sizes);
        return _mask;
    }
