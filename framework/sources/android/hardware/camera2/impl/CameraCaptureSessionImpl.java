...
public class CameraCaptureSessionImpl extends CameraCaptureSession implements CameraCaptureSessionCore {
    ...
    public CameraCaptureSessionImpl(int id, Surface input, CameraCaptureSession.StateCallback callback, Executor stateExecutor, CameraDeviceImpl deviceImpl, Executor deviceStateExecutor, boolean configureSuccess) {
        ...
        if (callback != null) {
            ...
            this.mSequenceDrainer = new TaskDrainer<>(executor2, new SequenceDrainListener(this, null), "seq");
            this.mIdleDrainer = new TaskSingleDrainer(executor2, new IdleDrainListener(this, null), "idle");
            this.mAbortDrainer = new TaskSingleDrainer(executor2, new AbortDrainListener(this, null), "abort");
            if (configureSuccess) {
    ...
    public void close() {
        synchronized (this.mDeviceImpl.mInterfaceLock) {
            ...
            try {
                this.mDeviceImpl.stopRepeating();
                this.mDeviceImpl.triggerDeviceClose();
                ...
                try {
                    ...
                    executor.execute(new Runnable() { // from class: android.hardware.camera2.impl.CameraCaptureSessionImpl$1$$ExternalSyntheticLambda2
                        ...
                        public final void run() {
                            CameraCaptureSessionImpl.AnonymousClass1.this.lambda$onCaptureStarted$0$CameraCaptureSessionImpl$1(captureCallback, request, timestamp, frameNumber);
                        }
                    });
                } finally {
            ...
            if (this.val$callback != null && this.val$executor != null) {
                ...
                try {
                    ...
                    executor.execute(new Runnable() { // from class: android.hardware.camera2.impl.CameraCaptureSessionImpl$1$$ExternalSyntheticLambda4
                        @Override // java.lang.Runnable
                        public final void run() {
                            CameraCaptureSessionImpl.AnonymousClass1.this.lambda$onCapturePartial$1$CameraCaptureSessionImpl$1(captureCallback, request, result);
                        }
                    });
                } finally {
                    Binder.restoreCallingIdentity(ident);
            ...
            if (this.val$callback != null && this.val$executor != null) {
                ...
                try {
                    ...
                    executor.execute(new Runnable() { // from class: android.hardware.camera2.impl.CameraCaptureSessionImpl$1$$ExternalSyntheticLambda5
                        @Override // java.lang.Runnable
                        public final void run() {
                            CameraCaptureSessionImpl.AnonymousClass1.this.lambda$onCaptureProgressed$2$CameraCaptureSessionImpl$1(captureCallback, request, partialResult);
                        }
                    });
                } finally {
                    Binder.restoreCallingIdentity(ident);
            ...
            if (this.val$callback != null && this.val$executor != null) {
                ...
                try {
                    ...
                    executor.execute(new Runnable() { // from class: android.hardware.camera2.impl.CameraCaptureSessionImpl$1$$ExternalSyntheticLambda6
                        @Override // java.lang.Runnable
                        public final void run() {
                            CameraCaptureSessionImpl.AnonymousClass1.this.lambda$onCaptureCompleted$3$CameraCaptureSessionImpl$1(captureCallback, request, result);
                        }
                    });
                } finally {
                    Binder.restoreCallingIdentity(ident);
            ...
            if (this.val$callback != null && this.val$executor != null) {
                ...
                try {
                    ...
                    executor.execute(new Runnable() { // from class: android.hardware.camera2.impl.CameraCaptureSessionImpl$1$$ExternalSyntheticLambda3
                        @Override // java.lang.Runnable
                        public final void run() {
                            CameraCaptureSessionImpl.AnonymousClass1.this.lambda$onCaptureFailed$4$CameraCaptureSessionImpl$1(captureCallback, request, failure);
                        }
                    });
                } finally {
                    Binder.restoreCallingIdentity(ident);
            ...
            if (this.val$callback != null && this.val$executor != null) {
                ...
                try {
                    ...
                    executor.execute(new Runnable() { // from class: android.hardware.camera2.impl.CameraCaptureSessionImpl$1$$ExternalSyntheticLambda1
                        @Override // java.lang.Runnable
                        public final void run() {
                            CameraCaptureSessionImpl.AnonymousClass1.this.lambda$onCaptureSequenceCompleted$5$CameraCaptureSessionImpl$1(captureCallback, sequenceId, frameNumber);
                        }
                    });
                } finally {
                    Binder.restoreCallingIdentity(ident);
            ...
            if (this.val$callback != null && this.val$executor != null) {
                ...
                try {
                    ...
                    executor.execute(new Runnable() { // from class: android.hardware.camera2.impl.CameraCaptureSessionImpl$1$$ExternalSyntheticLambda0
                        @Override // java.lang.Runnable
                        public final void run() {
                            CameraCaptureSessionImpl.AnonymousClass1.this.lambda$onCaptureSequenceAborted$6$CameraCaptureSessionImpl$1(captureCallback, sequenceId);
                        }
                    });
                } finally {
                    Binder.restoreCallingIdentity(ident);
            ...
            if (this.val$callback != null && this.val$executor != null) {
                ...
                try {
                    ...
                    executor.execute(new Runnable() { // from class: android.hardware.camera2.impl.CameraCaptureSessionImpl$1$$ExternalSyntheticLambda7
                        @Override // java.lang.Runnable
                        public final void run() {
                            CameraCaptureSessionImpl.AnonymousClass1.this.lambda$onCaptureBufferLost$7$CameraCaptureSessionImpl$1(captureCallback, request, target, frameNumber);
                        }
                    });
                } finally {
                    Binder.restoreCallingIdentity(ident);
