...
public class CameraOfflineSessionImpl extends CameraOfflineSession implements IBinder.DeathRecipient {
    ...
    public class CameraDeviceCallbacks extends ICameraDeviceCallbacks.Stub {
        ...
        private void onCaptureErrorLocked(int errorCode, CaptureResultExtras resultExtras) {
            ...
            if (errorCode == 5) {
                OutputConfiguration config = (CameraOfflineSessionImpl.this.mRemoteSession != null || CameraOfflineSessionImpl.this.isClosed()) ? (OutputConfiguration) CameraOfflineSessionImpl.this.mOfflineOutputs.get(resultExtras.getErrorStreamId()) : (OutputConfiguration) CameraOfflineSessionImpl.this.mConfiguredOutputs.get(resultExtras.getErrorStreamId());
                if (config == null) {
    ...
    /* JADX WARN: Unsupported multi-entry loop pattern (BACK_EDGE: B:44:? -> B:41:0x00cd). Please submit an issue!!! */
