...
public class MarshalQueryablePair<T1, T2> implements MarshalQueryable<Pair<T1, T2>> {
    ...
    private class MarshalerPair extends Marshaler<Pair<T1, T2>> {
        ...
        public Pair<T1, T2> mo1207unmarshal(ByteBuffer buffer) {
            T1 first = this.mNestedTypeMarshalerFirst.mo1207unmarshal(buffer);
            T2 second = this.mNestedTypeMarshalerSecond.mo1207unmarshal(buffer);
            try {
