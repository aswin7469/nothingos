...
public class MarshalQueryableRange<T extends Comparable<? super T>> implements MarshalQueryable<Range<T>> {
    ...
    private class MarshalerRange extends Marshaler<Range<T>> {
        ...
        public Range<T> mo1207unmarshal(ByteBuffer buffer) {
            T lower = this.mNestedTypeMarshaler.mo1207unmarshal(buffer);
            T upper = this.mNestedTypeMarshaler.mo1207unmarshal(buffer);
            try {
