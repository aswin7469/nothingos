...
public interface ICasListener extends android.hardware.cas.V1_1.ICasListener {
    ...
    public static final class Proxy implements ICasListener {
        ...
        @Override // android.hardware.cas.V1_2.ICasListener, android.hardware.cas.V1_1.ICasListener, android.hardware.cas.V1_0.ICasListener, android.internal.hidl.base.V1_0.IBase, android.os.IHwInterface
    ...
    public static abstract class Stub extends HwBinder implements ICasListener {
        ...
        public final ArrayList<byte[]> getHashChain() {
            return new ArrayList<>(Arrays.asList(new byte[]{-104, 17, -8, 103, -34, -12, -101, 66, IGnssVisibilityControlCallback.NfwRequestor.OTHER_CHIPSET_VENDOR, -116, 112, Byte.MAX_VALUE, 126, 56, -45, -67, -42, 79, -125, 82, 68, -31, -46, -91, -23, 118, 42, -71, -125, 86, 114, -36}, new byte[]{37, 1, 45, 23, 120, -9, 57, 111, -106, 123, -68, 2, 49, 57, 125, 84, 75, -34, 66, GsmAlphabet.GSM_EXTENDED_ESCAPE, -91, -71, -121, 6, -55, -28, -118, -57, MidiConstants.STATUS_NOTE_ON, 97, 38, -125}, new byte[]{-72, BluetoothHidDevice.ERROR_RSP_UNKNOWN, IGnssVisibilityControlCallback.NfwRequestor.AUTOMOBILE_CLIENT, 86, -72, 31, Byte.MIN_VALUE, 3, 45, IGnssVisibilityControlCallback.NfwRequestor.OTHER_CHIPSET_VENDOR, -25, -53, 69, 101, 42, -63, 90, MidiConstants.STATUS_MIDI_TIME_CODE, 30, 116, 116, -43, 32, -41, 87, 72, 30, -54, -83, 121, 109, -1}, new byte[]{-20, Byte.MAX_VALUE, -41, -98, MidiConstants.STATUS_CHANNEL_PRESSURE, 45, -6, -123, -68, 73, -108, 38, -83, -82, 62, -66, 35, -17, 5, 36, MidiConstants.STATUS_SONG_SELECT, -51, 105, 87, 19, -109, 36, -72, 59, 24, -54, 76}));
        }
