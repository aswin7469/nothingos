...
public interface IMediaCasService extends android.hardware.cas.V1_1.IMediaCasService {
    ...
    public static final class Proxy implements IMediaCasService {
        ...
        public android.hardware.cas.V1_1.ICas createPluginExt(int caSystemId, android.hardware.cas.V1_1.ICasListener listener) throws RemoteException {
            HwParcel _hidl_request = new HwParcel();
            _hidl_request.writeInterfaceToken(android.hardware.cas.V1_1.IMediaCasService.kInterfaceName);
            ...
            try {
                ...
                _hidl_reply.verifySuccess();
                _hidl_request.releaseTemporaryStorage();
                android.hardware.cas.V1_1.ICas _hidl_out_cas = android.hardware.cas.V1_1.ICas.asInterface(_hidl_reply.readStrongBinder());
                return _hidl_out_cas;
            } finally {
                _hidl_reply.release();
            }
    ...
    public static abstract class Stub extends HwBinder implements IMediaCasService {
        ...
        public final ArrayList<byte[]> getHashChain() {
            return new ArrayList<>(Arrays.asList(new byte[]{MidiConstants.STATUS_MIDI_TIME_CODE, -122, -107, -35, 54, -18, 32, 86, 64, -72, QosProtocol.ESP, 106, 23, 69, 56, 88, -89, -76, 89, 102, 83, -86, -90, -17, 0, 22, MidiConstants.STATUS_CONTROL_CHANGE, -82, MidiConstants.STATUS_MIDI_TIME_CODE, -67, 77, -84}, new byte[]{-33, -6, -51, -66, 11, -49, -124, 67, 1, 61, -27, -67, -59, 106, -125, 71, -102, -39, 121, -44, -111, -98, -47, 90, 85, -123, 83, -97, 70, 9, 31, 7}, new byte[]{-122, -70, -100, 3, -105, -117, 121, -89, 66, -23, MidiConstants.STATUS_NOTE_ON, 66, 11, -59, -50, MidiConstants.STATUS_CHANNEL_PRESSURE, 103, 61, 37, -87, 57, -8, 37, 114, -103, 107, -17, -110, 98, 30, 32, IGnssVisibilityControlCallback.NfwRequestor.AUTOMOBILE_CLIENT}, new byte[]{-20, Byte.MAX_VALUE, -41, -98, MidiConstants.STATUS_CHANNEL_PRESSURE, 45, -6, -123, -68, 73, -108, 38, -83, -82, 62, -66, 35, -17, 5, 36, MidiConstants.STATUS_SONG_SELECT, -51, 105, 87, 19, -109, 36, -72, 59, 24, -54, 76}));
        }
        ...
        public void onTransact(int _hidl_code, HwParcel _hidl_request, HwParcel _hidl_reply, int _hidl_flags) throws RemoteException {
            ...
            switch (_hidl_code) {
                ...
                case 5:
                    ...
                    return;
                case 6:
                    _hidl_request.enforceInterface(android.hardware.cas.V1_1.IMediaCasService.kInterfaceName);
                    int caSystemId = _hidl_request.readInt32();
                    android.hardware.cas.V1_1.ICasListener listener2 = android.hardware.cas.V1_1.ICasListener.asInterface(_hidl_request.readStrongBinder());
                    android.hardware.cas.V1_1.ICas _hidl_out_cas2 = createPluginExt(caSystemId, listener2);
                    _hidl_reply.writeStatus(0);
