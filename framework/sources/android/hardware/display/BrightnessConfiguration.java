...
public final class BrightnessConfiguration implements Parcelable {
    ...
    public static final Parcelable.Creator<BrightnessConfiguration> CREATOR = new Parcelable.Creator<BrightnessConfiguration>() { // from class: android.hardware.display.BrightnessConfiguration.1
        ...
        public BrightnessConfiguration mo3559createFromParcel(Parcel in) {
            ...
            for (int i = 0; i < n; i++) {
                ...
                BrightnessCorrection correction = BrightnessCorrection.CREATOR.mo3559createFromParcel(in);
                builder.addCorrectionByPackageName(packageName, correction);
            }
            int n2 = in.readInt();
            for (int i2 = 0; i2 < n2; i2++) {
                int category = in.readInt();
                BrightnessCorrection correction2 = BrightnessCorrection.CREATOR.mo3559createFromParcel(in);
        ...
        public BrightnessConfiguration[] mo3560newArray(int size) {
