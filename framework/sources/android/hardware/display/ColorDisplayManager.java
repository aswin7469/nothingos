...
public final class ColorDisplayManager {
    ...
    public static class ColorDisplayManagerInternal {
        ...
        boolean setDisplayWhiteBalanceColorTemperature(int temperature) {
            try {
                return this.mCdm.setDisplayWhiteBalanceColorTemperature(temperature);
            } catch (RemoteException e) {
                throw e.rethrowFromSystemServer();
            }
        }

        void applyNightDisplayImmediate(boolean activate) {
            try {
                this.mCdm.applyNightDisplayImmediate(activate);
            } catch (RemoteException e) {
                throw e.rethrowFromSystemServer();
            }
        }
    ...
    public boolean setDisplayWhiteBalanceColorTemperature(int temperature) {
        return this.mManager.setDisplayWhiteBalanceColorTemperature(temperature);
    }

    public void applyNightDisplayImmediate(boolean activate) {
        this.mManager.applyNightDisplayImmediate(activate);
    }
}
