...
public interface IColorDisplayManager extends IInterface {
    ...
    void applyNightDisplayImmediate(boolean z) throws RemoteException;
    ...
    boolean setDisplayWhiteBalanceColorTemperature(int i) throws RemoteException;
    ...
    public static class Default implements IColorDisplayManager {
        ...
        @Override // android.hardware.display.IColorDisplayManager
        public boolean setDisplayWhiteBalanceColorTemperature(int temperature) throws RemoteException {
            return false;
        }

        @Override // android.hardware.display.IColorDisplayManager
        public void applyNightDisplayImmediate(boolean activate) throws RemoteException {
        }
    ...
    public static abstract class Stub extends Binder implements IColorDisplayManager {
        static final int TRANSACTION_applyNightDisplayImmediate = 27;
        ...
        static final int TRANSACTION_setDisplayWhiteBalanceColorTemperature = 26;
        ...
        public static String getDefaultTransactionName(int transactionCode) {
            switch (transactionCode) {
                ...
                case 26:
                    return "setDisplayWhiteBalanceColorTemperature";
                case 27:
                    return "applyNightDisplayImmediate";
                default:
                    return null;
            }
        }
                ...
                default:
                    ...
                    switch (code) {
                        ...
                        case 14:
                            data.enforceInterface(IColorDisplayManager.DESCRIPTOR);
                            if (data.readInt() != 0) {
                                _arg0 = Time.CREATOR.mo3559createFromParcel(data);
                            } else {
                                _arg0 = null;
                            }
                        ...
                        case 16:
                            data.enforceInterface(IColorDisplayManager.DESCRIPTOR);
                            if (data.readInt() != 0) {
                                _arg02 = Time.CREATOR.mo3559createFromParcel(data);
                            } else {
                                _arg02 = null;
                            }
                        ...
                        case 26:
                            data.enforceInterface(IColorDisplayManager.DESCRIPTOR);
                            boolean displayWhiteBalanceColorTemperature = setDisplayWhiteBalanceColorTemperature(data.readInt());
                            reply.writeNoException();
                            reply.writeInt(displayWhiteBalanceColorTemperature ? 1 : 0);
                            return true;
                        case 27:
                            data.enforceInterface(IColorDisplayManager.DESCRIPTOR);
                            if (data.readInt() != 0) {
                            ...
                            applyNightDisplayImmediate(_arg03);
                            reply.writeNoException();
                            return true;
                        default:
        ...
        public static class Proxy implements IColorDisplayManager {
            ...
            public Time getNightDisplayCustomStartTime() throws RemoteException {
                ...
                try {
                    ...
                    _reply.readException();
                    if (_reply.readInt() != 0) {
                        _result = Time.CREATOR.mo3559createFromParcel(_reply);
                    } else {
                        _result = null;
                    }
                    return _result;
            ...
            public boolean setDisplayWhiteBalanceColorTemperature(int temperature) throws RemoteException {
                ...
                try {
                    ...
                    if (!_status && Stub.getDefaultImpl() != null) {
                        return Stub.getDefaultImpl().setDisplayWhiteBalanceColorTemperature(temperature);
                    }
                    _reply.readException();
                    if (_reply.readInt() != 0) {
                        z = true;
            ...
            public void applyNightDisplayImmediate(boolean activate) throws RemoteException {
                ...
                try {
                    ...
                    if (!_status && Stub.getDefaultImpl() != null) {
                        Stub.getDefaultImpl().applyNightDisplayImmediate(activate);
                    } else {
                        _reply.readException();
                    }
                } finally {
