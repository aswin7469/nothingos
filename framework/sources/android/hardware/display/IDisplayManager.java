                ...
                default:
                    ...
                    switch (code) {
                        ...
                        case 20:
                            data.enforceInterface(DESCRIPTOR);
                            if (data.readInt() != 0) {
                                _arg0 = VirtualDisplayConfig.CREATOR.mo3559createFromParcel(data);
                            } else {
                                _arg0 = null;
                            }
                        ...
                        case 28:
                            data.enforceInterface(DESCRIPTOR);
                            if (data.readInt() != 0) {
                                _arg02 = BrightnessConfiguration.CREATOR.mo3559createFromParcel(data);
                            } else {
                                _arg02 = null;
                            }
        ...
        public static class Proxy implements IDisplayManager {
            ...
            public DisplayInfo getDisplayInfo(int displayId) throws RemoteException {
                ...
                try {
                    ...
                    if (_reply.readInt() != 0) {
                        _result = DisplayInfo.CREATOR.mo3559createFromParcel(_reply);
                    } else {
                        _result = null;
                    }
                    return _result;
            ...
            public WifiDisplayStatus getWifiDisplayStatus() throws RemoteException {
                ...
                try {
                    ...
                    _reply.readException();
                    if (_reply.readInt() != 0) {
                        _result = WifiDisplayStatus.CREATOR.mo3559createFromParcel(_reply);
                    } else {
                        _result = null;
                    }
                    return _result;
            ...
            public BrightnessConfiguration getBrightnessConfigurationForUser(int userId) throws RemoteException {
                ...
                try {
                    ...
                    _reply.readException();
                    if (_reply.readInt() != 0) {
                        _result = BrightnessConfiguration.CREATOR.mo3559createFromParcel(_reply);
                    } else {
                        _result = null;
                    }
                    return _result;
            ...
            public Curve getMinimumBrightnessCurve() throws RemoteException {
                ...
                try {
                    ...
                    _reply.readException();
                    if (_reply.readInt() != 0) {
                        _result = Curve.CREATOR.mo3559createFromParcel(_reply);
                    } else {
                        _result = null;
                    }
                    return _result;
            ...
            public BrightnessInfo getBrightnessInfo(int displayId) throws RemoteException {
                ...
                try {
                    ...
                    _reply.readException();
                    if (_reply.readInt() != 0) {
                        _result = BrightnessInfo.CREATOR.mo3559createFromParcel(_reply);
                    } else {
                        _result = null;
                    }
                    return _result;
