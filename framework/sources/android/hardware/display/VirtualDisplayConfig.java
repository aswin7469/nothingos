...
public final class VirtualDisplayConfig implements Parcelable {
    public static final Parcelable.Creator<VirtualDisplayConfig> CREATOR = new Parcelable.Creator<VirtualDisplayConfig>() { // from class: android.hardware.display.VirtualDisplayConfig.1
        ...
        public VirtualDisplayConfig[] mo3560newArray(int size) {
        ...
        public VirtualDisplayConfig mo3559createFromParcel(Parcel in) {
    ...
    VirtualDisplayConfig(String name, int width, int height, int densityDpi, int flags, Surface surface, String uniqueId, int displayIdToMirror) {
        this.mFlags = 0;
        this.mSurface = null;
        this.mUniqueId = null;
    ...
    public static final class Builder {
        ...
        public VirtualDisplayConfig build() {
            ...
            VirtualDisplayConfig o = new VirtualDisplayConfig(this.mName, this.mWidth, this.mHeight, this.mDensityDpi, this.mFlags, this.mSurface, this.mUniqueId, this.mDisplayIdToMirror);
            return o;
        }
