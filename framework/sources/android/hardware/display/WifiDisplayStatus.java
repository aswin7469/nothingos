...
public final class WifiDisplayStatus implements Parcelable {
    public static final Parcelable.Creator<WifiDisplayStatus> CREATOR = new Parcelable.Creator<WifiDisplayStatus>() { // from class: android.hardware.display.WifiDisplayStatus.1
        ...
        public WifiDisplayStatus mo3559createFromParcel(Parcel in) {
            ...
            if (in.readInt() == 0) {
                ...
                WifiDisplay activeDisplay2 = WifiDisplay.CREATOR.mo3559createFromParcel(in);
                activeDisplay = activeDisplay2;
            }
            WifiDisplay[] displays = WifiDisplay.CREATOR.mo3560newArray(in.readInt());
            for (int i = 0; i < displays.length; i++) {
                displays[i] = WifiDisplay.CREATOR.mo3559createFromParcel(in);
            }
            WifiDisplaySessionInfo sessionInfo = WifiDisplaySessionInfo.CREATOR.mo3559createFromParcel(in);
        ...
        public WifiDisplayStatus[] mo3560newArray(int size) {
