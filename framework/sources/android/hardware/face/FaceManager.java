        ...
        try {
            if (this.mService != null) {
                try {
                    ...
                    this.mService.enroll(userId, this.mToken, hardwareAuthToken, this.mServiceReceiver, this.mContext.getOpPackageName(), disabledFeatures, previewSurface, debugConsent);
                } catch (RemoteException e) {
        ...
        try {
            if (this.mService != null) {
                try {
                    ...
                    this.mService.enrollRemotely(userId, this.mToken, hardwareAuthToken, this.mServiceReceiver, this.mContext.getOpPackageName(), disabledFeatures);
                } catch (RemoteException e) {
        ...
        public void handleMessage(Message msg) {
            ...
            switch (msg.what) {
                ...
                case 102:
                    ...
                    faceManager.sendAuthenticatedSucceeded(face, i, z);
                    break;
                case 103:
