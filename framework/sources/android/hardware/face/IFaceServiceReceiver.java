                ...
                default:
                    ...
                    switch (code) {
                        case 1:
                            ...
                            if (data.readInt() != 0) {
                                _arg0 = Face.CREATOR.mo3559createFromParcel(data);
                            } else {
                                _arg0 = null;
                            }
                        ...
                        case 3:
                            data.enforceInterface(IFaceServiceReceiver.DESCRIPTOR);
                            if (data.readInt() != 0) {
                                _arg02 = Face.CREATOR.mo3559createFromParcel(data);
                            } else {
                                _arg02 = null;
                            }
                        ...
                        case 7:
                            data.enforceInterface(IFaceServiceReceiver.DESCRIPTOR);
                            if (data.readInt() != 0) {
                                _arg03 = Face.CREATOR.mo3559createFromParcel(data);
                            } else {
                                _arg03 = null;
                            }
                        ...
                        case 11:
                            data.enforceInterface(IFaceServiceReceiver.DESCRIPTOR);
                            if (data.readInt() != 0) {
                                _arg04 = FaceAuthenticationFrame.CREATOR.mo3559createFromParcel(data);
                            } else {
                                _arg04 = null;
                            }
                        ...
                        case 12:
                            data.enforceInterface(IFaceServiceReceiver.DESCRIPTOR);
                            if (data.readInt() != 0) {
                                _arg05 = FaceEnrollFrame.CREATOR.mo3559createFromParcel(data);
                            } else {
                                _arg05 = null;
                            }
