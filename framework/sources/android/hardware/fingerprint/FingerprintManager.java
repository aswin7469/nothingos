...
public class FingerprintManager implements BiometricAuthenticator, BiometricFingerprintConstants {
        ...
        if (callback != null) {
            if (cancel != null && cancel.isCanceled()) {
                ...
                try {
                    ...
                    long authId = this.mService.authenticate(this.mToken, operationId, sensorId, userId, this.mServiceReceiver, this.mContext.getOpPackageName());
                    if (cancel != null) {
    ...
    public void sendAcquiredResult(int acquireInfo, int vendorCode) {
        ...
        if (enrollmentCallback != null) {
            ...
            this.mAuthenticationCallback.onAuthenticationHelp(clientInfo, shortMsg);
        }
    }
    ...
    public void cancelAuthentication(long requestId) {
        ...
        if (iFingerprintService != null) {
            try {
                iFingerprintService.cancelAuthentication(this.mToken, this.mContext.getOpPackageName(), requestId);
            } catch (RemoteException e) {
                throw e.rethrowFromSystemServer();
            }
        }
    ...
    public static String getAcquiredString(Context context, int acquireInfo, int vendorCode) {
        switch (acquireInfo) {
            ...
            case 6:
                String[] msgArray = context.getResources().getStringArray(R.array.nt_fingerprint_acquired_vendor);
                int msgIndex = vendorCode - 1;
