...
public interface IFingerprintService extends IInterface {
    ...
    long authenticate(IBinder iBinder, long j, int i, int i2, IFingerprintServiceReceiver iFingerprintServiceReceiver, String str) throws RemoteException;
    ...
    public static class Default implements IFingerprintService {
        ...
        @Override // android.hardware.fingerprint.IFingerprintService
        public long authenticate(IBinder token, long operationId, int sensorId, int userId, IFingerprintServiceReceiver receiver, String opPackageName) throws RemoteException {
            return 0L;
        }
    ...
    public static abstract class Stub extends Binder implements IFingerprintService {
        ...
        static final int TRANSACTION_registerFingerprintStateListener = 39;
                ...
                default:
                    switch (code) {
                        ...
                        case 7:
                            ...
                            prepareForAuthentication(_arg07, _arg16, _arg24, _arg33, _arg42, _arg52, _arg6, _arg7, _arg8);
                            reply.writeNoException();
                            return true;
                        case 8:
                            data.enforceInterface(DESCRIPTOR);
                        ...
                        case 12:
                            ...
                            enroll(_arg012, _arg111, _arg28, _arg35, _arg43, _arg53);
                            reply.writeNoException();
                            return true;
                        case 13:
                            data.enforceInterface(DESCRIPTOR);
                        ...
                        case 14:
                            ...
                            remove(_arg014, _arg112, _arg29, _arg36, _arg44);
                            reply.writeNoException();
                            return true;
                        case 15:
                            data.enforceInterface(DESCRIPTOR);
                            ...
                            removeAll(_arg015, _arg113, _arg210, _arg37);
                            reply.writeNoException();
                            return true;
                        case 16:
                            data.enforceInterface(DESCRIPTOR);
                            ...
                            rename(_arg016, _arg114, _arg211);
                            reply.writeNoException();
                            return true;
                        case 17:
                            data.enforceInterface(DESCRIPTOR);
                            ...
                            List<Fingerprint> _result7 = getEnrolledFingerprints(_arg017, _arg115);
                            reply.writeNoException();
                        ...
                        case 20:
                            ...
                            generateChallenge(_arg020, _arg117, _arg212, _arg38, _arg45);
                            reply.writeNoException();
                            return true;
                        case 21:
                            data.enforceInterface(DESCRIPTOR);
                            ...
                            revokeChallenge(_arg021, _arg118, _arg213, _arg39, _arg46);
                            reply.writeNoException();
                            return true;
                        case 22:
                            data.enforceInterface(DESCRIPTOR);
                        ...
                        case 23:
                            ...
                            boolean hasEnrolledFingerprints = hasEnrolledFingerprints(_arg023, _arg120, _arg214);
                            reply.writeNoException();
                        ...
                        case 24:
                            ...
                            int _result8 = getLockoutModeForUser(_arg024, _arg121);
                            reply.writeNoException();
                        ...
                        case 25:
                            ...
                            IInvalidationCallback _arg215 = IInvalidationCallback.Stub.asInterface(data.readStrongBinder());
                            invalidateAuthenticatorId(_arg025, _arg122, _arg215);
                            reply.writeNoException();
                            return true;
                        case 26:
                            data.enforceInterface(DESCRIPTOR);
                            ...
                            long _result9 = getAuthenticatorId(_arg026, _arg123);
                            reply.writeNoException();
                        ...
                        case 27:
                            ...
                            resetLockout(_arg027, _arg124, _arg216, _arg310, _arg47);
                            reply.writeNoException();
                            return true;
                        case 28:
                            data.enforceInterface(DESCRIPTOR);
                            ...
                            addLockoutResetCallback(_arg028, _arg125);
                            reply.writeNoException();
                            return true;
                        case 29:
                            data.enforceInterface(DESCRIPTOR);
                        ...
                        case 34:
                            ...
                            onPointerDown(_arg033, _arg126, _arg217, _arg311, _arg48);
                            reply.writeNoException();
                            return true;
                        case 35:
                            data.enforceInterface(DESCRIPTOR);
                        ...
                        case 39:
                            data.enforceInterface(DESCRIPTOR);
                            IFingerprintStateListener _arg038 = IFingerprintStateListener.Stub.asInterface(data.readStrongBinder());
                            registerFingerprintStateListener(_arg038);
                            reply.writeNoException();
                            return true;
                        default:
        ...
        public static class Proxy implements IFingerprintService {
            ...
            public FingerprintSensorPropertiesInternal getSensorProperties(int sensorId, String opPackageName) throws RemoteException {
                ...
                try {
                    ...
                    _reply.readException();
                    if (_reply.readInt() != 0) {
                        _result = FingerprintSensorPropertiesInternal.CREATOR.mo3559createFromParcel(_reply);
                    } else {
                        _result = null;
                    }
                    return _result;
            ...
            public long authenticate(IBinder token, long operationId, int sensorId, int userId, IFingerprintServiceReceiver receiver, String opPackageName) throws RemoteException {
                ...
                try {
                    ...
                    try {
                        ...
                        if (!_status && Stub.getDefaultImpl() != null) {
                            long authenticate = Stub.getDefaultImpl().authenticate(token, operationId, sensorId, userId, receiver, opPackageName);
                            _reply.recycle();
                            _data.recycle();
                            return authenticate;
                        }
            ...
            public long detectFingerprint(IBinder token, int userId, IFingerprintServiceReceiver receiver, String opPackageName) throws RemoteException {
                ...
                try {
                    ...
                    if (!_status && Stub.getDefaultImpl() != null) {
                        return Stub.getDefaultImpl().detectFingerprint(token, userId, receiver, opPackageName);
                    }
                    _reply.readException();
                    long _result = _reply.readLong();
                    return _result;
            ...
            public void prepareForAuthentication(int sensorId, IBinder token, long operationId, int userId, IBiometricSensorReceiver sensorReceiver, String opPackageName, long requestId, int cookie, boolean allowBackgroundAuthentication) throws RemoteException {
                ...
                try {
                    ...
                    try {
                        ...
                        if (!_status && Stub.getDefaultImpl() != null) {
                            Stub.getDefaultImpl().prepareForAuthentication(sensorId, token, operationId, userId, sensorReceiver, opPackageName, requestId, cookie, allowBackgroundAuthentication);
                            _reply.recycle();
                            _data.recycle();
                            return;
                        }
            ...
            public void cancelAuthentication(IBinder token, String opPackageName, long requestId) throws RemoteException {
                ...
                try {
                    ...
                    if (!_status && Stub.getDefaultImpl() != null) {
                        Stub.getDefaultImpl().cancelAuthentication(token, opPackageName, requestId);
                    } else {
                        _reply.readException();
                    }
                } finally {
            ...
            public void cancelFingerprintDetect(IBinder token, String opPackageName, long requestId) throws RemoteException {
                ...
                try {
                    ...
                    if (!_status && Stub.getDefaultImpl() != null) {
                        Stub.getDefaultImpl().cancelFingerprintDetect(token, opPackageName, requestId);
                    } else {
                        _reply.readException();
                    }
                } finally {
            ...
            public void cancelAuthenticationFromService(int sensorId, IBinder token, String opPackageName, long requestId) throws RemoteException {
                ...
                try {
                    ...
                    if (!_status && Stub.getDefaultImpl() != null) {
                        Stub.getDefaultImpl().cancelAuthenticationFromService(sensorId, token, opPackageName, requestId);
                    } else {
                        _reply.readException();
                    }
                } finally {
