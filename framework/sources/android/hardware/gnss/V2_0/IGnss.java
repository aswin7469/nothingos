...
public interface IGnss extends android.hardware.gnss.V1_1.IGnss {
    public static final String kInterfaceName = "android.hardware.gnss@2.0::IGnss";
    ...
    IAGnssRil getExtensionAGnssRil_2_0() throws RemoteException;

    IAGnss getExtensionAGnss_2_0() throws RemoteException;

    IGnssBatching getExtensionGnssBatching_2_0() throws RemoteException;

    IGnssConfiguration getExtensionGnssConfiguration_2_0() throws RemoteException;

    IGnssDebug getExtensionGnssDebug_2_0() throws RemoteException;

    IGnssMeasurement getExtensionGnssMeasurement_2_0() throws RemoteException;

    IMeasurementCorrections getExtensionMeasurementCorrections() throws RemoteException;

    IGnssVisibilityControl getExtensionVisibilityControl() throws RemoteException;

    @Override // android.hardware.gnss.V1_1.IGnss, android.hardware.gnss.V1_0.IGnss, android.internal.hidl.base.V1_0.IBase
    ArrayList<byte[]> getHashChain() throws RemoteException;

    boolean injectBestLocation_2_0(GnssLocation gnssLocation) throws RemoteException;
    ...
    boolean setCallback_2_0(IGnssCallback iGnssCallback) throws RemoteException;
    ...
    public static final class Proxy implements IGnss {
        ...
        @Override // android.hardware.gnss.V1_0.IGnss
        public android.hardware.gnss.V1_0.IAGnssRil getExtensionAGnssRil() throws RemoteException {
            HwParcel _hidl_request = new HwParcel();
            _hidl_request.writeInterfaceToken(android.hardware.gnss.V1_0.IGnss.kInterfaceName);
            HwParcel _hidl_reply = new HwParcel();
            try {
        ...
        @Override // android.hardware.gnss.V1_0.IGnss
        public android.hardware.gnss.V1_0.IAGnss getExtensionAGnss() throws RemoteException {
            HwParcel _hidl_request = new HwParcel();
            _hidl_request.writeInterfaceToken(android.hardware.gnss.V1_0.IGnss.kInterfaceName);
            HwParcel _hidl_reply = new HwParcel();
            try {
        ...
        @Override // android.hardware.gnss.V1_0.IGnss
        public android.hardware.gnss.V1_0.IGnssDebug getExtensionGnssDebug() throws RemoteException {
            HwParcel _hidl_request = new HwParcel();
            _hidl_request.writeInterfaceToken(android.hardware.gnss.V1_0.IGnss.kInterfaceName);
            HwParcel _hidl_reply = new HwParcel();
            try {
        ...
        @Override // android.hardware.gnss.V1_0.IGnss
        public android.hardware.gnss.V1_0.IGnssBatching getExtensionGnssBatching() throws RemoteException {
            HwParcel _hidl_request = new HwParcel();
            _hidl_request.writeInterfaceToken(android.hardware.gnss.V1_0.IGnss.kInterfaceName);
            HwParcel _hidl_reply = new HwParcel();
            try {
        ...
        @Override // android.hardware.gnss.V1_1.IGnss
        public boolean injectBestLocation(android.hardware.gnss.V1_0.GnssLocation location) throws RemoteException {
            HwParcel _hidl_request = new HwParcel();
            _hidl_request.writeInterfaceToken(android.hardware.gnss.V1_1.IGnss.kInterfaceName);
        ...
        public boolean setCallback_2_0(IGnssCallback callback) throws RemoteException {
            HwParcel _hidl_request = new HwParcel();
        ...
        public IGnssDebug getExtensionGnssDebug_2_0() throws RemoteException {
            ...
            try {
                ...
                _hidl_reply.verifySuccess();
                _hidl_request.releaseTemporaryStorage();
                IGnssDebug _hidl_out_gnssDebugIface = IGnssDebug.asInterface(_hidl_reply.readStrongBinder());
        ...
        @Override // android.hardware.gnss.V2_0.IGnss
        public boolean injectBestLocation_2_0(GnssLocation location) throws RemoteException {
            HwParcel _hidl_request = new HwParcel();
            _hidl_request.writeInterfaceToken(IGnss.kInterfaceName);
            location.writeToParcel(_hidl_request);
            HwParcel _hidl_reply = new HwParcel();
    ...
    public static abstract class Stub extends HwBinder implements IGnss {
        ...
        public final ArrayList<String> interfaceChain() {
            return new ArrayList<>(Arrays.asList(IGnss.kInterfaceName, android.hardware.gnss.V1_1.IGnss.kInterfaceName, android.hardware.gnss.V1_0.IGnss.kInterfaceName, IBase.kInterfaceName));
        }
        ...
        public final ArrayList<byte[]> getHashChain() {
            return new ArrayList<>(Arrays.asList(new byte[]{-11, 96, 95, 72, -62, -5, -97, 35, 22, 21, -35, -109, 43, -9, 48, -82, -107, 64, -12, -7, -117, 91, 122, -30, -78, 105, -105, 95, 69, 47, 109, 115}, new byte[]{-75, MidiConstants.STATUS_MIDI_TIME_CODE, -12, -63, -67, 109, -25, 26, -114, 113, -41, MidiConstants.STATUS_CHANNEL_MASK, 87, -51, -85, MidiConstants.STATUS_NOTE_ON, 74, -64, 36, -95, 47, 61, -18, 62, 33, 115, 119, 10, 69, -125, -68, -62}, new byte[]{-19, -26, -105, 16, -61, -87, 92, 44, -66, -127, -114, 108, -117, -73, 44, 120, 22, -126, QosFlowIdRange.MAX, -84, -27, -4, 33, -63, 119, 49, -78, 111, 65, -39, 77, 101}, new byte[]{-20, Byte.MAX_VALUE, -41, -98, MidiConstants.STATUS_CHANNEL_PRESSURE, 45, -6, -123, -68, 73, -108, 38, -83, -82, 62, -66, 35, -17, 5, 36, MidiConstants.STATUS_SONG_SELECT, -51, 105, 87, 19, -109, 36, -72, 59, 24, -54, 76}));
        }
        ...
        public void onTransact(int _hidl_code, HwParcel _hidl_request, HwParcel _hidl_reply, int _hidl_flags) throws RemoteException {
            ...
            switch (_hidl_code) {
                ...
                case 21:
                    ...
                    _hidl_reply.writeStatus(0);
                    if (_hidl_out_gnssConfigurationIface != null) {
                        iHwBinder = _hidl_out_gnssConfigurationIface.asBinder();
                    }
                    _hidl_reply.writeStrongBinder(iHwBinder);
                    _hidl_reply.send();
                    return;
                case 22:
                    ...
                    _hidl_reply.writeStatus(0);
                    if (_hidl_out_gnssMeasurementIface2 != null) {
                        iHwBinder = _hidl_out_gnssMeasurementIface2.asBinder();
                    }
                    _hidl_reply.writeStrongBinder(iHwBinder);
                    _hidl_reply.send();
                    return;
                ...
                case 24:
                    ...
                    IGnssCallback callback3 = IGnssCallback.asInterface(_hidl_request.readStrongBinder());
                ...
                case 25:
                    _hidl_request.enforceInterface(IGnss.kInterfaceName);
                    IGnssConfiguration _hidl_out_gnssConfigurationIface2 = getExtensionGnssConfiguration_2_0();
                    _hidl_reply.writeStatus(0);
                    if (_hidl_out_gnssConfigurationIface2 != null) {
                        iHwBinder = _hidl_out_gnssConfigurationIface2.asBinder();
                    }
                    _hidl_reply.writeStrongBinder(iHwBinder);
                    _hidl_reply.send();
                    return;
                case 26:
                    _hidl_request.enforceInterface(IGnss.kInterfaceName);
                    IGnssDebug _hidl_out_gnssDebugIface = getExtensionGnssDebug_2_0();
                    _hidl_reply.writeStatus(0);
                    if (_hidl_out_gnssDebugIface != null) {
                        iHwBinder = _hidl_out_gnssDebugIface.asBinder();
                    }
                    _hidl_reply.writeStrongBinder(iHwBinder);
                    _hidl_reply.send();
                    return;
                case 27:
                    _hidl_request.enforceInterface(IGnss.kInterfaceName);
                    IAGnss _hidl_out_aGnssIface2 = getExtensionAGnss_2_0();
                    _hidl_reply.writeStatus(0);
                    if (_hidl_out_aGnssIface2 != null) {
                        iHwBinder = _hidl_out_aGnssIface2.asBinder();
                    }
                    _hidl_reply.writeStrongBinder(iHwBinder);
                    _hidl_reply.send();
                    return;
                case 28:
                    _hidl_request.enforceInterface(IGnss.kInterfaceName);
                    IAGnssRil _hidl_out_aGnssRilIface2 = getExtensionAGnssRil_2_0();
                    _hidl_reply.writeStatus(0);
                    if (_hidl_out_aGnssRilIface2 != null) {
                        iHwBinder = _hidl_out_aGnssRilIface2.asBinder();
                    }
                    _hidl_reply.writeStrongBinder(iHwBinder);
                    _hidl_reply.send();
                    return;
                case 29:
                    _hidl_request.enforceInterface(IGnss.kInterfaceName);
                    IGnssMeasurement _hidl_out_gnssMeasurementIface3 = getExtensionGnssMeasurement_2_0();
                    _hidl_reply.writeStatus(0);
                    if (_hidl_out_gnssMeasurementIface3 != null) {
                        iHwBinder = _hidl_out_gnssMeasurementIface3.asBinder();
                    }
                    _hidl_reply.writeStrongBinder(iHwBinder);
                    _hidl_reply.send();
                    return;
                case 30:
                    _hidl_request.enforceInterface(IGnss.kInterfaceName);
                    IMeasurementCorrections _hidl_out_measurementCorrectionsIface = getExtensionMeasurementCorrections();
                    _hidl_reply.writeStatus(0);
                    if (_hidl_out_measurementCorrectionsIface != null) {
                        iHwBinder = _hidl_out_measurementCorrectionsIface.asBinder();
                    }
                    _hidl_reply.writeStrongBinder(iHwBinder);
                    _hidl_reply.send();
                    return;
                case 31:
                    ...
                    _hidl_reply.writeStatus(0);
                    if (_hidl_out_visibilityControlIface != null) {
                        iHwBinder = _hidl_out_visibilityControlIface.asBinder();
                    }
                    _hidl_reply.writeStrongBinder(iHwBinder);
                    _hidl_reply.send();
                    return;
                case 32:
                    _hidl_request.enforceInterface(IGnss.kInterfaceName);
                    IGnssBatching _hidl_out_batchingIface2 = getExtensionGnssBatching_2_0();
                    _hidl_reply.writeStatus(0);
                    if (_hidl_out_batchingIface2 != null) {
                        iHwBinder = _hidl_out_batchingIface2.asBinder();
                    }
                    _hidl_reply.writeStrongBinder(iHwBinder);
                    _hidl_reply.send();
                    return;
