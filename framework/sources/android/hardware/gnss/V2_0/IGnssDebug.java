...
public interface IGnssDebug extends android.hardware.gnss.V1_0.IGnssDebug {
    ...
    public static abstract class Stub extends HwBinder implements IGnssDebug {
        ...
        public final ArrayList<byte[]> getHashChain() {
            return new ArrayList<>(Arrays.asList(new byte[]{-74, 112, -70, -30, -85, -123, 23, QosProtocol.AH, 98, MidiConstants.STATUS_NOTE_ON, 83, 46, 54, 69, 2, -76, -37, -111, 32, 52, IGnssVisibilityControlCallback.NfwRequestor.OTHER_CHIPSET_VENDOR, 117, 71, 76, -52, -124, 66, -79, -79, 93, 106, -73}, new byte[]{69, 66, 18, 43, -106, -5, MidiConstants.STATUS_SONG_POSITION, 113, 1, -53, -126, 34, -70, -5, 118, -25, -56, MidiConstants.STATUS_CHANNEL_PRESSURE, QosProtocol.ESP, -39, 119, -35, 16, 88, -19, -40, -27, -120, 28, -91, 117, 47}, new byte[]{-20, Byte.MAX_VALUE, -41, -98, MidiConstants.STATUS_CHANNEL_PRESSURE, 45, -6, -123, -68, 73, -108, 38, -83, -82, 62, -66, 35, -17, 5, 36, MidiConstants.STATUS_SONG_SELECT, -51, 105, 87, 19, -109, 36, -72, 59, 24, -54, 76}));
        }
