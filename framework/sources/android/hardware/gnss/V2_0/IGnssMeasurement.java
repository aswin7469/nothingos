...
public interface IGnssMeasurement extends android.hardware.gnss.V1_1.IGnssMeasurement {
    ...
    public static final class Proxy implements IGnssMeasurement {
        ...
        public int setCallback_2_0(IGnssMeasurementCallback callback, boolean enableFullTracking) throws RemoteException {
            HwParcel _hidl_request = new HwParcel();
        ...
        public void onTransact(int _hidl_code, HwParcel _hidl_request, HwParcel _hidl_reply, int _hidl_flags) throws RemoteException {
            switch (_hidl_code) {
                ...
                case 4:
                    ...
                    IGnssMeasurementCallback callback3 = IGnssMeasurementCallback.asInterface(_hidl_request.readStrongBinder());
