...
public interface IGnss extends android.hardware.gnss.V2_0.IGnss {
    ...
    public static final class Proxy implements IGnss {
        ...
        @Override // android.hardware.gnss.V2_1.IGnss, android.hardware.gnss.V2_0.IGnss, android.hardware.gnss.V1_1.IGnss, android.hardware.gnss.V1_0.IGnss, android.internal.hidl.base.V1_0.IBase, android.os.IHwInterface
        ...
        public void onTransact(int _hidl_code, HwParcel _hidl_request, HwParcel _hidl_reply, int _hidl_flags) throws RemoteException {
            ...
            switch (_hidl_code) {
                ...
                case 35:
                    ...
                    _hidl_reply.writeStatus(0);
                    if (_hidl_out_gnssMeasurementIface4 != null) {
                        iHwBinder = _hidl_out_gnssMeasurementIface4.asBinder();
                    }
                    _hidl_reply.writeStrongBinder(iHwBinder);
                    _hidl_reply.send();
                    return;
                case 36:
                    ...
                    _hidl_reply.writeStatus(0);
                    if (_hidl_out_gnssConfigurationIface3 != null) {
                        iHwBinder = _hidl_out_gnssConfigurationIface3.asBinder();
                    }
                    _hidl_reply.writeStrongBinder(iHwBinder);
                    _hidl_reply.send();
                    return;
                case 37:
                    ...
                    _hidl_reply.writeStatus(0);
                    if (_hidl_out_measurementCorrectionsIface2 != null) {
                        iHwBinder = _hidl_out_measurementCorrectionsIface2.asBinder();
                    }
                    _hidl_reply.writeStrongBinder(iHwBinder);
                    _hidl_reply.send();
                    return;
                case 38:
                    ...
                    _hidl_reply.writeStatus(0);
                    if (_hidl_out_gnssAntennaInfoIface != null) {
                        iHwBinder = _hidl_out_gnssAntennaInfoIface.asBinder();
                    }
                    _hidl_reply.writeStrongBinder(iHwBinder);
                    _hidl_reply.send();
                    return;
