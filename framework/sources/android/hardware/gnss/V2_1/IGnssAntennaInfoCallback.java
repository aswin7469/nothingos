...
public interface IGnssAntennaInfoCallback extends IBase {
    ...
    public static final class Coord {
        ...
        public final void readEmbeddedFromParcel(HwParcel parcel, HwBlob _hidl_blob, long _hidl_offset) {
            ...
            this.z = _hidl_blob.getDouble(32 + _hidl_offset);
        ...
        public final void writeEmbeddedToBlob(HwBlob _hidl_blob, long _hidl_offset) {
            _hidl_blob.putDouble(0 + _hidl_offset, this.x);
            _hidl_blob.putDouble(8 + _hidl_offset, this.xUncertainty);
            _hidl_blob.putDouble(16 + _hidl_offset, this.y);
            _hidl_blob.putDouble(24 + _hidl_offset, this.yUncertainty);
            _hidl_blob.putDouble(32 + _hidl_offset, this.z);
