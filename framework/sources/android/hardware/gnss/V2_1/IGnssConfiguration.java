...
public interface IGnssConfiguration extends android.hardware.gnss.V2_0.IGnssConfiguration {
    public static final String kInterfaceName = "android.hardware.gnss@2.1::IGnssConfiguration";
    ...
    boolean setBlacklist_2_1(ArrayList<BlacklistedSource> arrayList) throws RemoteException;
    ...
    public static final class Proxy implements IGnssConfiguration {
        ...
        public boolean setBlacklist_2_1(ArrayList<BlacklistedSource> blacklist) throws RemoteException {
            HwParcel _hidl_request = new HwParcel();
    ...
    public static abstract class Stub extends HwBinder implements IGnssConfiguration {
        ...
        public final ArrayList<String> interfaceChain() {
            return new ArrayList<>(Arrays.asList(IGnssConfiguration.kInterfaceName, android.hardware.gnss.V2_0.IGnssConfiguration.kInterfaceName, android.hardware.gnss.V1_1.IGnssConfiguration.kInterfaceName, android.hardware.gnss.V1_0.IGnssConfiguration.kInterfaceName, IBase.kInterfaceName));
        }
        ...
        public final ArrayList<byte[]> getHashChain() {
            return new ArrayList<>(Arrays.asList(new byte[]{115, 125, 117, 0, 23, 115, -113, 7, 83, -47, 59, MidiConstants.STATUS_POLYPHONIC_AFTERTOUCH, 26, QosProtocol.AH, 16, MidiConstants.STATUS_PITCH_BEND, 22, 31, 41, 75, -118, -24, 11, QosFlowIdRange.MAX, -42, 62, -86, 34, 126, -99, -100, 102}, new byte[]{-20, -55, 102, -58, -117, -35, -67, -107, -56, -38, -25, -126, -72, 66, 4, -49, 1, -57, 87, 52, 103, 94, -121, 105, -106, QosFlowIdRange.MAX, 59, 81, 6, -20, 18, -117}, new byte[]{60, 81, -125, -41, 80, 96, 16, -66, 87, MidiConstants.STATUS_PITCH_BEND, -9, 72, -29, 100, MidiConstants.STATUS_CHANNEL_MASK, -62, -34, -47, -70, -107, 87, -124, -74, 37, 107, -92, 39, -12, -61, -103, 89, 28}, new byte[]{-5, -110, -30, -76, MidiConstants.STATUS_CHANNEL_MASK, -114, -99, 73, 78, -113, -45, -76, -84, 24, 73, -102, QosProtocol.ESP, 22, 52, 46, 124, -1, 22, 7, IGnssVisibilityControlCallback.NfwRequestor.AUTOMOBILE_CLIENT, -61, -69, MidiConstants.STATUS_SONG_SELECT, 102, 11, 110, 121}, new byte[]{-20, Byte.MAX_VALUE, -41, -98, MidiConstants.STATUS_CHANNEL_PRESSURE, 45, -6, -123, -68, 73, -108, 38, -83, -82, 62, -66, 35, -17, 5, 36, MidiConstants.STATUS_SONG_SELECT, -51, 105, 87, 19, -109, 36, -72, 59, 24, -54, 76}));
        }
        ...
        public void onTransact(int _hidl_code, HwParcel _hidl_request, HwParcel _hidl_reply, int _hidl_flags) throws RemoteException {
            switch (_hidl_code) {
                ...
                case 10:
                    ...
                    ArrayList<BlacklistedSource> blacklist2 = BlacklistedSource.readVectorFromParcel(_hidl_request);
                    boolean _hidl_out_success10 = setBlacklist_2_1(blacklist2);
                    _hidl_reply.writeStatus(0);
