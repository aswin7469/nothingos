...
public interface IGnssMeasurement extends android.hardware.gnss.V2_0.IGnssMeasurement {
    ...
    public static abstract class Stub extends HwBinder implements IGnssMeasurement {
        ...
        public final ArrayList<byte[]> getHashChain() {
            return new ArrayList<>(Arrays.asList(new byte[]{121, 19, -95, 18, 6, -91, 119, -79, 42, -34, -122, -89, -49, QosFlowIdRange.MAX, -107, -62, 99, -100, -75, IGnssVisibilityControlCallback.NfwRequestor.AUTOMOBILE_CLIENT, MidiConstants.STATUS_CHANNEL_PRESSURE, -122, 103, QosFlowIdRange.MAX, 39, -101, -7, -110, 56, -55, -111, 126}, new byte[]{-58, 119, 89, -11, -42, 56, 125, 39, 59, 102, 114, -111, Byte.MIN_VALUE, MidiConstants.STATUS_CHANNEL_PRESSURE, 54, MidiConstants.STATUS_NOTE_ON, -24, 39, -16, -74, -72, -44, -31, 60, -30, -1, 66, -45, GsmAlphabet.GSM_EXTENDED_ESCAPE, 34, 64, 101}, new byte[]{26, 7, -47, 56, 62, -124, 124, 61, -21, 105, 110, -57, -94, -55, -29, 59, -106, -125, 119, 41, 69, 102, 4, 72, MidiConstants.STATUS_POLYPHONIC_AFTERTOUCH, 16, -79, Byte.MIN_VALUE, 99, -38, 103, -92}, new byte[]{-98, -88, -104, 123, -79, 8, -100, -116, 93, 123, 103, -122, 101, 117, -72, 102, -17, 81, 96, 69, 2, 29, -98, -4, -61, 124, 99, 82, -68, MidiConstants.STATUS_PITCH_BEND, 114, -93}, new byte[]{-20, Byte.MAX_VALUE, -41, -98, MidiConstants.STATUS_CHANNEL_PRESSURE, 45, -6, -123, -68, 73, -108, 38, -83, -82, 62, -66, 35, -17, 5, 36, MidiConstants.STATUS_SONG_SELECT, -51, 105, 87, 19, -109, 36, -72, 59, 24, -54, 76}));
        }
        ...
        public void onTransact(int _hidl_code, HwParcel _hidl_request, HwParcel _hidl_reply, int _hidl_flags) throws RemoteException {
            switch (_hidl_code) {
                ...
                case 4:
                    ...
                    _hidl_reply.writeStatus(0);
                    _hidl_reply.writeInt32(_hidl_out_initRet3);
                    _hidl_reply.send();
                    return;
                case 5:
                    ...
                    _hidl_reply.writeStatus(0);
                    _hidl_reply.writeInt32(_hidl_out_initRet4);
                    _hidl_reply.send();
                    return;
                case 256067662:
