...
public final class InputManager {
    ...
    public static final long BLOCK_FLAG_SLIPPERY = 157929241;
    ...
    public void addUniqueIdAssociation(String inputDeviceName, String displayUniqueId) {
        try {
            this.mIm.addUniqueIdAssociation(inputDeviceName, displayUniqueId);
        } catch (RemoteException e) {
            throw e.rethrowFromSystemServer();
        }
    }

    public void removeUniqueIdAssociation(String inputDeviceName) {
        try {
            this.mIm.removeUniqueIdAssociation(inputDeviceName);
        } catch (RemoteException e) {
            throw e.rethrowFromSystemServer();
        }
    }
