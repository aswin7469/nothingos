...
public final class LightState {
    ...
    public final boolean equals(Object otherObject) {
        ...
        if (this.color == other.color && this.flashMode == other.flashMode && this.flashOnMs == other.flashOnMs && this.flashOffMs == other.flashOffMs && this.brightnessMode == other.brightnessMode) {
            return true;
        }
        return false;
    }
    ...
    public final String toString() {
        return "{.color = " + this.color + ", .flashMode = " + Flash.toString(this.flashMode) + ", .flashOnMs = " + this.flashOnMs + ", .flashOffMs = " + this.flashOffMs + ", .brightnessMode = " + Brightness.toString(this.brightnessMode) + "}";
    }
