                ...
                default:
                    ...
                    switch (code) {
                        ...
                        case 4:
                            ...
                            if (data.readInt() != 0) {
                                _arg1 = NanoApp.CREATOR.mo3559createFromParcel(data);
                            } else {
                                _arg1 = null;
                            }
                        ...
                        case 7:
                            ...
                            if (data.readInt() != 0) {
                                _arg12 = NanoAppFilter.CREATOR.mo3559createFromParcel(data);
                            } else {
                                _arg12 = null;
                            }
                        ...
                        case 8:
                            ...
                            if (data.readInt() != 0) {
                                _arg2 = ContextHubMessage.CREATOR.mo3559createFromParcel(data);
                            } else {
                                _arg2 = null;
                            }
                        ...
                        case 10:
                            ...
                            if (data.readInt() != 0) {
                                _arg13 = PendingIntent.CREATOR.mo3559createFromParcel(data);
                            } else {
                                _arg13 = null;
                            }
                        ...
                        case 12:
                            ...
                            if (data.readInt() != 0) {
                                _arg22 = NanoAppBinary.CREATOR.mo3559createFromParcel(data);
                            } else {
                                _arg22 = null;
                            }
        ...
        public static class Proxy implements IContextHubService {
            ...
            public ContextHubInfo getContextHubInfo(int contextHubHandle) throws RemoteException {
                ...
                try {
                    ...
                    _reply.readException();
                    if (_reply.readInt() != 0) {
                        _result = ContextHubInfo.CREATOR.mo3559createFromParcel(_reply);
                    } else {
                        _result = null;
                    }
                    return _result;
            ...
            public NanoAppInstanceInfo getNanoAppInstanceInfo(int nanoAppHandle) throws RemoteException {
                ...
                try {
                    ...
                    _reply.readException();
                    if (_reply.readInt() != 0) {
                        _result = NanoAppInstanceInfo.CREATOR.mo3559createFromParcel(_reply);
                    } else {
                        _result = null;
                    }
                    return _result;
