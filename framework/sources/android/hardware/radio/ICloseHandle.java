...
public interface ICloseHandle extends IInterface {
    ...
    public static abstract class Stub extends Binder implements ICloseHandle {
        ...
        public static ICloseHandle asInterface(IBinder obj) {
            if (obj == null) {
                return null;
            }
            IInterface iin = obj.queryLocalInterface(DESCRIPTOR);
            if (iin != null && (iin instanceof ICloseHandle)) {
                return (ICloseHandle) iin;
            }
        ...
        public static boolean setDefaultImpl(ICloseHandle impl) {
