                ...
                default:
                    ...
                    switch (code) {
                        ...
                        case 3:
                            data.enforceInterface(DESCRIPTOR);
                            if (data.readInt() != 0) {
                                _arg0 = RadioManager.BandConfig.CREATOR.mo3559createFromParcel(data);
                            } else {
                                _arg0 = null;
                            }
                        ...
                        case 9:
                            data.enforceInterface(DESCRIPTOR);
                            if (data.readInt() != 0) {
                                _arg04 = ProgramSelector.CREATOR.mo3559createFromParcel(data);
                            } else {
                                _arg04 = null;
                            }
                            tune(_arg04);
                        ...
                        case 14:
                            data.enforceInterface(DESCRIPTOR);
                            if (data.readInt() != 0) {
                                _arg05 = ProgramList.Filter.CREATOR.mo3559createFromParcel(data);
                            } else {
                                _arg05 = null;
                            }
        ...
        public static class Proxy implements ITuner {
            ...
            public RadioManager.BandConfig getConfiguration() throws RemoteException {
                ...
                try {
                    ...
                    _reply.readException();
                    if (_reply.readInt() != 0) {
                        _result = RadioManager.BandConfig.CREATOR.mo3559createFromParcel(_reply);
                    } else {
                        _result = null;
                    }
                    return _result;
