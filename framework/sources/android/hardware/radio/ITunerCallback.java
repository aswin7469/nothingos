                ...
                default:
                    ...
                    switch (code) {
                        ...
                        case 2:
                            ...
                            if (data.readInt() != 0) {
                                _arg1 = ProgramSelector.CREATOR.mo3559createFromParcel(data);
                            } else {
                                _arg1 = null;
                            }
                        ...
                        case 4:
                            data.enforceInterface(DESCRIPTOR);
                            if (data.readInt() != 0) {
                                _arg02 = RadioManager.ProgramInfo.CREATOR.mo3559createFromParcel(data);
                            } else {
                                _arg02 = null;
                            }
                        ...
                        case 11:
                            data.enforceInterface(DESCRIPTOR);
                            if (data.readInt() != 0) {
                                _arg03 = ProgramList.Chunk.CREATOR.mo3559createFromParcel(data);
                            } else {
                                _arg03 = null;
                            }
