...
public class HardwareAuthToken implements Parcelable {
    public static final Parcelable.Creator<HardwareAuthToken> CREATOR = new Parcelable.Creator<HardwareAuthToken>() { // from class: android.hardware.security.keymint.HardwareAuthToken.1
        ...
        public HardwareAuthToken mo3559createFromParcel(Parcel _aidl_source) {
        ...
        public HardwareAuthToken[] mo3560newArray(int _aidl_size) {
    ...
    public final void writeToParcel(Parcel _aidl_parcel, int _aidl_flag) {
        ...
        _aidl_parcel.writeLong(this.userId);
        _aidl_parcel.writeLong(this.authenticatorId);
        _aidl_parcel.writeInt(this.authenticatorType);
        if (this.timestamp != null) {
            _aidl_parcel.writeInt(1);
            this.timestamp.writeToParcel(_aidl_parcel, 0);
        } else {
            _aidl_parcel.writeInt(0);
        }
    ...
    public final void readFromParcel(Parcel _aidl_parcel) {
        ...
        try {
            ...
            this.userId = _aidl_parcel.readLong();
            if (_aidl_parcel.dataPosition() - _aidl_start_pos >= _aidl_parcelable_size) {
                if (_aidl_start_pos > Integer.MAX_VALUE - _aidl_parcelable_size) {
                    throw new BadParcelableException("Overflow in the size of parcelable");
                }
            ...
            this.authenticatorId = _aidl_parcel.readLong();
            if (_aidl_parcel.dataPosition() - _aidl_start_pos >= _aidl_parcelable_size) {
                if (_aidl_start_pos > Integer.MAX_VALUE - _aidl_parcelable_size) {
                    throw new BadParcelableException("Overflow in the size of parcelable");
                }
            ...
            this.authenticatorType = _aidl_parcel.readInt();
            if (_aidl_parcel.dataPosition() - _aidl_start_pos >= _aidl_parcelable_size) {
                if (_aidl_start_pos > Integer.MAX_VALUE - _aidl_parcelable_size) {
                    throw new BadParcelableException("Overflow in the size of parcelable");
                }
            ...
            if (_aidl_parcel.readInt() != 0) {
                this.timestamp = Timestamp.CREATOR.mo3559createFromParcel(_aidl_parcel);
            } else {
                this.timestamp = null;
            }
            if (_aidl_parcel.dataPosition() - _aidl_start_pos >= _aidl_parcelable_size) {
    ...
    public int describeContents() {
        int _mask = 0 | describeContents(this.timestamp);
        return _mask;
    }
