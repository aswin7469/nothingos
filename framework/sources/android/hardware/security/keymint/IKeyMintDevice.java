                ...
                default:
                    ...
                    switch (code) {
                        ...
                        case 3:
                            ...
                            if (data.readInt() != 0) {
                                _arg1 = AttestationKey.CREATOR.mo3559createFromParcel(data);
                            } else {
                                _arg1 = null;
                            }
                        ...
                        case 4:
                            ...
                            if (data.readInt() != 0) {
                                _arg3 = AttestationKey.CREATOR.mo3559createFromParcel(data);
                            } else {
                                _arg3 = null;
                            }
                            KeyCreationResult _result3 = importKey(_arg03, _arg13, _arg2, _arg3);
                            reply.writeNoException();
                            if (_result3 != null) {
                                reply.writeInt(1);
                        ...
                        case 5:
                            ...
                            KeyCreationResult _result4 = importWrappedKey(_arg04, _arg14, _arg22, _arg33, _arg4, _arg5);
                            reply.writeNoException();
                            if (_result4 != null) {
                                reply.writeInt(1);
                        ...
                        case 6:
                            ...
                            byte[] _result5 = upgradeKey(_arg05, _arg15);
                            reply.writeNoException();
                        ...
                        case 10:
                            ...
                            if (data.readInt() != 0) {
                                _arg32 = HardwareAuthToken.CREATOR.mo3559createFromParcel(data);
                            } else {
                                _arg32 = null;
                            }
                            BeginResult _result6 = begin(_arg07, _arg16, _arg23, _arg32);
                            reply.writeNoException();
                            if (_result6 != null) {
                                reply.writeInt(1);
                        ...
                        case 11:
                            ...
                            boolean _arg08 = z;
                            if (data.readInt() != 0) {
                                _arg12 = TimeStampToken.CREATOR.mo3559createFromParcel(data);
                            } else {
                                _arg12 = null;
                            }
                            deviceLocked(_arg08, _arg12);
                            reply.writeNoException();
                            return true;
                        case 12:
                            data.enforceInterface(descriptor);
        ...
        public static class Proxy implements IKeyMintDevice {
            ...
            public KeyMintHardwareInfo getHardwareInfo() throws RemoteException {
                ...
                try {
                    ...
                    if (_reply.readInt() != 0) {
                        _result = KeyMintHardwareInfo.CREATOR.mo3559createFromParcel(_reply);
                    } else {
                        _result = null;
                    }
                    return _result;
            ...
            public KeyCreationResult generateKey(KeyParameter[] keyParams, AttestationKey attestationKey) throws RemoteException {
                ...
                try {
                    ...
                    _reply.readException();
                    if (_reply.readInt() != 0) {
                        _result = KeyCreationResult.CREATOR.mo3559createFromParcel(_reply);
                    } else {
                        _result = null;
                    }
                    return _result;
            ...
            public BeginResult begin(int purpose, byte[] keyBlob, KeyParameter[] params, HardwareAuthToken authToken) throws RemoteException {
                ...
                try {
                    ...
                    _reply.readException();
                    if (_reply.readInt() != 0) {
                        _result = BeginResult.CREATOR.mo3559createFromParcel(_reply);
                    } else {
                        _result = null;
                    }
                    return _result;
