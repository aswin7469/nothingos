                ...
                default:
                    switch (code) {
                        case 1:
                            ...
                            if (data.readInt() != 0) {
                                _arg1 = HardwareAuthToken.CREATOR.mo3559createFromParcel(data);
                            } else {
                                _arg1 = null;
                            }
                            if (data.readInt() != 0) {
                                _arg2 = TimeStampToken.CREATOR.mo3559createFromParcel(data);
                            } else {
                                _arg2 = null;
                            }
                        ...
                        case 2:
                            ...
                            if (data.readInt() != 0) {
                                _arg12 = HardwareAuthToken.CREATOR.mo3559createFromParcel(data);
                            } else {
                                _arg12 = null;
                            }
                            if (data.readInt() != 0) {
                                _arg22 = TimeStampToken.CREATOR.mo3559createFromParcel(data);
                            } else {
                                _arg22 = null;
                            }
                        ...
                        case 3:
                            ...
                            if (data.readInt() != 0) {
                                _arg23 = HardwareAuthToken.CREATOR.mo3559createFromParcel(data);
                            } else {
                                _arg23 = null;
                            }
                            if (data.readInt() != 0) {
                                _arg3 = TimeStampToken.CREATOR.mo3559createFromParcel(data);
                            } else {
                                _arg3 = null;
                            }
