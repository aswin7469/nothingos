...
public class ProtectedData implements Parcelable {
    public static final Parcelable.Creator<ProtectedData> CREATOR = new Parcelable.Creator<ProtectedData>() { // from class: android.hardware.security.keymint.ProtectedData.1
        ...
        public ProtectedData mo3559createFromParcel(Parcel _aidl_source) {
        ...
        public ProtectedData[] mo3560newArray(int _aidl_size) {
    ...
    public final void writeToParcel(Parcel _aidl_parcel, int _aidl_flag) {
        ...
        _aidl_parcel.writeByteArray(this.protectedData);
    ...
    public final void readFromParcel(Parcel _aidl_parcel) {
        ...
        try {
            ...
            this.protectedData = _aidl_parcel.createByteArray();
            if (_aidl_start_pos > Integer.MAX_VALUE - _aidl_parcelable_size) {
                throw new BadParcelableException("Overflow in the size of parcelable");
            }
            _aidl_parcel.setDataPosition(_aidl_start_pos + _aidl_parcelable_size);
