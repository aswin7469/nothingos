...
public final class PrimitivePwle implements Parcelable {
    public static final Parcelable.Creator<PrimitivePwle> CREATOR = new Parcelable.Creator<PrimitivePwle>() { // from class: android.hardware.vibrator.PrimitivePwle.1
        ...
        public PrimitivePwle mo3559createFromParcel(Parcel _aidl_source) {
        ...
        public PrimitivePwle[] mo3560newArray(int _aidl_size) {
        ...
        switch (_aidl_tag) {
            case 0:
                if (_aidl_parcel.readInt() != 0) {
                    _aidl_value = ActivePwle.CREATOR.mo3559createFromParcel(_aidl_parcel);
                } else {
                    _aidl_value = null;
                }
            ...
            case 1:
                if (_aidl_parcel.readInt() != 0) {
                    _aidl_value2 = BrakingPwle.CREATOR.mo3559createFromParcel(_aidl_parcel);
                } else {
                    _aidl_value2 = null;
                }
