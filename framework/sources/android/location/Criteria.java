...
public class Criteria implements Parcelable {
    ...
    public static final Parcelable.Creator<Criteria> CREATOR = new Parcelable.Creator<Criteria>() { // from class: android.location.Criteria.1
        ...
        public Criteria mo3559createFromParcel(Parcel in) {
        ...
        public Criteria[] mo3560newArray(int size) {
    ...
    public String toString() {
        ...
        s.append("Criteria[");
        s.append("power=");
        s.append(requirementToString(this.mPowerRequirement));
        s.append(", ");
        s.append("accuracy=");
        s.append(requirementToString(this.mHorizontalAccuracy));
        if (this.mVerticalAccuracy != 0) {
            s.append(", verticalAccuracy=");
            s.append(requirementToString(this.mVerticalAccuracy));
        }
        if (this.mSpeedAccuracy != 0) {
            s.append(", speedAccuracy=");
            s.append(requirementToString(this.mSpeedAccuracy));
        }
        if (this.mBearingAccuracy != 0) {
            s.append(", bearingAccuracy=");
            s.append(requirementToString(this.mBearingAccuracy));
        }
