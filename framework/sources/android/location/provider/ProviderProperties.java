...
public final class ProviderProperties implements Parcelable {
    ...
    public static final Parcelable.Creator<ProviderProperties> CREATOR = new Parcelable.Creator<ProviderProperties>() { // from class: android.location.provider.ProviderProperties.1
        ...
        public ProviderProperties mo3559createFromParcel(Parcel in) {
        ...
        public ProviderProperties[] mo3560newArray(int size) {
    ...
    public String toString() {
        ...
        b.append("powerUsage=");
        b.append(powerToString(this.mPowerUsage));
        b.append(", ");
        b.append("accuracy=");
        b.append(accuracyToString(this.mAccuracy));
