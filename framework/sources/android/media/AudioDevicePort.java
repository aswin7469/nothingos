...
public class AudioDevicePort extends AudioPort {
    ...
    public int[] encapsulationModes() {
        ...
        return Arrays.stream(iArr).boxed().filter(AudioDevicePort$$ExternalSyntheticLambda0.INSTANCE).mapToInt(CameraDeviceImpl$9$$ExternalSyntheticLambda0.INSTANCE).toArray();
    }
    ...
    public AudioDevicePortConfig mo1520buildConfig(int samplingRate, int channelMask, int format, AudioGainConfig gain) {
