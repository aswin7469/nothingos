...
public final class AudioFocusInfo implements Parcelable {
    public static final Parcelable.Creator<AudioFocusInfo> CREATOR = new Parcelable.Creator<AudioFocusInfo>() { // from class: android.media.AudioFocusInfo.1
        ...
        public AudioFocusInfo mo3559createFromParcel(Parcel in) {
            AudioFocusInfo afi = new AudioFocusInfo(AudioAttributes.CREATOR.mo3559createFromParcel(in), in.readInt(), in.readString(), in.readString(), in.readInt(), in.readInt(), in.readInt(), in.readInt());
        ...
        public AudioFocusInfo[] mo3560newArray(int size) {
