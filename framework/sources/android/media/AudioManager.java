...
public class AudioManager {
    ...
    public void setParameters(String keyValuePairs) {
        ...
        try {
            ...
            service.setNtParameters(keyValuePairs, this.mICallBack);
        } catch (RemoteException e) {
            throw e.rethrowFromSystemServer();
        }
    }
    ...
    */
    ...
    static AudioPortConfig updatePortConfig(AudioPortConfig portCfg, ArrayList<AudioPort> ports) {
        AudioPort port = portCfg.mo1521port();
        int k = 0;
        while (true) {
            if (k >= ports.size()) {
                break;
        ...
        return port.mo1520buildConfig(portCfg.samplingRate(), portCfg.channelMask(), portCfg.format(), gainCfg);
    }
    ...
    public void removeOnCommunicationDeviceChangedListener(OnCommunicationDeviceChangedListener listener) {
        ...
        synchronized (this.mCommDevListenerLock) {
            ...
            if (this.mCommDevListeners.size() == 0) {
                try {
    ...
    public void setEnableDoVibrateTime(String pkgName, long time) {
        IAudioService service = getService();
        try {
            service.setEnableDoVibrateTime(pkgName, time);
        } catch (RemoteException e) {
            throw e.rethrowFromSystemServer();
        }
    }

    public long getEnableDoVibrateTime(String pkgName) {
        IAudioService service = getService();
        try {
            return service.getEnableDoVibrateTime(pkgName);
        } catch (RemoteException e) {
            throw e.rethrowFromSystemServer();
        }
    }
