...
public final class AudioMetadata {
    ...
    private static final HashMap<Class, Integer> AUDIO_METADATA_OBJ_TYPES = new HashMap<Class, Integer>() { // from class: android.media.AudioMetadata.2
        {
            put(Integer.class, 1);
            put(Long.class, 2);
            put(Float.class, 3);
    ...
    private static final HashMap<Integer, DataPackage<?>> DATA_PACKAGES = new HashMap<Integer, DataPackage<?>>() { // from class: android.media.AudioMetadata.3
        {
            put(1, new DataPackage<Integer>() { // from class: android.media.AudioMetadata.3.1
                /* JADX WARN: Can't rename method to resolve collision */
                @Override // android.media.AudioMetadata.DataPackage
                /* renamed from: unpack */
                public Integer mo1519unpack(ByteBuffer buffer) {
            ...
            put(2, new DataPackage<Long>() { // from class: android.media.AudioMetadata.3.2
                /* JADX WARN: Can't rename method to resolve collision */
                @Override // android.media.AudioMetadata.DataPackage
                /* renamed from: unpack */
                public Long mo1519unpack(ByteBuffer buffer) {
            ...
            put(3, new DataPackage<Float>() { // from class: android.media.AudioMetadata.3.3
                /* JADX WARN: Can't rename method to resolve collision */
                @Override // android.media.AudioMetadata.DataPackage
                /* renamed from: unpack */
                public Float mo1519unpack(ByteBuffer buffer) {
            ...
            put(4, new DataPackage<Double>() { // from class: android.media.AudioMetadata.3.4
                /* JADX WARN: Can't rename method to resolve collision */
                @Override // android.media.AudioMetadata.DataPackage
                /* renamed from: unpack */
                public Double mo1519unpack(ByteBuffer buffer) {
            ...
            put(5, new DataPackage<String>() { // from class: android.media.AudioMetadata.3.5
                @Override // android.media.AudioMetadata.DataPackage
                /* renamed from: unpack  reason: collision with other method in class */
                public String mo1519unpack(ByteBuffer buffer) {
    ...
    public interface DataPackage<T> {
        ...
        /* renamed from: unpack */
        T mo1519unpack(ByteBuffer byteBuffer);
    ...
    public static class ObjectPackage implements DataPackage<Pair<Class, Object>> {
        ...
        @Override // android.media.AudioMetadata.DataPackage
        /* renamed from: unpack */
        public Pair<Class, Object> mo1519unpack(ByteBuffer buffer) {
            ...
            Object obj = dataPackage.mo1519unpack(buffer);
    ...
    private static class BaseMapPackage implements DataPackage<BaseMap> {
        ...
        @Override // android.media.AudioMetadata.DataPackage
        /* renamed from: unpack */
        public BaseMap mo1519unpack(ByteBuffer buffer) {
            ...
            for (int i = 0; i < mapSize; i++) {
                String key = strDataPackage.mo1519unpack(buffer);
                if (key != null) {
                    Pair<Class, Object> value = AudioMetadata.OBJECT_PACKAGE.mo1519unpack(buffer);
                    if (value == null) {
        ...
        public boolean pack(AutoGrowByteBuffer output, BaseMap obj) {
            ...
            while (it.hasNext()) {
                ...
                if (strDataPackage.pack(output, key.getName())) {
                    if (!AudioMetadata.OBJECT_PACKAGE.pack(output, new Pair<>(key.getValueClass(), value))) {
                        Log.i(AudioMetadata.TAG, "Failed to pack value: " + obj.get(key));
                        return false;
                    }
                } else {
                    Log.i(AudioMetadata.TAG, "Failed to pack key: " + key.getName());
                    return false;
                }
            }
            return true;
    ...
    public static BaseMap fromByteBuffer(ByteBuffer buffer) {
        ...
        try {
            return (BaseMap) dataPackage.mo1519unpack(buffer);
