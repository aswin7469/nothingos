...
public final class AudioPlaybackConfiguration implements Parcelable {
    ...
    public static final Parcelable.Creator<AudioPlaybackConfiguration> CREATOR = new Parcelable.Creator<AudioPlaybackConfiguration>() { // from class: android.media.AudioPlaybackConfiguration.1
        ...
        public AudioPlaybackConfiguration mo3559createFromParcel(Parcel p) {
        ...
        public AudioPlaybackConfiguration[] mo3560newArray(int size) {
    ...
    public static AudioPlaybackConfiguration anonymizedCopy(AudioPlaybackConfiguration in) {
        ...
        AudioAttributes.Builder flags = new AudioAttributes.Builder().setContentType(in.mPlayerAttr.getContentType()).setFlags(in.mPlayerAttr.getFlags());
        int i = 1;
        if (in.mPlayerAttr.getAllowedCapturePolicy() != 1) {
            i = 3;
        }
        AudioAttributes.Builder builder = flags.setAllowedCapturePolicy(i);
    ...
    private AudioPlaybackConfiguration(Parcel in) {
        ...
        this.mPlayerAttr = AudioAttributes.CREATOR.mo3559createFromParcel(in);
