...
public class AudioPort {
    ...
    public AudioPort(AudioHandle handle, int role, String name, List<AudioProfile> profiles, AudioGain[] gains, List<AudioDescriptor> descriptors) {
        ...
        this.mSamplingRates = samplingRates.stream().mapToInt(AudioPort$$ExternalSyntheticLambda0.INSTANCE).toArray();
        this.mChannelMasks = channelMasks.stream().mapToInt(AudioPort$$ExternalSyntheticLambda0.INSTANCE).toArray();
        this.mChannelIndexMasks = channelIndexMasks.stream().mapToInt(AudioPort$$ExternalSyntheticLambda0.INSTANCE).toArray();
        this.mFormats = formats.stream().mapToInt(AudioPort$$ExternalSyntheticLambda0.INSTANCE).toArray();
    }
    ...
    /* renamed from: buildConfig */
    public AudioPortConfig mo1520buildConfig(int samplingRate, int channelMask, int format, AudioGainConfig gain) {
