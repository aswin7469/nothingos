...
public final class AudioRecordingConfiguration implements Parcelable {
    ...
    public static final Parcelable.Creator<AudioRecordingConfiguration> CREATOR = new Parcelable.Creator<AudioRecordingConfiguration>() { // from class: android.media.AudioRecordingConfiguration.1
        ...
        public AudioRecordingConfiguration mo3559createFromParcel(Parcel p) {
        ...
        public AudioRecordingConfiguration[] mo3560newArray(int size) {
        ...
        while (true) {
            ...
            if (patch.id() != this.mPatchHandle) {
                ...
                if (sources != null && sources.length > 0) {
                    int devId = sources[0].mo1521port().id();
    ...
    private AudioRecordingConfiguration(Parcel in) {
        ...
        this.mClientFormat = AudioFormat.CREATOR.mo3559createFromParcel(in);
        this.mDeviceFormat = AudioFormat.CREATOR.mo3559createFromParcel(in);
