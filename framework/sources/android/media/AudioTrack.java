...
public class AudioTrack extends PlayerBase implements AudioRouting, VolumeAutomation {
    ...
    public static class Builder {
        ...
        /* JADX WARN: Code restructure failed: missing block: B:8:0x0042, code lost:
            if (android.media.AudioTrack.shouldEnablePowerSaving(r12.mAttributes, r12.mFormat, r12.mBufferSizeInBytes, r12.mMode) == false) goto L10;
         */
        /*
        ...
        */
        public AudioTrack build() throws UnsupportedOperationException {
            ...
            if (this.mOffload) {
                ...
                if (AudioSystem.getOffloadSupport(this.mFormat, this.mAttributes) == 0) {
            ...
            try {
                AudioTrack track = new AudioTrack(this.mAttributes, this.mFormat, this.mBufferSizeInBytes, this.mMode, this.mSessionId, this.mOffload, this.mEncapsulationMode, this.mTunerConfiguration);
                if (track.getState() == 0) {
