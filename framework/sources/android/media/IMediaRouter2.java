                ...
                default:
                    switch (code) {
                        case 1:
                            ...
                            if (data.readInt() != 0) {
                                _arg1 = RoutingSessionInfo.CREATOR.mo3559createFromParcel(data);
                            } else {
                                _arg1 = null;
                            }
                        ...
                        case 5:
                            ...
                            if (data.readInt() != 0) {
                                _arg12 = RoutingSessionInfo.CREATOR.mo3559createFromParcel(data);
                            } else {
                                _arg12 = null;
                            }
                        ...
                        case 6:
                            data.enforceInterface(IMediaRouter2.DESCRIPTOR);
                            if (data.readInt() != 0) {
                                _arg0 = RoutingSessionInfo.CREATOR.mo3559createFromParcel(data);
                            } else {
                                _arg0 = null;
                            }
                        ...
                        case 7:
                            data.enforceInterface(IMediaRouter2.DESCRIPTOR);
                            if (data.readInt() != 0) {
                                _arg02 = RoutingSessionInfo.CREATOR.mo3559createFromParcel(data);
                            } else {
                                _arg02 = null;
                            }
                        ...
                        case 8:
                            ...
                            if (data.readInt() != 0) {
                                _arg13 = RoutingSessionInfo.CREATOR.mo3559createFromParcel(data);
                            } else {
                                _arg13 = null;
                            }
                            if (data.readInt() != 0) {
