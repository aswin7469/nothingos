                ...
                default:
                    ...
                    switch (code) {
                        ...
                        case 15:
                            ...
                            if (data.readInt() != 0) {
                                _arg1 = RouteDiscoveryPreference.CREATOR.mo3559createFromParcel(data);
                            } else {
                                _arg1 = null;
                            }
                        ...
                        case 16:
                            ...
                            if (data.readInt() != 0) {
                                _arg12 = MediaRoute2Info.CREATOR.mo3559createFromParcel(data);
                            } else {
                                _arg12 = null;
                            }
                        ...
                        case 17:
                            ...
                            if (data.readInt() != 0) {
                                _arg3 = RoutingSessionInfo.CREATOR.mo3559createFromParcel(data);
                            } else {
                                _arg3 = null;
                            }
                            if (data.readInt() != 0) {
                                _arg4 = MediaRoute2Info.CREATOR.mo3559createFromParcel(data);
                            } else {
                                _arg4 = null;
                            }
                            if (data.readInt() != 0) {
                        ...
                        case 18:
                            ...
                            if (data.readInt() != 0) {
                                _arg2 = MediaRoute2Info.CREATOR.mo3559createFromParcel(data);
                            } else {
                                _arg2 = null;
                            }
                        ...
                        case 19:
                            ...
                            if (data.readInt() != 0) {
                                _arg22 = MediaRoute2Info.CREATOR.mo3559createFromParcel(data);
                            } else {
                                _arg22 = null;
                            }
                        ...
                        case 20:
                            ...
                            if (data.readInt() != 0) {
                                _arg23 = MediaRoute2Info.CREATOR.mo3559createFromParcel(data);
                            } else {
                                _arg23 = null;
                            }
                        ...
                        case 26:
                            ...
                            if (data.readInt() != 0) {
                                _arg24 = MediaRoute2Info.CREATOR.mo3559createFromParcel(data);
                            } else {
                                _arg24 = null;
                            }
                        ...
                        case 29:
                            ...
                            if (data.readInt() != 0) {
                                _arg25 = RoutingSessionInfo.CREATOR.mo3559createFromParcel(data);
                            } else {
                                _arg25 = null;
                            }
                            if (data.readInt() != 0) {
                                _arg32 = MediaRoute2Info.CREATOR.mo3559createFromParcel(data);
                            } else {
                                _arg32 = null;
                            }
                        ...
                        case 30:
                            ...
                            if (data.readInt() != 0) {
                                _arg33 = MediaRoute2Info.CREATOR.mo3559createFromParcel(data);
                            } else {
                                _arg33 = null;
                            }
                        ...
                        case 31:
                            ...
                            if (data.readInt() != 0) {
                                _arg34 = MediaRoute2Info.CREATOR.mo3559createFromParcel(data);
                            } else {
                                _arg34 = null;
                            }
                        ...
                        case 32:
                            ...
                            if (data.readInt() != 0) {
                                _arg35 = MediaRoute2Info.CREATOR.mo3559createFromParcel(data);
                            } else {
                                _arg35 = null;
                            }
        ...
        public static class Proxy implements IMediaRouterService {
            ...
            public MediaRouterClientState getState(IMediaRouterClient client) throws RemoteException {
                ...
                try {
                    ...
                    _reply.readException();
                    if (_reply.readInt() != 0) {
                        _result = MediaRouterClientState.CREATOR.mo3559createFromParcel(_reply);
                    } else {
                        _result = null;
                    }
                    return _result;
            ...
            public RoutingSessionInfo getSystemSessionInfo() throws RemoteException {
                ...
                try {
                    ...
                    _reply.readException();
                    if (_reply.readInt() != 0) {
                        _result = RoutingSessionInfo.CREATOR.mo3559createFromParcel(_reply);
                    } else {
                        _result = null;
                    }
                    return _result;
