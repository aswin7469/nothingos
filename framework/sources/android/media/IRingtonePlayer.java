...
public interface IRingtonePlayer extends IInterface {
    ...
    void playVibrationAsync(Uri uri) throws RemoteException;
    ...
    void stopVibrationAsync() throws RemoteException;
    ...
    public static class Default implements IRingtonePlayer {
        ...
        @Override // android.media.IRingtonePlayer
        public void playVibrationAsync(Uri uri) throws RemoteException {
        }

        @Override // android.media.IRingtonePlayer
        public void stopVibrationAsync() throws RemoteException {
        }
    ...
    public static abstract class Stub extends Binder implements IRingtonePlayer {
        ...
        static final int TRANSACTION_playVibrationAsync = 10;
        ...
        static final int TRANSACTION_stopVibrationAsync = 11;
        ...
        public static String getDefaultTransactionName(int transactionCode) {
            switch (transactionCode) {
                ...
                case 9:
                    return "openRingtone";
                case 10:
                    return "playVibrationAsync";
                case 11:
                    return "stopVibrationAsync";
                default:
                    return null;
            }
        }
                ...
                default:
                    ...
                    switch (code) {
                        case 1:
                            ...
                            play(_arg05, _arg1, _arg2, _arg32, _arg4);
                            return true;
                        case 2:
                            data.enforceInterface(DESCRIPTOR);
                            ...
                            if (data.readInt() != 0) {
                                _arg22 = AudioAttributes.CREATOR.mo3559createFromParcel(data);
                            } else {
                                _arg22 = null;
                            }
                            ...
                            if (data.readInt() != 0) {
                                _arg5 = VolumeShaper.Configuration.CREATOR.mo3559createFromParcel(data);
                            } else {
                                _arg5 = null;
                            }
                            playWithVolumeShaping(_arg06, _arg12, _arg22, _arg33, _arg42, _arg5);
                            return true;
                        case 3:
                            data.enforceInterface(DESCRIPTOR);
                        ...
                        case 4:
                            ...
                            boolean isPlaying = isPlaying(_arg08);
                        ...
                        case 5:
                            ...
                            setPlaybackProperties(_arg09, _arg14, _arg23, _arg24);
                            return true;
                        case 6:
                            data.enforceInterface(DESCRIPTOR);
                            if (data.readInt() != 0) {
                            ...
                            if (data.readInt() != 0) {
                                _arg3 = AudioAttributes.CREATOR.mo3559createFromParcel(data);
                            } else {
                                _arg3 = null;
                            }
                        ...
                        case 8:
                            data.enforceInterface(DESCRIPTOR);
                            if (data.readInt() != 0) {
                                _arg02 = Uri.CREATOR.mo3559createFromParcel(data);
                            } else {
                                _arg02 = null;
                            }
                        ...
                        case 9:
                            data.enforceInterface(DESCRIPTOR);
                            if (data.readInt() != 0) {
                                _arg03 = Uri.CREATOR.mo3559createFromParcel(data);
                            } else {
                                _arg03 = null;
                            }
                        ...
                        case 10:
                            data.enforceInterface(DESCRIPTOR);
                            if (data.readInt() != 0) {
                                _arg04 = Uri.CREATOR.mo3559createFromParcel(data);
                            } else {
                                _arg04 = null;
                            }
                            playVibrationAsync(_arg04);
                            return true;
                        case 11:
                            data.enforceInterface(DESCRIPTOR);
                            stopVibrationAsync();
        ...
        public static class Proxy implements IRingtonePlayer {
            ...
            public void playVibrationAsync(Uri uri) throws RemoteException {
                ...
                try {
                    ...
                    if (!_status && Stub.getDefaultImpl() != null) {
                        Stub.getDefaultImpl().playVibrationAsync(uri);
                    }
                } finally {
                    _data.recycle();
                }
            ...
            public void stopVibrationAsync() throws RemoteException {
                ...
                try {
                    ...
                    if (!_status && Stub.getDefaultImpl() != null) {
                        Stub.getDefaultImpl().stopVibrationAsync();
                    }
                } finally {
                    _data.recycle();
                }
