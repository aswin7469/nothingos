...
public class ImageWriter implements AutoCloseable {
    ...
    public void queueInputImage(Image image) {
        ...
        if (!ownedByMe) {
            if (image.mo1529getOwner() instanceof ImageReader) {
                ImageReader prevOwner = (ImageReader) image.mo1529getOwner();
                prevOwner.detachImage(image);
            } else if (image.mo1529getOwner() != null) {
    ...
    public static class WriterSurfaceImage extends Image {
        ...
        public Image.Plane[] getPlanes() {
            ...
            if (this.mPlanes == null) {
                ...
                this.mPlanes = nativeCreatePlanes(numPlanes, mo1529getOwner().getFormat());
            }
        ...
        public ImageWriter mo1529getOwner() {
            throwISEIfImageIsInvalid();
            return this.mOwner;
        }
        ...
        public void close() {
            if (this.mIsImageValid) {
                mo1529getOwner().abortImage(this);
            }
        }
