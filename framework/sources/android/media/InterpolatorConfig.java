...
public class InterpolatorConfig implements Parcelable {
    public static final Parcelable.Creator<InterpolatorConfig> CREATOR = new Parcelable.Creator<InterpolatorConfig>() { // from class: android.media.InterpolatorConfig.1
        ...
        public InterpolatorConfig mo3559createFromParcel(Parcel _aidl_source) {
        ...
        public InterpolatorConfig[] mo3560newArray(int _aidl_size) {
    ...
    public final void writeToParcel(Parcel _aidl_parcel, int _aidl_flag) {
        ...
        _aidl_parcel.writeFloat(this.firstSlope);
        _aidl_parcel.writeFloat(this.lastSlope);
        _aidl_parcel.writeFloatArray(this.xy);
    ...
    public final void readFromParcel(Parcel _aidl_parcel) {
        ...
        try {
            ...
            this.firstSlope = _aidl_parcel.readFloat();
            if (_aidl_parcel.dataPosition() - _aidl_start_pos >= _aidl_parcelable_size) {
                if (_aidl_start_pos > Integer.MAX_VALUE - _aidl_parcelable_size) {
                    throw new BadParcelableException("Overflow in the size of parcelable");
                }
            ...
            this.lastSlope = _aidl_parcel.readFloat();
            if (_aidl_parcel.dataPosition() - _aidl_start_pos >= _aidl_parcelable_size) {
                if (_aidl_start_pos > Integer.MAX_VALUE - _aidl_parcelable_size) {
                    throw new BadParcelableException("Overflow in the size of parcelable");
                }
            ...
            this.xy = _aidl_parcel.createFloatArray();
            if (_aidl_start_pos > Integer.MAX_VALUE - _aidl_parcelable_size) {
                throw new BadParcelableException("Overflow in the size of parcelable");
            }
            _aidl_parcel.setDataPosition(_aidl_start_pos + _aidl_parcelable_size);
