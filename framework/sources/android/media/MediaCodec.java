                    ...
                    synchronized (MediaCodec.this.mBufferLock) {
                        switch (MediaCodec.this.mBufferMode) {
                            case 0:
                                ...
                                mediaCodec.validateInputByteBuffer(mediaCodec.mCachedInputBuffers, index);
                                break;
                            case 1:
                    ...
                    synchronized (MediaCodec.this.mBufferLock) {
                        switch (MediaCodec.this.mBufferMode) {
                            case 0:
                                ...
                                mediaCodec2.validateOutputByteBuffer(mediaCodec2.mCachedOutputBuffers, index2, info);
                                break;
                            case 1:
    ...
    public static class MediaImage extends Image {
        ...
        public MediaImage(ByteBuffer buffer, ByteBuffer info, boolean readOnly, long timestamp, int xOffset, int yOffset, Rect cropRect) {
            ...
            if (info.remaining() == 104) {
                ...
                this.mHeight = i2;
                if (i < 1 || i2 < 1) {
                    throw new UnsupportedOperationException("unsupported size: " + i + "x" + i2);
                }
