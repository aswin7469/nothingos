...
public class MediaDescription implements Parcelable {
    ...
    public static final Parcelable.Creator<MediaDescription> CREATOR = new Parcelable.Creator<MediaDescription>() { // from class: android.media.MediaDescription.1
        ...
        public MediaDescription mo3559createFromParcel(Parcel in) {
        ...
        public MediaDescription[] mo3560newArray(int size) {
    ...
    private MediaDescription(Parcel in) {
        ...
        this.mDescription = TextUtils.CHAR_SEQUENCE_CREATOR.mo3559createFromParcel(in);
