...
public final class MediaMetadata implements Parcelable {
    ...
    public static final Parcelable.Creator<MediaMetadata> CREATOR = new Parcelable.Creator<MediaMetadata>() { // from class: android.media.MediaMetadata.1
        /* JADX WARN: Can't rename method to resolve collision */
        @Override // android.os.Parcelable.Creator
        /* renamed from: createFromParcel */
        public MediaMetadata mo3559createFromParcel(Parcel in) {
        ...
        public MediaMetadata[] mo3560newArray(int size) {
