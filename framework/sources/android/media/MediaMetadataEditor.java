...
public abstract class MediaMetadataEditor {
    ...
    public synchronized MediaMetadataEditor mo1567putString(int key, String value) throws IllegalArgumentException {
        if (this.mApplied) {
    ...
    public synchronized MediaMetadataEditor mo1565putLong(int key, long value) throws IllegalArgumentException {
        if (this.mApplied) {
            Log.e(TAG, "Can't edit a previously applied MediaMetadataEditor");
            return this;
    ...
    /* renamed from: putBitmap */
    public synchronized MediaMetadataEditor mo1564putBitmap(int key, Bitmap bitmap) throws IllegalArgumentException {
        if (this.mApplied) {
            Log.e(TAG, "Can't edit a previously applied MediaMetadataEditor");
            return this;
        } else if (key != 100) {
    ...
    public synchronized MediaMetadataEditor mo1566putObject(int key, Object value) throws IllegalArgumentException {
        if (this.mApplied) {
            Log.e(TAG, "Can't edit a previously applied MediaMetadataEditor");
            return this;
        }
        switch (METADATA_KEYS_TYPE.get(key, -1)) {
            case 0:
                if (value instanceof Long) {
                    return mo1565putLong(key, ((Long) value).longValue());
                }
            ...
            case 1:
                ...
                return mo1567putString(key, (String) value);
            case 2:
                if (value != null && !(value instanceof Bitmap)) {
                    throw new IllegalArgumentException("Not a Bitmap for key " + key);
                }
                return mo1564putBitmap(key, (Bitmap) value);
            case 3:
