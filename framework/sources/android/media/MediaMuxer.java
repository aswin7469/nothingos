...
public final class MediaMuxer {
    ...
    public void setOrientationHint(int degrees) {
        if (degrees != 0 && degrees != 90 && degrees != 180 && degrees != 270) {
            ...
            throw new IllegalStateException("Can't set rotation degrees due to wrong state(" + convertMuxerStateCodeToString(this.mState) + ")");
        }
    }
    ...
    public void setLocation(float latitude, float longitude) {
        ...
        if (latitudex10000 > 900000 || latitudex10000 < -900000) {
            ...
            throw new IllegalStateException("Can't set location due to wrong state(" + convertMuxerStateCodeToString(this.mState) + ")");
        }
    }
    ...
    public void start() {
        ...
        throw new IllegalStateException("Can't start due to wrong state(" + convertMuxerStateCodeToString(this.mState) + ")");
    }
    ...
    public void stop() {
        ...
        throw new IllegalStateException("Can't stop due to wrong state(" + convertMuxerStateCodeToString(this.mState) + ")");
    }
