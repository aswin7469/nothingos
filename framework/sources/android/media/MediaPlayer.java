...
public class MediaPlayer extends PlayerBase implements SubtitleController.Listener, VolumeAutomation, AudioRouting {
    ...
    private native void native_setup(Object obj, Parcel parcel);
    ...
    public static class TrackInfo implements Parcelable {
        static final Parcelable.Creator<TrackInfo> CREATOR = new Parcelable.Creator<TrackInfo>() { // from class: android.media.MediaPlayer.TrackInfo.1
            ...
            public TrackInfo mo3559createFromParcel(Parcel in) {
            ...
            public TrackInfo[] mo3560newArray(int size) {
    ...
    public class EventHandler extends Handler {
                        ...
                        try {
                            ...
                            MediaPlayer.this.mOnRtpRxNoticeExecutor.execute(new Runnable() { // from class: android.media.MediaPlayer$EventHandler$$ExternalSyntheticLambda0
                                ...
                                public final void run() {
                                    MediaPlayer.EventHandler.this.lambda$handleMessage$0$MediaPlayer$EventHandler(rtpRxNoticeListener, noticeType, data3);
                                }
                            });
                            return;
                        } catch (Throwable th) {
        ...
        public /* synthetic */ void lambda$handleMessage$0$MediaPlayer$EventHandler(OnRtpRxNoticeListener rtpRxNoticeListener, int noticeType, int[] data) {
    ...
    public void setOnRtpRxNoticeListener(Context context, Executor executor, OnRtpRxNoticeListener listener) {
        ...
        this.mOnRtpRxNoticeListener = listener;
        Objects.requireNonNull(executor);
        this.mOnRtpRxNoticeExecutor = executor;
    }
    ...
    public static class TimeProvider implements OnSeekCompleteListener, MediaTimeProvider {
        ...
        public void cancelNotifications(MediaTimeProvider.OnMediaTimeListener listener) {
            synchronized (this) {
                ...
                while (true) {
                    ...
                    if (i >= onMediaTimeListenerArr.length) {
                        break;
                    } else if (onMediaTimeListenerArr[i] == listener) {
                        ...
                        break;
                    } else if (onMediaTimeListenerArr[i] == null) {
                        break;
                    } else {
                        i++;
                    }
        ...
        public synchronized void notifyTimedEvent(boolean refreshTime) {
            ...
            while (true) {
                ...
                MediaTimeProvider.OnMediaTimeListener[] onMediaTimeListenerArr = this.mListeners;
                if (onMediaTimeListenerArr[ix] == null) {
                    break;
                }
                if (jArr2[ix] > -1) {
                    if (jArr2[ix] <= 1000 + nowUs) {
                        activatedListeners.add(onMediaTimeListenerArr[ix]);
                        if (this.DEBUG) {
                            Log.d(TAG, Environment.MEDIA_REMOVED);
                        }
                        this.mTimes[ix] = -1;
                    } else if (nextTimeUs == nowUs || jArr2[ix] < nextTimeUs) {
                        nextTimeUs = jArr2[ix];
                    }
                }
                ix++;
        ...
        /* JADX WARN: Removed duplicated region for block: B:20:0x002f A[Catch: IllegalStateException -> 0x007b, all -> 0x00b4, TryCatch #1 {IllegalStateException -> 0x007b, blocks: (B:12:0x000d, B:14:0x0021, B:18:0x0029, B:20:0x002f, B:23:0x0041), top: B:11:0x000d, outer: #0 }] */
        /* JADX WARN: Removed duplicated region for block: B:27:0x0058 A[Catch: all -> 0x00b4, TRY_ENTER, TryCatch #0 {, blocks: (B:3:0x0001, B:6:0x0007, B:7:0x0009, B:12:0x000d, B:14:0x0021, B:18:0x0029, B:20:0x002f, B:23:0x0041, B:27:0x0058, B:29:0x0060, B:31:0x0068, B:32:0x0077, B:33:0x0079, B:35:0x0073, B:38:0x007c, B:40:0x0080, B:42:0x0084, B:44:0x0090, B:46:0x0096, B:47:0x00ae, B:48:0x00b0, B:50:0x008c, B:51:0x00b3), top: B:2:0x0001, inners: #1 }] */
        @Override // android.media.MediaTimeProvider
        /*
            Code decompiled incorrectly, please refer to instructions dump.
        */
                ...
                try {
                    ...
                    if (this.mPlayer.isPlaying() && !this.mBuffering) {
                        ...
                        if (monotonic) {
                            ...
                            if (j < j2) {
                                if (j2 - j > TimeUtils.NANOS_PER_MS) {
                                    this.mStopped = false;
                                    this.mSeeking = true;
                                    scheduleNotification(3, 0L);
                                }
