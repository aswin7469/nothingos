...
public abstract class MediaRoute2ProviderService extends Service {
    ...
    public final RoutingSessionInfo getSessionInfo(String sessionId) {
        ...
        synchronized (this.mSessionLock) {
            routingSessionInfo = this.mSessionInfo.get(sessionId);
        }
    ...
    public final void notifySessionCreated(long requestId, RoutingSessionInfo sessionInfo) {
        ...
        synchronized (this.mSessionLock) {
            if (this.mSessionInfo.containsKey(sessionId)) {
                Log.w(TAG, "notifySessionCreated: Ignoring duplicate session id.");
                return;
            }
            this.mSessionInfo.put(sessionInfo.getId(), sessionInfo);
    ...
    public final void notifySessionUpdated(RoutingSessionInfo sessionInfo) {
        ...
        synchronized (this.mSessionLock) {
            if (this.mSessionInfo.containsKey(sessionId)) {
                this.mSessionInfo.put(sessionId, sessionInfo);
    ...
    public final void notifySessionReleased(String sessionId) {
        ...
        synchronized (this.mSessionLock) {
            RoutingSessionInfo sessionInfo = this.mSessionInfo.remove(sessionId);
            if (sessionInfo == null) {
    ...
    public void updateSessions() {
        ...
        synchronized (this.mSessionLock) {
            sessions = new ArrayList<>(this.mSessionInfo.values());
        }
        try {
    ...
    final class MediaRoute2ProviderServiceStub extends IMediaRoute2ProviderService.Stub {
        ...
        public void setCallback(IMediaRoute2ProviderServiceCallback callback) {
            if (checkCallerIsSystem()) {
                MediaRoute2ProviderService.this.mHandler.sendMessage(PooledLambda.obtainMessage(MediaRoute2ProviderService$MediaRoute2ProviderServiceStub$$ExternalSyntheticLambda7.INSTANCE, MediaRoute2ProviderService.this, callback));
            }
        }
        ...
        public void updateDiscoveryPreference(RouteDiscoveryPreference discoveryPreference) {
            if (checkCallerIsSystem()) {
                MediaRoute2ProviderService.this.mHandler.sendMessage(PooledLambda.obtainMessage(MediaRoute2ProviderService$MediaRoute2ProviderServiceStub$$ExternalSyntheticLambda8.INSTANCE, MediaRoute2ProviderService.this, discoveryPreference));
            }
        }
        ...
        public void setRouteVolume(long requestId, String routeId, int volume) {
            if (checkCallerIsSystem() && checkRouteIdIsValid(routeId, "setRouteVolume")) {
                ...
                MediaRoute2ProviderService.this.mHandler.sendMessage(PooledLambda.obtainMessage(MediaRoute2ProviderService$MediaRoute2ProviderServiceStub$$ExternalSyntheticLambda0.INSTANCE, MediaRoute2ProviderService.this, Long.valueOf(requestId), routeId, Integer.valueOf(volume)));
            }
        }
        ...
        public void requestCreateSession(long requestId, String packageName, String routeId, Bundle requestCreateSession) {
            if (checkCallerIsSystem() && checkRouteIdIsValid(routeId, "requestCreateSession")) {
                MediaRoute2ProviderService.this.addRequestId(requestId);
                MediaRoute2ProviderService.this.mHandler.sendMessage(PooledLambda.obtainMessage(MediaRoute2ProviderService$MediaRoute2ProviderServiceStub$$ExternalSyntheticLambda5.INSTANCE, MediaRoute2ProviderService.this, Long.valueOf(requestId), packageName, routeId, requestCreateSession));
            }
        }
        ...
        public void selectRoute(long requestId, String sessionId, String routeId) {
            if (checkCallerIsSystem() && checkSessionIdIsValid(sessionId, "selectRoute") && checkRouteIdIsValid(routeId, "selectRoute")) {
                MediaRoute2ProviderService.this.addRequestId(requestId);
                MediaRoute2ProviderService.this.mHandler.sendMessage(PooledLambda.obtainMessage(MediaRoute2ProviderService$MediaRoute2ProviderServiceStub$$ExternalSyntheticLambda3.INSTANCE, MediaRoute2ProviderService.this, Long.valueOf(requestId), sessionId, routeId));
            }
        }
        ...
        public void deselectRoute(long requestId, String sessionId, String routeId) {
            if (checkCallerIsSystem() && checkSessionIdIsValid(sessionId, "deselectRoute") && checkRouteIdIsValid(routeId, "deselectRoute")) {
                MediaRoute2ProviderService.this.addRequestId(requestId);
                MediaRoute2ProviderService.this.mHandler.sendMessage(PooledLambda.obtainMessage(MediaRoute2ProviderService$MediaRoute2ProviderServiceStub$$ExternalSyntheticLambda2.INSTANCE, MediaRoute2ProviderService.this, Long.valueOf(requestId), sessionId, routeId));
            }
        }
        ...
        public void transferToRoute(long requestId, String sessionId, String routeId) {
            if (checkCallerIsSystem() && checkSessionIdIsValid(sessionId, "transferToRoute") && checkRouteIdIsValid(routeId, "transferToRoute")) {
                MediaRoute2ProviderService.this.addRequestId(requestId);
                MediaRoute2ProviderService.this.mHandler.sendMessage(PooledLambda.obtainMessage(MediaRoute2ProviderService$MediaRoute2ProviderServiceStub$$ExternalSyntheticLambda4.INSTANCE, MediaRoute2ProviderService.this, Long.valueOf(requestId), sessionId, routeId));
            }
        }
        ...
        public void setSessionVolume(long requestId, String sessionId, int volume) {
            if (checkCallerIsSystem() && checkSessionIdIsValid(sessionId, "setSessionVolume")) {
                MediaRoute2ProviderService.this.addRequestId(requestId);
                MediaRoute2ProviderService.this.mHandler.sendMessage(PooledLambda.obtainMessage(MediaRoute2ProviderService$MediaRoute2ProviderServiceStub$$ExternalSyntheticLambda1.INSTANCE, MediaRoute2ProviderService.this, Long.valueOf(requestId), sessionId, Integer.valueOf(volume)));
            }
        }
        ...
        public void releaseSession(long requestId, String sessionId) {
            if (checkCallerIsSystem() && checkSessionIdIsValid(sessionId, "releaseSession")) {
                MediaRoute2ProviderService.this.addRequestId(requestId);
                MediaRoute2ProviderService.this.mHandler.sendMessage(PooledLambda.obtainMessage(MediaRoute2ProviderService$MediaRoute2ProviderServiceStub$$ExternalSyntheticLambda6.INSTANCE, MediaRoute2ProviderService.this, Long.valueOf(requestId), sessionId));
            }
        }
    }
}
