...
public class RemoteControlClient {
    ...
    public class MetadataEditor extends MediaMetadataEditor {
        ...
        public synchronized MetadataEditor mo1567putString(int key, String value) throws IllegalArgumentException {
            String metadataKey;
            super.mo1567putString(key, value);
        ...
        public synchronized MetadataEditor mo1565putLong(int key, long value) throws IllegalArgumentException {
            String metadataKey;
            super.mo1565putLong(key, value);
            if (this.mMetadataBuilder != null && (metadataKey = MediaMetadata.getKeyFromMetadataEditorKey(key)) != null) {
        ...
        @Override // android.media.MediaMetadataEditor
        /* renamed from: putBitmap  reason: collision with other method in class */
        public synchronized MetadataEditor mo1564putBitmap(int key, Bitmap bitmap) throws IllegalArgumentException {
            String metadataKey;
            super.mo1564putBitmap(key, bitmap);
            if (this.mMetadataBuilder != null && (metadataKey = MediaMetadata.getKeyFromMetadataEditorKey(key)) != null) {
        ...
        @Override // android.media.MediaMetadataEditor
        /* renamed from: putObject  reason: collision with other method in class */
        public synchronized MetadataEditor mo1566putObject(int key, Object object) throws IllegalArgumentException {
            String metadataKey;
            super.mo1566putObject(key, object);
        ...
        /* JADX WARN: Unsupported multi-entry loop pattern (BACK_EDGE: B:29:0x008b -> B:30:0x0089). Please submit an issue!!! */
        @Override // android.media.MediaMetadataEditor
