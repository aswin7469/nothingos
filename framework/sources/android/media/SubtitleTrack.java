...
public abstract class SubtitleTrack implements MediaTimeProvider.OnMediaTimeListener {
    ...
    /* renamed from: getRenderingWidget */
    public abstract RenderingWidget mo1592getRenderingWidget();
    ...
    */
    ...
    public void show() {
        ...
        this.mVisible = true;
        RenderingWidget renderingWidget = mo1592getRenderingWidget();
    ...
    public static class CueList {
        ...
        class EntryIterator implements Iterator<Pair<Long, Cue>> {
            ...
            @Override // java.util.Iterator
            /* renamed from: next */
            public Pair<Long, Cue> mo1576next() {
                if (this.mDone) {
    ...
    public int getTrackType() {
        if (mo1592getRenderingWidget() == null) {
            return 3;
        }
        return 4;
    }
