            ...
            public void onEvent(final int eventCode, final V info) {
                ...
                executor.execute(new Runnable() { // from class: android.media.Utils$ListenerList$1$$ExternalSyntheticLambda0
                    ...
                    public final void run() {
                        Utils.ListenerList.AnonymousClass1.this.lambda$onEvent$0$Utils$ListenerList$1(listener, eventCode, info);
                    }
                });
            }

            public /* synthetic */ void lambda$onEvent$0$Utils$ListenerList$1(Listener listener, int eventCode, Object info) {
