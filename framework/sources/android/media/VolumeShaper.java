...
public final class VolumeShaper implements AutoCloseable {
    ...
    public static final class Configuration implements Parcelable {
        ...
        static {
            ...
            CREATOR = new Parcelable.Creator<Configuration>() { // from class: android.media.VolumeShaper.Configuration.1
                ...
                public Configuration mo3559createFromParcel(Parcel p) {
                    return Configuration.fromParcelable(VolumeShaperConfiguration.CREATOR.mo3559createFromParcel(p));
                }
    ...
    public static final class Operation implements Parcelable {
        ...
        public static final Parcelable.Creator<Operation> CREATOR = new Parcelable.Creator<Operation>() { // from class: android.media.VolumeShaper.Operation.1
            ...
            @Override // android.os.Parcelable.Creator
            /* renamed from: createFromParcel */
            public Operation mo3559createFromParcel(Parcel p) {
                return Operation.fromParcelable(VolumeShaperOperation.CREATOR.mo3559createFromParcel(p));
            }

            /* JADX WARN: Can't rename method to resolve collision */
            @Override // android.os.Parcelable.Creator
            /* renamed from: newArray */
            public Operation[] mo3560newArray(int size) {
    ...
    public static final class State implements Parcelable {
        public static final Parcelable.Creator<State> CREATOR = new Parcelable.Creator<State>() { // from class: android.media.VolumeShaper.State.1
            ...
            @Override // android.os.Parcelable.Creator
            /* renamed from: createFromParcel */
            public State mo3559createFromParcel(Parcel p) {
                return State.fromParcelable(VolumeShaperState.CREATOR.mo3559createFromParcel(p));
            }

            /* JADX WARN: Can't rename method to resolve collision */
            @Override // android.os.Parcelable.Creator
            /* renamed from: newArray */
            public State[] mo3560newArray(int size) {
