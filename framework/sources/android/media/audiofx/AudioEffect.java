...
public class AudioEffect {
    ...
    public static final UUID EFFECT_TYPE_HAPTIC_GENERATOR = UUID.fromString("1411e6d6-aecd-4021-a1cf-a6aceb0d71e5");
    ...
    */
    ...
    private AudioEffect(UUID type, UUID uuid, int priority, int audioSession, AudioDeviceAttributes device, boolean probe) throws IllegalArgumentException, UnsupportedOperationException, RuntimeException {
        ...
        if (device == null) {
            ...
            int deviceType2 = AudioDeviceInfo.convertDeviceTypeToInternalDevice(device.getType());
    ...
    public static boolean isEffectSupportedForDevice(UUID uuid, AudioDeviceAttributes device) {
        try {
            ...
            Objects.requireNonNull(uuid);
            Objects.requireNonNull(device);
            AudioEffect fx = new AudioEffect(uuid2, uuid, 0, -2, device, true);
            fx.release();
            return true;
        } catch (Exception e) {
            return false;
