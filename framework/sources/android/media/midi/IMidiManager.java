                ...
                default:
                    switch (code) {
                        ...
                        case 4:
                            ...
                            if (data.readInt() != 0) {
                                _arg1 = MidiDeviceInfo.CREATOR.mo3559createFromParcel(data);
                            } else {
                                _arg1 = null;
                            }
                        ...
                        case 10:
                            data.enforceInterface(DESCRIPTOR);
                            if (data.readInt() != 0) {
                                _arg0 = MidiDeviceInfo.CREATOR.mo3559createFromParcel(data);
                            } else {
                                _arg0 = null;
                            }
                        ...
                        case 11:
                            ...
                            if (data.readInt() != 0) {
                                _arg13 = MidiDeviceStatus.CREATOR.mo3559createFromParcel(data);
                            } else {
                                _arg13 = null;
                            }
        ...
        public static class Proxy implements IMidiManager {
                ...
                try {
                    ...
                    try {
                        ...
                        try {
                            ...
                            _reply.readException();
                            if (_reply.readInt() != 0) {
                                _result = MidiDeviceInfo.CREATOR.mo3559createFromParcel(_reply);
                            } else {
                                _result = null;
                            }
                            _reply.recycle();
            ...
            public MidiDeviceStatus getDeviceStatus(MidiDeviceInfo deviceInfo) throws RemoteException {
                ...
                try {
                    ...
                    _reply.readException();
                    if (_reply.readInt() != 0) {
                        _result = MidiDeviceStatus.CREATOR.mo3559createFromParcel(_reply);
                    } else {
                        _result = null;
                    }
                    return _result;
