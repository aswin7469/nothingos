                ...
                default:
                    switch (code) {
                        case 1:
                            ...
                            if (data.readInt() != 0) {
                                _arg3 = ResultReceiver.CREATOR.mo3559createFromParcel(data);
                            } else {
                                _arg3 = null;
                            }
                        ...
                        case 2:
                            ...
                            if (data.readInt() != 0) {
                                _arg1 = KeyEvent.CREATOR.mo3559createFromParcel(data);
                            } else {
                                _arg1 = null;
                            }
                        ...
                        case 29:
                            ...
                            if (data.readInt() != 0) {
                                _arg14 = Rating.CREATOR.mo3559createFromParcel(data);
                            } else {
                                _arg14 = null;
                            }
                            rate(_arg023, _arg14);
                        ...
                        case 31:
                            ...
                            if (data.readInt() != 0) {
                                _arg28 = Bundle.CREATOR.mo3559createFromParcel(data);
                            } else {
                                _arg28 = null;
                            }
        ...
        public static class Proxy implements ISessionController {
            ...
            public MediaController.PlaybackInfo getVolumeAttributes() throws RemoteException {
                ...
                try {
                    ...
                    _reply.readException();
                    if (_reply.readInt() != 0) {
                        _result = MediaController.PlaybackInfo.CREATOR.mo3559createFromParcel(_reply);
                    } else {
                        _result = null;
                    }
                    return _result;
            ...
            public MediaMetadata getMetadata() throws RemoteException {
                ...
                try {
                    ...
                    _reply.readException();
                    if (_reply.readInt() != 0) {
                        _result = MediaMetadata.CREATOR.mo3559createFromParcel(_reply);
                    } else {
                        _result = null;
                    }
                    return _result;
            ...
            public PlaybackState getPlaybackState() throws RemoteException {
                ...
                try {
                    ...
                    _reply.readException();
                    if (_reply.readInt() != 0) {
                        _result = PlaybackState.CREATOR.mo3559createFromParcel(_reply);
                    } else {
                        _result = null;
                    }
                    return _result;
