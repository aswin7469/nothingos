                ...
                default:
                    ...
                    switch (code) {
                        ...
                        case 5:
                            ...
                            if (data.readInt() != 0) {
                                _arg2 = KeyEvent.CREATOR.mo3559createFromParcel(data);
                            } else {
                                _arg2 = null;
                            }
                            if (data.readInt() != 0) {
                        ...
                        case 6:
                            ...
                            if (data.readInt() != 0) {
                                _arg12 = KeyEvent.CREATOR.mo3559createFromParcel(data);
                            } else {
                                _arg12 = null;
                            }
                            if (data.readInt() != 0) {
                                _arg22 = MediaSession.Token.CREATOR.mo3559createFromParcel(data);
                            } else {
                                _arg22 = null;
                            }
                        ...
                        case 7:
                            ...
                            if (data.readInt() != 0) {
                                _arg32 = KeyEvent.CREATOR.mo3559createFromParcel(data);
                            } else {
                                _arg32 = null;
                            }
                        ...
                        case 8:
                            ...
                            if (data.readInt() != 0) {
                                _arg24 = KeyEvent.CREATOR.mo3559createFromParcel(data);
                            } else {
                                _arg24 = null;
                            }
                            if (data.readInt() != 0) {
                                _arg33 = MediaSession.Token.CREATOR.mo3559createFromParcel(data);
                            } else {
                                _arg33 = null;
                            }
                        ...
                        case 28:
                            data.enforceInterface(DESCRIPTOR);
                            if (data.readInt() != 0) {
                                _arg02 = MediaSession.Token.CREATOR.mo3559createFromParcel(data);
                            } else {
                                _arg02 = null;
                            }
                        ...
                        case 29:
                            data.enforceInterface(DESCRIPTOR);
                            if (data.readInt() != 0) {
                                _arg03 = MediaSession.Token.CREATOR.mo3559createFromParcel(data);
                            } else {
                                _arg03 = null;
                            }
        ...
        public static class Proxy implements ISessionManager {
            ...
            public MediaSession.Token getMediaKeyEventSession() throws RemoteException {
                ...
                try {
                    ...
                    _reply.readException();
                    if (_reply.readInt() != 0) {
                        _result = MediaSession.Token.CREATOR.mo3559createFromParcel(_reply);
                    } else {
                        _result = null;
                    }
                    return _result;
