...
public final class MediaSession {
    ...
    public void setMediaButtonReceiver(PendingIntent mbr) {
        try {
            this.mBinder.setMediaButtonReceiver(mbr, this.mContext.getPackageName());
        } catch (RemoteException e) {
    ...
    public static final class Token implements Parcelable {
        public static final Parcelable.Creator<Token> CREATOR = new Parcelable.Creator<Token>() { // from class: android.media.session.MediaSession.Token.1
            ...
            public Token mo3559createFromParcel(Parcel in) {
                return new Token(in);
            }
            ...
            public Token[] mo3560newArray(int size) {
    ...
    public static final class QueueItem implements Parcelable {
        public static final Parcelable.Creator<QueueItem> CREATOR = new Parcelable.Creator<QueueItem>() { // from class: android.media.session.MediaSession.QueueItem.1
            ...
            @Override // android.os.Parcelable.Creator
            /* renamed from: createFromParcel */
            public QueueItem mo3559createFromParcel(Parcel p) {
            ...
            @Override // android.os.Parcelable.Creator
            /* renamed from: newArray */
            public QueueItem[] mo3560newArray(int size) {
        ...
        private QueueItem(Parcel in) {
            this.mDescription = MediaDescription.CREATOR.mo3559createFromParcel(in);
