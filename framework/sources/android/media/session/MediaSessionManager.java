...
public final class MediaSessionManager {
    ...
    public MediaSession.Token getMediaKeyEventSession() {
        try {
            return this.mService.getMediaKeyEventSession();
    ...
    public String getMediaKeyEventSessionPackageName() {
        try {
            String packageName = this.mService.getMediaKeyEventSessionPackageName();
    ...
    public void dispatchMediaKeyEventAsSystemService(KeyEvent keyEvent) {
        dispatchMediaKeyEventInternal(keyEvent, true, false);
    }
            ...
            try {
                ...
                executor.execute(new Runnable() { // from class: android.media.session.MediaSessionManager$$ExternalSyntheticLambda0
                    ...
                    public final void run() {
                        MediaSessionManager.this.lambda$addOnMediaKeyEventSessionChangedListener$0$MediaSessionManager(listener);
                    }
                });
    ...
    public /* synthetic */ void lambda$addOnMediaKeyEventSessionChangedListener$0$MediaSessionManager(OnMediaKeyEventSessionChangedListener listener) {
            ...
            public void onActiveSessionsChanged(final List<MediaSession.Token> tokens) {
                if (SessionsChangedWrapper.this.mExecutor != null) {
                    ...
                    executor.execute(new Runnable() { // from class: android.media.session.MediaSessionManager$SessionsChangedWrapper$1$$ExternalSyntheticLambda0
                        @Override // java.lang.Runnable
                        public final void run() {
                            MediaSessionManager.SessionsChangedWrapper.AnonymousClass1.this.lambda$onActiveSessionsChanged$0$MediaSessionManager$SessionsChangedWrapper$1(tokens);
                        }
                    });
                }
            }

            public /* synthetic */ void lambda$onActiveSessionsChanged$0$MediaSessionManager$SessionsChangedWrapper$1(List tokens) {
