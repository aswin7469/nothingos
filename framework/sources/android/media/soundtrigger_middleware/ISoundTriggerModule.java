                ...
                default:
                    switch (code) {
                        case 1:
                            ...
                            if (data.readInt() != 0) {
                                _arg0 = SoundModel.CREATOR.mo3559createFromParcel(data);
                            } else {
                                _arg0 = null;
                            }
                        ...
                        case 2:
                            data.enforceInterface(descriptor);
                            if (data.readInt() != 0) {
                                _arg02 = PhraseSoundModel.CREATOR.mo3559createFromParcel(data);
                            } else {
                                _arg02 = null;
                            }
                        ...
                        case 4:
                            ...
                            if (data.readInt() != 0) {
                                _arg1 = RecognitionConfig.CREATOR.mo3559createFromParcel(data);
                            } else {
                                _arg1 = null;
                            }
        ...
        public static class Proxy implements ISoundTriggerModule {
            ...
            public ModelParameterRange queryModelParameterSupport(int modelHandle, int modelParam) throws RemoteException {
                ...
                try {
                    ...
                    _reply.readException();
                    if (_reply.readInt() != 0) {
                        _result = ModelParameterRange.CREATOR.mo3559createFromParcel(_reply);
                    } else {
                        _result = null;
                    }
                    return _result;
