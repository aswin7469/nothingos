                ...
                default:
                    ...
                    switch (code) {
                        ...
                        case 3:
                            data.enforceInterface(DESCRIPTOR);
                            if (data.readInt() != 0) {
                                _arg0 = TvInputInfo.CREATOR.mo3559createFromParcel(data);
                            } else {
                                _arg0 = null;
                            }
                        ...
                        case 25:
                            ...
                            if (data.readInt() != 0) {
                                _arg24 = Rect.CREATOR.mo3559createFromParcel(data);
                            } else {
                                _arg24 = null;
                            }
                        ...
                        case 26:
                            ...
                            if (data.readInt() != 0) {
                                _arg13 = Rect.CREATOR.mo3559createFromParcel(data);
                            } else {
                                _arg13 = null;
                            }
                        ...
                        case 33:
                            ...
                            if (data.readInt() != 0) {
                                _arg15 = PlaybackParams.CREATOR.mo3559createFromParcel(data);
                            } else {
                                _arg15 = null;
                            }
                        ...
                        case 36:
                            ...
                            if (data.readInt() != 0) {
                                _arg16 = Uri.CREATOR.mo3559createFromParcel(data);
                            } else {
                                _arg16 = null;
                            }
                            if (data.readInt() != 0) {
                        ...
                        case 39:
                            ...
                            if (data.readInt() != 0) {
                                _arg18 = Bundle.CREATOR.mo3559createFromParcel(data);
                            } else {
                                _arg18 = null;
                            }
                        ...
                        case 41:
                            ...
                            if (data.readInt() != 0) {
                                _arg26 = TvInputInfo.CREATOR.mo3559createFromParcel(data);
                            } else {
                                _arg26 = null;
                            }
                        ...
                        case 44:
                            ...
                            if (data.readInt() != 0) {
                                _arg19 = Surface.CREATOR.mo3559createFromParcel(data);
                            } else {
                                _arg19 = null;
                            }
                            if (data.readInt() != 0) {
                                _arg27 = TvStreamConfig.CREATOR.mo3559createFromParcel(data);
                            } else {
                                _arg27 = null;
                            }
                        ...
                        case 47:
                            data.enforceInterface(DESCRIPTOR);
                            if (data.readInt() != 0) {
                                _arg02 = DvbDeviceInfo.CREATOR.mo3559createFromParcel(data);
                            } else {
                                _arg02 = null;
                            }
                        ...
                        case 48:
                            data.enforceInterface(DESCRIPTOR);
                            if (data.readInt() != 0) {
                                _arg03 = Intent.CREATOR.mo3559createFromParcel(data);
                            } else {
                                _arg03 = null;
                            }
        ...
        public static class Proxy implements ITvInputManager {
            ...
            public TvInputInfo getTvInputInfo(String inputId, int userId) throws RemoteException {
                ...
                try {
                    ...
                    _reply.readException();
                    if (_reply.readInt() != 0) {
                        _result = TvInputInfo.CREATOR.mo3559createFromParcel(_reply);
                    } else {
                        _result = null;
                    }
                    return _result;
