                ...
                default:
                    ...
                    switch (code) {
                        ...
                        case 3:
                            data.enforceInterface(DESCRIPTOR);
                            if (data.readInt() != 0) {
                                _arg0 = Surface.CREATOR.mo3559createFromParcel(data);
                            } else {
                                _arg0 = null;
                            }
                            setSurface(_arg0);
                        ...
                        case 18:
                            data.enforceInterface(DESCRIPTOR);
                            if (data.readInt() != 0) {
                                _arg05 = PlaybackParams.CREATOR.mo3559createFromParcel(data);
                            } else {
                                _arg05 = null;
                            }
                        ...
                        case 20:
                            data.enforceInterface(DESCRIPTOR);
                            if (data.readInt() != 0) {
                                _arg06 = Uri.CREATOR.mo3559createFromParcel(data);
                            } else {
                                _arg06 = null;
                            }
                            if (data.readInt() != 0) {
                        ...
                        case 22:
                            data.enforceInterface(DESCRIPTOR);
                            if (data.readInt() != 0) {
                                _arg07 = Bundle.CREATOR.mo3559createFromParcel(data);
                            } else {
                                _arg07 = null;
                            }
                        ...
                        case 23:
                            data.enforceInterface(DESCRIPTOR);
                            if (data.readInt() != 0) {
                                _arg08 = Bundle.CREATOR.mo3559createFromParcel(data);
                            } else {
                                _arg08 = null;
                            }
