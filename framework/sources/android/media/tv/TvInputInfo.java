...
public final class TvInputInfo implements Parcelable {
    public static final Parcelable.Creator<TvInputInfo> CREATOR = new Parcelable.Creator<TvInputInfo>() { // from class: android.media.tv.TvInputInfo.1
        ...
        public TvInputInfo mo3559createFromParcel(Parcel in) {
        ...
        public TvInputInfo[] mo3560newArray(int size) {
    ...
    private TvInputInfo(Parcel in) {
        this.mService = ResolveInfo.CREATOR.mo3559createFromParcel(in);
        this.mId = in.readString();
        this.mType = in.readInt();
        boolean z = false;
        this.mIsHardwareInput = in.readByte() == 1;
        this.mLabel = TextUtils.CHAR_SEQUENCE_CREATOR.mo3559createFromParcel(in);
    ...
    public static final class Builder {
        ...
        public TvInputInfo build() {
            ...
            return new TvInputInfo(resolveInfo, id, type, isHardwareInput, charSequence, i2, icon, icon2, icon3, str, booleanValue, booleanValue2, i, this.mHdmiDeviceInfo, isConnectedToHdmiSwitch, hdmiConnectionRelativePosition, this.mParentId, this.mExtras);
        }
