...
public abstract class TvInputService extends Service {
    ...
    public static abstract class HardwareSession extends Session {
        ...
        private final TvInputManager.SessionCallback mHardwareSessionCallback = new TvInputManager.SessionCallback() { // from class: android.media.tv.TvInputService.HardwareSession.1
        ...
        public final void handleMessage(Message msg) {
            switch (msg.what) {
                case 1:
                    ...
                    args.recycle();
                    Session sessionImpl = TvInputService.this.onCreateSession(inputId, sessionId);
                    if (sessionImpl == null) {
                        try {
