...
public final class TunerFrontendCapabilities implements Parcelable {
    public static final Parcelable.Creator<TunerFrontendCapabilities> CREATOR = new Parcelable.Creator<TunerFrontendCapabilities>() { // from class: android.media.tv.tuner.TunerFrontendCapabilities.1
        ...
        public TunerFrontendCapabilities mo3559createFromParcel(Parcel _aidl_source) {
        ...
        public TunerFrontendCapabilities[] mo3560newArray(int _aidl_size) {
        ...
        switch (_aidl_tag) {
            case 0:
                if (_aidl_parcel.readInt() != 0) {
                    _aidl_value = TunerFrontendAnalogCapabilities.CREATOR.mo3559createFromParcel(_aidl_parcel);
                } else {
                    _aidl_value = null;
                }
            ...
            case 1:
                if (_aidl_parcel.readInt() != 0) {
                    _aidl_value2 = TunerFrontendAtscCapabilities.CREATOR.mo3559createFromParcel(_aidl_parcel);
                } else {
                    _aidl_value2 = null;
                }
            ...
            case 2:
                if (_aidl_parcel.readInt() != 0) {
                    _aidl_value3 = TunerFrontendAtsc3Capabilities.CREATOR.mo3559createFromParcel(_aidl_parcel);
                } else {
                    _aidl_value3 = null;
                }
            ...
            case 3:
                if (_aidl_parcel.readInt() != 0) {
                    _aidl_value4 = TunerFrontendCableCapabilities.CREATOR.mo3559createFromParcel(_aidl_parcel);
                } else {
                    _aidl_value4 = null;
                }
            ...
            case 4:
                if (_aidl_parcel.readInt() != 0) {
                    _aidl_value5 = TunerFrontendDvbsCapabilities.CREATOR.mo3559createFromParcel(_aidl_parcel);
                } else {
                    _aidl_value5 = null;
                }
            ...
            case 5:
                if (_aidl_parcel.readInt() != 0) {
                    _aidl_value6 = TunerFrontendDvbtCapabilities.CREATOR.mo3559createFromParcel(_aidl_parcel);
                } else {
                    _aidl_value6 = null;
                }
            ...
            case 6:
                if (_aidl_parcel.readInt() != 0) {
                    _aidl_value7 = TunerFrontendIsdbsCapabilities.CREATOR.mo3559createFromParcel(_aidl_parcel);
                } else {
                    _aidl_value7 = null;
                }
            ...
            case 7:
                if (_aidl_parcel.readInt() != 0) {
                    _aidl_value8 = TunerFrontendIsdbs3Capabilities.CREATOR.mo3559createFromParcel(_aidl_parcel);
                } else {
                    _aidl_value8 = null;
                }
            ...
            case 8:
                if (_aidl_parcel.readInt() != 0) {
                    _aidl_value9 = TunerFrontendIsdbtCapabilities.CREATOR.mo3559createFromParcel(_aidl_parcel);
                } else {
                    _aidl_value9 = null;
                }
