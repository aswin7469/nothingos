...
public class TunerFrontendIsdbtCapabilities implements Parcelable {
    public static final Parcelable.Creator<TunerFrontendIsdbtCapabilities> CREATOR = new Parcelable.Creator<TunerFrontendIsdbtCapabilities>() { // from class: android.media.tv.tuner.TunerFrontendIsdbtCapabilities.1
        /* JADX WARN: Can't rename method to resolve collision */
        @Override // android.os.Parcelable.Creator
        /* renamed from: createFromParcel */
        public TunerFrontendIsdbtCapabilities mo3559createFromParcel(Parcel _aidl_source) {
        ...
        public TunerFrontendIsdbtCapabilities[] mo3560newArray(int _aidl_size) {
    ...
    public final void writeToParcel(Parcel _aidl_parcel, int _aidl_flag) {
        ...
        _aidl_parcel.writeInt(this.modeCap);
    ...
    public final void readFromParcel(Parcel _aidl_parcel) {
        ...
        try {
            ...
            this.modeCap = _aidl_parcel.readInt();
            if (_aidl_parcel.dataPosition() - _aidl_start_pos >= _aidl_parcelable_size) {
                if (_aidl_start_pos > Integer.MAX_VALUE - _aidl_parcelable_size) {
                    throw new BadParcelableException("Overflow in the size of parcelable");
                }
