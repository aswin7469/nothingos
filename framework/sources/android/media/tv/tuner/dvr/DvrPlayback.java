...
public class DvrPlayback implements AutoCloseable {
            ...
            if (executor != null && this.mListener != null) {
                executor.execute(new Runnable() { // from class: android.media.tv.tuner.dvr.DvrPlayback$$ExternalSyntheticLambda0
                    ...
                    public final void run() {
                        DvrPlayback.this.lambda$onPlaybackStatusChanged$0$DvrPlayback(status);
                    }
                });
            }
        }
    ...
    public /* synthetic */ void lambda$onPlaybackStatusChanged$0$DvrPlayback(int status) {
    ...
    public long read(byte[] bytes, long offset, long size) {
