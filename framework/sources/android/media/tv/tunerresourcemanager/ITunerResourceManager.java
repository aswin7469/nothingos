                ...
                default:
                    switch (code) {
                        case 1:
                            ...
                            if (data.readInt() != 0) {
                                _arg0 = ResourceClientProfile.CREATOR.mo3559createFromParcel(data);
                            } else {
                                _arg0 = null;
                            }
                        ...
                        case 3:
                            ...
                            boolean updateClientPriority = updateClientPriority(_arg010, _arg19, _arg22);
                            reply.writeNoException();
                        ...
                        case 7:
                            data.enforceInterface(descriptor);
                            if (data.readInt() != 0) {
                                _arg02 = TunerFrontendRequest.CREATOR.mo3559createFromParcel(data);
                            } else {
                                _arg02 = null;
                            }
                        ...
                        case 9:
                            data.enforceInterface(descriptor);
                            if (data.readInt() != 0) {
                                _arg03 = TunerDemuxRequest.CREATOR.mo3559createFromParcel(data);
                            } else {
                                _arg03 = null;
                            }
                        ...
                        case 10:
                            data.enforceInterface(descriptor);
                            if (data.readInt() != 0) {
                                _arg04 = TunerDescramblerRequest.CREATOR.mo3559createFromParcel(data);
                            } else {
                                _arg04 = null;
                            }
                        ...
                        case 11:
                            data.enforceInterface(descriptor);
                            if (data.readInt() != 0) {
                                _arg05 = CasSessionRequest.CREATOR.mo3559createFromParcel(data);
                            } else {
                                _arg05 = null;
                            }
                        ...
                        case 12:
                            data.enforceInterface(descriptor);
                            if (data.readInt() != 0) {
                                _arg06 = TunerCiCamRequest.CREATOR.mo3559createFromParcel(data);
                            } else {
                                _arg06 = null;
                            }
                        ...
                        case 13:
                            data.enforceInterface(descriptor);
                            if (data.readInt() != 0) {
                                _arg07 = TunerLnbRequest.CREATOR.mo3559createFromParcel(data);
                            } else {
                                _arg07 = null;
                            }
                        ...
                        case 20:
                            data.enforceInterface(descriptor);
                            if (data.readInt() != 0) {
                                _arg08 = ResourceClientProfile.CREATOR.mo3559createFromParcel(data);
                            } else {
                                _arg08 = null;
                            }
                            if (data.readInt() != 0) {
                                _arg17 = ResourceClientProfile.CREATOR.mo3559createFromParcel(data);
                            } else {
                                _arg17 = null;
                            }
