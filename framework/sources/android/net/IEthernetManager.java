                ...
                default:
                    ...
                    switch (code) {
                        ...
                        case 3:
                            ...
                            if (data.readInt() != 0) {
                                _arg1 = (IpConfiguration) IpConfiguration.CREATOR.mo3559createFromParcel(data);
                            } else {
                                _arg1 = null;
                            }
        ...
        public static class Proxy implements IEthernetManager {
            ...
            public IpConfiguration getConfiguration(String iface) throws RemoteException {
                ...
                try {
                    ...
                    _reply.readException();
                    if (_reply.readInt() != 0) {
                        _result = (IpConfiguration) IpConfiguration.CREATOR.mo3559createFromParcel(_reply);
                    } else {
                        _result = null;
                    }
                    return _result;
