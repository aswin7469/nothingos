                ...
                default:
                    ...
                    switch (code) {
                        case 1:
                            ...
                            if (data.readInt() != 0) {
                                _arg0 = ConnectivityMetricsEvent.CREATOR.mo3559createFromParcel(data);
                            } else {
                                _arg0 = null;
                            }
                        ...
                        case 3:
                            data.enforceInterface(DESCRIPTOR);
                            if (data.readInt() != 0) {
                                _arg02 = (Network) Network.CREATOR.mo3559createFromParcel(data);
                            } else {
                                _arg02 = null;
                            }
                            ...
                            if (data.readInt() != 0) {
                                _arg3 = (LinkProperties) LinkProperties.CREATOR.mo3559createFromParcel(data);
                            } else {
                                _arg3 = null;
                            }
                            if (data.readInt() != 0) {
                                _arg4 = (NetworkCapabilities) NetworkCapabilities.CREATOR.mo3559createFromParcel(data);
                            } else {
                                _arg4 = null;
                            }
                            if (data.readInt() != 0) {
                                _arg5 = (Network) Network.CREATOR.mo3559createFromParcel(data);
                            } else {
                                _arg5 = null;
                            }
                            int _arg6 = data.readInt();
                            if (data.readInt() != 0) {
                                _arg7 = (LinkProperties) LinkProperties.CREATOR.mo3559createFromParcel(data);
                            } else {
                                _arg7 = null;
                            }
                            if (data.readInt() != 0) {
                                _arg8 = (NetworkCapabilities) NetworkCapabilities.CREATOR.mo3559createFromParcel(data);
                            } else {
                                _arg8 = null;
                            }
