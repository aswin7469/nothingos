                ...
                default:
                    ...
                    switch (code) {
                        ...
                        case 9:
                            ...
                            if (data.readInt() != 0) {
                                _arg1 = DataUsageRequest.CREATOR.mo3559createFromParcel(data);
                            } else {
                                _arg1 = null;
                            }
                            if (data.readInt() != 0) {
                        ...
                        case 10:
                            data.enforceInterface(DESCRIPTOR);
                            if (data.readInt() != 0) {
                                _arg0 = DataUsageRequest.CREATOR.mo3559createFromParcel(data);
                            } else {
                                _arg0 = null;
                            }
        ...
        public static class Proxy implements INetworkStatsService {
            ...
            public DataUsageRequest registerUsageCallback(String callingPackage, DataUsageRequest request, Messenger messenger, IBinder binder) throws RemoteException {
                ...
                try {
                    ...
                    _reply.readException();
                    if (_reply.readInt() != 0) {
                        _result = DataUsageRequest.CREATOR.mo3559createFromParcel(_reply);
                    } else {
                        _result = null;
                    }
                    return _result;
