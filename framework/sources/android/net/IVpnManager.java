                ...
                default:
                    ...
                    switch (code) {
                        ...
                        case 3:
                            data.enforceInterface(IVpnManager.DESCRIPTOR);
                            if (data.readInt() != 0) {
                                _arg0 = VpnConfig.CREATOR.mo3559createFromParcel(data);
                            } else {
                                _arg0 = null;
                            }
                        ...
                        case 7:
                            data.enforceInterface(IVpnManager.DESCRIPTOR);
                            if (data.readInt() != 0) {
                                _arg02 = VpnProfile.CREATOR.mo3559createFromParcel(data);
                            } else {
                                _arg02 = null;
                            }
                        ...
                        case 18:
                            data.enforceInterface(IVpnManager.DESCRIPTOR);
                            if (data.readInt() != 0) {
                                _arg03 = VpnProfile.CREATOR.mo3559createFromParcel(data);
                            } else {
                                _arg03 = null;
                            }
        ...
        public static class Proxy implements IVpnManager {
            ...
            public LegacyVpnInfo getLegacyVpnInfo(int userId) throws RemoteException {
                ...
                try {
                    ...
                    _reply.readException();
                    if (_reply.readInt() != 0) {
                        _result = LegacyVpnInfo.CREATOR.mo3559createFromParcel(_reply);
                    } else {
                        _result = null;
                    }
                    return _result;
            ...
            public VpnConfig getVpnConfig(int userId) throws RemoteException {
                ...
                try {
                    ...
                    _reply.readException();
                    if (_reply.readInt() != 0) {
                        _result = VpnConfig.CREATOR.mo3559createFromParcel(_reply);
                    } else {
                        _result = null;
                    }
                    return _result;
