...
public class NetworkPolicyManager {
    ...
    public static Iterator<Pair<ZonedDateTime, ZonedDateTime>> cycleIterator(NetworkPolicy policy) {
        ...
        return new Iterator<Pair<ZonedDateTime, ZonedDateTime>>() { // from class: android.net.NetworkPolicyManager.1
            ...
            @Override // java.util.Iterator
            /* renamed from: next */
            public Pair<ZonedDateTime, ZonedDateTime> mo1741next() {
                if (hasNext()) {
    ...
    public static void dispatchOnUidBlockedReasonChanged(Executor executor, NetworkPolicyCallback callback, int uid, int blockedReasons) {
        if (executor == null) {
            ...
            executor.execute(PooledLambda.obtainRunnable(NetworkPolicyManager$$ExternalSyntheticLambda0.INSTANCE, callback, Integer.valueOf(uid), Integer.valueOf(blockedReasons)).mo3494recycleOnUse());
        }
    }
