...
public class NetworkScoreManager {
    ...
    public class NetworkScoreCallbackProxy extends INetworkScoreCache.Stub {
            ...
            try {
                this.mExecutor.execute(new Runnable() { // from class: android.net.NetworkScoreManager$NetworkScoreCallbackProxy$$ExternalSyntheticLambda1
                    ...
                    public final void run() {
                        NetworkScoreManager.NetworkScoreCallbackProxy.this.lambda$updateScores$0$NetworkScoreManager$NetworkScoreCallbackProxy(networks);
                    }
                });
            } finally {
        ...
        public /* synthetic */ void lambda$updateScores$0$NetworkScoreManager$NetworkScoreCallbackProxy(List networks) {
        ...
        public void clearScores() {
            ...
            try {
                this.mExecutor.execute(new Runnable() { // from class: android.net.NetworkScoreManager$NetworkScoreCallbackProxy$$ExternalSyntheticLambda0
                    @Override // java.lang.Runnable
                    public final void run() {
                        NetworkScoreManager.NetworkScoreCallbackProxy.this.lambda$clearScores$1$NetworkScoreManager$NetworkScoreCallbackProxy();
                    }
                });
            } finally {
                Binder.restoreCallingIdentity(token);
        ...
        public /* synthetic */ void lambda$clearScores$1$NetworkScoreManager$NetworkScoreCallbackProxy() {
