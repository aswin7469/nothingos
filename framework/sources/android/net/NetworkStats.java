...
public final class NetworkStats implements Parcelable {
    ...
    public static final Parcelable.Creator<NetworkStats> CREATOR = new Parcelable.Creator<NetworkStats>() { // from class: android.net.NetworkStats.1
        ...
        public NetworkStats mo3559createFromParcel(Parcel in) {
        ...
        public NetworkStats[] mo3560newArray(int size) {
    ...
    /* renamed from: clone */
    public NetworkStats m1748clone() {
    ...
    public NetworkStats addEntry(Entry entry) {
        return m1748clone().combineValues(entry);
    }

    public NetworkStats add(NetworkStats another) {
        NetworkStats ret = m1748clone();
            ...
            if (Objects.equals(this.iface[i3], tunIface)) {
                ...
                if (iArr[i3] != i || i == 1000) {
                    ...
                    if (totalTxPackets2 > 0) {
                        ...
                        long txPacketsAcrossUnderlyingIfaces2 = j / totalTxBytes4;
                        txPacketsAcrossUnderlyingIfaces = Math.min(this.txPackets[i3], txPacketsAcrossUnderlyingIfaces2);
                    } else {
                        totalTxBytes = totalTxBytes2;
