...
public class NetworkStatsHistory implements Parcelable {
    public static final Parcelable.Creator<NetworkStatsHistory> CREATOR = new Parcelable.Creator<NetworkStatsHistory>() { // from class: android.net.NetworkStatsHistory.1
        ...
        public NetworkStatsHistory mo3559createFromParcel(Parcel in) {
        ...
        public NetworkStatsHistory[] mo3560newArray(int size) {
            ...
            while (i2 >= 0) {
                ...
                if (curStart <= j2) {
                    ...
                    if (overlap > 0) {
                        ...
                        long rxPackets2 = fracRxPackets;
                        long fracRxPackets3 = duration2;
                        long fracTxBytes = NetworkUtilsInternal.multiplySafeByRational(txBytes2, overlap, fracRxPackets3);
                        ...
                        duration2 -= overlap;
                        fracRxPackets = rxPackets2 - fracRxPackets2;
                        i2 = i - 1;
                        j = start;
                        j2 = end;
                    }
