...
public class ScoredNetwork implements Parcelable {
    ...
    public static final Parcelable.Creator<ScoredNetwork> CREATOR = new Parcelable.Creator<ScoredNetwork>() { // from class: android.net.ScoredNetwork.1
        ...
        public ScoredNetwork mo3559createFromParcel(Parcel in) {
        ...
        public ScoredNetwork[] mo3560newArray(int size) {
    ...
    private ScoredNetwork(Parcel in) {
        this.networkKey = NetworkKey.CREATOR.mo3559createFromParcel(in);
        boolean z = true;
        if (in.readByte() == 1) {
            this.rssiCurve = RssiCurve.CREATOR.mo3559createFromParcel(in);
        } else {
            this.rssiCurve = null;
        }
