...
public abstract class Uri implements Parcelable, Comparable<Uri> {
    ...
    public static final Parcelable.Creator<Uri> CREATOR = new Parcelable.Creator<Uri>() { // from class: android.net.Uri.1
        ...
        public Uri mo3559createFromParcel(Parcel in) {
            int type = in.readInt();
            switch (type) {
                case 0:
                    return null;
        ...
        public Uri[] mo3560newArray(int size) {
            return new Uri[size];
        }
    };
    ...
    public String toSafeString() {
        ...
        if (scheme != null) {
            ...
            builder2.append(ShortcutConstants.SERVICES_SEPARATOR);
        }
        if (ssp != null) {
            builder2.append(ssp);
        }
    ...
    public boolean getBooleanQueryParameter(String key, boolean defaultValue) {
        ...
        return !"false".equals(flag2) && !"0".equals(flag2);
    }
    ...
    public static abstract class AbstractPart {
        ...
        final void writeTo(Parcel parcel) {
            ...
            if (canonicalValue == NotCachedHolder.NOT_CACHED) {
                throw new AssertionError("Canonical value not cached (" + this.mCanonicalRepresentation + ")");
            }
    ...
    public static class PathPart extends AbstractPart {
        ...
        static PathPart makeAbsolute(PathPart oldPart) {
            ...
            if (oldPart.decoded == NotCachedHolder.NOT_CACHED) {
                decodedCached = false;
            }
            if (decodedCached) {
