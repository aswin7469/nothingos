                ...
                default:
                    ...
                    switch (code) {
                        ...
                        case 20:
                            data.enforceInterface(ILowpanInterface.DESCRIPTOR);
                            if (data.readInt() != 0) {
                                _arg0 = LowpanProvision.CREATOR.mo3559createFromParcel(data);
                            } else {
                                _arg0 = null;
                            }
                            join(_arg0);
                        ...
                        case 21:
                            data.enforceInterface(ILowpanInterface.DESCRIPTOR);
                            if (data.readInt() != 0) {
                                _arg02 = LowpanProvision.CREATOR.mo3559createFromParcel(data);
                            } else {
                                _arg02 = null;
                            }
                            form(_arg02);
                        ...
                        case 22:
                            data.enforceInterface(ILowpanInterface.DESCRIPTOR);
                            if (data.readInt() != 0) {
                                _arg03 = LowpanProvision.CREATOR.mo3559createFromParcel(data);
                            } else {
                                _arg03 = null;
                            }
                            attach(_arg03);
                        ...
                        case 25:
                            data.enforceInterface(ILowpanInterface.DESCRIPTOR);
                            if (data.readInt() != 0) {
                                _arg04 = LowpanBeaconInfo.CREATOR.mo3559createFromParcel(data);
                            } else {
                                _arg04 = null;
                            }
                        ...
                        case 31:
                            data.enforceInterface(ILowpanInterface.DESCRIPTOR);
                            ILowpanInterfaceListener _arg011 = ILowpanInterfaceListener.Stub.asInterface(data.readStrongBinder());
                            addListener(_arg011);
                            reply.writeNoException();
                            return true;
                        case 32:
                            data.enforceInterface(ILowpanInterface.DESCRIPTOR);
                            ILowpanInterfaceListener _arg012 = ILowpanInterfaceListener.Stub.asInterface(data.readStrongBinder());
                            removeListener(_arg012);
                            return true;
                        case 33:
                            data.enforceInterface(ILowpanInterface.DESCRIPTOR);
                            ClassLoader cl = getClass().getClassLoader();
                            Map _arg013 = data.readHashMap(cl);
                            ILowpanNetScanCallback _arg1 = ILowpanNetScanCallback.Stub.asInterface(data.readStrongBinder());
                            startNetScan(_arg013, _arg1);
                            reply.writeNoException();
                            return true;
                        case 34:
                            data.enforceInterface(ILowpanInterface.DESCRIPTOR);
                        ...
                        case 37:
                            data.enforceInterface(ILowpanInterface.DESCRIPTOR);
                            if (data.readInt() != 0) {
                                _arg05 = (IpPrefix) IpPrefix.CREATOR.mo3559createFromParcel(data);
                            } else {
                                _arg05 = null;
                            }
                            int _arg13 = data.readInt();
                            addOnMeshPrefix(_arg05, _arg13);
                            reply.writeNoException();
                            return true;
                        case 38:
                            data.enforceInterface(ILowpanInterface.DESCRIPTOR);
                            if (data.readInt() != 0) {
                                _arg06 = (IpPrefix) IpPrefix.CREATOR.mo3559createFromParcel(data);
                            } else {
                                _arg06 = null;
                            }
                        ...
                        case 39:
                            data.enforceInterface(ILowpanInterface.DESCRIPTOR);
                            if (data.readInt() != 0) {
                                _arg07 = (IpPrefix) IpPrefix.CREATOR.mo3559createFromParcel(data);
                            } else {
                                _arg07 = null;
                            }
                            int _arg14 = data.readInt();
                            addExternalRoute(_arg07, _arg14);
                            reply.writeNoException();
                            return true;
                        case 40:
                            data.enforceInterface(ILowpanInterface.DESCRIPTOR);
                            if (data.readInt() != 0) {
                                _arg08 = (IpPrefix) IpPrefix.CREATOR.mo3559createFromParcel(data);
                            } else {
                                _arg08 = null;
                            }
        ...
        public static class Proxy implements ILowpanInterface {
            ...
            public LowpanIdentity getLowpanIdentity() throws RemoteException {
                ...
                try {
                    ...
                    _reply.readException();
                    if (_reply.readInt() != 0) {
                        _result = LowpanIdentity.CREATOR.mo3559createFromParcel(_reply);
                    } else {
                        _result = null;
                    }
                    return _result;
            ...
            public LowpanCredential getLowpanCredential() throws RemoteException {
                ...
                try {
                    ...
                    _reply.readException();
                    if (_reply.readInt() != 0) {
                        _result = LowpanCredential.CREATOR.mo3559createFromParcel(_reply);
                    } else {
                        _result = null;
                    }
                    return _result;
