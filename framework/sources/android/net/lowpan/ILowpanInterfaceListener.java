                ...
                default:
                    ...
                    switch (code) {
                        ...
                        case 6:
                            data.enforceInterface(ILowpanInterfaceListener.DESCRIPTOR);
                            if (data.readInt() != 0) {
                                _arg0 = LowpanIdentity.CREATOR.mo3559createFromParcel(data);
                            } else {
                                _arg0 = null;
                            }
                        ...
                        case 7:
                            data.enforceInterface(ILowpanInterfaceListener.DESCRIPTOR);
                            if (data.readInt() != 0) {
                                _arg02 = (IpPrefix) IpPrefix.CREATOR.mo3559createFromParcel(data);
                            } else {
                                _arg02 = null;
                            }
                        ...
                        case 8:
                            data.enforceInterface(ILowpanInterfaceListener.DESCRIPTOR);
                            if (data.readInt() != 0) {
                                _arg03 = (IpPrefix) IpPrefix.CREATOR.mo3559createFromParcel(data);
                            } else {
                                _arg03 = null;
                            }
