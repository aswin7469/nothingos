...
public class LowpanProvision implements Parcelable {
    public static final Parcelable.Creator<LowpanProvision> CREATOR = new Parcelable.Creator<LowpanProvision>() { // from class: android.net.lowpan.LowpanProvision.1
        ...
        public LowpanProvision mo3559createFromParcel(Parcel in) {
            Builder builder = new Builder();
            builder.setLowpanIdentity(LowpanIdentity.CREATOR.mo3559createFromParcel(in));
            if (in.readBoolean()) {
                builder.setLowpanCredential(LowpanCredential.CREATOR.mo3559createFromParcel(in));
            }
        ...
        public LowpanProvision[] mo3560newArray(int size) {
