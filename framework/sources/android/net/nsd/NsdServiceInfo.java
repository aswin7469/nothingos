...
public final class NsdServiceInfo implements Parcelable {
    public static final Parcelable.Creator<NsdServiceInfo> CREATOR = new Parcelable.Creator<NsdServiceInfo>() { // from class: android.net.nsd.NsdServiceInfo.1
        ...
        public NsdServiceInfo mo3559createFromParcel(Parcel in) {
        ...
        public NsdServiceInfo[] mo3560newArray(int size) {
    ...
    public void setAttribute(String key, byte[] value) {
        ...
        int length = key.length() + txtRecordSize;
        if (value != null) {
            i3 = value.length;
        }
        int futureSize = length + i3 + 2;
        if (futureSize > 1300) {
