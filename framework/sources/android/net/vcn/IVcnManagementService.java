                ...
                default:
                    switch (code) {
                        case 1:
                            ...
                            if (data.readInt() != 0) {
                                _arg1 = VcnConfig.CREATOR.mo3559createFromParcel(data);
                            } else {
                                _arg1 = null;
                            }
                        ...
                        case 2:
                            data.enforceInterface(IVcnManagementService.DESCRIPTOR);
                            if (data.readInt() != 0) {
                                _arg02 = ParcelUuid.CREATOR.mo3559createFromParcel(data);
                            } else {
                                _arg02 = null;
                            }
                        ...
                        case 6:
                            data.enforceInterface(IVcnManagementService.DESCRIPTOR);
                            if (data.readInt() != 0) {
                                _arg03 = (NetworkCapabilities) NetworkCapabilities.CREATOR.mo3559createFromParcel(data);
                            } else {
                                _arg03 = null;
                            }
                            if (data.readInt() != 0) {
                                _arg12 = (LinkProperties) LinkProperties.CREATOR.mo3559createFromParcel(data);
                            } else {
                                _arg12 = null;
                            }
        ...
        public static class Proxy implements IVcnManagementService {
            ...
            public VcnUnderlyingNetworkPolicy getUnderlyingNetworkPolicy(NetworkCapabilities nc, LinkProperties lp) throws RemoteException {
                ...
                try {
                    ...
                    _reply.readException();
                    if (_reply.readInt() != 0) {
                        _result = VcnUnderlyingNetworkPolicy.CREATOR.mo3559createFromParcel(_reply);
                    } else {
                        _result = null;
                    }
                    return _result;
