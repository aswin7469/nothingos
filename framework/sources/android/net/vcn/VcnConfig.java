...
public final class VcnConfig implements Parcelable {
    ...
    public static final Parcelable.Creator<VcnConfig> CREATOR = new Parcelable.Creator<VcnConfig>() { // from class: android.net.vcn.VcnConfig.1
        ...
        public VcnConfig mo3559createFromParcel(Parcel in) {
        ...
        public VcnConfig[] mo3560newArray(int size) {
    ...
    public VcnConfig(PersistableBundle in) {
        ...
        this.mGatewayConnectionConfigs = new ArraySet(PersistableBundleUtils.toList(gatewayConnectionConfigsBundle, VcnConfig$$ExternalSyntheticLambda0.INSTANCE));
    ...
    public PersistableBundle toPersistableBundle() {
        ...
        PersistableBundle gatewayConnectionConfigsBundle = PersistableBundleUtils.fromList(new ArrayList(this.mGatewayConnectionConfigs), VcnConfig$$ExternalSyntheticLambda1.INSTANCE);
