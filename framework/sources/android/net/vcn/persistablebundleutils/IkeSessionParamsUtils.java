...
public final class IkeSessionParamsUtils {
    ...
    public static PersistableBundle toPersistableBundle(IkeSessionParams params) {
        ...
        PersistableBundle saProposalBundle = PersistableBundleUtils.fromList(params.getSaProposals(), IkeSessionParamsUtils$$ExternalSyntheticLambda2.INSTANCE);
        ...
        PersistableBundle configReqListBundle = PersistableBundleUtils.fromList(reqList, IkeSessionParamsUtils$$ExternalSyntheticLambda3.INSTANCE);
        ...
        int[] optionArray = enabledIkeOptions.stream().mapToInt(IkeSessionParamsUtils$$ExternalSyntheticLambda4.INSTANCE).toArray();
    ...
    public static IkeSessionParams fromPersistableBundle(PersistableBundle in) {
        ...
        List<IkeSaProposal> saProposals = PersistableBundleUtils.toList(proposalBundle, IkeSessionParamsUtils$$ExternalSyntheticLambda0.INSTANCE);
        ...
        List<ConfigRequest> reqList = PersistableBundleUtils.toList(configReqListBundle, IkeSessionParamsUtils$$ExternalSyntheticLambda1.INSTANCE);
    ...
    public static class IkeAuthDigitalSignConfigUtils {
        ...
        public static PersistableBundle toPersistableBundle(IkeSessionParams.IkeAuthDigitalSignLocalConfig config, PersistableBundle result) {
            try {
                ...
                PersistableBundle certsBundle = PersistableBundleUtils.fromList(encodedCertList, IkeSessionParamsUtils$IkeAuthDigitalSignConfigUtils$$ExternalSyntheticLambda1.INSTANCE);
        ...
        public static void setBuilderByReadingPersistableBundle(PersistableBundle localAuthBundle, PersistableBundle remoteAuthBundle, IkeSessionParams.Builder builder) {
            ...
            List<byte[]> encodedCertList = PersistableBundleUtils.toList(certsBundle, IkeSessionParamsUtils$IkeAuthDigitalSignConfigUtils$$ExternalSyntheticLambda0.INSTANCE);
