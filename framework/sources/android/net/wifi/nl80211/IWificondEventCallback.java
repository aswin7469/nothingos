...
public interface IWificondEventCallback extends IInterface {
    ...
    public static abstract class Stub extends Binder implements IWificondEventCallback {
        ...
        public static class Proxy implements IWificondEventCallback {
            public static IWificondEventCallback sDefaultImpl;
            ...
            public void OnRegDomainChanged(String countryCode) throws RemoteException {
                ...
                try {
                    ...
                    if (!_status && Stub.getDefaultImpl() != null) {
                        Stub.getDefaultImpl().OnRegDomainChanged(countryCode);
                    }
                } finally {
                    _data.recycle();
                }
        ...
        public static boolean setDefaultImpl(IWificondEventCallback impl) {
        ...
        public static IWificondEventCallback getDefaultImpl() {
