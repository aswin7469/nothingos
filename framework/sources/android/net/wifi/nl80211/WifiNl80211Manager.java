...
public class WifiNl80211Manager {
    ...
    public class WificondEventHandler extends IWificondEventCallback.Stub {
        ...
        public void OnRegDomainChanged(final String countryCode) {
            ...
            try {
                this.mCountryCodeChangedListenerHolder.forEach(new BiConsumer() { // from class: android.net.wifi.nl80211.WifiNl80211Manager$WificondEventHandler$$ExternalSyntheticLambda1
                    @Override // java.util.function.BiConsumer
                    public final void accept(Object obj, Object obj2) {
                        Executor executor = (Executor) obj2;
                        executor.execute(new Runnable() { // from class: android.net.wifi.nl80211.WifiNl80211Manager$WificondEventHandler$$ExternalSyntheticLambda0
    ...
    public class ScanEventHandler extends IScanEvent.Stub {
        ...
        public void OnScanResultReady() {
            ...
            try {
                this.mExecutor.execute(new Runnable() { // from class: android.net.wifi.nl80211.WifiNl80211Manager$ScanEventHandler$$ExternalSyntheticLambda1
                    @Override // java.lang.Runnable
                    public final void run() {
                        WifiNl80211Manager.ScanEventHandler.this.lambda$OnScanResultReady$0$WifiNl80211Manager$ScanEventHandler();
                    }
                });
            } finally {
                Binder.restoreCallingIdentity(token);
        ...
        public /* synthetic */ void lambda$OnScanResultReady$0$WifiNl80211Manager$ScanEventHandler() {
        ...
        public void OnScanFailed() {
            ...
            try {
                this.mExecutor.execute(new Runnable() { // from class: android.net.wifi.nl80211.WifiNl80211Manager$ScanEventHandler$$ExternalSyntheticLambda0
                    @Override // java.lang.Runnable
                    public final void run() {
                        WifiNl80211Manager.ScanEventHandler.this.lambda$OnScanFailed$1$WifiNl80211Manager$ScanEventHandler();
                    }
                });
            } finally {
                Binder.restoreCallingIdentity(token);
        ...
        public /* synthetic */ void lambda$OnScanFailed$1$WifiNl80211Manager$ScanEventHandler() {
    ...
    public class PnoScanEventHandler extends IPnoScanEvent.Stub {
        ...
        public void OnPnoNetworkFound() {
            ...
            try {
                this.mExecutor.execute(new Runnable() { // from class: android.net.wifi.nl80211.WifiNl80211Manager$PnoScanEventHandler$$ExternalSyntheticLambda0
                    @Override // java.lang.Runnable
                    public final void run() {
                        WifiNl80211Manager.PnoScanEventHandler.this.lambda$OnPnoNetworkFound$0$WifiNl80211Manager$PnoScanEventHandler();
                    }
                });
            } finally {
                Binder.restoreCallingIdentity(token);
        ...
        public /* synthetic */ void lambda$OnPnoNetworkFound$0$WifiNl80211Manager$PnoScanEventHandler() {
            this.mCallback.onScanResultReady();
        }
        ...
        public void OnPnoScanFailed() {
            ...
            try {
                this.mExecutor.execute(new Runnable() { // from class: android.net.wifi.nl80211.WifiNl80211Manager$PnoScanEventHandler$$ExternalSyntheticLambda1
                    @Override // java.lang.Runnable
                    public final void run() {
                        WifiNl80211Manager.PnoScanEventHandler.this.lambda$OnPnoScanFailed$1$WifiNl80211Manager$PnoScanEventHandler();
                    }
                });
            } finally {
                Binder.restoreCallingIdentity(token);
        ...
        public /* synthetic */ void lambda$OnPnoScanFailed$1$WifiNl80211Manager$PnoScanEventHandler() {
            this.mCallback.onScanFailed();
        }
    }
    ...
    public class ApInterfaceEventCallback extends IApInterfaceEventCallback.Stub {
        ...
        public void onSoftApChannelSwitched(final int frequency, final int bandwidth) {
            ...
            try {
                this.mExecutor.execute(new Runnable() { // from class: android.net.wifi.nl80211.WifiNl80211Manager$ApInterfaceEventCallback$$ExternalSyntheticLambda0
                    @Override // java.lang.Runnable
                    public final void run() {
                        WifiNl80211Manager.ApInterfaceEventCallback.this.lambda$onSoftApChannelSwitched$0$WifiNl80211Manager$ApInterfaceEventCallback(frequency, bandwidth);
                    }
                });
            } finally {
                Binder.restoreCallingIdentity(token);
        ...
        public /* synthetic */ void lambda$onSoftApChannelSwitched$0$WifiNl80211Manager$ApInterfaceEventCallback(int frequency, int bandwidth) {
    ...
    public class SendMgmtFrameEvent extends ISendMgmtFrameEvent.Stub {
        ...
        private Executor mExecutor;
        private AlarmManager.OnAlarmListener mTimeoutCallback = new AlarmManager.OnAlarmListener() { // from class: android.net.wifi.nl80211.WifiNl80211Manager$SendMgmtFrameEvent$$ExternalSyntheticLambda0
            @Override // android.app.AlarmManager.OnAlarmListener
            public final void onAlarm() {
                WifiNl80211Manager.SendMgmtFrameEvent.this.lambda$new$2$WifiNl80211Manager$SendMgmtFrameEvent();
            }
        };
        ...
        public /* synthetic */ void lambda$new$2$WifiNl80211Manager$SendMgmtFrameEvent() {
            runIfFirstCall(new Runnable() { // from class: android.net.wifi.nl80211.WifiNl80211Manager$SendMgmtFrameEvent$$ExternalSyntheticLambda2
                @Override // java.lang.Runnable
                public final void run() {
                    WifiNl80211Manager.SendMgmtFrameEvent.this.lambda$new$1$WifiNl80211Manager$SendMgmtFrameEvent();
                }
            });
        }

        public /* synthetic */ void lambda$new$1$WifiNl80211Manager$SendMgmtFrameEvent() {
            if (WifiNl80211Manager.this.mVerboseLoggingEnabled) {
                Log.e(WifiNl80211Manager.TAG, "Timed out waiting for ACK");
            }
            long token = Binder.clearCallingIdentity();
            try {
                this.mExecutor.execute(new Runnable() { // from class: android.net.wifi.nl80211.WifiNl80211Manager$SendMgmtFrameEvent$$ExternalSyntheticLambda1
                    @Override // java.lang.Runnable
                    public final void run() {
                        WifiNl80211Manager.SendMgmtFrameEvent.this.lambda$new$0$WifiNl80211Manager$SendMgmtFrameEvent();
                    }
                });
            } finally {
                Binder.restoreCallingIdentity(token);
        ...
        public /* synthetic */ void lambda$new$0$WifiNl80211Manager$SendMgmtFrameEvent() {
            this.mCallback.onFailure(4);
        }

        @Override // android.net.wifi.nl80211.ISendMgmtFrameEvent
        public void OnAck(final int elapsedTimeMs) {
            WifiNl80211Manager.this.mEventHandler.post(new Runnable() { // from class: android.net.wifi.nl80211.WifiNl80211Manager$SendMgmtFrameEvent$$ExternalSyntheticLambda5
                @Override // java.lang.Runnable
                public final void run() {
                    WifiNl80211Manager.SendMgmtFrameEvent.this.lambda$OnAck$5$WifiNl80211Manager$SendMgmtFrameEvent(elapsedTimeMs);
                }
            });
        }

        public /* synthetic */ void lambda$OnAck$5$WifiNl80211Manager$SendMgmtFrameEvent(final int elapsedTimeMs) {
            runIfFirstCall(new Runnable() { // from class: android.net.wifi.nl80211.WifiNl80211Manager$SendMgmtFrameEvent$$ExternalSyntheticLambda4
                @Override // java.lang.Runnable
                public final void run() {
                    WifiNl80211Manager.SendMgmtFrameEvent.this.lambda$OnAck$4$WifiNl80211Manager$SendMgmtFrameEvent(elapsedTimeMs);
                }
            });
        }

        public /* synthetic */ void lambda$OnAck$4$WifiNl80211Manager$SendMgmtFrameEvent(final int elapsedTimeMs) {
            WifiNl80211Manager.this.mAlarmManager.cancel(this.mTimeoutCallback);
            long token = Binder.clearCallingIdentity();
            try {
                this.mExecutor.execute(new Runnable() { // from class: android.net.wifi.nl80211.WifiNl80211Manager$SendMgmtFrameEvent$$ExternalSyntheticLambda3
                    @Override // java.lang.Runnable
                    public final void run() {
                        WifiNl80211Manager.SendMgmtFrameEvent.this.lambda$OnAck$3$WifiNl80211Manager$SendMgmtFrameEvent(elapsedTimeMs);
                    }
                });
            } finally {
                Binder.restoreCallingIdentity(token);
        ...
        public /* synthetic */ void lambda$OnAck$3$WifiNl80211Manager$SendMgmtFrameEvent(int elapsedTimeMs) {
            this.mCallback.onAck(elapsedTimeMs);
        }

        @Override // android.net.wifi.nl80211.ISendMgmtFrameEvent
        public void OnFailure(final int reason) {
            WifiNl80211Manager.this.mEventHandler.post(new Runnable() { // from class: android.net.wifi.nl80211.WifiNl80211Manager$SendMgmtFrameEvent$$ExternalSyntheticLambda8
                @Override // java.lang.Runnable
                public final void run() {
                    WifiNl80211Manager.SendMgmtFrameEvent.this.lambda$OnFailure$8$WifiNl80211Manager$SendMgmtFrameEvent(reason);
                }
            });
        }

        public /* synthetic */ void lambda$OnFailure$8$WifiNl80211Manager$SendMgmtFrameEvent(final int reason) {
            runIfFirstCall(new Runnable() { // from class: android.net.wifi.nl80211.WifiNl80211Manager$SendMgmtFrameEvent$$ExternalSyntheticLambda7
                @Override // java.lang.Runnable
                public final void run() {
                    WifiNl80211Manager.SendMgmtFrameEvent.this.lambda$OnFailure$7$WifiNl80211Manager$SendMgmtFrameEvent(reason);
                }
            });
        }

        public /* synthetic */ void lambda$OnFailure$7$WifiNl80211Manager$SendMgmtFrameEvent(final int reason) {
            WifiNl80211Manager.this.mAlarmManager.cancel(this.mTimeoutCallback);
            long token = Binder.clearCallingIdentity();
            try {
                this.mExecutor.execute(new Runnable() { // from class: android.net.wifi.nl80211.WifiNl80211Manager$SendMgmtFrameEvent$$ExternalSyntheticLambda6
                    @Override // java.lang.Runnable
                    public final void run() {
                        WifiNl80211Manager.SendMgmtFrameEvent.this.lambda$OnFailure$6$WifiNl80211Manager$SendMgmtFrameEvent(reason);
                    }
                });
            } finally {
                Binder.restoreCallingIdentity(token);
        ...
        public /* synthetic */ void lambda$OnFailure$6$WifiNl80211Manager$SendMgmtFrameEvent(int reason) {
    ...
    public void lambda$retrieveWificondAndRegisterForDeath$1$WifiNl80211Manager() {
        this.mEventHandler.post(new Runnable() { // from class: android.net.wifi.nl80211.WifiNl80211Manager$$ExternalSyntheticLambda6
            @Override // java.lang.Runnable
            public final void run() {
                WifiNl80211Manager.this.lambda$binderDied$0$WifiNl80211Manager();
            }
        });
    }

    public /* synthetic */ void lambda$binderDied$0$WifiNl80211Manager() {
            ...
            try {
                asInterface.asBinder().linkToDeath(new IBinder.DeathRecipient() { // from class: android.net.wifi.nl80211.WifiNl80211Manager$$ExternalSyntheticLambda0
                    ...
                    public final void binderDied() {
                        WifiNl80211Manager.this.lambda$retrieveWificondAndRegisterForDeath$1$WifiNl80211Manager();
                    }
                }, 0);
    ...
    public void sendMgmtFrame(String ifaceName, byte[] frame, int mcs, Executor executor, final SendMgmtFrameCallback callback) {
        if (callback == null || executor == null) {
            ...
            executor.execute(new Runnable() { // from class: android.net.wifi.nl80211.WifiNl80211Manager$$ExternalSyntheticLambda3
                @Override // java.lang.Runnable
                public final void run() {
