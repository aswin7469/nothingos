                ...
                default:
                    ...
                    switch (code) {
                        ...
                        case 15:
                            ...
                            if (data.readInt() != 0) {
                                _arg2 = TechListParcel.CREATOR.mo3559createFromParcel(data);
                            } else {
                                _arg2 = null;
                            }
                        ...
                        case 18:
                            data.enforceInterface(DESCRIPTOR);
                            if (data.readInt() != 0) {
                                _arg02 = BeamShareData.CREATOR.mo3559createFromParcel(data);
                            } else {
                                _arg02 = null;
                            }
                        ...
                        case 20:
                            data.enforceInterface(DESCRIPTOR);
                            if (data.readInt() != 0) {
                                _arg03 = Tag.CREATOR.mo3559createFromParcel(data);
                            } else {
                                _arg03 = null;
                            }
                            dispatch(_arg03);
