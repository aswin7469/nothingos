                ...
                default:
                    switch (code) {
                        ...
                        case 5:
                            ...
                            if (data.readInt() != 0) {
                                _arg2 = AidGroup.CREATOR.mo3559createFromParcel(data);
                            } else {
                                _arg2 = null;
                            }
                        ...
                        case 8:
                            ...
                            if (data.readInt() != 0) {
                                _arg18 = ComponentName.CREATOR.mo3559createFromParcel(data);
                            } else {
                                _arg18 = null;
                            }
        ...
        public static class Proxy implements INfcCardEmulation {
            ...
            public AidGroup getAidGroupForService(int userHandle, ComponentName service, String category) throws RemoteException {
                ...
                try {
                    ...
                    _reply.readException();
                    if (_reply.readInt() != 0) {
                        _result = AidGroup.CREATOR.mo3559createFromParcel(_reply);
                    } else {
                        _result = null;
                    }
                    return _result;
            ...
            public ApduServiceInfo getPreferredPaymentService(int userHandle) throws RemoteException {
                ...
                try {
                    ...
                    _reply.readException();
                    if (_reply.readInt() != 0) {
                        _result = ApduServiceInfo.CREATOR.mo3559createFromParcel(_reply);
                    } else {
                        _result = null;
                    }
                    return _result;
