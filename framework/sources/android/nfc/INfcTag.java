                ...
                default:
                    switch (code) {
                        ...
                        case 8:
                            ...
                            if (data.readInt() != 0) {
                                _arg1 = NdefMessage.CREATOR.mo3559createFromParcel(data);
                            } else {
                                _arg1 = null;
                            }
        ...
        public static class Proxy implements INfcTag {
            ...
            public TransceiveResult transceive(int nativeHandle, byte[] data, boolean raw) throws RemoteException {
                ...
                try {
                    ...
                    _reply.readException();
                    if (_reply.readInt() != 0) {
                        _result = TransceiveResult.CREATOR.mo3559createFromParcel(_reply);
                    } else {
                        _result = null;
                    }
                    return _result;
            ...
            public NdefMessage ndefRead(int nativeHandle) throws RemoteException {
                ...
                try {
                    ...
                    _reply.readException();
                    if (_reply.readInt() != 0) {
                        _result = NdefMessage.CREATOR.mo3559createFromParcel(_reply);
                    } else {
                        _result = null;
                    }
                    return _result;
            ...
            public Tag rediscover(int nativehandle) throws RemoteException {
                ...
                try {
                    ...
                    _reply.readException();
                    if (_reply.readInt() != 0) {
                        _result = Tag.CREATOR.mo3559createFromParcel(_reply);
                    } else {
                        _result = null;
                    }
                    return _result;
