...
public class NfcControllerAlwaysOnListener extends INfcControllerAlwaysOnListener.Stub {
        ...
        synchronized (this) {
            ...
            executor.execute(new Runnable() { // from class: android.nfc.NfcControllerAlwaysOnListener$$ExternalSyntheticLambda0
                ...
                public final void run() {
                    NfcControllerAlwaysOnListener.this.lambda$sendCurrentState$0$NfcControllerAlwaysOnListener(listener);
                }
            });
    ...
    public /* synthetic */ void lambda$sendCurrentState$0$NfcControllerAlwaysOnListener(NfcAdapter.ControllerAlwaysOnListener listener) {
