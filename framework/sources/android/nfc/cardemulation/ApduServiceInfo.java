...
public final class ApduServiceInfo implements Parcelable {
    public static final Parcelable.Creator<ApduServiceInfo> CREATOR = new Parcelable.Creator<ApduServiceInfo>() { // from class: android.nfc.cardemulation.ApduServiceInfo.1
        ...
        public ApduServiceInfo mo3559createFromParcel(Parcel source) {
            ResolveInfo info = ResolveInfo.CREATOR.mo3559createFromParcel(source);
        ...
        public ApduServiceInfo[] mo3560newArray(int size) {
