...
public final class CardEmulation {
    ...
    public List<String> getAidsForPreferredPaymentService() {
        try {
            ApduServiceInfo serviceInfo = sService.getPreferredPaymentService(this.mContext.getUserId());
            if (serviceInfo == null) {
                return null;
            }
            ...
            try {
                ApduServiceInfo serviceInfo2 = iNfcCardEmulation.getPreferredPaymentService(this.mContext.getUserId());
