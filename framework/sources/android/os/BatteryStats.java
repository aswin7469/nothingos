...
public abstract class BatteryStats implements Parcelable {
    ...
    public static abstract class ControllerActivityCounter {
        /* renamed from: getIdleTimeCounter */
        public abstract LongCounter mo3389getIdleTimeCounter();

        /* renamed from: getMonitoredRailChargeConsumedMaMs */
        public abstract LongCounter mo3390getMonitoredRailChargeConsumedMaMs();

        /* renamed from: getPowerCounter */
        public abstract LongCounter mo3391getPowerCounter();

        /* renamed from: getRxTimeCounter */
        public abstract LongCounter mo3392getRxTimeCounter();

        /* renamed from: getScanTimeCounter */
        public abstract LongCounter mo3393getScanTimeCounter();

        /* renamed from: getSleepTimeCounter */
        public abstract LongCounter mo3394getSleepTimeCounter();

        /* renamed from: getTxTimeCounters */
        public abstract LongCounter[] mo3395getTxTimeCounters();
    }
    ...
    /* renamed from: getPhoneDataConnectionTimer */
    public abstract Timer mo3380getPhoneDataConnectionTimer(int i);
    ...
    /* renamed from: getPhoneSignalScanningTimer */
    public abstract Timer mo3381getPhoneSignalScanningTimer();
    ...
    /* renamed from: getPhoneSignalStrengthTimer */
    protected abstract Timer mo3382getPhoneSignalStrengthTimer(int i);
    ...
    /* renamed from: getScreenBrightnessTimer */
    public abstract Timer mo3383getScreenBrightnessTimer(int i);
    ...
    /* renamed from: getWifiSignalStrengthTimer */
    public abstract Timer mo3384getWifiSignalStrengthTimer(int i);

    public abstract int getWifiStateCount(int i, int i2);

    public abstract long getWifiStateTime(int i, long j, int i2);

    /* renamed from: getWifiStateTimer */
    public abstract Timer mo3385getWifiStateTimer(int i);

    public abstract int getWifiSupplStateCount(int i, int i2);

    public abstract long getWifiSupplStateTime(int i, long j, int i2);

    /* renamed from: getWifiSupplStateTimer */
    public abstract Timer mo3386getWifiSupplStateTimer(int i);
    ...
    public static abstract class Timer {
        ...
        /* renamed from: getSubTimer */
        public Timer mo3396getSubTimer() {
            return null;
        }
    ...
    public static abstract class Uid {
        ...
        public static abstract class Sensor {
            ...
            /* renamed from: getSensorBackgroundTime */
            public abstract Timer mo3418getSensorBackgroundTime();

            /* renamed from: getSensorTime */
            public abstract Timer mo3419getSensorTime();
        }

        /* loaded from: classes2.dex */
        public static abstract class Wakelock {
            /* renamed from: getWakeTime */
            public abstract Timer mo3420getWakeTime(int i);
        }

        /* renamed from: getAggregatedPartialWakelockTimer */
        public abstract Timer mo3397getAggregatedPartialWakelockTimer();

        /* renamed from: getAudioTurnedOnTimer */
        public abstract Timer mo3398getAudioTurnedOnTimer();

        public abstract ControllerActivityCounter getBluetoothControllerActivity();

        public abstract long getBluetoothMeasuredBatteryConsumptionUC();

        /* renamed from: getBluetoothScanBackgroundTimer */
        public abstract Timer mo3399getBluetoothScanBackgroundTimer();

        /* renamed from: getBluetoothScanResultBgCounter */
        public abstract Counter mo3400getBluetoothScanResultBgCounter();

        /* renamed from: getBluetoothScanResultCounter */
        public abstract Counter mo3401getBluetoothScanResultCounter();

        /* renamed from: getBluetoothScanTimer */
        public abstract Timer mo3402getBluetoothScanTimer();

        /* renamed from: getBluetoothUnoptimizedScanBackgroundTimer */
        public abstract Timer mo3403getBluetoothUnoptimizedScanBackgroundTimer();

        /* renamed from: getBluetoothUnoptimizedScanTimer */
        public abstract Timer mo3404getBluetoothUnoptimizedScanTimer();

        /* renamed from: getCameraTurnedOnTimer */
        public abstract Timer mo3405getCameraTurnedOnTimer();
        ...
        /* renamed from: getFlashlightTurnedOnTimer */
        public abstract Timer mo3406getFlashlightTurnedOnTimer();

        /* renamed from: getForegroundActivityTimer */
        public abstract Timer mo3407getForegroundActivityTimer();

        /* renamed from: getForegroundServiceTimer */
        public abstract Timer mo3408getForegroundServiceTimer();
        ...
        /* renamed from: getMulticastWakelockStats */
        public abstract Timer mo3409getMulticastWakelockStats();
        ...
        /* renamed from: getProcessStateTimer */
        public abstract Timer mo3410getProcessStateTimer(int i);
        ...
        /* renamed from: getVibratorOnTimer */
        public abstract Timer mo3411getVibratorOnTimer();

        /* renamed from: getVideoTurnedOnTimer */
        public abstract Timer mo3412getVideoTurnedOnTimer();
        ...
        /* renamed from: getWifiScanBackgroundTimer */
        public abstract Timer mo3413getWifiScanBackgroundTimer();

        public abstract int getWifiScanCount(int i);

        public abstract long getWifiScanTime(long j, int i);

        /* renamed from: getWifiScanTimer */
        public abstract Timer mo3414getWifiScanTimer();
    ...
    public static final class HistoryItem {
        ...
        public void writeToParcel(Parcel dest, int flags) {
            ...
            int i = 0;
            int i2 = (this.cmd & 255) | ((this.batteryLevel << 8) & 65280) | ((this.batteryStatus << 16) & SurfaceControl.FX_SURFACE_MASK) | ((this.batteryHealth << IGnssVisibilityControlCallback.NfwRequestor.AUTOMOBILE_CLIENT) & 15728640) | ((this.batteryPlugType << 24) & 251658240) | (this.wakelockTag != null ? 268435456 : 0) | (this.wakeReasonTag != null ? 536870912 : 0);
            if (this.eventCode != 0) {
                i = 1073741824;
            }
            int bat = i2 | i;
    ...
    private static boolean controllerActivityHasData(ControllerActivityCounter counter, int which) {
        LongCounter[] mo3395getTxTimeCounters;
        if (counter == null) {
            return false;
        }
        if (counter.mo3389getIdleTimeCounter().getCountLocked(which) != 0 || counter.mo3392getRxTimeCounter().getCountLocked(which) != 0 || counter.mo3391getPowerCounter().getCountLocked(which) != 0 || counter.mo3390getMonitoredRailChargeConsumedMaMs().getCountLocked(which) != 0) {
            return true;
        }
        for (LongCounter c : counter.mo3395getTxTimeCounters()) {
    ...
    private static final void dumpControllerActivityLine(PrintWriter pw, int uid, String category, String type, ControllerActivityCounter counter, int which) {
        ...
        dumpLineHeader(pw, uid, category, type);
        pw.print(",");
        pw.print(counter.mo3389getIdleTimeCounter().getCountLocked(which));
        pw.print(",");
        pw.print(counter.mo3392getRxTimeCounter().getCountLocked(which));
        pw.print(",");
        pw.print(counter.mo3391getPowerCounter().getCountLocked(which) / 3600000.0d);
        pw.print(",");
        pw.print(counter.mo3390getMonitoredRailChargeConsumedMaMs().getCountLocked(which) / 3600000.0d);
        for (LongCounter c : counter.mo3395getTxTimeCounters()) {
            pw.print(",");
    ...
    private static void dumpControllerActivityProto(ProtoOutputStream proto, long fieldId, ControllerActivityCounter counter, int which) {
        ...
        proto.write(1112396529665L, counter.mo3389getIdleTimeCounter().getCountLocked(which));
        proto.write(1112396529666L, counter.mo3392getRxTimeCounter().getCountLocked(which));
        proto.write(1112396529667L, counter.mo3391getPowerCounter().getCountLocked(which) / 3600000.0d);
        proto.write(1103806595077L, counter.mo3390getMonitoredRailChargeConsumedMaMs().getCountLocked(which) / 3600000.0d);
        LongCounter[] txCounters = counter.mo3395getTxTimeCounters();
    ...
    private final void printControllerActivity(PrintWriter pw, StringBuilder sb, String prefix, String controllerName, ControllerActivityCounter counter, int which) {
        ...
        String[] powerLevel;
        long powerDrainMaMs;
        long idleTimeMs = counter.mo3389getIdleTimeCounter().getCountLocked(which);
        long rxTimeMs2 = counter.mo3392getRxTimeCounter().getCountLocked(which);
        long powerDrainMaMs2 = counter.mo3391getPowerCounter().getCountLocked(which);
        long monitoredRailChargeConsumedMaMs = counter.mo3390getMonitoredRailChargeConsumedMaMs().getCountLocked(which);
        long totalControllerActivityTimeMs = computeBatteryRealtime(SystemClock.elapsedRealtime() * 1000, which) / 1000;
        long totalTxTimeMs = 0;
        LongCounter[] mo3395getTxTimeCounters = counter.mo3395getTxTimeCounters();
        int length = mo3395getTxTimeCounters.length;
        int i2 = 0;
        while (i2 < length) {
            int i3 = length;
            LongCounter txState = mo3395getTxTimeCounters[i2];
        ...
        if (!controllerName.equals(WIFI_CONTROLLER_NAME)) {
            ...
            long scanTimeMs = counter.mo3393getScanTimeCounter().getCountLocked(which);
            sb.setLength(0);
            sb.append(prefix);
            sb.append("     ");
        ...
        if (!controllerName.equals(CELLULAR_CONTROLLER_NAME)) {
            ...
            i = which;
            long sleepTimeMs = counter.mo3394getSleepTimeCounter().getCountLocked(i);
            obj = CELLULAR_CONTROLLER_NAME;
            sb.setLength(0);
            sb.append(prefix);
            sb.append("     ");
        ...
        int numTxLvls = Math.min(counter.mo3395getTxTimeCounters().length, powerLevel.length);
        if (numTxLvls > 1) {
            pw.println(sb.toString());
            for (int lvl = 0; lvl < numTxLvls; lvl++) {
                long txLvlTimeMs = counter.mo3395getTxTimeCounters()[lvl].getCountLocked(i);
                sb.setLength(0);
                sb.append(prefix);
                sb.append("    ");
            ...
            long txLvlTimeMs2 = counter.mo3395getTxTimeCounters()[0].getCountLocked(i);
                ...
                if (histStart >= 0 && !printed2) {
                    ...
                    if (tracker != null) {
                        if (rec.cmd != 0) {
                            ...
                            byte b = historyTag == 1 ? (byte) 1 : (byte) 0;
                            byte b2 = historyTag == 1 ? (byte) 1 : (byte) 0;
                            byte b3 = historyTag == 1 ? (byte) 1 : (byte) 0;
                            byte b4 = historyTag == 1 ? (byte) 1 : (byte) 0;
                            byte b5 = historyTag == 1 ? (byte) 1 : (byte) 0;
                            rec.cmd = b;
                        }
    ...
    private void dumpProtoAppsLocked(ProtoOutputStream proto, BatteryStatsHelper helper, List<ApplicationInfo> apps) {
        ...
        while (iu < n) {
            ...
            if (u2.mo3397getAggregatedPartialWakelockTimer() == null) {
                rawRealtimeMs = rawRealtimeMs5;
            } else {
                Timer timer = u2.mo3397getAggregatedPartialWakelockTimer();
                rawRealtimeMs = rawRealtimeMs5;
                long totTimeMs = timer.getTotalDurationMsLocked(rawRealtimeMs);
                Timer bgTimer = timer.mo3396getSubTimer();
            ...
            Uid u3 = u2;
            dumpTimer(proto, 1146756268040L, u2.mo3398getAudioTurnedOnTimer(), rawRealtimeUs3, 0);
            dumpControllerActivityProto(proto, 1146756268035L, u3.getBluetoothControllerActivity(), 0);
            Timer bleTimer3 = u3.mo3402getBluetoothScanTimer();
            if (bleTimer3 != null) {
                long bmToken = proto.start(1146756268038L);
                dumpTimer(proto, 1146756268033L, bleTimer3, rawRealtimeUs3, 0);
                dumpTimer(proto, 1146756268034L, u3.mo3399getBluetoothScanBackgroundTimer(), rawRealtimeUs3, 0);
                dumpTimer(proto, 1146756268035L, u3.mo3404getBluetoothUnoptimizedScanTimer(), rawRealtimeUs3, 0);
                dumpTimer(proto, 1146756268036L, u3.mo3403getBluetoothUnoptimizedScanBackgroundTimer(), rawRealtimeUs3, 0);
                proto.write(1120986464261L, u3.mo3401getBluetoothScanResultCounter() != null ? u3.mo3401getBluetoothScanResultCounter().getCountLocked(0) : 0);
                proto.write(1120986464262L, u3.mo3400getBluetoothScanResultBgCounter() != null ? u3.mo3400getBluetoothScanResultBgCounter().getCountLocked(0) : 0);
                proto.end(bmToken);
            }
            dumpTimer(proto, 1146756268041L, u3.mo3405getCameraTurnedOnTimer(), rawRealtimeUs3, 0);
            ...
            dumpTimer(proto, 1146756268042L, u4.mo3406getFlashlightTurnedOnTimer(), rawRealtimeUs3, 0);
            dumpTimer(proto, 1146756268043L, u4.mo3407getForegroundActivityTimer(), rawRealtimeUs3, 0);
            dumpTimer(proto, 1146756268044L, u4.mo3408getForegroundServiceTimer(), rawRealtimeUs3, 0);
            ...
            for (int ij = jobs.size() - 1; ij >= 0; ij--) {
                ...
                Timer bgTimer2 = timer2.mo3396getSubTimer();
            ...
            proto.end(nToken2);
            BatterySipper bs2 = uidToSipper5.get(uid);
            if (bs2 != null) {
            ...
            ArrayMap<String, ? extends Uid.Proc> processStats2 = u5.getProcessStats();
            ...
            while (ise < sensors.size()) {
                ...
                Timer timer3 = se.mo3419getSensorTime();
                if (timer3 == null) {
                    processStats = processStats2;
                } else {
                    Timer bgTimer3 = se.mo3418getSensorBackgroundTime();
            ...
            while (isy >= 0) {
                ...
                Timer bgTimer4 = timer4.mo3396getSubTimer();
            ...
            dumpTimer(proto, 1146756268045L, u8.mo3411getVibratorOnTimer(), rawRealtimeUs6, 0);
            dumpTimer(proto, 1146756268046L, u8.mo3412getVideoTurnedOnTimer(), rawRealtimeUs6, 0);
            ...
            while (iw >= 0) {
                ...
                dumpTimer(proto, 1146756268034L, wl.mo3420getWakeTime(1), rawRealtimeUs6, 0);
                Timer pTimer = wl.mo3420getWakeTime(0);
                if (pTimer != null) {
                    dumpTimer(proto, 1146756268035L, pTimer, rawRealtimeUs6, 0);
                    dumpTimer(proto, 1146756268036L, pTimer.mo3396getSubTimer(), rawRealtimeUs6, 0);
                }
                dumpTimer(proto, 1146756268037L, wl.mo3420getWakeTime(2), rawRealtimeUs6, 0);
                proto.end(wToken);
                iw = iw2 - 1;
                wakelocks = wakelocks2;
            }
            dumpTimer(proto, 1146756268060L, u8.mo3409getMulticastWakelockStats(), rawRealtimeUs6, 0);
            int i5 = 1;
            int ipkg4 = packageStats.size() - 1;
            while (ipkg4 >= 0) {
                ArrayMap<String, ? extends Uid.Pkg> packageStats7 = packageStats;
                Uid.Pkg ps2 = packageStats7.valueAt(ipkg4);
            ...
            dumpTimer(proto, 1146756268035L, u8.mo3414getWifiScanTimer(), rawRealtimeUs6, 0);
            proto.write(1112396529666L, roundUsToMs(u8.getWifiRunningTime(rawRealtimeUs6, 0)));
            dumpTimer(proto, 1146756268036L, u8.mo3413getWifiScanBackgroundTimer(), rawRealtimeUs6, 0);
            proto.end(wToken2);
            proto.end(uTkn);
            iu = iu2 + 1;
    ...
    */
                    ...
                    if (rec.cmd != 5 && rec.cmd != 7 && rec.cmd != 4 && rec.cmd != 8) {
                        ...
                        if (tracker != null) {
                            if (rec.cmd != 0) {
                                ...
                                hprinter.printNextItem(proto, rec, baseTime, z2);
                                byte b = historyTag == 1 ? (byte) 1 : (byte) 0;
                                byte b2 = historyTag == 1 ? (byte) 1 : (byte) 0;
                                byte b3 = historyTag == 1 ? (byte) 1 : (byte) 0;
                                byte b4 = historyTag == 1 ? (byte) 1 : (byte) 0;
                            ...
                            rec.eventTag = new HistoryTag();
                            int i3 = 0;
                            HistoryTag oldEventTag3 = historyTag;
                            while (i3 < 22) {
                                ...
                                if (active == null) {
                                    ...
                                    for (Map.Entry<String, SparseIntArray> ent : active.entrySet()) {
                                        SparseIntArray uids = ent.getValue();
                                        int j = 0;
                                        HistoryTag oldEventTag5 = oldEventTag4;
                                        while (j < uids.size()) {
                                            rec.eventCode = i3;
                                            rec.eventTag.string = ent.getKey();
                                            rec.eventTag.uid = uids.keyAt(j);
                                            ...
                                            if ((flags & 32) != 0) {
                                                ...
                                                boolean z8 = oldEventTag5 == 1 ? 1 : 0;
                                                boolean z9 = oldEventTag5 == 1 ? 1 : 0;
                                                boolean z10 = oldEventTag5 == 1 ? 1 : 0;
                                                z = z8;
                                            }
                                            hprinter.printNextItem(proto, rec, baseTime, z);
                                            rec.wakeReasonTag = null;
                                            rec.wakelockTag = null;
                                            j++;
    ...
    private void dumpProtoSystemLocked(ProtoOutputStream proto, BatteryStatsHelper helper) {
        ...
        while (true) {
            ...
            rawRealtimeUs = rawRealtimeUs2;
            dumpTimer(proto, 1146756268035L, mo3380getPhoneDataConnectionTimer(i2), rawRealtimeUs, 0);
            proto.end(pdcToken);
            i2++;
        ...
        while (iu < uidStats.size()) {
            ...
            while (iw >= 0) {
                Uid.Wakelock wl = wakelocks.valueAt(iw);
                Timer fullWakeTimer = wl.mo3420getWakeTime(i4);
                ...
                Timer partialWakeTimer = wl.mo3420getWakeTime(i);
        ...
        for (int i6 = 0; i6 < 5; i6++) {
            ...
            dumpTimer(proto, 1146756268034L, mo3383getScreenBrightnessTimer(i6), rawRealtimeUs3, 0);
            proto.end(sbToken);
        }
        dumpTimer(proto, 1146756268053L, mo3381getPhoneSignalScanningTimer(), rawRealtimeUs3, 0);
        for (int i7 = 0; i7 < CellSignalStrength.getNumSignalStrengthLevels(); i7++) {
            ...
            dumpTimer(proto, 1146756268034L, mo3382getPhoneSignalStrengthTimer(i7), rawRealtimeUs3, 0);
            proto.end(pssToken);
        }
        ...
        for (int i8 = 0; i8 < 5; i8++) {
            ...
            dumpTimer(proto, 1146756268034L, mo3384getWifiSignalStrengthTimer(i8), rawRealtimeUs3, 0);
            proto.end(wssToken);
        }
        for (int i9 = 0; i9 < 8; i9++) {
            long wsToken = proto.start(2246267895833L);
            proto.write(1159641169921L, i9);
            dumpTimer(proto, 1146756268034L, mo3385getWifiStateTimer(i9), rawRealtimeUs3, 0);
            proto.end(wsToken);
        }
        for (int i10 = 0; i10 < 13; i10++) {
            long wssToken2 = proto.start(2246267895834L);
            proto.write(1159641169921L, i10);
            dumpTimer(proto, 1146756268034L, mo3386getWifiSupplStateTimer(i10), rawRealtimeUs3, 0);
            proto.end(wssToken2);
        }
        proto.end(sToken);
    }
