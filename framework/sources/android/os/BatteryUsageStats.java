...
public final class BatteryUsageStats implements Parcelable {
    ...
    public static final Parcelable.Creator<BatteryUsageStats> CREATOR = new Parcelable.Creator<BatteryUsageStats>() { // from class: android.os.BatteryUsageStats.1
        ...
        public BatteryUsageStats mo3559createFromParcel(Parcel source) {
        ...
        public BatteryUsageStats[] mo3560newArray(int size) {
    ...
    private BatteryUsageStats(Parcel source) {
        ...
        this.mAggregateBatteryConsumers = new AggregateBatteryConsumer[2];
        for (int i = 0; i < 2; i++) {
            this.mAggregateBatteryConsumers[i] = AggregateBatteryConsumer.CREATOR.mo3559createFromParcel(source);
        ...
        for (int i2 = 0; i2 < uidCount; i2++) {
            UidBatteryConsumer consumer = UidBatteryConsumer.CREATOR.mo3559createFromParcel(blob);
        ...
        for (int i3 = 0; i3 < userCount; i3++) {
            UserBatteryConsumer consumer2 = UserBatteryConsumer.CREATOR.mo3559createFromParcel(source);
        ...
        while (eventType != 1) {
            if (eventType == 2) {
                ...
                switch (name.hashCode()) {
                    case 115792:
                        if (name.equals(GrantCredentialsPermissionActivity.EXTRAS_REQUESTING_UID)) {
                            z = true;
                            break;
                        }
                        z = true;
