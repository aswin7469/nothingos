...
public final class BugreportManager {
    ...
    public final class DumpstateListener extends IDumpstateListener.Stub {
        ...
        public void onScreenshotTaken(final boolean success) throws RemoteException {
            ...
            mainThreadHandler.post(new Runnable() { // from class: android.os.BugreportManager$DumpstateListener$$ExternalSyntheticLambda4
                @Override // java.lang.Runnable
                public final void run() {
                    BugreportManager.DumpstateListener.this.lambda$onScreenshotTaken$3$BugreportManager$DumpstateListener(success);
                }
            });
        }

        public /* synthetic */ void lambda$onScreenshotTaken$3$BugreportManager$DumpstateListener(boolean success) {
            int message;
            if (success) {
        ...
        public void onUiIntensiveBugreportDumpsFinished() throws RemoteException {
            ...
            try {
                this.mExecutor.execute(new Runnable() { // from class: android.os.BugreportManager$DumpstateListener$$ExternalSyntheticLambda1
                    @Override // java.lang.Runnable
                    public final void run() {
                        BugreportManager.DumpstateListener.this.lambda$onUiIntensiveBugreportDumpsFinished$4$BugreportManager$DumpstateListener();
                    }
                });
            } finally {
                Binder.restoreCallingIdentity(identity);
        ...
        public /* synthetic */ void lambda$onUiIntensiveBugreportDumpsFinished$4$BugreportManager$DumpstateListener() {
