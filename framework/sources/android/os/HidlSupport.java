...
public class HidlSupport {
    ...
    public static boolean deepEquals(Object lft, Object rgt) {
        ...
        if (lftClazz.isArray()) {
            ...
            if (lftArray.length == rgtArray.length && IntStream.range(0, lftArray.length).allMatch(new IntPredicate() { // from class: android.os.HidlSupport$$ExternalSyntheticLambda0
            ...
            return rgtList.stream().allMatch(new Predicate() { // from class: android.os.HidlSupport$$ExternalSyntheticLambda1
    ...
    public static int deepHashCode(Object o) {
        ...
        if (clazz.isArray()) {
            ...
            return Arrays.hashCode(Arrays.stream((Object[]) o).mapToInt(HidlSupport$$ExternalSyntheticLambda2.INSTANCE).toArray());
        } else if (o instanceof List) {
            return Arrays.hashCode(((List) o).stream().mapToInt(HidlSupport$$ExternalSyntheticLambda3.INSTANCE).toArray());
        } else {
