                ...
                default:
                    switch (code) {
                        case 1:
                            ...
                            if (data.readInt() != 0) {
                                _arg0 = IncidentReportArgs.CREATOR.mo3559createFromParcel(data);
                            } else {
                                _arg0 = null;
                            }
                        ...
                        case 2:
                            data.enforceInterface(DESCRIPTOR);
                            if (data.readInt() != 0) {
                                _arg02 = IncidentReportArgs.CREATOR.mo3559createFromParcel(data);
                            } else {
                                _arg02 = null;
                            }
        ...
        public static class Proxy implements IIncidentManager {
            ...
            public void registerSection(int id, String name, IIncidentDumpCallback callback) throws RemoteException {
                ...
                try {
                    ...
                    if (!_status && Stub.getDefaultImpl() != null) {
                        Stub.getDefaultImpl().registerSection(id, name, callback);
                    }
                } finally {
                    _data.recycle();
                }
            ...
            public void unregisterSection(int id) throws RemoteException {
                ...
                try {
                    ...
                    if (!_status && Stub.getDefaultImpl() != null) {
                        Stub.getDefaultImpl().unregisterSection(id);
                    }
                } finally {
                    _data.recycle();
                }
            ...
            public IncidentManager.IncidentReport getIncidentReport(String pkg, String cls, String id) throws RemoteException {
                ...
                try {
                    ...
                    _reply.readException();
                    if (_reply.readInt() != 0) {
                        _result = IncidentManager.IncidentReport.CREATOR.mo3559createFromParcel(_reply);
                    } else {
                        _result = null;
                    }
                    return _result;
