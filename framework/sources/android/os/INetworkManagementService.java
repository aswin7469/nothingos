                ...
                default:
                    ...
                    switch (code) {
                        ...
                        case 5:
                            ...
                            if (data.readInt() != 0) {
                                _arg1 = InterfaceConfiguration.CREATOR.mo3559createFromParcel(data);
                            } else {
                                _arg1 = null;
                            }
                        ...
                        case 13:
                            ...
                            if (data.readInt() != 0) {
                                _arg12 = (RouteInfo) RouteInfo.CREATOR.mo3559createFromParcel(data);
                            } else {
                                _arg12 = null;
                            }
                        ...
                        case 14:
                            ...
                            if (data.readInt() != 0) {
                                _arg13 = (RouteInfo) RouteInfo.CREATOR.mo3559createFromParcel(data);
                            } else {
                                _arg13 = null;
                            }
        ...
        public static class Proxy implements INetworkManagementService {
            ...
            public InterfaceConfiguration getInterfaceConfig(String iface) throws RemoteException {
                ...
                try {
                    ...
                    _reply.readException();
                    if (_reply.readInt() != 0) {
                        _result = InterfaceConfiguration.CREATOR.mo3559createFromParcel(_reply);
                    } else {
                        _result = null;
                    }
                    return _result;
