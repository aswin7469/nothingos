                ...
                default:
                    switch (code) {
                        ...
                        case 6:
                            ...
                            if (data.readInt() != 0) {
                                _arg3 = CombinedVibration.CREATOR.mo3559createFromParcel(data);
                            } else {
                                _arg3 = null;
                            }
                            if (data.readInt() != 0) {
                                _arg4 = VibrationAttributes.CREATOR.mo3559createFromParcel(data);
                            } else {
                                _arg4 = null;
                            }
                        ...
                        case 7:
                            ...
                            if (data.readInt() != 0) {
                                _arg2 = CombinedVibration.CREATOR.mo3559createFromParcel(data);
                            } else {
                                _arg2 = null;
                            }
                            if (data.readInt() != 0) {
                                _arg32 = VibrationAttributes.CREATOR.mo3559createFromParcel(data);
                            } else {
                                _arg32 = null;
                            }
        ...
        public static class Proxy implements IVibratorManagerService {
            ...
            public VibratorInfo getVibratorInfo(int vibratorId) throws RemoteException {
                ...
                try {
                    ...
                    _reply.readException();
                    if (_reply.readInt() != 0) {
                        _result = VibratorInfo.CREATOR.mo3559createFromParcel(_reply);
                    } else {
                        _result = null;
                    }
                    return _result;
