...
public final class Looper {
    ...
    */
    private static boolean loopOnce(Looper me, long ident, int thresholdOverride) {
        ...
        boolean logSlowDelivery = slowDeliveryThresholdMs > 0 && msg3.when > 0;
        boolean logSlowDispatch = slowDispatchThresholdMs > 0;
        ...
        try {
            ...
            if (!logSlowDelivery) {
                ...
                str = TAG;
                z = true;
                if (showSlowLog(slowDeliveryThresholdMs, j, dispatchStart, Telephony.RcsColumns.RcsMessageDeliveryColumns.DELIVERY_URI_PART, msg3)) {
