...
public final class Parcel {
    ...
    public static final Parcelable.Creator<String> STRING_CREATOR = new Parcelable.Creator<String>() { // from class: android.os.Parcel.1
        ...
        public String mo3559createFromParcel(Parcel source) {
            return source.readString();
        }

        @Override // android.os.Parcelable.Creator
        /* renamed from: newArray  reason: collision with other method in class */
        public String[] mo3560newArray(int size) {
    ...
    public final CharSequence readCharSequence() {
        return TextUtils.CHAR_SEQUENCE_CREATOR.mo3559createFromParcel(this);
    }
    ...
    public final <T> T readTypedObject(Parcelable.Creator<T> c) {
        if (readInt() != 0) {
            return c.mo3559createFromParcel(this);
        }
        return null;
    }
    ...
    public final <T extends Parcelable> T readParcelable(ClassLoader loader) {
        ...
        if (creator instanceof Parcelable.ClassLoaderCreator) {
            ...
            return (T) classLoaderCreator.mo3532createFromParcel(this, loader);
        }
        return (T) creator.mo3559createFromParcel(this);
    }
