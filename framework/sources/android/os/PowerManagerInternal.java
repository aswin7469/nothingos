...
public abstract class PowerManagerInternal {
    ...
    public interface PowerControllerInternalCallback {
        void onWakeLockAcquired(String str, String str2, int i, int i2, WorkSource workSource);

        void onWakeLockChanging(String str, String str2, int i, int i2, WorkSource workSource, String str3, String str4, int i3, int i4, WorkSource workSource2);

        void onWakeLockReleased(String str, String str2, int i, int i2, WorkSource workSource);
    }
    ...
    public abstract void registerPowerControllerInternalCallback(PowerControllerInternalCallback powerControllerInternalCallback);
    ...
    public abstract void uidFreeze(int i, boolean z);
