...
public final class StrictMode {
    ...
    private static final Consumer<String> sNonSdkApiUsageConsumer = StrictMode$$ExternalSyntheticLambda3.INSTANCE;
    ...
    private static final ThreadLocal<Handler> THREAD_HANDLER = new ThreadLocal<Handler>() { // from class: android.os.StrictMode.3
        ...
        public Handler mo1957initialValue() {
            return new Handler();
        }
    };
    private static final ThreadLocal<AndroidBlockGuardPolicy> THREAD_ANDROID_POLICY = new ThreadLocal<AndroidBlockGuardPolicy>() { // from class: android.os.StrictMode.4
        ...
        @Override // java.lang.ThreadLocal
        /* renamed from: initialValue */
        public AndroidBlockGuardPolicy mo1958initialValue() {
    ...
    private static final ThreadLocal<ThreadSpanState> sThisThreadSpanState = new ThreadLocal<ThreadSpanState>() { // from class: android.os.StrictMode.8
        ...
        @Override // java.lang.ThreadLocal
        /* renamed from: initialValue */
        public ThreadSpanState mo1959initialValue() {
    ...
    private static Singleton<IWindowManager> sWindowManager = new Singleton<IWindowManager>() { // from class: android.os.StrictMode.9
        ...
        /* renamed from: create */
        public IWindowManager mo3561create() {
    ...
    static {
        StrictMode$$ExternalSyntheticLambda0 strictMode$$ExternalSyntheticLambda0 = StrictMode$$ExternalSyntheticLambda0.INSTANCE;
        LOGCAT_LOGGER = strictMode$$ExternalSyntheticLambda0;
        sLogger = strictMode$$ExternalSyntheticLambda0;
    }
    ...
    /* loaded from: classes2.dex */
    public static class MzStrictModeDetector {
        private static final int CLOSE = 0;
        private static final int OPEN = 1;
        private static boolean sInited = false;
        private static boolean sEnabled = false;

        private MzStrictModeDetector() {
        }

        static boolean tryInitThreadDefaults(ApplicationInfo ai) {
            StringBuilder sb = new StringBuilder();
            sb.append("tryInitThreadDefaults currentPackageName:");
            sb.append(ai != null ? ai.packageName : null);
            Log.d(StrictMode.TAG, sb.toString());
            if (isEnabled() && Build.VERSION.SDK_INT >= 23) {
                ThreadPolicy.Builder builder = new ThreadPolicy.Builder();
                StrictMode.setThreadPolicy(builder.detectDiskReads().detectDiskWrites().detectNetwork().detectCustomSlowCalls().detectResourceMismatches().penaltyDropBox().build());
                return true;
            }
            return false;
        }

        static boolean tryInitVmDefaults(ApplicationInfo ai) {
            StringBuilder sb = new StringBuilder();
            sb.append("tryInitVmDefaults currentPackageName:");
            String str = null;
            sb.append(ai != null ? ai.packageName : null);
            Log.d(StrictMode.TAG, sb.toString());
            if (isEnabled() && Build.VERSION.SDK_INT >= 23) {
                VmPolicy.Builder builder = new VmPolicy.Builder();
                StrictMode.setVmPolicy(builder.detectLeakedSqlLiteObjects().detectLeakedClosableObjects().detectActivityLeaks().detectCleartextNetwork().detectFileUriExposure().detectLeakedRegistrationObjects().penaltyDropBox().build());
                StringBuilder sb2 = new StringBuilder();
                sb2.append("enable StrictMode, do setVmPolicy currentPackageName:");
                if (ai != null) {
                    str = ai.packageName;
                }
                sb2.append(str);
                Log.e(StrictMode.TAG, sb2.toString());
                return true;
            }
            return false;
        }
        ...
        private static boolean isEnabled() {
            if (!sInited) {
                ...
                if (SystemProperties.getInt("persist.sys.at.open", 0) != 1 && SystemProperties.getInt("persist.sys.mz.iodb.detector", 0) != 1) {
                    enabled = false;
                }
                sEnabled = enabled;
                sInited = true;
    ...
    public static void initThreadDefaults(ApplicationInfo ai) {
        if (MzStrictModeDetector.tryInitThreadDefaults(ai)) {
            return;
        }
        ThreadPolicy.Builder builder = new ThreadPolicy.Builder();
    ...
    public static void initVmDefaults(ApplicationInfo ai) {
        if (MzStrictModeDetector.tryInitVmDefaults(ai)) {
            return;
        }
        VmPolicy.Builder builder = new VmPolicy.Builder();
        int targetSdkVersion = ai != null ? ai.targetSdkVersion : 10000;
    ...
    public static class AndroidBlockGuardPolicy implements BlockGuard.Policy {
        ...
        void handleViolationWithTimingAttempt(ViolationInfo info) {
            ...
            if (looper != null && info.mPenaltyMask != 268435456) {
                ...
                ((Handler) StrictMode.THREAD_HANDLER.get()).postAtFrontOfQueue(new Runnable() { // from class: android.os.StrictMode$AndroidBlockGuardPolicy$$ExternalSyntheticLambda0
        ...
        void onThreadPolicyViolation(ViolationInfo info) {
            ...
            if (!info.penaltyEnabled(268435456)) {
                ...
                if (listener != null && executor != null) {
                    try {
                        executor.execute(new Runnable() { // from class: android.os.StrictMode$AndroidBlockGuardPolicy$$ExternalSyntheticLambda1
                            @Override // java.lang.Runnable
                            public final void run() {
    ...
    public static void dropboxViolationAsync(final int penaltyMask, final ViolationInfo info) {
        ...
        BackgroundThread.getHandler().post(new Runnable() { // from class: android.os.StrictMode$$ExternalSyntheticLambda1
            @Override // java.lang.Runnable
            public final void run() {
    ...
    public static void onCleartextNetworkDetected(byte[] firstPacket) {
        ...
        if (rawAddr != null) {
            try {
                msg.append(" to ");
                msg.append(InetAddress.getByAddress(rawAddr));
            } catch (UnknownHostException e) {
            }
        }
        msg.append(HexDump.dumpHexString(firstPacket).trim());
        msg.append(' ');
    ...
    public static void onVmPolicyViolation(final Violation violation, boolean forceDeath) {
        ...
        if (sVmPolicy.mListener != null && sVmPolicy.mCallbackExecutor != null) {
            ...
            try {
                sVmPolicy.mCallbackExecutor.execute(new Runnable() { // from class: android.os.StrictMode$$ExternalSyntheticLambda2
                    @Override // java.lang.Runnable
                    public final void run() {
    ...
    */
    ...
    public static final class ViolationInfo implements Parcelable {
        public static final Parcelable.Creator<ViolationInfo> CREATOR = new Parcelable.Creator<ViolationInfo>() { // from class: android.os.StrictMode.ViolationInfo.1
            ...
            public ViolationInfo mo3559createFromParcel(Parcel in) {
            ...
            public ViolationInfo[] mo3560newArray(int size) {
    ...
    public static final class InstanceTracker {
        ...
        public InstanceTracker(Object instance) {
            ...
            synchronized (hashMap) {
                ...
                int newValue = 1;
                hashMap.put(cls, Integer.valueOf(value != null ? 1 + value.intValue() : newValue));
            }
        }
