...
public final class UidBatteryConsumer extends BatteryConsumer implements Parcelable {
    public static final Parcelable.Creator<UidBatteryConsumer> CREATOR = new Parcelable.Creator<UidBatteryConsumer>() { // from class: android.os.UidBatteryConsumer.1
        ...
        public UidBatteryConsumer mo3559createFromParcel(Parcel source) {
        ...
        public UidBatteryConsumer[] mo3560newArray(int size) {
    ...
    public void writeToXml(TypedXmlSerializer serializer) throws IOException {
        ...
        serializer.startTag(null, GrantCredentialsPermissionActivity.EXTRAS_REQUESTING_UID);
        serializer.attributeInt(null, GrantCredentialsPermissionActivity.EXTRAS_REQUESTING_UID, getUid());
        ...
        serializer.endTag(null, GrantCredentialsPermissionActivity.EXTRAS_REQUESTING_UID);
    }
    ...
    public static void createFromXml(TypedXmlPullParser parser, BatteryUsageStats.Builder builder) throws XmlPullParserException, IOException {
        int uid = parser.getAttributeInt(null, GrantCredentialsPermissionActivity.EXTRAS_REQUESTING_UID);
        Builder consumerBuilder = builder.getOrCreateUidBatteryConsumerBuilder(uid);
        int eventType = parser.getEventType();
        if (eventType != 2 || !parser.getName().equals(GrantCredentialsPermissionActivity.EXTRAS_REQUESTING_UID)) {
        ...
        while (true) {
            if ((eventType != 3 || !parser.getName().equals(GrantCredentialsPermissionActivity.EXTRAS_REQUESTING_UID)) && eventType != 1) {
