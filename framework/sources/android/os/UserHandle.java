...
public final class UserHandle implements Parcelable {
    ...
    private static final UserHandle[] CACHED_USER_INFOS = new UserHandle[4];

    static {
        int i = 0;
        while (true) {
            UserHandle[] userHandleArr = CACHED_USER_INFOS;
            if (i < userHandleArr.length) {
                ...
                CREATOR = new Parcelable.Creator<UserHandle>() { // from class: android.os.UserHandle.1
                    ...
                    public UserHandle mo3559createFromParcel(Parcel in) {
                    ...
                    public UserHandle[] mo3560newArray(int size) {
