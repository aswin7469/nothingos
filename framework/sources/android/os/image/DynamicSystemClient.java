...
public class DynamicSystemClient {
            ...
            if (executor != null) {
                executor.execute(new Runnable() { // from class: android.os.image.DynamicSystemClient$$ExternalSyntheticLambda0
                    ...
                    public final void run() {
                        DynamicSystemClient.this.lambda$notifyOnStatusChangedListener$0$DynamicSystemClient(status, cause, progress, detail);
                    }
                });
            } else {
    ...
    public /* synthetic */ void lambda$notifyOnStatusChangedListener$0$DynamicSystemClient(int status, int cause, long progress, Throwable detail) {
