                ...
                default:
                    switch (code) {
                        ...
                        case 2:
                            ...
                            if (data.readInt() != 0) {
                                _arg1 = DataLoaderParamsParcel.CREATOR.mo3559createFromParcel(data);
                            } else {
                                _arg1 = null;
                            }
                        ...
                        case 4:
                            ...
                            if (data.readInt() != 0) {
                                _arg12 = DataLoaderParamsParcel.CREATOR.mo3559createFromParcel(data);
                            } else {
                                _arg12 = null;
                            }
                            IDataLoaderStatusListener _arg24 = IDataLoaderStatusListener.Stub.asInterface(data.readStrongBinder());
                            if (data.readInt() != 0) {
                                _arg3 = StorageHealthCheckParams.CREATOR.mo3559createFromParcel(data);
                            } else {
                                _arg3 = null;
                            }
                        ...
                        case 10:
                            ...
                            if (data.readInt() != 0) {
                                _arg2 = IncrementalNewFileParams.CREATOR.mo3559createFromParcel(data);
                            } else {
                                _arg2 = null;
                            }
