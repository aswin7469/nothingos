...
public class VolumeInfo implements Parcelable {
    ...
    public static final Parcelable.Creator<VolumeInfo> CREATOR = new Parcelable.Creator<VolumeInfo>() { // from class: android.os.storage.VolumeInfo.2
        /* JADX WARN: Can't rename method to resolve collision */
        @Override // android.os.Parcelable.Creator
        /* renamed from: createFromParcel */
        public VolumeInfo mo3559createFromParcel(Parcel in) {
        ...
        public VolumeInfo[] mo3560newArray(int size) {
    ...
    public VolumeInfo(Parcel parcel) {
        ...
        if (parcel.readInt() != 0) {
            this.disk = DiskInfo.CREATOR.mo3559createFromParcel(parcel);
        } else {
            this.disk = null;
        }
    ...
    public boolean isVisibleForUser(int userId) {
        int i = this.type;
        if ((i == 0 || i == 5 || i == 2) && this.mountUserId == userId) {
            return isVisible();
        }
        return false;
    }
    ...
    public boolean isPrimaryEmulatedForUser(int userId) {
        String str = this.id;
        return str.equals("emulated;" + userId);
    }
    ...
    public StorageVolume buildStorageVolume(Context context, int userId, boolean reportUnmounted) {
        ...
        return new StorageVolume(this.id, userPath, internalPath, description, isPrimary(), removable, emulated, false, maxFileSize, new UserHandle(userId), uuid, derivedFsUuid, envState);
    }
