...
public class VolumeRecord implements Parcelable {
    public static final Parcelable.Creator<VolumeRecord> CREATOR = new Parcelable.Creator<VolumeRecord>() { // from class: android.os.storage.VolumeRecord.1
        ...
        public VolumeRecord mo3559createFromParcel(Parcel in) {
        ...
        public VolumeRecord[] mo3560newArray(int size) {
    ...
    public StorageVolume buildStorageVolume(Context context) {
        ...
        return new StorageVolume(id, userPath, internalPath, description == null ? context.getString(17039374) : description, false, true, false, false, 0L, user, null, this.fsUuid, "unknown");
    }
    ...
    /* renamed from: clone */
    public VolumeRecord m2025clone() {
