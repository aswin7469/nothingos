...
public final class PrimitiveSegment extends VibrationEffectSegment {
    public static final Parcelable.Creator<PrimitiveSegment> CREATOR = new Parcelable.Creator<PrimitiveSegment>() { // from class: android.os.vibrator.PrimitiveSegment.1
        ...
        public PrimitiveSegment mo3559createFromParcel(Parcel in) {
            in.readInt();
        ...
        public PrimitiveSegment[] mo3560newArray(int size) {
    ...
    public PrimitiveSegment mo2044resolve(int defaultAmplitude) {
        return this;
    }

    @Override // android.os.vibrator.VibrationEffectSegment
    /* renamed from: scale */
    public PrimitiveSegment mo2045scale(float scaleFactor) {
    ...
    public PrimitiveSegment mo2043applyEffectStrength(int effectStrength) {
        return this;
    }
