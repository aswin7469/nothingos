...
public final class RampSegment extends VibrationEffectSegment {
    public static final Parcelable.Creator<RampSegment> CREATOR = new Parcelable.Creator<RampSegment>() { // from class: android.os.vibrator.RampSegment.1
        ...
        public RampSegment mo3559createFromParcel(Parcel in) {
            in.readInt();
        ...
        public RampSegment[] mo3560newArray(int size) {
    ...
    public RampSegment mo2044resolve(int defaultAmplitude) {
        return this;
    }

    @Override // android.os.vibrator.VibrationEffectSegment
    /* renamed from: scale */
    public RampSegment mo2045scale(float scaleFactor) {
    ...
    public RampSegment mo2043applyEffectStrength(int effectStrength) {
        return this;
    }
