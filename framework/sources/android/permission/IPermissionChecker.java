                ...
                default:
                    ...
                    switch (code) {
                        case 1:
                            ...
                            if (data.readInt() != 0) {
                                _arg1 = AttributionSourceState.CREATOR.mo3559createFromParcel(data);
                            } else {
                                _arg1 = null;
                            }
                        ...
                        case 2:
                            ...
                            if (data.readInt() != 0) {
                                _arg12 = AttributionSourceState.CREATOR.mo3559createFromParcel(data);
                            } else {
                                _arg12 = null;
                            }
                            if (data.readInt() != 0) {
                        ...
                        case 3:
                            ...
                            if (data.readInt() != 0) {
                                _arg13 = AttributionSourceState.CREATOR.mo3559createFromParcel(data);
                            } else {
                                _arg13 = null;
                            }
