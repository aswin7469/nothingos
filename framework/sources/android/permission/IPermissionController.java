                ...
                default:
                    ...
                    switch (code) {
                        case 1:
                            ...
                            if (data.readInt() != 0) {
                                _arg4 = AndroidFuture.CREATOR.mo3559createFromParcel(data);
                            } else {
                                _arg4 = null;
                            }
                        ...
                        case 2:
                            data.enforceInterface(IPermissionController.DESCRIPTOR);
                            if (data.readInt() != 0) {
                                _arg02 = UserHandle.CREATOR.mo3559createFromParcel(data);
                            } else {
                                _arg02 = null;
                            }
                            if (data.readInt() != 0) {
                        ...
                        case 3:
                            data.enforceInterface(IPermissionController.DESCRIPTOR);
                            if (data.readInt() != 0) {
                                _arg03 = UserHandle.CREATOR.mo3559createFromParcel(data);
                            } else {
                                _arg03 = null;
                            }
                            if (data.readInt() != 0) {
                        ...
                        case 4:
                            ...
                            if (data.readInt() != 0) {
                                _arg2 = AndroidFuture.CREATOR.mo3559createFromParcel(data);
                            } else {
                                _arg2 = null;
                            }
                        ...
                        case 5:
                            ...
                            if (data.readInt() != 0) {
                                _arg14 = AndroidFuture.CREATOR.mo3559createFromParcel(data);
                            } else {
                                _arg14 = null;
                            }
                        ...
                        case 7:
                            ...
                            if (data.readInt() != 0) {
                                _arg22 = AndroidFuture.CREATOR.mo3559createFromParcel(data);
                            } else {
                                _arg22 = null;
                            }
                        ...
                        case 8:
                            ...
                            if (data.readInt() != 0) {
                                _arg23 = AndroidFuture.CREATOR.mo3559createFromParcel(data);
                            } else {
                                _arg23 = null;
                            }
                        ...
                        case 9:
                            ...
                            if (data.readInt() != 0) {
                                _arg15 = AdminPermissionControlParams.CREATOR.mo3559createFromParcel(data);
                            } else {
                                _arg15 = null;
                            }
                            if (data.readInt() != 0) {
                                _arg24 = AndroidFuture.CREATOR.mo3559createFromParcel(data);
                            } else {
                                _arg24 = null;
                            }
                        ...
                        case 10:
                            data.enforceInterface(IPermissionController.DESCRIPTOR);
                            if (data.readInt() != 0) {
                                _arg04 = AndroidFuture.CREATOR.mo3559createFromParcel(data);
                            } else {
                                _arg04 = null;
                            }
                        ...
                        case 12:
                            ...
                            if (data.readInt() != 0) {
                                _arg16 = AndroidFuture.CREATOR.mo3559createFromParcel(data);
                            } else {
                                _arg16 = null;
                            }
                        ...
                        case 13:
                            ...
                            if (data.readInt() != 0) {
                                _arg17 = AndroidFuture.CREATOR.mo3559createFromParcel(data);
                            } else {
                                _arg17 = null;
                            }
                        ...
                        case 14:
                            ...
                            if (data.readInt() != 0) {
                                _arg18 = AndroidFuture.CREATOR.mo3559createFromParcel(data);
                            } else {
                                _arg18 = null;
                            }
                        ...
                        case 15:
                            ...
                            if (data.readInt() != 0) {
                                _arg19 = AndroidFuture.CREATOR.mo3559createFromParcel(data);
                            } else {
                                _arg19 = null;
                            }
