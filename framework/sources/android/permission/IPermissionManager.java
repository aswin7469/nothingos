                ...
                default:
                    ...
                    switch (code) {
                        ...
                        case 5:
                            data.enforceInterface(IPermissionManager.DESCRIPTOR);
                            if (data.readInt() != 0) {
                                _arg0 = PermissionInfo.CREATOR.mo3559createFromParcel(data);
                            } else {
                                _arg0 = null;
                            }
                            if (data.readInt() != 0) {
                        ...
                        case 26:
                            data.enforceInterface(IPermissionManager.DESCRIPTOR);
                            if (data.readInt() != 0) {
                                _arg02 = AttributionSourceState.CREATOR.mo3559createFromParcel(data);
                            } else {
                                _arg02 = null;
                            }
                        ...
                        case 27:
                            data.enforceInterface(IPermissionManager.DESCRIPTOR);
                            if (data.readInt() != 0) {
                                _arg03 = AttributionSourceState.CREATOR.mo3559createFromParcel(data);
                            } else {
                                _arg03 = null;
                            }
        ...
        public static class Proxy implements IPermissionManager {
            ...
            public PermissionInfo getPermissionInfo(String permissionName, String packageName, int flags) throws RemoteException {
                ...
                try {
                    ...
                    _reply.readException();
                    if (_reply.readInt() != 0) {
                        _result = PermissionInfo.CREATOR.mo3559createFromParcel(_reply);
                    } else {
                        _result = null;
                    }
                    return _result;
