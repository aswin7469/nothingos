...
public final class PermissionControllerManager {
    ...
    public void revokeRuntimePermissions(final Map<String, List<String>> request, final boolean doDryRun, final int reason, Executor executor, final OnRevokeRuntimePermissionsCallback callback) {
        ...
        for (Map.Entry<String, List<String>> appRequest : request.entrySet()) {
            ...
            Preconditions.checkCollectionElementsNotNull(appRequest.getValue(), DeviceConfig.NAMESPACE_PERMISSIONS);
        }
        ...
        this.mRemoteService.postAsync(new ServiceConnector.Job() { // from class: android.permission.PermissionControllerManager$$ExternalSyntheticLambda3
            ...
            public final Object run(Object obj) {
                return PermissionControllerManager.this.lambda$revokeRuntimePermissions$0$PermissionControllerManager(request, doDryRun, reason, (IPermissionController) obj);
            }
        }).mo3360whenCompleteAsync((BiConsumer<? super R, ? super Throwable>) new BiConsumer() { // from class: android.permission.PermissionControllerManager$$ExternalSyntheticLambda25
    ...
    public /* synthetic */ CompletableFuture lambda$revokeRuntimePermissions$0$PermissionControllerManager(Map request, boolean doDryRun, int reason, IPermissionController service) throws Exception {
    ...
    public static /* synthetic */ void lambda$revokeRuntimePermissions$1(OnRevokeRuntimePermissionsCallback callback, Map revoked, Throwable err) {
        ...
        try {
            if (err != null) {
                String str = TAG;
                Log.e(str, "Failure when revoking runtime permissions " + revoked, err);
    ...
    public void setRuntimePermissionGrantStateByDeviceAdmin(final String callerPackageName, final AdminPermissionControlParams params, Executor executor, final Consumer<Boolean> callback) {
        ...
        }).mo3360whenCompleteAsync((BiConsumer<? super R, ? super Throwable>) new BiConsumer() { // from class: android.permission.PermissionControllerManager$$ExternalSyntheticLambda27
            @Override // java.util.function.BiConsumer
            public final void accept(Object obj, Object obj2) {
    ...
    public static /* synthetic */ void lambda$setRuntimePermissionGrantStateByDeviceAdmin$3(String callerPackageName, Consumer callback, Boolean setRuntimePermissionGrantStateResult, Throwable err) {
        ...
        try {
            if (err != null) {
                String str = TAG;
                Log.e(str, "Error setting permissions state for device admin " + callerPackageName, err);
    ...
    public void getRuntimePermissionBackup(final UserHandle user, Executor executor, final Consumer<byte[]> callback) {
        ...
        this.mRemoteService.postAsync(new ServiceConnector.Job() { // from class: android.permission.PermissionControllerManager$$ExternalSyntheticLambda1
            @Override // com.android.internal.infra.ServiceConnector.Job
            public final Object run(Object obj) {
                CompletableFuture receiveBytes;
                receiveBytes = RemoteStream.receiveBytes(new FunctionalUtils.ThrowingConsumer() { // from class: android.permission.PermissionControllerManager$$ExternalSyntheticLambda16
        ...
        }).mo3360whenCompleteAsync((BiConsumer<? super R, ? super Throwable>) new BiConsumer() { // from class: android.permission.PermissionControllerManager$$ExternalSyntheticLambda32
            @Override // java.util.function.BiConsumer
            public final void accept(Object obj, Object obj2) {
    ...
    public void stageAndApplyRuntimePermissionsBackup(final byte[] backup, final UserHandle user) {
        ...
        this.mRemoteService.postAsync(new ServiceConnector.Job() { // from class: android.permission.PermissionControllerManager$$ExternalSyntheticLambda2
            ...
            public final Object run(Object obj) {
                ...
                sendBytes = RemoteStream.sendBytes(new FunctionalUtils.ThrowingConsumer() { // from class: android.permission.PermissionControllerManager$$ExternalSyntheticLambda17
                    @Override // com.android.internal.util.FunctionalUtils.ThrowingConsumer
                    public final void acceptOrThrow(Object obj2) {
        ...
        }).mo3358whenComplete((BiConsumer<? super R, ? super Throwable>) PermissionControllerManager$$ExternalSyntheticLambda33.INSTANCE);
    }
    ...
    public void applyStagedRuntimePermissionBackup(final String packageName, final UserHandle user, Executor executor, final Consumer<Boolean> callback) {
        ...
        Preconditions.checkNotNull(callback);
        enforceSomePermissionsGrantedToSelf(Manifest.permission.GRANT_RUNTIME_PERMISSIONS, Manifest.permission.RESTORE_RUNTIME_PERMISSIONS);
        this.mRemoteService.postAsync(new ServiceConnector.Job() { // from class: android.permission.PermissionControllerManager$$ExternalSyntheticLambda9
            @Override // com.android.internal.infra.ServiceConnector.Job
            public final Object run(Object obj) {
        ...
        }).mo3360whenCompleteAsync((BiConsumer<? super R, ? super Throwable>) new BiConsumer() { // from class: android.permission.PermissionControllerManager$$ExternalSyntheticLambda26
            @Override // java.util.function.BiConsumer
            public final void accept(Object obj, Object obj2) {
    ...
    public static /* synthetic */ void lambda$applyStagedRuntimePermissionBackup$11(String packageName, Consumer callback, Boolean applyStagedRuntimePermissionBackupResult, Throwable err) {
        ...
        try {
            if (err != null) {
                String str = TAG;
                Log.e(str, "Error restoring delayed permissions for " + packageName, err);
        ...
        try {
            this.mRemoteService.postAsync(new ServiceConnector.Job() { // from class: android.permission.PermissionControllerManager$$ExternalSyntheticLambda4
                ...
                public final Object run(Object obj) {
                    ...
                    runAsync = AndroidFuture.runAsync(FunctionalUtils.uncheckExceptions(new FunctionalUtils.ThrowingRunnable() { // from class: android.permission.PermissionControllerManager$$ExternalSyntheticLambda18
    ...
    public void getAppPermissions(final String packageName, final OnGetAppPermissionResultCallback callback, Handler handler) {
        ...
        this.mRemoteService.postAsync(new ServiceConnector.Job() { // from class: android.permission.PermissionControllerManager$$ExternalSyntheticLambda5
            @Override // com.android.internal.infra.ServiceConnector.Job
            public final Object run(Object obj) {
                return PermissionControllerManager.lambda$getAppPermissions$14(packageName, (IPermissionController) obj);
            }
        }).mo3358whenComplete((BiConsumer<? super R, ? super Throwable>) new BiConsumer() { // from class: android.permission.PermissionControllerManager$$ExternalSyntheticLambda23
            @Override // java.util.function.BiConsumer
            public final void accept(Object obj, Object obj2) {
                Handler.this.post(new Runnable() { // from class: android.permission.PermissionControllerManager$$ExternalSyntheticLambda20
    ...
    public void revokeRuntimePermission(final String packageName, final String permissionName) {
        ...
        this.mRemoteService.run(new ServiceConnector.VoidJob() { // from class: android.permission.PermissionControllerManager$$ExternalSyntheticLambda15
    ...
    public void countPermissionApps(final List<String> permissionNames, final int flags, final OnCountPermissionAppsResultCallback callback, Handler handler) {
        ...
        Preconditions.checkNotNull(callback);
        final Handler finalHandler = handler != null ? handler : this.mHandler;
        this.mRemoteService.postAsync(new ServiceConnector.Job() { // from class: android.permission.PermissionControllerManager$$ExternalSyntheticLambda11
            @Override // com.android.internal.infra.ServiceConnector.Job
            public final Object run(Object obj) {
                return PermissionControllerManager.lambda$countPermissionApps$18(permissionNames, flags, (IPermissionController) obj);
            }
        }).mo3358whenComplete((BiConsumer<? super R, ? super Throwable>) new BiConsumer() { // from class: android.permission.PermissionControllerManager$$ExternalSyntheticLambda22
            @Override // java.util.function.BiConsumer
            public final void accept(Object obj, Object obj2) {
                Handler.this.post(new Runnable() { // from class: android.permission.PermissionControllerManager$$ExternalSyntheticLambda19
                    @Override // java.lang.Runnable
                    public final void run() {
    ...
    public void getPermissionUsages(final boolean countSystem, final long numMillis, Executor executor, final OnPermissionUsageResultCallback callback) {
        ...
        }).mo3360whenCompleteAsync((BiConsumer<? super R, ? super Throwable>) new BiConsumer() { // from class: android.permission.PermissionControllerManager$$ExternalSyntheticLambda24
            @Override // java.util.function.BiConsumer
            public final void accept(Object obj, Object obj2) {
    ...
    public void grantOrUpgradeDefaultRuntimePermissions(Executor executor, final Consumer<Boolean> callback) {
        this.mRemoteService.postAsync(PermissionControllerManager$$ExternalSyntheticLambda13.INSTANCE).mo3360whenCompleteAsync((BiConsumer<? super R, ? super Throwable>) new BiConsumer() { // from class: android.permission.PermissionControllerManager$$ExternalSyntheticLambda30
            @Override // java.util.function.BiConsumer
            public final void accept(Object obj, Object obj2) {
    ...
    public void getPrivilegesDescriptionStringForProfile(final String profileName, Executor executor, final Consumer<CharSequence> callback) {
        ...
        }).mo3360whenCompleteAsync((BiConsumer<? super R, ? super Throwable>) new BiConsumer() { // from class: android.permission.PermissionControllerManager$$ExternalSyntheticLambda31
            @Override // java.util.function.BiConsumer
            public final void accept(Object obj, Object obj2) {
    ...
    public void updateUserSensitiveForApp(final int uid) {
        ...
        }).mo3358whenComplete((BiConsumer<? super R, ? super Throwable>) new BiConsumer() { // from class: android.permission.PermissionControllerManager$$ExternalSyntheticLambda21
            @Override // java.util.function.BiConsumer
            public final void accept(Object obj, Object obj2) {
    ...
    public static /* synthetic */ void lambda$updateUserSensitiveForApp$28(int uid, Void res, Throwable err) {
        if (err != null) {
            String str = TAG;
            Log.e(str, "Error updating user_sensitive flags for uid " + uid, err);
        }
    }

    public void notifyOneTimePermissionSessionTimeout(final String packageName) {
        this.mRemoteService.run(new ServiceConnector.VoidJob() { // from class: android.permission.PermissionControllerManager$$ExternalSyntheticLambda14
            @Override // com.android.internal.infra.ServiceConnector.VoidJob
            public final void runNoResult(Object obj) {
    ...
    public void getPlatformPermissionsForGroup(final String permissionGroupName, Executor executor, final Consumer<List<String>> callback) {
        this.mRemoteService.postAsync(new ServiceConnector.Job() { // from class: android.permission.PermissionControllerManager$$ExternalSyntheticLambda7
            @Override // com.android.internal.infra.ServiceConnector.Job
            public final Object run(Object obj) {
        ...
        }).mo3360whenCompleteAsync((BiConsumer<? super R, ? super Throwable>) new BiConsumer() { // from class: android.permission.PermissionControllerManager$$ExternalSyntheticLambda29
            @Override // java.util.function.BiConsumer
            public final void accept(Object obj, Object obj2) {
    ...
    public static /* synthetic */ void lambda$getPlatformPermissionsForGroup$31(String permissionGroupName, Consumer callback, List result, Throwable err) {
        ...
        try {
            if (err != null) {
                String str = TAG;
                Log.e(str, "Failed to get permissions of " + permissionGroupName, err);
    ...
    public void getGroupOfPlatformPermission(final String permissionName, Executor executor, final Consumer<String> callback) {
        ...
        }).mo3360whenCompleteAsync((BiConsumer<? super R, ? super Throwable>) new BiConsumer() { // from class: android.permission.PermissionControllerManager$$ExternalSyntheticLambda28
            @Override // java.util.function.BiConsumer
            public final void accept(Object obj, Object obj2) {
    ...
    public static /* synthetic */ void lambda$getGroupOfPlatformPermission$33(String permissionName, Consumer callback, String result, Throwable err) {
        ...
        try {
            if (err != null) {
                String str = TAG;
                Log.e(str, "Failed to get group of " + permissionName, err);
                callback.accept(null);
            } else {
                callback.accept(result);
            }
