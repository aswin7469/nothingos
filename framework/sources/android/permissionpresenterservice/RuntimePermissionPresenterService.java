...
public abstract class RuntimePermissionPresenterService extends Service {
    ...
    class AnonymousClass1 extends IRuntimePermissionPresenter.Stub {
        ...
        public void getAppPermissions(String packageName, RemoteCallback callback) {
            ...
            RuntimePermissionPresenterService.this.mHandler.sendMessage(PooledLambda.obtainMessage(RuntimePermissionPresenterService$1$$ExternalSyntheticLambda0.INSTANCE, RuntimePermissionPresenterService.this, packageName, callback));
        }
    }
