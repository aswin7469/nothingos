...
public class PreferenceGroupAdapter extends BaseAdapter implements Preference.OnPreferenceChangeInternalListener {
    ...
    private ArrayList<PreferenceLayout> mPreferenceLayouts = new ArrayList<>();
    ...
    public Preference mo3505getItem(int position) {
    ...
    public long getItemId(int position) {
        ...
        return mo3505getItem(position).getId();
    }
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        Preference preference = mo3505getItem(position);
    ...
    public boolean isEnabled(int position) {
        ...
        return mo3505getItem(position).isSelectable();
    }
