                ...
                default:
                    ...
                    switch (code) {
                        case 1:
                            ...
                            List<PrintJobInfo> _result = getPrintJobInfos(_arg08, _arg1);
                        ...
                        case 2:
                            data.enforceInterface(DESCRIPTOR);
                            if (data.readInt() != 0) {
                                _arg0 = PrintJobId.CREATOR.mo3559createFromParcel(data);
                            } else {
                                _arg0 = null;
                            }
                        ...
                        case 3:
                            ...
                            if (data.readInt() != 0) {
                                _arg2 = PrintAttributes.CREATOR.mo3559createFromParcel(data);
                            } else {
                                _arg2 = null;
                            }
                        ...
                        case 4:
                            data.enforceInterface(DESCRIPTOR);
                            if (data.readInt() != 0) {
                                _arg02 = PrintJobId.CREATOR.mo3559createFromParcel(data);
                            } else {
                                _arg02 = null;
                            }
                        ...
                        case 5:
                            data.enforceInterface(DESCRIPTOR);
                            if (data.readInt() != 0) {
                                _arg03 = PrintJobId.CREATOR.mo3559createFromParcel(data);
                            } else {
                                _arg03 = null;
                            }
                        ...
                        case 7:
                            ...
                            removePrintJobStateChangeListener(_arg011, _arg17);
                            reply.writeNoException();
                            return true;
                        case 8:
                            data.enforceInterface(DESCRIPTOR);
                            ...
                            addPrintServicesChangeListener(_arg012, _arg18);
                            reply.writeNoException();
                            return true;
                        case 9:
                            data.enforceInterface(DESCRIPTOR);
                            ...
                            removePrintServicesChangeListener(_arg013, _arg19);
                            reply.writeNoException();
                            return true;
                        case 10:
                            data.enforceInterface(DESCRIPTOR);
                            ...
                            List<PrintServiceInfo> _result4 = getPrintServices(_arg014, _arg110);
                            reply.writeNoException();
                        ...
                        case 11:
                            ...
                            setPrintServiceEnabled(_arg04, _arg111, _arg26);
                            reply.writeNoException();
                            return true;
                        case 12:
                            data.enforceInterface(DESCRIPTOR);
                            ...
                            addPrintServiceRecommendationsChangeListener(_arg015, _arg112);
                            reply.writeNoException();
                            return true;
                        case 13:
                            data.enforceInterface(DESCRIPTOR);
                            ...
                            removePrintServiceRecommendationsChangeListener(_arg016, _arg113);
                            reply.writeNoException();
                            return true;
                        case 14:
                            data.enforceInterface(DESCRIPTOR);
                        ...
                        case 15:
                            ...
                            createPrinterDiscoverySession(_arg018, _arg114);
                            reply.writeNoException();
                            return true;
                        case 16:
                            data.enforceInterface(DESCRIPTOR);
                            ...
                            startPrinterDiscovery(_arg019, _arg115, _arg27);
                            reply.writeNoException();
                            return true;
                        case 17:
                            data.enforceInterface(DESCRIPTOR);
                            ...
                            stopPrinterDiscovery(_arg020, _arg116);
                            reply.writeNoException();
                            return true;
                        case 18:
                            data.enforceInterface(DESCRIPTOR);
                            ...
                            validatePrinters(_arg021, _arg117);
                            reply.writeNoException();
                            return true;
                        case 19:
                            data.enforceInterface(DESCRIPTOR);
                            if (data.readInt() != 0) {
                                _arg05 = PrinterId.CREATOR.mo3559createFromParcel(data);
                            } else {
                                _arg05 = null;
                            }
                            int _arg118 = data.readInt();
                            startPrinterStateTracking(_arg05, _arg118);
                            reply.writeNoException();
                            return true;
                        case 20:
                            data.enforceInterface(DESCRIPTOR);
                            if (data.readInt() != 0) {
                                _arg06 = PrinterId.CREATOR.mo3559createFromParcel(data);
                            } else {
                                _arg06 = null;
                            }
                            int _arg119 = data.readInt();
                            Icon _result6 = getCustomPrinterIcon(_arg06, _arg119);
                            reply.writeNoException();
                            if (_result6 != null) {
                                reply.writeInt(1);
                        ...
                        case 21:
                            data.enforceInterface(DESCRIPTOR);
                            if (data.readInt() != 0) {
                                _arg07 = PrinterId.CREATOR.mo3559createFromParcel(data);
                            } else {
                                _arg07 = null;
                            }
                            int _arg120 = data.readInt();
                            stopPrinterStateTracking(_arg07, _arg120);
                            reply.writeNoException();
                            return true;
                        case 22:
                            data.enforceInterface(DESCRIPTOR);
        ...
        public static class Proxy implements IPrintManager {
            ...
            public PrintJobInfo getPrintJobInfo(PrintJobId printJobId, int appId, int userId) throws RemoteException {
                ...
                try {
                    ...
                    _reply.readException();
                    if (_reply.readInt() != 0) {
                        _result = PrintJobInfo.CREATOR.mo3559createFromParcel(_reply);
                    } else {
                        _result = null;
                    }
                    return _result;
            ...
            public Icon getCustomPrinterIcon(PrinterId printerId, int userId) throws RemoteException {
                ...
                try {
                    ...
                    _reply.readException();
                    if (_reply.readInt() != 0) {
                        _result = Icon.CREATOR.mo3559createFromParcel(_reply);
                    } else {
                        _result = null;
                    }
                    return _result;
