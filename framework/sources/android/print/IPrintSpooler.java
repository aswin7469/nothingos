                ...
                default:
                    switch (code) {
                        ...
                        case 4:
                            data.enforceInterface(DESCRIPTOR);
                            if (data.readInt() != 0) {
                                _arg02 = PrintJobInfo.CREATOR.mo3559createFromParcel(data);
                            } else {
                                _arg02 = null;
                            }
                        ...
                        case 6:
                            data.enforceInterface(DESCRIPTOR);
                            if (data.readInt() != 0) {
                                _arg04 = PrintJobId.CREATOR.mo3559createFromParcel(data);
                            } else {
                                _arg04 = null;
                            }
                        ...
                        case 10:
                            data.enforceInterface(DESCRIPTOR);
                            if (data.readInt() != 0) {
                                _arg08 = PrinterId.CREATOR.mo3559createFromParcel(data);
                            } else {
                                _arg08 = null;
                            }
                        ...
                        case 12:
                            data.enforceInterface(DESCRIPTOR);
                            if (data.readInt() != 0) {
                                _arg09 = PrintJobId.CREATOR.mo3559createFromParcel(data);
                            } else {
                                _arg09 = null;
                            }
                        ...
                        case 13:
                            ...
                            if (data.readInt() != 0) {
                                _arg14 = PrintJobId.CREATOR.mo3559createFromParcel(data);
                            } else {
                                _arg14 = null;
                            }
                        ...
                        case 15:
                            data.enforceInterface(DESCRIPTOR);
                            if (data.readInt() != 0) {
                                _arg011 = PrintJobId.CREATOR.mo3559createFromParcel(data);
                            } else {
                                _arg011 = null;
                            }
