...
public final class PrintAttributes implements Parcelable {
    ...
    public static final Parcelable.Creator<PrintAttributes> CREATOR = new Parcelable.Creator<PrintAttributes>() { // from class: android.print.PrintAttributes.1
        ...
        public PrintAttributes mo3559createFromParcel(Parcel parcel) {
        ...
        public PrintAttributes[] mo3560newArray(int size) {
    ...
    public static final class MediaSize {
        ...
        public static final MediaSize NA_GOVT_LETTER = new MediaSize("NA_GOVT_LETTER", "android", R.string.mediasize_na_gvrnmt_letter, 8000, DataFailCause.IWLAN_NETWORK_FAILURE);
        ...
        public static final MediaSize NA_MONARCH = new MediaSize("NA_MONARCH", "android", R.string.mediasize_na_monarch, 7250, DataFailCause.IWLAN_NETWORK_FAILURE);
        ...
        public static final MediaSize ANSI_F = new MediaSize("ANSI_F", "android", R.string.mediasize_na_ansi_f, 28000, HealthKeys.BASE_PACKAGE);
        public static final MediaSize NA_ARCH_A = new MediaSize("NA_ARCH_A", "android", R.string.mediasize_na_arch_a, DataFailCause.IWLAN_NON_3GPP_ACCESS_TO_EPC_NOT_ALLOWED, 12000);
        public static final MediaSize NA_ARCH_B = new MediaSize("NA_ARCH_B", "android", R.string.mediasize_na_arch_b, 12000, 18000);
        public static final MediaSize NA_ARCH_C = new MediaSize("NA_ARCH_C", "android", R.string.mediasize_na_arch_c, 18000, 24000);
        public static final MediaSize NA_ARCH_D = new MediaSize("NA_ARCH_D", "android", R.string.mediasize_na_arch_d, 24000, 36000);
        public static final MediaSize NA_ARCH_E = new MediaSize("NA_ARCH_E", "android", R.string.mediasize_na_arch_e, 36000, 48000);
        public static final MediaSize NA_ARCH_E1 = new MediaSize("NA_ARCH_E1", "android", R.string.mediasize_na_arch_e1, 30000, 42000);
        public static final MediaSize NA_SUPER_B = new MediaSize("NA_SUPER_B", "android", R.string.mediasize_na_super_b, 13000, 19000);
