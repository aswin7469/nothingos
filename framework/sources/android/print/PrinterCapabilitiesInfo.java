...
public final class PrinterCapabilitiesInfo implements Parcelable {
    ...
    public static final Parcelable.Creator<PrinterCapabilitiesInfo> CREATOR = new Parcelable.Creator<PrinterCapabilitiesInfo>() { // from class: android.print.PrinterCapabilitiesInfo.1
        ...
        public PrinterCapabilitiesInfo mo3559createFromParcel(Parcel parcel) {
        ...
        public PrinterCapabilitiesInfo[] mo3560newArray(int size) {
    ...
    private PrinterCapabilitiesInfo(Parcel parcel) {
        ...
        enforceValidMask(readInt, PrinterCapabilitiesInfo$$ExternalSyntheticLambda0.INSTANCE);
        int readInt2 = parcel.readInt();
        this.mDuplexModes = readInt2;
        enforceValidMask(readInt2, PrinterCapabilitiesInfo$$ExternalSyntheticLambda1.INSTANCE);
        readDefaults(parcel);
        boolean z = false;
        Preconditions.checkArgument(this.mMediaSizes.size() > iArr[0]);
        Preconditions.checkArgument(this.mResolutions.size() > iArr[1] ? true : z);
    }
    ...
    public int hashCode() {
        ...
        return ((((((result3 + i2) * 31) + this.mColorModes) * 31) + this.mDuplexModes) * 31) + Arrays.hashCode(this.mDefaults);
    }
    ...
    public static final class Builder {
        ...
        public Builder setColorModes(int colorModes, int defaultColorMode) {
            PrinterCapabilitiesInfo.enforceValidMask(colorModes, PrinterCapabilitiesInfo$Builder$$ExternalSyntheticLambda0.INSTANCE);
        ...
        public Builder setDuplexModes(int duplexModes, int defaultDuplexMode) {
            PrinterCapabilitiesInfo.enforceValidMask(duplexModes, PrinterCapabilitiesInfo$Builder$$ExternalSyntheticLambda1.INSTANCE);
