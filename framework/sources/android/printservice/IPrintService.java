                ...
                default:
                    switch (code) {
                        case 1:
                            ...
                            IPrintServiceClient _arg06 = IPrintServiceClient.Stub.asInterface(data.readStrongBinder());
                            setClient(_arg06);
                            return true;
                        case 2:
                            data.enforceInterface(DESCRIPTOR);
                            if (data.readInt() != 0) {
                                _arg0 = PrintJobInfo.CREATOR.mo3559createFromParcel(data);
                            } else {
                                _arg0 = null;
                            }
                        ...
                        case 7:
                            data.enforceInterface(DESCRIPTOR);
                            List<PrinterId> _arg08 = data.createTypedArrayList(PrinterId.CREATOR);
                            validatePrinters(_arg08);
                            return true;
                        case 8:
                            data.enforceInterface(DESCRIPTOR);
                            if (data.readInt() != 0) {
                                _arg03 = PrinterId.CREATOR.mo3559createFromParcel(data);
                            } else {
                                _arg03 = null;
                            }
                        ...
                        case 9:
                            data.enforceInterface(DESCRIPTOR);
                            if (data.readInt() != 0) {
                                _arg04 = PrinterId.CREATOR.mo3559createFromParcel(data);
                            } else {
                                _arg04 = null;
                            }
