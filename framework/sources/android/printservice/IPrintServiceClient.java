                ...
                default:
                    switch (code) {
                        ...
                        case 3:
                            ...
                            boolean printJobState = setPrintJobState(_arg02, _arg14, _arg22);
                            reply.writeNoException();
                        ...
                        case 4:
                            ...
                            boolean printJobTag = setPrintJobTag(_arg03, _arg15);
                            reply.writeNoException();
                        ...
                        case 5:
                            data.enforceInterface(DESCRIPTOR);
                            if (data.readInt() != 0) {
                                _arg04 = ParcelFileDescriptor.CREATOR.mo3559createFromParcel(data);
                            } else {
                                _arg04 = null;
                            }
                            if (data.readInt() != 0) {
                                _arg1 = PrintJobId.CREATOR.mo3559createFromParcel(data);
                            } else {
                                _arg1 = null;
                            }
                        ...
                        case 6:
                            data.enforceInterface(DESCRIPTOR);
                            if (data.readInt() != 0) {
                                _arg05 = PrintJobId.CREATOR.mo3559createFromParcel(data);
                            } else {
                                _arg05 = null;
                            }
                            float _arg16 = data.readFloat();
                            setProgress(_arg05, _arg16);
                            reply.writeNoException();
                            return true;
                        case 7:
                            data.enforceInterface(DESCRIPTOR);
                            if (data.readInt() != 0) {
                                _arg06 = PrintJobId.CREATOR.mo3559createFromParcel(data);
                            } else {
                                _arg06 = null;
                            }
                            if (data.readInt() != 0) {
                                _arg12 = TextUtils.CHAR_SEQUENCE_CREATOR.mo3559createFromParcel(data);
                            } else {
                                _arg12 = null;
                            }
                        ...
                        case 8:
                            data.enforceInterface(DESCRIPTOR);
                            if (data.readInt() != 0) {
                                _arg07 = PrintJobId.CREATOR.mo3559createFromParcel(data);
                            } else {
                                _arg07 = null;
                            }
                            ...
                            setStatusRes(_arg07, _arg17, _arg2);
                            reply.writeNoException();
                            return true;
                        case 9:
                            data.enforceInterface(DESCRIPTOR);
                        ...
                        case 11:
                            data.enforceInterface(DESCRIPTOR);
                            if (data.readInt() != 0) {
                                _arg010 = PrinterId.CREATOR.mo3559createFromParcel(data);
                            } else {
                                _arg010 = null;
                            }
                            if (data.readInt() != 0) {
                                _arg13 = Icon.CREATOR.mo3559createFromParcel(data);
                            } else {
                                _arg13 = null;
                            }
