...
public abstract class DocumentsProvider extends ContentProvider {
    ...
    private void enforceTreeForExtraUris(Bundle extras) {
        enforceTree((Uri) extras.getParcelable("uri"));
        enforceTree((Uri) extras.getParcelable(DocumentsContract.EXTRA_PARENT_URI));
        enforceTree((Uri) extras.getParcelable(DocumentsContract.EXTRA_TARGET_URI));
    }
    ...
    private Bundle callUnchecked(String method, String arg, Bundle extras) throws FileNotFoundException {
        ...
        Uri extraUri = validateIncomingNullableUri((Uri) extras.getParcelable("uri"));
        Uri extraTargetUri = validateIncomingNullableUri((Uri) extras.getParcelable(DocumentsContract.EXTRA_TARGET_URI));
        Uri extraParentUri = validateIncomingNullableUri((Uri) extras.getParcelable(DocumentsContract.EXTRA_PARENT_URI));
