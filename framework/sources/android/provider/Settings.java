...
public final class Settings {
    ...
    public static final String KEY_CONFIG_IS_SYNC_DISABLED_RETURN = "config_is_sync_disabled_return";
    ...
    public static class NameValueCache {
        ...
        <T extends NameValueTable> NameValueCache(Uri uri, String getCommand, String setCommand, ContentProviderHolder providerHolder, Class<T> callerClass) {
            this(uri, getCommand, setCommand, null, null, providerHolder, callerClass);
        }

        private <T extends NameValueTable> NameValueCache(Uri uri, String getCommand, String setCommand, String listCommand, String setAllCommand, ContentProviderHolder providerHolder, Class<T> callerClass) {
        ...
        /* JADX WARN: Removed duplicated region for block: B:65:0x0161 A[Catch: RemoteException -> 0x01b9, TryCatch #11 {RemoteException -> 0x01b9, blocks: (B:101:0x00d7, B:51:0x00e6, B:56:0x0108, B:58:0x010e, B:60:0x0118, B:63:0x0138, B:65:0x0161, B:67:0x016b, B:84:0x0144, B:89:0x01b8, B:69:0x016e, B:72:0x0181, B:74:0x018b, B:75:0x018e, B:76:0x019c, B:78:0x01a0, B:80:0x01a6, B:81:0x01ab, B:62:0x011e), top: B:100:0x00d7 }] */
        /* JADX WARN: Unsupported multi-entry loop pattern (BACK_EDGE: B:91:0x0100 -> B:88:0x01b7). Please submit an issue!!! */
        /*
        ...
        */
        public String getStringForUser(ContentResolver cr, String name, int userHandle) {
            ...
            if (!isCallerExemptFromReadableRestriction() && this.mAllFields.contains(name)) {
                ...
                } else if (this.mReadableFieldsWithMaxTargetSdk.containsKey(name)) {
            ...
            if (isSelf) {
                synchronized (this) {
                    ...
                    if (generationTracker != null) {
                        ...
                        GenerationTracker generationTracker2 = this.mGenerationTracker;
                        if (generationTracker2 != null) {
                            currentGeneration2 = generationTracker2.getCurrentGeneration();
                        }
                    }
                            ...
                            try {
                                if (this.mGenerationTracker == null) {
                                    ...
                                    if (Settings.isInSystemServer() || Binder.getCallingUid() == Process.myUid()) {
                                        b = cp.call(cr.getAttributionSource(), this.mProviderHolder.mUri.getAuthority(), this.mCallGetCommand, name, args2);
                                    } else {
                                        long token = Binder.clearCallingIdentity();
                                        Bundle b2 = cp.call(cr.getAttributionSource(), this.mProviderHolder.mUri.getAuthority(), this.mCallGetCommand, name, args2);
                                        ...
                                        if (isSelf) {
                                            synchronized (this) {
                                                if (needsGenerationTracker) {
                                                    MemoryIntArray array = (MemoryIntArray) b.getParcelable(Settings.CALL_METHOD_TRACK_GENERATION_KEY);
                                                    ...
                                                    if (array != null && index >= 0) {
                                                        ...
                                                        GenerationTracker generationTracker3 = this.mGenerationTracker;
                                                        if (generationTracker3 != null) {
                                                            generationTracker3.destroy();
                                                        }
                                                        this.mGenerationTracker = new GenerationTracker(array, index, generation, new Runnable() { // from class: android.provider.Settings$NameValueCache$$ExternalSyntheticLambda0
                                                            @Override // java.lang.Runnable
                                                            public final void run() {
                                                                Settings.NameValueCache.this.lambda$getStringForUser$0$Settings$NameValueCache();
                                                            }
                                                        });
                                                        currentGeneration = generation;
                                                    }
                                                }
                                                GenerationTracker generationTracker4 = this.mGenerationTracker;
                                                if (generationTracker4 != null && currentGeneration == generationTracker4.getCurrentGeneration()) {
            ...
            try {
                try {
                    ...
                    if (!Settings.isInSystemServer() || Binder.getCallingUid() == Process.myUid()) {
                        ...
                        try {
                            Cursor c3 = cp.query(cr.getAttributionSource(), this.mUri, SELECT_VALUE_PROJECTION, queryArgs, null);
            ...
            try {
                ...
                synchronized (this) {
                    GenerationTracker generationTracker5 = this.mGenerationTracker;
                    if (generationTracker5 != null && currentGeneration == generationTracker5.getCurrentGeneration()) {
            ...
            synchronized (this) {
                try {
                    ...
                    if (generationTracker != null) {
                                ...
                                if (!names.isEmpty()) {
                                    ...
                                    for (int i = 0; i < this.mValues.size(); i++) {
                                        ...
                                        if (key.startsWith(prefix) && !key.equals(prefix)) {
                                            keyValues.put(key, this.mValues.get(key));
                                        }
                                    }
                                }
                                return keyValues;
                        ...
                        GenerationTracker generationTracker2 = this.mGenerationTracker;
                        if (generationTracker2 != null) {
                            currentGeneration = generationTracker2.getCurrentGeneration();
                        }
                    }
                        ...
                        try {
                            synchronized (this) {
                                try {
                                    ...
                                    try {
                                        Bundle b = cp.call(cr.getAttributionSource(), this.mProviderHolder.mUri.getAuthority(), this.mCallListCommand, null, args);
                                        if (b == null) {
                                            return keyValues;
                                        }
                                        Map<String, String> flagsToValues = (HashMap) b.getSerializable("value");
                                        if (!names.isEmpty()) {
                                        ...
                                        synchronized (this) {
                                            if (needsGenerationTracker) {
                                                ...
                                                if (array != null && index >= 0) {
                                                    ...
                                                    this.mGenerationTracker = new GenerationTracker(array, index, generation, new Runnable() { // from class: android.provider.Settings$NameValueCache$$ExternalSyntheticLambda1
                                                        @Override // java.lang.Runnable
                                                        public final void run() {
                                                            Settings.NameValueCache.this.lambda$getStringsForPrefix$1$Settings$NameValueCache();
                                                        }
                                                    });
                                                    currentGeneration = generation;
                                                }
        ...
        public /* synthetic */ void lambda$getStringsForPrefix$1$Settings$NameValueCache() {
            synchronized (this) {
                Log.e(Settings.TAG, "Error accessing generation tracker - removing");
                GenerationTracker generationTracker = this.mGenerationTracker;
                if (generationTracker != null) {
    ...
    public static final class System extends NameValueTable {
        ...
        static {
            ...
            sNameValueCache = new NameValueCache(parse, Settings.CALL_METHOD_GET_SYSTEM, Settings.CALL_METHOD_PUT_SYSTEM, contentProviderHolder, System.class);
            ...
            arraySet.add(SCREEN_BRIGHTNESS_FOR_VR);
            arraySet.add(SCREEN_BRIGHTNESS_FOR_VR_FLOAT);
            ...
            arraySet.addAll(NtSettings.System.PUBLIC_SETTINGS);
            ...
            arraySet2.add(CALL_CONNECTED_TONE_ENABLED);
        ...
        private static boolean putStringForUser(ContentResolver resolver, String name, String value, int userHandle, boolean overrideableByRestore) {
            ...
            if (MOVED_TO_SECURE.contains(name)) {
                ...
                return sNameValueCache.putStringForUser(resolver, name, value, null, false, userHandle, overrideableByRestore);
            }
        }
    ...
    public static final class Secure extends NameValueTable {
        ...
        static {
            ...
            ContentProviderHolder contentProviderHolder = new ContentProviderHolder(parse);
            sProviderHolder = contentProviderHolder;
            sNameValueCache = new NameValueCache(parse, Settings.CALL_METHOD_GET_SECURE, Settings.CALL_METHOD_PUT_SECURE, contentProviderHolder, Secure.class);
            ...
            hashSet2.add(Global.NTP_SERVER_2);
        ...
        public static boolean isLocationProviderEnabled(ContentResolver cr, String provider) {
            ...
            ILocationManager asInterface = ILocationManager.Stub.asInterface(binder);
            Objects.requireNonNull(asInterface);
            ILocationManager lm = asInterface;
            try {
    ...
    public static final class Global extends NameValueTable {
        ...
        public static final String DEVELOPMENT_SETTINGS_ENABLED = "development_settings_enabled";
        @Readable
        public static final String DEVELOPMENT_USE_BLAST_ADAPTER_SV = "use_blast_adapter_sv";
        @Readable
        ...
        public static final String HDMI_CONTROL_SEND_STANDBY_ON_SLEEP = "hdmi_control_send_standby_on_sleep";
        @Readable
        ...
        static {
            ...
            ContentProviderHolder contentProviderHolder = new ContentProviderHolder(parse);
            sProviderHolder = contentProviderHolder;
            sNameValueCache = new NameValueCache(parse, Settings.CALL_METHOD_GET_GLOBAL, Settings.CALL_METHOD_PUT_GLOBAL, contentProviderHolder, Global.class);
    ...
    public static final class Config extends NameValueTable {
        ...
        static {
            ContentProviderHolder contentProviderHolder = new ContentProviderHolder(DeviceConfig.CONTENT_URI);
            sProviderHolder = contentProviderHolder;
            sNameValueCache = new NameValueCache(DeviceConfig.CONTENT_URI, Settings.CALL_METHOD_GET_CONFIG, Settings.CALL_METHOD_PUT_CONFIG, Settings.CALL_METHOD_LIST_CONFIG, Settings.CALL_METHOD_SET_ALL_CONFIG, contentProviderHolder, Config.class);
        }
        ...
        public static boolean putString(ContentResolver resolver, String namespace, String name, String value, boolean makeDefault) {
        ...
        /* JADX INFO: Access modifiers changed from: package-private */
        public static void resetToDefaults(ContentResolver resolver, int resetMode, String namespace) {
            try {
                Bundle arg = new Bundle();
        ...
        /* JADX INFO: Access modifiers changed from: package-private */
        public static void setSyncDisabled(ContentResolver resolver, int disableSyncMode) {
            try {
                Bundle args = new Bundle();
                args.putInt(Settings.CALL_METHOD_SYNC_DISABLED_MODE_KEY, disableSyncMode);
                ContentProviderHolder contentProviderHolder = sProviderHolder;
                IContentProvider cp = contentProviderHolder.getProvider(resolver);
                cp.call(resolver.getAttributionSource(), contentProviderHolder.mUri.getAuthority(), Settings.CALL_METHOD_SET_SYNC_DISABLED_CONFIG, null, args);
            } catch (RemoteException e) {
                Log.w(Settings.TAG, "Can't set sync disabled " + DeviceConfig.CONTENT_URI, e);
            }
        }

        /* JADX INFO: Access modifiers changed from: package-private */
        public static boolean isSyncDisabled(ContentResolver resolver) {
            try {
                Bundle args = Bundle.EMPTY;
                ContentProviderHolder contentProviderHolder = sProviderHolder;
                IContentProvider cp = contentProviderHolder.getProvider(resolver);
                Bundle bundle = cp.call(resolver.getAttributionSource(), contentProviderHolder.mUri.getAuthority(), Settings.CALL_METHOD_IS_SYNC_DISABLED_CONFIG, null, args);
                return bundle.getBoolean(Settings.KEY_CONFIG_IS_SYNC_DISABLED_RETURN);
            } catch (RemoteException e) {
                Log.w(Settings.TAG, "Can't query sync disabled " + DeviceConfig.CONTENT_URI, e);
                return false;
            }
        }

        public static void registerMonitorCallback(ContentResolver resolver, RemoteCallback callback) {
            registerMonitorCallbackAsUser(resolver, resolver.getUserId(), callback);
        }

        private static void registerMonitorCallbackAsUser(ContentResolver resolver, int userHandle, RemoteCallback callback) {
            try {
                Bundle arg = new Bundle();
                arg.putInt(Settings.CALL_METHOD_USER_KEY, userHandle);
                arg.putParcelable(Settings.CALL_METHOD_MONITOR_CALLBACK_KEY, callback);
                ContentProviderHolder contentProviderHolder = sProviderHolder;
                IContentProvider cp = contentProviderHolder.getProvider(resolver);
                ...
                Log.w(Settings.TAG, "Can't register config monitor callback", e);
            }
        }
