...
public final class ScriptIntrinsicHistogram extends ScriptIntrinsic {
    ...
    public void forEach(Allocation ain, Script.LaunchOptions opt) {
        ...
        if (!ain.getType().getElement().isCompatible(Element.U8(this.mRS)) && !ain.getType().getElement().isCompatible(Element.U8_2(this.mRS)) && !ain.getType().getElement().isCompatible(Element.U8_3(this.mRS)) && !ain.getType().getElement().isCompatible(Element.U8_4(this.mRS))) {
