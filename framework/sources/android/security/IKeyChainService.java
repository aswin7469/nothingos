                ...
                default:
                    ...
                    switch (code) {
                        ...
                        case 6:
                            ...
                            if (data.readInt() != 0) {
                                _arg1 = ParcelableKeyGenParameterSpec.CREATOR.mo3559createFromParcel(data);
                            } else {
                                _arg1 = null;
                            }
                        ...
                        case 20:
                            ...
                            if (data.readInt() != 0) {
                                _arg12 = AppUriAuthenticationPolicy.CREATOR.mo3559createFromParcel(data);
                            } else {
                                _arg12 = null;
                            }
        ...
        public static class Proxy implements IKeyChainService {
            ...
            public AppUriAuthenticationPolicy getCredentialManagementAppPolicy() throws RemoteException {
                ...
                try {
                    ...
                    _reply.readException();
                    if (_reply.readInt() != 0) {
                        _result = AppUriAuthenticationPolicy.CREATOR.mo3559createFromParcel(_reply);
                    } else {
                        _result = null;
                    }
                    return _result;
