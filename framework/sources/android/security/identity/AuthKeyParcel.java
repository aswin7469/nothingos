...
public class AuthKeyParcel implements Parcelable {
    public static final Parcelable.Creator<AuthKeyParcel> CREATOR = new Parcelable.Creator<AuthKeyParcel>() { // from class: android.security.identity.AuthKeyParcel.1
        ...
        public AuthKeyParcel mo3559createFromParcel(Parcel _aidl_source) {
        ...
        public AuthKeyParcel[] mo3560newArray(int _aidl_size) {
    ...
    public final void writeToParcel(Parcel _aidl_parcel, int _aidl_flag) {
        ...
        _aidl_parcel.writeByteArray(this.x509cert);
    ...
    public final void readFromParcel(Parcel _aidl_parcel) {
        ...
        try {
            ...
            this.x509cert = _aidl_parcel.createByteArray();
            if (_aidl_start_pos > Integer.MAX_VALUE - _aidl_parcelable_size) {
                throw new BadParcelableException("Overflow in the size of parcelable");
            }
            _aidl_parcel.setDataPosition(_aidl_start_pos + _aidl_parcelable_size);
