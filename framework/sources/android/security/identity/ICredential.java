                ...
                default:
                    ...
                    switch (code) {
                        ...
                        case 11:
                            data.enforceInterface(ICredential.DESCRIPTOR);
                            if (data.readInt() != 0) {
                                _arg02 = AuthKeyParcel.CREATOR.mo3559createFromParcel(data);
                            } else {
                                _arg02 = null;
                            }
                        ...
                        case 12:
                            data.enforceInterface(ICredential.DESCRIPTOR);
                            if (data.readInt() != 0) {
                                _arg03 = AuthKeyParcel.CREATOR.mo3559createFromParcel(data);
                            } else {
                                _arg03 = null;
                            }
                ...
                try {
                    ...
                    try {
                        ...
                        try {
                            ...
                            _reply.readException();
                            if (_reply.readInt() != 0) {
                                _result = GetEntriesResultParcel.CREATOR.mo3559createFromParcel(_reply);
                            } else {
                                _result = null;
                            }
                            _reply.recycle();
