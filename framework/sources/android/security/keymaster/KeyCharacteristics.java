...
public class KeyCharacteristics implements Parcelable {
    public static final Parcelable.Creator<KeyCharacteristics> CREATOR = new Parcelable.Creator<KeyCharacteristics>() { // from class: android.security.keymaster.KeyCharacteristics.1
        ...
        public KeyCharacteristics mo3559createFromParcel(Parcel in) {
        ...
        public KeyCharacteristics[] mo3560newArray(int length) {
    ...
    public void readFromParcel(Parcel in) {
        this.swEnforced = KeymasterArguments.CREATOR.mo3559createFromParcel(in);
        this.hwEnforced = KeymasterArguments.CREATOR.mo3559createFromParcel(in);
    }
