        ...
        if (!(key instanceof AndroidKeyStorePrivateKey) && ((key instanceof PrivateKey) || (key instanceof PublicKey))) {
            try {
                ...
                if ("RSA/ECB/OAEPWithSHA-224AndMGF1Padding".equals(transform)) {
                    OAEPParameterSpec spec = new OAEPParameterSpec(KeyProperties.DIGEST_SHA224, "MGF1", new MGF1ParameterSpec("SHA1"), PSource.PSpecified.DEFAULT);
                    this.mCipher.init(opmode, key, spec, random);
                    return;
                } else if ("RSA/ECB/OAEPWithSHA-256AndMGF1Padding".equals(transform)) {
                    OAEPParameterSpec spec2 = new OAEPParameterSpec("SHA-256", "MGF1", new MGF1ParameterSpec("SHA1"), PSource.PSpecified.DEFAULT);
                    this.mCipher.init(opmode, key, spec2, random);
                    return;
                } else if ("RSA/ECB/OAEPWithSHA-384AndMGF1Padding".equals(transform)) {
                    OAEPParameterSpec spec3 = new OAEPParameterSpec(KeyProperties.DIGEST_SHA384, "MGF1", new MGF1ParameterSpec("SHA1"), PSource.PSpecified.DEFAULT);
                    this.mCipher.init(opmode, key, spec3, random);
                    return;
                } else if ("RSA/ECB/OAEPWithSHA-512AndMGF1Padding".equals(transform)) {
                    OAEPParameterSpec spec4 = new OAEPParameterSpec(KeyProperties.DIGEST_SHA512, "MGF1", new MGF1ParameterSpec("SHA1"), PSource.PSpecified.DEFAULT);
