...
public class AndroidKeyStoreSpi extends KeyStoreSpi {
    ...
    private void setPrivateKeyEntry(String alias, PrivateKey key, Certificate[] chain, KeyStore.ProtectionParameter param) throws java.security.KeyStoreException {
        ...
        try {
            ...
            if (chain.length > 1) {
                ...
                for (int i2 = 0; i2 < certsBytes.length; i2++) {
                    try {
                        ...
                        throw new java.security.KeyStoreException("Failed to encode certificate #" + i2, e);
                    }
                }
                ...
                for (int i3 = 0; i3 < certsBytes.length; i3++) {
                    ...
                    System.arraycopy(certsBytes[i3], 0, chainBytes2, outputOffset, certLength);
            ...
            try {
                ...
                int i5 = 0;
                while (i5 < length2) {
                    String blockMode = blockModes[i5];
                ...
                int i7 = 0;
                while (i7 < length3) {
                    int padding = keymasterEncryptionPaddings[i7];
                ...
                int length4 = signaturePaddings.length;
                int i8 = 0;
                while (i8 < length4) {
                    String padding2 = signaturePaddings[i8];
                    String[] strArr3 = signaturePaddings;
                    importArgs.add(KeyStore2ParameterUtils.makeEnum(536870918, KeyProperties.SignaturePadding.toKeymaster(padding2)));
                    i8++;
                    signaturePaddings = strArr3;
                }
                ...
                try {
                    ...
                    try {
                        ...
                        throw new java.security.KeyStoreException("Failed to store certificate and certificate chain", e5);
                    }
            ...
            throw new java.security.KeyStoreException("Failed to encode certificate #0", e8);
        }
    }
    ...
    private static void assertCanReplace(String alias, int targetDomain, int targetNamespace, KeyDescriptor descriptor) throws java.security.KeyStoreException {
        ...
        if (!alias.equals(descriptor.alias) || descriptor.domain != targetDomain || (descriptor.domain == 2 && descriptor.nspace != targetNamespace)) {
            ...
            sb.append("Can only replace keys with same alias: ");
            sb.append(alias);
            sb.append(" != ");
            sb.append(descriptor.alias);
            sb.append(" in the same target domain: ");
            sb.append(targetDomain);
            sb.append(" != ");
            sb.append(descriptor.domain);
            if (targetDomain == 2) {
                str = " in the same target namespace: " + targetNamespace + " != " + descriptor.nspace;
            } else {
                str = "";
            }
            sb.append(str);
    ...
    private void setSecretKeyEntry(String alias, SecretKey key, KeyStore.ProtectionParameter param) throws java.security.KeyStoreException {
        ...
        if (key instanceof AndroidKeyStoreSecretKey) {
            ...
            final List<KeyParameter> importArgs = new ArrayList<>();
            try {
                int keymasterAlgorithm2 = KeyProperties.KeyAlgorithm.toKeymasterSecretKeyAlgorithm(key.getAlgorithm());
                importArgs.add(KeyStore2ParameterUtils.makeEnum(268435458, keymasterAlgorithm2));
                try {
                    if (keymasterAlgorithm2 == 128) {
                    ...
                    while (i < length) {
                        ...
                        if (keymasterAlgorithm2 != 32 || keymasterBlockMode != 32) {
                            keymasterAlgorithm = keymasterAlgorithm2;
                        } else {
                            keymasterAlgorithm = keymasterAlgorithm2;
                            importArgs.add(KeyStore2ParameterUtils.makeInt(805306376, 96));
                        }
                        importArgs.add(KeyStore2ParameterUtils.makeEnum(536870916, keymasterBlockMode));
                        i++;
                        keymasterAlgorithm2 = keymasterAlgorithm;
                    }
