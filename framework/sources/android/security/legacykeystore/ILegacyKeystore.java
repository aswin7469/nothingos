...
public interface ILegacyKeystore extends IInterface {
    ...
    public static abstract class Stub extends Binder implements ILegacyKeystore {
        ...
        public static class Proxy implements ILegacyKeystore {
            public static ILegacyKeystore sDefaultImpl;
            ...
            public void put(String alias, int uid, byte[] blob) throws RemoteException {
                ...
                try {
                    ...
                    if (!_status && Stub.getDefaultImpl() != null) {
                        Stub.getDefaultImpl().put(alias, uid, blob);
                    } else {
                        _reply.readException();
                    }
                } finally {
            ...
            public void remove(String alias, int uid) throws RemoteException {
                ...
                try {
                    ...
                    if (!_status && Stub.getDefaultImpl() != null) {
                        Stub.getDefaultImpl().remove(alias, uid);
                    } else {
                        _reply.readException();
                    }
                } finally {
            ...
            public String[] list(String prefix, int uid) throws RemoteException {
                ...
                try {
                    ...
                    if (!_status && Stub.getDefaultImpl() != null) {
                        return Stub.getDefaultImpl().list(prefix, uid);
                    }
                    _reply.readException();
        ...
        public static boolean setDefaultImpl(ILegacyKeystore impl) {
        ...
        public static ILegacyKeystore getDefaultImpl() {
