...
public class CrashStats implements Parcelable {
    public static final Parcelable.Creator<CrashStats> CREATOR = new Parcelable.Creator<CrashStats>() { // from class: android.security.metrics.CrashStats.1
        ...
        public CrashStats mo3559createFromParcel(Parcel _aidl_source) {
        ...
        public CrashStats[] mo3560newArray(int _aidl_size) {
    ...
    public final void writeToParcel(Parcel _aidl_parcel, int _aidl_flag) {
        ...
        _aidl_parcel.writeInt(this.count_of_crash_events);
    ...
    public final void readFromParcel(Parcel _aidl_parcel) {
        ...
        try {
            ...
            this.count_of_crash_events = _aidl_parcel.readInt();
            if (_aidl_start_pos > Integer.MAX_VALUE - _aidl_parcelable_size) {
                throw new BadParcelableException("Overflow in the size of parcelable");
            }
            _aidl_parcel.setDataPosition(_aidl_start_pos + _aidl_parcelable_size);
