...
public class KeyCreationWithPurposeAndModesInfo implements Parcelable {
    public static final Parcelable.Creator<KeyCreationWithPurposeAndModesInfo> CREATOR = new Parcelable.Creator<KeyCreationWithPurposeAndModesInfo>() { // from class: android.security.metrics.KeyCreationWithPurposeAndModesInfo.1
        ...
        public KeyCreationWithPurposeAndModesInfo mo3559createFromParcel(Parcel _aidl_source) {
        ...
        public KeyCreationWithPurposeAndModesInfo[] mo3560newArray(int _aidl_size) {
    ...
    public final void writeToParcel(Parcel _aidl_parcel, int _aidl_flag) {
        ...
        _aidl_parcel.writeInt(this.purpose_bitmap);
        _aidl_parcel.writeInt(this.padding_mode_bitmap);
        _aidl_parcel.writeInt(this.digest_bitmap);
        _aidl_parcel.writeInt(this.block_mode_bitmap);
    ...
    public final void readFromParcel(Parcel _aidl_parcel) {
        ...
        try {
            ...
            this.purpose_bitmap = _aidl_parcel.readInt();
            if (_aidl_parcel.dataPosition() - _aidl_start_pos >= _aidl_parcelable_size) {
                if (_aidl_start_pos > Integer.MAX_VALUE - _aidl_parcelable_size) {
                    throw new BadParcelableException("Overflow in the size of parcelable");
                }
            ...
            this.padding_mode_bitmap = _aidl_parcel.readInt();
            if (_aidl_parcel.dataPosition() - _aidl_start_pos >= _aidl_parcelable_size) {
                if (_aidl_start_pos > Integer.MAX_VALUE - _aidl_parcelable_size) {
                    throw new BadParcelableException("Overflow in the size of parcelable");
                }
            ...
            this.digest_bitmap = _aidl_parcel.readInt();
            if (_aidl_parcel.dataPosition() - _aidl_start_pos >= _aidl_parcelable_size) {
                if (_aidl_start_pos > Integer.MAX_VALUE - _aidl_parcelable_size) {
                    throw new BadParcelableException("Overflow in the size of parcelable");
                }
            ...
            this.block_mode_bitmap = _aidl_parcel.readInt();
            if (_aidl_start_pos > Integer.MAX_VALUE - _aidl_parcelable_size) {
                throw new BadParcelableException("Overflow in the size of parcelable");
            }
            _aidl_parcel.setDataPosition(_aidl_start_pos + _aidl_parcelable_size);
