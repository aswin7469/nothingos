...
public final class KeystoreAtomPayload implements Parcelable {
    public static final Parcelable.Creator<KeystoreAtomPayload> CREATOR = new Parcelable.Creator<KeystoreAtomPayload>() { // from class: android.security.metrics.KeystoreAtomPayload.1
        ...
        public KeystoreAtomPayload mo3559createFromParcel(Parcel _aidl_source) {
        ...
        public KeystoreAtomPayload[] mo3560newArray(int _aidl_size) {
        ...
        switch (_aidl_tag) {
            case 0:
                if (_aidl_parcel.readInt() != 0) {
                    _aidl_value = StorageStats.CREATOR.mo3559createFromParcel(_aidl_parcel);
                } else {
                    _aidl_value = null;
                }
            ...
            case 1:
                if (_aidl_parcel.readInt() != 0) {
                    _aidl_value2 = RkpPoolStats.CREATOR.mo3559createFromParcel(_aidl_parcel);
                } else {
                    _aidl_value2 = null;
                }
            ...
            case 2:
                if (_aidl_parcel.readInt() != 0) {
                    _aidl_value3 = KeyCreationWithGeneralInfo.CREATOR.mo3559createFromParcel(_aidl_parcel);
                } else {
                    _aidl_value3 = null;
                }
            ...
            case 3:
                if (_aidl_parcel.readInt() != 0) {
                    _aidl_value4 = KeyCreationWithAuthInfo.CREATOR.mo3559createFromParcel(_aidl_parcel);
                } else {
                    _aidl_value4 = null;
                }
            ...
            case 4:
                if (_aidl_parcel.readInt() != 0) {
                    _aidl_value5 = KeyCreationWithPurposeAndModesInfo.CREATOR.mo3559createFromParcel(_aidl_parcel);
                } else {
                    _aidl_value5 = null;
                }
            ...
            case 5:
                if (_aidl_parcel.readInt() != 0) {
                    _aidl_value6 = Keystore2AtomWithOverflow.CREATOR.mo3559createFromParcel(_aidl_parcel);
                } else {
                    _aidl_value6 = null;
                }
            ...
            case 6:
                if (_aidl_parcel.readInt() != 0) {
                    _aidl_value7 = KeyOperationWithPurposeAndModesInfo.CREATOR.mo3559createFromParcel(_aidl_parcel);
                } else {
                    _aidl_value7 = null;
                }
            ...
            case 7:
                if (_aidl_parcel.readInt() != 0) {
                    _aidl_value8 = KeyOperationWithGeneralInfo.CREATOR.mo3559createFromParcel(_aidl_parcel);
                } else {
                    _aidl_value8 = null;
                }
            ...
            case 8:
                if (_aidl_parcel.readInt() != 0) {
                    _aidl_value9 = RkpErrorStats.CREATOR.mo3559createFromParcel(_aidl_parcel);
                } else {
                    _aidl_value9 = null;
                }
            ...
            case 9:
                if (_aidl_parcel.readInt() != 0) {
                    _aidl_value10 = CrashStats.CREATOR.mo3559createFromParcel(_aidl_parcel);
                } else {
                    _aidl_value10 = null;
                }
