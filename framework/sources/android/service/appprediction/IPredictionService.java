                ...
                default:
                    switch (code) {
                        case 1:
                            ...
                            if (data.readInt() != 0) {
                                _arg0 = AppPredictionContext.CREATOR.mo3559createFromParcel(data);
                            } else {
                                _arg0 = null;
                            }
                            if (data.readInt() != 0) {
                                _arg1 = AppPredictionSessionId.CREATOR.mo3559createFromParcel(data);
                            } else {
                                _arg1 = null;
                            }
                        ...
                        case 2:
                            data.enforceInterface(IPredictionService.DESCRIPTOR);
                            if (data.readInt() != 0) {
                                _arg02 = AppPredictionSessionId.CREATOR.mo3559createFromParcel(data);
                            } else {
                                _arg02 = null;
                            }
                            if (data.readInt() != 0) {
                                _arg12 = AppTargetEvent.CREATOR.mo3559createFromParcel(data);
                            } else {
                                _arg12 = null;
                            }
                        ...
                        case 3:
                            data.enforceInterface(IPredictionService.DESCRIPTOR);
                            if (data.readInt() != 0) {
                                _arg03 = AppPredictionSessionId.CREATOR.mo3559createFromParcel(data);
                            } else {
                                _arg03 = null;
                            }
                        ...
                        case 4:
                            data.enforceInterface(IPredictionService.DESCRIPTOR);
                            if (data.readInt() != 0) {
                                _arg04 = AppPredictionSessionId.CREATOR.mo3559createFromParcel(data);
                            } else {
                                _arg04 = null;
                            }
                            if (data.readInt() != 0) {
                        ...
                        case 5:
                            data.enforceInterface(IPredictionService.DESCRIPTOR);
                            if (data.readInt() != 0) {
                                _arg05 = AppPredictionSessionId.CREATOR.mo3559createFromParcel(data);
                            } else {
                                _arg05 = null;
                            }
                        ...
                        case 6:
                            data.enforceInterface(IPredictionService.DESCRIPTOR);
                            if (data.readInt() != 0) {
                                _arg06 = AppPredictionSessionId.CREATOR.mo3559createFromParcel(data);
                            } else {
                                _arg06 = null;
                            }
                        ...
                        case 7:
                            data.enforceInterface(IPredictionService.DESCRIPTOR);
                            if (data.readInt() != 0) {
                                _arg07 = AppPredictionSessionId.CREATOR.mo3559createFromParcel(data);
                            } else {
                                _arg07 = null;
                            }
                        ...
                        case 8:
                            data.enforceInterface(IPredictionService.DESCRIPTOR);
                            if (data.readInt() != 0) {
                                _arg08 = AppPredictionSessionId.CREATOR.mo3559createFromParcel(data);
                            } else {
                                _arg08 = null;
                            }
