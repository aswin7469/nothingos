...
public final class AutofillServiceInfo {
    ...
    public String toString() {
        ...
        builder.append(", passwords activity:");
        builder.append(this.mPasswordsActivity);
        ...
        builder.append("]");
        builder.append(", inline suggestions enabled:");
        builder.append(this.mInlineSuggestionsEnabled);
