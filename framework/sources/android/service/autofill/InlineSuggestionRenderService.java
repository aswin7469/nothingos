...
public abstract class InlineSuggestionRenderService extends Service {
    ...
    public void handleRenderSuggestion(final IInlineSuggestionUiCallback callback, InlinePresentation presentation, int width, int height, IBinder hostInputToken, int displayId, int userId, int sessionId) {
        if (hostInputToken != null) {
            ...
            try {
                ...
                final SurfaceControlViewHost host = new SurfaceControlViewHost(this, getDisplay(), hostInputToken);
    ...
    public void handleDestroySuggestionViews(int userId, int sessionId) {
        Log.v(TAG, "handleDestroySuggestionViews called for " + userId + SettingsStringUtil.DELIMITER + sessionId);
    ...
    public final class InlineSuggestionUiImpl {
        ...
        public void releaseSurfaceControlViewHost() {
            this.mHandler.post(new Runnable() { // from class: android.service.autofill.InlineSuggestionRenderService$InlineSuggestionUiImpl$$ExternalSyntheticLambda0
                @Override // java.lang.Runnable
                public final void run() {
                    InlineSuggestionRenderService.InlineSuggestionUiImpl.this.lambda$releaseSurfaceControlViewHost$0$InlineSuggestionRenderService$InlineSuggestionUiImpl();
                }
            });
        }

        public /* synthetic */ void lambda$releaseSurfaceControlViewHost$0$InlineSuggestionRenderService$InlineSuggestionUiImpl() {
        ...
        public void getSurfacePackage(final ISurfacePackageResultCallback callback) {
            ...
            this.mHandler.post(new Runnable() { // from class: android.service.autofill.InlineSuggestionRenderService$InlineSuggestionUiImpl$$ExternalSyntheticLambda1
                @Override // java.lang.Runnable
                public final void run() {
                    InlineSuggestionRenderService.InlineSuggestionUiImpl.this.lambda$getSurfacePackage$1$InlineSuggestionRenderService$InlineSuggestionUiImpl(callback);
                }
            });
        }

        public /* synthetic */ void lambda$getSurfacePackage$1$InlineSuggestionRenderService$InlineSuggestionUiImpl(ISurfacePackageResultCallback callback) {
            try {
    ...
    class AnonymousClass2 extends IInlineSuggestionRenderService.Stub {
        ...
        public void renderSuggestion(IInlineSuggestionUiCallback callback, InlinePresentation presentation, int width, int height, IBinder hostInputToken, int displayId, int userId, int sessionId) {
            InlineSuggestionRenderService.this.mMainHandler.sendMessage(PooledLambda.obtainMessage(InlineSuggestionRenderService$2$$ExternalSyntheticLambda0.INSTANCE, InlineSuggestionRenderService.this, callback, presentation, Integer.valueOf(width), Integer.valueOf(height), hostInputToken, Integer.valueOf(displayId), Integer.valueOf(userId), Integer.valueOf(sessionId)));
        }

        @Override // android.service.autofill.IInlineSuggestionRenderService
        public void getInlineSuggestionsRendererInfo(RemoteCallback callback) {
            InlineSuggestionRenderService.this.mMainHandler.sendMessage(PooledLambda.obtainMessage(InlineSuggestionRenderService$2$$ExternalSyntheticLambda2.INSTANCE, InlineSuggestionRenderService.this, callback));
        }

        @Override // android.service.autofill.IInlineSuggestionRenderService
        public void destroySuggestionViews(int userId, int sessionId) {
            InlineSuggestionRenderService.this.mMainHandler.sendMessage(PooledLambda.obtainMessage(InlineSuggestionRenderService$2$$ExternalSyntheticLambda1.INSTANCE, InlineSuggestionRenderService.this, Integer.valueOf(userId), Integer.valueOf(sessionId)));
        }
    }
