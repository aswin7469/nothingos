...
public abstract class AugmentedAutofillService extends Service {
    ...
    /* loaded from: classes2.dex */
    public final class AugmentedAutofillServiceImpl extends IAugmentedAutofillService.Stub {
        ...
        public void onConnected(boolean debug, boolean verbose) {
            AugmentedAutofillService.this.mHandler.sendMessage(PooledLambda.obtainMessage(AugmentedAutofillService$AugmentedAutofillServiceImpl$$ExternalSyntheticLambda1.INSTANCE, AugmentedAutofillService.this, Boolean.valueOf(debug), Boolean.valueOf(verbose)));
        }

        @Override // android.service.autofill.augmented.IAugmentedAutofillService
        public void onDisconnected() {
            AugmentedAutofillService.this.mHandler.sendMessage(PooledLambda.obtainMessage(AugmentedAutofillService$AugmentedAutofillServiceImpl$$ExternalSyntheticLambda3.INSTANCE, AugmentedAutofillService.this));
        }
        ...
        public void onFillRequest(int sessionId, IBinder client, int taskId, ComponentName componentName, AutofillId focusedId, AutofillValue focusedValue, long requestTime, InlineSuggestionsRequest inlineSuggestionsRequest, IFillCallback callback) {
            AugmentedAutofillService.this.mHandler.sendMessage(PooledLambda.obtainMessage(AugmentedAutofillService$AugmentedAutofillServiceImpl$$ExternalSyntheticLambda0.INSTANCE, AugmentedAutofillService.this, Integer.valueOf(sessionId), client, Integer.valueOf(taskId), componentName, focusedId, focusedValue, Long.valueOf(requestTime), inlineSuggestionsRequest, callback));
        }

        @Override // android.service.autofill.augmented.IAugmentedAutofillService
        public void onDestroyAllFillWindowsRequest() {
            AugmentedAutofillService.this.mHandler.sendMessage(PooledLambda.obtainMessage(AugmentedAutofillService$AugmentedAutofillServiceImpl$$ExternalSyntheticLambda2.INSTANCE, AugmentedAutofillService.this));
        }
    }
    ...
    public boolean onUnbind(Intent intent) {
        this.mHandler.sendMessage(PooledLambda.obtainMessage(AugmentedAutofillService$$ExternalSyntheticLambda0.INSTANCE, this));
        return false;
    }
    ...
    public static final class AutofillProxy {
        ...
        public void reportResult(List<Dataset> inlineSuggestionsData, Bundle clientState, boolean showingFillWindow) {
            try {
                ...
                String str = AugmentedAutofillService.TAG;
                Log.e(str, "Error calling back with the inline suggestions data: " + e);
            }
        }
            ...
            synchronized (this.mLock) {
                if (this.mFocusedViewNode == null) {
                    try {
                        ...
                        String str = AugmentedAutofillService.TAG;
                        Log.e(str, "Error getting the ViewNode of the focused view: " + e);
                        return null;
                    }
                }
        ...
        public void logEvent(int event) {
            if (AugmentedAutofillService.sVerbose) {
                String str = AugmentedAutofillService.TAG;
                Log.v(str, "returnAndLogResult(): " + event);
            }
            long duration = -1;
            int type = 0;
            switch (event) {
                ...
                case 2:
                    ...
                    if (this.mUiFirstShownTime == 0) {
                        ...
                        if (AugmentedAutofillService.sDebug) {
                            ...
                            Log.d(str3, "UI shown in " + TimeUtils.formatDuration(duration));
                            break;
                        }
                    }
                    break;
                case 3:
                    ...
                    if (this.mUiFirstDestroyedTime == 0) {
                        ...
                        if (AugmentedAutofillService.sDebug) {
                            ...
                            Log.d(str4, "UI destroyed in " + TimeUtils.formatDuration(duration));
                            break;
                        }
                    }
                    break;
                case 4:
                    if (this.mFirstOnSuccessTime == 0) {
                        ...
                        if (AugmentedAutofillService.sDebug) {
                            ...
                            Log.d(str5, "Inline response in " + TimeUtils.formatDuration(duration));
                            break;
                        }
                    }
                    break;
                default:
                    ...
                    Log.w(str6, "invalid event reported: " + event);
                    break;
            }
