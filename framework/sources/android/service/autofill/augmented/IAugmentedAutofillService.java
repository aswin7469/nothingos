                ...
                default:
                    switch (code) {
                        ...
                        case 3:
                            ...
                            if (data.readInt() != 0) {
                                _arg4 = AutofillId.CREATOR.mo3559createFromParcel(data);
                            } else {
                                _arg4 = null;
                            }
                            if (data.readInt() != 0) {
                                _arg5 = AutofillValue.CREATOR.mo3559createFromParcel(data);
                            } else {
                                _arg5 = null;
                            }
                            long _arg6 = data.readLong();
                            if (data.readInt() != 0) {
                                _arg7 = InlineSuggestionsRequest.CREATOR.mo3559createFromParcel(data);
                            } else {
                                _arg7 = null;
                            }
