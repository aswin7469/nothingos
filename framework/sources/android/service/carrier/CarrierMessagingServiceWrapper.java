...
public final class CarrierMessagingServiceWrapper implements AutoCloseable {
    ...
    public final class CarrierMessagingCallbackInternal extends ICarrierMessagingCallback.Stub {
        ...
        public /* synthetic */ void lambda$onFilterComplete$0$CarrierMessagingServiceWrapper$CarrierMessagingCallbackInternal(int result) {
        ...
        public void onFilterComplete(final int result) throws RemoteException {
            this.mExecutor.execute(new Runnable() { // from class: android.service.carrier.CarrierMessagingServiceWrapper$CarrierMessagingCallbackInternal$$ExternalSyntheticLambda1
                ...
                public final void run() {
                    CarrierMessagingServiceWrapper.CarrierMessagingCallbackInternal.this.lambda$onFilterComplete$0$CarrierMessagingServiceWrapper$CarrierMessagingCallbackInternal(result);
                }
            });
        }

        public /* synthetic */ void lambda$onSendSmsComplete$1$CarrierMessagingServiceWrapper$CarrierMessagingCallbackInternal(int result, int messageRef) {
        ...
        public void onSendSmsComplete(final int result, final int messageRef) throws RemoteException {
            this.mExecutor.execute(new Runnable() { // from class: android.service.carrier.CarrierMessagingServiceWrapper$CarrierMessagingCallbackInternal$$ExternalSyntheticLambda2
                @Override // java.lang.Runnable
                public final void run() {
                    CarrierMessagingServiceWrapper.CarrierMessagingCallbackInternal.this.lambda$onSendSmsComplete$1$CarrierMessagingServiceWrapper$CarrierMessagingCallbackInternal(result, messageRef);
                }
            });
        }

        public /* synthetic */ void lambda$onSendMultipartSmsComplete$2$CarrierMessagingServiceWrapper$CarrierMessagingCallbackInternal(int result, int[] messageRefs) {
        ...
        public void onSendMultipartSmsComplete(final int result, final int[] messageRefs) throws RemoteException {
            this.mExecutor.execute(new Runnable() { // from class: android.service.carrier.CarrierMessagingServiceWrapper$CarrierMessagingCallbackInternal$$ExternalSyntheticLambda4
                @Override // java.lang.Runnable
                public final void run() {
                    CarrierMessagingServiceWrapper.CarrierMessagingCallbackInternal.this.lambda$onSendMultipartSmsComplete$2$CarrierMessagingServiceWrapper$CarrierMessagingCallbackInternal(result, messageRefs);
                }
            });
        }

        public /* synthetic */ void lambda$onSendMmsComplete$3$CarrierMessagingServiceWrapper$CarrierMessagingCallbackInternal(int result, byte[] sendConfPdu) {
        ...
        public void onSendMmsComplete(final int result, final byte[] sendConfPdu) throws RemoteException {
            this.mExecutor.execute(new Runnable() { // from class: android.service.carrier.CarrierMessagingServiceWrapper$CarrierMessagingCallbackInternal$$ExternalSyntheticLambda3
                @Override // java.lang.Runnable
                public final void run() {
                    CarrierMessagingServiceWrapper.CarrierMessagingCallbackInternal.this.lambda$onSendMmsComplete$3$CarrierMessagingServiceWrapper$CarrierMessagingCallbackInternal(result, sendConfPdu);
                }
            });
        }

        public /* synthetic */ void lambda$onDownloadMmsComplete$4$CarrierMessagingServiceWrapper$CarrierMessagingCallbackInternal(int result) {
        ...
        public void onDownloadMmsComplete(final int result) throws RemoteException {
            this.mExecutor.execute(new Runnable() { // from class: android.service.carrier.CarrierMessagingServiceWrapper$CarrierMessagingCallbackInternal$$ExternalSyntheticLambda0
                @Override // java.lang.Runnable
                public final void run() {
                    CarrierMessagingServiceWrapper.CarrierMessagingCallbackInternal.this.lambda$onDownloadMmsComplete$4$CarrierMessagingServiceWrapper$CarrierMessagingCallbackInternal(result);
                }
            });
        }
    }
