...
public abstract class ContentCaptureService extends Service {
    ...
    private final LocalDataShareAdapterResourceManager mDataShareAdapterResourceManager = new LocalDataShareAdapterResourceManager(null);
    ...
    class AnonymousClass1 extends IContentCaptureService.Stub {
        ...
        public void onConnected(IBinder callback, boolean verbose, boolean debug) {
            ...
            ContentCaptureService.this.mHandler.sendMessage(PooledLambda.obtainMessage(ContentCaptureService$1$$ExternalSyntheticLambda3.INSTANCE, ContentCaptureService.this, callback));
        }

        @Override // android.service.contentcapture.IContentCaptureService
        public void onDisconnected() {
            ContentCaptureService.this.mHandler.sendMessage(PooledLambda.obtainMessage(ContentCaptureService$1$$ExternalSyntheticLambda7.INSTANCE, ContentCaptureService.this));
        }
        ...
        public void onSessionStarted(ContentCaptureContext context, int sessionId, int uid, IResultReceiver clientReceiver, int initialState) {
            ContentCaptureService.this.mHandler.sendMessage(PooledLambda.obtainMessage(ContentCaptureService$1$$ExternalSyntheticLambda0.INSTANCE, ContentCaptureService.this, context, Integer.valueOf(sessionId), Integer.valueOf(uid), clientReceiver, Integer.valueOf(initialState)));
        }

        @Override // android.service.contentcapture.IContentCaptureService
        public void onActivitySnapshot(int sessionId, SnapshotData snapshotData) {
            ContentCaptureService.this.mHandler.sendMessage(PooledLambda.obtainMessage(ContentCaptureService$1$$ExternalSyntheticLambda2.INSTANCE, ContentCaptureService.this, Integer.valueOf(sessionId), snapshotData));
        }

        @Override // android.service.contentcapture.IContentCaptureService
        public void onSessionFinished(int sessionId) {
            ContentCaptureService.this.mHandler.sendMessage(PooledLambda.obtainMessage(ContentCaptureService$1$$ExternalSyntheticLambda6.INSTANCE, ContentCaptureService.this, Integer.valueOf(sessionId)));
        }

        @Override // android.service.contentcapture.IContentCaptureService
        public void onDataRemovalRequest(DataRemovalRequest request) {
            ContentCaptureService.this.mHandler.sendMessage(PooledLambda.obtainMessage(ContentCaptureService$1$$ExternalSyntheticLambda5.INSTANCE, ContentCaptureService.this, request));
        }

        @Override // android.service.contentcapture.IContentCaptureService
        public void onDataShared(DataShareRequest request, IDataShareCallback callback) {
            ContentCaptureService.this.mHandler.sendMessage(PooledLambda.obtainMessage(ContentCaptureService$1$$ExternalSyntheticLambda1.INSTANCE, ContentCaptureService.this, request, callback));
        }

        @Override // android.service.contentcapture.IContentCaptureService
        public void onActivityEvent(ActivityEvent event) {
            ContentCaptureService.this.mHandler.sendMessage(PooledLambda.obtainMessage(ContentCaptureService$1$$ExternalSyntheticLambda4.INSTANCE, ContentCaptureService.this, event));
        }
    }
    ...
    class AnonymousClass2 extends IContentCaptureDirectManager.Stub {
        ...
        public void sendEvents(ParceledListSlice events, int reason, ContentCaptureOptions options) {
            ContentCaptureService.this.mHandler.sendMessage(PooledLambda.obtainMessage(ContentCaptureService$2$$ExternalSyntheticLambda0.INSTANCE, ContentCaptureService.this, Integer.valueOf(Binder.getCallingUid()), events, Integer.valueOf(reason), options));
        }
    }
    ...
    public static class DataShareReadAdapterDelegate extends IDataShareReadAdapter.Stub {
        ...
        private void executeAdapterMethodLocked(final Consumer<DataShareReadAdapter> adapterFn, String methodName) {
            ...
            if (resourceManager == null) {
                String str = ContentCaptureService.TAG;
                Slog.w(str, "Can't execute " + methodName + "(), resource manager has been GC'ed");
                return;
            }
            ...
            if (adapter == null || executor == null) {
                String str2 = ContentCaptureService.TAG;
                Slog.w(str2, "Can't execute " + methodName + "(), references are null");
                return;
            }
    ...
    public static class LocalDataShareAdapterResourceManager {
        ...
        /* synthetic */ LocalDataShareAdapterResourceManager(AnonymousClass1 x0) {
            this();
        }
