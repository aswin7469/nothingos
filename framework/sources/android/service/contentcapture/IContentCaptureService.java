                ...
                default:
                    switch (code) {
                        ...
                        case 3:
                            data.enforceInterface(IContentCaptureService.DESCRIPTOR);
                            if (data.readInt() != 0) {
                                _arg0 = ContentCaptureContext.CREATOR.mo3559createFromParcel(data);
                            } else {
                                _arg0 = null;
                            }
                        ...
                        case 5:
                            ...
                            if (data.readInt() != 0) {
                                _arg1 = SnapshotData.CREATOR.mo3559createFromParcel(data);
                            } else {
                                _arg1 = null;
                            }
                        ...
                        case 6:
                            data.enforceInterface(IContentCaptureService.DESCRIPTOR);
                            if (data.readInt() != 0) {
                                _arg02 = DataRemovalRequest.CREATOR.mo3559createFromParcel(data);
                            } else {
                                _arg02 = null;
                            }
                        ...
                        case 7:
                            data.enforceInterface(IContentCaptureService.DESCRIPTOR);
                            if (data.readInt() != 0) {
                                _arg03 = DataShareRequest.CREATOR.mo3559createFromParcel(data);
                            } else {
                                _arg03 = null;
                            }
                        ...
                        case 8:
                            data.enforceInterface(IContentCaptureService.DESCRIPTOR);
                            if (data.readInt() != 0) {
                                _arg04 = ActivityEvent.CREATOR.mo3559createFromParcel(data);
                            } else {
                                _arg04 = null;
                            }
