...
public final class Control implements Parcelable {
    public static final Parcelable.Creator<Control> CREATOR = new Parcelable.Creator<Control>() { // from class: android.service.controls.Control.1
        ...
        public Control mo3559createFromParcel(Parcel source) {
        ...
        public Control[] mo3560newArray(int size) {
    ...
    Control(String controlId, int deviceType, CharSequence title, CharSequence subtitle, CharSequence structure, CharSequence zone, PendingIntent appIntent, Icon customIcon, ColorStateList customColor, int status, ControlTemplate controlTemplate, CharSequence statusText) {
    ...
    Control(Parcel in) {
        ...
        this.mAppIntent = PendingIntent.CREATOR.mo3559createFromParcel(in);
        if (in.readByte() == 1) {
            this.mCustomIcon = Icon.CREATOR.mo3559createFromParcel(in);
        } else {
            this.mCustomIcon = null;
        }
        if (in.readByte() == 1) {
            this.mCustomColor = ColorStateList.CREATOR.mo3559createFromParcel(in);
        } else {
            this.mCustomColor = null;
        }
        this.mStatus = in.readInt();
        ControlTemplateWrapper wrapper = ControlTemplateWrapper.CREATOR.mo3559createFromParcel(in);
