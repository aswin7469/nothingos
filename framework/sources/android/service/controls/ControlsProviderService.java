        ...
        private Consumer<Integer> consumerFor(final String controlId, final IControlsActionCallback cb) {
            return new Consumer() { // from class: android.service.controls.ControlsProviderService$RequestHandler$$ExternalSyntheticLambda0
                ...
                public final void accept(Object obj) {
                    ControlsProviderService.RequestHandler.this.lambda$consumerFor$0$ControlsProviderService$RequestHandler(cb, controlId, (Integer) obj);
                }
            };
        }

        public /* synthetic */ void lambda$consumerFor$0$ControlsProviderService$RequestHandler(IControlsActionCallback cb, String controlId, Integer response) {
