                ...
                default:
                    switch (code) {
                        case 1:
                            ...
                            if (data.readInt() != 0) {
                                _arg1 = HardwareBuffer.CREATOR.mo3559createFromParcel(data);
                            } else {
                                _arg1 = null;
                            }
                            if (data.readInt() != 0) {
                        ...
                        case 2:
                            ...
                            if (data.readInt() != 0) {
                                _arg12 = DisplayHash.CREATOR.mo3559createFromParcel(data);
                            } else {
                                _arg12 = null;
                            }
                            if (data.readInt() != 0) {
                                _arg22 = RemoteCallback.CREATOR.mo3559createFromParcel(data);
                            } else {
                                _arg22 = null;
                            }
                        ...
                        case 3:
                            data.enforceInterface(IDisplayHashingService.DESCRIPTOR);
                            if (data.readInt() != 0) {
                                _arg0 = RemoteCallback.CREATOR.mo3559createFromParcel(data);
                            } else {
                                _arg0 = null;
                            }
                        ...
                        case 4:
                            data.enforceInterface(IDisplayHashingService.DESCRIPTOR);
                            if (data.readInt() != 0) {
                                _arg02 = RemoteCallback.CREATOR.mo3559createFromParcel(data);
                            } else {
                                _arg02 = null;
                            }
