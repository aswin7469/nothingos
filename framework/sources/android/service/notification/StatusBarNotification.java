...
public class StatusBarNotification implements Parcelable {
    public static final Parcelable.Creator<StatusBarNotification> CREATOR = new Parcelable.Creator<StatusBarNotification>() { // from class: android.service.notification.StatusBarNotification.1
        ...
        public StatusBarNotification mo3559createFromParcel(Parcel parcel) {
        ...
        public StatusBarNotification[] mo3560newArray(int size) {
    ...
    public StatusBarNotification(Parcel in) {
        ...
        if (in.readInt() != 0) {
            this.mInstanceId = InstanceId.CREATOR.mo3559createFromParcel(in);
        }
        this.key = key();
        this.groupKey = groupKey();
    }
    ...
    /* renamed from: clone */
    public StatusBarNotification m2299clone() {
        return cloneShallow(this.notification.m151clone());
    }
