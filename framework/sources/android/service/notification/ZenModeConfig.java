...
public class ZenModeConfig implements Parcelable {
    ...
    public static final Parcelable.Creator<ZenModeConfig> CREATOR = new Parcelable.Creator<ZenModeConfig>() { // from class: android.service.notification.ZenModeConfig.1
        ...
        public ZenModeConfig mo3559createFromParcel(Parcel source) {
        ...
        public ZenModeConfig[] mo3560newArray(int size) {
    ...
    public ZenModeConfig(Parcel source) {
        ...
        this.areChannelsBypassingDnd = source.readInt() != 1 ? false : z9;
            ...
            if (type != 1) {
                ...
                if (type == 2) {
                    if (ALLOW_TAG.equals(tag)) {
                        ...
                        rt.allowConversations = safeBoolean(parser, ALLOW_ATT_CONV, false);
                        ...
                        rt.allowConversationsFrom = safeInt(parser, ALLOW_ATT_CONV_FROM, 3);
    ...
    public void writeXml(TypedXmlSerializer out, Integer version) throws IOException {
        ...
        out.attributeBoolean(null, "media", this.allowMedia);
    ...
    public ZenPolicy toZenPolicy() {
        ...
        if (i4 == 0) {
            ...
            if ((this.suppressedVisualEffects & 256) != 0) {
                z = false;
            }
            builder2.showInNotificationList(z);
        }
    ...
    public NotificationManager.Policy toNotificationPolicy() {
        ...
        int priorityConversationSenders = this.allowConversationsFrom;
    ...
    public void applyNotificationPolicy(NotificationManager.Policy policy) {
        ...
        boolean z2 = (policy.priorityCategories & 256) != 0;
        this.allowConversations = z2;
        this.allowConversationsFrom = normalizeConversationSenders(z2, policy.priorityConversationSenders, this.allowConversationsFrom);
        if (policy.state != -1) {
            if ((policy.state & 1) != 0) {
                z = true;
            }
    ...
    public static Condition toTimeCondition(Context context, long time, int minutes, int userHandle, boolean shortVersion) {
        ...
        if (minutes < 60) {
            ...
            line2 = res.getString(R.string.zen_mode_until_next_day, formattedTime);
            summary = line2;
            line22 = line2;
        }
    ...
    public static Uri toScheduleConditionId(ScheduleInfo schedule) {
        ...
        Uri.Builder appendQueryParameter2 = appendQueryParameter.appendQueryParameter("start", schedule.startHour + MediaMetrics.SEPARATOR + schedule.startMinute);
        return appendQueryParameter2.appendQueryParameter("end", schedule.endHour + MediaMetrics.SEPARATOR + schedule.endMinute).appendQueryParameter("exitAtAlarm", String.valueOf(schedule.exitAtAlarm)).build();
    }
    ...
    public static Uri toEventConditionId(EventInfo event) {
        String str = "";
        Uri.Builder appendQueryParameter = new Uri.Builder().scheme(Condition.SCHEME).authority("android").appendPath("event").appendQueryParameter("userId", Long.toString(event.userId)).appendQueryParameter("calendar", event.calName != null ? event.calName : str);
    ...
    public static class ZenRule implements Parcelable {
        public static final Parcelable.Creator<ZenRule> CREATOR = new Parcelable.Creator<ZenRule>() { // from class: android.service.notification.ZenModeConfig.ZenRule.1
            ...
            @Override // android.os.Parcelable.Creator
            /* renamed from: createFromParcel */
            public ZenRule mo3559createFromParcel(Parcel source) {
            ...
            @Override // android.os.Parcelable.Creator
            /* renamed from: newArray */
            public ZenRule[] mo3560newArray(int size) {
    ...
    public static boolean areAllZenBehaviorSoundsMuted(ZenModeConfig config) {
        return !config.allowAlarms && !config.allowMedia && areAllPriorityOnlyRingerSoundsMuted(config);
    }
