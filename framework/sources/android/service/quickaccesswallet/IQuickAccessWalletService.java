                ...
                default:
                    switch (code) {
                        case 1:
                            ...
                            if (data.readInt() != 0) {
                                _arg0 = GetWalletCardsRequest.CREATOR.mo3559createFromParcel(data);
                            } else {
                                _arg0 = null;
                            }
                        ...
                        case 2:
                            data.enforceInterface(IQuickAccessWalletService.DESCRIPTOR);
                            if (data.readInt() != 0) {
                                _arg02 = SelectWalletCardRequest.CREATOR.mo3559createFromParcel(data);
                            } else {
                                _arg02 = null;
                            }
                        ...
                        case 4:
                            data.enforceInterface(IQuickAccessWalletService.DESCRIPTOR);
                            if (data.readInt() != 0) {
                                _arg03 = WalletServiceEventListenerRequest.CREATOR.mo3559createFromParcel(data);
                            } else {
                                _arg03 = null;
                            }
                        ...
                        case 5:
                            data.enforceInterface(IQuickAccessWalletService.DESCRIPTOR);
                            if (data.readInt() != 0) {
                                _arg04 = WalletServiceEventListenerRequest.CREATOR.mo3559createFromParcel(data);
                            } else {
                                _arg04 = null;
                            }
