                ...
                default:
                    switch (code) {
                        case 1:
                            ...
                            if (data.readInt() != 0) {
                                _arg0 = GetWalletCardsResponse.CREATOR.mo3559createFromParcel(data);
                            } else {
                                _arg0 = null;
                            }
                        ...
                        case 2:
                            data.enforceInterface(IQuickAccessWalletServiceCallbacks.DESCRIPTOR);
                            if (data.readInt() != 0) {
                                _arg02 = GetWalletCardsError.CREATOR.mo3559createFromParcel(data);
                            } else {
                                _arg02 = null;
                            }
                        ...
                        case 3:
                            data.enforceInterface(IQuickAccessWalletServiceCallbacks.DESCRIPTOR);
                            if (data.readInt() != 0) {
                                _arg03 = WalletServiceEvent.CREATOR.mo3559createFromParcel(data);
                            } else {
                                _arg03 = null;
                            }
