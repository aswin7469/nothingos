...
public final class WalletCard implements Parcelable {
    public static final Parcelable.Creator<WalletCard> CREATOR = new Parcelable.Creator<WalletCard>() { // from class: android.service.quickaccesswallet.WalletCard.1
        ...
        public WalletCard mo3559createFromParcel(Parcel source) {
        ...
        public WalletCard[] mo3560newArray(int size) {
    ...
    public static WalletCard readFromParcel(Parcel source) {
        ...
        Icon cardImage = Icon.CREATOR.mo3559createFromParcel(source);
        CharSequence contentDesc = TextUtils.CHAR_SEQUENCE_CREATOR.mo3559createFromParcel(source);
        PendingIntent pendingIntent = PendingIntent.readPendingIntentOrNullFromParcel(source);
        Icon cardIcon = source.readByte() == 0 ? null : Icon.CREATOR.mo3559createFromParcel(source);
        CharSequence cardLabel = TextUtils.CHAR_SEQUENCE_CREATOR.mo3559createFromParcel(source);
