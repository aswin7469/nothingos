...
public final class Tile implements Parcelable {
    public static final Parcelable.Creator<Tile> CREATOR = new Parcelable.Creator<Tile>() { // from class: android.service.quicksettings.Tile.1
        ...
        public Tile mo3559createFromParcel(Parcel source) {
        ...
        public Tile[] mo3560newArray(int size) {
    ...
    private void readFromParcel(Parcel source) {
        ...
        this.mLabel = TextUtils.CHAR_SEQUENCE_CREATOR.mo3559createFromParcel(source);
        this.mSubtitle = TextUtils.CHAR_SEQUENCE_CREATOR.mo3559createFromParcel(source);
        this.mContentDescription = TextUtils.CHAR_SEQUENCE_CREATOR.mo3559createFromParcel(source);
        this.mStateDescription = TextUtils.CHAR_SEQUENCE_CREATOR.mo3559createFromParcel(source);
    }
}
