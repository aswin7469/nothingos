                ...
                default:
                    switch (code) {
                        case 1:
                            ...
                            if (data.readInt() != 0) {
                                _arg0 = SmartspaceConfig.CREATOR.mo3559createFromParcel(data);
                            } else {
                                _arg0 = null;
                            }
                            if (data.readInt() != 0) {
                                _arg1 = SmartspaceSessionId.CREATOR.mo3559createFromParcel(data);
                            } else {
                                _arg1 = null;
                            }
                        ...
                        case 2:
                            data.enforceInterface(ISmartspaceService.DESCRIPTOR);
                            if (data.readInt() != 0) {
                                _arg02 = SmartspaceSessionId.CREATOR.mo3559createFromParcel(data);
                            } else {
                                _arg02 = null;
                            }
                            if (data.readInt() != 0) {
                                _arg12 = SmartspaceTargetEvent.CREATOR.mo3559createFromParcel(data);
                            } else {
                                _arg12 = null;
                            }
                        ...
                        case 3:
                            data.enforceInterface(ISmartspaceService.DESCRIPTOR);
                            if (data.readInt() != 0) {
                                _arg03 = SmartspaceSessionId.CREATOR.mo3559createFromParcel(data);
                            } else {
                                _arg03 = null;
                            }
                        ...
                        case 4:
                            data.enforceInterface(ISmartspaceService.DESCRIPTOR);
                            if (data.readInt() != 0) {
                                _arg04 = SmartspaceSessionId.CREATOR.mo3559createFromParcel(data);
                            } else {
                                _arg04 = null;
                            }
                        ...
                        case 5:
                            data.enforceInterface(ISmartspaceService.DESCRIPTOR);
                            if (data.readInt() != 0) {
                                _arg05 = SmartspaceSessionId.CREATOR.mo3559createFromParcel(data);
                            } else {
                                _arg05 = null;
                            }
                        ...
                        case 6:
                            data.enforceInterface(ISmartspaceService.DESCRIPTOR);
                            if (data.readInt() != 0) {
                                _arg06 = SmartspaceSessionId.CREATOR.mo3559createFromParcel(data);
                            } else {
                                _arg06 = null;
                            }
