    ...
    public class ExternalStorageServiceWrapper extends IExternalStorageService.Stub {
        ...
        public void startSession(final String sessionId, final int flag, final ParcelFileDescriptor deviceFd, final String upperPath, final String lowerPath, final RemoteCallback callback) throws RemoteException {
            ExternalStorageService.this.mHandler.post(new Runnable() { // from class: android.service.storage.ExternalStorageService$ExternalStorageServiceWrapper$$ExternalSyntheticLambda2
                ...
                public final void run() {
                    ExternalStorageService.ExternalStorageServiceWrapper.this.lambda$startSession$0$ExternalStorageService$ExternalStorageServiceWrapper(sessionId, flag, deviceFd, upperPath, lowerPath, callback);
                }
            });
        }

        public /* synthetic */ void lambda$startSession$0$ExternalStorageService$ExternalStorageServiceWrapper(String sessionId, int flag, ParcelFileDescriptor deviceFd, String upperPath, String lowerPath, RemoteCallback callback) {
            try {
        ...
        public void notifyVolumeStateChanged(final String sessionId, final StorageVolume vol, final RemoteCallback callback) {
            ExternalStorageService.this.mHandler.post(new Runnable() { // from class: android.service.storage.ExternalStorageService$ExternalStorageServiceWrapper$$ExternalSyntheticLambda0
                @Override // java.lang.Runnable
                public final void run() {
                    ExternalStorageService.ExternalStorageServiceWrapper.this.lambda$notifyVolumeStateChanged$1$ExternalStorageService$ExternalStorageServiceWrapper(vol, sessionId, callback);
                }
            });
        }

        public /* synthetic */ void lambda$notifyVolumeStateChanged$1$ExternalStorageService$ExternalStorageServiceWrapper(StorageVolume vol, String sessionId, RemoteCallback callback) {
            try {
