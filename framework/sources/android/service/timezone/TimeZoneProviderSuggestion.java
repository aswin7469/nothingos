...
public final class TimeZoneProviderSuggestion implements Parcelable {
    public static final Parcelable.Creator<TimeZoneProviderSuggestion> CREATOR = new Parcelable.Creator<TimeZoneProviderSuggestion>() { // from class: android.service.timezone.TimeZoneProviderSuggestion.1
        ...
        public TimeZoneProviderSuggestion mo3559createFromParcel(Parcel in) {
            ArrayList<String> timeZoneIds = in.readArrayList(null);
        ...
        public TimeZoneProviderSuggestion[] mo3560newArray(int size) {
    ...
    public String toString() {
        return "TimeZoneProviderSuggestion{mTimeZoneIds=" + this.mTimeZoneIds + ", mElapsedRealtimeMillis=" + this.mElapsedRealtimeMillis + "(" + Duration.ofMillis(this.mElapsedRealtimeMillis) + ")}";
    }
    ...
    public static final class Builder {
        ...
        public Builder setTimeZoneIds(List<String> timeZoneIds) {
            Objects.requireNonNull(timeZoneIds);
            this.mTimeZoneIds = timeZoneIds;
            return this;
        }
