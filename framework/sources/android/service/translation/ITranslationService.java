...
public interface ITranslationService extends IInterface {
    ...
    public static abstract class Stub extends Binder implements ITranslationService {
                ...
                default:
                    switch (code) {
                        ...
                        case 3:
                            data.enforceInterface(ITranslationService.DESCRIPTOR);
                            if (data.readInt() != 0) {
                                _arg0 = TranslationContext.CREATOR.mo3559createFromParcel(data);
                            } else {
                                _arg0 = null;
                            }
                            int _arg1 = data.readInt();
                            IResultReceiver _arg22 = IResultReceiver.Stub.asInterface(data.readStrongBinder());
                            onCreateTranslationSession(_arg0, _arg1, _arg22);
                            return true;
                        case 4:
                            data.enforceInterface(ITranslationService.DESCRIPTOR);
                            ...
                            onTranslationCapabilitiesRequest(_arg03, _arg12, _arg2);
                            return true;
                        default:
        ...
        /* loaded from: classes3.dex */
        public static class Proxy implements ITranslationService {
            public static ITranslationService sDefaultImpl;
            ...
            public void onConnected(IBinder callback) throws RemoteException {
                ...
                try {
                    ...
                    if (!_status && Stub.getDefaultImpl() != null) {
                        Stub.getDefaultImpl().onConnected(callback);
                    }
                } finally {
                    _data.recycle();
                }
            ...
            public void onCreateTranslationSession(TranslationContext translationContext, int sessionId, IResultReceiver receiver) throws RemoteException {
                ...
                try {
                    ...
                    if (!_status && Stub.getDefaultImpl() != null) {
                        Stub.getDefaultImpl().onCreateTranslationSession(translationContext, sessionId, receiver);
                    }
                } finally {
                    _data.recycle();
                }
            ...
            public void onTranslationCapabilitiesRequest(int sourceFormat, int targetFormat, ResultReceiver receiver) throws RemoteException {
                ...
                try {
                    ...
                    if (!_status && Stub.getDefaultImpl() != null) {
                        Stub.getDefaultImpl().onTranslationCapabilitiesRequest(sourceFormat, targetFormat, receiver);
                    }
                } finally {
                    _data.recycle();
                }
        ...
        public static boolean setDefaultImpl(ITranslationService impl) {
        ...
        public static ITranslationService getDefaultImpl() {
