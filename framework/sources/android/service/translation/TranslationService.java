...
public abstract class TranslationService extends Service {
    ...
    private final ITranslationDirectManager mClientInterface = new ITranslationDirectManager.Stub() { // from class: android.service.translation.TranslationService.2
        ...
        public void onTranslationRequest(TranslationRequest request, int sessionId, ICancellationSignal transport, ITranslationCallback callback) throws RemoteException {
            ...
            TranslationService.this.mHandler.sendMessage(PooledLambda.obtainMessage(TranslationService$2$$ExternalSyntheticLambda0.INSTANCE, TranslationService.this, request, Integer.valueOf(sessionId), CancellationSignal.fromTransport(transport), consumer));
        }

        @Override // android.view.translation.ITranslationDirectManager
        public void onFinishTranslationSession(int sessionId) throws RemoteException {
            TranslationService.this.mHandler.sendMessage(PooledLambda.obtainMessage(TranslationService$2$$ExternalSyntheticLambda1.INSTANCE, TranslationService.this, Integer.valueOf(sessionId)));
        }
    };
    ...
    class AnonymousClass1 extends ITranslationService.Stub {
        ...
        public void onConnected(IBinder callback) {
            TranslationService.this.mHandler.sendMessage(PooledLambda.obtainMessage(TranslationService$1$$ExternalSyntheticLambda2.INSTANCE, TranslationService.this, callback));
        }

        @Override // android.service.translation.ITranslationService
        public void onDisconnected() {
            TranslationService.this.mHandler.sendMessage(PooledLambda.obtainMessage(TranslationService$1$$ExternalSyntheticLambda3.INSTANCE, TranslationService.this));
        }
        ...
        public void onCreateTranslationSession(TranslationContext translationContext, int sessionId, IResultReceiver receiver) throws RemoteException {
            TranslationService.this.mHandler.sendMessage(PooledLambda.obtainMessage(TranslationService$1$$ExternalSyntheticLambda0.INSTANCE, TranslationService.this, translationContext, Integer.valueOf(sessionId), receiver));
        }
        ...
        public void onTranslationCapabilitiesRequest(int sourceFormat, int targetFormat, ResultReceiver resultReceiver) throws RemoteException {
            TranslationService.this.mHandler.sendMessage(PooledLambda.obtainMessage(TranslationService$1$$ExternalSyntheticLambda1.INSTANCE, TranslationService.this, Integer.valueOf(sourceFormat), Integer.valueOf(targetFormat), resultReceiver));
        }
    }
    ...
    public void handleOnTranslationCapabilitiesRequest(final int sourceFormat, final int targetFormat, final ResultReceiver resultReceiver) {
        onTranslationCapabilitiesRequest(sourceFormat, targetFormat, new Consumer<Set<TranslationCapability>>() { // from class: android.service.translation.TranslationService.4
            ...
            public void accept(Set<TranslationCapability> values) {
                ...
                ArraySet<TranslationCapability> capabilities = new ArraySet<>(values);
                Bundle bundle = new Bundle();
                bundle.putParcelableArray(TranslationManager.EXTRA_CAPABILITIES, (Parcelable[]) capabilities.toArray(new TranslationCapability[0]));
