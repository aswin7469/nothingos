                ...
                default:
                    switch (code) {
                        case 1:
                            ...
                            if (data.readInt() != 0) {
                                _arg0 = SoundTrigger.KeyphraseRecognitionEvent.CREATOR.mo3559createFromParcel(data);
                            } else {
                                _arg0 = null;
                            }
                            if (data.readInt() != 0) {
                        ...
                        case 2:
                            ...
                            if (data.readInt() != 0) {
                                _arg2 = AudioFormat.CREATOR.mo3559createFromParcel(data);
                            } else {
                                _arg2 = null;
                            }
                            if (data.readInt() != 0) {
                        ...
                        case 3:
                            data.enforceInterface(IHotwordDetectionService.DESCRIPTOR);
                            if (data.readInt() != 0) {
                                _arg03 = PersistableBundle.CREATOR.mo3559createFromParcel(data);
                            } else {
                                _arg03 = null;
                            }
                            if (data.readInt() != 0) {
                                _arg12 = SharedMemory.CREATOR.mo3559createFromParcel(data);
                            } else {
                                _arg12 = null;
                            }
                        ...
                        case 5:
                            ...
                            if (data.readInt() != 0) {
                                _arg13 = ContentCaptureOptions.CREATOR.mo3559createFromParcel(data);
                            } else {
                                _arg13 = null;
                            }
