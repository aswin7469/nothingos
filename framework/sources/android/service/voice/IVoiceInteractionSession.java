                ...
                default:
                    switch (code) {
                        case 1:
                            ...
                            IVoiceInteractionSessionShowCallback _arg22 = IVoiceInteractionSessionShowCallback.Stub.asInterface(data.readStrongBinder());
                            show(_arg0, _arg1, _arg22);
                            return true;
                        case 2:
                            data.enforceInterface(DESCRIPTOR);
                            hide();
                        ...
                        case 3:
                            ...
                            if (data.readInt() != 0) {
                                _arg3 = AssistStructure.CREATOR.mo3559createFromParcel(data);
                            } else {
                                _arg3 = null;
                            }
                            if (data.readInt() != 0) {
                                _arg4 = AssistContent.CREATOR.mo3559createFromParcel(data);
                            } else {
                                _arg4 = null;
                            }
                            int _arg5 = data.readInt();
                            int _arg6 = data.readInt();
                            handleAssist(_arg05, _arg12, _arg2, _arg3, _arg4, _arg5, _arg6);
                            return true;
                        case 4:
                            data.enforceInterface(DESCRIPTOR);
                            if (data.readInt() != 0) {
                                _arg02 = Bitmap.CREATOR.mo3559createFromParcel(data);
                            } else {
                                _arg02 = null;
                            }
                        ...
                        case 5:
                            ...
                            taskStarted(_arg03, _arg13);
                            return true;
                        case 6:
                            data.enforceInterface(DESCRIPTOR);
                            if (data.readInt() != 0) {
                                _arg04 = Intent.CREATOR.mo3559createFromParcel(data);
                            } else {
                                _arg04 = null;
                            }
                            int _arg14 = data.readInt();
                            taskFinished(_arg04, _arg14);
                            return true;
                        case 7:
                            data.enforceInterface(DESCRIPTOR);
                            closeSystemDialogs();
