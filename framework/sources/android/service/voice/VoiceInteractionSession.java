...
public class VoiceInteractionSession implements KeyEvent.Callback, ComponentCallbacks2 {
    ...
    public VoiceInteractionSession(Context context, Handler handler) {
        ...
        this.mInteractor = new IVoiceInteractor.Stub() { // from class: android.service.voice.VoiceInteractionSession.1
            ...
            public void notifyDirectActionsChanged(int taskId, IBinder assistToken) {
                VoiceInteractionSession.this.mHandlerCaller.getHandler().sendMessage(PooledLambda.obtainMessage(VoiceInteractionSession$1$$ExternalSyntheticLambda0.INSTANCE, VoiceInteractionSession.this, new ActivityId(taskId, assistToken)));
            }
    ...
    void ensureWindowCreated() {
        ...
        SoftInputWindow softInputWindow = new SoftInputWindow(this.mContext, TAG, this.mTheme, this.mCallbacks, this, this.mDispatcherState, 2031, 80, true);
    ...
    public void startAssistantActivity(Intent intent) {
        ...
        try {
            intent.migrateExtraStreamToClipData(this.mContext);
            intent.prepareToLeaveProcess(this.mContext);
            int res = this.mSystemService.startAssistantActivity(this.mToken, intent, intent.resolveType(this.mContext.getContentResolver()), this.mContext.getAttributionTag());
            Instrumentation.checkStartActivityResult(res, intent);
        } catch (RemoteException e) {
        }
    }
    ...
    public final void requestDirectActions(ActivityId activityId, final CancellationSignal cancellationSignal, final Executor resultExecutor, final Consumer<List<DirectAction>> callback) {
        ...
        try {
            this.mSystemService.requestDirectActions(this.mToken, activityId.getTaskId(), activityId.getAssistToken(), cancellationCallback, new RemoteCallback(createSafeResultListener(new Consumer() { // from class: android.service.voice.VoiceInteractionSession$$ExternalSyntheticLambda6
    ...
    public final void performDirectAction(DirectAction action, Bundle extras, final CancellationSignal cancellationSignal, final Executor resultExecutor, final Consumer<Bundle> resultListener) {
        ...
        if (cancellationSignal != null) {
            cancellationCallback = new RemoteCallback(createSafeResultListener(new Consumer() { // from class: android.service.voice.VoiceInteractionSession$$ExternalSyntheticLambda4
                @Override // java.util.function.Consumer
                public final void accept(Object obj) {
        ...
        RemoteCallback resultCallback = new RemoteCallback(createSafeResultListener(new Consumer() { // from class: android.service.voice.VoiceInteractionSession$$ExternalSyntheticLambda5
            @Override // java.util.function.Consumer
            public final void accept(Object obj) {
    ...
    public static /* synthetic */ void lambda$performDirectAction$6(Executor resultExecutor, final Consumer resultListener, final Bundle b) {
        if (b != null) {
            ...
            resultExecutor.execute(new Runnable() { // from class: android.service.voice.VoiceInteractionSession$$ExternalSyntheticLambda1
                @Override // java.lang.Runnable
                public final void run() {
