...
public class TextToSpeech {
    ...
    public void dispatchOnInit(final int result) {
        Runnable onInitCommand = new Runnable() { // from class: android.speech.tts.TextToSpeech$$ExternalSyntheticLambda17
            @Override // java.lang.Runnable
            public final void run() {
                TextToSpeech.this.lambda$dispatchOnInit$0$TextToSpeech(result);
            }
        };
    ...
    public /* synthetic */ void lambda$dispatchOnInit$0$TextToSpeech(int result) {
        synchronized (this.mStartLock) {
    ...
    public void shutdown() {
        synchronized (this.mStartLock) {
            ...
            runActionNoReconnect(new Action() { // from class: android.speech.tts.TextToSpeech$$ExternalSyntheticLambda2
                @Override // android.speech.tts.TextToSpeech.Action
                public final Object run(ITextToSpeechService iTextToSpeechService) {
                    return TextToSpeech.this.lambda$shutdown$1$TextToSpeech(iTextToSpeechService);
                }
            }, null, "shutdown", false);
        }
    }

    public /* synthetic */ Object lambda$shutdown$1$TextToSpeech(ITextToSpeechService service) throws RemoteException {
    ...
    public int speak(final CharSequence text, final int queueMode, final Bundle params, final String utteranceId) {
        return ((Integer) runAction(new Action() { // from class: android.speech.tts.TextToSpeech$$ExternalSyntheticLambda6
            @Override // android.speech.tts.TextToSpeech.Action
            public final Object run(ITextToSpeechService iTextToSpeechService) {
                return TextToSpeech.this.lambda$speak$2$TextToSpeech(text, queueMode, params, utteranceId, iTextToSpeechService);
            }
        }, -1, "speak")).intValue();
    }

    public /* synthetic */ Integer lambda$speak$2$TextToSpeech(CharSequence text, int queueMode, Bundle params, String utteranceId, ITextToSpeechService service) throws RemoteException {
    ...
    public int playEarcon(final String earcon, final int queueMode, final Bundle params, final String utteranceId) {
        return ((Integer) runAction(new Action() { // from class: android.speech.tts.TextToSpeech$$ExternalSyntheticLambda8
            @Override // android.speech.tts.TextToSpeech.Action
            public final Object run(ITextToSpeechService iTextToSpeechService) {
                return TextToSpeech.this.lambda$playEarcon$3$TextToSpeech(earcon, queueMode, params, utteranceId, iTextToSpeechService);
            }
        }, -1, "playEarcon")).intValue();
    }

    public /* synthetic */ Integer lambda$playEarcon$3$TextToSpeech(String earcon, int queueMode, Bundle params, String utteranceId, ITextToSpeechService service) throws RemoteException {
    ...
    public int playSilentUtterance(final long durationInMs, final int queueMode, final String utteranceId) {
        return ((Integer) runAction(new Action() { // from class: android.speech.tts.TextToSpeech$$ExternalSyntheticLambda4
            @Override // android.speech.tts.TextToSpeech.Action
            public final Object run(ITextToSpeechService iTextToSpeechService) {
                return TextToSpeech.this.lambda$playSilentUtterance$4$TextToSpeech(durationInMs, queueMode, utteranceId, iTextToSpeechService);
            }
        }, -1, "playSilentUtterance")).intValue();
    }

    public /* synthetic */ Integer lambda$playSilentUtterance$4$TextToSpeech(long durationInMs, int queueMode, String utteranceId, ITextToSpeechService service) throws RemoteException {
    ...
    public Set<String> getFeatures(final Locale locale) {
        return (Set) runAction(new Action() { // from class: android.speech.tts.TextToSpeech$$ExternalSyntheticLambda10
            @Override // android.speech.tts.TextToSpeech.Action
            public final Object run(ITextToSpeechService iTextToSpeechService) {
    ...
    public boolean isSpeaking() {
        return ((Boolean) runAction(TextToSpeech$$ExternalSyntheticLambda16.INSTANCE, false, "isSpeaking")).booleanValue();
    }
    ...
    public int stop() {
        return ((Integer) runAction(new Action() { // from class: android.speech.tts.TextToSpeech$$ExternalSyntheticLambda3
            @Override // android.speech.tts.TextToSpeech.Action
            public final Object run(ITextToSpeechService iTextToSpeechService) {
                return TextToSpeech.this.lambda$stop$7$TextToSpeech(iTextToSpeechService);
            }
        }, -1, LocationTimeZoneManager.SHELL_COMMAND_STOP)).intValue();
    }

    public /* synthetic */ Integer lambda$stop$7$TextToSpeech(ITextToSpeechService service) throws RemoteException {
    ...
    public Locale getDefaultLanguage() {
        return (Locale) runAction(TextToSpeech$$ExternalSyntheticLambda13.INSTANCE, null, "getDefaultLanguage");
    }
    ...
    public int setLanguage(final Locale loc) {
        return ((Integer) runAction(new Action() { // from class: android.speech.tts.TextToSpeech$$ExternalSyntheticLambda9
            @Override // android.speech.tts.TextToSpeech.Action
            public final Object run(ITextToSpeechService iTextToSpeechService) {
                return TextToSpeech.this.lambda$setLanguage$9$TextToSpeech(loc, iTextToSpeechService);
            }
        }, -2, "setLanguage")).intValue();
    }

    public /* synthetic */ Integer lambda$setLanguage$9$TextToSpeech(Locale loc, ITextToSpeechService service) throws RemoteException {
        if (loc == null) {
            return -2;
        }
        try {
            ...
            try {
                ...
                if (result >= 0) {
                    ...
                    if (TextUtils.isEmpty(voiceName)) {
                        Log.w(TAG, "Couldn't find the default voice for " + language + NativeLibraryHelper.CLEAR_ABI_OVERRIDE + country + NativeLibraryHelper.CLEAR_ABI_OVERRIDE + variant);
                        return -2;
                    } else if (service.loadVoice(getCallerIdentity(), voiceName) == -1) {
                        Log.w(TAG, "The service claimed " + language + NativeLibraryHelper.CLEAR_ABI_OVERRIDE + country + NativeLibraryHelper.CLEAR_ABI_OVERRIDE + variant + " was available with voice name " + voiceName + " but loadVoice returned ERROR");
                        return -2;
                    } else {
                        Voice voice = getVoice(service, voiceName);
                        if (voice == null) {
                            Log.w(TAG, "getDefaultVoiceNameFor returned " + voiceName + " for locale " + language + NativeLibraryHelper.CLEAR_ABI_OVERRIDE + country + NativeLibraryHelper.CLEAR_ABI_OVERRIDE + variant + " but getVoice returns null");
                            return -2;
                        }
                ...
                Log.w(TAG, "Couldn't retrieve ISO 3166 country code for locale: " + loc, e3);
                return -2;
            }
        } catch (MissingResourceException e4) {
            Log.w(TAG, "Couldn't retrieve ISO 639-2/T language code for locale: " + loc, e4);
            return -2;
        }
    }
    ...
    public Locale getLanguage() {
        return (Locale) runAction(new Action() { // from class: android.speech.tts.TextToSpeech$$ExternalSyntheticLambda0
            @Override // android.speech.tts.TextToSpeech.Action
            public final Object run(ITextToSpeechService iTextToSpeechService) {
                return TextToSpeech.this.lambda$getLanguage$10$TextToSpeech(iTextToSpeechService);
            }
        }, null, "getLanguage");
    }

    public /* synthetic */ Locale lambda$getLanguage$10$TextToSpeech(ITextToSpeechService service) throws RemoteException {
    ...
    public Set<Locale> getAvailableLanguages() {
        return (Set) runAction(TextToSpeech$$ExternalSyntheticLambda12.INSTANCE, null, "getAvailableLanguages");
    }
    ...
    public Set<Voice> getVoices() {
        return (Set) runAction(TextToSpeech$$ExternalSyntheticLambda15.INSTANCE, null, "getVoices");
    }
    ...
    public int setVoice(final Voice voice) {
        return ((Integer) runAction(new Action() { // from class: android.speech.tts.TextToSpeech$$ExternalSyntheticLambda5
            @Override // android.speech.tts.TextToSpeech.Action
            public final Object run(ITextToSpeechService iTextToSpeechService) {
                return TextToSpeech.this.lambda$setVoice$13$TextToSpeech(voice, iTextToSpeechService);
            }
        }, -2, "setVoice")).intValue();
    }

    public /* synthetic */ Integer lambda$setVoice$13$TextToSpeech(Voice voice, ITextToSpeechService service) throws RemoteException {
    ...
    public Voice getVoice() {
        return (Voice) runAction(new Action() { // from class: android.speech.tts.TextToSpeech$$ExternalSyntheticLambda1
            @Override // android.speech.tts.TextToSpeech.Action
            public final Object run(ITextToSpeechService iTextToSpeechService) {
                return TextToSpeech.this.lambda$getVoice$14$TextToSpeech(iTextToSpeechService);
            }
        }, null, "getVoice");
    }

    public /* synthetic */ Voice lambda$getVoice$14$TextToSpeech(ITextToSpeechService service) throws RemoteException {
    ...
    public Voice getDefaultVoice() {
        return (Voice) runAction(TextToSpeech$$ExternalSyntheticLambda14.INSTANCE, null, "getDefaultVoice");
    }
    ...
    public int isLanguageAvailable(final Locale loc) {
        return ((Integer) runAction(new Action() { // from class: android.speech.tts.TextToSpeech$$ExternalSyntheticLambda11
            @Override // android.speech.tts.TextToSpeech.Action
            public final Object run(ITextToSpeechService iTextToSpeechService) {
    ...
    public static /* synthetic */ Integer lambda$isLanguageAvailable$16(Locale loc, ITextToSpeechService service) throws RemoteException {
        try {
            ...
            Log.w(TAG, "Couldn't retrieve ISO 639-2/T language code for locale: " + loc, e2);
            return -2;
        }
    }
    ...
    public int synthesizeToFile(final CharSequence text, final Bundle params, final ParcelFileDescriptor fileDescriptor, final String utteranceId) {
        return ((Integer) runAction(new Action() { // from class: android.speech.tts.TextToSpeech$$ExternalSyntheticLambda7
            @Override // android.speech.tts.TextToSpeech.Action
            public final Object run(ITextToSpeechService iTextToSpeechService) {
                return TextToSpeech.this.lambda$synthesizeToFile$17$TextToSpeech(text, fileDescriptor, params, utteranceId, iTextToSpeechService);
            }
        }, -1, "synthesizeToFile")).intValue();
    }

    public /* synthetic */ Integer lambda$synthesizeToFile$17$TextToSpeech(CharSequence text, ParcelFileDescriptor fileDescriptor, Bundle params, String utteranceId, ITextToSpeechService service) throws RemoteException {
        ...
        void disconnect() {
            ...
            if (session != null) {
                try {
                    ...
                    Log.w(TextToSpeech.TAG, "Error disconnecting session", ex);
                }
                clearServiceConnection();
            }
        }
