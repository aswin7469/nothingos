                ...
                default:
                    switch (code) {
                        case 1:
                            data.enforceInterface(descriptor);
                            if (data.readInt() != 0) {
                                _arg0 = KeyDescriptor.CREATOR.mo3559createFromParcel(data);
                            } else {
                                _arg0 = null;
                            }
                        ...
                        case 2:
                            data.enforceInterface(descriptor);
                            if (data.readInt() != 0) {
                                _arg02 = KeyDescriptor.CREATOR.mo3559createFromParcel(data);
                            } else {
                                _arg02 = null;
                            }
                            if (data.readInt() != 0) {
                                _arg1 = KeyDescriptor.CREATOR.mo3559createFromParcel(data);
                            } else {
                                _arg1 = null;
                            }
                        ...
                        case 3:
                            data.enforceInterface(descriptor);
                            if (data.readInt() != 0) {
                                _arg03 = KeyDescriptor.CREATOR.mo3559createFromParcel(data);
                            } else {
                                _arg03 = null;
                            }
                            if (data.readInt() != 0) {
                                _arg12 = KeyDescriptor.CREATOR.mo3559createFromParcel(data);
                            } else {
                                _arg12 = null;
                            }
                        ...
                        case 4:
                            data.enforceInterface(descriptor);
                            if (data.readInt() != 0) {
                                _arg04 = KeyDescriptor.CREATOR.mo3559createFromParcel(data);
                            } else {
                                _arg04 = null;
                            }
                            if (data.readInt() != 0) {
                                _arg13 = KeyDescriptor.CREATOR.mo3559createFromParcel(data);
                            } else {
                                _arg13 = null;
                            }
                        ...
                        case 5:
                            data.enforceInterface(descriptor);
                            if (data.readInt() != 0) {
                                _arg05 = KeyDescriptor.CREATOR.mo3559createFromParcel(data);
                            } else {
                                _arg05 = null;
                            }
                        ...
                        case 6:
                            data.enforceInterface(descriptor);
                            if (data.readInt() != 0) {
                                _arg06 = KeyDescriptor.CREATOR.mo3559createFromParcel(data);
                            } else {
                                _arg06 = null;
                            }
                            deleteKey(_arg06);
        ...
        public static class Proxy implements IKeystoreSecurityLevel {
            ...
            public CreateOperationResponse createOperation(KeyDescriptor key, KeyParameter[] operationParameters, boolean forced) throws RemoteException {
                ...
                try {
                    ...
                    if (_reply.readInt() != 0) {
                        _result = CreateOperationResponse.CREATOR.mo3559createFromParcel(_reply);
                    } else {
                        _result = null;
                    }
                    return _result;
            ...
            public KeyMetadata generateKey(KeyDescriptor key, KeyDescriptor attestationKey, KeyParameter[] params, int flags, byte[] entropy) throws RemoteException {
                ...
                try {
                    ...
                    _reply.readException();
                    if (_reply.readInt() != 0) {
                        _result = KeyMetadata.CREATOR.mo3559createFromParcel(_reply);
                    } else {
                        _result = null;
                    }
                    return _result;
            ...
            public EphemeralStorageKeyResponse convertStorageKeyToEphemeral(KeyDescriptor storageKey) throws RemoteException {
                ...
                try {
                    ...
                    _reply.readException();
                    if (_reply.readInt() != 0) {
                        _result = EphemeralStorageKeyResponse.CREATOR.mo3559createFromParcel(_reply);
                    } else {
                        _result = null;
                    }
                    return _result;
