...
public final class CallAudioState implements Parcelable {
    public static final Parcelable.Creator<CallAudioState> CREATOR = new Parcelable.Creator<CallAudioState>() { // from class: android.telecom.CallAudioState.1
        ...
        public CallAudioState mo3559createFromParcel(Parcel source) {
        ...
        public CallAudioState[] mo3560newArray(int size) {
    ...
    public String toString() {
        String bluetoothDeviceList = (String) this.supportedBluetoothDevices.stream().map(CallAudioState$$ExternalSyntheticLambda0.INSTANCE).collect(Collectors.joining(", "));
