...
public abstract class CallDiagnosticService extends Service {
    ...
    public abstract void lambda$handleBluetoothCallQualityReport$4$CallDiagnosticService(BluetoothCallQualityReport bluetoothCallQualityReport);
    ...
    public abstract void lambda$handleCallRemoved$2$CallDiagnosticService(CallDiagnostics callDiagnostics);
    ...
    public final class CallDiagnosticServiceBinder extends ICallDiagnosticService.Stub {
        ...
        public /* synthetic */ void lambda$updateCallAudioState$0$CallDiagnosticService$CallDiagnosticServiceBinder(CallAudioState callAudioState) {
        ...
        public void updateCallAudioState(final CallAudioState callAudioState) throws RemoteException {
            CallDiagnosticService.this.getExecutor().execute(new Runnable() { // from class: android.telecom.CallDiagnosticService$CallDiagnosticServiceBinder$$ExternalSyntheticLambda0
                ...
                public final void run() {
                    CallDiagnosticService.CallDiagnosticServiceBinder.this.lambda$updateCallAudioState$0$CallDiagnosticService$CallDiagnosticServiceBinder(callAudioState);
                }
            });
        }
    ...
    public void handleCallAdded(ParcelableCall parcelableCall) {
        ...
        getExecutor().execute(new Runnable() { // from class: android.telecom.CallDiagnosticService$$ExternalSyntheticLambda1
            @Override // java.lang.Runnable
            public final void run() {
                CallDiagnosticService.this.lambda$handleCallAdded$0$CallDiagnosticService(newCallDetails, telecomCallId);
            }
        });
    }

    public /* synthetic */ void lambda$handleCallAdded$0$CallDiagnosticService(Call.Details newCallDetails, String telecomCallId) {
    ...
    public void handleCallRemoved(String telecomCallId) {
        ...
        if (callDiagnostics != null) {
            getExecutor().execute(new Runnable() { // from class: android.telecom.CallDiagnosticService$$ExternalSyntheticLambda2
                @Override // java.lang.Runnable
                public final void run() {
                    CallDiagnosticService.this.lambda$handleCallRemoved$2$CallDiagnosticService(callDiagnostics);
                }
            });
        }
    }
    ...
    public void handleBluetoothCallQualityReport(final BluetoothCallQualityReport qualityReport) {
        ...
        getExecutor().execute(new Runnable() { // from class: android.telecom.CallDiagnosticService$$ExternalSyntheticLambda0
            @Override // java.lang.Runnable
            public final void run() {
                CallDiagnosticService.this.lambda$handleBluetoothCallQualityReport$4$CallDiagnosticService(qualityReport);
            }
        });
    }
