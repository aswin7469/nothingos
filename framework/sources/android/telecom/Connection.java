...
public abstract class Connection extends Conferenceable {
    ...
    public static final String EXTRA_DISABLE_SWAP_CALL = "android.telecom.extra.DISABLE_SWAP_CALL";
    ...
    public static final int PROPERTY_IS_PARTICIPANT_HOST = 16384;
    ...
    public static final class CallFilteringCompletionInfo implements Parcelable {
        public static final Parcelable.Creator<CallFilteringCompletionInfo> CREATOR = new Parcelable.Creator<CallFilteringCompletionInfo>() { // from class: android.telecom.Connection.CallFilteringCompletionInfo.1
            ...
            public CallFilteringCompletionInfo mo3559createFromParcel(Parcel in) {
            ...
            public CallFilteringCompletionInfo[] mo3560newArray(int size) {
        ...
        protected CallFilteringCompletionInfo(Parcel in) {
            ...
            this.mIsInContacts = in.readByte() == 0 ? false : z;
            CallScreeningService.ParcelableCallResponse response = (CallScreeningService.ParcelableCallResponse) in.readParcelable(CallScreeningService.class.getClassLoader());
            this.mCallResponse = response == null ? null : response.toCallResponse();
            this.mCallScreeningComponent = (ComponentName) in.readParcelable(ComponentName.class.getClassLoader());
        }
