...
public final class DisconnectCause implements Parcelable {
    ...
    public static final Parcelable.Creator<DisconnectCause> CREATOR = new Parcelable.Creator<DisconnectCause>() { // from class: android.telecom.DisconnectCause.1
        ...
        public DisconnectCause mo3559createFromParcel(Parcel source) {
            int code = source.readInt();
            CharSequence label = TextUtils.CHAR_SEQUENCE_CREATOR.mo3559createFromParcel(source);
            CharSequence description = TextUtils.CHAR_SEQUENCE_CREATOR.mo3559createFromParcel(source);
            ...
            ImsReasonInfo imsReasonInfo = (ImsReasonInfo) source.readParcelable(null);
        ...
        public DisconnectCause[] mo3560newArray(int size) {
    ...
    public String toString() {
        ...
        String reason = "";
        String label = charSequence == null ? reason : charSequence.toString();
        CharSequence charSequence2 = this.mDisconnectDescription;
        String description = charSequence2 == null ? reason : charSequence2.toString();
