...
public class GatewayInfo implements Parcelable {
    public static final Parcelable.Creator<GatewayInfo> CREATOR = new Parcelable.Creator<GatewayInfo>() { // from class: android.telecom.GatewayInfo.1
        ...
        public GatewayInfo mo3559createFromParcel(Parcel source) {
            String gatewayPackageName = source.readString();
            Uri gatewayUri = Uri.CREATOR.mo3559createFromParcel(source);
            Uri originalAddress = Uri.CREATOR.mo3559createFromParcel(source);
        ...
        public GatewayInfo[] mo3560newArray(int size) {
