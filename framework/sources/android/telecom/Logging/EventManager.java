...
public class EventManager {
    ...
    public void dumpEventsTimeline(IndentingPrintWriter pw) {
        ...
        Comparator<Pair<Loggable, Event>> byEventTime = Comparator.comparingLong(EventManager$$ExternalSyntheticLambda1.INSTANCE);
    ...
    public void changeEventCacheSize(int newSize) {
        ...
        oldEventLog.forEach(new Consumer() { // from class: android.telecom.Logging.EventManager$$ExternalSyntheticLambda0
