...
public class Session {
    ...
    private Session mParentSession = null;
    private ArrayList<Session> mChildSessions = new ArrayList<>(5);
    ...
    public static class Info implements Parcelable {
        public static final Parcelable.Creator<Info> CREATOR = new Parcelable.Creator<Info>() { // from class: android.telecom.Logging.Session.Info.1
            ...
            public Info mo3559createFromParcel(Parcel source) {
            ...
            public Info[] mo3560newArray(int size) {
