...
public final class ParcelableConference implements Parcelable {
    public static final Parcelable.Creator<ParcelableConference> CREATOR = new Parcelable.Creator<ParcelableConference>() { // from class: android.telecom.ParcelableConference.1
        ...
        public ParcelableConference mo3559createFromParcel(Parcel source) {
    ...
    public String toString() {
        ...
        stringBuffer.append(this.mRingbackRequested);
        stringBuffer.append(", disconnectCause: ");
        stringBuffer.append(this.mDisconnectCause);
        stringBuffer.append(", callDirection: ");
        stringBuffer.append(this.mCallDirection);
