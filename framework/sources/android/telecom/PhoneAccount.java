...
public final class PhoneAccount implements Parcelable {
    ...
    public static final Parcelable.Creator<PhoneAccount> CREATOR = new Parcelable.Creator<PhoneAccount>() { // from class: android.telecom.PhoneAccount.1
        ...
        public PhoneAccount mo3559createFromParcel(Parcel in) {
        ...
        public PhoneAccount[] mo3560newArray(int size) {
    ...
    private PhoneAccount(Parcel in) {
        if (in.readInt() > 0) {
            this.mAccountHandle = PhoneAccountHandle.CREATOR.mo3559createFromParcel(in);
        } else {
            this.mAccountHandle = null;
        }
        if (in.readInt() > 0) {
            this.mAddress = Uri.CREATOR.mo3559createFromParcel(in);
        } else {
            this.mAddress = null;
        }
        if (in.readInt() > 0) {
            this.mSubscriptionAddress = Uri.CREATOR.mo3559createFromParcel(in);
        } else {
    ...
    public String toString() {
        ...
        StringBuilder sb2 = sb.append(" Schemes: ");
        ...
        sb2.append(" GroupId: ");
        sb2.append(Log.pii(this.mGroupId));
        sb2.append("]");
        return sb2.toString();
    }
