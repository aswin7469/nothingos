...
public class TelecomManager {
    ...
    public PhoneAccountHandle getSimCallManager() {
        ...
        if (service != null) {
            try {
                return service.getSimCallManager(SubscriptionManager.getDefaultSubscriptionId());
            } catch (RemoteException e) {
    ...
    public List<PhoneAccountHandle> getPhoneAccountsSupportingScheme(String uriScheme) {
        ...
        if (service != null) {
            try {
                return service.getPhoneAccountsSupportingScheme(uriScheme, this.mContext.getOpPackageName());
            } catch (RemoteException e) {
    ...
    public List<PhoneAccountHandle> getSelfManagedPhoneAccounts() {
        ...
        if (service != null) {
            try {
                return service.getSelfManagedPhoneAccounts(this.mContext.getOpPackageName(), this.mContext.getAttributionTag());
            } catch (RemoteException e) {
    ...
    public List<PhoneAccountHandle> getCallCapablePhoneAccounts(boolean includeDisabledAccounts) {
        ...
        if (service != null) {
            try {
                return service.getCallCapablePhoneAccounts(includeDisabledAccounts, this.mContext.getOpPackageName(), this.mContext.getAttributionTag());
            } catch (RemoteException e) {
                android.util.Log.e(TAG, "Error calling ITelecomService#getCallCapablePhoneAccounts(" + includeDisabledAccounts + ")", e);
            }
        }
        return new ArrayList();
    }
    ...
    public List<PhoneAccountHandle> getPhoneAccountsForPackage() {
        ...
        if (service != null) {
            try {
                return service.getPhoneAccountsForPackage(this.mContext.getPackageName());
            } catch (RemoteException e) {
    ...
    public int getCallState() {
        ...
        if (service != null) {
            try {
                return service.getCallStateUsingPackage(this.mContext.getPackageName(), this.mContext.getAttributionTag());
            } catch (RemoteException e) {
    ...
    public void addNewIncomingConference(PhoneAccountHandle phoneAccount, Bundle extras) {
        ...
        if (service != null) {
            ...
            service.addNewIncomingConference(phoneAccount, bundle);
        }
    }
