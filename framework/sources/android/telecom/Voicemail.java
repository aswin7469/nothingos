...
public class Voicemail implements Parcelable {
    public static final Parcelable.Creator<Voicemail> CREATOR = new Parcelable.Creator<Voicemail>() { // from class: android.telecom.Voicemail.1
        ...
        public Voicemail mo3559createFromParcel(Parcel in) {
        ...
        public Voicemail[] mo3560newArray(int size) {
    ...
    private Voicemail(Parcel in) {
        ...
        if (in.readInt() > 0) {
            this.mPhoneAccount = PhoneAccountHandle.CREATOR.mo3559createFromParcel(in);
        } else {
        ...
        this.mHasContent = Boolean.valueOf(in.readInt() <= 0 ? false : z);
