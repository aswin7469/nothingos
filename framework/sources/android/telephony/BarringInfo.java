...
public final class BarringInfo implements Parcelable {
    ...
    public static final Parcelable.Creator<BarringInfo> CREATOR = new Parcelable.Creator<BarringInfo>() { // from class: android.telephony.BarringInfo.1
        ...
        public BarringInfo mo3559createFromParcel(Parcel source) {
        ...
        public BarringInfo[] mo3560newArray(int size) {
    ...
    public static final class BarringServiceInfo implements Parcelable {
        ...
        public static final Parcelable.Creator<BarringServiceInfo> CREATOR = new Parcelable.Creator<BarringServiceInfo>() { // from class: android.telephony.BarringInfo.BarringServiceInfo.1
            ...
            @Override // android.os.Parcelable.Creator
            /* renamed from: createFromParcel */
            public BarringServiceInfo mo3559createFromParcel(Parcel source) {
            ...
            @Override // android.os.Parcelable.Creator
            /* renamed from: newArray */
            public BarringServiceInfo[] mo3560newArray(int size) {
    ...
    public static BarringInfo create(android.hardware.radio.V1_5.CellIdentity halBarringCellId, List<android.hardware.radio.V1_5.BarringInfo> halBarringInfos) {
        ...
        for (android.hardware.radio.V1_5.BarringInfo halBarringInfo : halBarringInfos) {
            if (halBarringInfo.barringType == 1) {
                if (halBarringInfo.barringTypeSpecificInfo.getDiscriminator() == 1) {
    ...
    public BarringInfo createLocationInfoSanitizedCopy() {
        return this.mCellIdentity == null ? this : new BarringInfo(this.mCellIdentity.mo2458sanitizeLocationInfo(), this.mBarringServiceInfos);
    }
