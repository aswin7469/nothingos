...
public class CarrierConfigManager {
    ...
    public static final String KEY_ALLOW_CONCURRENT_CALL_DURING_VIDEO_CALL_BOOL = "allow_concurrent_call_during_video_call";
    ...
    public static final String KEY_CALL_FORWARDING_WHEN_NOT_LOGGED_IN_SUPPORTED_BOOL = "call_forwarding_when_not_logged_in_supported_bool";
    ...
    public static final String KEY_CARRIER_DATA_CALL_RETRY_NETWORK_REQUESTED_MAX_COUNT_INT = "carrier_data_call_retry_network_requested_max_count_int";
    ...
    public static final String KEY_CARRIER_DEFAULT_SA_ENABLED_BOOL = "carrier_default_sa_enabled_bool";
    public static final String KEY_CARRIER_DEFAULT_SMART_5G_ENABLED_BOOL = "carrier_default_smart_5g_enabled_bool";
    ...
    public static final String KEY_HIDE_5G_STANDALONE_BOOL = "hide_5g_standalone_bool";
    public static final String KEY_HIDE_CALL_BARRING_PASSWD_BOOL = "hide_call_barring_passwd_bool";
    public static final String KEY_HIDE_CARRIER_NAME_EXTRA_BOOL = "hide_carrier_name_extra_bool";
    ...
    public static final String KEY_HIDE_SMART_5G_BOOL = "hide_smart_5g_bool";
    ...
    public static final String KEY_OPPORTUNISTIC_NETWORK_5G_BACKOFF_TIME_LONG = "opportunistic_network_5g_backoff_time_long";
    public static final String KEY_OPPORTUNISTIC_NETWORK_5G_DATA_SWITCH_EXIT_HYSTERESIS_TIME_LONG = "opportunistic_network_5g_data_switch_exit_hysteresis_time_long";
    public static final String KEY_OPPORTUNISTIC_NETWORK_5G_DATA_SWITCH_HYSTERESIS_TIME_LONG = "opportunistic_network_5g_data_switch_hysteresis_time_long";
    public static final String KEY_OPPORTUNISTIC_NETWORK_5G_MAX_BACKOFF_TIME_LONG = "opportunistic_network_5g_max_backoff_time_long";
    public static final String KEY_OPPORTUNISTIC_NETWORK_5G_PING_PONG_TIME_LONG = "opportunistic_network_5g_ping_pong_time_long";
    ...
    public static final String KEY_OPPORTUNISTIC_NETWORK_ENTRY_THRESHOLD_SS_RSRP_INT = "opportunistic_network_entry_threshold_ss_rsrp_int";
    public static final String KEY_OPPORTUNISTIC_NETWORK_ENTRY_THRESHOLD_SS_RSRQ_DOUBLE = "opportunistic_network_entry_threshold_ss_rsrq_double";
    ...
    public static final String KEY_OPPORTUNISTIC_NETWORK_EXIT_THRESHOLD_SS_RSRP_INT = "opportunistic_network_exit_threshold_ss_rsrp_int";
    public static final String KEY_OPPORTUNISTIC_NETWORK_EXIT_THRESHOLD_SS_RSRQ_DOUBLE = "opportunistic_network_exit_threshold_ss_rsrq_double";
    ...
    public static final String KEY_REQUIRE_APN_FILTERING_WITH_RADIO_CAPABILITY = "require_apn_filtering_with_radio_capability_bool";
    ...
    public static final String KEY_SHOW_HSPA_DATA_ICON_BOOL = "show_hspa_data_icon_bool";
    ...
    public static final String KEY_SHOW_VOWIFI_STATUS_BAR_ICON_BOOL = "show_vowifi_status_bar_icon_bool";
    ...
    public static final String KEY_USE_LOWER_MTU_VALUE_IF_BOTH_RECEIVED = "use_lower_mtu_value_if_both_received";
    ...
    public static final String KEY_USE_SMS_CALLBACK_MODE_BOOL = "use_sms_callback_mode_bool";
    ...
    public static final String KEY_WLAN_CALL_TITLE_BOOL = "wlan_call_title_bool";
    ...
    static {
        ...
        persistableBundle.putBoolean(KEY_ALLOW_EMERGENCY_NUMBERS_IN_CALL_LOG_BOOL, true);
        ...
        persistableBundle.putBoolean(KEY_CARRIER_VOLTE_AVAILABLE_BOOL, true);
        persistableBundle.putBoolean(KEY_CARRIER_VT_AVAILABLE_BOOL, true);
        ...
        persistableBundle.putBoolean(KEY_IGNORE_RESET_UT_CAPABILITY_BOOL, false);
        persistableBundle.putBoolean(KEY_CARRIER_WFC_IMS_AVAILABLE_BOOL, true);
        ...
        persistableBundle.putBoolean(KEY_CARRIER_VT_TTY_SUPPORT_BOOL, false);
        ...
        persistableBundle.putBoolean(KEY_CALL_BARRING_VISIBILITY_BOOL, true);
        ...
        persistableBundle.putBoolean(KEY_CALL_FORWARDING_WHEN_NOT_LOGGED_IN_SUPPORTED_BOOL, true);
        ...
        persistableBundle.putBoolean(KEY_PREFER_2G_BOOL, true);
        ...
        persistableBundle.putLong(KEY_CARRIER_DATA_CALL_APN_DELAY_DEFAULT_LONG, 20000L);
        persistableBundle.putLong(KEY_CARRIER_DATA_CALL_APN_DELAY_FASTER_LONG, TelecomManager.VERY_SHORT_CALL_TIME_MS);
        persistableBundle.putLong(KEY_CARRIER_DATA_CALL_APN_RETRY_AFTER_DISCONNECT_LONG, JobInfo.MIN_BACKOFF_MILLIS);
        persistableBundle.putInt(KEY_CARRIER_DATA_CALL_RETRY_NETWORK_REQUESTED_MAX_COUNT_INT, 3);
        ...
        persistableBundle.putStringArray(KEY_CARRIER_METERED_APN_TYPES_STRINGS, new String[]{"default", "dun", "supl"});
        persistableBundle.putStringArray(KEY_CARRIER_METERED_ROAMING_APN_TYPES_STRINGS, new String[]{"default", "dun", "supl"});
        persistableBundle.putBoolean(KEY_CDMA_CW_CF_ENABLED_BOOL, false);
        persistableBundle.putStringArray(KEY_CARRIER_WWAN_DISALLOWED_APN_TYPES_STRING_ARRAY, new String[]{""});
        persistableBundle.putStringArray(KEY_CARRIER_WLAN_DISALLOWED_APN_TYPES_STRING_ARRAY, new String[]{""});
        persistableBundle.putIntArray(KEY_ONLY_SINGLE_DC_ALLOWED_INT_ARRAY, new int[]{4, 5, 6, 7, 8, 12});
        ...
        persistableBundle.putBoolean(KEY_HIDE_ENABLED_5G_BOOL, true);
        ...
        persistableBundle.putInt("httpSocketTimeout", MediaPlayer.ProvisioningThread.TIMEOUT_MS);
        ...
        persistableBundle.putBoolean(KEY_ALLOW_CONCURRENT_CALL_DURING_VIDEO_CALL_BOOL, true);
        ...
        persistableBundle.putBoolean(KEY_SHOW_IMS_REGISTRATION_STATUS_BOOL, true);
        ...
        persistableBundle.putBoolean(KEY_SHOW_4G_FOR_LTE_DATA_ICON_BOOL, true);
        ...
        persistableBundle.putBoolean(KEY_HIDE_LTE_PLUS_DATA_ICON_BOOL, false);
        ...
        persistableBundle.putIntArray(KEY_LTE_RSRP_THRESHOLDS_INT_ARRAY, new int[]{-126, PackageManager.INSTALL_FAILED_BAD_SIGNATURE, -110, -97});
        ...
        persistableBundle.putIntArray(KEY_WCDMA_RSCP_THRESHOLDS_INT_ARRAY, new int[]{PackageManager.INSTALL_FAILED_DUPLICATE_PERMISSION, PackageManager.INSTALL_PARSE_FAILED_BAD_SHARED_USER_ID, -97, -91});
        persistableBundle.putIntArray(KEY_5G_NR_SSRSRP_THRESHOLDS_INT_ARRAY, new int[]{-120, PackageManager.NO_NATIVE_LIBRARIES, PackageManager.INSTALL_PARSE_FAILED_BAD_PACKAGE_NAME, -98});
        ...
        persistableBundle.putStringArray(KEY_BANDWIDTH_STRING_ARRAY, new String[]{"GPRS:24,24", "EDGE:70,18", "UMTS:115,115", "CDMA-IS95A:14,14", "CDMA-IS95B:14,14", "1xRTT:30,30", "EvDo-rev.0:750,48", "EvDo-rev.A:950,550", "HSDPA:4300,620", "HSUPA:4300,1800", "HSPA:4300,1800", "EvDo-rev.B:1500,550", "eHRPD:750,48", "HSPAP:13000,3400", "TD-SCDMA:115,115", "LTE:30000,15000", "NR_NSA:47000,18000", "NR_NSA_MMWAVE:145000,60000", "NR_SA:145000,60000"});
        persistableBundle.putBoolean(KEY_BANDWIDTH_NR_NSA_USE_LTE_VALUE_FOR_UPSTREAM_BOOL, false);
        persistableBundle.putString(KEY_WCDMA_DEFAULT_SIGNAL_STRENGTH_MEASUREMENT_STRING, CellSignalStrengthWcdma.LEVEL_CALCULATION_METHOD_RSCP);
        ...
        persistableBundle.putBoolean(KEY_UNMETERED_NR_NSA_BOOL, false);
        persistableBundle.putBoolean(KEY_UNMETERED_NR_NSA_MMWAVE_BOOL, false);
        persistableBundle.putBoolean(KEY_UNMETERED_NR_NSA_SUB6_BOOL, false);
        persistableBundle.putBoolean(KEY_UNMETERED_NR_NSA_WHEN_ROAMING_BOOL, false);
        persistableBundle.putBoolean(KEY_UNMETERED_NR_SA_BOOL, false);
        persistableBundle.putBoolean(KEY_UNMETERED_NR_SA_MMWAVE_BOOL, false);
        persistableBundle.putBoolean(KEY_UNMETERED_NR_SA_SUB6_BOOL, false);
        ...
        persistableBundle.putInt(KEY_OPPORTUNISTIC_NETWORK_ENTRY_THRESHOLD_RSRP_INT, -110);
        persistableBundle.putInt(KEY_OPPORTUNISTIC_NETWORK_EXIT_THRESHOLD_RSRP_INT, PackageManager.INSTALL_FAILED_BAD_SIGNATURE);
        persistableBundle.putInt(KEY_OPPORTUNISTIC_NETWORK_ENTRY_THRESHOLD_RSSNR_INT, 45);
        persistableBundle.putInt(KEY_OPPORTUNISTIC_NETWORK_EXIT_THRESHOLD_RSSNR_INT, 10);
        ...
        persistableBundle.putInt(KEY_OPPORTUNISTIC_NETWORK_ENTRY_THRESHOLD_SS_RSRP_INT, PackageManager.INSTALL_FAILED_USER_RESTRICTED);
        persistableBundle.putDouble(KEY_OPPORTUNISTIC_NETWORK_ENTRY_THRESHOLD_SS_RSRQ_DOUBLE, -18.5d);
        persistableBundle.putInt(KEY_OPPORTUNISTIC_NETWORK_EXIT_THRESHOLD_SS_RSRP_INT, -120);
        persistableBundle.putDouble(KEY_OPPORTUNISTIC_NETWORK_EXIT_THRESHOLD_SS_RSRQ_DOUBLE, -18.5d);
        persistableBundle.putLong(KEY_OPPORTUNISTIC_NETWORK_5G_BACKOFF_TIME_LONG, JobInfo.MIN_BACKOFF_MILLIS);
        persistableBundle.putLong(KEY_OPPORTUNISTIC_NETWORK_5G_MAX_BACKOFF_TIME_LONG, 60000L);
        persistableBundle.putLong(KEY_OPPORTUNISTIC_NETWORK_5G_PING_PONG_TIME_LONG, 60000L);
        persistableBundle.putLong(KEY_OPPORTUNISTIC_NETWORK_5G_DATA_SWITCH_HYSTERESIS_TIME_LONG, 2000L);
        persistableBundle.putLong(KEY_OPPORTUNISTIC_NETWORK_5G_DATA_SWITCH_EXIT_HYSTERESIS_TIME_LONG, 2000L);
        ...
        persistableBundle.putLong(KEY_DATA_SWITCH_VALIDATION_MIN_GAP_LONG, TimeUnit.DAYS.toMillis(1L));
        ...
        persistableBundle.putBoolean(KEY_USE_LOWER_MTU_VALUE_IF_BOTH_RECEIVED, false);
        ...
        persistableBundle.putStringArray(KEY_ALLOWED_INITIAL_ATTACH_APN_TYPES_STRING_ARRAY, new String[]{"ia", "default", "mms", "dun"});
        ...
        persistableBundle.putBoolean(KEY_VONR_SETTING_VISIBILITY_BOOL, false);
        persistableBundle.putStringArray(KEY_MULTI_APN_ARRAY_FOR_SAME_GID, new String[]{"52FF:mms,supl,hipri,default,fota:SA:nrphone", "52FF:mms,supl,hipri,default,fota:NSA:nxtgenphone", "52FF:mms,supl,hipri,default,fota:LTE:nxtgenphone", "52FF:mms,supl,hipri,default,fota:TD_SCDMA:nxtgenphone", "52FF:mms,supl,hipri,default,fota:UMTS:nxtgenphone", "52FF:mms,supl,hipri,default,fota:GSM:nxtgenphone", "52FF:mms,supl,hipri,default,fota:HDR:nxtgenphone", "52FF:mms,supl,hipri,default,fota:1xRTT:nxtgenphone", "53FF:mms,supl,hipri,default,fota:SA:enhancedphone", "53FF:mms,supl,hipri,default,fota:NSA:enhancedphone", "53FF:mms,supl,hipri,default,fota:LTE:nxtgenphone", "53FF:mms,supl,hipri,default,fota:TD_SCDMA:nxtgenphone", "53FF:mms,supl,hipri,default,fota:UMTS:nxtgenphone", "53FF:mms,supl,hipri,default,fota:GSM:nxtgenphone", "53FF:mms,supl,hipri,default,fota:HDR:nxtgenphone", "53FF:mms,supl,hipri,default,fota:1xRTT:nxtgenphone"});
        persistableBundle.putBoolean(KEY_REQUIRE_APN_FILTERING_WITH_RADIO_CAPABILITY, false);
        persistableBundle.putBoolean(KEY_USE_SMS_CALLBACK_MODE_BOOL, false);
        persistableBundle.putBoolean(KEY_WLAN_CALL_TITLE_BOOL, false);
        persistableBundle.putBoolean(KEY_SHOW_HSPA_DATA_ICON_BOOL, true);
        persistableBundle.putBoolean(KEY_SHOW_VOWIFI_STATUS_BAR_ICON_BOOL, true);
        persistableBundle.putBoolean(KEY_HIDE_5G_STANDALONE_BOOL, false);
        persistableBundle.putBoolean(KEY_HIDE_CALL_BARRING_PASSWD_BOOL, false);
        persistableBundle.putBoolean(KEY_HIDE_CARRIER_NAME_EXTRA_BOOL, false);
        persistableBundle.putBoolean(KEY_HIDE_SMART_5G_BOOL, false);
        persistableBundle.putBoolean(KEY_CARRIER_DEFAULT_SMART_5G_ENABLED_BOOL, true);
        persistableBundle.putBoolean(KEY_CARRIER_DEFAULT_SA_ENABLED_BOOL, false);
    }
    ...
    public PersistableBundle getConfigForSubId(int subId) {
        try {
            ...
            if (loader == null) {
                com.android.telephony.Rlog.w(TAG, "Error getting config for subId " + subId + " ICarrierConfigLoader is null");
                return null;
            }
            return loader.getConfigForSubIdWithFeature(subId, this.mContext.getOpPackageName(), this.mContext.getAttributionTag());
        } catch (RemoteException ex) {
            com.android.telephony.Rlog.e(TAG, "Error getting config for subId " + subId + ": " + ex.toString());
            return null;
        }
    }
    ...
    public void overrideConfig(int subscriptionId, PersistableBundle overrideValues, boolean persistent) {
        try {
            ICarrierConfigLoader loader = getICarrierConfigLoader();
            if (loader == null) {
                com.android.telephony.Rlog.w(TAG, "Error setting config for subId " + subscriptionId + " ICarrierConfigLoader is null");
                return;
            }
            loader.overrideConfig(subscriptionId, overrideValues, persistent);
        } catch (RemoteException ex) {
            com.android.telephony.Rlog.e(TAG, "Error setting config for subId " + subscriptionId + ": " + ex.toString());
        }
    }
    ...
    public void notifyConfigChangedForSubId(int subId) {
        try {
            ICarrierConfigLoader loader = getICarrierConfigLoader();
            if (loader == null) {
                com.android.telephony.Rlog.w(TAG, "Error reloading config for subId=" + subId + " ICarrierConfigLoader is null");
                return;
            }
            loader.notifyConfigChangedForSubId(subId);
        } catch (RemoteException ex) {
            com.android.telephony.Rlog.e(TAG, "Error reloading config for subId=" + subId + ": " + ex.toString());
        }
    }
    ...
    public void updateConfigForPhoneId(int phoneId, String simState) {
        try {
            ICarrierConfigLoader loader = getICarrierConfigLoader();
            if (loader == null) {
                com.android.telephony.Rlog.w(TAG, "Error updating config for phoneId=" + phoneId + " ICarrierConfigLoader is null");
                return;
            }
            loader.updateConfigForPhoneId(phoneId, simState);
        } catch (RemoteException | IllegalArgumentException ex) {
            com.android.telephony.Rlog.e(TAG, "Error updating config for phoneId=" + phoneId + ": " + ex.toString());
        }
    }
    ...
    public String getDefaultCarrierServicePackageName() {
        try {
            ...
            com.android.telephony.Rlog.e(TAG, "getDefaultCarrierServicePackageName ICarrierConfigLoader is null" + ex.toString());
