...
public class CbGeoUtils {
        ...
        for (String geometryStr : str.split("\\s*;\\s*")) {
            ...
            switch (c) {
                ...
                case 1:
                    ...
                    break;
                default:
                    com.android.telephony.Rlog.e(TAG, "Invalid geometry format " + geometryStr);
                    break;
            }
        }
        return geometries;
    ...
    public static String encodeGeometriesToString(List<Geometry> geometries) {
        ...
        return (String) geometries.stream().map(CbGeoUtils$$ExternalSyntheticLambda0.INSTANCE).filter(CbGeoUtils$$ExternalSyntheticLambda1.INSTANCE).collect(Collectors.joining(";"));
    }
