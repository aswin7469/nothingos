...
public abstract class CellIdentity implements Parcelable {
    public static final Parcelable.Creator<CellIdentity> CREATOR = new Parcelable.Creator<CellIdentity>() { // from class: android.telephony.CellIdentity.1
        ...
        public CellIdentity mo3559createFromParcel(Parcel in) {
            int type = in.readInt();
            switch (type) {
                case 1:
        ...
        public CellIdentity[] mo3560newArray(int size) {
    ...
    public abstract CellLocation mo2457asCellLocation();

    @SystemApi
    /* renamed from: sanitizeLocationInfo */
    public abstract CellIdentity mo2458sanitizeLocationInfo();
