...
public final class CellIdentityGsm extends CellIdentity {
    ...
    public static final Parcelable.Creator<CellIdentityGsm> CREATOR = new Parcelable.Creator<CellIdentityGsm>() { // from class: android.telephony.CellIdentityGsm.1
        ...
        public CellIdentityGsm mo3559createFromParcel(Parcel in) {
            in.readInt();
        ...
        public CellIdentityGsm[] mo3560newArray(int size) {
    ...
    public CellIdentityGsm(android.hardware.radio.V1_0.CellIdentityGsm cid) {
        this(cid.lac, cid.cid, cid.arfcn, cid.bsic == -1 ? (byte) 2147483647 : cid.bsic, cid.mcc, cid.mnc, "", "", new ArraySet());
    }

    public CellIdentityGsm(android.hardware.radio.V1_2.CellIdentityGsm cid) {
        this(cid.base.lac, cid.base.cid, cid.base.arfcn, cid.base.bsic == -1 ? (byte) 2147483647 : cid.base.bsic, cid.base.mcc, cid.base.mnc, cid.operatorNames.alphaLong, cid.operatorNames.alphaShort, new ArraySet());
    }

    public CellIdentityGsm(android.hardware.radio.V1_5.CellIdentityGsm cid) {
        this(cid.base.base.lac, cid.base.base.cid, cid.base.base.arfcn, cid.base.base.bsic == -1 ? (byte) 2147483647 : cid.base.base.bsic, cid.base.base.mcc, cid.base.base.mnc, cid.base.operatorNames.alphaLong, cid.base.operatorNames.alphaShort, cid.additionalPlmns);
    }
    ...
    public CellIdentityGsm mo2458sanitizeLocationInfo() {
