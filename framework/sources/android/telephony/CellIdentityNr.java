...
public final class CellIdentityNr extends CellIdentity {
    public static final Parcelable.Creator<CellIdentityNr> CREATOR = new Parcelable.Creator<CellIdentityNr>() { // from class: android.telephony.CellIdentityNr.1
        ...
        public CellIdentityNr mo3559createFromParcel(Parcel in) {
            in.readInt();
        ...
        public CellIdentityNr[] mo3560newArray(int size) {
    ...
    public CellIdentityNr(android.hardware.radio.V1_4.CellIdentityNr cid) {
        this(cid.pci, cid.tac, cid.nrarfcn, new int[0], cid.mcc, cid.mnc, cid.nci, cid.operatorNames.alphaLong, cid.operatorNames.alphaShort, new ArraySet());
    }

    public CellIdentityNr(android.hardware.radio.V1_5.CellIdentityNr cid) {
        this(cid.base.pci, cid.base.tac, cid.base.nrarfcn, cid.bands.stream().mapToInt(CameraDeviceImpl$9$$ExternalSyntheticLambda0.INSTANCE).toArray(), cid.base.mcc, cid.base.mnc, cid.base.nci, cid.base.operatorNames.alphaLong, cid.base.operatorNames.alphaShort, cid.additionalPlmns);
    }

    @Override // android.telephony.CellIdentity
    /* renamed from: sanitizeLocationInfo  reason: collision with other method in class */
    public CellIdentityNr mo2458sanitizeLocationInfo() {
    ...
    @Override // android.telephony.CellIdentity
    /* renamed from: asCellLocation */
    public CellLocation mo2457asCellLocation() {
