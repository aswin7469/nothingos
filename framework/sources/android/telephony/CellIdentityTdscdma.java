...
public final class CellIdentityTdscdma extends CellIdentity {
    ...
    public static final Parcelable.Creator<CellIdentityTdscdma> CREATOR = new Parcelable.Creator<CellIdentityTdscdma>() { // from class: android.telephony.CellIdentityTdscdma.1
        ...
        public CellIdentityTdscdma mo3559createFromParcel(Parcel in) {
            in.readInt();
        ...
        public CellIdentityTdscdma[] mo3560newArray(int size) {
    ...
    */
    public CellIdentityTdscdma(android.hardware.radio.V1_5.CellIdentityTdscdma cid) {
        ...
        int i3 = cid.base.base.cpid;
        int i4 = cid.base.uarfcn;
    ...
    public CellIdentityTdscdma mo2458sanitizeLocationInfo() {
