...
public final class CellInfoGsm extends CellInfo implements Parcelable {
    public static final Parcelable.Creator<CellInfoGsm> CREATOR = new Parcelable.Creator<CellInfoGsm>() { // from class: android.telephony.CellInfoGsm.1
        ...
        public CellInfoGsm mo3559createFromParcel(Parcel in) {
            in.readInt();
        ...
        public CellInfoGsm[] mo3560newArray(int size) {
    ...
    public CellInfoGsm(CellInfoGsm ci) {
        ...
        this.mCellSignalStrengthGsm = ci.mCellSignalStrengthGsm.mo2502copy();
    }
    ...
    public CellIdentityGsm mo2483getCellIdentity() {
    ...
    public CellSignalStrengthGsm mo2484getCellSignalStrength() {
    ...
    public CellInfo sanitizeLocationInfo() {
        ...
        result.mCellIdentityGsm = this.mCellIdentityGsm.mo2458sanitizeLocationInfo();
        return result;
    }
    ...
    private CellInfoGsm(Parcel in) {
        super(in);
        this.mCellIdentityGsm = CellIdentityGsm.CREATOR.mo3559createFromParcel(in);
        this.mCellSignalStrengthGsm = CellSignalStrengthGsm.CREATOR.mo3559createFromParcel(in);
    }
