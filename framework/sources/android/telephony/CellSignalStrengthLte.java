...
public final class CellSignalStrengthLte extends CellSignalStrength implements Parcelable {
    ...
    private static final int[] sRsrpThresholds = {-126, PackageManager.INSTALL_FAILED_BAD_SIGNATURE, -110, -97};
    ...
    public static final Parcelable.Creator<CellSignalStrengthLte> CREATOR = new Parcelable.Creator<CellSignalStrengthLte>() { // from class: android.telephony.CellSignalStrengthLte.1
        ...
        public CellSignalStrengthLte mo3559createFromParcel(Parcel in) {
        ...
        public CellSignalStrengthLte[] mo3560newArray(int size) {
    ...
    public CellSignalStrengthLte(LteSignalStrength lte) {
        this(convertRssiAsuToDBm(lte.signalStrength), lte.rsrp != Integer.MAX_VALUE ? -lte.rsrp : lte.rsrp, lte.rsrq != Integer.MAX_VALUE ? -lte.rsrq : lte.rsrq, convertRssnrUnitFromTenDbToDB(lte.rssnr), lte.cqi, lte.timingAdvance);
    }

    public CellSignalStrengthLte(android.hardware.radio.V1_6.LteSignalStrength lte) {
        this(convertRssiAsuToDBm(lte.base.signalStrength), lte.base.rsrp != Integer.MAX_VALUE ? -lte.base.rsrp : lte.base.rsrp, lte.base.rsrq != Integer.MAX_VALUE ? -lte.base.rsrq : lte.base.rsrq, convertRssnrUnitFromTenDbToDB(lte.base.rssnr), lte.cqiTableIndex, lte.base.cqi, lte.base.timingAdvance);
    }
    ...
    public CellSignalStrengthLte mo2502copy() {
