...
public final class CellSignalStrengthWcdma extends CellSignalStrength implements Parcelable {
    ...
    private static final String DEFAULT_LEVEL_CALCULATION_METHOD = "rscp";
    ...
    private static final int WCDMA_RSCP_GOOD = -97;
    private static final int WCDMA_RSCP_GREAT = -91;
    private static final int WCDMA_RSCP_MAX = -24;
    private static final int WCDMA_RSCP_MIN = -120;
    private static final int WCDMA_RSCP_MODERATE = -107;
    private static final int WCDMA_RSCP_POOR = -112;
    ...
    private static final int[] sRssiThresholds = {PackageManager.INSTALL_PARSE_FAILED_BAD_SHARED_USER_ID, -97, WCDMA_RSSI_GOOD, -77};
    private static final int[] sRscpThresholds = {-112, PackageManager.INSTALL_PARSE_FAILED_BAD_SHARED_USER_ID, -97, -91};
    ...
    public static final Parcelable.Creator<CellSignalStrengthWcdma> CREATOR = new Parcelable.Creator<CellSignalStrengthWcdma>() { // from class: android.telephony.CellSignalStrengthWcdma.1
        ...
        public CellSignalStrengthWcdma mo3559createFromParcel(Parcel in) {
        ...
        public CellSignalStrengthWcdma[] mo3560newArray(int size) {
    ...
    public CellSignalStrengthWcdma mo2502copy() {
    ...
    public void updateLevel(PersistableBundle cc, ServiceState ss) {
        ...
        char c;
        if (cc != null) {
            calcMethod = cc.getString(CarrierConfigManager.KEY_WCDMA_DEFAULT_SIGNAL_STRENGTH_MEASUREMENT_STRING, "rscp");
        ...
        switch (calcMethod.hashCode()) {
            case 3509870:
                ...
                break;
            case 3510359:
                if (calcMethod.equals(LEVEL_CALCULATION_METHOD_RSSI)) {
                    c = 2;
                    break;
                }
                c = 65535;
