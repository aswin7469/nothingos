...
class JapanesePhoneNumberFormatter {
    ...
    public static void format(Editable text) {
        ...
        while (true) {
            ...
            if (Character.isDigit(ch)) {
                ...
                if (value < 0) {
                    ...
                    if (length2 > dashPos2) {
                        text.mo2734insert(dashPos2, NativeLibraryHelper.CLEAR_ABI_OVERRIDE);
                    }
                    int dashPos1 = (Math.abs((int) value) / 10) + rootIndex;
                    if (length2 > dashPos1) {
                        text.mo2734insert(dashPos1, NativeLibraryHelper.CLEAR_ABI_OVERRIDE);
                    }
                } else {
                    base = value;
                    i2++;
        ...
        if (length2 > 3 && rootIndex == 3) {
            text.mo2734insert(rootIndex, NativeLibraryHelper.CLEAR_ABI_OVERRIDE);
        }
    }
}
