...
public class NeighboringCellInfo implements Parcelable {
    public static final Parcelable.Creator<NeighboringCellInfo> CREATOR = new Parcelable.Creator<NeighboringCellInfo>() { // from class: android.telephony.NeighboringCellInfo.1
        ...
        public NeighboringCellInfo mo3559createFromParcel(Parcel in) {
        ...
        public NeighboringCellInfo[] mo3560newArray(int size) {
    ...
    public NeighboringCellInfo(CellInfoGsm info) {
        this.mNetworkType = 1;
        int asuLevel = info.mo2484getCellSignalStrength().getAsuLevel();
        this.mRssi = asuLevel;
        if (asuLevel == Integer.MAX_VALUE) {
            this.mRssi = 99;
        }
        int lac = info.mo2483getCellIdentity().getLac();
        this.mLac = lac;
        if (lac == Integer.MAX_VALUE) {
            this.mLac = -1;
        }
        int cid = info.mo2483getCellIdentity().getCid();
        this.mCid = cid;
    ...
    public NeighboringCellInfo(CellInfoWcdma info) {
        ...
        int psc = info.mo2483getCellIdentity().getPsc();
        this.mPsc = psc;
