...
public final class PreciseDataConnectionState implements Parcelable {
    public static final Parcelable.Creator<PreciseDataConnectionState> CREATOR = new Parcelable.Creator<PreciseDataConnectionState>() { // from class: android.telephony.PreciseDataConnectionState.1
        ...
        public PreciseDataConnectionState mo3559createFromParcel(Parcel in) {
        ...
        public PreciseDataConnectionState[] mo3560newArray(int size) {
    ...
    private PreciseDataConnectionState(Parcel in) {
        ...
        this.mLinkProperties = (LinkProperties) in.readParcelable(LinkProperties.class.getClassLoader());
        this.mFailCause = in.readInt();
        this.mApnSetting = (ApnSetting) in.readParcelable(ApnSetting.class.getClassLoader());
    }
