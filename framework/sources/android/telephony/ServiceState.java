...
public class ServiceState implements Parcelable {
    ...
    private static final List<Integer> FREQUENCY_RANGE_ORDER = Arrays.asList(0, 1, 2, 3, 4);
    public static final Parcelable.Creator<ServiceState> CREATOR = new Parcelable.Creator<ServiceState>() { // from class: android.telephony.ServiceState.1
        ...
        public ServiceState mo3559createFromParcel(Parcel in) {
        ...
        public ServiceState[] mo3560newArray(int size) {
    ...
    public ServiceState(Parcel in) {
        ...
        synchronized (arrayList) {
            in.readList(arrayList, NetworkRegistrationInfo.class.getClassLoader());
        }
    ...
    private void setFromNotifierBundle(Bundle m) {
        ServiceState ssFromBundle = (ServiceState) m.getParcelable(EXTRA_SERVICE_STATE);
    ...
    public int getRadioTechnology() {
        com.android.telephony.Rlog.e(LOG_TAG, "ServiceState.getRadioTechnology() DEPRECATED will be removed *******");
    ...
    public static final int getBetterNRFrequencyRange(int range1, int range2) {
        List<Integer> list = FREQUENCY_RANGE_ORDER;
        if (list.indexOf(Integer.valueOf(range1)) > list.indexOf(Integer.valueOf(range2))) {
            return range1;
        }
        return range2;
    }
    ...
    public ServiceState createLocationInfoSanitizedCopy(boolean removeCoarseLocation) {
        ...
        synchronized (state.mNetworkRegistrationInfos) {
            List<NetworkRegistrationInfo> networkRegistrationInfos = (List) state.mNetworkRegistrationInfos.stream().map(ServiceState$$ExternalSyntheticLambda0.INSTANCE).collect(Collectors.toList());
