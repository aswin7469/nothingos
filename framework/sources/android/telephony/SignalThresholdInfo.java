...
public final class SignalThresholdInfo implements Parcelable {
    public static final Parcelable.Creator<SignalThresholdInfo> CREATOR = new Parcelable.Creator<SignalThresholdInfo>() { // from class: android.telephony.SignalThresholdInfo.1
        ...
        public SignalThresholdInfo mo3559createFromParcel(Parcel in) {
        ...
        public SignalThresholdInfo[] mo3560newArray(int size) {
    ...
    private SignalThresholdInfo(int ran, int signalMeasurementType, int hysteresisMs, int hysteresisDb, int[] thresholds, boolean isEnabled) {
        ...
        this.mHysteresisDb = hysteresisDb >= 0 ? hysteresisDb : i;
    ...
    public int hashCode() {
        return Objects.hash(Integer.valueOf(this.mRan), Integer.valueOf(this.mSignalMeasurementType), Integer.valueOf(this.mHysteresisMs), Integer.valueOf(this.mHysteresisDb), this.mThresholds, Boolean.valueOf(this.mIsEnabled));
    }
