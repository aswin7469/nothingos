    ...
    public boolean enableCellBroadcastRange(int startMessageId, int endMessageId, int ranType) {
        ...
        try {
            ...
            if (iSms != null) {
                ...
                sb.append("enableCellBroadcastRange: ");
            ...
            com.android.telephony.Rlog.d(TAG, "enableCellBroadcastRange: " + ex.getStackTrace());
        }
        return success;
    }
    ...
    public boolean disableCellBroadcastRange(int startMessageId, int endMessageId, int ranType) {
        ...
        try {
            ...
            if (iSms != null) {
                ...
                StringBuilder sb = new StringBuilder();
                sb.append("disableCellBroadcastRange: ");
                sb.append(success ? "succeeded" : "failed");
            ...
            com.android.telephony.Rlog.d(TAG, "disableCellBroadcastRange: " + ex.getStackTrace());
        }
        return success;
    }
