...
public class SmsMessage {
    ...
    private static SmsMessage createFromPdu(byte[] pdu, String format, boolean fallbackToOtherFormat) {
        ...
        if ("3gpp2".equals(format)) {
            ...
            com.android.telephony.Rlog.e(LOG_TAG, "createFromPdu(): unsupported message format " + format);
            return null;
        }
    ...
    public static ArrayList<String> fragmentText(String text, int subId) {
        ...
        while (pos < textLen) {
            ...
            if (nextPos <= pos || nextPos > textLen) {
                com.android.telephony.Rlog.e(LOG_TAG, "fragmentText failed (" + pos + " >= " + nextPos + " or " + nextPos + " >= " + textLen + ")");
                break;
            }
