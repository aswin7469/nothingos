...
public class SubscriptionManager {
    ...
    private static VoidPropertyInvalidatedCache<Integer> sDefaultSubIdCache = new VoidPropertyInvalidatedCache<>(SubscriptionManager$$ExternalSyntheticLambda12.INSTANCE, CACHE_KEY_DEFAULT_SUB_ID_PROPERTY, -1);
    public static final String CACHE_KEY_DEFAULT_DATA_SUB_ID_PROPERTY = "cache_key.telephony.get_default_data_sub_id";
    private static VoidPropertyInvalidatedCache<Integer> sDefaultDataSubIdCache = new VoidPropertyInvalidatedCache<>(SubscriptionManager$$ExternalSyntheticLambda10.INSTANCE, CACHE_KEY_DEFAULT_DATA_SUB_ID_PROPERTY, -1);
    public static final String CACHE_KEY_DEFAULT_SMS_SUB_ID_PROPERTY = "cache_key.telephony.get_default_sms_sub_id";
    private static VoidPropertyInvalidatedCache<Integer> sDefaultSmsSubIdCache = new VoidPropertyInvalidatedCache<>(SubscriptionManager$$ExternalSyntheticLambda11.INSTANCE, CACHE_KEY_DEFAULT_SMS_SUB_ID_PROPERTY, -1);
    public static final String CACHE_KEY_ACTIVE_DATA_SUB_ID_PROPERTY = "cache_key.telephony.get_active_data_sub_id";
    private static VoidPropertyInvalidatedCache<Integer> sActiveDataSubIdCache = new VoidPropertyInvalidatedCache<>(SubscriptionManager$$ExternalSyntheticLambda9.INSTANCE, CACHE_KEY_ACTIVE_DATA_SUB_ID_PROPERTY, -1);
    public static final String CACHE_KEY_SLOT_INDEX_PROPERTY = "cache_key.telephony.get_slot_index";
    private static IntegerPropertyInvalidatedCache<Integer> sSlotIndexCache = new IntegerPropertyInvalidatedCache<>(SubscriptionManager$$ExternalSyntheticLambda8.INSTANCE, CACHE_KEY_SLOT_INDEX_PROPERTY, -1);
    private static IntegerPropertyInvalidatedCache<Integer> sPhoneIdCache = new IntegerPropertyInvalidatedCache<>(SubscriptionManager$$ExternalSyntheticLambda7.INSTANCE, CACHE_KEY_DEFAULT_SUB_ID_PROPERTY, -1);
