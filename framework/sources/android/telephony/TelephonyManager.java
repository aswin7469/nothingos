...
public class TelephonyManager {
    ...
    public static boolean isConcurrentCallsPossible() {
        int mSimVoiceConfig = TelephonyProperties.multi_sim_voice_capability().orElse(0).intValue();
        return mSimVoiceConfig == 3;
    }
    ...
    public String getDeviceId(int slotIndex) {
        SeempLog.record_str(8, "" + slotIndex);
        try {
    ...
    public CellLocation getCellLocation() {
        ...
        try {
            ...
            CellLocation cl = cellIdentity.mo2457asCellLocation();
    ...
    public String getSubscriberId(int subId) {
        SeempLog.record_str(MetricsProto.MetricsEvent.ACTION_WINDOW_DOCK_RESIZE, "" + subId);
        try {
            IPhoneSubInfo info = getSubscriberInfoService();
            if (info == null) {
                return null;
    ...
    */
    public static /* synthetic */ void lambda$uploadCallComposerPicture$2(InputStream pictureToUpload, OutcomeReceiver callback, ParcelFileDescriptor writeFd, OutputStream output) {
        if (Looper.getMainLooper().isCurrentThread()) {
            Log.w(TAG, "Uploading call composer picture on main thread! hic sunt dracones!");
        }
        ...
        while (true) {
            try {
                try {
                    ...
                    Log.e(TAG, "IOException reading from input while uploading pic: " + e3);
                    callback.onError(new CallComposerException(4, e3));
                    try {
                        writeFd.closeWithError("input closed");
                    } catch (IOException e12) {
                        Log.e(TAG, "Error closing fd pipe: " + e12);
                    }
                    output.close();
                    return;
                }
    ...
    public void setBasebandVersionForPhone(int phoneId, String version) {
        if (SubscriptionManager.isValidPhoneId(phoneId) && phoneId == 0) {
            SystemProperties.set(com.android.internal.telephony.TelephonyProperties.PROPERTY_BASEBAND_VERSION, version);
        }
    }
    ...
    public String getBasebandVersionForPhone(int phoneId) {
        return SystemProperties.get(com.android.internal.telephony.TelephonyProperties.PROPERTY_BASEBAND_VERSION, "");
    }
