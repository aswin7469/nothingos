                ...
                default:
                    ...
                    switch (code) {
                        ...
                        case 3:
                            ...
                            if (data.readInt() != 0) {
                                _arg2 = DataProfile.CREATOR.mo3559createFromParcel(data);
                            } else {
                                _arg2 = null;
                            }
                            ...
                            if (data.readInt() != 0) {
                                _arg6 = (LinkProperties) LinkProperties.CREATOR.mo3559createFromParcel(data);
                            } else {
                                _arg6 = null;
                            }
                            int _arg7 = data.readInt();
                            if (data.readInt() != 0) {
                                _arg8 = NetworkSliceInfo.CREATOR.mo3559createFromParcel(data);
                            } else {
                                _arg8 = null;
                            }
                            if (data.readInt() != 0) {
                                _arg9 = TrafficDescriptor.CREATOR.mo3559createFromParcel(data);
                            } else {
                                _arg9 = null;
                            }
                        ...
                        case 5:
                            ...
                            if (data.readInt() != 0) {
                                _arg1 = DataProfile.CREATOR.mo3559createFromParcel(data);
                            } else {
                                _arg1 = null;
                            }
                            if (data.readInt() != 0) {
