...
public class EuiccManager {
    ...
    public void setSupportedCountries(List<String> supportedCountries) {
        ...
        try {
            getIEuiccController().setSupportedCountries(true, (List) supportedCountries.stream().map(EuiccManager$$ExternalSyntheticLambda0.INSTANCE).collect(Collectors.toList()));
        } catch (RemoteException e) {
            throw e.rethrowFromSystemServer();
        }
    }
    ...
    public void setUnsupportedCountries(List<String> unsupportedCountries) {
        ...
        try {
            getIEuiccController().setSupportedCountries(false, (List) unsupportedCountries.stream().map(EuiccManager$$ExternalSyntheticLambda0.INSTANCE).collect(Collectors.toList()));
        } catch (RemoteException e) {
            throw e.rethrowFromSystemServer();
        }
    }
