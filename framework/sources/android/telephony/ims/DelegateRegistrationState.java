...
public final class DelegateRegistrationState implements Parcelable {
    public static final Parcelable.Creator<DelegateRegistrationState> CREATOR = new Parcelable.Creator<DelegateRegistrationState>() { // from class: android.telephony.ims.DelegateRegistrationState.1
        ...
        public DelegateRegistrationState mo3559createFromParcel(Parcel source) {
        ...
        public DelegateRegistrationState[] mo3560newArray(int size) {
    ...
    public boolean equals(Object o) {
        ...
        if (this.mRegisteredTags.equals(that.mRegisteredTags) && this.mDeregisteringTags.equals(that.mDeregisteringTags) && this.mDeregisteredTags.equals(that.mDeregisteredTags)) {
            return true;
        }
        return false;
    }
    ...
    public int hashCode() {
        return Objects.hash(this.mRegisteredTags, this.mDeregisteringTags, this.mDeregisteredTags);
    }

    public String toString() {
        return "DelegateRegistrationState{ registered={" + this.mRegisteredTags + "}, deregistering={" + this.mDeregisteringTags + "}, deregistered={" + this.mDeregisteredTags + "}}";
    }
}
