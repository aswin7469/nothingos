...
public final class ImsCallProfile implements Parcelable {
    ...
    public static final Parcelable.Creator<ImsCallProfile> CREATOR = new Parcelable.Creator<ImsCallProfile>() { // from class: android.telephony.ims.ImsCallProfile.1
        ...
        public ImsCallProfile mo3559createFromParcel(Parcel in) {
        ...
        public ImsCallProfile[] mo3560newArray(int size) {
    ...
    public String toString() {
        ...
        sb.append(imsStreamMediaProfile != null ? imsStreamMediaProfile.toString() : "null");
    ...
    private void readFromParcel(Parcel in) {
        ...
        this.mAcceptedRtpHeaderExtensionTypes = (Set) Arrays.stream(accepted).map(ImsCallProfile$$ExternalSyntheticLambda0.INSTANCE).collect(Collectors.toSet());
    }
