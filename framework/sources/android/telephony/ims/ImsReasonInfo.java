...
public final class ImsReasonInfo implements Parcelable {
    ...
    public static final Parcelable.Creator<ImsReasonInfo> CREATOR = new Parcelable.Creator<ImsReasonInfo>() { // from class: android.telephony.ims.ImsReasonInfo.1
        ...
        public ImsReasonInfo mo3559createFromParcel(Parcel in) {
        ...
        public ImsReasonInfo[] mo3560newArray(int size) {
    ...
    static {
        ...
        hashMap.put(Integer.valueOf((int) CODE_CONCURRENT_CALLS_NOT_POSSIBLE), "CODE_CONCURRENT_CALLS_NOT_POSSIBLE");
