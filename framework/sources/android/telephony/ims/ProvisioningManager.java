...
public class ProvisioningManager {
    ...
    public static class Callback {
        ...
        public static class CallbackBinder extends IImsConfigCallback.Stub {
            ...
            public final void onStringConfigChanged(final int item, final String value) {
                ...
                try {
                    this.mExecutor.execute(new Runnable() { // from class: android.telephony.ims.ProvisioningManager$Callback$CallbackBinder$$ExternalSyntheticLambda1
                        @Override // java.lang.Runnable
                        public final void run() {
                            ProvisioningManager.Callback.CallbackBinder.this.lambda$onStringConfigChanged$1$ProvisioningManager$Callback$CallbackBinder(item, value);
                        }
                    });
                } finally {
                    restoreCallingIdentity(callingIdentity);
            ...
            public /* synthetic */ void lambda$onStringConfigChanged$1$ProvisioningManager$Callback$CallbackBinder(int item, String value) {
    ...
    public static class RcsProvisioningCallback {
        ...
        public static class CallbackBinder extends IRcsConfigCallback.Stub {
            ...
            public void onConfigurationChanged(final byte[] configXml) {
                ...
                try {
                    this.mExecutor.execute(new Runnable() { // from class: android.telephony.ims.ProvisioningManager$RcsProvisioningCallback$CallbackBinder$$ExternalSyntheticLambda3
                        @Override // java.lang.Runnable
                        public final void run() {
                            ProvisioningManager.RcsProvisioningCallback.CallbackBinder.this.lambda$onConfigurationChanged$0$ProvisioningManager$RcsProvisioningCallback$CallbackBinder(configXml);
                        }
                    });
                } finally {
            ...
            public /* synthetic */ void lambda$onConfigurationChanged$0$ProvisioningManager$RcsProvisioningCallback$CallbackBinder(byte[] configXml) {
            ...
            public void onAutoConfigurationErrorReceived(final int errorCode, final String errorString) {
                ...
                try {
                    this.mExecutor.execute(new Runnable() { // from class: android.telephony.ims.ProvisioningManager$RcsProvisioningCallback$CallbackBinder$$ExternalSyntheticLambda2
                        @Override // java.lang.Runnable
                        public final void run() {
                            ProvisioningManager.RcsProvisioningCallback.CallbackBinder.this.lambda$onAutoConfigurationErrorReceived$1$ProvisioningManager$RcsProvisioningCallback$CallbackBinder(errorCode, errorString);
                        }
                    });
                } finally {
                    Binder.restoreCallingIdentity(identity);
            ...
            public /* synthetic */ void lambda$onAutoConfigurationErrorReceived$1$ProvisioningManager$RcsProvisioningCallback$CallbackBinder(int errorCode, String errorString) {
            ...
            public void onConfigurationReset() {
                ...
                try {
                    this.mExecutor.execute(new Runnable() { // from class: android.telephony.ims.ProvisioningManager$RcsProvisioningCallback$CallbackBinder$$ExternalSyntheticLambda0
                        @Override // java.lang.Runnable
                        public final void run() {
                            ProvisioningManager.RcsProvisioningCallback.CallbackBinder.this.lambda$onConfigurationReset$2$ProvisioningManager$RcsProvisioningCallback$CallbackBinder();
                        }
                    });
                } finally {
                    Binder.restoreCallingIdentity(identity);
            ...
            public /* synthetic */ void lambda$onConfigurationReset$2$ProvisioningManager$RcsProvisioningCallback$CallbackBinder() {
            ...
            public void onRemoved() {
                ...
                try {
                    this.mExecutor.execute(new Runnable() { // from class: android.telephony.ims.ProvisioningManager$RcsProvisioningCallback$CallbackBinder$$ExternalSyntheticLambda1
                        @Override // java.lang.Runnable
                        public final void run() {
                            ProvisioningManager.RcsProvisioningCallback.CallbackBinder.this.lambda$onRemoved$3$ProvisioningManager$RcsProvisioningCallback$CallbackBinder();
                        }
                    });
                } finally {
                    Binder.restoreCallingIdentity(identity);
            ...
            public /* synthetic */ void lambda$onRemoved$3$ProvisioningManager$RcsProvisioningCallback$CallbackBinder() {
            ...
            public void onPreProvisioningReceived(final byte[] configXml) {
                ...
                try {
                    this.mExecutor.execute(new Runnable() { // from class: android.telephony.ims.ProvisioningManager$RcsProvisioningCallback$CallbackBinder$$ExternalSyntheticLambda4
                        @Override // java.lang.Runnable
                        public final void run() {
                            ProvisioningManager.RcsProvisioningCallback.CallbackBinder.this.lambda$onPreProvisioningReceived$4$ProvisioningManager$RcsProvisioningCallback$CallbackBinder(configXml);
                        }
                    });
                } finally {
                    Binder.restoreCallingIdentity(identity);
            ...
            public /* synthetic */ void lambda$onPreProvisioningReceived$4$ProvisioningManager$RcsProvisioningCallback$CallbackBinder(byte[] configXml) {
    ...
    public boolean getRcsProvisioningStatusForCapability(int capability) {
        try {
            return getITelephony().getRcsProvisioningStatusForCapability(this.mSubId, capability);
        } catch (RemoteException e) {
            throw e.rethrowAsRuntimeException();
        }
    }
    ...
    public void setRcsProvisioningStatusForCapability(int capability, boolean isProvisioned) {
        try {
            getITelephony().setRcsProvisioningStatusForCapability(this.mSubId, capability, isProvisioned);
        } catch (RemoteException e) {
            throw e.rethrowAsRuntimeException();
        }
    }
