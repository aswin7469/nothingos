            ...
            switch (code) {
                ...
                default:
                    switch (code) {
                        ...
                        case 3:
                            data.enforceInterface(IImsRcsFeature.DESCRIPTOR);
                            IImsCapabilityCallback _arg03 = IImsCapabilityCallback.Stub.asInterface(data.readStrongBinder());
                            addCapabilityCallback(_arg03);
                            return true;
                        case 4:
                            data.enforceInterface(IImsRcsFeature.DESCRIPTOR);
                            IImsCapabilityCallback _arg04 = IImsCapabilityCallback.Stub.asInterface(data.readStrongBinder());
                            removeCapabilityCallback(_arg04);
                            return true;
                        case 5:
                            data.enforceInterface(IImsRcsFeature.DESCRIPTOR);
                            if (data.readInt() != 0) {
                                _arg0 = CapabilityChangeRequest.CREATOR.mo3559createFromParcel(data);
                            } else {
                                _arg0 = null;
                            }
                            IImsCapabilityCallback _arg1 = IImsCapabilityCallback.Stub.asInterface(data.readStrongBinder());
                            changeCapabilitiesConfiguration(_arg0, _arg1);
                            return true;
                        case 6:
                            data.enforceInterface(IImsRcsFeature.DESCRIPTOR);
                            ...
                            queryCapabilityConfiguration(_arg05, _arg12, _arg2);
                            return true;
                        case 7:
                            data.enforceInterface(IImsRcsFeature.DESCRIPTOR);
                            ICapabilityExchangeEventListener _arg06 = ICapabilityExchangeEventListener.Stub.asInterface(data.readStrongBinder());
                            setCapabilityExchangeEventListener(_arg06);
                            return true;
                        case 8:
                            data.enforceInterface(IImsRcsFeature.DESCRIPTOR);
                            String _arg07 = data.readString();
                            IPublishResponseCallback _arg13 = IPublishResponseCallback.Stub.asInterface(data.readStrongBinder());
                            publishCapabilities(_arg07, _arg13);
                            return true;
                        case 9:
                            data.enforceInterface(IImsRcsFeature.DESCRIPTOR);
                            List<Uri> _arg08 = data.createTypedArrayList(Uri.CREATOR);
                            ISubscribeResponseCallback _arg14 = ISubscribeResponseCallback.Stub.asInterface(data.readStrongBinder());
                            subscribeForCapabilities(_arg08, _arg14);
                            return true;
                        case 10:
                            data.enforceInterface(IImsRcsFeature.DESCRIPTOR);
                            if (data.readInt() != 0) {
                            ...
                            sendOptionsCapabilityRequest(_arg02, _arg15, _arg22);
                            return true;
                        default:
        ...
        public static class Proxy implements IImsRcsFeature {
            ...
            public void setCapabilityExchangeEventListener(ICapabilityExchangeEventListener listener) throws RemoteException {
                ...
                try {
                    ...
                    if (!_status && Stub.getDefaultImpl() != null) {
                        Stub.getDefaultImpl().setCapabilityExchangeEventListener(listener);
                    }
                } finally {
                    _data.recycle();
                }
            ...
            public void publishCapabilities(String pidfXml, IPublishResponseCallback cb) throws RemoteException {
                ...
                try {
                    ...
                    if (!_status && Stub.getDefaultImpl() != null) {
                        Stub.getDefaultImpl().publishCapabilities(pidfXml, cb);
                    }
                } finally {
                    _data.recycle();
                }
            ...
            public void subscribeForCapabilities(List<Uri> uris, ISubscribeResponseCallback cb) throws RemoteException {
                ...
                try {
                    ...
                    if (!_status && Stub.getDefaultImpl() != null) {
                        Stub.getDefaultImpl().subscribeForCapabilities(uris, cb);
                    }
                } finally {
                    _data.recycle();
                }
            ...
            public void sendOptionsCapabilityRequest(Uri contactUri, List<String> myCapabilities, IOptionsResponseCallback cb) throws RemoteException {
                ...
                try {
                    ...
                    if (!_status && Stub.getDefaultImpl() != null) {
                        Stub.getDefaultImpl().sendOptionsCapabilityRequest(contactUri, myCapabilities, cb);
                    }
                } finally {
                    _data.recycle();
                }
