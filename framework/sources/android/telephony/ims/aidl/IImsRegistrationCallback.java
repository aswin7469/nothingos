                ...
                default:
                    switch (code) {
                        case 1:
                            ...
                            if (data.readInt() != 0) {
                                _arg0 = ImsRegistrationAttributes.CREATOR.mo3559createFromParcel(data);
                            } else {
                                _arg0 = null;
                            }
                            onRegistered(_arg0);
                        ...
                        case 2:
                            data.enforceInterface(IImsRegistrationCallback.DESCRIPTOR);
                            if (data.readInt() != 0) {
                                _arg02 = ImsRegistrationAttributes.CREATOR.mo3559createFromParcel(data);
                            } else {
                                _arg02 = null;
                            }
                        ...
                        case 3:
                            data.enforceInterface(IImsRegistrationCallback.DESCRIPTOR);
                            if (data.readInt() != 0) {
                                _arg03 = ImsReasonInfo.CREATOR.mo3559createFromParcel(data);
                            } else {
                                _arg03 = null;
                            }
                        ...
                        case 4:
                            ...
                            if (data.readInt() != 0) {
                                _arg1 = ImsReasonInfo.CREATOR.mo3559createFromParcel(data);
                            } else {
                                _arg1 = null;
                            }
