                ...
                default:
                    switch (code) {
                        ...
                        case 2:
                            data.enforceInterface(ISipDelegateConnectionStateCallback.DESCRIPTOR);
                            if (data.readInt() != 0) {
                                _arg0 = DelegateRegistrationState.CREATOR.mo3559createFromParcel(data);
                            } else {
                                _arg0 = null;
                            }
                            List<FeatureTagState> _arg1 = data.createTypedArrayList(FeatureTagState.CREATOR);
                            onFeatureTagStatusChanged(_arg0, _arg1);
                            return true;
                        case 3:
                            data.enforceInterface(ISipDelegateConnectionStateCallback.DESCRIPTOR);
                            if (data.readInt() != 0) {
                                _arg02 = SipDelegateImsConfiguration.CREATOR.mo3559createFromParcel(data);
                            } else {
                                _arg02 = null;
                            }
                        ...
                        case 4:
                            data.enforceInterface(ISipDelegateConnectionStateCallback.DESCRIPTOR);
                            if (data.readInt() != 0) {
                                _arg03 = SipDelegateConfiguration.CREATOR.mo3559createFromParcel(data);
                            } else {
                                _arg03 = null;
                            }
