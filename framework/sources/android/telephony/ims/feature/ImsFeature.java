...
public abstract class ImsFeature {
    ...
    public static final Map<Integer, String> FEATURE_LOG_MAP = new HashMap<Integer, String>() { // from class: android.telephony.ims.feature.ImsFeature.1
        {
            put(0, "EMERGENCY_MMTEL");
            put(1, "MMTEL");
            put(2, "RCS");
        }
    };
    public static final Map<Integer, String> STATE_LOG_MAP = new HashMap<Integer, String>() { // from class: android.telephony.ims.feature.ImsFeature.2
        {
            put(0, "UNAVAILABLE");
            put(1, "INITIALIZING");
            put(2, "READY");
    ...
    protected abstract IInterface mo2705getBinder();
    ...
    public final void addCapabilityCallback(IImsCapabilityCallback c) {
        ...
        try {
            c.onCapabilitiesStatusChanged(mo2706queryCapabilityStatus().mCapabilities);
        } catch (RemoteException e) {
    ...
    /* renamed from: queryCapabilityStatus */
    public Capabilities mo2706queryCapabilityStatus() {
        Capabilities copy;
        synchronized (this.mLock) {
