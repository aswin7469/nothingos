...
public class MmTelFeature extends ImsFeature {
    ...
    private final IImsMmTelFeature mImsMMTelBinder = new IImsMmTelFeature.Stub() { // from class: android.telephony.ims.feature.MmTelFeature.1
        ...
        public int queryCapabilityStatus() {
            return MmTelFeature.this.mo2706queryCapabilityStatus().mCapabilities;
        }
    ...
    public final MmTelCapabilities mo2706queryCapabilityStatus() {
        return new MmTelCapabilities(super.mo2706queryCapabilityStatus());
    }
    ...
    public final IImsMmTelFeature mo2705getBinder() {
