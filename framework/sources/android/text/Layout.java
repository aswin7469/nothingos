...
public abstract class Layout {
    ...
    public void drawText(Canvas canvas, int firstLine, int lastLine) {
        ...
        while (lineNum4 <= lastLine) {
            ...
            if (directions != DIRS_ALL_LEFT_TO_RIGHT || layout.mSpannedText || hasTab || justify) {
                ...
                tabStops3 = tabStops2;
                lineNum2 = lineNum5;
                tl.set(paint, buf, start, end, dir3, directions, hasTab, tabStops2, layout.getEllipsisStart(lineNum5), layout.getEllipsisStart(lineNum5) + layout.getEllipsisCount(lineNum5));
                if (!justify) {
                    tl2 = tl;
                } else {
                    tl2 = tl;
    ...
    */
    ...
    /* JADX WARN: Removed duplicated region for block: B:30:0x00a8 A[LOOP:2: B:28:0x00a5->B:30:0x00a8, LOOP_END] */
    /*
        Code decompiled incorrectly, please refer to instructions dump.
    */
    ...
    */
    ...
    /* JADX WARN: Code restructure failed: missing block: B:16:0x0069, code lost:
        if ((r24 instanceof android.text.Spanned) == false) goto L41;
     */
    ...
    */
    private static float measurePara(TextPaint paint, CharSequence text, int start, int end, TextDirectionHeuristic textDir) {
        ...
        TextLine tl = TextLine.obtain();
        try {
            MeasuredParagraph mt2 = MeasuredParagraph.buildForBidi(text, start, end, textDir, null);
            try {
                char[] chars = mt2.getChars();
                int len = chars.length;
                Directions directions = mt2.getDirections(0, len);
                int dir = mt2.getParagraphDir();
