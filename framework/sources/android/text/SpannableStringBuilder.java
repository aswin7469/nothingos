...
public class SpannableStringBuilder implements CharSequence, GetChars, Spannable, Editable, Appendable, GraphicsOperations {
    ...
    public SpannableStringBuilder mo2735insert(int where, CharSequence tb, int start, int end) {
        return mo2737replace(where, where, tb, start, end);
    }

    @Override // android.text.Editable
    /* renamed from: insert  reason: collision with other method in class */
    public SpannableStringBuilder mo2734insert(int where, CharSequence tb) {
        return mo2737replace(where, where, tb, 0, tb.length());
    }

    @Override // android.text.Editable
    /* renamed from: delete  reason: collision with other method in class */
    public SpannableStringBuilder mo2733delete(int start, int end) {
        SpannableStringBuilder ret = mo2737replace(start, end, "", 0, 0);
    ...
    public SpannableStringBuilder mo2731append(CharSequence text) {
        int length = length();
        return mo2737replace(length, length, text, 0, text.length());
    }
    ...
    @Override // android.text.Editable, java.lang.Appendable
    /* renamed from: append  reason: collision with other method in class */
    public SpannableStringBuilder mo2732append(CharSequence text, int start, int end) {
        int length = length();
        return mo2737replace(length, length, text, start, end);
    }

    @Override // android.text.Editable, java.lang.Appendable
    /* renamed from: append  reason: collision with other method in class */
    public SpannableStringBuilder mo2730append(char text) {
        return mo2731append((CharSequence) String.valueOf(text));
    }
    ...
    public SpannableStringBuilder mo2736replace(int start, int end, CharSequence tb) {
        return mo2737replace(start, end, tb, 0, tb.length());
    }

    @Override // android.text.Editable
    /* renamed from: replace  reason: collision with other method in class */
    public SpannableStringBuilder mo2737replace(int start, int end, CharSequence tb, int tbstart, int tbend) {
        int selectionStart;
        int selectionEnd;
