    ...
    private boolean handleToken(CharBuffer formatBuffer, WallTime wallTime, ZoneInfoData zoneInfoData) {
        ...
        while (true) {
            ...
            if (formatBuffer.remaining() > 1) {
                ...
                int currentChar = charBuffer.get(formatBuffer.position());
                String str3 = "?";
                int i2 = 7;
                int i3 = 12;
                switch (currentChar) {
                    ...
                    case 103:
                        ...
                        java.util.Formatter formatter = this.numberFormatter;
