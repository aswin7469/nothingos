            ...
            if (rec2 < sparseArray.size()) {
                if (keyCode == 17) {
                    ...
                    if (Character.isLowerCase(current)) {
                        content.mo2736replace(selStart2, selEnd, String.valueOf(current).toUpperCase());
                        removeTimeouts(content);
                        new Timeout(content);
                        return true;
                    } else if (Character.isUpperCase(current)) {
                        content.mo2736replace(selStart2, selEnd, String.valueOf(current).toLowerCase());
                        removeTimeouts(content);
                        new Timeout(content);
                        return true;
                    }
                ...
                if (sparseArray.indexOfKey(keyCode) == rec2) {
                    ...
                    if (ix >= 0) {
                        ...
                        content.mo2737replace(selStart2, selEnd, val, ix2, ix2 + 1);
                        removeTimeouts(content);
                        new Timeout(content);
                        return true;
                    }
                ...
                if (selStart < 0) {
                    ...
                    content.mo2737replace(rec, selEnd, val2, off, off + 1);
