...
public class QwertyKeyListener extends BaseKeyListener {
    ...
    /* JADX WARN: Code restructure failed: missing block: B:159:0x0297, code lost:
        if (r25.hasModifiers(2) != false) goto L162;
     */
    ...
    */
    public boolean onKeyDown(View view, Editable content, int keyCode, KeyEvent event) {
        ...
        if (i2 != 0) {
            ...
            content.mo2736replace(selStart, selEnd, String.valueOf((char) i2));
            ...
            if ((pref & 2) != 0 && this.mAutoText) {
                if (i2 != 32 && i2 != 9 && i2 != 10 && i2 != 44 && i2 != 46 && i2 != 33 && i2 != 63 && i2 != 34 && Character.getType(i2) != 22) {
                    ...
                    if (rep == null) {
                        ...
                        content.mo2736replace(x, oldStart, rep);
                    }
                }
            } else {
                selEnd2 = selEnd4;
            ...
            if ((pref & 4) != 0 && this.mAutoText) {
                ...
                if (selEnd5 - 3 >= 0 && content.charAt(selEnd5 - 1) == ' ' && content.charAt(selEnd5 - 2) == ' ') {
                    ...
                    if (Character.isLetter(c3) || Character.isDigit(c3)) {
                        content.mo2736replace(selEnd5 - 2, selEnd5 - 1, MediaMetrics.SEPARATOR);
                    }
                }
            }
            return true;
            ...
            if (selStart == selEnd) {
                ...
                if (repl.length > 0) {
                    ...
                    if (selStart >= en) {
                        ...
                        content.mo2736replace(st, en, old);
