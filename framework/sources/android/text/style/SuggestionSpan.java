...
public class SuggestionSpan extends CharacterStyle implements ParcelableSpan {
    ...
    public static final Parcelable.Creator<SuggestionSpan> CREATOR = new Parcelable.Creator<SuggestionSpan>() { // from class: android.text.style.SuggestionSpan.1
        ...
        public SuggestionSpan mo3559createFromParcel(Parcel source) {
        ...
        public SuggestionSpan[] mo3560newArray(int size) {
    ...
    public SuggestionSpan(Context context, Locale locale, String[] suggestions, int flags, Class<?> notificationTargetClass) {
        ...
        String str = "";
        String locale2 = sourceLocale == null ? str : sourceLocale.toString();
        this.mLocaleStringForCompatibility = locale2;
        str = sourceLocale != null ? sourceLocale.toLanguageTag() : str;
        this.mLanguageTag = str;
        this.mHashCode = hashCodeInternal(strArr, str, locale2);
        initStyle(context);
    }
