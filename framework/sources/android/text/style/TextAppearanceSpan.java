...
public class TextAppearanceSpan extends MetricAffectingSpan implements ParcelableSpan {
    ...
    public TextAppearanceSpan(Parcel src) {
        ...
        if (src.readInt() != 0) {
            this.mTextColor = ColorStateList.CREATOR.mo3559createFromParcel(src);
        } else {
            this.mTextColor = null;
        }
        if (src.readInt() != 0) {
            this.mTextColorLink = ColorStateList.CREATOR.mo3559createFromParcel(src);
        } else {
    ...
    public void updateMeasureState(TextPaint ds) {
        ...
        if (typeface != null) {
            ...
            if (str != null) {
                ...
                Typeface styledTypeface2 = Typeface.create(tf, style);
