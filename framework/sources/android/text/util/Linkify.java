...
public class Linkify {
    ...
    private static final Function<String, URLSpan> DEFAULT_SPAN_FACTORY = Linkify$$ExternalSyntheticLambda0.INSTANCE;
    ...
    public static final boolean addLinks(TextView text, int mask) {
        ...
        CharSequence t = text.mo3084getText();
    ...
    public static final void addLinks(TextView text, Pattern pattern, String defaultScheme, String[] schemes, MatchFilter matchFilter, TransformFilter transformFilter) {
        SpannableString spannable = SpannableString.valueOf(text.mo3084getText());
