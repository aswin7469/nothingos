...
public class ChangeText extends Transition {
    ...
    private void captureValues(TransitionValues transitionValues) {
        if (transitionValues.view instanceof TextView) {
            ...
            transitionValues.values.put(PROPNAME_TEXT, textview.mo3084getText());
    ...
    */
    public Animator createAnimator(ViewGroup sceneRoot, TransitionValues startValues, TransitionValues endValues) {
        ...
        final CharSequence startText = startVals.get(PROPNAME_TEXT) != null ? (CharSequence) startVals.get(PROPNAME_TEXT) : charSequence;
        if (endVals.get(PROPNAME_TEXT) != null) {
            charSequence = (CharSequence) endVals.get(PROPNAME_TEXT);
        }
        final CharSequence endText = charSequence;
        int i3 = -1;
        if (view instanceof EditText) {
            ...
            if (endVals.get(PROPNAME_TEXT_SELECTION_START) != null) {
                i3 = ((Integer) endVals.get(PROPNAME_TEXT_SELECTION_START)).intValue();
            }
            int endSelectionStart2 = i3;
        ...
        if (this.mChangeBehavior == 0) {
            ...
            anim.addListener(new AnimatorListenerAdapter() { // from class: android.transition.ChangeText.1
                ...
                public void onAnimationEnd(Animator animation) {
                    if (startText.equals(view.mo3084getText())) {
                        view.setText(endText);
                        TextView textView = view;
                        if (textView instanceof EditText) {
                            ChangeText.this.setSelection((EditText) textView, i4, startSelectionEnd4);
                        }
                    }
                }
            });
            ...
            startSelectionEnd2 = startSelectionEnd;
            startSelectionStart2 = startSelectionStart;
            final int startColor2 = ((Integer) startVals.get(PROPNAME_TEXT_COLOR)).intValue();
            ...
            if (i5 == 3 || i5 == 1) {
                ValueAnimator outAnim2 = ValueAnimator.ofInt(Color.alpha(startColor2), 0);
                outAnim2.addUpdateListener(new ValueAnimator.AnimatorUpdateListener() { // from class: android.transition.ChangeText.2
                    ...
                    public void onAnimationUpdate(ValueAnimator animation) {
                        ...
                        view.setTextColor((currAlpha << 24) | (startColor2 & 16777215));
                    }
                });
                ...
                outAnim2.addListener(new AnimatorListenerAdapter() { // from class: android.transition.ChangeText.3
                    ...
                    public void onAnimationEnd(Animator animation) {
                        if (startText.equals(view.mo3084getText())) {
                            ...
                            TextView textView = view;
                            if (textView instanceof EditText) {
                                ChangeText.this.setSelection((EditText) textView, i6, i7);
                            }
                        }
        ...
        final int i9 = endSelectionStart;
        final int i10 = endSelectionEnd;
        final int i11 = endColor3;
        final int i12 = startSelectionStart2;
        final int i13 = startSelectionEnd2;
