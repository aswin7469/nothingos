...
public class Crossfade extends Transition {
    ...
    public Animator createAnimator(ViewGroup sceneRoot, TransitionValues startValues, TransitionValues endValues) {
        ...
        ViewOverlay overlay = useParentOverlay ? ((ViewGroup) view.getParent()).mo2895getOverlay() : view.mo2895getOverlay();
        ...
        anim.addListener(new AnimatorListenerAdapter() { // from class: android.transition.Crossfade.2
            ...
            public void onAnimationEnd(Animator animation) {
                ViewOverlay overlay2 = useParentOverlay ? ((ViewGroup) view.getParent()).mo2895getOverlay() : view.mo2895getOverlay();
