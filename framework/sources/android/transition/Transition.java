...
public abstract class Transition implements Cloneable {
    ...
    public Transition(Context context, AttributeSet attrs) {
        ...
        if (duration >= 0) {
            mo2760setDuration(duration);
        }
        long startDelay = a.getInt(2, -1);
        if (startDelay > 0) {
            mo2763setStartDelay(startDelay);
        }
        int resID = a.getResourceId(0, 0);
        if (resID > 0) {
            mo2761setInterpolator(AnimationUtils.loadInterpolator(context, resID));
        }
    ...
    public Transition mo2760setDuration(long duration) {
    ...
    public Transition mo2763setStartDelay(long startDelay) {
    ...
    public Transition mo2761setInterpolator(TimeInterpolator interpolator) {
    ...
    public Transition mo2750addTarget(int targetId) {
        if (targetId > 0) {
    ...
    /* renamed from: addTarget */
    public Transition mo2753addTarget(String targetName) {
        if (targetName != null) {
    ...
    /* renamed from: addTarget */
    public Transition mo2752addTarget(Class targetType) {
        if (targetType != null) {
            if (this.mTargetTypes == null) {
    ...
    public Transition mo2756removeTarget(int targetId) {
        if (targetId > 0) {
    ...
    /* renamed from: removeTarget */
    public Transition mo2759removeTarget(String targetName) {
    ...
    /* renamed from: addTarget */
    public Transition mo2751addTarget(View target) {
        this.mTargets.add(target);
        return this;
    }

    /* renamed from: removeTarget */
    public Transition mo2757removeTarget(View target) {
        if (target != null) {
    ...
    /* renamed from: removeTarget */
    public Transition mo2758removeTarget(Class target) {
        if (target != null) {
    ...
    protected void animate(Animator animator) {
        ...
        if (getDuration() >= 0) {
            animator.mo1103setDuration(getDuration());
        }
        if (getStartDelay() >= 0) {
    ...
    public Transition mo2749addListener(TransitionListener listener) {
    ...
    public Transition mo2755removeListener(TransitionListener listener) {
        ArrayList<TransitionListener> arrayList = this.mListeners;
        if (arrayList == null) {
            return this;
        }
    ...
    public Transition mo2762setSceneRoot(ViewGroup sceneRoot) {
