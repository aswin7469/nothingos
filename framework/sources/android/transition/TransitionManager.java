...
public class TransitionManager {
    ...
    private static void changeScene(Scene scene, Transition transition) {
        ...
        if (!sPendingTransitions.contains(sceneRoot)) {
            ...
            Transition transitionClone = transition.m2748clone();
            transitionClone.mo2762setSceneRoot(sceneRoot);
    ...
    public static class MultiListener implements ViewTreeObserver.OnPreDrawListener, View.OnAttachStateChangeListener {
        ...
        MultiListener(Transition transition, ViewGroup sceneRoot) {
            ...
            this.mViewTreeObserver = sceneRoot.getViewTreeObserver();
        }
        ...
        public boolean onPreDraw() {
            ...
            this.mTransition.mo2749addListener(new TransitionListenerAdapter() { // from class: android.transition.TransitionManager.MultiListener.1
