...
import nothing.perf.BoostAffinityManager;
...
public class BoostFramework {
    ...
    public static final int NT_HINT_BEGIN = 8193;
    public static final int NT_HINT_FINGER_FUNCTION = 8225;
    public static final int NT_HINT_SF_WINDOW_BLUR = 8231;
    public static final int NT_HINT_WEIXIN_LUCKY_MONEY = 8224;
        ...
        synchronized (BoostFramework.class) {
            if (!sIsLoaded) {
                try {
                    ...
                    Class[] argClasses10 = {Integer.TYPE, Integer.TYPE, String.class, Integer.TYPE, Integer.TYPE, Integer.TYPE, int[].class};
                    sperfHintAcqRelFunc = sPerfClass.getMethod("perfHintAcqRel", argClasses10);
                    Class[] argClasses11 = {Integer.TYPE, Integer.TYPE, String.class, Integer.TYPE, Integer.TYPE, Integer.TYPE, int[].class};
                    sperfHintRenewFunc = sPerfClass.getMethod("perfHintRenew", argClasses11);
                    try {
                        Class[] argClasses12 = {Integer.TYPE, Integer.TYPE, String.class, Integer.TYPE, String.class};
                        sUXEngineEvents = sPerfClass.getDeclaredMethod("perfUXEngine_events", argClasses12);
                        Class[] argClasses13 = {Integer.TYPE};
                        sUXEngineTrigger = sPerfClass.getDeclaredMethod("perfUXEngine_trigger", argClasses13);
                    } catch (Exception e) {
    ...
    public int perfHint(int hint, String userDataStr, int userData1, int userData2) {
        if (hint >= 8193) {
            int ret = BoostAffinityManager.getInstance().perfHint(hint, userDataStr, userData1, userData2);
            return ret;
        }
        try {
            ...
            int ret2 = ((Integer) retVal).intValue();
            return ret2;
        } catch (Exception e) {
            Log.e(TAG, "Exception " + e);
            return -1;
