...
public class TimeUtils {
    ...
    */
    private static int formatDurationLocked(long duration, int fieldLen) {
        ...
        boolean z2 = true;
        int pos5 = 2;
        int pos6 = printFieldLocked(formatStr, days, DateFormat.DATE, pos4, false, 0);
        int pos7 = printFieldLocked(formatStr, hours, DateFormat.HOUR, pos6, pos6 != pos4, zeropad ? 2 : 0);
        int pos8 = printFieldLocked(formatStr, minutes, DateFormat.MINUTE, pos7, pos7 != pos4, zeropad ? 2 : 0);
        if (pos8 == pos4) {
            z2 = false;
        }
        if (!zeropad) {
        ...
        int pos9 = printFieldLocked(formatStr, seconds, 's', pos8, z2, pos5);
        if (zeropad) {
            start = pos4;
        } else {
            start = pos4;
