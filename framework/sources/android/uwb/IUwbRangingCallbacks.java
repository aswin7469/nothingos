                ...
                default:
                    switch (code) {
                        case 1:
                            ...
                            if (data.readInt() != 0) {
                                _arg0 = SessionHandle.CREATOR.mo3559createFromParcel(data);
                            } else {
                                _arg0 = null;
                            }
                        ...
                        case 2:
                            data.enforceInterface(IUwbRangingCallbacks.DESCRIPTOR);
                            if (data.readInt() != 0) {
                                _arg02 = SessionHandle.CREATOR.mo3559createFromParcel(data);
                            } else {
                                _arg02 = null;
                            }
                        ...
                        case 3:
                            data.enforceInterface(IUwbRangingCallbacks.DESCRIPTOR);
                            if (data.readInt() != 0) {
                                _arg03 = SessionHandle.CREATOR.mo3559createFromParcel(data);
                            } else {
                                _arg03 = null;
                            }
                            if (data.readInt() != 0) {
                                _arg1 = PersistableBundle.CREATOR.mo3559createFromParcel(data);
                            } else {
                                _arg1 = null;
                            }
                        ...
                        case 4:
                            data.enforceInterface(IUwbRangingCallbacks.DESCRIPTOR);
                            if (data.readInt() != 0) {
                                _arg04 = SessionHandle.CREATOR.mo3559createFromParcel(data);
                            } else {
                                _arg04 = null;
                            }
                            int _arg15 = data.readInt();
                            if (data.readInt() != 0) {
                                _arg22 = PersistableBundle.CREATOR.mo3559createFromParcel(data);
                            } else {
                                _arg22 = null;
                            }
                        ...
                        case 5:
                            data.enforceInterface(IUwbRangingCallbacks.DESCRIPTOR);
                            if (data.readInt() != 0) {
                                _arg05 = SessionHandle.CREATOR.mo3559createFromParcel(data);
                            } else {
                                _arg05 = null;
                            }
                            if (data.readInt() != 0) {
                                _arg12 = PersistableBundle.CREATOR.mo3559createFromParcel(data);
                            } else {
                                _arg12 = null;
                            }
                        ...
                        case 6:
                            data.enforceInterface(IUwbRangingCallbacks.DESCRIPTOR);
                            if (data.readInt() != 0) {
                                _arg06 = SessionHandle.CREATOR.mo3559createFromParcel(data);
                            } else {
                                _arg06 = null;
                            }
                            int _arg16 = data.readInt();
                            if (data.readInt() != 0) {
                                _arg23 = PersistableBundle.CREATOR.mo3559createFromParcel(data);
                            } else {
                                _arg23 = null;
                            }
                        ...
                        case 7:
                            data.enforceInterface(IUwbRangingCallbacks.DESCRIPTOR);
                            if (data.readInt() != 0) {
                                _arg07 = SessionHandle.CREATOR.mo3559createFromParcel(data);
                            } else {
                                _arg07 = null;
                            }
                            int _arg17 = data.readInt();
                            if (data.readInt() != 0) {
                                _arg24 = PersistableBundle.CREATOR.mo3559createFromParcel(data);
                            } else {
                                _arg24 = null;
                            }
                        ...
                        case 8:
                            data.enforceInterface(IUwbRangingCallbacks.DESCRIPTOR);
                            if (data.readInt() != 0) {
                                _arg08 = SessionHandle.CREATOR.mo3559createFromParcel(data);
                            } else {
                                _arg08 = null;
                            }
                            int _arg18 = data.readInt();
                            if (data.readInt() != 0) {
                                _arg25 = PersistableBundle.CREATOR.mo3559createFromParcel(data);
                            } else {
                                _arg25 = null;
                            }
                        ...
                        case 9:
                            data.enforceInterface(IUwbRangingCallbacks.DESCRIPTOR);
                            if (data.readInt() != 0) {
                                _arg09 = SessionHandle.CREATOR.mo3559createFromParcel(data);
                            } else {
                                _arg09 = null;
                            }
                            int _arg19 = data.readInt();
                            if (data.readInt() != 0) {
                                _arg26 = PersistableBundle.CREATOR.mo3559createFromParcel(data);
                            } else {
                                _arg26 = null;
                            }
                        ...
                        case 10:
                            data.enforceInterface(IUwbRangingCallbacks.DESCRIPTOR);
                            if (data.readInt() != 0) {
                                _arg010 = SessionHandle.CREATOR.mo3559createFromParcel(data);
                            } else {
                                _arg010 = null;
                            }
                            if (data.readInt() != 0) {
                                _arg13 = RangingReport.CREATOR.mo3559createFromParcel(data);
                            } else {
                                _arg13 = null;
                            }
