...
public abstract class AbsSavedState implements Parcelable {
    ...
    public static final Parcelable.Creator<AbsSavedState> CREATOR = new Parcelable.ClassLoaderCreator<AbsSavedState>() { // from class: android.view.AbsSavedState.2
        ...
        public AbsSavedState mo3559createFromParcel(Parcel in) {
            return mo3532createFromParcel(in, (ClassLoader) null);
        }

        /* JADX WARN: Can't rename method to resolve collision */
        @Override // android.os.Parcelable.ClassLoaderCreator
        /* renamed from: createFromParcel */
        public AbsSavedState mo3532createFromParcel(Parcel in, ClassLoader loader) {
        ...
        public AbsSavedState[] mo3560newArray(int size) {
