...
public final class AccessibilityInteractionController {
    ...
    */
    public void findAccessibilityNodeInfoByAccessibilityIdUiThread(Message message) {
        ...
        SatisfiedFindAccessibilityNodeByAccessibilityIdRequest satisfiedRequest;
        IAccessibilityInteractionConnectionCallback callback2;
        int interactionId2;
        ...
        IAccessibilityInteractionConnectionCallback callback3 = (IAccessibilityInteractionConnectionCallback) args.arg1;
        ...
        try {
                        ...
                        if (requestedView != null) {
                            try {
                                if (isShown(requestedView)) {
                                    requestedNode = populateAccessibilityNodeInfoForView(requestedView, arguments, virtualDescendantId);
                                    updateInfoForViewportAndReturnFindNodeResult(requestedNode != null ? null : AccessibilityNodeInfo.obtain(requestedNode), callback3, interactionId3, spec3, interactiveRegion3);
                                    infos = this.mTempAccessibilityNodeInfoList;
                                    infos.clear();
                                    this.mPrefetcher.prefetchAccessibilityNodeInfos(requestedView, requestedNode != null ? null : AccessibilityNodeInfo.obtain(requestedNode), virtualDescendantId, flags, infos);
                                    this.mViewRootImpl.mAttachInfo.mAccessibilityFetchFlags = 0;
                                    updateInfosForViewPort(infos, spec3, interactiveRegion3);
                                    satisfiedRequest = getSatisfiedRequestInPrefetch(requestedNode != null ? null : requestedNode, infos, flags);
                                    ...
                                    returnPrefetchResult(interactionId3, infos, callback3);
                                ...
                                updateInfoForViewportAndReturnFindNodeResult(0 == 0 ? null : AccessibilityNodeInfo.obtain((AccessibilityNodeInfo) null), callback, interactionId, spec, interactiveRegion);
                                throw th;
                            }
                        }
                        requestedNode = null;
            ...
            updateInfoForViewportAndReturnFindNodeResult(0 == 0 ? null : AccessibilityNodeInfo.obtain((AccessibilityNodeInfo) null), callback2, interactionId2, spec2, interactiveRegion2);
        } catch (Throwable th3) {
            th = th3;
            spec = spec3;
            interactiveRegion = interactiveRegion3;
