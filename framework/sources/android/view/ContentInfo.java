...
public final class ContentInfo implements Parcelable {
    public static final Parcelable.Creator<ContentInfo> CREATOR = new Parcelable.Creator<ContentInfo>() { // from class: android.view.ContentInfo.1
        ...
        public ContentInfo mo3559createFromParcel(Parcel parcel) {
            ClipData clip = ClipData.CREATOR.mo3559createFromParcel(parcel);
            int source = parcel.readInt();
            int flags = parcel.readInt();
            Uri linkUri = Uri.CREATOR.mo3559createFromParcel(parcel);
            Bundle extras = parcel.readBundle();
            InputContentInfo inputContentInfo = null;
            if (parcel.readInt() != 0) {
                InputContentInfo inputContentInfo2 = InputContentInfo.CREATOR.mo3559createFromParcel(parcel);
                inputContentInfo = inputContentInfo2;
            }
            DragAndDropPermissions dragAndDropPermissions = null;
            if (parcel.readInt() != 0) {
                DragAndDropPermissions dragAndDropPermissions2 = DragAndDropPermissions.CREATOR.mo3559createFromParcel(parcel);
        ...
        public ContentInfo[] mo3560newArray(int size) {
    ...
    public Pair<ContentInfo, ContentInfo> partition(Predicate<ClipData.Item> itemPredicate) {
        ...
        if (this.mClip.getItemCount() == 1) {
            ...
            ContentInfo contentInfo2 = matched ? this : null;
            if (!matched) {
                contentInfo = this;
            }
