...
public final class Display {
    ...
    public int getModeIdByRefreshRate(float refreshRate) {
        synchronized (this.mLock) {
            updateDisplayInfoLocked();
            Mode[] modes = this.mDisplayInfo.supportedModes;
            for (int i = 0; i < modes.length; i++) {
                if (Math.abs(modes[i].getRefreshRate() - refreshRate) < 0.1f) {
    ...
    private void updateDisplayInfoLocked() {
        DisplayInfo newInfo = this.mOverrideDisplayInfo;
        if (newInfo == null) {
    ...
    public static final class Mode implements Parcelable {
        ...
        public static final Parcelable.Creator<Mode> CREATOR = new Parcelable.Creator<Mode>() { // from class: android.view.Display.Mode.1
            ...
            public Mode mo3559createFromParcel(Parcel in) {
                return new Mode(in);
            }
            ...
            public Mode[] mo3560newArray(int size) {
    ...
    public static final class HdrCapabilities implements Parcelable {
        ...
        public static final Parcelable.Creator<HdrCapabilities> CREATOR = new Parcelable.Creator<HdrCapabilities>() { // from class: android.view.Display.HdrCapabilities.1
            ...
            @Override // android.os.Parcelable.Creator
            /* renamed from: createFromParcel */
            public HdrCapabilities mo3559createFromParcel(Parcel source) {
            ...
            @Override // android.os.Parcelable.Creator
            /* renamed from: newArray */
            public HdrCapabilities[] mo3560newArray(int size) {
    ...
    public void setOverrideDisplayInfo(DisplayInfo displayInfo) {
        this.mOverrideDisplayInfo = displayInfo;
    }
}
