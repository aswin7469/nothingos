...
public final class DisplayCutout {
    ...
    private static Pair<Path, DisplayCutout> pathAndDisplayCutoutFromSpec(String pathSpec, String rectSpec, int displayWidth, int displayHeight, float density, Insets waterfallInsets) {
        ...
        int disableRoundedCorner = SystemProperties.getInt("vendor.display.disable_rounded_corner", 0);
        ...
        synchronized (obj) {
            try {
                if (spec.equals(sCachedSpec)) {
                    try {
                        if (sCachedDisplayWidth == displayWidth && sCachedDisplayHeight == displayHeight && sCachedDensity == density && waterfallInsets.equals(sCachedWaterfallInsets)) {
    ...
    public static final class ParcelableWrapper implements Parcelable {
        public static final Parcelable.Creator<ParcelableWrapper> CREATOR = new Parcelable.Creator<ParcelableWrapper>() { // from class: android.view.DisplayCutout.ParcelableWrapper.1
            ...
            public ParcelableWrapper mo3559createFromParcel(Parcel in) {
            ...
            public ParcelableWrapper[] mo3560newArray(int size) {
