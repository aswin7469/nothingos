...
public final class DisplayInfo implements Parcelable {
    public static final Parcelable.Creator<DisplayInfo> CREATOR = new Parcelable.Creator<DisplayInfo>() { // from class: android.view.DisplayInfo.1
        ...
        public DisplayInfo mo3559createFromParcel(Parcel source) {
        ...
        public DisplayInfo[] mo3560newArray(int size) {
    ...
    public void readFromParcel(Parcel source) {
        ...
        for (int i = 0; i < nModes; i++) {
            this.supportedModes[i] = Display.Mode.CREATOR.mo3559createFromParcel(source);
        }
