...
public class DragEvent implements Parcelable {
    ...
    public static final Parcelable.Creator<DragEvent> CREATOR = new Parcelable.Creator<DragEvent>() { // from class: android.view.DragEvent.1
        ...
        public DragEvent mo3559createFromParcel(Parcel in) {
            ...
            if (in.readInt() != 0) {
                event.mClipData = ClipData.CREATOR.mo3559createFromParcel(in);
            }
            if (in.readInt() != 0) {
                event.mClipDescription = ClipDescription.CREATOR.mo3559createFromParcel(in);
            }
            if (in.readInt() != 0) {
                event.mDragSurface = SurfaceControl.CREATOR.mo3559createFromParcel(in);
            }
            if (in.readInt() != 0) {
        ...
        public DragEvent[] mo3560newArray(int size) {
