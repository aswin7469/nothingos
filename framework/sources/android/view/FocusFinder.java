...
public class FocusFinder {
    private static final ThreadLocal<FocusFinder> tlFocusFinder = new ThreadLocal<FocusFinder>() { // from class: android.view.FocusFinder.1
        ...
        public FocusFinder mo2828initialValue() {
    ...
    private FocusFinder() {
        ...
        this.mUserSpecifiedFocusComparator = new UserSpecifiedFocusComparator(FocusFinder$$ExternalSyntheticLambda0.INSTANCE);
        this.mUserSpecifiedClusterComparator = new UserSpecifiedFocusComparator(FocusFinder$$ExternalSyntheticLambda1.INSTANCE);
