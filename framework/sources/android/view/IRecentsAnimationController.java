                ...
                default:
                    ...
                    switch (code) {
                        ...
                        case 2:
                            ...
                            if (data.readInt() != 0) {
                                _arg1 = PictureInPictureSurfaceTransaction.CREATOR.mo3559createFromParcel(data);
                            } else {
                                _arg1 = null;
                            }
                            if (data.readInt() != 0) {
                                _arg2 = SurfaceControl.CREATOR.mo3559createFromParcel(data);
                            } else {
                                _arg2 = null;
                            }
                            setFinishTaskTransaction(_arg04, _arg1, _arg2);
                            reply.writeNoException();
                            return true;
                        case 3:
                            data.enforceInterface(DESCRIPTOR);
                        ...
                        case 4:
                            ...
                            setInputConsumerEnabled(_arg03);
                            reply.writeNoException();
                            return true;
                        case 5:
                            data.enforceInterface(DESCRIPTOR);
                            ...
                            setAnimationTargetsBehindSystemBars(_arg03);
                            reply.writeNoException();
                            return true;
                        case 6:
                            data.enforceInterface(DESCRIPTOR);
                        ...
                        case 8:
                            ...
                            setDeferCancelUntilNextTransition(_arg02, _arg03);
                            reply.writeNoException();
                            return true;
                        case 9:
                            data.enforceInterface(DESCRIPTOR);
                        ...
                        case 11:
                            ...
                            detachNavigationBarFromApp(_arg03);
                            reply.writeNoException();
                            return true;
                        case 12:
                            data.enforceInterface(DESCRIPTOR);
