                ...
                default:
                    ...
                    switch (code) {
                        ...
                        case 23:
                            data.enforceInterface(DESCRIPTOR);
                            if (data.readInt() != 0) {
                                _arg0 = RemoteAnimationAdapter.CREATOR.mo3559createFromParcel(data);
                            } else {
                                _arg0 = null;
                            }
                        ...
                        case 32:
                            ...
                            if (data.readInt() != 0) {
                                _arg1 = TextUtils.CHAR_SEQUENCE_CREATOR.mo3559createFromParcel(data);
                            } else {
                                _arg1 = null;
                            }
                        ...
                        case 69:
                            data.enforceInterface(DESCRIPTOR);
                            if (data.readInt() != 0) {
                                _arg03 = Bundle.CREATOR.mo3559createFromParcel(data);
                            } else {
                                _arg03 = null;
                            }
                            lockNow(_arg03);
                        ...
                        case 75:
                            data.enforceInterface(DESCRIPTOR);
                            if (data.readInt() != 0) {
                                _arg04 = Rect.CREATOR.mo3559createFromParcel(data);
                            } else {
                                _arg04 = null;
                            }
                        ...
                        case 79:
                            ...
                            if (data.readInt() != 0) {
                                _arg12 = Insets.CREATOR.mo3559createFromParcel(data);
                            } else {
                                _arg12 = null;
                            }
                        ...
                        case 86:
                            data.enforceInterface(DESCRIPTOR);
                            int[] _result16 = registerDisplayWindowListener(IDisplayWindowListener.Stub.asInterface(data.readStrongBinder()));
                            reply.writeNoException();
                        ...
                        case 92:
                            data.enforceInterface(DESCRIPTOR);
                            int _result17 = getWindowingMode(data.readInt());
                            reply.writeNoException();
                        ...
                        case 94:
                            data.enforceInterface(DESCRIPTOR);
                            int _result18 = getRemoveContentMode(data.readInt());
                            reply.writeNoException();
                        ...
                        case 100:
                            data.enforceInterface(DESCRIPTOR);
                            int _result19 = getDisplayImePolicy(data.readInt());
                            reply.writeNoException();
                        ...
                        case 102:
                            data.enforceInterface(DESCRIPTOR);
                            if (data.readInt() != 0) {
                                _arg05 = InputEvent.CREATOR.mo3559createFromParcel(data);
                            } else {
                                _arg05 = null;
                            }
                        ...
                        case 108:
                            ...
                            if (data.readInt() != 0) {
                                _arg13 = InsetsState.CREATOR.mo3559createFromParcel(data);
                            } else {
                                _arg13 = null;
                            }
                        ...
                        case 109:
                            data.enforceInterface(DESCRIPTOR);
                            if (data.readInt() != 0) {
                                _arg06 = WindowManager.LayoutParams.CREATOR.mo3559createFromParcel(data);
                            } else {
                                _arg06 = null;
                            }
                        ...
                        case 114:
                            data.enforceInterface(DESCRIPTOR);
                            String[] _result20 = getSupportedDisplayHashAlgorithms();
                            reply.writeNoException();
                        ...
                        case 115:
                            data.enforceInterface(DESCRIPTOR);
                            if (data.readInt() != 0) {
                                _arg07 = DisplayHash.CREATOR.mo3559createFromParcel(data);
                            } else {
                                _arg07 = null;
                            }
                            VerifiedDisplayHash _result21 = verifyDisplayHash(_arg07);
                            reply.writeNoException();
                            if (_result21 != null) {
                                reply.writeInt(1);
                        ...
                        case 117:
                            ...
                            if (data.readInt() != 0) {
                                _arg32 = Bundle.CREATOR.mo3559createFromParcel(data);
                            } else {
                                _arg32 = null;
                            }
                            Configuration _result22 = attachWindowContextToDisplayArea(_arg028, _arg119, _arg210, _arg32);
                            reply.writeNoException();
                            if (_result22 != null) {
                                reply.writeInt(1);
        ...
        public static class Proxy implements IWindowManager {
            ...
            public SurfaceControl addShellRoot(int displayId, IWindow client, int shellRootLayer) throws RemoteException {
                ...
                try {
                    ...
                    _reply.readException();
                    if (_reply.readInt() != 0) {
                        _result = SurfaceControl.CREATOR.mo3559createFromParcel(_reply);
                    } else {
                        _result = null;
                    }
                    return _result;
            ...
            public WindowContentFrameStats getWindowContentFrameStats(IBinder token) throws RemoteException {
                ...
                try {
                    ...
                    _reply.readException();
                    if (_reply.readInt() != 0) {
                        _result = WindowContentFrameStats.CREATOR.mo3559createFromParcel(_reply);
                    } else {
                        _result = null;
                    }
                    return _result;
            ...
            public Region getCurrentImeTouchRegion() throws RemoteException {
                ...
                try {
                    ...
                    _reply.readException();
                    if (_reply.readInt() != 0) {
                        _result = Region.CREATOR.mo3559createFromParcel(_reply);
                    } else {
                        _result = null;
                    }
                    return _result;
            ...
            public int[] registerDisplayWindowListener(IDisplayWindowListener listener) throws RemoteException {
                ...
                try {
                    ...
                    if (!_status && Stub.getDefaultImpl() != null) {
                        return Stub.getDefaultImpl().registerDisplayWindowListener(listener);
                    }
                    _reply.readException();
            ...
            public VerifiedDisplayHash verifyDisplayHash(DisplayHash displayHash) throws RemoteException {
                ...
                try {
                    ...
                    _reply.readException();
                    if (_reply.readInt() != 0) {
                        _result = VerifiedDisplayHash.CREATOR.mo3559createFromParcel(_reply);
                    } else {
                        _result = null;
                    }
                    return _result;
