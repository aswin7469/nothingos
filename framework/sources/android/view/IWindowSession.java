...
public interface IWindowSession extends IInterface {
    ...
    public static class Default implements IWindowSession {
        ...
        @Override // android.view.IWindowSession
        public void getWindowModeTouchOffset(IWindow window, float[] values) throws RemoteException {
        }
    ...
    public static abstract class Stub extends Binder implements IWindowSession {
        ...
        static final int TRANSACTION_getWindowModeTouchOffset = 39;
        ...
        public static String getDefaultTransactionName(int transactionCode) {
            switch (transactionCode) {
                ...
                case 39:
                    return "getWindowModeTouchOffset";
                default:
                    return null;
            }
        }
                ...
                default:
                    ...
                    switch (code) {
                        case 1:
                            ...
                            if (data.readInt() != 0) {
                                _arg1 = WindowManager.LayoutParams.CREATOR.mo3559createFromParcel(data);
                            } else {
                                _arg1 = null;
                            }
                            ...
                            if (data.readInt() != 0) {
                                _arg4 = InsetsState.CREATOR.mo3559createFromParcel(data);
                            } else {
                                _arg4 = null;
                            }
                            ...
                            int _result = addToDisplay(_arg0, _arg1, _arg24, _arg33, _arg4, _arg54, _arg62, _arg73);
                        ...
                        case 2:
                            ...
                            if (data.readInt() != 0) {
                                _arg12 = WindowManager.LayoutParams.CREATOR.mo3559createFromParcel(data);
                            } else {
                                _arg12 = null;
                            }
                            ...
                            if (data.readInt() != 0) {
                                _arg5 = InsetsState.CREATOR.mo3559createFromParcel(data);
                            } else {
                                _arg5 = null;
                            }
                            ...
                            if (_arg8_length < 0) {
                                ...
                                InsetsSourceControl[] _arg83 = new InsetsSourceControl[_arg8_length];
                                _arg8 = _arg83;
                            }
                            InsetsSourceControl[] _arg84 = _arg8;
                            int _result2 = addToDisplayAsUser(_arg02, _arg12, _arg25, _arg34, _arg43, _arg5, _arg63, _arg74, _arg84);
                            reply.writeNoException();
                            reply.writeInt(_result2);
                            reply.writeInt(1);
                            _arg63.writeToParcel(reply, 1);
                            reply.writeInt(1);
                            _arg74.writeToParcel(reply, 1);
                            reply.writeTypedArray(_arg84, 1);
                            return true;
                        case 3:
                            data.enforceInterface(DESCRIPTOR);
                            IWindow _arg03 = IWindow.Stub.asInterface(data.readStrongBinder());
                            if (data.readInt() != 0) {
                                _arg13 = WindowManager.LayoutParams.CREATOR.mo3559createFromParcel(data);
                            } else {
                                _arg13 = null;
                            }
                            ...
                            int _result3 = addToDisplayWithoutInputChannel(_arg03, _arg13, _arg26, _arg35, _arg44);
                            reply.writeNoException();
                        ...
                        case 5:
                            ...
                            if (data.readInt() != 0) {
                                _arg14 = WindowManager.LayoutParams.CREATOR.mo3559createFromParcel(data);
                            } else {
                                _arg14 = null;
                            }
                            ...
                            ClientWindowFrames _arg75 = new ClientWindowFrames();
                            MergedConfiguration _arg85 = new MergedConfiguration();
                            ...
                            if (_arg11_length < 0) {
                                ...
                                InsetsSourceControl[] _arg112 = new InsetsSourceControl[_arg11_length];
                                _arg11 = _arg112;
                            }
                            Point _arg122 = new Point();
                            InsetsSourceControl[] _arg113 = _arg11;
                            int _result4 = relayout(_arg05, _arg14, _arg27, _arg36, _arg45, _arg55, _arg64, _arg75, _arg85, _arg9, _arg10, _arg113, _arg122);
                            reply.writeNoException();
                            reply.writeInt(_result4);
                            reply.writeInt(1);
                            _arg75.writeToParcel(reply, 1);
                            reply.writeInt(1);
                            _arg85.writeToParcel(reply, 1);
                            reply.writeInt(1);
                            _arg9.writeToParcel(reply, 1);
                            reply.writeInt(1);
                            _arg10.writeToParcel(reply, 1);
                            reply.writeTypedArray(_arg113, 1);
                            reply.writeInt(1);
                        ...
                        case 6:
                            ...
                            boolean _arg114 = z;
                            prepareToReplaceWindows(_arg06, _arg114);
                            return true;
                        case 7:
                            data.enforceInterface(DESCRIPTOR);
                        ...
                        case 8:
                            ...
                            if (data.readInt() != 0) {
                                _arg2 = Rect.CREATOR.mo3559createFromParcel(data);
                            } else {
                                _arg2 = null;
                            }
                            if (data.readInt() != 0) {
                            ...
                            if (data.readInt() != 0) {
                                _arg42 = Region.CREATOR.mo3559createFromParcel(data);
                            } else {
                                _arg42 = null;
                            }
                            setInsets(_arg08, _arg115, _arg2, _arg3, _arg42);
                            return true;
                        case 9:
                            data.enforceInterface(DESCRIPTOR);
                            IWindow _arg09 = IWindow.Stub.asInterface(data.readStrongBinder());
                            if (data.readInt() != 0) {
                                _arg15 = SurfaceControl.Transaction.CREATOR.mo3559createFromParcel(data);
                            } else {
                                _arg15 = null;
                            }
                        ...
                        case 12:
                            ...
                            boolean _arg116 = z;
                            boolean performHapticFeedback = performHapticFeedback(_arg011, _arg116);
                            reply.writeNoException();
                        ...
                        case 13:
                            ...
                            if (data.readInt() != 0) {
                                _arg22 = SurfaceControl.CREATOR.mo3559createFromParcel(data);
                            } else {
                                _arg22 = null;
                            }
                            ...
                            if (data.readInt() != 0) {
                                _arg82 = ClipData.CREATOR.mo3559createFromParcel(data);
                            } else {
                                _arg82 = null;
                            }
                            IBinder _result5 = performDrag(_arg012, _arg117, _arg22, _arg37, _arg46, _arg56, _arg65, _arg76, _arg82);
                            reply.writeNoException();
                        ...
                        case 14:
                            ...
                            boolean _arg118 = z;
                            reportDropResult(_arg013, _arg118);
                            return true;
                        case 15:
                            data.enforceInterface(DESCRIPTOR);
                        ...
                        case 20:
                            ...
                            boolean _arg123 = z;
                            setShouldZoomOutWallpaper(_arg019, _arg123);
                            return true;
                        case 21:
                            data.enforceInterface(DESCRIPTOR);
                            IBinder _arg020 = data.readStrongBinder();
                            wallpaperOffsetsComplete(_arg020);
                            return true;
                        case 22:
                            data.enforceInterface(DESCRIPTOR);
                            ...
                            setWallpaperDisplayOffset(_arg021, _arg124, _arg29);
                            return true;
                        case 23:
                            data.enforceInterface(DESCRIPTOR);
                            ...
                            Bundle _result6 = sendWallpaperCommand(_arg022, _arg125, _arg210, _arg39, _arg48, _arg52, _arg6);
                            reply.writeNoException();
                            if (_result6 != null) {
                                reply.writeInt(1);
                        ...
                        case 24:
                            ...
                            wallpaperCommandComplete(_arg023, _arg16);
                            return true;
                        case 25:
                            data.enforceInterface(DESCRIPTOR);
                            IBinder _arg024 = data.readStrongBinder();
                            if (data.readInt() != 0) {
                                _arg17 = Rect.CREATOR.mo3559createFromParcel(data);
                            } else {
                                _arg17 = null;
                            }
                            onRectangleOnScreenRequested(_arg024, _arg17);
                            return true;
                        case 26:
                            data.enforceInterface(DESCRIPTOR);
                            IBinder _arg025 = data.readStrongBinder();
                            IWindowId _result7 = getWindowId(_arg025);
                            reply.writeNoException();
                        ...
                        case 28:
                            ...
                            boolean startMovingTask = startMovingTask(_arg027, _arg126, _arg211);
                            reply.writeNoException();
                        ...
                        case 31:
                            ...
                            updateDisplayContentLocation(_arg030, _arg127, _arg212, _arg310);
                            return true;
                        case 32:
                            data.enforceInterface(DESCRIPTOR);
                            IWindow _arg031 = IWindow.Stub.asInterface(data.readStrongBinder());
                            if (data.readInt() != 0) {
                                _arg18 = Region.CREATOR.mo3559createFromParcel(data);
                            } else {
                                _arg18 = null;
                            }
                            updateTapExcludeRegion(_arg031, _arg18);
                            return true;
                        case 33:
                            data.enforceInterface(DESCRIPTOR);
                            IWindow _arg032 = IWindow.Stub.asInterface(data.readStrongBinder());
                            if (data.readInt() != 0) {
                                _arg19 = InsetsState.CREATOR.mo3559createFromParcel(data);
                            } else {
                                _arg19 = null;
                            }
                            insetsModified(_arg032, _arg19);
                            return true;
                        case 34:
                            data.enforceInterface(DESCRIPTOR);
                            IWindow _arg033 = IWindow.Stub.asInterface(data.readStrongBinder());
                            List<Rect> _arg128 = data.createTypedArrayList(Rect.CREATOR);
                            reportSystemGestureExclusionChanged(_arg033, _arg128);
                            return true;
                        case 35:
                            data.enforceInterface(DESCRIPTOR);
                            int _arg034 = data.readInt();
                            if (data.readInt() != 0) {
                                _arg110 = SurfaceControl.CREATOR.mo3559createFromParcel(data);
                            } else {
                                _arg110 = null;
                            }
                            IWindow _arg213 = IWindow.Stub.asInterface(data.readStrongBinder());
                            IBinder _arg311 = data.readStrongBinder();
                            int _arg49 = data.readInt();
                            int _arg57 = data.readInt();
                            int _arg66 = data.readInt();
                            InputChannel _arg77 = new InputChannel();
                            grantInputChannel(_arg034, _arg110, _arg213, _arg311, _arg49, _arg57, _arg66, _arg77);
                            reply.writeNoException();
                            reply.writeInt(1);
                            _arg77.writeToParcel(reply, 1);
                            return true;
                        case 36:
                            data.enforceInterface(DESCRIPTOR);
                            ...
                            if (data.readInt() != 0) {
                                _arg23 = SurfaceControl.CREATOR.mo3559createFromParcel(data);
                            } else {
                                _arg23 = null;
                            }
                            ...
                            if (data.readInt() != 0) {
                                _arg53 = Region.CREATOR.mo3559createFromParcel(data);
                            } else {
                                _arg53 = null;
                            }
                            updateInputChannel(_arg035, _arg129, _arg23, _arg312, _arg410, _arg53);
                            return true;
                        case 37:
                            data.enforceInterface(DESCRIPTOR);
                            ...
                            boolean _arg214 = z;
                            grantEmbeddedWindowFocus(_arg036, _arg130, _arg214);
                            reply.writeNoException();
                            return true;
                        case 38:
                            data.enforceInterface(DESCRIPTOR);
                            ...
                            generateDisplayHash(_arg037, _arg111, _arg215, _arg32);
                            return true;
                        case 39:
                            data.enforceInterface(DESCRIPTOR);
                            IWindow _arg038 = IWindow.Stub.asInterface(data.readStrongBinder());
                            float[] _arg131 = data.createFloatArray();
                            getWindowModeTouchOffset(_arg038, _arg131);
                            reply.writeNoException();
                            reply.writeFloatArray(_arg131);
                            return true;
                        default:
        ...
        public static class Proxy implements IWindowSession {
            ...
            public void getWindowModeTouchOffset(IWindow window, float[] values) throws RemoteException {
                ...
                try {
                    ...
                    if (!_status && Stub.getDefaultImpl() != null) {
                        Stub.getDefaultImpl().getWindowModeTouchOffset(window, values);
                        return;
                    }
                    _reply.readException();
                    _reply.readFloatArray(values);
                } finally {
                    _reply.recycle();
                    _data.recycle();
                }
