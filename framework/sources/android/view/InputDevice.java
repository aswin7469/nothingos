...
public final class InputDevice implements Parcelable {
    public static final Parcelable.Creator<InputDevice> CREATOR = new Parcelable.Creator<InputDevice>() { // from class: android.view.InputDevice.1
        ...
        public InputDevice mo3559createFromParcel(Parcel in) {
        ...
        public InputDevice[] mo3560newArray(int size) {
    ...
    private InputDevice(Parcel in) {
        this.mMotionRanges = new ArrayList<>();
        this.mKeyCharacterMap = KeyCharacterMap.CREATOR.mo3559createFromParcel(in);
        this.mId = in.readInt();
        ...
        this.mHasBattery = in.readInt() != 0 ? true : z;
    ...
    public String toString() {
        ...
        description.append("\n");
        description.append("  Has Sensor: ");
        description.append(this.mHasSensor);
        description.append("\n");
        description.append("  Has battery: ");
        description.append(this.mHasBattery);
        description.append("\n");
