...
public class InsetsState implements Parcelable {
    public static final Parcelable.Creator<InsetsState> CREATOR = new Parcelable.Creator<InsetsState>() { // from class: android.view.InsetsState.1
        ...
        public InsetsState mo3559createFromParcel(Parcel in) {
        ...
        public InsetsState[] mo3560newArray(int size) {
    ...
    public InsetsState() {
        this.mSources = new InsetsSource[22];
    ...
    public Rect calculateVisibleInsets(Rect frame, int softInputMode) {
        ...
        for (int type = 0; type <= 21; type++) {
            ...
            if (source != null) {
                int publicType = toPublicType(type);
                if (WindowInsets.Type.isVisibleInsetsType(publicType, softInputMode)) {
    ...
    public int hashCode() {
        return Objects.hash(this.mDisplayFrame, this.mDisplayCutout, Integer.valueOf(Arrays.hashCode(this.mSources)), this.mRoundedCorners, this.mPrivacyIndicatorBounds);
    }
    ...
    public String toSourceVisibilityString() {
        ...
        for (int i = 0; i < 22; i++) {
            ...
            if (source != null) {
                ...
                sb.append(": ");
                sb.append(source.isVisible() ? CalendarContract.CalendarColumns.VISIBLE : "invisible");
