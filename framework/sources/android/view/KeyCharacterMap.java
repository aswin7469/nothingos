...
public class KeyCharacterMap implements Parcelable {
    ...
    public static final Parcelable.Creator<KeyCharacterMap> CREATOR = new Parcelable.Creator<KeyCharacterMap>() { // from class: android.view.KeyCharacterMap.1
        /* JADX WARN: Can't rename method to resolve collision */
        @Override // android.os.Parcelable.Creator
        /* renamed from: createFromParcel */
        public KeyCharacterMap mo3559createFromParcel(Parcel in) {
        ...
        public KeyCharacterMap[] mo3560newArray(int size) {
    ...
    static {
        ...
        addDeadKey(45, 73, MetricsProto.MetricsEvent.ACTION_NOTIFICATION_EXPANDER);
