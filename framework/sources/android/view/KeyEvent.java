...
public class KeyEvent extends InputEvent implements Parcelable {
    ...
    public static final int KEYCODE_GESTURE_TAP = 627;
    ...
    public static final int KEYCODE_TAP = 626;
    ...
    public static final Parcelable.Creator<KeyEvent> CREATOR = new Parcelable.Creator<KeyEvent>() { // from class: android.view.KeyEvent.1
        ...
        public KeyEvent mo3559createFromParcel(Parcel in) {
            in.readInt();
        ...
        public KeyEvent[] mo3560newArray(int size) {
    ...
    public KeyEvent(KeyEvent origEvent) {
        ...
        this.mHmac = bArr == null ? null : (byte[]) bArr.clone();
    ...
    public static KeyEvent obtain(int id, long downTime, long eventTime, int action, int code, int repeat, int metaState, int deviceId, int scancode, int flags, int source, int displayId, byte[] hmac, String characters) {
        KeyEvent ev = obtain();
        ev.mId = id;
    ...
    public static KeyEvent obtain(long downTime, long eventTime, int action, int code, int repeat, int metaState, int deviceId, int scanCode, int flags, int source, int displayId, String characters) {
        return obtain(nativeNextId(), downTime, eventTime, action, code, repeat, metaState, deviceId, scanCode, flags, source, displayId, null, characters);
    }
