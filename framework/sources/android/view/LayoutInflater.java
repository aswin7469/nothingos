...
public abstract class LayoutInflater {
    ...
    private View tryInflatePrecompiled(int resource, Resources res, ViewGroup root, boolean attachToRoot) {
        ...
        try {
            ...
            if (view != null && root != null) {
                ...
                ViewGroup.LayoutParams params = root.mo3517generateLayoutParams(attrs);
                if (attachToRoot) {
                    ...
                    try {
                        ...
                        try {
                            if (!TAG_MERGE.equals(name)) {
                                ...
                                if (root != null) {
                                    params = root.mo3517generateLayoutParams(attrs);
                                    if (!attachToRoot) {
    ...
    */
            ...
            if ((type != 3 || parser.getDepth() > depth) && type != 1) {
                if (type == 2) {
                    ...
                    if (TAG_REQUEST_FOCUS.equals(name)) {
                        ...
                        ViewGroup.LayoutParams params = viewGroup.mo3517generateLayoutParams(attrs);
    ...
    /* JADX WARN: Code restructure failed: missing block: B:58:0x0105, code lost:
        r21 = r0.mo3517generateLayoutParams(r26);
     */
    ...
    */
    private void parseInclude(XmlPullParser parser, Context context, View parent, AttributeSet attrs) throws XmlPullParserException, IOException {
        ...
        if (params == null) {
            ...
            params2 = group.mo3517generateLayoutParams(childAttrs);
        } else {
            childAttrs = childParser2;
            params2 = params;
        }
