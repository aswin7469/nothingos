    ...
    class SensorEventListenerImpl implements SensorEventListener {
        ...
        public void onSensorChanged(SensorEvent event) {
            ...
            if (!ActivityThread.isSystem()) {
                int windowingMode = ActivityThread.currentActivityThread().getWindowingMode(null);
                if (WindowConfiguration.isNtWindowMode(windowingMode)) {
                    Log.i(OrientationEventListener.TAG, "not post orientation change on windowingMode=" + windowingMode);
                    return;
                }
            }
