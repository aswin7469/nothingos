...
public final class SurfaceControl implements Parcelable {
    ...
    public static final int HBM_DIM_LAYER = 1073741824;
    ...
    public static final int METADATA_LIGHT_MODE = 10;
    ...
    public static final Parcelable.Creator<SurfaceControl> CREATOR = new Parcelable.Creator<SurfaceControl>() { // from class: android.view.SurfaceControl.1
        ...
        public SurfaceControl mo3559createFromParcel(Parcel in) {
        ...
        public SurfaceControl[] mo3560newArray(int size) {
    ...
    private void assignNativeObject(long nativeObject, String callsite) {
        ...
        if (nativeObject != 0) {
            this.mCloseGuard.openWithCallSite(i.c, callsite);
        }
    ...
    public static class Transaction implements Closeable, Parcelable {
        ...
        public static final Parcelable.Creator<Transaction> CREATOR = new Parcelable.Creator<Transaction>() { // from class: android.view.SurfaceControl.Transaction.1
            ...
            @Override // android.os.Parcelable.Creator
            /* renamed from: createFromParcel */
            public Transaction mo3559createFromParcel(Parcel in) {
            ...
            @Override // android.os.Parcelable.Creator
            /* renamed from: newArray */
            public Transaction[] mo3560newArray(int size) {
