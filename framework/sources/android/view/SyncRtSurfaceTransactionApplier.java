...
public class SyncRtSurfaceTransactionApplier {
    ...
    public void scheduleApply(SurfaceParams... params) {
        ...
        this.mTargetViewRootImpl.registerRtFrameCallback(new HardwareRenderer.FrameDrawingCallback() { // from class: android.view.SyncRtSurfaceTransactionApplier$$ExternalSyntheticLambda0
            ...
            public final void onFrameDraw(long j) {
                SyncRtSurfaceTransactionApplier.this.lambda$scheduleApply$0$SyncRtSurfaceTransactionApplier(t, j);
            }
        });
        this.mTargetViewRootImpl.getView().invalidate();
    }

    public /* synthetic */ void lambda$scheduleApply$0$SyncRtSurfaceTransactionApplier(SurfaceControl.Transaction t, long frame) {
    ...
    /* JADX INFO: Access modifiers changed from: package-private */
    public void applyTransaction(SurfaceControl.Transaction t, long frame) {
        ViewRootImpl viewRootImpl = this.mTargetViewRootImpl;
        if (viewRootImpl != null) {
            viewRootImpl.lambda$applyTransactionOnDraw$9$ViewRootImpl(t, frame);
        } else {
            t.apply();
        }
    }
