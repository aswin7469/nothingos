...
public class View implements Drawable.Callback, KeyEvent.Callback, AccessibilityEventSource {
    ...
    */
    public View(Context context, AttributeSet attrs, int defStyleAttr, int defStyleRes) {
        ...
        if (isRtlCompatibilityMode()) {
            ...
            hasRelativePadding = (startPaddingDefined || endPaddingDefined) ? true : hasRelativePadding;
    ...
    */
    ...
    public void getWindowVisibleDisplayFrame(Rect outRect) {
        ...
        if (attachInfo != null) {
            ...
            handleJioTvDisplayFrame(outRect);
            return;
        }
    ...
    private void handleJioTvDisplayFrame(Rect outRect) {
        StackTraceElement[] stackTraceElements;
        Context context = this.mContext;
        if (context != null && "com.jio.jioplay.tv".equals(context.getPackageName()) && (stackTraceElements = new Throwable().getStackTrace()) != null && stackTraceElements.length > 2 && "isKeyboardOpen".equals(stackTraceElements[2].getMethodName()) && outRect.top == 136) {
            outRect.top = (int) (this.mContext.getResources().getDisplayMetrics().density * 48.0f);
        }
    }
    ...
    protected final void onDrawScrollBars(Canvas canvas) {
        ...
        if (state == 2) {
            ...
            if (cache.scrollBarInterpolator.timeToValues(values) == Interpolator.Result.FREEZE_END) {
                ...
                cache.scrollBar.mo3113mutate().setAlpha(Math.round(values[0]));
            }
            invalidate = true;
        } else {
            cache.scrollBar.mo3113mutate().setAlpha(255);
            invalidate = false;
        }
    ...
    */
    public boolean draw(Canvas canvas, ViewGroup parent, long drawingTime) {
        ...
        AttachInfo attachInfo = this.mAttachInfo;
        boolean drawingWithRenderNode2 = attachInfo != null && attachInfo.mHardwareAccelerated && hardwareAcceleratedCanvas2;
        boolean more2 = false;
        ...
        if (a3 != null) {
            a = a3;
            more2 = applyLegacyAnimation(parent, drawingTime, a3, scalingRequired);
        ...
        this.mPrivateFlags |= 32;
        if (concatMatrix2 || (parentFlags & 2049) != 1 || !canvas.quickReject(this.mLeft, this.mTop, this.mRight, this.mBottom) || (this.mPrivateFlags & 64) != 0) {
            this.mPrivateFlags2 &= -268435457;
            if (hardwareAcceleratedCanvas2) {
                int i2 = this.mPrivateFlags;
                this.mRecreateDisplayList = (Integer.MIN_VALUE & i2) != 0;
                this.mPrivateFlags = i2 & Integer.MAX_VALUE;
            }
            int layerType2 = getLayerType();
            if (layerType2 != 1 && drawingWithRenderNode2) {
                cache = null;
                ...
                Bitmap cache3 = getDrawingCache(true);
                cache = cache3;
                layerType = layerType2;
            }
                            ...
                            if (transformToApply != null) {
                                ...
                                if (!concatMatrix2) {
                                    ...
                                    if (drawingWithRenderNode) {
                                        ...
                                        restoreTo2 = restoreTo;
                                        int restoreTo5 = -transY;
                                        canvas.translate(-transX, restoreTo5);
    ...
    public ViewOverlay mo2895getOverlay() {
    ...
    public void setBackgroundColor(int color) {
        ...
        if (drawable instanceof ColorDrawable) {
            ((ColorDrawable) drawable.mo3113mutate()).setColor(color);
            computeOpaqueFlags();
    ...
    private void applyBackgroundTint() {
        if (this.mBackground != null && this.mBackgroundTint != null) {
            ...
            if (tintInfo.mHasTintList || tintInfo.mHasTintMode) {
                this.mBackground = this.mBackground.mo3113mutate();
    ...
    private void applyForegroundTint() {
        ...
        if (foregroundInfo != null && foregroundInfo.mDrawable != null && this.mForegroundInfo.mTintInfo != null) {
            ...
            if (tintInfo.mHasTintList || tintInfo.mHasTintMode) {
                ...
                foregroundInfo2.mDrawable = foregroundInfo2.mDrawable.mo3113mutate();
                if (tintInfo.mHasTintList) {
    ...
    */
    ...
    /* JADX WARN: Type inference failed for: r13v3, types: [android.view.Surface] */
    ...
    */
    public final boolean startDragAndDrop(ClipData data, DragShadowBuilder shadowBuilder, Object myLocalState, int flags) {
        ...
        if (attachInfo == null) {
            ...
            surface.onProvideShadowMetrics(shadowSize, shadowTouchPoint);
            ...
            SurfaceControl surfaceControl = new SurfaceControl.Builder(session2).setName("drag surface").setParent(root.getSurfaceControl()).setBufferSize(shadowSize.x, shadowSize.y).setFormat(-3).setCallsite("View.startDragAndDrop").build();
                ...
                try {
                    if (isHardwareAccelerated()) {
                        try {
                            ...
                            session = session2;
                            str = VIEW_LOG_TAG;
                            Log.e(str, "Unable to initiate drag", e);
                            if (token == null) {
                            }
                            session.kill();
                            return false;
                    ...
                    try {
                        ...
                        float f = shadowSize.x;
                        float f2 = shadowSize.y;
                        float f3 = shadowTouchPoint.x;
                        float f4 = shadowTouchPoint.y;
                        surface = surface2;
                        session = session2;
                        str = VIEW_LOG_TAG;
                        try {
    ...
    public static class BaseSavedState extends AbsSavedState {
        ...
        public static final Parcelable.Creator<BaseSavedState> CREATOR = new Parcelable.ClassLoaderCreator<BaseSavedState>() { // from class: android.view.View.BaseSavedState.1
            ...
            public BaseSavedState mo3559createFromParcel(Parcel in) {
            ...
            /* renamed from: createFromParcel */
            public BaseSavedState mo3532createFromParcel(Parcel in, ClassLoader loader) {
                return new BaseSavedState(in, loader);
            }

            @Override // android.os.Parcelable.Creator
            /* renamed from: newArray */
            public BaseSavedState[] mo3560newArray(int size) {
