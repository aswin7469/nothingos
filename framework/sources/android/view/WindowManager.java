...
public interface WindowManager extends ViewManager {
    ...
    public static final String INPUT_CONSUMER_PIP_WINDOW = "pip_window_input_consumer";
    ...
    public static class LayoutParams extends ViewGroup.LayoutParams implements Parcelable {
        ...
        public static final Parcelable.Creator<LayoutParams> CREATOR = new Parcelable.Creator<LayoutParams>() { // from class: android.view.WindowManager.LayoutParams.1
            ...
            public LayoutParams mo3559createFromParcel(Parcel in) {
            ...
            public LayoutParams[] mo3560newArray(int size) {
                return new LayoutParams[size];
            }
        };
        public static final int DIM_AMOUNT_CHANGED = 32;
        public static final int FIRST_APPLICATION_WINDOW = 1;
        public static final int FIRST_NT_WINDOW = 2050;
        ...
        public static final int NT_FLAGS_CHANGED = 1073741824;
        public static final int NT_FLAG_FORCED_FULLSCREEN = 4;
        public static final int NT_FLAG_NOT_CONTROL_SYSTEM_UI_BAR = 8192;
        public static final int NT_FLAG_SHOW_WINDOW_MODE_DIM = 4096;
        ...
        public static final int TYPE_WINDOW_MODE_DIM = 2053;
        public static final int TYPE_WINDOW_MODE_HEADS_UP = 2056;
        public static final int TYPE_WINDOW_MODE_PINNED_WINDOW_DISMISS = 2058;
        public static final int TYPE_WINDOW_MODE_PINNED_WINDOW_MENU = 2057;
        ...
        @ViewDebug.ExportedProperty(flagMapping = {@ViewDebug.FlagToString(equals = 4, mask = 4, name = "FORCED_FULLSCREEN"), @ViewDebug.FlagToString(equals = 4096, mask = 4096, name = "SHOW_WINDOW_MODE_DIM"), @ViewDebug.FlagToString(equals = 8192, mask = 8192, name = "NOT_CONTROL_SYSTEM_UI_BAR")})
        public int ntFlags;
        ...
        public LayoutParams(Parcel in) {
            ...
            this.mTitle = TextUtils.CHAR_SEQUENCE_CREATOR.mo3559createFromParcel(in);
            ...
            this.accessibilityTitle = TextUtils.CHAR_SEQUENCE_CREATOR.mo3559createFromParcel(in);
        ...
        public final int copyFrom(LayoutParams o) {
            ...
            int i26 = this.systemUiVisibility;
            int i27 = o.systemUiVisibility;
            if (i26 != i27 || this.subtreeSystemUiVisibility != o.subtreeSystemUiVisibility) {
                this.systemUiVisibility = i27;
            ...
            int i28 = this.inputFeatures;
            int i29 = o.inputFeatures;
            if (i28 != i29) {
                this.inputFeatures = i29;
                changes |= 65536;
            }
            ...
            int i32 = this.mBlurBehindRadius;
            int i33 = o.mBlurBehindRadius;
            if (i32 != i33) {
                this.mBlurBehindRadius = i33;
                changes |= 536870912;
            }
            ...
            int i34 = this.mFitInsetsTypes;
            int i35 = o.mFitInsetsTypes;
            if (i34 != i35) {
                this.mFitInsetsTypes = i35;
                changes |= 1;
            }
            int i36 = this.mFitInsetsSides;
            int i37 = o.mFitInsetsSides;
            if (i36 != i37) {
                this.mFitInsetsSides = i37;
                changes |= 1;
            }
            ...
            int i38 = this.ntFlags;
            int i39 = o.ntFlags;
            if (i38 != i39) {
                this.ntFlags = i39;
                return changes | 1073741824;
            }
            return changes;
        }
        ...
        public void dumpDimensions(StringBuilder sb) {
            ...
            if (this.width == -1) {
                ...
                valueOf = this.width == -2 ? str : String.valueOf(this.width);
            }
            sb.append(valueOf);
        ...
        public String toString(String prefix) {
            ...
            if (this.insetsFlags.appearance != 0) {
                ...
                sb.append(prefix);
                sb.append("  apr=");
                sb.append(ViewDebug.flagsToString(InsetsFlags.class, "appearance", this.insetsFlags.appearance));
            }
            if (this.insetsFlags.behavior != 0) {
                sb.append(System.lineSeparator());
                sb.append(prefix);
                sb.append("  bhv=");
                sb.append(ViewDebug.flagsToString(InsetsFlags.class, "behavior", this.insetsFlags.behavior));
            }
            if (this.mFitInsetsTypes != 0) {
                sb.append(System.lineSeparator());
                sb.append(prefix);
                sb.append("  fitTypes=");
                sb.append(ViewDebug.flagsToString(LayoutParams.class, "mFitInsetsTypes", this.mFitInsetsTypes));
            }
            if (this.mFitInsetsSides != WindowInsets.Side.all()) {
                sb.append(System.lineSeparator());
                sb.append(prefix);
                sb.append("  fitSides=");
                sb.append(ViewDebug.flagsToString(LayoutParams.class, "mFitInsetsSides", this.mFitInsetsSides));
            }
            ...
            if (i2 != 0) {
                ...
                sb.append(prefix);
                sb.append("  mfl=");
                sb.append(ViewDebug.flagsToString(LayoutParams.class, "flags", this.ntFlags));
            }
            sb.append('}');
            return sb.toString();
        }
