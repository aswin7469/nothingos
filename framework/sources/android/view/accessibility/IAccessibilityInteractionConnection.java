                ...
                default:
                    switch (code) {
                        case 1:
                            ...
                            if (data.readInt() != 0) {
                                _arg1 = Region.CREATOR.mo3559createFromParcel(data);
                            } else {
                                _arg1 = null;
                            }
                            ...
                            if (data.readInt() != 0) {
                                _arg7 = MagnificationSpec.CREATOR.mo3559createFromParcel(data);
                            } else {
                                _arg7 = null;
                            }
                            if (data.readInt() != 0) {
                                _arg8 = Bundle.CREATOR.mo3559createFromParcel(data);
                            } else {
                                _arg8 = null;
                            }
                        ...
                        case 2:
                            ...
                            if (data.readInt() != 0) {
                                _arg2 = Region.CREATOR.mo3559createFromParcel(data);
                            } else {
                                _arg2 = null;
                            }
                            ...
                            if (data.readInt() != 0) {
                                _arg82 = MagnificationSpec.CREATOR.mo3559createFromParcel(data);
                            } else {
                                _arg82 = null;
                            }
                        ...
                        case 3:
                            ...
                            if (data.readInt() != 0) {
                                _arg22 = Region.CREATOR.mo3559createFromParcel(data);
                            } else {
                                _arg22 = null;
                            }
                            ...
                            if (data.readInt() != 0) {
                                _arg83 = MagnificationSpec.CREATOR.mo3559createFromParcel(data);
                            } else {
                                _arg83 = null;
                            }
                        ...
                        case 4:
                            ...
                            if (data.readInt() != 0) {
                                _arg23 = Region.CREATOR.mo3559createFromParcel(data);
                            } else {
                                _arg23 = null;
                            }
                            ...
                            if (data.readInt() != 0) {
                                _arg84 = MagnificationSpec.CREATOR.mo3559createFromParcel(data);
                            } else {
                                _arg84 = null;
                            }
                        ...
                        case 5:
                            ...
                            if (data.readInt() != 0) {
                                _arg24 = Region.CREATOR.mo3559createFromParcel(data);
                            } else {
                                _arg24 = null;
                            }
                            ...
                            if (data.readInt() != 0) {
                                _arg85 = MagnificationSpec.CREATOR.mo3559createFromParcel(data);
                            } else {
                                _arg85 = null;
                            }
                        ...
                        case 6:
                            ...
                            performAccessibilityAction(_arg06, _arg16, _arg25, _arg36, _arg46, _arg56, _arg66, _arg76);
                            return true;
                        case 7:
                            data.enforceInterface(DESCRIPTOR);
        ...
        public static class Proxy implements IAccessibilityInteractionConnection {
            ...
            public void findAccessibilityNodeInfoByAccessibilityId(long accessibilityNodeId, Region bounds, int interactionId, IAccessibilityInteractionConnectionCallback callback, int flags, int interrogatingPid, long interrogatingTid, MagnificationSpec spec, Bundle arguments) throws RemoteException {
                ...
                try {
                    ...
                    _data3.writeLong(accessibilityNodeId);
                    if (bounds != null) {
                        try {
                            _data3.writeInt(1);
                    ...
                    _data3.writeInt(interactionId);
                    _data3.writeStrongBinder(callback != null ? callback.asBinder() : null);
                    _data3.writeInt(flags);
                    _data3.writeInt(interrogatingPid);
                    _data3.writeLong(interrogatingTid);
                    if (spec != null) {
                        _data3.writeInt(1);
                        spec.writeToParcel(_data3, 0);
                    } else {
                        _data3.writeInt(0);
                    }
                    if (arguments != null) {
                        _data3.writeInt(1);
                        arguments.writeToParcel(_data3, 0);
                    } else {
                        _data3.writeInt(0);
                    }
                    boolean _status = this.mRemote.transact(1, _data3, null, 1);
                    if (_status) {
                        _data2 = _data3;
