...
public class AnimationSet extends Animation {
    ...
    public AnimationSet mo2921clone() throws CloneNotSupportedException {
        AnimationSet animation = (AnimationSet) super.m2920clone();
        ...
        for (int i = 0; i < count; i++) {
            animation.mAnimations.add(animations.get(i).m2920clone());
        }
        return animation;
    }
