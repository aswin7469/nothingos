...
public class Transformation {
    ...
    protected boolean mHasCornerRadius;
    ...
    public void set(Transformation t) {
        ...
        this.mCornerRadius = t.getCornerRadius();
        this.mHasCornerRadius = t.hasCornerRadius();
    ...
    public void compose(Transformation t) {
        this.mAlpha *= t.getAlpha();
        this.mCornerRadius = Math.max(t.getCornerRadius(), this.mCornerRadius);
        this.mHasCornerRadius = this.mHasCornerRadius || t.hasCornerRadius();
