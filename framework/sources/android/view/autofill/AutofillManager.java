...
public final class AutofillManager {
    ...
    /* JADX WARN: Removed duplicated region for block: B:56:0x01b2 A[Catch: TimeoutException -> 0x01ea, RemoteException -> 0x01ee, TryCatch #4 {RemoteException -> 0x01ee, TimeoutException -> 0x01ea, blocks: (B:51:0x016b, B:54:0x0187, B:56:0x01b2, B:57:0x01b4, B:59:0x01bf, B:61:0x01c3, B:62:0x01e1, B:63:0x01e6), top: B:50:0x016b }] */
    /* JADX WARN: Removed duplicated region for block: B:59:0x01bf A[Catch: TimeoutException -> 0x01ea, RemoteException -> 0x01ee, TryCatch #4 {RemoteException -> 0x01ee, TimeoutException -> 0x01ea, blocks: (B:51:0x016b, B:54:0x0187, B:56:0x01b2, B:57:0x01b4, B:59:0x01bf, B:61:0x01c3, B:62:0x01e1, B:63:0x01e6), top: B:50:0x016b }] */
    ...
    */
                ...
                if (!this.mEnabledForAugmentedAutofillOnly && (autofillOptions = this.mOptions) != null && autofillOptions.isAutofillDisabledLocked(clientActivity)) {
                    if (this.mOptions.isAugmentedAutofillEnabled(this.mContext)) {
                        if (Helper.sDebug) {
                            ...
                            intResult = receiver.getIntResult();
                            this.mSessionId = intResult;
                            if (intResult != Integer.MAX_VALUE) {
                                this.mState = 1;
                            }
                            extraFlags = receiver.getOptionalExtraIntResult(0);
                            if ((extraFlags & 1) != 0) {
                                if (Helper.sDebug) {
    ...
    private boolean startAutofillIfNeededLocked(View view) {
        if (this.mState == 0 && this.mSessionId == Integer.MAX_VALUE && (view instanceof EditText) && !TextUtils.isEmpty(((EditText) view).mo3084getText()) && !view.isFocused() && view.isImportantForAutofill() && view.isLaidOut() && view.isVisibleToUser()) {
            boolean clientAdded = tryAddServiceClientIfNeededLocked();
            if (Helper.sVerbose) {
