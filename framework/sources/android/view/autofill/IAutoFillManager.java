                ...
                default:
                    ...
                    switch (code) {
                        ...
                        case 3:
                            ...
                            if (data.readInt() != 0) {
                                _arg2 = AutofillId.CREATOR.mo3559createFromParcel(data);
                            } else {
                                _arg2 = null;
                            }
                            if (data.readInt() != 0) {
                            ...
                            if (data.readInt() != 0) {
                                _arg4 = AutofillValue.CREATOR.mo3559createFromParcel(data);
                            } else {
                                _arg4 = null;
                            }
                            ...
                            if (data.readInt() != 0) {
                                _arg8 = ComponentName.CREATOR.mo3559createFromParcel(data);
                            } else {
                                _arg8 = null;
                            }
                        ...
                        case 6:
                            ...
                            if (data.readInt() != 0) {
                                _arg22 = Rect.CREATOR.mo3559createFromParcel(data);
                            } else {
                                _arg22 = null;
                            }
                            if (data.readInt() != 0) {
                                _arg32 = AutofillValue.CREATOR.mo3559createFromParcel(data);
                            } else {
                                _arg32 = null;
                            }
                        ...
                        case 18:
                            data.enforceInterface(DESCRIPTOR);
                            if (data.readInt() != 0) {
                                _arg02 = UserData.CREATOR.mo3559createFromParcel(data);
                            } else {
                                _arg02 = null;
                            }
                            setUserData(_arg02);
