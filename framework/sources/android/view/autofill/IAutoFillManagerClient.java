                ...
                default:
                    ...
                    switch (code) {
                        ...
                        case 3:
                            ...
                            if (data.readInt() != 0) {
                                _arg1 = AutofillId.CREATOR.mo3559createFromParcel(data);
                            } else {
                                _arg1 = null;
                            }
                            if (data.readInt() != 0) {
                                _arg2 = ClipData.CREATOR.mo3559createFromParcel(data);
                            } else {
                                _arg2 = null;
                            }
                        ...
                        case 4:
                            ...
                            if (data.readInt() != 0) {
                                _arg22 = IntentSender.CREATOR.mo3559createFromParcel(data);
                            } else {
                                _arg22 = null;
                            }
                            if (data.readInt() != 0) {
                        ...
                        case 5:
                            ...
                            if (data.readInt() != 0) {
                                _arg5 = AutofillId.CREATOR.mo3559createFromParcel(data);
                            } else {
                                _arg5 = null;
                            }
                        ...
                        case 6:
                            ...
                            if (data.readInt() != 0) {
                                _arg12 = AutofillId.CREATOR.mo3559createFromParcel(data);
                            } else {
                                _arg12 = null;
                            }
                        ...
                        case 7:
                            ...
                            if (data.readInt() != 0) {
                                _arg13 = AutofillId.CREATOR.mo3559createFromParcel(data);
                            } else {
                                _arg13 = null;
                            }
                        ...
                        case 8:
                            ...
                            if (data.readInt() != 0) {
                                _arg14 = AutofillId.CREATOR.mo3559createFromParcel(data);
                            } else {
                                _arg14 = null;
                            }
                        ...
                        case 9:
                            ...
                            if (data.readInt() != 0) {
                                _arg15 = AutofillId.CREATOR.mo3559createFromParcel(data);
                            } else {
                                _arg15 = null;
                            }
                        ...
                        case 10:
                            ...
                            if (data.readInt() != 0) {
                                _arg16 = AutofillId.CREATOR.mo3559createFromParcel(data);
                            } else {
                                _arg16 = null;
                            }
                        ...
                        case 11:
                            ...
                            if (data.readInt() != 0) {
                                _arg17 = AutofillId.CREATOR.mo3559createFromParcel(data);
                            } else {
                                _arg17 = null;
                            }
                            if (data.readInt() != 0) {
                                _arg23 = KeyEvent.CREATOR.mo3559createFromParcel(data);
                            } else {
                                _arg23 = null;
                            }
                        ...
                        case 12:
                            data.enforceInterface(DESCRIPTOR);
                            if (data.readInt() != 0) {
                                _arg0 = IntentSender.CREATOR.mo3559createFromParcel(data);
                            } else {
                                _arg0 = null;
                            }
                            if (data.readInt() != 0) {
                                _arg18 = Intent.CREATOR.mo3559createFromParcel(data);
                            } else {
                                _arg18 = null;
                            }
                        ...
                        case 16:
                            ...
                            if (data.readInt() != 0) {
                                _arg19 = ComponentName.CREATOR.mo3559createFromParcel(data);
                            } else {
                                _arg19 = null;
                            }
                        ...
                        case 17:
                            data.enforceInterface(DESCRIPTOR);
                            if (data.readInt() != 0) {
                                _arg02 = AutofillId.CREATOR.mo3559createFromParcel(data);
                            } else {
                                _arg02 = null;
                            }
