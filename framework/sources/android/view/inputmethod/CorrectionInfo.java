...
public final class CorrectionInfo implements Parcelable {
    public static final Parcelable.Creator<CorrectionInfo> CREATOR = new Parcelable.Creator<CorrectionInfo>() { // from class: android.view.inputmethod.CorrectionInfo.1
        ...
        public CorrectionInfo mo3559createFromParcel(Parcel source) {
        ...
        public CorrectionInfo[] mo3560newArray(int size) {
    ...
    private CorrectionInfo(Parcel source) {
        ...
        this.mOldText = TextUtils.CHAR_SEQUENCE_CREATOR.mo3559createFromParcel(source);
        this.mNewText = TextUtils.CHAR_SEQUENCE_CREATOR.mo3559createFromParcel(source);
    }
