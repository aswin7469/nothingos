...
public class ExtractedText implements Parcelable {
    public static final Parcelable.Creator<ExtractedText> CREATOR = new Parcelable.Creator<ExtractedText>() { // from class: android.view.inputmethod.ExtractedText.1
        ...
        public ExtractedText mo3559createFromParcel(Parcel source) {
            ExtractedText res = new ExtractedText();
            res.text = TextUtils.CHAR_SEQUENCE_CREATOR.mo3559createFromParcel(source);
            ...
            res.hint = TextUtils.CHAR_SEQUENCE_CREATOR.mo3559createFromParcel(source);
            return res;
        }
        ...
        public ExtractedText[] mo3560newArray(int size) {
