...
public final class InlineSuggestion implements Parcelable {
    ...
    public void inflate(Context context, Size size, Executor callbackExecutor, final Consumer<InlineContentView> callback) {
        ...
        try {
            ...
            callbackExecutor.execute(new Runnable() { // from class: android.view.inputmethod.InlineSuggestion$$ExternalSyntheticLambda2
                @Override // java.lang.Runnable
                public final void run() {
                    callback.accept(null);
                }
        ...
        this.mInfo.getTooltip().inflate(context, tooltipSize, callbackExecutor, new Consumer() { // from class: android.view.inputmethod.InlineSuggestion$$ExternalSyntheticLambda3
            @Override // java.util.function.Consumer
            public final void accept(Object obj) {
                InlineSuggestion.this.lambda$inflate$3$InlineSuggestion((InlineContentView) obj);
            }
        });
    }

    public /* synthetic */ void lambda$inflate$2$InlineSuggestion(InlineContentView view) {
        this.mInlineTooltipUi.setTooltipView(view);
    }

    public /* synthetic */ void lambda$inflate$3$InlineSuggestion(final InlineContentView view) {
        Handler.getMain().post(new Runnable() { // from class: android.view.inputmethod.InlineSuggestion$$ExternalSyntheticLambda0
            @Override // java.lang.Runnable
            public final void run() {
                InlineSuggestion.this.lambda$inflate$2$InlineSuggestion(view);
            }
        });
    }
    ...
    public static final class InlineContentCallbackImpl {
        ...
        public void onContent(final SurfaceControlViewHost.SurfacePackage content, final int width, final int height) {
            this.mMainHandler.post(new Runnable() { // from class: android.view.inputmethod.InlineSuggestion$InlineContentCallbackImpl$$ExternalSyntheticLambda4
                @Override // java.lang.Runnable
                public final void run() {
                    InlineSuggestion.InlineContentCallbackImpl.this.lambda$onContent$0$InlineSuggestion$InlineContentCallbackImpl(content, width, height);
                }
            });
        }
        ...
        public void lambda$onContent$0$InlineSuggestion$InlineContentCallbackImpl(SurfaceControlViewHost.SurfacePackage content, int width, int height) {
        ...
        private void handleOnFirstContentReceived(SurfaceControlViewHost.SurfacePackage content, int width, int height) {
            ...
            if (content == null) {
                this.mCallbackExecutor.execute(new Runnable() { // from class: android.view.inputmethod.InlineSuggestion$InlineContentCallbackImpl$$ExternalSyntheticLambda0
                    @Override // java.lang.Runnable
                    public final void run() {
                        InlineSuggestion.InlineContentCallbackImpl.this.lambda$handleOnFirstContentReceived$1$InlineSuggestion$InlineContentCallbackImpl();
                    }
                });
                return;
            }
            ...
            this.mCallbackExecutor.execute(new Runnable() { // from class: android.view.inputmethod.InlineSuggestion$InlineContentCallbackImpl$$ExternalSyntheticLambda1
                @Override // java.lang.Runnable
                public final void run() {
                    InlineSuggestion.InlineContentCallbackImpl.this.lambda$handleOnFirstContentReceived$2$InlineSuggestion$InlineContentCallbackImpl();
                }
            });
        }

        public /* synthetic */ void lambda$handleOnFirstContentReceived$1$InlineSuggestion$InlineContentCallbackImpl() {
            this.mCallback.accept(null);
        }

        public /* synthetic */ void lambda$handleOnFirstContentReceived$2$InlineSuggestion$InlineContentCallbackImpl() {
        ...
        public class AnonymousClass2 implements InlineContentView.SurfacePackageUpdater {
            ...
            public void onSurfacePackageReleased() {
                InlineContentCallbackImpl.this.mMainHandler.post(new Runnable() { // from class: android.view.inputmethod.InlineSuggestion$InlineContentCallbackImpl$2$$ExternalSyntheticLambda0
                    @Override // java.lang.Runnable
                    public final void run() {
                        InlineSuggestion.InlineContentCallbackImpl.AnonymousClass2.this.lambda$onSurfacePackageReleased$0$InlineSuggestion$InlineContentCallbackImpl$2();
                    }
                });
            }

            public /* synthetic */ void lambda$onSurfacePackageReleased$0$InlineSuggestion$InlineContentCallbackImpl$2() {
            ...
            public void getSurfacePackage(final Consumer<SurfaceControlViewHost.SurfacePackage> consumer) {
                InlineContentCallbackImpl.this.mMainHandler.post(new Runnable() { // from class: android.view.inputmethod.InlineSuggestion$InlineContentCallbackImpl$2$$ExternalSyntheticLambda1
                    @Override // java.lang.Runnable
                    public final void run() {
                        InlineSuggestion.InlineContentCallbackImpl.AnonymousClass2.this.lambda$getSurfacePackage$1$InlineSuggestion$InlineContentCallbackImpl$2(consumer);
                    }
                });
            }

            public /* synthetic */ void lambda$getSurfacePackage$1$InlineSuggestion$InlineContentCallbackImpl$2(Consumer consumer) {
        ...
        public void onClick() {
            this.mMainHandler.post(new Runnable() { // from class: android.view.inputmethod.InlineSuggestion$InlineContentCallbackImpl$$ExternalSyntheticLambda2
                @Override // java.lang.Runnable
                public final void run() {
                    InlineSuggestion.InlineContentCallbackImpl.this.lambda$onClick$3$InlineSuggestion$InlineContentCallbackImpl();
                }
            });
        }

        public /* synthetic */ void lambda$onClick$3$InlineSuggestion$InlineContentCallbackImpl() {
        ...
        public void onLongClick() {
            this.mMainHandler.post(new Runnable() { // from class: android.view.inputmethod.InlineSuggestion$InlineContentCallbackImpl$$ExternalSyntheticLambda3
                @Override // java.lang.Runnable
                public final void run() {
                    InlineSuggestion.InlineContentCallbackImpl.this.lambda$onLongClick$4$InlineSuggestion$InlineContentCallbackImpl();
                }
            });
        }

        public /* synthetic */ void lambda$onLongClick$4$InlineSuggestion$InlineContentCallbackImpl() {
            InlineContentView inlineContentView = this.mView;
    ...
    private static class InlineContentCallbackImplParceling implements Parcelling<InlineContentCallbackImpl> {
        ...
        public InlineContentCallbackImpl mo3468unparcel(Parcel source) {
            return null;
        }
    }
    ...
    private static class InlineTooltipUiParceling implements Parcelling<InlineTooltipUi> {
        ...
        @Override // com.android.internal.util.Parcelling
        /* renamed from: unparcel */
        public InlineTooltipUi mo3468unparcel(Parcel source) {
            return null;
        }
    }
    ...
    static {
        ...
        CREATOR = new Parcelable.Creator<InlineSuggestion>() { // from class: android.view.inputmethod.InlineSuggestion.1
            ...
            public InlineSuggestion[] mo3560newArray(int size) {
            ...
            public InlineSuggestion mo3559createFromParcel(Parcel in) {
    ...
    InlineSuggestion(Parcel in) {
        ...
        InlineContentCallbackImpl inlineContentCallback = sParcellingForInlineContentCallback.mo3468unparcel(in);
        InlineTooltipUi inlineTooltipUi = sParcellingForInlineTooltipUi.mo3468unparcel(in);
        this.mInfo = info;
        AnnotationValidations.validate((Class<NonNull>) NonNull.class, (NonNull) null, (Object) info);
        this.mContentProvider = contentProvider;
        this.mInlineContentCallback = inlineContentCallback;
