...
public final class InputContentInfo implements Parcelable {
    public static final Parcelable.Creator<InputContentInfo> CREATOR = new Parcelable.Creator<InputContentInfo>() { // from class: android.view.inputmethod.InputContentInfo.1
        ...
        public InputContentInfo mo3559createFromParcel(Parcel source) {
        ...
        public InputContentInfo[] mo3560newArray(int size) {
    ...
    private InputContentInfo(Parcel source) {
        this.mContentUri = Uri.CREATOR.mo3559createFromParcel(source);
        this.mContentUriOwnerUserId = source.readInt();
        this.mDescription = ClipDescription.CREATOR.mo3559createFromParcel(source);
        this.mLinkUri = Uri.CREATOR.mo3559createFromParcel(source);
        if (source.readInt() == 1) {
