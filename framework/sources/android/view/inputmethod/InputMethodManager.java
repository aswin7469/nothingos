...
public final class InputMethodManager {
    ...
    boolean startInputInner(final int startInputReason, IBinder windowGainingFocus, int startInputFlags, int softInputMode, int windowFlags) {
        ...
        synchronized (this.mH) {
            try {
                ...
                Handler vh2 = view.getHandler();
                if (vh2 == null) {
                    closeCurrentInput();
                    return false;
                } else if (vh2.getLooper() != Looper.myLooper()) {
                    vh2.post(new Runnable() { // from class: android.view.inputmethod.InputMethodManager$$ExternalSyntheticLambda0
                        @Override // java.lang.Runnable
                        public final void run() {
                            ...
                            try {
                                ...
                                if (servedView != view) {
                                    ...
                                    if (ic != null) {
                                        ...
                                        Handler icHandler2 = (missingMethodFlags2 & 32) != 0 ? null : ic.getHandler();
                                        missingMethodFlags = missingMethodFlags2;
                                        icHandler = icHandler2;
                                        servedContext = new IInputConnectionWrapper(icHandler2 != null ? icHandler2.getLooper() : vh2.getLooper(), ic, this, view);
                                    } else {
                                    ...
                                    try {
                                        InputBindResult res = this.mService.startInputOrWindowGainedFocus(startInputReason, this.mClient, windowGainingFocus2, startInputFlags2, softInputMode2, windowFlags2, tba, servedContext, missingMethodFlags, view.getContext().getApplicationInfo().targetSdkVersion);
                                        try {
                                            if (res == null) {
                                            ...
                                            try {
                                                ...
                                                if (ic != null && res != null && res.method != null) {
                                                    view.onInputConnectionOpenedInternal(ic, tba, vh);
                                                }
                                                return true;
                                            } catch (Throwable th2) {
                                                th = th2;
    ...
    public void updateSelection(View view, int selStart, int selEnd, int candidatesStart, int candidatesEnd) {
        ...
        checkFocus();
        synchronized (this.mH) {
            if (hasServedByInputMethodLocked(view) && this.mCurrentTextBoxAttribute != null && (inputMethodSessionWrapper = this.mCurrentInputMethodSession) != null) {
                int oldSelStart = this.mCursorSelStart;
                if (oldSelStart != selStart || this.mCursorSelEnd != selEnd || this.mCursorCandStart != candidatesStart || this.mCursorCandEnd != candidatesEnd) {
                    ...
                    inputMethodSessionWrapper.updateSelection(oldSelStart, oldSelEnd, selStart, selEnd, candidatesStart, candidatesEnd);
                }
            }
        }
    }
    ...
    public void viewClicked(View view) {
        ...
        synchronized (this.mH) {
            if (hasServedByInputMethodLocked(view) && this.mCurrentTextBoxAttribute != null && (inputMethodSessionWrapper = this.mCurrentInputMethodSession) != null) {
                inputMethodSessionWrapper.viewClicked(focusChanged);
            }
        }
    }
    ...
    public void sendAppPrivateCommand(View view, String action, Bundle data) {
        ...
        synchronized (this.mH) {
            if (hasServedByInputMethodLocked(view) && this.mCurrentTextBoxAttribute != null && (inputMethodSessionWrapper = this.mCurrentInputMethodSession) != null) {
                inputMethodSessionWrapper.appPrivateCommand(action, data);
            }
        }
    }
