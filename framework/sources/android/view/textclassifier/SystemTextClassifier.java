...
public final class SystemTextClassifier implements TextClassifier {
    ...
    public SystemTextClassifier(Context context, TextClassificationConstants settings, boolean useDefault) throws ServiceManager.ServiceNotFoundException {
        ...
        Objects.requireNonNull(opPackageName);
        this.mSystemTcMetadata = new SystemTextClassifierMetadata(opPackageName, context.getUserId(), useDefault);
    }
    ...
    public void dump(IndentingPrintWriter printWriter) {
        ...
        printWriter.mo3455increaseIndent();
        ...
        printWriter.mo3454decreaseIndent();
        printWriter.println();
    }
