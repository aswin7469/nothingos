...
public final class TextSelection implements Parcelable {
    public static final Parcelable.Creator<TextSelection> CREATOR = new Parcelable.Creator<TextSelection>() { // from class: android.view.textclassifier.TextSelection.1
        ...
        public TextSelection mo3559createFromParcel(Parcel in) {
        ...
        public TextSelection[] mo3560newArray(int size) {
    ...
    private TextSelection(Parcel in) {
        ...
        this.mEntityConfidence = EntityConfidence.CREATOR.mo3559createFromParcel(in);
        this.mId = in.readString();
        this.mExtras = in.readBundle();
        this.mTextClassification = (TextClassification) in.readParcelable(TextClassification.class.getClassLoader());
    }
}
