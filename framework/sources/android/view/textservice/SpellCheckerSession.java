...
public class SpellCheckerSession {
    ...
    void handleOnGetSuggestionsMultiple(final SuggestionsInfo[] suggestionsInfos) {
        this.mExecutor.execute(new Runnable() { // from class: android.view.textservice.SpellCheckerSession$$ExternalSyntheticLambda1
            ...
            public final void run() {
                SpellCheckerSession.this.lambda$handleOnGetSuggestionsMultiple$0$SpellCheckerSession(suggestionsInfos);
            }
        });
    }

    public /* synthetic */ void lambda$handleOnGetSuggestionsMultiple$0$SpellCheckerSession(SuggestionsInfo[] suggestionsInfos) {
    ...
    void handleOnGetSentenceSuggestionsMultiple(final SentenceSuggestionsInfo[] suggestionsInfos) {
        this.mExecutor.execute(new Runnable() { // from class: android.view.textservice.SpellCheckerSession$$ExternalSyntheticLambda0
            @Override // java.lang.Runnable
            public final void run() {
                SpellCheckerSession.this.lambda$handleOnGetSentenceSuggestionsMultiple$1$SpellCheckerSession(suggestionsInfos);
            }
        });
    }

    public /* synthetic */ void lambda$handleOnGetSentenceSuggestionsMultiple$1$SpellCheckerSession(SentenceSuggestionsInfo[] suggestionsInfos) {
