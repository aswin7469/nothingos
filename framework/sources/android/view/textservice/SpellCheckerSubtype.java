...
public final class SpellCheckerSubtype implements Parcelable {
    ...
    public static final Parcelable.Creator<SpellCheckerSubtype> CREATOR = new Parcelable.Creator<SpellCheckerSubtype>() { // from class: android.view.textservice.SpellCheckerSubtype.1
        ...
        public SpellCheckerSubtype mo3559createFromParcel(Parcel source) {
        ...
        public SpellCheckerSubtype[] mo3560newArray(int size) {
    ...
    public SpellCheckerSubtype(int nameId, String locale, String languageTag, String extraValue, int subtypeId) {
        ...
        String str = "";
        String str2 = locale != null ? locale : str;
        this.mSubtypeLocale = str2;
        this.mSubtypeLanguageTag = languageTag != null ? languageTag : str;
        str = extraValue != null ? extraValue : str;
        this.mSubtypeExtraValue = str;
        this.mSubtypeId = subtypeId;
        this.mSubtypeHashCode = subtypeId != 0 ? subtypeId : hashCodeInternal(str2, str);
    }
    ...
    SpellCheckerSubtype(Parcel source) {
        ...
        this.mSubtypeHashCode = readInt == 0 ? hashCodeInternal(str2, str) : readInt;
    }
