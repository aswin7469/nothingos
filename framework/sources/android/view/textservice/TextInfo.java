...
public final class TextInfo implements Parcelable {
    public static final Parcelable.Creator<TextInfo> CREATOR = new Parcelable.Creator<TextInfo>() { // from class: android.view.textservice.TextInfo.1
        ...
        public TextInfo mo3559createFromParcel(Parcel source) {
        ...
        public TextInfo[] mo3560newArray(int size) {
    ...
    public TextInfo(Parcel source) {
        this.mCharSequence = TextUtils.CHAR_SEQUENCE_CREATOR.mo3559createFromParcel(source);
