                ...
                default:
                    switch (code) {
                        ...
                        case 5:
                            ...
                            if (data.readInt() != 0) {
                                _arg1 = TranslationSpec.CREATOR.mo3559createFromParcel(data);
                            } else {
                                _arg1 = null;
                            }
                            if (data.readInt() != 0) {
                                _arg22 = TranslationSpec.CREATOR.mo3559createFromParcel(data);
                            } else {
                                _arg22 = null;
                            }
                            ...
                            if (data.readInt() != 0) {
                                _arg6 = UiTranslationSpec.CREATOR.mo3559createFromParcel(data);
                            } else {
                                _arg6 = null;
                            }
