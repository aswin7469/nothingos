        ...
        public void accept(final Translator translator) {
            ...
            if (translator != null) {
                ...
                try {
                    ...
                    executor.execute(new Runnable() { // from class: android.view.translation.TranslationManager$1$$ExternalSyntheticLambda1
                        @Override // java.lang.Runnable
                        public final void run() {
            ...
            try {
                ...
                executor2.execute(new Runnable() { // from class: android.view.translation.TranslationManager$1$$ExternalSyntheticLambda0
                    @Override // java.lang.Runnable
                    public final void run() {
