...
public final class TranslationRequest implements Parcelable {
    public static final Parcelable.Creator<TranslationRequest> CREATOR = new Parcelable.Creator<TranslationRequest>() { // from class: android.view.translation.TranslationRequest.1
        ...
        public TranslationRequest[] mo3560newArray(int size) {
        ...
        public TranslationRequest mo3559createFromParcel(Parcel in) {
    ...
    public static String requestFlagsToString(int value) {
        return BitUtils.flagsToString(value, TranslationRequest$$ExternalSyntheticLambda0.INSTANCE);
    }
    ...
    TranslationRequest(Parcel in) {
        ...
        in.readParcelableList(arrayList, TranslationRequestValue.class.getClassLoader());
        ArrayList arrayList2 = new ArrayList();
        in.readParcelableList(arrayList2, ViewTranslationRequest.class.getClassLoader());
        this.mFlags = flags;
        Preconditions.checkFlagsArgument(flags, 15);
