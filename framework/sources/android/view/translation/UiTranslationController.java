...
public class UiTranslationController {
    ...
    public /* synthetic */ void lambda$onTranslationCompleted$4$UiTranslationController(View view, ViewTranslationResponse response, AutofillId autofillId) {
        ...
        if (view.getViewTranslationResponse() != null && view.getViewTranslationResponse().equals(response) && (callback instanceof TextViewTranslationCallback) && ((TextViewTranslationCallback) callback).isShowingTranslation()) {
            if (DEBUG) {
