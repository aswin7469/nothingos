...
public class FindActionModeCallback implements ActionMode.Callback, TextWatcher, View.OnClickListener, WebView.FindListener {
    ...
    public void setText(String text) {
        ...
        Spannable span = this.mEditText.mo3084getText();
    ...
    public void findAll() {
        ...
        CharSequence find = this.mEditText.mo3084getText();
        if (find.length() == 0) {
    ...
    public boolean onCreateActionMode(ActionMode mode, Menu menu) {
        ...
        Editable edit = this.mEditText.mo3084getText();
    ...
    public boolean onActionItemClicked(ActionMode mode, MenuItem item) {
        ...
        switch (item.getItemId()) {
            case R.id.find_next /* 16908982 */:
                findNext(true);
                break;
            case R.id.find_prev /* 16908983 */:
                findNext(false);
                break;
            default:
                return false;
