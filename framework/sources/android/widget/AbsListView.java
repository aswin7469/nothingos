...
public abstract class AbsListView extends AdapterView<ListAdapter> implements TextWatcher, ViewTreeObserver.OnGlobalLayoutListener, Filter.FilterListener, ViewTreeObserver.OnTouchModeChangeListener, RemoteViewsAdapter.RemoteAdapterConnectionCallback {
    ...
    public Parcelable onSaveInstanceState() {
        ...
        ss.filter = null;
        if (this.mFiltered && (textFilter = this.mTextFilter) != null && (filterText = textFilter.mo3084getText()) != null) {
        ...
        SparseBooleanArray sparseBooleanArray = this.mCheckStates;
        if (sparseBooleanArray != null) {
            ss.checkState = sparseBooleanArray.m2783clone();
        }
    ...
    private boolean canScrollUp() {
        ...
        if (!canScrollUp2 && getChildCount() > 0) {
            ...
            if (child.getTop() >= this.mListPadding.top) {
                canScrollUp = false;
            }
            return canScrollUp;
        }
    ...
    private boolean canScrollDown() {
        ...
        if (!canScrollDown2 && count > 0) {
            ...
            if (child.getBottom() > this.mBottom - this.mListPadding.bottom) {
                canScrollDown = true;
            }
    ...
    private void setItemViewLayoutParams(View child, int position) {
        ...
        if (vlp == null) {
            lp = (LayoutParams) mo3516generateDefaultLayoutParams();
        } else if (!checkLayoutParams(vlp)) {
            lp = (LayoutParams) mo3518generateLayoutParams(vlp);
        } else {
            lp = (LayoutParams) vlp;
        }
    ...
    private void scrollIfNeeded(int x, int y, MotionEvent vtev) {
        ...
        if (!dispatchNestedPreScroll(0, -incrementalDeltaY6, this.mScrollConsumed, this.mScrollOffset)) {
            ...
            int rawDeltaY3 = rawDeltaY2 + iArr3[1];
            int scrollOffsetCorrection2 = -this.mScrollOffset[1];
            int incrementalDeltaY7 = incrementalDeltaY6 + iArr3[1];
            if (vtev != null) {
                vtev.offsetLocation(0.0f, iArr2[1]);
        ...
        if (i2 == 3) {
            ...
            if (y != this.mLastY) {
                ...
                if (i3 >= 0) {
                    motionIndex = i3 - this.mFirstPosition;
                } else {
            ...
            if (i2 == 5 && y != this.mLastY) {
                ...
                if (incrementalDeltaY4 != 0) {
                    ...
                    if (motionView3 != null) {
                        i4 = motionView3.getTop();
                    }
                    this.mMotionViewOriginalTop = i4;
    ...
    private boolean isGlowActive() {
        return (this.mEdgeGlowBottom.getDistance() == 0.0f && this.mEdgeGlowTop.getDistance() == 0.0f) ? false : true;
    }
    ...
    public boolean onTouchEvent(MotionEvent ev) {
        ...
        switch (actionMasked) {
            ...
            case 1:
                ...
                break;
            case 2:
                int i = this.mNumTouchMoveEvent + 1;
                this.mNumTouchMoveEvent = i;
                if (i == 1) {
    ...
    */
    ...
    public ViewGroup.LayoutParams mo3516generateDefaultLayoutParams() {
        ...
        public void run() {
            ...
            switch (this.mMode) {
                ...
                case 2:
                    ...
                    AbsListView absListView2 = AbsListView.this;
                    int i3 = firstViewTop - extraScroll2;
                    int i4 = this.mScrollDuration;
                    if (firstPos > this.mTargetPos) {
                        z2 = true;
                    }
                    absListView2.smoothScrollBy(i3, i4, true, z2);
