...
public class ActionMenuPresenter extends BaseMenuPresenter implements ActionProvider.SubUiVisibilityListener {
    ...
    private ViewTreeObserver.OnPreDrawListener mItemAnimationPreDrawListener = new ViewTreeObserver.OnPreDrawListener() { // from class: android.widget.ActionMenuPresenter.1
    ...
    private View.OnAttachStateChangeListener mAttachStateChangeListener = new View.OnAttachStateChangeListener() { // from class: android.widget.ActionMenuPresenter.2
    ...
    public View getItemView(MenuItemImpl item, View convertView, ViewGroup parent) {
        ...
        if (!menuParent.checkLayoutParams(lp)) {
            actionView.setLayoutParams(menuParent.mo3518generateLayoutParams(lp));
        }
        return actionView;
    }
    ...
    public void runItemAnimations() {
        ...
        for (int i = 0; i < this.mPreLayoutItems.size(); i++) {
            ...
            if (postLayoutIndex >= 0) {
                ...
                ((ViewGroup) this.mMenuView).mo2895getOverlay().add(menuItemLayoutInfoPre.view);
                anim2.mo1103setDuration(150L);
                anim2.start();
                ...
                anim2.addListener(new AnimatorListenerAdapter() { // from class: android.widget.ActionMenuPresenter.4
                    ...
                    public void onAnimationEnd(Animator animation) {
                        ...
                        ((ViewGroup) ActionMenuPresenter.this.mMenuView).mo2895getOverlay().remove(menuItemLayoutInfoPre.view);
                    }
                });
            }
        }
