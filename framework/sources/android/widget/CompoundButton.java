...
public abstract class CompoundButton extends Button implements Checkable {
    ...
    public CompoundButton(Context context, AttributeSet attrs, int defStyleAttr, int defStyleRes) {
        ...
        if (d != null) {
            lambda$setButtonIconAsync$1$CompoundButton(d);
        }
        if (a.hasValue(3)) {
    ...
    public Runnable setButtonDrawableAsync(int resId) {
        ...
        return new Runnable() { // from class: android.widget.CompoundButton$$ExternalSyntheticLambda0
            ...
            public final void run() {
                CompoundButton.this.lambda$setButtonDrawableAsync$0$CompoundButton(drawable);
            }
        };
    }

    /* renamed from: setButtonDrawable */
    public void lambda$setButtonIconAsync$1$CompoundButton(Drawable drawable) {
    ...
    public void setButtonIcon(Icon icon) {
        lambda$setButtonIconAsync$1$CompoundButton(icon == null ? null : icon.loadDrawable(getContext()));
    }
    ...
    public Runnable setButtonIconAsync(Icon icon) {
        ...
        return new Runnable() { // from class: android.widget.CompoundButton$$ExternalSyntheticLambda1
            @Override // java.lang.Runnable
            public final void run() {
                CompoundButton.this.lambda$setButtonIconAsync$1$CompoundButton(button);
            }
        };
    }
    ...
    private void applyButtonTint() {
        ...
        if (drawable != null) {
            if (this.mHasButtonTint || this.mHasButtonBlendMode) {
                ...
                this.mButtonDrawable = mo3113mutate;
                if (this.mHasButtonTint) {
                    mo3113mutate.setTintList(this.mButtonTintList);
                }
