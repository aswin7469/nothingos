...
public abstract class CursorTreeAdapter extends BaseExpandableListAdapter implements Filterable, CursorFilter.CursorFilterClient {
    ...
    public Cursor mo3080getChild(int groupPosition, int childPosition) {
    ...
    public Cursor mo3081getGroup(int groupPosition) {
    ...
    /* renamed from: convertToString  reason: collision with other method in class */
    public String mo3079convertToString(Cursor cursor) {
