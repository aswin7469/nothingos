...
public class DialerFilter extends RelativeLayout {
            ...
            case 67:
                switch (this.mMode) {
                    ...
                    case 2:
                        ...
                        if (this.mLetters.mo3084getText().length() == this.mDigits.mo3084getText().length()) {
                            setMode(1);
                            break;
                        }
                        break;
                    case 3:
                        if (this.mDigits.mo3084getText().length() == this.mLetters.mo3084getText().length()) {
    ...
    private void swapPrimaryAndHint(boolean makeLettersPrimary) {
        Editable lettersText = this.mLetters.mo3084getText();
        Editable digitsText = this.mDigits.mo3084getText();
        ...
        Editable lettersText2 = this.mLetters.mo3084getText();
        ...
        Editable digitsText2 = this.mDigits.mo3084getText();
    ...
    public CharSequence getLetters() {
        if (this.mLetters.getVisibility() == 0) {
            return this.mLetters.mo3084getText();
        }
        return "";
    }
    ...
    public CharSequence getDigits() {
        if (this.mDigits.getVisibility() == 0) {
            return this.mDigits.mo3084getText();
        }
        return "";
    }
    ...
    public void append(String text) {
        switch (this.mMode) {
            case 1:
                this.mDigits.mo3084getText().mo2720append((CharSequence) text);
                this.mLetters.mo3084getText().mo2720append((CharSequence) text);
                return;
            case 2:
            case 5:
                this.mLetters.mo3084getText().mo2720append((CharSequence) text);
    ...
    public void clearText() {
        Editable text = this.mLetters.mo3084getText();
        text.clear();
        Editable text2 = this.mDigits.mo3084getText();
        text2.clear();
        if (this.mIsQwerty) {
            setMode(1);
        } else {
    ...
    public void removeFilterWatcher(TextWatcher watcher) {
        Spannable text;
        if (this.mMode != 4) {
            text = this.mLetters.mo3084getText();
        } else {
            text = this.mDigits.mo3084getText();
        }
