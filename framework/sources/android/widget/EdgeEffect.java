...
public class EdgeEffect {
    ...
    public EdgeEffect(Context context, AttributeSet attrs) {
        ...
        this.mEdgeEffectType = Compatibility.isChangeEnabled((long) USE_STRETCH_EDGE_EFFECT_BY_DEFAULT) ? 1 : i;
        a.recycle();
    ...
    private void updateSpring() {
        ...
        double distance = Math.pow(2.718281828459045d, deltaT * (-24.16386d)) * ((Math.cos(deltaT * mDampedFreq) * cosCoeff) + (Math.sin(mDampedFreq * deltaT) * sinCoeff));
