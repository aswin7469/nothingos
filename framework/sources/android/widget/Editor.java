...
public class Editor {
    ...
    final ProcessTextIntentActionsHandler mProcessTextIntentActionsHandler = new ProcessTextIntentActionsHandler();
    ...
    public Editor(TextView textView) {
        ...
        this.mNewMagnifierEnabled = AppGlobals.getIntCoreSetting(WidgetFlags.KEY_ENABLE_NEW_MAGNIFIER, 0) != 0 ? true : z3;
    ...
    private Magnifier.Builder createBuilderWithInlineMagnifierDefaults() {
        ...
        int line = layout.getLineForOffset(this.mTextView.getSelectionStart());
        int sourceHeight = layout.getLineBottomWithoutSpacing(line) - layout.getLineTop(line);
    ...
    public void replace() {
        ...
        Selection.setSelection((Spannable) this.mTextView.mo3084getText(), middle);
    }
    ...
    public void onAttachedToWindow() {
        ...
        updateSpellCheckSpans(0, this.mTextView.mo3084getText().length(), true);
    ...
    public boolean selectCurrentWord() {
        ...
        if (minOffset < 0 || minOffset > this.mTextView.mo3084getText().length() || maxOffset < 0 || maxOffset > this.mTextView.mo3084getText().length()) {
            return false;
        }
        URLSpan[] urlSpans = (URLSpan[]) ((Spanned) this.mTextView.mo3084getText()).getSpans(minOffset, maxOffset, URLSpan.class);
        if (urlSpans.length >= 1) {
            URLSpan urlSpan = urlSpans[0];
            selectionStart = ((Spanned) this.mTextView.mo3084getText()).getSpanStart(urlSpan);
            selectionEnd = ((Spanned) this.mTextView.mo3084getText()).getSpanEnd(urlSpan);
        } else {
            WordIterator wordIterator = getWordIterator();
            wordIterator.setCharSequence(this.mTextView.mo3084getText(), minOffset, maxOffset);
        ...
        Selection.setSelection((Spannable) this.mTextView.mo3084getText(), selectionStart, selectionEnd);
    ...
    public boolean selectCurrentParagraph() {
        ...
        Selection.setSelection((Spannable) this.mTextView.mo3084getText(), start, end);
        return true;
    }
    ...
    public long getParagraphsRange(int startOffset, int endOffset) {
        ...
        CharSequence text = this.mTextView.mo3084getText();
    ...
    private long getCharClusterRange(int offset) {
        int textLength = this.mTextView.mo3084getText().length();
    ...
    public boolean performLongClick(boolean handled) {
        ...
        if (!handled && !isPositionOnText(this.mTouchState.getLastDownX(), this.mTouchState.getLastDownY()) && !this.mTouchState.isOnHandle() && this.mInsertionControllerEnabled) {
            ...
            Selection.setSelection((Spannable) this.mTextView.mo3084getText(), offset);
    ...
    public void onFocusChanged(boolean focused, int direction) {
        ...
        if (focused) {
            ...
            boolean isFocusHighlighted = this.mSelectAllOnFocus && selStart == 0 && selEnd == this.mTextView.mo3084getText().length();
            ...
            if (!this.mFrozenWithFocus || selStart < 0 || selEnd < 0) {
                ...
                if (lastTapPosition >= 0) {
                    Selection.setSelection((Spannable) this.mTextView.mo3084getText(), lastTapPosition);
                }
                MovementMethod mMovement = this.mTextView.getMovementMethod();
                if (mMovement != null) {
                    TextView textView = this.mTextView;
                    mMovement.onTakeFocus(textView, (Spannable) textView.mo3084getText(), direction);
                }
                if ((this.mTextView.isInExtractedMode() || this.mSelectionMoved) && selStart >= 0 && selEnd >= 0) {
                    Selection.setSelection((Spannable) this.mTextView.mo3084getText(), selStart, selEnd);
                }
    ...
    private void ensureNoSelectionIfNonSelectable() {
        if (!this.mTextView.textCanBeSelected() && this.mTextView.hasSelection()) {
            Selection.setSelection((Spannable) this.mTextView.mo3084getText(), this.mTextView.length(), this.mTextView.length());
        }
    }
    ...
    private int getLastTapPosition() {
        ...
        if (selectionModifierCursorController != null && (lastTapPosition = selectionModifierCursorController.getMinTouchOffset()) >= 0) {
            if (lastTapPosition > this.mTextView.mo3084getText().length()) {
                return this.mTextView.mo3084getText().length();
            }
        ...
        if (ims != null) {
            ...
            if (nesting == 1) {
                ...
                if (ims.mContentChanged) {
                    ims.mChangedStart = 0;
                    ims.mChangedEnd = this.mTextView.mo3084getText().length();
                } else {
                    ims.mChangedStart = -1;
                    ims.mChangedEnd = -1;
    ...
    private boolean extractTextInternal(ExtractedTextRequest request, int partialStartOffset, int partialEndOffset, int delta, ExtractedText outText) {
        ...
        if (request == null || outText == null || (content = this.mTextView.mo3084getText()) == null) {
            return false;
        }
    ...
    public void sendUpdateSelection() {
        ...
        if (inputMethodState != null && inputMethodState.mBatchEditNesting <= 0 && !this.mHasPendingRestartInputForSetText && (imm = getInputMethodManager()) != null) {
            int selectionStart = this.mTextView.getSelectionStart();
            int selectionEnd = this.mTextView.getSelectionEnd();
            if (!(this.mTextView.mo3084getText() instanceof Spannable)) {
                candStart = -1;
                candEnd = -1;
            } else {
                Spannable sp = (Spannable) this.mTextView.mo3084getText();
    ...
    public void startInsertionActionMode() {
        ...
        ActionMode startActionMode = this.mTextView.startActionMode(actionModeCallback, 1);
        this.mTextActionMode = startActionMode;
        if (startActionMode != null && getInsertionController() != null) {
            getInsertionController().show();
        }
    }
    ...
    public boolean extractedTextModeWillBeStarted() {
        InputMethodManager imm;
        return !this.mTextView.isInExtractedMode() && (imm = getInputMethodManager()) != null && imm.isFullscreenMode();
    }
    ...
    public boolean shouldOfferToShowSuggestions() {
        ...
        int minSpanStart = this.mTextView.mo3084getText().length();
        int maxSpanEnd = 0;
        int unionOfSpansCoveringSelectionStartStart = this.mTextView.mo3084getText().length();
    ...
    public boolean isCursorInsideEasyCorrectionSpan() {
        Spannable spannable = (Spannable) this.mTextView.mo3084getText();
    ...
    public int clampHorizontalPosition(Drawable drawable, float horizontal) {
        ...
        if (horizontalDiff >= viewClippedWidth - 1.0f) {
            ...
            return left;
        } else if (Math.abs(horizontalDiff) <= 1.0f || (TextUtils.isEmpty(this.mTextView.mo3084getText()) && 1048576 - scrollX <= viewClippedWidth + 1.0f && horizontal2 <= 1.0f)) {
    ...
    public void onDrop(DragEvent event) {
        ...
        this.mUndoInputFilter.freezeLastEdit();
        try {
            int originalLength = this.mTextView.mo3084getText().length();
            Selection.setSelection((Spannable) this.mTextView.mo3084getText(), offset);
    ...
    private void deleteSourceAfterLocalDrop(DragLocalState dragLocalState, int dropOffset, int lengthBeforeDrop) {
        ...
        if (dropOffset <= dragSourceStart) {
            int shift = this.mTextView.mo3084getText().length() - lengthBeforeDrop;
            dragSourceStart += shift;
            dragSourceEnd += shift;
        }
        this.mTextView.deleteText_internal(dragSourceStart, dragSourceEnd);
        int prevCharIdx = Math.max(0, dragSourceStart - 1);
        int nextCharIdx = Math.min(this.mTextView.mo3084getText().length(), dragSourceStart + 1);
    ...
    public SuggestionSpan findEquivalentSuggestionSpan(SuggestionSpanInfo suggestionSpanInfo) {
        Editable editable = (Editable) this.mTextView.mo3084getText();
            ...
            if (isNonIntermediateSelectionSpan(text, span)) {
                ...
                this.mPopupWindow.setOnDeleteListener(new EasyEditDeleteListener() { // from class: android.widget.Editor.SpanController.2
                    ...
                    public void onDeleteClick(EasyEditSpan span2) {
                        Editable editable = (Editable) Editor.this.mTextView.mo3084getText();
    ...
    public class EasyEditPopupWindow extends PinnedPopupWindow implements View.OnClickListener {
        private static final int POPUP_TEXT_LAYOUT = 17367334;
        ...
        protected void initContentView() {
            ...
            TextView textView = (TextView) inflater.inflate(17367334, (ViewGroup) null);
    ...
    public abstract class PinnedPopupWindow implements TextViewPositionListener {
        ...
        private void computeLocalPosition() {
            ...
            int primaryHorizontal = (int) (Editor.this.mTextView.getLayout().getPrimaryHorizontal(offset) - (width / 2.0f));
    ...
    public class SuggestionHelper {
        ...
        private SuggestionSpan[] getSortedSuggestionSpans() {
            ...
            Spannable spannable = (Spannable) Editor.this.mTextView.mo3084getText();
        ...
        public int getSuggestionInfo(SuggestionInfo[] suggestionInfos, SuggestionSpanInfo misspelledSpanInfo) {
            ...
            Spannable spannable2 = (Spannable) Editor.this.mTextView.mo3084getText();
                ...
                while (suggestionIndex < nbSuggestions) {
                    ...
                    while (true) {
                        if (i2 < numberOfSuggestions) {
                            ...
                            suggestionInfo.mText.mo2736replace(0, suggestionInfo.mText.length(), (CharSequence) suggestion);
                            numberOfSuggestions++;
    ...
    public final class SuggestionsPopupWindow extends PinnedPopupWindow implements AdapterView.OnItemClickListener {
        ...
        private class CustomPopupWindow extends PopupWindow {
            ...
            public void dismiss() {
                ...
                ((Spannable) Editor.this.mTextView.mo3084getText()).removeSpan(Editor.this.mSuggestionRangeSpan);
        ...
        public class SuggestionAdapter extends BaseAdapter {
            ...
            public Object mo3505getItem(int position) {
        ...
        @Override // android.widget.Editor.PinnedPopupWindow
        public void show() {
            if (!(Editor.this.mTextView.mo3084getText() instanceof Editable) || Editor.this.extractedTextModeWillBeStarted()) {
                return;
            }
            int i = 0;
        ...
        private boolean updateSuggestions() {
            ...
            if (suggestionInfo != 0 || this.mMisspelledSpanInfo.mSuggestionSpan != null) {
                int spanUnionStart = Editor.this.mTextView.mo3084getText().length();
                int spanUnionEnd = 0;
                for (int i = 0; i < this.mNumberOfSuggestions; i++) {
        ...
        private void highlightTextDifferences(SuggestionInfo suggestionInfo, int unionStart, int unionEnd) {
            Spannable text = (Spannable) Editor.this.mTextView.mo3084getText();
            ...
            suggestionInfo.mText.mo2734insert(0, (CharSequence) textAsString.substring(unionStart, spanStart));
            suggestionInfo.mText.mo2731append((CharSequence) textAsString.substring(spanEnd, unionEnd));
        }
    ...
    public class TextActionModeCallback extends ActionMode.Callback2 {
        ...
        public boolean onCreateActionMode(ActionMode mode, Menu menu) {
            ...
            Selection.setSelection((Spannable) Editor.this.mTextView.mo3084getText(), Editor.this.mTextView.getSelectionEnd());
            return false;
        }
        ...
        private int createAssistMenuItemPendingIntentRequestCode() {
            if (Editor.this.mTextView.hasSelection()) {
                return Editor.this.mTextView.mo3084getText().subSequence(Editor.this.mTextView.getSelectionStart(), Editor.this.mTextView.getSelectionEnd()).hashCode();
            }
            return 0;
        }
    ...
    public final class CursorAnchorInfoNotifier implements TextViewPositionListener {
        ...
        public void updatePosition(int parentPositionX, int parentPositionY, boolean parentPositionChanged, boolean parentScrolled) {
            ...
            CharSequence text = Editor.this.mTextView.mo3084getText();
            if (text instanceof Spannable) {
    ...
    public static class MagnifierMotionAnimator {
        ...
        private MagnifierMotionAnimator(Magnifier magnifier) {
            ...
            ofFloat.mo1103setDuration(DURATION);
    ...
    public abstract class HandleView extends View implements TextViewPositionListener {
        ...
        private boolean tooLargeTextForMagnifier() {
            if (Editor.this.mNewMagnifierEnabled) {
                ...
                return layout.getLineBottomWithoutSpacing(line) - layout.getLineTop(line) >= Editor.this.mMaxLineHeightForMagnifier;
            }
        ...
        /* JADX WARN: Removed duplicated region for block: B:56:0x01f7 A[ADDED_TO_REGION, ORIG_RETURN, RETURN] */
        /*
        ...
        */
        private boolean obtainMagnifierShowCoordinates(MotionEvent event, PointF showPosInView) {
            ...
            if (sameLineSelection) {
                if ((offset < otherHandleOffset) != (getHorizontal(Editor.this.mTextView.getLayout(), offset) < getHorizontal(Editor.this.mTextView.getLayout(), otherHandleOffset))) {
                    ...
                    if (Editor.this.mNewMagnifierEnabled) {
                        ...
                        if (sameLineSelection) {
                            if ((trigger == 2) ^ rtl) {
                                ...
                                contentWidth = Math.round(Editor.this.mMagnifierAnimator.mMagnifier.getWidth() / Editor.this.mMagnifierAnimator.mMagnifier.getZoom());
                                return touchXInView >= leftBound2 - (contentWidth / 2.0f) ? false : false;
                            }
                        }
                    ...
                    showPosInView.x = Math.max(contentWidth2, Math.min(rightBound2, scaledTouchXInView));
                    showPosInView.y = ((((Editor.this.mTextView.getLayout().getLineTop(lineNumber) + Editor.this.mTextView.getLayout().getLineBottomWithoutSpacing(lineNumber)) / 2.0f) + Editor.this.mTextView.getTotalPaddingTop()) - Editor.this.mTextView.getScrollY()) * this.mTextViewScaleY;
                    return true;
                }
            }
            rtl = false;
        ...
        private void updateHandlesVisibility() {
            ...
            setVisible(!handleOverlapsMagnifier(this, magnifierRect) && !Editor.this.mDrawCursorOnMagnifier);
        ...
        protected final void updateMagnifier(MotionEvent event) {
            ...
            if (shouldShow) {
                ...
                if (Editor.this.mNewMagnifierEnabled) {
                    ...
                    Editor editor = Editor.this;
                    if (showPosInView.x < lineLeft2 - 20 || showPosInView.x > lineRight2 + 20) {
                        z = true;
                    }
                    editor.mDrawCursorOnMagnifier = z;
                    ...
                    editor2.mCursorVisible = true ^ editor2.mDrawCursorOnMagnifier;
                    if (Editor.this.mCursorVisible && !cursorVisible) {
                        Editor.this.updateCursorPosition();
                    }
                    int lineHeight = layout.getLineBottomWithoutSpacing(line) - layout.getLineTop(line);
    ...
    public class InsertionHandleView extends HandleView {
        ...
        private MotionEvent transformEventForTouchThrough(MotionEvent ev) {
            Layout layout = Editor.this.mTextView.getLayout();
            int line = layout.getLineForOffset(getCurrentCursorOffset());
            int textHeight = layout.getLineBottomWithoutSpacing(line) - layout.getLineTop(line);
            Matrix m = new Matrix();
        ...
        public void updateSelection(int offset) {
            Selection.setSelection((Spannable) Editor.this.mTextView.mo3084getText(), offset);
        }
    ...
    public final class SelectionHandleView extends HandleView {
        ...
        protected void updateSelection(int offset) {
            if (isStartHandle()) {
                Selection.setSelection((Spannable) Editor.this.mTextView.mo3084getText(), offset, Editor.this.mTextView.getSelectionEnd());
            } else {
                Selection.setSelection((Spannable) Editor.this.mTextView.mo3084getText(), Editor.this.mTextView.getSelectionStart(), offset);
            }
            updateDrawable(false);
            if (Editor.this.mTextActionMode != null) {
                Editor.this.invalidateActionMode();
        ...
        */
        ...
        private boolean positionNearEdgeOfScrollingView(float x, boolean atRtl) {
            ...
            if (atRtl == isStartHandle()) {
                ...
                if (x <= rightEdge - this.mTextViewEdgeSlop) {
                    z = false;
                }
                boolean nearEdge = z;
                return nearEdge;
            ...
            if (x >= leftEdge + this.mTextViewEdgeSlop) {
                z = false;
            }
            boolean nearEdge2 = z;
            return nearEdge2;
    ...
    public class SelectionModifierCursorController implements CursorController {
        ...
        private void updateSelectionInternal(int selectionStart, int selectionEnd, boolean fromTouchScreen) {
            ...
            Selection.setSelection((Spannable) Editor.this.mTextView.mo3084getText(), selectionStart, selectionEnd);
        ...
        private void resetDragAcceleratorState() {
            ...
            if (selectionStart < 0 || selectionEnd < 0) {
                Selection.removeSelection((Spannable) Editor.this.mTextView.mo3084getText());
            } else if (selectionStart > selectionEnd) {
                Selection.setSelection((Spannable) Editor.this.mTextView.mo3084getText(), selectionEnd, selectionStart);
            }
        }
    ...
    public class CorrectionHighlighter {
        ...
        private boolean updatePath() {
            ...
            int length = Editor.this.mTextView.mo3084getText().length();
    ...
    public static class UndoInputFilter implements InputFilter {
        ...
        private boolean isInTextWatcher() {
            CharSequence text = this.mEditor.mTextView.mo3084getText();
    ...
    public static class EditOperation extends UndoOperation<Editor> {
        public static final Parcelable.ClassLoaderCreator<EditOperation> CREATOR = new Parcelable.ClassLoaderCreator<EditOperation>() { // from class: android.widget.Editor.EditOperation.1
            ...
            public EditOperation mo3559createFromParcel(Parcel in) {
            ...
            /* renamed from: createFromParcel */
            public EditOperation mo3532createFromParcel(Parcel in, ClassLoader loader) {
                return new EditOperation(in, loader);
            }

            @Override // android.os.Parcelable.Creator
            /* renamed from: newArray */
            public EditOperation[] mo3560newArray(int size) {
        ...
        public void undo() {
            ...
            Editable text = (Editable) editor.mTextView.mo3084getText();
        ...
        public void forceMergeWith(EditOperation edit) {
            ...
            Editor editor = getOwnerData();
            Editable editable = (Editable) editor.mTextView.mo3084getText();
        ...
        private static void modifyText(Editable text, int deleteFrom, int deleteTo, CharSequence newText, int newTextInsertAt, int newCursorPos) {
            if (Editor.isValidRange(text, deleteFrom, deleteTo) && newTextInsertAt <= text.length() - (deleteTo - deleteFrom)) {
                if (deleteFrom != deleteTo) {
                    text.mo2733delete(deleteFrom, deleteTo);
                }
                if (newText.length() != 0) {
                    text.mo2734insert(newTextInsertAt, newText);
                }
            }
    ...
    public static final class ProcessTextIntentActionsHandler {
        ...
        private ProcessTextIntentActionsHandler(Editor editor) {
            ...
            TextView textView = editor2.mTextView;
