...
public class FastScroller {
    ...
    private void transitionToHidden() {
        ...
        Animator fadeOut = groupAnimatorOfFloat(View.ALPHA, 0.0f, this.mThumbImage, this.mTrackImage, this.mPreviewImage, this.mPrimaryText, this.mSecondaryText).mo1103setDuration(300L);
        float offset = this.mLayoutFromRight ? this.mThumbImage.getWidth() : -this.mThumbImage.getWidth();
        Animator slideOut = groupAnimatorOfFloat(View.TRANSLATION_X, offset, this.mThumbImage, this.mTrackImage).mo1103setDuration(300L);
    ...
    private void transitionToVisible() {
        ...
        Animator fadeIn = groupAnimatorOfFloat(View.ALPHA, 1.0f, this.mThumbImage, this.mTrackImage).mo1103setDuration(150L);
        Animator fadeOut = groupAnimatorOfFloat(View.ALPHA, 0.0f, this.mPreviewImage, this.mPrimaryText, this.mSecondaryText).mo1103setDuration(300L);
        Animator slideIn = groupAnimatorOfFloat(View.TRANSLATION_X, 0.0f, this.mThumbImage, this.mTrackImage).mo1103setDuration(150L);
        AnimatorSet animatorSet2 = new AnimatorSet();
        this.mDecorAnimation = animatorSet2;
    ...
    private void transitionToDragging() {
        ...
        Animator fadeIn = groupAnimatorOfFloat(View.ALPHA, 1.0f, this.mThumbImage, this.mTrackImage, this.mPreviewImage).mo1103setDuration(150L);
        Animator slideIn = groupAnimatorOfFloat(View.TRANSLATION_X, 0.0f, this.mThumbImage, this.mTrackImage).mo1103setDuration(150L);
        AnimatorSet animatorSet2 = new AnimatorSet();
        this.mDecorAnimation = animatorSet2;
    ...
    private boolean transitionPreviewLayout(int sectionIndex) {
        ...
        Animator showTarget = animateAlpha(target, 1.0f).mo1103setDuration(50L);
        Animator hideShowing = animateAlpha(showing, 0.0f).mo1103setDuration(50L);
        ...
        resizePreview.mo1103setDuration(100L);
        AnimatorSet animatorSet2 = new AnimatorSet();
        ...
        if (targetWidth <= previewWidth) {
            ...
            Animator scaleAnim = animateScaleX(target, 1.0f).mo1103setDuration(100L);
            builder.with(scaleAnim);
        }
        int showingWidth = showing.getWidth();
        if (showingWidth > targetWidth) {
            float scale = targetWidth / showingWidth;
            Animator scaleAnim2 = animateScaleX(showing, scale).mo1103setDuration(100L);
