...
public class ImageView extends View {
    ...
    private void applyImageTint() {
        ...
        if (drawable != null) {
            if (this.mHasDrawableTint || this.mHasDrawableBlendMode) {
                ...
                this.mDrawable = mo3113mutate;
                if (this.mHasDrawableTint) {
                    mo3113mutate.setTintList(this.mDrawableTintList);
                }
    ...
    private Drawable getDrawableFromUri(Uri uri) {
        ...
        if (ContentResolver.SCHEME_ANDROID_RESOURCE.equals(scheme)) {
            ...
            try {
                ...
                return ImageDecoder.decodeDrawable(src, ImageView$$ExternalSyntheticLambda0.INSTANCE);
    ...
    private void applyXfermode() {
        ...
        if (drawable != null && this.mHasXfermode) {
            Drawable mo3113mutate = drawable.mo3113mutate();
            this.mDrawable = mo3113mutate;
            mo3113mutate.setXfermode(this.mXfermode);
        }
    }
    ...
    private void applyColorFilter() {
        ...
        if (drawable != null && this.mHasColorFilter) {
            Drawable mo3113mutate = drawable.mo3113mutate();
            this.mDrawable = mo3113mutate;
            mo3113mutate.setColorFilter(this.mColorFilter);
        }
    }
    ...
    private void applyAlpha() {
        ...
        if (drawable != null && this.mHasAlpha) {
            Drawable mo3113mutate = drawable.mo3113mutate();
            this.mDrawable = mo3113mutate;
            mo3113mutate.setAlpha((this.mAlpha * 256) >> 8);
        }
    }
    ...
    public boolean isDefaultFocusHighlightNeeded(Drawable background, Drawable foreground) {
        Drawable drawable = this.mDrawable;
        boolean lackFocusState = drawable == null || !drawable.isStateful() || !this.mDrawable.hasFocusStateSpecified();
