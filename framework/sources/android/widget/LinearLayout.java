...
public class LinearLayout extends ViewGroup {
    ...
    public void measureVertical(int widthMeasureSpec, int heightMeasureSpec) {
        ...
        while (true) {
            ...
            if (i6 < count6) {
                ...
                if (child2 == null) {
                    int largestChildHeight4 = largestChildHeight2;
                    int largestChildHeight5 = this.mTotalLength;
                    this.mTotalLength = largestChildHeight5 + measureNullChild(i6);
                    count4 = count6;
                    heightMode4 = heightMode6;
                    i5 = alternativeMaxWidth4;
                    largestChildHeight2 = largestChildHeight4;
                } else {
                    int largestChildHeight6 = largestChildHeight2;
                    int largestChildHeight7 = child2.getVisibility();
                    int weightedMaxWidth4 = weightedMaxWidth3;
                    if (largestChildHeight7 == 8) {
                        i6 += getChildrenSkipCount(child2, i6);
                        count4 = count6;
                        i5 = alternativeMaxWidth4;
                        largestChildHeight2 = largestChildHeight6;
                        ...
                        if (heightMode6 == 1073741824 && useExcessSpace) {
                            ...
                            count5 = 1073741824;
                            heightMode4 = heightMode6;
                            heightMode5 = alternativeMaxWidth4;
                        } else {
                            if (useExcessSpace) {
                                lp2.height = -2;
                            }
                            ...
                            count5 = 1073741824;
                            childState5 = measuredWidth;
                            measureChildBeforeLayout(child2, i7, widthMeasureSpec, 0, heightMeasureSpec, i8);
                            ...
                            if (!useLargestChild2) {
                                ...
                                largestChildHeight2 = Math.max(childHeight2, largestChildHeight6);
                            }
                        }
                        ...
                        if (largestChildHeight3 != 0) {
                            ...
                            if (lp.width == -1) {
                                ...
                                if (lp.weight <= 0.0f) {
                                    ...
                                    heightMode5 = Math.max(heightMode5, matchWidthLocally2 ? margin2 : measuredWidth2);
                                }
                        ...
                        while (i10 < count) {
                            ...
                            if (child3 == null) {
                                ...
                                if (child3.getVisibility() == 8) {
                                    ...
                                    this.mTotalLength = Math.max(totalLength3, totalLength3 + largestChildHeight2 + i11 + lp3.bottomMargin + getNextLocationOffset(child3));
                                }
                            }
                            i2 = i;
                            i10 = i2 + 1;
                            ...
                            if (child4 != null) {
                                ...
                                if (child4.getVisibility() == 8) {
                                    ...
                                    if (childExtra > 0.0f) {
                                        ...
                                        weightedMaxWidth = weightedMaxWidth5;
                                        int weightedMaxWidth6 = View.MeasureSpec.makeMeasureSpec(largestChildHeight2, 1073741824);
                ...
                while (i13 < count) {
                    ...
                    if (child5 != null) {
                        ...
                        if (child5.getVisibility() == 8) {
                            ...
                            int largestChildHeight8 = lp4.leftMargin;
                            int margin4 = largestChildHeight8 + lp4.rightMargin;
    ...
    */
    public void measureHorizontal(int widthMeasureSpec, int heightMeasureSpec) {
        ...
        while (i3 < count7) {
            ...
            if (child == null) {
                int weightedMaxHeight5 = childState5;
                int weightedMaxHeight6 = this.mTotalLength;
                this.mTotalLength = weightedMaxHeight6 + measureNullChild(i3);
                baselineAligned = baselineAligned2;
                count5 = count7;
                childState5 = weightedMaxHeight5;
                weightedMaxHeight2 = widthMode5;
            } else {
                int weightedMaxHeight7 = childState5;
                ...
                if (weightedMaxHeight8 == 8) {
                    ...
                    baselineAligned = baselineAligned2;
                    childState5 = weightedMaxHeight7;
                    ...
                    if (widthMode5 != 1073741824 || !useExcessSpace) {
                        int childState6 = weightedMaxHeight4;
                        if (useExcessSpace) {
                            lp2.width = -2;
                        }
                        ...
                        count5 = count7;
                        count6 = -1;
                        measureChildBeforeLayout(child, i3, widthMeasureSpec, largestChildWidth8, heightMeasureSpec, 0);
                        ...
                        if (isExactly) {
                            ...
                            int childState7 = lp2.rightMargin;
                            this.mTotalLength = i4 + i5 + childState7;
                        } else {
                            childState3 = weightedMaxHeight4;
                            int totalLength2 = this.mTotalLength;
                    ...
                    int childState8 = combineMeasuredStates(childState2, child.getMeasuredState());
                    if (!baselineAligned) {
                        margin = margin2;
                    ...
                    int maxHeight4 = Math.max(widthMode4, childHeight);
                    ...
                    int weightedMaxHeight10 = getChildrenSkipCount(child, i3);
                    i3 += weightedMaxHeight10;
                    matchHeight = allFillParent2;
                    weightedMaxHeight4 = childState8;
                    childState5 = weightedMaxHeight3;
                    totalWeight2 = totalWeight3;
        ...
        if (maxAscent[1] == -1 && maxAscent[0] == -1 && maxAscent[2] == -1 && maxAscent[3] == -1) {
            ...
            int i8 = maxDescent[1];
            childState = childState9;
            int childState10 = maxDescent[2];
            int descent2 = Math.max(i6, Math.max(i7, Math.max(i8, childState10)));
                ...
                while (i9 < count) {
                    ...
                    if (child2 == null) {
                        ...
                        if (isExactly) {
                            ...
                            i = i9;
                            int i11 = lp3.leftMargin;
                            maxHeight3 = descent;
                            int maxHeight5 = lp3.rightMargin;
                            this.mTotalLength = i10 + i11 + largestChildWidth10 + maxHeight5 + getNextLocationOffset(child2);
                        } else {
                            i = i9;
                            maxHeight3 = descent;
                            int i12 = this.mTotalLength;
                            this.mTotalLength = Math.max(i12, i12 + largestChildWidth10 + lp3.leftMargin + lp3.rightMargin + getNextLocationOffset(child2));
                        }
                    }
                    i2 = i;
                    i9 = i2 + 1;
        ...
        if (largestChildWidth6 != 0) {
            ...
            int alternativeMaxHeight8 = Math.max(alternativeMaxHeight7, count9);
            ...
            if (!matchHeight && heightMode != 1073741824) {
                maxHeight2 = alternativeMaxHeight7;
            }
            setMeasuredDimension(widthSizeAndState | ((-16777216) & count3), resolveSizeAndState(Math.max(maxHeight2 + this.mPaddingTop + this.mPaddingBottom, getSuggestedMinimumHeight()), widthMode2, count3 << 16));
            if (!skippedMeasure) {
        ...
        while (i14 < count) {
            ...
            if (child4 != null) {
                count4 = count;
                int count10 = child4.getVisibility();
                if (count10 == 8) {
                    ...
                    if (childWeight <= 0.0f) {
                        ...
                        widthSizeAndState2 = widthSizeAndState3;
                        int share = (int) ((remainingExcess6 * childWeight) / remainingWeightSum);
                        ...
                        widthMode3 = widthMode;
                        int childHeightMeasureSpec = getChildMeasureSpec(heightMeasureSpec, i15 + childWidth5 + lp4.topMargin + lp4.bottomMargin, lp4.height);
                        child4.measure(childWidthMeasureSpec, childHeightMeasureSpec);
                        childState11 = combineMeasuredStates(childState11, child4.getMeasuredState() & (-16777216));
        ...
        widthSizeAndState = widthSizeAndState3;
        widthMode2 = heightMeasureSpec;
        int count11 = this.mTotalLength;
        this.mTotalLength = count11 + this.mPaddingLeft + this.mPaddingRight;
        if (maxAscent[1] == -1 && maxAscent[0] == -1 && maxAscent[2] == -1 && maxAscent[3] == -1) {
            ...
            maxHeight2 = Math.max(maxHeight6, ascent2 + descent3);
        }
        count3 = childState11;
        if (!matchHeight) {
            maxHeight2 = alternativeMaxHeight7;
    ...
    */
    public void layoutHorizontal(int left, int top, int right, int bottom) {
        ...
        int childBottom2 = height2 - this.mPaddingBottom;
    ...
    public LayoutParams mo3517generateLayoutParams(AttributeSet attrs) {
    ...
    public LayoutParams mo3516generateDefaultLayoutParams() {
    ...
    @Override // android.view.ViewGroup
    /* renamed from: generateLayoutParams  reason: collision with other method in class */
    public LayoutParams mo3518generateLayoutParams(ViewGroup.LayoutParams lp) {
