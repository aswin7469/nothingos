...
public class NumberPicker extends LinearLayout {
    private static final int DEFAULT_LAYOUT_RESOURCE_ID = 17367236;
    ...
    public NumberPicker(Context context, AttributeSet attrs, int defStyleAttr, int defStyleRes) {
        ...
        int layoutResId = attributesArray.getResourceId(3, 17367236);
        if (layoutResId != 17367236) {
            z = true;
        } else {
            z = false;
        }
    ...
    public void validateInputTextView(View v) {
        String str = String.valueOf(((TextView) v).mo3084getText());
    ...
    private boolean updateInputTextView() {
        ...
        if (!TextUtils.isEmpty(text)) {
            CharSequence beforeText = this.mInputText.mo3084getText();
        ...
        private void findAccessibilityNodeInfosByTextInChild(String searchedLowerCase, int virtualViewId, List<AccessibilityNodeInfo> outResult) {
            switch (virtualViewId) {
                case 1:
                    ...
                    return;
                case 2:
                    CharSequence text2 = NumberPicker.this.mInputText.mo3084getText();
                    if (TextUtils.isEmpty(text2) || !text2.toString().toLowerCase().contains(searchedLowerCase)) {
                        CharSequence contentDesc = NumberPicker.this.mInputText.mo3084getText();
