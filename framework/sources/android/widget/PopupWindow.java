...
public class PopupWindow {
    ...
    public PopupWindow(Context context, AttributeSet attrs, int defStyleAttr, int defStyleRes) {
        ...
        if (a.hasValueOrEmpty(5)) {
            ...
            exitTransition = enterTransition == null ? null : enterTransition.m2748clone();
        }
        a.recycle();
    ...
    public boolean findDropDownPosition(View anchor, WindowManager.LayoutParams outParams, int xOffset, int yOffset, int width, int height, int gravity, boolean allowScroll) {
        ...
        if (!fitsVertical || !fitsHorizontal) {
            ...
            tryFitVertical(outParams, yOffset2, height3, anchorHeight, drawingLocation[c4], screenLocation[c], displayFrame.top, displayFrame.bottom, this.mClipToScreen);
        ...
        if (layoutParams2.y < drawingLocation[c2 == 1 ? 1 : 0]) {
            boolean z = c2 == 1 ? 1 : 0;
            boolean z2 = c2 == 1 ? 1 : 0;
            boolean z3 = c2 == 1 ? 1 : 0;
            boolean z4 = c2 == 1 ? 1 : 0;
    ...
    public class PopupDecorView extends FrameLayout {
        ...
        public void requestEnterTransition(Transition transition) {
            ...
            if (observer != null && transition != null) {
                final Transition enterTransition = transition.m2748clone();
        ...
        public void startEnterTransition(Transition enterTransition) {
            ...
            for (int i = 0; i < count; i++) {
                ...
                enterTransition.mo2751addTarget(child);
        ...
        public void startExitTransition(final Transition transition, final View anchorRoot, final Rect epicenter, final Transition.TransitionListener listener) {
            ...
            Transition exitTransition = transition.m2748clone();
            exitTransition.mo2749addListener(new TransitionListenerAdapter() { // from class: android.widget.PopupWindow.PopupDecorView.2
                @Override // android.transition.TransitionListenerAdapter, android.transition.Transition.TransitionListener
                public void onTransitionEnd(Transition t) {
                    t.mo2755removeListener(this);
            ...
            for (int i = 0; i < count; i++) {
                View child = getChildAt(i);
                exitTransition.mo2751addTarget(child);
            }
