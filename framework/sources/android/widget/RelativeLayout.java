...
public class RelativeLayout extends ViewGroup {
        ...
        while (heightSize2 < count3) {
            ...
            if (child2.getVisibility() == 8) {
                ...
                if (!isWrapContentWidth) {
                    ...
                    myHeight = myHeight2;
                    width3 = targetSdkVersion < 19 ? Math.max(width3, params2.mRight) : Math.max(width3, params2.mRight + params2.rightMargin);
                }
                if (isWrapContentHeight2) {
                    height3 = targetSdkVersion < 19 ? Math.max(height3, params2.mBottom) : Math.max(height3, params2.mBottom + params2.bottomMargin);
                }
    ...
    protected ViewGroup.LayoutParams mo3518generateLayoutParams(ViewGroup.LayoutParams lp) {
    ...
    public static class LayoutParams extends ViewGroup.MarginLayoutParams {
        ...
        private void resolveRules(int layoutDirection) {
            ...
            if (this.mIsRtlCompatibilityMode) {
                ...
                if (iArr2[18] != 0) {
                    iArr2[isLayoutRtl ? (char) 7 : (char) 5] = iArr2[18];
                    iArr2[18] = 0;
                }
                if (iArr2[19] != 0) {
                    if (isLayoutRtl) {
                ...
                if (iArr2[16] != 0) {
                    iArr2[isLayoutRtl ? (char) 1 : (char) 0] = iArr2[16];
                    iArr2[16] = 0;
                }
                if (iArr2[17] != 0) {
                    if (isLayoutRtl) {
                ...
                if (iArr2[20] != 0) {
                    iArr2[isLayoutRtl ? (char) 11 : '\t'] = iArr2[20];
                    iArr2[20] = 0;
                }
                if (iArr2[21] != 0) {
                    if (isLayoutRtl) {
