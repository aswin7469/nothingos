...
public class RemoteViews implements Parcelable, LayoutInflater.Filter {
    ...
    private int mViewId;
    private static final LayoutInflater.Filter INFLATER_FILTER = RemoteViews$$ExternalSyntheticLambda0.INSTANCE;
    private static final InteractionHandler DEFAULT_INTERACTION_HANDLER = RemoteViews$$ExternalSyntheticLambda1.INSTANCE;
    ...
    public static final Parcelable.Creator<RemoteViews> CREATOR = new Parcelable.Creator<RemoteViews>() { // from class: android.widget.RemoteViews.2
        ...
        public RemoteViews mo3559createFromParcel(Parcel parcel) {
        ...
        public RemoteViews[] mo3560newArray(int size) {
    ...
    static /* synthetic */ Action access$1000() {
        return ACTION_NOOP;
    }

    static /* synthetic */ MethodHandle access$700(RemoteViews x0, View x1, String x2, Class x3, boolean x4) {
        return x0.getMethod(x1, x2, x3, x4);
    }

    static /* synthetic */ Class access$900(int x0) {
        return getParameterType(x0);
    }
    ...
    public static abstract class Action implements Parcelable {
        ...
        public abstract void apply(View view, ViewGroup viewGroup, InteractionHandler interactionHandler, ColorResources colorResources) throws ActionException;
    ...
    public class SetPendingIntentTemplate extends Action {
        ...
        @Override // android.widget.RemoteViews.Action
        public void apply(View root, ViewGroup rootParent, final InteractionHandler handler, ColorResources colorResources) {
            ...
            if (target instanceof AdapterView) {
                ...
                AdapterView.OnItemClickListener listener = new AdapterView.OnItemClickListener() { // from class: android.widget.RemoteViews$SetPendingIntentTemplate$$ExternalSyntheticLambda0
                    ...
                    public final void onItemClick(AdapterView adapterView, View view, int i, long j) {
                        RemoteViews.SetPendingIntentTemplate.this.lambda$apply$0$RemoteViews$SetPendingIntentTemplate(handler, adapterView, view, i, j);
                    }
                };
        ...
        public /* synthetic */ void lambda$apply$0$RemoteViews$SetPendingIntentTemplate(InteractionHandler handler, AdapterView parent, View view, int position, long id) {
        ...
        public void apply(View root, ViewGroup rootParent, InteractionHandler handler, ColorResources colorResources) {
            ...
            if (!(rootParent instanceof AppWidgetHostView)) {
                ...
                if ((a instanceof RemoteViewsListAdapter) && this.viewTypeCount <= a.getViewTypeCount()) {
                    ...
                    v.setAdapter((ListAdapter) new RemoteViewsListAdapter(v.getContext(), this.list, this.viewTypeCount, colorResources));
                }
                ...
                if ((a2 instanceof RemoteViewsListAdapter) && this.viewTypeCount <= a2.getViewTypeCount()) {
                    ...
                    v2.setAdapter(new RemoteViewsListAdapter(v2.getContext(), this.list, this.viewTypeCount, colorResources));
                }
            }
        }
    ...
    /* JADX INFO: Access modifiers changed from: private */
    /* loaded from: classes3.dex */
    public static class SetRemoteCollectionItemListAdapterAction extends Action {
        ...
        SetRemoteCollectionItemListAdapterAction(Parcel parcel) {
            super();
            this.viewId = parcel.readInt();
            this.mItems = (RemoteCollectionItems) parcel.readTypedObject(RemoteCollectionItems.CREATOR);
        }

        @Override // android.os.Parcelable
        public void writeToParcel(Parcel dest, int flags) {
            dest.writeInt(this.viewId);
            dest.writeTypedObject(this.mItems, flags);
        }
    ...
    public class SetOnClickResponse extends Action {
        ...
        public /* synthetic */ void lambda$apply$0$RemoteViews$SetOnClickResponse(InteractionHandler handler, View v) {
            this.mResponse.handleViewInteraction(v, handler);
        }
    ...
    public class SetOnCheckedChangeResponse extends Action {
        ...
        public void apply(View root, ViewGroup rootParent, final InteractionHandler handler, ColorResources colorResources) {
            ...
            CompoundButton.OnCheckedChangeListener onCheckedChangeListener = new CompoundButton.OnCheckedChangeListener() { // from class: android.widget.RemoteViews$SetOnCheckedChangeResponse$$ExternalSyntheticLambda0
                ...
                public final void onCheckedChanged(CompoundButton compoundButton, boolean z) {
                    RemoteViews.SetOnCheckedChangeResponse.this.lambda$apply$0$RemoteViews$SetOnCheckedChangeResponse(handler, compoundButton, z);
                }
            };
        ...
        public /* synthetic */ void lambda$apply$0$RemoteViews$SetOnCheckedChangeResponse(InteractionHandler handler, CompoundButton v, boolean isChecked) {
            this.mResponse.handleViewInteraction(v, handler);
        }
    ...
    public class SetDrawableTint extends Action {
        ...
        public void apply(View root, ViewGroup rootParent, InteractionHandler handler, ColorResources colorResources) {
            ...
            if (targetDrawable != null) {
                targetDrawable.mo3113mutate().setColorFilter(this.colorFilter, this.filterMode);
            }
        }
    ...
    public class SetRippleDrawableColor extends Action {
        ...
        public void apply(View root, ViewGroup rootParent, InteractionHandler handler, ColorResources colorResources) {
            ...
            if (targetDrawable instanceof RippleDrawable) {
                ((RippleDrawable) targetDrawable.mo3113mutate()).setColor(this.mColorStateList);
            }
        }
    ...
    public final class ViewContentNavigation extends Action {
        ...
        /*  JADX ERROR: Failed to decode insn: 0x001C: INVOKE_POLYMORPHIC r1, r0, method: android.widget.RemoteViews.ViewContentNavigation.apply(android.view.View, android.view.ViewGroup, android.widget.RemoteViews$InteractionHandler, android.widget.RemoteViews$ColorResources):void
            jadx.core.utils.exceptions.DecodeException: Unknown instruction: '0x001C: INVOKE_POLYMORPHIC r1, r0'
            	...
            	at jadx.core.dex.nodes.ClassNode.load(ClassNode.java:416)
            ...
            */
        @Override // android.widget.RemoteViews.Action
        public void apply(android.view.View r6, android.view.ViewGroup r7, android.widget.RemoteViews.InteractionHandler r8, android.widget.RemoteViews.ColorResources r9) {
            /*
                r5 = this;
                int r0 = r5.viewId
                r6.findViewById(r0)
                ...
                if (r0 != 0) goto L9
                return
                android.widget.RemoteViews r1 = android.widget.RemoteViews.this
                boolean r2 = r5.mNext
                if (r2 == 0) goto L13
                java.lang.String r2 = "showNext"
                goto L16
                java.lang.String r2 = "showPrevious"
                r3 = 0
                r4 = 0
                android.widget.RemoteViews.access$700(r1, r0, r2, r3, r4)
                r1 = move-result
                // decode failed: Unknown instruction: '0x001C: INVOKE_POLYMORPHIC r1, r0'
                return
                r1 = move-exception
                android.widget.RemoteViews$ActionException r2 = new android.widget.RemoteViews$ActionException
                r2.<init>(r1)
                throw r2
            */
            throw new UnsupportedOperationException("Method not decompiled: android.widget.RemoteViews.ViewContentNavigation.apply(android.view.View, android.view.ViewGroup, android.widget.RemoteViews$InteractionHandler, android.widget.RemoteViews$ColorResources):void");
        }
    ...
    private abstract class BaseReflectionAction extends Action {
        ...
        /*  JADX ERROR: Failed to decode insn: 0x001E: INVOKE_POLYMORPHIC r3, r0, r2, method: android.widget.RemoteViews.BaseReflectionAction.apply(android.view.View, android.view.ViewGroup, android.widget.RemoteViews$InteractionHandler, android.widget.RemoteViews$ColorResources):void
            jadx.core.utils.exceptions.DecodeException: Unknown instruction: '0x001E: INVOKE_POLYMORPHIC r3, r0, r2'
            	at jadx.core.dex.instructions.InsnDecoder.decode(InsnDecoder.java:494)
            	at jadx.core.dex.instructions.InsnDecoder.lambda$process$0(InsnDecoder.java:50)
            	at jadx.plugins.input.dex.sections.DexCodeReader.visitInstructions(DexCodeReader.java:85)
            	at jadx.core.dex.instructions.InsnDecoder.process(InsnDecoder.java:45)
            ...
            */
        @Override // android.widget.RemoteViews.Action
        public final void apply(android.view.View r7, android.view.ViewGroup r8, android.widget.RemoteViews.InteractionHandler r9, android.widget.RemoteViews.ColorResources r10) {
            /*
                r6 = this;
                int r0 = r6.viewId
                r7.findViewById(r0)
                ...
                return
                int r1 = r6.type
                android.widget.RemoteViews.access$900(r1)
                r1 = move-result
                if (r1 == 0) goto L2b
                r6.getParameterValue(r0)
                r2 = move-result
                android.widget.RemoteViews r3 = android.widget.RemoteViews.this
                java.lang.String r4 = r6.methodName
                r5 = 0
                android.widget.RemoteViews.access$700(r3, r0, r4, r1, r5)
                r3 = move-result
                // decode failed: Unknown instruction: '0x001E: INVOKE_POLYMORPHIC r3, r0, r2'
                return
                r3 = move-exception
                android.widget.RemoteViews$ActionException r4 = new android.widget.RemoteViews$ActionException
                r4.<init>(r3)
                throw r4
                android.widget.RemoteViews$ActionException r2 = new android.widget.RemoteViews$ActionException
                java.lang.StringBuilder r3 = new java.lang.StringBuilder
                r3.<init>()
                java.lang.String r4 = "bad type: "
                r3.append(r4)
                int r4 = r6.type
                r3.append(r4)
                r3.toString()
                ...
                throw r2
            */
            throw new UnsupportedOperationException("Method not decompiled: android.widget.RemoteViews.BaseReflectionAction.apply(android.view.View, android.view.ViewGroup, android.widget.RemoteViews$InteractionHandler, android.widget.RemoteViews$ColorResources):void");
        }

        protected abstract Object getParameterValue(View view) throws ActionException;

        /*  JADX ERROR: Failed to decode insn: 0x0024: INVOKE_POLYMORPHIC r3, r0, r2, method: android.widget.RemoteViews.BaseReflectionAction.initActionAsync(android.widget.RemoteViews$ViewTree, android.view.ViewGroup, android.widget.RemoteViews$InteractionHandler, android.widget.RemoteViews$ColorResources):android.widget.RemoteViews$Action
            jadx.core.utils.exceptions.DecodeException: Unknown instruction: '0x0024: INVOKE_POLYMORPHIC r3, r0, r2'
            	at jadx.core.dex.instructions.InsnDecoder.decode(InsnDecoder.java:494)
            	at jadx.core.dex.instructions.InsnDecoder.lambda$process$0(InsnDecoder.java:50)
            	at jadx.plugins.input.dex.sections.DexCodeReader.visitInstructions(DexCodeReader.java:85)
            	at jadx.core.dex.instructions.InsnDecoder.process(InsnDecoder.java:45)
            ...
            */
        @Override // android.widget.RemoteViews.Action
        public final android.widget.RemoteViews.Action initActionAsync(android.widget.RemoteViews.ViewTree r8, android.view.ViewGroup r9, android.widget.RemoteViews.InteractionHandler r10, android.widget.RemoteViews.ColorResources r11) {
            /*
                r7 = this;
                int r0 = r7.viewId
                r8.findViewById(r0)
                r0 = move-result
                if (r0 != 0) goto Ld
                android.widget.RemoteViews.access$1000()
                r1 = move-result
                return r1
                int r1 = r7.type
                android.widget.RemoteViews.access$900(r1)
                r1 = move-result
                if (r1 == 0) goto L54
                r7.getParameterValue(r0)
                r2 = move-result
                android.widget.RemoteViews r3 = android.widget.RemoteViews.this
                java.lang.String r4 = r7.methodName
                r5 = 1
                android.widget.RemoteViews.access$700(r3, r0, r4, r1, r5)
                r3 = move-result
                if (r3 == 0) goto L4b
                // decode failed: Unknown instruction: '0x0024: INVOKE_POLYMORPHIC r3, r0, r2'
                r4 = move-result
                if (r4 != 0) goto L30
                android.widget.RemoteViews.access$1000()
                r5 = move-result
                return r5
                boolean r5 = r4 instanceof android.view.ViewStub.ViewReplaceRunnable
                if (r5 == 0) goto L45
                r8.createTree()
                int r5 = r7.viewId
                r8.findViewTreeById(r5)
                r5 = move-result
                r6 = r4
                android.view.ViewStub$ViewReplaceRunnable r6 = (android.view.ViewStub.ViewReplaceRunnable) r6
                android.view.View r6 = r6.view
                r5.replaceView(r6)
                android.widget.RemoteViews$RunnableAction r5 = new android.widget.RemoteViews$RunnableAction
                r5.<init>(r4)
                return r5
                return r7
                r3 = move-exception
                ...
                throw r2
            */
            throw new UnsupportedOperationException("Method not decompiled: android.widget.RemoteViews.BaseReflectionAction.initActionAsync(android.widget.RemoteViews$ViewTree, android.view.ViewGroup, android.widget.RemoteViews$InteractionHandler, android.widget.RemoteViews$ColorResources):android.widget.RemoteViews$Action");
        }
        ...
        ReflectionAction(Parcel in) {
            ...
            switch (this.type) {
                ...
                case 9:
                    ...
                    return;
                case 10:
                    this.value = TextUtils.CHAR_SEQUENCE_CREATOR.mo3559createFromParcel(in);
                    return;
                case 11:
                ...
                switch (this.mResourceType) {
                    case 1:
                        switch (this.type) {
                            ...
                            case 6:
                                int i3 = this.mResId;
                                return Float.valueOf(i3 == 0 ? 0.0f : resources.getDimension(i3));
                        }
                    case 2:
                        switch (this.type) {
                            case 4:
                                if (this.mResId != 0) {
                                    i = view.getContext().getColor(this.mResId);
                                }
                                return Integer.valueOf(i);
                            case 15:
                                if (this.mResId != 0) {
                                    obj = view.getContext().getColorStateList(this.mResId);
                                }
                                return obj;
                            default:
    ...
    public class ViewGroupActionAdd extends Action {
            ...
            if (target != null) {
                ...
                if (nextChild >= 0 && this.mStableId != -1 && (recycledViewIndex = findViewIndexToRecycle(target, rvToApply)) >= 0) {
                    ...
                    if (rvToApply.canRecycleView(child)) {
                        ...
                        rvToApply.reapply(context, child, handler, null, colorResources, false);
                        return;
                    }
                    target.removeViews(nextChild, (recycledViewIndex - nextChild) + 1);
                }
                View nestedView = rvToApply.apply(context, target, handler, null, colorResources);
        ...
        public Action initActionAsync(ViewTree root, ViewGroup rootParent, InteractionHandler handler, ColorResources colorResources) {
            ...
            Context context2 = root.mRoot.getContext();
            final int nextChild = RemoteViews.getNextRecyclableChild(targetVg);
            if (nextChild < 0 || this.mStableId == -1) {
                context = context2;
            } else {
                RemoteViews rvToApply = this.mNestedViews.getRemoteViewsToApply(context2);
                final int recycledViewIndex = target.findChildIndex(nextChild, new Predicate() { // from class: android.widget.RemoteViews$ViewGroupActionAdd$$ExternalSyntheticLambda2
                    @Override // java.util.function.Predicate
                    public final boolean test(Object obj) {
                        return RemoteViews.ViewGroupActionAdd.this.lambda$initActionAsync$0$RemoteViews$ViewGroupActionAdd((View) obj);
                    }
                });
                if (recycledViewIndex >= 0) {
                    ...
                    if (rvToApply.canRecycleView(recycled.mRoot)) {
                        ...
                        final AsyncApplyTask reapplyTask = rvToApply.getInternalAsyncApplyTask(context2, targetVg, null, handler, null, colorResources, recycled.mRoot);
                        ...
                        return new RuntimeAction() { // from class: android.widget.RemoteViews.ViewGroupActionAdd.1
                            ...
                            @Override // android.widget.RemoteViews.Action
                            public void apply(View root2, ViewGroup rootParent2, InteractionHandler handler2, ColorResources colorResources2) throws ActionException {
                    ...
                    return insertNewView(context2, target, handler, colorResources, new Runnable() { // from class: android.widget.RemoteViews$ViewGroupActionAdd$$ExternalSyntheticLambda0
            ...
            return insertNewView(context, target, handler, colorResources, RemoteViews$ViewGroupActionAdd$$ExternalSyntheticLambda1.INSTANCE);
        }

        public /* synthetic */ boolean lambda$initActionAsync$0$RemoteViews$ViewGroupActionAdd(View view) {
        ...
        private Action insertNewView(Context context, ViewTree target, InteractionHandler handler, ColorResources colorResources, final Runnable finalizeAction) {
            ...
            return new RuntimeAction() { // from class: android.widget.RemoteViews.ViewGroupActionAdd.2
                ...
                @Override // android.widget.RemoteViews.Action
                public void apply(View root, ViewGroup rootParent, InteractionHandler handler2, ColorResources colorResources2) throws ActionException {
    ...
    public class ViewGroupActionRemove extends Action {
        ...
        public Action initActionAsync(ViewTree root, ViewGroup rootParent, InteractionHandler handler, ColorResources colorResources) {
            ...
            final ViewGroup targetVg = (ViewGroup) target.mRoot;
            if (this.mViewIdToKeep == -2) {
                target.mChildren.removeIf(RemoteViews$ViewGroupActionRemove$$ExternalSyntheticLambda1.INSTANCE);
                ...
                target.mChildren.removeIf(new Predicate() { // from class: android.widget.RemoteViews$ViewGroupActionRemove$$ExternalSyntheticLambda0
                    @Override // java.util.function.Predicate
                    public final boolean test(Object obj) {
                        return RemoteViews.ViewGroupActionRemove.this.lambda$initActionAsync$1$RemoteViews$ViewGroupActionRemove((RemoteViews.ViewTree) obj);
                    }
                });
        ...
        public /* synthetic */ boolean lambda$initActionAsync$1$RemoteViews$ViewGroupActionRemove(ViewTree childTree) {
        ...
        public void apply(View root, ViewGroup rootParent, InteractionHandler handler, ColorResources colorResources) {
            ...
            while (!viewsToProcess.isEmpty()) {
                ...
                if (v instanceof TextView) {
                    ...
                    textView.setText(ContrastColorUtil.clearColorSpans(textView.mo3084getText()));
        ...
        public void apply(View root, ViewGroup rootParent, InteractionHandler handler, ColorResources colorResources) throws ActionException {
            ...
            try {
                ...
                switch (this.mValueType) {
                    ...
                    case 3:
                        if (this.mValue != 0) {
                            radius = target.getResources().getDimension(this.mValue);
                        }
                        break;
                    case 4:
                        TypedArray typedArray = target.getContext().obtainStyledAttributes(new int[]{this.mValue});
    ...
    public RemoteViews(Map<SizeF, RemoteViews> remoteViews) {
        ...
        if (remoteViews.size() <= 16) {
            ...
            this.mBitmapCache = new BitmapCache();
            this.mClassCookies = initializeSizedRemoteViews(remoteViews.entrySet().stream().map(RemoteViews$$ExternalSyntheticLambda2.INSTANCE).iterator());
    ...
    private void initializeFrom(RemoteViews src) {
        ...
        if (src.hasSizedRemoteViews()) {
            ...
            for (RemoteViews srcView : src.mSizedRemoteViews) {
                this.mSizedRemoteViews.add(new RemoteViews(srcView));
            }
        }
    ...
    private RemoteViews(Parcel parcel, BitmapCache bitmapCache, ApplicationInfo info, int depth, Map<Class, Object> classCookies) {
        ...
        if (mode == 0) {
            this.mApplication = parcel.readInt() == 0 ? info : ApplicationInfo.CREATOR.mo3559createFromParcel(parcel);
            this.mIdealSize = parcel.readInt() != 0 ? SizeF.CREATOR.mo3559createFromParcel(parcel) : sizeF;
            ...
            RemoteViews remoteViews = new RemoteViews(parcel, this.mBitmapCache, this.mLandscape.mApplication, depth2, this.mClassCookies);
            this.mPortrait = remoteViews;
            this.mApplication = remoteViews.mApplication;
            this.mLayoutId = remoteViews.mLayoutId;
            this.mViewId = remoteViews.mViewId;
            ...
            List<RemoteViews> remoteViews2 = new ArrayList<>(numViews);
            ApplicationInfo info2 = info;
            for (int i = 0; i < numViews; i++) {
                RemoteViews view = new RemoteViews(parcel, this.mBitmapCache, info2, depth2, this.mClassCookies);
                info2 = view.mApplication;
                remoteViews2.add(view);
            }
            initializeSizedRemoteViews(remoteViews2.iterator());
            RemoteViews smallestView = findSmallestRemoteView();
            this.mApplication = smallestView.mApplication;
            this.mLayoutId = smallestView.mLayoutId;
            this.mViewId = smallestView.mViewId;
    ...
    public CancellationSignal applyAsync(Context context, ViewGroup parent, Executor executor, OnViewAppliedListener listener, InteractionHandler handler, SizeF size, ColorResources colorResources) {
        return new AsyncApplyTask(getRemoteViewsToApply(context, size), parent, context, listener, handler, colorResources, null, true).startTaskOnExecutor(executor);
    }

    /* JADX INFO: Access modifiers changed from: private */
    public AsyncApplyTask getInternalAsyncApplyTask(Context context, ViewGroup parent, OnViewAppliedListener listener, InteractionHandler handler, SizeF size, ColorResources colorResources, View result) {
        return new AsyncApplyTask(getRemoteViewsToApply(context, size), parent, context, listener, handler, colorResources, result, false);
    }
    ...
    public class AsyncApplyTask extends AsyncTask<Void, Void, ViewTree> implements CancellationSignal.OnCancelListener {
            ...
            try {
                ...
                if (this.mRV.mActions != null) {
                    ...
                    for (int i = 0; i < count && !isCancelled(); i++) {
                        this.mActions[i] = ((Action) this.mRV.mActions.get(i)).initActionAsync(this.mTree, this.mParent, this.mHandler, this.mColorResources);
                    }
                } else {
                    this.mActions = null;
                }
        ...
        public void onPostExecute(ViewTree viewTree) {
            ...
            if (this.mError == null) {
                ...
                try {
                    if (this.mActions != null) {
                        InteractionHandler handler = this.mHandler;
                        if (handler == null) {
                            handler = RemoteViews.DEFAULT_INTERACTION_HANDLER;
                        }
    ...
    public void reapply(Context context, View v, InteractionHandler handler) {
        reapply(context, v, handler, null, null);
    }
    ...
    /* JADX INFO: Access modifiers changed from: private */
    public void reapply(Context context, View v, InteractionHandler handler, SizeF size, ColorResources colorResources, boolean topLevel) {
        RemoteViews rvToApply = getRemoteViewsToApply(context, size);
        if (hasMultipleLayouts() && !rvToApply.canRecycleView(v)) {
    ...
    public CancellationSignal reapplyAsync(Context context, View v, Executor executor, OnViewAppliedListener listener, InteractionHandler handler, SizeF size, ColorResources colorResources) {
        RemoteViews rvToApply = getRemoteViewsToApply(context, size);
        if (hasMultipleLayouts() && ((Integer) v.getTag(16908312)).intValue() != rvToApply.getLayoutId()) {
            throw new RuntimeException("Attempting to re-apply RemoteViews to a view that that does not share the same root layout id.");
        }
    ...
    private void performApply(View v, ViewGroup parent, InteractionHandler handler, ColorResources colorResources) {
        ArrayList<Action> arrayList = this.mActions;
        if (arrayList != null) {
            InteractionHandler handler2 = handler == null ? DEFAULT_INTERACTION_HANDLER : handler;
            int count = arrayList.size();
            for (int i = 0; i < count; i++) {
                Action a = this.mActions.get(i);
                a.apply(v, parent, handler2, colorResources);
            }
        }
    }
    ...
    public void updateAppInfo(ApplicationInfo info) {
        ApplicationInfo applicationInfo = this.mApplication;
        if (applicationInfo != null && applicationInfo.sourceDir.equals(info.sourceDir)) {
        ...
        if (hasLandscapeAndPortraitLayouts()) {
            this.mLandscape.updateAppInfo(info);
            this.mPortrait.updateAppInfo(info);
        }
    }
        ...
        public static ColorResources create(Context context, SparseIntArray colorMapping) {
            try {
                ...
                try {
                    ...
                    ColorResources colorResources = new ColorResources(colorsLoader);
                    if (pfd != null) {
                        pfd.close();
                    }
                    pipeWriter.close();
    ...
    public static final class RemoteCollectionItems implements Parcelable {
        public static final Parcelable.Creator<RemoteCollectionItems> CREATOR = new Parcelable.Creator<RemoteCollectionItems>() { // from class: android.widget.RemoteViews.RemoteCollectionItems.1
            ...
            @Override // android.os.Parcelable.Creator
            /* renamed from: createFromParcel */
            public RemoteCollectionItems mo3559createFromParcel(Parcel source) {
            ...
            @Override // android.os.Parcelable.Creator
            /* renamed from: newArray */
            public RemoteCollectionItems[] mo3560newArray(int size) {
        ...
        RemoteCollectionItems(long[] ids, RemoteViews[] views, boolean hasStableIds, int viewTypeCount) {
            ...
            int layoutIdCount = (int) Arrays.stream(views).mapToInt(RemoteViews$RemoteCollectionItems$$ExternalSyntheticLambda0.INSTANCE).distinct().count();
        ...
        RemoteCollectionItems(Parcel in) {
            ...
            in.readTypedArray(remoteViewsArr, RemoteViews.CREATOR);
        ...
        public static final class Builder {
            ...
            public RemoteCollectionItems build() {
                if (this.mViewTypeCount < 1) {
                    this.mViewTypeCount = (int) this.mViews.stream().mapToInt(RemoteViews$RemoteCollectionItems$$ExternalSyntheticLambda0.INSTANCE).distinct().count();
                }
