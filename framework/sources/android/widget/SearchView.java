...
public class SearchView extends LinearLayout implements CollapsibleActionView {
    ...
    private void rewriteQueryFromSuggestion(int position) {
        ...
        if (c.moveToPosition(position)) {
            CharSequence newQuery = this.mSuggestionsAdapter.mo3079convertToString(c);
            if (newQuery != null) {
                setQuery(newQuery);
                return;
            } else {
    ...
    public static class SearchAutoComplete extends AutoCompleteTextView {
        ...
        final Runnable mRunShowSoftInputIfNecessary = new Runnable() { // from class: android.widget.SearchView$SearchAutoComplete$$ExternalSyntheticLambda0
            @Override // java.lang.Runnable
