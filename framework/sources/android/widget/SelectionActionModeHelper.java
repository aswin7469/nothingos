...
public final class SelectionActionModeHelper {
    ...
    public SelectionActionModeHelper(Editor editor) {
        ...
        this.mTextClassificationHelper = new TextClassificationHelper(context, new SelectionActionModeHelper$$ExternalSyntheticLambda12(textView), getText(textView), 0, 1, textView.getTextLocales());
        ...
        if (getTextClassificationSettings().isSmartSelectionAnimationEnabled()) {
            ...
            Objects.requireNonNull(textView);
            this.mSmartSelectSprite = new SmartSelectSprite(context2, i, new Runnable() { // from class: android.widget.SelectionActionModeHelper$$ExternalSyntheticLambda2
    ...
    public static int[] sortSelectionIndices(int selectionStart, int selectionEnd) {
        return selectionStart < selectionEnd ? new int[]{selectionStart, selectionEnd} : new int[]{selectionEnd, selectionStart};
    }
    ...
    /* JADX WARN: Type inference failed for: r4v3, types: [android.widget.SelectionActionModeHelper$$ExternalSyntheticLambda11] */
    public void startSelectionActionModeAsync(boolean adjustSelection) {
        SelectionActionModeHelper$$ExternalSyntheticLambda9 selectionActionModeHelper$$ExternalSyntheticLambda9;
        Consumer consumer;
        ...
        if (adjustSelection2) {
            ...
            selectionActionModeHelper$$ExternalSyntheticLambda9 = new Supplier() { // from class: android.widget.SelectionActionModeHelper$$ExternalSyntheticLambda11
            ...
            selectionActionModeHelper$$ExternalSyntheticLambda9 = new SelectionActionModeHelper$$ExternalSyntheticLambda9(textClassificationHelper2);
        }
        if (this.mSmartSelectSprite != null) {
            ...
            consumer = new Consumer() { // from class: android.widget.SelectionActionModeHelper$$ExternalSyntheticLambda3
                @Override // java.util.function.Consumer
                public final void accept(Object obj) {
        ...
        this.mTextClassificationAsyncTask = new TextClassificationAsyncTask(textView, timeoutDuration, selectionActionModeHelper$$ExternalSyntheticLambda9, consumer, new SelectionActionModeHelper$$ExternalSyntheticLambda10(textClassificationHelper3)).execute(new Void[0]);
    }
    ...
    public void startLinkActionModeAsync(int start, int end) {
        ...
        Objects.requireNonNull(textClassificationHelper);
        SelectionActionModeHelper$$ExternalSyntheticLambda9 selectionActionModeHelper$$ExternalSyntheticLambda9 = new SelectionActionModeHelper$$ExternalSyntheticLambda9(textClassificationHelper);
        ...
        TextClassificationHelper textClassificationHelper2 = this.mTextClassificationHelper;
        Objects.requireNonNull(textClassificationHelper2);
        this.mTextClassificationAsyncTask = new TextClassificationAsyncTask(textView, timeoutDuration, selectionActionModeHelper$$ExternalSyntheticLambda9, consumer, new SelectionActionModeHelper$$ExternalSyntheticLambda10(textClassificationHelper2)).execute(new Void[0]);
    }
    ...
    public void invalidateActionModeAsync() {
        ...
        Objects.requireNonNull(textClassificationHelper);
        SelectionActionModeHelper$$ExternalSyntheticLambda9 selectionActionModeHelper$$ExternalSyntheticLambda9 = new SelectionActionModeHelper$$ExternalSyntheticLambda9(textClassificationHelper);
        Consumer consumer = new Consumer() { // from class: android.widget.SelectionActionModeHelper$$ExternalSyntheticLambda4
            @Override // java.util.function.Consumer
            public final void accept(Object obj) {
    ...
    private void startActionMode(int actionMode, SelectionResult result) {
        ...
        if (this.mEditor.startActionModeInternal(actionMode) && result != null) {
            switch (actionMode) {
                case 0:
    ...
    public void startSelectionActionModeWithSmartSelectAnimation(final SelectionResult result) {
        ...
        Runnable onAnimationEndCallback = new Runnable() { // from class: android.widget.SelectionActionModeHelper$$ExternalSyntheticLambda1
            @Override // java.lang.Runnable
            public final void run() {
        ...
        int[] sortedSelectionIndices = sortSelectionIndicesFromTextView(this.mTextView);
        boolean didSelectionChange = true;
        ...
        PointF animationStartPoint = movePointInsideNearestRectangle(touchPoint, selectionRectangles, SelectionActionModeHelper$$ExternalSyntheticLambda8.INSTANCE);
    ...
    private List<SmartSelectSprite.RectangleWithTextSelectionLayout> convertSelectionToRectangles(Layout layout, int start, int end) {
        ...
        Layout.SelectionRectangleConsumer consumer = new Layout.SelectionRectangleConsumer() { // from class: android.widget.SelectionActionModeHelper$$ExternalSyntheticLambda0
            @Override // android.text.Layout.SelectionRectangleConsumer
            public final void accept(float f, float f2, float f3, float f4, int i) {
                SelectionActionModeHelper.mergeRectangleIntoList(result, new RectF(f, f2, f3, f4), SelectionActionModeHelper$$ExternalSyntheticLambda8.INSTANCE, new Function() { // from class: android.widget.SelectionActionModeHelper$$ExternalSyntheticLambda7
        ...
        result.sort(Comparator.comparing(SelectionActionModeHelper$$ExternalSyntheticLambda8.INSTANCE, SmartSelectSprite.RECTANGLE_COMPARATOR));
        return result;
    }
    ...
    private void resetTextClassificationHelper(int selectionStart, int selectionEnd) {
        ...
        TextView textView = this.mTextView;
        Objects.requireNonNull(textView);
        textClassificationHelper.init(new SelectionActionModeHelper$$ExternalSyntheticLambda12(textView), getText(this.mTextView), selectionStart, selectionEnd, this.mTextView.getTextLocales());
    }
    ...
    public static final class TextClassificationAsyncTask extends AsyncTask<Void, Void, SelectionResult> {
        ...
        TextClassificationAsyncTask(TextView textView, int timeOut, Supplier<SelectionResult> selectionResultSupplier, Consumer<SelectionResult> selectionResultCallback, Supplier<SelectionResult> timeOutResultSupplier) {
            ...
            Objects.requireNonNull(selectionResultSupplier);
            this.mSelectionResultSupplier = selectionResultSupplier;
            Objects.requireNonNull(selectionResultCallback);
            this.mSelectionResultCallback = selectionResultCallback;
            Objects.requireNonNull(timeOutResultSupplier);
            this.mTimeOutResultSupplier = timeOutResultSupplier;
    ...
    public static CharSequence getText(TextView textView) {
        CharSequence text = textView.mo3084getText();
        if (text != null) {
            return text;
        }
        return "";
