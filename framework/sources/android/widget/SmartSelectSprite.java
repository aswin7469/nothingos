...
public final class SmartSelectSprite {
    ...
    static final Comparator<RectF> RECTANGLE_COMPARATOR = Comparator.comparingDouble(SmartSelectSprite$$ExternalSyntheticLambda1.INSTANCE).thenComparingDouble(SmartSelectSprite$$ExternalSyntheticLambda2.INSTANCE);
    ...
    public void startAnimation(PointF start, List<RectangleWithTextSelectionLayout> destinationRectangles, Runnable onAnimationEnd) {
        ...
        cancelAnimation();
        ValueAnimator.AnimatorUpdateListener updateListener = new ValueAnimator.AnimatorUpdateListener() { // from class: android.widget.SmartSelectSprite$$ExternalSyntheticLambda0
    ...
    private Animator createAnimator(RectangleList rectangleList, float startingOffsetLeft, float startingOffsetRight, ValueAnimator.AnimatorUpdateListener updateListener, Runnable onAnimationEnd) {
        ...
        rightBoundaryAnimator.mo1103setDuration(200L);
        leftBoundaryAnimator.mo1103setDuration(200L);
