...
public class StackView extends AdapterViewAnimator {
    ...
    void transformViewForTransition(int fromIndex, int toIndex, final View view, boolean animate) {
        ...
        if (fromIndex == -1 && toIndex == getNumActiveViews() - 1) {
            ...
            if (animate) {
                ...
                slideIn.mo1103setDuration(duration);
            ...
            if (animate) {
                ...
                slideOut.mo1103setDuration(duration2);
    ...
    private void transformViewAtIndex(int index, View view, boolean animate) {
        ...
        if (animate) {
            ...
            oa.mo1103setDuration(MIN_TIME_BETWEEN_SCROLLS);
            if (view instanceof StackFrame) {
    ...
    private void handlePointerUp(MotionEvent ev) {
        ...
        if (deltaY > this.mSwipeThreshold && this.mSwipeGestureType == 2 && this.mStackSlider.mMode == 0) {
            ...
            if (i == 1) {
                ...
                pa.mo1103setDuration(duration2);
                ...
                pa2.mo1103setDuration(duration);
                pa2.start();
            }
        }
        this.mActivePointerId = -1;
    ...
    /* JADX INFO: Access modifiers changed from: package-private */
    @Override // android.widget.AdapterViewAnimator
    /* renamed from: createOrReuseLayoutParams  reason: collision with other method in class */
    public LayoutParams mo3120createOrReuseLayoutParams(View v) {
    ...
    public void onMeasure(int widthMeasureSpec, int heightMeasureSpec) {
        ...
        if (widthSpecMode == 0) {
            if (haveChildRefSize) {
                i2 = Math.round(this.mReferenceChildWidth * (1.0f + 1.1111112f)) + this.mPaddingLeft + this.mPaddingRight;
            }
            widthSpecSize = i2;
        } else if (heightSpecMode == Integer.MIN_VALUE) {
            if (haveChildRefSize) {
