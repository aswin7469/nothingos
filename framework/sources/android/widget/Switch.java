...
public class Switch extends CompoundButton {
    ...
    public void lambda$setTrackResourceAsync$0$Switch(Drawable track) {
    ...
    public void setTrackResource(int resId) {
        lambda$setTrackResourceAsync$0$Switch(getContext().getDrawable(resId));
    }
    ...
    public Runnable setTrackResourceAsync(int resId) {
        ...
        return new Runnable() { // from class: android.widget.Switch$$ExternalSyntheticLambda3
            ...
            public final void run() {
                Switch.this.lambda$setTrackResourceAsync$0$Switch(drawable);
            }
        };
    }
    ...
    public void setTrackIcon(Icon icon) {
        lambda$setTrackResourceAsync$0$Switch(icon == null ? null : icon.loadDrawable(getContext()));
    }
    ...
    public Runnable setTrackIconAsync(Icon icon) {
        ...
        return new Runnable() { // from class: android.widget.Switch$$ExternalSyntheticLambda2
            @Override // java.lang.Runnable
            public final void run() {
                Switch.this.lambda$setTrackIconAsync$1$Switch(track);
            }
        };
    }
    ...
    private void applyTrackTint() {
        ...
        if (drawable != null) {
            if (this.mHasTrackTint || this.mHasTrackTintMode) {
                Drawable mo3113mutate = drawable.mo3113mutate();
                this.mTrackDrawable = mo3113mutate;
                if (this.mHasTrackTint) {
                    mo3113mutate.setTintList(this.mTrackTintList);
                }
    ...
    public void lambda$setThumbResourceAsync$2$Switch(Drawable thumb) {
    ...
    public void setThumbResource(int resId) {
        lambda$setThumbResourceAsync$2$Switch(getContext().getDrawable(resId));
    }
    ...
    public Runnable setThumbResourceAsync(int resId) {
        ...
        return new Runnable() { // from class: android.widget.Switch$$ExternalSyntheticLambda1
            @Override // java.lang.Runnable
            public final void run() {
                Switch.this.lambda$setThumbResourceAsync$2$Switch(drawable);
            }
        };
    }
    ...
    public void setThumbIcon(Icon icon) {
        lambda$setThumbResourceAsync$2$Switch(icon == null ? null : icon.loadDrawable(getContext()));
    }
    ...
    public Runnable setThumbIconAsync(Icon icon) {
        ...
        return new Runnable() { // from class: android.widget.Switch$$ExternalSyntheticLambda0
            @Override // java.lang.Runnable
            public final void run() {
                Switch.this.lambda$setThumbIconAsync$3$Switch(track);
            }
        };
    }
    ...
    private void applyThumbTint() {
        ...
        if (drawable != null) {
            if (this.mHasThumbTint || this.mHasThumbTintMode) {
                Drawable mo3113mutate = drawable.mo3113mutate();
                this.mThumbDrawable = mo3113mutate;
                if (this.mHasThumbTint) {
                    mo3113mutate.setTintList(this.mThumbTintList);
                }
    ...
    private void animateThumbToCheckedState(boolean newCheckedState) {
        ...
        ofFloat.mo1103setDuration(250L);
