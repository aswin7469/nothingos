...
public class TableLayout extends LinearLayout {
    ...
    public LinearLayout.LayoutParams mo3516generateDefaultLayoutParams() {
    ...
    public LinearLayout.LayoutParams mo3518generateLayoutParams(ViewGroup.LayoutParams p) {
