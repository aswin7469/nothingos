...
public class TextInputTimePickerView extends RelativeLayout {
    ...
    public boolean validateInput() {
        String hourText;
        String minuteText;
        if (TextUtils.isEmpty(this.mHourEditText.mo3084getText())) {
            hourText = this.mHourEditText.getHint().toString();
        } else {
            hourText = this.mHourEditText.mo3084getText().toString();
        }
        if (TextUtils.isEmpty(this.mMinuteEditText.mo3084getText())) {
            minuteText = this.mMinuteEditText.getHint().toString();
        } else {
            minuteText = this.mMinuteEditText.mo3084getText().toString();
        }
        boolean z = true;
