...
public final class TextViewOnReceiveContentListener implements OnReceiveContentListener {
    ...
    public ContentInfo onReceiveContent(View view, ContentInfo payload) {
        ...
        Editable editable = (Editable) ((TextView) view).mo3084getText();
        ...
        for (int i = 0; i < clip.getItemCount(); i++) {
            ...
            if (itemText != null) {
                if (!didFirst) {
                    ...
                    editable.mo2734insert(Selection.getSelectionEnd(editable), "\n");
                    editable.mo2734insert(Selection.getSelectionEnd(editable), itemText);
                }
            }
        }
        return null;
    ...
    private static void replaceSelection(Editable editable, CharSequence replacement) {
        ...
        editable.mo2736replace(start, end, replacement);
    }
    ...
    private void onReceiveForAutofill(TextView view, ContentInfo payload) {
        ...
        view.setText(text);
        Editable editable = (Editable) view.mo3084getText();
    ...
    private ClipData handleNonTextViaImeCommitContent(ClipData clip) {
        ...
        if (containsUri(clip) && !containsOnlyText(clip)) {
            ...
            if (icInfo != null) {
                inputConnection = (InputConnection) icInfo.mInputConnection.get();
            } else {
