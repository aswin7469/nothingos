...
public class Toolbar extends ViewGroup {
    ...
    private void ensureMenuView() {
        if (this.mMenuView == null) {
            ...
            LayoutParams lp = mo3516generateDefaultLayoutParams();
    ...
    private void addSystemView(View v, boolean allowHide) {
        ...
        if (vlp == null) {
            lp = mo3516generateDefaultLayoutParams();
        } else if (!checkLayoutParams(vlp)) {
            lp = mo3518generateLayoutParams(vlp);
        } else {
            lp = (LayoutParams) vlp;
        }
        lp.mViewType = 1;
    ...
    public void onSetLayoutParams(View child, ViewGroup.LayoutParams lp) {
        if (!checkLayoutParams(lp)) {
            child.setLayoutParams(mo3518generateLayoutParams(lp));
        }
    }
    ...
    */
    ...
    @Override // android.view.ViewGroup
    /* renamed from: generateLayoutParams  reason: collision with other method in class */
    public LayoutParams mo3518generateLayoutParams(ViewGroup.LayoutParams p) {
    ...
    public static class SavedState extends View.BaseSavedState {
        public static final Parcelable.Creator<SavedState> CREATOR = new Parcelable.Creator<SavedState>() { // from class: android.widget.Toolbar.SavedState.1
            ...
            public SavedState mo3559createFromParcel(Parcel source) {
    ...
    public class ExpandedActionViewMenuPresenter implements MenuPresenter {
        ...
        public boolean expandItemActionView(MenuBuilder menu, MenuItemImpl item) {
            ...
            if (parent2 != toolbar2) {
                LayoutParams lp = toolbar2.mo3516generateDefaultLayoutParams();
