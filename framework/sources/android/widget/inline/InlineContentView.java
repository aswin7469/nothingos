...
public class InlineContentView extends ViewGroup {
    ...
    public InlineContentView(Context context, AttributeSet attrs, int defStyleAttr, int defStyleRes) {
        ...
        SurfaceView surfaceView = new SurfaceView(context, attrs, defStyleAttr, defStyleRes) { // from class: android.widget.inline.InlineContentView.4
            ...
            public void onSetSurfacePositionAndScaleRT(SurfaceControl.Transaction transaction, SurfaceControl surface, int positionLeft, int positionTop, float postScaleX, float postScaleY) {
                ...
                super.onSetSurfacePositionAndScaleRT(transaction, surface, positionLeft, positionTop, postScaleX2, postScaleY2);
            }
        };
        ...
        if (surfacePackageUpdater != null) {
            surfacePackageUpdater.getSurfacePackage(new Consumer() { // from class: android.widget.inline.InlineContentView$$ExternalSyntheticLambda0
                ...
                public final void accept(Object obj) {
                    InlineContentView.this.lambda$onAttachedToWindow$0$InlineContentView((SurfaceControlViewHost.SurfacePackage) obj);
                }
            });
        }
    ...
    public /* synthetic */ void lambda$onAttachedToWindow$0$InlineContentView(SurfaceControlViewHost.SurfacePackage sp) {
    ...
    public void computeParentPositionAndScale() {
        ...
        if (parentSurfaceOwnerView != null) {
            ...
            if (oldParentPositionX != iArr2[0] || oldParentPositionY != iArr2[1]) {
