...
public class ClientWindowFrames implements Parcelable {
    public static final Parcelable.Creator<ClientWindowFrames> CREATOR = new Parcelable.Creator<ClientWindowFrames>() { // from class: android.window.ClientWindowFrames.1
        ...
        public ClientWindowFrames mo3559createFromParcel(Parcel in) {
        ...
        public ClientWindowFrames[] mo3560newArray(int size) {
    ...
    private ClientWindowFrames(Parcel in) {
        this.frame = Rect.CREATOR.mo3559createFromParcel(in);
        this.displayFrame = Rect.CREATOR.mo3559createFromParcel(in);
        this.backdropFrame = Rect.CREATOR.mo3559createFromParcel(in);
    }
