                ...
                default:
                    switch (code) {
                        case 1:
                            ...
                            if (data.readInt() != 0) {
                                _arg0 = DisplayAreaInfo.CREATOR.mo3559createFromParcel(data);
                            } else {
                                _arg0 = null;
                            }
                            if (data.readInt() != 0) {
                        ...
                        case 2:
                            data.enforceInterface(IDisplayAreaOrganizer.DESCRIPTOR);
                            if (data.readInt() != 0) {
                                _arg02 = DisplayAreaInfo.CREATOR.mo3559createFromParcel(data);
                            } else {
                                _arg02 = null;
                            }
                        ...
                        case 3:
                            data.enforceInterface(IDisplayAreaOrganizer.DESCRIPTOR);
                            if (data.readInt() != 0) {
                                _arg03 = DisplayAreaInfo.CREATOR.mo3559createFromParcel(data);
                            } else {
                                _arg03 = null;
                            }
