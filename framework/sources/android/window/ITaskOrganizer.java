                ...
                default:
                    switch (code) {
                        case 1:
                            ...
                            if (data.readInt() != 0) {
                                _arg0 = StartingWindowInfo.CREATOR.mo3559createFromParcel(data);
                            } else {
                                _arg0 = null;
                            }
                        ...
                        case 2:
                            ...
                            if (data.readInt() != 0) {
                                _arg1 = SurfaceControl.CREATOR.mo3559createFromParcel(data);
                            } else {
                                _arg1 = null;
                            }
                            if (data.readInt() != 0) {
                        ...
                        case 5:
                            ...
                            if (data.readInt() != 0) {
                                _arg12 = SurfaceControl.CREATOR.mo3559createFromParcel(data);
                            } else {
                                _arg12 = null;
                            }
