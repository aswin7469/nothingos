                ...
                default:
                    ...
                    switch (code) {
                        ...
                        case 4:
                            data.enforceInterface(ITaskOrganizerController.DESCRIPTOR);
                            if (data.readInt() != 0) {
                                _arg0 = WindowContainerToken.CREATOR.mo3559createFromParcel(data);
                            } else {
                                _arg0 = null;
                            }
                        ...
                        case 5:
                            data.enforceInterface(ITaskOrganizerController.DESCRIPTOR);
                            if (data.readInt() != 0) {
                                _arg02 = WindowContainerToken.CREATOR.mo3559createFromParcel(data);
                            } else {
                                _arg02 = null;
                            }
                        ...
                        case 8:
                            data.enforceInterface(ITaskOrganizerController.DESCRIPTOR);
                            if (data.readInt() != 0) {
                                _arg03 = WindowContainerToken.CREATOR.mo3559createFromParcel(data);
                            } else {
                                _arg03 = null;
                            }
                            if (data.readInt() != 0) {
                        ...
                        case 9:
                            data.enforceInterface(ITaskOrganizerController.DESCRIPTOR);
                            if (data.readInt() != 0) {
                                _arg04 = WindowContainerToken.CREATOR.mo3559createFromParcel(data);
                            } else {
                                _arg04 = null;
                            }
        ...
        public static class Proxy implements ITaskOrganizerController {
            ...
            public WindowContainerToken getImeTarget(int display) throws RemoteException {
                ...
                try {
                    ...
                    _reply.readException();
                    if (_reply.readInt() != 0) {
                        _result = WindowContainerToken.CREATOR.mo3559createFromParcel(_reply);
                    } else {
                        _result = null;
                    }
                    return _result;
