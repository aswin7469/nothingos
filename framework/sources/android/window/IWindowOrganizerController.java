                ...
                default:
                    ...
                    switch (code) {
                        case 1:
                            ...
                            if (data.readInt() != 0) {
                                _arg0 = WindowContainerTransaction.CREATOR.mo3559createFromParcel(data);
                            } else {
                                _arg0 = null;
                            }
                        ...
                        case 2:
                            data.enforceInterface(IWindowOrganizerController.DESCRIPTOR);
                            if (data.readInt() != 0) {
                                _arg02 = WindowContainerTransaction.CREATOR.mo3559createFromParcel(data);
                            } else {
                                _arg02 = null;
                            }
                        ...
                        case 3:
                            ...
                            if (data.readInt() != 0) {
                                _arg2 = WindowContainerTransaction.CREATOR.mo3559createFromParcel(data);
                            } else {
                                _arg2 = null;
                            }
                        ...
                        case 4:
                            ...
                            if (data.readInt() != 0) {
                                _arg1 = WindowContainerTransaction.CREATOR.mo3559createFromParcel(data);
                            } else {
                                _arg1 = null;
                            }
