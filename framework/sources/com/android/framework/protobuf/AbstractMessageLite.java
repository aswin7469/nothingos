...
public abstract class AbstractMessageLite<MessageType extends AbstractMessageLite<MessageType, BuilderType>, BuilderType extends Builder<MessageType, BuilderType>> implements MessageLite {
    ...
    public static abstract class Builder<MessageType extends AbstractMessageLite<MessageType, BuilderType>, BuilderType extends Builder<MessageType, BuilderType>> implements MessageLite.Builder {
        ...
        /* renamed from: clone */
        public abstract BuilderType mo3229clone();

        protected abstract BuilderType internalMergeFrom(MessageType messagetype);

        @Override // com.android.framework.protobuf.MessageLite.Builder
        /* renamed from: mergeFrom */
        public abstract BuilderType mo3231mergeFrom(CodedInputStream codedInputStream, ExtensionRegistryLite extensionRegistryLite) throws IOException;

        @Override // com.android.framework.protobuf.MessageLite.Builder
        /* renamed from: mergeFrom */
        public BuilderType mo3180mergeFrom(CodedInputStream input) throws IOException {
            return mo3231mergeFrom(input, ExtensionRegistryLite.getEmptyRegistry());
        }

        @Override // com.android.framework.protobuf.MessageLite.Builder
        /* renamed from: mergeFrom */
        public BuilderType mo3178mergeFrom(ByteString data) throws InvalidProtocolBufferException {
            try {
                CodedInputStream input = data.newCodedInput();
                mo3180mergeFrom(input);
        ...
        @Override // com.android.framework.protobuf.MessageLite.Builder
        /* renamed from: mergeFrom */
        public BuilderType mo3179mergeFrom(ByteString data, ExtensionRegistryLite extensionRegistry) throws InvalidProtocolBufferException {
            try {
                CodedInputStream input = data.newCodedInput();
                mo3231mergeFrom(input, extensionRegistry);
                input.checkLastTagWas(0);
                return this;
            } catch (InvalidProtocolBufferException e) {
                throw e;
        ...
        @Override // com.android.framework.protobuf.MessageLite.Builder
        /* renamed from: mergeFrom */
        public BuilderType mo3185mergeFrom(byte[] data) throws InvalidProtocolBufferException {
            return mo3232mergeFrom(data, 0, data.length);
        }

        @Override // com.android.framework.protobuf.MessageLite.Builder
        /* renamed from: mergeFrom */
        public BuilderType mo3232mergeFrom(byte[] data, int off, int len) throws InvalidProtocolBufferException {
            try {
        ...
        @Override // com.android.framework.protobuf.MessageLite.Builder
        /* renamed from: mergeFrom */
        public BuilderType mo3188mergeFrom(byte[] data, ExtensionRegistryLite extensionRegistry) throws InvalidProtocolBufferException {
            return mo3233mergeFrom(data, 0, data.length, extensionRegistry);
        }

        @Override // com.android.framework.protobuf.MessageLite.Builder
        /* renamed from: mergeFrom */
        public BuilderType mo3233mergeFrom(byte[] data, int off, int len, ExtensionRegistryLite extensionRegistry) throws InvalidProtocolBufferException {
            try {
                CodedInputStream input = CodedInputStream.newInstance(data, off, len);
                mo3231mergeFrom(input, extensionRegistry);
                input.checkLastTagWas(0);
        ...
        @Override // com.android.framework.protobuf.MessageLite.Builder
        /* renamed from: mergeFrom */
        public BuilderType mo3183mergeFrom(InputStream input) throws IOException {
            CodedInputStream codedInput = CodedInputStream.newInstance(input);
            mo3180mergeFrom(codedInput);
        ...
        @Override // com.android.framework.protobuf.MessageLite.Builder
        /* renamed from: mergeFrom */
        public BuilderType mo3184mergeFrom(InputStream input, ExtensionRegistryLite extensionRegistry) throws IOException {
            CodedInputStream codedInput = CodedInputStream.newInstance(input);
            mo3231mergeFrom(codedInput, extensionRegistry);
            codedInput.checkLastTagWas(0);
            return this;
        }
        ...
        public boolean mergeDelimitedFrom(InputStream input, ExtensionRegistryLite extensionRegistry) throws IOException {
            ...
            mo3184mergeFrom(limitedInput, extensionRegistry);
            return true;
        }
        ...
        @Override // com.android.framework.protobuf.MessageLite.Builder
        /* renamed from: mergeFrom */
        public BuilderType mo3182mergeFrom(MessageLite other) {
