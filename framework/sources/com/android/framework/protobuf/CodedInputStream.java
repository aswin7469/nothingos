...
public abstract class CodedInputStream {
    ...
    public static final class ArrayDecoder extends CodedInputStream {
        ...
        public void readGroup(int fieldNumber, MessageLite.Builder builder, ExtensionRegistryLite extensionRegistry) throws IOException {
            ...
            this.recursionDepth++;
            builder.mo3231mergeFrom(this, extensionRegistry);
        ...
        public <T extends MessageLite> T readGroup(int fieldNumber, Parser<T> parser, ExtensionRegistryLite extensionRegistry) throws IOException {
            ...
            this.recursionDepth++;
            T result = parser.mo3235parsePartialFrom(this, extensionRegistry);
            checkLastTagWas(WireFormat.makeTag(fieldNumber, 4));
            this.recursionDepth--;
            return result;
        }
            ...
            if (this.limit != tempPos) {
                ...
                if (x >= 0) {
                    ...
                    if (x2 < 0) {
                        ...
                        int x3 = (UnsafeUtil.getByte(tempPos3) << BluetoothHidDevice.ERROR_RSP_UNKNOWN) ^ x2;
                        if (x3 >= 0) {
                            y = x3 ^ 16256;
                            tempPos3 = tempPos4;
                        } else {
            ...
            if (this.limit != tempPos) {
                ...
                if (y >= 0) {
                    ...
                    if (y2 < 0) {
                        ...
                        long tempPos4 = tempPos3 + 1;
                        int y3 = (UnsafeUtil.getByte(tempPos3) << BluetoothHidDevice.ERROR_RSP_UNKNOWN) ^ y2;
                        if (y3 >= 0) {
                            x = y3 ^ 16256;
                            tempPos3 = tempPos4;
                        } else {
