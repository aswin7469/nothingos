...
final class ExtensionSchemaLite extends ExtensionSchema<GeneratedMessageLite.ExtensionDescriptor> {
        ...
        if (extension.descriptor.isRepeated() && extension.descriptor.isPacked()) {
            switch (AnonymousClass1.$SwitchMap$com$google$protobuf$WireFormat$FieldType[extension.getLiteType().ordinal()]) {
                ...
                case 14:
                    ...
                    unknownFields = (UB) SchemaUtil.filterUnknownEnumList(fieldNumber, list14, extension.descriptor.getEnumType(), unknownFields, unknownFieldSchema);
                    value = list14;
                    break;
                default:
    ...
    public void parseMessageSetItem(ByteString data, Object extensionObject, ExtensionRegistryLite extensionRegistry, FieldSet<GeneratedMessageLite.ExtensionDescriptor> extensions) throws IOException {
        GeneratedMessageLite.GeneratedExtension<?, ?> extension = (GeneratedMessageLite.GeneratedExtension) extensionObject;
        MessageLite mo3236buildPartial = extension.getMessageDefaultInstance().mo3223newBuilderForType().mo3236buildPartial();
        Reader reader = BinaryReader.newInstance(ByteBuffer.wrap(data.toByteArray()), true);
        Protobuf.getInstance().mergeFrom(mo3236buildPartial, reader, extensionRegistry);
        extensions.setField(extension.descriptor, mo3236buildPartial);
