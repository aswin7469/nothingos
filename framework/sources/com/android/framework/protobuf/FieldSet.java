...
public final class FieldSet<FieldDescriptorType extends FieldDescriptorLite<FieldDescriptorType>> {
    ...
    /* renamed from: clone */
    public FieldSet<FieldDescriptorType> m3219clone() {
    ...
    private void mergeFromField(Map.Entry<FieldDescriptorType, Object> entry) {
        ...
        if (descriptor.isRepeated()) {
            ...
            this.fields.put((SmallSortedMap<FieldDescriptorType, Object>) descriptor, (FieldDescriptorType) descriptor.internalMergeFrom(((MessageLite) value2).mo3224toBuilder(), (MessageLite) otherValue).mo3225build());
        } else {
            this.fields.put((SmallSortedMap<FieldDescriptorType, Object>) descriptor, (FieldDescriptorType) cloneIfMutable(otherValue));
        }
    }
