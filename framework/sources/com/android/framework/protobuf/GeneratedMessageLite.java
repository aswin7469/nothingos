...
public abstract class GeneratedMessageLite<MessageType extends GeneratedMessageLite<MessageType, BuilderType>, BuilderType extends Builder<MessageType, BuilderType>> extends AbstractMessageLite<MessageType, BuilderType> {
    ...
    public final MessageType mo3230getDefaultInstanceForType() {
        return (MessageType) dynamicMethod(MethodToInvoke.GET_DEFAULT_INSTANCE);
    }

    @Override // com.android.framework.protobuf.MessageLite
    /* renamed from: newBuilderForType */
    public final BuilderType mo3223newBuilderForType() {
    ...
    public boolean equals(Object other) {
        ...
        if (!mo3230getDefaultInstanceForType().getClass().isInstance(other)) {
            return false;
        }
    ...
    public final BuilderType mo3224toBuilder() {
    ...
    public static <T extends GeneratedMessageLite<?, ?>> T getDefaultInstance(Class<T> clazz) {
        ...
        if (generatedMessageLite == null) {
            generatedMessageLite = (T) ((GeneratedMessageLite) UnsafeUtil.allocateInstance(clazz)).mo3230getDefaultInstanceForType();
            if (generatedMessageLite == null) {
    ...
    public static abstract class Builder<MessageType extends GeneratedMessageLite<MessageType, BuilderType>, BuilderType extends Builder<MessageType, BuilderType>> extends AbstractMessageLite.Builder<MessageType, BuilderType> {
        ...
        /* renamed from: clear */
        public final BuilderType mo3227clear() {
        ...
        public BuilderType mo3229clone() {
            BuilderType builder = (BuilderType) mo3230getDefaultInstanceForType().mo3223newBuilderForType();
            builder.mergeFrom(mo3236buildPartial());
            return builder;
        }

        @Override // com.android.framework.protobuf.MessageLite.Builder
        /* renamed from: buildPartial */
        public MessageType mo3236buildPartial() {
            if (this.isBuilt) {
        ...
        @Override // com.android.framework.protobuf.MessageLite.Builder
        /* renamed from: build */
        public final MessageType mo3225build() {
            MessageType result = mo3236buildPartial();
        ...
        @Override // com.android.framework.protobuf.MessageLiteOrBuilder
        /* renamed from: getDefaultInstanceForType */
        public MessageType mo3230getDefaultInstanceForType() {
            return this.defaultInstance;
        }

        @Override // com.android.framework.protobuf.AbstractMessageLite.Builder, com.android.framework.protobuf.MessageLite.Builder
        /* renamed from: mergeFrom  reason: collision with other method in class */
        public BuilderType mo3233mergeFrom(byte[] input, int offset, int length, ExtensionRegistryLite extensionRegistry) throws InvalidProtocolBufferException {
            copyOnWrite();
            try {
        ...
        @Override // com.android.framework.protobuf.AbstractMessageLite.Builder, com.android.framework.protobuf.MessageLite.Builder
        /* renamed from: mergeFrom  reason: collision with other method in class */
        public BuilderType mo3232mergeFrom(byte[] input, int offset, int length) throws InvalidProtocolBufferException {
            return mo3233mergeFrom(input, offset, length, ExtensionRegistryLite.getEmptyRegistry());
        }

        @Override // com.android.framework.protobuf.AbstractMessageLite.Builder, com.android.framework.protobuf.MessageLite.Builder
        /* renamed from: mergeFrom  reason: collision with other method in class */
        public BuilderType mo3231mergeFrom(CodedInputStream input, ExtensionRegistryLite extensionRegistry) throws IOException {
            copyOnWrite();
            try {
    ...
    public static abstract class ExtendableMessage<MessageType extends ExtendableMessage<MessageType, BuilderType>, BuilderType extends ExtendableBuilder<MessageType, BuilderType>> extends GeneratedMessageLite<MessageType, BuilderType> implements ExtendableMessageOrBuilder<MessageType, BuilderType> {
        ...
        protected final void mergeExtensionFields(MessageType other) {
            if (this.extensions.isImmutable()) {
                this.extensions = this.extensions.m3219clone();
            }
                ...
                switch (AnonymousClass1.$SwitchMap$com$google$protobuf$WireFormat$JavaType[extension.descriptor.getLiteJavaType().ordinal()]) {
                    case 1:
                        ...
                        if (!extension.descriptor.isRepeated() && (existingValue = (MessageLite) this.extensions.getField(extension.descriptor)) != null) {
                            subBuilder = existingValue.mo3224toBuilder();
                        }
                        if (subBuilder == null) {
                            subBuilder = extension.getMessageDefaultInstance().mo3223newBuilderForType();
                        }
        ...
        private void mergeMessageSetExtensionFromBytes(ByteString rawBytes, ExtensionRegistryLite extensionRegistry, GeneratedExtension<?, ?> extension) throws IOException {
            ...
            subBuilder.mo3179mergeFrom(rawBytes, extensionRegistry);
            MessageLite value = subBuilder.mo3225build();
    ...
    public static abstract class ExtendableBuilder<MessageType extends ExtendableMessage<MessageType, BuilderType>, BuilderType extends ExtendableBuilder<MessageType, BuilderType>> extends Builder<MessageType, BuilderType> implements ExtendableMessageOrBuilder<MessageType, BuilderType> {
        ...
        public void copyOnWrite() {
            ...
            super.copyOnWrite();
            ((ExtendableMessage) this.instance).extensions = ((ExtendableMessage) this.instance).extensions.m3219clone();
        }

        private FieldSet<ExtensionDescriptor> ensureExtensionsAreMutable() {
            FieldSet<ExtensionDescriptor> extensions = ((ExtendableMessage) this.instance).extensions;
            if (extensions.isImmutable()) {
                FieldSet<ExtensionDescriptor> extensions2 = extensions.m3219clone();
        ...
        /* renamed from: buildPartial */
        public final MessageType mo3236buildPartial() {
            if (this.isBuilt) {
                return (MessageType) this.instance;
            }
            ((ExtendableMessage) this.instance).extensions.makeImmutable();
            return (MessageType) super.mo3236buildPartial();
        }
    ...
    protected static final class SerializedForm implements Serializable {
        ...
        protected Object readResolve() throws ObjectStreamException {
            try {
                ...
                return defaultInstance.mo3223newBuilderForType().mo3185mergeFrom(this.asBytes).mo3236buildPartial();
            } catch (InvalidProtocolBufferException e) {
    ...
    protected static Internal.IntList mutableCopy(Internal.IntList list) {
        int size = list.size();
        return list.mo3251mutableCopyWithCapacity(size == 0 ? 10 : size * 2);
    }
    ...
    protected static class DefaultInstanceBasedParser<T extends GeneratedMessageLite<T, ?>> extends AbstractParser<T> {
        ...
        public T mo3235parsePartialFrom(CodedInputStream input, ExtensionRegistryLite extensionRegistry) throws InvalidProtocolBufferException {
        ...
        /* renamed from: parsePartialFrom */
        public T mo3234parsePartialFrom(byte[] input, int offset, int length, ExtensionRegistryLite extensionRegistry) throws InvalidProtocolBufferException {
