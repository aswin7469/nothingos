...
public class LazyFieldLite {
    ...
    public void merge(LazyFieldLite other) {
        ...
        if (byteString2 != null && (byteString = other.delayedBytes) != null) {
            ...
            setValue(this.value.mo3224toBuilder().mo3182mergeFrom(other.value).mo3225build());
        }
    }
    ...
    public void mergeFrom(CodedInputStream input, ExtensionRegistryLite extensionRegistry) throws IOException {
        ...
        try {
            setValue(this.value.mo3224toBuilder().mo3231mergeFrom(input, extensionRegistry).mo3225build());
    ...
    private static MessageLite mergeValueAndBytes(MessageLite value, ByteString otherBytes, ExtensionRegistryLite extensionRegistry) {
        try {
            return value.mo3224toBuilder().mo3179mergeFrom(otherBytes, extensionRegistry).mo3225build();
        } catch (InvalidProtocolBufferException e) {
            return value;
        }
    }
        ...
        synchronized (this) {
            ...
            try {
                if (this.delayedBytes != null) {
                    MessageLite parsedValue = defaultInstance.getParserForType().mo3192parseFrom(this.delayedBytes, this.extensionRegistry);
