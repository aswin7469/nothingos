        ...
        private static <L> List<L> mutableListAt(Object message, long offset, int additionalCapacity) {
            ...
            if (list2.isEmpty()) {
                if (list2 instanceof LazyStringList) {
                    ...
                    list = ((Internal.ProtobufList) list2).mo3251mutableCopyWithCapacity(additionalCapacity);
                } else {
                ...
                List<L> list3 = ((Internal.ProtobufList) list2).mo3251mutableCopyWithCapacity(list2.size() + additionalCapacity);
    ...
    private static final class ListFieldSchemaLite extends ListFieldSchema {
        ...
        <L> List<L> mutableListAt(Object message, long offset) {
            ...
            if (!list.isModifiable()) {
                int size = list.size();
                Internal.ProtobufList<L> list2 = list.mo3251mutableCopyWithCapacity(size == 0 ? 10 : size * 2);
        ...
        <E> void mergeListsAt(Object msg, Object otherMsg, long offset) {
            ...
            if (size > 0 && otherSize > 0) {
                ...
                if (!isModifiable) {
                    mine3 = mine.mo3251mutableCopyWithCapacity(size + otherSize);
                }
                mine3.addAll(other);
                mine2 = mine3;
            }
