...
public final class MessageSchema<T> implements Schema<T> {
    ...
    */
    static <T> MessageSchema<T> newSchemaForRawMessageInfo(RawMessageInfo messageInfo, NewInstanceSchema newInstanceSchema, ListFieldSchema listFieldSchema, UnknownFieldSchema<?, ?> unknownFieldSchema, ExtensionSchema<?> extensionSchema, MapFieldSchema mapFieldSchema) {
        ...
        int i16 = 55296;
        if (next15 >= 55296) {
            int result = next15 & NetworkStackConstants.IPV4_FRAGMENT_MASK;
            int shift = 13;
            while (true) {
                i14 = i15 + 1;
                ...
                result |= (next14 & NetworkStackConstants.IPV4_FRAGMENT_MASK) << shift;
                shift += 13;
                i15 = i14;
            }
        ...
        if (next16 >= 55296) {
            int result2 = next16 & NetworkStackConstants.IPV4_FRAGMENT_MASK;
            int shift2 = 13;
            while (true) {
                i13 = i17 + 1;
                ...
                result2 |= (next13 & NetworkStackConstants.IPV4_FRAGMENT_MASK) << shift2;
                shift2 += 13;
                i17 = i13;
            }
        ...
        if (fieldCount == 0) {
            ...
            if (next17 >= 55296) {
                int result3 = next17 & NetworkStackConstants.IPV4_FRAGMENT_MASK;
                int shift3 = 13;
                while (true) {
                    i8 = i18 + 1;
                    ...
                    result3 |= (next8 & NetworkStackConstants.IPV4_FRAGMENT_MASK) << shift3;
                    shift3 += 13;
                    i18 = i8;
                }
            ...
            if (next18 >= 55296) {
                int result5 = next18 & NetworkStackConstants.IPV4_FRAGMENT_MASK;
                int shift4 = 13;
                while (true) {
                    i7 = i19 + 1;
                    ...
                    result5 |= (next7 & NetworkStackConstants.IPV4_FRAGMENT_MASK) << shift4;
                    shift4 += 13;
                    i19 = i7;
                }
            ...
            if (next19 >= 55296) {
                int result7 = next19 & NetworkStackConstants.IPV4_FRAGMENT_MASK;
                int shift5 = 13;
                while (true) {
                    i6 = i20 + 1;
                    ...
                    result7 |= (next6 & NetworkStackConstants.IPV4_FRAGMENT_MASK) << shift5;
                    shift5 += 13;
                    i20 = i6;
                }
            ...
            if (next20 >= 55296) {
                int result9 = next20 & NetworkStackConstants.IPV4_FRAGMENT_MASK;
                int shift6 = 13;
                while (true) {
                    i5 = i21 + 1;
                    ...
                    result9 |= (next5 & NetworkStackConstants.IPV4_FRAGMENT_MASK) << shift6;
                    shift6 += 13;
                    i21 = i5;
                }
            ...
            if (next21 >= 55296) {
                int result11 = next21 & NetworkStackConstants.IPV4_FRAGMENT_MASK;
                int shift7 = 13;
                while (true) {
                    i4 = i22 + 1;
                    ...
                    result11 |= (next4 & NetworkStackConstants.IPV4_FRAGMENT_MASK) << shift7;
                    shift7 += 13;
                    i22 = i4;
                }
            ...
            if (next22 >= 55296) {
                int result13 = next22 & NetworkStackConstants.IPV4_FRAGMENT_MASK;
                int shift8 = 13;
                while (true) {
                    i3 = i23 + 1;
                    ...
                    result13 |= (next3 & NetworkStackConstants.IPV4_FRAGMENT_MASK) << shift8;
                    shift8 += 13;
                    i23 = i3;
                }
            ...
            if (next23 >= 55296) {
                int result15 = next23 & NetworkStackConstants.IPV4_FRAGMENT_MASK;
                int shift9 = 13;
                while (true) {
                    i2 = i24 + 1;
                    ...
                    result15 |= (next2 & NetworkStackConstants.IPV4_FRAGMENT_MASK) << shift9;
                    shift9 += 13;
                    i24 = i2;
                }
            ...
            if (next16 >= 55296) {
                int result17 = next16 & NetworkStackConstants.IPV4_FRAGMENT_MASK;
                int shift10 = 13;
                while (true) {
                    i = i25 + 1;
                    ...
                    result17 |= (next & NetworkStackConstants.IPV4_FRAGMENT_MASK) << shift10;
                    shift10 += 13;
                    i25 = i;
                }
        ...
        while (i26 < length2) {
            ...
            if (next24 >= i16) {
                int result19 = next24 & NetworkStackConstants.IPV4_FRAGMENT_MASK;
                int shift11 = 13;
                while (true) {
                    i12 = i27 + 1;
                    ...
                    result19 |= (next12 & NetworkStackConstants.IPV4_FRAGMENT_MASK) << shift11;
                    shift11 += 13;
                    i27 = i12;
                }
            ...
            if (next25 >= i16) {
                int result21 = next25 & NetworkStackConstants.IPV4_FRAGMENT_MASK;
                int shift12 = 13;
                while (true) {
                    i11 = i28 + 1;
                    ...
                    result21 |= (next11 & NetworkStackConstants.IPV4_FRAGMENT_MASK) << shift12;
                    shift12 += 13;
                    i28 = i11;
                }
            ...
            if (fieldType >= 51) {
                ...
                if (next26 >= i16) {
                    int result23 = next26 & NetworkStackConstants.IPV4_FRAGMENT_MASK;
                    int shift13 = 13;
                    while (true) {
                        i10 = i29 + 1;
                        ...
                        result23 |= (next10 & NetworkStackConstants.IPV4_FRAGMENT_MASK) << shift13;
                        shift13 += 13;
                        i29 = i10;
                    }
                ...
                if ((flags & 1) != objectsPosition2 || fieldType > 17) {
                    ...
                    if (next25 >= 55296) {
                        int result25 = next25 & NetworkStackConstants.IPV4_FRAGMENT_MASK;
                        int shift14 = 13;
                        while (true) {
                            i9 = i31 + 1;
                            ...
                            result25 |= (next9 & NetworkStackConstants.IPV4_FRAGMENT_MASK) << shift14;
                            shift14 += 13;
                            i31 = i9;
                        }
    ...
    */
    static <T> MessageSchema<T> newSchemaForMessageInfo(StructuralMessageInfo messageInfo, NewInstanceSchema newInstanceSchema, ListFieldSchema listFieldSchema, UnknownFieldSchema<?, ?> unknownFieldSchema, ExtensionSchema<?> extensionSchema, MapFieldSchema mapFieldSchema) {
        ...
        if (repeatedFieldOffsets2 != null) {
            ...
            int[] repeatedFieldOffsets3 = EMPTY_INT_ARRAY;
            repeatedFieldOffsets = repeatedFieldOffsets3;
        }
    ...
    private static void storeFieldData(FieldInfo fi, int[] buffer, int bufferIndex, boolean proto3, Object[] objects) {
        ...
        buffer[i] = i3 | i2 | (typeId << 20) | fieldOffset;
    ...
    public boolean equals(T message, T other) {
        ...
        Object messageUnknown = this.unknownFieldSchema.mo3257getFromMessage(message);
        Object otherUnknown = this.unknownFieldSchema.mo3257getFromMessage(other);
    ...
    public int hashCode(T message) {
        ...
        int hashCode4 = pos2 + this.unknownFieldSchema.mo3257getFromMessage(message).hashCode();
        if (this.hasExtensions) {
    ...
    private <UT, UB> int getUnknownFieldsSerializedSize(UnknownFieldSchema<UT, UB> schema, T message) {
        UT unknowns = schema.mo3257getFromMessage(message);
    ...
    private <UT, UB> void writeUnknownInMessageTo(UnknownFieldSchema<UT, UB> schema, T message, Writer writer) throws IOException {
        schema.writeTo(schema.mo3257getFromMessage(message), writer);
    }
    ...
    */
                    ...
                    try {
                        switch (type(typeAndOffset)) {
                            ...
                            default:
                                if (obj == null) {
                                    try {
                                        obj = unknownFieldSchema.mo3258newBuilder();
                                    } catch (InvalidProtocolBufferException.InvalidWireTypeException e3) {
                                        if (!unknownFieldSchema.shouldDiscardUnknownFields(reader)) {
                                            if (obj == null) {
                                                obj = unknownFieldSchema.mo3256getBuilderFromMessage(message);
                                            }
    ...
    private int parseRepeatedField(T message, byte[] data, int position, int limit, int tag, int number, int wireType, int bufferPosition, long typeAndOffset, int fieldType, long fieldOffset, ArrayDecoders.Registers registers) throws IOException {
        ...
        if (list2.isModifiable()) {
            ...
            int size = list2.size();
            Internal.ProtobufList<?> list3 = list2.mo3251mutableCopyWithCapacity(size == 0 ? 10 : size * 2);
                    ...
                    if (fieldType <= 17) {
                        ...
                        if (fieldType != 27) {
                            ...
                            if (!list.isModifiable()) {
                                int size = list.size();
                                list = list.mo3251mutableCopyWithCapacity(size == 0 ? 10 : size * 2);
    ...
    private final <K, V, UT, UB> UB filterUnknownEnumMap(int pos, int number, Map<K, V> mapData, Internal.EnumVerifier enumVerifier, UB unknownFields, UnknownFieldSchema<UT, UB> unknownFieldSchema) {
        ...
        while (it.hasNext()) {
            ...
            if (!enumVerifier.isInRange(((Integer) entry.getValue()).intValue())) {
                if (unknownFields == null) {
                    UB unknownFields2 = unknownFieldSchema.mo3258newBuilder();
