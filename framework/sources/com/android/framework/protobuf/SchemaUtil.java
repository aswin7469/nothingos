...
public final class SchemaUtil {
    ...
    public static <T, UT, UB> void mergeUnknownFields(UnknownFieldSchema<UT, UB> schema, T message, T other) {
        UT messageUnknowns = schema.mo3257getFromMessage(message);
        UT otherUnknowns = schema.mo3257getFromMessage(other);
        UT merged = schema.merge(messageUnknowns, otherUnknowns);
        schema.setToMessage(message, merged);
    }

    /* JADX INFO: Access modifiers changed from: package-private */
    public static <UT, UB> UB filterUnknownEnumList(int number, List<Integer> enumList, Internal.EnumLiteMap<?> enumMap, UB unknownFields, UnknownFieldSchema<UT, UB> unknownFieldSchema) {
        if (enumMap == null) {
        ...
        if (enumList instanceof RandomAccess) {
            ...
            for (int readPos = 0; readPos < size; readPos++) {
                ...
                if (enumMap.findValueByNumber(enumValue) != null) {
                    ...
                    unknownFields = (UB) storeUnknownEnum(number, enumValue, unknownFields, unknownFieldSchema);
                }
            }
            if (writePos != size) {
            ...
            while (it.hasNext()) {
                ...
                if (enumMap.findValueByNumber(enumValue2) == null) {
                    unknownFields = (UB) storeUnknownEnum(number, enumValue2, unknownFields, unknownFieldSchema);
                    it.remove();
                }
            }
        }
    ...
    /* JADX INFO: Access modifiers changed from: package-private */
    public static <UT, UB> UB filterUnknownEnumList(int number, List<Integer> enumList, Internal.EnumVerifier enumVerifier, UB unknownFields, UnknownFieldSchema<UT, UB> unknownFieldSchema) {
    ...
    /* JADX INFO: Access modifiers changed from: package-private */
    public static <UT, UB> UB storeUnknownEnum(int number, int enumValue, UB unknownFields, UnknownFieldSchema<UT, UB> unknownFieldSchema) {
        if (unknownFields == null) {
            unknownFields = unknownFieldSchema.mo3258newBuilder();
        }
