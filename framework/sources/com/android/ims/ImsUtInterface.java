...
public interface ImsUtInterface {
    ...
    void queryCallBarring(int i, Message message, int i2);

    void queryCallForward(int i, String str, int i2, Message message);

    void queryCallForward(int i, String str, Message message);

    void queryCallWaiting(Message message);

    void registerForSuppServiceIndication(Handler handler, int i, Object obj);
    ...
    void updateCallBarring(int i, int i2, Message message, String[] strArr, int i3);

    void updateCallBarring(int i, int i2, Message message, String[] strArr, int i3, String str);
