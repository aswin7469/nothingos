                ...
                default:
                    ...
                    switch (code) {
                        ...
                        case 13:
                            ...
                            if (data.readInt() != 0) {
                                _arg13 = ImsStreamMediaProfile.CREATOR.mo3559createFromParcel(data);
                            } else {
                                _arg13 = null;
                            }
                        ...
                        case 16:
                            ...
                            transfer(_arg08, _arg04);
                            reply.writeNoException();
                            return true;
                        case 17:
                            data.enforceInterface(DESCRIPTOR);
                            consultativeTransfer(asInterface(data.readStrongBinder()));
                            reply.writeNoException();
                            return true;
                        case 18:
                            data.enforceInterface(DESCRIPTOR);
                        ...
                        case 20:
                            data.enforceInterface(DESCRIPTOR);
                            if (data.readInt() != 0) {
                                _arg02 = ImsStreamMediaProfile.CREATOR.mo3559createFromParcel(data);
                            } else {
                                _arg02 = null;
                            }
                            resume(_arg02);
                        ...
                        case 22:
                            ...
                            if (data.readInt() != 0) {
                                _arg14 = ImsStreamMediaProfile.CREATOR.mo3559createFromParcel(data);
                            } else {
                                _arg14 = null;
                            }
                            update(_arg09, _arg14);
                            reply.writeNoException();
                            return true;
                        case 23:
                            data.enforceInterface(DESCRIPTOR);
                        ...
                        case 26:
                            ...
                            if (data.readInt() != 0) {
                                _arg15 = Message.CREATOR.mo3559createFromParcel(data);
                            } else {
                                _arg15 = null;
                            }
                            sendDtmf(_arg010, _arg15);
                            reply.writeNoException();
                            return true;
                        case 27:
                            data.enforceInterface(DESCRIPTOR);
                        ...
                        case 32:
                            data.enforceInterface(DESCRIPTOR);
                            if (data.readInt() != 0) {
                                _arg03 = ImsCallProfile.CREATOR.mo3559createFromParcel(data);
                            } else {
                                _arg03 = null;
                            }
                        ...
                        case 35:
                            data.enforceInterface(DESCRIPTOR);
                            sendRtpHeaderExtensions(data.createTypedArrayList(RtpHeaderExtension.CREATOR));
                            reply.writeNoException();
                            return true;
                        default:
        ...
        public static class Proxy implements IImsCallSession {
            ...
            public ImsCallProfile getCallProfile() throws RemoteException {
                ...
                try {
                    ...
                    _reply.readException();
                    if (_reply.readInt() != 0) {
                        _result = ImsCallProfile.CREATOR.mo3559createFromParcel(_reply);
                    } else {
                        _result = null;
                    }
                    return _result;
            ...
            public void transfer(String number, boolean isConfirmationRequired) throws RemoteException {
                ...
                try {
                    ...
                    if (!_status && Stub.getDefaultImpl() != null) {
                        Stub.getDefaultImpl().transfer(number, isConfirmationRequired);
                    } else {
                        _reply.readException();
                    }
                } finally {
            ...
            public void consultativeTransfer(IImsCallSession transferToSession) throws RemoteException {
                ...
                try {
                    _data.writeInterfaceToken(Stub.DESCRIPTOR);
                    _data.writeStrongBinder(transferToSession != null ? transferToSession.asBinder() : null);
                    boolean _status = this.mRemote.transact(17, _data, _reply, 0);
                    if (!_status && Stub.getDefaultImpl() != null) {
                        Stub.getDefaultImpl().consultativeTransfer(transferToSession);
                    } else {
                        _reply.readException();
                    }
                } finally {
            ...
            public void sendRtpHeaderExtensions(List<RtpHeaderExtension> extensions) throws RemoteException {
                ...
                try {
                    ...
                    if (!_status && Stub.getDefaultImpl() != null) {
                        Stub.getDefaultImpl().sendRtpHeaderExtensions(extensions);
                    } else {
                        _reply.readException();
                    }
                } finally {
