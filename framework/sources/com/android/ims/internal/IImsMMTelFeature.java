                ...
                default:
                    ...
                    switch (code) {
                        case 1:
                            ...
                            int _result = startSession(_arg0, _arg13);
                        ...
                        case 3:
                            ...
                            boolean isConnected = isConnected(_arg03, _arg14);
                            reply.writeNoException();
                        ...
                        case 8:
                            ...
                            ImsCallProfile _result3 = createCallProfile(_arg06, _arg15, _arg2);
                            reply.writeNoException();
                            if (_result3 != null) {
                                reply.writeInt(1);
                        ...
                        case 10:
                            ...
                            IImsCallSession _result5 = getPendingCallSession(_arg08, _arg16);
                            reply.writeNoException();
                            if (_result5 != null) {
                        ...
                        case 16:
                            ...
                            if (data.readInt() != 0) {
                                _arg12 = Message.CREATOR.mo3559createFromParcel(data);
                            } else {
                                _arg12 = null;
                            }
                            setUiTTYMode(_arg09, _arg12);
                            reply.writeNoException();
                            return true;
                        case 17:
                            data.enforceInterface(DESCRIPTOR);
