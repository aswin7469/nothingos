                ...
                default:
                    switch (code) {
                        ...
                        case 4:
                            ...
                            if (data.readInt() != 0) {
                                _arg23 = ImsReasonInfo.CREATOR.mo3559createFromParcel(data);
                            } else {
                                _arg23 = null;
                            }
                        ...
                        case 5:
                            ...
                            if (data.readInt() != 0) {
                                _arg1 = ImsSsInfo.CREATOR.mo3559createFromParcel(data);
                            } else {
                                _arg1 = null;
                            }
                        ...
                        case 9:
                            data.enforceInterface(DESCRIPTOR);
                            if (data.readInt() != 0) {
                                _arg0 = ImsSsData.CREATOR.mo3559createFromParcel(data);
                            } else {
                                _arg0 = null;
                            }
