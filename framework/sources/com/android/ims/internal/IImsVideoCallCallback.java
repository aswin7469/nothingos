...
public interface IImsVideoCallCallback extends IInterface {
    ...
    public static abstract class Stub extends Binder implements IImsVideoCallCallback {
                ...
                default:
                    switch (code) {
                        case 1:
                            ...
                            if (data.readInt() != 0) {
                                _arg0 = VideoProfile.CREATOR.mo3559createFromParcel(data);
                            } else {
                                _arg0 = null;
                            }
                        ...
                        case 2:
                            ...
                            if (data.readInt() != 0) {
                                _arg1 = VideoProfile.CREATOR.mo3559createFromParcel(data);
                            } else {
                                _arg1 = null;
                            }
                            if (data.readInt() != 0) {
                                _arg2 = VideoProfile.CREATOR.mo3559createFromParcel(data);
                            } else {
                                _arg2 = null;
                            }
                        ...
                        case 6:
                            data.enforceInterface(DESCRIPTOR);
                            if (data.readInt() != 0) {
                                _arg02 = VideoProfile.CameraCapabilities.CREATOR.mo3559createFromParcel(data);
                            } else {
                                _arg02 = null;
                            }
        ...
        public static boolean setDefaultImpl(IImsVideoCallCallback impl) {
