                ...
                default:
                    switch (code) {
                        ...
                        case 4:
                            ...
                            if (data.readInt() != 0) {
                                _arg1 = OptionsSipResponse.CREATOR.mo3559createFromParcel(data);
                            } else {
                                _arg1 = null;
                            }
                            if (data.readInt() != 0) {
                                _arg2 = OptionsCapInfo.CREATOR.mo3559createFromParcel(data);
                            } else {
                                _arg2 = null;
                            }
                        ...
                        case 5:
                            data.enforceInterface(DESCRIPTOR);
                            if (data.readInt() != 0) {
                                _arg03 = OptionsCmdStatus.CREATOR.mo3559createFromParcel(data);
                            } else {
                                _arg03 = null;
                            }
                            cmdStatus(_arg03);
                        ...
                        case 6:
                            ...
                            if (data.readInt() != 0) {
                                _arg12 = OptionsCapInfo.CREATOR.mo3559createFromParcel(data);
                            } else {
                                _arg12 = null;
                            }
