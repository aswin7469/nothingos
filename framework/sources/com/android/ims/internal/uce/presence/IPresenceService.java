                ...
                default:
                    switch (code) {
                        ...
                        case 2:
                            ...
                            if (data.readInt() != 0) {
                                _arg2 = UceLong.CREATOR.mo3559createFromParcel(data);
                            } else {
                                _arg2 = null;
                            }
                        ...
                        case 3:
                            ...
                            if (data.readInt() != 0) {
                                _arg1 = UceLong.CREATOR.mo3559createFromParcel(data);
                            } else {
                                _arg1 = null;
                            }
                        ...
                        case 5:
                            ...
                            if (data.readInt() != 0) {
                                _arg12 = PresCapInfo.CREATOR.mo3559createFromParcel(data);
                            } else {
                                _arg12 = null;
                            }
                            int _arg23 = data.readInt();
                            StatusCode _result5 = publishMyCap(_arg05, _arg12, _arg23);
                            reply.writeNoException();
                            if (_result5 != null) {
                                reply.writeInt(1);
                        ...
                        case 6:
                            ...
                            StatusCode _result6 = getContactCap(_arg06, _arg15, _arg24);
                            reply.writeNoException();
                            if (_result6 != null) {
                                reply.writeInt(1);
                        ...
                        case 7:
                            ...
                            StatusCode _result7 = getContactListCap(_arg07, _arg16, _arg25);
                            reply.writeNoException();
                            if (_result7 != null) {
                                reply.writeInt(1);
                        ...
                        case 8:
                            ...
                            if (data.readInt() != 0) {
                                _arg22 = PresServiceInfo.CREATOR.mo3559createFromParcel(data);
                            } else {
                                _arg22 = null;
                            }
        ...
        public static class Proxy implements IPresenceService {
            ...
            public StatusCode getVersion(int presenceServiceHdl) throws RemoteException {
                ...
                try {
                    ...
                    if (_reply.readInt() != 0) {
                        _result = StatusCode.CREATOR.mo3559createFromParcel(_reply);
                    } else {
                        _result = null;
                    }
                    return _result;
