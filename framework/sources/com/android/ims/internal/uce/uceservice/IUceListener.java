...
public interface IUceListener extends IInterface {
    ...
    public static abstract class Stub extends Binder implements IUceListener {
        ...
        public static IUceListener asInterface(IBinder obj) {
            if (obj == null) {
                return null;
            }
            IInterface iin = obj.queryLocalInterface(DESCRIPTOR);
            if (iin != null && (iin instanceof IUceListener)) {
                return (IUceListener) iin;
            }
            ...
            public void setStatus(int serviceStatusValue) throws RemoteException {
                ...
                try {
                    ...
                    if (!_status && Stub.getDefaultImpl() != null) {
                        Stub.getDefaultImpl().setStatus(serviceStatusValue);
                    } else {
        ...
        public static boolean setDefaultImpl(IUceListener impl) {
