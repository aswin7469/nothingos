...
public class AccessibilityButtonChooserActivity extends Activity {
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        if (rdl != null) {
            rdl.setOnDismissedListener(new ResolverDrawerLayout.OnDismissedListener() { // from class: com.android.internal.accessibility.dialog.AccessibilityButtonChooserActivity$$ExternalSyntheticLambda1
        ...
        gridview.setOnItemClickListener(new AdapterView.OnItemClickListener() { // from class: com.android.internal.accessibility.dialog.AccessibilityButtonChooserActivity$$ExternalSyntheticLambda0
            ...
            public final void onItemClick(AdapterView adapterView, View view, int i3, long j) {
                AccessibilityButtonChooserActivity.this.lambda$onCreate$0$AccessibilityButtonChooserActivity(adapterView, view, i3, j);
            }
        });
    }
