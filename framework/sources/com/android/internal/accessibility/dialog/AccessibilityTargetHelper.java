...
public final class AccessibilityTargetHelper {
    ...
    private static List<AccessibilityTarget> getAccessibilityFilteredTargets(Context context, int shortcutType) {
        ...
        for (final AccessibilityTarget activityTarget : activityTargets) {
            serviceTargets.removeIf(new Predicate() { // from class: com.android.internal.accessibility.dialog.AccessibilityTargetHelper$$ExternalSyntheticLambda2
    ...
    public static View createEnableDialogContentView(Context context, final AccessibilityServiceTarget target, final View.OnClickListener allowListener, final View.OnClickListener denyListener) {
        ...
        View content = inflater.inflate(R.layout.accessibility_enable_service_encryption_warning, (ViewGroup) null);
        TextView encryptionWarningView = (TextView) content.findViewById(R.id.accessibility_encryption_warning);
        if (StorageManager.isNonDefaultBlockEncrypted()) {
            String text = context.getString(R.string.accessibility_enable_service_encryption_warning, getServiceName(context, target.getLabel()));
        ...
        allowButton.setOnClickListener(new View.OnClickListener() { // from class: com.android.internal.accessibility.dialog.AccessibilityTargetHelper$$ExternalSyntheticLambda0
        ...
        denyButton.setOnClickListener(new View.OnClickListener() { // from class: com.android.internal.accessibility.dialog.AccessibilityTargetHelper$$ExternalSyntheticLambda1
            @Override // android.view.View.OnClickListener
            public final void onClick(View view) {
