...
class ShortcutTargetAdapter extends TargetAdapter {
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        if (convertView == null) {
            convertView = LayoutInflater.from(context).inflate(R.layout.accessibility_shortcut_chooser_item, parent, false);
            holder = new TargetAdapter.ViewHolder();
            holder.mCheckBoxView = (CheckBox) convertView.findViewById(R.id.accessibility_shortcut_target_checkbox);
            holder.mIconView = (ImageView) convertView.findViewById(R.id.accessibility_shortcut_target_icon);
            holder.mLabelView = (TextView) convertView.findViewById(R.id.accessibility_shortcut_target_label);
            holder.mStatusView = (TextView) convertView.findViewById(R.id.accessibility_shortcut_target_status);
