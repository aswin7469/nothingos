...
public abstract class AbstractMultiProfilePagerAdapter extends PagerAdapter {
    ...
    /* JADX INFO: Access modifiers changed from: package-private */
    /* renamed from: getActiveAdapterView */
    public abstract ViewGroup mo3321getActiveAdapterView();

    /* renamed from: getActiveListAdapter */
    public abstract ResolverListAdapter mo3310getActiveListAdapter();

    /* renamed from: getAdapterForIndex */
    public abstract Object mo3322getAdapterForIndex(int i);

    /* renamed from: getCurrentRootAdapter */
    abstract Object mo3323getCurrentRootAdapter();

    /* JADX INFO: Access modifiers changed from: package-private */
    /* renamed from: getInactiveAdapterView */
    public abstract ViewGroup mo3313getInactiveAdapterView();

    /* renamed from: getInactiveListAdapter */
    public abstract ResolverListAdapter mo3314getInactiveListAdapter();

    /* renamed from: getItem */
    abstract ProfileDescriptor mo3324getItem(int i);
    ...
    public abstract ResolverListAdapter mo3316getListAdapterForUserHandle(UserHandle userHandle);
    ...
    public ViewGroup mo3325instantiateItem(ViewGroup container, int position) {
        ProfileDescriptor profileDescriptor = mo3324getItem(position);
    ...
    public UserHandle getCurrentUserHandle() {
        return mo3310getActiveListAdapter().mResolverListController.getUserHandle();
    }
    ...
    public boolean rebuildActiveTab(boolean doPostProcessing) {
        return rebuildTab(mo3310getActiveListAdapter(), doPostProcessing);
    }
    ...
    public boolean rebuildInactiveTab(boolean doPostProcessing) {
        ...
        return rebuildTab(mo3314getInactiveListAdapter(), doPostProcessing);
    }
    ...
    public void updateAfterConfigChange() {
        for (int i = 0; i < getItemCount(); i++) {
            ViewGroup emptyStateView = mo3324getItem(i).getEmptyStateView();
    ...
    public /* synthetic */ void lambda$maybeShowWorkProfileOffEmptyState$0$AbstractMultiProfilePagerAdapter(ResolverListAdapter listAdapter, View v) {
        ProfileDescriptor descriptor = mo3324getItem(userHandleToPageIndex(listAdapter.getUserHandle()));
    ...
    public void showEmptyState(ResolverListAdapter activeListAdapter, int iconRes, int titleRes, int subtitleRes, View.OnClickListener buttonOnClick) {
        ProfileDescriptor descriptor = mo3324getItem(userHandleToPageIndex(activeListAdapter.getUserHandle()));
        int i = 8;
