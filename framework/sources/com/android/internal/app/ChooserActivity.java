...
public class ChooserActivity extends ResolverActivity implements ChooserListAdapter.ChooserListCommunicator, SelectableTargetInfo.SelectableTargetInfoCommunicator {
                    ...
                    case 2:
                        if (!ChooserActivity.this.isFinishing()) {
                            ...
                            if (task.mBmp != null) {
                                ...
                                fadeAnim.mo1103setDuration(150L);
                                fadeAnim.start();
        ...
        public void maybeHideContentPreview() {
            if (!this.mAtLeastOneLoaded) {
                if (this.mHideParentOnFail) {
                    ...
                    } else if (ChooserActivity.this.mChooserMultiProfilePagerAdapter.mo3323getCurrentRootAdapter() != null) {
                        ChooserActivity.this.mChooserMultiProfilePagerAdapter.mo3323getCurrentRootAdapter().hideContentPreview();
                    }
    ...
    public class ChooserHandler extends Handler {
        ...
        public void restartServiceRequestTimer() {
            ...
            removeMessages(2);
            removeMessages(3);
            Log.d(ChooserActivity.TAG, "queryTargets setting watchdog timer for 1000ms");
        ...
        private void maybeStopServiceRequestTimer() {
            if (this.mMinTimeoutPassed && ChooserActivity.this.mServiceConnections.isEmpty()) {
                ...
                ChooserActivity.this.mChooserMultiProfilePagerAdapter.mo3310getActiveListAdapter().completeServiceTargetLoading();
            }
        }
        ...
        public void handleMessage(Message msg) {
            ...
            ChooserListAdapter adapterForUserHandle2;
            if (ChooserActivity.this.mChooserMultiProfilePagerAdapter.mo3310getActiveListAdapter() == null || ChooserActivity.this.isDestroyed()) {
                return;
            }
            switch (msg.what) {
                case 1:
                    Log.d(ChooserActivity.TAG, "CHOOSER_TARGET_SERVICE_RESULT");
                    ServiceResultInfo sri = (ServiceResultInfo) msg.obj;
                    if (!ChooserActivity.this.mServiceConnections.contains(sri.connection)) {
                        Log.w(ChooserActivity.TAG, "ChooserTargetServiceConnection " + sri.connection + sri.originalTarget.getResolveInfo().activityInfo.packageName + " returned after being removed from active connections. Have you considered returning results faster?");
                        return;
                    }
                    if (sri.resultTargets != null && (adapterForUserHandle = ChooserActivity.this.mChooserMultiProfilePagerAdapter.mo3316getListAdapterForUserHandle(sri.userHandle)) != null) {
                        adapterForUserHandle.addServiceResults(sri.originalTarget, sri.resultTargets, 1, null, ChooserActivity.this.mServiceConnections);
                        if (!sri.resultTargets.isEmpty() && sri.originalTarget != null) {
                            ChooserActivity.this.mChooserTargetComponentNameCache.put(sri.resultTargets.get(0).getComponentName(), sri.originalTarget.getResolvedComponentName());
                        }
                    }
                ...
                case 3:
                    ...
                    return;
                case 4:
                    Log.d(ChooserActivity.TAG, "SHORTCUT_MANAGER_SHARE_TARGET_RESULT");
                    ServiceResultInfo resultInfo = (ServiceResultInfo) msg.obj;
                    if (resultInfo.resultTargets != null && (adapterForUserHandle2 = ChooserActivity.this.mChooserMultiProfilePagerAdapter.mo3316getListAdapterForUserHandle(resultInfo.userHandle)) != null) {
                        adapterForUserHandle2.addServiceResults(resultInfo.originalTarget, resultInfo.resultTargets, msg.arg1, ChooserActivity.this.mDirectShareShortcutInfoCache, ChooserActivity.this.mServiceConnections);
                        return;
                    }
                    return;
                case 5:
                ...
                case 6:
                    ...
                    ChooserActivity.this.mChooserMultiProfilePagerAdapter.mo3316getListAdapterForUserHandle(userHandle).refreshListView();
                    return;
                default:
    ...
    */
        ...
        if (parcelableExtra instanceof Uri) {
            ...
            if (target != null) {
                if (!isSendAction(target)) {
                    ...
                    if (pa2 == null) {
                        ComponentName[] names = new ComponentName[pa2.length + (hasNearby ? 1 : 0)];
                        int i4 = 0;
                        while (true) {
                            if (i4 >= pa2.length) {
                                break;
                    ...
                    setEnterSharedElementCallback(new SharedElementCallback() { // from class: com.android.internal.app.ChooserActivity.2
                        ...
                        public void onMapSharedElements(List<String> names2, Map<String, View> sharedElements) {
                            if (ChooserActivity.this.mRemoveSharedElements) {
                                names2.remove(ChooserActivity.FIRST_IMAGE_PREVIEW_TRANSITION_NAME);
            ...
            boolean hasNearby2 = nearbySharingComponent2 == null;
            if (pa2 == null) {
            }
            pa3 = intent.getParcelableArrayExtra(Intent.EXTRA_CHOOSER_TARGETS);
            if (pa3 != null) {
            ...
            Log.d(TAG, "System Time Cost is " + systemCost2);
    ...
    private AppPredictor.Callback createAppPredictorCallback(final ChooserListAdapter chooserListAdapter) {
        return new AppPredictor.Callback() { // from class: com.android.internal.app.ChooserActivity$$ExternalSyntheticLambda0
            @Override // android.app.prediction.AppPredictor.Callback
            public final void onTargetsAvailable(List list) {
                ChooserActivity.this.lambda$createAppPredictorCallback$0$ChooserActivity(chooserListAdapter, list);
            }
        };
    }

    public /* synthetic */ void lambda$createAppPredictorCallback$0$ChooserActivity(ChooserListAdapter chooserListAdapter, List resultList) {
    ...
    private ChooserMultiProfilePagerAdapter createChooserMultiProfilePagerAdapterForOneProfile(Intent[] initialIntents, List<ResolveInfo> rList, boolean filterLastUsed) {
        ChooserGridAdapter adapter = createChooserGridAdapter(this, this.mIntents, initialIntents, rList, filterLastUsed, UserHandle.of(UserHandle.myUserId()));
        return new ChooserMultiProfilePagerAdapter(this, adapter, getPersonalProfileUserHandle(), null, isSendAction(getTargetIntent()), getMaxTargetsPerRow());
    }
    ...
    private ChooserMultiProfilePagerAdapter createChooserMultiProfilePagerAdapterForTwoProfiles(Intent[] initialIntents, List<ResolveInfo> rList, boolean filterLastUsed) {
        ...
        return new ChooserMultiProfilePagerAdapter(this, personalAdapter, workAdapter, selectedProfile, getPersonalProfileUserHandle(), getWorkProfileUserHandle(), isSendAction(getTargetIntent()), getMaxTargetsPerRow());
    }

    private int findSelectedProfile() {
        int selectedProfile = getSelectedProfileExtra();
        if (selectedProfile == -1) {
            return getProfileForUser(getUser());
        }
    ...
    protected boolean postRebuildList(boolean rebuildCompleted) {
        ...
        if (shouldShowStickyContentPreview() || this.mChooserMultiProfilePagerAdapter.mo3323getCurrentRootAdapter().getSystemRowCount() != 0) {
    ...
    public void handlePackagesChanged(ResolverListAdapter listAdapter) {
        this.mPinnedSharedPrefs = getPinnedSharedPrefs(this);
        if (listAdapter == null) {
            this.mChooserMultiProfilePagerAdapter.mo3310getActiveListAdapter().handlePackagesChanged();
            if (this.mChooserMultiProfilePagerAdapter.getCount() > 1) {
                this.mChooserMultiProfilePagerAdapter.mo3314getInactiveListAdapter().handlePackagesChanged();
            }
        } else {
    ...
    /* JADX INFO: Access modifiers changed from: private */
    public ViewGroup createContentPreviewView(ViewGroup parent) {
        Intent targetIntent = getTargetIntent();
    ...
    protected TargetInfo getEditSharingTarget(Intent originalIntent) {
        ...
        ClipData previewData = originalIntent.getClipData();
        if (previewData != null && previewData.getItemCount() > 0) {
            ClipData.Item previewDataItem = previewData.getItemAt(0);
            Uri uri2 = previewDataItem.getUri();
            uri = uri2;
        } else {
            uri = null;
        }
        resolveIntent.setDataAndType(uri, ContentType.IMAGE_PNG);
        resolveIntent.addFlags(3);
    ...
    private Button createCopyButton() {
        Button b = createActionButton(getDrawable(R.drawable.ic_menu_copy_material), getString(17039361), new View.OnClickListener() { // from class: com.android.internal.app.ChooserActivity$$ExternalSyntheticLambda1
    ...
    public /* synthetic */ void lambda$createNearbyButton$1$ChooserActivity(TargetInfo ti, View unused) {
        getChooserActivityLogger().logShareTargetSelected(5, "", -1);
    ...
    private Button createEditButton(Intent originalIntent) {
        ...
        Button b = createActionButton(ti.getDisplayIcon(this), ti.getDisplayLabel(), new View.OnClickListener() { // from class: com.android.internal.app.ChooserActivity$$ExternalSyntheticLambda2
            @Override // android.view.View.OnClickListener
            public final void onClick(View view) {
                ChooserActivity.this.lambda$createEditButton$2$ChooserActivity(ti, view);
            }
        });
    ...
    public /* synthetic */ void lambda$createEditButton$2$ChooserActivity(TargetInfo ti, View unused) {
        getChooserActivityLogger().logShareTargetSelected(6, "", -1);
        safelyStartActivityAsUser(ti, getPersonalProfileUserHandle());
        finish();
    }
    ...
    private ViewGroup displayTextContentPreview(Intent targetIntent, LayoutInflater layoutInflater, ViewGroup parent) {
        ...
        if (TextUtils.isEmpty(previewTitle)) {
            ...
            if (previewThumbnail == null) {
                ...
                contentPreviewCoordinator.loadUriIntoView(R.id.content_preview_thumbnail, previewThumbnail, 0);
            }
        }
    ...
    private ViewGroup displayImageContentPreview(Intent targetIntent, LayoutInflater layoutInflater, ViewGroup parent) {
        ...
        String action = targetIntent.getAction();
        if (Intent.ACTION_SEND.equals(action)) {
            imagePreview.findViewById(R.id.content_preview_image_1_large).setTransitionName(FIRST_IMAGE_PREVIEW_TRANSITION_NAME);
    ...
    protected void onDestroy() {
        ...
        this.mChooserMultiProfilePagerAdapter.mo3310getActiveListAdapter().destroyAppPredictor();
        if (this.mChooserMultiProfilePagerAdapter.mo3314getInactiveListAdapter() != null) {
            this.mChooserMultiProfilePagerAdapter.mo3314getInactiveListAdapter().destroyAppPredictor();
        }
    }
    ...
    public void addUseDifferentAppLabelIfNecessary(ResolverListAdapter adapter) {
        ...
        if (chooserTargetArr != null && chooserTargetArr.length > 0) {
            this.mChooserMultiProfilePagerAdapter.mo3310getActiveListAdapter().addServiceResults(null, Lists.newArrayList(this.mCallerChooserTargets), 0, null, this.mServiceConnections);
        }
    }
    ...
    /* JADX INFO: Access modifiers changed from: private */
    public void showTargetDetails(DisplayResolveInfo ti) {
        ...
        Bundle b = new Bundle();
        b.putParcelable(ChooserTargetActionsDialogFragment.USER_HANDLE_KEY, this.mChooserMultiProfilePagerAdapter.getCurrentUserHandle());
        b.putParcelableArrayList(ChooserTargetActionsDialogFragment.TARGET_INFOS_KEY, targetList);
        f.setArguments(b);
    ...
    public void startSelected(int which, boolean always, boolean filtered) {
        ChooserListAdapter currentListAdapter = this.mChooserMultiProfilePagerAdapter.mo3310getActiveListAdapter();
            ...
            if (currentListAdapter.getCount() > 0) {
                ...
                switch (currentListAdapter.getPositionTargetType(which)) {
                    ...
                    case 2:
                        ...
                        getChooserActivityLogger().logShareTargetSelected(2, targetInfo.getResolveInfo().activityInfo.processName, value);
                        break;
                    case 1:
                        cat = 216;
                        ...
                        getChooserActivityLogger().logShareTargetSelected(1, targetInfo.getResolveInfo().activityInfo.processName, value);
                        break;
                    case 3:
                        value = -1;
                        cat = 217;
                        getChooserActivityLogger().logShareTargetSelected(3, targetInfo.getResolveInfo().activityInfo.processName, -1);
                        break;
                }
                if (cat != 0) {
    ...
    protected void applyFooterView(int height) {
        ...
        for (int i = 0; i < count; i++) {
            this.mChooserMultiProfilePagerAdapter.mo3322getAdapterForIndex(i).setFooterHeight(height);
        }
    }
    ...
    protected void queryTargetServices(ChooserListAdapter adapter) {
        ...
        Context selectedProfileContext2 = createContextAsUser(adapter.getUserHandle(), 0);
        PackageManager pm = selectedProfileContext2.getPackageManager();
        ShortcutManager sm = (ShortcutManager) selectedProfileContext2.getSystemService(ShortcutManager.class);
        ...
        while (true) {
            ...
            if (chooserListAdapter.getScore(dri) == 0.0f) {
                perm = str2;
                selectedProfileContext = selectedProfileContext2;
            } else {
                ...
                if (sm.hasShareTargets(ai.packageName)) {
                    ...
                    if (serviceName == null || !ChooserFlags.USE_SERVICE_TARGETS_FOR_DIRECT_TARGETS) {
                        ...
                        Pair<ComponentName, UserHandle> requestedItem = new Pair<>(serviceComponent, userHandle);
                        if (this.mServicesRequested.contains(requestedItem)) {
                            perm = str2;
                            selectedProfileContext = selectedProfileContext2;
                        } else {
                            this.mServicesRequested.add(requestedItem);
                            Intent serviceIntent = new Intent(ChooserTargetService.SERVICE_INTERFACE).setComponent(serviceComponent);
                            StringBuilder sb = new StringBuilder();
                            selectedProfileContext = selectedProfileContext2;
                            sb.append("queryTargets found target with service ");
                            sb.append(serviceComponent);
                            Log.d(TAG, sb.toString());
                            try {
                                String perm2 = pm.getServiceInfo(serviceComponent, 0).permission;
                                if (str2.equals(perm2)) {
                                    ChooserTargetServiceConnection conn = new ChooserTargetServiceConnection(this, dri, adapter.getUserHandle());
                                    perm = str2;
                                    if (bindServiceAsUser(serviceIntent, conn, 5, adapter.getUserHandle())) {
            ...
            selectedProfileContext2 = selectedProfileContext;
            str2 = perm;
        }
    ...
    protected void queryDirectShareTargets(final ChooserListAdapter adapter, boolean skipAppPredictionService) {
        ...
        AsyncTask.execute(new Runnable() { // from class: com.android.internal.app.ChooserActivity$$ExternalSyntheticLambda6
            @Override // java.lang.Runnable
            public final void run() {
                ChooserActivity.this.lambda$queryDirectShareTargets$3$ChooserActivity(userHandle, filter, adapter);
            }
        });
    }

    public /* synthetic */ void lambda$queryDirectShareTargets$3$ChooserActivity(UserHandle userHandle, IntentFilter filter, ChooserListAdapter adapter) {
    ...
    private void sendShareShortcutInfoList(List<ShortcutManager.ShareShortcutInfo> resultList, ChooserListAdapter chooserListAdapter, List<AppTarget> appTargets, UserHandle userHandle) {
        ...
        for (int i2 = 0; i2 < chooserListAdapter.getDisplayResolveInfoCount(); i2++) {
            ...
            for (int j = 0; j < resultList.size(); j++) {
                if (chooserListAdapter.getDisplayResolveInfo(i2).getResolvedComponentName().equals(resultList.get(j).getTargetComponent())) {
            ...
            if (!matchingShortcuts.isEmpty()) {
                ...
                Message msg = Message.obtain();
                msg.what = 4;
                msg.obj = new ServiceResultInfo(chooserListAdapter.getDisplayResolveInfo(i2), chooserTargets, null, userHandle);
    ...
    public List<ChooserTarget> convertToChooserTarget(List<ShortcutManager.ShareShortcutInfo> matchingShortcuts, List<ShortcutManager.ShareShortcutInfo> allShortcuts, List<AppTarget> allAppTargets, int shortcutType) {
        ...
        for (int i2 = 0; i2 < matchingShortcuts.size(); i2++) {
            ...
            ChooserTarget chooserTarget = new ChooserTarget(shortcutInfo.getLabel(), null, score, matchingShortcuts.get(i2).getTargetComponent().m671clone(), extras);
        ...
        Comparator<ChooserTarget> byScore = ChooserActivity$$ExternalSyntheticLambda8.INSTANCE;
    ...
    private String convertServiceName(String packageName, String serviceName) {
        ...
        if (serviceName.startsWith(MediaMetrics.SEPARATOR)) {
    ...
    private void sendImpressionToAppPredictor(TargetInfo targetInfo, ChooserListAdapter adapter) {
        ...
        for (ChooserTargetInfo chooserTargetInfo : surfacedTargetInfo) {
            ...
            ComponentName componentName = this.mChooserTargetComponentNameCache.getOrDefault(chooserTarget.getComponentName(), chooserTarget.getComponentName());
    ...
    void filterServiceTargets(Context contextAsUser, String packageName, List<ChooserTarget> targets) {
        if (targets == null) {
            return;
        }
    ...
    public class ChooserListController extends ResolverListController {
        public ChooserListController(Context context, PackageManager pm, Intent targetIntent, String referrerPackageName, int launchedFromUid, UserHandle userId, AbstractResolverComparator resolverComparator) {
            super(context, pm, targetIntent, referrerPackageName, launchedFromUid, userId, resolverComparator);
        }
    ...
    public ChooserGridAdapter createChooserGridAdapter(Context context, List<Intent> payloadIntents, Intent[] initialIntents, List<ResolveInfo> rList, boolean filterLastUsed, UserHandle userHandle) {
        ChooserListAdapter chooserListAdapter = createChooserListAdapter(context, payloadIntents, initialIntents, rList, filterLastUsed, createListController(userHandle));
    ...
    public ChooserListAdapter createChooserListAdapter(Context context, List<Intent> payloadIntents, Intent[] initialIntents, List<ResolveInfo> rList, boolean filterLastUsed, ResolverListController resolverListController) {
        return new ChooserListAdapter(context, payloadIntents, initialIntents, rList, filterLastUsed, resolverListController, this, this, context.getPackageManager(), getChooserActivityLogger());
    }
    ...
    protected ResolverListController createListController(UserHandle userHandle) {
        ...
        if (appPredictor != null) {
            ...
            resolverComparator = new ResolverRankerServiceResolverComparator(this, getTargetIntent(), getReferrerPackageName(), null, getChooserActivityLogger());
        }
        return new ChooserListController(this, this.mPm, getTargetIntent(), getReferrerPackageName(), this.mLaunchedFromUid, userHandle, resolverComparator);
    }
    ...
    public void handleScroll(View view, int x, int y, int oldx, int oldy) {
        if (this.mChooserMultiProfilePagerAdapter.mo3323getCurrentRootAdapter() != null) {
            this.mChooserMultiProfilePagerAdapter.mo3323getCurrentRootAdapter().handleScroll(view, y, oldy);
        }
    }
    ...
    public void handleLayoutChange(View v, int left, final int top, int right, final int bottom, int oldLeft, int oldTop, int oldRight, int oldBottom) {
        ...
        final RecyclerView recyclerView = chooserMultiProfilePagerAdapter.mo3321getActiveAdapterView();
        final ChooserGridAdapter gridAdapter = this.mChooserMultiProfilePagerAdapter.mo3323getCurrentRootAdapter();
        ...
        if (isLayoutUpdated || this.mLastNumberOfChildren != recyclerView.getChildCount()) {
            this.mCurrAvailableWidth = availableWidth;
            if (isLayoutUpdated) {
                recyclerView.setAdapter(gridAdapter);
                ((GridLayoutManager) recyclerView.getLayoutManager()).setSpanCount(getMaxTargetsPerRow());
            }
            ...
            if (currentProfile != initialProfile || this.mLastNumberOfChildren == recyclerView.getChildCount()) {
                return;
            }
            getMainThreadHandler().post(new Runnable() { // from class: com.android.internal.app.ChooserActivity$$ExternalSyntheticLambda7
                @Override // java.lang.Runnable
                public final void run() {
                    ChooserActivity.this.lambda$handleLayoutChange$5$ChooserActivity(gridAdapter, recyclerView, bottom, top);
                }
            });
        }
    }

    public /* synthetic */ void lambda$handleLayoutChange$5$ChooserActivity(ChooserGridAdapter gridAdapter, RecyclerView recyclerView, int bottom, int top) {
        boolean z;
    ...
    private boolean shouldShowExtraRow(int rowsToShow) {
        if (shouldShowTabs() && rowsToShow == 1) {
            ChooserMultiProfilePagerAdapter chooserMultiProfilePagerAdapter = this.mChooserMultiProfilePagerAdapter;
            if (chooserMultiProfilePagerAdapter.shouldShowEmptyStateScreen(chooserMultiProfilePagerAdapter.mo3314getInactiveListAdapter())) {
                return true;
            }
        }
        return false;
    ...
    private ViewGroup getActiveEmptyStateView() {
        ...
        return this.mChooserMultiProfilePagerAdapter.mo3324getItem(currentPage).getEmptyStateView();
    }
    ...
    public void onHandlePackagesChanged(ResolverListAdapter listAdapter) {
        this.mServicesRequested.clear();
        this.mChooserMultiProfilePagerAdapter.mo3310getActiveListAdapter().notifyDataSetChanged();
    ...
    public ResolverListAdapter.ActivityInfoPresentationGetter makePresentationGetter(ActivityInfo info) {
        return this.mChooserMultiProfilePagerAdapter.mo3310getActiveListAdapter().makePresentationGetter(info);
    }
    ...
    public void sendListViewUpdateMessage(UserHandle userHandle) {
        ...
        msg.what = 6;
        msg.obj = userHandle;
        this.mChooserHandler.sendMessageDelayed(msg, 250L);
    }
    ...
    public void onListRebuilt(ResolverListAdapter listAdapter) {
        ...
        if (chooserListAdapter.getUserHandle().equals(this.mChooserMultiProfilePagerAdapter.getCurrentUserHandle())) {
            this.mChooserMultiProfilePagerAdapter.mo3321getActiveAdapterView().setAdapter(this.mChooserMultiProfilePagerAdapter.mo3323getCurrentRootAdapter());
            ChooserMultiProfilePagerAdapter chooserMultiProfilePagerAdapter = this.mChooserMultiProfilePagerAdapter;
        ...
        } else if (!shouldQueryShortcutManager(chooserListAdapter.getUserHandle())) {
            getChooserActivityLogger().logSharesheetAppLoadComplete();
        } else {
    ...
    private void setupScrollListener() {
        ...
        this.mChooserMultiProfilePagerAdapter.mo3321getActiveAdapterView().addOnScrollListener(new RecyclerView.OnScrollListener() { // from class: com.android.internal.app.ChooserActivity.4
    ...
    private void maybeSetupGlobalLayoutListener() {
        ...
        final View recyclerView = this.mChooserMultiProfilePagerAdapter.mo3321getActiveAdapterView();
    ...
    private boolean shouldShowStickyContentPreviewNoOrientationCheck() {
        return shouldShowTabs() && this.mMultiProfilePagerAdapter.mo3316getListAdapterForUserHandle(UserHandle.of(UserHandle.myUserId())).getCount() > 0 && isSendAction(getTargetIntent());
    }
        ...
        ItemViewHolder(View itemView, boolean isClickable, int viewType) {
            ...
            if (isClickable) {
                itemView.setOnClickListener(new View.OnClickListener() { // from class: com.android.internal.app.ChooserActivity$ItemViewHolder$$ExternalSyntheticLambda0
                    @Override // android.view.View.OnClickListener
                    public final void onClick(View view) {
                        ChooserActivity.ItemViewHolder.this.lambda$new$0$ChooserActivity$ItemViewHolder(view);
                    }
                });
                itemView.setOnLongClickListener(new View.OnLongClickListener() { // from class: com.android.internal.app.ChooserActivity$ItemViewHolder$$ExternalSyntheticLambda1
                    ...
                    public final boolean onLongClick(View view) {
                        return ChooserActivity.ItemViewHolder.this.lambda$new$1$ChooserActivity$ItemViewHolder(view);
                    }
                });
            }
        }

        public /* synthetic */ void lambda$new$0$ChooserActivity$ItemViewHolder(View v) {
            ChooserActivity.this.startSelected(this.mListPosition, false, true);
        }

        public /* synthetic */ boolean lambda$new$1$ChooserActivity$ItemViewHolder(View v) {
            TargetInfo ti = ChooserActivity.this.mChooserMultiProfilePagerAdapter.mo3310getActiveListAdapter().targetInfoForPosition(this.mListPosition, true);
    ...
    protected void onProfileTabSelected() {
        ChooserGridAdapter currentRootAdapter = this.mChooserMultiProfilePagerAdapter.mo3323getCurrentRootAdapter();
    ...
    private void setVerticalScrollEnabled(boolean enabled) {
        ChooserGridLayoutManager layoutManager = (ChooserGridLayoutManager) this.mChooserMultiProfilePagerAdapter.mo3321getActiveAdapterView().getLayoutManager();
    ...
    public final class ChooserGridAdapter extends RecyclerView.Adapter<RecyclerView.ViewHolder> {
        ...
        public boolean calculateChooserTargetWidth(int width) {
            int newWidth;
            if (width == 0 || (newWidth = width / ChooserActivity.this.getMaxTargetsPerRow()) == this.mChooserTargetWidth) {
                return false;
            }
        ...
        public int getRowCount() {
            return (int) (getSystemRowCount() + getProfileRowCount() + getServiceTargetRowCount() + getCallerAndRankedTargetRowCount() + getAzLabelRowCount() + Math.ceil(this.mChooserListAdapter.getAlphaTargetCount() / ChooserActivity.this.getMaxTargetsPerRow()));
        }
        ...
        public int getSystemRowCount() {
            ...
            return (!chooserActivity.isSendAction(chooserActivity.getTargetIntent()) || (chooserListAdapter = this.mChooserListAdapter) == null || chooserListAdapter.getCount() == 0) ? 0 : 1;
        }

        public int getProfileRowCount() {
            return (!ChooserActivity.this.shouldShowTabs() && this.mChooserListAdapter.getOtherProfile() != null) ? 1 : 0;
        }
        ...
        public int getCallerAndRankedTargetRowCount() {
            return (int) Math.ceil((this.mChooserListAdapter.getCallerTargetCount() + this.mChooserListAdapter.getRankedTargetCount()) / ChooserActivity.this.getMaxTargetsPerRow());
        }
        ...
        public RecyclerView.ViewHolder mo3317onCreateViewHolder(ViewGroup parent, int viewType) {
            switch (viewType) {
                case 0:
                case 5:
            ...
            for (int i = 0; i < columnCount; i++) {
                ...
                if (!isDirectShare) {
                    v.setOnLongClickListener(new View.OnLongClickListener() { // from class: com.android.internal.app.ChooserActivity$ChooserGridAdapter$$ExternalSyntheticLambda1
                        @Override // android.view.View.OnLongClickListener
                        public final boolean onLongClick(View view) {
                            return ChooserActivity.ChooserGridAdapter.this.lambda$loadViewsIntoGroup$0$ChooserActivity$ChooserGridAdapter(holder, column, view);
                        }
                    });
                }
                holder.addView(i, v);
        ...
        public /* synthetic */ boolean lambda$loadViewsIntoGroup$0$ChooserActivity$ChooserGridAdapter(ItemGroupViewHolder holder, int column, View v1) {
        ...
        ItemGroupViewHolder createItemGroupViewHolder(int viewType, ViewGroup parent) {
            if (viewType != 0) {
                ...
                ChooserActivity chooserActivity = ChooserActivity.this;
                ItemGroupViewHolder holder = new SingleRowViewHolder(row, chooserActivity.getMaxTargetsPerRow(), viewType);
            ...
            DirectShareViewHolder directShareViewHolder = new DirectShareViewHolder(parentGroup, Lists.newArrayList(row1, row2), ChooserActivity.this.getMaxTargetsPerRow(), viewType);
        ...
        void bindItemGroupViewHolder(int position, ItemGroupViewHolder holder) {
            ...
            if (end == start && (this.mChooserListAdapter.mo3505getItem(start) instanceof EmptyTargetInfo)) {
                ...
                if (textView.getVisibility() != 0) {
                    ...
                    animSet.mo1103setDuration(200L);
        ...
        int getListPosition(int position) {
            ...
            if (position2 < serviceRows) {
                return ChooserActivity.this.getMaxTargetsPerRow() * position2;
            }
            ...
            if (position3 < callerAndRankedRows) {
                return (ChooserActivity.this.getMaxTargetsPerRow() * position3) + serviceCount;
            }
        ...
        public void handleScroll(View v, int y, int oldy) {
            ...
            if (directShareViewHolder != null && canExpandDirectShare) {
                directShareViewHolder.handleScroll(ChooserActivity.this.mChooserMultiProfilePagerAdapter.mo3321getActiveAdapterView(), y, oldy, ChooserActivity.this.getMaxTargetsPerRow());
            }
        }
        ...
        void updateDirectShareExpansion() {
            ...
            RecyclerView activeAdapterView = ChooserActivity.this.mChooserMultiProfilePagerAdapter.mo3321getActiveAdapterView();
    ...
    public class DirectShareViewHolder extends ItemGroupViewHolder {
        ...
        DirectShareViewHolder(ViewGroup parent, List<ViewGroup> rows, int cellCountPerRow, int viewType) {
        ...
        public void setViewVisibility(int i, int visibility) {
            ...
            if (visibility == 0) {
                ...
                if (zArr[i]) {
                    ...
                    fadeAnim.mo1103setDuration(200L);
        ...
        public void handleScroll(RecyclerView view, int y, int oldy, int maxTargetsPerRow) {
            ...
            if (notExpanded) {
                ...
                ChooserListAdapter adapter = ChooserActivity.this.mChooserMultiProfilePagerAdapter.mo3310getActiveListAdapter();
    ...
    public static class ChooserTargetServiceConnection implements ServiceConnection {
        ...
        private final IChooserTargetResult mChooserTargetResult = new IChooserTargetResult.Stub() { // from class: com.android.internal.app.ChooserActivity.ChooserTargetServiceConnection.1
            ...
            public void sendResult(List<ChooserTarget> targets) throws RemoteException {
                synchronized (ChooserTargetServiceConnection.this.mLock) {
                    ...
                    Context contextAsUser = ChooserTargetServiceConnection.this.mChooserActivity.createContextAsUser(ChooserTargetServiceConnection.this.mUserHandle, 0);
                    ChooserTargetServiceConnection.this.mChooserActivity.filterServiceTargets(contextAsUser, ChooserTargetServiceConnection.this.mOriginalTarget.getResolveInfo().activityInfo.packageName, targets);
                    Message msg = Message.obtain();
                    msg.what = 1;
                    ...
                    msg.obj = new ServiceResultInfo(displayResolveInfo, targets, chooserTargetServiceConnection, chooserTargetServiceConnection.mUserHandle);
                    ChooserTargetServiceConnection.this.mChooserActivity.mChooserHandler.sendMessage(msg);
                }
            }
        };

        public ChooserTargetServiceConnection(ChooserActivity chooserActivity, DisplayResolveInfo dri, UserHandle userHandle) {
        ...
        public void onServiceConnected(ComponentName name, IBinder service) {
            Log.d(ChooserActivity.TAG, "onServiceConnected: " + name);
        ...
        public void onServiceDisconnected(ComponentName name) {
            Log.d(ChooserActivity.TAG, "onServiceDisconnected: " + name);
            synchronized (this.mLock) {
    ...
    public static class ServiceResultInfo {
        ...
        public ServiceResultInfo(DisplayResolveInfo ot, List<ChooserTarget> rt, ChooserTargetServiceConnection c, UserHandle userHandle) {
