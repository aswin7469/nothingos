...
public class ChooserMultiProfilePagerAdapter extends AbstractMultiProfilePagerAdapter {
    ...
    RecyclerView getListViewForIndex(int index) {
        return mo3324getItem(index).recyclerView;
    }
    ...
    public ChooserProfileDescriptor mo3324getItem(int pageIndex) {
    ...
    public ChooserActivity.ChooserGridAdapter mo3322getAdapterForIndex(int pageIndex) {
    ...
    public ChooserListAdapter mo3316getListAdapterForUserHandle(UserHandle userHandle) {
    ...
    public void setupListAdapter(int pageIndex) {
        RecyclerView recyclerView = mo3324getItem(pageIndex).recyclerView;
        final ChooserActivity.ChooserGridAdapter chooserGridAdapter = mo3324getItem(pageIndex).chooserGridAdapter;
    ...
    public ChooserListAdapter mo3310getActiveListAdapter() {
        return mo3322getAdapterForIndex(getCurrentPage()).getListAdapter();
    }

    @Override // com.android.internal.app.AbstractMultiProfilePagerAdapter
    /* renamed from: getInactiveListAdapter */
    public ChooserListAdapter mo3314getInactiveListAdapter() {
        if (getCount() == 1) {
            return null;
        }
        return mo3322getAdapterForIndex(1 - getCurrentPage()).getListAdapter();
    }

    @Override // com.android.internal.app.AbstractMultiProfilePagerAdapter
    public ResolverListAdapter getPersonalListAdapter() {
        return mo3322getAdapterForIndex(0).getListAdapter();
    }

    @Override // com.android.internal.app.AbstractMultiProfilePagerAdapter
    public ResolverListAdapter getWorkListAdapter() {
        return mo3322getAdapterForIndex(1).getListAdapter();
    }

    /* JADX INFO: Access modifiers changed from: package-private */
    @Override // com.android.internal.app.AbstractMultiProfilePagerAdapter
    /* renamed from: getCurrentRootAdapter */
    public ChooserActivity.ChooserGridAdapter mo3323getCurrentRootAdapter() {
    ...
    public RecyclerView mo3321getActiveAdapterView() {
        return getListViewForIndex(getCurrentPage());
    }

    /* JADX INFO: Access modifiers changed from: package-private */
    @Override // com.android.internal.app.AbstractMultiProfilePagerAdapter
    /* renamed from: getInactiveAdapterView  reason: collision with other method in class */
    public RecyclerView mo3313getInactiveAdapterView() {
        if (getCount() == 1) {
            return null;
        }
