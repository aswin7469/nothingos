                ...
                default:
                    ...
                    switch (code) {
                        case 1:
                            ...
                            int _result = checkOperation(_arg03, _arg16, _arg23);
                        ...
                        case 2:
                            ...
                            SyncNotedAppOp _result2 = noteOperation(_arg04, _arg17, _arg24, _arg32, _arg43, _arg54, _arg63);
                            reply.writeNoException();
                            if (_result2 != null) {
                                reply.writeInt(1);
                        ...
                        case 3:
                            ...
                            SyncNotedAppOp _result3 = startOperation(_arg05, _arg18, _arg25, _arg33, _arg44, _arg5, _arg6, _arg7, _arg8, _arg93, _arg10);
                            reply.writeNoException();
                            if (_result3 != null) {
                                reply.writeInt(1);
                        ...
                        case 4:
                            ...
                            finishOperation(_arg06, _arg19, _arg26, _arg34, _arg45);
                            reply.writeNoException();
                            return true;
                        case 5:
                            data.enforceInterface(DESCRIPTOR);
                            ...
                            IAppOpsCallback _arg27 = IAppOpsCallback.Stub.asInterface(data.readStrongBinder());
                            startWatchingMode(_arg07, _arg110, _arg27);
                            reply.writeNoException();
                            return true;
                        case 6:
                            data.enforceInterface(DESCRIPTOR);
                        ...
                        case 8:
                            ...
                            int _result5 = checkAudioOperation(_arg010, _arg111, _arg28, _arg35);
                            reply.writeNoException();
                        ...
                        case 13:
                            ...
                            boolean _arg29 = z;
                            finishProxyOperation(_arg015, _arg13, _arg29);
                            reply.writeNoException();
                            return true;
                        case 14:
                            data.enforceInterface(DESCRIPTOR);
                        ...
                        case 16:
                            ...
                            if (data.readInt() != 0) {
                                _arg14 = SyncNotedAppOp.CREATOR.mo3559createFromParcel(data);
                            } else {
                                _arg14 = null;
                            }
                        ...
                        case 19:
                            ...
                            if (data.readInt() != 0) {
                                _arg9 = RemoteCallback.CREATOR.mo3559createFromParcel(data);
                            } else {
                                _arg9 = null;
                            }
                        ...
                        case 20:
                            ...
                            if (data.readInt() != 0) {
                                _arg92 = RemoteCallback.CREATOR.mo3559createFromParcel(data);
                            } else {
                                _arg92 = null;
                            }
                        ...
                        case 23:
                            data.enforceInterface(DESCRIPTOR);
                            if (data.readInt() != 0) {
                                _arg0 = AppOpsManager.HistoricalOps.CREATOR.mo3559createFromParcel(data);
                            } else {
                                _arg0 = null;
                            }
                        ...
                        case 34:
                            ...
                            if (data.readInt() != 0) {
                                _arg42 = PackageTagsList.CREATOR.mo3559createFromParcel(data);
                            } else {
                                _arg42 = null;
                            }
        ...
        public static class Proxy implements IAppOpsService {
                            ...
                            try {
                                ...
                                try {
                                    ...
                                    try {
                                        ...
                                        _reply.readException();
                                        if (_reply.readInt() != 0) {
                                            _result = SyncNotedAppOp.CREATOR.mo3559createFromParcel(_reply);
                                        } else {
                                            _result = null;
                                        }
                                        _reply.recycle();
            ...
            public RuntimeAppOpAccessMessage collectRuntimeAppOpAccessMessage() throws RemoteException {
                ...
                try {
                    ...
                    _reply.readException();
                    if (_reply.readInt() != 0) {
                        _result = RuntimeAppOpAccessMessage.CREATOR.mo3559createFromParcel(_reply);
                    } else {
                        _result = null;
                    }
                    return _result;
            ...
            public MessageSamplingConfig reportRuntimeAppOpAccessMessageAndGetConfig(String packageName, SyncNotedAppOp appOp, String message) throws RemoteException {
                ...
                try {
                    ...
                    _reply.readException();
                    if (_reply.readInt() != 0) {
                        _result = MessageSamplingConfig.CREATOR.mo3559createFromParcel(_reply);
                    } else {
                        _result = null;
                    }
                    return _result;
