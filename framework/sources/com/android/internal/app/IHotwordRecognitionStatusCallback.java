                ...
                default:
                    switch (code) {
                        case 1:
                            ...
                            if (data.readInt() != 0) {
                                _arg1 = HotwordDetectedResult.CREATOR.mo3559createFromParcel(data);
                            } else {
                                _arg1 = null;
                            }
                        ...
                        case 2:
                            data.enforceInterface(IHotwordRecognitionStatusCallback.DESCRIPTOR);
                            if (data.readInt() != 0) {
                                _arg02 = SoundTrigger.GenericRecognitionEvent.CREATOR.mo3559createFromParcel(data);
                            } else {
                                _arg02 = null;
                            }
                        ...
                        case 3:
                            data.enforceInterface(IHotwordRecognitionStatusCallback.DESCRIPTOR);
                            if (data.readInt() != 0) {
                                _arg03 = HotwordRejectedResult.CREATOR.mo3559createFromParcel(data);
                            } else {
                                _arg03 = null;
                            }
                            onRejected(_arg03);
