                ...
                default:
                    ...
                    switch (code) {
                        ...
                        case 2:
                            data.enforceInterface(ISoundTriggerSession.DESCRIPTOR);
                            if (data.readInt() != 0) {
                                _arg02 = SoundTrigger.GenericSoundModel.CREATOR.mo3559createFromParcel(data);
                            } else {
                                _arg02 = null;
                            }
                        ...
                        case 3:
                            data.enforceInterface(ISoundTriggerSession.DESCRIPTOR);
                            if (data.readInt() != 0) {
                                _arg03 = ParcelUuid.CREATOR.mo3559createFromParcel(data);
                            } else {
                                _arg03 = null;
                            }
                        ...
                        case 4:
                            data.enforceInterface(ISoundTriggerSession.DESCRIPTOR);
                            if (data.readInt() != 0) {
                                _arg04 = ParcelUuid.CREATOR.mo3559createFromParcel(data);
                            } else {
                                _arg04 = null;
                            }
                            IRecognitionStatusCallback _arg12 = IRecognitionStatusCallback.Stub.asInterface(data.readStrongBinder());
                            if (data.readInt() != 0) {
                                _arg2 = SoundTrigger.RecognitionConfig.CREATOR.mo3559createFromParcel(data);
                            } else {
                                _arg2 = null;
                            }
                            if (data.readInt() != 0) {
                        ...
                        case 5:
                            data.enforceInterface(ISoundTriggerSession.DESCRIPTOR);
                            if (data.readInt() != 0) {
                                _arg05 = ParcelUuid.CREATOR.mo3559createFromParcel(data);
                            } else {
                                _arg05 = null;
                            }
                        ...
                        case 6:
                            data.enforceInterface(ISoundTriggerSession.DESCRIPTOR);
                            if (data.readInt() != 0) {
                                _arg06 = SoundTrigger.GenericSoundModel.CREATOR.mo3559createFromParcel(data);
                            } else {
                                _arg06 = null;
                            }
                        ...
                        case 7:
                            data.enforceInterface(ISoundTriggerSession.DESCRIPTOR);
                            if (data.readInt() != 0) {
                                _arg07 = SoundTrigger.KeyphraseSoundModel.CREATOR.mo3559createFromParcel(data);
                            } else {
                                _arg07 = null;
                            }
                        ...
                        case 8:
                            ...
                            if (data.readInt() != 0) {
                                _arg22 = ComponentName.CREATOR.mo3559createFromParcel(data);
                            } else {
                                _arg22 = null;
                            }
                            if (data.readInt() != 0) {
                                _arg3 = SoundTrigger.RecognitionConfig.CREATOR.mo3559createFromParcel(data);
                            } else {
                                _arg3 = null;
                            }
                        ...
                        case 9:
                            data.enforceInterface(ISoundTriggerSession.DESCRIPTOR);
                            if (data.readInt() != 0) {
                                _arg09 = ParcelUuid.CREATOR.mo3559createFromParcel(data);
                            } else {
                                _arg09 = null;
                            }
                        ...
                        case 10:
                            data.enforceInterface(ISoundTriggerSession.DESCRIPTOR);
                            if (data.readInt() != 0) {
                                _arg010 = ParcelUuid.CREATOR.mo3559createFromParcel(data);
                            } else {
                                _arg010 = null;
                            }
                        ...
                        case 11:
                            data.enforceInterface(ISoundTriggerSession.DESCRIPTOR);
                            if (data.readInt() != 0) {
                                _arg011 = ParcelUuid.CREATOR.mo3559createFromParcel(data);
                            } else {
                                _arg011 = null;
                            }
                        ...
                        case 12:
                            data.enforceInterface(ISoundTriggerSession.DESCRIPTOR);
                            if (data.readInt() != 0) {
                                _arg012 = ParcelUuid.CREATOR.mo3559createFromParcel(data);
                            } else {
                                _arg012 = null;
                            }
                        ...
                        case 14:
                            data.enforceInterface(ISoundTriggerSession.DESCRIPTOR);
                            if (data.readInt() != 0) {
                                _arg013 = ParcelUuid.CREATOR.mo3559createFromParcel(data);
                            } else {
                                _arg013 = null;
                            }
                        ...
                        case 15:
                            data.enforceInterface(ISoundTriggerSession.DESCRIPTOR);
                            if (data.readInt() != 0) {
                                _arg014 = ParcelUuid.CREATOR.mo3559createFromParcel(data);
                            } else {
                                _arg014 = null;
                            }
                        ...
                        case 16:
                            data.enforceInterface(ISoundTriggerSession.DESCRIPTOR);
                            if (data.readInt() != 0) {
                                _arg015 = ParcelUuid.CREATOR.mo3559createFromParcel(data);
                            } else {
                                _arg015 = null;
                            }
        ...
        public static class Proxy implements ISoundTriggerSession {
            ...
            public SoundTrigger.GenericSoundModel getSoundModel(ParcelUuid soundModelId) throws RemoteException {
                ...
                try {
                    ...
                    if (_reply.readInt() != 0) {
                        _result = SoundTrigger.GenericSoundModel.CREATOR.mo3559createFromParcel(_reply);
                    } else {
                        _result = null;
                    }
                    return _result;
            ...
            public SoundTrigger.ModuleProperties getModuleProperties() throws RemoteException {
                ...
                try {
                    ...
                    _reply.readException();
                    if (_reply.readInt() != 0) {
                        _result = SoundTrigger.ModuleProperties.CREATOR.mo3559createFromParcel(_reply);
                    } else {
                        _result = null;
                    }
                    return _result;
            ...
            public SoundTrigger.ModelParamRange queryParameter(ParcelUuid soundModelId, int modelParam) throws RemoteException {
                ...
                try {
                    ...
                    _reply.readException();
                    if (_reply.readInt() != 0) {
                        _result = SoundTrigger.ModelParamRange.CREATOR.mo3559createFromParcel(_reply);
                    } else {
                        _result = null;
                    }
                    return _result;
