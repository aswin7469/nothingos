                ...
                default:
                    ...
                    switch (code) {
                        case 1:
                            ...
                            if (data.readInt() != 0) {
                                _arg2 = VoiceInteractor.Prompt.CREATOR.mo3559createFromParcel(data);
                            } else {
                                _arg2 = null;
                            }
                            if (data.readInt() != 0) {
                        ...
                        case 2:
                            ...
                            if (data.readInt() != 0) {
                                _arg22 = VoiceInteractor.Prompt.CREATOR.mo3559createFromParcel(data);
                            } else {
                                _arg22 = null;
                            }
                        ...
                        case 3:
                            ...
                            if (data.readInt() != 0) {
                                _arg23 = VoiceInteractor.Prompt.CREATOR.mo3559createFromParcel(data);
                            } else {
                                _arg23 = null;
                            }
                            if (data.readInt() != 0) {
                        ...
                        case 4:
                            ...
                            if (data.readInt() != 0) {
                                _arg24 = VoiceInteractor.Prompt.CREATOR.mo3559createFromParcel(data);
                            } else {
                                _arg24 = null;
                            }
                            if (data.readInt() != 0) {
