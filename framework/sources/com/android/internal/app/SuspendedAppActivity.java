        ...
        public void onReceive(Context context, Intent intent) {
            if (Intent.ACTION_PACKAGES_SUSPENSION_CHANGED.equals(intent.getAction())) {
                ...
                if (ArrayUtils.contains(modified, SuspendedAppActivity.this.mSuspendedPackage) && !SuspendedAppActivity.this.isFinishing()) {
                    ...
                    Slog.w(str, "Package " + SuspendedAppActivity.this.mSuspendedPackage + " has modified suspension conditions while dialog was visible. Finishing.");
                    ...
                    case 1:
                        ...
                        try {
                            ...
                            if (ArrayUtils.contains(errored, this.mSuspendedPackage)) {
                                String str = TAG;
                                Slog.e(str, "Could not unsuspend " + this.mSuspendedPackage);
                                break;
                            } else {
                                ...
                                if (intentSender != null) {
                                    try {
                                        ...
                                        String str2 = TAG;
                                        Slog.e(str2, "Error while starting intent " + this.mOnUnsuspend, e);
                                        break;
                                    }
                                }
                            }
