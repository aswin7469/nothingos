...
public final class DumpUtils {
    ...
    static {
        ...
        STATE_NAMES_CSV = r1;
        String[] strArr3 = {"pers", "top", "btopfgs", "fgs", "impfg", "impbg", Context.BACKUP_SERVICE, "service", "service-rs", IncidentManager.URI_PARAM_RECEIVER_CLASS, "heavy", CalendarContract.CalendarCache.TIMEZONE_TYPE_HOME, "lastact", "cch-activity", "cch-aclient", "cch-empty"};
        STATE_TAGS = r1;
