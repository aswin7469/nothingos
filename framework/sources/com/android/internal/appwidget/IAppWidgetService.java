                ...
                default:
                    ...
                    switch (code) {
                        ...
                        case 10:
                            ...
                            if (data.readInt() != 0) {
                                _arg2 = RemoteViews.CREATOR.mo3559createFromParcel(data);
                            } else {
                                _arg2 = null;
                            }
                        ...
                        case 13:
                            ...
                            if (data.readInt() != 0) {
                                _arg23 = RemoteViews.CREATOR.mo3559createFromParcel(data);
                            } else {
                                _arg23 = null;
                            }
                        ...
                        case 14:
                            ...
                            if (data.readInt() != 0) {
                                _arg1 = RemoteViews.CREATOR.mo3559createFromParcel(data);
                            } else {
                                _arg1 = null;
                            }
        ...
        public static class Proxy implements IAppWidgetService {
            ...
            public RemoteViews getAppWidgetViews(String callingPackage, int appWidgetId) throws RemoteException {
                ...
                try {
                    ...
                    _reply.readException();
                    if (_reply.readInt() != 0) {
                        _result = RemoteViews.CREATOR.mo3559createFromParcel(_reply);
                    } else {
                        _result = null;
                    }
                    return _result;
            ...
            public AppWidgetProviderInfo getAppWidgetInfo(String callingPackage, int appWidgetId) throws RemoteException {
                ...
                try {
                    ...
                    _reply.readException();
                    if (_reply.readInt() != 0) {
                        _result = AppWidgetProviderInfo.CREATOR.mo3559createFromParcel(_reply);
                    } else {
                        _result = null;
                    }
                    return _result;
