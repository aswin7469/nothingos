                ...
                default:
                    ...
                    switch (code) {
                        ...
                        case 9:
                            data.enforceInterface(DESCRIPTOR);
                            if (data.readInt() != 0) {
                                _arg0 = PackageInfo.CREATOR.mo3559createFromParcel(data);
                            } else {
                                _arg0 = null;
                            }
                            if (data.readInt() != 0) {
                            ...
                            int _result9 = performBackup(_arg0, _arg1, _arg2);
                            reply.writeNoException();
                        ...
                        case 10:
                            data.enforceInterface(DESCRIPTOR);
                            if (data.readInt() != 0) {
                                _arg02 = PackageInfo.CREATOR.mo3559createFromParcel(data);
                            } else {
                                _arg02 = null;
                            }
                        ...
                        case 14:
                            ...
                            int _result14 = startRestore(_arg07, (PackageInfo[]) data.createTypedArray(PackageInfo.CREATOR));
                            reply.writeNoException();
                        ...
                        case 16:
                            data.enforceInterface(DESCRIPTOR);
                            if (data.readInt() != 0) {
                                _arg03 = ParcelFileDescriptor.CREATOR.mo3559createFromParcel(data);
                            } else {
                                _arg03 = null;
                            }
                        ...
                        case 19:
                            data.enforceInterface(DESCRIPTOR);
                            if (data.readInt() != 0) {
                                _arg04 = PackageInfo.CREATOR.mo3559createFromParcel(data);
                            } else {
                                _arg04 = null;
                            }
                            if (data.readInt() != 0) {
                            ...
                            int _result18 = performFullBackup(_arg04, _arg12, _arg22);
                            reply.writeNoException();
                        ...
                        case 20:
                            ...
                            int _result19 = checkFullBackupSize(_arg08);
                            reply.writeNoException();
                        ...
                        case 21:
                            ...
                            int _result20 = sendBackupData(_arg09);
                            reply.writeNoException();
                        ...
                        case 23:
                            data.enforceInterface(DESCRIPTOR);
                            if (data.readInt() != 0) {
                                _arg05 = PackageInfo.CREATOR.mo3559createFromParcel(data);
                            } else {
                                _arg05 = null;
                            }
                            if (data.readInt() != 0) {
                        ...
                        case 24:
                            ...
                            long _result21 = getBackupQuota(_arg010, _arg13);
                            reply.writeNoException();
                        ...
                        case 25:
                            data.enforceInterface(DESCRIPTOR);
                            if (data.readInt() != 0) {
                                _arg06 = ParcelFileDescriptor.CREATOR.mo3559createFromParcel(data);
                            } else {
                                _arg06 = null;
                            }
        ...
        public static class Proxy implements IBackupTransport {
            ...
            public RestoreDescription nextRestorePackage() throws RemoteException {
                ...
                try {
                    ...
                    _reply.readException();
                    if (_reply.readInt() != 0) {
                        _result = RestoreDescription.CREATOR.mo3559createFromParcel(_reply);
                    } else {
                        _result = null;
                    }
                    return _result;
