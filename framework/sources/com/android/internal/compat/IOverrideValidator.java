...
public interface IOverrideValidator extends IInterface {
    ...
    public static abstract class Stub extends Binder implements IOverrideValidator {
            ...
            public OverrideAllowedState getOverrideAllowedState(long changeId, String packageName) throws RemoteException {
                ...
                try {
                    ...
                    if (!_status && Stub.getDefaultImpl() != null) {
                        return Stub.getDefaultImpl().getOverrideAllowedState(changeId, packageName);
                    }
                    _reply.readException();
                    if (_reply.readInt() != 0) {
                        _result = OverrideAllowedState.CREATOR.mo3559createFromParcel(_reply);
                    } else {
                        _result = null;
                    }
                    return _result;
        ...
        public static boolean setDefaultImpl(IOverrideValidator impl) {
