                ...
                default:
                    switch (code) {
                        case 1:
                            ...
                            if (data.readInt() != 0) {
                                _arg1 = ApplicationInfo.CREATOR.mo3559createFromParcel(data);
                            } else {
                                _arg1 = null;
                            }
                        ...
                        case 4:
                            ...
                            if (data.readInt() != 0) {
                                _arg12 = ApplicationInfo.CREATOR.mo3559createFromParcel(data);
                            } else {
                                _arg12 = null;
                            }
                        ...
                        case 7:
                            data.enforceInterface(IPlatformCompat.DESCRIPTOR);
                            if (data.readInt() != 0) {
                                _arg0 = CompatibilityChangeConfig.CREATOR.mo3559createFromParcel(data);
                            } else {
                                _arg0 = null;
                            }
                        ...
                        case 8:
                            data.enforceInterface(IPlatformCompat.DESCRIPTOR);
                            if (data.readInt() != 0) {
                                _arg02 = CompatibilityOverrideConfig.CREATOR.mo3559createFromParcel(data);
                            } else {
                                _arg02 = null;
                            }
                        ...
                        case 9:
                            data.enforceInterface(IPlatformCompat.DESCRIPTOR);
                            if (data.readInt() != 0) {
                                _arg03 = CompatibilityChangeConfig.CREATOR.mo3559createFromParcel(data);
                            } else {
                                _arg03 = null;
                            }
                        ...
                        case 12:
                            data.enforceInterface(IPlatformCompat.DESCRIPTOR);
                            if (data.readInt() != 0) {
                                _arg04 = CompatibilityOverridesToRemoveConfig.CREATOR.mo3559createFromParcel(data);
                            } else {
                                _arg04 = null;
                            }
                        ...
                        case 17:
                            data.enforceInterface(IPlatformCompat.DESCRIPTOR);
                            if (data.readInt() != 0) {
                                _arg05 = ApplicationInfo.CREATOR.mo3559createFromParcel(data);
                            } else {
                                _arg05 = null;
                            }
        ...
        public static class Proxy implements IPlatformCompat {
            ...
            public CompatibilityChangeConfig getAppConfig(ApplicationInfo appInfo) throws RemoteException {
                ...
                try {
                    ...
                    _reply.readException();
                    if (_reply.readInt() != 0) {
                        _result = CompatibilityChangeConfig.CREATOR.mo3559createFromParcel(_reply);
                    } else {
                        _result = null;
                    }
                    return _result;
