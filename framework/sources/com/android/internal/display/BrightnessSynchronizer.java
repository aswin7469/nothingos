...
public class BrightnessSynchronizer {
    ...
    public static float brightnessIntToFloat(int brightnessInt) {
        ...
        return MathUtils.constrainedMap(0.0f, 1.0f, 1.0f, 3515.0f, brightnessInt);
    }
    ...
    public static float brightnessFloatToIntRange(float brightnessFloat) {
        ...
        return MathUtils.constrainedMap(1.0f, 3515.0f, 0.0f, 1.0f, brightnessFloat);
    }
    ...
    public void updateBoth(float newBrightnessFloat) {
        ...
        if (getScreenBrightnessInt(this.mContext) != newBrightnessInt) {
        ...
        private BrightnessSyncObserver() {
            this.mListener = new DisplayManager.DisplayListener() { // from class: com.android.internal.display.BrightnessSynchronizer.BrightnessSyncObserver.1
                ...
                public void onDisplayChanged(int displayId) {
                    float currentFloat = BrightnessSynchronizer.this.getScreenBrightnessFloat();
                    int toSend = Float.floatToIntBits(currentFloat);
                    BrightnessSynchronizer.this.mHandler.removeMessages(2);
                    BrightnessSynchronizer.this.mHandler.obtainMessage(2, toSend, 0).sendToTarget();
                }
            };
    ...
    public static float brightnessIntToFloat(int brightnessInt, int minInt, int maxInt, float minFloat, float maxFloat) {
        if (brightnessInt == 0) {
            return -1.0f;
        }
        if (brightnessInt == -1) {
