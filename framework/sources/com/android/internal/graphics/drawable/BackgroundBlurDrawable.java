...
public final class BackgroundBlurDrawable extends Drawable {
    ...
    /* synthetic */ BackgroundBlurDrawable(Aggregator x0, AnonymousClass1 x1) {
        this(x0);
    }
    ...
    public class AnonymousClass1 implements RenderNode.PositionUpdateListener {
        ...
        public void positionChanged(long frameNumber, final int left, final int top, final int right, final int bottom) {
            BackgroundBlurDrawable.this.mAggregator.onRenderNodePositionChanged(frameNumber, new Runnable() { // from class: com.android.internal.graphics.drawable.BackgroundBlurDrawable$1$$ExternalSyntheticLambda1
                ...
                public final void run() {
                    BackgroundBlurDrawable.AnonymousClass1.this.lambda$positionChanged$0$BackgroundBlurDrawable$1(left, top, right, bottom);
                }
            });
        }

        public /* synthetic */ void lambda$positionChanged$0$BackgroundBlurDrawable$1(int left, int top, int right, int bottom) {
        ...
        public void positionLost(long frameNumber) {
            BackgroundBlurDrawable.this.mAggregator.onRenderNodePositionChanged(frameNumber, new Runnable() { // from class: com.android.internal.graphics.drawable.BackgroundBlurDrawable$1$$ExternalSyntheticLambda0
                @Override // java.lang.Runnable
                public final void run() {
                    BackgroundBlurDrawable.AnonymousClass1.this.lambda$positionLost$1$BackgroundBlurDrawable$1();
                }
            });
        }

        public /* synthetic */ void lambda$positionLost$1$BackgroundBlurDrawable$1() {
    ...
    public static final class Aggregator {
        ...
        public BackgroundBlurDrawable createBackgroundBlurDrawable(Context context) {
            BackgroundBlurDrawable drawable = new BackgroundBlurDrawable(this, null);
        ...
        void onBlurDrawableUpdated(BackgroundBlurDrawable drawable) {
            ...
            if (shouldBeDrawn) {
                ...
                if (BackgroundBlurDrawable.DEBUG) {
                    String str2 = BackgroundBlurDrawable.TAG;
                    Log.d(str2, "Add " + drawable);
                }
            } else if (!shouldBeDrawn && isDrawn) {
                this.mHasUiUpdates = true;
                this.mDrawables.remove(drawable);
                if (BackgroundBlurDrawable.DEBUG) {
                    String str3 = BackgroundBlurDrawable.TAG;
                    Log.d(str3, "Remove " + drawable);
                }
            }
        }
        ...
        public float[][] getBlurRegionsToDispatchToSf(long frameNumber, BlurRegion[] blurRegionsForFrame, boolean hasUiUpdatesForFrame) {
            synchronized (this.mRtLock) {
                if (!hasUiUpdatesForFrame) {
                    if (this.mFrameRtUpdates.size() == 0 || this.mFrameRtUpdates.keyAt(0) > frameNumber) {
                        return null;
                    }
                }
                ...
                if (BackgroundBlurDrawable.DEBUG) {
                    String str = BackgroundBlurDrawable.TAG;
                    Log.d(str, "Dispatching " + blurRegionsForFrame.length + " blur regions:");
                }
        ...
        public void dispatchBlurTransactionIfNeeded(long frameNumber, BlurRegion[] blurRegionsForFrame, boolean hasUiUpdatesForFrame) {
            float[][] blurRegionsArray = getBlurRegionsToDispatchToSf(frameNumber, blurRegionsForFrame, hasUiUpdatesForFrame);
