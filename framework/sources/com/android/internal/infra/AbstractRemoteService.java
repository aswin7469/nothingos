...
public abstract class AbstractRemoteService<S extends AbstractRemoteService<S, I>, I extends IInterface> implements IBinder.DeathRecipient {
    ...
    public final void destroy() {
        this.mHandler.sendMessage(PooledLambda.obtainMessage(AbstractRemoteService$$ExternalSyntheticLambda4.INSTANCE, this));
    }
    ...
    public void binderDied() {
        this.mHandler.sendMessage(PooledLambda.obtainMessage(AbstractRemoteService$$ExternalSyntheticLambda6.INSTANCE, this));
    }
    ...
    protected void scheduleRequest(BasePendingRequest<S, I> pendingRequest) {
        this.mHandler.sendMessage(PooledLambda.obtainMessage(AbstractRemoteService$$ExternalSyntheticLambda0.INSTANCE, this, pendingRequest));
    }

    void finishRequest(BasePendingRequest<S, I> finshedRequest) {
        this.mHandler.sendMessage(PooledLambda.obtainMessage(AbstractRemoteService$$ExternalSyntheticLambda1.INSTANCE, this, finshedRequest));
    }
    ...
    protected void scheduleAsyncRequest(AsyncRequest<I> request) {
        ...
        this.mHandler.sendMessage(PooledLambda.obtainMessage(AbstractRemoteService$$ExternalSyntheticLambda2.INSTANCE, this, asyncRequest));
    }
    ...
    protected void scheduleBind() {
        ...
        this.mHandler.sendMessage(PooledLambda.obtainMessage(AbstractRemoteService$$ExternalSyntheticLambda3.INSTANCE, this).setWhat(1));
    }
    ...
    public void scheduleUnbind(boolean delay) {
        ...
        this.mHandler.sendMessageDelayed(PooledLambda.obtainMessage(AbstractRemoteService$$ExternalSyntheticLambda5.INSTANCE, this).setWhat(2), unbindDelay);
    }
