...
public interface MetricsProto {
    ...
    public static final class MetricsEvent extends MessageNano {
        ...
        public static final int ACTION_ACTIVITY_CHOOSER_PICKED_SYSTEM_TARGET = 1749;
        ...
        public MetricsEvent mo3556mergeFrom(CodedInputByteBufferNano input) throws IOException {
            int tag;
            do {
                tag = input.readTag();
                switch (tag) {
        ...
        public static MetricsEvent parseFrom(CodedInputByteBufferNano input) throws IOException {
            return new MetricsEvent().mo3556mergeFrom(input);
        }
    }
}
