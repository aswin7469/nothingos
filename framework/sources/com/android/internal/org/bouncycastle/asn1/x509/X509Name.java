...
public class X509Name extends ASN1Object {
    ...
    static {
        ...
        hashtable4.put(GrantCredentialsPermissionActivity.EXTRAS_REQUESTING_UID, aSN1ObjectIdentifier32);
            ...
            while (i < set.size()) {
                ...
                if ((value instanceof ASN1String) && !(value instanceof DERUniversalString)) {
                    ...
                    try {
                        ...
                        vector2.addElement("#" + bytesToString(Hex.encode(value.toASN1Primitive().getEncoded(ASN1Encoding.DER))));
