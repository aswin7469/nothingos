...
public class AESEngine implements BlockCipher {
    ...
    private byte[] s;
    private static final byte[] S = {99, 124, 119, 123, MidiConstants.STATUS_SONG_POSITION, 107, 111, -59, 48, 1, 103, 43, -2, -41, -85, 118, -54, -126, -55, 125, -6, 89, 71, -16, -83, -44, -94, -81, -100, -92, 114, -64, -73, -3, -109, 38, 54, QosFlowIdRange.MAX, -9, -52, 52, -91, -27, MidiConstants.STATUS_MIDI_TIME_CODE, 113, -40, 49, 21, 4, -57, 35, -61, 24, -106, 5, -102, 7, 18, Byte.MIN_VALUE, -30, -21, 39, -78, 117, 9, -125, 44, 26, GsmAlphabet.GSM_EXTENDED_ESCAPE, 110, 90, MidiConstants.STATUS_POLYPHONIC_AFTERTOUCH, 82, 59, -42, -77, 41, -29, 47, -124, 83, -47, 0, -19, 32, -4, -79, 91, 106, -53, -66, 57, 74, 76, 88, -49, MidiConstants.STATUS_CHANNEL_PRESSURE, -17, -86, -5, 67, 77, QosProtocol.AH, -123, 69, -7, 2, Byte.MAX_VALUE, 80, 60, -97, -88, 81, -93, 64, -113, -110, -99, 56, -11, -68, -74, -38, 33, 16, -1, MidiConstants.STATUS_SONG_SELECT, -46, -51, 12, 19, -20, 95, -105, 68, 23, -60, -89, 126, 61, 100, 93, 25, 115, 96, -127, 79, -36, 34, 42, MidiConstants.STATUS_NOTE_ON, -120, 70, -18, -72, IGnssVisibilityControlCallback.NfwRequestor.AUTOMOBILE_CLIENT, -34, 94, 11, -37, MidiConstants.STATUS_PITCH_BEND, QosProtocol.ESP, 58, 10, 73, 6, 36, 92, -62, -45, -84, 98, -111, -107, -28, 121, -25, -56, 55, 109, -115, -43, 78, -87, 108, 86, -12, -22, 101, 122, -82, 8, -70, 120, 37, 46, 28, -90, -76, -58, -24, -35, 116, 31, 75, -67, -117, -118, 112, 62, -75, 102, 72, 3, -10, BluetoothHidDevice.ERROR_RSP_UNKNOWN, 97, 53, 87, -71, -122, -63, 29, -98, -31, -8, -104, 17, 105, -39, -114, -108, -101, 30, -121, -23, -50, 85, 40, -33, -116, -95, -119, IGnssVisibilityControlCallback.NfwRequestor.OTHER_CHIPSET_VENDOR, -65, -26, 66, 104, 65, -103, 45, MidiConstants.STATUS_CHANNEL_MASK, MidiConstants.STATUS_CONTROL_CHANGE, 84, -69, 22};
    private static final byte[] Si = {82, 9, 106, -43, 48, 54, -91, 56, -65, 64, -93, -98, -127, MidiConstants.STATUS_SONG_SELECT, -41, -5, 124, -29, 57, -126, -101, 47, -1, -121, 52, -114, 67, 68, -60, -34, -23, -53, 84, 123, -108, QosProtocol.ESP, -90, -62, 35, 61, -18, 76, -107, 11, 66, -6, -61, 78, 8, 46, -95, 102, 40, -39, 36, -78, 118, 91, -94, 73, 109, -117, -47, 37, 114, -8, -10, 100, -122, 104, -104, 22, -44, -92, 92, -52, 93, 101, -74, -110, 108, 112, 72, 80, -3, -19, -71, -38, 94, 21, 70, 87, -89, -115, -99, -124, MidiConstants.STATUS_NOTE_ON, -40, -85, 0, -116, -68, -45, 10, -9, -28, 88, 5, -72, -77, 69, 6, MidiConstants.STATUS_CHANNEL_PRESSURE, 44, 30, -113, -54, QosFlowIdRange.MAX, MidiConstants.STATUS_CHANNEL_MASK, 2, -63, -81, -67, 3, 1, 19, -118, 107, 58, -111, 17, 65, 79, 103, -36, -22, -105, MidiConstants.STATUS_SONG_POSITION, -49, -50, -16, -76, -26, 115, -106, -84, 116, 34, -25, -83, 53, -123, -30, -7, 55, -24, 28, 117, -33, 110, 71, MidiConstants.STATUS_MIDI_TIME_CODE, 26, 113, 29, 41, -59, -119, 111, -73, 98, BluetoothHidDevice.ERROR_RSP_UNKNOWN, -86, 24, -66, GsmAlphabet.GSM_EXTENDED_ESCAPE, -4, 86, 62, 75, -58, -46, 121, 32, -102, -37, -64, -2, 120, -51, 90, -12, 31, -35, -88, QosProtocol.AH, -120, 7, -57, 49, -79, 18, 16, 89, 39, Byte.MIN_VALUE, -20, 95, 96, 81, Byte.MAX_VALUE, -87, 25, -75, 74, IGnssVisibilityControlCallback.NfwRequestor.OTHER_CHIPSET_VENDOR, 45, -27, 122, -97, -109, -55, -100, -17, MidiConstants.STATUS_POLYPHONIC_AFTERTOUCH, MidiConstants.STATUS_PITCH_BEND, 59, 77, -82, 42, -11, MidiConstants.STATUS_CONTROL_CHANGE, -56, -21, -69, 60, -125, 83, -103, 97, 23, 43, 4, 126, -70, 119, -42, 38, -31, 105, IGnssVisibilityControlCallback.NfwRequestor.AUTOMOBILE_CLIENT, 99, 85, 33, 12, 125};
    ...
    private int[][] generateWorkingKey(byte[] key, boolean forEncryption) {
        ...
        this.ROUNDS = i;
        int colx = 0;
        int[][] W = (int[][]) Array.newInstance(int.class, i + 1, 4);
        int i2 = 8;
        int colx2 = 3;
        switch (KC) {
            case 4:
    ...
    private void encryptBlock(int[][] KW) {
        ...
        byte[] bArr2 = this.s;
        this.C0 = ((i ^ ((bArr2[(r23 >> 16) & 255] & 255) << 16)) ^ (bArr2[(r34 >> 24) & 255] << 24)) ^ KW[r5][0];
        this.C1 = ((((bArr2[r13 & 255] & 255) ^ ((bArr[(r23 >> 8) & 255] & 255) << 8)) ^ ((bArr[(r34 >> 16) & 255] & 255) << 16)) ^ (bArr2[(r02 >> 24) & 255] << 24)) ^ KW[r5][1];
        this.C2 = ((((bArr2[r23 & 255] & 255) ^ ((bArr[(r34 >> 8) & 255] & 255) << 8)) ^ ((bArr[(r02 >> 16) & 255] & 255) << 16)) ^ (bArr[(r13 >> 24) & 255] << 24)) ^ KW[r5][2];
        this.C3 = ((bArr[(r23 >> 24) & 255] << 24) ^ (((bArr2[r34 & 255] & 255) ^ ((bArr2[(r02 >> 8) & 255] & 255) << 8)) ^ ((bArr2[(r13 >> 16) & 255] & 255) << 16))) ^ KW[r5][3];
    }
    ...
    private void decryptBlock(int[][] KW) {
        ...
        byte[] bArr = Si;
        byte[] bArr2 = this.s;
        this.C0 = (((((bArr2[(r34 >> 8) & 255] & 255) << 8) ^ (bArr[r02 & 255] & 255)) ^ ((bArr2[(r23 >> 16) & 255] & 255) << 16)) ^ (bArr[(r13 >> 24) & 255] << 24)) ^ KW[0][0];
        this.C1 = ((((bArr2[r13 & 255] & 255) ^ ((bArr2[(r02 >> 8) & 255] & 255) << 8)) ^ ((bArr[(r34 >> 16) & 255] & 255) << 16)) ^ (bArr2[(r23 >> 24) & 255] << 24)) ^ KW[0][1];
        this.C2 = ((((bArr2[r23 & 255] & 255) ^ ((bArr[(r13 >> 8) & 255] & 255) << 8)) ^ ((bArr[(r02 >> 16) & 255] & 255) << 16)) ^ (bArr2[(r34 >> 24) & 255] << 24)) ^ KW[0][2];
        this.C3 = ((((bArr[r34 & 255] & 255) ^ ((bArr2[(r23 >> 8) & 255] & 255) << 8)) ^ ((bArr2[(r13 >> 16) & 255] & 255) << 16)) ^ (bArr2[(r02 >> 24) & 255] << 24)) ^ KW[0][3];
    }
}
