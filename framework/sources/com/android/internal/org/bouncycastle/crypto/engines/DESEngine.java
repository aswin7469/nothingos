...
public class DESEngine implements BlockCipher {
    ...
    private static final byte[] pc1 = {56, 48, 40, 32, 24, 16, 8, 0, 57, 49, 41, 33, 25, 17, 9, 1, 58, QosProtocol.ESP, 42, 34, 26, 18, 10, 2, 59, QosProtocol.AH, 43, 35, 62, 54, 46, 38, 30, 22, BluetoothHidDevice.ERROR_RSP_UNKNOWN, 6, 61, 53, 45, 37, 29, 21, IGnssVisibilityControlCallback.NfwRequestor.OTHER_CHIPSET_VENDOR, 5, 60, 52, 44, 36, 28, IGnssVisibilityControlCallback.NfwRequestor.AUTOMOBILE_CLIENT, 12, 4, GsmAlphabet.GSM_EXTENDED_ESCAPE, 19, 11, 3};
    private static final byte[] totrot = {1, 2, 4, 6, 8, 10, 12, BluetoothHidDevice.ERROR_RSP_UNKNOWN, MidiConstants.STATUS_CHANNEL_MASK, 17, 19, 21, 23, 25, GsmAlphabet.GSM_EXTENDED_ESCAPE, 28};
    private static final byte[] pc2 = {IGnssVisibilityControlCallback.NfwRequestor.OTHER_CHIPSET_VENDOR, 16, 10, 23, 0, 4, 2, GsmAlphabet.GSM_EXTENDED_ESCAPE, BluetoothHidDevice.ERROR_RSP_UNKNOWN, 5, IGnssVisibilityControlCallback.NfwRequestor.AUTOMOBILE_CLIENT, 9, 22, 18, 11, 3, 25, 7, MidiConstants.STATUS_CHANNEL_MASK, 6, 26, 19, 12, 1, 40, QosProtocol.AH, 30, 36, 46, 54, 29, 39, QosProtocol.ESP, 44, 32, 47, 43, 48, 38, 55, 33, 52, 45, 41, 49, 35, 28, 31};
