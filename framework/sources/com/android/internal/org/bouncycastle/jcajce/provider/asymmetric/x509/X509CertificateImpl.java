                ...
                if (ext.getExtnValue() != null) {
                    ...
                    try {
                        if (oid.equals((ASN1Primitive) Extension.basicConstraints)) {
                            ...
                            buf.append(new NetscapeCertType(DERBitString.getInstance(dIn.readObject())));
                            buf.append(nl);
                        } else if (oid.equals((ASN1Primitive) MiscObjectIdentifiers.netscapeRevocationURL)) {
                            buf.append(new NetscapeRevocationURL(DERIA5String.getInstance(dIn.readObject())));
                            buf.append(nl);
                        } else if (oid.equals((ASN1Primitive) MiscObjectIdentifiers.verisignCzagExtension)) {
                            buf.append(new VerisignCzagExtension(DERIA5String.getInstance(dIn.readObject())));
                            buf.append(nl);
                        } else {
