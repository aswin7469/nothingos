...
public class PKCS12KeyStoreSpi extends KeyStoreSpi implements PKCSObjectIdentifiers, X509ObjectIdentifiers, BCKeyStore {
    ...
    /* JADX WARN: Removed duplicated region for block: B:52:0x01e8 A[Catch: CertificateEncodingException -> 0x01cb, TRY_ENTER, TRY_LEAVE, TryCatch #11 {CertificateEncodingException -> 0x01cb, blocks: (B:47:0x01bd, B:52:0x01e8), top: B:46:0x01bd }] */
    /* JADX WARN: Removed duplicated region for block: B:57:0x01ff A[Catch: CertificateEncodingException -> 0x0240, TRY_LEAVE, TryCatch #5 {CertificateEncodingException -> 0x0240, blocks: (B:50:0x01e0, B:54:0x01f5, B:55:0x01f9, B:57:0x01ff, B:81:0x01d4), top: B:53:0x01f5 }] */
    /*
    ...
    */
    private void doStore(OutputStream stream, char[] password, boolean useDEREncoding) throws IOException {
        ...
        if (password != null) {
            ...
            byte[] keySEncoded2 = dERSequence.getEncoded(str);
            ...
            byte[] certSeqEncoded = new DERSequence(certSeq).getEncoded(str);
            ...
            byte[] pkg = auth.getEncoded(useDEREncoding ? str : ASN1Encoding.BER);
