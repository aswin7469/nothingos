...
public class LongArray implements Cloneable {
    ...
    private static int bitLength(long w) {
        ...
        if (t == 0) {
            ...
            int k = t >>> 8;
            v = k == 0 ? bitLengths[t] + 16 : bitLengths[k] + 24;
        }
        return b + v;
    }
    ...
    public LongArray modMultiply(LongArray other, int m, int[] ks) {
        ...
        while (aPos < aLen) {
            ...
            while (true) {
                ...
                bDeg = bDeg2;
                int v = ((int) aVal3) & 15;
                addBoth(c, cOff, T02, ti[u], T1, ti[v], bMax);
                aVal2 = aVal3 >>> 4;
                if (aVal2 == 0) {
                    break;
                }
    ...
    public LongArray modMultiplyAlt(LongArray other, int m, int[] ks) {
        ...
        if (aLen == 1) {
            ...
            long[] c0 = new long[cLen];
            multiplyWord(a0, B.m_ints, bMax, c0, 0);
            return reduceResult(c0, 0, cLen, m, ks);
        }
        ...
        int bOff = aLen;
        System.arraycopy(B.m_ints, 0, c, bOff, bMax);
        int bank2 = 1;
        while (true) {
            banks = bank;
            if (bank2 >= banks) {
            ...
            shiftUp(c, aLen, c, bOff2, bMax3, bank2);
            bank2++;
            bank = banks;
            B = B;
            bOff = bOff2;
            ...
            while (true) {
                ...
                while (true) {
                    ...
                    if (index != 0) {
                        bLen = bMax;
                        bLen2 = bMax3;
                        add(c, aPos + ci[index], c, bOff3, bLen2);
                    } else {
                        bLen = bMax;
                        bLen2 = bMax3;
                    }
        ...
        while (true) {
            ...
            if ((ciPos3 & 1) == 0) {
                ciPos = ciPos3;
                cTotal3 = cTotal;
                addShiftedUp(c, ci[ciPos3 >>> 1], c, ci[ciPos3], cLen, 16);
            } else {
                ciPos = ciPos3;
                cTotal3 = cTotal;
    ...
    private static long interleave3(long x) {
        ...
        return (interleave3_21to63(((int) (x >>> 42)) & 2097151) << 2) | interleave3_21to63(((int) x) & 2097151) | z | (interleave3_21to63(((int) (x >>> 21)) & 2097151) << 1);
    }
    ...
    private static long interleave5(long x) {
        return interleave3_13to65(((int) x) & NetworkStackConstants.IPV4_FRAGMENT_MASK) | (interleave3_13to65(((int) (x >>> 13)) & NetworkStackConstants.IPV4_FRAGMENT_MASK) << 1) | (interleave3_13to65(((int) (x >>> 26)) & NetworkStackConstants.IPV4_FRAGMENT_MASK) << 2) | (interleave3_13to65(((int) (x >>> 39)) & NetworkStackConstants.IPV4_FRAGMENT_MASK) << 3) | (interleave3_13to65(((int) (x >>> 52)) & NetworkStackConstants.IPV4_FRAGMENT_MASK) << 4);
    }
