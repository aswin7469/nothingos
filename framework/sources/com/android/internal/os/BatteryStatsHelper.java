    ...
    public static BatteryStats statsFromFile(Context context, String fname) {
        synchronized (sFileXfer) {
            ...
            try {
                ...
                BatteryStatsImpl mo3559createFromParcel = BatteryStatsImpl.CREATOR.mo3559createFromParcel(parcel);
                try {
                    fin.close();
                } catch (IOException e) {
                }
                return mo3559createFromParcel;
            } catch (IOException e2) {
            ...
            if (pfd != null) {
                try {
                    ...
                    try {
                        ...
                        parcel.unmarshall(data, 0, data.length);
                        parcel.setDataPosition(0);
                        BatteryStatsImpl stats = BatteryStatsImpl.CREATOR.mo3559createFromParcel(parcel);
                        fis.close();
                        return stats;
                    } catch (Throwable th) {
                        try {
