...
public interface IKeyguardService extends IInterface {
    ...
    void onKeyGestureTap(KeyEvent keyEvent) throws RemoteException;
    ...
    public static class Default implements IKeyguardService {
        ...
        @Override // com.android.internal.policy.IKeyguardService
        public void onKeyGestureTap(KeyEvent event) throws RemoteException {
        }
    ...
    public static abstract class Stub extends Binder implements IKeyguardService {
        ...
        static final int TRANSACTION_onKeyGestureTap = 23;
            ...
            switch (code) {
                ...
                default:
                    ...
                    switch (code) {
                        ...
                        case 4:
                            data.enforceInterface(DESCRIPTOR);
                            IKeyguardDismissCallback _arg05 = IKeyguardDismissCallback.Stub.asInterface(data.readStrongBinder());
                            if (data.readInt() != 0) {
                                _arg1 = TextUtils.CHAR_SEQUENCE_CREATOR.mo3559createFromParcel(data);
                            } else {
                                _arg1 = null;
                            }
                            dismiss(_arg05, _arg1);
                            return true;
                        case 5:
                            data.enforceInterface(DESCRIPTOR);
                            onDreamingStarted();
                        ...
                        case 8:
                            ...
                            onFinishedGoingToSleep(_arg06, _arg04);
                            return true;
                        case 9:
                            data.enforceInterface(DESCRIPTOR);
                            ...
                            onStartedWakingUp(_arg07, _arg04);
                            return true;
                        case 10:
                            data.enforceInterface(DESCRIPTOR);
                            onFinishedWakingUp();
                        ...
                        case 21:
                            ...
                            startKeyguardExitAnimation(_arg08, _arg12);
                            return true;
                        case 22:
                            data.enforceInterface(DESCRIPTOR);
                        ...
                        case 23:
                            data.enforceInterface(DESCRIPTOR);
                            if (data.readInt() != 0) {
                                _arg03 = KeyEvent.CREATOR.mo3559createFromParcel(data);
                            } else {
                                _arg03 = null;
                            }
                            onKeyGestureTap(_arg03);
                            return true;
                        default:
        ...
        public static class Proxy implements IKeyguardService {
            ...
            public void onStartedGoingToSleep(int pmSleepReason) throws RemoteException {
                ...
                try {
                    ...
                    if (!_status && Stub.getDefaultImpl() != null) {
                        Stub.getDefaultImpl().onStartedGoingToSleep(pmSleepReason);
                    }
                } finally {
                    _data.recycle();
                }
            ...
            public void onFinishedGoingToSleep(int pmSleepReason, boolean cameraGestureTriggered) throws RemoteException {
                ...
                try {
                    ...
                    if (!_status && Stub.getDefaultImpl() != null) {
                        Stub.getDefaultImpl().onFinishedGoingToSleep(pmSleepReason, cameraGestureTriggered);
                    }
                } finally {
                    _data.recycle();
                }
            ...
            public void onStartedWakingUp(int pmWakeReason, boolean cameraGestureTriggered) throws RemoteException {
                ...
                try {
                    ...
                    if (!_status && Stub.getDefaultImpl() != null) {
                        Stub.getDefaultImpl().onStartedWakingUp(pmWakeReason, cameraGestureTriggered);
                    }
                } finally {
                    _data.recycle();
                }
            ...
            public void onKeyGestureTap(KeyEvent event) throws RemoteException {
                ...
                try {
                    ...
                    if (!_status && Stub.getDefaultImpl() != null) {
                        Stub.getDefaultImpl().onKeyGestureTap(event);
                    }
                } finally {
                    _data.recycle();
                }
