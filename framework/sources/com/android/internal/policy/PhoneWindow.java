...
public class PhoneWindow extends Window implements MenuBuilder.Callback {
    ...
    private static final Window.OnContentApplyWindowInsetsListener sDefaultContentInsetsApplier = PhoneWindow$$ExternalSyntheticLambda0.INSTANCE;
    ...
    public PhoneWindow(Context context) {
        ...
        this.mRenderShadowsInCompositor = Settings.Global.getInt(context.getContentResolver(), Settings.Global.DEVELOPMENT_RENDER_SHADOWS_IN_COMPOSITOR, 1) != 0 ? true : z;
    }
    ...
    protected ViewGroup generateLayout(DecorView decor) {
        ...
        if (DEBUG) {
            Log.d(TAG, "Min width minor: " + ((Object) this.mMinWidthMinor.coerceToString()) + ", major: " + ((Object) this.mMinWidthMajor.coerceToString()));
        }
        if (a.hasValue(64)) {
            if (this.mFixedWidthMajor == null) {
                this.mFixedWidthMajor = new TypedValue();
            }
            a.getValue(64, this.mFixedWidthMajor);
        }
        if (a.hasValue(65)) {
            if (this.mFixedWidthMinor == null) {
                this.mFixedWidthMinor = new TypedValue();
            }
            a.getValue(65, this.mFixedWidthMinor);
        }
        if (a.hasValue(62)) {
            if (this.mFixedHeightMajor == null) {
                this.mFixedHeightMajor = new TypedValue();
            }
            a.getValue(62, this.mFixedHeightMajor);
        }
        if (a.hasValue(63)) {
            if (this.mFixedHeightMinor == null) {
                this.mFixedHeightMinor = new TypedValue();
            }
            a.getValue(63, this.mFixedHeightMinor);
        }
        ...
        if (!this.mForcedNavigationBarColor) {
            this.mNavigationBarColor = a.getColor(35, -16777216);
                    ...
                    if (layoutResource4 == 0) {
                        if (this.mIsFloating) {
                            ...
                            if (layoutResource5 != 0) {
                                layoutResource = a.getResourceId(61, R.layout.screen_action_bar);
                            } else {
    ...
    public static final class PanelFeatureState {
        ...
        void setStyle(Context context) {
            ...
            this.isCompact = a.getBoolean(328, false);
            this.listPresenterTheme = a.getResourceId(329, R.style.Theme_ExpandedMenu);
            a.recycle();
        }
        ...
        MenuView getListMenuView(Context context, MenuPresenter.Callback cb) {
            ...
            if (this.listMenuPresenter == null) {
                ListMenuPresenter listMenuPresenter = new ListMenuPresenter((int) R.layout.list_menu_item_layout, this.listPresenterTheme);
