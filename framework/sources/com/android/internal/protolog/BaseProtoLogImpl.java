...
public class BaseProtoLogImpl {
    ...
    public static Runnable sCacheUpdater = BaseProtoLogImpl$$ExternalSyntheticLambda0.INSTANCE;
        ...
        try {
            ...
            if (args == null) {
                ...
                if (longParams.size() > 0) {
                    os.writePackedSInt64(ProtoLogMessage.SINT64_PARAMS, longParams.stream().mapToLong(BaseProtoLogImpl$$ExternalSyntheticLambda5.INSTANCE).toArray());
                }
                if (doubleParams.size() > 0) {
                    os.writePackedDouble(ProtoLogMessage.DOUBLE_PARAMS, doubleParams.stream().mapToDouble(BaseProtoLogImpl$$ExternalSyntheticLambda4.INSTANCE).toArray());
                }
    ...
    public int onShellCommand(ShellCommand shell) {
        ...
        switch (cmd.hashCode()) {
            ...
            case -892481550:
                ...
                break;
            case 3540994:
                if (cmd.equals(LocationTimeZoneManager.SHELL_COMMAND_STOP)) {
                    c = 1;
                    break;
                }
                break;
    ...
    public String getStatus() {
        ...
        sb.append("ProtoLog status: ");
        sb.append(isProtoEnabled() ? "Enabled" : "Disabled");
        sb.append("\nEnabled log groups: \n  Proto: ");
        TreeMap<String, IProtoLogGroup> treeMap = LOG_GROUPS;
        sb.append((String) treeMap.values().stream().filter(BaseProtoLogImpl$$ExternalSyntheticLambda2.INSTANCE).map(BaseProtoLogImpl$$ExternalSyntheticLambda1.INSTANCE).collect(Collectors.joining(" ")));
        sb.append("\n  Logcat: ");
        sb.append((String) treeMap.values().stream().filter(BaseProtoLogImpl$$ExternalSyntheticLambda3.INSTANCE).map(BaseProtoLogImpl$$ExternalSyntheticLambda1.INSTANCE).collect(Collectors.joining(" ")));
