                ...
                default:
                    ...
                    switch (code) {
                        case 1:
                            ...
                            if (data.readInt() != 0) {
                                _arg1 = StatusBarIcon.CREATOR.mo3559createFromParcel(data);
                            } else {
                                _arg1 = null;
                            }
                        ...
                        case 39:
                            data.enforceInterface(DESCRIPTOR);
                            if (data.readInt() != 0) {
                                _arg05 = PromptInfo.CREATOR.mo3559createFromParcel(data);
                            } else {
                                _arg05 = null;
                            }
                            ...
                            showAuthenticationDialog(_arg05, _arg19, _arg25, _arg33, _arg42, _arg52, _arg6, _arg7, _arg8, _arg9);
                            return true;
                        case 40:
                            data.enforceInterface(DESCRIPTOR);
                        ...
                        case 59:
                            ...
                            if (data.readInt() != 0) {
                                _arg13 = ParcelFileDescriptor.CREATOR.mo3559createFromParcel(data);
                            } else {
                                _arg13 = null;
                            }
