                ...
                default:
                    switch (code) {
                        ...
                        case 2:
                            data.enforceInterface(ICallDiagnosticService.DESCRIPTOR);
                            if (data.readInt() != 0) {
                                _arg0 = ParcelableCall.CREATOR.mo3559createFromParcel(data);
                            } else {
                                _arg0 = null;
                            }
                        ...
                        case 3:
                            data.enforceInterface(ICallDiagnosticService.DESCRIPTOR);
                            if (data.readInt() != 0) {
                                _arg02 = ParcelableCall.CREATOR.mo3559createFromParcel(data);
                            } else {
                                _arg02 = null;
                            }
                            updateCall(_arg02);
                        ...
                        case 4:
                            data.enforceInterface(ICallDiagnosticService.DESCRIPTOR);
                            if (data.readInt() != 0) {
                                _arg03 = CallAudioState.CREATOR.mo3559createFromParcel(data);
                            } else {
                                _arg03 = null;
                            }
                        ...
                        case 7:
                            ...
                            if (data.readInt() != 0) {
                                _arg1 = CallQuality.CREATOR.mo3559createFromParcel(data);
                            } else {
                                _arg1 = null;
                            }
                        ...
                        case 8:
                            data.enforceInterface(ICallDiagnosticService.DESCRIPTOR);
                            if (data.readInt() != 0) {
                                _arg04 = BluetoothCallQualityReport.CREATOR.mo3559createFromParcel(data);
                            } else {
                                _arg04 = null;
                            }
                        ...
                        case 9:
                            ...
                            if (data.readInt() != 0) {
                                _arg12 = DisconnectCause.CREATOR.mo3559createFromParcel(data);
                            } else {
                                _arg12 = null;
                            }
