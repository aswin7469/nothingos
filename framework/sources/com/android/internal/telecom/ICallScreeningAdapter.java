                ...
                default:
                    switch (code) {
                        case 1:
                            ...
                            if (data.readInt() != 0) {
                                _arg2 = CallScreeningService.ParcelableCallResponse.CREATOR.mo3559createFromParcel(data);
                            } else {
                                _arg2 = null;
                            }
            ...
            public void onScreeningResponse(String callId, ComponentName componentName, CallScreeningService.ParcelableCallResponse response) throws RemoteException {
                ...
                try {
                    ...
                    if (!_status && Stub.getDefaultImpl() != null) {
                        Stub.getDefaultImpl().onScreeningResponse(callId, componentName, response);
                    }
                } finally {
                    _data.recycle();
                }
