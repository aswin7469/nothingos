                ...
                default:
                    ...
                    switch (code) {
                        case 1:
                            ...
                            if (data.readInt() != 0) {
                                _arg5 = PendingIntent.CREATOR.mo3559createFromParcel(data);
                            } else {
                                _arg5 = null;
                            }
                            long _arg62 = data.readLong();
                            sendMessage(_arg0, _arg15, _arg2, _arg33, _arg4, _arg5, _arg62);
                        ...
                        case 2:
                            ...
                            if (data.readInt() != 0) {
                                _arg3 = Uri.CREATOR.mo3559createFromParcel(data);
                            } else {
                                _arg3 = null;
                            }
                            if (data.readInt() != 0) {
                            ...
                            if (data.readInt() != 0) {
                                _arg52 = PendingIntent.CREATOR.mo3559createFromParcel(data);
                            } else {
                                _arg52 = null;
                            }
                            long _arg63 = data.readLong();
                            downloadMessage(_arg02, _arg16, _arg24, _arg3, _arg42, _arg52, _arg63);
                            reply.writeNoException();
                            return true;
                        case 3:
                            data.enforceInterface(DESCRIPTOR);
                            ...
                            Uri _result = importTextMessage(_arg03, _arg17, _arg25, _arg34, _arg45, _arg53, _arg6);
                            reply.writeNoException();
                            if (_result != null) {
                                reply.writeInt(1);
                        ...
                        case 6:
                            ...
                            boolean deleteStoredConversation = deleteStoredConversation(_arg06, _arg18);
                            reply.writeNoException();
                        ...
                        case 7:
                            ...
                            if (data.readInt() != 0) {
                                _arg22 = ContentValues.CREATOR.mo3559createFromParcel(data);
                            } else {
                                _arg22 = null;
                            }
                        ...
                        case 8:
                            ...
                            boolean _arg27 = z;
                            boolean archiveStoredConversation = archiveStoredConversation(_arg08, _arg19, _arg27);
                            reply.writeNoException();
                        ...
                        case 9:
                            ...
                            Uri _result3 = addTextMessageDraft(_arg09, _arg110, _arg28);
                            reply.writeNoException();
                            if (_result3 != null) {
                                reply.writeInt(1);
                        ...
                        case 10:
                            ...
                            if (data.readInt() != 0) {
                                _arg14 = Uri.CREATOR.mo3559createFromParcel(data);
                            } else {
                                _arg14 = null;
                            }
                        ...
                        case 11:
                            ...
                            if (data.readInt() != 0) {
                                _arg23 = Uri.CREATOR.mo3559createFromParcel(data);
                            } else {
                                _arg23 = null;
                            }
                            if (data.readInt() != 0) {
                            ...
                            if (data.readInt() != 0) {
                                _arg44 = PendingIntent.CREATOR.mo3559createFromParcel(data);
                            } else {
                                _arg44 = null;
                            }
