                ...
                default:
                    ...
                    switch (code) {
                        case 1:
                            ...
                            if (data.readInt() != 0) {
                                _arg0 = ServiceState.CREATOR.mo3559createFromParcel(data);
                            } else {
                                _arg0 = null;
                            }
                        ...
                        case 5:
                            data.enforceInterface(DESCRIPTOR);
                            if (data.readInt() != 0) {
                                _arg02 = CellIdentity.CREATOR.mo3559createFromParcel(data);
                            } else {
                                _arg02 = null;
                            }
                        ...
                        case 10:
                            data.enforceInterface(DESCRIPTOR);
                            if (data.readInt() != 0) {
                                _arg03 = SignalStrength.CREATOR.mo3559createFromParcel(data);
                            } else {
                                _arg03 = null;
                            }
                        ...
                        case 12:
                            data.enforceInterface(DESCRIPTOR);
                            if (data.readInt() != 0) {
                                _arg04 = PreciseCallState.CREATOR.mo3559createFromParcel(data);
                            } else {
                                _arg04 = null;
                            }
                        ...
                        case 13:
                            data.enforceInterface(DESCRIPTOR);
                            if (data.readInt() != 0) {
                                _arg05 = PreciseDataConnectionState.CREATOR.mo3559createFromParcel(data);
                            } else {
                                _arg05 = null;
                            }
                        ...
                        case 14:
                            data.enforceInterface(DESCRIPTOR);
                            if (data.readInt() != 0) {
                                _arg06 = DataConnectionRealTimeInfo.CREATOR.mo3559createFromParcel(data);
                            } else {
                                _arg06 = null;
                            }
                        ...
                        case 21:
                            data.enforceInterface(DESCRIPTOR);
                            if (data.readInt() != 0) {
                                _arg07 = TelephonyDisplayInfo.CREATOR.mo3559createFromParcel(data);
                            } else {
                                _arg07 = null;
                            }
                        ...
                        case 22:
                            data.enforceInterface(DESCRIPTOR);
                            if (data.readInt() != 0) {
                                _arg08 = PhoneCapability.CREATOR.mo3559createFromParcel(data);
                            } else {
                                _arg08 = null;
                            }
                        ...
                        case 25:
                            data.enforceInterface(DESCRIPTOR);
                            if (data.readInt() != 0) {
                                _arg09 = CallAttributes.CREATOR.mo3559createFromParcel(data);
                            } else {
                                _arg09 = null;
                            }
                        ...
                        case 27:
                            data.enforceInterface(DESCRIPTOR);
                            if (data.readInt() != 0) {
                                _arg010 = EmergencyNumber.CREATOR.mo3559createFromParcel(data);
                            } else {
                                _arg010 = null;
                            }
                        ...
                        case 28:
                            data.enforceInterface(DESCRIPTOR);
                            if (data.readInt() != 0) {
                                _arg011 = EmergencyNumber.CREATOR.mo3559createFromParcel(data);
                            } else {
                                _arg011 = null;
                            }
                        ...
                        case 30:
                            data.enforceInterface(DESCRIPTOR);
                            if (data.readInt() != 0) {
                                _arg012 = ImsReasonInfo.CREATOR.mo3559createFromParcel(data);
                            } else {
                                _arg012 = null;
                            }
                        ...
                        case 31:
                            data.enforceInterface(DESCRIPTOR);
                            if (data.readInt() != 0) {
                                _arg013 = CellIdentity.CREATOR.mo3559createFromParcel(data);
                            } else {
                                _arg013 = null;
                            }
                        ...
                        case 32:
                            data.enforceInterface(DESCRIPTOR);
                            if (data.readInt() != 0) {
                                _arg014 = BarringInfo.CREATOR.mo3559createFromParcel(data);
                            } else {
                                _arg014 = null;
                            }
