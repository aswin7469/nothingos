                ...
                default:
                    ...
                    switch (code) {
                        ...
                        case 24:
                            ...
                            if (data.readInt() != 0) {
                                _arg1 = ParcelUuid.CREATOR.mo3559createFromParcel(data);
                            } else {
                                _arg1 = null;
                            }
                        ...
                        case 25:
                            ...
                            if (data.readInt() != 0) {
                                _arg12 = ParcelUuid.CREATOR.mo3559createFromParcel(data);
                            } else {
                                _arg12 = null;
                            }
        ...
        public static class Proxy implements ISub {
            ...
            public SubscriptionInfo getActiveSubscriptionInfo(int subId, String callingPackage, String callingFeatureId) throws RemoteException {
                ...
                try {
                    ...
                    _reply.readException();
                    if (_reply.readInt() != 0) {
                        _result = SubscriptionInfo.CREATOR.mo3559createFromParcel(_reply);
                    } else {
                        _result = null;
                    }
                    return _result;
            ...
            public ParcelUuid createSubscriptionGroup(int[] subIdList, String callingPackage) throws RemoteException {
                ...
                try {
                    ...
                    _reply.readException();
                    if (_reply.readInt() != 0) {
                        _result = ParcelUuid.CREATOR.mo3559createFromParcel(_reply);
                    } else {
                        _result = null;
                    }
                    return _result;
