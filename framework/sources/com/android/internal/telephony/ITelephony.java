...
public interface ITelephony extends IInterface {
    ...
    public static abstract class Stub extends Binder implements ITelephony {
        ...
        static final int TRANSACTION_addUceRegistrationOverrideShell = 321;
        static final int TRANSACTION_bootstrapAuthenticationRequest = 294;
        ...
        static final int TRANSACTION_clearSignalStrengthUpdateRequest = 329;
        static final int TRANSACTION_clearUceRegistrationOverrideShell = 323;
        ...
        static final int TRANSACTION_getBoundGbaService = 296;
        ...
        static final int TRANSACTION_getCapabilityFromEab = 318;
        ...
        static final int TRANSACTION_getCarrierSingleRegistrationEnabled = 312;
        ...
        static final int TRANSACTION_getContactFromEab = 317;
        ...
        static final int TRANSACTION_getDeviceSingleRegistrationEnabled = 307;
        static final int TRANSACTION_getDeviceSoftwareVersionForSlot = 154;
        static final int TRANSACTION_getDeviceUceEnabled = 319;
        ...
        static final int TRANSACTION_getGbaReleaseTime = 298;
        static final int TRANSACTION_getImeiForSlot = 150;
        static final int TRANSACTION_getImsConfig = 96;
        static final int TRANSACTION_getImsFeatureValidationOverride = 314;
        ...
        static final int TRANSACTION_getLastUcePidfXmlShell = 325;
        static final int TRANSACTION_getLatestRcsContactUceCapabilityShell = 324;
        ...
        static final int TRANSACTION_getMobileProvisioningUrl = 315;
        ...
        static final int TRANSACTION_getPhoneCapability = 330;
        ...
        static final int TRANSACTION_getRcsSingleRegistrationTestModeEnabled = 305;
        ...
        static final int TRANSACTION_getSlicingConfig = 332;
        ...
        static final int TRANSACTION_isNrDualConnectivityEnabled = 291;
        static final int TRANSACTION_isRadioInterfaceCapabilitySupported = 292;
        ...
        static final int TRANSACTION_isRcsVolteSingleRegistrationCapable = 300;
        ...
        static final int TRANSACTION_isVoNrEnabled = 289;
        ...
        static final int TRANSACTION_prepareForUnattendedReboot = 331;
        ...
        static final int TRANSACTION_registerRcsProvisioningCallback = 301;
        static final int TRANSACTION_removeContactFromEab = 316;
        static final int TRANSACTION_removeUceRegistrationOverrideShell = 322;
        static final int TRANSACTION_removeUceRequestDisallowedStatus = 326;
        ...
        static final int TRANSACTION_sendDeviceToDeviceMessage = 309;
        static final int TRANSACTION_sendDialerSpecialCode = 60;
        static final int TRANSACTION_sendEnvelopeWithStatus = 82;
        static final int TRANSACTION_sendThermalMitigationRequest = 293;
        static final int TRANSACTION_sendVisualVoicemailSmsForSubscriber = 59;
        static final int TRANSACTION_setActiveDeviceToDeviceTransport = 310;
        ...
        static final int TRANSACTION_setBoundGbaServiceOverride = 295;
        ...
        static final int TRANSACTION_setCapabilitiesRequestTimeout = 327;
        static final int TRANSACTION_setCarrierSingleRegistrationEnabledOverride = 308;
        ...
        static final int TRANSACTION_setDeviceSingleRegistrationEnabledOverride = 306;
        static final int TRANSACTION_setDeviceToDeviceForceEnabled = 311;
        static final int TRANSACTION_setDeviceUceEnabled = 320;
        static final int TRANSACTION_setForbiddenPlmns = 190;
        static final int TRANSACTION_setGbaReleaseTimeOverride = 297;
        static final int TRANSACTION_setIccLockEnabled = 281;
        static final int TRANSACTION_setImsFeatureValidationOverride = 313;
        ...
        static final int TRANSACTION_setNrDualConnectivityState = 290;
        ...
        static final int TRANSACTION_setRcsClientConfiguration = 299;
        static final int TRANSACTION_setRcsProvisioningStatusForCapability = 244;
        static final int TRANSACTION_setRcsSingleRegistrationTestModeEnabled = 304;
        static final int TRANSACTION_setRoamingOverride = 131;
        static final int TRANSACTION_setRttCapabilitySetting = 234;
        static final int TRANSACTION_setSignalStrengthUpdateRequest = 328;
        ...
        static final int TRANSACTION_setVoNrEnabled = 288;
        ...
        static final int TRANSACTION_triggerRcsReconfiguration = 303;
        ...
        static final int TRANSACTION_unregisterRcsProvisioningCallback = 302;
                ...
                default:
                    ...
                    switch (code) {
                        ...
                        case 4:
                            ...
                            boolean isRadioOnWithFeature = isRadioOnWithFeature(_arg012, data.readString());
                            reply.writeNoException();
                        ...
                        case 5:
                            ...
                            boolean isRadioOnForSubscriber = isRadioOnForSubscriber(_arg013, data.readString());
                            reply.writeNoException();
                        ...
                        case 6:
                            ...
                            boolean isRadioOnForSubscriberWithFeature = isRadioOnForSubscriberWithFeature(_arg014, _arg16, _arg23);
                            reply.writeNoException();
                        ...
                        case 7:
                            ...
                            setCallComposerStatus(_arg015, data.readInt());
                            reply.writeNoException();
                            return true;
                        case 8:
                            data.enforceInterface(DESCRIPTOR);
                            int _arg016 = data.readInt();
                            int _result = getCallComposerStatus(_arg016);
                            reply.writeNoException();
                        ...
                        case 9:
                            ...
                            boolean supplyPinForSubscriber = supplyPinForSubscriber(_arg017, data.readString());
                            reply.writeNoException();
                        ...
                        case 10:
                            ...
                            boolean supplyPukForSubscriber = supplyPukForSubscriber(_arg018, _arg17, _arg24);
                            reply.writeNoException();
                        ...
                        case 11:
                            ...
                            int[] _result2 = supplyPinReportResultForSubscriber(_arg019, data.readString());
                            reply.writeNoException();
                        ...
                        case 12:
                            ...
                            int[] _result3 = supplyPukReportResultForSubscriber(_arg020, _arg18, _arg25);
                            reply.writeNoException();
                        ...
                        case 14:
                            ...
                            if (data.readInt() != 0) {
                                _arg2 = ResultReceiver.CREATOR.mo3559createFromParcel(data);
                            } else {
                                _arg2 = null;
                            }
                            handleUssdRequest(_arg022, _arg19, _arg2);
                            reply.writeNoException();
                            return true;
                        case 15:
                            data.enforceInterface(DESCRIPTOR);
                        ...
                        case 19:
                            ...
                            boolean radioForSubscriber = setRadioForSubscriber(_arg026, _arg15);
                            reply.writeNoException();
                        ...
                        case 22:
                            ...
                            updateServiceLocationWithPackageName(_arg028);
                            reply.writeNoException();
                            return true;
                        case 23:
                            data.enforceInterface(DESCRIPTOR);
                        ...
                        case 27:
                            ...
                            boolean isDataConnectivityPossible = isDataConnectivityPossible(_arg029);
                            reply.writeNoException();
                        ...
                        case 28:
                            ...
                            CellIdentity _result4 = getCellLocation(_arg030, data.readString());
                            reply.writeNoException();
                            if (_result4 != null) {
                                reply.writeInt(1);
                        ...
                        case 29:
                            ...
                            String _result5 = getNetworkCountryIsoForPhone(_arg031);
                            reply.writeNoException();
                        ...
                        case 30:
                            ...
                            List<NeighboringCellInfo> _result6 = getNeighboringCellInfo(_arg032, data.readString());
                            reply.writeNoException();
                        ...
                        case 32:
                            ...
                            int _result8 = getCallStateForSubscription(_arg033, _arg110, _arg26);
                            reply.writeNoException();
                        ...
                        case 34:
                            ...
                            int _result10 = getDataActivityForSubId(_arg034);
                            reply.writeNoException();
                        ...
                        case 36:
                            ...
                            int _result12 = getDataStateForSubId(_arg035);
                            reply.writeNoException();
                        ...
                        case 38:
                            ...
                            int _result14 = getActivePhoneTypeForSlot(_arg036);
                            reply.writeNoException();
                        ...
                        case 39:
                            ...
                            int _result15 = getCdmaEriIconIndex(_arg037, data.readString());
                            reply.writeNoException();
                        ...
                        case 40:
                            ...
                            int _result16 = getCdmaEriIconIndexForSubscriber(_arg038, _arg111, _arg27);
                            reply.writeNoException();
                        ...
                        case 41:
                            ...
                            int _result17 = getCdmaEriIconMode(_arg039, data.readString());
                            reply.writeNoException();
                        ...
                        case 42:
                            ...
                            int _result18 = getCdmaEriIconModeForSubscriber(_arg040, _arg112, _arg28);
                            reply.writeNoException();
                        ...
                        case 43:
                            ...
                            String _result19 = getCdmaEriText(_arg041, data.readString());
                            reply.writeNoException();
                        ...
                        case 44:
                            ...
                            String _result20 = getCdmaEriTextForSubscriber(_arg042, _arg113, _arg29);
                            reply.writeNoException();
                        ...
                        case 46:
                            ...
                            boolean voiceMailNumber = setVoiceMailNumber(_arg043, _arg114, _arg210);
                            reply.writeNoException();
                        ...
                        case 49:
                            ...
                            int _result21 = getVoiceActivationState(_arg046, data.readString());
                            reply.writeNoException();
                        ...
                        case 50:
                            ...
                            int _result22 = getDataActivationState(_arg047, data.readString());
                            reply.writeNoException();
                        ...
                        case 51:
                            ...
                            int _result23 = getVoiceMessageCountForSubscriber(_arg048, _arg115, _arg211);
                            reply.writeNoException();
                        ...
                        case 54:
                            ...
                            String _result25 = getVisualVoicemailPackageName(_arg051, _arg116, _arg212);
                            reply.writeNoException();
                        ...
                        case 55:
                            ...
                            if (data.readInt() != 0) {
                                _arg22 = VisualVoicemailSmsFilterSettings.CREATOR.mo3559createFromParcel(data);
                            } else {
                                _arg22 = null;
                            }
                            enableVisualVoicemailSmsFilter(_arg052, _arg117, _arg22);
                            reply.writeNoException();
                            return true;
                        case 56:
                            data.enforceInterface(DESCRIPTOR);
                        ...
                        case 60:
                            ...
                            sendDialerSpecialCode(_arg056, data.readString());
                            reply.writeNoException();
                            return true;
                        case 61:
                            data.enforceInterface(DESCRIPTOR);
                            ...
                            int _result28 = getNetworkTypeForSubscriber(_arg057, _arg118, _arg213);
                            reply.writeNoException();
                        ...
                        case 62:
                            ...
                            int _result29 = getDataNetworkType(_arg058, data.readString());
                            reply.writeNoException();
                        ...
                        case 63:
                            ...
                            int _result30 = getDataNetworkTypeForSubscriber(_arg059, _arg119, _arg214);
                            reply.writeNoException();
                        ...
                        case 64:
                            ...
                            int _result31 = getVoiceNetworkTypeForSubscriber(_arg060, _arg120, _arg215);
                            reply.writeNoException();
                        ...
                        case 66:
                            ...
                            boolean hasIccCardUsingSlotIndex = hasIccCardUsingSlotIndex(_arg061);
                            reply.writeNoException();
                        ...
                        case 67:
                            ...
                            int _result32 = getLteOnCdmaMode(_arg062, data.readString());
                            reply.writeNoException();
                        ...
                        case 68:
                            ...
                            int _result33 = getLteOnCdmaModeForSubscriber(_arg063, _arg121, _arg216);
                            reply.writeNoException();
                        ...
                        case 69:
                            ...
                            List<CellInfo> _result34 = getAllCellInfo(_arg064, data.readString());
                            reply.writeNoException();
                        ...
                        case 75:
                            ...
                            boolean iccCloseLogicalChannelBySlot = iccCloseLogicalChannelBySlot(_arg066, data.readInt());
                            reply.writeNoException();
                        ...
                        case 76:
                            ...
                            boolean iccCloseLogicalChannel = iccCloseLogicalChannel(_arg067, data.readInt());
                            reply.writeNoException();
                        ...
                        case 82:
                            ...
                            String _result35 = sendEnvelopeWithStatus(_arg068, data.readString());
                            reply.writeNoException();
                        ...
                        case 83:
                            ...
                            String _result36 = nvReadItem(_arg069);
                            reply.writeNoException();
                        ...
                        case 84:
                            ...
                            boolean nvWriteItem = nvWriteItem(_arg070, data.readString());
                            reply.writeNoException();
                        ...
                        case 85:
                            ...
                            boolean nvWriteCdmaPrl = nvWriteCdmaPrl(_arg071);
                            reply.writeNoException();
                        ...
                        case 86:
                            ...
                            boolean resetModemConfig = resetModemConfig(_arg072);
                            reply.writeNoException();
                        ...
                        case 87:
                            ...
                            boolean rebootModem = rebootModem(_arg073);
                            reply.writeNoException();
                        ...
                        case 88:
                            ...
                            int _result37 = getAllowedNetworkTypesBitmask(_arg074);
                            reply.writeNoException();
                        ...
                        case 89:
                            ...
                            boolean isTetheringApnRequiredForSubscriber = isTetheringApnRequiredForSubscriber(_arg075);
                            reply.writeNoException();
                        ...
                        case 93:
                            ...
                            registerMmTelFeatureCallback(_arg079, IImsServiceFeatureCallback.Stub.asInterface(data.readStrongBinder()));
                            reply.writeNoException();
                            return true;
                        case 94:
                            data.enforceInterface(DESCRIPTOR);
                            IImsServiceFeatureCallback _arg080 = IImsServiceFeatureCallback.Stub.asInterface(data.readStrongBinder());
                            unregisterImsFeatureCallback(_arg080);
                            reply.writeNoException();
                            return true;
                        case 95:
                            data.enforceInterface(DESCRIPTOR);
                            int _arg081 = data.readInt();
                            IImsRegistration _result38 = getImsRegistration(_arg081, data.readInt());
                            reply.writeNoException();
                            if (_result38 != null) {
                        ...
                        case 96:
                            ...
                            IImsConfig _result39 = getImsConfig(_arg082, data.readInt());
                            reply.writeNoException();
                            if (_result39 != null) {
                        ...
                        case 98:
                            ...
                            boolean clearCarrierImsServiceOverride = clearCarrierImsServiceOverride(_arg083);
                            reply.writeNoException();
                        ...
                        case 99:
                            ...
                            String _result40 = getBoundImsServicePackage(_arg084, _arg15, _arg217);
                            reply.writeNoException();
                        ...
                        case 100:
                            ...
                            getImsMmTelFeatureState(_arg085, IIntegerConsumer.Stub.asInterface(data.readStrongBinder()));
                            reply.writeNoException();
                            return true;
                        case 101:
                            data.enforceInterface(DESCRIPTOR);
                            int _arg086 = data.readInt();
                            setNetworkSelectionModeAutomatic(_arg086);
                            reply.writeNoException();
                            return true;
                        case 102:
                            data.enforceInterface(DESCRIPTOR);
                            ...
                            CellNetworkScanResult _result41 = getCellNetworkScanResults(_arg087, _arg122, _arg218);
                            reply.writeNoException();
                            if (_result41 != null) {
                                reply.writeInt(1);
                        ...
                        case 104:
                            ...
                            stopNetworkScan(_arg088, data.readInt());
                            reply.writeNoException();
                            return true;
                        case 105:
                            data.enforceInterface(DESCRIPTOR);
                            ...
                            if (data.readInt() != 0) {
                                _arg1 = OperatorInfo.CREATOR.mo3559createFromParcel(data);
                            } else {
                                _arg1 = null;
                            }
                            if (data.readInt() != 0) {
                            ...
                            boolean networkSelectionModeManual = setNetworkSelectionModeManual(_arg089, _arg1, _arg15);
                            reply.writeNoException();
                        ...
                        case 106:
                            ...
                            long _result42 = getAllowedNetworkTypesForReason(_arg090, data.readInt());
                            reply.writeNoException();
                        ...
                        case 107:
                            ...
                            boolean allowedNetworkTypesForReason = setAllowedNetworkTypesForReason(_arg091, _arg123, _arg219);
                            reply.writeNoException();
                        ...
                        case 108:
                            ...
                            boolean dataEnabled = getDataEnabled(_arg092);
                            reply.writeNoException();
                        ...
                        case 109:
                            ...
                            boolean isUserDataEnabled = isUserDataEnabled(_arg093);
                            reply.writeNoException();
                        ...
                        case 110:
                            ...
                            boolean isDataEnabled = isDataEnabled(_arg094);
                            reply.writeNoException();
                        ...
                        case 111:
                            ...
                            setDataEnabledForReason(_arg095, _arg124, _arg15);
                            reply.writeNoException();
                            return true;
                        case 112:
                            data.enforceInterface(DESCRIPTOR);
                            int _arg096 = data.readInt();
                            boolean isDataEnabledForReason = isDataEnabledForReason(_arg096, data.readInt());
                            reply.writeNoException();
                        ...
                        case 114:
                            ...
                            setAlwaysReportSignalStrength(_arg098, _arg15);
                            reply.writeNoException();
                            return true;
                        case 115:
                            data.enforceInterface(DESCRIPTOR);
                            ...
                            String[] _result43 = getPcscfAddress(_arg099, _arg125, _arg220);
                            reply.writeNoException();
                        ...
                        case 116:
                            ...
                            boolean _arg0100 = _arg15;
                            setImsRegistrationState(_arg0100);
                            reply.writeNoException();
                            return true;
                        case 117:
                            data.enforceInterface(DESCRIPTOR);
                            int _arg0101 = data.readInt();
                            String _result44 = getCdmaMdn(_arg0101);
                            reply.writeNoException();
                        ...
                        case 118:
                            ...
                            String _result45 = getCdmaMin(_arg0102);
                            reply.writeNoException();
                        ...
                        case 120:
                            ...
                            int _result46 = getCarrierPrivilegeStatus(_arg0103);
                            reply.writeNoException();
                        ...
                        case 121:
                            ...
                            int _result47 = getCarrierPrivilegeStatusForUid(_arg0104, data.readInt());
                            reply.writeNoException();
                        ...
                        case 122:
                            ...
                            int _result48 = checkCarrierPrivilegesForPackage(_arg0105, data.readString());
                            reply.writeNoException();
                        ...
                        case 123:
                            ...
                            int _result49 = checkCarrierPrivilegesForPackageAnyPhone(_arg0106);
                            reply.writeNoException();
                        ...
                        case 124:
                            ...
                            List<String> _result50 = getCarrierPackageNamesForIntentAndPhone(_arg0, data.readInt());
                            reply.writeNoException();
                        ...
                        case 125:
                            ...
                            boolean line1NumberForDisplayForSubscriber = setLine1NumberForDisplayForSubscriber(_arg0107, _arg126, _arg221);
                            reply.writeNoException();
                        ...
                        case 126:
                            ...
                            String _result51 = getLine1NumberForDisplay(_arg0108, _arg127, _arg222);
                            reply.writeNoException();
                        ...
                        case 127:
                            ...
                            String _result52 = getLine1AlphaTagForDisplay(_arg0109, _arg128, _arg223);
                            reply.writeNoException();
                        ...
                        case 128:
                            ...
                            String[] _result53 = getMergedSubscriberIds(_arg0110, _arg129, _arg224);
                            reply.writeNoException();
                        ...
                        case 129:
                            ...
                            String[] _result54 = getMergedImsisFromGroup(_arg0111, data.readString());
                            reply.writeNoException();
                        ...
                        case 132:
                            data.enforceInterface(DESCRIPTOR);
                            byte[] _arg0113 = data.createByteArray();
                            ...
                            int _result55 = invokeOemRilRequestRaw(_arg0113, _arg12);
                            reply.writeNoException();
                        ...
                        case 135:
                            ...
                            int _result56 = getRadioAccessFamily(_arg0114, data.readString());
                            reply.writeNoException();
                        ...
                        case 138:
                            ...
                            boolean isVideoCallingEnabled = isVideoCallingEnabled(_arg0116, data.readString());
                            reply.writeNoException();
                        ...
                        case 139:
                            ...
                            boolean canChangeDtmfToneLength = canChangeDtmfToneLength(_arg0117, _arg130, _arg225);
                            reply.writeNoException();
                        ...
                        case 140:
                            ...
                            boolean isWorldPhone = isWorldPhone(_arg0118, _arg131, _arg226);
                            reply.writeNoException();
                        ...
                        case 142:
                            ...
                            boolean isRttSupported = isRttSupported(_arg0119);
                            reply.writeNoException();
                        ...
                        case 144:
                            ...
                            boolean isImsRegistered = isImsRegistered(_arg0120);
                            reply.writeNoException();
                        ...
                        case 145:
                            ...
                            boolean isWifiCallingAvailable = isWifiCallingAvailable(_arg0121);
                            reply.writeNoException();
                        ...
                        case 146:
                            ...
                            boolean isVideoTelephonyAvailable = isVideoTelephonyAvailable(_arg0122);
                            reply.writeNoException();
                        ...
                        case 147:
                            ...
                            int _result57 = getImsRegTechnologyForMmTel(_arg0123);
                            reply.writeNoException();
                        ...
                        case 148:
                            ...
                            String _result58 = getDeviceId(_arg0124);
                            reply.writeNoException();
                        ...
                        case 149:
                            ...
                            String _result59 = getDeviceIdWithFeature(_arg0125, data.readString());
                            reply.writeNoException();
                        ...
                        case 150:
                            ...
                            String _result60 = getImeiForSlot(_arg0126, _arg132, _arg227);
                            reply.writeNoException();
                        ...
                        case 151:
                            ...
                            String _result61 = getTypeAllocationCodeForSlot(_arg0127);
                            reply.writeNoException();
                        ...
                        case 152:
                            ...
                            String _result62 = getMeidForSlot(_arg0128, _arg133, _arg228);
                            reply.writeNoException();
                        ...
                        case 153:
                            ...
                            String _result63 = getManufacturerCodeForSlot(_arg0129);
                            reply.writeNoException();
                        ...
                        case 155:
                            data.enforceInterface(DESCRIPTOR);
                            if (data.readInt() != 0) {
                                _arg02 = PhoneAccount.CREATOR.mo3559createFromParcel(data);
                            } else {
                                _arg02 = null;
                            }
                            int _result64 = getSubIdForPhoneAccount(_arg02);
                            reply.writeNoException();
                        ...
                        case 157:
                            ...
                            PhoneAccountHandle _result65 = getPhoneAccountHandleForSubscriptionId(_arg0130);
                            reply.writeNoException();
                            if (_result65 != null) {
                                reply.writeInt(1);
                        ...
                        case 158:
                            ...
                            factoryReset(_arg0131);
                            reply.writeNoException();
                            return true;
                        case 159:
                            data.enforceInterface(DESCRIPTOR);
                            int _arg0132 = data.readInt();
                            String _result66 = getSimLocaleForSubscriber(_arg0132);
                            reply.writeNoException();
                        ...
                        case 160:
                            data.enforceInterface(DESCRIPTOR);
                            if (data.readInt() != 0) {
                                _arg03 = ResultReceiver.CREATOR.mo3559createFromParcel(data);
                            } else {
                                _arg03 = null;
                            }
                            requestModemActivityInfo(_arg03);
                            return true;
                        case 161:
                        ...
                        case 162:
                            data.enforceInterface(DESCRIPTOR);
                            if (data.readInt() != 0) {
                                _arg04 = PhoneAccountHandle.CREATOR.mo3559createFromParcel(data);
                            } else {
                                _arg04 = null;
                            }
                            Uri _result67 = getVoicemailRingtoneUri(_arg04);
                            reply.writeNoException();
                            if (_result67 != null) {
                                reply.writeInt(1);
                        ...
                        case 164:
                            data.enforceInterface(DESCRIPTOR);
                            if (data.readInt() != 0) {
                                _arg05 = PhoneAccountHandle.CREATOR.mo3559createFromParcel(data);
                            } else {
                                _arg05 = null;
                            }
                            boolean isVoicemailVibrationEnabled = isVoicemailVibrationEnabled(_arg05);
                            reply.writeNoException();
                        ...
                        case 166:
                            ...
                            List<String> _result68 = getPackagesWithCarrierPrivileges(_arg0133);
                            reply.writeNoException();
                            reply.writeStringList(_result68);
                            return true;
                        case 167:
                            data.enforceInterface(DESCRIPTOR);
                            List<String> _result69 = getPackagesWithCarrierPrivilegesForAllPhones();
                            reply.writeNoException();
                        ...
                        case 168:
                            ...
                            String _result70 = getAidForAppType(_arg0134, data.readInt());
                            reply.writeNoException();
                        ...
                        case 169:
                            ...
                            String _result71 = getEsn(_arg0135);
                            reply.writeNoException();
                        ...
                        case 170:
                            ...
                            String _result72 = getCdmaPrlVersion(_arg0136);
                            reply.writeNoException();
                            reply.writeString(_result72);
                            return true;
                        case 171:
                            data.enforceInterface(DESCRIPTOR);
                            List<TelephonyHistogram> _result73 = getTelephonyHistograms();
                            reply.writeNoException();
                        ...
                        case 172:
                            data.enforceInterface(DESCRIPTOR);
                            if (data.readInt() != 0) {
                                _arg06 = CarrierRestrictionRules.CREATOR.mo3559createFromParcel(data);
                            } else {
                                _arg06 = null;
                            }
                            int _result74 = setAllowedCarriers(_arg06);
                            reply.writeNoException();
                            reply.writeInt(_result74);
                            return true;
                        case 173:
                            data.enforceInterface(DESCRIPTOR);
                            CarrierRestrictionRules _result75 = getAllowedCarriers();
                            reply.writeNoException();
                            if (_result75 != null) {
                                reply.writeInt(1);
                        ...
                        case 174:
                            ...
                            int _result76 = getSubscriptionCarrierId(_arg0137);
                            reply.writeNoException();
                        ...
                        case 175:
                            ...
                            String _result77 = getSubscriptionCarrierName(_arg0138);
                            reply.writeNoException();
                        ...
                        case 176:
                            ...
                            int _result78 = getSubscriptionSpecificCarrierId(_arg0139);
                            reply.writeNoException();
                        ...
                        case 177:
                            ...
                            String _result79 = getSubscriptionSpecificCarrierName(_arg0140);
                            reply.writeNoException();
                        ...
                        case 179:
                            ...
                            carrierActionSetRadioEnabled(_arg0141, _arg15);
                            reply.writeNoException();
                            return true;
                        case 180:
                            data.enforceInterface(DESCRIPTOR);
                            ...
                            carrierActionReportDefaultNetworkStatus(_arg0142, _arg15);
                            reply.writeNoException();
                            return true;
                        case 181:
                            data.enforceInterface(DESCRIPTOR);
                            int _arg0143 = data.readInt();
                            carrierActionResetAll(_arg0143);
                            reply.writeNoException();
                            return true;
                        case 182:
                        ...
                        case 184:
                            ...
                            getCallWaitingStatus(_arg0144, IIntegerConsumer.Stub.asInterface(data.readStrongBinder()));
                            reply.writeNoException();
                            return true;
                        case 185:
                        ...
                        case 187:
                            ...
                            setSimPowerStateForSlot(_arg0145, data.readInt());
                            reply.writeNoException();
                            return true;
                        case 188:
                        ...
                        case 191:
                            ...
                            boolean emergencyCallbackMode = getEmergencyCallbackMode(_arg0146);
                            reply.writeNoException();
                        ...
                        case 192:
                            ...
                            SignalStrength _result80 = getSignalStrength(_arg0147);
                            reply.writeNoException();
                            if (_result80 != null) {
                                reply.writeInt(1);
                        ...
                        case 193:
                            ...
                            int _result81 = getCardIdForDefaultEuicc(_arg0148, data.readString());
                            reply.writeNoException();
                        ...
                        case 194:
                            ...
                            List<UiccCardInfo> _result82 = getUiccCardsInfo(_arg0149);
                            reply.writeNoException();
                            reply.writeTypedList(_result82);
                            return true;
                        case 195:
                            data.enforceInterface(DESCRIPTOR);
                            UiccSlotInfo[] _result83 = getUiccSlotsInfo();
                            reply.writeNoException();
                            reply.writeTypedArray(_result83, 1);
                            return true;
                        case 196:
                            data.enforceInterface(DESCRIPTOR);
                            int[] _arg0150 = data.createIntArray();
                            boolean switchSlots = switchSlots(_arg0150);
                            reply.writeNoException();
                        ...
                        case 197:
                            ...
                            boolean isDataRoamingEnabled = isDataRoamingEnabled(_arg0151);
                            reply.writeNoException();
                        ...
                        case 198:
                            ...
                            setDataRoamingEnabled(_arg0152, _arg15);
                            reply.writeNoException();
                            return true;
                        case 199:
                            data.enforceInterface(DESCRIPTOR);
                            int _arg0153 = data.readInt();
                            int _result84 = getCdmaRoamingMode(_arg0153);
                            reply.writeNoException();
                        ...
                        case 200:
                            ...
                            boolean cdmaRoamingMode = setCdmaRoamingMode(_arg0154, data.readInt());
                            reply.writeNoException();
                        ...
                        case 201:
                            ...
                            int _result85 = getCdmaSubscriptionMode(_arg0155);
                            reply.writeNoException();
                        ...
                        case 202:
                            ...
                            boolean cdmaSubscriptionMode = setCdmaSubscriptionMode(_arg0156, data.readInt());
                            reply.writeNoException();
                        ...
                        case 204:
                            ...
                            int _result86 = getCarrierIdListVersion(_arg0157);
                            reply.writeNoException();
                        ...
                        case 207:
                            ...
                            int _result87 = getNetworkSelectionMode(_arg0159);
                            reply.writeNoException();
                        ...
                        case 210:
                            ...
                            registerImsRegistrationCallback(_arg0160, IImsRegistrationCallback.Stub.asInterface(data.readStrongBinder()));
                            reply.writeNoException();
                            return true;
                        case 211:
                            data.enforceInterface(DESCRIPTOR);
                            int _arg0161 = data.readInt();
                            unregisterImsRegistrationCallback(_arg0161, IImsRegistrationCallback.Stub.asInterface(data.readStrongBinder()));
                            reply.writeNoException();
                            return true;
                        case 212:
                            data.enforceInterface(DESCRIPTOR);
                            int _arg0162 = data.readInt();
                            getImsMmTelRegistrationState(_arg0162, IIntegerConsumer.Stub.asInterface(data.readStrongBinder()));
                            reply.writeNoException();
                            return true;
                        case 213:
                            data.enforceInterface(DESCRIPTOR);
                            int _arg0163 = data.readInt();
                            getImsMmTelRegistrationTransportType(_arg0163, IIntegerConsumer.Stub.asInterface(data.readStrongBinder()));
                            reply.writeNoException();
                            return true;
                        case 214:
                            data.enforceInterface(DESCRIPTOR);
                            int _arg0164 = data.readInt();
                            registerMmTelCapabilityCallback(_arg0164, IImsCapabilityCallback.Stub.asInterface(data.readStrongBinder()));
                            reply.writeNoException();
                            return true;
                        case 215:
                            data.enforceInterface(DESCRIPTOR);
                            int _arg0165 = data.readInt();
                            unregisterMmTelCapabilityCallback(_arg0165, IImsCapabilityCallback.Stub.asInterface(data.readStrongBinder()));
                            reply.writeNoException();
                            return true;
                        case 216:
                        ...
                        case 219:
                            ...
                            boolean isAdvancedCallingSettingEnabled = isAdvancedCallingSettingEnabled(_arg0166);
                            reply.writeNoException();
                        ...
                        case 220:
                            ...
                            setAdvancedCallingSettingEnabled(_arg0167, _arg15);
                            reply.writeNoException();
                            return true;
                        case 221:
                            data.enforceInterface(DESCRIPTOR);
                            int _arg0168 = data.readInt();
                            boolean isVtSettingEnabled = isVtSettingEnabled(_arg0168);
                            reply.writeNoException();
                        ...
                        case 222:
                            ...
                            setVtSettingEnabled(_arg0169, _arg15);
                            reply.writeNoException();
                            return true;
                        case 223:
                            data.enforceInterface(DESCRIPTOR);
                            int _arg0170 = data.readInt();
                            boolean isVoWiFiSettingEnabled = isVoWiFiSettingEnabled(_arg0170);
                            reply.writeNoException();
                        ...
                        case 224:
                            ...
                            setVoWiFiSettingEnabled(_arg0171, _arg15);
                            reply.writeNoException();
                            return true;
                        case 225:
                            data.enforceInterface(DESCRIPTOR);
                            int _arg0172 = data.readInt();
                            boolean isCrossSimCallingEnabledByUser = isCrossSimCallingEnabledByUser(_arg0172);
                            reply.writeNoException();
                        ...
                        case 226:
                            ...
                            setCrossSimCallingEnabled(_arg0173, _arg15);
                            reply.writeNoException();
                            return true;
                        case 227:
                            data.enforceInterface(DESCRIPTOR);
                            int _arg0174 = data.readInt();
                            boolean isVoWiFiRoamingSettingEnabled = isVoWiFiRoamingSettingEnabled(_arg0174);
                            reply.writeNoException();
                        ...
                        case 228:
                            ...
                            setVoWiFiRoamingSettingEnabled(_arg0175, _arg15);
                            reply.writeNoException();
                            return true;
                        case 229:
                        ...
                        case 230:
                            ...
                            int _result88 = getVoWiFiModeSetting(_arg0176);
                            reply.writeNoException();
                        ...
                        case 231:
                            ...
                            setVoWiFiModeSetting(_arg0177, data.readInt());
                            reply.writeNoException();
                            return true;
                        case 232:
                            data.enforceInterface(DESCRIPTOR);
                            int _arg0178 = data.readInt();
                            int _result89 = getVoWiFiRoamingModeSetting(_arg0178);
                            reply.writeNoException();
                        ...
                        case 233:
                            ...
                            setVoWiFiRoamingModeSetting(_arg0179, data.readInt());
                            reply.writeNoException();
                            return true;
                        case 234:
                            data.enforceInterface(DESCRIPTOR);
                            ...
                            setRttCapabilitySetting(_arg0180, _arg15);
                            reply.writeNoException();
                            return true;
                        case 235:
                            data.enforceInterface(DESCRIPTOR);
                            int _arg0181 = data.readInt();
                            boolean isTtyOverVolteEnabled = isTtyOverVolteEnabled(_arg0181);
                            reply.writeNoException();
                        ...
                        case 236:
                            ...
                            Map _result90 = getEmergencyNumberList(_arg0182, data.readString());
                            reply.writeNoException();
                            reply.writeMap(_result90);
                            return true;
                        case 237:
                            data.enforceInterface(DESCRIPTOR);
                            ...
                            boolean isEmergencyNumber = isEmergencyNumber(_arg0183, _arg15);
                            reply.writeNoException();
                        ...
                        case 238:
                            ...
                            List<String> _result91 = getCertsFromCarrierPrivilegeAccessRules(_arg0184);
                            reply.writeNoException();
                        ...
                        case 239:
                            ...
                            registerImsProvisioningChangedCallback(_arg0185, IImsConfigCallback.Stub.asInterface(data.readStrongBinder()));
                            reply.writeNoException();
                            return true;
                        case 240:
                            data.enforceInterface(DESCRIPTOR);
                            int _arg0186 = data.readInt();
                            unregisterImsProvisioningChangedCallback(_arg0186, IImsConfigCallback.Stub.asInterface(data.readStrongBinder()));
                            reply.writeNoException();
                            return true;
                        case 241:
                        ...
                        case 243:
                            ...
                            boolean rcsProvisioningStatusForCapability = getRcsProvisioningStatusForCapability(_arg0187, data.readInt());
                            reply.writeNoException();
                        ...
                        case 247:
                            ...
                            int _result92 = getImsProvisioningInt(_arg0188, data.readInt());
                            reply.writeNoException();
                        ...
                        case 248:
                            ...
                            String _result93 = getImsProvisioningString(_arg0189, data.readInt());
                            reply.writeNoException();
                        ...
                        case 252:
                            ...
                            if (data.readInt() != 0) {
                                _arg13 = EmergencyNumber.CREATOR.mo3559createFromParcel(data);
                            } else {
                                _arg13 = null;
                            }
                            updateEmergencyNumberListTestMode(_arg0190, _arg13);
                            reply.writeNoException();
                            return true;
                        case 253:
                            data.enforceInterface(DESCRIPTOR);
                            List<String> _result94 = getEmergencyNumberListTestMode();
                            reply.writeNoException();
                        ...
                        case 254:
                            ...
                            int _result95 = getEmergencyNumberDbVersion(_arg0191);
                            reply.writeNoException();
                        ...
                        case 256:
                            ...
                            updateOtaEmergencyNumberDbFilePath(_arg07);
                            reply.writeNoException();
                            return true;
                        case 257:
                            data.enforceInterface(DESCRIPTOR);
                        ...
                        case 258:
                            ...
                            boolean enableModemForSlot = enableModemForSlot(_arg0192, _arg15);
                            reply.writeNoException();
                        ...
                        case 259:
                            ...
                            boolean _arg0193 = _arg15;
                            setMultiSimCarrierRestriction(_arg0193);
                            reply.writeNoException();
                            return true;
                        case 260:
                            data.enforceInterface(DESCRIPTOR);
                            String _arg0194 = data.readString();
                            int _result96 = isMultiSimSupported(_arg0194, data.readString());
                            reply.writeNoException();
                        ...
                        case 263:
                            data.enforceInterface(DESCRIPTOR);
                            int[] _result97 = getSlotsMapping();
                            reply.writeNoException();
                            reply.writeIntArray(_result97);
                            return true;
                        case 264:
                            data.enforceInterface(DESCRIPTOR);
                            int _result98 = getRadioHalVersion();
                            reply.writeNoException();
                            reply.writeInt(_result98);
                            return true;
                        case 265:
                            data.enforceInterface(DESCRIPTOR);
                            String _result99 = getCurrentPackageName();
                            reply.writeNoException();
                        ...
                        case 266:
                            ...
                            boolean isApplicationOnUicc = isApplicationOnUicc(_arg0196, data.readInt());
                            reply.writeNoException();
                        ...
                        case 269:
                            ...
                            boolean isApnMetered = isApnMetered(_arg0197, data.readInt());
                            reply.writeNoException();
                        ...
                        case 271:
                            ...
                            List<RadioAccessSpecifier> _result100 = getSystemSelectionChannels(_arg0198);
                            reply.writeNoException();
                            reply.writeTypedList(_result100);
                            return true;
                        case 272:
                        ...
                        case 274:
                            ...
                            String _result101 = getMmsUserAgent(_arg0199);
                            reply.writeNoException();
                        ...
                        case 275:
                            ...
                            String _result102 = getMmsUAProfUrl(_arg0200);
                            reply.writeNoException();
                        ...
                        case 277:
                            ...
                            boolean isMobileDataPolicyEnabled = isMobileDataPolicyEnabled(_arg0201, data.readInt());
                            reply.writeNoException();
                        ...
                        case 278:
                            ...
                            boolean _arg0202 = _arg15;
                            setCepEnabled(_arg0202);
                            return true;
                        case 279:
                        ...
                        case 280:
                            ...
                            boolean isIccLockEnabled = isIccLockEnabled(_arg0203);
                            reply.writeNoException();
                        ...
                        case 285:
                            ...
                            String _result103 = getManualNetworkSelectionPlmn(_arg0204);
                            reply.writeNoException();
                        ...
                        case 288:
                            ...
                            int _result104 = setVoNrEnabled(_arg0205, _arg15);
                            reply.writeNoException();
                        ...
                        case 289:
                            ...
                            boolean isVoNrEnabled = isVoNrEnabled(_arg0206);
                            reply.writeNoException();
                        ...
                        case 290:
                            ...
                            int _result105 = setNrDualConnectivityState(_arg0207, data.readInt());
                            reply.writeNoException();
                        ...
                        case 291:
                            ...
                            boolean isNrDualConnectivityEnabled = isNrDualConnectivityEnabled(_arg0208);
                            reply.writeNoException();
                        ...
                        case 292:
                            ...
                            boolean isRadioInterfaceCapabilitySupported = isRadioInterfaceCapabilitySupported(_arg0209);
                            reply.writeNoException();
                        ...
                        case 295:
                            ...
                            boolean boundGbaServiceOverride = setBoundGbaServiceOverride(_arg0210, data.readString());
                            reply.writeNoException();
                        ...
                        case 296:
                            ...
                            String _result106 = getBoundGbaService(_arg0211);
                            reply.writeNoException();
                        ...
                        case 297:
                            ...
                            boolean gbaReleaseTimeOverride = setGbaReleaseTimeOverride(_arg0212, data.readInt());
                            reply.writeNoException();
                        ...
                        case 298:
                            ...
                            int _result107 = getGbaReleaseTime(_arg0213);
                            reply.writeNoException();
                        ...
                        case 299:
                            ...
                            if (data.readInt() != 0) {
                                _arg14 = RcsClientConfiguration.CREATOR.mo3559createFromParcel(data);
                            } else {
                                _arg14 = null;
                            }
                            setRcsClientConfiguration(_arg0214, _arg14);
                            reply.writeNoException();
                            return true;
                        case 300:
                            data.enforceInterface(DESCRIPTOR);
                            int _arg0215 = data.readInt();
                            boolean isRcsVolteSingleRegistrationCapable = isRcsVolteSingleRegistrationCapable(_arg0215);
                            reply.writeNoException();
                        ...
                        case 301:
                            ...
                            registerRcsProvisioningCallback(_arg0216, IRcsConfigCallback.Stub.asInterface(data.readStrongBinder()));
                            reply.writeNoException();
                            return true;
                        case 302:
                            data.enforceInterface(DESCRIPTOR);
                            int _arg0217 = data.readInt();
                            unregisterRcsProvisioningCallback(_arg0217, IRcsConfigCallback.Stub.asInterface(data.readStrongBinder()));
                            reply.writeNoException();
                            return true;
                        case 303:
                            data.enforceInterface(DESCRIPTOR);
                            int _arg0218 = data.readInt();
                            triggerRcsReconfiguration(_arg0218);
                            reply.writeNoException();
                            return true;
                        case 304:
                            data.enforceInterface(DESCRIPTOR);
                            ...
                            boolean _arg0219 = _arg15;
                            setRcsSingleRegistrationTestModeEnabled(_arg0219);
                            reply.writeNoException();
                            return true;
                        case 305:
                            data.enforceInterface(DESCRIPTOR);
                        ...
                        case 306:
                            ...
                            setDeviceSingleRegistrationEnabledOverride(_arg0220);
                            reply.writeNoException();
                            return true;
                        case 307:
                            data.enforceInterface(DESCRIPTOR);
                        ...
                        case 308:
                            ...
                            boolean carrierSingleRegistrationEnabledOverride = setCarrierSingleRegistrationEnabledOverride(_arg0221, data.readString());
                            reply.writeNoException();
                        ...
                        case 309:
                            ...
                            sendDeviceToDeviceMessage(_arg0222, data.readInt());
                            reply.writeNoException();
                            return true;
                        case 310:
                            data.enforceInterface(DESCRIPTOR);
                            String _arg0223 = data.readString();
                            setActiveDeviceToDeviceTransport(_arg0223);
                            reply.writeNoException();
                            return true;
                        case 311:
                            data.enforceInterface(DESCRIPTOR);
                            ...
                            boolean _arg0224 = _arg15;
                            setDeviceToDeviceForceEnabled(_arg0224);
                            reply.writeNoException();
                            return true;
                        case 312:
                            data.enforceInterface(DESCRIPTOR);
                            int _arg0225 = data.readInt();
                            boolean carrierSingleRegistrationEnabled = getCarrierSingleRegistrationEnabled(_arg0225);
                            reply.writeNoException();
                        ...
                        case 313:
                            ...
                            boolean imsFeatureValidationOverride = setImsFeatureValidationOverride(_arg0226, data.readString());
                            reply.writeNoException();
                        ...
                        case 314:
                            ...
                            boolean imsFeatureValidationOverride2 = getImsFeatureValidationOverride(_arg0227);
                            reply.writeNoException();
                            reply.writeInt(imsFeatureValidationOverride2 ? 1 : 0);
                            return true;
                        case 315:
                            data.enforceInterface(DESCRIPTOR);
                            String _result108 = getMobileProvisioningUrl();
                            reply.writeNoException();
                        ...
                        case 316:
                            ...
                            int _result109 = removeContactFromEab(_arg0228, data.readString());
                            reply.writeNoException();
                        ...
                        case 317:
                            ...
                            String _result110 = getContactFromEab(_arg0229);
                            reply.writeNoException();
                        ...
                        case 318:
                            ...
                            String _result111 = getCapabilityFromEab(_arg0230);
                            reply.writeNoException();
                        ...
                        case 320:
                            ...
                            boolean _arg0231 = _arg15;
                            setDeviceUceEnabled(_arg0231);
                            reply.writeNoException();
                            return true;
                        case 321:
                            data.enforceInterface(DESCRIPTOR);
                            int _arg0232 = data.readInt();
                            RcsContactUceCapability _result112 = addUceRegistrationOverrideShell(_arg0232, data.createStringArrayList());
                            reply.writeNoException();
                            if (_result112 != null) {
                                reply.writeInt(1);
                                _result112.writeToParcel(reply, 1);
                            } else {
                                reply.writeInt(0);
                            }
                            return true;
                        case 322:
                            ...
                            RcsContactUceCapability _result113 = removeUceRegistrationOverrideShell(_arg0233, data.createStringArrayList());
                            reply.writeNoException();
                            if (_result113 != null) {
                                reply.writeInt(1);
                        ...
                        case 323:
                            ...
                            RcsContactUceCapability _result114 = clearUceRegistrationOverrideShell(_arg0234);
                            reply.writeNoException();
                            if (_result114 != null) {
                                reply.writeInt(1);
                        ...
                        case 324:
                            ...
                            RcsContactUceCapability _result115 = getLatestRcsContactUceCapabilityShell(_arg0235);
                            reply.writeNoException();
                            if (_result115 != null) {
                                reply.writeInt(1);
                        ...
                        case 325:
                            ...
                            String _result116 = getLastUcePidfXmlShell(_arg0236);
                            reply.writeNoException();
                        ...
                        case 326:
                            ...
                            boolean removeUceRequestDisallowedStatus = removeUceRequestDisallowedStatus(_arg0237);
                            reply.writeNoException();
                        ...
                        case 327:
                            ...
                            boolean capabilitiesRequestTimeout = setCapabilitiesRequestTimeout(_arg0238, data.readLong());
                            reply.writeNoException();
                        ...
                        case 330:
                            data.enforceInterface(DESCRIPTOR);
                            PhoneCapability _result117 = getPhoneCapability();
                            reply.writeNoException();
                            if (_result117 != null) {
                                reply.writeInt(1);
                                _result117.writeToParcel(reply, 1);
                            } else {
                                reply.writeInt(0);
                            }
                            return true;
                        case 331:
                            data.enforceInterface(DESCRIPTOR);
                            int _result118 = prepareForUnattendedReboot();
                            reply.writeNoException();
                        ...
                        case 332:
                            data.enforceInterface(DESCRIPTOR);
                            if (data.readInt() != 0) {
                                _arg08 = ResultReceiver.CREATOR.mo3559createFromParcel(data);
                            } else {
                                _arg08 = null;
                            }
                            getSlicingConfig(_arg08);
                            reply.writeNoException();
                            return true;
                        default:
        ...
        public static class Proxy implements ITelephony {
            ...
            public CellIdentity getCellLocation(String callingPkg, String callingFeatureId) throws RemoteException {
                ...
                try {
                    ...
                    _reply.readException();
                    if (_reply.readInt() != 0) {
                        _result = CellIdentity.CREATOR.mo3559createFromParcel(_reply);
                    } else {
                        _result = null;
                    }
                    return _result;
            ...
            public VisualVoicemailSmsFilterSettings getVisualVoicemailSmsFilterSettings(String callingPackage, int subId) throws RemoteException {
                ...
                try {
                    ...
                    _reply.readException();
                    if (_reply.readInt() != 0) {
                        _result = VisualVoicemailSmsFilterSettings.CREATOR.mo3559createFromParcel(_reply);
                    } else {
                        _result = null;
                    }
                    return _result;
            ...
            public IccOpenLogicalChannelResponse iccOpenLogicalChannelBySlot(int slotIndex, String callingPackage, String AID, int p2) throws RemoteException {
                ...
                try {
                    ...
                    _reply.readException();
                    if (_reply.readInt() != 0) {
                        _result = IccOpenLogicalChannelResponse.CREATOR.mo3559createFromParcel(_reply);
                    } else {
                        _result = null;
                    }
                    return _result;
            ...
            public CellNetworkScanResult getCellNetworkScanResults(int subId, String callingPackage, String callingFeatureId) throws RemoteException {
                ...
                try {
                    ...
                    _reply.readException();
                    if (_reply.readInt() != 0) {
                        _result = CellNetworkScanResult.CREATOR.mo3559createFromParcel(_reply);
                    } else {
                        _result = null;
                    }
                    return _result;
            ...
            public PhoneAccountHandle getPhoneAccountHandleForSubscriptionId(int subscriptionId) throws RemoteException {
                ...
                try {
                    ...
                    _reply.readException();
                    if (_reply.readInt() != 0) {
                        _result = PhoneAccountHandle.CREATOR.mo3559createFromParcel(_reply);
                    } else {
                        _result = null;
                    }
                    return _result;
            ...
            public ServiceState getServiceStateForSubscriber(int subId, String callingPackage, String callingFeatureId) throws RemoteException {
                ...
                try {
                    ...
                    _reply.readException();
                    if (_reply.readInt() != 0) {
                        _result = ServiceState.CREATOR.mo3559createFromParcel(_reply);
                    } else {
                        _result = null;
                    }
                    return _result;
            ...
            public Uri getVoicemailRingtoneUri(PhoneAccountHandle accountHandle) throws RemoteException {
                ...
                try {
                    ...
                    _reply.readException();
                    if (_reply.readInt() != 0) {
                        _result = Uri.CREATOR.mo3559createFromParcel(_reply);
                    } else {
                        _result = null;
                    }
                    return _result;
            ...
            public CarrierRestrictionRules getAllowedCarriers() throws RemoteException {
                ...
                try {
                    ...
                    _reply.readException();
                    if (_reply.readInt() != 0) {
                        _result = CarrierRestrictionRules.CREATOR.mo3559createFromParcel(_reply);
                    } else {
                        _result = null;
                    }
                    return _result;
            ...
            public SignalStrength getSignalStrength(int subId) throws RemoteException {
                ...
                try {
                    ...
                    _reply.readException();
                    if (_reply.readInt() != 0) {
                        _result = SignalStrength.CREATOR.mo3559createFromParcel(_reply);
                    } else {
                        _result = null;
                    }
                    return _result;
            ...
            public int setVoNrEnabled(int subId, boolean enabled) throws RemoteException {
                ...
                try {
                    ...
                    if (!_status && Stub.getDefaultImpl() != null) {
                        return Stub.getDefaultImpl().setVoNrEnabled(subId, enabled);
                    }
                    _reply.readException();
                    int _result = _reply.readInt();
                    return _result;
            ...
            public RcsContactUceCapability addUceRegistrationOverrideShell(int subId, List<String> featureTags) throws RemoteException {
                ...
                try {
                    ...
                    _reply.readException();
                    if (_reply.readInt() != 0) {
                        _result = RcsContactUceCapability.CREATOR.mo3559createFromParcel(_reply);
                    } else {
                        _result = null;
                    }
                    return _result;
            ...
            public PhoneCapability getPhoneCapability() throws RemoteException {
                ...
                try {
                    ...
                    _reply.readException();
                    if (_reply.readInt() != 0) {
                        _result = PhoneCapability.CREATOR.mo3559createFromParcel(_reply);
                    } else {
                        _result = null;
                    }
                    return _result;
        ...
        private boolean onTransact$sendVisualVoicemailSmsForSubscriber$(Parcel data, Parcel reply) throws RemoteException {
            ...
            if (data.readInt() != 0) {
                _arg6 = PendingIntent.CREATOR.mo3559createFromParcel(data);
            } else {
                _arg6 = null;
            }
        ...
        private boolean onTransact$requestCellInfoUpdateWithWorkSource$(Parcel data, Parcel reply) throws RemoteException {
            ...
            String _arg3 = data.readString();
            if (data.readInt() != 0) {
                _arg4 = WorkSource.CREATOR.mo3559createFromParcel(data);
            } else {
                _arg4 = null;
            }
        ...
        private boolean onTransact$requestNetworkScan$(Parcel data, Parcel reply) throws RemoteException {
            ...
            int _arg0 = data.readInt();
            if (data.readInt() != 0) {
                _arg1 = NetworkScanRequest.CREATOR.mo3559createFromParcel(data);
            } else {
                _arg1 = null;
            }
            if (data.readInt() != 0) {
                _arg2 = Messenger.CREATOR.mo3559createFromParcel(data);
            } else {
                _arg2 = null;
            }
        ...
        private boolean onTransact$requestNumberVerification$(Parcel data, Parcel reply) throws RemoteException {
            ...
            data.enforceInterface(DESCRIPTOR);
            if (data.readInt() != 0) {
                _arg0 = PhoneNumberRange.CREATOR.mo3559createFromParcel(data);
            } else {
                _arg0 = null;
            }
        ...
        private boolean onTransact$uploadCallComposerPicture$(Parcel data, Parcel reply) throws RemoteException {
            ...
            String _arg2 = data.readString();
            if (data.readInt() != 0) {
                _arg3 = ParcelFileDescriptor.CREATOR.mo3559createFromParcel(data);
            } else {
                _arg3 = null;
            }
            if (data.readInt() != 0) {
                _arg4 = ResultReceiver.CREATOR.mo3559createFromParcel(data);
            } else {
                _arg4 = null;
            }
        ...
        private boolean onTransact$getSubIdForPhoneAccountHandle$(Parcel data, Parcel reply) throws RemoteException {
            ...
            data.enforceInterface(DESCRIPTOR);
            if (data.readInt() != 0) {
                _arg0 = PhoneAccountHandle.CREATOR.mo3559createFromParcel(data);
            } else {
                _arg0 = null;
            }
            String _arg1 = data.readString();
        ...
        private boolean onTransact$setVoicemailRingtoneUri$(Parcel data, Parcel reply) throws RemoteException {
            ...
            String _arg0 = data.readString();
            if (data.readInt() != 0) {
                _arg1 = PhoneAccountHandle.CREATOR.mo3559createFromParcel(data);
            } else {
                _arg1 = null;
            }
            if (data.readInt() != 0) {
                _arg2 = Uri.CREATOR.mo3559createFromParcel(data);
            } else {
                _arg2 = null;
            }
        ...
        private boolean onTransact$setCallForwarding$(Parcel data, Parcel reply) throws RemoteException {
            ...
            int _arg0 = data.readInt();
            if (data.readInt() != 0) {
                _arg1 = CallForwardingInfo.CREATOR.mo3559createFromParcel(data);
            } else {
                _arg1 = null;
            }
        ...
        private boolean onTransact$sendThermalMitigationRequest$(Parcel data, Parcel reply) throws RemoteException {
            ...
            int _arg0 = data.readInt();
            if (data.readInt() != 0) {
                _arg1 = ThermalMitigationRequest.CREATOR.mo3559createFromParcel(data);
            } else {
                _arg1 = null;
            }
            String _arg2 = data.readString();
        ...
        private boolean onTransact$bootstrapAuthenticationRequest$(Parcel data, Parcel reply) throws RemoteException {
            ...
            if (data.readInt() != 0) {
                _arg3 = UaSecurityProtocolIdentifier.CREATOR.mo3559createFromParcel(data);
            } else {
                _arg3 = null;
            }
        ...
        private boolean onTransact$setSignalStrengthUpdateRequest$(Parcel data, Parcel reply) throws RemoteException {
            ...
            int _arg0 = data.readInt();
            if (data.readInt() != 0) {
                _arg1 = SignalStrengthUpdateRequest.CREATOR.mo3559createFromParcel(data);
            } else {
                _arg1 = null;
            }
            String _arg2 = data.readString();
