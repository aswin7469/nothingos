...
public interface IUpdateAvailableNetworksCallback extends IInterface {
    public static final String DESCRIPTOR = "com.android.internal.telephony.IUpdateAvailableNetworksCallback";
    ...
    public static abstract class Stub extends Binder implements IUpdateAvailableNetworksCallback {
        ...
        public Stub() {
            attachInterface(this, IUpdateAvailableNetworksCallback.DESCRIPTOR);
        }
        ...
        public static IUpdateAvailableNetworksCallback asInterface(IBinder obj) {
            ...
            IInterface iin = obj.queryLocalInterface(IUpdateAvailableNetworksCallback.DESCRIPTOR);
        ...
        public boolean onTransact(int code, Parcel data, Parcel reply, int flags) throws RemoteException {
            switch (code) {
                case IBinder.INTERFACE_TRANSACTION /* 1598968902 */:
                    reply.writeString(IUpdateAvailableNetworksCallback.DESCRIPTOR);
                    return true;
                default:
                    switch (code) {
                        case 1:
                            data.enforceInterface(IUpdateAvailableNetworksCallback.DESCRIPTOR);
        ...
        public static class Proxy implements IUpdateAvailableNetworksCallback {
            ...
            public String getInterfaceDescriptor() {
                return IUpdateAvailableNetworksCallback.DESCRIPTOR;
            }
            ...
            public void onComplete(int result) throws RemoteException {
                ...
                try {
                    _data.writeInterfaceToken(IUpdateAvailableNetworksCallback.DESCRIPTOR);
