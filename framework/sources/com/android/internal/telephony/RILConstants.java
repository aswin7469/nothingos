...
public interface RILConstants {
    ...
    public static final int PREFERRED_NETWORK_MODE = ((Integer) Optional.of(android.sysprop.TelephonyProperties.default_network()).filter(RILConstants$$ExternalSyntheticLambda1.INSTANCE).map(RILConstants$$ExternalSyntheticLambda0.INSTANCE).orElse(0)).intValue();
    ...
    public static final int RIL_REQUEST_ALLOCATE_PDU_SESSION_ID = 215;
    ...
    public static final int RIL_REQUEST_CANCEL_HANDOVER = 218;
    ...
    public static final int RIL_REQUEST_CDMA_SEND_SMS_EXPECT_MORE = 148;
    ...
    public static final int RIL_REQUEST_EMERGENCY_DIAL = 205;
    public static final int RIL_REQUEST_ENABLE_MODEM = 146;
    public static final int RIL_REQUEST_ENABLE_NR_DUAL_CONNECTIVITY = 213;
    public static final int RIL_REQUEST_ENABLE_UICC_APPLICATIONS = 208;
    public static final int RIL_REQUEST_ENABLE_VONR = 225;
    public static final int RIL_REQUEST_ENTER_NETWORK_DEPERSONALIZATION = 8;
    public static final int RIL_REQUEST_ENTER_SIM_DEPERSONALIZATION = 212;
    ...
    public static final int RIL_REQUEST_GET_ALLOWED_NETWORK_TYPES_BITMAP = 223;
    public static final int RIL_REQUEST_GET_BARRING_INFO = 211;
    ...
    public static final int RIL_REQUEST_GET_ENHANCED_RADIO_CAPABILITY = 600;
    public static final int RIL_REQUEST_GET_HAL_DEVICE_CAPABILITIES = 220;
    ...
    public static final int RIL_REQUEST_GET_MODEM_STATUS = 147;
    public static final int RIL_REQUEST_GET_MUTE = 54;
    public static final int RIL_REQUEST_GET_NEIGHBORING_CELL_IDS = 75;
    public static final int RIL_REQUEST_GET_PHONE_CAPABILITY = 206;
    ...
    public static final int RIL_REQUEST_GET_SIM_PHONEBOOK_CAPACITY = 149;
    public static final int RIL_REQUEST_GET_SIM_PHONEBOOK_RECORDS = 150;
    public static final int RIL_REQUEST_GET_SIM_STATUS = 1;
    public static final int RIL_REQUEST_GET_SLICING_CONFIG = 224;
    public static final int RIL_REQUEST_GET_SLOT_STATUS = 200;
    public static final int RIL_REQUEST_GET_SMSC_ADDRESS = 100;
    public static final int RIL_REQUEST_GET_SYSTEM_SELECTION_CHANNELS = 219;
    public static final int RIL_REQUEST_GET_UICC_APPLICATIONS_ENABLEMENT = 209;
    ...
    public static final int RIL_REQUEST_HAL_NON_RIL_BASE = 200;
    ...
    public static final int RIL_REQUEST_IS_NR_DUAL_CONNECTIVITY_ENABLED = 214;
    public static final int RIL_REQUEST_IS_VONR_ENABLED = 225;
    ...
    public static final int RIL_REQUEST_RELEASE_PDU_SESSION_ID = 216;
    ...
    public static final int RIL_REQUEST_SET_ALLOWED_NETWORK_TYPES_BITMAP = 222;
    ...
    public static final int RIL_REQUEST_SET_CARRIER_INFO_IMSI_ENCRYPTION = 141;
    public static final int RIL_REQUEST_SET_CLIR = 32;
    public static final int RIL_REQUEST_SET_DATA_PROFILE = 128;
    public static final int RIL_REQUEST_SET_DATA_THROTTLING = 221;
    ...
    public static final int RIL_REQUEST_SET_LINK_CAPACITY_REPORTING_CRITERIA = 203;
    public static final int RIL_REQUEST_SET_LOCATION_UPDATES = 76;
    public static final int RIL_REQUEST_SET_LOGICAL_TO_PHYSICAL_SLOT_MAPPING = 201;
    ...
    public static final int RIL_REQUEST_SET_PREFERRED_DATA_MODEM = 204;
    ...
    public static final int RIL_REQUEST_SET_SIGNAL_STRENGTH_REPORTING_CRITERIA = 202;
    ...
    public static final int RIL_REQUEST_SET_SYSTEM_SELECTION_CHANNELS = 210;
    ...
    public static final int RIL_REQUEST_START_HANDOVER = 217;
    public static final int RIL_REQUEST_START_KEEPALIVE = 144;
    public static final int RIL_REQUEST_START_LCE = 132;
    public static final int RIL_REQUEST_START_NETWORK_SCAN = 142;
    ...
    public static final int RIL_REQUEST_STOP_KEEPALIVE = 145;
    public static final int RIL_REQUEST_STOP_LCE = 133;
    public static final int RIL_REQUEST_STOP_NETWORK_SCAN = 143;
    public static final int RIL_REQUEST_SWITCH_DUAL_SIM_CONFIG = 207;
    public static final int RIL_REQUEST_SWITCH_WAITING_OR_HOLDING_AND_ACTIVE = 15;
    public static final int RIL_REQUEST_UDUB = 17;
    public static final int RIL_REQUEST_UPDATE_SIM_PHONEBOOK_RECORD = 151;
    ...
    public static final int RIL_UNSOL_BARRING_INFO_CHANGED = 1105;
    public static final int RIL_UNSOL_CALL_RING = 1018;
    public static final int RIL_UNSOL_CARRIER_INFO_IMSI_ENCRYPTION = 1048;
    ...
    public static final int RIL_UNSOL_EMERGENCY_NUMBER_LIST = 1102;
    ...
    public static final int RIL_UNSOL_HAL_NON_RIL_BASE = 1100;
    public static final int RIL_UNSOL_HARDWARE_CONFIG_CHANGED = 1040;
    public static final int RIL_UNSOL_ICC_SLOT_STATUS = 1100;
    public static final int RIL_UNSOL_KEEPALIVE_STATUS = 1050;
    public static final int RIL_UNSOL_LCEDATA_RECV = 1045;
    public static final int RIL_UNSOL_MODEM_RESTART = 1047;
    public static final int RIL_UNSOL_NETWORK_SCAN_RESULT = 1049;
    ...
    public static final int RIL_UNSOL_PHYSICAL_CHANNEL_CONFIG = 1101;
    public static final int RIL_UNSOL_RADIO_CAPABILITY = 1042;
    public static final int RIL_UNSOL_REGISTRATION_FAILED = 1104;
    ...
    public static final int RIL_UNSOL_RESPONSE_SIM_PHONEBOOK_CHANGED = 1053;
    public static final int RIL_UNSOL_RESPONSE_SIM_PHONEBOOK_RECORDS_RECEIVED = 1054;
    ...
    public static final int RIL_UNSOL_UICC_APPLICATIONS_ENABLEMENT_CHANGED = 1103;
    public static final int RIL_UNSOL_UICC_SUBSCRIPTION_STATUS_CHANGED = 1038;
    public static final int RIL_UNSOL_UNTHROTTLE_APN = 1052;
    ...
    static /* synthetic */ boolean lambda$static$0(List list) {
        return !list.isEmpty();
    }

    static /* synthetic */ Integer lambda$static$1(List list) {
