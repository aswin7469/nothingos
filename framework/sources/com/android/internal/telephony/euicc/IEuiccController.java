                ...
                default:
                    ...
                    switch (code) {
                        ...
                        case 2:
                            ...
                            if (data.readInt() != 0) {
                                _arg12 = DownloadableSubscription.CREATOR.mo3559createFromParcel(data);
                            } else {
                                _arg12 = null;
                            }
                        ...
                        case 3:
                            ...
                            if (data.readInt() != 0) {
                                _arg22 = PendingIntent.CREATOR.mo3559createFromParcel(data);
                            } else {
                                _arg22 = null;
                            }
                        ...
                        case 6:
                            ...
                            if (data.readInt() != 0) {
                                _arg13 = DownloadableSubscription.CREATOR.mo3559createFromParcel(data);
                            } else {
                                _arg13 = null;
                            }
                            if (data.readInt() != 0) {
                        ...
                        case 8:
                            ...
                            if (data.readInt() != 0) {
                                _arg32 = PendingIntent.CREATOR.mo3559createFromParcel(data);
                            } else {
                                _arg32 = null;
                            }
                        ...
                        case 9:
                            ...
                            if (data.readInt() != 0) {
                                _arg33 = PendingIntent.CREATOR.mo3559createFromParcel(data);
                            } else {
                                _arg33 = null;
                            }
                        ...
                        case 10:
                            ...
                            if (data.readInt() != 0) {
                                _arg42 = PendingIntent.CREATOR.mo3559createFromParcel(data);
                            } else {
                                _arg42 = null;
                            }
                        ...
                        case 11:
                            ...
                            if (data.readInt() != 0) {
                                _arg14 = PendingIntent.CREATOR.mo3559createFromParcel(data);
                            } else {
                                _arg14 = null;
                            }
                        ...
                        case 12:
                            ...
                            if (data.readInt() != 0) {
                                _arg24 = PendingIntent.CREATOR.mo3559createFromParcel(data);
                            } else {
                                _arg24 = null;
                            }
        ...
        public static class Proxy implements IEuiccController {
            ...
            public EuiccInfo getEuiccInfo(int cardId) throws RemoteException {
                ...
                try {
                    ...
                    _reply.readException();
                    if (_reply.readInt() != 0) {
                        _result = EuiccInfo.CREATOR.mo3559createFromParcel(_reply);
                    } else {
                        _result = null;
                    }
                    return _result;
