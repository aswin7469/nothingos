            ...
            if (userDataCompressed) {
                ...
                switch ((i2 >> 2) & 3) {
                    case 0:
                        ...
                        break;
                    case 1:
                        if (r.getBoolean(R.bool.config_sms_decode_gsm_8bit_data)) {
                            encodingType = 2;
                            break;
                        }
                        Rlog.w(LOG_TAG, "1 - Unsupported SMS data coding scheme " + (this.mDataCodingScheme & 255));
                        encodingType = r.getInteger(R.integer.default_reserved_data_coding_scheme);
                        break;
                    case 2:
                        encodingType = 3;
                        break;
