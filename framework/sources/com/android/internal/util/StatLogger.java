...
public class StatLogger {
    ...
    public void dump(PrintWriter pw, String prefix) {
        dump(new android.util.IndentingPrintWriter(pw, "  ").mo3457setIndent(prefix));
    }

    public void dump(android.util.IndentingPrintWriter pw) {
        synchronized (this.mLock) {
            if (!TextUtils.isEmpty(this.mStatsTag)) {
                pw.println(this.mStatsTag + SettingsStringUtil.DELIMITER);
            } else {
                pw.println("Stats:");
            }
