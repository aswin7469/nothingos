...
public interface PooledLambda {
    ...
    PooledLambda mo3494recycleOnUse();
    ...
    static <A> PooledSupplier<Boolean> obtainSupplier(Predicate<? super A> function, A arg1) {
        return (PooledSupplier) PooledLambdaImpl.acquire(PooledLambdaImpl.sPool, function, 1, 0, 2, arg1, null, null, null, null, null, null, null, null, null, null, null);
    }

    static <A, R> PooledSupplier<R> obtainSupplier(Function<? super A, ? extends R> function, A arg1) {
        return (PooledSupplier) PooledLambdaImpl.acquire(PooledLambdaImpl.sPool, function, 1, 0, 3, arg1, null, null, null, null, null, null, null, null, null, null, null);
    }
    ...
    static <A> Message obtainMessage(Consumer<? super A> function, A arg1) {
        ...
        synchronized (Message.sPoolSync) {
            ...
            callback = Message.obtain().setCallback(callback2.mo3494recycleOnUse());
        }
        return callback;
    }
    ...
    static <A, B> PooledSupplier<Boolean> obtainSupplier(BiPredicate<? super A, ? super B> function, A arg1, B arg2) {
        return (PooledSupplier) PooledLambdaImpl.acquire(PooledLambdaImpl.sPool, function, 2, 0, 2, arg1, arg2, null, null, null, null, null, null, null, null, null, null);
    }

    static <A, B, R> PooledSupplier<R> obtainSupplier(BiFunction<? super A, ? super B, ? extends R> function, A arg1, B arg2) {
        return (PooledSupplier) PooledLambdaImpl.acquire(PooledLambdaImpl.sPool, function, 2, 0, 3, arg1, arg2, null, null, null, null, null, null, null, null, null, null);
    }

    static <A, B> PooledConsumer<A> obtainConsumer(BiConsumer<? super A, ? super B> function, ArgumentPlaceholder<A> arg1, B arg2) {
        return (PooledConsumer) PooledLambdaImpl.acquire(PooledLambdaImpl.sPool, function, 2, 1, 1, arg1, arg2, null, null, null, null, null, null, null, null, null, null);
    }
    ...
    static <A, B, R> PooledFunction<A, R> obtainFunction(BiFunction<? super A, ? super B, ? extends R> function, ArgumentPlaceholder<A> arg1, B arg2) {
        return (PooledFunction) PooledLambdaImpl.acquire(PooledLambdaImpl.sPool, function, 2, 1, 3, arg1, arg2, null, null, null, null, null, null, null, null, null, null);
    }
    ...
    static <A, B, C, R> PooledSupplier<R> obtainSupplier(TriFunction<? super A, ? super B, ? super C, ? extends R> function, A arg1, B arg2, C arg3) {
        return (PooledSupplier) PooledLambdaImpl.acquire(PooledLambdaImpl.sPool, function, 3, 0, 3, arg1, arg2, arg3, null, null, null, null, null, null, null, null, null);
    }
    ...
    static <A, B, C> PooledConsumer<A> obtainConsumer(TriConsumer<? super A, ? super B, ? super C> function, ArgumentPlaceholder<A> arg1, B arg2, C arg3) {
        return (PooledConsumer) PooledLambdaImpl.acquire(PooledLambdaImpl.sPool, function, 3, 1, 1, arg1, arg2, arg3, null, null, null, null, null, null, null, null, null);
    }
    ...
    static <A, B, C, R> PooledFunction<A, R> obtainFunction(TriFunction<? super A, ? super B, ? super C, ? extends R> function, ArgumentPlaceholder<A> arg1, B arg2, C arg3) {
        return (PooledFunction) PooledLambdaImpl.acquire(PooledLambdaImpl.sPool, function, 3, 1, 3, arg1, arg2, arg3, null, null, null, null, null, null, null, null, null);
    }
    ...
    static <A, B, C, D, R> PooledSupplier<R> obtainSupplier(QuadFunction<? super A, ? super B, ? super C, ? super D, ? extends R> function, A arg1, B arg2, C arg3, D arg4) {
        return (PooledSupplier) PooledLambdaImpl.acquire(PooledLambdaImpl.sPool, function, 4, 0, 3, arg1, arg2, arg3, arg4, null, null, null, null, null, null, null, null);
    }
    ...
    static <A, B, C, D> PooledConsumer<A> obtainConsumer(QuadConsumer<? super A, ? super B, ? super C, ? super D> function, ArgumentPlaceholder<A> arg1, B arg2, C arg3, D arg4) {
        return (PooledConsumer) PooledLambdaImpl.acquire(PooledLambdaImpl.sPool, function, 4, 1, 1, arg1, arg2, arg3, arg4, null, null, null, null, null, null, null, null);
    }
    ...
    static <A, B, C, D, R> PooledFunction<A, R> obtainFunction(QuadFunction<? super A, ? super B, ? super C, ? super D, ? extends R> function, ArgumentPlaceholder<A> arg1, B arg2, C arg3, D arg4) {
        return (PooledFunction) PooledLambdaImpl.acquire(PooledLambdaImpl.sPool, function, 4, 1, 3, arg1, arg2, arg3, arg4, null, null, null, null, null, null, null, null);
    }
    ...
    static <A, B, C, D, E, R> PooledSupplier<R> obtainSupplier(QuintFunction<? super A, ? super B, ? super C, ? super D, ? super E, ? extends R> function, A arg1, B arg2, C arg3, D arg4, E arg5) {
        return (PooledSupplier) PooledLambdaImpl.acquire(PooledLambdaImpl.sPool, function, 5, 0, 3, arg1, arg2, arg3, arg4, arg5, null, null, null, null, null, null, null);
    }
    ...
    static <A, B, C, D, E, F, R> PooledSupplier<R> obtainSupplier(HexFunction<? super A, ? super B, ? super C, ? super D, ? super E, ? super F, ? extends R> function, A arg1, B arg2, C arg3, D arg4, E arg5, F arg6) {
        return (PooledSupplier) PooledLambdaImpl.acquire(PooledLambdaImpl.sPool, function, 6, 0, 3, arg1, arg2, arg3, arg4, arg5, arg6, null, null, null, null, null, null);
    }
    ...
    static <A, B, C, D, E, F, G, R> PooledSupplier<R> obtainSupplier(HeptFunction<? super A, ? super B, ? super C, ? super D, ? super E, ? super F, ? super G, ? extends R> function, A arg1, B arg2, C arg3, D arg4, E arg5, F arg6, G arg7) {
        return (PooledSupplier) PooledLambdaImpl.acquire(PooledLambdaImpl.sPool, function, 7, 0, 3, arg1, arg2, arg3, arg4, arg5, arg6, arg7, null, null, null, null, null);
    }
    ...
    static <A, B, C, D, E, F, G, H, R> PooledSupplier<R> obtainSupplier(OctFunction<? super A, ? super B, ? super C, ? super D, ? super E, ? super F, ? super G, ? super H, ? extends R> function, A arg1, B arg2, C arg3, D arg4, E arg5, F arg6, G arg7, H arg8) {
        return (PooledSupplier) PooledLambdaImpl.acquire(PooledLambdaImpl.sPool, function, 8, 0, 3, arg1, arg2, arg3, arg4, arg5, arg6, arg7, arg8, null, null, null, null);
    }
    ...
    static <A, B, C, D, E, F, G, H, I, R> PooledSupplier<R> obtainSupplier(NonaFunction<? super A, ? super B, ? super C, ? super D, ? super E, ? super F, ? super G, ? super H, ? super I, ? extends R> function, A arg1, B arg2, C arg3, D arg4, E arg5, F arg6, G arg7, H arg8, I arg9) {
        return (PooledSupplier) PooledLambdaImpl.acquire(PooledLambdaImpl.sPool, function, 9, 0, 3, arg1, arg2, arg3, arg4, arg5, arg6, arg7, arg8, arg9, null, null, null);
    }
    ...
    static <A, B, C, D, E, F, G, H, I, J, R> PooledSupplier<R> obtainSupplier(DecFunction<? super A, ? super B, ? super C, ? super D, ? super E, ? super F, ? super G, ? super H, ? super I, ? super J, ? extends R> function, A arg1, B arg2, C arg3, D arg4, E arg5, F arg6, G arg7, H arg8, I arg9, J arg10) {
        return (PooledSupplier) PooledLambdaImpl.acquire(PooledLambdaImpl.sPool, function, 10, 0, 3, arg1, arg2, arg3, arg4, arg5, arg6, arg7, arg8, arg9, arg10, null, null);
    }
    ...
    static <A, B, C, D, E, F, G, H, I, J, K, R> PooledSupplier<R> obtainSupplier(UndecFunction<? super A, ? super B, ? super C, ? super D, ? super E, ? super F, ? super G, ? super H, ? super I, ? super J, ? super K, ? extends R> function, A arg1, B arg2, C arg3, D arg4, E arg5, F arg6, G arg7, H arg8, I arg9, J arg10, K arg11) {
        return (PooledSupplier) PooledLambdaImpl.acquire(PooledLambdaImpl.sPool, function, 11, 0, 3, arg1, arg2, arg3, arg4, arg5, arg6, arg7, arg8, arg9, arg10, arg11, null);
    }
    ...
    static <A, B, C, D, E, F, G, H, I, J, K, L, R> PooledSupplier<R> obtainSupplier(DodecFunction<? super A, ? super B, ? super C, ? super D, ? super E, ? super F, ? super G, ? super H, ? super I, ? super J, ? super K, ? extends L, ? extends R> function, A arg1, B arg2, C arg3, D arg4, E arg5, F arg6, G arg7, H arg8, I arg9, J arg10, K arg11, L arg12) {
        return (PooledSupplier) PooledLambdaImpl.acquire(PooledLambdaImpl.sPool, function, 11, 0, 3, arg1, arg2, arg3, arg4, arg5, arg6, arg7, arg8, arg9, arg10, arg11, arg12);
    }
