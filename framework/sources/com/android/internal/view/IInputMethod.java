                ...
                default:
                    ...
                    switch (code) {
                        ...
                        case 2:
                            data.enforceInterface(DESCRIPTOR);
                            if (data.readInt() != 0) {
                                _arg0 = InlineSuggestionsRequestInfo.CREATOR.mo3559createFromParcel(data);
                            } else {
                                _arg0 = null;
                            }
                        ...
                        case 3:
                            data.enforceInterface(DESCRIPTOR);
                            if (data.readInt() != 0) {
                                _arg02 = InputBinding.CREATOR.mo3559createFromParcel(data);
                            } else {
                                _arg02 = null;
                            }
                            bindInput(_arg02);
                        ...
                        case 5:
                            ...
                            if (data.readInt() != 0) {
                                _arg3 = EditorInfo.CREATOR.mo3559createFromParcel(data);
                            } else {
                                _arg3 = null;
                            }
                        ...
                        case 6:
                            data.enforceInterface(DESCRIPTOR);
                            if (data.readInt() != 0) {
                                _arg03 = InputChannel.CREATOR.mo3559createFromParcel(data);
                            } else {
                                _arg03 = null;
                            }
                        ...
                        case 10:
                            ...
                            if (data.readInt() != 0) {
                                _arg22 = ResultReceiver.CREATOR.mo3559createFromParcel(data);
                            } else {
                                _arg22 = null;
                            }
                        ...
                        case 11:
                            data.enforceInterface(DESCRIPTOR);
                            if (data.readInt() != 0) {
                                _arg04 = InputMethodSubtype.CREATOR.mo3559createFromParcel(data);
                            } else {
                                _arg04 = null;
                            }
