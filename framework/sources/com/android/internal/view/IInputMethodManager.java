                ...
                default:
                    ...
                    switch (code) {
                        ...
                        case 6:
                            ...
                            boolean showSoftInput = showSoftInput(_arg05, _arg13, _arg22, _arg3, _arg4);
                            reply.writeNoException();
                        ...
                        case 7:
                            ...
                            if (data.readInt() != 0) {
                                _arg32 = ResultReceiver.CREATOR.mo3559createFromParcel(data);
                            } else {
                                _arg32 = null;
                            }
                            int _arg42 = data.readInt();
                            boolean hideSoftInput = hideSoftInput(_arg06, _arg14, _arg23, _arg32, _arg42);
                            reply.writeNoException();
                        ...
                        case 8:
                            ...
                            if (data.readInt() != 0) {
                                _arg6 = EditorInfo.CREATOR.mo3559createFromParcel(data);
                            } else {
                                _arg6 = null;
                            }
                            ...
                            InputBindResult _result5 = startInputOrWindowGainedFocus(_arg07, _arg15, _arg24, _arg33, _arg43, _arg5, _arg6, _arg7, _arg8, _arg9);
                            reply.writeNoException();
                            if (_result5 != null) {
                                reply.writeInt(1);
                        ...
                        case 16:
                            ...
                            boolean _arg110 = z2;
                            reportPerceptibleAsync(_arg012, _arg110);
                            return true;
                        case 17:
                            data.enforceInterface(DESCRIPTOR);
                            removeImeSurface();
        ...
        public static class Proxy implements IInputMethodManager {
            ...
            public InputMethodSubtype getLastInputMethodSubtype() throws RemoteException {
                ...
                try {
                    ...
                    _reply.readException();
                    if (_reply.readInt() != 0) {
                        _result = InputMethodSubtype.CREATOR.mo3559createFromParcel(_reply);
                    } else {
                        _result = null;
                    }
                    return _result;
            ...
            public InputBindResult startInputOrWindowGainedFocus(int startInputReason, IInputMethodClient client, IBinder windowToken, int startInputFlags, int softInputMode, int windowFlags, EditorInfo attribute, IInputContext inputContext, int missingMethodFlags, int unverifiedTargetSdkVersion) throws RemoteException {
                ...
                try {
                    ...
                    try {
                        ...
                        _reply.readException();
                        if (_reply.readInt() != 0) {
                            _result = InputBindResult.CREATOR.mo3559createFromParcel(_reply);
                        } else {
                            _result = null;
                        }
                        _reply.recycle();
