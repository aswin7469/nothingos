...
public class ScrollCaptureViewSupport<V extends View> implements ScrollCaptureCallback {
    ...
    public final void onScrollCaptureImageRequest(ScrollCaptureSession session, final CancellationSignal signal, Rect requestRect, final Consumer<Rect> onComplete) {
        ...
        final ScrollCaptureViewHelper.ScrollResult scrollResult = this.mViewHelper.onScrollRequested(view, session.getScrollBounds(), requestRect);
        ...
        Runnable captureAction = new Runnable() { // from class: com.android.internal.view.ScrollCaptureViewSupport$$ExternalSyntheticLambda0
            @Override // java.lang.Runnable
            public final void run() {
                ScrollCaptureViewSupport.this.lambda$onScrollCaptureImageRequest$0$ScrollCaptureViewSupport(signal, view, viewCaptureArea, onComplete, scrollResult);
            }
        };
        view.postOnAnimationDelayed(captureAction, this.mPostScrollDelayMillis);
    }

    public /* synthetic */ void lambda$onScrollCaptureImageRequest$0$ScrollCaptureViewSupport(CancellationSignal signal, View view, Rect viewCaptureArea, Consumer onComplete, ScrollCaptureViewHelper.ScrollResult scrollResult) {
        if (signal.isCanceled()) {
