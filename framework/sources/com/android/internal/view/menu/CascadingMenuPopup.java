...
final class CascadingMenuPopup extends MenuPopup implements MenuPresenter, View.OnKeyListener, PopupWindow.OnDismissListener {
    ...
    private static final int ITEM_LAYOUT = 17367117;
    ...
    private void showMenu(MenuBuilder menu) {
        ...
        MenuAdapter adapter = new MenuAdapter(menu, inflater, this.mOverflowOnly, 17367117);
        ...
        if (parentInfo == null && this.mShowTitle && menu.getHeaderTitle() != null) {
            FrameLayout titleItemView = (FrameLayout) inflater.inflate(R.layout.popup_menu_header_item_layout, (ViewGroup) listView, false);
    ...
    private View findParentViewForSubmenu(CascadingMenuInfo parentInfo, MenuBuilder submenu) {
        ...
        while (true) {
            if (i >= count) {
                break;
            } else if (owner != menuAdapter.mo3505getItem(i)) {
                i++;
            } else {
                ownerPosition = i;
                break;
