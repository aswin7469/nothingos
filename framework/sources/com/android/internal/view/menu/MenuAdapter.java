...
public class MenuAdapter extends BaseAdapter {
    ...
    public MenuItemImpl mo3505getItem(int position) {
        ArrayList<MenuItemImpl> items = this.mOverflowOnly ? this.mAdapterMenu.getNonActionItems() : this.mAdapterMenu.getVisibleItems();
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        int currGroupId = mo3505getItem(position).getGroupId();
        int prevGroupId = position + (-1) >= 0 ? mo3505getItem(position - 1).getGroupId() : currGroupId;
        ...
        itemView.initialize(mo3505getItem(position), 0);
        return convertView;
    }
