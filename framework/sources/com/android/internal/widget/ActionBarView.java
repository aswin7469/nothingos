...
public class ActionBarView extends AbsActionBarView implements DecorToolbar {
    ...
    public ActionBarView(Context context, AttributeSet attrs) {
        ...
        ViewGroup viewGroup = (ViewGroup) inflater.inflate(R.layout.action_bar_up_container, (ViewGroup) this, false);
    ...
    public void initTitle() {
        if (this.mTitleLayout == null) {
            ...
            LinearLayout linearLayout = (LinearLayout) inflater.inflate(R.layout.action_bar_title_item, (ViewGroup) this, false);
    ...
    */
    public void onMeasure(int widthMeasureSpec, int heightMeasureSpec) {
        ...
        if (this.mExpandedActionView == null) {
            ...
            if (customView == null) {
                ViewGroup.LayoutParams lp = mo3518generateLayoutParams(customView.getLayoutParams());
    ...
    */
    ...
    @Override // android.view.ViewGroup
    /* renamed from: generateLayoutParams */
    public ViewGroup.LayoutParams mo3518generateLayoutParams(ViewGroup.LayoutParams lp) {
        if (lp == null) {
            return mo3516generateDefaultLayoutParams();
        }
        return lp;
    }
