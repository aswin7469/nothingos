    ...
    public void setOriginalIconColor(int color) {
        ...
        if (background == null) {
            if (hasColor && icon != null) {
                icon.mo3113mutate().setColorFilter(color, PorterDuff.Mode.SRC_ATOP);
            }
        } else if (hasColor) {
            background.mo3113mutate().setColorFilter(color, PorterDuff.Mode.SRC_ATOP);
            if (icon != null) {
                icon.mo3113mutate().setColorFilter(this.mBackgroundColor, PorterDuff.Mode.SRC_ATOP);
            }
        } else {
            background.mo3113mutate().setColorFilter(this.mBackgroundColor, PorterDuff.Mode.SRC_ATOP);
        }
    }
