...
public class ConversationLayout extends FrameLayout implements ImageMessageConsumer, IMessagingLayout {
    ...
    private static final Consumer<MessagingMessage> REMOVE_MESSAGE = ConversationLayout$$ExternalSyntheticLambda6.INSTANCE;
    ...
    public void onFinishInflate() {
        ...
        this.mIcon.setOnVisibilityChangedListener(new Consumer() { // from class: com.android.internal.widget.ConversationLayout$$ExternalSyntheticLambda4
            @Override // java.util.function.Consumer
            public final void accept(Object obj) {
                ConversationLayout.this.lambda$onFinishInflate$0$ConversationLayout((Integer) obj);
            }
        });
        this.mIcon.setOnForceHiddenChangedListener(new Consumer() { // from class: com.android.internal.widget.ConversationLayout$$ExternalSyntheticLambda2
            @Override // java.util.function.Consumer
            public final void accept(Object obj) {
                ConversationLayout.this.lambda$onFinishInflate$1$ConversationLayout((Boolean) obj);
            }
        });
        this.mConversationIconView.setOnForceHiddenChangedListener(new Consumer() { // from class: com.android.internal.widget.ConversationLayout$$ExternalSyntheticLambda3
            @Override // java.util.function.Consumer
            public final void accept(Object obj) {
                ConversationLayout.this.lambda$onFinishInflate$2$ConversationLayout((Boolean) obj);
            }
        });
        ...
        this.mAppNameGone = z;
        this.mAppName.setOnVisibilityChangedListener(new Consumer() { // from class: com.android.internal.widget.ConversationLayout$$ExternalSyntheticLambda5
            @Override // java.util.function.Consumer
            public final void accept(Object obj) {
                ConversationLayout.this.lambda$onFinishInflate$3$ConversationLayout((Integer) obj);
            }
        });
    }

    public /* synthetic */ void lambda$onFinishInflate$0$ConversationLayout(Integer visibility) {
        boolean wasGone = true;
        boolean isGone = visibility.intValue() == 8;
        int oldVisibility = this.mConversationIconBadgeBg.getVisibility();
        boolean wasGone2 = oldVisibility == 8;
        if (wasGone2 != isGone) {
        ...
        boolean wasGone3 = oldVisibility2 == 8;
    ...
    public /* synthetic */ void lambda$onFinishInflate$1$ConversationLayout(Boolean forceHidden) {
    ...
    public /* synthetic */ void lambda$onFinishInflate$2$ConversationLayout(Boolean forceHidden) {
        this.mPeopleHelper.animateViewForceHidden(this.mConversationIconBadgeBg, forceHidden.booleanValue());
        this.mPeopleHelper.animateViewForceHidden(this.mImportanceRingView, forceHidden.booleanValue());
        this.mPeopleHelper.animateViewForceHidden(this.mIcon, forceHidden.booleanValue());
    }

    public /* synthetic */ void lambda$onFinishInflate$3$ConversationLayout(Integer visibility) {
    ...
    public void setIsImportantConversation(boolean isImportantConversation, boolean animate) {
        ...
        if (animate && isImportantConversation) {
            ...
            ValueAnimator.AnimatorUpdateListener animatorUpdateListener = new ValueAnimator.AnimatorUpdateListener() { // from class: com.android.internal.widget.ConversationLayout$$ExternalSyntheticLambda0
                @Override // android.animation.ValueAnimator.AnimatorUpdateListener
                public final void onAnimationUpdate(ValueAnimator valueAnimator) {
                    ConversationLayout.this.lambda$setIsImportantConversation$4$ConversationLayout(ring, ringColor, baseSize, valueAnimator);
                }
            };
            ValueAnimator growAnimation = ValueAnimator.ofFloat(0.0f, largeThickness);
            growAnimation.setInterpolator(LINEAR_OUT_SLOW_IN);
            growAnimation.mo1103setDuration(250L);
            ...
            shrinkAnimation.mo1103setDuration(200L);
    ...
    public /* synthetic */ void lambda$setIsImportantConversation$4$ConversationLayout(GradientDrawable ring, int ringColor, int baseSize, ValueAnimator animation) {
    ...
    public void setData(Bundle extras) {
        ...
        RemoteInputHistoryItem[] history = (RemoteInputHistoryItem[]) extras.getParcelableArray(Notification.EXTRA_REMOTE_INPUT_HISTORY_ITEMS);
    ...
    private void bind(List<Notification.MessagingStyle.Message> newMessages, List<Notification.MessagingStyle.Message> newHistoricMessages, boolean showSpinner) {
        ...
        Consumer<MessagingMessage> consumer = REMOVE_MESSAGE;
        list.forEach(consumer);
        this.mHistoricMessages.forEach(consumer);
    ...
    private void updateImageMessages() {
        ...
        MessagingLinearLayout messagingLinearLayout = this.mImageMessageContainer;
        if (newMessage == null) {
            i = 8;
        }
        messagingLinearLayout.setVisibility(i);
    }
    ...
    public void bindFacePile(ImageView bottomBackground, ImageView bottomView, ImageView topView) {
        ...
        while (true) {
            ...
            boolean notUser = messageSender != null && !TextUtils.equals(userKey, getKey(messageSender));
    ...
    public CharSequence getConversationTitle() {
        return this.mConversationText.mo3084getText();
    }
    ...
    private void removeGroups(ArrayList<MessagingGroup> oldGroups) {
        ...
        for (int i = 0; i < size; i++) {
            ...
            if (!this.mGroups.contains(group)) {
                ...
                Runnable endRunnable = new Runnable() { // from class: com.android.internal.widget.ConversationLayout$$ExternalSyntheticLambda1
                    @Override // java.lang.Runnable
                    public final void run() {
                        ConversationLayout.this.lambda$removeGroups$5$ConversationLayout(group);
                    }
                };
    ...
    public /* synthetic */ void lambda$removeGroups$5$ConversationLayout(MessagingGroup group) {
    ...
    private void createGroupViews(List<List<MessagingMessage>> groups, List<Person> senders, boolean showSpinner) {
        ...
        for (int groupIndex = 0; groupIndex < groups.size(); groupIndex++) {
            ...
            newGroup.setShowingAvatar(!this.mIsOneToOne && !this.mIsCollapsed);
    ...
    private void findGroups(List<MessagingMessage> historicMessages, List<MessagingMessage> messages, List<List<MessagingMessage>> groups, List<Person> senders) {
        ...
        for (int i = 0; i < messages.size() + histSize; i++) {
            ...
            Person sender2 = message.getMessage().getSenderPerson();
