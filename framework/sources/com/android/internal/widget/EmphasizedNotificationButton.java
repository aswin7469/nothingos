...
public class EmphasizedNotificationButton extends Button {
    ...
    public void setImageIcon(Icon icon) {
        ...
        lambda$setImageIconAsync$0$EmphasizedNotificationButton(drawable);
    }
    ...
    public Runnable setImageIconAsync(Icon icon) {
        ...
        return new Runnable() { // from class: com.android.internal.widget.EmphasizedNotificationButton$$ExternalSyntheticLambda0
            ...
            public final void run() {
                EmphasizedNotificationButton.this.lambda$setImageIconAsync$0$EmphasizedNotificationButton(drawable);
            }
        };
    }
    ...
    public void lambda$setImageIconAsync$0$EmphasizedNotificationButton(Drawable drawable) {
        if (drawable != null) {
            drawable.mo3113mutate();
