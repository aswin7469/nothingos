...
public final class FloatingToolbar {
    ...
    public static final class FloatingToolbarPopup {
        ...
        public FloatingToolbarPopup(Context context, View parent) {
            ...
            this.mOverflowPanelViewHelper = new OverflowPanelViewHelper(context2, dimensionPixelSize);
        ...
        public List<MenuItem> layoutMainPanelItems(List<MenuItem> menuItems, int toolbarWidth) {
            ...
            while (!remainingMenuItems.isEmpty()) {
                ...
                boolean showIcon = (!isFirstItem || menuItem2.getItemId() != i) ? isLastItem : true;
    ...
    public static AnimatorSet createEnterAnimation(View view) {
        ...
        animation.playTogether(ObjectAnimator.ofFloat(view, View.ALPHA, 0.0f, 1.0f).mo1103setDuration(150L));
        return animation;
    }
    ...
    public static AnimatorSet createExitAnimation(View view, int startDelay, Animator.AnimatorListener listener) {
        AnimatorSet animation = new AnimatorSet();
        animation.playTogether(ObjectAnimator.ofFloat(view, View.ALPHA, 1.0f, 0.0f).mo1103setDuration(100L));
