...
public class MessagingLayout extends FrameLayout implements ImageMessageConsumer, IMessagingLayout {
    ...
    private void updateImageMessages() {
        ImageView imageView;
        ArrayList<MessagingGroup> arrayList;
        View newMessage = null;
        if (this.mImageMessageContainer == null) {
            return;
        }
        if (this.mIsCollapsed && !this.mGroups.isEmpty()) {
            MessagingGroup messagingGroup = this.mGroups.get(arrayList.size() - 1);
    ...
    private void removeGroups(ArrayList<MessagingGroup> oldGroups) {
        ...
        for (int i = 0; i < size; i++) {
            ...
            if (!this.mGroups.contains(group)) {
                ...
                Runnable endRunnable = new Runnable() { // from class: com.android.internal.widget.MessagingLayout$$ExternalSyntheticLambda0
