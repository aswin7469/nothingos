    ...
    public class TabAdapter extends BaseAdapter {
        ...
        public View getView(int position, View convertView, ViewGroup parent) {
            if (convertView == null) {
                ...
                return scrollingTabContainerView.createTabView(scrollingTabContainerView.mContext, (ActionBar.Tab) mo3505getItem(position), true);
            }
            ((TabView) convertView).bindTab((ActionBar.Tab) mo3505getItem(position));
            return convertView;
        }
        ...
        public View getDropDownView(int position, View convertView, ViewGroup parent) {
            if (convertView == null) {
                return ScrollingTabContainerView.this.createTabView(this.mDropDownContext, (ActionBar.Tab) mo3505getItem(position), true);
            }
            ((TabView) convertView).bindTab((ActionBar.Tab) mo3505getItem(position));
            return convertView;
        }
