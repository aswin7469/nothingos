...
public class ViewClippingUtil {
    private static final int CLIP_CHILDREN_TAG = 16908853;
    private static final int CLIP_CLIPPING_SET = 16908852;
    private static final int CLIP_TO_PADDING = 16908855;
    ...
    public static void setClippingDeactivated(View transformedView, boolean deactivated, ClippingParameters clippingParameters) {
        ...
        while (true) {
            ...
            ArraySet<View> clipSet = (ArraySet) parent.getTag(16908852);
            if (clipSet == null) {
                clipSet = new ArraySet<>();
                parent.setTagInternal(16908852, clipSet);
            }
            Boolean clipChildren = (Boolean) parent.getTag(16908853);
            if (clipChildren == null) {
                clipChildren = Boolean.valueOf(parent.getClipChildren());
                parent.setTagInternal(16908853, clipChildren);
            }
            Boolean clipToPadding = (Boolean) parent.getTag(16908855);
            if (clipToPadding == null) {
                clipToPadding = Boolean.valueOf(parent.getClipToPadding());
                parent.setTagInternal(16908855, clipToPadding);
            }
            if (!deactivated) {
                ...
                if (clipSet.isEmpty()) {
                    ...
                    parent.setTagInternal(16908852, null);
