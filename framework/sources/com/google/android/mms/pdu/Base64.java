    ...
    public static byte[] decodeBase64(byte[] base64Data) {
        ...
        for (int i = 0; i < numberQuadruple; i++) {
            ...
            if (marker0 != 61 && marker1 != 61) {
                ...
                decodedData[encodedIndex + 1] = (byte) (((b2 & MidiConstants.STATUS_CHANNEL_MASK) << 4) | ((b3 >> 2) & 15));
                ...
                decodedData[encodedIndex] = (byte) ((b1 << 2) | (b2 >> 4));
                decodedData[encodedIndex + 1] = (byte) (((b2 & MidiConstants.STATUS_CHANNEL_MASK) << 4) | ((b32 >> 2) & 15));
            }
            encodedIndex += 3;
        }
        return decodedData;
