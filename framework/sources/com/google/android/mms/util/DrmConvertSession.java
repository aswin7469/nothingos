        ...
        if (context != null && mimeType != null && !mimeType.equals("")) {
            try {
                ...
                try {
                    ...
                    Log.w(str, "Conversion of Mimetype: " + mimeType + " is not supported.", e);
                    str = str;
                } catch (IllegalStateException e2) {
                    Log.w(str, "Could not access Open DrmFramework.", e2);
                    str = str;
                }
            } catch (IllegalArgumentException e3) {
                Log.w(str, "DrmManagerClient instance could not be created, context is Illegal.");
            } catch (IllegalStateException e4) {
                Log.w(str, "DrmManagerClient didn't initialize properly.");
            }
        }
